...
/**
 * Injects the Net Worth & Solvency cluster's supporting blogs as CMS posts.
 *
 * Records live in database/data/networth-cluster-blogs.json, generated from the same
...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        $catId = DB::table('post_categories')->where('slug', 'net-worth-solvency')->value('id');
        if (! $catId) {
            $catId = DB::table('post_categories')->insertGetId([
                'name' => 'Net Worth & Solvency',
                'slug' => 'net-worth-solvency',
                'description' => 'Net worth, solvency and CA certificate explainers for Indian businesses and individuals.',
        ...
        foreach ($rows as $r) {
            ...
            $postId = DB::table('posts')->insertGetId([
                ...
                'status' => 'published',
                'published_at' => '2026-08-04 09:30:00',
                'created_at' => $now, 'updated_at' => $now,
            ]);
