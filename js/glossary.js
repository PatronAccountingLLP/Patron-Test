...
(function () {
  ...
  // FAQ collapse/expand is handled by the sitewide /js/faq-toggle.js (loaded by
  // the layout). Do NOT also run initFAQ() here or the .faq-expanded block gets
  // two "Collapse all" buttons. Keep only the TOC scroll-spy.
  function init() { initTOC(); }
