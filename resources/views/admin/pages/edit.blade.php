...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            ...
            <form method="POST" action="{{ route('admin.pages.update', $page->id) }}" enctype="multipart/form-data" novalidate>
                @csrf
                @method('PUT')
 ...
 <option value="stock-audit" {{ old('directry_label', $page->directry_label)=='stock-audit'?'selected':''}}>Stock Audit</option>
                                       <option value="fssai-registration" {{ old('directry_label', $page->directry_label)=='fssai-registration'?'selected':''}}>Fssai Registration</option>
                                       <option value="ngo-registration" {{ old('directry_label', $page->directry_label)=='ngo-registration'?'selected':''}} >NGO Registration</option>
                                        <option value="trade-license" {{ old('directry_label', $page->directry_label)=='trade-license'?'selected':''}} >Trade License</option>
                                         <option value="drug-license" {{ old('directry_label', $page->directry_label)=='drug-license'?'selected':''}} >Drug License</option>
                                          <option value="llp-registration" {{ old('directry_label', $page->directry_label)=='llp-registration'?'selected':''}} >LLP Registration</option>
                                          <option value="private-limited-company-registration" {{ old('directry_label', $page->directry_label)=='private-limited-company-registration'?'selected':''}} >Private Limited Company Registration</option>
                                        <option value="udyam-registration" {{ old('directry_label', $page->directry_label)=='udyam-registration'?'selected':''}} >Udyam Registration</option>
                                        
                                        <option value="startup-registration" {{ old('directry_label', $page->directry_label)=='startup-registration'?'selected':''}} >Startup Registration</option>
                                        
                                    <option value="msme-registration" {{ old('directry_label', $page->directry_label)=='msme-registration'?'selected':''}} >MSME Registration
</option>
                                        <option value="iec-registration" {{ old('directry_label', $page->directry_label)=='iec-registration'?'selected':''}} >IEC Registration
</option>
                                        <option value="registration-for-12a-80g-certificate" {{ old('directry_label', $page->directry_label)=='registration-for-12a-80g-certificate'?'selected':''}} >Registration for 12a 80g Certificate</option>
                                        <option value="society-registration" {{ old('directry_label', $page->directry_label)=='society-registration'?'selected':''}} >Society Registration</option>
                                        <option value="itr-filling-services" {{ old('directry_label', $page->directry_label)=='itr-filling-services'?'selected':''}} >ITR Filling Services</option>
                                        
                                 <option value="trademark" {{ old('directry_label', $page->directry_label)=='trademark'?'selected':''}} >Trademark</option>
                                 <option value="gst" {{ old('directry_label', $page->directry_label)=='gst'?'selected':''}} >GST</option>
                                 <option value="section-8-company-registration" {{ old('directry_label', $page->directry_label)=='section-8-company-registration'?'selected':''}} >Section-8 Company Registration</option>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('excerpt') is-invalid @enderror" 
                                              ...
                                              placeholder="Brief description of the page (optional)">{{ old('excerpt', $page->excerpt) }}</textarea>
                                    @error('excerpt')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3 d-none">
                                    ...
                                    <textarea class="form-control @error('meta_description') is-invalid @enderror" 
                                              ...
                                              placeholder="SEO description for search engines (optional)">{{ old('meta_description', $page->meta_description) }}</textarea>
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" 
                                                       id="hero_enabled" name="hero_enabled" value="1"
                                                       {{ old('hero_enabled', $page->hero_enabled ?? false) ? 'checked' : '' }}>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div id="hero-benefits-container">
                                                @php
                                                    $heroBenefits = old('hero_benefits', $page->hero_benefits ?? []);
                                                    if (empty($heroBenefits)) $heroBenefits = [''];
                                                @endphp
                                                ...
                                                <div class="hero-benefit-item mb-2">
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" name="hero_benefits[]" 
                                                               placeholder="Enter benefit text" value="{{ $benefit }}">
                                                        <button type="button" class="btn btn-danger remove-hero-benefit" 
                                                                style="display: {{ count($heroBenefits) > 1 ? 'block' : 'none' }};">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" class="form-control" id="hero_button_link" name="hero_button_link" 
                                                       value="{{ old('hero_button_link', $page->hero_button_link ?? '') }}" 
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" class="form-control" id="hero_video_text" name="hero_video_text" 
                                                       value="{{ old('hero_video_text', $page->hero_video_text ?? '') }}" 
                                                       placeholder="e.g., Know about PVT in 60 seconds.">
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" class="form-control" id="hero_video_link" name="hero_video_link" 
                                                       value="{{ old('hero_video_link', $page->hero_video_link ?? '') }}" 
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" class="form-control" id="hero_document_text" name="hero_document_text" 
                                                       value="{{ old('hero_document_text', $page->hero_document_text ?? '') }}" 
                                                       placeholder="e.g., View Sample document">
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" class="form-control" id="hero_document_link" name="hero_document_link" 
                                                       value="{{ old('hero_document_link', $page->hero_document_link ?? '') }}" 
                                        ...
                                        <div class="text-muted small">
                                            ...
                                            The hero section appears at the top of the page with the title, benefits list, and action buttons.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card mt-4">
                                    <div class="card-header d-flex justify-content-between align-items-center">
                                        <h6 class="mb-0">Intro Section</h6>
                                    </div>
                                    <div class="card-body">
                                        <div class="mb-3">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" 
                                                       id="intro_enabled" name="intro_enabled" value="1"
                                                       {{ old('intro_enabled', $page->intro_enabled ?? false) ? 'checked' : '' }}>
                                                <label class="form-check-label" for="intro_enabled">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('intro_content') is-invalid @enderror" 
                                                      ...
                                                      placeholder="Enter the introductory content here...">{{ old('intro_content', $page->intro_content ?? '') }}</textarea>
                                        ...
                                        <div class="text-muted small">
                                            <i class="bi bi-info-circle"></i> 
                                            The intro section will be displayed prominently on the page with custom styling.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card mt-4">
                                    <div class="card-header d-flex justify-content-between align-items-center">
                                        <h6 class="mb-0">What Section</h6>
                                    </div>
                                    <div class="card-body">
                                        <div class="mb-3">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" 
                                                       id="what_enabled" name="what_enabled" value="1"
                                                       {{ old('what_enabled', $page->what_enabled ?? false) ? 'checked' : '' }}>
                                                <label class="form-check-label" for="what_enabled">
                                                    Enable What Section
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('what_title') is-invalid @enderror" 
                                                   id="what_title" name="what_title" 
                                                   value="{{ old('what_title', $page->what_title ?? '') }}"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('what_content') is-invalid @enderror" 
                                                      ...
                                                      placeholder="Enter the content explaining what this topic is about...">{{ old('what_content', $page->what_content ?? '') }}</textarea>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="hidden" name="what_image" id="what_image" 
                                                   value="{{ old('what_image', $page->what_image ?? '') }}">
                                            @if(old('what_image', $page->what_image ?? ''))
                                            <div class="mt-2">
                                                <img src="{{ asset('storage/' . old('what_image', $page->what_image ?? '')) }}" 
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('what_additional_content') is-invalid @enderror" 
                                                      ...
                                                      placeholder="Enter additional content that will appear after the image...">{{ old('what_additional_content', $page->what_additional_content ?? '') }}</textarea>
                                        ...
                                        <div class="text-muted small">
                                            <i class="bi bi-info-circle"></i> 
                                            This section displays an informative content block with an image, perfect for explaining "What is..." type content.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card mt-4">
                                    <div class="card-header">
                                        <h6 class="mb-0">Applicability Section</h6>
                                    </div>
                                    <div class="card-body">
                                        <div class="mb-3">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" 
                                                       id="applicability_enabled" name="applicability_enabled" value="1"
                                                       {{ old('applicability_enabled', $page->applicability_enabled ?? false) ? 'checked' : '' }}>
                                                <label class="form-check-label" for="applicability_enabled">
                                                    Enable Applicability Section
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('applicability_title') is-invalid @enderror" 
                                                   id="applicability_title" name="applicability_title" 
                                                   value="{{ old('applicability_title', $page->applicability_title ?? '') }}"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('applicability_content') is-invalid @enderror" 
                                                      ...
                                                      placeholder="Enter the applicability content with multiple paragraphs...">{{ old('applicability_content', $page->applicability_content ?? '') }}</textarea>
                                        ...
                                        <div class="text-muted small">
                                            <i class="bi bi-info-circle"></i> 
                                            This section displays applicability rules and limits information.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card mt-4">
                                    <div class="card-header d-flex justify-content-between align-items-center">
                                        <h6 class="mb-0">Services Section (Max 6 items)</h6>
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" 
                                                       id="services_enabled" name="services_enabled" value="1"
                                                       {{ old('services_enabled', $page->services_enabled ?? false) ? 'checked' : '' }}>
                                                <label class="form-check-label" for="services_enabled">
                                        ...
                                        <div id="services-items-container">
                                            @php
                                                $services = old('services_items', $page->services_items ?? []);
                                                if(empty($services)) {
                                            ...
                                            <div class="service-item border rounded p-3 mb-3" data-index="{{ $index }}">
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                                    <h6 class="mb-0">Service #<span class="service-number">{{ $index + 1 }}</span></h6>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control @error('services_items.'.$index.'.title') is-invalid @enderror" 
                                                           name="services_items[{{ $index }}][title]" 
                                                           value="{{ $service['title'] ?? '' }}"
                                                           placeholder="e.g., Opening & Closing Stock Verification">
                                                    @error('services_items.'.$index.'.title')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control @error('services_items.'.$index.'.description') is-invalid @enderror" 
                                                              name="services_items[{{ $index }}][description]" 
                                                              rows="2"
                                                              placeholder="Brief description of the service...">{{ $service['description'] ?? '' }}</textarea>
                                                    @error('services_items.'.$index.'.description')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="mb-2">
                                                        ...
                                                        <button type="button" class="btn btn-sm btn-outline-danger ms-2 remove-service-image" 
                                                                data-index="{{ $index }}">
                                                            <i class="bi bi-trash"></i> Remove Image
                                                        </button>
                                                    </div>
                                                    @endif
                                                    <input type="file" class="form-control service-image-input @error('services_items.'.$index.'.image') is-invalid @enderror" 
                                                           data-index="{{ $index }}" 
                                                           accept="image/*">
                                                    <input type="hidden" name="services_items[{{ $index }}][image]" value="{{ $service['image'] ?? '' }}">
                                                    <input type="hidden" name="services_items[{{ $index }}][remove_image]" value="0" class="remove-image-flag">
                                                    <small class="text-muted">Upload an image (PNG, JPG, SVG - Max 2MB)</small>
                                                    @error('services_items.'.$index.'.image')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('services_note') is-invalid @enderror" 
                                                      ...
                                                      placeholder="e.g., Such reports not only enhance internal control but also provide valuable insights for decision-making, financial reporting, and stakeholder assurance.">{{ old('services_note', $page->services_note ?? '') }}</textarea>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('service_content') is-invalid @enderror" 
                                                      ...
                                                      placeholder="Write your content here... Use the editor toolbar above to format text, add images, tables, and more.">{{ old('service_content', $page->service_content ?? '') }}</textarea>
                                        ...
                                        <div class="text-muted small">
                                            <i class="bi bi-info-circle"></i> 
                                            You can add up to 6 service items. Each service will be displayed in a card with an icon, title, and description.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card mt-4">
                                    <div class="card-header d-flex justify-content-between align-items-center">
                                        <h6 class="mb-0">Report Components Section (Max 6 items)</h6>
                                        <button type="button" class="btn btn-sm btn-primary" id="add-report-component">
                                            <i class="bi bi-plus"></i> Add Report Component
                                        </button>
                                    </div>
                                    <div class="card-body">
                                        <div class="mb-3">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" 
                                                       id="report_components_enabled" name="report_components_enabled" value="1"
                                                       {{ old('report_components_enabled', $page->report_components_enabled ?? false) ? 'checked' : '' }}>
                                                <label class="form-check-label" for="report_components_enabled">
                                                    Enable Report Components Section
                                                </label>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card-body">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control @error('report_format_title') is-invalid @enderror" 
                                                           ...
                                                           value="{{ old('report_format_title', $page->report_format_title ?? '') }}"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control @error('report_format_description') is-invalid @enderror" 
                                                              ...
                                                              placeholder="A report is presented in a structured format...">{{ old('report_format_description', $page->report_format_description ?? '') }}</textarea>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <input type="text" class="form-control @error('report_format_button1_text') is-invalid @enderror" 
                                                               ...
                                                               value="{{ old('report_format_button1_text', $page->report_format_button1_text ?? '') }}"
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <input type="text" class="form-control @error('report_format_button1_link') is-invalid @enderror" 
                                                               ...
                                                               value="{{ old('report_format_button1_link', $page->report_format_button1_link ?? '') }}"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <input type="text" class="form-control @error('report_format_button2_text') is-invalid @enderror" 
                                                               ...
                                                               value="{{ old('report_format_button2_text', $page->report_format_button2_text ?? '') }}"
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <input type="text" class="form-control @error('report_format_button2_link') is-invalid @enderror" 
                                                               ...
                                                               value="{{ old('report_format_button2_link', $page->report_format_button2_link ?? '') }}"
                                                               placeholder="e.g., #contact">
                                        ...
                                        <div id="report-components-container">
                                            @if(old('report_components_items', $page->report_components_items ?? []))
                                                @foreach(old('report_components_items', $page->report_components_items ?? []) as $index => $component)
                                                    <div class="report-component-item border rounded p-3 mb-3" data-index="{{ $index }}">
                                                        <div class="d-flex justify-content-between align-items-center mb-3">
                                                            ...
                                                            <button type="button" class="btn btn-danger btn-sm remove-report-component">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6 mb-3">
                                                                ...
                                                                <input type="text" class="form-control" 
                                                                       name="report_components_items[{{ $index }}][title]" 
                                                            ...
                                                            <div class="col-md-6 mb-3">
                                                                ...
                                                                @if(!empty($component['image']))
                                                                    <div class="mb-2">
                                                                        <img src="{{ asset('storage/' . $component['image']) }}" 
                                                                             ...
                                                                             class="img-thumbnail" 
                                                                             style="max-height: 100px;">
                                                                        <button type="button" class="btn btn-sm btn-danger remove-report-component-image" data-index="{{ $index }}">
                                                                ...
                                                                <input type="file" class="form-control report-component-image-input" 
                                                                       data-index="{{ $index }}" 
                                                                       accept="image/*">
                                                                <input type="hidden" name="report_components_items[{{ $index }}][image]" 
                                                                       value="{{ $component['image'] ?? '' }}">
                                                                <input type="hidden" name="report_components_items[{{ $index }}][remove_image]" 
                                                                       value="0" class="remove-report-component-image-flag">
                                                                <small class="text-muted">Upload an image (PNG, JPG, SVG - Max 2MB)</small>
                                                            </div>
                                                            <div class="col-12">
                                                                <label class="fw-bold d-block mb-1">Component Description</label>
                                                                <textarea class="form-control" 
                                                                          name="report_components_items[{{ $index }}][description]" 
                                                                          rows="3">{{ $component['description'] ?? '' }}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                @endforeach
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('report_components_note') is-invalid @enderror" 
                                                      ...
                                                      placeholder="e.g., Such reports not only enhance internal control but also provide valuable insights for decision-making, financial reporting, and stakeholder assurance.">{{ old('report_components_note', $page->report_components_note ?? '') }}</textarea>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('report_components_content') is-invalid @enderror" 
                                                      ...
                                                      placeholder="Write your content here... Use the editor toolbar above to format text, add images, tables, and more.">{{ old('report_components_content', $page->report_components_content ?? '') }}</textarea>
                                            <div class="form-text">Use the rich editor toolbar to format your content with text styling, links, images, tables, and more.</div>
                                        ...
                                        <div class="text-muted small">
                                            <i class="bi bi-info-circle"></i> 
                                            You can add up to 6 report component items. Each component will be displayed in a card with an icon, title, and description.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card mt-4">
                                    <div class="card-header d-flex justify-content-between align-items-center">
                                        <h6 class="mb-0">Procedure Steps Section</h6>
                                        <button type="button" class="btn btn-sm btn-primary" id="add-procedure-step">
                                            <i class="bi bi-plus"></i> Add Procedure Step
                                        </button>
                                    </div>
                                    <div class="card-body">
                                        <div class="mb-3">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" 
                                                       id="procedure_steps_enabled" name="procedure_steps_enabled" value="1"
                                                       {{ old('procedure_steps_enabled', $page->procedure_steps_enabled ?? false) ? 'checked' : '' }}>
                                                <label class="form-check-label" for="procedure_steps_enabled">
                                                    Enable Procedure Steps Section
                                                </label>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card-body">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control @error('procedure_header_title') is-invalid @enderror" 
                                                           ...
                                                           value="{{ old('procedure_header_title', $page->procedure_header_title ?? '') }}"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control @error('procedure_header_description') is-invalid @enderror" 
                                                              ...
                                                              placeholder="The procedure is a systematic process...">{{ old('procedure_header_description', $page->procedure_header_description ?? '') }}</textarea>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <input type="text" class="form-control @error('procedure_header_button1_text') is-invalid @enderror" 
                                                               ...
                                                               value="{{ old('procedure_header_button1_text', $page->procedure_header_button1_text ?? '') }}"
                                                               placeholder="e.g., Explore more">
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <input type="text" class="form-control @error('procedure_header_button1_link') is-invalid @enderror" 
                                                               ...
                                                               value="{{ old('procedure_header_button1_link', $page->procedure_header_button1_link ?? '') }}"
                                                               placeholder="e.g., #contact">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <input type="text" class="form-control @error('procedure_header_button2_text') is-invalid @enderror" 
                                                               ...
                                                               value="{{ old('procedure_header_button2_text', $page->procedure_header_button2_text ?? '') }}"
                                                               placeholder="e.g., Get in touch">
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <input type="text" class="form-control @error('procedure_header_button2_link') is-invalid @enderror" 
                                                               ...
                                                               value="{{ old('procedure_header_button2_link', $page->procedure_header_button2_link ?? '') }}"
                                                               placeholder="e.g., #contact">
                                        ...
                                        <div id="procedure-steps-container">
                                            @if(old('procedure_steps_items', $page->procedure_steps_items ?? []))
                                                @foreach(old('procedure_steps_items', $page->procedure_steps_items ?? []) as $index => $step)
                                                    <div class="procedure-step-item border rounded p-3 mb-3" data-index="{{ $index }}">
                                                        <div class="d-flex justify-content-between align-items-center mb-3">
                                                            ...
                                                            <button type="button" class="btn btn-danger btn-sm remove-procedure-step">
                                                                <i class="bi bi-trash"></i> Remove
                                                            </button>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-6 mb-3">
                                                                ...
                                                                <input type="text" class="form-control" 
                                                                       name="procedure_steps_items[{{ $index }}][step_number]" 
                                                                       value="{{ $step['step_number'] ?? 'STEP ' . ($index + 1) }}" 
                                                            ...
                                                            <div class="col-12 mb-3">
                                                                ...
                                                                <input type="text" class="form-control" 
                                                                       name="procedure_steps_items[{{ $index }}][title]" 
                                                                       value="{{ $step['title'] ?? '' }}" 
                                                                       placeholder="e.g., Audit Planning">
                                                            </div>
                                                            <div class="col-12 mb-3">
                                                                <label class="fw-bold d-block mb-1">Step Description</label>
                                                                <textarea class="form-control" 
                                                                          name="procedure_steps_items[{{ $index }}][description]" 
                                                                          rows="3" 
                                                                          placeholder="Detailed description of this step...">{{ $step['description'] ?? '' }}</textarea>
                                                            </div>
                                                            <div class="col-12">
                                                                ...
                                                                @if(!empty($step['image']))
                                                                    <div class="mb-2">
                                                                        <img src="{{ asset('storage/' . $step['image']) }}" 
                                                                             ...
                                                                             class="img-thumbnail" 
                                                                             style="max-height: 100px;">
                                                                        <button type="button" class="btn btn-sm btn-danger remove-procedure-step-image" data-index="{{ $index }}">
                                                                            <i class="bi bi-x"></i> Remove Image
                                                                        </button>
                                                                    </div>
                                                                @endif
                                                                <input type="file" class="form-control procedure-step-image-input" 
                                                                       data-index="{{ $index }}" 
                                                                       accept="image/*">
                                                                <input type="hidden" name="procedure_steps_items[{{ $index }}][image]" 
                                                                       value="{{ $step['image'] ?? '' }}">
                                                                <input type="hidden" name="procedure_steps_items[{{ $index }}][remove_image]" 
                                                                       value="0" class="remove-procedure-step-image-flag">
                                                                <small class="text-muted">Upload an image (PNG, JPG, SVG - Max 2MB)</small>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('procedure_steps_content') is-invalid @enderror" 
                                                      ...
                                                      placeholder="Write your content here... Use the editor toolbar above to format text, add images, tables, and more.">{{ old('procedure_steps_content', $page->procedure_steps_content ?? '') }}</textarea>
                                            <div class="form-text">Use the rich editor toolbar to format your content with text styling, links, images, tables, and more.</div>
                                        ...
                                        <div class="text-muted small">
                                            <i class="bi bi-info-circle"></i> 
                                            You can add unlimited procedure steps. Each step will alternate between left and right layout automatically for visual variety, with smooth scroll animations.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card mt-4">
                                    <div class="card-header d-flex justify-content-between align-items-center">
                                        <h6 class="mb-0">Checklist Section</h6>
                                        <button type="button" class="btn btn-sm btn-primary" id="add-checklist-btn">
                                            <i class="bi bi-plus"></i> Add Checklist Item
                                        </button>
                                    </div>
                                    <div class="card-body">
                                        <div class="mb-3">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" id="checklist_enabled" name="checklist_enabled" value="1" {{ old('checklist_enabled', $page->checklist_enabled ?? false) ? 'checked' : '' }}>
                                                <label class="form-check-label" for="checklist_enabled">
                                                    Enable Checklist Section
                                                </label>
                                            </div>
                                        </div>
                                        <div id="checklist-content" style="display: {{ old('checklist_enabled', $page->checklist_enabled ?? false) ? 'block' : 'none' }};">
                                                ...
                                                <div class="card-body">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control @error('checklist_header_title') is-invalid @enderror" 
                                                               ...
                                                               value="{{ old('checklist_header_title', $page->checklist_header_title ?? '') }}" 
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control @error('checklist_header_description') is-invalid @enderror" 
                                                                  ...
                                                                  rows="4" 
                                                                  placeholder="An effective audit requires careful preparation and the availability of relevant records...">{{ old('checklist_header_description', $page->checklist_header_description ?? '') }}</textarea>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <input type="text" class="form-control @error('checklist_header_button1_text') is-invalid @enderror" 
                                                                   ...
                                                                   value="{{ old('checklist_header_button1_text', $page->checklist_header_button1_text ?? '') }}" 
                                                        ...
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <input type="text" class="form-control @error('checklist_header_button1_link') is-invalid @enderror" 
                                                                   ...
                                                                   value="{{ old('checklist_header_button1_link', $page->checklist_header_button1_link ?? '') }}" 
                                                                   placeholder="#contact">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <input type="text" class="form-control @error('checklist_header_button2_text') is-invalid @enderror" 
                                                                   ...
                                                                   value="{{ old('checklist_header_button2_text', $page->checklist_header_button2_text ?? '') }}" 
                                                        ...
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <input type="text" class="form-control @error('checklist_header_button2_link') is-invalid @enderror" 
                                                                   ...
                                                                   value="{{ old('checklist_header_button2_link', $page->checklist_header_button2_link ?? '') }}" 
                                                                   placeholder="#contact">
                                            ...
                                            <div id="checklist-items-container">
                                                @if(old('checklist_items'))
                                                    ...
                                                    @endforeach
                                                @elseif($page->checklist_items && count($page->checklist_items) > 0)
                                                    @foreach($page->checklist_items as $index => $item)
                                                        <div class="checklist-item border rounded p-3 mb-3" data-index="{{ $index }}">
                                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                                <h6 class="mb-0">Checklist Item #<span class="checklist-number">{{ $index + 1 }}</span></h6>
                                                                <button type="button" class="btn btn-outline-danger btn-sm remove-checklist-btn">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('checklist_note') is-invalid @enderror" 
                                                      ...
                                                      rows="3" 
                                                      placeholder="Having these documents in place ensures that the audit is conducted smoothly...">{{ old('checklist_note', $page->checklist_note ?? '') }}</textarea>
                                        ...
                                        <div class="alert alert-info mt-3">
                                            <i class="bi bi-info-circle"></i> You can add unlimited checklist items. Each item will be displayed with a check icon on the frontend.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card mt-4">
                                    <div class="card-header d-flex justify-content-between align-items-center">
                                        <h6 class="mb-0">Challenges & Solutions Section</h6>
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" id="challenges_enabled" name="challenges_enabled" value="1" {{ old('challenges_enabled', $page->challenges_enabled ?? false) ? 'checked' : '' }}>
                                                <label class="form-check-label" for="challenges_enabled">
                                                    Enable Challenges & Solutions Section
                                                </label>
                                            </div>
                                        </div>
                                        <div id="challenges-content" style="display: {{ old('challenges_enabled', $page->challenges_enabled ?? false) ? 'block' : 'none' }};">
                                            <!-- Section Header -->
                                            <div class="card mb-3 bg-light">
                                                <div class="card-header">
                                                ...
                                                <div class="card-body">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control @error('challenges_title') is-invalid @enderror" 
                                                               ...
                                                               value="{{ old('challenges_title', $page->challenges_title ?? '') }}" 
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control @error('challenges_description') is-invalid @enderror" 
                                                                  ...
                                                                  rows="3" 
                                                                  placeholder="Stock audits often face operational and management challenges...">{{ old('challenges_description', $page->challenges_description ?? '') }}</textarea>
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control @error('challenges_column_heading') is-invalid @enderror" 
                                                           ...
                                                           value="{{ old('challenges_column_heading', $page->challenges_column_heading ?? 'Common Challenge') }}" 
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control @error('solutions_column_heading') is-invalid @enderror" 
                                                           ...
                                                           value="{{ old('solutions_column_heading', $page->solutions_column_heading ?? 'Patron Accounting Solution') }}" 
                                            ...
                                            <div id="challenges-items-container">
                                                @if(old('challenges_items'))
                                                    ...
                                                    @endforeach
                                                @elseif($page->challenges_items && count($page->challenges_items) > 0)
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control @error('challenges_note') is-invalid @enderror" 
                                                          ...
                                                          rows="3" 
                                                          placeholder="Addressing these challenges systematically ensures precise inventory records...">{{ old('challenges_note', $page->challenges_note ?? '') }}</textarea>
                                            ...
                                            <div class="alert alert-info mt-3">
                                                <i class="bi bi-info-circle"></i> You can add up to 4 challenge and solution pairs. Each pair will be displayed side by side.
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card mt-4">
                                    <div class="card-header d-flex justify-content-between align-items-center">
                                        <h6 class="mb-0">Stock Audit Fee in India Section</h6>
                                        <button type="button" class="btn btn-sm btn-primary" id="add-fee-btn">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" id="fees_enabled" name="fees_enabled" value="1" {{ old('fees_enabled', $page->fees_enabled ?? false) ? 'checked' : '' }}>
                                                <label class="form-check-label" for="fees_enabled">
                                                    Enable Fees Section
                                                </label>
                                            </div>
                                        </div>
                                        <div id="fees-content" style="display: {{ old('fees_enabled', $page->fees_enabled ?? false) ? 'block' : 'none' }};">
                                            <!-- Section Header -->
                                            <div class="card mb-3 bg-light">
                                                <div class="card-header">
                                                    <h6 class="mb-0">Section Header</h6>
                                                ...
                                                <div class="card-body">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control @error('fees_title') is-invalid @enderror" 
                                                               ...
                                                               value="{{ old('fees_title', $page->fees_title ?? '') }}" 
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control @error('fees_description') is-invalid @enderror" 
                                                                  ...
                                                                  rows="3" 
                                                                  placeholder="Fees vary based on business size, number of locations, and scope...">{{ old('fees_description', $page->fees_description ?? '') }}</textarea>
                                            ...
                                            <div id="fees-items-container">
                                                @if(old('fees_items'))
                                                    ...
                                                    @endforeach
                                                @elseif($page->fees_items && count($page->fees_items) > 0)
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control @error('fees_note') is-invalid @enderror" 
                                                          ...
                                                          rows="3" 
                                                          placeholder="Actual fees depend on audit complexity and industry requirements.">{{ old('fees_note', $page->fees_note ?? '') }}</textarea>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control @error('fees_content') is-invalid @enderror" 
                                                          ...
                                                          placeholder="Write your content here... Use the editor toolbar above to format text, add images, tables, and more.">{{ old('fees_content', $page->fees_content ?? '') }}</textarea>
                                                <div class="form-text">Use the rich editor toolbar to format your content with text styling, links, images, tables, and more.</div>
                                                @error('fees_content')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            ...
                                            <div class="alert alert-info mt-3">
                                                <i class="bi bi-info-circle"></i> You can add up to 4 fee items. Each item will be displayed in a table format.
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card mt-4">
                                    <div class="card-header">
                                        <h6 class="mb-0">Time Taken for Stock Audit Section</h6>
                                    </div>
                                    <div class="card-body">
                                        <div class="mb-3">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" id="time_taken_enabled" name="time_taken_enabled" value="1" {{ old('time_taken_enabled', $page->time_taken_enabled ?? false) ? 'checked' : '' }}>
                                                <label class="form-check-label" for="time_taken_enabled">
                                                    Enable Time Taken Section
                                                </label>
                                            </div>
                                        </div>
                                        <div id="time-taken-content" style="display: {{ old('time_taken_enabled', $page->time_taken_enabled ?? false) ? 'block' : 'none' }};">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control @error('time_taken_title') is-invalid @enderror" 
                                                       ...
                                                       value="{{ old('time_taken_title', $page->time_taken_title ?? '') }}" 
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control @error('time_taken_content') is-invalid @enderror" 
                                                          ...
                                                          rows="6" 
                                                          placeholder="The duration of an audit depends on the scale and complexity of operations...">{{ old('time_taken_content', $page->time_taken_content ?? '') }}</textarea>
                                ...
                                <div class="card mt-4">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" id="benefits_enabled" name="benefits_enabled" value="1" {{ old('benefits_enabled', $page->benefits_enabled ?? false) ? 'checked' : '' }}>
                                                <label class="form-check-label" for="benefits_enabled">
                                                    Enable Benefits Section
                                                </label>
                                            </div>
                                        </div>
                                        <div id="benefits-content" style="display: {{ old('benefits_enabled', $page->benefits_enabled ?? false) ? 'block' : 'none' }};">
                                                ...
                                                <div class="card-body">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control @error('benefits_header_title') is-invalid @enderror" 
                                                               ...
                                                               value="{{ old('benefits_header_title', $page->benefits_header_title ?? '') }}" 
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control @error('benefits_header_description') is-invalid @enderror" 
                                                                  ...
                                                                  rows="3" 
                                                                  placeholder="A stock audit provides organizations with a comprehensive evaluation...">{{ old('benefits_header_description', $page->benefits_header_description ?? '') }}</textarea>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <input type="text" class="form-control @error('benefits_header_button1_text') is-invalid @enderror" 
                                                                   ...
                                                                   value="{{ old('benefits_header_button1_text', $page->benefits_header_button1_text ?? '') }}" 
                                                                   placeholder="Explore more">
                                                        ...
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <input type="text" class="form-control @error('benefits_header_button1_link') is-invalid @enderror" 
                                                                   ...
                                                                   value="{{ old('benefits_header_button1_link', $page->benefits_header_button1_link ?? '') }}" 
                                                                   placeholder="#contact">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <input type="text" class="form-control @error('benefits_header_button2_text') is-invalid @enderror" 
                                                                   ...
                                                                   value="{{ old('benefits_header_button2_text', $page->benefits_header_button2_text ?? '') }}" 
                                                                   placeholder="Get in touch">
                                                        ...
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <input type="text" class="form-control @error('benefits_header_button2_link') is-invalid @enderror" 
                                                                   ...
                                                                   value="{{ old('benefits_header_button2_link', $page->benefits_header_button2_link ?? '') }}" 
                                                                   placeholder="#contact">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12 mb-3">
                                                            ...
                                                            @if(!empty($page->benefits_header_image))
                                                            <div class="mt-2" id="benefits_header_current_image">
                                                                <p class="mb-1"><strong>Current Image:</strong></p>
                                                                <img src="{{ asset('storage/' . $page->benefits_header_image) }}" alt="Current Benefits Header Image" style="max-width: 200px; max-height: 200px;" class="img-thumbnail">
                                                                <div class="form-check mt-2">
                                                                    <input class="form-check-input" type="checkbox" name="remove_benefits_header_image" value="1" id="remove_benefits_header_image">
                                                                    <label class="form-check-label" for="remove_benefits_header_image">
                                            ...
                                            <div id="benefits-items-container">
                                                @if(old('benefits_items'))
                                                    @foreach(old('benefits_items') as $index => $item)
                                                        <div class="benefit-item border rounded p-3 mb-3" data-index="{{ $index }}">
                                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                                <h6 class="mb-0">Benefit #<span class="benefit-number">{{ $index + 1 }}</span></h6>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12 mb-3">
                                                                    ...
                                                                    <input type="file" class="form-control" name="benefit_icon_{{ $index }}" accept="image/*" onchange="previewBenefitImage(this, {{ $index }})">
                                                                    <input type="hidden" name="benefits_items[{{ $index }}][icon]" value="{{ $item['icon'] ?? '' }}" class="benefit-icon-path">
                                                                    <small class="text-muted">Upload an icon image for this benefit</small>
                                                                    @if(!empty($item['icon']))
                                                                        <div class="mt-2">
                                                                            <img src="{{ asset('storage/' . $item['icon']) }}" alt="Current Icon" style="max-width: 100px; max-height: 100px;" class="img-thumbnail">
                                                                            <p class="text-muted small mt-1">Current image</p>
                                                                        </div>
                                                                    @endif
                                                                    <div class="mt-2 benefit-image-preview" id="benefit_preview_container_{{ $index }}" style="display:none;">
                                                                        <img id="benefit_preview_{{ $index }}" src="" alt="Preview" style="max-width: 100px; max-height: 100px;" class="img-thumbnail">
                                                                        <button type="button" class="btn btn-sm btn-danger ms-2" onclick="removeBenefitImage({{ $index }})">Remove Image</button>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-12 mb-3">
                                                                    <label class="fw-bold d-block mb-1">Benefit Title</label>
                                                                    <input type="text" class="form-control" name="benefits_items[{{ $index }}][title]" value="{{ $item['title'] ?? '' }}" placeholder="Enter benefit title">
                                                                </div>
                                                                <div class="col-12">
                                                                    <label class="fw-bold d-block mb-1">Description</label>
                                                                    <textarea class="form-control" name="benefits_items[{{ $index }}][description]" rows="2" placeholder="Enter benefit description">{{ $item['description'] ?? '' }}</textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                @elseif($page->benefits_items && count($page->benefits_items) > 0)
                                                    @foreach($page->benefits_items as $index => $item)
                                                        <div class="benefit-item border rounded p-3 mb-3" data-index="{{ $index }}">
                                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                                <h6 class="mb-0">Benefit #<span class="benefit-number">{{ $index + 1 }}</span></h6>
                                                                <button type="button" class="btn btn-outline-danger btn-sm remove-benefit-btn">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('benefits_note') is-invalid @enderror" 
                                                      ...
                                                      rows="3" 
                                                      placeholder="Please Note: Additional important information about benefits...">{{ old('benefits_note', $page->benefits_note ?? '') }}</textarea>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('benefits_content') is-invalid @enderror" 
                                                      ...
                                                      placeholder="Write your content here... Use the editor toolbar above to format text, add images, tables, and more.">{{ old('benefits_content', $page->benefits_content ?? '') }}</textarea>
                                            <div class="form-text">Use the rich editor toolbar to format your content with text styling, links, images, tables, and more.</div>
                                ...
                                <div class="card mt-4">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" id="fees_comparison_enabled" name="fees_comparison_enabled" value="1" {{ old('fees_comparison_enabled', $page->fees_comparison_enabled ?? false) ? 'checked' : '' }}>
                                                <label class="form-check-label" for="fees_comparison_enabled">
                                                    Enable Fees Comparison Section
                                                </label>
                                            </div>
                                        </div>
                                        <div id="fees-comparison-content" style="display: {{ old('fees_comparison_enabled', $page->fees_comparison_enabled ?? false) ? 'block' : 'none' }};">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control @error('fees_comparison_title') is-invalid @enderror" 
                                                       ...
                                                       value="{{ old('fees_comparison_title', $page->fees_comparison_title ?? '') }}" 
                                                       placeholder="Stock Audit Fee in India">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <input type="text" class="form-control @error('fees_comparison_header_col1') is-invalid @enderror" 
                                                           ...
                                                           value="{{ old('fees_comparison_header_col1', $page->fees_comparison_header_col1 ?? '') }}" 
                                                           placeholder="Feature">
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <input type="text" class="form-control @error('fees_comparison_header_col2') is-invalid @enderror" 
                                                           ...
                                                           value="{{ old('fees_comparison_header_col2', $page->fees_comparison_header_col2 ?? '') }}" 
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <input type="text" class="form-control @error('fees_comparison_header_col3') is-invalid @enderror" 
                                                           ...
                                                           value="{{ old('fees_comparison_header_col3', $page->fees_comparison_header_col3 ?? '') }}" 
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control @error('fees_comparison_subtitle') is-invalid @enderror" 
                                                          ...
                                                          rows="2" 
                                                          placeholder="Understanding the key differences between external stock audit and internal inventory management systems">{{ old('fees_comparison_subtitle', $page->fees_comparison_subtitle ?? '') }}</textarea>
                                            ...
                                            <div id="comparison-rows-container">
                                                @if(old('fees_comparison_rows'))
                                                    @foreach(old('fees_comparison_rows') as $index => $row)
                                                        <div class="comparison-row-item border rounded p-3 mb-3" data-index="{{ $index }}">
                                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                                <h6 class="mb-0">Row #<span class="row-number">{{ $index + 1 }}</span></h6>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-4 mb-3">
                                                                    ...
                                                                    <input type="text" class="form-control" name="fees_comparison_rows[{{ $index }}][feature]" value="{{ $row['feature'] ?? '' }}" placeholder="e.g., Objective">
                                                                </div>
                                                                <div class="col-md-4 mb-3">
                                                                    <label class="fw-bold d-block mb-1">Stock Audit</label>
                                                                    <input type="text" class="form-control" name="fees_comparison_rows[{{ $index }}][stock_audit]" value="{{ $row['stock_audit'] ?? '' }}" placeholder="e.g., Independent verification">
                                                                </div>
                                                                <div class="col-md-4 mb-3">
                                                                    <label class="fw-bold d-block mb-1">Internal Inventory Control</label>
                                                                    <input type="text" class="form-control" name="fees_comparison_rows[{{ $index }}][internal_control]" value="{{ $row['internal_control'] ?? '' }}" placeholder="e.g., Day-to-day management">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                @elseif($page->fees_comparison_rows && count($page->fees_comparison_rows) > 0)
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control @error('fees_comparison_note') is-invalid @enderror" 
                                                          ...
                                                          rows="2" 
                                                          placeholder="Please Note: With Patron Accounting, clients receive more than just compliance...">{{ old('fees_comparison_note', $page->fees_comparison_note ?? '') }}</textarea>
                                ...
                                <div class="card mt-4">
                                    ...
                                    <div class="card-body">
                                        <div class="form-check form-switch mb-3">
                                            <input class="form-check-input" type="checkbox" id="partner_services_enabled" name="partner_services_enabled" {{ old('partner_services_enabled', $page->partner_services_enabled) ? 'checked' : '' }}>
                                            <label class="form-check-label" for="partner_services_enabled">
                                                Enable Partner Services Section
                                            </label>
                                        </div>

                                        <div id="partner-services-content" style="display: {{ old('partner_services_enabled', $page->partner_services_enabled) ? 'block' : 'none' }};">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control @error('partner_services_title') is-invalid @enderror" 
                                                       ...
                                                       value="{{ old('partner_services_title', $page->partner_services_title ?? 'Patron Accounting: Your Stock Audit Partner in India') }}"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control @error('partner_services_description') is-invalid @enderror" 
                                                          ...
                                                          rows="3"
                                                          placeholder="Enter section description">{{ old('partner_services_description', $page->partner_services_description ?? 'Patron Accounting offers specialized stock audit services across India, leveraging years of experience in statutory, internal, and sector-specific audits. Our team provides:') }}</textarea>
                                            ...
                                            <div class="d-flex justify-content-between align-items-center mb-3">
                                                ...
                                                <button type="button" class="btn btn-primary btn-sm" id="add-partner-service-btn">
                                                    <i class="bi bi-plus-circle"></i> Add Partner Service
                                                </button>
                                            </div>

                                            <div id="partner-services-items-container">
                                                @php
                                                    $partnerServicesItems = old('partner_services_items', $page->partner_services_items ?? []);
                                                @endphp

                                                @if(!empty($partnerServicesItems) && is_array($partnerServicesItems))
                                                    @foreach($partnerServicesItems as $index => $item)
                                                    <div class="partner-service-item border rounded p-3 mb-3" data-index="{{ $index }}">
                                                        <div class="d-flex justify-content-between align-items-center mb-2">
                                                            <h6 class="mb-0">Partner Service #<span class="partner-service-number">{{ $index + 1 }}</span></h6>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12 mb-3">
                                                                <label class="fw-bold d-block mb-1">Icon Image</label>
                                                                <input type="file" class="form-control" name="partner_service_icon_{{ $index }}" accept="image/*" onchange="previewPartnerServiceImage(this, {{ $index }})">
                                                                <input type="hidden" name="partner_services_items[{{ $index }}][icon]" class="partner-service-icon-path" value="{{ $item['icon'] ?? '' }}">
                                                                <small class="text-muted">Upload a new icon image (leave empty to keep existing)</small>
                                                                
                                                                @if(!empty($item['icon']))
                                                                    <div class="mt-2 partner-service-existing-image">
                                                                        <p class="mb-1 small text-muted">Current Icon:</p>
                                                                        <img src="{{ asset('storage/' . $item['icon']) }}" alt="Current Icon" style="max-width: 100px; max-height: 100px;" class="img-thumbnail">
                                                                    </div>
                                                                @endif
                                                                
                                                                <div class="mt-2 partner-service-image-preview" id="partner_service_preview_container_{{ $index }}" style="display:none;">
                                                                    <p class="mb-1 small text-muted">New Icon Preview:</p>
                                                                    <img id="partner_service_preview_{{ $index }}" src="" alt="Preview" style="max-width: 100px; max-height: 100px;" class="img-thumbnail">
                                                                    <button type="button" class="btn btn-sm btn-danger ms-2" onclick="removePartnerServiceImage({{ $index }})">Remove New Image</button>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-12 mb-3">
                                                                <label class="fw-bold d-block mb-1">Service Title</label>
                                                                <input type="text" class="form-control" name="partner_services_items[{{ $index }}][title]" value="{{ old('partner_services_items.' . $index . '.title', $item['title'] ?? '') }}" placeholder="Enter service title">
                                                            </div>
                                                            <div class="col-12">
                                                                <label class="fw-bold d-block mb-1">Description</label>
                                                                <textarea class="form-control" name="partner_services_items[{{ $index }}][description]" rows="2" placeholder="Enter service description">{{ old('partner_services_items.' . $index . '.description', $item['description'] ?? '') }}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    @endforeach
                                        ...
                                        <div class="alert alert-info mt-3">
                                            <i class="bi bi-info-circle"></i> Add multiple partner service items. Each service will be displayed with icon, title, and description on the frontend.
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('partner_services_note') is-invalid @enderror" 
                                                      ...
                                                      rows="3"
                                                      placeholder="Enter important note about partner services...">{{ old('partner_services_note', $page->partner_services_note ?? 'With Patron Accounting, clients receive more than just compliance; they gain actionable insights to optimize inventory management, enhance profitability, and strengthen corporate governance.') }}</textarea>
                                ...
                                <div class="card mt-4">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" id="license_types_enabled" name="license_types_enabled" value="1" {{ old('license_types_enabled', $page->license_types_enabled ?? false) ? 'checked' : '' }}>
                                                <label class="form-check-label" for="license_types_enabled">
                                                    Enable License Types Table Section
                                                </label>
                                            </div>
                                        </div>
                                        <div id="license-types-content" style="display: {{ old('license_types_enabled', $page->license_types_enabled ?? false) ? 'block' : 'none' }};">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control @error('license_types_title') is-invalid @enderror" 
                                                       ...
                                                       value="{{ old('license_types_title', $page->license_types_title ?? 'Types of FSSAI Licenses') }}"
                                                       placeholder="Enter section title">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control @error('license_types_description') is-invalid @enderror" 
                                                          ...
                                                          rows="3"
                                                          placeholder="Enter section description...">{{ old('license_types_description', $page->license_types_description ?? '') }}</textarea>
                                            ...
                                            <div class="mb-3">
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                                    <label class="form-label mb-0">License Type Rows (Max 10)</label>
                                                ...
                                                <div id="license-types-items-container">
                                                    @if($page->license_types_rows && count($page->license_types_rows) > 0)
                                                        @foreach($page->license_types_rows as $index => $row)
                                ...
                                <div class="card mt-4">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" id="conclusion_enabled" name="conclusion_enabled" {{ old('conclusion_enabled', $page->conclusion_enabled) ? 'checked' : '' }}>
                                                <label class="form-check-label" for="conclusion_enabled">
                                                    Enable Conclusion Section
                                                </label>
                                            </div>
                                        </div>
                                        <div id="conclusion-content" style="display: {{ old('conclusion_enabled', $page->conclusion_enabled) ? 'block' : 'none' }};">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control @error('conclusion_title') is-invalid @enderror" 
                                                       ...
                                                       value="{{ old('conclusion_title', $page->conclusion_title ?? 'Conclusion') }}"
                                ...
                                <div class="card mt-4">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" id="partnership_enabled" name="partnership_enabled" {{ old('partnership_enabled', $page->partnership_enabled) ? 'checked' : '' }}>
                                                <label class="form-check-label" for="partnership_enabled">
                                                    Enable Partnership Section
                                                </label>
                                            </div>
                                        </div>
                                        <div id="partnership-content" style="display: {{ old('partnership_enabled', $page->partnership_enabled) ? 'block' : 'none' }};">
                                            <div class="mb-3">
                                                ...
                                                @if($page->partnership_image)
                                                    <div class="mt-2">
                                                        <img src="{{ asset('storage/' . $page->partnership_image) }}" alt="Current Image" class="img-thumbnail" style="max-width: 200px;">
                                                        <div class="form-check mt-2">
                                                            <input class="form-check-input" type="checkbox" id="remove_partnership_image" name="remove_partnership_image" value="1">
                                                            <label class="form-check-label" for="remove_partnership_image">
                                                                Remove current image
                                                            </label>
                                                        </div>
                                                    </div>
                                                @endif
                                                <small class="text-muted">Upload a new image or leave empty to keep existing</small>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control @error('partnership_title') is-invalid @enderror" 
                                                       ...
                                                       value="{{ old('partnership_title', $page->partnership_title ?? 'Your one-stop partner for Business Registration') }}"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control @error('partnership_services') is-invalid @enderror" 
                                                       ...
                                                       value="{{ old('partnership_services', $page->partnership_services ?? 'Accounting • Tax • Audit • Compliance') }}"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control @error('partnership_button_text') is-invalid @enderror" 
                                                       ...
                                                       value="{{ old('partnership_button_text', $page->partnership_button_text ?? 'Let\'s grow together!') }}"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control @error('partnership_content') is-invalid @enderror" 
                                                          ...
                                                          placeholder="Enter partnership content with rich text">{{ old('partnership_content', $page->partnership_content ?? '') }}</textarea>
                                ...
                                <div class="card mt-4">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" id="company_registration_enabled" name="company_registration_enabled" {{ old('company_registration_enabled', $page->company_registration_enabled) ? 'checked' : '' }}>
                                                <label class="form-check-label" for="company_registration_enabled">
                                                    Enable Company Registration Section
                                                </label>
                                            </div>
                                        </div>
                                        <div id="company-registration-content" style="display: {{ old('company_registration_enabled', $page->company_registration_enabled) ? 'block' : 'none' }};">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control @error('company_registration_title') is-invalid @enderror" 
                                                       ...
                                                       value="{{ old('company_registration_title', $page->company_registration_title ?? 'Company Registration Customised by States and Cities') }}"
                                                       placeholder="Enter section title">
                                            ...
                                            <div id="company-registration-items-container">
                                                @php
                                                    $companyRegItems = old('company_registration_items', $page->company_registration_items ?? []);
                                                @endphp

                                                @if(!empty($companyRegItems) && is_array($companyRegItems))
                                                    @foreach($companyRegItems as $index => $item)
                                                    <div class="company-registration-item border rounded p-3 mb-3" data-index="{{ $index }}">
                                                        <div class="d-flex justify-content-between align-items-center mb-2">
                                                            <h6 class="mb-0">Registration Item #<span class="company-registration-number">{{ $index + 1 }}</span></h6>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12 mb-3">
                                                                ...
                                                                <input type="text" class="form-control" name="company_registration_items[{{ $index }}][title]" value="{{ $item['title'] ?? '' }}" placeholder="e.g., Private Limited Company Registration in Assam">
                                                            </div>
                                                            <div class="col-12">
                                                                <label class="fw-bold d-block mb-1">Link (Optional)</label>
                                                                <input type="text" class="form-control" name="company_registration_items[{{ $index }}][link]" value="{{ $item['link'] ?? '' }}" placeholder="Enter URL (e.g., /company-registration-assam)">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    @endforeach
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control @error('company_registration_content') is-invalid @enderror" 
                                                          ...
                                                          placeholder="Write your content here... Use the editor toolbar above to format text, add images, tables, and more.">{{ old('company_registration_content', $page->company_registration_content ?? '') }}</textarea>
                                                <div class="form-text">Use the rich editor toolbar to format your content with text styling, links, images, tables, and more.</div>
                                ...
                                <div class="card mt-4">
                                    <div class="card-header">
                                        <h6 class="mb-0">Video Section</h6>
                                    </div>
                                    <div class="card-body">
                                        <div class="mb-3">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" id="video_enabled" name="video_enabled" value="1" {{ old('video_enabled', $page->video_enabled ?? false) ? 'checked' : '' }}>
                                                <label class="form-check-label" for="video_enabled">Enable Video Section</label>
                                            </div>
                                        </div>

                                        <div id="video-content" style="display: {{ old('video_enabled', $page->video_enabled ?? false) ? 'block' : 'none' }};">
                                            <div class="mb-3">
                                                ...
                                                <div class="mb-2 border rounded p-3">
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div>
                                                            <i class="bi bi-film"></i> Current Video: {{ basename($page->video_file) }}
                                                        </div>
                                                    ...
                                                    <video class="mt-2" width="100%" controls style="max-height: 300px;">
                                                        <source src="{{ asset('storage/' . $page->video_file) }}" type="video/{{ pathinfo($page->video_file, PATHINFO_EXTENSION) }}">
                                                ...
                                                <small class="form-text text-muted">Accepted formats: MP4, WebM, OGG (Max: 50MB)</small>
                                                @error('video_file')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                                ...
                                                <div id="video-preview-container" class="mt-3" style="display: none;">
                                                    ...
                                                    <video id="video-preview" width="100%" controls style="max-height: 300px;"></video>
                                                    <button type="button" class="btn btn-sm btn-danger mt-2" onclick="removeVideoFile()">Remove</button>
                                                </div>
                                            </div>

                                            <div class="alert alert-info">
                                                <i class="bi bi-info-circle"></i> Upload a video file to display before the FAQ section on your page.
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card mt-4" id="background-image-section" style="display: {{ $page->template === 'background-map' ? 'block' : 'none' }};">
                                    ...
                                    <div class="card-body">
                                        @if($page->hero_background_image)
                                            <div class="current-image mb-3 text-center">
                                                <img src="{{ asset('storage/' . $page->hero_background_image) }}" alt="Current image" 
                                ...
                                <div class="card mt-4" id="map-section" style="display: {{ $page->template === 'background-map' ? 'block' : 'none' }};">
                                    <div class="card-header" style="background-color: #17a2b8; color: white;">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <h6 class="mb-0"><i class="bi bi-geo-alt-fill"></i> Map Section</h6>
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" id="map_enabled" name="map_enabled" value="1" 
                                                       {{ old('map_enabled', $page->map_enabled) ? 'checked' : '' }}>
                                                <label class="form-check-label text-white" for="map_enabled">Enable</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-body" id="map-content" style="display: {{ old('map_enabled', $page->map_enabled) ? 'block' : 'none' }};">
                                        <div class="mb-3">
                                            <label for="map_title" class="form-label">Map Section Title</label>
                                            <input type="text" class="form-control" id="map_title" name="map_title" 
                                                   value="{{ old('map_title', $page->map_title) }}" placeholder="e.g., Find Us Here">
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" id="map_description" name="map_description" rows="2" 
                                                      placeholder="Optional description above the map">{{ old('map_description', $page->map_description) }}</textarea>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control" id="map_type" name="map_type" onchange="toggleMapOptions()">
                                                <option value="google" {{ old('map_type', $page->map_type) == 'google' ? 'selected' : '' }}>Google Maps</option>
                                                <option value="openstreetmap" {{ old('map_type', $page->map_type) == 'openstreetmap' ? 'selected' : '' }}>OpenStreetMap</option>
                                                <option value="iframe" {{ old('map_type', $page->map_type) == 'iframe' ? 'selected' : '' }}>Custom Iframe Embed</option>
                                            </select>
                                        </div>
                                        
                                        <!-- Coordinates Option (for Google & OpenStreetMap) -->
                                        <div id="coordinates-option" style="display: {{ old('map_type', $page->map_type) != 'iframe' ? 'block' : 'none' }};">
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="map_latitude" name="map_latitude" 
                                                           value="{{ old('map_latitude', $page->map_latitude) }}" placeholder="e.g., 19.0760">
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="map_longitude" name="map_longitude" 
                                                           value="{{ old('map_longitude', $page->map_longitude) }}" placeholder="e.g., 72.8777">
                                                </div>
                                            </div>
                                            
                                            <div class="mb-3">
                                                <label for="map_zoom_level" class="form-label">Zoom Level: <span id="zoom-value-edit">{{ $page->map_zoom_level ?? 15 }}</span></label>
                                                <input type="range" class="form-range" id="map_zoom_level" name="map_zoom_level" 
                                                       min="1" max="20" value="{{ old('map_zoom_level', $page->map_zoom_level ?? 15) }}" 
                                                       oninput="document.getElementById('zoom-value-edit').textContent = this.value">
                                                <div class="form-text">1 = World view, 20 = Street level</div>
                                            </div>
                                        </div>
                                        
                                        <!-- Iframe Option (for custom embeds) -->
                                        <div id="iframe-option" style="display: {{ old('map_type', $page->map_type) == 'iframe' ? 'block' : 'none' }};">
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control" id="map_embed_code" name="map_embed_code" rows="4" 
                                                          placeholder="Paste your map iframe embed code here">{{ old('map_embed_code', $page->map_embed_code) }}</textarea>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="map_marker_title" name="map_marker_title" 
                                                   value="{{ old('map_marker_title', $page->map_marker_title) }}" 
                                                   placeholder="e.g., Patron Accounting Office">
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" id="map_marker_description" name="map_marker_description" rows="3" 
                                                      placeholder="Address, contact info, or directions">{{ old('map_marker_description', $page->map_marker_description) }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card mt-4">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" 
                                                       id="faq_enabled" name="faq_enabled" value="1"
                                                       {{ old('faq_enabled', $page->faq_enabled ?? false) ? 'checked' : '' }}>
                                                <label class="form-check-label" for="faq_enabled">
                                                    Enable FAQ Section
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('faq_title') is-invalid @enderror" 
                                                   ...
                                                   value="{{ old('faq_title', $page->faq_title ?? 'Frequently Asked Questions') }}"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('faq_subtitle') is-invalid @enderror" 
                                                      id="faq_subtitle" name="faq_subtitle" rows="2"
                                                      placeholder="Have a look at the answers to the most asked questions...">{{ old('faq_subtitle', $page->faq_subtitle ?? '') }}</textarea>
                                            @error('faq_subtitle')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div id="faq-items-container">
                                            @php
                                                $faqs = old('faq_items', $page->faq_items ?? []);
                                                if(empty($faqs)) {
                                            ...
                                            <div class="faq-item border rounded p-3 mb-3" data-index="{{ $index }}">
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                                    <h6 class="mb-0">FAQ #<span class="faq-number">{{ $index + 1 }}</span></h6>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control @error('faqs.'.$index.'.question') is-invalid @enderror" 
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control @error('faqs.'.$index.'.answer') is-invalid @enderror" 
                                                              name="faq_items[{{ $index }}][answer]" rows="4"
                                        ...
                                        <div class="text-muted small">
                                            <i class="bi bi-info-circle"></i> 
                                            FAQ items will be displayed in an accordion format on the frontend.
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <!-- Include SEO Fields -->
                        @include('admin.seo._fields', ['page' => $page])
...
document.getElementById('map_enabled')?.addEventListener('change', function() {
    ...
    if (mapContent) {
        mapContent.style.display = this.checked ? 'block' : 'none';
    }
});

// Toggle map options between coordinates and iframe
...
function updateTemplatePreview() {
    ...
    // Show/hide background image and map sections for background-map template
    const backgroundImageSection = document.getElementById('background-image-section');
    const mapSection = document.getElementById('map-section');
    
    if (backgroundImageSection) {
        backgroundImageSection.style.display = selectedTemplate === 'background-map' ? 'block' : 'none';
    }
    
    if (mapSection) {
        mapSection.style.display = selectedTemplate === 'background-map' ? 'block' : 'none';
    }
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    initializeReportComponentHandlers();
    initializeProcedureStepHandlers();
...
function addServiceItem() {
    ...
    // Limit to 6 items
    if (items.length >= 6) {
        alert('Maximum 6 service items allowed.');
        return;
    }
    ...
    const serviceHtml = `
        <div class="service-item border rounded p-3 mb-3" data-index="${serviceIndex}">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h6 class="mb-0">Service #<span class="service-number">${serviceIndex + 1}</span></h6>
                <button type="button" class="btn btn-sm btn-outline-danger remove-service">
                    <i class="bi bi-trash"></i>
                </button>
            </div>
            ...
            <div class="mb-3">
                <label class="fw-bold d-block mb-1">Service Title *</label>
                <input type="text" class="form-control" 
                       name="services_items[${serviceIndex}][title]" 
                       placeholder="e.g., Opening & Closing Stock Verification">
            </div>
            ...
            <div class="mb-3">
                <label class="fw-bold d-block mb-1">Service Description *</label>
                <textarea class="form-control" 
                          name="services_items[${serviceIndex}][description]" rows="2"
            ...
            <div class="mb-3">
                ...
                <input type="file" class="form-control service-image-input" 
                       ...
                       accept="image/*">
                <input type="hidden" name="services_items[${serviceIndex}][image]" value="">
                <input type="hidden" name="services_items[${serviceIndex}][remove_image]" value="0" class="remove-image-flag">
                <small class="text-muted">Upload an image (PNG, JPG, SVG - Max 2MB)</small>
            </div>
        </div>
    `;
...
function updateServiceNumbers() {
    ...
    items.forEach((item, index) => {
        ...
        const imageInputs = item.querySelectorAll('input[name*="[image]"]');
        const removeImageInput = item.querySelector('.remove-image-flag');
        ...
        imageInputs.forEach(input => {
            if (input.type === 'hidden' && !input.classList.contains('remove-image-flag')) {
                input.name = `services_items[${index}][image]`;
            }
        });
        if (removeImageInput) {
            removeImageInput.name = `services_items[${index}][remove_image]`;
        }
        if (fileInput) {
    ...
    if (e.target.classList.contains('service-image-input')) {
        ...
        if (file) {
            ...
            reader.onload = function(event) {
                ...
                let previewContainer = serviceItem.querySelector('.service-image-preview')?.parentElement;
                
                if (!previewContainer) {
                    previewContainer = document.createElement('div');
                    previewContainer.className = 'mb-2';
                    previewContainer.innerHTML = `
                        <img class="img-thumbnail service-image-preview" style="max-height: 100px;">
                        <button type="button" class="btn btn-sm btn-outline-danger ms-2 remove-service-image" data-index="${index}">
                            <i class="bi bi-trash"></i> Remove Image
                        </button>
                    `;
                    e.target.parentElement.insertBefore(previewContainer, e.target);
                }
                
                const preview = previewContainer.querySelector('.service-image-preview');
...
// Handle service image removal
document.addEventListener('click', function(e) {
    if (e.target.closest('.remove-service-image')) {
        const button = e.target.closest('.remove-service-image');
        const serviceItem = button.closest('.service-item');
        const previewContainer = button.parentElement;
        const removeFlag = serviceItem.querySelector('.remove-image-flag');
        const hiddenImageInput = serviceItem.querySelector('input[type="hidden"][name*="[image]"]:not(.remove-image-flag)');
...
let reportComponentIndex = document.querySelectorAll('.report-component-item').length;

function initializeReportComponentHandlers() {
    // Add Report Component button
    const addBtn = document.getElementById('add-report-component');
    if (addBtn) {
        addBtn.addEventListener('click', addReportComponentItem);
    }
    
    // Remove Report Component buttons
    document.addEventListener('click', function(e) {
        if (e.target.closest('.remove-report-component')) {
            removeReportComponentItem(e.target.closest('.report-component-item'));
        }
    });
...
function addReportComponentItem() {
    const container = document.getElementById('report-components-container');
    const items = container.querySelectorAll('.report-component-item');
    
    // Limit to 6 items
    if (items.length >= 6) {
        alert('Maximum 6 report component items allowed.');
        return;
    }
    
    const componentHtml = `
        <div class="report-component-item border rounded p-3 mb-3" data-index="${reportComponentIndex}">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h6 class="mb-0">Report Component #<span class="report-component-number">${reportComponentIndex + 1}</span></h6>
                <button type="button" class="btn btn-danger btn-sm remove-report-component">
                    <i class="bi bi-trash"></i> Remove
                </button>
            </div>
            <div class="row">
                <div class="col-md-6 mb-3">
                    <label class="fw-bold d-block mb-1">Component Title</label>
                    <input type="text" class="form-control" 
                           name="report_components_items[${reportComponentIndex}][title]" 
                           placeholder="e.g., Executive Summary">
                </div>
                <div class="col-md-6 mb-3">
                    <label class="fw-bold d-block mb-1">Component Image</label>
                    <input type="file" class="form-control report-component-image-input" 
                           data-index="${reportComponentIndex}" 
                           accept="image/*">
                    <input type="hidden" name="report_components_items[${reportComponentIndex}][image]" value="">
                    <input type="hidden" name="report_components_items[${reportComponentIndex}][remove_image]" value="0" class="remove-report-component-image-flag">
                    <small class="text-muted">Upload an image (PNG, JPG, SVG - Max 2MB)</small>
                </div>
                <div class="col-12">
                    <label class="fw-bold d-block mb-1">Component Description</label>
                    <textarea class="form-control" 
                              name="report_components_items[${reportComponentIndex}][description]" 
                              rows="3"></textarea>
                </div>
            </div>
        </div>
...
function removeReportComponentItem(componentItem) {
    componentItem.remove();
    updateReportComponentNumbers();
}

function updateReportComponentNumbers() {
    const items = document.querySelectorAll('.report-component-item');
    items.forEach((item, index) => {
        item.dataset.index = index;
        ...
        const descriptionTextarea = item.querySelector('textarea[name*="[description]"]');
        const imageInputs = item.querySelectorAll('input[name*="[image]"]');
        const removeImageInput = item.querySelector('.remove-report-component-image-flag');
        ...
        imageInputs.forEach(input => {
            if (input.type === 'hidden' && !input.classList.contains('remove-report-component-image-flag')) {
                input.name = `report_components_items[${index}][image]`;
            }
        });
        if (removeImageInput) {
            removeImageInput.name = `report_components_items[${index}][remove_image]`;
        }
        if (fileInput) {
            fileInput.setAttribute('data-index', index);
        }
    ...
    reportComponentIndex = items.length;
}
    ...
    if (e.target.classList.contains('report-component-image-input')) {
        ...
        if (file) {
            ...
            reader.onload = function(event) {
                ...
                let previewContainer = componentItem.querySelector('.report-component-image-preview')?.parentElement;
                
                if (!previewContainer) {
                    previewContainer = document.createElement('div');
                    previewContainer.className = 'mb-2';
                    previewContainer.innerHTML = `
                        <img class="img-thumbnail report-component-image-preview" style="max-height: 100px;">
                        <button type="button" class="btn btn-sm btn-danger remove-report-component-image" data-index="${index}">
                            <i class="bi bi-x"></i> Remove Image
                        </button>
                    `;
                ...
                const preview = previewContainer.querySelector('.report-component-image-preview');
                preview.src = event.target.result;
            };
            reader.readAsDataURL(file);
        }
...
// Handle report component image removal
document.addEventListener('click', function(e) {
    if (e.target.closest('.remove-report-component-image')) {
        const button = e.target.closest('.remove-report-component-image');
        const componentItem = button.closest('.report-component-item');
        const previewContainer = button.parentElement;
        const removeFlag = componentItem.querySelector('.remove-report-component-image-flag');
        const hiddenImageInput = componentItem.querySelector('input[type="hidden"][name*="[image]"]:not(.remove-report-component-image-flag)');
...
let procedureStepIndex = document.querySelectorAll('.procedure-step-item').length;

function initializeProcedureStepHandlers() {
    // Add Procedure Step button
    const addBtn = document.getElementById('add-procedure-step');
    if (addBtn) {
        addBtn.addEventListener('click', addProcedureStepItem);
    }
    
    // Remove Procedure Step buttons
    document.addEventListener('click', function(e) {
        if (e.target.closest('.remove-procedure-step')) {
            removeProcedureStepItem(e.target.closest('.procedure-step-item'));
        }
    });
...
function addProcedureStepItem() {
    ...
    const stepHtml = `
        <div class="procedure-step-item border rounded p-3 mb-3" data-index="${procedureStepIndex}">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h6 class="mb-0">Procedure Step #<span class="procedure-step-number">${procedureStepIndex + 1}</span></h6>
                <button type="button" class="btn btn-danger btn-sm remove-procedure-step">
                    <i class="bi bi-trash"></i> Remove
                </button>
            </div>
            <div class="row">
                <div class="col-md-6 mb-3">
                    <label class="fw-bold d-block mb-1">Step Number</label>
                    <input type="text" class="form-control" 
                           name="procedure_steps_items[${procedureStepIndex}][step_number]" 
                           value="STEP ${procedureStepIndex + 1}" 
                           placeholder="e.g., STEP ${procedureStepIndex + 1}">
                </div>
                <div class="col-md-6 mb-3">
                    <label class="fw-bold d-block mb-1">Alignment</label>
                    <select class="form-control" name="procedure_steps_items[${procedureStepIndex}][alignment]">
                        <option value="left" ${procedureStepIndex % 2 == 0 ? 'selected' : ''}>Left (Content Left, Image Right)</option>
                        <option value="right" ${procedureStepIndex % 2 != 0 ? 'selected' : ''}>Right (Image Left, Content Right)</option>
                    </select>
                </div>
                <div class="col-12 mb-3">
                    <label class="fw-bold d-block mb-1">Step Title</label>
                    <input type="text" class="form-control" 
                           name="procedure_steps_items[${procedureStepIndex}][title]" 
                           placeholder="e.g., Audit Planning">
                </div>
                <div class="col-12 mb-3">
                    <label class="fw-bold d-block mb-1">Step Description</label>
                    <textarea class="form-control" 
                              name="procedure_steps_items[${procedureStepIndex}][description]" 
                              rows="3" 
                ...
                <div class="col-12">
                    <label class="fw-bold d-block mb-1">Step Image</label>
                    <input type="file" class="form-control procedure-step-image-input" 
                           data-index="${procedureStepIndex}" 
                           accept="image/*">
                    <input type="hidden" name="procedure_steps_items[${procedureStepIndex}][image]" value="">
                    <input type="hidden" name="procedure_steps_items[${procedureStepIndex}][remove_image]" value="0" class="remove-procedure-step-image-flag">
                    <small class="text-muted">Upload an image (PNG, JPG, SVG - Max 2MB)</small>
                </div>
            </div>
        </div>
...
function removeProcedureStepItem(stepItem) {
    stepItem.remove();
    updateProcedureStepNumbers();
}
...
function updateProcedureStepNumbers() {
    ...
    items.forEach((item, index) => {
        ...
        const imageInputs = item.querySelectorAll('input[name*="[image]"]');
        const removeImageInput = item.querySelector('.remove-procedure-step-image-flag');
        ...
        if (stepNumberInput) {
            ...
            // Auto-update step number if it follows the default pattern
            if (!stepNumberInput.value || stepNumberInput.value.match(/^STEP \d+$/)) {
                stepNumberInput.value = `STEP ${index + 1}`;
            }
        }
        if (titleInput) {
            titleInput.name = `procedure_steps_items[${index}][title]`;
        }
        if (descriptionTextarea) {
            descriptionTextarea.name = `procedure_steps_items[${index}][description]`;
        }
        if (alignmentSelect) {
            alignmentSelect.name = `procedure_steps_items[${index}][alignment]`;
        }
        imageInputs.forEach(input => {
            if (input.type === 'hidden' && !input.classList.contains('remove-procedure-step-image-flag')) {
                input.name = `procedure_steps_items[${index}][image]`;
            }
        });
        if (removeImageInput) {
            removeImageInput.name = `procedure_steps_items[${index}][remove_image]`;
        }
        if (fileInput) {
            fileInput.setAttribute('data-index', index);
        }
    ...
    procedureStepIndex = items.length;
}
    ...
    if (e.target.classList.contains('procedure-step-image-input')) {
        ...
        if (file) {
            ...
            reader.onload = function(event) {
                ...
                let previewContainer = stepItem.querySelector('.procedure-step-image-preview')?.parentElement;
                
                if (!previewContainer) {
                    previewContainer = document.createElement('div');
                    previewContainer.className = 'mb-2';
                    previewContainer.innerHTML = `
                        <img class="img-thumbnail procedure-step-image-preview" style="max-height: 100px;">
                        <button type="button" class="btn btn-sm btn-danger remove-procedure-step-image" data-index="${index}">
                            <i class="bi bi-x"></i> Remove Image
                        </button>
                    `;
                ...
                const preview = previewContainer.querySelector('.procedure-step-image-preview');
                preview.src = event.target.result;
            };
            reader.readAsDataURL(file);
        }
...
// Handle procedure step image removal
document.addEventListener('click', function(e) {
    if (e.target.closest('.remove-procedure-step-image')) {
        const button = e.target.closest('.remove-procedure-step-image');
        const stepItem = button.closest('.procedure-step-item');
        const previewContainer = button.parentElement;
        const removeFlag = stepItem.querySelector('.remove-procedure-step-image-flag');
        const hiddenImageInput = stepItem.querySelector('input[type="hidden"][name*="[image]"]:not(.remove-procedure-step-image-flag)');
...
let heroBenefitCount = document.querySelectorAll('.hero-benefit-item').length;
...
function addLicenseTypeRow() {
    ...
    if (items.length >= 10) {
        alert('Maximum 10 license types allowed');
        return;
    }
    ...
    const itemHtml = `
        <div class="license-type-item border rounded p-3 mb-3" data-index="${newIndex}">
            ...
            <div class="row">
                <div class="col-md-12 mb-3">
                    <label class="fw-bold d-block mb-1">License Type <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" name="license_types_rows[${newIndex}][license_type]" placeholder="e.g., Basic FSSAI Registration" required>
                </div>
                <div class="col-md-6 mb-3">
                    <label class="fw-bold d-block mb-1">Business Scale <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" name="license_types_rows[${newIndex}][business_scale]" placeholder="e.g., Turnover up to ₹12 Lakhs" required>
                </div>
                <div class="col-md-6 mb-3">
                    <label class="fw-bold d-block mb-1">Jurisdiction <span class="text-danger">*</span></label>
                    <textarea class="form-control" name="license_types_rows[${newIndex}][jurisdiction]" rows="2" placeholder="e.g., Within State" required></textarea>
                </div>
                <div class="col-md-6 mb-3">
                    <label class="fw-bold d-block mb-1">Validity <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" name="license_types_rows[${newIndex}][validity]" placeholder="e.g., 1-2 years" required>
                </div>
                <div class="col-md-6 mb-3">
                    <label class="fw-bold d-block mb-1">Suitable For <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" name="license_types_rows[${newIndex}][suitable_for]" placeholder="e.g., Small food businesses" required>
                </div>
            </div>
        </div>
    `;
...
function removeLicenseTypeRow(button) {
    const licenseTypeItem = button.closest('.license-type-item');
    licenseTypeItem.remove();
    updateLicenseTypeNumbers();
}
...
function updateLicenseTypeNumbers() {
    ...
    items.forEach((item, index) => {
        ...
        const suitableForInput = item.querySelector('input[name*="[suitable_for]"]');
        ...
        if (suitableForInput) suitableForInput.name = `license_types_rows[${index}][suitable_for]`;
    });
}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // License Types Table Section Event Listeners
...
function initializeFAQHandlers() {
    ...
    document.addEventListener('click', function(e) {
        if (e.target.closest('.remove-faq')) {
            removeFAQItem(e.target.closest('.faq-item'));
        }
    });
    ...
    const faqHtml = `
        <div class="faq-item border rounded p-3 mb-3" data-index="${faqIndex}">
            ...
            <div class="mb-3">
                <label class="fw-bold d-block mb-1">Answer *</label>
                <textarea class="form-control" 
                          name="faq_items[${faqIndex}][answer]" rows="4"
...
function updateFAQNumbers() {
    document.querySelectorAll('.faq-item').forEach((item, index) => {
        ...
        inputs.forEach(input => {
            const name = input.getAttribute('name');
            if (name) {
                const newName = name.replace(/faq_items\[\d+\]/, `faq_items[${index}]`);
                input.setAttribute('name', newName);
            }
        });
    });
...
document.getElementById('video_enabled').addEventListener('change', function() {
    document.getElementById('video-content').style.display = this.checked ? 'block' : 'none';
});
