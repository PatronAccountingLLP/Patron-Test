                            ...
                            <div class="card-body">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('trending_badge') is-invalid @enderror" 
                                                   id="trending_badge" name="trending_badge" value="{{ old('trending_badge') }}"
                                                            ...
                                                            <div class="faq-item border rounded p-3 mb-3" data-index="{{ $index }}">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-12 mb-2">
                                                                        ...
                                                                        <input type="text" class="form-control" name="faq_items[{{ $index }}][question]" value="{{ $faq_item['question'] ?? '' }}" required>
                                                                    </div>
                                                                    <div class="col-12">
                                                                        <label class="form-label">Answer</label>
                                                                        <textarea class="form-control" name="faq_items[{{ $index }}][answer]" rows="3" required>{{ $faq_item['answer'] ?? '' }}</textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        @endforeach
                                                    @else
                                                        ...
                                                        <div class="faq-item border rounded p-3 mb-3" data-index="0">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-12 mb-2">
                                                                    <label class="form-label">Question</label>
                                                                    <input type="text" class="form-control" name="faq_items[0][question]" placeholder="Enter your question here..." required>
                                                                </div>
                                                                <div class="col-12">
                                                                    <label class="form-label">Answer</label>
                                                                    <textarea class="form-control" name="faq_items[0][answer]" rows="3" placeholder="Enter the answer here..." required></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @endif
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('key_points') is-invalid @enderror" 
                                              id="key_points" name="key_points" rows="15">{{ old('key_points') }}</textarea>
                                    @error('key_points')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                                    <div class="form-text">Use the rich text editor above to format your content with headings, links, images, and more.</div>
                            ...
                            <div class="card-body" id="seo-content">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('meta_description') is-invalid @enderror" 
                                              ...
                                              maxlength="160" placeholder="SEO description (120-160 chars)">{{ old('meta_description') }}</textarea>
                                    <div class="form-text">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="url" class="form-control @error('seo_canonical_url') is-invalid @enderror" 
                                           id="seo_canonical_url" name="seo_canonical_url" value="{{ old('seo_canonical_url') }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('seo_header_scripts') is-invalid @enderror" 
                                              ...
                                              placeholder="<script>// Custom header scripts</script>">{{ old('seo_header_scripts') }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('seo_footer_scripts') is-invalid @enderror" 
                                              ...
                                              placeholder="<script>// Custom footer scripts</script>">{{ old('seo_footer_scripts') }}</textarea>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mt-3">
                                    ...
                                    <div id="selected-user" class="d-flex flex-wrap gap-1">
                                        <!-- Selected user will be displayed here as badge -->
                                    </div>
                                    <div id="no-user-selected" class="text-muted">
...
// Handle radio button changes to update selected user display
document.addEventListener('change', function(e) {
    if (e.target.type === 'radio' && e.target.name === 'user_id') {
...
function updateSelectedUserDisplay() {
    ...
    if (!selectedRadio) {
        ...
        badge.innerHTML = `${userName} <i class="bi bi-x ms-1" style="cursor: pointer;" onclick="removeUser(${userId})"></i>`;
...
function removeUser(userId) {
    const radio = document.querySelector('input[value="' + userId + '"]');
    if (radio) {
        radio.checked = false;
        updateSelectedUserDisplay();
    }
...
let faqItemIndex = {{ old('faq_items') ? count(old('faq_items')) : 1 }};
...
function addFAQItem() {
    ...
    newItem.innerHTML = `
        ...
        <div class="row">
            <div class="col-12 mb-2">
                <label class="form-label">Question</label>
                <input type="text" class="form-control" name="faq_items[${faqItemIndex}][question]" placeholder="Enter your question here..." required>
            </div>
            <div class="col-12">
                <label class="form-label">Answer</label>
                <textarea class="form-control" name="faq_items[${faqItemIndex}][answer]" rows="3" placeholder="Enter the answer here..." required></textarea>
            </div>
        </div>
    `;
...
ClassicEditor
    ...
    .then(editor => {
        ...
        editor.model.document.on('change:data', () => {
            ...
            if (keyPoints.trim() !== '') {
                ...
                const ckEditor = field.closest('.mb-3')?.querySelector('.ck-editor');
                if (ckEditor) {
                    ckEditor.style.border = '';
                    ckEditor.style.borderRadius = '';
                }
    ...
    .catch(error => {
        console.error('Key Points CKEditor initialization error:', error);
    });
...
document.querySelector('form').addEventListener('submit', function(e) {
    if (contentEditor) {
        ...
        // Only validate content if "Publish" button was clicked (not "Save Draft")
        if (actionValue === 'publish') {
            ...
            if (!content || content.trim() === '' || content.trim() === '<p>&nbsp;</p>' || content.trim() === '<p></p>') {
                ...
                // Show alert
                alert('⚠️ Content is required when publishing a post.\n\nPlease add content to your post before publishing, or save it as a draft instead.');
...
// Initial trigger to set counters on page load
