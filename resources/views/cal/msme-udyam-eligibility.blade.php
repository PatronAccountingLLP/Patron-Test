...
@section('meta')
    ...
    <link rel="canonical" href="https://www.patronaccounting.com/tools/msme-udyam-eligibility">
...
<div class="callout" style="background:linear-gradient(135deg,#EFF6FF,#F0F7FF);border-left-color:var(--primary);margin:0 0 32px;"><p style="color:var(--primary-dark);font-size:15px;"><strong>Need MSME registration help?</strong> Our CAs handle Udyam Registration, MSME loans, and compliance for businesses across India. <a href="https://wa.me/919459456700?text=Hello%2C%20I%20just%20visited%20your%20MSME%20Udyam%20Eligibility%20page.%20I%20would%20like%20to%20know%20more%20about%20it." target="_blank" rel="noopener" style="color:var(--primary);font-weight:700;">Talk to a CA today &rarr;</a></p></div>

<section class="content-section" id="faqs"><h2>Frequently Asked Questions</h2><div id="faqList"></div></section>
</div>
<aside class="sidebar-col">
    <div class="cta-card"><h3>Need MSME Help?</h3><p>Our CAs handle Udyam Registration, MSME loans &amp; compliance.</p><a href="https://wa.me/919459456700?text=Hello%2C%20I%20just%20visited%20your%20MSME%20Udyam%20Eligibility%20page.%20I%20would%20like%20to%20know%20more%20about%20it." target="_blank" rel="noopener" class="cta-btn">Get Expert Help &rarr;</a></div>
    <div class="sidebar-card"><h3>Services</h3><a href="https://www.patronaccounting.com/udyam-registration" class="sidebar-link">Udyam Registration <span class="arrow">&rarr;</span></a><a href="https://www.patronaccounting.com/startup-registration" class="sidebar-link">Startup Registration <span class="arrow">&rarr;</span></a><a href="https://www.patronaccounting.com/gst-registration" class="sidebar-link">GST Registration <span class="arrow">&rarr;</span></a><a href="https://www.patronaccounting.com/private-limited-company-registration" class="sidebar-link">Pvt Ltd Registration <span class="arrow">&rarr;</span></a></div>
    <div class="sidebar-card"><h3>Related Tools</h3><a href="https://www.patronaccounting.com/tools/company-registration-cost-calculator" class="sidebar-link">Registration Cost Calculator <span class="arrow">&rarr;</span></a><a href="https://www.patronaccounting.com/tools/business-structure-comparison" class="sidebar-link">Structure Comparison <span class="arrow">&rarr;</span></a><a href="https://www.patronaccounting.com/tools/startup-india-eligibility" class="sidebar-link">Startup India Eligibility <span class="arrow">&rarr;</span></a><a href="https://www.patronaccounting.com/tools/gst-calculator" class="sidebar-link">GST Calculator <span class="arrow">&rarr;</span></a></div>
