...
<p>Once the settlement is reconciled, the second object is the stock. Goods in a seller&#x27;s own godown, in a marketplace fulfilment centre and with a courier as undelivered returns are three balances that must agree before a close holds. A provision is carried for what will come back, and the operator&#x27;s collected tax is claimed rather than left to lapse. E-commerce accounting services in Mumbai keep the settlement ledger and the stock record tied to one dated position each month, which is what makes the reported margin per product believable.</p>
                ...
                <div class="highlight-box" style="margin-top:20px;">
                    ...
                    <div class="key-terms"><ul class="al-list"><li><span class="al-t"><a href="/glossary/maharashtra-stamp-act-provisions">Maharashtra Stamp Act Provisions</a></span><span class="al-d">State stamp duty rules governing agreements, invoices and instruments executed within Maharashtra.</span></li><li><span class="al-t"><a href="/glossary/marketplace-settlement-reconciliation">Marketplace Settlement Reconciliation</a></span><span class="al-d">Matching a platform&#x27;s payout against its commission, shipping and return deductions line by line.</span></li><li><span class="al-t"><a href="/glossary/section-52-tcs-under-gst">Section 52 TCS under GST</a></span><span class="al-d">Tax the marketplace collects on your sales, claimable back through your own returns.</span></li><li><span class="al-t"><a href="/glossary/return-to-origin-rto-provisions">Return to Origin (RTO) Provisions</a></span><span class="al-d">A provision for goods dispatched but refused or undelivered, later returned to you.</span></li></ul></div>
