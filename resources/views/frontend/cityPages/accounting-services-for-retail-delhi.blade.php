        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'accounting-services-for-retail/delhi',
                    'options'  => [
                        'accounting-services-for-retail/delhi' => 'Retail Sector Accounting in Delhi',
                        ...
                        'accounting-services-for-e-commerce-industry/delhi' => 'E-commerce Accounting in Delhi',
                        'other' => 'Other',
                    ],
                ])
            </div>
