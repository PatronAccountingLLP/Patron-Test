...
@section('meta')
    ...
    <meta property="og:image" content="/images/accounting-services-for-trading-wholesale-retail-pune-og.webp">
    ...
    <meta name="twitter:image" content="/images/accounting-services-for-trading-wholesale-retail-pune-og.webp">
@endsection
  ...
  "@graph": [
    {
      ...
      "url": "/accounting-services-for-trading-industry/pune",
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - Trading Accounting in Pune'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="accounting-services-for-trading-wholesale-retail/pune" selected>Trading Accounting in Pune</option><option value="accounting-services/pune">Accounting Services in Pune</option><option value="gst-registration/pune">GST Registration in Pune</option><option value="gst-return-filing/pune">GST Return Filing in Pune</option><option value="income-tax-return/pune">Income Tax Return in Pune</option><option value="payroll-services/pune">Payroll Services in Pune</option><option value="startup-registration/pune">Startup Registration in Pune</option><option value="other">Other</option>
        ...
        <div class="reviews-cta" style="margin-top: 16px; display: flex !important;">
            <div class="reviews-cta-content">
                ...
                <div class="reviews-cta-text">
                    ...
                    <p>Get CA-managed trading accounting, GST compliance, and stock audit for your Pune wholesale or retail business.</p>
                </div>
            </div>
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    ...
                    @include('partials.faq-enquiry-form', ['enquiryLocation' => 'Pune', 'enquiryService' => 'Trading Accounting in Pune'])
                </aside>
