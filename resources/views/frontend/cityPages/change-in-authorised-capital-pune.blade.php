...
@section('meta')
    ...
    <meta property="og:image" content="/images/change-in-authorised-capital/pune-og.webp">
    ...
    <meta name="twitter:image" content="/images/change-in-authorised-capital/pune-og.webp">
@endsection
  ...
  "@graph": [
    {
      ...
      "url": "/change-in-authorised-capital/pune",
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - Change in Authorised Capital in Pune'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="change-in-authorised-capital/pune" selected>Capital Change in Pune</option><option value="private-limited-company-registration-in-india/pune">Pvt Ltd Registration in Pune</option><option value="annual-roc-filing/pune">Annual ROC Filing in Pune</option><option value="roc-notice/pune">ROC Notice in Pune</option><option value="gst-returns/pune">GST Returns in Pune</option><option value="startup-registration/pune">Startup Registration in Pune</option><option value="income-tax-return">Income Tax Return Filing</option><option value="other">Other</option>
