...
@section('meta')
    ...
    <meta property="og:image" content="/images/change-in-registered-office/mumbai-og.webp">
    ...
    <meta name="twitter:image" content="/images/change-in-registered-office/mumbai-og.webp">
@endsection
  ...
  "@graph": [
    {
      ...
      "url": "/change-in-registered-office/mumbai",
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - Change in Registered Office'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="change-in-registered-office/mumbai" selected>Change in Registered Office in Mumbai</option>
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    ...
                    @include('partials.faq-enquiry-form', ['enquiryLocation' => 'Mumbai', 'enquiryService' => 'Change in Registered Office in Mumbai'])
                </aside>
