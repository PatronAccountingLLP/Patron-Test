...
@section('meta')
    ...
    <meta property="og:image" content="/images/company-registration-in-uae/delhi-og.webp">
    ...
    <meta name="twitter:image" content="/images/company-registration-in-uae/delhi-og.webp">
@endsection
  ...
  "@graph": [
    {
      ...
      "url": "/company-registration-in-uae/delhi",
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - UAE Company Registration in Delhi'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="company-registration-in-uae/delhi" selected>UAE Company Registration in Delhi</option><option value="import-export-code/delhi">Import Export Code in Delhi</option><option value="accounting-services/delhi">Accounting Services in Delhi</option><option value="gst-registration/delhi">GST Registration in Delhi</option><option value="statutory-audit/delhi">Statutory Audit in Delhi</option><option value="income-tax-return/delhi">Income Tax Return in Delhi</option><option value="other">Other</option>
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    ...
                    @include('partials.faq-enquiry-form', ['enquiryLocation' => 'Delhi', 'enquiryService' => 'UAE Company Registration from Delhi'])
                </aside>
