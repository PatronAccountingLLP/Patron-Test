...
@section('meta')
    ...
    <meta property="og:image" content="/images/copyright-registration-for-artistic-work-gurugram-og.webp">
    ...
    <meta name="twitter:image" content="/images/copyright-registration-for-artistic-work-gurugram-og.webp">
@endsection
  ...
  "@graph": [
    {
      ...
      "url": "/copyright-registration-for-artistic-work/gurugram",
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-4 private-registration-heading">
                        Copyright for Artistic Work in Gurugram: Photographs, Logos, Designs, and Architecture
                    </h1>
                    ...
                    <div class="mb-4">
                        <div class="d-flex align-items-start mb-3">
                            ...
                            <p class="mb-0 text-dark benefit-paragraph"><span>Documents:</span> Copy of artistic work (JPG/PDF), author identity proof, NOC (if applicant is not author), NOC from persons in photographs</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Fees:</span> Rs 500 per work (individuals) | Rs 2,000 per work (companies). Professional: Rs 3,000-8,000</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Eligibility:</span> Creator of any original painting, photograph, drawing, sculpture, logo, architectural design, or graphic design</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="mailto:sales@patronaccounting.com?subject=Enquiry%20for%20Artistic%20Work%20Copyright%20in%20Gurugram&body=Hello%20Patron%20Accounting%20Team%2C%0A%0AI%20am%20interested%20in%20your%20Artistic%20Work%20Copyright%20services%20in%20Gurugram%20and%20would%20like%20to%20know%20more.%0A%0APlease%20get%20in%20touch%20with%20me%20at%20your%20earliest%20convenience.%0A%0AThank%20you." class="btn-sample text-decoration-none">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:18px;height:18px;"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,12 2,6"/></svg>
                            Email Us
                        </a>
                        <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20help%20with%20Artistic%20Work%20Copyright%20in%20Gurugram.%20Please%20share%20details." target="_blank" class="btn-sample text-decoration-none">
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - Artistic Work Copyright Gurugram'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="copyright-registration-for-artistic-work/gurugram" selected>Copyright for Artistic Work in Gurugram</option>
...
<section class="testimonials-section">
    <div class="section-container">
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            ...
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Patron handled copyright registration for our entire product photography portfolio - over 200 images. Their batch filing strategy saved us significant fees and their Section 15 advisory protected our packaging designs. Extremely thorough.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div>
                    ...
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Founder, Sohna Road D2C Brand</div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Our branding agency needed copyright for 50+ logo designs and marketing graphics. Patron identified which works needed Design Act registration too - the Section 15 advisory alone saved us from losing copyright on our packaging designs.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                <div style="width:36px;height:36px;border-radius:50%;background:var(--blue);display:flex;align-items:center;justify-content:center;font-weight:700;font-size:13px;color:#fff;flex-shrink:0;">DV</div>
                <div>
                    <div style="font-weight:700;font-size:13px;color:var(--blue);">Deepak Verma</div>
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Creative Director, Golf Course Road Design Agency</div>
                    <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                </div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">As a commercial photographer, I needed copyright protection for my highest-value product images. Patron helped me prioritize which photographs to register first and drafted assignment deeds for all my client work. Essential service.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                <div style="width:36px;height:36px;border-radius:50%;background:#10B981;display:flex;align-items:center;justify-content:center;font-weight:700;font-size:13px;color:#fff;flex-shrink:0;">KR</div>
                <div>
                    <div style="font-weight:700;font-size:13px;color:var(--blue);">Kavita Rao</div>
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Commercial Photographer, Gurugram</div>
                    <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                </div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Patron registered copyright for our architectural designs - building elevations, floor plans, and interior schemes. The team understood the nuances of Section 2(c)(ii) architectural copyright and helped protect our unique designs.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                <div style="width:36px;height:36px;border-radius:50%;background:#6366F1;display:flex;align-items:center;justify-content:center;font-weight:700;font-size:13px;color:#fff;flex-shrink:0;">AA</div>
                <div>
                    <div style="font-weight:700;font-size:13px;color:var(--blue);">Amit Arora</div>
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Principal Architect, Gurugram Designs</div>
                    <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                </div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Patron provided the dual copyright-plus-trademark protection for our company logo. The team clearly explained the difference and why both were needed. Their logo protection strategy is comprehensive and well-executed.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div>
                    <div style="font-weight:700;font-size:13px;color:var(--blue);">Meera Joshi</div>
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Brand Manager, NCR FMCG Company</div>
                    <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                </div>
        ...
        <div class="reviews-cta" style="margin-top: 16px; display: flex !important;">
            <div class="reviews-cta-content">
                ...
                <div class="reviews-cta-text">
                    ...
                    <p>Trusted artistic work copyright partner for photographers, designers, and brands in Gurugram.</p>
                </div>
            </div>
...
<div class="stats-bar">
    <div class="stats-container">
        <div class="stat-item">
            ...
            <div class="stat-content"><span class="stat-value">10,000+</span><span class="stat-label">Businesses Served</span><span class="stat-desc">Artistic work and design IP protection across India.</span></div>
        </div>
        <div class="stat-item">
            <div class="stat-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8M12 17v4"/></svg></div>
            <div class="stat-content"><span class="stat-value">15+</span><span class="stat-label">Years Experience</span><span class="stat-desc">Deep expertise in artistic work copyright and design IP.</span></div>
        </div>
        <div class="stat-item">
            <div class="stat-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><path d="M14 2v6h6M16 13H8M16 17H8"/></svg></div>
            <div class="stat-content"><span class="stat-value">50,000+</span><span class="stat-label">Documents Filed</span><span class="stat-desc">Artistic work registrations, design filings, and IP documents handled.</span></div>
        </div>
        <div class="stat-item">
            <div class="stat-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="8" r="7"/><path d="M8.21 13.89L7 23l5-3 5 3-1.21-9.12"/></svg></div>
            <div class="stat-content"><span class="stat-value">4.9&#9733;</span><span class="stat-label">Client Rating</span><span class="stat-desc">Trusted by photographers, designers, architects, and creative businesses.</span></div>
        </div>
...
<section class="content-section" id="overview-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Why Artistic Work Copyright Is Critical for Gurugram's Visual Economy</h2>
            <div class="content-text">
                <div class="highlight-box" style="margin-bottom:20px;">
                    <p><strong>&#128204; TL;DR - Artistic Work Copyright Services at a Glance</strong></p>
                    <p>Artistic work under Section 2(c) of the Copyright Act 1957 includes paintings, sculptures, drawings (including diagrams, maps, charts, plans), engravings, photographs, works of architecture, and works of artistic craftsmanship (logos, packaging designs, graphic elements) - whether or not possessing artistic quality. This means even a simple product photograph, a basic logo sketch, or a technical diagram qualifies for copyright protection. Registration via Form XIV at the Copyright Office (JPG/PDF format, Rs 500 per work for individuals) provides prima facie evidence of ownership. Duration: author's lifetime + 60 years. Critical trap: Section 15(2) - if an artistic work is applied to an industrial article and reproduced more than 50 times without Design Act registration, copyright protection ceases. Gurugram's photographers, designers, and architects must understand this overlap.</p>
                </div>
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Parameter</th><th>Detail</th></tr></thead>
                    <tbody>
                        <tr><td>Definition</td><td>Section 2(c): paintings, sculptures, drawings, engravings, photographs, architecture, works of artistic craftsmanship</td></tr>
                        <tr><td>Key Rule</td><td>No artistic quality required. Even a technical diagram or simple photograph qualifies</td></tr>
                        <tr><td>Registration</td><td>Form XIV on <a href="https://copyright.gov.in" target="_blank" rel="noopener">copyright.gov.in</a>. Upload in JPG or PDF format</td></tr>
                        <tr><td>Fee</td><td>Rs 500/work (individual) | Rs 2,000/work (company)</td></tr>
                        <tr><td>Duration</td><td>Author's lifetime + 60 years. Photographs: 60 years from publication</td></tr>
                        <tr><td>Section 15 Trap</td><td>Artistic work applied to industrial article more than 50 times loses copyright unless registered under Designs Act 2000</td></tr>
                        <tr><td>Logo Protection</td><td>Dual: copyright (as artistic work) + trademark (as device mark under Trade Marks Act 1999)</td></tr>
                        <tr><td>TM-60</td><td>Trademark Search Certificate may be required for logos/labels overlapping with trademarks</td></tr>
                    </tbody>
                </table>
                </div>
                <p>Gurugram's visual economy is enormous. E-commerce businesses on Sohna Road shoot thousands of product photographs monthly. Design agencies on Golf Course Road create logos, brand identity systems, and marketing graphics. Architectural firms design buildings for Gurugram's construction boom. UI/UX designers in DLF Cyber City create application interfaces. Fashion designers, interior decorators, and illustrators produce original visual works daily. For comprehensive information about <a href="/copyright-registration">copyright registration across India</a>, visit our national service page.</p>
                <p>The most common artistic work copyright issue in Gurugram: product photographers and graphic designers create works for businesses but never register copyright or execute assignment deeds. The photographer owns the copyright in every photograph (Section 17 - author is first owner). The business that paid for the photoshoot does not own the photographs without a written assignment. When competitors copy product photographs (extremely common in Gurugram's e-commerce market), the business discovers it does not have the legal standing to enforce. Registration plus proper assignment deeds solve this. You may also need <a href="/trademark-registration">trademark registration</a> for logo brand identity protection alongside copyright.</p>
        ...
        <div class="two-column">
            <div class="column-content">
                ...
                <div class="content-text what-is-definition">
                    <p>Copyright for artistic work is the legal protection automatically granted to original visual and crafted works under Section 2(c) of the Copyright Act 1957. The protection covers the expression (not the idea) and includes the exclusive right to reproduce the work in any material form, communicate it to the public, issue copies, make adaptations, and translate it.</p>
                    <p>Registration through Form XIV with the Copyright Office creates a prima facie evidence record. The definition is deliberately broad - it covers everything from a celebrated oil painting to a basic technical drawing, from a professional portrait photograph to a product packaging design. Section 2(c) explicitly states 'whether or not possessing artistic quality.'</p>
                    <p>The certificate is prima facie evidence of ownership valid for the author's lifetime plus 60 years. The critical Section 15(2) trap must be understood: artistic works applied to industrial articles more than 50 times lose copyright without Designs Act registration. Businesses should consider pairing artistic work copyright with <a href="/brand-copyright-registration">brand copyright registration</a> for complete protection.</p>
                </div>
                <div class="highlight-box" style="margin-top:20px;">
                    <p><strong>Key Terms for Copyright Registration:</strong></p>
                    <ul>
                        <li><strong>Section 2(c)</strong> - Definition of artistic work covering paintings, sculptures, drawings, photographs, architecture, and artistic craftsmanship</li>
                        <li><strong>Section 15(2)</strong> - Artistic work applied to industrial articles more than 50 times loses copyright without Designs Act registration</li>
                        <li><strong>TM-60</strong> - Trademark Search Certificate required when registering copyright for logos/labels overlapping with trademarks</li>
                        <li><strong>Assignment Deed</strong> - Written agreement under Section 19 transferring copyright from creator to commissioning party</li>
                        <li><strong>Form XIV</strong> - Prescribed application form for copyright registration under Copyright Rules 2013</li>
                    </ul>
                </div>
            </div>
            <div class="column-image">
                <div class="illustration-placeholder">
                    ...
                    <div class="illustration-badge">
                        <span>Section 2(c) Copyright Act</span>
                        <strong>Artistic Work Protection</strong>
                    </div>
                </div>
            </div>
        </div>
...
<section class="content-section" id="who-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Who Needs Artistic Work Copyright in Gurugram</h2>
            <div class="content-text">
                <ul>
                    <li><strong>Professional photographers</strong> (product, commercial, wedding, corporate, architectural) who create thousands of images annually. Each photograph is an independent artistic work with separate copyright. Batch registration strategies are essential for portfolio protection. Product photographers supplying e-commerce images face the highest infringement risk in Gurugram.</li>
                    <li><strong>Graphic designers, branding agencies, and creative studios</strong> on Golf Course Road and Sohna Road creating logos, visual identities, packaging designs, marketing collateral, infographics, and social media graphics. Logos deserve dual protection: copyright (artistic work) + trademark (device mark). Packaging designs face the Section 15 question if applied to products industrially.</li>
                    ...
                    <li><strong>D2C and FMCG brands</strong> on Sohna Road and Udyog Vihar needing copyright for product packaging designs, label artwork, and brand visual elements. The Section 15 trap is most relevant here: packaging designs reproduced on products more than 50 times need Design Act registration to maintain protection.</li>
                    <li><strong>Fashion designers, interior decorators, and illustrators</strong> producing original visual works for galleries, commissions, or commercial licensing in Gurugram's growing creative ecosystem. Fine art copyright persists even if a design derived from the artwork is registered under the Designs Act.</li>
...
<section class="content-section" id="services-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">8 Artistic Work Copyright Services Included</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Service</th><th>What We Do</th></tr></thead>
                    <tbody>
                        <tr><td>Logo and Brand Identity Copyright</td><td>Filing copyright for logos as artistic works. Dual protection advisory: copyright (Section 2(c), lifetime + 60 years) + trademark (Trade Marks Act, device mark, 10 years renewable). TM-60 certificate obtained if required.</td></tr>
                        <tr><td>Packaging and Product Design</td><td>Copyright registration for packaging artwork, label designs, and product visual elements. Section 15 advisory: if design applied to products more than 50 times, Designs Act 2000 registration also needed.</td></tr>
                        <tr><td>Photograph Copyright Registration</td><td>Batch filing for professional photographers. Each photograph as separate Form XIV. JPG/PDF format. NOC from identifiable persons. Metadata preservation advisory for creation date evidence.</td></tr>
                        <tr><td>Architectural Design Copyright</td><td>Registration for building designs, floor plans, elevation drawings, and interior design schemes. Section 2(c)(ii) covers architecture. Protection extends to artistic character and design only.</td></tr>
                        <tr><td>Graphic Design Portfolio</td><td>Batch registration for design agencies: marketing graphics, infographics, social media designs. Strategy to prioritize highest-value and most-copied works for registration.</td></tr>
                        <tr><td>Section 15 Design Overlap Advisory</td><td>Expert guidance on when artistic work needs additional Designs Act registration. If applied to industrial articles more than 50 times, dual registration preserves protection.</td></tr>
                        <tr><td>Assignment Deed for Commissioned Works</td><td>Drafting Section 19-compliant assignment deeds for photographs, designs, and artistic works created by freelance photographers and designers for Gurugram businesses.</td></tr>
                    </tbody>
                </table>
                </div>
            </div>
...
<section class="steps-section" id="procedure-section">
    <div class="section-container">
        <header class="section-header" style="text-align:center;margin-bottom:48px;">
            ...
            <h2 class="section-title">How Artistic Work Copyright Registration Works: 6-Step Process</h2>
            <p class="section-subtitle" style="text-align:left;max-width:100%;">Our CA-led team handles the complete artistic work copyright registration with the Section 2(c) Copyright Act under Section 2(c) of the Copyright Act 1957, including Section 15 design overlap assessment.</p>
        </header>
        <div class="steps-container">
            <div class="step-card">
                <div class="step-content">
                    <span class="step-badge">Step 1</span>
                    <h3 class="step-title">Identify and Prepare Artistic Works</h3>
                    <p class="step-description">Review all visual works to be registered: photographs (JPG), designs (PDF/JPG), architectural plans (PDF), illustrations (PDF/JPG). Determine if each is original. For commissioned works: verify assignment deed exists. For persons in photographs: obtain NOC. For logos: check TM-60 trademark overlap.</p>
                    <div class="step-highlights">
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Visual Works</span>
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Assignment Check</span>
                    </div>
                </div>
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">Prepare File Formats</h3>
                    <p class="step-description">Upload requirements: JPG or PDF format, file size under 10 MB per work. For photographs: high-resolution JPG. For designs: clear PDF with full design visible. For architectural works: plan drawings in PDF. Each artistic work is a separate application and fee.</p>
                    <div class="step-highlights">
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>JPG/PDF Format</span>
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Under 10 MB</span>
                    </div>
                </div>
                <div class="step-visual">
                    <div class="step-illustration">
                        ...
                        <span class="illustration-label">Files Prepared</span>
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <p class="step-description">Complete Form XIV with: work title, category (artistic work), author details, applicant details, date of creation, publication details. Upload work copy. Attach NOC from author (if applicant differs), NOC from persons in photographs, TM-60 (if logo/label). Pay fee: Rs 500 (individual) or Rs 2,000 (company). Diary Number issued.</p>
                    <div class="step-highlights">
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Form XIV Filed</span>
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Fee Payment</span>
                    </div>
                </div>
                <div class="step-visual">
                    <div class="step-illustration">
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <p class="step-description">Mandatory waiting period for third-party objections. Monitor via Diary Number. If objection received, respond within 30 days with evidence of originality and ownership (see Copyright Objection service).</p>
                    <div class="step-highlights">
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Objection Watch</span>
                ...
                <div class="step-visual">
                    <div class="step-illustration">
                        ...
                        <span class="illustration-label">Monitoring</span>
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <p class="step-description">Copyright Office examiner reviews application. Discrepancy letter if issues found (respond within 30 days). On clearance: Registrar enters details in Register of Copyrights. Certificate issued. Prima facie evidence under Section 48.</p>
                    <div class="step-highlights">
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Design Act Check</span>
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">Section 15 Assessment (If Industrial Application)</h3>
                    <p class="step-description">If the artistic work will be applied to products for industrial reproduction (packaging, labels, product surface designs), assess whether Design Act registration is needed. If reproduction will exceed 50 times: file design registration with Design Wing CGPDTM to preserve protection. Original fine art retains copyright regardless.</p>
                    <div class="step-highlights">
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Design Act Check</span>
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>CGPDTM Filing</span>
                    </div>
                </div>
                <div class="step-visual">
                    <div class="step-illustration">
                        ...
                        <span class="illustration-label">S15 Assessed</span>
        ...
        <div class="highlight-box" style="margin-top:32px;max-width:1000px;margin-left:auto;margin-right:auto;">
            <p><strong>City Processing Note:</strong> Patron's Gurugram office on Golf Course Extension Road handles artistic work copyright for photographers, designers, architects, and brands across Gurugram.</p>
        </div>
    </div>
</section>
...
<section class="content-section" id="documents-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Documents Required for Artistic Work Copyright in Gurugram</h2>
            <div class="content-text">
                <ul>
                    <li><strong>Artistic Work:</strong> Copy of the work in JPG or PDF format (under 10 MB). Clear, high-resolution. Each work separately.</li>
                    <li><strong>Author Identity:</strong> DVN card or Aadhaar card or passport. For companies: Certificate of Incorporation.</li>
                    <li><strong>NOC:</strong> No Objection Certificate from the author (if applicant is different from author). Publisher's NOC (if work is published and applicant is not publisher).</li>
                    <li><strong>Additional:</strong> Power of Attorney (if filing through agent). Authorization letter (for companies). GST number (for companies).</li>
                </ul>
            </div>
        </div>
    </div>
...
<section class="content-section" id="challenges-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">5 Common Artistic Work Copyright Challenges in Gurugram</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Challenge</th><th>Impact</th><th>How Patron Accounting Solves It</th></tr></thead>
                    <tbody>
                        <tr><td>Product Photographs Copied by Competitors</td><td>E-commerce sellers invest lakhs in photography, competitors download and use same images</td><td>Register high-value product photography before listing on marketplaces. Certificate provides prima facie proof for immediate injunction.</td></tr>
                        <tr><td>Designer Retains Logo Copyright</td><td>Business pays freelance designer but does not own the logo copyright without assignment deed</td><td>Always execute copyright assignment deed under Section 19 when commissioning artistic works. Verify ownership chain before registration.</td></tr>
                        <tr><td>Section 15 Copyright Loss for Packaging</td><td>Packaging design printed on 100,000+ units loses copyright under Section 15(2) without Design Act registration</td><td>Dual registration (copyright + design) for all packaging artwork applied to products industrially. Coordinate both filings simultaneously.</td></tr>
                        <tr><td>Architectural Design Infringement</td><td>Developer shares architect's unique building plans with another builder who constructs similar building</td><td>Register architectural designs promptly. Copyright protects artistic character and design. Registration simplifies enforcement in Delhi High Court.</td></tr>
                        <tr><td>No Artistic Quality Required but Originality Is</td><td>Businesses hesitate to register simple works (basic logos, technical diagrams) assuming they lack artistic quality</td><td>Section 2(c) explicitly covers works whether or not possessing artistic quality. The requirement is originality, not quality. File even for simple original works.</td></tr>
                    </tbody>
                </table>
                </div>
            </div>
...
<section class="content-section" id="fees-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Artistic Work Copyright Fees in Gurugram 2026</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table class="table-amount">
                    <thead><tr><th>Fee Component</th><th>Amount</th></tr></thead>
                    <tbody>
                        <tr><td>Single Artistic Work (Individual)</td><td>Rs 500 per work</td></tr>
                        <tr><td>Single Artistic Work (Company)</td><td>Rs 2,000 per work</td></tr>
                        <tr><td>Photography Portfolio (10+ works) - Individual</td><td>Rs 500/work govt + Rs 1,500-2,500/work professional</td></tr>
                        <tr><td>Logo Dual Protection (Copyright + Trademark)</td><td>Rs 500 copyright + Rs 4,500-9,000 trademark</td></tr>
                        <tr><td>Section 15 Dual Filing (Copyright + Design)</td><td>Rs 500 copyright + Design Act fees</td></tr>
                        <tr><td>Assignment Deed (Commissioned Work)</td><td>Rs 3,000-5,000</td></tr>
                ...
                <p style="margin-top:16px;">Professional service charges for Form XIV preparation, filing, Section 15 assessment, and certificate procurement are separate from the statutory fees. Contact us for a detailed quote.</p>
...
<section class="content-section" id="timeline-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Artistic Work Copyright Timeline in Gurugram</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Stage</th><th>Estimated Timeline</th></tr></thead>
                    <tbody>
                        <tr><td>Filing Form XIV and Diary Number</td><td>Immediate (same day)</td></tr>
                        <tr><td>Mandatory 30-Day Objection Period</td><td>30 days</td></tr>
                        ...
                        <tr><td>If objection filed</td><td>Additional 2-4 months for hearing and resolution</td></tr>
                        <tr><td>Discrepancy response</td><td>Additional 1-2 months</td></tr>
                    </tbody>
                </table>
                </div>
                <div class="highlight-box" style="margin-top:16px;">
                    <p><strong>Note:</strong> Timeline varies based on Copyright Office workload and whether objections or discrepancies arise. Patron Accounting actively follows up with the Copyright Office to minimize delays for Gurugram clients.</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="why-choose-section" id="benefits-section">
    <div class="section-container">
        <div style="text-align:center;margin-bottom:48px;">
            ...
            <h2 class="section-title">Why Choose Patron for Artistic Work Copyright in Gurugram</h2>
        </div>
        <div class="features-grid">
            <article class="feature-card">
                ...
                <h3 class="feature-title">Section 2(c) Expertise</h3>
                <p class="feature-text">Specialized filing for all artistic work types under Section 2(c) - photographs, logos, designs, paintings, architecture, and works of artistic craftsmanship - with Section 15 design overlap advisory.</p>
            </article>
            <article class="feature-card">
                ...
                <h3 class="feature-title">Portfolio Batch Filing</h3>
                <p class="feature-text">Batch registration for design agencies and photographers with multiple works. Prioritization strategy for highest-value and most-copied images. Reduced professional fees per work.</p>
            </article>
            <article class="feature-card">
                ...
                <h3 class="feature-title">Section 15 Advisory</h3>
                <p class="feature-text">Expert guidance on when artistic work needs Designs Act registration. If applied to industrial articles more than 50 times, dual registration prevents copyright loss.</p>
            </article>
            <article class="feature-card">
                <div class="feature-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg></div>
                <h3 class="feature-title">Logo Dual Protection</h3>
                <p class="feature-text">Copyright (Section 2(c), lifetime + 60 years) plus trademark (device mark, 10 years renewable) for maximum logo and brand identity protection.</p>
            </article>
            <article class="feature-card">
                ...
                <h3 class="feature-title">Software Specialization</h3>
                <p class="feature-text">Portfolio prioritization and batch filing for commercial photographers - register highest-value and most-copied images first. Assignment deed drafting for commissioned works.</p>
            </article>
            <article class="feature-card">
                ...
                <h3 class="feature-title">Assignment Deed Drafting</h3>
                <p class="feature-text">Section 19-compliant assignment deeds for photographs, designs, and artistic works created by freelancers - transferring copyright from creator to commissioning business.</p>
            </article>
        </div>
    </div>
</section>
...
<!-- SECTION 13: COMDVRISON -->
<section class="content-section" id="comparison-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Types of Artistic Works and Copyright Protection</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table class="table-comparison">
                    <thead><tr><th>Artistic Work</th><th>Examples</th><th>Section</th><th>Format</th><th>Duration</th><th>Special Note</th></tr></thead>
                    <tbody>
                        <tr><td>Photograph</td><td>Product, portrait, commercial</td><td>S2(c)(i)</td><td>JPG/PDF</td><td>60 yrs from pub</td><td>NOC if persons shown</td></tr>
                        <tr><td>Logo/Brand Mark</td><td>Logos, brand identity</td><td>S2(c)(iii)</td><td>JPG/PDF</td><td>Life + 60 yrs</td><td>Dual: copyright + TM</td></tr>
                        <tr><td>Painting/Illustration</td><td>Fine art, illustrations</td><td>S2(c)(i)</td><td>JPG/PDF</td><td>Life + 60 yrs</td><td>Retains CR even if design reg</td></tr>
                        <tr><td>Packaging Design</td><td>Product packaging, labels</td><td>S2(c)(iii)</td><td>PDF</td><td>Life + 60 yrs*</td><td>S15: Design Act if &gt;50 copies</td></tr>
                        <tr><td>Architecture</td><td>Building designs, plans</td><td>S2(c)(ii)</td><td>PDF</td><td>Life + 60 yrs</td><td>Design only, not methods</td></tr>
                        <tr><td>Drawing/Diagram</td><td>Technical, maps, charts</td><td>S2(c)(i)</td><td>PDF</td><td>Life + 60 yrs</td><td>No artistic quality needed</td></tr>
                        <tr><td>UI/UX Design</td><td>App interfaces, icons</td><td>S2(c)(iii)</td><td>JPG/PDF</td><td>Life + 60 yrs</td><td>Separate from code (literary)</td></tr>
                    </tbody>
                </table>
                </div>
                <p style="margin-top:12px;font-size:13px;color:var(--text-muted);font-style:italic;">* Packaging: copyright may cease under S15(2) if applied industrially &gt;50 times without Design Act registration.</p>
                <p style="margin-top:8px;">External Authority: <a href="https://copyright.gov.in" target="_blank" rel="noopener">Copyright Office, DPIIT (copyright.gov.in)</a></p>
            </div>
        </div>
    </div>
</section>
...
<!-- SECTION 15A: LEGAL FRAMEWOAS -->
<section class="content-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Legal Framework for Copyright Registration</h2>
            <div class="content-text">
                <p>Artistic work copyright in India is governed by <strong>Section 2(c) of the Copyright Act 1957</strong> and the <strong>Copyright Rules 2013</strong>. Section 2(c) defines artistic work as paintings, sculptures, drawings (including diagrams, maps, charts, plans), engravings, photographs, works of architecture, and works of artistic craftsmanship - whether or not possessing artistic quality. The critical Section 15 creates an intersection with the <strong>Designs Act 2000</strong> for works applied to industrial articles.</p>
                <p>Section 17 establishes the photographer/designer as the first owner of copyright - even for commissioned works. Unlike works made during employment (Section 17(c) where the employer is first owner), freelance-created artistic works remain with the creator unless a written assignment deed under Section 19 is executed. Section 15(2) provides that if an artistic work registrable under the Designs Act is applied to any article by industrial process more than 50 times, copyright protection ceases for that industrial application.</p>
                <p>For photographs, the duration is 60 years from the year following publication (not the author's lifetime). For logos, dual protection through copyright (Section 2(c)) and trademark (Trade Marks Act 1999) provides maximum coverage. The Design Wing of the Controller General of Patents, Designs and Trade Marks (CGPDTM) handles Designs Act registrations. IP enforcement in Gurugram falls under the jurisdiction of the <a href="https://copyright.gov.in" target="_blank" rel="noopener">Delhi High Court</a>. The Copyright Office at copyright.gov.in is administered by DPIIT.</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    <h2 class="faq-expanded__title">FAQs - Copyright for Artistic Work in Gurugram</h2>
                    <p class="faq-expanded__lead">Answers to common questions about artistic work copyright, Section 15 design overlap, photographer ownership, and logo dual protection for Gurugram businesses.</p>
                    @include('partials.faq-enquiry-form', ['enquiryLocation' => 'Gurugram', 'enquiryService' => 'Copyright for Artistic Work in Gurugram'])
                </aside>
                <div class="faq-expanded__list">
                    <div class="faq-expanded__item" id="faq-1">
                        <h3 class="faq-expanded__q">Does an artistic work need artistic quality for copyright?</h3>
                        <div class="faq-expanded__a"><p>No. Section 2(c)(i) explicitly states 'whether or not any such work possesses artistic quality.' A simple product photograph, a basic technical diagram, a rough sketch, or a functional map all qualify for copyright protection. The requirement is originality (independent creation by the author) not artistic merit. Even commercially utilitarian designs are protected as long as they are original expressions.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-2">
                        <h3 class="faq-expanded__q">How much does artistic work copyright cost in Gurugram?</h3>
                        <div class="faq-expanded__a"><p>Government fee: Rs 500 per work for individuals, Rs 2,000 per work for companies. Professional fee: Rs 3,000 to Rs 5,000 per work (Form XIV preparation, filing, certificate). Photography portfolio (10+ works): Rs 1,500 to Rs 2,500 per work professional. Logo dual protection (copyright + trademark): Rs 500 + Rs 4,500 to Rs 9,000. Call +91 945 945 6700.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-3">
                        <h3 class="faq-expanded__q">What is the Section 15 trap for packaging designs?</h3>
                        <div class="faq-expanded__a"><p>Section 15(2) of the Copyright Act provides that if a design registrable under the Designs Act 2000 has been applied to any article by an industrial process more than 50 times, it ceases to enjoy copyright protection. This means a packaging design (which is artistic) printed on 100,000 product units loses copyright unless also registered under the Designs Act. The original artwork (painting/illustration) retains copyright, but its industrial application on products does not. D2C brands must register under both Acts.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-4">
                        <h3 class="faq-expanded__q">Who owns the copyright in commissioned photographs?</h3>
                        <div class="faq-expanded__a"><p>The photographer (author) is the first owner under Section 17, even if the business commissioned and paid for the photoshoot. There is no automatic transfer of copyright through payment. The business must obtain a written assignment deed from the photographer to own the copyright. Without the deed, the photographer can license the same images to competitors, register copyright in their own name, and prevent the business from using the photographs in ways not originally agreed. Always execute assignment deeds before or at the time of commissioning.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-5">
                        <h3 class="faq-expanded__q">Can a logo be protected by both copyright and trademark?</h3>
                        <div class="faq-expanded__a"><p>Yes, and this dual protection is recommended. Copyright (as artistic work under Section 2(c)) protects the visual design for the author's lifetime + 60 years. Trademark (as device mark under the Trade Marks Act 1999) protects the logo's commercial use as a brand identifier for 10 years (renewable). Copyright prevents reproduction of the design itself. Trademark prevents use of a similar mark in the same goods/services class. Together, they provide maximum protection.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-6">
                        <h3 class="faq-expanded__q">How should photographers protect a large portfolio?</h3>
                        <div class="faq-expanded__a"><p>Each photograph is a separate artistic work requiring its own Form XIV and fee. For commercial photographers with hundreds or thousands of images, prioritize registration: (1) highest-value commercial images (product photos, campaign images), (2) images most likely to be copied (e-commerce product photos), (3) signature works (portfolio highlights). Batch filing reduces professional fees per image. Maintain metadata (EXIF data, creation date, camera details) for all images as creation evidence.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-7">
                        <h3 class="faq-expanded__q">How long does artistic work copyright last?</h3>
                        <div class="faq-expanded__a"><p>For most artistic works (paintings, illustrations, logos, designs, sculptures): author's lifetime + 60 years from the year following the author's death. For photographs: 60 years from the year following publication. For anonymous or pseudonymous works: 60 years from publication. For joint authorship: lifetime of the last surviving author + 60 years. India's Berne Convention membership means this protection applies in 181+ countries.</p></div>
                    </div>
                </div>
            </div>
            ...
            <div class="highlight-box" style="margin-top:32px;">
                ...
                <p><strong>Product photo ka copyright kiski hai?</strong> Photographer ka. Section 17 ke under photographer first owner hai chahe business ne payment kiya ho. Assignment deed ke bina business ko copyright nahi milta. Deed zaroori hai.</p>
                <p><strong>Logo ka copyright aur trademark dono chahiye?</strong> Haan. Copyright design protect karta hai (lifetime + 60 years). Trademark brand use protect karta hai (10 years, renewable). Dono saath mein maximum protection dete hain.</p>
                <p><strong>Packaging design pe copyright khatam ho sakta hai?</strong> Haan. Section 15(2) ke under agar packaging design 50 se zyada baar industrial process se product pe print ho toh copyright khatam. Designs Act mein bhi register karo protection ke liye.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section" style="background: var(--orange-lighter) !important; border-left: 4px solid var(--orange);">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Why Artistic Work Copyright Is Critical for Gurugram's Visual Economy</h2>
            <div class="content-text">
                <p>A Gurugram e-commerce brand investing Rs 3 lakh in professional product photography sees competitors using the same images within weeks. Without copyright registration, the brand must hire lawyers, gather metadata evidence, locate the photographer for testimony, and prove ownership through circumstantial evidence - a process costing Rs 2-5 lakh in legal fees and taking months. With registered copyright (Rs 500 per photo), the brand presents the certificate as prima facie proof, obtains an injunction within days, and the infringer is legally compelled to remove the images. For Gurugram's visual economy where images are currency, copyright registration is the most cost-effective protection available.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section" style="background: var(--blue) !important;">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title" style="color:#FFFFFF !important;">Start Your Artistic Work Copyright in Gurugram Today</h2>
            <div class="content-text" style="text-align:left;">
                <p style="color:rgba(255,255,255,0.85);">Copyright for artistic work in Gurugram protects the photographs, logos, designs, architectural drawings, packaging artwork, and visual creations that drive the city's commercial and creative economy - with registration providing the prima facie ownership evidence that enforcement requires.</p>
                <p style="color:rgba(255,255,255,0.85);">Patron Accounting's Gurugram office on Golf Course Extension Road handles artistic work copyright registration with Section 15 design overlap advisory, photographer assignment deeds, logo dual protection (copyright + trademark), and portfolio batch filing for designers and photographers across Gurugram.</p>
...
<!-- CITY DVGES GRID — Zone C: Gurugram NOT interlinked (4-city non-starred) + Zone D: Same-city cross-sell -->
<section class="content-section" style="padding:48px 32px;background:var(--gray-50);">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title" style="text-align:center;margin-bottom:12px;">Artistic Work Copyright Across India</h2>
            <p style="text-align:center;color:var(--text-muted);font-size:15px;margin-bottom:40px;">Artistic work copyright services available in major cities across India with local office support.</p>
            ...
            <div class="pa-city-block">
                ...
                <div class="pa-block-sub">End-to-end support for Artistic Work Copyright in Gurugram</div>
...
<section class="content-section" style="padding:32px;">
    <div class="content-container">
        <div class="text-content" style="font-size:13px;color:var(--text-muted);">
            ...
            <p>This page is reviewed quarterly for accuracy. Copyright Act Section 2(c) provisions, fee schedules, Section 15 design overlap rules, and Copyright Office processes are verified against official government notifications and updated when changes occur. Gurugram-specific information including design agencies, photographers, and local business context is validated with each review.</p>
        </div>
    </div>
</section>
