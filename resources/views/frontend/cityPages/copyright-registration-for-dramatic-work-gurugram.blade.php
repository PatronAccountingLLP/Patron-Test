...
@section('meta')
    ...
    <meta property="og:image" content="/images/copyright-registration-for-dramatic-work-gurugram-og.webp">
    ...
    <meta name="twitter:image" content="/images/copyright-registration-for-dramatic-work-gurugram-og.webp">
@endsection
  ...
  "@graph": [
    {
      ...
      "url": "/copyright-registration-for-dramatic-work/gurugram",
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-4 private-registration-heading">
                        Copyright for Dramatic Work in Gurugram: Scripts, Screenplays, Choreography, and Theatre
                    </h1>
                    ...
                    <div class="mb-4">
                        <div class="d-flex align-items-start mb-3">
                            ...
                            <p class="mb-0 text-dark benefit-paragraph"><span>Documents:</span> Copy of dramatic work (script/notation in PDF), author identity proof, NOC (if applicant is not author)</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Fees:</span> Rs 500 per work (individuals) | Rs 2,000 (companies). Professional: Rs 3,000-5,000</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Eligibility:</span> Creator of any original play, screenplay, choreographic notation, mime script, scenic arrangement, or recitation piece</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="mailto:sales@patronaccounting.com?subject=Enquiry%20for%20Dramatic%20Work%20Copyright%20in%20Gurugram&body=Hello%20Patron%20Accounting%20Team%2C%0A%0AI%20am%20interested%20in%20your%20Dramatic%20Work%20Copyright%20services%20in%20Gurugram%20and%20would%20like%20to%20know%20more.%0A%0APlease%20get%20in%20touch%20with%20me%20at%20your%20earliest%20convenience.%0A%0AThank%20you." class="btn-sample text-decoration-none">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:18px;height:18px;"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,12 2,6"/></svg>
                            Email Us
                        </a>
                        <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20help%20with%20Dramatic%20Work%20Copyright%20in%20Gurugram.%20Please%20share%20details." target="_blank" class="btn-sample text-decoration-none">
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - Dramatic Work Copyright Gurugram'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="copyright-registration-for-dramatic-work/gurugram" selected>Copyright for Dramatic Work in Gurugram</option>
...
<section class="testimonials-section">
    <div class="section-container">
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            ...
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Patron registered copyright for my screenplay before I shared it with any production house. When the series was a hit and the producer wanted adaptation rights, my registration certificate gave me negotiating power. They understood the screenplay-film distinction perfectly.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div>
                    <div style="font-weight:700;font-size:13px;color:var(--blue);">Neeraj Pandey</div>
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Screenwriter, Gurugram</div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Our choreography studio needed to fix and register 20+ original dance routines. Patron guided us through notation requirements and video recording with proper timestamps. Now our choreographic works are properly protected.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div>
                    <div style="font-weight:700;font-size:13px;color:var(--blue);">Ritu Deshmukh</div>
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Director, NCR Dance Academy</div>
                    <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                </div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">As a stand-up comedian, I was skeptical about copyrighting my material. Patron explained that written scripts qualify as dramatic works under Section 2(h). Now my best sets are registered and I have proof against joke theft.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div>
                    <div style="font-weight:700;font-size:13px;color:var(--blue);">Kunal Sharma</div>
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Stand-up Comedian, Gurugram</div>
                    <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                </div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Patron drafted the assignment deed when I transferred my play script to a production company. They ensured I retained adaptation rights and moral rights. The terms were clear and my interests were protected.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div>
                    <div style="font-weight:700;font-size:13px;color:var(--blue);">Ananya Verma</div>
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Playwright, Delhi-Gurugram</div>
                    <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                </div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Our event company creates original theatrical presentations for corporate clients. Patron registered our best experiential scripts as dramatic works. When a competitor copied our format, we had prima facie proof to enforce.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div>
                    <div style="font-weight:700;font-size:13px;color:var(--blue);">Saurabh Jain</div>
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">MD, Corporate Events Company</div>
                    <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                </div>
        ...
        <div class="reviews-cta" style="margin-top: 16px; display: flex !important;">
            <div class="reviews-cta-content">
                ...
                <div class="reviews-cta-text">
                    ...
                    <p>Trusted dramatic work copyright partner for screenwriters and performance creators in Gurugram.</p>
                </div>
            </div>
...
<div class="stats-bar">
    <div class="stats-container">
        <div class="stat-item">
            ...
            <div class="stat-content"><span class="stat-value">10,000+</span><span class="stat-label">Businesses Served</span><span class="stat-desc">Dramatic work and script IP protection across India.</span></div>
        </div>
        <div class="stat-item">
            <div class="stat-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8M12 17v4"/></svg></div>
            <div class="stat-content"><span class="stat-value">15+</span><span class="stat-label">Years Experience</span><span class="stat-desc">Deep expertise in dramatic work copyright, screenplay IP, and performance rights.</span></div>
        </div>
        <div class="stat-item">
            <div class="stat-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><path d="M14 2v6h6M16 13H8M16 17H8"/></svg></div>
            <div class="stat-content"><span class="stat-value">50,000+</span><span class="stat-label">Documents Filed</span><span class="stat-desc">Script registrations, assignment deeds, and performance agreements handled.</span></div>
        </div>
        <div class="stat-item">
            <div class="stat-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="8" r="7"/><path d="M8.21 13.89L7 23l5-3 5 3-1.21-9.12"/></svg></div>
            <div class="stat-content"><span class="stat-value">4.9&#9733;</span><span class="stat-label">Client Rating</span><span class="stat-desc">Trusted by screenwriters, playwrights, choreographers, and production houses.</span></div>
        </div>
...
<section class="content-section" id="overview-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Why Dramatic Work Copyright Matters for Gurugram's Creative Industry</h2>
            <div class="content-text">
                <div class="highlight-box" style="margin-bottom:20px;">
                    <p><strong>&#128204; TL;DR - Dramatic Work Copyright Services at a Glance</strong></p>
                    <p>A dramatic work under Section 2(h) of the Copyright Act 1957 includes any piece for recitation, choreographic work, entertainment in dumb show (mime), and the scenic arrangement or acting form - provided the form is fixed in writing or otherwise. The definition explicitly excludes cinematograph films. Dramatic works are intended to be performed, not merely read. This covers stage plays, theatre scripts, screenplays, choreographic notations, mime routines, stand-up comedy scripts, and corporate theatrical presentations. Registration via Form XIV costs Rs 500 per work (individuals). Duration: author's lifetime + 60 years. The critical requirement: the work must be 'fixed' - written down or recorded. Unfixed choreography or improvised performance cannot be copyrighted.</p>
                </div>
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Parameter</th><th>Detail</th></tr></thead>
                    <tbody>
                        <tr><td>Definition</td><td>Section 2(h): recitation, choreographic work, dumb show, scenic arrangement - fixed in writing or otherwise. Excludes cinematograph film</td></tr>
                        <tr><td>Key Requirement</td><td>Must be FIXED - written down, notated, or recorded. Unfixed work not copyrightable</td></tr>
                        <tr><td>Registration</td><td>Form XIV on <a href="https://copyright.gov.in" target="_blank" rel="noopener">copyright.gov.in</a>. Category: Dramatic Work. Upload in PDF format</td></tr>
                        <tr><td>Fee</td><td>Rs 500/work (individual) | Rs 2,000/work (company)</td></tr>
                        <tr><td>Duration (S22)</td><td>Author's lifetime + 60 years. Joint authorship: 60 years from death of last surviving author</td></tr>
                        <tr><td>Exclusive Rights (S14)</td><td>Reproduce, perform in public, communicate to public, adapt, translate, make film/recording</td></tr>
                        <tr><td>Author</td><td>The creator of the dramatic work (playwright, choreographer, screenwriter)</td></tr>
                        <tr><td>Moral Rights (S57)</td><td>Attribution and integrity rights - non-assignable, survive even after economic rights assigned</td></tr>
                    </tbody>
                </table>
                </div>
                <p>Gurugram's creative and corporate ecosystem produces dramatic works across multiple contexts. Screenwriters working with production houses on Golf Course Road create scripts for films, web series, TV shows, and ad films. Choreographers create dance routines for Bollywood sequences, corporate events, and digital content. Stand-up comedians write performance scripts at Gurugram venues. Corporate trainers develop theatrical presentations for DLF Cyber City companies. For comprehensive information about <a href="/copyright-registration-for-dramatic-work">dramatic work copyright across India</a>, visit our national service page.</p>
                <p>The most consequential copyright issue for Gurugram's dramatic work creators is the screenplay-film ownership gap. When a screenwriter writes a script for a film producer, the screenplay copyright belongs to the screenwriter (not the producer) unless assigned. The producer owns the composite film copyright but the underlying screenplay remains the writer's independent dramatic work. Screenwriters who do not register their scripts lose control of their own creative work. You may also need <a href="/copyright-registration-for-cinematographic-film">cinematographic film copyright</a> for the produced film and <a href="/copyright-assignment">copyright assignment</a> services.</p>
        ...
        <div class="two-column">
            <div class="column-content">
                ...
                <div class="content-text what-is-definition">
                    <p>Copyright for dramatic work is the exclusive right of the author to reproduce, perform in public, communicate to the public, adapt, translate, and create derivative works from an original dramatic work under Sections 13 and 14 of the Copyright Act 1957.</p>
                    <p>The work must be original and must be fixed in a tangible form - a script written on paper, a choreographic notation, a video recording of a dance routine, or any other form that captures the dramatic expression. Registration with the Copyright Office (Form XIV, Rs 500) creates prima facie evidence.</p>
                    <p>The author retains moral rights (attribution and integrity) even after economic rights are assigned. For screenwriters, the dramatic work copyright is independent of the <a href="/copyright-registration-for-cinematographic-film">cinematographic film copyright</a> produced from the script.</p>
                </div>
                <div class="highlight-box" style="margin-top:20px;">
                    <p><strong>Key Terms for Copyright Registration:</strong></p>
                    <ul>
                        <li><strong>Section 2(h)</strong> - Dramatic work includes recitation, choreographic work, dumb show, and scenic arrangement fixed in writing or otherwise</li>
                        <li><strong>Fixation</strong> - The work must be fixed in tangible form (written script, notation, video) to qualify for copyright</li>
                        <li><strong>Moral Rights (S57)</strong> - Attribution and integrity rights for authors that survive assignment of economic rights</li>
                        <li><strong>Screenplay Independence</strong> - Screenplay copyright belongs to the writer independently of the film produced from it</li>
                        <li><strong>Adaptation Rights</strong> - Rights to transform a dramatic work into another format (novel to screenplay, play to film)</li>
                    </ul>
                </div>
            </div>
            <div class="column-image">
                <div class="illustration-placeholder">
                    ...
                    <div class="illustration-badge">
                        <span>Section 2(h) Dramatic Work</span>
                        <strong>Scripts & Performance</strong>
                    </div>
                </div>
            </div>
        </div>
...
<section class="content-section" id="who-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Who Needs Dramatic Work Copyright in Gurugram</h2>
            <div class="content-text">
                <ul>
                    <li><strong>Screenwriters and script writers</strong> creating screenplays, dialogue, and scripts for films, web series, television shows, and ad films produced by Gurugram production houses. The screenplay is a dramatic work with copyright independent of the film. Registration protects the writer's rights before, during, and after production.</li>
                    <li><strong>Playwrights and theatre writers</strong> creating original stage plays, adaptations, and theatrical scripts for Gurugram's theatre scene including venues like Kingdom of Dreams and community theatre groups. Stage plays are the core dramatic work category.</li>
                    ...
                    <li><strong>Stand-up comedians and spoken word performers</strong> in Gurugram creating original performance material (jokes, monologues, spoken word pieces). When written down or recorded, these qualify as dramatic works (pieces for recitation). Registration prevents other performers from using the same material.</li>
...
<section class="content-section" id="services-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">7 Dramatic Work Copyright Services Included</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Service</th><th>What We Do</th></tr></thead>
                    <tbody>
                        <tr><td>Screenplay/Script Registration</td><td>Filing Form XIV for screenplays, film scripts, web series scripts, and television scripts as dramatic works. PDF format submission. Establishing the screenwriter's independent copyright before the script enters production.</td></tr>
                        <tr><td>Play and Theatre Script Registration</td><td>Copyright registration for original stage plays, adaptations, monologues, and theatrical scripts. Documentation of first performance date, publication details, and author information.</td></tr>
                        <tr><td>Choreography Fixation and Registration</td><td>Advisory on fixing choreographic work in copyrightable form: Labanotation/Benesh notation, detailed written descriptions, or video recording with timestamps. Filing Form XIV once fixed.</td></tr>
                        <tr><td>Performance Script Registration</td><td>Registration for stand-up comedy scripts, spoken word pieces, recitation scripts, and corporate presentation scripts. The written script (not the performance itself) is copyrightable. Performer's rights (S38) protect live performance separately.</td></tr>
                        <tr><td>Assignment Deeds (Script to Producer)</td><td>Drafting Section 19-compliant assignment deeds when screenwriters transfer screenplay copyright to film producers. Specifying rights assigned vs retained, duration, territory, royalty terms, and 2012 Amendment provisions.</td></tr>
                        <tr><td>Adaptation Rights Advisory</td><td>Advising on dramatic work adaptation rights: novel to screenplay, play to film, screenplay to novelization. Adaptation requires permission from the copyright owner. Both novelist and screenwriter have separate copyrights.</td></tr>
                        <tr><td>Moral Rights Protection</td><td>Advisory on Section 57 moral rights: right to attribution (credited as writer/choreographer) and right to integrity (prevent distortion). These rights survive assignment and are non-assignable.</td></tr>
                    </tbody>
                </table>
                </div>
            </div>
...
<section class="steps-section" id="procedure-section">
    <div class="section-container">
        <header class="section-header" style="text-align:center;margin-bottom:48px;">
            ...
            <h2 class="section-title">How Dramatic Work Copyright Registration Works: 5-Step Process</h2>
            <p class="section-subtitle" style="text-align:left;max-width:100%;">Our CA-led team handles dramatic work copyright including screenplay ownership, choreography fixation, assignment deeds, and adaptation rights advisory.</p>
        </header>
        <div class="steps-container">
            <div class="step-card">
                <div class="step-content">
                    <span class="step-badge">Step 1</span>
                    <h3 class="step-title">Fix the Dramatic Work</h3>
                    <p class="step-description">The dramatic work must be fixed in a tangible form. Scripts: written document (PDF). Choreography: notation system or detailed written description or video recording. Mime: written description of movements. Without fixation, the work cannot be registered.</p>
                    <div class="step-highlights">
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Work Fixed</span>
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Notation Ready</span>
                    </div>
                </div>
                <div class="step-visual">
                    <div class="step-illustration">
                        ...
                        <span class="illustration-label">Work Fixed</span>
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">Prepare Documentation</h3>
                    <p class="step-description">Author identity proof (PAN/Aadhaar). Copy of the work in PDF format. NOC from author (if applicant differs). For screenplays: clarify ownership status with producer before filing.</p>
                    <div class="step-highlights">
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>ID Verified</span>
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>NOC Obtained</span>
                    </div>
                </div>
                <div class="step-visual">
                    <div class="step-illustration">
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <p class="step-description">Complete Form XIV with: work title, category (dramatic work), sub-type (play, screenplay, choreography, mime), author details, date of creation, performance details. Upload PDF. Pay Rs 500 (individual) or Rs 2,000 (company). Diary Number issued.</p>
                    <div class="step-highlights">
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Dramatic Work Filed</span>
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">Objection Period and Examination</h3>
                    <p class="step-description">Mandatory 30-day waiting period. If a producer claims the screenplay was work-for-hire or was assigned, they may object. Response with evidence of authorship, contracts, and correspondence. Examiner reviews. Certificate issued on clearance.</p>
                    <div class="step-highlights">
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Producer Notified</span>
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">Rights Management</h3>
                    <p class="step-description">With certificate: negotiate assignment terms with producers from documented ownership. License performance rights to theatre groups. Control adaptation rights. Enforce moral rights (credit, integrity). Track derivative works.</p>
                    <div class="step-highlights">
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Assignment Negotiated</span>
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Adaptations Controlled</span>
                    </div>
                </div>
                <div class="step-visual">
                    <div class="step-illustration">
                        ...
                        <span class="illustration-label">Rights Managed</span>
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">Ongoing Protection</h3>
                    <p class="step-description">Annual review for new performances or adaptations. Monitor for unauthorized performances of registered dramatic works. Enforce against script theft and unauthorized adaptations through Delhi High Court.</p>
                    <div class="step-highlights">
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Monitoring Active</span>
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>IP Protected</span>
                    </div>
                </div>
                <div class="step-visual">
                    <div class="step-illustration">
        ...
        <div class="highlight-box" style="margin-top:32px;max-width:1000px;margin-left:auto;margin-right:auto;">
            <p><strong>City Processing Note:</strong> Patron's Gurugram office on Golf Course Extension Road handles dramatic work copyright for screenwriters, playwrights, choreographers, and performance creators across Gurugram.</p>
        </div>
    </div>
</section>
...
<section class="content-section" id="documents-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Documents Required for Dramatic Work Copyright in Gurugram</h2>
            <div class="content-text">
                <ul>
                    <li><strong>Dramatic Work:</strong> Copy in PDF format: script, screenplay, choreographic notation, stage directions, or mime description. Video recording acceptable for choreography.</li>
                    <li><strong>Author Identity:</strong> PAN/Aadhaar (individual) | Certificate of Incorporation (company).</li>
                    <li><strong>NOC:</strong> From author (if applicant is different) | From publisher (if published).</li>
                    <li><strong>Additional:</strong> Power of Attorney (if through agent) | Production agreement (if screenplay for a film, to clarify ownership status).</li>
                </ul>
            </div>
        </div>
    </div>
...
<section class="content-section" id="challenges-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">5 Common Dramatic Work Copyright Challenges in Gurugram</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Challenge</th><th>Impact</th><th>How Patron Accounting Solves It</th></tr></thead>
                    <tbody>
                        <tr><td>Screenplay Ownership Lost to Producer</td><td>Screenwriter creates script, producer registers it as part of film. Writer never independently registered</td><td>Register the screenplay before entering production agreements. Delhi HC confirmed screenplay copyright vests in writer independently of film.</td></tr>
                        <tr><td>Unfixed Choreography</td><td>Choreographers create routines but never fix them in writing or video notation</td><td>Record every original choreographic work: detailed written description, Labanotation, or video with date metadata. Section 2(h) requires fixation.</td></tr>
                        <tr><td>Stand-Up Comedy Script Theft</td><td>Comedian performs original material, another performer watches and uses same jokes</td><td>Document original material: write it down, date it, register high-value sets. Without written script (fixed form), no copyright claim.</td></tr>
                        <tr><td>Script Classification - Literary vs Dramatic</td><td>Whether screenplay is literary work or dramatic work has practical consequences for rights</td><td>Patron advises on optimal classification based on work nature and commercial objectives. Screenplay purpose is performance, making it dramatic under S2(h).</td></tr>
                        <tr><td>Corporate Theatre IP Unprotected</td><td>Event companies invest Rs 5-20 lakh in theatrical presentations but rarely register</td><td>Register high-value corporate dramatic works. Without documented ownership, competitor copying is unenforceable.</td></tr>
                    </tbody>
                </table>
                </div>
            </div>
...
<section class="content-section" id="fees-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Dramatic Work Copyright Fees in Gurugram 2026</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table class="table-amount">
                    <thead><tr><th>Fee Component</th><th>Amount</th></tr></thead>
                    <tbody>
                        <tr><td>Script/Screenplay Registration</td><td>Rs 500 govt + Rs 3,000-5,000 professional</td></tr>
                        <tr><td>Play/Theatre Script Registration</td><td>Rs 500 govt + Rs 3,000-5,000 professional</td></tr>
                        <tr><td>Choreography Registration</td><td>Rs 500 govt + Rs 4,000-6,000 professional (includes fixation advisory)</td></tr>
                        <tr><td>Performance Script (Comedy/Spoken Word)</td><td>Rs 500 govt + Rs 3,000-4,000 professional</td></tr>
                        <tr><td>Assignment Deed (Script to Producer)</td><td>Rs 3,000-8,000</td></tr>
                        <tr><td>Adaptation Rights Agreement</td><td>Rs 5,000-12,000</td></tr>
                ...
                <p style="margin-top:16px;">Professional service charges cover Form XIV preparation, fixation advisory (choreography), registration, and certificate procurement. Assignment deeds and adaptation agreements are quoted separately.</p>
...
<section class="content-section" id="timeline-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Dramatic Work Copyright Timeline in Gurugram</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Stage</th><th>Estimated Timeline</th></tr></thead>
                    <tbody>
                        <tr><td>Fixation of Work (if not yet fixed)</td><td>1-5 business days (choreography notation/video)</td></tr>
                        <tr><td>Form XIV Filing and Diary Number</td><td>Immediate after fixation</td></tr>
                        <tr><td>30-Day Objection Period</td><td>30 days (producer may object for screenplays)</td></tr>
                        ...
                        <tr><td>If producer objects to screenplay</td><td>Additional 2-4 months for hearing and resolution</td></tr>
                    </tbody>
                </table>
                </div>
                <div class="highlight-box" style="margin-top:16px;">
                    <p><strong>Note:</strong> Screenplay registrations may face objections from producers during the 30-day period. Fixation of choreographic works (video/notation) must be completed before filing. Patron handles all objection responses and Copyright Office follow-up.</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="why-choose-section" id="benefits-section">
    <div class="section-container">
        <div style="text-align:center;margin-bottom:48px;">
            ...
            <h2 class="section-title">Why Choose Patron for Dramatic Work Copyright in Gurugram</h2>
        </div>
        <div class="features-grid">
            <article class="feature-card">
                ...
                <h3 class="feature-title">Screenplay Independence</h3>
                <p class="feature-text">Establishing screenwriter's independent copyright before script enters production. Registration provides leverage in assignment negotiations with producers.</p>
            </article>
            <article class="feature-card">
                ...
                <h3 class="feature-title">Choreography Fixation</h3>
                <p class="feature-text">Advisory on fixing choreographic work in copyrightable form: Labanotation, Benesh notation, written description, or video recording. Essential first step before registration.</p>
            </article>
            <article class="feature-card">
                ...
                <h3 class="feature-title">Script-to-Producer Deeds</h3>
                <p class="feature-text">Section 19-compliant assignment deeds specifying rights assigned vs retained, duration, territory, royalty terms, and 2012 Amendment provisions.</p>
            </article>
            <article class="feature-card">
                <div class="feature-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg></div>
                <h3 class="feature-title">Adaptation Rights</h3>
                <p class="feature-text">Advisory on dramatic work adaptation: novel to screenplay, play to film, screenplay to novelization. Each adaptation requires permission from the copyright owner.</p>
            </article>
            <article class="feature-card">
                ...
                <h3 class="feature-title">Moral Rights Protection</h3>
                <p class="feature-text">Section 57 moral rights advisory: attribution (credited as writer/choreographer) and integrity (prevent distortion). These rights survive assignment and are non-assignable.</p>
            </article>
            <article class="feature-card">
                ...
                <h3 class="feature-title">Performance Rights</h3>
                <p class="feature-text">Licensing performance rights to theatre groups, production companies, and event organizers. Controlling who performs your dramatic work and on what terms.</p>
            </article>
        </div>
    </div>
</section>
...
<section class="content-section" id="comparison-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Types of Dramatic Works and Copyright Protection</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table class="table-comparison">
                    <thead><tr><th>Dramatic Work</th><th>Section</th><th>Fixation Form</th><th>Duration</th><th>Key Consideration</th></tr></thead>
                    <tbody>
                        <tr><td>Stage Play/Script</td><td>S2(h)</td><td>Written script (PDF)</td><td>Life + 60 yrs</td><td>License to theatre groups</td></tr>
                        <tr><td>Screenplay</td><td>S2(h)/debated</td><td>Written script (PDF)</td><td>Life + 60 yrs</td><td>Independent from film CR</td></tr>
                        <tr><td>Choreography</td><td>S2(h)</td><td>Notation or video</td><td>Life + 60 yrs</td><td>Must fix before registration</td></tr>
                        <tr><td>Mime/Dumb Show</td><td>S2(h)</td><td>Written description</td><td>Life + 60 yrs</td><td>Movement sequence fixed</td></tr>
                        <tr><td>Recitation Piece</td><td>S2(h)</td><td>Written text (PDF)</td><td>Life + 60 yrs</td><td>Comedy, spoken word</td></tr>
                        <tr><td>Scenic Arrangement</td><td>S2(h)</td><td>Written directions</td><td>Life + 60 yrs</td><td>Stage directions, blocking</td></tr>
                        <tr><td>Corporate Theatre</td><td>S2(h)</td><td>Written script (PDF)</td><td>Life + 60 yrs</td><td>Training, events, experiential</td></tr>
                    </tbody>
                </table>
                </div>
...
<section class="content-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>Dramatic work copyright is governed by <strong>Section 2(h) of the Copyright Act 1957</strong> and the <strong>Copyright Rules 2013</strong>. Section 2(h) defines dramatic work to include pieces for recitation, choreographic work, entertainment in dumb show, and scenic arrangement - provided the form is fixed in writing or otherwise. The definition explicitly excludes cinematograph films (which have their own category under Section 2(f)).</p>
                <p>Section 14 provides exclusive rights: reproduce, perform in public, communicate to public, adapt, translate, and make films or sound recordings from the dramatic work. Section 57 provides moral rights (attribution and integrity) that are non-assignable and survive even after economic rights are assigned. The 2012 Amendment protects screenwriters' royalty rights for non-cinema exploitation.</p>
                <p>The screenplay-film ownership distinction has been addressed by the Delhi High Court, which confirmed that screenplay copyright vests in the writer independently. Registration with the <a href="https://copyright.gov.in" target="_blank" rel="noopener">Copyright Office (DPIIT)</a> on copyright.gov.in creates prima facie evidence. IP enforcement in Gurugram falls under the jurisdiction of the Delhi High Court.</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    <h2 class="faq-expanded__title">FAQs - Copyright for Dramatic Work in Gurugram</h2>
                    <p class="faq-expanded__lead">Answers to common questions about dramatic work copyright including screenplay ownership, choreography fixation, comedy scripts, and adaptation rights for Gurugram creators.</p>
                    @include('partials.faq-enquiry-form', ['enquiryLocation' => 'Gurugram', 'enquiryService' => 'Copyright for Dramatic Work in Gurugram'])
                </aside>
                <div class="faq-expanded__list">
                    <div class="faq-expanded__item" id="faq-1">
                        <h3 class="faq-expanded__q">What qualifies as a dramatic work under the Copyright Act?</h3>
                        <div class="faq-expanded__a"><p>Section 2(h) defines dramatic work to include: any piece for recitation, choreographic work, entertainment in dumb show (mime), and the scenic arrangement or acting form of which is fixed in writing or otherwise. The key requirements are: (1) the work must be intended for performance, and (2) it must be fixed in a tangible form. Cinematograph films are explicitly excluded.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-2">
                        <h3 class="faq-expanded__q">How much does dramatic work copyright registration cost?</h3>
                        <div class="faq-expanded__a"><p>Government fee: Rs 500 per work for individuals, Rs 2,000 for companies. Professional fee: Rs 3,000 to Rs 6,000 per work (Form XIV preparation, fixation advisory for choreography, registration, certificate). Assignment deed for script-to-producer: Rs 3,000 to Rs 8,000. Adaptation rights agreement: Rs 5,000 to Rs 12,000. Call +91 945 945 6700.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-3">
                        <h3 class="faq-expanded__q">Does a screenwriter retain copyright when a film is made?</h3>
                        <div class="faq-expanded__a"><p>Yes, by default. The screenplay is a dramatic work with copyright independent of the cinematograph film. The producer is the first owner of the composite film copyright but the screenplay copyright belongs to the screenwriter unless transferred through a written assignment deed. The Delhi High Court confirmed this. Screenwriters should register their scripts before entering production agreements.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-4">
                        <h3 class="faq-expanded__q">Can choreography be copyrighted?</h3>
                        <div class="faq-expanded__a"><p>Yes, but only if it is fixed. Section 2(h) includes 'choreographic work' in the definition of dramatic work. The critical requirement is fixation: the choreography must be recorded in writing (Labanotation, Benesh notation, detailed written description) or otherwise (video recording with date metadata). A dance routine performed but never recorded cannot be copyrighted.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-5">
                        <h3 class="faq-expanded__q">Is a stand-up comedy script a dramatic work?</h3>
                        <div class="faq-expanded__a"><p>Yes, when written down. A comedian's performance material qualifies as a 'piece for recitation' under Section 2(h) when fixed in writing. The written script is the copyrightable dramatic work. The live performance is protected separately under performer's rights (Section 38). For enforcement against joke theft, the written and dated script (registered with the Copyright Office) provides the strongest evidence.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-6">
                        <h3 class="faq-expanded__q">What is the difference between dramatic work and literary work?</h3>
                        <div class="faq-expanded__a"><p>The primary distinction is purpose. A dramatic work is created with the purpose of being performed (plays, screenplays, choreography, recitation). A literary work is created primarily to be read (novels, articles, software). A screenplay is debated - some courts treat it as literary, while others recognize its dramatic nature. Both categories offer similar protection duration (lifetime + 60 years) but classification affects adaptation and performance rights.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-7">
                        <h3 class="faq-expanded__q">How long does dramatic work copyright last?</h3>
            ...
            <div class="highlight-box" style="margin-top:32px;">
                ...
                <p><strong>Screenplay ka copyright producer ka hai ya writer ka?</strong> Writer ka. Screenplay dramatic work hai aur writer first owner hai. Producer ko film ka copyright milta hai (S2(d)(v)), screenplay ka nahi - jab tak writer assignment deed na de. Register karo pehle, negotiate karo baad mein.</p>
                <p><strong>Choreography ka copyright ho sakta hai?</strong> Haan, lekin fix karna padega pehle. Dance routine likh lo ya video record karo. Bina fixation ke copyright nahi milta. Fixed hone ke baad Form XIV se register karo.</p>
                <p><strong>Comedy script protect ho sakta hai?</strong> Haan. Likh lo toh 'piece for recitation' ban jaata hai S2(h) ke under. Registration karo toh prima facie proof milta hai joke theft ke case mein. Date aur timestamps rakho.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section" style="background: var(--orange-lighter) !important; border-left: 4px solid var(--orange);">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Why Dramatic Work Copyright Matters for Gurugram's Creative Industry</h2>
            <div class="content-text">
                <p>A Gurugram screenwriter creates a web series concept and 10-episode screenplay. The production house produces the series, it becomes a hit, and the producer plans a theatrical adaptation, a novelization, and international remakes. Without the screenwriter's copyright registration and a clear assignment deed, the producer may claim all adaptation rights. With registered copyright, the writer demonstrates independent ownership, negotiates each adaptation separately, and earns royalties from every derivative format. The Rs 500 registration fee protects potentially crores in adaptation revenue.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section" style="background: var(--blue) !important;">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title" style="color:#FFFFFF !important;">Start Your Dramatic Work Copyright in Gurugram Today</h2>
            <div class="content-text" style="text-align:left;">
                <p style="color:rgba(255,255,255,0.85);">Copyright for dramatic work in Gurugram protects the scripts, screenplays, choreographic notations, theatrical works, and performance scripts that form the creative foundation of the city's entertainment, media, and corporate content industry - establishing author ownership independent of the films, shows, and events produced from these works.</p>
                <p style="color:rgba(255,255,255,0.85);">Patron Accounting's Gurugram office on Golf Course Extension Road handles dramatic work copyright registration, screenplay assignment deeds, choreography fixation, and adaptation rights advisory for screenwriters, playwrights, choreographers, and performance creators across Gurugram.</p>
...
<section class="content-section" style="padding:48px 32px;background:var(--gray-50);">
    <div class="content-container">
        <div class="text-content">
            ...
            <p style="text-align:center;color:var(--text-muted);font-size:15px;margin-bottom:40px;">Dramatic work copyright services available in major cities across India with local office support.</p>
            ...
            <div class="pa-city-block">
                ...
                <div class="pa-block-sub">End-to-end support for Dramatic Work Copyright in Gurugram</div>
...
<section class="content-section" style="padding:32px;">
    <div class="content-container">
        <div class="text-content" style="font-size:13px;color:var(--text-muted);">
            ...
            <p>This page is reviewed quarterly for accuracy. Copyright Act Section 2(h) provisions, dramatic work registration rules, screenplay ownership case law, and Copyright Office processes are verified against official government notifications. Gurugram-specific creative industry information is validated with each review.</p>
        </div>
    </div>
</section>
