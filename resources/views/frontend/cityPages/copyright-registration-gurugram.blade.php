...
@section('meta')
    ...
    <meta property="og:image" content="/images/copyright-registration-gurugram-og.webp">
    ...
    <meta name="twitter:image" content="/images/copyright-registration-gurugram-og.webp">
@endsection
  ...
  "@graph": [
    {
      ...
      "url": "/copyright-registration/gurugram",
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-4 private-registration-heading">
                        Copyright Registration in Gurugram: Protect Software, Content, and Creative Works
                    </h1>
                    ...
                    <div class="mb-4">
                        <div class="d-flex align-items-start mb-3">
                            ...
                            <p class="mb-0 text-dark benefit-paragraph"><span>Documents:</span> Copy of the work (PDF/JPG/MP3/source code), author identity proof, NOC, POA</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Fees:</span> Rs 500 per work (literary/artistic individual) to Rs 5,000 (films)</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Eligibility:</span> Author, owner, or assignee of any original literary, artistic, musical, dramatic, software, film, or sound recording</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Timeline:</span> 2-6 months (30-day objection period + 1-3 months examination + certificate)</p>
                        </div>
                    </div>
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="mailto:sales@patronaccounting.com?subject=Enquiry%20for%20Copyright%20Registration%20in%20Gurugram&body=Hello%20Patron%20Accounting%20Team%2C%0A%0AI%20am%20interested%20in%20your%20Copyright%20Registration%20services%20in%20Gurugram%20and%20would%20like%20to%20know%20more.%0A%0APlease%20get%20in%20touch%20with%20me%20at%20your%20earliest%20convenience.%0A%0AThank%20you." class="btn-sample text-decoration-none">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:18px;height:18px;"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,12 2,6"/></svg>
                            Email Us
                        </a>
                        <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20help%20with%20Copyright%20Registration%20in%20Gurugram.%20Please%20share%20details." target="_blank" class="btn-sample text-decoration-none">
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - Copyright Registration Gurugram'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="copyright-registration/gurugram" selected>Copyright Registration in Gurugram</option>
...
<section class="testimonials-section">
    <div class="section-container">
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            ...
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Patron Accounting handled our software copyright registration for three SaaS products. Their guidance on source code submission format was invaluable - they ensured our proprietary logic remained protected while meeting Copyright Office requirements.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div>
                    <div style="font-weight:700;font-size:13px;color:var(--blue);">Rajesh Khanna</div>
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">CTO, Cyber City Software Pvt Ltd</div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Excellent service for copyright registration of our design portfolio. The team identified all copyrightable elements in our brand identity system and filed each separately. Very thorough approach to IP protection.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div>
                    <div style="font-weight:700;font-size:13px;color:var(--blue);">Priya Aggarwal</div>
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Founder, D2C Brand Studio</div>
                    <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                </div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Filed copyright for our literary works and articles. The team at Patron was responsive throughout the 30-day objection period and followed up with the Copyright Office for timely certificate issuance. Highly recommended.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div>
                    <div style="font-weight:700;font-size:13px;color:var(--blue);">Sanjay Mehta</div>
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Author & Content Creator</div>
                    <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                </div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">We needed copyright registration for our mobile app code and UI designs as separate filings. Patron handled everything from category assessment to certificate procurement. Their Gurugram office was very convenient for us.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                <div style="width:36px;height:36px;border-radius:50%;background:#6366F1;display:flex;align-items:center;justify-content:center;font-weight:700;font-size:13px;color:#fff;flex-shrink:0;">NK</div>
                <div>
                    <div style="font-weight:700;font-size:13px;color:var(--blue);">Neha Kapoor</div>
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Co-founder, TechStart Solutions</div>
                    <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                </div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Professional and knowledgeable team. They helped us understand the difference between copyright and trademark for our logo, and registered both. The Berne Convention advisory was a bonus for our international business.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div>
                    ...
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Director, Golf Course Media</div>
                    <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                </div>
        ...
        <div class="reviews-cta" style="margin-top: 16px; display: flex !important;">
            <div class="reviews-cta-content">
                ...
                <div class="reviews-cta-text">
                    ...
                    <p>Trusted copyright registration partner for IT companies and creative businesses in Gurugram.</p>
                </div>
            </div>
...
<div class="stats-bar">
    <div class="stats-container">
        <div class="stat-item">
            ...
            <div class="stat-content"><span class="stat-value">10,000+</span><span class="stat-label">Businesses Served</span><span class="stat-desc">Copyright and IP protection across India.</span></div>
        </div>
        <div class="stat-item">
            <div class="stat-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8M12 17v4"/></svg></div>
            <div class="stat-content"><span class="stat-value">15+</span><span class="stat-label">Years Experience</span><span class="stat-desc">Deep expertise in IP registration and copyright compliance.</span></div>
        </div>
        <div class="stat-item">
            <div class="stat-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><path d="M14 2v6h6M16 13H8M16 17H8"/></svg></div>
            <div class="stat-content"><span class="stat-value">50,000+</span><span class="stat-label">Documents Filed</span><span class="stat-desc">Copyright registrations, filings, and IP documents handled.</span></div>
        </div>
        <div class="stat-item">
            <div class="stat-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="8" r="7"/><path d="M8.21 13.89L7 23l5-3 5 3-1.21-9.12"/></svg></div>
            <div class="stat-content"><span class="stat-value">4.9&#9733;</span><span class="stat-label">Client Rating</span><span class="stat-desc">Trusted by IT companies, startups, and creative businesses.</span></div>
        </div>
...
<section class="content-section" id="overview-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Why Copyright Registration Matters for Gurugram Businesses</h2>
            <div class="content-text">
                <div class="highlight-box" style="margin-bottom:20px;">
                    <p><strong>&#128204; TL;DR - Copyright Registration Services at a Glance</strong></p>
                    <p>Copyright exists automatically when you create an original work under the Copyright Act 1957 - no registration required for protection. However, registration with the Copyright Office provides prima facie evidence of ownership in court (Section 48), creates a public record in the Register of Copyrights, and significantly strengthens enforcement against infringers. Registration is done via Form XIV on copyright.gov.in, with a mandatory 30-day objection waiting period followed by Copyright Office examination. Fees range from Rs 500 (literary/artistic for individuals) to Rs 5,000 (films). Protection lasts for the author's lifetime plus 60 years for literary, artistic, musical, and dramatic works, and 60 years from publication for films and sound recordings. India's membership in the Berne Convention means your registered copyright is recognized in 181+ countries.</p>
                </div>
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Parameter</th><th>Detail</th></tr></thead>
                    <tbody>
                        <tr><td>Governing Law</td><td>Copyright Act 1957, Sections 13-17 (subsistence), 44-50A (registration). Copyright Rules 2013</td></tr>
                        <tr><td>Registry</td><td>Copyright Office, DPIIT (<a href="https://copyright.gov.in" target="_blank" rel="noopener">copyright.gov.in</a>). Registrar of Copyrights</td></tr>
                        <tr><td>Form</td><td>Form XIV with Statement of Particulars and Statement of Further Particulars</td></tr>
                ...
                <p>Gurugram's creative and technology economy produces copyrightable works at industrial scale. IT companies in DLF Cyber City develop SaaS platforms, mobile apps, APIs, and databases - each containing copyrightable source code. Content and media companies on Golf Course Road produce articles, videos, marketing campaigns, and creative assets. D2C brands on Sohna Road create product photographs, packaging designs, and marketing copy. Design agencies deliver logos, illustrations, and brand identity systems. Freelancers in co-working spaces write code, design graphics, compose music, and create educational content. For comprehensive information about <a href="/copyright-registration">copyright registration across India</a>, visit our national service page.</p>
                <p>Every one of these works is automatically protected by copyright. But when an infringer copies your software, republishes your article, or uses your photographs without permission, proving ownership in court requires evidence. A copyright registration certificate from the Copyright Office is the strongest evidence - it is prima facie proof under Section 48, meaning the court accepts it as valid unless the opposing party presents contrary evidence. For Gurugram businesses investing lakhs in content creation and software development, the Rs 500 to Rs 5,000 registration fee is trivial compared to the enforcement advantage it provides. You may also need <a href="/trademark-registration">trademark registration</a> for brand identity protection alongside copyright.</p>
        ...
        <div class="two-column">
            <div class="column-content">
                ...
                <div class="content-text what-is-definition">
                    <p>Copyright registration is the process of formally recording your ownership of an original creative work with the Copyright Office under the Copyright Act 1957. The application (Form XIV) is filed online at copyright.gov.in with a copy of the work, author details, applicant details, and prescribed fee.</p>
                    <p>After a mandatory 30-day waiting period for third-party objections, the Copyright Office examiner scrutinizes the application. If no objection is raised and the application complies with the Act, the Registrar enters the details in the Register of Copyrights and issues a certificate.</p>
                    <p>This certificate serves as prima facie evidence of ownership in all courts and is valid for the author's lifetime plus 60 years. Businesses looking for complete IP protection should consider pairing copyright with <a href="/brand-copyright-registration">brand copyright registration</a> services.</p>
                </div>
                <div class="highlight-box" style="margin-top:20px;">
                    ...
                    <ul>
                        ...
                        <li><strong>Register of Copyrights</strong> - Official register maintained by the Registrar under Section 44</li>
                        <li><strong>Prima Facie Evidence</strong> - Certificate accepted as valid proof unless contrary evidence presented (Section 48)</li>
                        <li><strong>Berne Convention</strong> - International treaty providing automatic recognition in 181+ countries</li>
                        <li><strong>Diary Number</strong> - Tracking reference issued upon filing of Form XIV</li>
                    </ul>
                </div>
            </div>
            <div class="column-image">
                <div class="illustration-placeholder">
                    ...
                    <div class="illustration-badge">
                        <span>Copyright Office DPIIT</span>
                        <strong>Form XIV Registration</strong>
                    </div>
                </div>
            </div>
        </div>
...
<section class="content-section" id="who-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Who Needs Copyright Registration in Gurugram</h2>
            <div class="content-text">
                <ul>
                    <li><strong>Software and IT companies</strong> in DLF Cyber City and Sohna Road building SaaS platforms, mobile applications, APIs, databases, and proprietary algorithms. Software (classified as literary work under Section 2(o)) is one of the most valuable and most frequently infringed categories. Registration requires submitting the first and last 10 pages of source code in PDF format.</li>
                    <li><strong>Authors, writers, and publishers</strong> creating books, articles, research papers, blogs, educational content, scripts, and translations. Literary works are the most commonly registered category. Registration creates an official ownership record that simplifies licensing, syndication, and infringement enforcement.</li>
                    ...
                    <li><strong>Music composers, lyricists, and producers</strong> creating original compositions, background scores, jingles, and audio content. Musical work and sound recording registrations are separate - the composition (musical) and the recording (sound recording) each need registration.</li>
...
<section class="content-section" id="services-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">7 Copyright Registration Services Included</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Service</th><th>What We Do</th></tr></thead>
                    <tbody>
                        <tr><td>Work Category Assessment</td><td>Determining the correct category under Section 13: literary (including software, databases), artistic (photographs, logos), musical, dramatic, cinematograph film, or sound recording. Category determines documentation and fee.</td></tr>
                        <tr><td>Form XIV Preparation and Filing</td><td>Completing Form XIV on copyright.gov.in with title, category, author details, applicant details, date of creation/publication, and work description. Uploading copies and fee payment online.</td></tr>
                        <tr><td>Software Copyright Filing</td><td>Specialized filing for software, SaaS platforms, mobile apps, APIs, and databases. Formatting source code submission (first 10 + last 10 pages). Addressing proprietary information concerns.</td></tr>
                        <tr><td>Objection Period Management</td><td>Monitoring the mandatory 30-day waiting period after filing. Tracking application status via Diary Number. Responding to third-party objections.</td></tr>
                        <tr><td>Certificate Procurement</td><td>Following up with the Copyright Office through examination to certificate issuance. Certificate provides prima facie evidence of ownership under Section 48.</td></tr>
                        <tr><td>Multiple Work Registration</td><td>Batch filing for businesses with multiple copyrightable works - websites (content + code + designs), software companies (multiple products), content companies (article series, video library).</td></tr>
...
<section class="steps-section" id="procedure-section">
    <div class="section-container">
        <header class="section-header" style="text-align:center;margin-bottom:48px;">
            ...
            <h2 class="section-title">How Copyright Registration Works in Gurugram: 6-Step Process</h2>
            <p class="section-subtitle" style="text-align:left;max-width:100%;">Our CA-led team handles the complete copyright registration process with the Copyright Office DPIIT for all six categories under Section 13 of the Copyright Act 1957.</p>
        </header>
        ...
        <div class="highlight-box" style="margin-top:32px;max-width:1000px;margin-left:auto;margin-right:auto;">
            <p><strong>City Processing Note:</strong> Patron's Gurugram office on Golf Course Extension Road handles copyright registration with the Copyright Office for IT companies, content creators, and creative businesses across Gurugram.</p>
        </div>
    </div>
</section>
...
<section class="content-section" id="documents-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Documents Required for Copyright Registration in Gurugram</h2>
            <div class="content-text">
                <ul>
                    <li><strong>Work Copy:</strong> Literary/Software: PDF (software: first 10 + last 10 pages of source code) | Artistic: JPG/PDF | Sound Recording: MP3 | Film: physical copy. File size under 10 MB.</li>
                    <li><strong>Author Identity:</strong> PAN card or Aadhaar card or passport. For companies: Certificate of Incorporation.</li>
...
<section class="content-section" id="challenges-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">5 Common Copyright Registration Challenges in Gurugram</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Challenge</th><th>Impact</th><th>How Patron Accounting Solves It</th></tr></thead>
                    <tbody>
                        <tr><td>Software Source Code Submission Concerns</td><td>IT companies hesitate fearing disclosure of proprietary algorithms</td><td>Strategic guidance on selecting which 10 pages to submit demonstrating originality without exposing core logic. Submissions treated as confidential by Copyright Office.</td></tr>
                        <tr><td>Multiple Copyright Elements in One Product</td><td>Websites contain text (literary), images (artistic), code (software) - each needs separate filing</td><td>Comprehensive copyright strategy identifying all copyrightable elements and prioritizing registration with separate Form XIV for each.</td></tr>
                        <tr><td>Employee vs Contractor Work Ownership</td><td>Under Section 17(c) employer owns employee work, but contractor work needs assignment deed</td><td>Ensure assignment deeds are executed before filing for commissioned works. Verify ownership chain before registration.</td></tr>
                        <tr><td>Proving Creation Date for Unpublished Works</td><td>No publication records for drafts, unreleased software, unpublished designs</td><td>Guide on maintaining timestamped creation records - file metadata, email attachments, version control history for evidence.</td></tr>
                        <tr><td>Delayed Registration After Years of Use</td><td>Gap between creation and registration weakens ownership presumption</td><td>Register as close to creation as possible. For delayed registrations, compile supporting evidence to establish creation timeline.</td></tr>
                    </tbody>
                </table>
                </div>
            </div>
...
<section class="content-section" id="fees-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Copyright Registration Fees in Gurugram 2026</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table class="table-amount">
                    <thead><tr><th>Fee Component</th><th>Amount</th></tr></thead>
                    <tbody>
                        <tr><td>Literary Work (books, articles) - Individual</td><td>Rs 500 per work</td></tr>
                        <tr><td>Literary Work - Company</td><td>Rs 2,000 per work</td></tr>
                        <tr><td>Artistic Work (photos, designs) - Individual</td><td>Rs 500 per work</td></tr>
                        <tr><td>Artistic Work - Company</td><td>Rs 2,000 per work</td></tr>
                        <tr><td>Musical Work (compositions) - Individual</td><td>Rs 500 per work</td></tr>
                        <tr><td>Dramatic Work (scripts) - Individual</td><td>Rs 500 per work</td></tr>
                        <tr><td>Software (source code)</td><td>Rs 500 - Rs 4,000</td></tr>
                        <tr><td>Sound Recording</td><td>Rs 2,000</td></tr>
                        <tr><td>Cinematograph Film</td><td>Rs 5,000</td></tr>
                ...
                <p style="margin-top:16px;">Professional service charges for Form XIV preparation, filing, objection handling, and certificate procurement are separate from the statutory fees. Contact us for a detailed quote.</p>
                <p style="margin-top:16px;"><strong>Get a free Copyright Registration consultation - <a href="tel:+919459456700">Call +91 945 945 6700</a> or <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20help%20with%20Copyright%20Registration%20in%20Gurugram.%20Please%20share%20fee%20details." target="_blank">WhatsApp us</a>. No-obligation assessment.</strong></p>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section" id="timeline-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Copyright Registration Timeline in Gurugram</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    ...
                    <tbody>
                        ...
                        <tr><td>Mandatory 30-Day Objection Waiting Period</td><td>30 days</td></tr>
...
<section class="why-choose-section" id="benefits-section">
    <div class="section-container">
        <div style="text-align:center;margin-bottom:48px;">
            ...
            <h2 class="section-title">Why Choose Patron for Copyright Registration in Gurugram</h2>
        </div>
        <div class="features-grid">
            <article class="feature-card">
                ...
                <h3 class="feature-title">6-Category Expertise</h3>
                <p class="feature-text">Specialized filing for all six categories under Section 13 - literary, artistic, musical, dramatic, film, and sound recording - with software source code expertise.</p>
            </article>
            <article class="feature-card">
                ...
                <h3 class="feature-title">Pre-Filing IP Strategy</h3>
                <p class="feature-text">Identify all copyrightable elements in your business, select correct categories, ensure assignment deeds exist for contractor works before filing.</p>
            </article>
            <article class="feature-card">
                ...
                <h3 class="feature-title">International Coverage</h3>
                <p class="feature-text">Berne Convention advisory for 181+ countries automatic recognition. WIPO Copyright Treaty guidance for digital rights. No separate international filing needed.</p>
            </article>
            <article class="feature-card">
                <div class="feature-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg></div>
                <h3 class="feature-title">Integrated IP Services</h3>
                <p class="feature-text">Copyright registration integrated with assignment, disclaimer, and objection handling - complete IP lifecycle management from Gurugram office.</p>
            </article>
            <article class="feature-card">
                ...
                <p class="feature-text">Strategic source code submission guidance for IT companies - demonstrate originality without exposing proprietary logic. Confidential handling ensured.</p>
            </article>
            <article class="feature-card">
                ...
                <h3 class="feature-title">Batch Filing for Portfolios</h3>
                <p class="feature-text">Multiple work registration for software companies, content creators, and design agencies - systematic IP portfolio building with separate filings per work.</p>
            </article>
        </div>
    </div>
</section>
...
<section class="content-section" id="comparison-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Copyright Categories and Registration Details</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table class="table-comparison">
                    <thead><tr><th>Category</th><th>Examples</th><th>Section</th><th>Format</th><th>Validity</th><th>Fee (Individual)</th></tr></thead>
                    <tbody>
                        <tr><td>Literary</td><td>Books, articles, software</td><td>S2(o)</td><td>PDF</td><td>Life + 60 yrs</td><td>Rs 500</td></tr>
                        <tr><td>Artistic</td><td>Photos, logos, designs</td><td>S2(c)</td><td>JPG/PDF</td><td>Life + 60 yrs</td><td>Rs 500</td></tr>
                        <tr><td>Musical</td><td>Compositions, notations</td><td>S2(p)</td><td>PDF</td><td>Life + 60 yrs</td><td>Rs 500</td></tr>
                        <tr><td>Dramatic</td><td>Scripts, choreography</td><td>S2(h)</td><td>PDF</td><td>Life + 60 yrs</td><td>Rs 500</td></tr>
                        <tr><td>Film</td><td>Movies, documentaries</td><td>S2(f)</td><td>Physical</td><td>60 yrs from pub</td><td>Rs 5,000</td></tr>
                        <tr><td>Sound Recording</td><td>Music, podcasts, audio</td><td>S2(xx)</td><td>MP3</td><td>60 yrs from pub</td><td>Rs 2,000</td></tr>
                    </tbody>
                </table>
                </div>
...
<section class="content-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>Copyright registration in India is governed by the <strong>Copyright Act 1957</strong> and the <strong>Copyright Rules 2013</strong>. Section 13 defines six categories of copyrightable works: literary (including computer programs under Section 2(o)), artistic, musical, dramatic, cinematograph films, and sound recordings. Sections 44 to 50A govern the registration process, including Form XIV filing, the Register of Copyrights, and the Registrar's powers.</p>
                <p>Section 48 provides that a certificate of registration shall be prima facie evidence of the particulars entered therein. Section 17 establishes the first owner of copyright - generally the author, except for works made during employment (Section 17(c)) where the employer is the first owner. The Copyright (Amendment) Act 2012 strengthened protections for performers and authors.</p>
                <p>India's membership in the Berne Convention (1886, India joined 1928), the Universal Copyright Convention, and TRIPS (WTO) ensures international recognition. The WIPO Copyright Treaty (WCT) and WIPO Performances and Phonograms Treaty (WPPT) provide additional protections for digital rights. Copyright registration with the Copyright Office at <a href="https://copyright.gov.in" target="_blank" rel="noopener">copyright.gov.in</a> is administered by the Department for Promotion of Industry and Internal Trade (DPIIT). IP enforcement in Gurugram falls under the jurisdiction of the Delhi High Court.</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    <h2 class="faq-expanded__title">FAQs - Copyright Registration in Gurugram</h2>
                    <p class="faq-expanded__lead">Answers to common questions about copyright registration process, fees, timeline, and international protection for Gurugram businesses.</p>
                    @include('partials.faq-enquiry-form', ['enquiryLocation' => 'Gurugram', 'enquiryService' => 'Copyright Registration in Gurugram'])
                </aside>
                <div class="faq-expanded__list">
                    <div class="faq-expanded__item" id="faq-1">
                        <h3 class="faq-expanded__q">Is copyright registration mandatory in India?</h3>
                        <div class="faq-expanded__a"><p>No. Copyright protection arises automatically when you create an original work under the Copyright Act 1957. Registration is optional. However, a registration certificate provides prima facie evidence of ownership under Section 48, creates a public record in the Register of Copyrights, and significantly strengthens enforcement in infringement disputes. For Gurugram businesses with valuable IP, registration is strongly recommended.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-2">
                        <h3 class="faq-expanded__q">How much does copyright registration cost in Gurugram?</h3>
                        <div class="faq-expanded__a"><p>Government fees: Rs 500 per work for literary, artistic, musical, and dramatic works (individuals). Rs 2,000 per work for companies. Sound recordings: Rs 2,000. Software: Rs 500 to Rs 4,000. Films: Rs 5,000. Professional fee: Rs 3,000 to Rs 8,000 (Form XIV preparation, filing, objection handling, certificate procurement). Total: Rs 3,500 to Rs 13,000 per work. Call +91 945 945 6700 for a detailed quote.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-3">
                        <h3 class="faq-expanded__q">How long does copyright registration take?</h3>
                        <div class="faq-expanded__a"><p>Total timeline: 2-6 months. Filing and Diary Number: immediate. Mandatory 30-day objection waiting period: 1 month. Examination by Copyright Office: 1-3 months. Certificate issuance: after examination approval. If a third-party objection is filed, the timeline extends by 2-4 months for hearing and resolution.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-4">
                        <h3 class="faq-expanded__q">Can software and mobile apps be copyrighted?</h3>
                        <div class="faq-expanded__a"><p>Yes. Software (including source code, object code, and databases) is classified as literary work under Section 2(o) of the Copyright Act. Mobile apps can have multiple copyrightable elements: source code (literary), UI/UX designs (artistic), text content (literary), and in-app audio/video. Each element can be registered separately. For software registration, submit a PDF with the first and last 10 pages of source code.</p></div>
                    </div>
                    ...
                    <div class="faq-expanded__item" id="faq-6">
                        ...
                        <div class="faq-expanded__a"><p>Copyright protects original creative works (books, software, photographs, music, films) under the Copyright Act 1957. It exists automatically and lasts for the author's lifetime plus 60 years. Trademark protects brand identity (names, logos, taglines) under the Trade Marks Act 1999. It requires registration and is valid for 10 years (renewable). A logo can be protected as both artistic work (copyright) and device mark (trademark).</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-7">
                        <h3 class="faq-expanded__q">Does Indian copyright work internationally?</h3>
                        <div class="faq-expanded__a"><p>Yes. India is a member of the Berne Convention (181+ countries), the Universal Copyright Convention, and TRIPS (WTO). Your copyright registered in India is automatically recognized in all Berne Convention countries without separate filing. This means a Gurugram software company's registered copyright is enforceable in the US, EU, UK, and most other jurisdictions.</p></div>
                    </div>
                </div>
            </div>
            ...
            <div class="highlight-box" style="margin-top:32px;">
                ...
                <p><strong>Registration zaroori hai kya?</strong> Mandatory nahi hai - copyright creation pe automatic milta hai. Lekin registration se court mein proof strong hota hai (Section 48 prima facie evidence). Rs 500-5,000 mein lifetime + 60 years protection. Worth it.</p>
                <p><strong>Software ka copyright hota hai?</strong> Haan. Software 'literary work' hai Copyright Act mein. Source code ke first 10 + last 10 pages PDF mein submit karo. Rs 500-4,000 fees. Mobile app ke code, UI design, content sab alag-alag register ho sakte hain.</p>
                <p><strong>Kitna time lagta hai?</strong> 2-6 mahine. Filing turant. 30-din objection period. 1-3 mahine examination. Certificate approval ke baad milta hai. Objection aaye toh 2-4 mahine extra.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section" style="background: var(--orange-lighter) !important; border-left: 4px solid var(--orange);">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Why Copyright Registration Matters for Gurugram Businesses</h2>
            <div class="content-text">
                <p>A Gurugram SaaS company with Rs 5 crore ARR discovers its core codebase being used by a competitor started by former employees. Without copyright registration, the company must prove ownership through circumstantial evidence - a process that takes months and costs lakhs in legal fees. With a copyright registration certificate, the company presents prima facie proof of ownership on day one of litigation, obtains an ex parte injunction within days, and the competitor is legally stopped. The Rs 4,000 software registration fee versus Rs 10-20 lakh in extended litigation costs makes registration the most cost-effective IP investment a Gurugram tech company can make.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section" style="background: var(--blue) !important;">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title" style="color:#FFFFFF !important;">Start Your Copyright Registration in Gurugram Today</h2>
            <div class="content-text" style="text-align:left;">
                <p style="color:rgba(255,255,255,0.85);">Copyright registration in Gurugram provides prima facie evidence of ownership for software, literary works, artistic designs, photographs, music, films, and sound recordings - the strongest IP protection for creative and technology businesses at fees starting from Rs 500 per work.</p>
                <p style="color:rgba(255,255,255,0.85);">Patron Accounting's Gurugram office on Golf Course Extension Road handles copyright registration with the Copyright Office for all six categories, integrated with assignment, disclaimer, and objection services for complete IP lifecycle management.</p>
            ...
            <div style="display:flex;gap:14px;flex-wrap:wrap;margin-top:24px;">
                ...
                <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20help%20with%20Copyright%20Registration%20in%20Gurugram.%20Please%20share%20details." target="_blank" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:#25D366;color:#fff;border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#128172; WhatsApp Us</a>
                <a href="mailto:sales@patronaccounting.com?subject=Enquiry%20for%20Copyright%20Registration%20in%20Gurugram&body=Hello%20Patron%20Accounting%20Team%2C%0A%0AI%20am%20interested%20in%20your%20Copyright%20Registration%20services%20in%20Gurugram%20and%20would%20like%20to%20know%20more.%0A%0APlease%20get%20in%20touch%20with%20me%20at%20your%20earliest%20convenience.%0A%0AThank%20you." style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:transparent;color:#fff;border:2px solid rgba(255,255,255,0.3);border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#9993;&#65039; Email Us</a>
            </div>
...
<section class="content-section" style="padding:48px 32px;background:var(--gray-50);">
    <div class="content-container">
        <div class="text-content">
            ...
            <p style="text-align:center;color:var(--text-muted);font-size:15px;margin-bottom:40px;">Copyright registration services available in major cities across India with local office support.</p>
            ...
            <div class="pa-city-block">
                ...
                <div class="pa-block-sub">End-to-end support for Copyright Registration in Gurugram</div>
...
<section class="content-section" style="padding:32px;">
    <div class="content-container">
        <div class="text-content" style="font-size:13px;color:var(--text-muted);">
            ...
            <p>This page is reviewed quarterly for accuracy. Copyright Act provisions, fee schedules, and Copyright Office processes are verified against official government notifications and updated when changes occur. Gurugram-specific information including jurisdictional offices and local business context is validated with each review.</p>
        </div>
    </div>
</section>
