...
@section('meta')
    ...
    <meta property="og:image" content="/images/drug-license/chennai-og.webp">
    ...
    <meta name="twitter:image" content="/images/drug-license/chennai-og.webp">
@endsection
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20a%20drug%20license%20in%20Chennai.%20Please%20share%20details." target="_blank" class="btn-sample text-decoration-none">
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - Drug License in Chennai'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="drug-license/chennai" selected>Drug License in Chennai</option><option value="gst-registration/chennai">GST Registration in Chennai</option><option value="fssai-registration/chennai">FSSAI Registration in Chennai</option><option value="trademark-registration/chennai">Trademark Registration in Chennai</option><option value="accounting-services/chennai">Accounting Services in Chennai</option><option value="income-tax-return/chennai">Income Tax Return Filing in Chennai</option><option value="other">Other</option>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p style="margin-top:16px;"><strong>Get a free Drug License in Chennai consultation - <a href="tel:+919459456700">Call +91 945 945 6700</a> or <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20a%20drug%20license%20in%20Chennai.%20Please%20share%20a%20free%20consultation." target="_blank">WhatsApp us</a>. No-obligation assessment.</strong></p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    ...
                    @include('partials.faq-enquiry-form', ['enquiryLocation' => 'Chennai', 'enquiryService' => 'Drug License in Chennai'])
                </aside>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>Operating a pharmacy without a drug license is a criminal offence under Section 27 of the D&C Act 1940 - imprisonment up to 3 years. Drug Inspectors conduct regular surprise inspections across Chennai zones. Platforms like PharmEasy and Netmeds require valid drug license numbers for onboarding. Every day your pharmacy operates without a license is a day of criminal liability and lost platform revenue.</p><p><strong><a href="tel:+919459456700">Call +91 945 945 6700</a> or <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20a%20drug%20license%20in%20Chennai." target="_blank">WhatsApp us</a> to start your drug license application today.</strong></p>
