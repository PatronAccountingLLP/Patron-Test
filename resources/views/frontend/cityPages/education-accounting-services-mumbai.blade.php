...
@section('meta')
    ...
    <link rel="canonical" href="/education-accounting-services/mumbai">
    ...
    <meta property="og:url" content="/education-accounting-services/mumbai">
    <meta property="og:type" content="website">
    <meta property="og:site_name" content="Patron Accounting">
    <meta property="og:image" content="/images/education-accounting-services/mumbai-og.webp">
    ...
    <meta name="twitter:image" content="/images/education-accounting-services/mumbai-og.webp">
@endsection
  ...
  "@graph": [
    {
      ...
      "url": "/education-accounting-services/mumbai",
    ...
    },
    {
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "item": "https://www.patronaccounting.com/education-accounting-services"
        },
        {
          "@type": "ListItem",
          "position": 3,
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20education%20accounting%20services%20in%20Mumbai.%20Please%20call%20me." target="_blank" class="btn-sample text-decoration-none">
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - Education Accounting in Mumbai'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="education-accounting-services/mumbai" selected>Education Accounting in Mumbai</option><option value="accounting-services/mumbai">Accounting Services in Mumbai</option><option value="statutory-audit/mumbai">Statutory Audit in Mumbai</option><option value="ngo-registration">NGO Registration</option><option value="tds-return-filing">TDS Returns</option><option value="internal-audit">Internal Audit</option><option value="other">Other</option>
...
<section class="testimonials-section">
    <div class="section-container">
        ...
        -->
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;"><div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div><div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Patron completed our trust audit 30 days before the ITR-7 deadline. Form 10B filed, IX-C submitted to Charity Commissioner, and the 85% application was verified line by line. We had an IT scrutiny last year - zero issues found because the documentation was thorough. PTRC also filed by 15th every month.</div><div style="display:flex;align-items:center;gap:10px;margin-top:16px;"><div style="width:36px;height:36px;border-radius:50%;background:var(--orange);display:flex;align-items:center;justify-content:center;font-weight:700;font-size:13px;color:#fff;flex-shrink:0;">PR</div><div><div style="font-weight:700;font-size:13px;color:var(--blue);">Principal</div><div style="font-size:12px;color:var(--text-muted);margin-top:2px;">ICSE School, South Mumbai</div><div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div></div><div style="margin-left:auto;font-size:11px;color:var(--text-muted);">1 month ago</div></div></div><div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;"><div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div><div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Our Mumbai University college had UGC grant accounting, hostel fund management, and exam fee tracking all tangled up. Patron restructured our chart of accounts, set up proper grant tracking, and now our I&amp;E statement is clean enough for any audit. The RTE fee refund reconciliation alone saved us from a major audit observation.</div><div style="display:flex;align-items:center;gap:10px;margin-top:16px;"><div style="width:36px;height:36px;border-radius:50%;background:var(--blue);display:flex;align-items:center;justify-content:center;font-weight:700;font-size:13px;color:#fff;flex-shrink:0;">RG</div><div><div style="font-weight:700;font-size:13px;color:var(--blue);">Registrar</div><div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Degree College, Vile Parle</div><div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div></div><div style="margin-left:auto;font-size:11px;color:var(--text-muted);">2 months ago</div></div></div><div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;"><div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div><div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">We were confused about GST on our coaching institute in Andheri. Patron clarified that coaching is 18% GST (not exempt like schools), set up proper GST accounting, and now our returns are filed correctly. They also identified that our transport service was outsourced (5% GST) not direct (exempt) - saved us from a potential demand notice.</div><div style="display:flex;align-items:center;gap:10px;margin-top:16px;"><div style="width:36px;height:36px;border-radius:50%;background:#0D9488;display:flex;align-items:center;justify-content:center;font-weight:700;font-size:13px;color:#fff;flex-shrink:0;">DR</div><div><div style="font-weight:700;font-size:13px;color:var(--blue);">Director</div><div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Coaching Institute, Andheri</div><div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div></div><div style="margin-left:auto;font-size:11px;color:var(--text-muted);">3 months ago</div></div></div><div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;"><div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div><div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Our school receives foreign donations through FCRA. Patron maintains the separate designated SBI account, tracks utilisation per project, and files Form FC-4 by 30 June every year. The FCRA compliance was the part our previous CA couldn't handle. Patron's education trust expertise made the difference.</div><div style="display:flex;align-items:center;gap:10px;margin-top:16px;"><div style="width:36px;height:36px;border-radius:50%;background:#7C3AED;display:flex;align-items:center;justify-content:center;font-weight:700;font-size:13px;color:#fff;flex-shrink:0;">TR</div><div><div style="font-weight:700;font-size:13px;color:var(--blue);">Trustee</div><div style="font-size:12px;color:var(--text-muted);margin-top:2px;">International School, Bandra</div><div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div></div><div style="margin-left:auto;font-size:11px;color:var(--text-muted);">2 months ago</div></div></div>
    </div>
        <div class="reviews-cta" style="margin-top: 16px; display: flex !important;">
            <div class="reviews-cta-content">
                ...
                <div class="reviews-cta-text">
                    ...
                    <p>CA-led education accounting with trust audit, Form 10B, Charity Commissioner IX-C, and GST advisory for Mumbai schools and colleges.</p>
                </div>
            </div>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p style="margin-top:16px;"><strong>Get a free Education Accounting in Mumbai consultation - <a href="tel:+919459456700">Call +91 945 945 6700</a> or <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20education%20accounting%20in%20Mumbai.%20Please%20call%20me." target="_blank">WhatsApp us</a>. No-obligation assessment.</strong></p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    ...
                    @include('partials.faq-enquiry-form', ['enquiryLocation' => 'Mumbai', 'enquiryService' => 'Education Accounting in Mumbai'])
                </aside>
