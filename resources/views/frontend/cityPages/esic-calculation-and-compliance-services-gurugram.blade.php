...
@section('meta')
    ...
    <link rel="canonical" href="/esic-calculation-and-compliance-services/gurugram">
    ...
    <meta property="og:url" content="/esic-calculation-and-compliance-services/gurugram">
    <meta property="og:type" content="website">
    <meta property="og:site_name" content="Patron Accounting">
    <meta property="og:image" content="/images/esic-calculation-compliance-gurugram-og.webp">
    ...
    <meta name="twitter:image" content="/images/esic-calculation-compliance-gurugram-og.webp">
@endsection
  ...
  "@graph": [
    {
      ...
      "url": "https://www.patronaccounting.com/esic-calculation-and-compliance-services/gurugram",
    ...
    },
    {
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "position": 3,
          "name": "ESIC Calculation & Compliance Gurugram - Returns & Wages",
          "item": "https://www.patronaccounting.com/esic-calculation-and-compliance-services/gurugram"
        }
      ]
    },
    {
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-4 private-registration-heading">
                        ESIC Calculation & Compliance in Gurugram: Medical Care and Social Security for Your Workforce
                    </h1>
                    ...
                    <div class="mb-4">
                        <div class="d-flex align-items-start mb-3">
                            ...
                            <p class="mb-0 text-dark benefit-paragraph"><span>Documents:</span> PAN, incorporation certificate, GST, bank details, employee details (Aadhaar, wages, DOJ)</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Fees:</span> Registration: No govt fee. Professional: Rs 3,999-7,999. Monthly: Rs 1,500-5,000/month</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Eligibility:</span> Mandatory for 10+ employees. Wages up to Rs 21,000/month. All establishment types</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Timeline:</span> Registration: 3-7 days online. Monthly deposit by 15th. Half-yearly returns</p>
                        </div>
                    </div>
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="mailto:sales@patronaccounting.com?subject=Enquiry%20for%20ESIC%20Compliance%20in%20Gurugram&body=Hello%20Patron%20Accounting%20Team%2C%0A%0AI%20am%20interested%20in%20your%20ESIC%20Compliance%20services%20in%20Gurugram%20and%20would%20like%20to%20know%20more.%0A%0APlease%20get%20in%20touch%20with%20me%20at%20your%20earliest%20convenience.%0A%0AThank%20you." class="btn-sample text-decoration-none">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:18px;height:18px;"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,12 2,6"/></svg>
                            Email Us
                        </a>
                        <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20help%20with%20ESIC%20Compliance%20in%20Gurugram.%20Please%20share%20details." target="_blank" class="btn-sample text-decoration-none">
...
<section class="testimonials-section">
    <div class="section-container">
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            ...
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Patron registered us for ESIC the week we hired our 10th employee. Monthly calculations accurate, challans generated on time, Pehchan cards issued for all staff. When an employee needed maternity benefit, Patron processed the claim seamlessly. Essential employer service.</div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Our factory was not ESI registered for 8 months. Patron regularised us, handled the backdated demand negotiation, and set up monthly compliance. The penalty was significantly less than it could have been thanks to their professional handling of the ESIC inspection.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Patron handles ESI, PF, and payroll together for our 25-employee office. One team, one process, zero compliance gaps. They caught that we were excluding HRA from ESI wages - corrected before the inspector found it. Proactive approach.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Our restaurant staff didn't know about ESIC hospital benefits. Patron issued Pehchan cards for all 15 employees and mapped the nearest ESIC dispensary. Two employees have since used ESIC medical care. Awareness makes the benefit real.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">We were calculating ESI on basic only, missing HRA and special allowance. Patron corrected the calculation, filed revised returns, and prevented what would have been a substantial demand notice during inspection. Accurate calculation prevents penalties.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                <div style="width:36px;height:36px;border-radius:50%;background:var(--orange);display:flex;align-items:center;justify-content:center;font-weight:700;font-size:13px;color:#fff;flex-shrink:0;">MY</div>
                <div>
                    <div style="font-weight:700;font-size:13px;color:var(--blue);">Manish Yadav</div>
...
<div class="stats-bar">
    <div class="stats-container">
        <div class="stat-item">
            ...
            <div class="stat-content"><span class="stat-value">10,000+</span><span class="stat-label">Businesses Served</span><span class="stat-desc">ESIC compliance and social security across India.</span></div>
        </div>
        <div class="stat-item">
            <div class="stat-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8M12 17v4"/></svg></div>
            <div class="stat-content"><span class="stat-value">15+</span><span class="stat-label">Years Experience</span><span class="stat-desc">Deep expertise in ESI calculation, compliance, and benefit management.</span></div>
        </div>
        <div class="stat-item">
            <div class="stat-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><path d="M14 2v6h6M16 13H8M16 17H8"/></svg></div>
            <div class="stat-content"><span class="stat-value">50,000+</span><span class="stat-label">Documents Filed</span><span class="stat-desc">ESIC registrations, monthly challans, and compliance documents handled.</span></div>
        </div>
        <div class="stat-item">
...
<section class="content-section" id="overview-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Why ESIC Matters for Gurugram Businesses</h2>
            <div class="content-text">
                <div class="highlight-box" style="margin-bottom:20px;">
                    <p><strong>&#128204; TL;DR - ESIC Compliance Services at a Glance</strong></p>
                    <p>The Employees' State Insurance scheme under the ESI Act 1948 is a self-financing social security system providing medical care, sickness benefits, maternity benefits, disablement benefits, and dependent benefits. Mandatory for non-seasonal establishments with 10+ employees in Gurugram. Employees earning up to Rs 21,000/month covered. Employee contribution: 0.75% of wages. Employer: 3.25%. Total: 4%. Deposit by 15th. Benefits: comprehensive medical at ESIC hospitals, sickness benefit (70%, 91 days), maternity (26 weeks), disablement (90%), dependent benefit (90%), funeral (Rs 15,000). Penalties: 1-3 years imprisonment, 12% interest, 25% damages.</p>
                </div>
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Parameter</th><th>Detail</th></tr></thead>
                    <tbody>
                        <tr><td>Governing Law</td><td>ESI Act 1948 | Code on Social Security 2020 (ESI provisions from Nov 2025)</td></tr>
                        <tr><td>Authority</td><td>ESIC under Ministry of Labour & Employment. Portal: <a href="https://esic.gov.in" target="_blank" rel="noopener">esic.gov.in</a></td></tr>
                        <tr><td>Applicability</td><td>Non-seasonal establishments with 10+ employees (Haryana). All commercial establishments</td></tr>
                        <tr><td>Employee Coverage</td><td>Monthly wages up to Rs 21,000 (Rs 25,000 disabled). Basic+DA+HRA+allowances</td></tr>
                        <tr><td>Employee Contribution</td><td>0.75% of wages (exempted if daily avg wage up to Rs 176)</td></tr>
                        <tr><td>Employer Contribution</td><td>3.25% of wages (pays even if employee exempted)</td></tr>
                        <tr><td>Deposit Deadline</td><td>15th of following month. Online or authorized bank branches</td></tr>
                        <tr><td>Penalties</td><td>Late: 12% interest. 6+ months: 25% damages. Non-payment: 1-3 years imprisonment</td></tr>
                    </tbody>
                </table>
                </div>
                <p>Gurugram has a massive ESI-eligible workforce. IT companies in DLF Cyber City with junior developers, QA, and support staff within the wage ceiling. Manufacturing units in Udyog Vihar and Manesar with factory workforces. Restaurants and hospitality businesses with service staff. Even startups cross the 10-employee threshold quickly. For comprehensive information about <a href="/esic-calculation-and-compliance-services">ESIC compliance across India</a>, visit our national service page.</p>
                <p>ESIC calculation is the application of 0.75% (employee) and 3.25% (employer) to ESI wages (basic+DA+HRA+allowances, excluding conveyance allowance). Employer deposits both shares by the 15th. You will also need <a href="/pf-registration">PF registration</a> (20+ employees) and <a href="#">POSH compliance</a> (10+ employees) for complete employer obligations.</p>
        ...
        <div class="two-column">
            <div class="column-content">
                ...
                <div class="content-text what-is-definition">
                    <p>ESIC calculation and compliance is the process of registering with ESIC, computing monthly contributions for each eligible employee (wages up to Rs 21,000), depositing by the 15th, and filing half-yearly returns - providing comprehensive medical and social security coverage.</p>
                    <p>Employee contribution: 0.75% of wages. Employer: 3.25%. Total: 4%. ESI wages include basic+DA+HRA+all allowances except conveyance. Each employee gets an IP number and Pehchan card for accessing ESIC hospitals and benefits.</p>
                    <p>Benefits: free medical care at ESIC hospitals, sickness benefit (70% wages), maternity (26 weeks), disablement (90%), dependent benefit (90%). For complete employer compliance, pair ESIC with <a href="/pf-registration">PF registration</a> and <a href="/payroll-services">payroll services</a>.</p>
                </div>
                <div class="highlight-box" style="margin-top:20px;">
                    <p><strong>Key Terms for Copyright Registration:</strong></p>
                    <ul>
                        <li><strong>ESI Act 1948</strong> - Law mandating social security for 10+ employee establishments</li>
                        <li><strong>Contribution Period</strong> - Two 6-month periods determining coverage eligibility</li>
                        <li><strong>ESI Wages</strong> - Base for calculating 4% contribution (excl. conveyance)</li>
                        <li><strong>Pehchan Card</strong> - ESIC ID for hospital and dispensary access</li>
                        <li><strong>IP Number</strong> - Insurance Person number for each covered employee</li>
                    </ul>
                </div>
            </div>
...
<section class="content-section" id="who-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Who Needs ESIC Compliance in Gurugram</h2>
            <div class="content-text">
                <ul>
                    <li><strong>IT companies in DLF Cyber City</strong> with 10+ employees. Junior developers, QA staff, support, interns, and contract workers often fall within the Rs 21,000 wage ceiling and must be covered.</li>
                    <li><strong>Manufacturing units in Udyog Vihar and Manesar</strong> with factory workforces. Most factory workers earn within the Rs 21,000 ceiling. Highest ESI-eligible employee percentage.</li>
                    ...
                    <li><strong>Retail shops, salons, clinics</strong> with 10+ employees. These often cross the threshold without realizing ESI triggers immediately.</li>
...
<section class="content-section" id="services-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">6 ESIC Compliance Services Included</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Service</th><th>What We Do</th></tr></thead>
                    <tbody>
                        <tr><td>ESIC Registration</td><td>Registering on esic.gov.in or Unified Shram Suvidha Portal. Establishment details, employee info, wage data. 17-digit ESIC code. Within 15 days of crossing 10 employees.</td></tr>
                        <tr><td>Monthly Contribution Calculation</td><td>Computing ESI per employee: identifying ESI wages, applying 0.75% employee + 3.25% employer, generating challan, depositing by 15th.</td></tr>
                        <tr><td>Half-Yearly Return Filing</td><td>April-September return by 12th November. October-March by 12th May. Reconciling contributions, employee changes, wage updates.</td></tr>
                        <tr><td>IP Number and Pehchan Card</td><td>Generating IP numbers for each covered employee. Facilitating Pehchan card issuance for ESIC hospital access.</td></tr>
                        <tr><td>Benefit Claim Support</td><td>Assisting with sickness (70% wages), maternity (26 weeks), disablement (90%), dependent benefit claims through ESIC portal.</td></tr>
                        <tr><td>Penalty Prevention</td><td>Proactive deposit by 15th. Reconciliation to prevent short payments. Handling inspections and Section 45A proceedings.</td></tr>
...
<section class="steps-section" id="procedure-section">
    <div class="section-container">
        <header class="section-header" style="text-align:center;margin-bottom:48px;">
            ...
            <h2 class="section-title">How ESIC Compliance Works in Gurugram: 5-Step Process</h2>
            <p class="section-subtitle" style="text-align:left;max-width:100%;">Our CA-led team handles ESIC registration, monthly calculation, challan, returns, Pehchan card, and penalty prevention for Gurugram employers.</p>
        </header>
        <div class="steps-container">
            <div class="step-card">
                <div class="step-content">
                    <span class="step-badge">Step 1</span>
                    <h3 class="step-title">Register on ESIC Portal</h3>
                    <p class="step-description">Register on esic.gov.in within 15 days of crossing 10 employees. File establishment details, employee wages, bank account. Obtain 17-digit ESIC code.</p>
                    <div class="step-highlights">
                        ...
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>ESIC Code</span>
                    </div>
                </div>
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <p class="step-description">Identify ESI wages per employee (basic+DA+HRA+allowances, exclude conveyance). Apply 0.75% employee + 3.25% employer. Generate challan.</p>
                    <div class="step-highlights">
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>0.75%+3.25%</span>
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Computed</span>
                    </div>
                </div>
                <div class="step-visual">
                    <div class="step-illustration">
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">Deposit by 15th</h3>
                    <p class="step-description">Deposit combined employer and employee contribution by 15th of following month. Online through ESIC portal or authorized bank branches.</p>
                    <div class="step-highlights">
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>By 15th</span>
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">Issue IP Numbers and Pehchan Cards</h3>
                    <p class="step-description">Generate IP numbers for each covered employee. Facilitate Pehchan card issuance for ESIC hospital access. Inform employees of nearest ESIC facility.</p>
                    <div class="step-highlights">
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>IP Numbers</span>
                ...
                <div class="step-visual">
                    <div class="step-illustration">
                        ...
                        <span class="illustration-label">Cards Done</span>
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">File Half-Yearly Returns</h3>
                    <p class="step-description">April-September return by 12th November. October-March by 12th May. Reconcile contributions, additions, exits, wage changes.</p>
                    <div class="step-highlights">
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <p class="step-description">Monthly deposits. New employee enrollment. Benefit claim facilitation. Inspection readiness. Penalty prevention. Integrate with PF and payroll.</p>
                    <div class="step-highlights">
                        ...
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Integrated</span>
                    </div>
                </div>
                <div class="step-visual">
                    <div class="step-illustration">
                        ...
                        <span class="illustration-label">Running</span>
        ...
        <div class="highlight-box" style="margin-top:32px;max-width:1000px;margin-left:auto;margin-right:auto;">
            <p><strong>City Processing Note:</strong> Patron's Gurugram office on Golf Course Extension Road handles ESIC registration, monthly compliance, and integrated payroll for employers across Gurugram.</p>
        </div>
    </div>
</section>
...
<section class="content-section" id="documents-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Documents Required for ESIC Compliance in Gurugram</h2>
            <div class="content-text">
                <ul>
                    <li><strong>Business Registration:</strong> Certificate of Incorporation / LLP / Partnership Deed / GST certificate / PAN.</li>
                    <li><strong>Bank Details:</strong> Cancelled cheque or bank statement for ESI deposit setup.</li>
                    <li><strong>Employee Details:</strong> List with Aadhaar, DOB, DOJ, monthly wages breakdown, nominee details for each employee.</li>
                    <li><strong>Additional:</strong> Registered address proof | Nature of business | Employee count | Wage registers.</li>
                </ul>
            </div>
        </div>
    </div>
...
<section class="content-section" id="challenges-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">5 Common ESIC Challenges in Gurugram</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Challenge</th><th>Impact</th><th>How Patron Accounting Solves It</th></tr></thead>
                    <tbody>
                        <tr><td>Not Registering at 10 Employees</td><td>Restaurant with 12 employees does not register. ESIC inspector visits. Backdated demand + interest + damages</td><td>Register within 15 days of crossing 10 employees. Backdated demand plus 12% interest plus 25% damages for delay. Register proactively.</td></tr>
                        <tr><td>Wrong Wage Components</td><td>IT company calculates ESI on basic only, excluding HRA, special allowance, overtime</td><td>ESI wages include ALL components except conveyance. Short payment leads to demand notice, interest, damages. Calculate on complete wages.</td></tr>
                        <tr><td>Contribution Period Crossing</td><td>Employee gets raise to Rs 23,000 mid-period. Employer stops ESI. Employee remains covered until period end</td><td>Coverage continues until the current contribution period ends (September 30 or March 31). Do not stop ESI mid-period.</td></tr>
                        <tr><td>Deposit After 15th</td><td>Cash flow issues cause employer to delay monthly ESI deposit past the 15th</td><td>12% interest from the 16th automatically. Repeated delays attract prosecution. Never delay ESI deposits.</td></tr>
                        <tr><td>Employees Unaware of Benefits</td><td>Employees visit private clinics paying out-of-pocket when entitled to free ESIC care</td><td>Issue Pehchan cards and inform of nearest ESIC facility. Map ESIC Hospital Gurugram. Awareness makes the benefit real.</td></tr>
                    </tbody>
                </table>
                </div>
            </div>
...
<section class="content-section" id="fees-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">ESIC Compliance Fees in Gurugram 2026</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table class="table-amount">
                    <thead><tr><th>Fee Component</th><th>Amount</th></tr></thead>
                    <tbody>
                        <tr><td>ESIC Registration</td><td>Rs 3,999-7,999 professional (govt: free)</td></tr>
                        <tr><td>Monthly Compliance</td><td>Rs 1,500-5,000/month</td></tr>
                        <tr><td>Half-Yearly Return</td><td>Rs 2,000-4,000/return</td></tr>
                        <tr><td>Pehchan Card (per employee)</td><td>Rs 500-1,000</td></tr>
                        <tr><td>ESI + PF + Payroll Bundle</td><td>Rs 5,000-12,000/month</td></tr>
                        <tr><td>Inspection/Notice Response</td><td>Rs 5,000-15,000</td></tr>
                ...
                <p style="margin-top:16px;">No government registration fee. Monthly ESI contribution (4%) is the ongoing cost. Professional fees cover registration, calculation, challan generation, and return filing.</p>
                <p style="margin-top:16px;"><strong>Get a free Copyright Registration consultation - <a href="tel:+919459456700">Call +91 945 945 6700</a> or <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20help%20with%20ESIC%20Compliance%20in%20Gurugram.%20Please%20share%20fee%20details." target="_blank">WhatsApp us</a>. No-obligation assessment.</strong></p>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section" id="timeline-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">ESIC Compliance Timeline in Gurugram</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Stage</th><th>Estimated Timeline</th></tr></thead>
                    <tbody>
                        <tr><td>ESIC Registration</td><td>3-7 working days online</td></tr>
                        <tr><td>IP Number Generation</td><td>Within 1-3 days of registration</td></tr>
                        <tr><td>Pehchan Card Issuance</td><td>2-4 weeks from IP number</td></tr>
                        <tr><td>Monthly Deposit Deadline</td><td>15th of following month</td></tr>
                        <tr><td>Half-Yearly Return (Apr-Sep)</td><td>By 12th November</td></tr>
                        <tr><td>Half-Yearly Return (Oct-Mar)</td><td>By 12th May</td></tr>
                        <tr><td>Registration Deadline</td><td>Within 15 days of crossing 10 employees</td></tr>
                    </tbody>
                </table>
                </div>
                <div class="highlight-box" style="margin-top:16px;">
                    <p><strong>Note:</strong> ESIC registration is fast (3-7 days online). Monthly deposit by 15th is absolute. Half-yearly returns by 12th November and 12th May. Patron automates all deadlines and calculations.</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="why-choose-section" id="benefits-section">
    <div class="section-container">
        <div style="text-align:center;margin-bottom:48px;">
            ...
            <h2 class="section-title">Why Choose Patron for ESIC Compliance in Gurugram</h2>
        </div>
        <div class="features-grid">
            <article class="feature-card">
                ...
                <p class="feature-text">Registration within 15 days of crossing 10 employees. Proactive monitoring. ESIC code obtained. Coverage starts immediately.</p>
            </article>
            <article class="feature-card">
                ...
                <h3 class="feature-title">Monthly Calculation</h3>
                <p class="feature-text">Accurate ESI wages identification. 0.75% + 3.25% computation per employee. Challan generation. Deposit by 15th. Zero late payments.</p>
            </article>
            <article class="feature-card">
                ...
                <h3 class="feature-title">Benefit Facilitation</h3>
                <p class="feature-text">IP numbers and Pehchan cards for all employees. ESIC hospital access. Sickness, maternity, disablement benefit claims processed.</p>
            </article>
            <article class="feature-card">
                <div class="feature-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg></div>
                <h3 class="feature-title">PF + Payroll Bundle</h3>
                <p class="feature-text">ESI integrated with PF contributions, TDS, and payroll processing. Single engagement for all employer obligations.</p>
            </article>
            <article class="feature-card">
                ...
                <h3 class="feature-title">Half-Yearly Returns</h3>
                <p class="feature-text">April-September and October-March returns filed on time. Employee reconciliation. Wage change updates. Contribution period management.</p>
            </article>
            <article class="feature-card">
                ...
                <p class="feature-text">Proactive deposit preventing 12% interest and 25% damages. Inspection readiness. Section 45A proceeding management.</p>
            </article>
        </div>
    </div>
</section>
...
<section class="content-section" id="comparison-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">ESI Contribution Structure and Benefits</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table class="table-comparison">
                    <thead><tr><th>Component</th><th>Detail</th></tr></thead>
                    <tbody>
                        <tr><td>Employee Contribution</td><td>0.75% of wages (exempted if daily avg up to Rs 176)</td></tr>
                        <tr><td>Employer Contribution</td><td>3.25% of wages (pays even for exempted employees)</td></tr>
                        <tr><td>Total</td><td>4% of ESI wages</td></tr>
                        <tr><td>Wage Ceiling</td><td>Rs 21,000/month (Rs 25,000 for disabled)</td></tr>
                        <tr><td>ESI Wages Include</td><td>Basic+DA+HRA+CCA+OT+Meal+Uniform+Incentives+Special Allowances</td></tr>
                        <tr><td>Medical Care</td><td>Complete treatment at ESIC hospitals. Employee+family covered</td></tr>
                        <tr><td>Sickness Benefit</td><td>70% of wages for up to 91 days/year</td></tr>
                    </tbody>
                </table>
                </div>
...
<section class="content-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>ESIC compliance is governed by the <strong>ESI Act 1948</strong> and the <strong>Code on Social Security 2020</strong> (ESI provisions effective from November 2025). ESIC under the Ministry of Labour and Employment administers the scheme. The ESIC Regional Office covering Gurugram/Faridabad handles local jurisdiction.</p>
                <p>Contribution rate: employee 0.75% + employer 3.25% = 4% of ESI wages. ESI wages include basic+DA+HRA+all allowances <strong>except conveyance</strong> (Supreme Court ruling). Wage ceiling: Rs 21,000/month. Two contribution periods: April-September and October-March. Employee covered during a period remains covered for the benefit period even if wages exceed the ceiling.</p>
                <p>Registration and monthly compliance are managed through <a href="https://esic.gov.in" target="_blank" rel="noopener">ESIC portal (esic.gov.in)</a>. The Unified Shram Suvidha Portal integrates ESI with other labour compliances. ESIC Hospital Gurugram provides medical care to insured persons and their families.</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="content-container">
        <div class="text-content">
            <div class="faq-expanded">
                ...
                <div class="faq-expanded__list">
                    <div class="faq-expanded__item" id="faq-1">
                        <h3 class="faq-expanded__q">When is ESIC mandatory in Gurugram?</h3>
                        <div class="faq-expanded__a"><p>ESIC is mandatory when your establishment has 10 or more employees in Haryana/Gurugram. All employee types count: permanent, contract, temporary, intern. Employees earning up to Rs 21,000/month are covered (Rs 25,000 for disabled). Once registered, coverage continues even if employee count drops below 10.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-2">
                        <h3 class="faq-expanded__q">How is ESI contribution calculated?</h3>
                        <div class="faq-expanded__a"><p>Employee contribution: 0.75% of ESI wages. Employer: 3.25%. Total: 4%. ESI wages include basic+DA+HRA+CCA+OT+meal+uniform+incentives+special allowances. Exclude: conveyance allowance (Supreme Court ruling). Wage ceiling: Rs 21,000/month. Deposit by 15th. Call +91 945 945 6700 for a detailed quote.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-3">
                        <h3 class="faq-expanded__q">What benefits do employees get under ESIC?</h3>
                        <div class="faq-expanded__a"><p>Total timeline: 2-6 months. Filing and Diary Number: immediate. Mandatory 30-day objection waiting period: 1 month. File Half-Yearly Returns: 1-3 months. Certificate issuance: after examination approval. If a third-party objection is filed, the timeline extends by 2-4 months for hearing and resolution.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-4">
                        <h3 class="faq-expanded__q">What are the penalties for ESIC non-compliance?</h3>
                        <div class="faq-expanded__a"><p>Late deposit: 12% interest per annum from the 16th of the month. Delay of 6+ months: 25% damages on the arrears amount. Non-registration or non-payment: imprisonment of 1-3 years. Backdated demand from the date the 10th employee joined. These penalties make ESIC one of the most strictly enforced employer compliances.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-5">
                        <h3 class="faq-expanded__q">How is ESIC different from PF?</h3>
                        <div class="faq-expanded__a"><p>ESI (Employees' State Insurance): medical and social security under ESI Act 1948. For 10+ employees. 4% contribution (0.75% employee + 3.25% employer). Wage ceiling Rs 21,000. Provides medical, sickness, maternity, disablement benefits. PF (Provident Fund): retirement savings under EPF Act 1952. For 20+ employees. 24% contribution (12% each). Provides retirement corpus, pension, life insurance. Both are separate and mandatory.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-6">
                        <h3 class="faq-expanded__q">What wages are included in ESI calculation?</h3>
                        <div class="faq-expanded__a"><p>ESI wages include: basic salary, dearness allowance (DA), house rent allowance (HRA), city compensatory allowance (CCA), overtime pay, meal allowance, uniform allowance, incentives, and special allowances. Excluded: conveyance allowance (per Supreme Court ruling) and employer's PF/ESI contribution. The complete wage (excluding conveyance) forms the base for the 4% calculation.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-7">
                        <h3 class="faq-expanded__q">What is the contribution period in ESIC?</h3>
                        <div class="faq-expanded__a"><p>Two 6-month contribution periods: April 1 to September 30 and October 1 to March 31. An employee covered during a contribution period remains covered for the corresponding benefit period even if their wages exceed Rs 21,000 mid-period. Employer must continue ESI deductions until the current contribution period ends.</p></div>
                    </div>
                </div>
            </div>
            ...
            <div class="highlight-box" style="margin-top:32px;">
                ...
                <p><strong>Kab applicable?</strong> 10+ employees hote hi. Haryana mein 10. Sab count hote hain - permanent, contract, temporary. Ek baar registered toh hamesha covered.</p>
                <p><strong>Kitna deduct?</strong> Employee: 0.75%. Employer: 3.25%. Total 4%. Rs 21,000 tak ki wages pe. 15 tarikh tak deposit. Conveyance nahi count hota.</p>
                <p><strong>Benefits?</strong> Free medical ESIC hospital (employee+family). Bimar: 70% salary. Maternity: 26 weeks. Injury: 90%. Death: 90% dependents ko.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section" style="background: var(--orange-lighter) !important; border-left: 4px solid var(--orange);">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Why ESIC Matters for Gurugram Businesses</h2>
            <div class="content-text">
                <p>A Gurugram manufacturing unit with 30 workers, average wage Rs 16,000. Total ESI-eligible wages: Rs 4.8 lakh/month. Monthly ESI: Rs 19,200 (4%). Unit does not register. Employee injured. Without ESI: no ESIC hospital, no disablement benefit, employer faces direct liability. Inspector discovers non-registration. Backdated 24 months: Rs 4.6 lakh + 12% interest + 25% damages = Rs 6.3 lakh. Plus criminal risk. Monthly Rs 19,200 would have covered everything at Rs 520/employee/month.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section" style="background: var(--blue) !important;">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title" style="color:#FFFFFF !important;">Start Your ESIC Compliance in Gurugram Today</h2>
            <div class="content-text" style="text-align:left;">
                <p style="color:rgba(255,255,255,0.85);">ESIC Calculation and Compliance in Gurugram is mandatory for every establishment with 10+ employees, providing comprehensive medical care, sickness, maternity, and disablement benefits through a 4% monthly contribution (0.75% employee + 3.25% employer) deposited by the 15th.</p>
                <p style="color:rgba(255,255,255,0.85);">Patron Accounting's Gurugram office on Golf Course Extension Road handles ESIC registration, monthly calculation, challan, returns, Pehchan card, and penalty prevention for IT companies, manufacturers, restaurants, and startups across Gurugram.</p>
            ...
            <div style="display:flex;gap:14px;flex-wrap:wrap;margin-top:24px;">
                ...
                <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20help%20with%20ESIC%20Compliance%20in%20Gurugram.%20Please%20share%20details." target="_blank" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:#25D366;color:#fff;border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#128172; WhatsApp Us</a>
                <a href="mailto:sales@patronaccounting.com?subject=Enquiry%20for%20ESIC%20Compliance%20in%20Gurugram&body=Hello%20Patron%20Accounting%20Team%2C%0A%0AI%20am%20interested%20in%20your%20ESIC%20Compliance%20services%20in%20Gurugram%20and%20would%20like%20to%20know%20more.%0A%0APlease%20get%20in%20touch%20with%20me%20at%20your%20earliest%20convenience.%0A%0AThank%20you." style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:transparent;color:#fff;border:2px solid rgba(255,255,255,0.3);border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#9993;&#65039; Email Us</a>
            </div>
...
<section class="content-section" style="padding:48px 32px;background:var(--gray-50);">
    <div class="content-container">
        <div class="text-content">
            ...
            <p style="text-align:center;color:var(--text-muted);font-size:15px;margin-bottom:40px;">ESIC compliance services available in major cities across India with local office support.</p>
            ...
            <div class="pa-city-block">
                ...
                <div class="pa-block-sub">End-to-end support for ESIC Compliance in Gurugram</div>
...
<section class="content-section" style="padding:32px;">
    <div class="content-container">
        <div class="text-content" style="font-size:13px;color:var(--text-muted);">
            ...
            <p>This page is reviewed quarterly for accuracy. ESI Act provisions, contribution rates, wage ceiling, benefit entitlements, and ESIC portal procedures are verified against current notifications. Gurugram employer landscape and ESIC Regional Office information is validated with each review.</p>
        </div>
    </div>
</section>
