...
@section('meta')
    ...
    <meta property="og:image" content="/images/esic-calculation-and-compliance-services/delhi-og.webp">
    ...
    <meta name="twitter:image" content="/images/esic-calculation-and-compliance-services/delhi-og.webp">
@endsection
  ...
  "@graph": [
    {
      ...
      "url": "/esic-calculation-compliance/delhi",
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - ESIC Calculation & Compliance in Delhi'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="esic-calculation-and-compliance-services/delhi" selected>ESIC Compliance in Delhi</option><option value="esic-registration/delhi">ESIC Registration in Delhi</option><option value="pf-registration/delhi">PF Registration in Delhi</option><option value="payroll-services/delhi">Payroll Services in Delhi</option><option value="gst-registration/delhi">GST Registration in Delhi</option><option value="private-limited-company-registration/delhi">Private Limited Company Registration in Delhi</option><option value="shop-act-registration/delhi">Shop Act Registration in Delhi</option><option value="other">Other</option>
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    ...
                    @include('partials.faq-enquiry-form', ['enquiryLocation' => 'Delhi', 'enquiryService' => 'ESIC Calculation in Delhi'])
                </aside>
