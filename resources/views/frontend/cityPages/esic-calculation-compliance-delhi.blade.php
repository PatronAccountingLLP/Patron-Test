        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'esic-calculation-and-compliance-services/delhi',
                    'options'  => [
                        'esic-calculation-and-compliance-services/delhi' => 'ESIC Compliance in Delhi',
                        'esic-registration/delhi' => 'ESIC Registration in Delhi',
                        'pf-registration/delhi' => 'PF Registration in Delhi',
