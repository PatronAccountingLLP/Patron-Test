...
@section('meta')
    ...
    <meta property="og:image" content="/images/esic-calculation-compliance/pune-og.webp">
    ...
    <meta name="twitter:image" content="/images/esic-calculation-compliance/pune-og.webp">
@endsection
  ...
  "@graph": [
    {
      ...
      "url": "/esic-calculation-compliance/pune",
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - ESIC Calculation & Compliance in Pune'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="esic-calculation-compliance/pune" selected>ESIC Compliance in Pune</option>
