...
@section('meta')
    ...
    <link rel="canonical" href="/esic-return/gurugram">
    ...
    <meta property="og:url" content="/esic-return/gurugram">
...
@section('schema')
    @include('partials.city-localbusiness', ['citySlug' => 'gurugram', 'pageUrl' => '/esic-return/gurugram'])
  ...
  "@graph": [
    {
      ...
      "url": "https://www.patronaccounting.com/esic-return/gurugram",
    ...
    },
    {
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "position": 3,
          "name": "ESIC Return Filing Gurugram - Process, Due Date & Fees",
          "item": "https://www.patronaccounting.com/esic-return/gurugram"
        }
      ]
    },
    {
