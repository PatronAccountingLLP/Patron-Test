        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'esic-returns/pune',
                    'options'  => [
                        'esic-returns/pune' => 'ESIC Returns in Pune',
                        'payroll-processing-and-management/pune' => 'Payroll Processing in Pune',
                        'professional-tax-registration/pune' => 'Professional Tax in Pune',
