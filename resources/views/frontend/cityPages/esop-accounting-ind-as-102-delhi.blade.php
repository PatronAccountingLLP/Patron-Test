...
@section('meta')
    <title>Delhi ESOP Accounting Under Ind AS 102 & ICAI Note</title>
    <meta name="description" content="Ind AS 102 ESOP accounting for Delhi Nehru Place and Connaught Place firms: fair valuation, expense schedules and RoC Delhi disclosures from INR 24,999.">
    <meta name="keywords" content="ESOP Accounting Ind AS 102 Delhi, ESOP Accounting Ind AS 102 in Delhi, ESOP Accounting Ind AS 102 services in Delhi, ESOP services Delhi, ESOP Accounting Ind AS 102 cost Delhi, ESOP Accounting Ind AS 102 consultants Delhi, CA firm for ESOP Accounting Ind AS 102 Delhi, ESOP advisory Delhi">
    <link rel="canonical" href="/esop-accounting-ind-as-102/delhi">
    <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1">
    <meta property="og:title" content="Delhi ESOP Accounting Under Ind AS 102 & ICAI Note | Patron Accounting">
    <meta property="og:description" content="Ind AS 102 ESOP accounting for Delhi Nehru Place and Connaught Place firms: fair valuation, expense schedules and RoC Delhi disclosures from INR 24,999.">
    <meta property="og:url" content="/esop-accounting-ind-as-102/delhi">
    ...
    <meta name="twitter:title" content="Delhi ESOP Accounting Under Ind AS 102 & ICAI Note | Patron Accounting">
    <meta name="twitter:description" content="Ind AS 102 ESOP accounting for Delhi Nehru Place and Connaught Place firms: fair valuation, expense schedules and RoC Delhi disclosures from INR 24,999.">
...
@section('schema')    <script type="application/ld+json">{
  ...
  "@graph": [
    {
      "@type": "Service",
      "@id": "https://www.patronaccounting.com/esop-accounting-ind-as-102/delhi#service",
      "name": "ESOP Accounting under Ind AS 102",
      "url": "https://www.patronaccounting.com/esop-accounting-ind-as-102/delhi",
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://www.patronaccounting.com/esop-accounting-ind-as-102/delhi#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
        ...
        },
        {
          ...
          "position": 4,
          "name": "ESOP Accounting under Ind AS 102",
          "item": "https://www.patronaccounting.com/esop-accounting-ind-as-102/delhi"
        }
      ]
    },
    {
      ...
      "@id": "https://www.patronaccounting.com/esop-accounting-ind-as-102/delhi#localbusiness",
      "name": "Patron Accounting LLP - ESOP Accounting Ind As 102, Delhi",
      "url": "https://www.patronaccounting.com/esop-accounting-ind-as-102/delhi",
    ...
    {
      "@type": "FAQPage",
      "@id": "https://www.patronaccounting.com/esop-accounting-ind-as-102/delhi#faq",
      "datePublished": "2026-06-24T08:00:00+05:30",
      "dateModified": "2026-06-24T08:00:00+05:30",
      "mainEntity": [
        {
          "@type": "Question",
          "name": "Where do Delhi companies file ESOP allotment forms after exercise?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Delhi-registered companies file with RoC Delhi, the Registrar of Companies for the National Capital Territory, which also covers Haryana. Form MGT-14 is filed within 30 days of the special resolution approving the ESOP scheme, and Form PAS-3 (return of allotment) within 30 days of allotting shares on exercise. The SH-6 register of employee stock options is kept at the registered office, whether in Nehru Place, Connaught Place or the Saket-Aerocity belt. Delhi head offices sit close to the Ministry of Corporate Affairs, but the Ind AS 102 accounting expense recognition is a separate audit deliverable that runs in parallel with this RoC filing."
          }
        },
        {
          "@type": "Question",
          "name": "Why are many Delhi holding companies pulled into Ind AS 102 for ESOPs?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "A large share of Connaught Place and Nehru Place registered offices are group holding companies or NCR head offices rather than standalone startups. Ind AS 102 is mandatory for any company that is the holding, subsidiary, joint venture or associate of a listed or Ind AS entity, regardless of its own size. So the moment a Delhi holding company has even one Ind AS subsidiary, the holding itself must apply Ind AS 102 to its own ESOP scheme and cannot use the Intrinsic Value Method shortcut a small standalone Saket startup might still use under the AS framework with the ICAI Guidance Note 2020."
          }
        },
        {
          "@type": "Question",
        ...
        {
          "@type": "Question",
          "name": "How are group ESOPs where a Delhi parent grants options to subsidiary staff accounted for?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Delhi-headquartered groups frequently run a single ESOP scheme from the parent that grants options to employees of subsidiaries across the NCR and elsewhere. Under Ind AS 102 group share-based payment rules, the entity receiving the employee services (the subsidiary) recognises the expense with a corresponding credit to equity as a capital contribution from the parent, while the parent recognises an increase in its investment in the subsidiary. The grant-date fair value is measured once at parent level. Patron sets up the inter-company cross-charge and the matching journal entries so both the holding and subsidiary financials reconcile at audit."
          }
        },
        {
          "@type": "Question",
        ...
        {
          "@type": "Question",
          "name": "How is ESOP accounting carried out?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "ESOP accounting is governed by Ind AS 102. At the grant date, the fair value per option is computed using Black-Scholes, and the expense is recognised over the vesting period (typically 4 years) - Dr ESOP Expense and Cr ESOP Reserve. For cash-settled SARs, the liability is remeasured at each reporting date. Non-Ind AS companies follow the ICAI Guidance Note 2020. Patron delivers the full schedule and journal entries within 5 to 10 working days. Call +91 945 945 6700."
          }
        }
      ]
    }
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-4 private-registration-heading">
                        ESOP Accounting under Ind AS 102 in Delhi
                    </h1>

                    <p class="mb-4" style="font-size:16px;color:var(--text-secondary);">Ind AS 102 share-based payment expense for Nehru Place IT, Connaught Place trading houses and Saket-Aerocity consumer-tech firms - Black-Scholes valuation and RoC Delhi disclosures that reconcile cleanly to your NRI investors' IFRS books.</p>
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="https://wa.me/919459456700?text=Hello%2C%20I%20just%20visited%20your%20ESOP%20Accounting%20IND%20As%20102%20in%20Delhi%20page.%20I%20would%20like%20to%20know%20more%20about%20it." target="_blank" class="btn-sample text-decoration-none" rel="noopener">
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>Delhi's corporate base spans the Nehru Place IT trading hub, the Connaught Place finance district and the Saket-Aerocity corporate belt, with a dense layer of registered head offices that file directly under the Ministry of Corporate Affairs jurisdiction. Many of these are holding companies or NCR head offices whose net worth or group structure pulls them straight into the Ind AS framework. ESOP accounting is the statutory expense recognition layer that translates a grant of stock options into Profit and Loss compensation cost over the vesting period. The exact treatment depends on whether the company applies Ind AS or the older AS framework, and on whether the scheme is equity-settled (ESOP) or cash-settled (SAR or Phantom Stock).</p>
                <p>Patron Accounting LLP provides Ind AS 102 expense computation, Black-Scholes fair valuation, year-wise schedule, journal entries and Schedule III note disclosure as part of the audit engagement or as a standalone ESOP accounting deliverable. The firm has handled ESOP accounting for Delhi head offices, group holding companies and growth-stage startups since 2009, with CA, audit and tax teams under one roof across offices in Pune, Mumbai, Delhi and Gurugram. Delhi-registered companies file ESOP allotment forms (PAS-3, MGT-14) with RoC Delhi, which sits within the National Capital Territory close to the MCA headquarters at Shastri Bhawan.</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="two-column">
            <div class="column-content">
                ...
                <div class="content-text what-is-definition">
                    ...
                    <p>Delhi is where the Ministry of Corporate Affairs is headquartered and where RoC Delhi processes the filings, so the rules behind ESOP accounting are, in a sense, administered from this city. For a Nehru Place IT business, a Connaught Place trading or finance house, or a Saket consumer-tech company, Ind AS 102 is the standard - notified under Section 133 of the Companies Act 2013 read with Rule 4 of the Companies (Indian Accounting Standards) Rules 2015 - that turns employee option grants into a recognised compensation charge.</p>
                    <p>The mechanics are straightforward in principle: the grant-date fair value of equity-settled awards, or the remeasured fair value of cash-settled awards, is expensed over the vesting period, with the credit posted to an equity reserve or a liability. For Delhi companies with a substantial NRI investor base, this is also the line item overseas backers examine first when reconciling Indian books to IFRS-style reporting.</p>
                    <p>Helpfully, Ind AS 102 is materially converged with IFRS 2 - Share-based Payment from the IFRS Foundation, which smooths that reconciliation. Delhi companies below the Ind AS net worth threshold - including many Nehru Place product firms and Aerocity-based startups - instead apply the ICAI Guidance Note on Accounting for Share-based Payments (September 2020) under the Companies (Accounting Standards) Rules 2006 framework.</p>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p><em>Note: The ICAI Guidance Note on Accounting for Share-based Payments (September 2020) permits both the Fair Value Method and the Intrinsic Value Method (FMV at grant minus exercise price) for AS framework companies. Many Connaught Place and Nehru Place head offices act as the holding entity of a group, and once a Delhi holding company has even one Ind AS subsidiary or associate, the holding itself is pulled into Ind AS 102, closing the Intrinsic Value option that a standalone Saket startup might otherwise have used.</em></p>
                <h3>What Sets Off an Ind AS 102 Run for a Delhi Company</h3>
                <ul>
                    <li>The opening grant after scheme approval - first reserve set up and grant-date fair value computed</li>
                    <li>Each new tranche as a Nehru Place IT firm or Saket consumer-tech team hires through the year</li>
                    <li>A modification - repricing or exercise-window extension, often after an NRI-led funding round</li>
                    <li>A cancellation or settlement that brings forward the unrecognised expense</li>
                    <li>The year-end close driving the cumulative true-up, Schedule III note and RoC Delhi Directors' Report disclosure</li>
                    <li>A standalone entity becoming part of a Connaught Place group, or crossing the net worth line, forcing the Ind AS 101 transition</li>
                </ul>
...
<section class="content-section" id="services-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>For Delhi's trading houses, Nehru Place IT firms and consumer-tech companies - many with NRI shareholders who want IFRS-comparable numbers - each deliverable below is documented to bridge the Indian books to overseas reporting and to satisfy RoC Delhi disclosure in one pass.</p>
...
<section class="steps-section" id="procedure-section">
    <div class="section-container">
        <div class="section-header" style="text-align:center;margin-bottom:48px;">
            ...
            <p class="section-subtitle" style="text-align:left;max-width:100%;">For a Connaught Place finance house or a Saket startup with overseas investors, Patron's seven-step run produces both the Schedule III note for RoC Delhi and a clean reconciliation an NRI backer can map to IFRS 2. The procedure follows Ind AS 102 paragraphs 10 to 29 and the ICAI Guidance Note 2020, and closes in 5 to 10 working days.</p>
        </div>
        <div class="steps-container">
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <p class="step-description">Collect the approved ESOP Scheme document, all Board Resolutions for grants, <a href="/esop-sh-6-register-administration/delhi">Form SH-6 Register of Employee Stock Options</a>, <a href="/esop-valuation-services/delhi">IBBI Valuer FMV report</a> and a list of grantees with grant dates, vesting schedules and exercise prices.</p>
...
<section class="content-section" id="documents-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>For Delhi groups with a holding company at Connaught Place or Nehru Place, we also map subsidiary and associate grants so the consolidated Ind AS 102 position is complete. Send what is to hand; we reconstruct the rest from board minutes and the registered-office registers.</p>
                <ul>
...
<section class="content-section" id="challenges-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>For Delhi companies these errors most often surface during NRI-investor diligence or when a standalone Saket entity gets folded into a Connaught Place group and is suddenly inside the Ind AS net. Here is how we resolve each before it reaches the auditor.</p>
                <div class="table-responsive-wrapper">
                <table>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p style="margin-top:16px;"><strong>Get a free ESOP Accounting consultation - <a href="tel:+919459456700">Call +91 945 945 6700</a> or <a href="https://wa.me/919459456700?text=Hello%2C%20I%20just%20visited%20your%20ESOP%20Accounting%20IND%20As%20102%20in%20Delhi%20page.%20I%20would%20like%20to%20know%20more%20about%20it." target="_blank" rel="noopener">WhatsApp us</a>. No-obligation assessment.</strong></p>
            </div>
        </div>
    </div>
</section>
...
<section class="why-choose-section" id="benefits-section">
    ...
    <article class="feature-card">
        ...
        <p>Engagement aligned to your year-end close and any NRI-investor reporting deadlines - no April scramble before the audit. Quarterly fresh-grant valuations turned around in 2 to 3 working days.</p>
    </article>
    <article class="feature-card">
...
<section class="content-section" id="comparison-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>Delhi product and consumer-tech companies usually grant equity-settled ESOPs, but trading and family-promoted businesses around Connaught Place often favour <a href="/esop-vs-sar/delhi">cash-settled SARs</a> or <a href="/esop-vs-phantom-stock/delhi">phantom plans</a> to keep promoter holdings intact. The two diverge in measurement, balance-sheet placement and the picture an NRI investor sees, so the classification call matters early. The table below maps the differences.</p>
                <div class="table-responsive-wrapper">
                <table>
                    <thead>
                        <tr>
...
<section class="content-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>Delhi companies file their ESOP forms with RoC Delhi, the registry sitting under the MCA headquarters in the capital. The accounting standards and rules that govern the numbers - the same ones an NRI investor's auditor will cross-check - are set out below.</p>
                <ul>
            ...
            <div class="faq-expanded">
                ...
                <div class="faq-expanded__list">
                    <div class="faq-expanded__item" id="faq-1">
                        <h3 class="faq-expanded__q">Where do Delhi companies file ESOP allotment forms after exercise?</h3>
                        <div class="faq-expanded__a"><p>Delhi-registered companies file with RoC Delhi, the Registrar of Companies for the National Capital Territory, which also covers Haryana. Form MGT-14 is filed within 30 days of the special resolution approving the ESOP scheme, and Form PAS-3 (return of allotment) within 30 days of allotting shares on exercise. The SH-6 register of employee stock options is kept at the registered office, whether in Nehru Place, Connaught Place or the Saket-Aerocity belt. Delhi head offices sit close to the Ministry of Corporate Affairs, but the Ind AS 102 accounting expense recognition is a separate audit deliverable that runs in parallel with this RoC filing.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-2">
                        <h3 class="faq-expanded__q">Why are many Delhi holding companies pulled into Ind AS 102 for ESOPs?</h3>
                        <div class="faq-expanded__a"><p>A large share of Connaught Place and Nehru Place registered offices are group holding companies or NCR head offices rather than standalone startups. Ind AS 102 is mandatory for any company that is the holding, subsidiary, joint venture or associate of a listed or Ind AS entity, regardless of its own size. So the moment a Delhi holding company has even one Ind AS subsidiary, the holding itself must apply Ind AS 102 to its own ESOP scheme and cannot use the Intrinsic Value Method shortcut a small standalone Saket startup might still use under the AS framework with the ICAI Guidance Note 2020.</p></div>
                    </div>
                    ...
                    <div class="faq-expanded__item" id="faq-6">
                        <h3 class="faq-expanded__q">How are group ESOPs where a Delhi parent grants options to subsidiary staff accounted for?</h3>
                        <div class="faq-expanded__a"><p>Delhi-headquartered groups frequently run a single ESOP scheme from the parent that grants options to employees of subsidiaries across the NCR and elsewhere. Under Ind AS 102 group share-based payment rules, the entity receiving the employee services (the subsidiary) recognises the expense with a corresponding credit to equity as a capital contribution from the parent, while the parent recognises an increase in its investment in the subsidiary. The grant-date fair value is measured once at parent level. Patron sets up the inter-company cross-charge and the matching journal entries so both the holding and subsidiary financials reconcile at audit.</p></div>
                    </div>
                    ...
                    <div class="faq-expanded__item" id="faq-8">
                        <h3 class="faq-expanded__q">How is ESOP accounting carried out?</h3>
                        <div class="faq-expanded__a"><p>ESOP accounting is governed by Ind AS 102. At the grant date, the fair value per option is computed using Black-Scholes, and the expense is recognised over the vesting period (typically 4 years) - Dr ESOP Expense and Cr ESOP Reserve. For cash-settled SARs, the liability is remeasured at each reporting date. Non-Ind AS companies follow the ICAI Guidance Note 2020. Patron delivers the full schedule and journal entries within 5 to 10 working days. Call <a href="tel:+919459456700" style="color:inherit;">+91 945 945 6700</a>.</p></div>
                    </div>
                </div>
            </div>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                Missing share-based payment expense in the books is the most common Series A diligence reopen. Wrong classification of SARs as equity-settled is the most common audit qualification. Get a free scoping call with the Patron Ind AS 102 team - we will tell you in 20 minutes what your ESOP accounting actually needs. <strong><a href="tel:+919459456700" style="color:inherit;text-decoration:underline;">Call +91 945 945 6700</a></strong> or <strong><a href="https://wa.me/919459456700?text=Hello%2C%20I%20just%20visited%20your%20ESOP%20Accounting%20IND%20As%20102%20in%20Delhi%20page.%20I%20would%20like%20to%20know%20more%20about%20it." target="_blank" rel="noopener" style="color:inherit;text-decoration:underline;">WhatsApp us</a></strong> for a free scoping conversation.
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text" style="text-align:left;">
                ...
                <p style="color:rgba(255,255,255,0.92);"><strong>Call <a href="tel:+919459456700" style="color:inherit;">+91 945 945 6700</a> or <a href="https://wa.me/919459456700?text=Hello%2C%20I%20just%20visited%20your%20ESOP%20Accounting%20IND%20As%20102%20in%20Delhi%20page.%20I%20would%20like%20to%20know%20more%20about%20it.">WhatsApp us</a></strong> for a free scoping call. Response within 2 hours during business hours.</p>

            </div>
            <div style="display:flex;gap:14px;flex-wrap:wrap;margin-top:24px;">
                <a href="tel:+919459456700" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:var(--orange);color:#fff;border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#128222; Call +91 945 945 6700</a>
                <a href="https://wa.me/919459456700?text=Hello%2C%20I%20just%20visited%20your%20ESOP%20Accounting%20IND%20As%20102%20in%20Delhi%20page.%20I%20would%20like%20to%20know%20more%20about%20it." target="_blank" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:#25D366;color:#fff;border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;" rel="noopener">&#128172; WhatsApp Us</a>
...
<section class="content-section" style="padding:48px 32px;background:var(--gray-50);">
    <div class="content-container"><div class="text-content">
        ...
        <div class="pa-city-grid"><a href="/esop-accounting-ind-as-102/pune" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Pune</div><div class="pa-card-sub">Maharashtra</div></div></a><a href="/esop-accounting-ind-as-102/mumbai" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Mumbai</div><div class="pa-card-sub">Maharashtra</div></div></a><span class="pa-city-card" aria-current="page" style="border-color:var(--orange);background:#FFF7F2;cursor:default;position:relative;"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Delhi</div><div class="pa-card-sub">Delhi NCR</div></div><span style="position:absolute;top:10px;right:12px;font-size:10px;font-weight:700;color:var(--orange);letter-spacing:.04em;">YOU'RE HERE</span></span><a href="/esop-accounting-ind-as-102/gurugram" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Gurugram</div><div class="pa-card-sub">Haryana</div></div></a></div>
    </div></div>
</section>
