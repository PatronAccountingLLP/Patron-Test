...
@section('meta')
    <title>Gurugram SaaS ESOP Accounting Under Ind AS 102 Rules</title>
    <meta name="description" content="ESOP accounting under Ind AS 102 for Gurugram Cyber City enterprise-SaaS firms: Black-Scholes valuation, vesting expense and RoC Delhi notes from INR 24,999.">
    <meta name="keywords" content="ESOP Accounting Ind AS 102 Gurugram, ESOP Accounting Ind AS 102 in Gurugram, ESOP Accounting Ind AS 102 services in Gurugram, ESOP services Gurugram, ESOP Accounting Ind AS 102 cost Gurugram, ESOP Accounting Ind AS 102 consultants Gurugram, CA firm for ESOP Accounting Ind AS 102 Gurugram, ESOP advisory Gurugram">
    <link rel="canonical" href="/esop-accounting-ind-as-102/gurugram">
    <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1">
    <meta property="og:title" content="Gurugram SaaS ESOP Accounting Under Ind AS 102 Rules | Patron Accounting">
    <meta property="og:description" content="ESOP accounting under Ind AS 102 for Gurugram Cyber City enterprise-SaaS firms: Black-Scholes valuation, vesting expense and RoC Delhi notes from INR 24,999.">
    <meta property="og:url" content="/esop-accounting-ind-as-102/gurugram">
    ...
    <meta name="twitter:title" content="Gurugram SaaS ESOP Accounting Under Ind AS 102 Rules | Patron Accounting">
    <meta name="twitter:description" content="ESOP accounting under Ind AS 102 for Gurugram Cyber City enterprise-SaaS firms: Black-Scholes valuation, vesting expense and RoC Delhi notes from INR 24,999.">
...
@section('schema')    <script type="application/ld+json">{
  ...
  "@graph": [
    {
      "@type": "Service",
      "@id": "https://www.patronaccounting.com/esop-accounting-ind-as-102/gurugram#service",
      "name": "ESOP Accounting under Ind AS 102",
      "url": "https://www.patronaccounting.com/esop-accounting-ind-as-102/gurugram",
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://www.patronaccounting.com/esop-accounting-ind-as-102/gurugram#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
        ...
        },
        {
          ...
          "position": 4,
          "name": "ESOP Accounting under Ind AS 102",
          "item": "https://www.patronaccounting.com/esop-accounting-ind-as-102/gurugram"
        }
      ]
    },
    {
      ...
      "@id": "https://www.patronaccounting.com/esop-accounting-ind-as-102/gurugram#localbusiness",
      "name": "Patron Accounting LLP - ESOP Accounting Ind As 102, Gurugram",
      "url": "https://www.patronaccounting.com/esop-accounting-ind-as-102/gurugram",
    ...
    {
      "@type": "FAQPage",
      "@id": "https://www.patronaccounting.com/esop-accounting-ind-as-102/gurugram#faq",
      "datePublished": "2026-06-24T08:00:00+05:30",
      "dateModified": "2026-06-24T08:00:00+05:30",
      "mainEntity": [
        {
          "@type": "Question",
          "name": "Where do Gurugram companies file ESOP allotment forms after exercise?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Gurugram sits in Haryana, and Haryana companies file with RoC Delhi, which holds Registrar of Companies jurisdiction over both Delhi and Haryana. Form MGT-14 is filed within 30 days of the special resolution approving the ESOP scheme, and Form PAS-3 (return of allotment) within 30 days of allotting shares on exercise. The SH-6 register of employee stock options is maintained at the registered office in Cyber City, Udyog Vihar or wherever the company is based. The Ind AS 102 accounting expense recognition runs in parallel with this RoC compliance and is what the statutory auditor signs off on."
          }
        },
        {
          "@type": "Question",
          "name": "Does a Gurugram SaaS company with a Delaware-flip parent follow Ind AS 102?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Many Cyber City and Udyog Vihar B2B SaaS companies hold their IP and cap table in a US Delaware parent while a Gurugram Indian subsidiary issues mirror grants to local engineering and sales teams. Once that Gurugram entity is a subsidiary of a parent reporting under IFRS or US GAAP, or its own net worth crosses Rs 250 crore, it must apply Ind AS 102 in its standalone Indian financials. Below that, it follows the AS framework with the ICAI Guidance Note 2020. Patron reconciles the group share-based payment policy with the Indian Ind AS 102 expense before the audit."
          }
        },
        {
          "@type": "Question",
        ...
        {
          "@type": "Question",
          "name": "How are ARR-linked or sales-quota vesting conditions accounted for under Ind AS 102?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Gurugram enterprise-SaaS plans often tie vesting to ARR milestones, sales quotas or net revenue retention rather than plain time service. Under Ind AS 102 these are non-market performance conditions: they are NOT built into the grant-date fair value, but instead adjust the estimated number of options expected to vest, and the cumulative expense is trued up at each reporting date as the targets are met or missed. This differs from a market condition such as a share-price hurdle, which is baked into the grant-date fair value and never reversed. Patron maps each Gurugram plan's vesting triggers to the correct treatment before booking."
          }
        },
        {
          "@type": "Question",
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "ESOP accounting is carried out under Ind AS 102. At the grant date, the fair value is computed using Black-Scholes, and the expense is recognised over the vesting period (typically 4 years) - Dr ESOP Expense and Cr ESOP Reserve. For cash-settled SARs, the liability is remeasured at each reporting date. Non-Ind AS companies follow the ICAI Guidance Note 2020. Patron delivers the full schedule and journal entries in 5 to 10 working days. Call +91 945 945 6700."
          }
        }
      ]
    }
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-4 private-registration-heading">
                        ESOP Accounting under Ind AS 102 in Gurugram
                    </h1>

                    <p class="mb-4" style="font-size:17px;color:var(--text-secondary);line-height:1.6;">Built for Gurugram's enterprise-SaaS and unicorn ecosystem - the kind of option pools Zomato, Delhivery and Policybazaar scaled with - across DLF Cyber City, Udyog Vihar, Golf Course Road and Sohna Road, with filings routed to RoC Delhi.</p>
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="https://wa.me/919459456700?text=Hello%2C%20I%20just%20visited%20your%20ESOP%20Accounting%20IND%20As%20102%20in%20Gurugram%20page.%20I%20would%20like%20to%20know%20more%20about%20it." target="_blank" class="btn-sample text-decoration-none" rel="noopener">
        ...
        <div class="two-column">
            <div class="column-content">
                ...
                <div class="content-text what-is-definition">
                    ...
                    <p>Picture a Cyber City enterprise-SaaS company that grants a refreshed pool of options to its sales and engineering org during a Series D raise, exercise price pegged to the latest 409A-style valuation. No cash leaves the company on grant day - yet Ind AS 102 refuses to let it record zero cost. The standard, notified under Section 133 of the Companies Act 2013 read with Rule 4 of the Companies (Indian Accounting Standards) Rules 2015, forces that pool to be fair-valued at grant and charged to Profit and Loss across the vesting period. At unicorn-scale pools the size Zomato, Delhivery or Policybazaar carried while scaling, this is a board-level number, not a footnote.</p>
                    <p>Mechanically the cost is front-loaded onto grant date. An equity-settled ESOP or RSU is fixed once - grant-date fair value - and marched through the P and L over the vesting window against an ESOP Reserve in equity; a cash-settled SAR or phantom unit is remeasured to fair value every reporting date with the credit sitting as a liability. So a Golf Course Road scale-up running graded four-year vesting books a slice of the cost each year, never a single hit at exercise, and the forfeiture true-up keeps that slice honest as people leave.</p>
                    <p>The Gurugram twist is the foreign parent. Because so many Udyog Vihar and Cyber City firms are the Indian subsidiary of a US or Singapore holding issuing mirror grants, the standalone Ind AS 102 charge has to tie back to a group IFRS 2 or US GAAP number - and Ind AS 102 being materially converged with IFRS 2 from the IFRS Foundation is what makes that tie-out possible on one basis. An Indian arm still under the Rs 250 crore threshold applies the ICAI Guidance Note on Accounting for Share-based Payments (September 2020) under the Companies (Accounting Standards) Rules 2006, until a parent trigger or a net-worth trigger pulls it into Ind AS.</p>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p><em>Note: The ICAI Guidance Note on Accounting for Share-based Payments (September 2020) permits both the Fair Value Method and the Intrinsic Value Method (FMV at grant minus exercise price) for AS framework companies. Many Cyber City and Udyog Vihar B2B SaaS companies run a US holding (Delaware flip) with a Gurugram Indian subsidiary issuing mirror grants; once that Indian arm becomes a subsidiary of an Ind AS or foreign-GAAP parent, it is pulled into Ind AS 102 and the Intrinsic Value shortcut closes. Patron determines the correct framework before the first Gurugram grant batch is booked.</em></p>
                <h3>Triggers for an Ind AS 102 Run at a Gurugram SaaS Company</h3>
                <ul>
                    <li>The founding grant batch after scheme approval - opening reserve and first grant-date fair value</li>
                    <li>Every quarterly hiring wave across a scaling Cyber City or Udyog Vihar team, each a new tranche to value</li>
                    <li>A modification - <a href="/esop-restructuring-underwater-options/gurugram">repricing</a>, exercise-window extension or acceleration, frequent around large enterprise-SaaS funding rounds</li>
                    <li>A cancellation or settlement that pulls the remaining unrecognised expense forward</li>
                    <li>The year-end close feeding the cumulative true-up and the Schedule III note (filed via RoC Delhi)</li>
                    <li>The Indian subsidiary entering a foreign or Ind AS group, triggering the Ind AS 101 first-time adoption switch</li>
                </ul>
...
<section class="content-section" id="services-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>For Gurugram's enterprise-SaaS scale-ups and late-stage Sohna Road companies running multi-year, multi-tranche pools, the deliverables below are built to handle volume - thousands of options across grant cohorts - and to reconcile cleanly with the foreign-parent reporting many Cyber City subsidiaries feed into.</p>
...
<section class="steps-section" id="procedure-section">
    <div class="section-container">
        <div class="section-header" style="text-align:center;margin-bottom:48px;">
            ...
            <p class="section-subtitle" style="text-align:left;max-width:100%;">Whether you are a Golf Course Road startup booking your first grant or a Cyber City unicorn truing up a pool spread across five grant years, Patron's seven-step run scales to the volume and ties back to any foreign-parent reporting. It follows Ind AS 102 paragraphs 10 to 29 and the ICAI Guidance Note 2020, and closes in 5 to 10 working days.</p>
        </div>
...
<section class="content-section" id="documents-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>For Gurugram subsidiaries of a foreign holding, we also ask for the parent's grant terms so the Indian mirror-grant accounting lines up with group reporting. Most of the rest comes straight from your cap-table platform; we rebuild any gaps from board minutes and the SH-6 register.</p>
                <ul>
...
<section class="content-section" id="challenges-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>At Gurugram's high-volume enterprise-SaaS companies, these slips compound fast across thousands of options and multiple grant years - and they surface hardest during a late-stage round or a parent-company audit. Here is how we clear each one.</p>
                <div class="table-responsive-wrapper">
                <table>
...
<section class="why-choose-section" id="benefits-section">
    ...
    <article class="feature-card">
        ...
        <p>Engagement aligned to both your Indian year-end close and the foreign parent's reporting calendar - no April scramble. High-volume quarterly fresh-grant valuations turned around in 2 to 3 working days.</p>
    </article>
    <article class="feature-card">
...
<section class="content-section" id="comparison-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>Gurugram's enterprise-SaaS firms lean heavily on equity-settled ESOPs and RSUs to compete for talent, while some use cash-settled SARs or phantom units in the Indian subsidiary where issuing local shares against a foreign-parent cap table is awkward. The accounting, balance-sheet treatment and group reconciliation differ sharply between the two, as the table sets out.</p>
                <div class="table-responsive-wrapper">
                <table>
                    <thead>
                        <tr>
...
<section class="content-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>Gurugram sits in Haryana, but its companies file ESOP forms with RoC Delhi, which holds jurisdiction over the territory. The accounting itself runs on the standards and rules below - the framework a foreign parent's group auditor will also reconcile the Indian subsidiary against.</p>
                <ul>
            ...
            <div class="faq-expanded">
                ...
                <div class="faq-expanded__list">
                    <div class="faq-expanded__item" id="faq-1">
                        <h3 class="faq-expanded__q">Where do Gurugram companies file ESOP allotment forms after exercise?</h3>
                        <div class="faq-expanded__a"><p>Gurugram sits in Haryana, and Haryana companies file with RoC Delhi, which holds Registrar of Companies jurisdiction over both Delhi and Haryana. Form MGT-14 is filed within 30 days of the special resolution approving the ESOP scheme, and Form PAS-3 (return of allotment) within 30 days of allotting shares on exercise. The SH-6 register of employee stock options is maintained at the registered office in Cyber City, Udyog Vihar or wherever the company is based. The Ind AS 102 accounting expense recognition runs in parallel with this RoC compliance and is what the statutory auditor signs off on.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-2">
                        <h3 class="faq-expanded__q">Does a Gurugram SaaS company with a Delaware-flip parent follow Ind AS 102?</h3>
                        <div class="faq-expanded__a"><p>Many Cyber City and Udyog Vihar B2B SaaS companies hold their IP and cap table in a US Delaware parent while a Gurugram Indian subsidiary issues mirror grants to local engineering and sales teams. Once that Gurugram entity is a subsidiary of a parent reporting under IFRS or US GAAP, or its own net worth crosses Rs 250 crore, it must apply Ind AS 102 in its standalone Indian financials. Below that, it follows the AS framework with the ICAI Guidance Note 2020. Patron reconciles the group share-based payment policy with the Indian Ind AS 102 expense before the audit.</p></div>
                    </div>
                    ...
                    <div class="faq-expanded__item" id="faq-6">
                        <h3 class="faq-expanded__q">How are ARR-linked or sales-quota vesting conditions accounted for under Ind AS 102?</h3>
                        <div class="faq-expanded__a"><p>Gurugram enterprise-SaaS plans often tie vesting to ARR milestones, sales quotas or net revenue retention rather than plain time service. Under Ind AS 102 these are non-market performance conditions: they are NOT built into the grant-date fair value, but instead adjust the estimated number of options expected to vest, and the cumulative expense is trued up at each reporting date as the targets are met or missed. This differs from a market condition such as a share-price hurdle, which is baked into the grant-date fair value and never reversed. Patron maps each Gurugram plan's vesting triggers to the correct treatment before booking.</p></div>
                    </div>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div style="display:flex;gap:14px;flex-wrap:wrap;margin-top:24px;">
                ...
                <a href="https://wa.me/919459456700?text=Hello%2C%20I%20just%20visited%20your%20ESOP%20Accounting%20IND%20As%20102%20in%20Gurugram%20page.%20I%20would%20like%20to%20know%20more%20about%20it." target="_blank" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:#25D366;color:#fff;border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;" rel="noopener">&#128172; WhatsApp Us</a>
