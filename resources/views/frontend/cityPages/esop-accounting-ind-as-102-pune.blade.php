...
@section('meta')
    <title>Pune ESOP Accounting: Ind AS 102 Black-Scholes Help</title>
    <meta name="description" content="Ind AS 102 ESOP accounting for Pune Hinjewadi and Kharadi SaaS firms: Black-Scholes valuation, vesting expense and RoC Pune disclosures from INR 24,999.">
    <meta name="keywords" content="ESOP Accounting Ind AS 102 Pune, ESOP Accounting Ind AS 102 in Pune, ESOP Accounting Ind AS 102 services in Pune, ESOP services Pune, ESOP Accounting Ind AS 102 cost Pune, ESOP Accounting Ind AS 102 consultants Pune, CA firm for ESOP Accounting Ind AS 102 Pune, ESOP advisory Pune">
    <link rel="canonical" href="/esop-accounting-ind-as-102/pune">
    <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1">
    <meta property="og:title" content="Pune ESOP Accounting: Ind AS 102 Black-Scholes Help | Patron Accounting">
    <meta property="og:description" content="Ind AS 102 ESOP accounting for Pune Hinjewadi and Kharadi SaaS firms: Black-Scholes valuation, vesting expense and RoC Pune disclosures from INR 24,999.">
...
@section('schema')    <script type="application/ld+json">{
  ...
  "@graph": [
    {
      "@type": "Service",
      "@id": "https://www.patronaccounting.com/esop-accounting-ind-as-102/pune#service",
      "name": "ESOP Accounting under Ind AS 102",
      "url": "https://www.patronaccounting.com/esop-accounting-ind-as-102/pune",
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://www.patronaccounting.com/esop-accounting-ind-as-102/pune#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
        ...
        },
        {
          ...
          "position": 4,
          "name": "ESOP Accounting under Ind AS 102",
          "item": "https://www.patronaccounting.com/esop-accounting-ind-as-102/pune"
        }
      ]
    },
    {
      ...
      "@id": "https://www.patronaccounting.com/esop-accounting-ind-as-102/pune#localbusiness",
      "name": "Patron Accounting LLP - ESOP Accounting Ind As 102, Pune",
      "url": "https://www.patronaccounting.com/esop-accounting-ind-as-102/pune",
    ...
    {
      "@type": "FAQPage",
      "@id": "https://www.patronaccounting.com/esop-accounting-ind-as-102/pune#faq",
      "datePublished": "2026-06-24T08:00:00+05:30",
      "dateModified": "2026-06-24T08:00:00+05:30",
      "mainEntity": [
        {
          "@type": "Question",
          "name": "Where do Pune companies file ESOP allotment forms after exercise?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Pune-registered companies file with RoC Pune, the Registrar of Companies for the Maharashtra jurisdiction covering Pune. Form MGT-14 is filed within 30 days of the special resolution approving the ESOP scheme, and Form PAS-3 (return of allotment) is filed within 30 days of allotting shares on exercise. The SH-6 register of employee stock options is maintained at the registered office. The Ind AS 102 accounting expense recognition runs in parallel with this RoC compliance and is what the statutory auditor signs off on."
          }
        },
        {
          "@type": "Question",
          "name": "Do Hinjewadi and Magarpatta IT-park startups follow Ind AS 102 or the ICAI Guidance Note?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Most early-stage Pune startups in Hinjewadi, Magarpatta, Kharadi and Baner with net worth below Rs 250 crore follow the AS framework using the ICAI Guidance Note on Accounting for Share-based Payments (September 2020). They move to Ind AS 102 once they cross the Rs 250 crore net worth threshold or become a subsidiary, associate or JV of a listed or Ind AS entity. Pune captive arms of listed multinationals apply Ind AS 102 from inception. Patron determines the correct framework before the first grant is booked."
          }
        },
        {
          "@type": "Question",
          "name": "What triggers Ind AS 102 accounting for a Pune startup raising a funding round?",
          "acceptedAnswer": {
            "@type": "Answer",
        ...
        <div class="row align-items-center">
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <p class="mb-4" style="font-size:16px;color:var(--text-secondary);line-height:1.6;">Black-Scholes valuation, vesting-period expense and audit-ready Schedule III notes for Hinjewadi, Kharadi, Magarpatta and Baner option grants - reconciled to your PAS-3 and MGT-14 filings with RoC Pune.</p>
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="https://wa.me/919459456700?text=Hello%2C%20I%20just%20visited%20your%20ESOP%20Accounting%20IND%20As%20102%20in%20Pune%20page.%20I%20would%20like%20to%20know%20more%20about%20it." target="_blank" class="btn-sample text-decoration-none" rel="noopener">
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p><em>Note: Under the ICAI Guidance Note (September 2020), an AS-framework company may choose the Fair Value Method or the Intrinsic Value Method (FMV at grant minus exercise price). Here is where Pune startups trip: a Rajiv Gandhi Infotech Park SaaS team sets its exercise price at face value (Rs 10), elects Intrinsic Value, and the books show almost nil ESOP cost. It looks clean until a growth-round investor's diligence reviewer asks why a company with 40 grantees carries no share-based payment expense - and the cap table gets reopened over precisely that hole. We close it by running a shadow Fair Value alongside the Intrinsic books well before the data room opens.</em></p>
                <h3>The Moments That Force a Pune ESOP Accounting Run</h3>
                <ul>
                    <li>Your founding option pool goes live after the EGM resolution clears - opening ESOP Reserve and the first grant-date fair value for the founding cohort</li>
                    <li>A hiring sprint in a scaling Hinjewadi or EON IT Park team drops a fresh grant tranche that needs its own valuation</li>
                    <li>Post-funding housekeeping - an exercise-window extension, <a href="/esop-at-down-round-and-repricing/pune">a repricing</a> or a vesting acceleration - which is a modification, not an administrative edit</li>
                    <li><a href="/esop-employee-exit-and-good-leaver-bad-leaver/pune">An employee exit</a> or buy-back settlement that pulls the remaining unrecognised expense forward</li>
                    <li>The 31 March close, when the cumulative forfeiture true-up and the Schedule III movement note are due before audit</li>
                    <li>A growth round that pushes net worth past Rs 250 crore - triggering the AS-to-Ind AS switch and an Ind AS 101 First-Time Adoption restatement of prior years</li>
                </ul>
...
<section class="steps-section" id="procedure-section">
    <div class="section-container">
        <div class="section-header" style="text-align:center;margin-bottom:48px;">
            ...
            <p class="section-subtitle" style="text-align:left;max-width:100%;">Whether you are a Baner SaaS company on its first grant or a Chakan manufacturer running a multi-tranche scheme, Patron's annual ESOP run follows the same documented seven steps - data in, audit-ready Schedule III note out - aligned to Ind AS 102 paragraphs 10 to 29 and the ICAI Guidance Note 2020, and closing in 5 to 10 working days.</p>
        </div>
...
<section class="content-section" id="documents-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>Most Pune teams already hold three-quarters of this list in their cap-table software and the SH-6 register that lives at the registered office - the same documents that back your MGT-14 and PAS-3 filings. Send across whatever is ready and do not stall on the gaps; we rebuild missing pieces from board minutes, grant letters and the IBBI valuer report. The list below is the full set we reconcile against.</p>
                <ul>
...
<section class="content-section" id="challenges-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>None of these errors are exotic - they are the ordinary ways a fast-growing Pune cap table drifts out of line with the standard. We see them most when a Kharadi or Hinjewadi founder who has been self-maintaining the ESOP schedule in a spreadsheet meets either a Series A investor's diligence reviewer or a freshly appointed statutory auditor, and the share-based payment note suddenly gets read line by line for the first time. Each row below pairs the mistake with what it costs and how we unwind it.</p>
                <div class="table-responsive-wrapper">
                <table>
...
<section class="why-choose-section" id="benefits-section">
    ...
    <article class="feature-card">
        ...
        <p>Engagement mapped to your March year-end close so there is no April scramble before the audit. Quarterly fresh-grant valuations for fast-hiring Hinjewadi and Kharadi teams turned around in 2 to 3 working days.</p>
    </article>
    <article class="feature-card">
            ...
            <div class="faq-expanded">
                ...
                <div class="faq-expanded__list">
                    <div class="faq-expanded__item" id="faq-1">
                        <h3 class="faq-expanded__q">Where do Pune companies file ESOP allotment forms after exercise?</h3>
                        <div class="faq-expanded__a"><p>Pune-registered companies file with RoC Pune, the Registrar of Companies for the Maharashtra jurisdiction covering Pune. Form MGT-14 is filed within 30 days of the special resolution approving the ESOP scheme, and Form PAS-3 (return of allotment) is filed within 30 days of allotting shares on exercise. The SH-6 register of employee stock options is maintained at the registered office. The Ind AS 102 accounting expense recognition runs in parallel with this RoC compliance and is what the statutory auditor signs off on.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-2">
                        <h3 class="faq-expanded__q">Do Hinjewadi and Magarpatta IT-park startups follow Ind AS 102 or the ICAI Guidance Note?</h3>
                        <div class="faq-expanded__a"><p>Most early-stage Pune startups in Hinjewadi, Magarpatta, Kharadi and Baner with net worth below Rs 250 crore follow the AS framework using the ICAI Guidance Note on Accounting for Share-based Payments (September 2020). They move to Ind AS 102 once they cross the Rs 250 crore net worth threshold or become a subsidiary, associate or JV of a listed or Ind AS entity. Pune captive arms of listed multinationals apply Ind AS 102 from inception. Patron determines the correct framework before the first grant is booked.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-3">
                        <h3 class="faq-expanded__q">What triggers Ind AS 102 accounting for a Pune startup raising a funding round?</h3>
                    ...
                    <div class="faq-expanded__item" id="faq-8">
                        ...
                        <div class="faq-expanded__a"><p>ESOP accounting is governed by Ind AS 102. At the grant date, the fair value is computed using Black-Scholes, and the expense is recognised over the vesting period (typically 4 years) - Dr ESOP Expense and Cr ESOP Reserve. For cash-settled SARs, the liability must be remeasured at each reporting date. Non-Ind AS companies follow the ICAI Guidance Note 2020. The Patron Pune office delivers the full schedule and journal entries within 5 to 10 days. Call <a href="tel:+919459456700" style="color:inherit;">+91 945 945 6700</a>.</p></div>
                    </div>
                </div>
            </div>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text" style="text-align:left;">
                ...
                <p style="color:rgba(255,255,255,0.92);"><strong>Call <a href="tel:+919459456700" style="color:inherit;">+91 945 945 6700</a> or WhatsApp us</strong> for a free scoping call. Response within 2 hours during business hours.</p>

            </div>
            <div style="display:flex;gap:14px;flex-wrap:wrap;margin-top:24px;">
                <a href="tel:+919459456700" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:var(--orange);color:#fff;border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#128222; Call +91 945 945 6700</a>
                <a href="https://wa.me/919459456700?text=Hello%2C%20I%20just%20visited%20your%20ESOP%20Accounting%20IND%20As%20102%20in%20Pune%20page.%20I%20would%20like%20to%20know%20more%20about%20it." target="_blank" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:#25D366;color:#fff;border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;" rel="noopener">&#128172; WhatsApp Us</a>
...
<section class="content-section" style="padding:48px 32px;background:var(--gray-50);">
    <div class="content-container"><div class="text-content">
        ...
        <div class="pa-city-grid"><span class="pa-city-card" aria-current="page" style="border-color:var(--orange);background:#FFF7F2;cursor:default;position:relative;"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Pune</div><div class="pa-card-sub">Maharashtra</div></div><span style="position:absolute;top:10px;right:12px;font-size:10px;font-weight:700;color:var(--orange);letter-spacing:.04em;">YOU'RE HERE</span></span><a href="/esop-accounting-ind-as-102/mumbai" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Mumbai</div><div class="pa-card-sub">Maharashtra</div></div></a><a href="/esop-accounting-ind-as-102/delhi" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Delhi</div><div class="pa-card-sub">Delhi NCR</div></div></a><a href="/esop-accounting-ind-as-102/gurugram" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Gurugram</div><div class="pa-card-sub">Haryana</div></div></a></div>
    </div></div>
</section>
