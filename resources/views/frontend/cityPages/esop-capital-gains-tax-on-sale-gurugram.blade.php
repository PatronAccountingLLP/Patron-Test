...
@section('meta')
    <title>Gurugram ESOP Sale Tax: FMV Cost Base & LTCG Rates</title>
    <meta name="description" content="Cyber City ESOP holders in Gurugram: we set the FMV cost base, split LTCG and STCG by holding period, and file your gains return from INR 4,999.">
    <meta name="keywords" content="ESOP Capital Gains Tax On Sale Gurugram, ESOP Capital Gains Tax On Sale in Gurugram, ESOP Capital Gains Tax On Sale services in Gurugram, ESOP services Gurugram, ESOP Capital Gains Tax On Sale cost Gurugram, ESOP Capital Gains Tax On Sale consultants Gurugram, CA firm for ESOP Capital Gains Tax On Sale Gurugram, ESOP advisory Gurugram">
    <link rel="canonical" href="/esop-capital-gains-tax-on-sale/gurugram">
    <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1">
    <meta property="og:title" content="Gurugram ESOP Sale Tax: FMV Cost Base & LTCG Rates | Patron Accounting">
    <meta property="og:description" content="Cyber City ESOP holders in Gurugram: we set the FMV cost base, split LTCG and STCG by holding period, and file your gains return from INR 4,999.">
...
@section('schema')    <script type="application/ld+json">{
  ...
  "@graph": [
    {
      "@type": "Service",
      "@id": "https://www.patronaccounting.com/esop-capital-gains-tax-on-sale/gurugram#service",
      "name": "ESOP Capital Gains Tax Computation on Sale in Gurugram",
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://www.patronaccounting.com/esop-capital-gains-tax-on-sale/gurugram#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
        ...
        },
        {
          ...
          "item": "https://www.patronaccounting.com/esop-capital-gains-tax-on-sale/gurugram"
        }
      ]
    },
    {
      ...
      "@id": "https://www.patronaccounting.com/esop-capital-gains-tax-on-sale/gurugram#localbusiness",
      "name": "Patron Accounting LLP - ESOP Capital Gains Tax On Sale, Gurugram",
      "url": "https://www.patronaccounting.com/esop-capital-gains-tax-on-sale/gurugram",
    ...
    {
      "@type": "FAQPage",
      "@id": "https://www.patronaccounting.com/esop-capital-gains-tax-on-sale/gurugram#faq",
      ...
      "mainEntity": [
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Capital gains tax is payable on the sale of ESOP shares, calculated on the sale price minus the FMV on exercise. For listed shares held for more than 12 months, LTCG is taxed at 12.5% on gains above Rs 1.25 lakh; otherwise STCG is taxed at 20%. We compute the gain and file the return for you."
          }
        },
        {
          "@type": "Question",
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-4 private-registration-heading">
                        ESOP Capital Gains Tax on Sale in Gurugram
                    </h1>

                    <p class="mb-4" style="font-size:16px;color:var(--text-secondary);">For Cyber City and Udyog Vihar SaaS-ITES staff and Golf Course Road startup teams, we set the FMV-on-exercise cost base, split LTCG and STCG by holding period, and file the gain.</p>
        ...
        <div class="two-column">
            <div class="column-content">
                ...
                <div class="content-text what-is-definition">
                    ...
                    <p>In a city where Cyber City SaaS and unicorn employees routinely hold large grants, ESOP capital gains tax is the charge that lands when those shares are finally sold. Section 111A or 112A of the Income-tax Act applies, and it taxes the sale price after deducting the fair market value set on your exercise date.</p>
                    <p>This sits one step beyond the <a href="/esop-perquisite-tax-section-17-2-vi/gurugram">perquisite tax you already paid when you exercised</a>. That earlier tax covered the gap between FMV and your exercise price as salary; the capital gain now captures only the further climb from FMV-on-exercise to the sale price, so a unicorn employee is never taxed twice on the same rupee.</p>
                    <p>The gain turns short-term or long-term on the holding period, which the law measures from the allotment date rather than the exercise date, a detail that decides the rate on a fast-moving Gurugram buyback.</p>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>Anyone who sells shares acquired through ESOPs has a capital gains event, whether the shares are listed, unlisted or foreign. In Gurugram this commonly means:</p>
                <ul>
                    <li>Cyber City and Udyog Vihar SaaS-ITES employees selling listed shares of a US or Singapore parent on the exchange or after an IPO.</li>
                    <li>Golf Course Road and Sohna Road startup staff selling unlisted shares in a company buyback or an <a href="/esop-secondary-sale-advisory/gurugram">ESOP-fund secondary</a>.</li>
                    <li>Indian residents selling foreign-parent ESOP or RSU shares, also taxable in Gurugram.</li>
                    <li>Unicorn and growth-stage founders advising teams on the tax impact of a liquidity event.</li>
                </ul>
...
<section class="content-section" style="background: var(--gray-50);">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">ESOP Share Sales in the Gurugram Market</h2>
            <div class="content-text">
                <p>Gurugram is among the most ESOP-heavy job markets in India. The Cyber City and Udyog Vihar SaaS and ITES campuses concentrate engineers holding RSUs in US-listed parents, while the Golf Course Road and Sohna Road startup clusters add a deep layer of unlisted-share holders in DPIIT-recognised, venture-backed companies. The typical Gurugram exit is therefore either a listed foreign-share sale through a broker, or an unlisted buyback or secondary in a high-growth startup.</p>
                <p>Although Gurugram sits in Haryana, companies here are registered with the <strong>Registrar of Companies (RoC) Delhi</strong>, which has jurisdiction over Haryana as well. For an unlisted share sale, the cost base rests on the <a href="/esop-valuation-services/gurugram">FMV that a SEBI-registered Category I merchant banker certified on the exercise date under Rule 11UA</a>, and that valuation must be no older than 180 days, a frequent gap when a Golf Course Road startup announces a buyback at short notice.</p>
                <p>For residents <a href="/blog/received-esops-from-a-foreign-company">holding foreign-parent shares</a>, the gain is taxed in Gurugram as Indian capital gains, the foreign holding is disclosed in Schedule FA, and tax withheld abroad is claimed via Form 67 under the relevant DTAA. We reconcile the broker statement, FMV-on-exercise working and AIS so a Cyber City or Udyog Vihar seller is taxed only on the genuine post-exercise gain, with advance tax timed to the right quarter.</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <table>
                    ...
                    <tbody>
                        <tr><td>Unicorn and Startup Buyback Handling</td><td>For Cyber City and Golf Course Road employees, we compute each buyback or secondary against its FMV-on-exercise cost base.</td></tr>
                        <tr><td>Cost-Base Verification</td><td>We tie that cost base to the perquisite in Form 12BA, so the exercise value is never taxed a second time.</td></tr>
                        <tr><td>Listed and Unlisted Treatment</td><td>Listed foreign-parent sales use Section 111A or 112A; unlisted startup shares use the slab or 12.5% rule.</td></tr>
                        <tr><td>Foreign ESOP and DTAA Relief</td><td>For US and Singapore parent RSUs across the SaaS-ITES belt, we apply treaty relief, Form 67 credit and Schedule FA disclosure.</td></tr>
                        <tr><td>Advance Tax Planning</td><td>We fit the advance-tax instalment into the right quarter to keep Section 234B and 234C interest off your account.</td></tr>
                        <tr><td>ITR Filing</td><td>We record each lot in Schedule 112A and file, separating sales before and after 23 July 2024.</td></tr>
...
<section class="steps-section" id="procedure-section">
    <div class="section-container">
        <header class="section-header" style="text-align:center;margin-bottom:48px;">
            ...
            <p class="section-subtitle" style="text-align:left;max-width:100%;">From a Cyber City employee's buyback letter to the filed return, these six steps carry a Gurugram ESOP sale through to the correct post-exercise gain.</p>
        </header>
    ...
    <div class="step-content">
        ...
        <p class="step-description">We capture the sale date and price from the buyback note or contract note and flag listed versus unlisted stock.</p>
...
<div class="step-card">
    <div class="step-content">
        ...
        <p class="step-description">We fix the cost at the FMV on your exercise date, the same value that already bore perquisite tax.</p>
        <div class="step-highlights">
...
<div class="step-card">
    <div class="step-content">
        ...
        <p class="step-description">Starting at allotment, more than 12 months for listed or 24 months for unlisted shares makes the gain long-term.</p>
        <div class="step-highlights">
...
<div class="step-card">
    <div class="step-content">
        ...
        <p class="step-description">We deduct cost base from sale price and classify the result as long-term or short-term capital gain.</p>
        <div class="step-highlights">
...
<div class="step-card">
    <div class="step-content">
        ...
        <p class="step-description">Listed stock: 12.5% LTCG above Rs 1.25 lakh or 20% STCG. Unlisted: 12.5% LTCG or slab STCG.</p>
        <div class="step-highlights">
...
<div class="step-card">
    <div class="step-content">
        ...
        <p class="step-description">We disclose each lot in Schedule 112A, pay advance tax, and file with pre and post 23 July 2024 sales separated.</p>
        <div class="step-highlights">
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <ul>
                    <li>The buyback letter or contract note for your Cyber City or Golf Course Road exit, with date and price.</li>
                    <li>The FMV-on-exercise certificate or perquisite working that forms your cost base.</li>
                    <li>The allotment record that sets the holding-period start date.</li>
                    <li>Your broker statement and AIS, reconciled before filing.</li>
                    <li>Form 16 or Form 12BA evidencing the perquisite already taxed at exercise.</li>
                    <li>For US or Singapore parent RSUs, the foreign-share and forex data plus Form 67 for the foreign tax credit.</li>
                </ul>
                <div class="highlight-box" style="margin-top:16px;">
                    <p><strong>Worked example</strong></p>
                    <p>Cyber City example: FMV at exercise Rs 600, sold listed at Rs 900 after 14 months, 2,500 shares. LTCG = (900 minus 600) x 2,500 = Rs 7,50,000. Tax at 12.5% on (7,50,000 minus 1,25,000) = Rs 78,125, plus cess.</p>
                </div>
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <table>
                    ...
                    <tbody>
                        <tr><td>A unicorn buyback taxed in full, ignoring the FMV-on-exercise already taxed</td><td>The exercise value is taxed twice over</td><td>We hold the cost base at FMV-on-exercise so only the genuine post-exercise gain is taxed.</td></tr>
                        <tr><td>Holding period counted from exercise instead of allotment</td><td>The gain is misfiled as STCG or LTCG</td><td>We always start at the allotment date to get the classification right.</td></tr>
                        <tr><td>Pre and post 23 July 2024 lots blended in the ITR</td><td>Part of the gain draws the wrong rate</td><td>We split the transactions by date and apply the correct rate to each.</td></tr>
                        <tr><td>A large Cyber City buyback gain that skips the advance-tax instalment</td><td>Section 234B and 234C interest</td><td>We schedule the advance tax to the quarter so that interest never begins.</td></tr>
...
<article class="feature-card">
            ...
            <p class="feature-text">The cost base is held at FMV-on-exercise, so the value already taxed at exercise is not charged a second time.</p>
        </article>
<article class="feature-card">
            ...
            <p class="feature-text">The LTCG or STCG call is made from the allotment date the law uses, not from the exercise date.</p>
        </article>
<article class="feature-card">
            ...
            <p class="feature-text">Applied per transaction across the 23 July 2024 split, each lot ends up on the rate that fits it.</p>
        </article>
<article class="feature-card">
            ...
            <p class="feature-text">Advance tax on a large buyback gain is scheduled in advance so Section 234B and 234C interest never accrues.</p>
        </article>
        </div>
    </div>
</section>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>Patron Accounting LLP is a CA and CS firm with 15+ years computing capital gains on equity and ESOP-share sales for employees and companies, including Cyber City SaaS-ITES and Golf Course Road startup teams across Gurugram.</p>
                <p>With offices in Pune, Mumbai, Delhi and Gurugram, Patron Accounting serves Cyber City, Udyog Vihar, Golf Course Road and Sohna Road sellers in-person and the rest of India remotely.</p>
...
<section class="content-section" id="comparison-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>Gurugram's option-holders span both ends: Cyber City SaaS-ITES staff often hold listed RSUs of a US-listed parent, while Golf Course Road and Sohna Road startup teams sit on unlisted shares until a buyback. The two carry different holding periods and rates, mapped out below.</p>
                <div class="table-responsive-wrapper">
                <table>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>For a Gurugram seller, although companies here file with RoC Delhi, the share-sale tax is governed entirely by the income-tax provisions summarised below.</p>
            ...
            <div class="faq-expanded">
                ...
                <div class="faq-expanded__list">
                    ...
                    <div class="faq-expanded__item" id="faq-3">
                        ...
                        <div class="faq-expanded__a"><p>Capital gains tax is payable on the sale of ESOP shares, calculated on the sale price minus the FMV on exercise. For listed shares held for more than 12 months, LTCG is taxed at 12.5% on gains above Rs 1.25 lakh; otherwise STCG is taxed at 20%. We compute the gain and file the return for you.</p></div>
                    </div>
                    ...
                    <div class="faq-expanded__item" id="faq-5">
                        <h3 class="faq-expanded__q">Are ESOPs taxed twice in Gurugram?</h3>
                    ...
                    <div class="faq-expanded__item" id="faq-6">
                        <h3 class="faq-expanded__q">How are foreign-parent RSUs taxed for a DLF Cyber City SaaS employee?</h3>
                        <div class="faq-expanded__a"><p>Many DLF Cyber City and Udyog Vihar enterprise-SaaS and ITES employees hold US or Singapore parent RSUs. For a Gurugram resident the gain is taxed as Indian capital gains on sale price minus FMV-on-exercise; the foreign holding is disclosed in Schedule FA and any tax withheld abroad is claimed through Form 67 under the relevant DTAA, so the same gain is not taxed twice across borders.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-7">
                        <h3 class="faq-expanded__q">How is a Gurugram unicorn secondary sale of ESOP shares taxed?</h3>
                        <div class="faq-expanded__a"><p>When employees of a DLF Cyber City or Golf Course Road unicorn such as Zomato, Delhivery or Policybazaar exit through a secondary or buyback, the gain is sale price minus FMV-on-exercise. Held over 24 months for unlisted shares it is long-term at 12.5% without indexation; within 24 months it is taxed at slab rate. Gurugram companies file with the Registrar of Companies (RoC) Delhi, which covers Haryana.</p></div>
                    </div>
