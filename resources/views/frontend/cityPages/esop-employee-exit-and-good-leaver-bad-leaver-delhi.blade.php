...
@section('meta')
    <title>Delhi ESOP Exit Advisory: Vesting & Buyback Rights</title>
    <meta name="description" content="When you exit a Delhi-NCR company, we settle ESOP good vs bad leaver status, vested-option forfeiture, buyback and perquisite tax cleanly, from INR 14,999.">
    <meta name="keywords" content="ESOP Employee Exit and Good Leaver Bad Leaver Delhi, ESOP Employee Exit and Good Leaver Bad Leaver in Delhi, ESOP Employee Exit and Good Leaver Bad Leaver services in Delhi, ESOP services Delhi, ESOP Employee Exit and Good Leaver Bad Leaver cost Delhi, ESOP Employee Exit and Good Leaver Bad Leaver consultants Delhi, CA firm for ESOP Employee Exit and Good Leaver Bad Leaver Delhi, ESOP advisory Delhi">
    <link rel="canonical" href="/esop-employee-exit-and-good-leaver-bad-leaver/delhi">
    <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1">
    <meta property="og:title" content="Delhi ESOP Exit Advisory: Vesting & Buyback Rights | Patron Accounting">
    <meta property="og:description" content="When you exit a Delhi-NCR company, we settle ESOP good vs bad leaver status, vested-option forfeiture, buyback and perquisite tax cleanly, from INR 14,999.">
...
@section('schema')    <script type="application/ld+json">{
  ...
  "@graph": [
    {
      "@type": "Service",
      "@id": "https://www.patronaccounting.com/esop-employee-exit-and-good-leaver-bad-leaver/delhi#service",
      "name": "ESOP on Employee Exit: Good Leaver and Bad Leaver in Delhi",
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://www.patronaccounting.com/esop-employee-exit-and-good-leaver-bad-leaver/delhi#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
        ...
        },
        {
          ...
          "item": "https://www.patronaccounting.com/esop-employee-exit-and-good-leaver-bad-leaver/delhi"
        }
      ]
    },
    {
      ...
      "@id": "https://www.patronaccounting.com/esop-employee-exit-and-good-leaver-bad-leaver/delhi#localbusiness",
      "name": "Patron Accounting LLP - ESOP Employee Exit And Good Leaver Bad Leaver, Delhi",
      "url": "https://www.patronaccounting.com/esop-employee-exit-and-good-leaver-bad-leaver/delhi",
    ...
    {
      "@type": "FAQPage",
      "@id": "https://www.patronaccounting.com/esop-employee-exit-and-good-leaver-bad-leaver/delhi#faq",
      ...
      "mainEntity": [
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "A good leaver is someone who leaves the company under fair circumstances, such as resignation on notice, a layoff or retirement, and retains their vested options along with an exercise window. A bad leaver is someone who is terminated for cause, or who commits misconduct or joins a competitor; such a person loses their unvested options and, in some cases, their vested options as well. The exact rule is set out in the scheme."
          }
        },
        {
          "@type": "Question",
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-4 private-registration-heading">
                        ESOP on Employee Exit: Good Leaver and Bad Leaver in Delhi
                    </h1>

                    <p class="mb-4" style="color: var(--text-secondary); font-size: 16px; line-height: 1.6;">For Delhi-NCR employers, from Nehru Place product teams to Connaught Place advisory firms, with RoC Delhi and the MCA head office in the capital and many cap tables carrying NRI and overseas holders.</p>
        ...
        <div class="two-column">
            <div class="column-content">
                ...
                <div class="content-text what-is-definition">
                    ...
                    <p>Almost every ESOP scheme run by a Delhi company splits departing employees into two categories, and the category decides what happens to their options. For a Nehru Place IT manager moving firms or a Connaught Place finance professional exiting on mutual terms, the line is drawn by how, and why, the person leaves.</p>
                    <p><strong>Good leaver:</strong> a fair exit, a Nehru Place IT manager resigning on notice, a Connaught Place professional leaving on mutual terms, or an employee departing on layoff, retirement or health grounds. Good leavers keep their vested options and are given a defined window to exercise.</p>
                    <p><strong>Bad leaver:</strong> a departure that injures the company, termination for cause, misconduct, a breach of confidentiality, or moving to a competitor. Bad leavers forfeit unvested options and, in many of the older Delhi schemes, unexercised vested options as well.</p>
                    <p><strong>The provision to scrutinise:</strong> Delhi schemes are often older and governance-led, and some still treat an ordinary resignation as a bad-leaver event, capable of stripping vested options from a loyal employee. A fair scheme reads a plain resignation as a good-leaver exit. With the MCA and RoC Delhi on our doorstep, we examine the drafting closely so the classification is both correct and defensible.</p>
...
<section class="content-section" id="who-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Unvested Options, Buyback and the NRI Holder</h2>
            <div class="content-text">
                
                <p><strong>Unvested options:</strong> on a Delhi exit these are generally forfeited for good and bad leavers alike, since they were never earned. A board can decide to accelerate or pro-rate a portion for a good leaver, but that remains discretionary and never guaranteed.</p>
                <p><strong>Buyback on exit:</strong> a company can buy back a leaver's vested options or shares for cash, delivering liquidity and cleaning the cap table together, which matters where a departing holder is an NRI managing the exit from abroad. Good leavers are bought out at fair value, bad leavers may take a discount if the scheme allows. We structure the buyback, the <a href="/esop-valuation-services/delhi">valuation</a>, the cross-border paperwork and the filings.</p>
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <table>
                    ...
                    <tbody>
                        <tr><td>30 days</td><td>Punitive and impractical, especially for an NRI leaver coordinating funds across borders.</td></tr>
                        <tr><td>90 days</td><td>The common standard in Delhi startups.</td></tr>
                        <tr><td>1 year or more</td><td>Employee-friendly; the standard in well-governed, professionally drafted Delhi schemes.</td></tr>
                        <tr><td>The exercise-cost trap</td><td>To exercise, the leaver pays the strike plus the perquisite tax in cash before the window ends. Where the scheme is old and silent and there is no buyback, Delhi employees, NRI holders included, routinely lose options they earned.</td></tr>
...
<section class="steps-section" id="procedure-section">
    <div class="section-container">
        <header class="section-header" style="text-align:center;margin-bottom:48px;">
            ...
            <p class="section-subtitle" style="text-align:left;max-width:100%;">From reading the grant to the final RoC Delhi filing, we move with the exit so a Delhi ESOP separation is settled when the employee leaves, with older, governance-led schemes corrected along the way.</p>
        </header>
    ...
    <div class="step-content">
        ...
        <p class="step-description">We study the scheme and grant letter, including older drafting, and pull the vesting and exercise terms.</p>
...
<div class="step-card">
    <div class="step-content">
        ...
        <p class="step-description">We set the facts of the exit against the scheme and document the good- or bad-leaver finding.</p>
        <div class="step-highlights">
...
<div class="step-card">
    <div class="step-content">
        ...
        <p class="step-description">We calculate vested and unvested options and define what this leaver type retains.</p>
        <div class="step-highlights">
...
<div class="step-card">
    <div class="step-content">
        ...
        <p class="step-description">We administer the window or arrange a buyback, handling any NRI element and the tax.</p>
        <div class="step-highlights">
...
<div class="step-card">
    <div class="step-content">
        ...
        <p class="step-description">We fold it into the full-and-final settlement and complete the SH-6 register and RoC filings.</p>
        <div class="step-highlights">
...
<section class="content-section" id="documents-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">How an Exit Exercise Is Taxed in Delhi</h2>
            <div class="content-text">
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Where Delhi exits run into trouble</th><th>Impact</th><th>How Patron Accounting Solves It</th></tr></thead>
                    <tbody>
                        <tr><td>Leaver status disputed under an old scheme</td><td>A costly, avoidable dispute</td><td>We apply the scheme to the facts and record a defensible basis.</td></tr>
                        <tr><td>NRI leaver cannot fund exercise in the window</td><td>Earned vested options lost</td><td>We advise on window, tax and a buyback to bridge liquidity.</td></tr>
                        <tr><td>Resignation treated as bad leaver by old wording</td><td>Unfair loss of vested options</td><td>We test the clause and correct the classification.</td></tr>
                        <tr><td>Vested options forfeited without authority</td><td>A legally indefensible forfeiture</td><td>We confirm what the scheme actually permits before acting.</td></tr>
...
<article class="feature-card">
            ...
            <h3 class="feature-title">Governance-grade classification</h3>
            <p class="feature-text">A defensible leaver call that holds up under the governance lens Delhi schemes invite.</p>
        </article>
<article class="feature-card">
            ...
            <h3 class="feature-title">Tax made clear, cross-border too</h3>
            <p class="feature-text">The window and perquisite tax explained to the leaver, including any NRI dimension.</p>
        </article>
<article class="feature-card">
            ...
            <h3 class="feature-title">Clean buyback and transfer</h3>
            <p class="feature-text">A clean buyback and share transfer that closes the equity, onshore or offshore.</p>
        </article>
<article class="feature-card">
            ...
            <h3 class="feature-title">Old schemes, fewer disputes</h3>
            <p class="feature-text">We fix dated wording so the treatment follows the scheme and disputes fade.</p>
        </article>
        </div>
    </div>
</section>
...
<section class="content-section" id="comparison-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Good Leaver and Bad Leaver Compared</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p><strong>Leaver provisions:</strong> good- and bad-leaver treatment is governed by the ESOP scheme and grant letter; with the MCA headquartered in Delhi, any forfeiture of vested options must be expressly permitted by the scheme and legally defensible, never arbitrary.</p>
                <p><strong>Exercise window:</strong> vested options last only for the post-termination window in the scheme and then lapse; the company must give the leaver, including one based abroad, the means and information to exercise.</p>
                <p><strong>Perquisite tax:</strong> at exercise the spread between fair market value and the strike is a <a href="/esop-perquisite-tax-section-17-2-vi/delhi">salary perquisite under Section 17(2)(vi)</a> of the Income-tax Act, with fair market value under Rule 3 and the related valuation rules.</p>
                <p><strong>Capital gains and buyback:</strong> a later sale or buyback of the shares is taxed as <a href="/esop-capital-gains-tax-on-sale/delhi">capital gains</a> over the perquisite-taxed value, the rate set by the holding period, with NRI holders subject to the applicable withholding.</p>
            ...
            <div class="faq-expanded">
                ...
                <div class="faq-expanded__list">
                    ...
                    <div class="faq-expanded__item" id="faq-3">
                        <h3 class="faq-expanded__q">What is the difference between a good leaver and a bad leaver?</h3>
                        <div class="faq-expanded__a"><p>A good leaver is someone who leaves the company under fair circumstances, such as resignation on notice, a layoff or retirement, and retains their vested options along with an exercise window. A bad leaver is someone who is terminated for cause, or who commits misconduct or joins a competitor; such a person loses their unvested options and, in some cases, their vested options as well. The exact rule is set out in the scheme.</p></div>
                    </div>
                    ...
                    <div class="faq-expanded__item" id="faq-5">
                        <h3 class="faq-expanded__q">Our Delhi company's ESOP scheme is old and vague on exits. Can you fix it?</h3>
                        <div class="faq-expanded__a"><p>Yes, and this is the most common issue we see with established Delhi companies. Older schemes often leave the leaver definition and exercise window unclear, or treat ordinary resignation as a bad-leaver event, which is legally fragile. We review the scheme, tighten the good-leaver and bad-leaver wording, set a defensible exercise window and align it with the grant letters, so the next exit is handled cleanly instead of being negotiated under pressure. We can do this proactively or at the point of a live exit.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-6">
                        <h3 class="faq-expanded__q">Where does a Delhi company file its ESOP and exit paperwork?</h3>
                        <div class="faq-expanded__a"><p>A Delhi-headquartered private company files its option allotments and maintains the SH-6 register with the Registrar of Companies (RoC) Delhi under the Ministry of Corporate Affairs, whose headquarters is in the capital, while the perquisite tax on exercise and capital gains on a buyback are administered by the Income Tax Department. The leaver classification, exercise window and any forfeiture flow from your ESOP scheme rather than a government form, so we align the documentation with both the scheme and these MCA and tax filings.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-7">
                        <h3 class="faq-expanded__q">Does a resignation count as a bad-leaver event?</h3>
                        <div class="faq-expanded__a"><p>This depends on the scheme. Under a well-drafted scheme, an ordinary resignation is treated as a good-leaver event. However, some schemes treat even a voluntary resignation as a bad-leaver event, which is a red flag, because it can cause you to lose even the vested options you have already earned. You should therefore check the leaver definition in your grant letter carefully. This is something we review for you.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-8">
                        <h3 class="faq-expanded__q">Can a Delhi company take away an employee's vested options?</h3>
                        <div class="faq-expanded__a"><p>Only if the scheme expressly allows it and the action is legally defensible. Vested options are an earned right, and a company cannot simply erase them; a bad-leaver clause can forfeit them only where the scheme provides for it and the facts support that classification. With governance-conscious Delhi employers, the risk is usually an older scheme being read too aggressively against a normal resignation. We confirm what the scheme actually permits before any forfeiture, so the company stays on defensible ground and the employee is treated fairly.</p></div>
                    </div>
                </div>
            </div>
