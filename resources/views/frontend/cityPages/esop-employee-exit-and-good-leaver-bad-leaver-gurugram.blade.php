...
@section('meta')
    <title>Gurugram ESOP Exit: Leaver Status & Exercise Window</title>
    <meta name="description" content="Exiting a Gurugram Cyber City SaaS firm? We resolve good vs bad leaver terms, option forfeiture, the exercise window and buyback value, from INR 14,999.">
    <meta name="keywords" content="ESOP Employee Exit and Good Leaver Bad Leaver Gurugram, ESOP Employee Exit and Good Leaver Bad Leaver in Gurugram, ESOP Employee Exit and Good Leaver Bad Leaver services in Gurugram, ESOP services Gurugram, ESOP Employee Exit and Good Leaver Bad Leaver cost Gurugram, ESOP Employee Exit and Good Leaver Bad Leaver consultants Gurugram, CA firm for ESOP Employee Exit and Good Leaver Bad Leaver Gurugram, ESOP advisory Gurugram">
    <link rel="canonical" href="/esop-employee-exit-and-good-leaver-bad-leaver/gurugram">
    <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1">
    <meta property="og:title" content="Gurugram ESOP Exit: Leaver Status & Exercise Window | Patron Accounting">
    <meta property="og:description" content="Exiting a Gurugram Cyber City SaaS firm? We resolve good vs bad leaver terms, option forfeiture, the exercise window and buyback value, from INR 14,999.">
...
@section('schema')    <script type="application/ld+json">{
  ...
  "@graph": [
    {
      "@type": "Service",
      "@id": "https://www.patronaccounting.com/esop-employee-exit-and-good-leaver-bad-leaver/gurugram#service",
      "name": "ESOP on Employee Exit: Good Leaver and Bad Leaver in Gurugram",
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://www.patronaccounting.com/esop-employee-exit-and-good-leaver-bad-leaver/gurugram#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
        ...
        },
        {
          ...
          "item": "https://www.patronaccounting.com/esop-employee-exit-and-good-leaver-bad-leaver/gurugram"
        }
      ]
    },
    {
      ...
      "@id": "https://www.patronaccounting.com/esop-employee-exit-and-good-leaver-bad-leaver/gurugram#localbusiness",
      "name": "Patron Accounting LLP - ESOP Employee Exit And Good Leaver Bad Leaver, Gurugram",
      "url": "https://www.patronaccounting.com/esop-employee-exit-and-good-leaver-bad-leaver/gurugram",
    ...
    {
      "@type": "FAQPage",
      "@id": "https://www.patronaccounting.com/esop-employee-exit-and-good-leaver-bad-leaver/gurugram#faq",
      ...
      "mainEntity": [
        ...
        {
          "@type": "Question",
          "name": "What is the practical difference between a good leaver and a bad leaver?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "A good leaver is an employee who leaves the company under fair circumstances, such as resignation on notice, a layoff or retirement, and retains their vested options together with an exercise window. A bad leaver is an employee who is terminated for cause or who commits misconduct or joins a competitor; such an employee forfeits unvested options and, in some cases, vested options as well. The exact rule is set out in the scheme."
          }
        },
        {
          "@type": "Question",
        ...
        {
          "@type": "Question",
          "name": "Do you handle ESOP exits for Gurugram Cyber City and Udyog Vihar companies?",
          "acceptedAnswer": {
            "@type": "Answer",
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-4 private-registration-heading">
                        ESOP on Employee Exit: Good Leaver and Bad Leaver in Gurugram
                    </h1>

                    <p class="mb-4" style="color: var(--text-secondary); font-size: 16px;">For Cyber City, Udyog Vihar and Golf Course Road SaaS and unicorn teams, we settle the leaver call, exercise window and buyback the moment an employee exits.</p>
        ...
        <div class="two-column">
            <div class="column-content">
                ...
                <div class="content-text what-is-definition">
                    ...
                    <p>Almost every ESOP scheme run by a Gurugram SaaS or ITES company splits departing employees into two categories, and the category decides what happens to their options. For a Cyber City engineer moving to another product company or a Golf Course Road founder restructuring a sales team, the line is drawn by how, and why, the person leaves.</p>
                    <p><strong>Good leaver:</strong> a clean exit, a Cyber City engineer resigning on notice, a Golf Course Road operator leaving in a post-funding restructure, or someone departing on layoff, retirement or health grounds. Good leavers keep their vested options with a fixed window to exercise.</p>
                    <p><strong>Bad leaver:</strong> a departure that harms the company, termination for cause, misconduct, a confidentiality breach, or crossing to a rival in Gurugram's dense enterprise-SaaS market. Bad leavers forfeit unvested options and, where the plan says so, unexercised vested options as well.</p>
                    <p><strong>The clause that bites:</strong> fast-scaling Gurugram unicorns and SaaS firms granted options at speed, and some schemes still tag a normal resignation as a bad-leaver event, wiping out vested options as employees churn between Cyber City and Udyog Vihar. A fair scheme treats ordinary resignation as a good-leaver exit. We pressure-test the wording so the classification is correct and defensible.</p>
...
<section class="content-section" id="who-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Unvested Options and Buyback at Scale</h2>
            <div class="content-text">
                
                <p><strong>Unvested options:</strong> across Gurugram's high-attrition SaaS teams these lapse on exit for good and bad leavers alike, because they were never earned. A board can accelerate or pro-rate a portion for a key good leaver, but that is a discretionary, case-by-case call.</p>
                <p><strong>Buyback on exit:</strong> with unicorns running <a href="/esop-secondary-sale-advisory/gurugram">secondaries</a> and structured buybacks, a company can repurchase a leaver's vested options or shares for cash, giving liquidity and cleaning a cap table that turns over fast. Good leavers are bought out at fair value, bad leavers at a discount where the scheme allows. We structure the buyback, the <a href="/esop-valuation-services/gurugram">valuation</a> and the paperwork at the volume Gurugram exits demand.</p>
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <table>
                    ...
                    <tbody>
                        <tr><td>30 days</td><td>Punitive for high-churn teams, too little time to fund the strike and tax on a quick exit.</td></tr>
                        <tr><td>90 days</td><td>The common standard in Gurugram startups.</td></tr>
                        <tr><td>1 year or more</td><td>Employee-friendly; increasingly the norm at well-run Gurugram unicorns and SaaS firms.</td></tr>
                        <tr><td>The exercise-cost trap</td><td>Exercising means paying the strike plus the perquisite tax in cash before the window shuts. With rapid churn and no secondary or buyback timed to it, many Gurugram employees forfeit vested options they earned.</td></tr>
...
<section class="steps-section" id="procedure-section">
    <div class="section-container">
        <header class="section-header" style="text-align:center;margin-bottom:48px;">
            ...
            <p class="section-subtitle" style="text-align:left;max-width:100%;">From reading the grant to the final filing, we keep pace with high-volume Gurugram exits so each ESOP separation is settled as the employee leaves, even across a fast-churning SaaS team.</p>
        </header>
    ...
    <div class="step-content">
        ...
        <p class="step-description">We review the scheme and grant letter and extract the vesting and exercise terms.</p>
...
<div class="step-card">
    <div class="step-content">
        ...
        <p class="step-description">We test the facts of the exit against the scheme and record the good- or bad-leaver call.</p>
        <div class="step-highlights">
...
<div class="step-card">
    <div class="step-content">
        ...
        <p class="step-description">We compute vested and unvested options and set out what this leaver type keeps.</p>
        <div class="step-highlights">
...
<div class="step-card">
    <div class="step-content">
        ...
        <p class="step-description">We run the window or build a buyback at scale, with the perquisite tax handled.</p>
        <div class="step-highlights">
...
<section class="content-section" id="documents-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">How an Exit Exercise Is Taxed in Gurugram</h2>
            <div class="content-text">
                ...
                <p><strong>Gurugram example.</strong> A sales lead leaving a Udyog Vihar SaaS company as a good leaver may hold 3,000 vested options at a low strike; on exercise, the spread between fair market value and the exercise price is <a href="/esop-perquisite-tax-section-17-2-vi/gurugram">taxed as a perquisite</a> straight away, even though the company is unlisted and there is no buyer yet. That perquisite-tax cash demand, due inside the scheme's 30-to-90-day window, is the single most common reason Gurugram employees forfeit options they have earned, which is why we pair the classification with a buyback or liquidity plan where one is possible.</p>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Where Gurugram exits break down</th><th>Impact</th><th>How Patron Accounting Solves It</th></tr></thead>
                    <tbody>
                        <tr><td>Leaver status disputed amid rapid attrition</td><td>A costly dispute, often repeated</td><td>We apply the scheme to the facts and document a defensible basis each time.</td></tr>
                        <tr><td>Leaver cannot fund exercise before a secondary</td><td>Earned vested options forfeited</td><td>We align the window, tax and buyback to the liquidity event.</td></tr>
                        <tr><td>Resignation mis-tagged in a fast-granted scheme</td><td>Unfair loss of vested options</td><td>We check the clause and correct the classification.</td></tr>
                        <tr><td>Vested options pulled without scheme authority</td><td>An indefensible forfeiture</td><td>We confirm what the scheme permits before any forfeiture, at any volume.</td></tr>
...
<article class="feature-card">
            ...
            <h3 class="feature-title">Defensible across every exit</h3>
            <p class="feature-text">A consistent, documented leaver call that holds up across a high-volume Gurugram cap table.</p>
        </article>
<article class="feature-card">
            ...
            <h3 class="feature-title">Tax clarity at speed</h3>
            <p class="feature-text">The window and perquisite tax explained to each departing employee, fast.</p>
        </article>
<article class="feature-card">
            ...
            <h3 class="feature-title">Buyback built to scale</h3>
            <p class="feature-text">A clean buyback and settlement that closes equity even on a churning team.</p>
        </article>
<article class="feature-card">
            ...
            <h3 class="feature-title">Fewer disputes, repeatably</h3>
            <p class="feature-text">Treatment follows the scheme and is on record, so exits rarely escalate.</p>
        </article>
        </div>
    </div>
</section>
...
<section class="content-section" id="comparison-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Good Leaver vs Bad Leaver: the Distinction</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p><strong>Leaver provisions:</strong> good- and bad-leaver treatment is fixed by the ESOP scheme and grant letter; for Gurugram companies, which file with RoC Delhi, any forfeiture of vested options must be expressly permitted by the scheme and legally defensible, not arbitrary.</p>
                <p><strong>Exercise window:</strong> vested options last only for the post-termination window the scheme sets and then lapse; the company must give every leaver the means and information to exercise within it.</p>
                <p><strong>Perquisite tax:</strong> on exercise the spread between fair market value and the strike is a salary perquisite under Section 17(2)(vi) of the Income-tax Act, with fair market value under Rule 3 and the related valuation rules.</p>
                <p><strong>Capital gains and buyback:</strong> a later sale, often into a secondary, or a buyback is taxed as <a href="/esop-capital-gains-tax-on-sale/gurugram">capital gains</a> over the perquisite-taxed value, with the rate driven by the holding period.</p>
            ...
            <div class="faq-expanded">
                ...
                <div class="faq-expanded__list">
                    ...
                    <div class="faq-expanded__item" id="faq-3">
                        <h3 class="faq-expanded__q">What is the practical difference between a good leaver and a bad leaver?</h3>
                        <div class="faq-expanded__a"><p>A good leaver is an employee who leaves the company under fair circumstances, such as resignation on notice, a layoff or retirement, and retains their vested options together with an exercise window. A bad leaver is an employee who is terminated for cause or who commits misconduct or joins a competitor; such an employee forfeits unvested options and, in some cases, vested options as well. The exact rule is set out in the scheme.</p></div>
                    </div>
                    ...
                    <div class="faq-expanded__item" id="faq-5">
                        <h3 class="faq-expanded__q">Do you handle ESOP exits for Gurugram Cyber City and Udyog Vihar companies?</h3>
                        <div class="faq-expanded__a"><p>Yes. We work with founders and HR teams across Cyber City, Udyog Vihar, Golf Course Road and the Sohna Road tech corridor, the clusters where most of Gurugram's SaaS and ITES employers sit. Because these teams grant options aggressively and churn fast, we set up the leaver classification and exercise-window process once and then run each senior exit cleanly against the scheme, in step with the notice period and the full-and-final settlement.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-6">
                        <h3 class="faq-expanded__q">Where does a Gurugram company file its ESOP and exit paperwork?</h3>
                        <div class="faq-expanded__a"><p>A Gurugram-headquartered private company is in Haryana, but since there is no separate Registrar of Companies for Haryana, it files its option allotments and maintains the SH-6 register with the Registrar of Companies (RoC) Delhi, which has jurisdiction over Haryana, under the Ministry of Corporate Affairs. The perquisite tax on exercise and capital gains on a buyback are administered by the Income Tax Department. The leaver classification, exercise window and any forfeiture flow from your ESOP scheme, so we align the documentation with both the scheme and these filings.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-7">
                        <h3 class="faq-expanded__q">Is a resignation treated as a bad-leaver event?</h3>
                        <div class="faq-expanded__a"><p>It depends on the scheme. Under a well-drafted scheme, an ordinary resignation is a good-leaver event. However, some schemes treat even a voluntary resignation as a bad-leaver event, which is a red flag, because it can cause you to forfeit the vested options you have already earned. You should therefore check the leaver definition in your grant letter carefully. We review this for you.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-8">
                        <h3 class="faq-expanded__q">Can a Gurugram SaaS employee afford the exercise on a pre-liquidity grant?</h3>
                        <div class="faq-expanded__a"><p>That is the central problem in Gurugram. Many Cyber City and Sohna Road SaaS companies grant options while still private and pre-liquidity, so a good leaver must fund the exercise price plus the perquisite tax in cash within a 30-to-90-day window, often with no buyer in sight. This cash crunch is why earned options get forfeited. We flag it early, check whether the scheme allows a cashless exercise, and structure a buyback or liquidity route where the company can support one.</p></div>
                    </div>
                </div>
            </div>
