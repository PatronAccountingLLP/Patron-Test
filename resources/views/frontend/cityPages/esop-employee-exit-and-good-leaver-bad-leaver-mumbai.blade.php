...
@section('meta')
    <title>Mumbai ESOP Leaver Treatment & Option Buyback Plan</title>
    <meta name="description" content="For Mumbai option holders, we map good-leaver vs bad-leaver outcomes, vested-share buyback, exercise timelines and exit tax in your F&F, from INR 14,999.">
    <meta name="keywords" content="ESOP Employee Exit and Good Leaver Bad Leaver Mumbai, ESOP Employee Exit and Good Leaver Bad Leaver in Mumbai, ESOP Employee Exit and Good Leaver Bad Leaver services in Mumbai, ESOP services Mumbai, ESOP Employee Exit and Good Leaver Bad Leaver cost Mumbai, ESOP Employee Exit and Good Leaver Bad Leaver consultants Mumbai, CA firm for ESOP Employee Exit and Good Leaver Bad Leaver Mumbai, ESOP advisory Mumbai">
    <link rel="canonical" href="/esop-employee-exit-and-good-leaver-bad-leaver/mumbai">
    <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1">
    <meta property="og:title" content="Mumbai ESOP Leaver Treatment & Option Buyback Plan | Patron Accounting">
    <meta property="og:description" content="For Mumbai option holders, we map good-leaver vs bad-leaver outcomes, vested-share buyback, exercise timelines and exit tax in your F&F, from INR 14,999.">
...
@section('schema')    <script type="application/ld+json">{
  ...
  "@graph": [
    {
      "@type": "Service",
      "@id": "https://www.patronaccounting.com/esop-employee-exit-and-good-leaver-bad-leaver/mumbai#service",
      "name": "ESOP on Employee Exit: Good Leaver and Bad Leaver in Mumbai",
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://www.patronaccounting.com/esop-employee-exit-and-good-leaver-bad-leaver/mumbai#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
        ...
        },
        {
          ...
          "item": "https://www.patronaccounting.com/esop-employee-exit-and-good-leaver-bad-leaver/mumbai"
        }
      ]
    },
    {
      ...
      "@id": "https://www.patronaccounting.com/esop-employee-exit-and-good-leaver-bad-leaver/mumbai#localbusiness",
      "name": "Patron Accounting LLP - ESOP Employee Exit And Good Leaver Bad Leaver, Mumbai",
      "url": "https://www.patronaccounting.com/esop-employee-exit-and-good-leaver-bad-leaver/mumbai",
    ...
    {
      "@type": "FAQPage",
      "@id": "https://www.patronaccounting.com/esop-employee-exit-and-good-leaver-bad-leaver/mumbai#faq",
      ...
      "mainEntity": [
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "A good leaver is someone who leaves the company under fair circumstances, such as resignation with notice, a layoff or retirement, and retains their vested options with an exercise window. A bad leaver is someone terminated for cause, or who has committed misconduct or joined a competitor; such a person forfeits unvested options and, in some cases, vested options as well. The exact rule is set out in the scheme."
          }
        },
        {
          "@type": "Question",
        ...
        <div class="row align-items-center">
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <p class="mb-4" style="color: var(--text-secondary); font-size: 16px;">For exits across BKC, Lower Parel and the Andheri-Powai SaaS belt, we classify the leaver and settle vested options before the next listing or secondary, a short ride from SEBI's BKC headquarters.</p>
        ...
        <div class="two-column">
            <div class="column-content">
                ...
                <div class="content-text what-is-definition">
                    ...
                    <p>Almost every ESOP scheme run by a Mumbai company splits departing employees into two categories, and the category decides what happens to their options. For a BKC fintech executive joining a rival or a Powai SaaS engineer resigning to start up, the line is drawn by how, and why, the person leaves.</p>
                    <p><strong>Good leaver:</strong> a clean exit, a BKC fintech manager resigning on notice, a Powai SaaS lead leaving to found a startup, or someone going on layoff, retirement or health grounds. Good leavers hold on to their vested options and receive a set window to exercise.</p>
                    <p><strong>Bad leaver:</strong> an exit that hurts the firm, dismissal for cause, misconduct, a confidentiality breach, or moving to a competing house in Mumbai's tight finance and fintech circle. Bad leavers forfeit unvested options and, where the plan provides, their unexercised vested options too.</p>
                    <p><strong>The clause to interrogate:</strong> in some Mumbai plans even a routine resignation is coded as a bad-leaver trigger, capable of erasing vested options from an employee who simply moved on. Sound schemes treat ordinary resignation as a good-leaver exit. Sitting a short ride from SEBI's BKC headquarters, we hold these schemes to a governance standard and check the wording before any options are touched.</p>
...
<section class="content-section" id="who-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Unvested Options, and the Buyback Before a Listing</h2>
            <div class="content-text">
                
                <p><strong>Unvested options:</strong> on any Mumbai exit these typically fall away for good and bad leavers alike, as they were never earned. A board may, at its discretion, accelerate or pro-rate part of them for a good leaver, but nothing about that is automatic.</p>
                <p><strong>Buyback on exit:</strong> in a finance hub where a listing or <a href="/esop-secondary-sale-advisory/mumbai">secondary</a> can be on the horizon, a buyback of a leaver's vested options or shares gives liquidity and clears the cap table at once. Good leavers are bought out at fair value; bad leavers may be priced at a discount if the scheme permits. We structure the buyback, the <a href="/esop-valuation-services/mumbai">valuation</a> and the documents, and time them around any SEBI-regulated event.</p>
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <table>
                    ...
                    <tbody>
                        <tr><td>30 days</td><td>Harsh in a high-cost city, too little time to fund the strike and the tax bill.</td></tr>
                        <tr><td>90 days</td><td>The common standard in Mumbai startups.</td></tr>
                        <tr><td>1 year or more</td><td>Employee-friendly, common in better-governed Mumbai finance and fintech plans.</td></tr>
                        <tr><td>The exercise-cost trap</td><td>Exercising means paying the strike plus the perquisite tax in cash before the window closes. In Mumbai the absolute numbers are often large, so without a listing, secondary or buyback even well-paid employees walk away from vested options.</td></tr>
...
<section class="steps-section" id="procedure-section">
    <div class="section-container">
        <header class="section-header" style="text-align:center;margin-bottom:48px;">
            ...
            <p class="section-subtitle" style="text-align:left;max-width:100%;">From reading the grant to the final filing, we work to the rhythm of the exit, and to the timing of any listing or secondary, so a Mumbai ESOP exit is settled the moment the employee leaves.</p>
        </header>
    ...
    <div class="step-content">
        ...
        <p class="step-description">We go through the scheme and grant letter and extract the precise vesting and exercise terms.</p>
...
<div class="step-card">
    <div class="step-content">
        ...
        <p class="step-description">We weigh the facts of the exit against the scheme and record the good- or bad-leaver decision.</p>
        <div class="step-highlights">
...
<div class="step-card">
    <div class="step-content">
        ...
        <p class="step-description">We compute vested and unvested options and state exactly what this leaver type retains.</p>
        <div class="step-highlights">
...
<div class="step-card">
    <div class="step-content">
        ...
        <p class="step-description">We run the window or structure a buyback, sequenced around any listing, with the tax handled.</p>
        <div class="step-highlights">
...
<div class="step-card">
    <div class="step-content">
        ...
        <p class="step-description">We bring it into the full-and-final settlement and complete the SH-6 register and filings.</p>
        <div class="step-highlights">
...
<section class="content-section" id="documents-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">How an Exit Exercise Is Taxed in Mumbai</h2>
            <div class="content-text">
                ...
                <p><strong>Mumbai example.</strong> A product head leaving a BKC fintech ahead of its IPO may exercise vested options and trigger a large perquisite-tax bill, then sell into the listing or a SEBI-regulated secondary and pay <a href="/esop-capital-gains-tax-on-sale/mumbai">capital gains</a> on the further upside. Here the timing is everything: exercising as a good leaver before listing locks in a lower perquisite base, while a mishandled bad-leaver tag can forfeit the very options that would have funded the gain. We sequence the exercise, buyback and tax so a Mumbai exit captures, rather than loses, that value.</p>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Where Mumbai exits get tricky</th><th>Impact</th><th>How Patron Accounting Solves It</th></tr></thead>
                    <tbody>
                        <tr><td>Leaver status disputed on a high-value grant</td><td>A costly and visible dispute</td><td>We map the scheme to the facts and document a defensible position.</td></tr>
                        <tr><td>Large strike and tax due before any listing</td><td>Valuable vested options forfeited</td><td>We sequence window, tax and buyback around the liquidity event.</td></tr>
                        <tr><td>Resignation mis-tagged as a bad-leaver exit</td><td>Unfair loss of vested options</td><td>We re-read the clause and correct the classification.</td></tr>
                        <tr><td>Vested options pulled without scheme backing</td><td>An indefensible forfeiture</td><td>We confirm exactly what the scheme authorises first.</td></tr>
...
<article class="feature-card">
            ...
            <h3 class="feature-title">Defensible at any scrutiny</h3>
            <p class="feature-text">A leaver classification documented to withstand the scrutiny a Mumbai finance exit attracts.</p>
        </article>
<article class="feature-card">
            ...
            <h3 class="feature-title">Tax timed to the listing</h3>
            <p class="feature-text">The window and perquisite tax explained and timed around any IPO or secondary.</p>
        </article>
<article class="feature-card">
            ...
            <h3 class="feature-title">Buyback done right</h3>
            <p class="feature-text">A clean buyback and settlement that closes the equity, even on large grants.</p>
        </article>
<article class="feature-card">
            ...
            <h3 class="feature-title">No litigation tail</h3>
            <p class="feature-text">Treatment follows the scheme and is on record, so disputes seldom arise.</p>
        </article>
        </div>
    </div>
</section>
...
<section class="content-section" id="comparison-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Good Leaver versus Bad Leaver: the Key Differences</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p><strong>Leaver provisions:</strong> good- and bad-leaver outcomes are dictated by the ESOP scheme and grant letter; in a SEBI-aware Mumbai market, any forfeiture of vested options must be expressly written into the scheme and be legally defensible rather than arbitrary.</p>
                <p><strong>Exercise window:</strong> vested options survive only through the post-termination window the scheme fixes and then lapse; the company must furnish the leaver with the means and information to exercise inside it.</p>
                <p><strong>Perquisite tax:</strong> on exercise the spread between fair market value and the strike is a salary perquisite under <a href="/esop-perquisite-tax-section-17-2-vi/mumbai">Section 17(2)(vi)</a> of the Income-tax Act, fair market value being set under Rule 3 and the allied valuation rules.</p>
                <p><strong>Capital gains and buyback:</strong> a subsequent sale, often into a listing or secondary, or a buyback, is taxed as capital gains over the perquisite-taxed value, the rate depending on the holding period.</p>
            ...
            <div class="faq-expanded">
                ...
                <div class="faq-expanded__list">
                    ...
                    <div class="faq-expanded__item" id="faq-3">
                        <h3 class="faq-expanded__q">What is the difference between a good leaver and a bad leaver?</h3>
                        <div class="faq-expanded__a"><p>A good leaver is someone who leaves the company under fair circumstances, such as resignation with notice, a layoff or retirement, and retains their vested options with an exercise window. A bad leaver is someone terminated for cause, or who has committed misconduct or joined a competitor; such a person forfeits unvested options and, in some cases, vested options as well. The exact rule is set out in the scheme.</p></div>
                    </div>
                    ...
                    <div class="faq-expanded__item" id="faq-5">
                        <h3 class="faq-expanded__q">What happens to my ESOPs if I leave a Mumbai company before its IPO?</h3>
                        <div class="faq-expanded__a"><p>If you leave as a good leaver, you usually keep your vested options and can exercise them within the post-termination window, which positions you to participate in the IPO or a pre-listing secondary; unvested options are forfeited. As a bad leaver you may lose even vested options or face a discounted buyback. For Mumbai companies heading toward a SEBI-regulated listing, the leaver classification and exercise timing directly decide whether you capture the IPO upside, so we review the scheme and plan the exercise around the liquidity event.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-6">
                        <h3 class="faq-expanded__q">Can a departing Mumbai employee sell vested shares in a secondary or buyback?</h3>
                        <div class="faq-expanded__a"><p>Often yes. Mumbai's later-stage and pre-IPO companies frequently run buybacks or secondary sales, so a leaver's vested options or shares can be bought for cash at fair value, giving liquidity and tidying the cap table. A good leaver is typically bought out at fair value; a bad leaver may face a discounted price where the scheme permits. For BKC and Lower Parel companies this is often the cleanest route to realise value before a listing, and we structure the price, the transfer and the tax.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-7">
                        <h3 class="faq-expanded__q">Does a resignation count as a bad-leaver event?</h3>
                        <div class="faq-expanded__a"><p>It depends on the scheme. In a well-drafted scheme, an ordinary resignation is a good-leaver event. However, some schemes treat even a voluntary resignation as a bad-leaver event, which is a red flag, because it can cause you to lose your earned vested options. For this reason, you should always check the leaver definition in the grant letter. We review this for you.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-8">
                        <h3 class="faq-expanded__q">Where does a Mumbai company file its ESOP and exit paperwork?</h3>
                        <div class="faq-expanded__a"><p>A Mumbai-headquartered private company files its option allotments and maintains the SH-6 register with the Registrar of Companies (RoC) Mumbai under the Ministry of Corporate Affairs, while the perquisite tax on exercise and capital gains on a sale or buyback are administered by the Income Tax Department. If the company is listed or listing, SEBI rules in BKC also apply to the secondary or IPO sale. The leaver classification and exercise window flow from your ESOP scheme, so we align the documentation with the scheme and these filings.</p></div>
                    </div>
                </div>
            </div>
