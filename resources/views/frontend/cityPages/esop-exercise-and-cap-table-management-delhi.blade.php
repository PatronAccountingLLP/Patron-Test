...
@section('meta')
    <title>Delhi ESOP Exercise & Cap Table Compliance Service</title>
    <meta name="description" content="Run ESOP exercises and keep an audit-ready cap table for Delhi founders near Nehru Place and Connaught Place, filed at RoC Delhi, for just INR 14,999/yr.">
    <meta name="keywords" content="ESOP Exercise and Cap Table M&Anagement Delhi, ESOP Exercise and Cap Table M&Anagement in Delhi, ESOP Exercise and Cap Table M&Anagement services in Delhi, ESOP services Delhi, ESOP Exercise and Cap Table M&Anagement cost Delhi, ESOP Exercise and Cap Table M&Anagement consultants Delhi, CA firm for ESOP Exercise and Cap Table M&Anagement Delhi, ESOP advisory Delhi">
    <link rel="canonical" href="/esop-exercise-and-cap-table-management/delhi">
    <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1">
    <meta property="og:title" content="Delhi ESOP Exercise & Cap Table Compliance Service | Patron Accounting">
    <meta property="og:description" content="Run ESOP exercises and keep an audit-ready cap table for Delhi founders near Nehru Place and Connaught Place, filed at RoC Delhi, for just INR 14,999/yr.">
...
@section('schema')    <script type="application/ld+json">{
  ...
  "@graph": [
    {
      "@type": "Service",
      "@id": "https://www.patronaccounting.com/esop-exercise-and-cap-table-management/delhi#service",
      "name": "ESOP Exercise and Cap Table Management in Delhi",
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://www.patronaccounting.com/esop-exercise-and-cap-table-management/delhi#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
        ...
        },
        {
          ...
          "item": "https://www.patronaccounting.com/esop-exercise-and-cap-table-management/delhi"
        }
      ]
    },
    {
      ...
      "@id": "https://www.patronaccounting.com/esop-exercise-and-cap-table-management/delhi#localbusiness",
      "name": "Patron Accounting LLP - ESOP Exercise And Cap Table Management, Delhi",
      "url": "https://www.patronaccounting.com/esop-exercise-and-cap-table-management/delhi",
    ...
    {
      "@type": "FAQPage",
      "@id": "https://www.patronaccounting.com/esop-exercise-and-cap-table-management/delhi#faq",
      ...
      "mainEntity": [
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "After the exercise, the board passes the allotment resolution, and Form PAS-3 must then be filed with the ROC within 30 days. The shares are credited to demat accounts, and the SH-6 register and cap table are updated. The FMV report must be no older than 180 days."
          }
        },
        {
          "@type": "Question",
        ...
        {
          "@type": "Question",
          "name": "Where is PAS-3 filed for a company registered in Delhi?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "For a company with a Delhi CIN, Form PAS-3 is filed online on the MCA21 portal against the Registrar of Companies, Delhi, which covers the National Capital Territory. There is no physical visit, even though the Ministry of Corporate Affairs is headquartered in the capital. The allotment record, SH-6 register and cap table must all reconcile to the same RoC Delhi filing history so nothing is exposed during an audit."
          }
        },
        {
          "@type": "Question",
          "name": "What trips up Delhi companies running their first exercise window?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Promoter-led companies around Nehru Place and Connaught Place often find their SH-6 register has not kept pace with the grants made over the years, so the first formal exercise surfaces gaps. We reconstruct the option history, fix the register, obtain a current FMV report, then run the allotment and file PAS-3 within 30 days. Cleaning the record once makes every future Delhi exercise window straightforward."
          }
        },
        {
          "@type": "Question",
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "The cap table should be updated immediately after every allotment so that it matches the SH-6 register and the PAS-3 filing. To avoid any mismatch during due diligence or an audit, we reconcile the records after every exercise event."
          }
        },
        {
          "@type": "Question",
          "name": "How quickly can a Delhi company source an FMV report for exercise?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Delhi and the wider NCR have a good supply of Category I Merchant Bankers and registered valuers, so the FMV report for an unlisted exercise is usually quick to obtain. Speed does not change the rule: the report must be no older than 180 days at the exercise date, and the 30-day PAS-3 clock runs from the board allotment date with RoC Delhi. We schedule the valuation, allotment and filing together so the window never slips."
          }
        }
      ]
    }
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-4 private-registration-heading">
                        ESOP Exercise and Cap Table Management in Delhi
                    </h1>

                    <p class="mb-4" style="color: var(--text-secondary); font-size: 16px; line-height: 1.6;">For Delhi NCT companies filing at RoC Delhi a short walk from the MCA's own head office, with NRI and overseas grantees on the cap table, we close every exercise window on time.</p>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>Picture a Nehru Place SaaS company whose three earliest engineers, two now resident in Dubai and Singapore, want to exercise before a Series A term sheet closes. That single window touches <a href="/esop-fema-and-rbi-firms-reporting/delhi">FEMA-compliant remittance for the NRI grantees</a>, a current <a href="/esop-valuation-services/delhi">merchant-banker valuation</a>, a board allotment, a PAS-3 return at RoC Delhi and a cap table that has to survive an investor's diligence. This service runs that whole chain for Delhi NCT companies so nothing is left hanging between an option and a clean share record.</p>
                <p>Because the Registrar of Companies, Delhi sits in the same city as the Ministry of Corporate Affairs head office, a Delhi board has little room to treat a late allotment return as a minor slip. We treat each exercise as a managed event: confirm who is eligible, take in the price through banking channels, lock the FMV, pass the allotment, file Form PAS-3 inside 30 days, push the demat credit, and reconcile the SH-6 register and cap table the same week, so the next funding round or audit finds the share issue already watertight.</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="two-column">
            <div class="column-content">
                ...
                <div class="content-text what-is-definition">
                    ...
                    <p>Two jobs sit behind the phrase. Exercise management is the operational work of converting vested options into allotted shares with every statutory filing closed; cap table management is keeping the resulting ownership record accurate enough to put in front of an investor. They run together because in Delhi's consumer-tech and trading companies the people exercising are often the same early hires an incoming fund will scrutinise.</p>
                    <p>Walk a typical Connaught Place fintech through it and the order is fixed: eligibility verification, exercise-price collection over banking channels, the Category I Merchant Banker FMV report, the board allotment resolution, the PAS-3 return to RoC Delhi, demat credit, then the SH-6 register and cap-table refresh. Where a grantee has relocated abroad, the price collection and KYC step carries the extra FEMA layer that NRI-heavy Delhi cap tables routinely throw up.</p>
                    <p>None of this is <a href="/esop-scheme-design/delhi">scheme design</a>. The pool, the plan and the special resolution are a one-time exercise; this page is the recurring execution that fires every time a Delhi employee, resident or NRI, presses the button.</p>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>If any of the following describes your Delhi company, the exercise sequence below is work you cannot afford to improvise:</p>
                <ul>
                    <li>Consumer-tech and D2C brands in the Saket-Aerocity corporate belt allotting shares as early employees exercise ahead of a raise.</li>
                    <li>Companies whose cap table carries NRI or overseas-based grantees and investors, where each exercise drags in FEMA remittance and KYC.</li>
                    <li>Nehru Place IT and product firms opening their first formal liquidity-event window after years of informal grants.</li>
                    <li>Connaught Place finance and trading houses running periodic exercise rounds across a large option pool.</li>
                </ul>
                <p><strong>Statutory anchor:</strong> a Delhi company allotting shares on exercise of options under Section 62(1)(b) must file a Return of Allotment in Form PAS-3 with RoC Delhi within 30 days of allotment, and the FMV for unlisted shares must rest on a merchant-banker report not older than 180 days under Rule 3(8)(iii).</p>
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <table>
                    ...
                    <tbody>
                        <tr><td>Eligibility Verification</td><td>We map vesting, the open window and grantee status against the scheme, flagging early any Delhi grantee who has moved abroad and now exercises as an NRI.</td></tr>
                        <tr><td>Exercise-Price Collection</td><td>We route the price through banking channels and document it, adding the FEMA-route paperwork where the consideration arrives from a Dubai, Singapore or US-based grantee.</td></tr>
                        <tr><td>FMV Report Coordination</td><td>We commission the Category I Merchant Banker report from valuers in Delhi-NCR and keep it live inside the 180-day window.</td></tr>
                        <tr><td>Allotment and PAS-3</td><td>We draft the board allotment resolution and lodge Form PAS-3 on MCA21 against your Delhi CIN at RoC Delhi within 30 days.</td></tr>
                        <tr><td>Demat Credit</td><td>We instruct the depository so allotted shares land in employee demat accounts, resident and NRI alike, after allotment.</td></tr>
                        <tr><td>Register and Cap Table Update</td><td>We reconcile the SH-6 register and cap table to the fresh PAS-3 history so an investor's diligence finds no gap.</td></tr>
...
<section class="steps-section" id="procedure-section">
    <div class="section-container">
        <header class="section-header" style="text-align:center;margin-bottom:48px;">
            ...
            <p class="section-subtitle" style="text-align:left;max-width:100%;">Take a Connaught Place fintech with two grantees now in the Gulf: we sequence the six steps below, slotting the FEMA remittance and NRI KYC into the price-collection step, so the window closes at RoC Delhi on time and the cap table stands up to investor diligence.</p>
        </header>
    ...
    <div class="step-content">
        ...
        <p class="step-description">We confirm vested quantity, the open window and grantee eligibility, NRI grantees included, against the scheme.</p>
...
<div class="step-card">
    <div class="step-content">
        ...
        <p class="step-description">We receive the exercise price through banking channels and record the consideration on file.</p>
        <div class="step-highlights">
...
<div class="step-card">
    <div class="step-content">
        ...
        <p class="step-description">We pass the board allotment resolution; this allotment date starts the 30-day clock for RoC Delhi PAS-3.</p>
        <div class="step-highlights">
...
<div class="step-card">
    <div class="step-content">
        ...
        <p class="step-description">We log the exercise in the SH-6 register and refresh the cap table for the new shares.</p>
        <div class="step-highlights">
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>Before a Delhi window opens, we ask the company to pull together this set, and we chase the gaps where the record has drifted:</p>
                <ul>
                    <li>The ESOP scheme document and grant letters that pin eligibility and vesting dates.</li>
                    <li>Employee exercise notices, plus banking-channel proof of the price, and the FEMA inward-remittance trail for any grantee paying from abroad.</li>
                    <li>A Category I Merchant Banker FMV report dated within the last 180 days.</li>
                    <li>The board allotment resolution and the supporting allotment list.</li>
                    <li>Demat account details, with full KYC for NRI grantees, for the share credit.</li>
                    <li>The current SH-6 register and cap table to reconcile against the new allotment.</li>
                </ul>
                <div class="highlight-box" style="margin-top:16px;">
                    <p><strong>The one date that catches Delhi boards out</strong></p>
                    <p>Sitting in the same city as the MCA head office offers no grace on timing. The trap is always the same: the 30-day PAS-3 clock starts on the board allotment date, never on the date the employee filed the exercise form. Read it from the wrong date and a Connaught Place company walks straight into Section 454 adjudication.</p>
                </div>
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <table>
                    ...
                    <tbody>
                        <tr><td>NRI grantee in Dubai or Singapore exercises, but the inward remittance and KYC are incomplete</td><td>The allotment to a non-resident stalls or is later queried in diligence</td><td>We assemble the FEMA banking-channel trail and KYC before the board meets, so the credit is clean from day one.</td></tr>
                        <tr><td>A Saket consumer-tech firm dates the 30-day clock from the exercise form, not the allotment</td><td>Section 454 adjudication and late fees, levied in the MCA's home city</td><td>We anchor the clock to the board allotment date and lodge PAS-3 with room to spare.</td></tr>
                        <tr><td>The merchant-banker FMV report has aged past 180 days when the window opens</td><td>The valuation is invalid and a perquisite-tax exposure opens up</td><td>We time a fresh Delhi-NCR valuation to sit inside the 180-day window.</td></tr>
                        <tr><td>The registered-valuer figure and the merchant-banker figure disagree</td><td>Scrutiny risk where the Companies Act and Income Tax numbers diverge</td><td>We reconcile both valuations before allotment so MCA and tax records tell one story.</td></tr>
...
<article class="feature-card">
            ...
            <p class="feature-text">Lodged at RoC Delhi inside 30 days, no Section 454 adjudication in the MCA's home city.</p>
        </article>
<article class="feature-card">
            ...
            <p class="feature-text">Valuation sourced from Delhi-NCR merchant bankers and held inside the 180-day window.</p>
        </article>
<article class="feature-card">
            ...
            <p class="feature-text">Cap table and SH-6 register reconciled after every exercise event.</p>
        </article>
<article class="feature-card">
            ...
            <p class="feature-text">MCA and income-tax valuations aligned, keeping NRI-investor diligence clean.</p>
        </article>
        </div>
    </div>
</section>
...
<section class="content-section" id="comparison-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>For a company filing in the same city as the MCA head office, none of these dates bends, and an NRI-heavy cap table only raises the cost of getting one wrong. This is the chain we hold every Connaught Place, Nehru Place or Saket exercise window to, from FMV validity through to the same-week cap-table refresh.</p>
                <div class="table-responsive-wrapper">
                <table>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>The same statutes govern an exercise everywhere in India; for a Delhi NCT company the filing simply lands at RoC Delhi, the jurisdiction that shares its address with the MCA, and the NRI grantees common on capital cap tables add a FEMA layer on top of the Companies Act and Income Tax rules below.</p>
                <p><strong>Allotment filing:</strong> a Delhi company allotting shares on exercise of options under Section 62(1)(b) of the Companies Act must file a Return of Allotment in Form PAS-3 with RoC Delhi within 30 days of allotment.</p>
            ...
            <div class="faq-expanded">
                ...
                <div class="faq-expanded__list">
                    ...
                    <div class="faq-expanded__item" id="faq-3">
                        ...
                        <div class="faq-expanded__a"><p>After the exercise, the board passes the allotment resolution, and Form PAS-3 must then be filed with the ROC within 30 days. The shares are credited to demat accounts, and the SH-6 register and cap table are updated. The FMV report must be no older than 180 days.</p></div>
                    </div>
                    ...
                    <div class="faq-expanded__item" id="faq-5">
                        <h3 class="faq-expanded__q">Where is PAS-3 filed for a company registered in Delhi?</h3>
                        <div class="faq-expanded__a"><p>For a company with a Delhi CIN, Form PAS-3 is filed online on the MCA21 portal against the Registrar of Companies, Delhi, which covers the National Capital Territory. There is no physical visit, even though the Ministry of Corporate Affairs is headquartered in the capital. The allotment record, SH-6 register and cap table must all reconcile to the same RoC Delhi filing history so nothing is exposed during an audit.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-6">
                        <h3 class="faq-expanded__q">What trips up Delhi companies running their first exercise window?</h3>
                        <div class="faq-expanded__a"><p>Promoter-led companies around Nehru Place and Connaught Place often find their SH-6 register has not kept pace with the grants made over the years, so the first formal exercise surfaces gaps. We reconstruct the option history, fix the register, obtain a current FMV report, then run the allotment and file PAS-3 within 30 days. Cleaning the record once makes every future Delhi exercise window straightforward.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-7">
                        <h3 class="faq-expanded__q">When should the cap table be updated?</h3>
                        <div class="faq-expanded__a"><p>The cap table should be updated immediately after every allotment so that it matches the SH-6 register and the PAS-3 filing. To avoid any mismatch during due diligence or an audit, we reconcile the records after every exercise event.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-8">
                        <h3 class="faq-expanded__q">How quickly can a Delhi company source an FMV report for exercise?</h3>
                        <div class="faq-expanded__a"><p>Delhi and the wider NCR have a good supply of Category I Merchant Bankers and registered valuers, so the FMV report for an unlisted exercise is usually quick to obtain. Speed does not change the rule: the report must be no older than 180 days at the exercise date, and the 30-day PAS-3 clock runs from the board allotment date with RoC Delhi. We schedule the valuation, allotment and filing together so the window never slips.</p></div>
                    </div>
                </div>
            </div>
