...
@section('meta')
    <title>Gurugram ESOP Exercise, Cap Table and PAS-3 Filing</title>
    <meta name="description" content="Cap table and ESOP exercise support for Gurugram enterprise-SaaS firms in Cyber City, with FMV-backed PAS-3 at RoC Delhi. Flat INR 14,999/yr, fully managed.">
    <meta name="keywords" content="ESOP Exercise and Cap Table M&Anagement Gurugram, ESOP Exercise and Cap Table M&Anagement in Gurugram, ESOP Exercise and Cap Table M&Anagement services in Gurugram, ESOP services Gurugram, ESOP Exercise and Cap Table M&Anagement cost Gurugram, ESOP Exercise and Cap Table M&Anagement consultants Gurugram, CA firm for ESOP Exercise and Cap Table M&Anagement Gurugram, ESOP advisory Gurugram">
    <link rel="canonical" href="/esop-exercise-and-cap-table-management/gurugram">
    <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1">
    <meta property="og:title" content="Gurugram ESOP Exercise, Cap Table and PAS-3 Filing | Patron Accounting">
    <meta property="og:description" content="Cap table and ESOP exercise support for Gurugram enterprise-SaaS firms in Cyber City, with FMV-backed PAS-3 at RoC Delhi. Flat INR 14,999/yr, fully managed.">
    <meta property="og:url" content="/esop-exercise-and-cap-table-management/gurugram">
    ...
    <meta name="twitter:title" content="Gurugram ESOP Exercise, Cap Table and PAS-3 Filing | Patron Accounting">
    <meta name="twitter:description" content="Cap table and ESOP exercise support for Gurugram enterprise-SaaS firms in Cyber City, with FMV-backed PAS-3 at RoC Delhi. Flat INR 14,999/yr, fully managed.">
...
@section('schema')    <script type="application/ld+json">{
  ...
  "@graph": [
    {
      "@type": "Service",
      "@id": "https://www.patronaccounting.com/esop-exercise-and-cap-table-management/gurugram#service",
      "name": "ESOP Exercise and Cap Table Management in Gurugram",
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://www.patronaccounting.com/esop-exercise-and-cap-table-management/gurugram#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
        ...
        },
        {
          ...
          "item": "https://www.patronaccounting.com/esop-exercise-and-cap-table-management/gurugram"
        }
      ]
    },
    {
      ...
      "@id": "https://www.patronaccounting.com/esop-exercise-and-cap-table-management/gurugram#localbusiness",
      "name": "Patron Accounting LLP - ESOP Exercise And Cap Table Management, Gurugram",
      "url": "https://www.patronaccounting.com/esop-exercise-and-cap-table-management/gurugram",
    ...
    {
      "@type": "FAQPage",
      "@id": "https://www.patronaccounting.com/esop-exercise-and-cap-table-management/gurugram#faq",
      ...
      "mainEntity": [
        ...
        {
          "@type": "Question",
          "name": "What filing is required after an ESOP exercise?",
          "acceptedAnswer": {
            "@type": "Answer",
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-4 private-registration-heading">
                        ESOP Exercise and Cap Table Management in Gurugram
                    </h1>

                    <p class="mb-4" style="color: var(--text-secondary); font-size: 16px;">For the enterprise-SaaS and unicorn teams across Cyber City, Udyog Vihar and Golf Course Road, we close high-volume exercise windows end to end and file PAS-3 with RoC Delhi, which covers Haryana.</p>
...
<section class="content-section" id="local-market-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">ESOP Exercise and Cap Tables in the Gurugram Market</h2>
            <div class="content-text">
                <p>Gurugram is in Haryana, and companies registered here file with the Registrar of Companies, Delhi, which holds jurisdiction over Haryana. Every Form PAS-3 for shares allotted on exercise goes against your Haryana CIN on the MCA21 portal under RoC Delhi, so the allotment record, SH-6 register and cap table all have to tie back to that same filing history, regardless of the Cyber City address.</p>
                <p>The local exercise pattern reflects Gurugram's clusters. In Cyber City and Udyog Vihar, large SaaS and ITES teams run scheduled annual exercise windows with sizeable grant pools, which makes batch eligibility checks and a single clean reconciliation the priority. Along Golf Course Road and Sohna Road, venture-funded startups tend to exercise around a <a href="/esop-at-funding-round-series-a-b-c/gurugram">funding round</a> or <a href="/esop-secondary-sale-advisory/gurugram">secondary</a>, so FMV timing against the 180-day window is the pressure point. US-flip structures add a layer: the Indian exercise and PAS-3 filing must still be completed even when the parent cap table sits offshore.</p>
                <p>Gurugram companies usually source the Category I Merchant Banker FMV report from valuers in Delhi-NCR, so turnaround is fast. The deadline does not move with it: the report must be no older than 180 days at exercise, and the 30-day PAS-3 window runs from the board allotment date. We sequence the <a href="/esop-valuation-services/gurugram">valuation</a>, board resolution and filing together so a Gurugram exercise never drifts past the deadline.</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="two-column">
            <div class="column-content">
                ...
                <div class="content-text what-is-definition">
                    ...
                    <p>Gurugram's enterprise-SaaS and unicorn ecosystem runs large option pools, so exercise windows here often move hundreds of grantees at once. ESOP exercise management is the operational handling of that window, turning vested options into allotted shares with every filing closed, while cap table management keeps the resulting shareholding record accurate at scale.</p>
                    <p>For a Cyber City SaaS company, the work spans eligibility verification, exercise-price collection over banking channels, the FMV report, the board allotment resolution, PAS-3 filing, demat credit, and the SH-6 register and cap-table update; because Gurugram companies file with RoC Delhi, the same 30-day discipline applies.</p>
                    <p>This is not <a href="/esop-scheme-design/gurugram">scheme design</a>. It is the high-volume execution a Golf Course Road startup repeats each time its employees exercise.</p>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>Gurugram's high-growth companies run frequent, large-volume exercise windows that have to close cleanly. This service fits:</p>
                <ul>
                    <li>Cyber City and Udyog Vihar SaaS-ITES firms opening periodic or liquidity-event windows.</li>
                    <li>Unicorn-scale companies allotting shares as hundreds of employees exercise vested options.</li>
                    <li>Golf Course Road and Sohna Road HR and CS teams managing high grant volumes at once.</li>
                    <li>Late-stage startups presenting an investor-ready cap table before a large funding round.</li>
                </ul>
                <p><strong>Statutory anchor:</strong> a Gurugram company, which files with RoC Delhi, must lodge a Return of Allotment in Form PAS-3 within 30 days for shares allotted on exercise of options under Section 62(1)(b), and the FMV for unlisted shares must rest on a merchant-banker report not older than 180 days under Rule 3(8)(iii).</p>
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <table>
                    ...
                    <tbody>
                        <tr><td>Eligibility Verification</td><td>We reconcile vesting and the open window across large grantee pools against the scheme and grants.</td></tr>
                        <tr><td>Exercise-Price Collection</td><td>We coordinate exercise-price collection through banking channels at volume and evidence each remittance.</td></tr>
                        <tr><td>FMV Report Coordination</td><td>We obtain the Category I Merchant Banker FMV report and keep it valid within the 180-day window.</td></tr>
                        <tr><td>Allotment and PAS-3</td><td>We prepare the board allotment resolution and file Form PAS-3 with RoC Delhi within 30 days.</td></tr>
                        <tr><td>Demat Credit</td><td>We instruct the depository so allotted shares credit to employee demat accounts in bulk.</td></tr>
                        <tr><td>Register and Cap Table Update</td><td>We update the SH-6 register and keep the cap table accurate even after a large exercise event.</td></tr>
...
<section class="steps-section" id="procedure-section">
    <div class="section-container">
        <header class="section-header" style="text-align:center;margin-bottom:48px;">
            ...
            <p class="section-subtitle" style="text-align:left;max-width:100%;">For a Cyber City enterprise-SaaS firm moving hundreds of grantees, we run the full exercise sequence from eligibility to cap table, so every high-volume window closes compliant and on time.</p>
        </header>
    ...
    <div class="step-content">
        ...
        <p class="step-description">We reconcile vested quantity and eligibility across the full grantee pool against the scheme.</p>
...
<div class="step-card">
    <div class="step-content">
        ...
        <p class="step-description">We collect the exercise price through banking channels at volume and record each consideration.</p>
        <div class="step-highlights">
...
<div class="step-card">
    <div class="step-content">
        ...
        <p class="step-description">We pass the board allotment resolution; that date starts the 30-day PAS-3 clock for the RoC Delhi filing.</p>
        <div class="step-highlights">
...
<div class="step-card">
    <div class="step-content">
        ...
        <p class="step-description">We post the exercise to the SH-6 register and refresh the cap table across the enlarged pool.</p>
        <div class="step-highlights">
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>For a Gurugram exercise event, especially a large one, we gather:</p>
                <ul>
                    <li>The ESOP scheme and grant letters underpinning eligibility and vesting across the pool.</li>
                    <li>Employee exercise notices and banking-channel remittance proof for each grantee.</li>
                    <li>A Category I Merchant Banker FMV report current within the 180-day window.</li>
                    <li>The board resolution for allotment and the full allotment list.</li>
                    <li>Demat account details for share credit at volume.</li>
                    <li>The existing SH-6 register and cap table for reconciliation.</li>
                </ul>
                <div class="highlight-box" style="margin-top:16px;">
                    <p><strong>The deadline that trips Gurugram companies</strong></p>
                    <p>At unicorn scale the volume hides the date: the 30-day PAS-3 clock runs from the board allotment date, not the exercise-form date. Conflating the two across a large window is the most common reason a Cyber City company misses the deadline and faces Section 454 adjudication.</p>
                </div>
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <table>
                    ...
                    <tbody>
                        <tr><td>A large Cyber City window buries the 30-day clock</td><td>Section 454 adjudication and late fees</td><td>We track the clock from the board allotment date and file with RoC Delhi well within 30 days.</td></tr>
                        <tr><td>FMV report older than 180 days at exercise</td><td>Invalid valuation and tax exposure</td><td>We schedule a fresh merchant-banker valuation inside the 180-day window.</td></tr>
                        <tr><td>Cap table out of sync after a bulk allotment</td><td>Discrepancy surfaces in VC or pre-IPO due diligence</td><td>We reconcile the cap table and SH-6 register immediately after each large event.</td></tr>
                        <tr><td>Valuation mismatch between MCA and tax filings</td><td>Scrutiny risk on a high-value cap table</td><td>We align the registered-valuer and merchant-banker figures to avoid scrutiny.</td></tr>
...
<article class="feature-card">
            ...
            <p class="feature-text">Filed with RoC Delhi inside 30 days even at volume, so no Section 454 adjudication or late fees.</p>
        </article>
<article class="feature-card">
            ...
            <p class="feature-text">FMV always fresh, held inside the 180-day validity window for each event.</p>
        </article>
<article class="feature-card">
            ...
            <p class="feature-text">Cap table and SH-6 register reconciled after every bulk exercise event.</p>
        </article>
<article class="feature-card">
            ...
            <p class="feature-text">MCA and income-tax valuations aligned, so pre-IPO diligence finds no red flags.</p>
        </article>
        </div>
    </div>
</section>
...
<section class="content-section" id="comparison-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>When a Gurugram unicorn opens a window for hundreds of grantees, volume cannot be an excuse for a slipped date. This is the deadline chain we hold every Cyber City or Golf Course Road event to, from FMV validity through to the cap-table refresh.</p>
                <div class="table-responsive-wrapper">
                <table>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p><strong>Allotment filing:</strong> a Gurugram company allotting shares on exercise of options under Section 62(1)(b) of the Companies Act must file a Return of Allotment in Form PAS-3 with RoC Delhi within 30 days of allotment.</p>
            ...
            <div class="faq-expanded">
                ...
                <div class="faq-expanded__list">
                    ...
                    <div class="faq-expanded__item" id="faq-3">
                        <h3 class="faq-expanded__q">What filing is required after an ESOP exercise?</h3>
                        <div class="faq-expanded__a"><p>After the exercise, the board passes an allotment resolution, and Form PAS-3 must then be filed with the RoC within 30 days of allotment. The shares are credited to the employee demat account, and the SH-6 register and cap table are updated. The FMV report must be no older than 180 days at the time of exercise.</p></div>
                    </div>
                    ...
                    <div class="faq-expanded__item" id="faq-5">
                        <h3 class="faq-expanded__q">Which RoC handles PAS-3 for a company registered in Gurugram?</h3>
                        <div class="faq-expanded__a"><p>Gurugram is in Haryana, and companies registered here file Form PAS-3 with the Registrar of Companies, Delhi, which has jurisdiction over Haryana. The filing is done online on the MCA21 portal against your Haryana CIN, so a Cyber City address does not change the RoC. The allotment record, SH-6 register and cap table must all reconcile to that same RoC Delhi filing history.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-6">
                        <h3 class="faq-expanded__q">How does a US-flip structure affect ESOP exercise in Gurugram?</h3>
                        <div class="faq-expanded__a"><p>Many Gurugram SaaS companies mirror their option pool under a US parent, but if the operating entity is an Indian private company, the Indian exercise still requires a Category I Merchant Banker FMV, a board allotment and Form PAS-3 within 30 days, filed with RoC Delhi. We handle the Indian-side exercise and PAS-3 filing and reconcile the Indian cap table even when the parent cap table sits offshore.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-7">
                        <h3 class="faq-expanded__q">When should the cap table be updated?</h3>
                        <div class="faq-expanded__a"><p>The cap table should be updated immediately after every allotment, so that it matches the SH-6 register and the PAS-3 filing. To avoid any mismatch during due diligence or audit, we reconcile after each exercise event.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-8">
                        <h3 class="faq-expanded__q">Can Patron manage high-volume exercises for a Cyber City SaaS team?</h3>
                        <div class="faq-expanded__a"><p>Yes. Large SaaS and ITES teams in Cyber City and Udyog Vihar often exercise in scheduled windows with sizeable grant pools across many employees. We run batch eligibility checks, coordinate one FMV report for the window, process the board allotment, file PAS-3 with RoC Delhi within 30 days and credit each employee demat account, then complete a single clean cap-table and SH-6 reconciliation for the whole window.</p></div>
                    </div>
                </div>
            </div>
