...
@section('meta')
    <title>Mumbai ESOP Exercise & Cap Table Filing with PAS-3</title>
    <meta name="description" content="End-to-end ESOP exercise and cap table upkeep for Mumbai startups from BKC to Powai, with FMV reports and PAS-3 at RoC Mumbai. Fixed fee INR 14,999/yr.">
    <meta name="keywords" content="ESOP Exercise and Cap Table M&Anagement Mumbai, ESOP Exercise and Cap Table M&Anagement in Mumbai, ESOP Exercise and Cap Table M&Anagement services in Mumbai, ESOP services Mumbai, ESOP Exercise and Cap Table M&Anagement cost Mumbai, ESOP Exercise and Cap Table M&Anagement consultants Mumbai, CA firm for ESOP Exercise and Cap Table M&Anagement Mumbai, ESOP advisory Mumbai">
    <link rel="canonical" href="/esop-exercise-and-cap-table-management/mumbai">
    <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1">
    <meta property="og:title" content="Mumbai ESOP Exercise & Cap Table Filing with PAS-3 | Patron Accounting">
    <meta property="og:description" content="End-to-end ESOP exercise and cap table upkeep for Mumbai startups from BKC to Powai, with FMV reports and PAS-3 at RoC Mumbai. Fixed fee INR 14,999/yr.">
...
@section('schema')    <script type="application/ld+json">{
  ...
  "@graph": [
    {
      "@type": "Service",
      "@id": "https://www.patronaccounting.com/esop-exercise-and-cap-table-management/mumbai#service",
      "name": "ESOP Exercise and Cap Table Management in Mumbai",
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://www.patronaccounting.com/esop-exercise-and-cap-table-management/mumbai#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
        ...
        },
        {
          ...
          "item": "https://www.patronaccounting.com/esop-exercise-and-cap-table-management/mumbai"
        }
      ]
    },
    {
      ...
      "@id": "https://www.patronaccounting.com/esop-exercise-and-cap-table-management/mumbai#localbusiness",
      "name": "Patron Accounting LLP - ESOP Exercise And Cap Table Management, Mumbai",
      "url": "https://www.patronaccounting.com/esop-exercise-and-cap-table-management/mumbai",
    ...
    {
      "@type": "FAQPage",
      "@id": "https://www.patronaccounting.com/esop-exercise-and-cap-table-management/mumbai#faq",
      ...
      "mainEntity": [
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "The cap table should be updated immediately after every allotment so that it matches the SH-6 register and the PAS-3 filing. To avoid any mismatch during due diligence or audit, we reconcile it after each exercise event."
          }
        },
        {
          "@type": "Question",
          "name": "How do BKC and Lower Parel companies keep cap tables diligence-ready?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Later-stage companies in BKC and Lower Parel often run exercises around secondary sales and liquidity events, where investors scrutinise the cap table closely. We update the cap table immediately after each allotment so it always matches the SH-6 register and the PAS-3 filings on record with RoC Mumbai. Reconciling after every window, rather than scrambling before a round, is what keeps a Mumbai cap table diligence-ready."
          }
        }
      ]
    }
        ...
        <div class="row align-items-center">
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <p class="mb-4" style="color: var(--text-secondary); font-size: 16px; line-height: 1.6;">From BKC and Lower Parel finance houses to the Andheri-Powai SaaS belt, we run every exercise window to PAS-3 at RoC Mumbai with a diligence-ready cap table.</p>
...
<section class="content-section" id="local-market-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">ESOP Exercise and Cap Tables in the Mumbai Market</h2>
            <div class="content-text">
        ...
        <div class="two-column">
            <div class="column-content">
                ...
                <div class="content-text what-is-definition">
                    ...
                    <p>In a city where SEBI sits at BKC and listed-company discipline is everyday culture, exercise execution is held to a high bar. ESOP exercise management is the operational handling of a window, converting vested options into allotted shares with every filing closed; cap table management keeps the resulting shareholding record exact.</p>
                    <p>For a BKC fintech or an Andheri SaaS firm, the run covers eligibility verification, exercise-price collection through banking channels, the FMV report, the board allotment resolution, PAS-3 filing, demat credit, and the SH-6 register and cap-table update.</p>
                    <p>It is separate from <a href="/esop-scheme-design/mumbai">designing the scheme</a>. This is the recurring execution a Powai deep-tech company performs each time its team exercises.</p>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>Mumbai companies, from regulated finance to media, need the exercise sequence run precisely and on time. This service fits:</p>
                <ul>
                    <li>BKC and Lower Parel fintechs opening periodic or liquidity-event exercise windows.</li>
                    <li>Andheri and Powai SaaS and deep-tech firms allotting shares as employees exercise vested options.</li>
                    <li>HR and CS teams in Goregaon-Vikhroli managing high grant volumes across many employees.</li>
                    <li>Founders presenting a clean, investor-ready cap table before a Mumbai <a href="/esop-at-funding-round-series-a-b-c/mumbai">funding round</a>.</li>
                </ul>
                <p><strong>Statutory anchor:</strong> a Mumbai company that allots shares on exercise of options under Section 62(1)(b) must file a Return of Allotment in Form PAS-3 with RoC Mumbai within 30 days of allotment, and the FMV for unlisted shares must rest on a merchant-banker report not older than 180 days under Rule 3(8)(iii).</p>
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <table>
                    ...
                    <tbody>
                        <tr><td>Eligibility Verification</td><td>We test each grantee's vesting and open window against the scheme and grant letters before allotment.</td></tr>
                        <tr><td>Exercise-Price Collection</td><td>We route the exercise price through proper banking channels and keep clean remittance evidence.</td></tr>
                        <tr><td>FMV Report Coordination</td><td>We engage a Category I Merchant Banker and hold the FMV report inside its 180-day validity.</td></tr>
                        <tr><td>Allotment and PAS-3</td><td>We prepare the board allotment resolution and file Form PAS-3 with RoC Mumbai within 30 days.</td></tr>
                        <tr><td>Demat Credit</td><td>We instruct the depository so allotted shares credit to employee demat accounts.</td></tr>
                        <tr><td>Register and Cap Table Update</td><td>We update the SH-6 register and cap table to a finance-grade, audit-ready standard.</td></tr>
...
<section class="steps-section" id="procedure-section">
    <div class="section-container">
        <header class="section-header" style="text-align:center;margin-bottom:48px;">
            ...
            <p class="section-subtitle" style="text-align:left;max-width:100%;">For a BKC fintech or a Powai deep-tech firm, we run the full exercise sequence from eligibility to cap table, so every window closes compliant and on time.</p>
        </header>
    ...
    <div class="step-content">
        ...
        <p class="step-description">We verify vested quantity, the open window and grantee eligibility against the scheme and grants.</p>
...
<div class="step-card">
    <div class="step-content">
        ...
        <p class="step-description">We collect the exercise price through banking channels and document the consideration.</p>
        <div class="step-highlights">
...
<div class="step-card">
    <div class="step-content">
        ...
        <p class="step-description">We pass the board allotment resolution; this allotment date starts the 30-day PAS-3 clock.</p>
        <div class="step-highlights">
...
<div class="step-card">
    <div class="step-content">
        ...
        <p class="step-description">We enter the exercise in the SH-6 register and refresh the cap table for the new shares.</p>
        <div class="step-highlights">
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>For a Mumbai exercise event, we assemble:</p>
                <ul>
                    <li>The ESOP scheme and grant letters that establish eligibility and vesting.</li>
                    <li>Employee exercise notices with banking-channel remittance proof of the exercise price.</li>
                    <li>A Category I Merchant Banker FMV report current within the 180-day window.</li>
                    <li>The board allotment resolution and the allotment list.</li>
                    <li>Employee demat account details for share credit.</li>
                    <li>The existing SH-6 register and cap table for reconciliation.</li>
                </ul>
                <div class="highlight-box" style="margin-top:16px;">
                    <p><strong>The deadline that trips Mumbai companies</strong></p>
                    <p>Even finance-literate BKC teams slip here: the 30-day PAS-3 clock runs from the board allotment date, not the exercise-form date. Conflating the two is the most common reason a window is missed and Section 454 adjudication follows.</p>
                </div>
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <table>
                    ...
                    <tbody>
                        <tr><td>A Lower Parel fintech misreads the 30-day clock</td><td>Section 454 adjudication and late fees</td><td>We track the clock from the board allotment date and file well within 30 days.</td></tr>
                        <tr><td>FMV report has aged past 180 days at exercise</td><td>Invalid valuation and tax exposure</td><td>We schedule a fresh merchant-banker valuation inside the 180-day window.</td></tr>
                        <tr><td>Cap table out of sync after allotment</td><td>Flagged in audit or investor due diligence</td><td>We reconcile the cap table and SH-6 register immediately after each event.</td></tr>
                        <tr><td>MCA and tax valuations disagree</td><td>Scrutiny risk on a finance-sensitive cap table</td><td>We align the registered-valuer and merchant-banker figures so nothing diverges.</td></tr>
...
<article class="feature-card">
            ...
            <p class="feature-text">Filed with RoC Mumbai inside 30 days, so no Section 454 adjudication or late fees.</p>
        </article>
<article class="feature-card">
            ...
            <p class="feature-text">Merchant-banker FMV held current inside its 180-day validity window.</p>
        </article>
<article class="feature-card">
            ...
            <p class="feature-text">Cap table and SH-6 register reconciled to a finance-grade standard after every event.</p>
        </article>
<article class="feature-card">
            ...
            <p class="feature-text">MCA and income-tax valuations aligned, so investor due diligence stays clean.</p>
        </article>
        </div>
    </div>
</section>
...
<section class="content-section" id="comparison-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>Mumbai boards expect filings to land on the day they are due. Here is the deadline chain we hold every BKC or Andheri exercise window to, from FMV validity through to the cap-table refresh.</p>
                <div class="table-responsive-wrapper">
                <table>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p><strong>Allotment filing:</strong> a Mumbai company allotting shares on exercise of options under Section 62(1)(b) of the Companies Act must file a Return of Allotment in Form PAS-3 with RoC Mumbai within 30 days of allotment.</p>
            ...
            <div class="faq-expanded">
                ...
                <div class="faq-expanded__list">
                    ...
                    <div class="faq-expanded__item" id="faq-5">
                        <h3 class="faq-expanded__q">Where is PAS-3 filed for a company registered in Mumbai?</h3>
                        <div class="faq-expanded__a"><p>For a company with a Mumbai CIN, Form PAS-3 is filed online on the MCA21 portal against the Registrar of Companies, Mumbai, the busiest RoC in the country. There is no physical visit. Because so many investors are headquartered in the city, the match between your cap table, the SH-6 register and your RoC Mumbai filing history is exactly what diligence teams check first, so we reconcile all three after each exercise.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-6">
                        <h3 class="faq-expanded__q">Does SEBI being in BKC affect how Mumbai companies run ESOP exercises?</h3>
                        <div class="faq-expanded__a"><p>SEBI rules bite directly only for listed companies and registered intermediaries, but its BKC presence means Mumbai has the deepest pool of Category I Merchant Bankers and registered valuers in India. That makes the FMV report quick to source for an unlisted exercise. The compliance steps are the same nationwide: a valuation under 180 days old, board allotment, and PAS-3 within 30 days of that allotment.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-7">
                        <h3 class="faq-expanded__q">When should the cap table be updated?</h3>
                        <div class="faq-expanded__a"><p>The cap table should be updated immediately after every allotment so that it matches the SH-6 register and the PAS-3 filing. To avoid any mismatch during due diligence or audit, we reconcile it after each exercise event.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-8">
                        <h3 class="faq-expanded__q">How do BKC and Lower Parel companies keep cap tables diligence-ready?</h3>
                        <div class="faq-expanded__a"><p>Later-stage companies in BKC and Lower Parel often run exercises around secondary sales and liquidity events, where investors scrutinise the cap table closely. We update the cap table immediately after each allotment so it always matches the SH-6 register and the PAS-3 filings on record with RoC Mumbai. Reconciling after every window, rather than scrambling before a round, is what keeps a Mumbai cap table diligence-ready.</p></div>
                    </div>
                </div>
            </div>
