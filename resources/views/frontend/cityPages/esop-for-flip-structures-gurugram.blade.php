...
@section('meta')
    <title>Gurugram Flip ESOP Setup for Enterprise-SaaS Teams</title>
    <meta name="description" content="Structure mirror-grant ESOPs for Gurugram Cyber City enterprise-SaaS firms under offshore holdcos, with FEMA OI Rules and 409A pricing, from INR 49,999.">
    <meta name="keywords" content="ESOP for Flip Structures Gurugram, ESOP for Flip Structures in Gurugram, ESOP for Flip Structures services in Gurugram, ESOP services Gurugram, ESOP for Flip Structures cost Gurugram, ESOP for Flip Structures consultants Gurugram, CA firm for ESOP for Flip Structures Gurugram, ESOP advisory Gurugram">
    <link rel="canonical" href="/esop-for-flip-structures/gurugram">
    <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1">
    <meta property="og:title" content="Gurugram Flip ESOP Setup for Enterprise-SaaS Teams | Patron Accounting">
    <meta property="og:description" content="Structure mirror-grant ESOPs for Gurugram Cyber City enterprise-SaaS firms under offshore holdcos, with FEMA OI Rules and 409A pricing, from INR 49,999.">
...
@section('schema')    <script type="application/ld+json">{
  ...
  "@graph": [
    {
      "@type": "Service",
      "@id": "https://www.patronaccounting.com/esop-for-flip-structures/gurugram#service",
      "name": "ESOP for Flip Structures",
      "url": "https://www.patronaccounting.com/esop-for-flip-structures/gurugram",
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://www.patronaccounting.com/esop-for-flip-structures/gurugram#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
        ...
        },
        {
          ...
          "position": 4,
          "name": "ESOP for Flip Structures",
          "item": "https://www.patronaccounting.com/esop-for-flip-structures/gurugram"
        }
      ]
    },
    {
      ...
      "@id": "https://www.patronaccounting.com/esop-for-flip-structures/gurugram#localbusiness",
      "name": "Patron Accounting LLP - ESOP For Flip Structures, Gurugram",
      "url": "https://www.patronaccounting.com/esop-for-flip-structures/gurugram",
    ...
    },
    {
      ...
      "mainEntity": [
        ...
        {
          "@type": "Question",
          "name": "What is reverse flip and which Gurugram startups have done it?",
          "acceptedAnswer": {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          "name": "Why does a Gurugram reverse flip go to NCLT Chandigarh, not Delhi?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Because jurisdiction follows the registered office state, not the city. Gurugram companies are incorporated in Haryana, and Haryana falls under the territorial jurisdiction of the NCLT Chandigarh bench for scheme petitions under Sections 230-232 - even though the company's routine ROC filings go to RoC Delhi, which administratively covers both Delhi and Haryana. A Gurugram founder who assumes the Delhi Principal Bench applies risks the petition being returned. We confirm the registered-office position, file the reverse-flip scheme before NCLT Chandigarh, and run RoC Delhi filings such as INC-28 and MGT-14 in parallel."
          }
        },
        {
          "@type": "Question",
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-4 private-registration-heading">
                        ESOP for Flip Structures in Gurugram
                    </h1>

                    <p class="mb-4" style="font-size:17px;color:var(--text-secondary);line-height:1.6;">For Cyber City and Udyog Vihar enterprise-SaaS teams running a Delaware or Singapore parent - the city that gave India Zomato, Delhivery and Policybazaar - we design mirror-grant ESOPs and reverse-flip migrations, filing at RoC Delhi while the scheme is heard at the NCLT Chandigarh bench.</p>
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="https://wa.me/919459456700?text=Hello%2C%20I%20just%20visited%20your%20ESOP%20for%20Flip%20Structures%20in%20Gurugram%20page.%20I%20would%20like%20to%20know%20more%20about%20it." target="_blank" class="btn-sample text-decoration-none" rel="noopener">
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>Gurugram runs on SaaS, ITES and GCC-style delivery, and it externalised harder than almost anywhere in the 2018-2022 wave. The pattern across Cyber City, Udyog Vihar and the Golf Course Road cluster: a US seed or Series A closes, founders incorporate a Delaware C-Corp parent, IP and US customer contracts move to it, and the Gurugram operating company - a Haryana entity that files with RoC Delhi - becomes a wholly-owned captive billing the parent on cost-plus transfer pricing under Section 92. The delivery headcount stays on the Millennium City's Sohna Road and DLF corridors; the cap table and ESOP pool move to Delaware.</p>
                <p>From 2023 the wave reversed. PhonePe (Singapore to India 2023), Groww (US to India 2024 with Rs 1,340 crore tax paid), Razorpay, Pixxel, Meesho and Eruditus have re-domiciled or are mid-migration. Gurugram SaaS teams eyeing a BSE or NSE IPO now have to unwind the mirror grants their Cyber City and Sohna Road engineers hold in a foreign parent and re-issue them from an Indian NewCo - and because Gurugram is a Haryana company, that scheme runs through the NCLT Chandigarh bench rather than Delhi. Patron Accounting LLP designs the ESOP for both directions across CA, CS, valuation, FEMA and NCLT disciplines.</p>
            </div>

            <div class="highlight-box" style="margin-top:24px;">
                <p><strong>&#128205; Gurugram Flip-Structure Market Notes</strong></p>
                <p>Gurugram has a split jurisdiction that trips up founders: as a Haryana company it <strong>files with the Registrar of Companies, Delhi</strong> (RoC Delhi serves both NCT Delhi and Haryana), but a reverse-flip scheme petition is heard by the <strong>NCLT Chandigarh bench</strong>, which has territorial jurisdiction over Haryana - not the Delhi Principal Bench that serves Gurugram's neighbours across the border. Getting this venue right at the drafting stage avoids a return of the petition. The local flip population is overwhelmingly <strong>B2B SaaS, ITES and global-capability-centre style</strong> teams in Cyber City, Udyog Vihar and along Golf Course and Sohna Road, where value sits in recurring US enterprise revenue and delivery capacity - so the transfer-pricing recharge of ESOP cost from the foreign parent, and the headcount-heavy Section 192 TDS and Schedule FA reporting at exercise, are the items most exposed in a statutory audit. Large delivery-leadership grants routinely hit the LRS USD 250,000 ceiling, making net-settled exercise the default design.</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="two-column">
            <div class="column-content">
                ...
                <div class="content-text what-is-definition">
                    ...
                    <p>Gurugram is where India's enterprise-SaaS and unicorn cohort actually sits - Zomato, Delivery and Policybazaar all call the Cyber City-to-Golf Course Road corridor home - and that cohort has lived the full flip arc in public. Many externalised early to chase US enterprise revenue and US capital; several have since come home to list on Indian markets. So for a Gurugram founder the flip is not an abstract structuring choice; it is a path their own neighbours have already walked. The local administrative quirk matters too: a Haryana company files with RoC Delhi but has its reverse-flip scheme heard at the NCLT Chandigarh bench. Forward and reverse are two separate ESOP problems, and Gurugram's enterprise-SaaS teams typically design for both.</p>
                    <p><strong>Why the forward flip happened (2018-2022):</strong> the round came from a US fund papering on Delaware; SAFEs and convertible notes are settled US instruments; a NASDAQ or NYSE listing is cleaner from Delaware; US enterprise buyers want to contract with a US entity; US-resident founders eye Section 1202 QSBS; and US acquirers read a Delaware cap table instantly.</p>
                    <p><strong>Why the reverse flip follows (2023-2026):</strong> BSE and NSE now welcome new-economy issuers; Finance Act 2024 removed the Section 56(2)(viib) angel tax; Section 80-IAC benefits remain; DPIIT, IMB, online MCA and FEMA OI Rules 2022 have matured the home framework; Indian growth funds match US cheque sizes; and at unicorn scale the cost of US 409A and quarterly US board reporting stops paying for itself.</p>
                    <p><strong>The precedents are local, not just national.</strong> PhonePe reverse-flipped from Singapore in 2023; Groww completed Delaware-to-India in 2024, paying Rs 1,340 crore in tax; Razorpay, Pixxel, Meesho and Eruditus are in progress. For Gurugram enterprise-SaaS founders, several of these names are companies they benchmark against directly.</p>

                </div>
                <div class="highlight-box" style="margin-top:20px;">
                    <p><strong>The working vocabulary for a Gurugram enterprise-SaaS cap table:</strong></p>
                    <p><strong>Forward Flip (externalisation):</strong> the Indian-origin company shifts its holdco offshore - Delaware C-Corp for US-VC-backed enterprise SaaS, Singapore Pte Ltd for APAC distribution, Cayman for funds and IP holdcos - leaving the Gurugram company as a wholly-owned services subsidiary.</p>
                    <p><strong>Reverse Flip (re-domiciliation to India):</strong> the foreign parent migrates home through an NCLT-approved scheme of arrangement under Sections 230-232 plus Section 234 of the Companies Act 2013 - for a Haryana company, heard at the NCLT Chandigarh bench - with a Gurugram NewCo or the existing sub becoming the new parent.</p>
                    <p><strong>Mirror Grant:</strong> options the foreign parent grants directly to the Gurugram sub's employees; the instrument is foreign parent equity, not an Indian Section 62(1)(b) ESOP - the form most large Cyber City option pools actually take.</p>
                    <p><strong>FEMA OI Rules 2022:</strong> the Overseas Investment Rules of 22 August 2022 governing resident holdings of foreign equity - OPI up to 10 percent of parent equity per individual under Rule 7, ODI above under Rule 9. At unicorn headcount this classification has to run across hundreds of employees.</p>
                    <p><strong>LRS cap of USD 250,000:</strong> the Liberalised Remittance Scheme limit per financial year per resident under Section 5 of FEMA 1999 - the ceiling senior Gurugram employees hit first on large cash exercises.</p>
                    <p><strong>Section 47 pathway:</strong> the Income Tax Act 1961 <a href="/esop-capital-gains-tax-on-sale/gurugram">capital-gains exemption route</a> on reverse flip - 47(via) for foreign amalgamating-company shares, 47(vii) for the in-scheme share transfer, 47(vicc) for the merger of a foreign holding into the Indian subsidiary, with 49(2AA) preserving the original cost basis.</p>
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <ul>
                    ...
                    <li><strong><a href="/esop-valuation-services/gurugram">Foreign Parent Valuation</a>:</strong> US 409A every 12 months or on material event; jurisdiction-equivalent for Singapore (IRAS guidance) and Cayman. Coordinated with US 409A valuation firm; INR translation for India use.</li>
                    <li><strong><a href="/esop-perquisite-tax-section-17-2-vi/gurugram">Section 17(2)(vi) Perquisite Tax at Exercise</a>:</strong> FMV on parent stock minus exercise price; converted to INR at SBI TTBR on vesting or exercise date. Rule 3(8)(ii) FMV computation; payroll integration.</li>
...
<section class="content-section" id="services-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>A Cyber City enterprise-SaaS firm with a Delaware parent and a Golf Course Road startup planning its way back for a domestic listing need very different work from us - but both run through the same engagement stack below. We scope it for the Gurugram reality: a Haryana-registered operating company that bills its US enterprise customers through a foreign holdco, runs payroll out of Udyog Vihar or Sohna Road, and files its routine paperwork with RoC Delhi while any scheme petition is heard at the NCLT Chandigarh bench. Each deliverable in the table is mapped to that fact pattern.</p>
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Service</th><th>What We Do</th></tr></thead>
                    <tbody>

                        <tr><td><strong>Forward Flip ESOP Design</strong></td><td>The outbound side for a Cyber City SaaS team already sitting under a Delaware, Singapore or Cayman parent - we build the mirror grant scheme under FEMA OI Rules 2022, line it up with the US 409A position, set the Udyog Vihar subsidiary up as TDS deductor under Section 192(1), draft the transfer pricing recharge memo, track exercise consideration against LRS, and classify each option-holder as OPI or ODI.</td><td><span class="badge-included">Included</span></td></tr>
                        <tr><td><strong>Reverse Flip ESOP Migration Planning</strong></td><td>The inbound side for a Golf Course Road startup steering toward an Indian IPO - we design the Section 47 scheme of arrangement, run the NCLT filings under Sections 230-232, and handle the option pool itself: foreign parent ESOPs cancelled, Indian parent ESOPs reissued with Section 49(2AA) cost basis and original grant dates intact.</td><td><span class="badge-included">Included</span></td></tr>
                        <tr><td><strong>FEMA OI Rules 2022 Compliance</strong></td><td>Per-employee OPI/ODI classification, annual Form FLA and OPI report filing, all run alongside our FDI Compliance team as a single outbound-investment stack - sized for a Gurugram cap table that can carry hundreds of option-holders.</td><td><span class="badge-included">Included</span></td></tr>
                        <tr><td><strong>NCLT Scheme of Arrangement Drafting</strong></td><td>Cross-border scheme drafting under Sections 230-232 plus Section 234, share exchange ratio determination, fairness opinion coordination with a SEBI Cat I Merchant Banker, Form NCLT-1 filing at the Chandigarh bench, and no-objection coordination with IT, RBI and MCA.</td><td><span class="badge-included">Included</span></td></tr>
                        <tr><td><strong>Section 47 Tax Memo</strong></td><td>A memo confirming Section 47(via), 47(vii) and 47(vicc) applicability to the scheme, with conditions analysis, Section 47A risk review, Section 49(2AA) cost basis preservation, Section 17(2)(vi) timing for post-flip exercises, and a Section 80-IAC re-eligibility read for the reverse-flipped Haryana entity.</td><td><span class="badge-included">Included</span></td></tr>
                        <tr><td><strong>Rule 11UA and US 409A Valuation Coordination</strong></td><td>A coordinated valuation engagement - US 409A refreshed on the foreign parent through a US valuation firm and Rule 11UA run via the SEBI Cat I Merchant Banker route, with the share exchange ratio documented to hold on both sides.</td><td><span class="badge-addon">Add-on</span></td></tr>
                        <tr><td><strong>Employee Communication Pack</strong></td><td>Pre-flip and post-flip sessions for the Cyber City and Sohna Road engineering teams, an FAQ on tax, vesting continuity and exercise mechanics, consent forms for ESOP cancellation and reissuance, and an ITR support memo for affected option-holders.</td><td><span class="badge-included">Included</span></td></tr>
                        <tr><td><strong>Section 80-IAC Re-Eligibility Confirmation</strong></td><td>For a reverse-flipped Gurugram entity - confirmation of Section 80-IAC eligibility post merger, DPIIT recognition continuity or a fresh recognition application, IMB certification implications, and a 10-year clock read (it typically runs from the original Indian incorporation date when the scheme is structured correctly).</td><td><span class="badge-addon">Add-on</span></td></tr>
...
<section class="content-section" id="challenges-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>The errors we see most often in Gurugram are the ones that look harmless until a US enterprise deal, a 409A refresh or an NCLT scheme forces them into the open. A Cyber City SaaS company with a Delaware parent and a large engineering bench in Udyog Vihar carries every one of these risks at once - transfer pricing on the captive billing, an LRS ceiling that senior staff hit at exercise, and a Section 47 question waiting at the back end if and when the team reverse-flips for an Indian listing. The table runs from the day-one forward-flip slips through to the reverse-flip exposure, with the way Patron heads each one off.</p>
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Challenge</th><th>Impact</th><th>How Patron Accounting Solves It</th></tr></thead>
                    <tbody>

                        <tr><td><strong>Transfer pricing left on default at forward flip</strong></td><td>Once a Gurugram operating company sits under a foreign parent, the engineering and customer-support billing has to be arm's-length under Section 92. A Cyber City captive that lets this drift is exposed to a TP adjustment on the recharge.</td><td>Patron drafts the TP recharge memo at forward-flip setup and refreshes it each year on a cost-plus basis matched to the engineering services billing.</td></tr>
                        <tr><td><strong>Mirror grant mistaken for an Indian ESOP</strong></td><td>Foreign parent mirror grants are NOT Indian ESOPs under Section 62(1)(b) Companies Act 2013 - they sit under FEMA OI Rules 2022 and the foreign jurisdiction's stock plan. The Udyog Vihar subsidiary is only the TDS deductor; the instrument itself is foreign parent equity.</td><td>Patron keeps the two paths separate in the documentation - foreign parent stock plan plus the FEMA OI Rules workflow for mirror grants, and Section 62(1)(b) only where it actually applies.</td></tr>
                        <tr><td><strong>LRS ceiling overlooked on cash exercises</strong></td><td>An Indian resident can remit only USD 250,000 per FY under LRS. A Golf Course Road startup's CTO or VP exercising a large block of Delaware options can run straight into that cap and find the exercise blocked.</td><td>Patron builds cashless and net-settled exercise mechanics that fall outside LRS scope, or stages the exercise across financial years to stay under the ceiling.</td></tr>
                        <tr><td><strong>US 409A valuation gone stale at the flip event</strong></td><td>A reverse flip is a material event that calls for a fresh US 409A. Skip it and you carry IRS exposure on the US side plus a Rule 11UA defensibility gap on the India side.</td><td>Patron runs both valuations at the flip event - 409A on the US side and Rule 11UA on the India side through a SEBI Cat I Merchant Banker.</td></tr>
                        <tr><td><strong>Reverse flip drafted without Section 47 analysis</strong></td><td>For a unicorn-scale Gurugram register, a reverse flip with no Section 47 capital gains planning can detonate a multi-crore tax event across founders, the ESOP base and investors.</td><td>Patron settles the Section 47(via), 47(vii) and 47(vicc) condition analysis upfront and shapes the scheme to qualify before anything is filed at the Chandigarh bench.</td></tr>
                        <tr><td><strong>Foreign parent ESOPs left behind in the migration</strong></td><td>Reverse-flip schemes that move the shares but forget the option pool leave the Cyber City team holding cancelled options with nothing reissued in their place.</td><td>Patron's reverse-flip workflow treats ESOP migration as a core step, preserving original grant date and vesting status under Section 49(2AA).</td></tr>
                        <tr><td><strong>No Section 80-IAC re-eligibility planning</strong></td><td>A reverse-flipped entity may keep or lose Section 80-IAC eligibility depending on whether the incorporation date is preserved, IMB certification carries over and the 10-year clock holds.</td><td>Patron's tax memo settles Section 80-IAC re-eligibility for the post-flip Gurugram entity as a standard part of the reverse-flip engagement.</td></tr>
...
<section class="why-choose-section" id="benefits-section">
    ...
    <article class="feature-card"><h3>One Engagement At Scale</h3><p>CA, CS, valuation, FEMA and NCLT under a single engagement that plugs into your counsel and merchant banker - built for the headcount and investor count of a Gurugram enterprise-SaaS cap table.</p></article>
    <article class="feature-card"><h3>Both Directions Covered</h3><p>Mirror-grant design outbound (FEMA OI Rules 2022, US 409A) and ESOP migration inbound (Section 47 plus NCLT 230-232, Chandigarh bench) - whichever way the Gurugram company is moving.</p></article>
    <article class="feature-card"><h3>Section 47 Across A Long Register</h3><p>The 47(via), 47(vii) and 47(vicc) analysis settled before filing across founders, a broad ESOP base and multiple funds - keeping a unicorn-scale Gurugram cap table clear of a Groww-size bill.</p></article>
    <article class="feature-card"><h3>Outbound Stack, Productised</h3><p>OPI/ODI classification, the annual Form FLA, LRS ceiling management and the Section 92 recharge - run as a repeatable process across hundreds of Gurugram option-holders, not one by one.</p></article>
    <article class="feature-card"><h3>Two Valuations, Reconciled</h3><p>US 409A through a US firm and Rule 11UA through a SEBI Cat I Merchant Banker at the flip event, with the share-exchange ratio documented to stand on both sides.</p></article>
    <article class="feature-card"><h3>80-IAC Continuity, Confirmed</h3><p>For a reverse-flipped Gurugram entity, a memo settling DPIIT continuity, IMB carry-over and whether the 10-year clock still runs from the original incorporation date.</p></article>
</div>
    </div>
</section>
...
<section class="content-section" id="comparison-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>Gurugram's enterprise-SaaS playbook has historically pointed to Delaware, because the revenue and the lead investor were both American - the same logic that took the city's best-known unicorns offshore before they came home. But the right answer still depends on the customer base: a US-enterprise SaaS company out of Cyber City trends Delaware; an APAC-distribution or gaming business may suit Singapore; a fund or IP holdco leans Cayman. The table below compares the three on the dimensions that decide both the running cost and the eventual reverse-flip difficulty for a Gurugram company.</p>
                <div class="table-responsive-wrapper">
                <table>
                    <thead>
                        <tr>
...
<section class="content-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>A Gurugram flip carries a split-jurisdiction footprint - a Haryana company files with RoC Delhi but has its scheme heard at the NCLT Chandigarh bench - layered over RBI's overseas-investment rules and the Income Tax Act capital-gains provisions, and applied across an enterprise-scale option pool. The statutes, rules and forms Patron works to on a Gurugram flip-structure ESOP engagement are listed below.</p>
                <ul>
            ...
            <div class="faq-expanded">
                ...
                <div class="faq-expanded__list">
                    <div class="faq-expanded__item" id="faq-1">
                        <h3 class="faq-expanded__q">What is a flip structure for Gurugram startups?</h3>
                        <div class="faq-expanded__a"><p>For a Gurugram startup it means the holding company has moved offshore - typically Delaware C-Corp (US VC), Singapore Pte Ltd (APAC GTM) or Cayman Islands (funds). The foreign entity becomes the parent; the original Gurugram operating company, a Haryana entity that files with RoC Delhi, becomes a wholly-owned subsidiary that keeps the Cyber City, Udyog Vihar or Sohna Road delivery team and bills the foreign parent on arm's-length cost-plus transfer pricing under Section 92. The Gurugram sub still runs Indian payroll, PF and ESI, but the cap table, ESOP pool and US customer contracts now sit with the foreign parent.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-2">
                        <h3 class="faq-expanded__q">Why do Gurugram startups flip to Delaware, Singapore or Cayman?</h3>
                        <div class="faq-expanded__a"><p>For Gurugram's B2B SaaS and ITES founders the trigger is US enterprise customers and US VC term sheets - Accel, Sequoia and Tiger prefer a Delaware C-Corp, SAFEs and convertible notes are simpler under US law, and US customer contracting and a NASDAQ option are cleaner from a US parent. The Cyber City and Udyog Vihar delivery model maps neatly onto a captive-subsidiary structure. The 2018-2022 wave externalised heavily out of the Millennium City; from 2023 many Gurugram teams are reversing back toward an Indian IPO.</p></div>
                    </div>
                    ...
                    <div class="faq-expanded__item" id="faq-4">
                        <h3 class="faq-expanded__q">What is reverse flip and which Gurugram startups have done it?</h3>
                        <div class="faq-expanded__a"><p>Reverse flip is migration of the foreign parent back to India via an NCLT scheme under Sections 230-232 plus Section 234 Companies Act 2013; because Gurugram is a Haryana company, the petition is heard by the NCLT Chandigarh bench, while ongoing filings stay with RoC Delhi. PhonePe reversed Singapore to India in 2023; Groww completed Delaware to India in 2024 paying Rs 1,340 crore tax; Razorpay, Pixxel, Meesho and Eruditus are in progress. Gurugram SaaS and ITES startups building Indian recurring revenue and targeting a domestic IPO are the most active candidates, drawn by Indian listing access, angel-tax abolition and Section 80-IAC benefits.</p></div>
                    </div>
                    ...
                    <div class="faq-expanded__item" id="faq-8">
                        <h3 class="faq-expanded__q">Why does a Gurugram reverse flip go to NCLT Chandigarh, not Delhi?</h3>
                        <div class="faq-expanded__a"><p>Because jurisdiction follows the registered office state, not the city. Gurugram companies are incorporated in Haryana, and Haryana falls under the territorial jurisdiction of the NCLT Chandigarh bench for scheme petitions under Sections 230-232 - even though the company's routine ROC filings go to RoC Delhi, which administratively covers both Delhi and Haryana. A Gurugram founder who assumes the Delhi Principal Bench applies risks the petition being returned. We confirm the registered-office position, file the reverse-flip scheme before NCLT Chandigarh, and run RoC Delhi filings such as INC-28 and MGT-14 in parallel.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-9">
                        <h3 class="faq-expanded__q">How do you reverse flip after a Delaware flip?</h3>
                        <div class="faq-expanded__a"><p>A reverse flip is a 12 to 18 month NCLT process. The steps are: obtain board approval; design the structure (merging the Delaware parent into an India NewCo); secure foreign-side approvals; prepare the Section 47 tax memo; refresh the US 409A and Rule 11UA valuations; file Form NCLT-1 under Sections 230-232 plus Section 234; observe the creditor objection window (21 days); complete the First Motion and Second Motion hearings; make the MCA filing once the final NCLT order is received; allot the Indian parent shares; and cancel the foreign parent ESOPs while reissuing Indian parent ESOPs with the original grant dates preserved. A Section 80-IAC re-eligibility check must also be carried out. Groww paid Rs 1,340 crore in tax on its 2024 reverse flip; with proper planning this can be reduced. Patron charges Rs 3-5 lakh. Call <a href="tel:+919459456700" style="color:inherit;">+91 945 945 6700</a>.</p></div>
                    </div>
                </div>
            </div>
