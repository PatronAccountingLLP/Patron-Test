...
@section('meta')
    <title>Mumbai Founder ESOP &amp; SEBI Reg 9A for IPO-Bound Cos</title>
    <meta name="description" content="Planning a Mumbai listing from BKC or Powai? We structure founder ESOPs around the Rule 12 bar and SEBI Regulation 9A, near the SEBI HQ. From INR 49,999.">
    <meta name="keywords" content="ESOP for Founders and Promoters Mumbai, ESOP for Founders and Promoters in Mumbai, ESOP for Founders and Promoters services in Mumbai, ESOP services Mumbai, ESOP for Founders and Promoters cost Mumbai, ESOP for Founders and Promoters consultants Mumbai, CA firm for ESOP for Founders and Promoters Mumbai, ESOP advisory Mumbai">
    <link rel="canonical" href="/esop-for-founders-and-promoters/mumbai">
    <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1">
    <meta property="og:title" content="Mumbai Founder ESOP &amp; SEBI Reg 9A for IPO-Bound Cos | Patron Accounting">
    <meta property="og:description" content="Planning a Mumbai listing from BKC or Powai? We structure founder ESOPs around the Rule 12 bar and SEBI Regulation 9A, near the SEBI HQ. From INR 49,999.">
...
@section('schema')    <script type="application/ld+json">{
  ...
  "@graph": [
    {
      "@type": "Service",
      "@id": "https://www.patronaccounting.com/esop-for-founders-and-promoters/mumbai#service",
      "name": "ESOP for Founders and Promoters in Mumbai",
      "description": "Patron Accounting advises founders and promoters on ESOP eligibility in Mumbai, including the Rule 12 exclusion of promoters and over-10-percent directors, the DPIIT-recognised-startup exemption for up to 10 years, SEBI Regulation 9A for IPO-bound founders, and sweat equity under Section 54 as the alternative, with eligibility opinions, structuring, valuation and governance.",
      "provider": {
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://www.patronaccounting.com/esop-for-founders-and-promoters/mumbai#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
        ...
        },
        {
          ...
          "item": "https://www.patronaccounting.com/esop-for-founders-and-promoters/mumbai"
        }
      ]
    },
    {
      ...
      "@id": "https://www.patronaccounting.com/esop-for-founders-and-promoters/mumbai#localbusiness",
      "name": "Patron Accounting LLP - ESOP For Founders And Promoters, Mumbai",
      "url": "https://www.patronaccounting.com/esop-for-founders-and-promoters/mumbai",
    ...
    },
    {
      ...
      "mainEntity": [
        ...
        {
          "@type": "Question",
          "name": "My BKC fintech is planning an IPO. Will I lose my ESOPs as a promoter?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Not if the grant is timed correctly. SEBI Regulation 9A, notified in September 2025, lets a founder identified as a promoter in the draft red herring prospectus continue to hold and exercise options or SAR granted at least one year before the DRHP filing, covering both vested and unvested options. For a BKC or Lower Parel company close to listing, this makes the grant date decisive: options granted inside that one-year cooling-off period are not protected. We map your founder grants against the DRHP calendar so they survive the IPO."
          }
        },
        {
          "@type": "Question",
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-4 private-registration-heading">
                        ESOP for Founders and Promoters in Mumbai
                    </h1>

                    <p class="mb-4" style="color: var(--text-secondary); font-size: 16px; line-height: 1.6;">For a BKC, Lower Parel or Powai company with SEBI's BKC headquarters in view, we time founder grants so they clear both the Rule 12 bar and the Regulation 9A one-year line before any DRHP.</p>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>Mumbai is where India's listing and capital-markets machinery sits, so founder-equity questions here are almost always asked with an eventual IPO in view. The BKC and Lower Parel finance hubs are home to fintech and capital-markets-facing companies, the Andheri and Powai SaaS belt to product startups scaling fast, and the Goregaon-Vikhroli corridor to a steady stream of early-stage founders. With SEBI's headquarters in BKC and a heavy concentration of IPO-bound companies, the SEBI Regulation 9A treatment of founder options is the question we field most often in this city. Patron Accounting advises Mumbai founders and promoters on ESOP eligibility: the Rule 12 bar, the DPIIT-startup exemption, the Reg 9A path for IPO-bound founders, and sweat equity as the alternative.</p>
                <p>For a Mumbai private limited company registered with RoC Mumbai, a founder who is a promoter or an over-10-percent director cannot be granted ESOPs by default, so a self-grant is invalid unless an exemption applies. Because so many Mumbai companies are heading towards a public listing, the timing of a founder grant against the draft red herring prospectus matters more here than almost anywhere else. This page sets out exactly when a Mumbai founder or promoter can hold ESOPs, and how to protect those options through to listing.</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="two-column">
            <div class="column-content">
                ...
                <div class="content-text what-is-definition">
                    ...
                    <p>In a city where SEBI's headquarters sits in BKC, founders feel the listed-company side of this rule early. The Companies Act draws ESOPs around employees, not the owners who control the business, and Section 62(1)(b) read with Rule 12 of the Share Capital Rules removes two groups of founder from the definition of 'employee' altogether.</p>
                    <p><strong>Promoters:</strong> a promoter, or anyone in the promoter group, is excluded.</p>
                    <p><strong>Directors over 10 percent:</strong> a director holding more than 10 percent of the equity, directly or indirectly, alone or with relatives or a body corporate, is excluded too.</p>
                    <p><strong>What it means for a BKC founder:</strong> a fintech promoter in BKC or a Lower Parel capital-markets founder who has crossed 10 percent is not an 'employee' for ESOP purposes, so any grant to them is invalid unless an exemption applies. Crucially for Mumbai, the SEBI SBEB and Sweat Equity Regulations carry the same exclusion into the listed world, which is why founder-equity planning here is so closely tied to listing.</p>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>There is a way through, and for the Andheri and Powai product crowd it is the main one. The law accepts that a startup's founder is usually also its hardest-working operator, so it suspends the bar for recognised startups.</p>
                <p><strong>The 10-year window:</strong> a proviso to Rule 12, brought in by the 2016 amendment and since extended, permits a DPIIT-recognised startup to grant ESOPs to promoters and to directors above the 10-percent line for up to 10 years from incorporation or registration. During that period the exclusion is set aside, so a recognised Powai deep-tech founder can be granted options like any salaried colleague.</p>
                <p><strong>When it expires:</strong> the relaxation lapses at the ten-year mark from incorporation, or earlier if recognised-startup status is lost, and the ordinary bar then returns for fresh grants. Because Mumbai founders so often have a listing in view, we usually advise locking in DPIIT recognition early and completing grants with room to spare against both the ten-year clock and the Reg 9A timeline.</p>
                <p><strong>The prerequisite:</strong> the company must hold DPIIT startup recognition, which itself depends on meeting the startup criteria, including the turnover limit. For an Andheri or Powai SaaS company still inside its first decade, recognition is usually straightforward, and we obtain it and time the grants so they also clear the Reg 9A one-year line before any listing.</p>
...
<!-- LOCAL MARKET CONTEXT: MUMBAI -->
<section class="content-section" id="local-market-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Founder ESOPs in the Mumbai Startup and Capital-Markets Ecosystem</h2>
            <div class="content-text">
                <p>Mumbai companies file with the Registrar of Companies, Mumbai, and the city also hosts the SEBI headquarters in BKC, which is why founder-equity work here leans heavily towards listing readiness. The Rule 12 bar and DPIIT proviso are national, but Reg 9A planning is the local centre of gravity.</p>
                <p><strong>BKC and Lower Parel finance hubs:</strong> fintech and capital-markets companies that are often the closest to a public issue, where preserving founder options through the DRHP under Reg 9A is the priority. A BKC fintech founder classified as a promoter in the DRHP can keep options granted at least a year earlier, so we map grant dates against the listing timeline.</p>
                <p><strong>Andheri and Powai SaaS belt:</strong> growth-stage product companies, most still inside the 10-year DPIIT window, where the recognised-startup exemption supports valid founder grants now and Reg 9A protects them later.</p>
                <p><strong>Goregaon-Vikhroli startup corridor:</strong> earlier-stage companies where the first task is simply confirming whether the founder is a promoter or over the 10-percent line before any grant is made.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section" id="services-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">SEBI Regulation 9A and the BKC Founder's IPO Problem</h2>
            <div class="content-text">
                <p>For the BKC and Lower Parel companies closest to a public issue, the SEBI-administered Regulation 9A is often the single most important rule in the founder-equity file. It decides whether a promoter-founder keeps their options once the offer documents go in.</p>
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Question</th><th>Position under Reg 9A</th></tr></thead>
                    <tbody>
                        <tr><td>The old trap</td><td>Options earned as an employee could be lost the moment the founder was named a promoter in the IPO documents.</td></tr>
                        <tr><td>What now survives</td><td>A founder shown as a promoter in the DRHP keeps and may exercise, post-listing, any options or SAR granted at least one year before the DRHP is filed.</td></tr>
                        <tr><td>What is covered</td><td>Both vested and unvested options, so long as the grant cleared the one-year line.</td></tr>
                        <tr><td>What remains barred</td><td>Fresh grants to promoters are still not allowed.</td></tr>
                        <tr><td>The Mumbai takeaway</td><td>With SEBI next door in BKC, a fintech founder who grants a clear year before the DRHP carries those options through the listing.</td></tr>
...
<section class="steps-section" id="procedure-section">
    <div class="section-container">
        <header class="section-header" style="text-align:center;margin-bottom:48px;">
            ...
            <p class="section-subtitle" style="text-align:left;max-width:100%;">For a Mumbai founder, often with a listing somewhere on the horizon, we settle eligibility, then choose an instrument and grant date that also work against the Reg 9A and DRHP calendar.</p>
        </header>
    ...
    <div class="step-content">
        ...
        <p class="step-description">We settle whether you count as a promoter and where your stake falls against the 10-percent line.</p>
...
<div class="step-card">
    <div class="step-content">
        ...
        <p class="step-description">We verify DPIIT recognition and how many years of the window remain.</p>
        <div class="step-highlights">
...
<div class="step-card">
    <div class="step-content">
        ...
        <p class="step-description">ESOP while the window holds, sweat equity once it lapses, and Reg 9A timing for any listing.</p>
        <div class="step-highlights">
...
<div class="step-card">
    <div class="step-content">
        ...
        <p class="step-description">We carry the board and member resolutions and obtain the registered-valuer report.</p>
        <div class="step-highlights">
...
<div class="step-card">
    <div class="step-content">
        ...
        <p class="step-description">We issue the grant letters and record them in the SH-6 options register.</p>
        <div class="step-highlights">
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>Once a Mumbai founder validly holds an ESOP, the tax follows the ordinary employee path in two stages, with a deferral that helps recognised startups manage cash. For a Powai SaaS founder exercising long before any listing window opens at BSE or NSE, that startup deferral is often the difference between holding the shares and selling early just to fund the <a href="/esop-perquisite-tax-section-17-2-vi/mumbai">perquisite tax</a>.</p>
                <ul>
                    <li><strong>On exercise:</strong> the difference between fair market value and the exercise price is charged as a salary perquisite in the exercise year.</li>
                    <li><strong>On sale:</strong> any gain beyond the value already taxed at exercise is treated as a <a href="/esop-capital-gains-tax-on-sale/mumbai">capital gain when the shares are sold</a>.</li>
                    <li><strong>Deferral for recognised startups:</strong> employees of a DPIIT-recognised startup, eligible founders included, may defer the perquisite TDS under the <a href="/esop-startup-tds-deferral-section-192-1c/mumbai">startup deferral provisions</a>, which matters for an Andheri or Powai founder exercising long before any liquidity event.</li>
                    <li><strong>Even-handed treatment:</strong> a valid founder ESOP is taxed on precisely the same basis as any other employee's, with nothing extra layered on.</li>
                </ul>
...
<section class="content-section" id="challenges-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>The mistakes we see in Mumbai cluster around listing readiness rather than the basic Rule 12 bar: a media or fintech founder who self-granted years before recruiting a merchant banker, or a Lower Parel company that left founder grants until the DRHP was almost ready. Because a BRLM and the SEBI desk in BKC will read every grant date, the table below maps the founder-equity problems we most often unwind in this city.</p>
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Challenge</th><th>Impact</th><th>How Patron Accounting Solves It</th></tr></thead>
                    <tbody>
                        <tr><td>A barred founder was granted options anyway</td><td>Void grant that an underwriter or investor will flag</td><td>Test eligibility first and reverse any invalid grant before diligence.</td></tr>
                        <tr><td>The 10-year DPIIT window has run out</td><td>The ESOP route is no longer available</td><td>Move to sweat equity under Section 54, which promoters can use.</td></tr>
                        <tr><td>Founder options exposed as a listing nears</td><td>Promoter classification in the DRHP could lose them</td><td>Structure and date the grants to clear Reg 9A.</td></tr>
                        <tr><td>The company is not yet a recognised startup</td><td>The exemption cannot be relied on</td><td>Obtain DPIIT recognition, then grant inside the window.</td></tr>
                        <tr><td>BKC company granting founder options close to its DRHP</td><td>Options fall inside the Reg 9A cooling-off year</td><td>Bring grants forward so they predate the DRHP by at least a year.</td></tr>
...
<section class="why-choose-section" id="benefits-section">
    <div class="section-container">
        <div style="text-align:center;margin-bottom:48px;">
            ...
            <h2 class="section-title">Why Mumbai Founders Get Specialist Advice</h2>
        </div>
...
<article class="feature-card">
            ...
            <h3 class="feature-title">Promoter status read correctly</h3>
            <p class="feature-text">In a city of listed-co and fintech cap tables, we settle whether a BKC or Lower Parel founder is a promoter before a single option is granted.</p>
        </article>
<article class="feature-card">
            ...
            <h3 class="feature-title">DPIIT window used in time</h3>
            <p class="feature-text">For an Andheri or Powai SaaS founder still inside the first decade, we lock in recognition and grant while the exemption holds.</p>
        </article>
<article class="feature-card">
            ...
            <h3 class="feature-title">Survives the SEBI desk in BKC</h3>
            <p class="feature-text">With SEBI's headquarters down the road, we date founder options to clear the Reg 9A one-year line and carry through the DRHP.</p>
        </article>
<article class="feature-card">
            <div class="feature-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg></div>
            <h3 class="feature-title">Ready for merchant-banker diligence</h3>
            <p class="feature-text">A cap table and governance trail built to survive the underwriters and BRLMs a Mumbai listing brings to the table.</p>
        </article>
        </div>
    </div>
</section>
...
<section class="content-section" id="comparison-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>Where the ESOP route is closed to a Mumbai promoter, sweat equity is the practical alternative, and the right pick turns on whether the founder is being rewarded for service still to come or for value already contributed. Take a Goregaon-Vikhroli media founder past the 10-year DPIIT window who controls more than 10 percent: options are off the table, but sweat equity under Section 54 can still recognise the brand and IP they built. A Powai deep-tech founder licensing IIT-Bombay research is a similar candidate. The two instruments diverge on the following.</p>
                <div class="table-responsive-wrapper">
                <table>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>A Mumbai company files with RoC Mumbai, but the rules that decide founder eligibility are national, and SEBI, headquartered here in BKC, adds the listed-company layer. Four provisions frame it.</p>
            ...
            <div class="faq-expanded">
                ...
                <div class="faq-expanded__list">
                    <div class="faq-expanded__item" id="faq-1">
                        <h3 class="faq-expanded__q">Can founders get ESOPs in Mumbai?</h3>
                        <div class="faq-expanded__a"><p>By default, no. For a company registered with RoC Mumbai, Section 62(1)(b) read with Rule 12 excludes a promoter and a director holding more than 10 percent of the equity from the definition of employee, so they cannot be granted ESOPs. A DPIIT-recognised startup can grant to founders for up to 10 years from incorporation, and because so many Mumbai companies are IPO-bound, SEBI Reg 9A then protects those options through listing if they were granted in time. So a recognised Mumbai startup founder can hold ESOPs, while others rely on sweat equity.</p></div>
                    </div>
                    ...
                    <div class="faq-expanded__item" id="faq-3">
                        <h3 class="faq-expanded__q">My BKC fintech is planning an IPO. Will I lose my ESOPs as a promoter?</h3>
                        <div class="faq-expanded__a"><p>Not if the grant is timed correctly. SEBI Regulation 9A, notified in September 2025, lets a founder identified as a promoter in the draft red herring prospectus continue to hold and exercise options or SAR granted at least one year before the DRHP filing, covering both vested and unvested options. For a BKC or Lower Parel company close to listing, this makes the grant date decisive: options granted inside that one-year cooling-off period are not protected. We map your founder grants against the DRHP calendar so they survive the IPO.</p></div>
                    </div>
                    ...
                    <div class="faq-expanded__item" id="faq-7">
                        <h3 class="faq-expanded__q">How far ahead of a Mumbai IPO should founder grants be made?</h3>
                        <div class="faq-expanded__a"><p>At least one year before the board decides to undertake the IPO and file the DRHP. Reg 9A builds in a twelve-month cooling-off period precisely so companies cannot rush ESOPs to promoters just before listing, so grants made inside that year are not preserved. For Mumbai companies, where listing timelines move quickly once funding is in place, we recommend settling the founder ESOP scheme and making the grants early, well before the DRHP is on the horizon, and we maintain the record trail SEBI and the merchant bankers will expect.</p></div>
                    </div>
