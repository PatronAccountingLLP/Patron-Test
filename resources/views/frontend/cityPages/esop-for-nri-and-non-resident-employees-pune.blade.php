...
@section('meta')
    <title>Pune ESOP Plans for NRI Employees - FEMA & RBI Filing</title>
    <meta name="description" content="Grant ESOPs to NRI and non-resident staff from your Pune company with full FEMA, NDI Rules and Form ESOP filing support, priced at INR 19,999.">
    <meta name="keywords" content="ESOP for NRI and Non Resident Employees Pune, ESOP for NRI and Non Resident Employees in Pune, ESOP for NRI and Non Resident Employees services in Pune, ESOP services Pune, ESOP for NRI and Non Resident Employees cost Pune, ESOP for NRI and Non Resident Employees consultants Pune, CA firm for ESOP for NRI and Non Resident Employees Pune, ESOP advisory Pune">
    <link rel="canonical" href="/esop-for-nri-and-non-resident-employees/pune">
    <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1">
    <meta property="og:title" content="Pune ESOP Plans for NRI Employees - FEMA & RBI Filing | Patron Accounting">
    <meta property="og:description" content="Grant ESOPs to NRI and non-resident staff from your Pune company with full FEMA, NDI Rules and Form ESOP filing support, priced at INR 19,999.">
...
@section('schema')    <script type="application/ld+json">{
  ...
  "@graph": [
    {
      "@type": "Service",
      "@id": "https://www.patronaccounting.com/esop-for-nri-and-non-resident-employees/pune#service",
      "name": "ESOP for NRI and Non-Resident Employees in Pune",
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://www.patronaccounting.com/esop-for-nri-and-non-resident-employees/pune#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
        ...
        },
        {
          ...
          "item": "https://www.patronaccounting.com/esop-for-nri-and-non-resident-employees/pune"
        }
      ]
    },
    {
      ...
      "@id": "https://www.patronaccounting.com/esop-for-nri-and-non-resident-employees/pune#localbusiness",
      "name": "Patron Accounting LLP - ESOP For Nri And Non Resident Employees, Pune",
      "url": "https://www.patronaccounting.com/esop-for-nri-and-non-resident-employees/pune",
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-4 private-registration-heading">
                        ESOP for NRI and Non-Resident Employees in Pune
                    </h1>

                    <p style="font-size:1.05rem;color:var(--text-secondary);margin-bottom:1.25rem;margin-top:-0.5rem;">For Hinjewadi, Magarpatta and Kharadi product teams whose engineers have moved abroad - we handle the FEMA grant, RoC Pune resolutions and RBI Form ESOP filing end to end.</p>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>A Rajiv Gandhi Infotech Park SaaS company promotes its lead architect, who has just relocated to Austin on an L-1; a Magarpatta IT-services firm wants its founding back-end engineer in Berlin to stay vested; a Chakan MIDC manufacturer adds a non-resident technical director to its scheme. In each case the equity decision is easy - the compliance is not. The instant the cap table shows shares moving to a person resident outside India, the grant stops being a pure Companies Act matter and becomes a FEMA-reported foreign investment that your authorised dealer bank and the RBI both need to see.</p>
                <p>Patron Accounting runs that employer-side workload for Pune companies: we read the residency status of each grantee, structure the grant so it sits inside the NDI Rules, secure the certified fair-value number before allotment, and lodge Form ESOP through your AD bank within the 30-day window - while the Section 62 special resolution and scheme records continue to flow to RoC Pune on MCA21 in parallel.</p>
                <p>Note the boundary of this page. It is written for the company secretary, founder or finance lead doing the granting and reporting, not for the employee receiving the option. The <a href="/esop-perquisite-tax-section-17-2-vi/pune">perquisite at exercise</a>, the <a href="/esop-capital-gains-tax-on-sale/pune">capital-gains treatment on sale</a> and any DTAA relief sit on the employee's tax return; for that workstream, see our dedicated ESOP tax page for NRIs and non-residents.</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="two-column">
            <div class="column-content">
                ...
                <div class="content-text what-is-definition">
                    ...
                    <p><strong>Yes - and the law does not care which time zone the employee sits in.</strong> Rule 12 of the Companies (Share Capital and Debentures) Rules defines an eligible 'employee' to include permanent employees and directors working in or outside India, so a Kharadi product engineer now in San Jose, an OCI architect in Singapore, or a foreign-national CTO on your overseas subsidiary's payroll are all squarely inside the eligible class. The promoter and over-10-percent-director exclusion is the only carve-out, and it bites exactly the same way for a non-resident as for a Pune-based hire.</p>
                    <p><strong>So the friction is never the grant - it is the cross-border layer that sits on top of it.</strong> The moment those shares vest in someone resident outside India, FEMA reclassifies the issuance as inbound foreign investment, and that pulls in RBI reporting, a fair-value floor on the price and a defined repatriation route for the eventual sale. None of that displaces your ordinary ESOP scheme or the Companies Act steps; it runs alongside them. The pages that follow walk a Pune employer through each of those FEMA-specific obligations in turn.</p>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>Pune founders sometimes assume a non-resident grant is the mirror image of an Indian engineer holding options in a US parent - it is not. Here the equity flows the other way: an Indian company in Baner or Viman Nagar is issuing its own shares outward to someone abroad, which is the inbound foreign-investment direction RBI watches. Three rulebooks stack on a single grant, and a Pune SaaS or manufacturing employer has to satisfy all three at once:</p>
                <ul>
                    <li><strong>FEMA (the cross-border layer):</strong> issuing ESOPs to a person resident outside India is foreign investment under Schedule I of the FEMA (Non-debt Instruments) Rules, 2019, read with the Mode of Payment and Reporting Regulations - this is the layer that the national-scheme paperwork alone never covers.</li>
                    <li><strong>Companies Act (the grant itself):</strong> Section 62(1)(b) with Rule 12 and your board-approved ESOP scheme still govern eligibility, the special resolution and the option terms, with those records filed at RoC Pune.</li>
                    <li><strong>SEBI (only if listed):</strong> a listed Pune company layers the SEBI (Share Based Employee Benefits and Sweat Equity) Regulations on top; most Hinjewadi-belt startups are private and skip this rung.</li>
                </ul>
                <div class="highlight-box" style="margin-top:20px;">
                    <p><strong>The Pune picture.</strong> A typical Pune scenario is a Hinjewadi or Magarpatta SaaS firm whose lead engineer has moved to the US on an H-1B but stays on the rolls, or a Kharadi product company hiring a non-resident director. Both are foreign-investment grants. The corporate steps, the Section 62 special resolution and the scheme, are filed with RoC Pune, while the FEMA leg is reported through your authorised dealer bank, often one of the AD branches clustered around Baner and the central business district. Because many Pune engineers acquired their shares while still resident here and only later moved abroad, the repatriation basis is frequently non-repatriation, which is a planning point we flag at grant rather than at exit.</p>
                </div>
...
<section class="content-section" id="services-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p style="margin-bottom:16px;">For a Pune company the FEMA reporting never goes anywhere near RoC Pune - it is filed entirely through the RBI's FIRMS portal, routed via the authorised dealer branch your company banks with, typically one of the AD branches clustered along Baner Road, in Hinjewadi Phase 1 or in the city's central business district. Here is what actually has to reach the RBI, and when:</p>
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Trigger</th><th>What gets filed</th></tr></thead>
                    <tbody>
                        <tr><td>You grant options to a non-resident employee</td><td>Form ESOP, lodged within 30 days of the grant date.</td></tr>
                        <tr><td>The filing route</td><td>RBI FIRMS portal, submitted through your company's AD bank, not at any Pune office counter.</td></tr>
                        <tr><td>Shares are later allotted on exercise</td><td>The share issuance to the non-resident is reported as a separate event.</td></tr>
                        <tr><td>A deadline slips</td><td>The RBI applies a Late Submission Fee; the grant itself stays valid.</td></tr>
                        <tr><td>Why the 30 days matters in practice</td><td>One late filing is fixable, but a habit of them surfaces as a FEMA red flag in due diligence when a Pune startup raises its next round or sells.</td></tr>
...
<section class="content-section" id="challenges-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p style="margin-bottom:16px;">The cases that reach us from Hinjewadi, Kharadi and the Chakan belt tend to repeat the same four slip-ups - usually spotted late, when a funding round or an employee's exit forces the cap table open. Here is what goes wrong and how we close it off:</p>
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Where Pune companies trip up</th><th>What it costs you</th><th>How Patron Accounting fixes it</th></tr></thead>
                    <tbody>
                        <tr><td>The 30-day Form ESOP window quietly passes while the team focuses on the grant paperwork</td><td>A Late Submission Fee, plus a FEMA flag waiting in your next diligence</td><td>We diary every grant date and file inside the window, or regularise an old grant with the LSF before it is found.</td></tr>
                        <tr><td>Options pushed out to an overseas engineer at the resident exercise price</td><td>A below-fair-value entry sitting on your foreign-investment record</td><td>We get the certified DCF valuation done before the grant, so the price floor is met from day one.</td></tr>
                        <tr><td>Repatriation basis never decided at grant for a Kharadi-then-abroad engineer</td><td>Proceeds stuck or delayed when they finally sell</td><td>We fix NRE versus NRO routing at grant and document it, so the exit clears without a scramble.</td></tr>
                        <tr><td>The FEMA filing and the employee's tax run on separate desks</td><td>Form ESOP and the perquisite TDS that do not reconcile</td><td>We line the RBI reporting up against the <a href="/esop-tds-section-192-and-form-24q/pune">exercise-stage TDS</a> and capital-gains position.</td></tr>
...
<section class="content-section" id="comparison-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p style="margin-bottom:16px;">A non-resident ESOP is not one filing - it is a sequence stretched across the option's life, from the day a Viman Nagar startup grants to the day the employee finally sells. This is the full thread a Pune company has to keep intact:</p>
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>When it happens</th><th>What the RBI expects</th></tr></thead>
                    <tbody>
                        <tr><td>Grant to a non-resident employee</td><td>Form ESOP filed within 30 days of the grant</td></tr>
                        <tr><td>How it is filed</td><td>RBI FIRMS portal, routed through your Pune AD bank</td></tr>
                        <tr><td>Shares allotted on exercise</td><td>The share issuance to the non-resident reported separately</td></tr>
                        <tr><td>A deadline missed</td><td>Late Submission Fee levied by the RBI</td></tr>
                        <tr><td>Employee sells</td><td>Proceeds repatriated via the NRE or NRO account</td></tr>
...
<section class="content-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p style="margin-bottom:16px;">A Pune company running a non-resident grant is standing on two statutes at once - the Companies Act for the option and FEMA for the cross-border issuance - with the RoC Pune track and the RBI track each carrying their own deadlines. These are the exact provisions that govern it:</p>
                <p><strong>The cross-border classification:</strong> issuing ESOPs to a person resident outside India is treated as foreign investment under Schedule I of the FEMA (Non-debt Instruments) Rules, 2019, read with the FEMA (Mode of Payment and Reporting of Non-Debt Instruments) Regulations, 2019 - this is the leg the RBI, not RoC Pune, oversees.</p>
                <p><strong>The eligibility basis:</strong> the option is granted under Section 62(1)(b) of the Companies Act with Rule 12 of the Companies (Share Capital and Debentures) Rules, which lets a non-resident employee or director qualify, save for the promoter and over-10-percent-director exclusion; this is where your MGT-14 and PAS-3 filings reach RoC Pune.</p>
                <p><strong>The reporting and price rules:</strong> Form ESOP must reach the RBI within 30 days via the FIRMS portal and your AD bank, with a Late Submission Fee if it slips, and the issue price cannot fall below fair value certified by a CA or merchant banker.</p>
                <p><strong>The exit rule:</strong> sale proceeds move through the employee's NRE or NRO account, and whether they can be sent abroad turns on whether the shares are held on a repatriation or non-repatriation basis under FEMA.</p>
            ...
            <div class="faq-expanded">
                ...
                <div class="faq-expanded__list">
                    <div class="faq-expanded__item" id="faq-1">
                        <h3 class="faq-expanded__q">Can a Pune IT-services company grant ESOPs to an engineer who moved to the US?</h3>
                        <div class="faq-expanded__a"><p>Yes. Rule 12 of the Companies Act covers employees and directors whether based in Hinjewadi or in San Jose, so a Pune company can keep an engineer who has moved to the US on its ESOP scheme, and can grant to staff of an overseas branch or subsidiary. The promoter and over-10-percent-director bar still applies. The one extra step versus a resident grant is FEMA compliance, because the shares now go to a person resident outside India, which triggers RBI Form ESOP reporting through your authorised dealer bank.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-2">
                        <h3 class="faq-expanded__q">We file with RoC Pune. Does the FEMA reporting go to the same place?</h3>
                        <div class="faq-expanded__a"><p>No, they are two separate tracks. Your corporate filings, the Section 62 special resolution and the scheme records, go to RoC Pune as usual. The FEMA leg is entirely separate: Form ESOP is filed with the RBI through the FIRMS portal, routed via your authorised dealer bank, often one of the AD branches around Baner or the Pune central business district. We coordinate both so the RoC paperwork and the RBI reporting stay consistent and land within their own deadlines.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-3">
                        <h3 class="faq-expanded__q">Our engineer got ESOPs while resident in Pune, then moved abroad. What about repatriation?</h3>
                        <div class="faq-expanded__a"><p>This is the most common Pune pattern. An engineer who acquired or exercised shares while still resident in Pune typically holds them on a non-repatriation basis, so when they later sell, the proceeds route through the NRO account and remittance abroad follows the NRO limit, currently up to USD 1 million per financial year. Someone who was already a non-resident at grant may be on a repatriation basis with NRE routing. We confirm the basis at grant and document it, so the eventual exit is not held up by ambiguity.</p></div>
                    </div>
...
<section class="content-section" style="padding:48px 32px;background:var(--gray-50);">
    <div class="content-container"><div class="text-content">
        ...
        <div class="pa-city-grid"><span class="pa-city-card" aria-current="page" style="border-color:var(--orange);background:#FFF7F2;cursor:default;position:relative;"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Pune</div><div class="pa-card-sub">Maharashtra</div></div><span style="position:absolute;top:10px;right:12px;font-size:10px;font-weight:700;color:var(--orange);letter-spacing:.04em;">YOU'RE HERE</span></span><a href="/esop-for-nri-and-non-resident-employees/mumbai" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Mumbai</div><div class="pa-card-sub">Maharashtra</div></div></a><a href="/esop-for-nri-and-non-resident-employees/delhi" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Delhi</div><div class="pa-card-sub">Delhi NCR</div></div></a><a href="/esop-for-nri-and-non-resident-employees/gurugram" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Gurugram</div><div class="pa-card-sub">Haryana</div></div></a></div>
    </div></div>
</section>
