...
@section('meta')
    <title>Delhi ESOP Scheme Design with MCA & RoC Filing Support</title>
    <meta name="description" content="Set up a fully compliant ESOP for your Delhi tech startup with pool sizing, vesting, MGT-14 and PAS-3 filings handled at RoC Delhi, from INR 24,999.">
    <meta name="keywords" content="ESOP for Tech Startups Delhi, ESOP for Tech Startups in Delhi, ESOP for Tech Startups services in Delhi, ESOP services Delhi, ESOP for Tech Startups cost Delhi, ESOP for Tech Startups consultants Delhi, CA firm for ESOP for Tech Startups Delhi, ESOP advisory Delhi">
    <link rel="canonical" href="/esop-for-tech-startups/delhi">
    <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1">
    <meta property="og:title" content="Delhi ESOP Scheme Design with MCA & RoC Filing Support | Patron Accounting">
    <meta property="og:description" content="Set up a fully compliant ESOP for your Delhi tech startup with pool sizing, vesting, MGT-14 and PAS-3 filings handled at RoC Delhi, from INR 24,999.">
    <meta property="og:url" content="/esop-for-tech-startups/delhi">
    <meta property="og:type" content="website">
    <meta property="og:site_name" content="Patron Accounting">
    <meta property="og:image" content="/images/esop-for-tech-startups-og.webp">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Delhi ESOP Scheme Design with MCA & RoC Filing Support | Patron Accounting">
    <meta name="twitter:description" content="Set up a fully compliant ESOP for your Delhi tech startup with pool sizing, vesting, MGT-14 and PAS-3 filings handled at RoC Delhi, from INR 24,999.">
...
@section('schema')    <script type="application/ld+json">{
  ...
  "@graph": [
    {
      "@type": "Service",
      "@id": "https://www.patronaccounting.com/esop-for-tech-startups/delhi#service",
      "name": "ESOP for Tech Startups",
      "url": "https://www.patronaccounting.com/esop-for-tech-startups/delhi",
      ...
      "hasOfferCatalog": {
        ...
        "itemListElement": [
          {
            "@type": "Offer",
            "name": "Tech Startup ESOP Scheme Design",
            "priceCurrency": "INR",
            "price": "24999",
            "description": "Tech-optimised ESOP scheme design starting from INR 24,999; stage-based scope (Seed, Pre-Series A, Series A-plus, cross-border mirror grant) quoted on a free scoping call"
          },
          {
            "@type": "Offer",
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://www.patronaccounting.com/esop-for-tech-startups/delhi#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
        ...
        },
        {
          ...
          "position": 4,
          "name": "ESOP for Tech Startups",
          "item": "https://www.patronaccounting.com/esop-for-tech-startups/delhi"
        }
      ]
    },
    {
      ...
      "@id": "https://www.patronaccounting.com/esop-for-tech-startups/delhi#localbusiness",
      "name": "Patron Accounting LLP - ESOP For Tech Startups, Delhi",
      "url": "https://www.patronaccounting.com/esop-for-tech-startups/delhi",
    ...
    {
      "@type": "FAQPage",
      "@id": "https://www.patronaccounting.com/esop-for-tech-startups/delhi#faq",
      "datePublished": "2026-06-24T08:00:00+05:30",
      "dateModified": "2026-06-24T08:00:00+05:30",
      "mainEntity": [
        {
          "@type": "Question",
          "name": "What is the typical ESOP pool size for tech startups in Delhi?",
          "acceptedAnswer": {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          "name": "Where does a Delhi startup file its ESOP resolutions?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "A startup with its registered office in Delhi (Nehru Place, Connaught Place, Saket, Aerocity or anywhere in the NCT) files its ESOP scheme special resolution and pool top-ups on form MGT-14 within 30 days under Section 117(2) of the Companies Act 2013 with the Registrar of Companies, NCT of Delhi and Haryana, located at IFCI Tower, 61 Nehru Place. The same RoC also covers Haryana, so Gurugram and Faridabad companies file at the same office. PAS-3 follows within 30 days of allotment on exercise under Section 39(4)."
          }
        },
        {
          "@type": "Question",
          "name": "Does being near the MCA help a Delhi startup's ESOP?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "The Ministry of Corporate Affairs is headquartered in Delhi, but ESOP rules under Section 62(1)(b) and Rule 12 are uniform across India, so a Delhi startup gets no special legal treatment. The practical Delhi advantage is speed and access: the Nehru Place RoC, a dense pool of IBBI Registered Valuers and CS professionals, and proximity to MCA policy mean filings, the Rule 11UA FMV and DPIIT recognition tend to move quickly. The scheme itself - pool sizing, vesting, acceleration and the Section 80-IAC perquisite deferral - is designed to the same national standard wherever you register."
          }
        },
        {
          "@type": "Question",
          "name": "How does a Delhi startup retain engineers across the NCR?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Delhi, Gurugram and Noida operate as one fluid engineering market, so a Delhi startup loses talent not only to local rivals but to the well-funded Cyber City SaaS firms a metro ride away. The retention design that works is double-trigger acceleration plus refresh grants at 24 to 36 months (25 to 50 percent of the original grant), which reset the incentive before a senior engineer hits full vesting and fields an NCR-wide counteroffer. Patron pre-drafts refresh authority into the Delhi scheme so retaining a key hire never waits on a fresh EGM."
          }
        },
        {
          "@type": "Question",
          "name": "How do you design an ESOP for a tech startup?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "The template for a tech startup ESOP is a 10 to 15 percent pool (depending on stage), 4-year vesting with a 1-year cliff under Rule 12(6)(a), role-based grants (founder backfill 0.5-2 percent, CTO 0.5-1.5 percent, senior engineer 0.15-0.3 percent, mid-IC 0.05-0.15 percent), and refresh grant authority drafted into the scheme for top performers with 24-36 months tenure, with hybrid 50/100 acceleration on acquisition. DPIIT recognition is required for the Rule 12 10-year exemption, which allows ESOPs to be granted to founders and 10 percent-plus directors. Section 80-IAC provides a 48-month tax deferral (60 months under the Income Tax Act 2025 from 1 April 2026). Where there is a foreign parent, mirror grants and LRS limits apply under the FEMA OI Rules 2022. MGT-14 must be filed within 30 days under Section 117(2). Patron designs the full scheme in 4 to 6 weeks. Call +91 945 945 6700."
          }
        }
      ]
    }
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-4 private-registration-heading">
                        ESOP for Tech Startups in Delhi
                    </h1>

                    <p class="mb-4" style="font-size:16px;color:var(--text-secondary);max-width:680px;">Built for Nehru Place, Connaught Place and Saket-Aerocity founders - schemes that satisfy NRI and US-flipped cap tables and file straight into RoC Delhi, a short drive from the MCA head office.</p>
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - Tech Startup ESOP'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value='Seed Stage Tech ESOP Design' selected>Seed Stage Tech ESOP Design</option>
                                <option value='Pre-Series A Tech ESOP Design'>Pre-Series A Tech ESOP Design</option>
                                <option value='Series A+ Comprehensive Tech ESOP'>Series A+ Comprehensive Tech ESOP</option>
                                <option value='Cross-Border Mirror Grant Design'>Cross-Border Mirror Grant Design</option>
                                <option value='Pool Top-Up at Funding Round'>Pool Top-Up at Funding Round</option>
                                <option value='Annual Refresh Grant Review'>Annual Refresh Grant Review</option>
                                ...
                                <option value='Hybrid Acceleration Drafting'>Hybrid Acceleration Drafting</option>
                                <option value='SAR Cash-Settled Scheme Design'>SAR Cash-Settled Scheme Design</option>
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                <div class="highlight-box" style="margin-bottom:20px;">
                    <p><strong>&#128204; TL;DR - Tech Startup ESOP in Delhi at a Glance</strong></p>
                    <p>For a Delhi founder, the ESOP is the one lever strong enough to hold engineers, product leads and CXOs against the higher-cash offers waiting a metro ride away in Gurugram and Noida. A scheme that does the job carries a stage-sized pool (10 to 20 percent from Seed to Series C-plus), seven role bands of grants (early engineers 0.5 to 2 percent, VP and C-Level 0.3 to 1.5 percent, mid-IC 0.05 to 0.3 percent), a 4-year vest on a Rule 12(6)(a) one-year cliff, refresh-grant authority for the 24-36 month tenure crowd (25 to 50 percent of the original), and pre-drafted acceleration (single, double or hybrid 50/100) for the M&amp;A or strategic exit your NRI and overseas investors are underwriting. Every filing lands at RoC Delhi and Haryana, in the capital where the MCA itself sits.</p>
                </div>
                <p>An ESOP designed in Delhi is shaped less by where it is filed than by who it has to compete against and who is funding it. The registered office may sit in Nehru Place, Connaught Place or the Saket-Aerocity belt, but the engineer being retained reads offers from across the whole National Capital Region - so the retention maths is an NCR problem, not a Delhi-only one. Layered on top is the capital's distinctive backer profile: a deep NRI and overseas-investor base, plenty of US-flipped consumer and product startups, and a trading and consumer-tech slant that pushes cross-border structuring to the front of the brief rather than the footnotes. Proximity to the Ministry of Corporate Affairs and to RoC Delhi makes the paperwork fast, but it does nothing for attrition; the scheme still has to carry the 4th engineer at Seed and the VP Engineering hire after Series B on one Board-approved document.</p>
                <p>That is why a Delhi tech scheme leans hard on the tools generic ESOPs skip - refresh grants at 24-36 months, performance vesting tied to ARR, GMV or product milestones, and acceleration drafted for a tech M&amp;A rather than negotiated under deal pressure. Patron Accounting LLP has run these for Delhi SaaS, fintech, consumer-tech and B2B founders since 2009. The CA, CS and tax bench models the dilution, drafts the scheme, files the EGM resolutions into RoC Delhi, commissions the <a href="/esop-valuation-services/delhi">IBBI Registered Valuer FMV under Rule 11UA</a>, and clears DPIIT recognition where it applies - and, for the capital's overseas-parent cap tables, carries the FEMA mirror-grant work in the same engagement. With offices in Pune, Mumbai, Delhi and Gurugram, each engagement ships stage-wise dilution scenarios, a role-band term-sheet library, refresh authority pre-drafted, and hybrid acceleration that holds up under Series A diligence.</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="two-column">
            <div class="column-content">
                ...
                <div class="content-text what-is-definition">
                    ...
                    <p>Two features set the capital's tech ESOPs apart from a boilerplate scheme, and the first is the one founders elsewhere meet later: cross-border structuring is a day-one question in Delhi. With a heavy NRI and overseas-investor base and a cluster of US-flipped consumer and product startups near Nehru Place and across the Saket-Aerocity belt, a sizeable share of capital-region cap tables sit under a US, Singapore or UK parent. Where they do, three structures are on the table - a Mirror Grant on the parent's stock under the <a href="/esop-fema-and-rbi-firms-reporting/delhi">FEMA Overseas Investment Rules 2022</a> (OPI at or below 10 percent of parent equity, ODI above), a Local Indian-Entity ESOP via a Section 62(1)(b) scheme (rare for wholly-owned subsidiaries), and a <a href="/esop-vs-sar/delhi">cash-settled SAR (Stock Appreciation Right)</a> under Ind AS 102 group SBP rules. Picking among them, not just drafting one, is where the Delhi brief usually starts.</p>
                    <p>The second feature is the design grammar every serious tech scheme shares, whatever the parent. The pool is stage-driven and front-loaded (Pre-Seed 5-8 percent, Seed 10-12 percent, Series A 12-15 percent, Series B 15-18 percent, Series C-plus 15-20 percent of fully diluted equity); grants run across seven role bands from a junior IC at 0.01-0.05 percent up to a founder backfill at 0.5-2 percent; refresh authority for 24-36 month tenure top performers (25-50 percent of the original) sits inside the scheme so retention never waits on a fresh EGM; acceleration - single, double or hybrid 50/100 - is drafted in rather than fought over at M&amp;A; and founder grants are unlocked through the Rule 12 DPIIT 10-year exemption that would otherwise bar promoters and 10 percent-plus directors.</p>
                    <p>Underneath all of it the instrument is identical to anywhere in India - a Section 62(1)(b) Companies Act 2013 grant operated under Rule 12 of the Companies (Share Capital and Debentures) Rules 2014. What Delhi adds is speed and an audience: filings clear quickly through RoC Delhi and Haryana in the MCA's home city, while the scheme itself answers to NRI-grade diligence and a consumer-tech, trading-platform talent market that prices engineers against the whole NCR.</p>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>Picture three Delhi cap tables. A trading-and-consumer-tech team near Nehru Place hiring its first ten engineers; a Connaught Place fintech where the founders hold most of the equity and need their own grants made valid; and a Saket-Aerocity product company whose Series A lead is an NRI fund insisting on a clean, diligence-ready pool. Each is the same brief at root - equity stretched across competitive engineer pay, equity-weighted CXO offers and investor pool top-ups round after round - and each is the kind of work a non-tech ESOP template handles badly, leaving retention friction, conflicting side letters and Series A pushback in its wake. The roles below are the ones that need a tech-vertical scheme rather than a generic one.</p>
                <ul>
...
<section class="content-section" id="services-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>The tiers below scale with your round, not your postcode, but two of them earn their keep in Delhi specifically: the cross-border mirror-grant tiers, which the capital's NRI-backed and US-flipped cap tables reach for far more often than a typical Indian city, and the corporate-action tiers, which we run to the documentation standard that RoC Delhi and Haryana - the MCA's own jurisdiction - tends to expect.</p>
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Service</th><th>What We Do</th></tr></thead>
                    <tbody>
                        
                        <tr><td><strong>Seed Stage Tech ESOP Design</strong></td><td>Pool sizing for 18-24 month hiring plan with senior CXO bench reserved; tech-optimised scheme drafting under Section 62(1)(b); Board and EGM kit; MGT-14 within 30 days of special resolution; SH-6 register setup; sample term sheets for 4 role bands (founder backfill, CXO, senior IC, mid-IC).</td><td>Quoted on scoping call</td></tr>
                        <tr><td><strong>Pre-Series A Tech ESOP Design</strong></td><td>Seed scope plus DPIIT recognition under Notification GSR 127(E) 2019; Section 80-IAC plus Section 192(2C) tax deferral pathway; refresh grant authority drafted into the scheme; hybrid 50/100 acceleration; CXO performance vesting hooks under Rule 12 measurable conditions.</td><td>Quoted on scoping call</td></tr>
                        <tr><td><strong>Series A Plus Comprehensive Tech ESOP</strong></td><td>Full Pre-Series A scheme with role-based grant library across 7 bands; leaver matrix (good leaver, bad leaver, retirement, death); clawback provisions; exit window tiers (90 days IC, 6 months managers, 12-24 months senior leadership); Board ratification of retrospective grants.</td><td>Quoted on scoping call</td></tr>
                        <tr><td><strong>Pool Top-Up at Each Funding Round</strong></td><td>Fresh EGM, Special Resolution at 75 percent majority, MGT-14 within 30 days for pool expansion at Series A, B, C closings. Investor pre-approved pool size drafted into the scheme.</td><td>Quoted on scoping call</td></tr>
                        ...
                        <tr><td><strong>Annual Refresh Grant Review</strong></td><td>Year-end review of pool consumption; attrition adjustments; market benchmark refresh against Trifecta, Index Ventures, EquityList data; refresh grant recommendations for top performers nearing full vesting at 24-36 month tenure.</td><td>Quoted on scoping call</td></tr>
                        <tr><td><strong>IBBI Valuation (Pass-Through)</strong></td><td>FMV report under Rule 11UA for grant date - DCF, NAV or CCA methodology selection. Valuation refreshed at every fresh grant batch and every 180 days for exercise events.</td><td>quoted on a scoping call</td></tr>
                        <tr><td><strong>Cross-Border Mirror Grant Premium (Multi-Jurisdiction)</strong></td><td>Complex multi-jurisdiction structure (US Delaware/Singapore/UK parent); transfer pricing coordination under Section 92 plus Rule 10D; multi-class capital structure; Ind AS 102 group SBP coordination with statutory auditor.</td><td>Quoted on scoping call</td></tr>
...
<section class="steps-section" id="procedure-section">
    <div class="section-container">
        <div class="section-header" style="text-align:center;margin-bottom:48px;">
            ...
            <p class="section-subtitle" style="text-align:left;max-width:100%;">The eight steps run the same 4-6 week clock in the capital - discovery and cap-table review, DPIIT pathway, a pool-sizing workshop with three dilution scenarios, scheme drafting with refresh authority and hybrid acceleration baked in, the Board and EGM cycle filed into RoC Delhi and Haryana, the Rule 11UA IBBI valuation, the role-band term-sheet library, and the first grant batch with SH-6 setup. The one Delhi-specific overlay sits across Steps 1, 4 and 7: where an NRI fund or a US, Singapore or UK parent is on the cap table, FEMA OI Rules 2022 and a 409A or mirror-grant valuation get coordinated alongside the domestic flow, stretching the timeline to roughly 5-7 weeks.</p>
        </div>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>A Delhi engagement hands back three things: the design artifacts (pool model, scheme, term-sheet library), the statutory filings lodged at RoC Delhi and Haryana, and the operational register set. Where the capital's deal flow differs is the fifth deliverable below - the cross-border structure pack runs deeper here than on a typical domestic-only cap table, because so many Nehru Place and Saket-Aerocity teams sit under an overseas parent or an NRI-led round.</p>
                ...
                <ul>
                    ...
                    <li>Built on the <a href="/esop-scheme-design/delhi">ESOP Scheme Design</a> engagement template.</li>
                </ul>
...
<section class="content-section" id="challenges-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>Most of these mistakes are national, but two bite harder in the capital. The cross-border mirror-grant slip - issuing a US or Singapore parent's stock to Delhi engineers without the FEMA OI Rules 2022 paperwork - shows up constantly here precisely because so many capital-region cap tables are overseas-parented, and it invites RBI compounding. And an MGT-14 default does not get lost in a queue when RoC Delhi and Haryana sits in the MCA's own backyard. The table pairs each failure point with the way we head it off.</p>
                <div class="table-responsive-wrapper">
                <table>
                    ...
                    <tbody>
                        ...
                        <tr><td><strong>MGT-14 default under Section 117(2)</strong></td><td>Rs 100 per day after 30 days under Section 117(2) of Companies Act 2013 for delay in filing special resolutions (scheme adoption, pool top-up). Compounding can exceed Rs 50,000 for a 6-month delay.</td><td>Patron filing calendar tracks every special resolution against the 30-day MGT-14 deadline. Automated reminder 7 days before deadline. End-to-end through <a href="/esop-corporate-filings/delhi">ESOP Corporate Filings</a> retainer.</td></tr>
            ...
            <div class="content-text">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr><td>Annual refresh grant review</td><td>Year-end review of pool, attrition adjustments, market benchmarks, refresh grant recommendations</td><td class="table-amount">Quoted on scoping call</td></tr>
                        <tr><td>IBBI valuation (pass-through)</td><td>FMV report under Rule 11UA for grant date and exercise events</td><td class="table-amount">quoted on a scoping call</td></tr>
                        <tr><td>Seed stage tech ESOP design</td><td>Pool sizing, scheme drafting, Board and EGM kit, MGT-14, SH-6 setup, sample term sheets for 4 role bands</td><td class="table-amount">Quoted on scoping call</td></tr>
                        <tr><td>Pre-Series A tech ESOP design</td><td>Seed scope plus DPIIT and 80-IAC pathway, refresh grant authority, hybrid acceleration, CXO performance vesting hooks</td><td class="table-amount">Quoted on scoping call</td></tr>
                        <tr><td>Series A+ comprehensive tech ESOP</td><td>Full Pre-Series A scheme with role-based grant library across 7 bands, leaver matrix, clawback, exit window tiers</td><td class="table-amount">Quoted on scoping call</td></tr>
                        <tr><td>Cross-border mirror grant design</td><td>Foreign parent plus Indian subsidiary structure under FEMA OI Rules 2022; OPI classification; LRS design; SAR alternative</td><td class="table-amount">Quoted on scoping call</td></tr>
                        <tr><td>Cross-border mirror grant premium (multi-jurisdiction)</td><td>Complex multi-jurisdiction (US/Singapore/UK); transfer pricing coordination; multi-class capital structure</td><td class="table-amount">Quoted on scoping call</td></tr>
                        <tr><td><strong>Patron Accounting Professional Fees</strong></td><td>Starting price for Seed stage tech ESOP design; listed-company SEBI SBEB schemes quoted separately; ESOP filings retainer (MCA filings) available as separate annual engagement under ESOP Corporate Filings</td><td class="table-amount"><strong>From INR 24,999 (Exl GST and Govt. Charges)</strong></td></tr>
...
<section class="why-choose-section" id="benefits-section">
    ...
    <article class="feature-card"><h3>Delhi Presence Plus Pan-India</h3><p>Offices in Pune, Mumbai, Delhi and Gurugram, with direct support for Nehru Place, Saket and Aerocity founders and filings to the Registrar of Companies Delhi. Cross-border desk for NRI and US-parent cap tables.</p></article>
</div>
    </div>
</section>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p><strong>Selected Tech Clients (Illustrative):</strong> Tech startup clients across SaaS, AI/ML, fintech, marketplaces, deeptech and DevTools verticals. </p>
...
<section class="content-section" id="comparison-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>Acceleration is where a Delhi exit is quietly won or lost. Many capital-region consumer-tech and product companies are built to be acquired - often by a US or Singapore parent already on the cap table - so the acceleration clause directly sets how much leverage the acquirer keeps over your team after the deal, and how much an NRI-led board will accept at diligence. The table sets single, double and hybrid 50/100 side by side so the choice holds up under that US-style review rather than being renegotiated at signing.</p>
                <div class="table-responsive-wrapper">
                <table>
                    <thead>
                        <tr>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <ul>
                    <li><strong><a href="/esop-services/delhi">ESOP Services Master Hub</a></strong> - end-to-end ESOP lifecycle services covering all verticals and engagement types.</li>
                    <li><strong><a href="/esop-for-saas-companies/delhi">ESOP for SaaS Companies</a></strong> - sibling vertical-specific page for B2B SaaS with ARR-linked vesting, sales quota acceleration, CSM NRR linkage and Delaware flip mirror grant structures.</li>
                    <li><strong><a href="/esop-scheme-design/delhi">ESOP Scheme Design</a></strong> - generic first-time scheme drafting with sample term sheet; baseline template that tech-vertical design builds on.</li>
                    <li><strong><a href="/esop-valuation-services/delhi">ESOP Valuation Services</a></strong> - Rule 11UA FMV reports including DCF, NAV and CCA methodologies for grant and exercise events.</li>
                    <li><strong><a href="/esop-accounting-ind-as-102/delhi">ESOP Accounting under Ind AS 102</a></strong> - share-based payment expense recognition over vesting period; group SBP rules for cross-border mirror grants.</li>
                    <li><strong><a href="/esop-corporate-filings/delhi">ESOP Corporate Filings</a></strong> - ongoing MCA filings retainer covering MGT-14, PAS-3 and MGT-7 for tech startups with active grant cycles.</li>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>The statutes below are national, but they land in a particular order for a Delhi founder. The Companies Act corporate actions - MGT-14, PAS-3, the Section 62(1)(b) scheme itself - file into RoC Delhi and Haryana, the registry that also covers Gurugram and Faridabad and sits in the MCA's own city. The FEMA and DTAA provisions, often an afterthought elsewhere, sit near the top of the stack here because the capital's NRI-led rounds and US, Singapore and UK parents make cross-border ESOPs routine rather than exceptional.</p>
                <ul>
...
<section class="content-section" id="local-market-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">ESOP Design for the Delhi Startup Ecosystem</h2>
            <div class="content-text">
                <p>Delhi's startup activity clusters in three belts, each with a different ESOP profile. <strong>Nehru Place</strong>, the historic IT and electronics hub, now hosts a mix of SaaS, IT-services and B2B startups - and, notably, the Registrar of Companies for NCT of Delhi sits in the IFCI Tower right here, so scheme filings are close to home. The <strong>Connaught Place and central Delhi</strong> finance core attracts fintech and capital-light startups where founder ESOPs under the DPIIT Rule 12 ten-year exemption and disciplined pool sizing matter most. The <strong>Saket and Aerocity</strong> corporate belt (the Saket District Centre and the Aerocity hospitality-and-office cluster near the airport) hosts growth-stage startups and Indian arms of global firms that often run cross-border mirror grants under FEMA Overseas Investment Rules 2022.</p>
                <p>Delhi companies file their ESOP special resolutions and MGT-14 with the <strong>Registrar of Companies, NCT of Delhi and Haryana</strong> at IFCI Tower, Nehru Place, within 30 days under Section 117(2), with PAS-3 on allotment after exercise. The same RoC covers Haryana, which is why Gurugram and Faridabad companies file at the same office. Being in the same city as the Ministry of Corporate Affairs and a deep bench of IBBI Registered Valuers means Delhi founders get fast turnaround on the Rule 11UA FMV and scheme filings. Patron has structured ESOPs for Delhi SaaS, fintech and B2B founders since 2009, coordinating the Section 62(1)(b) scheme adoption, the IBBI valuation, the Section 80-IAC perquisite deferral and any cross-border structure as one engagement.</p>
                <div class="highlight-box">
                    <p><strong>Delhi local context:</strong> Because Delhi, Gurugram and Noida share one fluid talent market, a Delhi startup competes for engineers against the well-capitalised Cyber City SaaS firms next door. Refresh grants at 24 to 36 months and double-trigger acceleration are the two design moves that keep a Delhi scheme competitive across the whole NCR rather than only within the capital.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="content-container">
        <div class="text-content">
            <div class="faq-expanded">
                ...
                <div class="faq-expanded__list">
                    <div class="faq-expanded__item" id="faq-1">
                        <h3 class="faq-expanded__q">What is the typical ESOP pool size for tech startups in Delhi?</h3>
                    ...
                    <div class="faq-expanded__item" id="faq-5">
                        <h3 class="faq-expanded__q">Where does a Delhi startup file its ESOP resolutions?</h3>
                        <div class="faq-expanded__a"><p>A startup with its registered office in Delhi (Nehru Place, Connaught Place, Saket, Aerocity or anywhere in the NCT) files its ESOP scheme special resolution and pool top-ups on form MGT-14 within 30 days under Section 117(2) of the Companies Act 2013 with the Registrar of Companies, NCT of Delhi and Haryana, located at IFCI Tower, 61 Nehru Place. The same RoC also covers Haryana, so Gurugram and Faridabad companies file at the same office. PAS-3 follows within 30 days of allotment on exercise under Section 39(4).</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-6">
                        <h3 class="faq-expanded__q">Does being near the MCA help a Delhi startup's ESOP?</h3>
                        <div class="faq-expanded__a"><p>The Ministry of Corporate Affairs is headquartered in Delhi, but ESOP rules under Section 62(1)(b) and Rule 12 are uniform across India, so a Delhi startup gets no special legal treatment. The practical Delhi advantage is speed and access: the Nehru Place RoC, a dense pool of IBBI Registered Valuers and CS professionals, and proximity to MCA policy mean filings, the Rule 11UA FMV and DPIIT recognition tend to move quickly. The scheme itself - pool sizing, vesting, acceleration and the Section 80-IAC perquisite deferral - is designed to the same national standard wherever you register.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-7">
                        <h3 class="faq-expanded__q">How does a Delhi startup retain engineers across the NCR?</h3>
                        <div class="faq-expanded__a"><p>Delhi, Gurugram and Noida operate as one fluid engineering market, so a Delhi startup loses talent not only to local rivals but to the well-funded Cyber City SaaS firms a metro ride away. The retention design that works is double-trigger acceleration plus refresh grants at 24 to 36 months (25 to 50 percent of the original grant), which reset the incentive before a senior engineer hits full vesting and fields an NCR-wide counteroffer. Patron pre-drafts refresh authority into the Delhi scheme so retaining a key hire never waits on a fresh EGM.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-8">
                        <h3 class="faq-expanded__q">How do you design an ESOP for a tech startup?</h3>
                        <div class="faq-expanded__a"><p>The template for a tech startup ESOP is a 10 to 15 percent pool (depending on stage), 4-year vesting with a 1-year cliff under Rule 12(6)(a), role-based grants (founder backfill 0.5-2 percent, CTO 0.5-1.5 percent, senior engineer 0.15-0.3 percent, mid-IC 0.05-0.15 percent), and refresh grant authority drafted into the scheme for top performers with 24-36 months tenure, with hybrid 50/100 acceleration on acquisition. DPIIT recognition is required for the Rule 12 10-year exemption, which allows ESOPs to be granted to founders and 10 percent-plus directors. Section 80-IAC provides a 48-month tax deferral (60 months under the Income Tax Act 2025 from 1 April 2026). Where there is a foreign parent, mirror grants and LRS limits apply under the FEMA OI Rules 2022. MGT-14 must be filed within 30 days under Section 117(2). Patron designs the full scheme in 4 to 6 weeks. Call <a href="tel:+919459456700" style="color:inherit;">+91 945 945 6700</a>.</p></div>
                    </div>
                </div>
            </div>
            ...
            <div class="highlight-box" style="margin-top:32px;">
                ...
                <ul>
                    <li><strong>How large should a tech startup's ESOP pool be compared with other industries?</strong> Tech pools run larger: B2B SaaS and deeptech typically set aside 10-20 percent, while traditional services and manufacturing usually keep it to 5-10 percent.</li>
                    <li><strong>Can I grant ESOPs before incorporating as a Private Limited company?</strong> No, ESOPs require a Section 62(1)(b) special resolution that applies only to companies with share capital, so founders execute equity promises pre-incorporation and regularise them once the company is formed.</li>
                    <li><strong>Do investors need to consent before we top up the ESOP pool?</strong> Usually yes, because most Series A shareholders' agreements require investor approval for pool expansion, and Patron drafts the scheme to grant within the investor pre-approved pool size.</li>
                    <li><strong>What is the typical Series A ESOP pool norm for tech startups?</strong> Series A term sheets typically demand a 12-15 percent post-money pool.</li>
                    <li><strong>How long can employees defer perquisite tax under Section 80-IAC?</strong> Eligible startups can defer for 48 months currently, rising to 60 months under Section 392(3) of the Income Tax Act 2025 from 1 April 2026.</li>
                    <li><strong>What is the filing deadline for Form MGT-14 after the ESOP special resolution?</strong> Form MGT-14 must be filed within 30 days of passing the special resolution, under Section 117(2) of the Companies Act 2013.</li>
                </ul>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text" style="text-align:left;">
                ...
                <p style="color:rgba(255,255,255,0.92);">Ready to design your tech startup ESOP scheme? <strong><a href="tel:+919459456700" style="color:inherit;text-decoration:underline;">Call us at +91 945 945 6700</a></strong> or <strong><a href="https://wa.me/919459456700?text=Hi%2C%20I%20would%20like%20a%20free%20consultation%20about%20ESOP%20services." target="_blank" rel="noopener" style="color:inherit;text-decoration:underline;">WhatsApp us</a></strong> for a free tech ESOP scoping call. Response within 2 hours. 4 to 6 week end-to-end design timeline.</p>
...
<section class="content-section">
    <div class="content-container"><div class="text-content">
        ...
        <div class="content-text"><p>Start with the national ESOP for Tech Startups service, then explore complementary ESOP services across India.</p>
        <ul>
                    <li><strong><a href="/esop-for-tech-startups">ESOP for Tech Startups in India</a></strong> - the national parent service</li>
...
<section class="content-section" style="padding:48px 32px;background:var(--gray-50);">
    <div class="content-container"><div class="text-content">
        <h2 class="section-title">ESOP for Tech Startups by City</h2>
        <div class="content-text"><p>Available across our four office cities. You are viewing the Delhi page.</p></div>
        <div class="pa-city-grid"><a href="/esop-for-tech-startups/pune" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Pune</div><div class="pa-card-sub">Maharashtra</div></div></a><a href="/esop-for-tech-startups/mumbai" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Mumbai</div><div class="pa-card-sub">Maharashtra</div></div></a><span class="pa-city-card" aria-current="page" style="border-color:var(--orange);background:#FFF7F2;cursor:default;position:relative;"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Delhi</div><div class="pa-card-sub">Delhi NCR</div></div><span style="position:absolute;top:10px;right:12px;font-size:10px;font-weight:700;color:var(--orange);letter-spacing:.04em;">YOU'RE HERE</span></span><a href="/esop-for-tech-startups/gurugram" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Gurugram</div><div class="pa-card-sub">Haryana</div></div></a></div>
    </div></div>
</section>
