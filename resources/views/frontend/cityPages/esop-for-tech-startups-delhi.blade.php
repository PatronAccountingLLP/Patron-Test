        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'Seed Stage Tech ESOP Design',
                    'options'  => [
                        'Seed Stage Tech ESOP Design' => 'Seed Stage Tech ESOP Design',
                        'Pre-Series A Tech ESOP Design' => 'Pre-Series A Tech ESOP Design',
                        'Series A+ Comprehensive Tech ESOP' => 'Series A+ Comprehensive Tech ESOP',
                        'Cross-Border Mirror Grant Design' => 'Cross-Border Mirror Grant Design',
                        'Pool Top-Up at Funding Round' => 'Pool Top-Up at Funding Round',
                        'Annual Refresh Grant Review' => 'Annual Refresh Grant Review',
                        ...
                        'Hybrid Acceleration Drafting' => 'Hybrid Acceleration Drafting',
                        'SAR Cash-Settled Scheme Design' => 'SAR Cash-Settled Scheme Design',
                        'Other' => 'Other',
                    ],
                ])
            </div>
