...
@section('meta')
    <title>Gurugram ESOP Plans for Cyber City Enterprise SaaS</title>
    <meta name="description" content="Design enterprise-SaaS ESOPs for your Cyber City startup with role-based grants, performance vesting and change-of-control acceleration, from INR 24,999.">
    <meta name="keywords" content="ESOP for Tech Startups Gurugram, ESOP for Tech Startups in Gurugram, ESOP for Tech Startups services in Gurugram, ESOP services Gurugram, ESOP for Tech Startups cost Gurugram, ESOP for Tech Startups consultants Gurugram, CA firm for ESOP for Tech Startups Gurugram, ESOP advisory Gurugram">
    <link rel="canonical" href="/esop-for-tech-startups/gurugram">
    <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1">
    <meta property="og:title" content="Gurugram ESOP Plans for Cyber City Enterprise SaaS | Patron Accounting">
    <meta property="og:description" content="Design enterprise-SaaS ESOPs for your Cyber City startup with role-based grants, performance vesting and change-of-control acceleration, from INR 24,999.">
...
@section('schema')    <script type="application/ld+json">{
  ...
  "@graph": [
    {
      "@type": "Service",
      "@id": "https://www.patronaccounting.com/esop-for-tech-startups/gurugram#service",
      "name": "ESOP for Tech Startups",
      "url": "https://www.patronaccounting.com/esop-for-tech-startups/gurugram",
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://www.patronaccounting.com/esop-for-tech-startups/gurugram#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
        ...
        },
        {
          ...
          "position": 4,
          "name": "ESOP for Tech Startups",
          "item": "https://www.patronaccounting.com/esop-for-tech-startups/gurugram"
        }
      ]
    },
    {
      ...
      "@id": "https://www.patronaccounting.com/esop-for-tech-startups/gurugram#localbusiness",
      "name": "Patron Accounting LLP - ESOP For Tech Startups, Gurugram",
      "url": "https://www.patronaccounting.com/esop-for-tech-startups/gurugram",
    ...
    {
      "@type": "FAQPage",
      "@id": "https://www.patronaccounting.com/esop-for-tech-startups/gurugram#faq",
      "datePublished": "2026-06-24T08:00:00+05:30",
      "dateModified": "2026-06-24T08:00:00+05:30",
      "mainEntity": [
        {
          "@type": "Question",
          "name": "What is the typical ESOP pool size for tech startups in Gurugram?",
          "acceptedAnswer": {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          "name": "Where does a Gurugram startup file its ESOP resolutions?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Although Gurugram is in Haryana, its companies file ESOP scheme special resolutions and pool top-ups on form MGT-14 within 30 days under Section 117(2) of the Companies Act 2013 with the Registrar of Companies, NCT of Delhi and Haryana, at IFCI Tower, 61 Nehru Place, New Delhi - that single RoC has jurisdiction over both Delhi and Haryana. PAS-3 on allotment after exercise is filed at the same office under Section 39(4). Whether your registered office is in Cyber City, Golf Course Road or on Sohna Road, the filing destination is the Delhi RoC, not a separate Haryana office."
          }
        },
        {
          "@type": "Question",
          "name": "How do Cyber City startups retain engineers against constant poaching?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Cyber City and Udyog Vihar are the densest poaching environment in the NCR - a senior engineer can switch to a funded rival or a global capability centre without changing their commute. Cash cannot win that fight, so the ESOP has to. The two moves that hold are refresh grants at 24 to 36 months (25 to 50 percent of the original grant) to reset the incentive before full vesting, and hybrid 50/100 acceleration so the grant reads as real money on an exit. Patron pre-drafts refresh authority into the Gurugram scheme so a founder can counter a poaching threat the same week."
          }
        },
        {
          "@type": "Question",
          "name": "What pool size suits an early-stage Sohna Road startup?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "The Sohna Road and Golf Course Extension belt is where Gurugram's earlier-stage and more cost-conscious startups cluster. A Pre-Seed or bootstrap team there typically carves out a 5 to 8 percent pool before the first angel cheque, expanding to 10 to 12 percent at Seed - the pool should be set pre-money so dilution lands on founders rather than incoming investors. Founder ESOPs under the DPIIT Rule 12 ten-year exemption should be planned from day one. Patron sizes the Sohna Road startup's pool to its 18 to 24 month hiring roadmap so it scales to Golf Course Road Series A scrutiny without a re-draft."
          }
        },
        {
          "@type": "Question",
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "The template for designing a tech startup ESOP is as follows: a 10 to 15 percent pool (depending on stage), 4-year vesting with a 1-year cliff under Rule 12(6)(a), role-based grants (founder backfill 0.5-2 percent, CTO 0.5-1.5 percent, senior engineer 0.15-0.3 percent, mid-IC 0.05-0.15 percent), refresh grant authority drafted into the scheme for top performers at 24-36 month tenure, and hybrid 50/100 acceleration on acquisition. DPIIT recognition is required to access the Rule 12 10-year exemption, under which founders and 10 percent-plus directors can be granted ESOPs. Section 80-IAC provides a 48-month tax deferral (60 months under the Income Tax Act 2025 from 1 April 2026). Where there is a foreign parent, mirror grants and LRS limits apply under the FEMA OI Rules 2022. MGT-14 must be filed within 30 days under Section 117(2). Patron delivers the full scheme design within 4 to 6 weeks. Call +91 945 945 6700."
          }
        }
      ]
    }
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-4 private-registration-heading">
                        ESOP for Tech Startups in Gurugram
                    </h1>

                    <p class="mb-4" style="color: var(--text-secondary); font-size: 16px; line-height: 1.6;">Built for Cyber City, Udyog Vihar and Golf Course Road enterprise-SaaS teams - unicorn-grade pools, refresh-grant authority against constant poaching, and cross-border mirror grants, all filed via RoC Delhi for Haryana companies.</p>
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                <div class="highlight-box" style="margin-bottom:20px;">
                    ...
                    <p>For a Gurugram founder hiring against the Cyber City and Udyog Vihar unicorn cohort, the ESOP is the one lever cash cannot replace - it has to size the pool right (10 to 20 percent across stages from Seed to Series C-plus), set role-based grants (0.5 to 2 percent for early engineers, 0.3 to 1.5 percent for VPs and C-Level, 0.05 to 0.3 percent for mid-IC), run 4-year vesting with a 1-year cliff under Rule 12(6)(a), pre-draft refresh-grant authority at 24-36 month tenure (25 to 50 percent of the original) to counter poaching, and lock acceleration on acquisition (single, double or hybrid 50/100). Patron designs Gurugram schemes that survive Series A diligence, scale to Series C, and file correctly via RoC Delhi for Haryana companies.</p>
                </div>
                <p>Gurugram tech startups design ESOPs in the most concentrated SaaS-and-ITES market in north India. Cyber City and Udyog Vihar pack funded product startups, global capability centres and IT-services majors onto the same few square kilometres, so a Gurugram founder's engineers are being pinged by recruiters from a dozen well-capitalised neighbours at once - cash alone cannot hold them. Equity is the lever, and it has to be designed to survive both aggressive poaching and the diligence of the many VC funds active across the NCR. The scheme must work for the 4th engineer at Seed stage and for the VP Engineering hire after Series B - on the same Board-approved document. Tech startup ESOP design optimises for four pressures at once: retaining engineering and product talent who could earn far more at the GCCs and SaaS rivals nearby, attracting senior CXO hires whose offers are heavily equity-weighted, managing founder dilution across funding rounds, and satisfying increasingly sophisticated investor diligence at each stage.</p>
        ...
        <div class="two-column">
            <div class="column-content">
                ...
                <div class="content-text what-is-definition">
                    ...
                    <p>Gurugram packs more enterprise-SaaS and ITES talent per square kilometre than anywhere in the NCR, and the unicorns built here - the Zomato, Delhivery and Policybazaar lineage - set the equity benchmark every younger Cyber City team is measured against. For those founders an ESOP for tech startups is a Section 62(1)(b) Companies Act 2013 scheme, run under Rule 12 of the Companies (Share Capital and Debentures) Rules 2014, engineered for four simultaneous pressures: retaining engineers and product leaders the unicorns keep poaching, funding equity-weighted CXO offers, holding founder dilution in check across rounds, and clearing the pool top-up each investor expects.</p>
                    <p>Five things separate a genuine tech scheme from a template, and a Cyber City or Udyog Vihar SaaS team needs all five. Front-loaded, stage-driven pool sizing - Pre-Seed 5-8 percent, Seed 10-12 percent, Series A 12-15 percent, Series B 15-18 percent, Series C-plus 15-20 percent of fully diluted equity. Seven role bands of grants, from junior IC at 0.01-0.05 percent to founder backfill at 0.5-2 percent. Refresh grants at 24-36 month tenure (25-50 percent of the original) to hold top performers against the unicorn pull. Acceleration - single, double or hybrid 50/100 - drafted up front, not fought over at M&amp;A. And founder grants unlocked via the Rule 12 DPIIT 10-year founder exemption that otherwise shuts out promoters and 10 percent-plus directors.</p>
                    <p>Enterprise-SaaS in Gurugram sells globally, and many teams sit as the Indian subsidiary of a US, Singapore or UK parent. Three structures fit: a Mirror Grant on the parent's stock under the FEMA Overseas Investment Rules 2022 (OPI at or below 10 percent of parent equity, ODI above), a Local Indian-Entity ESOP via a Section 62(1)(b) scheme (rare for wholly-owned subsidiaries), and a cash-settled SAR (Stock Appreciation Right) under Ind AS 102 group SBP rules.</p>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>Gurugram's enterprise-SaaS and ITES density - Cyber City, Udyog Vihar, Golf Course Road and Sohna Road - means almost every scaling team is fighting the local unicorns for the same engineers and product leads, with equity as the lever. Any startup whose talent costs are driven by competitive engineer pay, equity-weighted CXO offers and multi-round pool top-ups needs purpose-built design; a generic non-tech scheme just yields retention friction, side-letter conflicts and Series A pushback.</p>
                <ul>
...
<section class="content-section" id="services-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>Gurugram's enterprise-SaaS teams in Cyber City and Udyog Vihar usually need two things at once - aggressive pool sizing to match the local unicorn benchmark, and cross-border mirror grants for their US or Singapore parents. The tiers below address both on a single Board-approved scheme.</p>
...
<section class="steps-section" id="procedure-section">
    <div class="section-container">
        <div class="section-header" style="text-align:center;margin-bottom:48px;">
            ...
            <p class="section-subtitle" style="text-align:left;max-width:100%;">For Gurugram teams the 4-6 week workflow - discovery, cap-table review, DPIIT pathway, pool-sizing workshop with 3 dilution scenarios benchmarked against the local unicorn cohort, scheme drafting with refresh-grant authority and hybrid acceleration, Board and EGM cycle (filed via RoC Delhi for Haryana companies), IBBI valuation under Rule 11UA, term-sheet library and first grant batch with SH-6 setup - typically carries a heavier cross-border mirror-grant workstream for US and Singapore parents.</p>
        </div>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>Every Gurugram engagement hands the founder a complete kit - design artifacts, statutory filings (lodged via RoC Delhi for Haryana-registered companies), and operational documentation - with the cross-border mirror-grant pack weighted for the enterprise-SaaS teams that dominate Cyber City.</p>
                ...
                <ul>
                    ...
                    <li>Built on the <a href="/esop-scheme-design/gurugram">ESOP Scheme Design</a> engagement template.</li>
                </ul>
...
<section class="content-section" id="challenges-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>In Gurugram the errors below bite hardest when an enterprise-SaaS team is competing with the local unicorns - an under-sized pool that cannot fund the next VP Engineering hire, or no refresh-grant authority when a Cyber City rival is offering fresh equity at Year 3.</p>
                <div class="table-responsive-wrapper">
                <table>
                    ...
                    <tbody>
                        ...
                        <tr><td><strong>MGT-14 default under Section 117(2)</strong></td><td>Rs 100 per day after 30 days under Section 117(2) of Companies Act 2013 for delay in filing special resolutions (scheme adoption, pool top-up). Compounding can exceed Rs 50,000 for a 6-month delay.</td><td>Patron filing calendar tracks every special resolution against the 30-day MGT-14 deadline. Automated reminder 7 days before deadline. End-to-end through <a href="/esop-corporate-filings/gurugram">ESOP Corporate Filings</a> retainer.</td></tr>
...
<section class="why-choose-section" id="benefits-section">
    ...
    <article class="feature-card"><h3>Gurugram Presence Plus Pan-India</h3><p>Offices in Pune, Mumbai, Delhi and Gurugram, with direct support for Cyber City, Udyog Vihar and Golf Course Road teams (filed via RoC Delhi). Cross-border desk built for enterprise-SaaS parents abroad.</p></article>
</div>
    </div>
</section>
...
<section class="content-section" id="comparison-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>With Gurugram's frequent enterprise-SaaS M&amp;A and unicorn secondary activity, acceleration terms carry real deal weight. The table compares single, double and hybrid 50/100 so a Cyber City scheme is future-proofed before an acquirer ever calls.</p>
                <div class="table-responsive-wrapper">
                <table>
                    <thead>
                        <tr>
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <ul>
                    ...
                    <li><strong><a href="/esop-for-saas-companies/gurugram">ESOP for SaaS Companies</a></strong> - sibling vertical-specific page for B2B SaaS with ARR-linked vesting, sales quota acceleration, CSM NRR linkage and Delaware flip mirror grant structures.</li>
                    <li><strong><a href="/esop-scheme-design/gurugram">ESOP Scheme Design</a></strong> - generic first-time scheme drafting with sample term sheet; baseline template that tech-vertical design builds on.</li>
                    <li><strong><a href="/esop-valuation-services/gurugram">ESOP Valuation Services</a></strong> - Rule 11UA FMV reports including DCF, NAV and CCA methodologies for grant and exercise events.</li>
                    <li><strong><a href="/esop-accounting-ind-as-102/gurugram">ESOP Accounting under Ind AS 102</a></strong> - share-based payment expense recognition over vesting period; group SBP rules for cross-border mirror grants.</li>
                    <li><strong><a href="/esop-corporate-filings/gurugram">ESOP Corporate Filings</a></strong> - ongoing MCA filings retainer covering MGT-14, PAS-3 and MGT-7 for tech startups with active grant cycles.</li>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>Gurugram (Haryana) companies file the corporate actions below with the Registrar of Companies, Delhi, while the FEMA and Ind AS 102 group-SBP provisions matter most to the city's cross-border enterprise-SaaS teams.</p>
                <ul>
...
<section class="content-section" id="local-market-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">ESOP Design for the Gurugram Startup Ecosystem</h2>
            <div class="content-text">
                <p>Gurugram's startup geography runs along three corridors, each with its own ESOP centre of gravity. <strong>Cyber City and Udyog Vihar</strong> form the dense SaaS-and-ITES core, where funded product startups sit beside global capability centres and IT-services majors - here refresh grants and double-trigger acceleration are non-negotiable because poaching is constant and well-funded. The <strong>Golf Course Road</strong> cluster, the premium office-and-VC belt, concentrates growth-stage and Series A-plus startups whose investors push for a clean 12 to 15 percent post-money pool and hard leaver provisions. The <strong>Sohna Road and Golf Course Extension</strong> tech corridor is the more budget-friendly belt where early-stage and Seed startups carve out their first 5 to 12 percent pool and plan <a href="/esop-for-founders-and-promoters/gurugram">founder ESOPs under the DPIIT Rule 12 ten-year exemption</a> from day one.</p>
                <p>A filing point that surprises many Gurugram founders: although the company sits in Haryana, it files its ESOP special resolutions and MGT-14 with the <strong>Registrar of Companies, NCT of Delhi and Haryana</strong>, at IFCI Tower, Nehru Place, New Delhi, because that single RoC has jurisdiction over both Delhi and Haryana. PAS-3 on allotment after exercise goes to the same office. Everything else - the Section 62(1)(b) scheme adoption, the <a href="/esop-valuation-services/gurugram">IBBI Registered Valuer FMV under Rule 11UA</a>, the <a href="/esop-startup-tds-deferral-section-192-1c/gurugram">Section 80-IAC perquisite deferral</a> and DPIIT recognition - is pan-India. Patron has structured ESOPs for Gurugram SaaS, fintech and ITES founders since 2009 and files Haryana companies correctly at the Delhi RoC without the back-and-forth that trips up firms unfamiliar with the jurisdiction.</p>
                <div class="highlight-box">
                    <p><strong>Gurugram local context:</strong> Cyber City is arguably the toughest retention environment in the NCR - a senior engineer can change employers without changing their commute. The schemes that hold up here pre-draft refresh grant authority (25 to 50 percent of the original grant at 24 to 36 months) and hybrid 50/100 acceleration, so a Gurugram founder can respond to a poaching threat the same week rather than waiting on a fresh EGM.</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="faq-expanded">
                ...
                <div class="faq-expanded__list">
                    <div class="faq-expanded__item" id="faq-1">
                        <h3 class="faq-expanded__q">What is the typical ESOP pool size for tech startups in Gurugram?</h3>
                    ...
                    <div class="faq-expanded__item" id="faq-5">
                        <h3 class="faq-expanded__q">Where does a Gurugram startup file its ESOP resolutions?</h3>
                        <div class="faq-expanded__a"><p>Although Gurugram is in Haryana, its companies file ESOP scheme special resolutions and pool top-ups on form MGT-14 within 30 days under Section 117(2) of the Companies Act 2013 with the Registrar of Companies, NCT of Delhi and Haryana, at IFCI Tower, 61 Nehru Place, New Delhi - that single RoC has jurisdiction over both Delhi and Haryana. PAS-3 on allotment after exercise is filed at the same office under Section 39(4). Whether your registered office is in Cyber City, Golf Course Road or on Sohna Road, the filing destination is the Delhi RoC, not a separate Haryana office.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-6">
                        <h3 class="faq-expanded__q">How do Cyber City startups retain engineers against constant poaching?</h3>
                        <div class="faq-expanded__a"><p>Cyber City and Udyog Vihar are the densest poaching environment in the NCR - a senior engineer can switch to a funded rival or a global capability centre without changing their commute. Cash cannot win that fight, so the ESOP has to. The two moves that hold are refresh grants at 24 to 36 months (25 to 50 percent of the original grant) to reset the incentive before full vesting, and hybrid 50/100 acceleration so the grant reads as real money on an exit. Patron pre-drafts refresh authority into the Gurugram scheme so a founder can counter a poaching threat the same week.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-7">
                        <h3 class="faq-expanded__q">What pool size suits an early-stage Sohna Road startup?</h3>
                        <div class="faq-expanded__a"><p>The Sohna Road and Golf Course Extension belt is where Gurugram's earlier-stage and more cost-conscious startups cluster. A Pre-Seed or bootstrap team there typically carves out a 5 to 8 percent pool before the first angel cheque, expanding to 10 to 12 percent at Seed - the pool should be set pre-money so dilution lands on founders rather than incoming investors. Founder ESOPs under the DPIIT Rule 12 ten-year exemption should be planned from day one. Patron sizes the Sohna Road startup's pool to its 18 to 24 month hiring roadmap so it scales to Golf Course Road Series A scrutiny without a re-draft.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-8">
                        <h3 class="faq-expanded__q">How do you design an ESOP for a tech startup?</h3>
                        <div class="faq-expanded__a"><p>The template for designing a tech startup ESOP is as follows: a 10 to 15 percent pool (depending on stage), 4-year vesting with a 1-year cliff under Rule 12(6)(a), role-based grants (founder backfill 0.5-2 percent, CTO 0.5-1.5 percent, senior engineer 0.15-0.3 percent, mid-IC 0.05-0.15 percent), refresh grant authority drafted into the scheme for top performers at 24-36 month tenure, and hybrid 50/100 acceleration on acquisition. DPIIT recognition is required to access the Rule 12 10-year exemption, under which founders and 10 percent-plus directors can be granted ESOPs. Section 80-IAC provides a 48-month tax deferral (60 months under the Income Tax Act 2025 from 1 April 2026). Where there is a foreign parent, mirror grants and LRS limits apply under the FEMA OI Rules 2022. MGT-14 must be filed within 30 days under Section 117(2). Patron delivers the full scheme design within 4 to 6 weeks. Call <a href="tel:+919459456700" style="color:inherit;">+91 945 945 6700</a>.</p></div>
                    </div>
                </div>
            </div>
