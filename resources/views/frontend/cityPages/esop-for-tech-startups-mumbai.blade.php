        ...
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <ul>
                    ...
                    <li><strong><a href="/esop-accounting-ind-as-102/mumbai">ESOP Accounting under Ind AS 102</a></strong> - share-based payment expense recognition over vesting period; group SBP rules for cross-border mirror grants.</li>
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    ...
                    @include('partials.faq-enquiry-form', ['enquiryLocation' => 'Mumbai', 'enquiryService' => 'ESOP For Tech Startups in Mumbai'])
                </aside>
