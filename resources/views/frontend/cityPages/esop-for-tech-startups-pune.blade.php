...
@section('meta')
    <title>Pune ESOP Scheme Design & Vesting for SaaS Startups</title>
    <meta name="description" content="Structure a compliant ESOP for your Hinjewadi or Kharadi SaaS startup with stage-wise pools, vesting and acceleration, RoC Pune-ready, from INR 24,999.">
    <meta name="keywords" content="ESOP for Tech Startups Pune, ESOP for Tech Startups in Pune, ESOP for Tech Startups services in Pune, ESOP services Pune, ESOP for Tech Startups cost Pune, ESOP for Tech Startups consultants Pune, CA firm for ESOP for Tech Startups Pune, ESOP advisory Pune">
    <link rel="canonical" href="/esop-for-tech-startups/pune">
    <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1">
    <meta property="og:title" content="Pune ESOP Scheme Design & Vesting for SaaS Startups | Patron Accounting">
    <meta property="og:description" content="Structure a compliant ESOP for your Hinjewadi or Kharadi SaaS startup with stage-wise pools, vesting and acceleration, RoC Pune-ready, from INR 24,999.">
...
@section('schema')    <script type="application/ld+json">{
  ...
  "@graph": [
    {
      "@type": "Service",
      "@id": "https://www.patronaccounting.com/esop-for-tech-startups/pune#service",
      "name": "ESOP for Tech Startups",
      "url": "https://www.patronaccounting.com/esop-for-tech-startups/pune",
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://www.patronaccounting.com/esop-for-tech-startups/pune#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
        ...
        },
        {
          ...
          "position": 4,
          "name": "ESOP for Tech Startups",
          "item": "https://www.patronaccounting.com/esop-for-tech-startups/pune"
        }
      ]
    },
    {
      ...
      "@id": "https://www.patronaccounting.com/esop-for-tech-startups/pune#localbusiness",
      "name": "Patron Accounting LLP - ESOP For Tech Startups, Pune",
      "url": "https://www.patronaccounting.com/esop-for-tech-startups/pune",
    ...
    {
      "@type": "FAQPage",
      "@id": "https://www.patronaccounting.com/esop-for-tech-startups/pune#faq",
      "datePublished": "2026-06-24T08:00:00+05:30",
      "dateModified": "2026-06-24T08:00:00+05:30",
      "mainEntity": [
        {
          "@type": "Question",
          "name": "What is the typical ESOP pool size for tech startups in Pune?",
          "acceptedAnswer": {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          "name": "Where does a Pune startup file its ESOP resolutions?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "A startup with its registered office in Pune (Hinjewadi, Kharadi, Magarpatta, Baner or anywhere in the city) files its ESOP scheme special resolution and pool top-ups on form MGT-14 within 30 days under Section 117(2) of the Companies Act 2013 with the Registrar of Companies, Pune, which has jurisdiction over most of Maharashtra outside the Mumbai belt. After employees exercise, PAS-3 is filed within 30 days of allotment under Section 39(4). The IBBI Registered Valuer FMV under Rule 11UA and DPIIT recognition are pan-India and not Pune-specific."
          }
        },
        {
          "@type": "Question",
          "name": "How do Pune startups retain engineers against the Hinjewadi GCCs?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "The captive GCCs of multinationals in Hinjewadi and Magarpatta can outbid a Pune Seed-stage startup on cash by 50 to 100 percent, so equity is the retention lever. The two design moves that matter are double-trigger acceleration (so the grant is not seen as a free option that vanishes on acquisition) and refresh grants at 24 to 36 months, sized at 25 to 50 percent of the original grant, to reset the incentive before a senior engineer hits full vesting and gets poached. Patron pre-drafts refresh grant authority into the Pune scheme so no fresh EGM is needed at the moment a key engineer is at flight risk."
          }
        },
        {
          "@type": "Question",
          "name": "Should a Pune startup benchmark ESOP grants against Bengaluru?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Grant percentages are benchmarked nationally, not by city - the role-band ranges (founder backfill 0.5 to 2 percent, CTO 0.5 to 1.5 percent, senior engineer 0.15 to 0.3 percent) hold whether you are in Pune or Bengaluru. What differs is the cash-versus-equity trade-off: because Pune base salaries for senior engineers run slightly below the Bengaluru band while the GCC competition is just as fierce, Pune founders often lean on the upper end of each equity band to close offers. Patron sizes the Pune pool and per-role grants against current Indian tech round data and the candidate's outside option, not a US template."
          }
        },
        {
          "@type": "Question",
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "The template for designing a tech startup ESOP is as follows: a 10 to 15 percent pool (depending on the stage), 4-year vesting with a 1-year cliff under Rule 12(6)(a), role-based grants (founder backfill 0.5-2 percent, CTO 0.5-1.5 percent, senior engineer 0.15-0.3 percent, mid-IC 0.05-0.15 percent), refresh grant authority that must be drafted into the scheme for top performers at 24-36 months tenure, and hybrid 50/100 acceleration on acquisition. DPIIT recognition is required for the Rule 12 10-year exemption, under which founders and 10 percent-plus directors can be granted ESOPs. Section 80-IAC provides a 48-month tax deferral (60 months under the Income Tax Act 2025 from 1 April 2026). Where there is a foreign parent, mirror grants and LRS limits apply under FEMA OI Rules 2022. MGT-14 must be filed within 30 days under Section 117(2). Patron completes the full scheme design in 4 to 6 weeks. Call +91 945 945 6700."
          }
        }
      ]
    }
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-4 private-registration-heading">
                        ESOP for Tech Startups in Pune
                    </h1>

                    <p class="mb-4" style="color: var(--text-secondary); font-size: 16px;">Built for Hinjewadi SaaS, Kharadi fintech and Baner-Balewadi product teams that lose engineers to the GCCs next door &mdash; scheme drafted, resolutions filed on MGT-14 with RoC Pune.</p>
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="https://wa.me/919459456700?text=Hello%2C%20I%20just%20visited%20your%20ESOP%20for%20Tech%20Startups%20in%20Pune%20page.%20I%20would%20like%20to%20know%20more%20about%20it." target="_blank" class="btn-sample text-decoration-none" rel="noopener">
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                <div class="highlight-box" style="margin-bottom:20px;">
                    <p><strong>&#128204; TL;DR - Tech Startup ESOP in Pune at a Glance</strong></p>
                    <p>A Pune product startup &mdash; whether it sits in Hinjewadi's Rajiv Gandhi Infotech Park, the EON IT Park belt in Kharadi or the Baner-Balewadi corridor &mdash; runs an ESOP under Section 62(1)(b) read with Rule 12, and lodges its scheme special resolution on MGT-14 with the Registrar of Companies, Pune. The numbers that matter locally: a 10-12 percent Seed pool stretching to 12-15 percent at Series A, role grants from 0.01-0.05 percent (junior IC) up to 0.5-2 percent (founder backfill), a 4-year/1-year cliff vest under Rule 12(6)(a), refresh grants at the 24-36 month mark to hold engineers against the Magarpatta GCCs, and hybrid 50/100 acceleration that does not get re-opened at the Series A table. Founders unlock their own grants through the DPIIT 10-year exemption.</p>
                </div>
                <p>Why is the ESOP harder to get right in Pune than the textbook suggests? Because a Seed-stage founder in Viman Nagar is hiring the same backend engineer that a captive GCC in Hinjewadi or Magarpatta is courting with 50 to 100 percent more cash &mdash; and equity is the only line on the offer where a startup can actually win. The scheme therefore has to do two jobs on one Board-approved document: land the fourth engineer today, and still hold the VP Engineering hire who arrives two rounds later on an equity-weighted package. That is a different design problem from a services firm or a Chakan/MIDC manufacturer handing out flat sweat-equity, and it is why a generic policy with "tech" pasted on the cover keeps failing diligence.</p>
                <p>Three mechanics separate a real tech scheme from a template, and Pune founders hit all three. Refresh grants at 24-36 months reset the retention clock before a senior engineer at a Kharadi SaaS team walks at Year 3. Performance vesting ties CXO grants to ARR, a product launch or a profitability milestone rather than the calendar alone. And acceleration is written for an actual tech M&amp;A exit, not improvised when the term sheet lands. Patron Accounting LLP has drafted these schemes for SaaS, fintech, AI/ML, marketplace, deeptech and DevTools companies since 2009; with a Pune office plus Mumbai, Delhi and Gurugram, the CA-CS-tax team models the dilution, drafts the scheme, runs the EGM, files MGT-14 with RoC Pune, commissions the Rule 11UA FMV from an IBBI Registered Valuer, and lines up DPIIT recognition where it unlocks the founder grant and the Section 80-IAC deferral.</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="two-column">
            <div class="column-content">
                ...
                <div class="content-text what-is-definition">
                    ...
                    <p>Take a concrete Pune case: a 14-person SaaS team in Hinjewadi Phase 1 about to make its first two senior offers, or a fintech in EON IT Park, Kharadi closing a Seed round. For either, "ESOP for tech startups" is a specific instrument &mdash; a Section 62(1)(b) Companies Act 2013 scheme read with Rule 12 of the Companies (Share Capital and Debentures) Rules 2014 &mdash; and the reason it cannot be a borrowed template is that it is asked to absorb four pressures simultaneously: keeping engineers who are being pinged weekly by the GCCs in the same park, funding CXO offers that are mostly equity, soaking up founder dilution at every close, and hitting the pool size the next investor will insist on.</p>
                    <p>Look closely and the tech scheme diverges from an off-the-shelf one in exactly five places. (1) The pool is front-loaded by stage &mdash; Pre-Seed 5-8 percent, Seed 10-12 percent, Series A 12-15 percent, Series B 15-18 percent, Series C-plus 15-20 percent of fully diluted equity. (2) Grants are benchmarked across 7 role bands, junior IC at 0.01-0.05 percent up to founder backfill at 0.5-2 percent. (3) Refresh grants at 24-36 months (25-50 percent of the original) stop a Baner-Balewadi deeptech team from bleeding its best engineers at Year 3. (4) Acceleration &mdash; single, double or hybrid 50/100 &mdash; is locked into the document before any acquisition conversation. (5) <a href="/esop-for-founders-and-promoters/pune">Founder grants</a> are switched on through the Rule 12 DPIIT 10-year exemption, which otherwise shuts out promoters and 10 percent-plus directors entirely.</p>
                    <p>Pune's long IT-services and global-capability heritage means a large share of these founders are running the Indian arm of a US, Singapore or UK parent &mdash; common across the Kharadi and Viman Nagar belt. For them the question is which of three structures fits: a Mirror Grant on the parent's stock under the FEMA Overseas Investment Rules 2022 (OPI at or below 10 percent of parent equity, ODI above it), a Local Indian-Entity ESOP via a fresh Section 62(1)(b) scheme (uncommon for wholly-owned subsidiaries), or a <a href="/esop-vs-sar/pune">cash-settled SAR (Stock Appreciation Right)</a> carried as a liability under Ind AS 102 group SBP rules.</p>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>The simplest test in Pune: if your hiring budget is set by what a Magarpatta or Hinjewadi GCC will pay the same candidate, and you are closing the gap with equity rather than cash, you need a tech-vertical scheme. That captures the SaaS product teams in Rajiv Gandhi Infotech Park, the fintech and AI/ML founders in the Kharadi-Viman Nagar startup belt, and the deeptech outfits in Baner-Balewadi &mdash; but typically not a Chakan/MIDC manufacturer or a services shop, where a flat sweat-equity policy will do. Run a generic scheme over a product-startup cap table and you simply manufacture retention friction, side-letter clashes and Series A pushback. The roles below are where Pune founders most often engage us:</p>
                <ul>
...
<section class="content-section" id="services-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>Two trigger moments bring Pune founders to us. The first is a Rajiv Gandhi Infotech Park SaaS team standing up its very first Seed pool before angel money lands. The second is a Kharadi or Baner-Balewadi company that has just been handed a Series A term sheet demanding a 12-15 percent post-money pool and has weeks, not months, to comply. The engagement tiers below are deliberately built on one Board-approved scheme so that whichever moment you start at, you scale up without re-drafting and re-filing mid-fundraise.</p>
...
<section class="steps-section" id="procedure-section">
    <div class="section-container">
        <div class="section-header" style="text-align:center;margin-bottom:48px;">
            ...
            <p class="section-subtitle" style="text-align:left;max-width:100%;">Here is how the 4-6 week run actually unfolds for, say, a Hinjewadi SaaS team. Week one is a cap-table walkthrough and a DPIIT eligibility check. Then a pool-sizing workshop with three dilution scenarios benchmarked against live Indian tech rounds rather than a US cap-table template. Next, the scheme is drafted with refresh-grant authority and hybrid acceleration written in. The Board-and-EGM cycle follows, with the special resolution lodged on MGT-14 at the Registrar of Companies, Pune. The IBBI Rule 11UA valuation, the role-band term-sheet library and the first grant batch with SH-6 setup close it out.</p>
        </div>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>What does a Pune founder actually walk away with? Three things: the design artefacts (pool model, scheme, term-sheet library), the statutory filings lodged and acknowledged at the Registrar of Companies, Pune, and the operational paperwork tuned to the tech vertical and to any US/Singapore/UK cross-border structure. A Magarpatta SaaS company and a Viman Nagar fintech receive the same kit; only the cross-border layer changes. The full deliverable set:</p>
                ...
                <ul>
                    ...
                    <li>Built on the <a href="/esop-scheme-design/pune">ESOP Scheme Design</a> engagement template.</li>
                </ul>
...
<section class="content-section" id="challenges-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>Two failure patterns dominate our Pune intake calls. One is the under-sized pool: a Hinjewadi SaaS founder carves out 6 percent for today's headcount, burns through it on three senior offers, and then eats the Series A top-up pre-money. The other is the founder grant issued before DPIIT recognition &mdash; common with Kharadi and Viman Nagar fintech promoters who hold well above 10 percent and find their own grants legally void. Both, and the rest below, are avoidable at the drafting stage.</p>
                <div class="table-responsive-wrapper">
                <table>
                    ...
                    <tbody>
                        ...
                        <tr><td><strong>MGT-14 default under Section 117(2)</strong></td><td>Rs 100 per day after 30 days under Section 117(2) of Companies Act 2013 for delay in filing special resolutions (scheme adoption, pool top-up). Compounding can exceed Rs 50,000 for a 6-month delay.</td><td>Patron filing calendar tracks every special resolution against the 30-day MGT-14 deadline. Automated reminder 7 days before deadline. End-to-end through <a href="/esop-corporate-filings/pune">ESOP Corporate Filings</a> retainer.</td></tr>
...
<section class="why-choose-section" id="benefits-section">
    ...
    <article class="feature-card"><h3>On-the-Ground in Pune Plus Pan-India</h3><p>Offices in Pune, Mumbai, Delhi and Gurugram, with hands-on coverage for Hinjewadi, Kharadi and Baner tech teams and RoC Pune filings. Same documentation quality whether you engage in person or remotely.</p></article>
</div>
    </div>
</section>
...
<section class="content-section" id="comparison-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>Of every clause in a Pune Seed scheme, acceleration is the one most likely to be re-opened at the Series A table. The pattern is predictable: a Baner-Balewadi or Hinjewadi founder takes the founder-friendly single-trigger default, and then institutional investors arrive and force a re-draft under deal pressure. The comparison below lays out single-trigger, double-trigger and hybrid 50/100 side by side so a Pune founder picks once and never re-negotiates it mid-acquisition.</p>
                <div class="table-responsive-wrapper">
                <table>
                    <thead>
                        <tr>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <ul>
                    <li><strong><a href="/esop-services/pune">ESOP Services Master Hub</a></strong> - end-to-end ESOP lifecycle services covering all verticals and engagement types.</li>
                    <li><strong><a href="/esop-for-saas-companies/pune">ESOP for SaaS Companies</a></strong> - sibling vertical-specific page for B2B SaaS with ARR-linked vesting, sales quota acceleration, CSM NRR linkage and Delaware flip mirror grant structures.</li>
                    <li><strong><a href="/esop-scheme-design/pune">ESOP Scheme Design</a></strong> - generic first-time scheme drafting with sample term sheet; baseline template that tech-vertical design builds on.</li>
                    <li><strong><a href="/esop-valuation-services/pune">ESOP Valuation Services</a></strong> - Rule 11UA FMV reports including DCF, NAV and CCA methodologies for grant and exercise events.</li>
                    ...
                    <li><strong><a href="/esop-corporate-filings/pune">ESOP Corporate Filings</a></strong> - ongoing MCA filings retainer covering MGT-14, PAS-3 and MGT-7 for tech startups with active grant cycles.</li>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>One distinction worth holding onto: the statutes themselves are national, but where you file is local. For a company registered in Pune, the corporate filings &mdash; MGT-14 for the scheme resolution, PAS-3 on allotment &mdash; route to the Registrar of Companies, Pune (jurisdiction over most of Maharashtra outside the Mumbai belt) and are lodged on the MCA21 portal. The DPIIT recognition, the Income Tax perquisite and deferral provisions, the Rule 11UA FMV and the FEMA cross-border rules are administered centrally and read the same whether your office is in Hinjewadi or anywhere else in India. The framework:</p>
                <ul>
...
<section class="content-section" id="local-market-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">ESOP Design for the Pune Startup Ecosystem</h2>
            <div class="content-text">
                <p>Pune runs three distinct startup geographies, and each puts a different stress on an ESOP scheme. The <strong>Hinjewadi Rajiv Gandhi Infotech Park and Magarpatta City</strong> belt is dense with SaaS and enterprise-product startups spun out of the surrounding IT services majors and MNC GCCs - here the design priority is refresh grants and double-trigger acceleration, because senior engineers are constantly poached by the captives next door. The <strong>Kharadi and Viman Nagar</strong> corridor (EON IT Park, World Trade Center) skews toward fintech and AI/ML seed startups where founder ESOPs under the DPIIT Rule 12 ten-year exemption and a clean 10 to 12 percent pool matter most. The <strong>Baner-Balewadi-Pashan</strong> tech corridor hosts early product and deeptech teams that need the initial 5 to 8 percent pre-Seed pool carved out before the first angel cheque dilutes the cap table.</p>
                <p>Pune companies file their ESOP special resolutions and MGT-14 with the <strong>Registrar of Companies, Pune</strong> (the RoC having jurisdiction over companies registered in most of Maharashtra outside the Mumbai belt), with PAS-3 on allotment after exercise. Whether your registered office sits in a Hinjewadi co-working space or a Kharadi tech park, the Section 62(1)(b) scheme adoption, the IBBI Registered Valuer FMV under Rule 11UA, and the Section 80-IAC perquisite deferral run identically - what changes is the pool math and the acceleration posture your investors expect. Patron has structured ESOPs for Pune SaaS, fintech and deeptech founders since 2009 and benchmarks every Pune grant against current Indian tech round data, not US cap-table templates.</p>
                <div class="highlight-box">
                    <p><strong>Pune local context:</strong> A typical Pune Series A SaaS startup in Hinjewadi or Kharadi is asked by investors for a 12 to 15 percent post-money pool. Founders who waited until the term sheet to draft the scheme dilute themselves more than founders who carved the pool pre-money. Patron drafts the scheme to expand within an investor-pre-approved pool size so each Pune funding round does not trigger a fresh founder-only dilution event.</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="faq-expanded">
                ...
                <div class="faq-expanded__list">
                    <div class="faq-expanded__item" id="faq-1">
                        <h3 class="faq-expanded__q">What is the typical ESOP pool size for tech startups in Pune?</h3>
                    ...
                    <div class="faq-expanded__item" id="faq-5">
                        <h3 class="faq-expanded__q">Where does a Pune startup file its ESOP resolutions?</h3>
                        <div class="faq-expanded__a"><p>A startup with its registered office in Pune (Hinjewadi, Kharadi, Magarpatta, Baner or anywhere in the city) files its ESOP scheme special resolution and pool top-ups on form MGT-14 within 30 days under Section 117(2) of the Companies Act 2013 with the Registrar of Companies, Pune, which has jurisdiction over most of Maharashtra outside the Mumbai belt. After employees exercise, PAS-3 is filed within 30 days of allotment under Section 39(4). The IBBI Registered Valuer FMV under Rule 11UA and DPIIT recognition are pan-India and not Pune-specific.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-6">
                        <h3 class="faq-expanded__q">How do Pune startups retain engineers against the Hinjewadi GCCs?</h3>
                        <div class="faq-expanded__a"><p>The captive GCCs of multinationals in Hinjewadi and Magarpatta can outbid a Pune Seed-stage startup on cash by 50 to 100 percent, so equity is the retention lever. The two design moves that matter are double-trigger acceleration (so the grant is not seen as a free option that vanishes on acquisition) and refresh grants at 24 to 36 months, sized at 25 to 50 percent of the original grant, to reset the incentive before a senior engineer hits full vesting and gets poached. Patron pre-drafts refresh grant authority into the Pune scheme so no fresh EGM is needed at the moment a key engineer is at flight risk.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-7">
                        <h3 class="faq-expanded__q">Should a Pune startup benchmark ESOP grants against Bengaluru?</h3>
                        <div class="faq-expanded__a"><p>Grant percentages are benchmarked nationally, not by city - the role-band ranges (founder backfill 0.5 to 2 percent, CTO 0.5 to 1.5 percent, senior engineer 0.15 to 0.3 percent) hold whether you are in Pune or Bengaluru. What differs is the cash-versus-equity trade-off: because Pune base salaries for senior engineers run slightly below the Bengaluru band while the GCC competition is just as fierce, Pune founders often lean on the upper end of each equity band to close offers. Patron sizes the Pune pool and per-role grants against current Indian tech round data and the candidate's outside option, not a US template.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-8">
                        <h3 class="faq-expanded__q">How do you design an ESOP for a tech startup?</h3>
                        <div class="faq-expanded__a"><p>The template for designing a tech startup ESOP is as follows: a 10 to 15 percent pool (depending on the stage), 4-year vesting with a 1-year cliff under Rule 12(6)(a), role-based grants (founder backfill 0.5-2 percent, CTO 0.5-1.5 percent, senior engineer 0.15-0.3 percent, mid-IC 0.05-0.15 percent), refresh grant authority that must be drafted into the scheme for top performers at 24-36 months tenure, and hybrid 50/100 acceleration on acquisition. DPIIT recognition is required for the Rule 12 10-year exemption, under which founders and 10 percent-plus directors can be granted ESOPs. Section 80-IAC provides a 48-month tax deferral (60 months under the Income Tax Act 2025 from 1 April 2026). Where there is a foreign parent, mirror grants and LRS limits apply under FEMA OI Rules 2022. MGT-14 must be filed within 30 days under Section 117(2). Patron completes the full scheme design in 4 to 6 weeks. <a href="tel:+919459456700" style="color:inherit;">+91 945 945 6700</a>.</p></div>
                    </div>
                </div>
            </div>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text" style="text-align:left;">
                ...
                <p style="color:rgba(255,255,255,0.92);">Ready to design your tech startup ESOP scheme? <strong><a href="tel:+919459456700" style="color:inherit;text-decoration:underline;">Call us at +91 945 945 6700</a></strong> or <strong><a href="https://wa.me/919459456700?text=Hello%2C%20I%20just%20visited%20your%20ESOP%20for%20Tech%20Startups%20in%20Pune%20page.%20I%20would%20like%20to%20know%20more%20about%20it." target="_blank" rel="noopener" style="color:inherit;text-decoration:underline;">WhatsApp us</a></strong> for a free tech ESOP scoping call. Response within 2 hours. 4 to 6 week end-to-end design timeline.</p>

            </div>
            <div style="display:flex;gap:14px;flex-wrap:wrap;margin-top:24px;">
                <a href="tel:+919459456700" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:var(--orange);color:#fff;border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#128222; Call +91 945 945 6700</a>
                <a href="https://wa.me/919459456700?text=Hello%2C%20I%20just%20visited%20your%20ESOP%20for%20Tech%20Startups%20in%20Pune%20page.%20I%20would%20like%20to%20know%20more%20about%20it." target="_blank" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:#25D366;color:#fff;border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;" rel="noopener">&#128172; WhatsApp Us</a>
...
<section class="content-section" style="padding:48px 32px;background:var(--gray-50);">
    <div class="content-container"><div class="text-content">
        ...
        <div class="pa-city-grid"><span class="pa-city-card" aria-current="page" style="border-color:var(--orange);background:#FFF7F2;cursor:default;position:relative;"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Pune</div><div class="pa-card-sub">Maharashtra</div></div><span style="position:absolute;top:10px;right:12px;font-size:10px;font-weight:700;color:var(--orange);letter-spacing:.04em;">YOU'RE HERE</span></span><a href="/esop-for-tech-startups/mumbai" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Mumbai</div><div class="pa-card-sub">Maharashtra</div></div></a><a href="/esop-for-tech-startups/delhi" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Delhi</div><div class="pa-card-sub">Delhi NCR</div></div></a><a href="/esop-for-tech-startups/gurugram" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Gurugram</div><div class="pa-card-sub">Haryana</div></div></a></div>
    </div></div>
</section>
