...
@section('meta')
    <title>Pune ESOP Perquisite Reporting in Your ITR-2 Filing</title>
    <meta name="description" content="Hinjewadi and Kharadi techies: get your ESOP perquisite, capital gains and foreign shares filed correctly in ITR-2 or ITR-3 from INR 2,499 in Pune.">
    <meta name="keywords" content="ESOP Perquisite Reporting in ITR Pune, ESOP Perquisite Reporting in ITR in Pune, ESOP Perquisite Reporting in ITR services in Pune, ESOP services Pune, ESOP Perquisite Reporting in ITR cost Pune, ESOP Perquisite Reporting in ITR consultants Pune, CA firm for ESOP Perquisite Reporting in ITR Pune, ESOP advisory Pune">
    <link rel="canonical" href="/esop-perquisite-reporting-in-itr/pune">
    <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1">
    <meta property="og:title" content="Pune ESOP Perquisite Reporting in Your ITR-2 Filing | Patron Accounting">
    <meta property="og:description" content="Hinjewadi and Kharadi techies: get your ESOP perquisite, capital gains and foreign shares filed correctly in ITR-2 or ITR-3 from INR 2,499 in Pune.">
    <meta property="og:url" content="/esop-perquisite-reporting-in-itr/pune">
    <meta property="og:type" content="website">
    <meta property="og:site_name" content="Patron Accounting">
    <meta property="og:image" content="/images/esop-perquisite-reporting-in-itr-og.webp">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Pune ESOP Perquisite Reporting in Your ITR-2 Filing | Patron Accounting">
    <meta name="twitter:description" content="Hinjewadi and Kharadi techies: get your ESOP perquisite, capital gains and foreign shares filed correctly in ITR-2 or ITR-3 from INR 2,499 in Pune.">
...
@section('schema')    <script type="application/ld+json">{
  ...
  "@graph": [
    {
      "@type": "Service",
      "@id": "https://www.patronaccounting.com/esop-perquisite-reporting-in-itr/pune#service",
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://www.patronaccounting.com/esop-perquisite-reporting-in-itr/pune#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
        ...
        },
        {
          ...
          "item": "https://www.patronaccounting.com/esop-perquisite-reporting-in-itr/pune"
        }
      ]
    },
    {
      ...
      "@id": "https://www.patronaccounting.com/esop-perquisite-reporting-in-itr/pune#localbusiness",
      "name": "Patron Accounting LLP - ESOP Perquisite Reporting In Itr, Pune",
      "url": "https://www.patronaccounting.com/esop-perquisite-reporting-in-itr/pune",
    ...
    {
      "@type": "FAQPage",
      "@id": "https://www.patronaccounting.com/esop-perquisite-reporting-in-itr/pune#faq",
      ...
      "mainEntity": [
        ...
        {
          "@type": "Question",
          "name": "In which schedules of the ITR is an ESOP reported?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "The ESOP perquisite is reported in Schedule S, in line with Form 16. When the shares are sold, the capital gain is reported in Schedule CG and Schedule 112A, while foreign shares are disclosed in Schedule FA. Use ITR-2 or ITR-3, and never ITR-1."
          }
        },
        {
          "@type": "Question",
          "name": "Are unlisted Pune startup ESOPs reported differently from listed shares?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes. For an unlisted Hinjewadi or Kharadi startup, the perquisite still goes in Schedule S, but a sale is taxed as off-market capital gains in Schedule CG, not under Schedule 112A, which is only for listed STT-paid shares. The fair market value at exercise comes from a merchant-banker certificate, and the holding period from allotment decides short-term versus long-term."
          }
        },
        {
          "@type": "Question",
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-4 private-registration-heading">
                        ESOP Perquisite Reporting in ITR in Pune
                    </h1>

                    <p class="mb-4" style="color: var(--text-secondary); font-size: 16px; line-height: 1.6;">For Hinjewadi, Kharadi and Magarpatta employees juggling unlisted startup options and US-parent RSUs in a single return.</p>
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                <div class="highlight-box" style="margin-bottom:20px;">
                    <p><strong>&#128204; TL;DR - ESOP Perquisite Reporting in ITR for Pune Employees</strong></p>
                    <p>A Hinjewadi, Kharadi or Magarpatta employee with options or RSUs files on ITR-2 or ITR-3, never ITR-1: perquisite in Schedule S, sale in Schedule CG and 112A, foreign-parent shares in Schedule FA. We map every figure and file it.</p>
                </div>
                <p>Pune's equity-pay base looks different from most cities. In the same office floor at a Hinjewadi SaaS product company you will find an engineer holding unlisted Indian options, a manager sitting on Nasdaq-listed RSUs from a US parent, and a recent joiner whose startup is <a href="/esop-startup-tds-deferral-section-192-1c/pune">deferring the tax under Section 80-IAC</a>. Each of those three benefits travels to a different schedule, and that is exactly where a Pune return goes wrong.</p>
                <p>This service exists to keep those three streams from colliding. We read your Form 16 and Form 12BA, decide between ITR-2 and ITR-3 on your real income mix, and reconcile the perquisite and TDS to your AIS and Form 26AS before the return is submitted, so the portal does not throw a defective-return flag. Patron Accounting has handled ESOP-linked returns for salaried staff, founders, NRIs and MNC employees for over 15 years, much of it across Pune's IT and product clusters.</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="two-column">
            <div class="column-content">
                ...
                <div class="content-text what-is-definition">
                    ...
                    <p>Take a Kharadi (EON IT Park) employee who exercised options last year and also sold a tranche of vested shares. To the income-tax portal that is not one event but three lines of disclosure: the benefit at exercise sits under salary, the profit on sale sits under <a href="/esop-capital-gains-tax-on-sale/pune">capital gains</a>, and if the shares were issued by a foreign parent they also sit under foreign assets. ESOP reporting in ITR is simply the discipline of routing each line to its correct schedule.</p>
                    <p>What it is not is a second round of tax maths. The perquisite was already valued and taxed when you exercised, and it is already baked into your Form 16, so re-computing it only creates a mismatch. The actual work, the part Pune employees most often get wrong on their own, is form selection (ITR-2 versus ITR-3), placing each figure in the right schedule, and squaring it against the AIS, Form 26AS and Form 12BA before submission.</p>

                </div>
                <div class="highlight-box" style="margin-top:20px;">
                    <p><strong>Key Terms for ESOP Perquisite Reporting in ITR:</strong></p>
                    <ul>
                        <li><strong>Schedule S:</strong> the salary schedule that carries the ESOP perquisite, tied back to Form 16 Part B.</li>
                        <li><strong>Schedule 112A:</strong> scrip-by-scrip reporting of listed STT-paid long-term gains, used when vested shares are sold on an Indian exchange.</li>
                        <li><strong>Schedule FA:</strong> the foreign-asset schedule a Magarpatta employee with US-parent RSUs must complete, sold or not.</li>
                        <li><strong>Form 12BA:</strong> the employer's perquisite statement we cross-check the Schedule S figure against.</li>
                    </ul>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>If any equity benefit touched your year, this page is for you. In Pune that tends to mean one of four profiles, and each one is locked out of ITR-1:</p>
                <ul>
                    <li>A Hinjewadi (Rajiv Gandhi Infotech Park) product manager with vested options in an unlisted Indian startup, carried as a perquisite in Form 16.</li>
                    <li>A Magarpatta or Viman Nagar engineer holding Nasdaq-listed RSUs from a US parent, whether or not any have been sold.</li>
                    <li>A Baner-Balewadi employee who exercised and then sold, leaving a capital gain or a carry-forward loss.</li>
                    <li>An early joiner at a DPIIT-recognised, 80-IAC-eligible Kharadi startup whose ESOP tax is deferred and must still be disclosed.</li>
                </ul>
                <p>A Chakan or MIDC professional drawing consulting income alongside an ESOP perquisite is the classic ITR-3 case, since business or professional income rules out ITR-2 as well.</p>
                <p><strong>Statutory anchor:</strong> once you hold ESOPs, foreign assets, or capital gains beyond the narrow 112A carve-out, ITR-1 is barred. File it anyway and Section 139(9) treats the return as defective, and if you do not rectify it, as invalid.</p>
...
<section class="content-section" id="local-market-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">ESOP ITR Reporting for Pune Employees</h2>
            <div class="content-text">
                <p>Pune's equity-compensation base is concentrated in three clusters: the Hinjewadi (Rajiv Gandhi Infotech Park) and Magarpatta IT parks, the Kharadi and Viman Nagar startup hubs around EON and World Trade Center, and the Baner-Balewadi tech corridor. Employees here typically hold one of two ESOP types, an unlisted Indian-startup option <a href="/esop-valuation-services/pune">valued by a merchant-banker certificate</a>, or a foreign-parent RSU listed on a US exchange, and each routes to a different schedule.</p>
                <p>Companies incorporated in Pune file with the <strong>Registrar of Companies (RoC), Pune</strong>, under the Western Region of the MCA, while DPIIT recognition and the Section 80-IAC IMB certificate that unlocks tax deferral are granted centrally. For the ITR itself, jurisdiction follows your residence and PAN, not the employer's RoC, so a Baner resident files the same Schedule S, CG, 112A and FA mapping regardless of where the startup is registered.</p>
                <p><strong>Local benchmark:</strong> a common Pune profile is a Hinjewadi SaaS engineer who exercised unlisted options taxed as a perquisite in Form 16, then later received vested US-parent RSUs needing Schedule FA disclosure. We reconcile the perquisite to Form 12BA, file Form 67 for any Foreign Tax Credit, and keep the AIS clean before the 31 July due date.</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <table>
                    ...
                    <tbody>
                        <tr><td>Schedule Mapping</td><td>We split the Hinjewadi or Kharadi employee's perquisite, sale gains and foreign shares into the right schedules of ITR-2 or ITR-3.</td></tr>
                        <tr><td>Form Selection</td><td>We read your full income profile, including any MIDC consulting income, and lock in ITR-2 or ITR-3 so ITR-1 is never used by mistake.</td></tr>
                        <tr><td>AIS and Form 26AS Reconciliation</td><td>We tally the ESOP perquisite and TDS against your AIS, Form 26AS and Form 12BA before anything is filed.</td></tr>
                        <tr><td>Foreign Asset Disclosure</td><td>For US-parent RSUs common across Pune SaaS teams, we complete Schedule FA, FSI and TR and file Form 67 for Foreign Tax Credit.</td></tr>
                        <tr><td>Deferral Disclosure</td><td>We fill the Schedule Tax-Deferred on ESOP for eligible 80-IAC startup employees.</td></tr>
                        <tr><td>Notice Defence</td><td>We answer Section 139(9) defective-return and AIS-mismatch notices on ESOP income.</td></tr>
...
<section class="steps-section" id="procedure-section">
    <div class="section-container">
        <header class="section-header" style="text-align:center;margin-bottom:48px;">
            ...
            <p class="section-subtitle" style="text-align:left;max-width:100%;">The same six steps we run for a Hinjewadi options holder or a Magarpatta RSU holder: lock the form, place each figure in its schedule, disclose the foreign leg, then reconcile to AIS before e-verifying.</p>
        </header>
...
<div class="step-card">
    <div class="step-content">
        ...
        <p class="step-description">For US-parent RSUs common in Pune SaaS firms, complete Schedule FA, FSI and TR and file Form 67 for Foreign Tax Credit.</p>
        <div class="step-highlights">
...
<section class="content-section" id="documents-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>A pure Hinjewadi salary-plus-options case needs only the first four items below; add the foreign-broker and valuation papers once Magarpatta-style US-parent RSUs or an unlisted Kharadi sale enter the picture.</p>
                <ul>
                    <li>Form 16 Part B carrying the ESOP perquisite under salary.</li>
                    <li>Form 12BA showing the perquisite break-up your employer filed.</li>
                    <li>Broker contract notes and the capital gains statement, if vested shares were sold.</li>
                    <li>AIS and Form 26AS, which we reconcile against the figures above.</li>
                    <li>Foreign-broker statements and US tax slips for Schedule FA and Form 67 (typical for Pune SaaS staff with parent-company RSUs).</li>
                    <li>Exercise and allotment records, plus a merchant-banker valuation for unlisted Kharadi or Baner startup options, to fix the cost base and holding period.</li>
                </ul>
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <table>
                    ...
                    <tbody>
                        <tr><td>A Hinjewadi salaried employee files ITR-1 with an ESOP perquisite</td><td>Defective-return notice risk</td><td>We move you to ITR-2 or ITR-3 so a Section 139(9) defective-return notice never lands.</td></tr>
                        <tr><td>US-parent RSUs left out of Schedule FA</td><td>Black Money Act exposure</td><td>We disclose every foreign holding, the step Pune SaaS employees most often miss.</td></tr>
                        ...
                        <tr><td>Unlisted startup sale routed through the wrong schedule</td><td>Wrong tax or rejection</td><td>We send off-market Kharadi-startup gains through Schedule CG, and listed sales through 112A and SI, with the correct cost base.</td></tr>
...
<article class="feature-card">
            ...
            <p class="feature-text">The right form for a Hinjewadi or Baner employee, so no Section 139(9) defective-return notice.</p>
        </article>
<article class="feature-card">
...
<article class="feature-card">
            ...
            <p class="feature-text">US-parent RSUs from Pune SaaS groups disclosed in Schedule FA, avoiding Black Money Act risk.</p>
        </article>
<article class="feature-card">
...
<section class="content-section" id="comparison-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>A typical Pune SaaS employee touches three or four of these rows at once, an unlisted startup perquisite, a listed sale, and a US-parent RSU holding. The map below shows where each piece lands and which document proves it.</p>
                <div class="table-responsive-wrapper">
                <table>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>The rules are the same wherever you live, but for a Pune resident the ITR jurisdiction follows your PAN and home address, not the RoC Pune registration of the startup that granted the options.</p>
            ...
            <div class="faq-expanded">
                ...
                <div class="faq-expanded__list">
                    ...
                    <div class="faq-expanded__item" id="faq-3">
                        <h3 class="faq-expanded__q">In which schedules of the ITR is an ESOP reported?</h3>
                        <div class="faq-expanded__a"><p>The ESOP perquisite is reported in Schedule S, in line with Form 16. When the shares are sold, the capital gain is reported in Schedule CG and Schedule 112A, while foreign shares are disclosed in Schedule FA. Use ITR-2 or ITR-3, and never ITR-1.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-4">
                        <h3 class="faq-expanded__q">Are unlisted Pune startup ESOPs reported differently from listed shares?</h3>
                        <div class="faq-expanded__a"><p>Yes. For an unlisted Hinjewadi or Kharadi startup, the perquisite still goes in Schedule S, but a sale is taxed as off-market capital gains in Schedule CG, not under Schedule 112A, which is only for listed STT-paid shares. The fair market value at exercise comes from a merchant-banker certificate, and the holding period from allotment decides short-term versus long-term.</p></div>
                    </div>
                    ...
                    <div class="faq-expanded__item" id="faq-6">
                        <h3 class="faq-expanded__q">I work in Hinjewadi for a US-parent SaaS firm. Where do my RSUs go?</h3>
                        <div class="faq-expanded__a"><p>If you are a resident, the vesting value is salary in Schedule S, and the foreign shares must be disclosed in Schedule FA even before you sell. On sale, the gain is foreign capital gains in Schedule CG, with foreign income in Schedule FSI and Form 67 for any US tax credit under the India-US DTAA. Many Hinjewadi and Magarpatta employees miss the Schedule FA step and draw a Black Money Act query.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-7">
                        <h3 class="faq-expanded__q">What should I do if the AIS and Form 16 do not match?</h3>
                        <div class="faq-expanded__a"><p>First, reconcile the perquisite value in Schedule S against Form 12BA and Form 16, and then reconcile it with the AIS and Form 26AS. Where there is a mismatch, we file the correct figure and help you avoid a notice.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-8">
                        <h3 class="faq-expanded__q">My Kharadi startup is DPIIT-recognised. Can I defer the ESOP tax?</h3>
                        <div class="faq-expanded__a"><p>Only if the employer also holds a valid Section 80-IAC IMB certificate, not just DPIIT recognition, since both are required. Where it qualifies, the perquisite tax is deferred to the earliest of leaving the company, selling the shares, or the statutory window after allotment. You still disclose the perquisite and fill the Schedule Tax-Deferred on ESOP in ITR-2 or ITR-3 so the figures reconcile.</p></div>
                    </div>
                </div>
            </div>
