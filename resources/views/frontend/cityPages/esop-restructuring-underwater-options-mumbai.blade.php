...
@section('meta')
    <title>Mumbai ESOP Exchange Programs After a Down Round Hit</title>
    <meta name="description" content="Mumbai startups can swap underwater options for fresh grants with full SEBI and Section 62(1)(b) compliance, handled end to end from INR 24,999.">
    <meta name="keywords" content="ESOP Restructuring Underwater Options Mumbai, ESOP Restructuring Underwater Options in Mumbai, ESOP Restructuring Underwater Options services in Mumbai, ESOP services Mumbai, ESOP Restructuring Underwater Options cost Mumbai, ESOP Restructuring Underwater Options consultants Mumbai, CA firm for ESOP Restructuring Underwater Options Mumbai, ESOP advisory Mumbai">
    <link rel="canonical" href="/esop-restructuring-underwater-options/mumbai">
    <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1">
    <meta property="og:title" content="Mumbai ESOP Exchange Programs After a Down Round Hit | Patron Accounting">
    <meta property="og:description" content="Mumbai startups can swap underwater options for fresh grants with full SEBI and Section 62(1)(b) compliance, handled end to end from INR 24,999.">
...
@section('schema')    <script type="application/ld+json">{
  ...
  "@graph": [
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://www.patronaccounting.com/esop-restructuring-underwater-options/mumbai#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
        ...
        },
        {
          ...
          "position": 4,
          "name": "ESOP Restructuring and Underwater Options",
          "item": "https://www.patronaccounting.com/esop-restructuring-underwater-options/mumbai"
        }
      ]
    },
    {
      ...
      "@id": "https://www.patronaccounting.com/esop-restructuring-underwater-options/mumbai#localbusiness",
      "name": "Patron Accounting LLP - ESOP Restructuring Underwater Options, Mumbai",
      "url": "https://www.patronaccounting.com/esop-restructuring-underwater-options/mumbai",
    ...
    {
      "@type": "FAQPage",
      "@id": "https://www.patronaccounting.com/esop-restructuring-underwater-options/mumbai#faq",
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-4 private-registration-heading">
                        ESOP Restructuring and Underwater Options in Mumbai
                    </h1>
                    ...
                    <p class="mb-4 fw-bold" style="color: var(--blue); font-size: 15px;">Underwater ESOP fixes for BKC, Lower Parel and Powai companies | RoC Mumbai and SEBI SBEB | 10,000+ Businesses Served | 4.9 Google Rating | 15+ Years</p>
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="https://wa.me/919459456700?text=Hello%2C%20I%20just%20visited%20your%20ESOP%20Restructuring%20Underwater%20Options%20in%20Mumbai%20page.%20I%20would%20like%20to%20know%20more%20about%20it." target="_blank" class="btn-sample text-decoration-none" rel="noopener">
...
<section class="content-section" id="local-market-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Underwater ESOPs in the Mumbai and BKC Market</h2>
            <div class="content-text">
                <p>Mumbai's equity-compensation map runs across three clusters: the <strong>BKC and Lower Parel finance hubs</strong> (fintech, NBFCs, listed and pre-IPO issuers), the <strong>Andheri and Powai SaaS belt</strong> (product and B2B startups), and the <strong>Goregaon-Vikhroli startup corridor</strong> (consumer and growth-stage). Companies here file with the <strong>Registrar of Companies, Mumbai</strong>, and crucially, <strong>SEBI's headquarters sits in BKC</strong> - so listed-entity ESOP modifications land in the regulator's backyard. Any scheme modification routes its <strong>MGT-14</strong> through RoC Mumbai within 30 days of the Special Resolution under Section 117(2).</p>
                <p>The distinctive Mumbai pattern is the <strong>listed or DRHP-stage underwater scheme</strong>. Unlike an unlisted Pune or Gurugram startup, a BKC-listed company cannot simply pass a Special Resolution and reprice - it must run the <strong>SEBI (Share Based Employee Benefits and Sweat Equity) Regulations 2021 Regulation 18 variation procedure</strong>, satisfy the prohibition on <strong>detrimental variation</strong> to grantee economics, and notify the Stock Exchanges under Regulation 19. For a Lower Parel fintech whose listed-market multiple compressed post-2022, an exchange program or repricing has to be structured so it is not detrimental to any grantee class - a far higher bar than an unlisted reprice.</p>
                <p>Two practical notes for Mumbai issuers. First, pre-IPO companies in BKC and Powai preparing a DRHP should clean up accumulated underwater grants across multiple rounds <strong>before</strong> SEBI SBEB Regulations apply on listing - retrofitting a fragmented ESOP history during diligence is expensive. Second, the <strong><a href="/esop-valuation-services/mumbai">Rule 11UA FMV refresh</a></strong> at modification and the <strong>Ind AS 102 paragraphs 26-29</strong> incremental fair value computation must be audit-ready for the Big-Four auditors that most Mumbai listed and late-stage issuers use, since modification accounting is a frequent emphasis-of-matter trigger.</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="two-column">
            <div class="column-content">
                ...
                <div class="content-text what-is-definition">
                    ...
                    <p>"Underwater" is the cleanest word for a problem every CFO in BKC and Lower Parel recognises: the strike price written into the grant letter now sits above the share's current Fair Market Value. A BKC fintech that handed out options at a Rs 100 strike against a frothy 2021-2022 valuation, then re-priced lower at its next round, has handed its team a coupon that costs more to redeem than the thing it buys. Nobody exercises an out-of-the-money option, so it does nothing to keep talent. The danger in Mumbai's finance and fintech cohort is concentration - when public-market multiples compress, an entire grant vintage can go underwater in the same quarter, and the retention hit lands across the whole floor at once.</p>
                    <p>Restructuring is how you reset those economics, and because Mumbai is also SEBI's home ground - the regulator is headquartered at BKC - the listed-entity discipline matters more here than anywhere else. Patron runs one Board-approved corporate action and selects from five tools. <strong>Repricing</strong> lowers the strike on the existing options and keeps the original vesting. An <strong>Exchange Program</strong> cancels the old options and issues new ones at the lower FMV with a fresh 1-year cliff under Rule 12(6)(a), usually at a 0.8x to 1.0x ratio. <strong>Top-Up Grants</strong> add new options at today's FMV without touching the old ones. <strong>Vesting Acceleration</strong> brings time-based vesting forward. <strong>Cashout / Buyback</strong> retires the options at nominal value. Tax timing sits under Section 17(2)(vi), accounting under Ind AS 102 paragraphs 26-29, the corporate workflow under Section 62(1)(b) with Rule 12(2) - and for listed firms the SEBI SBEB Regulations 2021 Regulation 18 variation procedure governs the whole thing.</p>
                    <p><strong>Triggers we see most in Mumbai:</strong> public-market multiple compression flowing into private FMV via comparable-company analysis (the dominant trigger for a finance-heavy, listing-adjacent ecosystem); a down round where a Series B or later prices below the round the strike was set against; a flat round that runs long while the strike stays anchored to an earlier optimistic FMV; revenue or margin deterioration dragging a DCF valuation down; a secondary sale at a lower clearing price; or a scheme of arrangement that cuts per-share value.</p>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p><strong>How the rulebook lands for a Mumbai scheme:</strong> whether the company sits unlisted in Andheri or listed out of Lower Parel, a material modification needs a fresh Special Resolution at 75 percent majority under Rule 12(2) of Companies (Share Capital and Debentures) Rules 2014, with MGT-14 lodged at the Registrar of Companies, Mumbai within 30 days under Section 117(2) (default carries Rs 10,000 plus Rs 100 per day) and the modification narrative carried into the Directors Report under Rule 12(9). The Mumbai-specific layer is SEBI: a listed BKC or Lower Parel issuer must additionally clear the Regulation 18 variation procedure, avoid any detrimental variation to grantee economics, and notify the Stock Exchanges under Regulation 19. On the employee side the timing is the same everywhere - <a href="/esop-perquisite-tax-section-17-2-vi/mumbai">Section 17(2)(vi) perquisite</a> bites at exercise, never at modification or cancellation, so the corporate action itself is tax-neutral for the team; Section 49(2AA) then fixes the cost of acquisition for the eventual <a href="/esop-capital-gains-tax-on-sale/mumbai">capital-gains computation</a>, and the <a href="/esop-startup-tds-deferral-section-192-1c/mumbai">Section 80-IAC plus Section 192(2C) 48-month deferral</a> (60 months under Income Tax Act 2025 Section 392(3) read with 289(3) from 1 April 2026) survives the restructuring for DPIIT plus IMB certified startups. The accounting sits under Ind AS 102 paragraphs 26-29, read with the B42-B44 Application Guidance on incremental fair value - the area Mumbai's Big-Four statutory auditors probe hardest.</p>
...
<section class="content-section" id="services-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>Mumbai's option economics swung hard through the 2022-2025 correction. A BKC fintech that raised at a frothy Series B mark, and a Powai deep-tech team that priced its pool against a peak valuation, both ended up with grants sitting well above current Fair Market Value. The tiers below let you pick the exact remediation - from a standalone underwater diagnostic to a full listed-issuer variation - rather than buying a one-size package. Each tier is scoped on a call so the work matches your grant depth, vesting status and whether you sit unlisted in Andheri or listed out of Lower Parel.</p>
        ...
        <div class="steps-container">
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <p class="step-description">We pull the cap table and map current FMV against every grant batch, then compute the underwater value per grant (exercise price minus current FMV multiplied by outstanding options). Retention risk is scored by tenure band - in Mumbai, the senior fintech and finance hires sitting on deep underwater grants are the ones the next BKC employer is already calling. A peer benchmark and recommendation memo name the optimal tool for your situation.</p>
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <p class="step-description">Repricing closes with revised grant letters at the new exercise price and original vesting intact. An Exchange Program closes with signed employee consent, cancellation of the old options and fresh grants carrying a new Rule 12(6)(a) 1-year cliff. For a BKC or Lower Parel listed issuer there is one more gate - SEBI SBEB Regulation 18 documentation, the detrimental-variation prevention check, and Stock Exchange notification under Regulation 19 - which we file with SEBI a short walk from the issuer's own registered office.</p>
                    <div class="step-highlights">
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>A Mumbai restructuring leaves you with a file that has to satisfy three different audiences at once - the Registrar of Companies, Mumbai for the corporate filings, the Big-Four statutory auditor most BKC and Lower Parel issuers carry for the Ind AS 102 working papers, and SEBI for any listed-entity variation. The kit below is built so each of those gates is closed without a follow-up: analysis, statutory filings, accounting documentation, tax memos and the employee communication pack, all cross-referenced to the relevant statute.</p>
                ...
                <ul>
                    ...
                    <li>Peer benchmarking against similar-stage Mumbai startups post-down-round.</li>
                ...
                <ul>
                    <li>Coordinated valuation engagement through <a href="/esop-valuation-services/mumbai">ESOP Valuation Services</a> for new FMV determination at the modification date.</li>
                ...
                <ul>
                    ...
                    <li>MGT-14 filing within 30 days. Coordinated with <a href="/esop-corporate-filings/mumbai">ESOP Corporate Filings</a> workflow.</li>
                </ul>
...
<section class="why-choose-section" id="benefits-section">
    ...
    <article class="feature-card"><h3>SEBI SBEB 2021 Depth for BKC and Lower Parel Issuers</h3><p>With SEBI headquartered at BKC, listed Mumbai issuers get scrutinised on home turf. We run the Regulation 18 variation so it clears the detrimental-variation bar before it reaches employees, list the resulting shares under Regulation 19, and handle the Stock Exchange notification. Pre-IPO Mumbai companies use this to walk into a DRHP with a clean SEBI SBEB record.</p></article>
    <article class="feature-card"><h3>Five-Tool Remediation Matched to Mumbai Grant Realities</h3><p>Repricing, Exchange Program, Top-Up Grants, Vesting Acceleration and Cashout / Buyback - chosen via a quantified recommendation memo across six factors including underwater depth, vesting credit and pool capacity. A Powai deep-tech team protecting four years of vesting credit gets a different answer than a BKC fintech with a deep 50-percent gap.</p></article>
    <article class="feature-card"><h3>Ind AS 102 Modification Accounting, Audit-Ready</h3><p>Paragraphs 26-29 incremental fair value built on documented Black-Scholes inputs (volatility, risk-free rate, expected term, dividend yield) - paragraph 27 for Repricing, paragraph 28 for cancellation-and-replacement Exchange Programs. Built to survive a Big Four statutory review, which most BKC and Lower Parel finance-sector companies face.</p></article>
    <article class="feature-card"><h3>Section 17(2)(vi) and Section 49(2AA) Tax Timing</h3><p>A clean memo confirming no tax bites at modification or cancellation - the perquisite triggers only at exercise on the new lower exercise price, with Section 49(2AA) cost-of-acquisition locked for the eventual sale. Section 80-IAC deferral stays intact (48 months now; 60 months under Income Tax Act 2025 from 1 April 2026) for DPIIT plus IMB startups.</p></article>
    <article class="feature-card"><h3>Exchange Ratio Benchmarking, Not 1-for-1 Guesswork</h3><p>The 0.8x to 1.0x range is set against your actual underwater depth, vesting status and remaining term - so a 10,000-option surrender does not quietly burn the same pool as a fresh grant. Deeper gaps may justify 0.7x. Pool discipline matters in Mumbai where late-stage pools are already stretched.</p></article>
    <article class="feature-card"><h3>One Desk Across Four Rulebooks</h3><p>Companies Act 2013, Income Tax Act 1961, Ind AS 102 and - for listed issuers - SEBI SBEB 2021, all under a single engagement with a named partner. No handoff gaps between the company secretary, the valuer and the auditor, which is where most stalled Mumbai restructurings lose weeks.</p></article>
    <article class="feature-card"><h3>Communication Built for Finance and Media Talent</h3><p>An HR-ready pack - consent letter template, FAQ and town-hall talking points - tuned for the finance, fintech and media employees who fill Mumbai cap tables and read every clause. A coordinated signature drive closes Exchange Program consent so the cancellation is never contestable.</p></article>
    <article class="feature-card"><h3>15-Plus Years Across MCA, CBDT, ICAI, SEBI, IBBI</h3><p>Patron has designed and restructured ESOPs since 2009 across fintech, SaaS, media, edtech and healthtech through the 2022-2025 down-round cycle. 10,000+ businesses served, 4.9 Google rating, working with Mumbai teams in person and pan-India remotely.</p></article>
</div>
    </div>
</section>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p><strong>With offices in Pune, Mumbai, Delhi and Gurugram, Patron Accounting serves Mumbai startups facing underwater ESOP situations across India - both in-person and remotely. Pan-India remote engagement standard.</strong></p>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <ul>
                    <li><strong><a href="/esop-services/mumbai">ESOP Services Master Hub</a></strong> - end-to-end ESOP lifecycle services covering all verticals and engagement types including ongoing scheme operations post-restructuring.</li>
                    <li><strong><a href="/esop-scheme-design/mumbai">ESOP Scheme Design</a></strong> - first-time scheme drafting with sample term sheet (used for new schemes, not for restructuring).</li>
                    <li><strong><a href="/esop-for-tech-startups/mumbai">ESOP for Tech Startups</a></strong> - tech-vertical scheme design for SaaS, fintech, AI/ML, marketplaces, deeptech and B2B; useful context for understanding pre-restructuring scheme architecture.</li>
                    <li><strong><a href="/esop-for-saas-companies/mumbai">ESOP for SaaS Companies</a></strong> - B2B SaaS-specific design with ARR-linked vesting, sales quota acceleration and Delaware flip structures.</li>
                    ...
                    <li><strong><a href="/esop-valuation-services/mumbai">ESOP Valuation Services</a></strong> - Rule 11UA FMV reports for the modification date during restructuring; DCF, NAV or CCA methodology selection.</li>
                    <li><strong><a href="/esop-corporate-filings/mumbai">ESOP Corporate Filings</a></strong> - ongoing MCA filings retainer (MGT-14, PAS-3, MGT-7) for post-restructuring annual cycle including Rule 12(9) Directors Report disclosure.</li>
...
<section class="content-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>Every Mumbai restructuring is built on the same statutory spine - the Companies Act and Rule 12 corporate workflow filed at RoC Mumbai, the Income Tax Act perquisite and deferral provisions, and Ind AS 102 modification accounting - with one extra tier that the city's listed and DRHP-stage profile makes routine here: the SEBI SBEB Regulations 2021 administered from BKC. The references below are the exact provisions Patron works to on a Mumbai engagement.</p>
                <ul>
            ...
            <div class="faq-expanded">
                ...
                <div class="faq-expanded__list">
                    ...
                    <div class="faq-expanded__item" id="faq-3">
                        <h3 class="faq-expanded__q">Is ESOP repricing allowed for a Mumbai company, listed or unlisted?</h3>
                        <div class="faq-expanded__a"><p>Yes, but the path differs. An unlisted Mumbai startup - say in Andheri or Powai - reprices via a Special Resolution under Rule 12(2) and files MGT-14 with the Registrar of Companies, Mumbai within 30 days under Section 117(2). A listed BKC or Lower Parel issuer must additionally run the SEBI SBEB Regulations 2021 Regulation 18 variation procedure, ensure the change is not a detrimental variation to any grantee class, and notify the Stock Exchanges under Regulation 19. In both cases repricing preserves the original vesting cliff, and Section 17(2)(vi) is triggered only at exercise on the new lower exercise price.</p></div>
                    </div>
                    ...
                    <div class="faq-expanded__item" id="faq-7">
                        <h3 class="faq-expanded__q">We are a BKC-listed company with underwater ESOPs - what extra SEBI steps apply?</h3>
                        <div class="faq-expanded__a"><p>A listed Mumbai issuer cannot reprice or run an exchange program on a Special Resolution alone. SEBI SBEB Regulations 2021 Regulation 18 governs variation of ESOP terms: the variation must be approved by the shareholders by special resolution, must not be detrimental to the interests of the option grantees, and any shares arising must be listed under Regulation 19 with Stock Exchange notification. Pricing must respect SEBI norms, the Nomination and Remuneration Committee must approve, and disclosure flows into the Board's Report and the Exchange filings. Patron structures the variation so it clears the detrimental-variation bar before it reaches employees.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-8">
                        <h3 class="faq-expanded__q">What is an underwater ESOP and what can be done about it?</h3>
                        <div class="faq-expanded__a"><p>An ESOP becomes underwater when the exercise price stated in the grant letter exceeds the current FMV. In effect, exercising would require the employee to pay more than the share's present value, which makes no economic sense. In Mumbai this commonly arises in listed or pre-IPO companies in BKC or Lower Parel - for example, FMV was Rs 200 at Series A, options were granted at Rs 100, and a down Series B at Rs 60 leaves all grants underwater. For a listed company, the SEBI SBEB Regulation 18 variation procedure must also be followed. Five remediation options are available - (1) Repricing (bring the exercise price down to current FMV and keep the vesting schedule unchanged), (2) Exchange Program (cancel the existing options and issue new options at a 0.8x-1.0x ratio with a fresh 1-year cliff), (3) Top-Up Grants (leave the existing options in place and issue fresh grants at current FMV), (4) Vesting Acceleration (bring time-based vesting forward), and (5) Cashout (buyback at Re 1). Under Rule 12(2) of the Companies (Share Capital and Debentures) Rules 2014, a Special Resolution at 75 percent majority is required, and MGT-14 must be filed within 30 days under Section 117(2). Section 17(2)(vi) tax is triggered at exercise, not at modification - for a DPIIT plus IMB certified startup, the Section 80-IAC 48-month deferral applies (60 months under ITA 2025 from 1 April 2026). Under Ind AS 102 paragraph 27, the incremental fair value is expensed over the remaining vesting period. For a listed company, the SEBI SBEB Regulation 18 variation procedure and Stock Exchange notification apply. Patron completes the full restructuring within 6 to 10 weeks. Call <a href="tel:+919459456700" style="color:inherit;">+91 945 945 6700</a>.</p></div>
                    </div>
                </div>
            </div>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text" style="text-align:left;">
                ...
                <p style="color:rgba(255,255,255,0.92);">Ready to address your underwater ESOP situation? <strong><a href="tel:+919459456700" style="color:inherit;text-decoration:underline;">Call us at +91 945 945 6700</a></strong> or <strong><a href="https://wa.me/919459456700?text=Hello%2C%20I%20just%20visited%20your%20ESOP%20Restructuring%20Underwater%20Options%20in%20Mumbai%20page.%20I%20would%20like%20to%20know%20more%20about%20it." target="_blank" rel="noopener" style="color:inherit;text-decoration:underline;">WhatsApp us</a></strong> for a free ESOP restructuring scoping call. Response within 2 hours. 6 to 10 week end-to-end timeline from analysis to first revised grant letter or new grant batch.</p>

            </div>
            <div style="display:flex;gap:14px;flex-wrap:wrap;margin-top:24px;">
                <a href="tel:+919459456700" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:var(--orange);color:#fff;border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#128222; Call +91 945 945 6700</a>
                <a href="https://wa.me/919459456700?text=Hello%2C%20I%20just%20visited%20your%20ESOP%20Restructuring%20Underwater%20Options%20in%20Mumbai%20page.%20I%20would%20like%20to%20know%20more%20about%20it." target="_blank" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:#25D366;color:#fff;border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;" rel="noopener">&#128172; WhatsApp Us</a>
...
<section class="content-section" style="padding:48px 32px;background:var(--gray-50);">
    <div class="content-container"><div class="text-content">
        ...
        <div class="pa-city-grid"><a href="/esop-restructuring-underwater-options/pune" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Pune</div><div class="pa-card-sub">Maharashtra</div></div></a><span class="pa-city-card" aria-current="page" style="border-color:var(--orange);background:#FFF7F2;cursor:default;position:relative;"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Mumbai</div><div class="pa-card-sub">Maharashtra</div></div><span style="position:absolute;top:10px;right:12px;font-size:10px;font-weight:700;color:var(--orange);letter-spacing:.04em;">YOU'RE HERE</span></span><a href="/esop-restructuring-underwater-options/delhi" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Delhi</div><div class="pa-card-sub">Delhi NCR</div></div></a><a href="/esop-restructuring-underwater-options/gurugram" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Gurugram</div><div class="pa-card-sub">Haryana</div></div></a></div>
    </div></div>
</section>
