...
@section('meta')
    <title>Delhi ESOP Scheme Design for Funded Startup Companies</title>
    <meta name="description" content="Get a compliant ESOP scheme drafted and filed with RoC Delhi, with MCA-ready resolutions, vesting and leaver clauses, in 4 to 8 weeks starting at INR 19,999.">
    <meta name="keywords" content="ESOP Scheme Design Delhi, ESOP Scheme Design in Delhi, ESOP Scheme Design services in Delhi, ESOP services Delhi, ESOP Scheme Design cost Delhi, ESOP Scheme Design consultants Delhi, CA firm for ESOP Scheme Design Delhi, ESOP advisory Delhi">
    <link rel="canonical" href="/esop-scheme-design/delhi">
    <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1">
    <meta property="og:title" content="Delhi ESOP Scheme Design for Funded Startup Companies | Patron Accounting">
    <meta property="og:description" content="Get a compliant ESOP scheme drafted and filed with RoC Delhi, with MCA-ready resolutions, vesting and leaver clauses, in 4 to 8 weeks starting at INR 19,999.">
...
@section('schema')    <script type="application/ld+json">{
  ...
  "@graph": [
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://www.patronaccounting.com/esop-scheme-design/delhi#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
        ...
        },
        {
          ...
          "position": 4,
          "name": "ESOP Scheme Design",
          "item": "https://www.patronaccounting.com/esop-scheme-design/delhi"
        }
      ]
    },
    {
      ...
      "@id": "https://www.patronaccounting.com/esop-scheme-design/delhi#localbusiness",
      "name": "Patron Accounting LLP - ESOP Scheme Design, Delhi",
      "url": "https://www.patronaccounting.com/esop-scheme-design/delhi",
    ...
    {
      "@type": "FAQPage",
      "@id": "https://www.patronaccounting.com/esop-scheme-design/delhi#faq",
      "datePublished": "2026-06-24T08:00:00+05:30",
      "dateModified": "2026-06-24T08:00:00+05:30",
      "mainEntity": [
        {
          "@type": "Question",
          "name": "How much does ESOP scheme design cost in Delhi?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "ESOP scheme design for Delhi startups starts from INR 19,999 (Exl GST and Govt. Charges). Stage-based scope - Seed through Series B with cap table modelling and leaver matrix, plus FEMA mirror-grant alignment for Delhi companies with a foreign parent or NRI promoters - is quoted on a free scoping call. IBBI valuation is a third-party pass-through of Rs 25,000 to Rs 75,000. Fees are exclusive of GST."
          }
        },
        {
          "@type": "Question",
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "The statutory minimum is one year from the grant date under Rule 12(6)(a) of the Companies (Share Capital and Debentures) Rules 2014. Companies cannot vest any portion of an option grant earlier than 12 months even if the employee resigns or is terminated. Most Delhi startups follow a 4-year vesting schedule with this 1-year cliff."
          }
        },
        {
          "@type": "Question",
          "name": "Which RoC handles ESOP filings for Delhi companies and what gets filed?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Companies registered in Delhi fall under the Registrar of Companies, Delhi (RoC Delhi) and file on the MCA21 portal, even though the Ministry of Corporate Affairs headquarters is also in Delhi. After the EGM Special Resolution, MGT-14 is filed within 30 days under Section 117(2) (default Rs 100 per day), and PAS-3 for allotment within 30 days of each exercise under Section 39(5). The Form SH-6 register is kept at the registered office under Rule 12(10), not filed with RoC Delhi. Patron handles the full RoC Delhi filing cycle."
          }
        },
        {
          "@type": "Question",
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Single-trigger acceleration vests all unvested options on a change of control event (acquisition, merger, IPO). Double-trigger acceleration requires both a change of control event AND a termination without cause of the employee within a defined window (typically 12 months). Double-trigger is investor-friendly and now the Series B-plus market norm in Delhi."
          }
        },
        {
          "@type": "Question",
          "name": "Can a Delhi company with a foreign parent grant ESOPs across borders?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes. Many Delhi-registered companies sit under a foreign holding company or have NRI promoters, and employees may be granted options of the overseas parent or of the Indian entity. Mirror grants and cross-border ESOPs are governed by FEMA Overseas Investment Rules 2022 and reporting via the RBI's OPI route, in addition to the Section 62(1)(b) and Rule 12 scheme for the Indian company. Patron drafts the Indian scheme and aligns it with the parent's plan and FEMA reporting so the structure clears Series A diligence."
          }
        },
        {
          "@type": "Question",
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Designing an ESOP scheme follows a defined process. The first step is to check whether the AoA authorises ESOPs; if it does not, an AoA amendment is required. Next comes cap table modelling and pool sizing - typically 10 to 15 percent of post-money equity for Delhi startups. The scheme is then drafted under Section 62(1)(b) of the Companies Act 2013, covering the pool, a 4-year vesting schedule with the Rule 12(6)(a) 1-year statutory cliff, the exercise price (at or below FMV but never below face value), the leaver matrix (good leaver versus bad leaver), single or double-trigger acceleration and clawback. A Board Resolution is then passed and a 21-day EGM notice is issued under Section 101. At the EGM, a Special Resolution is passed at a 75 percent majority. MGT-14 must be filed within 30 days under Section 117(2) (default Rs 100 per day). The IBBI valuation is obtained under Rule 11UA (valid for 180 days). The Form SH-6 register must be maintained at the registered office under Rule 12(10) and authenticated by the Company Secretary. Where DPIIT recognition under Notification GSR 127(E) 2019 is in place, founders and 10 percent-plus directors may also be granted ESOPs through the Rule 12 10-year exemption. Perquisite tax under Section 17(2)(vi) applies at exercise; a 48-month deferral is available under Section 80-IAC read with Section 192(2C) for DPIIT plus IMB certified startups (60 months under the Income Tax Act 2025 from 1 April 2026). Under Ind AS 102, the share-based payment expense is recognised over the vesting period using Black-Scholes. Patron completes the entire process in 4 to 8 weeks, including the sample term sheet, scheme document, Board kit, EGM kit, MGT-14, IBBI valuation, SH-6 setup and the first Grant Letter. Call +91 945 945 6700."
          }
        }
      ]
    }
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-4 private-registration-heading">
                        ESOP Scheme Design in Delhi
                    </h1>

                    <p class="mb-4" style="font-size:17px;color:var(--text-secondary);max-width:640px;">Drafted and filed at RoC Delhi - a short walk from the MCA head office in the capital - for Nehru Place, Connaught Place and Saket-Aerocity companies, with NRI promoters and foreign-parent mirror grants built in.</p>
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="https://wa.me/919459456700?text=Hello%2C%20I%20just%20visited%20your%20ESOP%20Scheme%20Design%20in%20Delhi%20page.%20I%20would%20like%20to%20know%20more%20about%20it." target="_blank" class="btn-sample text-decoration-none" rel="noopener">
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                <div class="highlight-box" style="margin-bottom:20px;">
                    <p><strong>&#128204; TL;DR - ESOP Scheme Design for Delhi Companies</strong></p>
                    <p>For a Delhi-registered company, ESOP scheme design means a first-time Employee Stock Option Plan drafted under Section 62(1)(b) of the Companies Act 2013 and Rule 12, then carried through an EGM and filed at the Registrar of Companies, Delhi on MCA21 - the same building cluster as the Ministry of Corporate Affairs head office. The scheme fixes pool size (12 to 15 percent post-money is the Series A pool a Connaught Place fund will expect), a 4-year vesting curve with the Rule 12(6)(a) one-year cliff, exercise-price method, a good-vs-bad leaver matrix and acceleration triggers, plus a 20-parameter term sheet your HR team reuses for every grant. Where NRI promoters or a US/Singapore parent sit on the cap table, the Indian scheme is aligned to <a href="/esop-fema-and-rbi-firms-reporting/delhi">FEMA Overseas Investment Rules 2022 mirror-grant reporting</a>. Delivered in 4 to 8 weeks.</p>
                </div>
                <p>Delhi and the NCR carry a startup mix you do not see in the pure-SaaS hubs - trading and hardware houses around Nehru Place, consumer-tech and D2C ventures in the Saket-Aerocity belt, and finance and advisory firms near Connaught Place - and a large share of them carry an NRI promoter or an overseas holding company. That changes what scheme design has to do here: the Section 62(1)(b) document is rarely a standalone, it has to dovetail with a parent plan and FEMA reporting from the first draft. Because RoC Delhi and the MCA itself both sit in the capital, a clean filing trail is scrutinised closely the moment a company reaches a priced round.</p>
                <p>ESOP scheme design is also the highest-leverage governance project a Delhi startup takes on in its first three years. Get the pool, cliff, vesting, leaver and acceleration wrong and you dilute the wrong people, fail Series A diligence and hand employees a tax surprise at exercise. Get them right in one Board-approved document and the scheme survives every downstream round and every senior-hire negotiation. Patron Accounting LLP has drafted and filed these schemes since 2009 across Private Limited, Public Unlisted and DPIIT-recognised structures.</p>
                <p>The CA and CS team runs the full Delhi jurisdiction in a single 4-to-8-week sprint: policy drafting under Section 62(1)(b) read with Rule 12, <a href="/esop-valuation-services/delhi">IBBI valuation under Rule 11UA</a>, the EGM cycle (21-day notice under Section 101, Explanatory Statement under Section 102, Special Resolution at 75 percent, MGT-14 within 30 days under Section 117(2)) and the Form SH-6 register at the registered office under Rule 12(10). <a href="/esop-perquisite-tax-section-17-2-vi/delhi">Section 17(2)(vi) perquisite tax</a> and the <a href="/esop-startup-tds-deferral-section-192-1c/delhi">Section 80-IAC plus Section 192(2C) 48-month deferral</a> (60 months under Income Tax Act 2025 Section 392(3) read with 289(3) from 1 April 2026) are pre-mapped, and Ind AS 102 expense is modelled from grant date using Black-Scholes. With offices in Pune, Mumbai, Delhi and Gurugram, in-person board sessions across Delhi NCR are available alongside the standard remote engagement.</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="two-column">
            <div class="column-content">
                ...
                <div class="content-text what-is-definition">
                    ...
                    <p>For a Delhi company, ESOP scheme design is the engagement that converts an equity intention into a master Employee Stock Option Plan policy under Section 62(1)(b) of the Companies Act 2013 and Rule 12 - drafted, taken through a Board meeting and an EGM, and filed at RoC Delhi via Form MGT-14 within 30 days of the Special Resolution under Section 117(2). The deliverable is a single Board-and-shareholder-approved document that fixes pool size, eligibility, vesting, cliff, exercise-price method, the leaver matrix, acceleration triggers and grant authority - the record a Connaught Place fund's counsel will pull up first at Series A.</p>
                    <p>Think of the scheme as the operating manual for every grant, exercise and exit the company will run for the next decade. A Nehru Place trading firm uses it to convert verbal equity promises into clean grants; a Saket consumer-tech founder uses it to lock the pool before a term sheet; a Delhi company with an overseas parent uses it as the Indian leg of a cross-border plan. Five parameters carry most of the weight: (1) pool size against post-money equity (5 to 10 percent at seed, 12 to 15 percent the Series A norm in Delhi, up to 18 percent by Series B), (2) a 4-year vesting curve with the Rule 12(6)(a) one-year statutory cliff, (3) exercise price at or below FMV but never below face value, (4) an explicit good-leaver-vs-bad-leaver matrix, and (5) single, double or hybrid 50/100 acceleration on change of control.</p>
                    <p>Three overlays decide which way a Delhi scheme is built. DPIIT-recognised startups can use the Rule 12 ten-year exemption to grant ESOPs to promoters and 10 percent-plus directors who are otherwise excluded. Listed entities pick up SEBI (Share Based Employee Benefits and Sweat Equity) Regulations 2021 for ESOP, RSU, SAR and ESPS schemes. And - the overlay we meet most often in the capital - companies with an NRI promoter or a foreign holding company must align the Section 62(1)(b) scheme with FEMA Overseas Investment Rules 2022 mirror-grant reporting so the structure does not unravel at diligence.</p>

                </div>
                <div class="highlight-box" style="margin-top:20px;">
                    <p><strong>Key Terms for ESOP Design:</strong></p>
                    <p><strong>ESOP Pool:</strong> The block of equity shares reserved for employees, expressed as a percentage of fully diluted capital - typically 10 to 15 percent for Delhi startups. Sized against the 18-24 month hiring plan.</p>
                    ...
                    <p><strong>Double-Trigger Acceleration:</strong> Options vest only if a change of control event is followed by termination without cause within a defined period (typically 12 months). Series B-plus market norm in Delhi.</p>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>Delhi and the wider NCR run a different kind of startup mix from the pure-SaaS hubs - Nehru Place IT and trading houses, consumer-tech and D2C ventures around Saket and Aerocity, and finance and advisory firms clustered near Connaught Place, many carrying NRI promoters or a foreign holding company on the cap table. ESOP scheme design is the first-time engagement that turns a Delhi unlisted company's equity intentions into a Board-approved, RoC Delhi-filed Employee Stock Option Plan. Because RoC Delhi and the MCA head office both sit in the capital, getting the Section 62(1)(b) sequence right the first time matters even more for companies that will be looked at closely at Series A. The engagement scales from bootstrapped pre-revenue through Series B; listed entities pick up the additional SEBI SBEB Regulations 2021 layer as a premium engagement.</p>
                <ul>
                    <li><strong>Nehru Place trading and product firms making their first equity hire</strong> - a hardware-trading or B2B distribution company moving from a founder-only cap table to a Seed-stage 5-12 percent pool with 4-year vesting and a 1-year cliff before its first 5-25 grants go out.</li>
                    <li><strong>Saket and Aerocity consumer-tech ventures pre-Series A</strong> - a D2C or consumer-tech founder who needs the scheme on record before the term sheet, since Series A investors typically insist on a 12-15 percent post-money pool established pre-funding; skipping it forces founder dilution at signing.</li>
                    <li><strong>Delhi companies with NRI promoters or a foreign parent</strong> - structures where promoters or the holding company sit abroad need the Indian Section 62(1)(b) scheme aligned with the parent plan and FEMA Overseas Investment Rules 2022 reporting from day one.</li>
                    <li><strong>Connaught Place finance and advisory firms regularising informal equity promises</strong> - two to four years of verbal equity offers to early partners and analysts converted into a clean Board-approved scheme; backdated effective grant dates are allowed where the Board ratifies.</li>
                    <li><strong>Senior CXO hires under negotiation</strong> - VP Engineering, VP Product, CFO or CTO joining at Seed or Series A on equity-weighted offers that need performance vesting hooks and accelerated vesting written into the scheme.</li>
                    <li><strong>DPIIT-recognised Delhi startups granting founder ESOPs</strong> - the Rule 12 10-year founder exemption lets promoters and 10 percent-plus directors receive ESOPs in DPIIT-recognised startups (Private Limited or LLP, within 10 years of incorporation, turnover under Rs 100 crore).</li>
                    <li><strong>Companies whose AoA pre-dates ESOPs</strong> - an older AoA that does not authorise ESOPs needs a fresh EGM Special Resolution and MGT-14 filing at RoC Delhi before the scheme can be adopted.</li>
                    <li><strong>Founders heading into Series A or M&amp;A diligence</strong> - a clean scheme survives Series A through C review and acquirer counsel scrutiny with one minor comment typical.</li>
                    <li><strong>Listed entities under SEBI SBEB Regulations 2021</strong> - listed-company ESOP, RSU, SAR and ESPS schemes carrying grantee class disclosure, Stock Exchange notification and shareholder communication.</li>
                </ul>
...
<section class="content-section" id="services-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>Engagement scope is set by stage, not by a fixed package. A Nehru Place trading firm issuing its first handful of grants sits in the Seed tier; a Saket consumer-tech venture going into a priced round sits in Pre-Series A or Series A to B; and a Delhi company with NRI promoters or a US/Singapore parent adds the cross-border mirror-grant layer on top. The add-ons below - IBBI valuation, AoA amendment, DPIIT founder ESOP - are priced as pass-throughs or scoped separately so you only pay for what your structure actually needs.</p>
...
<section class="steps-section" id="procedure-section">
    <div class="section-container">
        <div class="section-header" style="text-align:center;margin-bottom:48px;">
            ...
            <p class="section-subtitle" style="text-align:left;max-width:100%;">For a Delhi-registered company the same eight steps run 4 to 8 weeks end-to-end, with the corporate filings landing at RoC Delhi on the MCA21 portal. The sequence covers discovery and AoA review, cap table modelling with 3 dilution scenarios, scheme drafting, Board Resolution and the 21-day EGM notice, Special Resolution at 75 percent majority, MGT-14 filing within 30 days, IBBI valuation under Rule 11UA, Form SH-6 register setup and the first grant batch. Where NRI promoters or a foreign parent are involved, the FEMA mirror-grant alignment is woven in alongside drafting rather than bolted on at the end.</p>
        </div>
        <div class="steps-container">
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <p class="step-description">60-minute discovery call covering stage, headcount, hiring roadmap, funding plans and investor SHA constraints, plus a check on whether NRI promoters or a foreign holding company sit on the cap table - common for Delhi and NCR companies and decisive for FEMA scope. Document collection and AoA review confirm whether the existing AoA authorises ESOPs; if not, an AoA amendment via fresh EGM is added to scope. Engagement letter signed.</p>
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <p class="step-description">MGT-14 filed at RoC Delhi on the MCA21 portal within 30 days under Section 117(2) of Companies Act 2013 - default attracts Rs 100 per day penalty. In parallel, an IBBI Registered Valuer is engaged for grant-date FMV under Rule 11UA of Income Tax Rules 1962 - DCF, NAV or CCA methodology selection. Valuation is refreshed at every fresh grant batch and every 180 days for exercise events.</p>
                    <div class="step-highlights">
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>A Delhi engagement closes with a complete handover pack - the scheme itself, the governance documents, the RoC Delhi filings, the IBBI valuation, the Ind AS 102 accounting workings and a reusable term-sheet library your HR team can run grants from without coming back for fresh legal fees. For a Nehru Place trading firm or a Saket consumer-tech venture, this is the full record an investor or acquirer's counsel will ask to see at Series A diligence.</p>
                ...
                <ul>
                    <li>MGT-14 filing at RoC Delhi within 30 days of Special Resolution under Section 117(2). Coordinated with <a href="/esop-corporate-filings/delhi">ESOP Corporate Filings</a> workflow.</li>
...
<section class="content-section" id="challenges-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>The mistakes we see most often in Delhi self-built schemes cluster around two things - pools sized for a trading or product firm's current payroll rather than its hiring plan, and cross-border tangles where a company with a foreign parent or NRI promoters drafts the Indian scheme in isolation and trips the FEMA reporting at diligence. Each row below pairs the error with its cost and how Patron designs it out from the start.</p>
                <div class="table-responsive-wrapper">
                <table>
                    ...
                    <tbody>
                        ...
                        <tr><td><strong>MGT-14 default under Section 117(2)</strong></td><td>Rs 100 per day after the 30-day filing window under Section 117(2) of Companies Act 2013. Compounding can exceed Rs 25,000 for a 6-month delay plus regulatory friction during subsequent funding diligence.</td><td>Patron filing calendar tracks every Special Resolution against the 30-day MGT-14 deadline at RoC Delhi. PAS-3 30-day window also tracked under Section 39(5) - Rs 1,000 per day default for private companies up to Rs 25 lakh. End-to-end through <a href="/esop-corporate-filings/delhi">ESOP Corporate Filings</a> retainer.</td></tr>
...
<section class="why-choose-section" id="benefits-section">
    ...
    <article class="feature-card"><h3>One Delhi Engagement: CA + CS + Valuation + Tax</h3><p>CA, CS, valuation and tax specialists with named partner accountability under a single engagement, filing into RoC Delhi on MCA21. No coordination tax across separate firms. End-to-end delivery from AoA review through the first Grant Letter in 4 to 8 weeks.</p></article>
    <article class="feature-card"><h3>FEMA-Aligned for NRI Promoters and Foreign Parents</h3><p>For Delhi companies with NRI promoters or a US, Singapore or UK holding company, the Indian Section 62(1)(b) scheme is drafted to sit alongside the parent plan with FEMA Overseas Investment Rules 2022 reporting handled - so cross-border and mirror-grant structures clear Series A diligence cleanly.</p></article>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p><strong>With offices in Pune, Mumbai, Delhi and Gurugram, Patron Accounting serves Delhi startups establishing first-time ESOP schemes across India - both in-person and remotely. Pan-India remote engagement standard.</strong></p>
...
<section class="content-section" id="comparison-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>The free template a Nehru Place or Aerocity founder downloads is usually a US Delaware plan or a generic Indian boilerplate - it never carries the two things a Delhi cap table actually needs: a pool sized to a Series A pool a Connaught Place investor will demand, and a FEMA mirror-grant alignment for the NRI promoter or foreign parent sitting on the structure. The gap only surfaces at diligence, when the scheme gets reopened a few weeks before close. The table below sets the self-built template against a Patron-designed scheme filed at RoC Delhi, dimension by dimension.</p>
                <div class="table-responsive-wrapper">
                <table>
                    <thead>
                        <tr>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <ul>
                    <li><strong><a href="/esop-services/delhi">ESOP Services Master Hub</a></strong> - end-to-end ESOP lifecycle services covering all verticals and engagement types; ongoing operational compliance after scheme design including vesting tracking and annual ESOP disclosures.</li>
                    <li><strong><a href="/esop-for-tech-startups/delhi">ESOP for Tech Startups</a></strong> - tech-vertical scheme design with engineer/CTO pool benchmarks, refresh grants at 24-36 month tenure, performance vesting hooks and hybrid 50/100 acceleration drafted into the scheme at the outset.</li>
...
<section class="content-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>Every statute below applies nationwide, but for a Delhi company the corporate-law steps are administered through the Registrar of Companies, Delhi on MCA21 - and the Ministry of Corporate Affairs that issues these rules is headquartered in the capital itself. Two further layers come up far more often on Delhi cap tables than elsewhere: the FEMA Overseas Investment Rules 2022 and the LRS limit, because of the NRI promoters and foreign holding companies common across the Nehru Place, Connaught Place and Saket-Aerocity clusters. The provisions Patron works to on a Delhi ESOP scheme are listed below.</p>
                <ul>
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    ...
                    <p class="faq-expanded__lead">Long-tail answers on first-time ESOP scheme design for Delhi startups - fees by stage, end-to-end timeline, minimum cliff, scheme document contents, single vs double-trigger acceleration, good vs bad leaver definitions and founder ESOPs under DPIIT 10-year exemption.</p>
                    @include('partials.bigin-form', [
                        'variant'  => 'compact',
                        'service'  => 'ESOP Design',
                        'city'     => 'Delhi',
                ...
                <div class="faq-expanded__list">
                    <div class="faq-expanded__item" id="faq-1">
                        <h3 class="faq-expanded__q">How much does ESOP scheme design cost in Delhi?</h3>
                        <div class="faq-expanded__a"><p>ESOP scheme design for Delhi startups starts from INR 19,999 (Exl GST and Govt. Charges). Stage-based scope - Seed through Series B with cap table modelling and leaver matrix, plus FEMA mirror-grant alignment for Delhi companies with a foreign parent or NRI promoters - is quoted on a free scoping call. IBBI valuation is a third-party pass-through of Rs 25,000 to Rs 75,000. Fees are exclusive of GST.</p></div>
                    </div>
                    ...
                    <div class="faq-expanded__item" id="faq-3">
                        ...
                        <div class="faq-expanded__a"><p>The statutory minimum is one year from the grant date under Rule 12(6)(a) of the Companies (Share Capital and Debentures) Rules 2014. Companies cannot vest any portion of an option grant earlier than 12 months even if the employee resigns or is terminated. Most Delhi startups follow a 4-year vesting schedule with this 1-year cliff.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-4">
                        <h3 class="faq-expanded__q">Which RoC handles ESOP filings for Delhi companies and what gets filed?</h3>
                        <div class="faq-expanded__a"><p>Companies registered in Delhi fall under the Registrar of Companies, Delhi (RoC Delhi) and file on the MCA21 portal, even though the Ministry of Corporate Affairs headquarters is also in Delhi. After the EGM Special Resolution, MGT-14 is filed within 30 days under Section 117(2) (default Rs 100 per day), and PAS-3 for allotment within 30 days of each exercise under Section 39(5). The Form SH-6 register is kept at the registered office under Rule 12(10), not filed with RoC Delhi. Patron handles the full RoC Delhi filing cycle.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-5">
                        <h3 class="faq-expanded__q">What is the difference between single-trigger and double-trigger acceleration?</h3>
                        <div class="faq-expanded__a"><p>Single-trigger acceleration vests all unvested options on a change of control event (acquisition, merger, IPO). Double-trigger acceleration requires both a change of control event AND a termination without cause of the employee within a defined window (typically 12 months). Double-trigger is investor-friendly and now the Series B-plus market norm in Delhi.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-6">
                        <h3 class="faq-expanded__q">Can a Delhi company with a foreign parent grant ESOPs across borders?</h3>
                        <div class="faq-expanded__a"><p>Yes. Many Delhi-registered companies sit under a foreign holding company or have NRI promoters, and employees may be granted options of the overseas parent or of the Indian entity. Mirror grants and cross-border ESOPs are governed by FEMA Overseas Investment Rules 2022 and reporting via the RBI's OPI route, in addition to the Section 62(1)(b) and Rule 12 scheme for the Indian company. Patron drafts the Indian scheme and aligns it with the parent's plan and FEMA reporting so the structure clears Series A diligence.</p></div>
                    </div>
                    ...
                    <div class="faq-expanded__item" id="faq-8">
                        ...
                        <div class="faq-expanded__a"><p>Designing an ESOP scheme follows a defined process. The first step is to check whether the AoA authorises ESOPs; if it does not, an AoA amendment is required. Next comes cap table modelling and pool sizing - typically 10 to 15 percent of post-money equity for Delhi startups. The scheme is then drafted under Section 62(1)(b) of the Companies Act 2013, covering the pool, a 4-year vesting schedule with the Rule 12(6)(a) 1-year statutory cliff, the exercise price (at or below FMV but never below face value), the leaver matrix (good leaver versus bad leaver), single or double-trigger acceleration and clawback. A Board Resolution is then passed and a 21-day EGM notice is issued under Section 101. At the EGM, a Special Resolution is passed at a 75 percent majority. MGT-14 must be filed within 30 days under Section 117(2) (default Rs 100 per day). The IBBI valuation is obtained under Rule 11UA (valid for 180 days). The Form SH-6 register must be maintained at the registered office under Rule 12(10) and authenticated by the Company Secretary. Where DPIIT recognition under Notification GSR 127(E) 2019 is in place, founders and 10 percent-plus directors may also be granted ESOPs through the Rule 12 10-year exemption. Perquisite tax under Section 17(2)(vi) applies at exercise; a 48-month deferral is available under Section 80-IAC read with Section 192(2C) for DPIIT plus IMB certified startups (60 months under the Income Tax Act 2025 from 1 April 2026). Under Ind AS 102, the share-based payment expense is recognised over the vesting period using Black-Scholes. Patron completes the entire process in 4 to 8 weeks, including the sample term sheet, scheme document, Board kit, EGM kit, MGT-14, IBBI valuation, SH-6 setup and the first Grant Letter. Call <a href="tel:+919459456700" style="color:inherit;">+91 945 945 6700</a>.</p></div>
                    </div>
                </div>
            </div>
            ...
            <div class="highlight-box" style="margin-top:32px;">
                ...
                <ul>
                    <li><strong>What is a typical ESOP pool size for a startup?</strong> Most Delhi startups reserve 10 to 15 percent of post-money equity, with 5 to 10 percent at seed stage rising to as much as 18 percent by Series B.</li>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text" style="text-align:left;">
                ...
                <p style="color:rgba(255,255,255,0.92);">Ready to design your first ESOP scheme? <strong><a href="tel:+919459456700" style="color:inherit;text-decoration:underline;">Call us at +91 945 945 6700</a></strong> or <strong><a href="https://wa.me/919459456700?text=Hello%2C%20I%20just%20visited%20your%20ESOP%20Scheme%20Design%20in%20Delhi%20page.%20I%20would%20like%20to%20know%20more%20about%20it." target="_blank" rel="noopener" style="color:inherit;text-decoration:underline;">WhatsApp us</a></strong> for a free scheme design scoping call. Response within 2 hours. 4 to 8 week end-to-end timeline from discovery to first Grant Letter.</p>

            </div>
            <div style="display:flex;gap:14px;flex-wrap:wrap;margin-top:24px;">
                <a href="tel:+919459456700" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:var(--orange);color:#fff;border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#128222; Call +91 945 945 6700</a>
                <a href="https://wa.me/919459456700?text=Hello%2C%20I%20just%20visited%20your%20ESOP%20Scheme%20Design%20in%20Delhi%20page.%20I%20would%20like%20to%20know%20more%20about%20it." target="_blank" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:#25D366;color:#fff;border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;" rel="noopener">&#128172; WhatsApp Us</a>
...
<section class="content-section" style="padding:48px 32px;background:var(--gray-50);">
    <div class="content-container"><div class="text-content">
        ...
        <div class="pa-city-grid"><a href="/esop-scheme-design/pune" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Pune</div><div class="pa-card-sub">Maharashtra</div></div></a><a href="/esop-scheme-design/mumbai" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Mumbai</div><div class="pa-card-sub">Maharashtra</div></div></a><span class="pa-city-card" aria-current="page" style="border-color:var(--orange);background:#FFF7F2;cursor:default;position:relative;"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Delhi</div><div class="pa-card-sub">Delhi NCR</div></div><span style="position:absolute;top:10px;right:12px;font-size:10px;font-weight:700;color:var(--orange);letter-spacing:.04em;">YOU'RE HERE</span></span><a href="/esop-scheme-design/gurugram" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Gurugram</div><div class="pa-card-sub">Haryana</div></div></a></div>
    </div></div>
</section>
