...
@section('meta')
    <title>Mumbai ESOP Scheme Design with SEBI-Aligned Term Sheets</title>
    <meta name="description" content="End-to-end ESOP drafting for BKC and Powai companies, covering vesting, leaver clauses and SEBI-aligned term sheets, delivered in 4 to 8 weeks from INR 19,999.">
    <meta name="keywords" content="ESOP Scheme Design Mumbai, ESOP Scheme Design in Mumbai, ESOP Scheme Design services in Mumbai, ESOP services Mumbai, ESOP Scheme Design cost Mumbai, ESOP Scheme Design consultants Mumbai, CA firm for ESOP Scheme Design Mumbai, ESOP advisory Mumbai">
    <link rel="canonical" href="/esop-scheme-design/mumbai">
    <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1">
    <meta property="og:title" content="Mumbai ESOP Scheme Design with SEBI-Aligned Term Sheets | Patron Accounting">
    <meta property="og:description" content="End-to-end ESOP drafting for BKC and Powai companies, covering vesting, leaver clauses and SEBI-aligned term sheets, delivered in 4 to 8 weeks from INR 19,999.">
    <meta property="og:url" content="/esop-scheme-design/mumbai">
    <meta property="og:type" content="website">
    <meta property="og:site_name" content="Patron Accounting">
    <meta property="og:image" content="/images/esop-scheme-design-og.webp">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Mumbai ESOP Scheme Design with SEBI-Aligned Term Sheets | Patron Accounting">
    <meta name="twitter:description" content="End-to-end ESOP drafting for BKC and Powai companies, covering vesting, leaver clauses and SEBI-aligned term sheets, delivered in 4 to 8 weeks from INR 19,999.">
...
@section('schema')    <script type="application/ld+json">{
  ...
  "@graph": [
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://www.patronaccounting.com/esop-scheme-design/mumbai#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
        ...
        },
        {
          ...
          "position": 4,
          "name": "ESOP Scheme Design",
          "item": "https://www.patronaccounting.com/esop-scheme-design/mumbai"
        }
      ]
    },
    {
      ...
      "@id": "https://www.patronaccounting.com/esop-scheme-design/mumbai#localbusiness",
      "name": "Patron Accounting LLP - ESOP Scheme Design, Mumbai",
      "url": "https://www.patronaccounting.com/esop-scheme-design/mumbai",
    ...
    {
      "@type": "FAQPage",
      "@id": "https://www.patronaccounting.com/esop-scheme-design/mumbai#faq",
      "datePublished": "2026-06-24T08:00:00+05:30",
      "dateModified": "2026-06-24T08:00:00+05:30",
      "mainEntity": [
        {
          "@type": "Question",
          "name": "How much does ESOP scheme design cost in Mumbai?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "ESOP scheme design for Mumbai startups starts from INR 19,999 (Exl GST and Govt. Charges). Stage-based scope - Seed through Series B with cap table modelling, leaver matrix and SHA coordination, plus SEBI SBEB-ready definitions for BKC and Lower Parel companies eyeing a listing - is quoted on a free scoping call. IBBI valuation is a third-party pass-through of Rs 25,000 to Rs 75,000. Fees are exclusive of GST."
          }
        },
        {
          "@type": "Question",
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "The statutory minimum is one year from the grant date under Rule 12(6)(a) of the Companies (Share Capital and Debentures) Rules 2014. Companies cannot vest any portion of an option grant earlier than 12 months even if the employee resigns or is terminated. Most Mumbai startups follow a 4-year vesting schedule with this 1-year cliff."
          }
        },
        {
          "@type": "Question",
          "name": "Do Mumbai startups need to follow SEBI SBEB Regulations when designing an ESOP?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Only listed companies must comply with the SEBI (Share Based Employee Benefits and Sweat Equity) Regulations 2021 - grantee class disclosure, compensation committee, trust route rules and Stock Exchange notification. Unlisted Mumbai startups design under Section 62(1)(b) and Rule 12 alone. But because SEBI is headquartered in BKC and many Mumbai founders target a public listing, we draft SBEB-ready definitions and Regulation 18 variation language early so the scheme migrates cleanly to the listed regime later without a full redraft."
          }
        },
        {
          "@type": "Question",
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Single-trigger acceleration vests all unvested options on a change of control event (acquisition, merger, IPO). Double-trigger acceleration requires both a change of control event AND a termination without cause of the employee within a defined window (typically 12 months). Double-trigger is investor-friendly and now the Series B-plus market norm in Mumbai."
          }
        },
        {
          "@type": "Question",
          "name": "Where do Mumbai companies file ESOP forms and which RoC has jurisdiction?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Companies with a registered office in Mumbai fall under the Registrar of Companies, Mumbai (RoC Mumbai) and file all ESOP forms on the MCA21 portal. MGT-14 for the Special Resolution is filed within 30 days under Section 117(2) (default Rs 100 per day), and PAS-3 for allotment within 30 days of each exercise under Section 39(5). Form SH-6 is not filed with RoC Mumbai but maintained at the registered office under Rule 12(10), authenticated by the Company Secretary. Patron manages the full RoC Mumbai filing cycle."
          }
        },
        {
          "@type": "Question",
        ...
        {
          "@type": "Question",
          "name": "How is an ESOP scheme designed, step by step?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Designing an ESOP scheme follows a defined sequence. First, the Articles of Association are reviewed to confirm whether they authorise ESOPs; if they do not, an AoA amendment is carried out. Next comes cap table modelling and pool sizing - typically 10 to 15 percent of post-money equity for Mumbai startups. The scheme is then drafted under Section 62(1)(b) of the Companies Act 2013, covering the pool, 4-year vesting with the Rule 12(6)(a) 1-year statutory cliff, exercise price (at or below FMV but never below face value), the leaver matrix (good leaver vs bad leaver), single or double-trigger acceleration and clawback. The Board Resolution is then passed and a 21-day EGM notice is issued under Section 101. At the EGM, the Special Resolution is passed by a 75 percent majority. MGT-14 is filed within 30 days under Section 117(2) (default Rs 100 per day). The IBBI valuation is obtained under Rule 11UA (valid for 180 days). The Form SH-6 register is maintained at the registered office under Rule 12(10) and authenticated by the Company Secretary. Where the company holds DPIIT recognition under Notification GSR 127(E) 2019, founders and 10 percent-plus directors can also be granted ESOPs through the Rule 12 10-year exemption. Section 17(2)(vi) perquisite tax applies on exercise; a 48-month deferral is available to DPIIT plus IMB startups under Section 80-IAC read with Section 192(2C) (60 months under the Income Tax Act 2025 from 1 April 2026). Under Ind AS 102, the share-based payment expense is recognised using Black-Scholes over the vesting period. Patron completes the entire process in 4 to 8 weeks, including the sample term sheet, scheme document, Board kit, EGM kit, MGT-14, IBBI valuation, SH-6 setup and the first Grant Letter. Call +91 945 945 6700."
          }
        }
      ]
    }
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-4 private-registration-heading">
                        ESOP Scheme Design in Mumbai
                    </h1>

                    <p class="mb-4" style="font-size:17px;color:var(--text-secondary);max-width:640px;">For BKC and Lower Parel finance houses, Powai-Andheri SaaS teams and Goregaon-Vikhroli media ventures - listing-ready ESOP schemes drafted a stone's throw from SEBI, filed with RoC Mumbai.</p>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Fees:</span> From INR 19,999 (Exl GST and Govt. Charges)</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - ESOP Design'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value='Seed Stage ESOP Scheme' selected>Seed Stage ESOP Scheme</option>
                                <option value='Pre-Series A ESOP Scheme'>Pre-Series A ESOP Scheme</option>
                                <option value='Series A to B ESOP Scheme'>Series A to B ESOP Scheme</option>
                                <option value='IBBI Valuation under Rule 11UA'>IBBI Valuation under Rule 11UA</option>
                                <option value='AoA Amendment for ESOP'>AoA Amendment for ESOP</option>
                                <option value='Founder ESOP under DPIIT Exemption'>Founder ESOP under DPIIT Exemption</option>
                                <option value='Performance Vesting Drafting'>Performance Vesting Drafting</option>
                                <option value='Sample Term Sheet Library'>Sample Term Sheet Library</option>
                                <option value='Accelerated Vesting Clauses'>Accelerated Vesting Clauses</option>
                                <option value='Leaver Matrix Drafting'>Leaver Matrix Drafting</option>
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                <div class="highlight-box" style="margin-bottom:20px;">
                    <p><strong>&#128204; TL;DR - ESOP Design for Mumbai Companies</strong></p>
                    <p>In Mumbai, ESOP scheme design is rarely just a startup HR exercise - it is the first rung of an equity story that BKC and Lower Parel founders expect to carry all the way to a SEBI-regulated listing. Patron drafts the master Employee Stock Option Plan from scratch under Section 62(1)(b) of the Companies Act 2013 and Rule 12 of the Companies (Share Capital and Debentures) Rules 2014, then files it with RoC Mumbai. You receive a Board-approved, EGM-ratified document fixing pool size (10 to 15 percent of post-money equity), 4-year vesting with the Rule 12(6)(a) one-year cliff, exercise-price method, a good-vs-bad leaver matrix, single/double/hybrid acceleration and a 20-parameter sample term sheet - and, for finance-sector clients, SEBI SBEB-ready language layered in from the first draft. Typical turnaround is 4 to 8 weeks from INR 19,999.</p>
                </div>
                <p>Mumbai sits closer to the capital-markets regulator than any other Indian startup hub - SEBI's head office is at BKC, a short drive from the finance desks of Lower Parel and the deep-tech labs of Powai - and that proximity changes how the city's companies write their equity plans. A fintech that intends to list in three years cannot afford a scheme that has to be torn up and re-passed when the SEBI (Share Based Employee Benefits and Sweat Equity) Regulations 2021 kick in. So the architecture - pool, cliff, vesting, leaver, acceleration - has to be right the first time, and it has to be drafted with the listed-company regime in view even while the company is still unlisted.</p>
                <p>Patron Accounting LLP has drafted and filed ESOP schemes since 2009 across Private Limited, Public Unlisted and DPIIT-recognised structures, and our Mumbai practice skews heavily toward BKC and Lower Parel finance and fintech houses, the Andheri-Powai SaaS belt seeded by IIT-Bombay, and the Goregaon-Vikhroli media and content corridor. The CA and CS team handles the whole arc in one sprint - policy drafting under Section 62(1)(b) read with Rule 12, IBBI valuation under Rule 11UA, the 21-day EGM notice under Section 101 with Explanatory Statement under Section 102, the Special Resolution at 75 percent majority, MGT-14 within 30 days under Section 117(2), and the Form SH-6 register at the registered office under Rule 12(10).</p>
                <p>Tax and accounting are pre-built into the scheme rather than bolted on later. Section 17(2)(vi) perquisite mechanics, the Section 80-IAC plus Section 192(2C) 48-month deferral (60 months under Income Tax Act 2025 Section 392(3) read with 289(3) from 1 April 2026) for DPIIT plus IMB startups, and Ind AS 102 Black-Scholes expense modelling all sit inside the cap table from grant date. Every Mumbai company is filed through RoC Mumbai on MCA21, and where a marquee PE or growth investor wants the board or compensation committee in a room, those sessions can be run in person across the city.</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="two-column">
            <div class="column-content">
                ...
                <div class="highlight-box" style="margin-top:20px;">
                    ...
                    <p><strong>Double-Trigger Acceleration:</strong> Options vest only if a change of control event is followed by termination without cause within a defined period (typically 12 months). Series B-plus market norm in Mumbai.</p>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>Mumbai's equity-comp work has a distinct flavour. The city's deal flow is dominated by finance and fintech houses out of BKC and Lower Parel, deep-tech and SaaS teams clustered around Powai and Andheri, and media and content ventures along the Goregaon-Vikhroli belt - and because SEBI sits a few hundred metres away in BKC, founders here think about a public listing far earlier than peers in other metros. So while every first-time Private Limited or Public Unlisted company registered with RoC Mumbai is a fit for this engagement, the conversations skew toward two recurring scenarios: a BKC fintech that needs a clean, listing-ready pool before a PE or growth round, and a Powai deep-tech startup that has been handing out equity on email and now needs it regularised before diligence. The eligibility profiles below are the ones we see week to week.</p>
                <ul>
                    <li><strong>BKC and Lower Parel fintechs on an IPO trajectory</strong> - finance-sector founders who want SEBI SBEB-ready definitions and Regulation 18 variation language drafted into the very first unlisted scheme so it migrates cleanly when the company lists.</li>
                    <li><strong>Powai and Andheri SaaS / deep-tech teams regularising verbal equity</strong> - two to four years of equity promised over email or in offer letters that now need consolidating into one Board-approved scheme; backdated effective grant dates are permissible where the Board ratifies them.</li>
                    <li><strong>Founders who must have a pool in place before the term sheet</strong> - Series A leads routinely insist on a 12-15 percent post-money pool ahead of closing; a fintech that walks in without it absorbs the dilution itself at term-sheet stage.</li>
                    <li><strong>First-time founders sizing a pool before the first senior hire</strong> - a seed-stage scheme establishing a 5-12 percent pool with 4-year vesting and a 1-year cliff before the opening batch of 5-25 grants.</li>
                    <li><strong>Media, content and consumer ventures heading into acquirer diligence</strong> - Goregaon-Vikhroli companies whose scheme architecture has to survive acquirer counsel review with no more than a minor comment.</li>
                    <li><strong>Startups recruiting CXOs on equity-weighted offers</strong> - VP Engineering, VP Product, CFO or CTO joining at seed or Series A where performance vesting hooks and acceleration need to be written into the scheme up front.</li>
                    <li><strong>DPIIT-recognised startups granting <a href="/esop-for-founders-and-promoters/mumbai">founder ESOPs</a></strong> - the Rule 12 10-year founder exemption lets promoters and 10 percent-plus directors hold ESOPs in DPIIT-recognised startups (Private Limited or LLP, within 10 years of incorporation, turnover under Rs 100 crore).</li>
                    <li><strong>Companies whose AoA does not yet authorise ESOPs</strong> - an existing AoA silent on ESOPs needs a fresh EGM Special Resolution and MGT-14 filing before the scheme can be adopted.</li>
                    <li><strong>Listed entities under SEBI SBEB Regulations 2021</strong> - listed-company ESOP, RSU, SAR and ESPS schemes governed by the SEBI SBEB Regulations 2021, including grantee class disclosure, Stock Exchange notification and shareholder communication.</li>
                </ul>
...
<section class="content-section" id="services-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>The engagement is priced in stages so a Powai deep-tech team at seed and a BKC fintech walking into a PE round each pay only for the scope they actually need. Because Mumbai's client base is so finance-weighted, two tiers that stay quiet in other cities are the busiest ones here: the Listed Entity SEBI SBEB premium tier, for founders who want RSU and SAR-ready language baked into the first unlisted scheme, and the SHA-coordinated Series A to B tier, where investor counsel out of the city's PE and VC desks expects acceleration and leaver mechanics negotiated against the shareholders' agreement. Everything else - IBBI valuation, an AoA amendment, DPIIT founder-ESOP activation and cross-border mirror-grant coordination for companies with a US or Singapore parent - attaches as an add-on rather than padding the base fee.</p>
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Service</th><th>What We Do</th></tr></thead>
                    <tbody>
                        
                        <tr><td><strong>Seed Stage Scheme</strong></td><td>Pool sizing modelled against current hiring plan, basic scheme drafting (10 to 12 pages) under Section 62(1)(b), Board and EGM kit with 21-day notice under Section 101 and Explanatory Statement under Section 102, MGT-14 filing within 30 days under Section 117(2), Form SH-6 register setup at registered office under Rule 12(10).</td><td>Quoted on scoping call</td></tr>
                        <tr><td><strong>Pre-Series A Scheme</strong></td><td>Seed scope plus cap table modelling with 3 dilution scenarios (no top-up, post-money top-up, pre-money top-up), explicit leaver clause matrix covering 7 categories, sample term sheet reusable across future grants, AoA amendment if needed via fresh EGM.</td><td>Quoted on scoping call</td></tr>
...
<section class="steps-section" id="procedure-section">
    <div class="section-container">
        <div class="section-header" style="text-align:center;margin-bottom:48px;">
            ...
            <p class="section-subtitle" style="text-align:left;max-width:100%;">For a Mumbai company the same eight steps run start to finish in 4 to 8 weeks, with every RoC filing routed through RoC Mumbai on MCA21. The sequence moves from discovery and AoA review, through cap table modelling with 3 dilution scenarios and scheme drafting, into the Board Resolution and 21-day EGM notice, the Special Resolution at 75 percent majority, the MGT-14 filing within 30 days, the IBBI valuation under Rule 11UA, the Form SH-6 register setup and finally the first grant batch. For BKC and Lower Parel companies eyeing a listing, the drafting step also bakes in SEBI SBEB-ready definitions so the scheme need not be torn up later.</p>
        </div>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>When a Powai SaaS founder or a BKC fintech CFO closes this engagement, what lands is an investor-grade file rather than a one-page policy - the kind of pack that a Mumbai PE or VC diligence team can open without follow-up questions. It pairs the governance documents and RoC Mumbai filings with an IBBI valuation, Ind AS 102 working papers and, for the listing-minded finance houses that make up so much of the city's deal flow, scheme language drafted to anticipate the SEBI SBEB transition before it is needed. The eight deliverables that follow are what go into that file.</p>
                ...
                <ul>
                    <li>MGT-14 filing within 30 days of Special Resolution under Section 117(2). Coordinated with <a href="/esop-corporate-filings/mumbai">ESOP Corporate Filings</a> workflow.</li>
                ...
                <ul>
                    ...
                    <li>Coordinated through <a href="/esop-valuation-services/mumbai">ESOP Valuation Services</a>.</li>
                </ul>
                ...
                <ul>
                    ...
                    <li>Coordinated through <a href="/esop-accounting-ind-as-102/mumbai">ESOP Accounting under Ind AS 102</a>.</li>
                </ul>
            ...
            <div class="content-text">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr><td><strong>Under-sizing the pool</strong></td><td>A Powai SaaS team sets a 5 percent pool around today's headcount, burns through it after three senior hires, then has to widen it mid-round with the founders eating the dilution pre-money. The Series A lead - often a Mumbai-based fund - typically wants a 12-15 percent post-money pool, which translates to a Rs 50 lakh to Rs 5 crore founder cost depending on the round valuation.</td><td>Patron models pool against 18-24 month hiring plan with senior CXO bench accounted for explicitly. Pre-Series A pool typically 12-13 percent to absorb Series A 12-15 percent demand without re-top-up. Pool sized at the upper end of the stage range when an early CXO bench is planned.</td></tr>
                        ...
                        <tr><td><strong>Missing accelerated vesting clauses</strong></td><td>BKC and Lower Parel investors at Series B-plus almost always demand double-trigger acceleration. A scheme drafted without acceleration language has to be amended through a fresh Special Resolution and another MGT-14 filing - the 21-day EGM notice plus the 30-day filing window quietly adds 6-8 weeks to a fundraise that is already on the clock.</td><td>Patron drafts acceleration provisions into the original scheme - single-trigger, double-trigger and hybrid 50/100 options with Board discretion to apply. Future-proofs the scheme for Series B and beyond without scheme amendment friction.</td></tr>
                        <tr><td><strong>Exercise window too short</strong></td><td>Default schemes give 30 to 60 days post-termination, forcing employees to either find cash for the exercise price plus perquisite TDS or forfeit. Senior employees in particular lose substantial vested value because they cannot fund <a href="/esop-perquisite-tax-section-17-2-vi/mumbai">Section 17(2)(vi) tax obligation</a> on short timelines.</td><td>Patron drafts tiered exercise window in the scheme - 90 days for IC roles, 6 months for managers, 12 to 24 months for senior leadership. Aligned to standard Indian market practice; protects vested option value while preserving forfeit-on-bad-leaver mechanics.</td></tr>
                        ...
                        <tr><td><strong>IBBI valuation older than 180 days</strong></td><td>Rule 11UA requires IBBI valuation not older than 180 days from exercise date. Stale valuations trigger tax officer reassessment at Section 17(2)(vi) perquisite computation and potential adjustment under transfer pricing principles.</td><td>Patron coordinates <a href="/esop-valuation-services/mumbai">Rule 11UA valuation</a> refresh at every fresh grant batch and at 180-day intervals for exercise events. DCF, NAV or CCA methodology selected for defensibility under tax scrutiny.</td></tr>
                        <tr><td><strong>MGT-14 default under Section 117(2)</strong></td><td>Rs 100 per day after the 30-day filing window under Section 117(2) of Companies Act 2013. Compounding can exceed Rs 25,000 for a 6-month delay plus regulatory friction during subsequent funding diligence.</td><td>Patron filing calendar tracks every Special Resolution against the 30-day MGT-14 deadline. PAS-3 30-day window also tracked under Section 39(5) - Rs 1,000 per day default for private companies up to Rs 25 lakh. End-to-end through <a href="/esop-corporate-filings/mumbai">ESOP Corporate Filings</a> retainer.</td></tr>
            ...
            <div class="content-text">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr><td>AoA amendment (add-on)</td><td>EGM Special Resolution, MGT-14, MoA/AoA print for companies whose existing AoA does not authorise ESOPs</td><td class="table-amount">quoted on a scoping call</td></tr>
                        <tr><td>IBBI valuation (pass-through)</td><td>FMV report under Rule 11UA - DCF/NAV/CCA methodology; valid for 180 days from issue</td><td class="table-amount">quoted on a scoping call</td></tr>
                        <tr><td>Founder ESOP under DPIIT exemption</td><td>DPIIT recognition coordination plus Rule 12 10-year founder exemption activation plus Section 80-IAC tax deferral pathway</td><td class="table-amount">quoted on a scoping call</td></tr>
                        <tr><td>Seed stage scheme</td><td>Pool sizing, basic scheme drafting, Board and EGM kit, MGT-14 within 30 days, SH-6 register setup</td><td class="table-amount">Quoted on scoping call</td></tr>
                        <tr><td>Pre-Series A scheme</td><td>Seed scope plus cap table modelling, leaver clause matrix, sample term sheet, AoA amendment if needed</td><td class="table-amount">Quoted on scoping call</td></tr>
                        <tr><td>Series A to B scheme</td><td>Above plus performance vesting design, single/double/hybrid acceleration triggers, SHA coordination, founder ESOP under DPIIT exemption</td><td class="table-amount">Quoted on scoping call</td></tr>
                        <tr><td>Cross-border mirror grant coordination</td><td>Foreign parent plus Indian subsidiary structure under FEMA OI Rules 2022; OPI classification; LRS design; quoted separately for complex structures</td><td class="table-amount">From INR 19,999</td></tr>
                        <tr><td>Listed entity SEBI SBEB premium</td><td>SEBI SBEB Regulations 2021 alignment - grantee class disclosure, Stock Exchange notification, Regulation 18 variation procedure; quoted separately</td><td class="table-amount">From INR 19,999</td></tr>
                        <tr><td><strong>Patron Accounting Professional Fees</strong></td><td>Standard starting price for Seed Stage ESOP Scheme Design; listed-company SEBI SBEB schemes quoted separately; cross-border structures quoted separately; ESOP filings retainer (MGT-14, PAS-3, MGT-7) available as separate annual engagement under ESOP Corporate Filings</td><td class="table-amount"><strong>From INR 19,999 (Exl GST and Govt. Charges)</strong></td></tr>
...
<section class="why-choose-section" id="benefits-section">
    ...
    <article class="feature-card"><h3>Built for Mumbai PE and VC Diligence</h3><p>The scheme holds up through Series A, B and C due diligence and the diligence-level Q&amp;A that the city's PE and VC counsel run. On a Patron-drafted scheme that counsel typically comes back with one to two minor comments - a clean pass is the standard outcome.</p></article>
    ...
    <article class="feature-card"><h3>SEBI SBEB-Ready From the First Draft</h3><p>With SEBI headquartered in BKC, Mumbai founders think about listing early - so we draft Regulation 18 variation language and grantee-class definitions into the very first unlisted scheme. When the company eventually lists, the scheme migrates to the SEBI SBEB Regulations 2021 regime without a ground-up redraft.</p></article>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p><strong>Who we work with:</strong> ESOP scheme design engagements completed across SaaS, fintech, edtech, healthtech, consumer-tech and B2B startups from Seed through Series B.</p>
                <p><strong>With offices in Pune, Mumbai, Delhi and Gurugram, Patron Accounting serves Mumbai startups establishing first-time ESOP schemes across India - both in-person and remotely. Pan-India remote engagement standard.</strong></p>
            ...
            <div class="content-text">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr><td><strong>Total Cost (3 Years)</strong></td><td>Free upfront + Rs 2 to 5 lakh restatement cost at Series A + founder dilution from pool top-up</td><td>Quoted on scoping call (one-time) + Rs 36,000+ annual compliance retainer through ESOP Corporate Filings</td></tr>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <ul>
                    <li><strong><a href="/esop-services/mumbai">ESOP Services Master Hub</a></strong> - end-to-end ESOP lifecycle services covering all verticals and engagement types; ongoing operational compliance after scheme design including vesting tracking and annual ESOP disclosures.</li>
                    <li><strong><a href="/esop-for-tech-startups/mumbai">ESOP for Tech Startups</a></strong> - tech-vertical scheme design with engineer/CTO pool benchmarks, refresh grants at 24-36 month tenure, performance vesting hooks and hybrid 50/100 acceleration drafted into the scheme at the outset.</li>
                    <li><strong><a href="/esop-for-saas-companies/mumbai">ESOP for SaaS Companies</a></strong> - B2B SaaS-specific design with ARR-linked vesting, sales quota acceleration, CSM NRR linkage and Delaware flip mirror grant structures.</li>
                    <li><strong><a href="/esop-restructuring-underwater-options/mumbai">ESOP Restructuring and Underwater Options</a></strong> - down-round remediation through Repricing, Exchange Program, Top-Up Grants, Vesting Acceleration or Cashout/Buyback for schemes that have gone underwater post-down-round.</li>
                    <li><strong><a href="/esop-valuation-services/mumbai">ESOP Valuation Services</a></strong> - Rule 11UA FMV reports including DCF, NAV and CCA methodologies for grant date, exercise events and modification events; IBBI Registered Valuer engagement.</li>
                    <li><strong><a href="/esop-accounting-ind-as-102/mumbai">ESOP Accounting under Ind AS 102</a></strong> - share-based payment expense recognition over vesting period using Black-Scholes; Schedule III disclosure plus Rule 12(9) Directors Report disclosure pack; group SBP rules for cross-border mirror grants.</li>
                    <li><strong><a href="/esop-corporate-filings/mumbai">ESOP Corporate Filings</a></strong> - ongoing MCA filings retainer covering MGT-14, PAS-3 and MGT-7 for active grant cycles plus annual Directors Report ESOP disclosure under Rule 12(9).</li>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>The same statute book applies in Mumbai as anywhere in India, but two jurisdictional facts shape every engagement here: company filings route through the Registrar of Companies, Mumbai (RoC Mumbai) on MCA21, and SEBI - the listed-company regulator whose SBEB Regulations 2021 a great many Mumbai finance and fintech founders are drafting toward - sits at BKC. The provisions below are the ones a BKC fintech, a Powai SaaS team or a Goregaon media venture is tested against at scheme adoption, at each grant, and again at Series A and listing diligence.</p>
                <ul>
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    ...
                    <p class="faq-expanded__lead">Long-tail answers on first-time ESOP scheme design for Mumbai startups - fees by stage, end-to-end timeline, minimum cliff, scheme document contents, single vs double-trigger acceleration, good vs bad leaver definitions and founder ESOPs under DPIIT 10-year exemption.</p>
                    @include('partials.faq-enquiry-form', ['enquiryLocation' => 'Mumbai'])
                </aside>
                <div class="faq-expanded__list">
                    <div class="faq-expanded__item" id="faq-1">
                        <h3 class="faq-expanded__q">How much does ESOP scheme design cost in Mumbai?</h3>
                        <div class="faq-expanded__a"><p>ESOP scheme design for Mumbai startups starts from INR 19,999 (Exl GST and Govt. Charges). Stage-based scope - Seed through Series B with cap table modelling, leaver matrix and SHA coordination, plus SEBI SBEB-ready definitions for BKC and Lower Parel companies eyeing a listing - is quoted on a free scoping call. IBBI valuation is a third-party pass-through of Rs 25,000 to Rs 75,000. Fees are exclusive of GST.</p></div>
                    </div>
                    ...
                    <div class="faq-expanded__item" id="faq-3">
                        ...
                        <div class="faq-expanded__a"><p>The statutory minimum is one year from the grant date under Rule 12(6)(a) of the Companies (Share Capital and Debentures) Rules 2014. Companies cannot vest any portion of an option grant earlier than 12 months even if the employee resigns or is terminated. Most Mumbai startups follow a 4-year vesting schedule with this 1-year cliff.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-4">
                        <h3 class="faq-expanded__q">Do Mumbai startups need to follow SEBI SBEB Regulations when designing an ESOP?</h3>
                        <div class="faq-expanded__a"><p>Only listed companies must comply with the SEBI (Share Based Employee Benefits and Sweat Equity) Regulations 2021 - grantee class disclosure, compensation committee, trust route rules and Stock Exchange notification. Unlisted Mumbai startups design under Section 62(1)(b) and Rule 12 alone. But because SEBI is headquartered in BKC and many Mumbai founders target a public listing, we draft SBEB-ready definitions and Regulation 18 variation language early so the scheme migrates cleanly to the listed regime later without a full redraft.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-5">
                        <h3 class="faq-expanded__q">What is the difference between single-trigger and double-trigger acceleration?</h3>
                        <div class="faq-expanded__a"><p>Single-trigger acceleration vests all unvested options on a change of control event (acquisition, merger, IPO). Double-trigger acceleration requires both a change of control event AND a termination without cause of the employee within a defined window (typically 12 months). Double-trigger is investor-friendly and now the Series B-plus market norm in Mumbai.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-6">
                        <h3 class="faq-expanded__q">Where do Mumbai companies file ESOP forms and which RoC has jurisdiction?</h3>
                        <div class="faq-expanded__a"><p>Companies with a registered office in Mumbai fall under the Registrar of Companies, Mumbai (RoC Mumbai) and file all ESOP forms on the MCA21 portal. MGT-14 for the Special Resolution is filed within 30 days under Section 117(2) (default Rs 100 per day), and PAS-3 for allotment within 30 days of each exercise under Section 39(5). Form SH-6 is not filed with RoC Mumbai but maintained at the registered office under Rule 12(10), authenticated by the Company Secretary. Patron manages the full RoC Mumbai filing cycle.</p></div>
                    </div>
                    ...
                    <div class="faq-expanded__item" id="faq-8">
                        <h3 class="faq-expanded__q">How is an ESOP scheme designed, step by step?</h3>
                        <div class="faq-expanded__a"><p>Designing an ESOP scheme follows a defined sequence. First, the Articles of Association are reviewed to confirm whether they authorise ESOPs; if they do not, an AoA amendment is carried out. Next comes cap table modelling and pool sizing - typically 10 to 15 percent of post-money equity for Mumbai startups. The scheme is then drafted under Section 62(1)(b) of the Companies Act 2013, covering the pool, 4-year vesting with the Rule 12(6)(a) 1-year statutory cliff, exercise price (at or below FMV but never below face value), the leaver matrix (good leaver vs bad leaver), single or double-trigger acceleration and clawback. The Board Resolution is then passed and a 21-day EGM notice is issued under Section 101. At the EGM, the Special Resolution is passed by a 75 percent majority. MGT-14 is filed within 30 days under Section 117(2) (default Rs 100 per day). The IBBI valuation is obtained under Rule 11UA (valid for 180 days). The Form SH-6 register is maintained at the registered office under Rule 12(10) and authenticated by the Company Secretary. Where the company holds DPIIT recognition under Notification GSR 127(E) 2019, founders and 10 percent-plus directors can also be granted ESOPs through the Rule 12 10-year exemption. Section 17(2)(vi) perquisite tax applies on exercise; a 48-month deferral is available to DPIIT plus IMB startups under Section 80-IAC read with Section 192(2C) (60 months under the Income Tax Act 2025 from 1 April 2026). Under Ind AS 102, the share-based payment expense is recognised using Black-Scholes over the vesting period. Patron completes the entire process in 4 to 8 weeks, including the sample term sheet, scheme document, Board kit, EGM kit, MGT-14, IBBI valuation, SH-6 setup and the first Grant Letter. Call <a href="tel:+919459456700" style="color:inherit;">+91 945 945 6700</a>.</p></div>
                    </div>
                </div>
            </div>
            ...
            <div class="highlight-box" style="margin-top:32px;">
                ...
                <ul>
                    <li><strong>What is a typical ESOP pool size for a startup?</strong> Most Mumbai startups reserve 10 to 15 percent of post-money equity, with 5 to 10 percent at seed stage rising to as much as 18 percent by Series B.</li>
                    <li><strong>Can the exercise price be set at the face value of the share?</strong> Yes - the Board may fix the exercise price at or below fair market value, but it can never go below the face value of the share.</li>
                    <li><strong>Which MCA forms are filed while implementing the scheme?</strong> MGT-14 is filed within 30 days of the board and special resolutions under Section 117(2), PAS-3 within 30 days of allotment on first exercise under Section 39(5), and the SH-6 register is maintained at the registered office under Rule 12(10).</li>
                    <li><strong>Is shareholder approval mandatory for the scheme?</strong> Yes - a Special Resolution passed by a 75 percent majority is required under Section 62(1)(b), and private companies cannot use an ordinary resolution for a fresh share issue under ESOP.</li>
                    <li><strong>What is the penalty for filing MGT-14 after the deadline?</strong> A default attracts Rs 100 per day under Section 117(2) read with Section 450, accruing once the 30-day filing window has lapsed.</li>
                    <li><strong>What happens if options are granted before the EGM Special Resolution?</strong> Such a grant is legally invalid under Section 62(1)(b), the RoC may set it aside, and Series A diligence will flag it as a material restatement.</li>
                </ul>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text" style="text-align:left;">
                ...
                <p style="color:rgba(255,255,255,0.92);">Ready to design your first ESOP scheme? <strong><a href="tel:+919459456700" style="color:inherit;text-decoration:underline;">Call us at +91 945 945 6700</a></strong> or <strong><a href="https://wa.me/919459456700?text=Hi%2C%20I%20would%20like%20a%20free%20consultation%20about%20ESOP%20services." target="_blank" rel="noopener" style="color:inherit;text-decoration:underline;">WhatsApp us</a></strong> for a free scheme design scoping call. Response within 2 hours. 4 to 8 week end-to-end timeline from discovery to first Grant Letter.</p>
...
<section class="content-section">
    <div class="content-container"><div class="text-content">
        ...
        <div class="content-text"><p>Start with the national ESOP Scheme Design service, then explore complementary ESOP services across India.</p>
        <ul>
                    <li><strong><a href="/esop-scheme-design">ESOP Scheme Design in India</a></strong> - the national parent service</li>
...
<section class="content-section" style="padding:48px 32px;background:var(--gray-50);">
    <div class="content-container"><div class="text-content">
        <h2 class="section-title">ESOP Scheme Design by City</h2>
        <div class="content-text"><p>Available across our four office cities. You are viewing the Mumbai page.</p></div>
        <div class="pa-city-grid"><a href="/esop-scheme-design/pune" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Pune</div><div class="pa-card-sub">Maharashtra</div></div></a><span class="pa-city-card" aria-current="page" style="border-color:var(--orange);background:#FFF7F2;cursor:default;position:relative;"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Mumbai</div><div class="pa-card-sub">Maharashtra</div></div><span style="position:absolute;top:10px;right:12px;font-size:10px;font-weight:700;color:var(--orange);letter-spacing:.04em;">YOU'RE HERE</span></span><a href="/esop-scheme-design/delhi" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Delhi</div><div class="pa-card-sub">Delhi NCR</div></div></a><a href="/esop-scheme-design/gurugram" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Gurugram</div><div class="pa-card-sub">Haryana</div></div></a></div>
    </div></div>
</section>
