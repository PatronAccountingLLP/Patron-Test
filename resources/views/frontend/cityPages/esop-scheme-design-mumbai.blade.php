        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'Seed Stage ESOP Scheme',
                    'options'  => [
                        'Seed Stage ESOP Scheme' => 'Seed Stage ESOP Scheme',
                        'Pre-Series A ESOP Scheme' => 'Pre-Series A ESOP Scheme',
                        'Series A to B ESOP Scheme' => 'Series A to B ESOP Scheme',
                        'IBBI Valuation under Rule 11UA' => 'IBBI Valuation under Rule 11UA',
                        'AoA Amendment for ESOP' => 'AoA Amendment for ESOP',
                        'Founder ESOP under DPIIT Exemption' => 'Founder ESOP under DPIIT Exemption',
                        'Performance Vesting Drafting' => 'Performance Vesting Drafting',
                        'Sample Term Sheet Library' => 'Sample Term Sheet Library',
                        'Accelerated Vesting Clauses' => 'Accelerated Vesting Clauses',
                        'Leaver Matrix Drafting' => 'Leaver Matrix Drafting',
                        'Other' => 'Other',
                    ],
                ])
            </div>
