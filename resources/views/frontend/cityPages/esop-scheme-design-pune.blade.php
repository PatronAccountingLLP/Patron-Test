...
@section('meta')
    <title>Pune ESOP Scheme Design for IT and SaaS Startup Teams</title>
    <meta name="description" content="Design a board-ready ESOP for your Hinjewadi or Kharadi startup, from pool sizing to MGT-14 filing with RoC Pune, in 4 to 8 weeks from INR 19,999.">
    <meta name="keywords" content="ESOP Scheme Design Pune, ESOP Scheme Design in Pune, ESOP Scheme Design services in Pune, ESOP services Pune, ESOP Scheme Design cost Pune, ESOP Scheme Design consultants Pune, CA firm for ESOP Scheme Design Pune, ESOP advisory Pune">
    <link rel="canonical" href="/esop-scheme-design/pune">
    <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1">
    <meta property="og:title" content="Pune ESOP Scheme Design for IT and SaaS Startup Teams | Patron Accounting">
    <meta property="og:description" content="Design a board-ready ESOP for your Hinjewadi or Kharadi startup, from pool sizing to MGT-14 filing with RoC Pune, in 4 to 8 weeks from INR 19,999.">
...
@section('schema')    <script type="application/ld+json">{
  ...
  "@graph": [
    {
      "@type": "Service",
      "@id": "https://www.patronaccounting.com/esop-scheme-design/pune#service",
      "name": "ESOP Scheme Design in Pune",
      "url": "https://www.patronaccounting.com/esop-scheme-design/pune",
      ...
      "hasOfferCatalog": {
        "@type": "OfferCatalog",
        "name": "ESOP Scheme Design Engagement",
        "itemListElement": [
          {
            "@type": "Offer",
            "name": "ESOP Scheme Design (Startup)",
            "priceCurrency": "INR",
            "price": "19999",
            "description": "Pool sizing, scheme drafting under Section 62(1)(b), Board and EGM kit, MGT-14 filing within 30 days with RoC Pune on MCA21, Form SH-6 register setup, sample term sheet. Starting fee; final fee depends on stage and scheme complexity, confirmed on a free scoping call."
          },
          {
            "@type": "Offer",
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://www.patronaccounting.com/esop-scheme-design/pune#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
        ...
        },
        {
          ...
          "position": 4,
          "name": "ESOP Scheme Design in Pune",
          "item": "https://www.patronaccounting.com/esop-scheme-design/pune"
        }
      ]
    },
    {
      ...
      "@id": "https://www.patronaccounting.com/esop-scheme-design/pune#localbusiness",
      "name": "Patron Accounting LLP - ESOP Scheme Design, Pune",
      "url": "https://www.patronaccounting.com/esop-scheme-design/pune",
      "telephone": "+91-9459456700",
      "priceRange": "INR 19,999 onwards",
      "areaServed": {
        "@type": "City",
        "name": "Pune"
      },
    ...
    {
      "@type": "FAQPage",
      "@id": "https://www.patronaccounting.com/esop-scheme-design/pune#faq",
      "datePublished": "2026-06-24T08:00:00+05:30",
      "dateModified": "2026-06-24T08:00:00+05:30",
      "mainEntity": [
        {
          "@type": "Question",
          "name": "How much does ESOP scheme design cost in Pune?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "ESOP scheme design for Pune startups starts from INR 19,999 (Exl GST and Govt. Charges). Stage-based scope - Seed, Pre-Series A and Series A to B with cap table modelling, leaver matrix, performance vesting and SHA coordination - is quoted on a free scoping call. IBBI valuation is a third-party pass-through of Rs 25,000 to Rs 75,000. Fees are exclusive of GST."
          }
        },
        {
          "@type": "Question",
        ...
        {
          "@type": "Question",
          "name": "What is the process for designing an ESOP scheme?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Designing an ESOP scheme follows this process. First, the AoA is reviewed to confirm whether it authorises ESOPs; if it does not, an amendment is required. Next come cap table modelling and pool sizing - typically 10 to 15 percent of post-money equity for Indian startups. The scheme is then drafted under Section 62(1)(b) of the Companies Act 2013, covering the pool, 4-year vesting with the Rule 12(6)(a) 1-year statutory cliff, exercise price (at or below FMV but not below face value), the leaver matrix (good leaver vs bad leaver), single or double-trigger acceleration and clawback. The Board Resolution is then passed and a 21-day EGM notice is issued under Section 101. At the EGM, a Special Resolution is passed at a 75 percent majority. MGT-14 is filed within 30 days under Section 117(2) (default Rs 100 per day). IBBI valuation is obtained under Rule 11UA (valid for 180 days). The Form SH-6 register is maintained at the registered office under Rule 12(10) and authenticated by the Company Secretary. Where the company holds DPIIT recognition under Notification GSR 127(E) 2019, founders and 10 percent-plus directors may also receive ESOPs through the Rule 12 10-year exemption. The Section 17(2)(vi) perquisite tax applies at exercise; a 48-month deferral under Section 80-IAC plus Section 192(2C) is available to DPIIT plus IMB certified startups (60 months under the Income Tax Act 2025 from 1 April 2026). Under Ind AS 102, the share-based payment expense is recognised over the vesting period using Black-Scholes. Patron completes the entire process in 4 to 8 weeks, including the sample term sheet, scheme document, Board kit, EGM kit, MGT-14, IBBI valuation, SH-6 setup and the first Grant Letter. Call +91 945 945 6700."
          }
        }
      ]
    }
...
/* Align term/description list rows: give the leading <strong> a fixed
           column so every description starts at the same x (was ragged because
           the term and the description are separate flex items). */
        #who-section ul li:not(.nav-item) > strong:first-child {
            flex: 0 0 300px;
            max-width: 300px;
        }
@media (max-width: 768px) {
            section ul li:not(.nav-item) { flex-wrap: wrap; }
            #who-section ul li:not(.nav-item) > strong:first-child { flex-basis: 100%; max-width: 100%; }
        }
</style>
<main>
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-4 private-registration-heading">
                        ESOP Scheme Design in Pune
                    </h1>

                    <p class="mb-4" style="font-size:16px;color:var(--text-secondary);max-width:640px;">Board-ready ESOP schemes for Hinjewadi, Kharadi and Baner-Balewadi startups - pool to MGT-14 filing with RoC Pune on MCA21, in 4 to 8 weeks from INR 19,999.</p>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Fees:</span> Starting from INR 19,999 (Exl GST and Govt. Charges); stage-based scope (Seed to Series B) and complexity quoted on a free scoping call; IBBI valuation pass-through from Rs 25,000</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="https://wa.me/919459456700?text=Hello%2C%20I%20just%20visited%20your%20ESOP%20Scheme%20Design%20in%20Pune%20page.%20I%20would%20like%20to%20know%20more%20about%20it." target="_blank" class="btn-sample text-decoration-none" rel="noopener">
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p><strong>ESOP scheme design for Pune startups:</strong> Patron works with companies across Pune's startup and IT-SaaS clusters - Hinjewadi and Magarpatta IT parks, the Kharadi and Viman Nagar startup hubs and the Baner-Balewadi tech corridor. Companies registered in Pune file their ESOP forms (MGT-14, PAS-3) with the Registrar of Companies, Pune (RoC Pune) on the MCA21 portal, and we manage that jurisdiction end to end. Engagements run remotely with scheduled video reviews, so a founder in Hinjewadi or Baner gets the same CA and CS team and the same 4 to 8 week timeline as our national clients, with optional in-person board or compensation-committee sessions in Pune when needed.</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="two-column">
            <div class="column-content">
                ...
                <div class="content-text what-is-definition">
                    ...
                    <p>When a Hinjewadi SaaS company hires its first VP Engineering, or a Kharadi product startup wants to convert two years of verbal equity promises into something an investor can read, the document that does the work is the ESOP scheme. ESOP scheme design is the engagement that drafts, gets approved and files that master Employee Stock Option Plan policy under Section 62(1)(b) of the Companies Act 2013, read with Rule 12 of the Companies (Share Capital and Debentures) Rules 2014. The deliverable is a Board-and-shareholder-approved scheme document that fixes pool size, eligibility, vesting schedule, cliff, exercise price method, leaver clauses, accelerated vesting triggers and administrative authority - then lodged with the Registrar of Companies (RoC Pune) through Form MGT-14 within 30 days of the special resolution under Section 117(2).</p>
                    <p>Pune's startup economy runs on two distinct engines - the IT and SaaS clusters of Hinjewadi, Magarpatta, Kharadi and the Baner-Balewadi corridor, and the Chakan-MIDC manufacturing belt on the city's edge - and a scheme has to fit whichever one the company sits in. Five parameters carry most of that weight. Pool size comes first (10 to 15 percent of post-money equity is the Indian norm, 5 to 10 percent at seed, up to 18 percent by Series B). Then the vesting schedule, with its 4-year time-based default and the Rule 12(6)(a) statutory 1-year cliff. Then exercise price method (at or below FMV but never below face value), the leaver matrix that separates good leavers from bad leavers, and the acceleration triggers - single, double or hybrid 50/100 on a change of control. For a Viman Nagar engineering team or a Chakan-area equipment maker, those five choices decide how much founder equity is left standing after each round.</p>
                    <p>Three regimes wrap around the core scheme. DPIIT-recognised startups - common among Pune's IT-SaaS founders - get a 10-year founder ESOP exemption under Rule 12, letting <a href="/esop-for-founders-and-promoters/pune">promoters and 10 percent-plus directors</a> hold grants the Companies Act default would otherwise exclude. Listed entities fall under SEBI (Share Based Employee Benefits and Sweat Equity) Regulations 2021, which govern ESOP, RSU, SAR and ESPS schemes. And <a href="/esop-for-foreign-parent-indian-subsidiary/pune">where a foreign parent grants to its Pune subsidiary</a>, FEMA Overseas Investment Rules 2022 govern the mirror grant.</p>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>Pune's equity-design demand splits cleanly along two lines. On one side sit the product engineering and SaaS teams clustered in Hinjewadi Phase 1-3, Magarpatta, Kharadi and Viman Nagar, racing to lock a senior engineering or product leader into a written grant before a venture round prices the cap table; on the other sit the Chakan and MIDC manufacturing firms extending equity to a plant or operations leadership bench for the very first time. Both file at RoC Pune, both need a scheme that survives counsel review, and both arrive at this engagement at different stages - pre-revenue bootstrapped through to Series B. A meaningful share of the Pune cohort already carries DPIIT recognition, so the founder-grant and <a href="/esop-startup-tds-deferral-section-192-1c/pune">Section 80-IAC deferral routes</a> come up routinely; listed Pune-region issuers fall under the SEBI SBEB Regulations 2021 premium track. The recurring client profiles are set out below.</p>
                <ul>
                    <li><strong>Hinjewadi/Kharadi founders heading into a priced round</strong> - Series A investors typically demand a 12-15 percent post-money pool established before funding; a SaaS team that arrives at the term sheet without one absorbs the dilution itself at the worst possible moment.</li>
                    <li><strong>First-time founders ahead of their first senior hire</strong> - Seed-stage scheme establishing a 5-12 percent pool with 4-year vesting and a 1-year cliff before the first 5-25 grants go out.</li>
                    <li><strong>SaaS and product teams negotiating a CXO offer</strong> - VP Engineering, VP Product, CFO or CTO joining at Seed/Series A on equity-weighted terms that need performance-vesting hooks and accelerated vesting written into the scheme.</li>
                    <li><strong>Founders/CFOs regularising scattered equity promises</strong> - 2-4 years of informal offers to early employees folded into a clean Board-approved scheme; backdated effective grant dates permitted where the Board ratifies.</li>
                    <li><strong>DPIIT-recognised Pune startups granting founder ESOPs</strong> - the Rule 12 10-year founder exemption allows ESOPs to promoters and 10 percent-plus directors in DPIIT-recognised startups (Private Limited or LLP, 10 years from incorporation, turnover under Rs 100 crore).</li>
                    <li><strong>Chakan/MIDC and other companies amending AoA first</strong> - an existing AoA that does not authorise ESOPs requires a fresh EGM Special Resolution with MGT-14 filing before any scheme can be adopted.</li>
                    <li><strong>Teams facing Series A or M&amp;A diligence</strong> - clean scheme architecture clears Series A through C diligence and acquirer counsel review, typically with a single minor comment.</li>
                    <li><strong>Listed Pune-region entities under SEBI SBEB Regulations 2021</strong> - listed-company ESOP, RSU, SAR and ESPS schemes governed by SEBI SBEB Regulations 2021 with grantee class disclosure, Stock Exchange notification and shareholder communication.</li>
                </ul>
...
<section class="content-section" id="services-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>The engagement is tiered by funding stage, not by a one-size fee, so a bootstrapped Baner-Balewadi startup and a Series B Hinjewadi SaaS scale-up each pay for the depth they actually use. A pre-revenue founder usually starts on the Seed Stage Scheme; once a priced round is on the horizon the work moves up to Pre-Series A or Series A to B scope, where the cap table modelling, performance-vesting design and acceleration drafting carry the weight. Around that core sit the add-ons - IBBI valuation, an AoA amendment, DPIIT founder-ESOP activation, and for a Chakan manufacturer with an overseas parent the cross-border mirror-grant coordination - each switched on only where the company's structure calls for it.</p>
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Service</th><th>What We Do</th></tr></thead>
                    <tbody>
                        
                        <tr><td><strong>Seed Stage Scheme</strong></td><td>Pool sizing modelled against current hiring plan, basic scheme drafting (10 to 12 pages) under Section 62(1)(b), Board and EGM kit with 21-day notice under Section 101 and Explanatory Statement under Section 102, MGT-14 filing within 30 days under Section 117(2), Form SH-6 register setup at registered office under Rule 12(10).</td><td>From INR 19,999</td></tr>
...
<section class="steps-section" id="procedure-section">
    <div class="section-container">
        <div class="section-header" style="text-align:center;margin-bottom:48px;">
            ...
            <p class="section-subtitle" style="text-align:left;max-width:100%;">From a Hinjewadi SaaS founder's first discovery call to the first signed Grant Letter, the Patron workflow runs 4 to 8 weeks and moves through eight checkpoints: discovery and AoA review, cap table modelling with 3 dilution scenarios, scheme drafting, the Board Resolution and 21-day EGM notice, the Special Resolution at 75 percent majority, MGT-14 filing within 30 days, the Rule 11UA IBBI valuation, Form SH-6 register setup and the first grant batch. RoC Pune filings are routed on MCA21.</p>
        </div>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>What a Pune founder walks away with is not a single PDF policy but an audit-ready binder. A Kharadi SaaS team or a Chakan manufacturer receives the governance set, the MCA filings lodged with RoC Pune on MCA21, the IBBI valuation, the Ind AS 102 working papers, and - the piece that pays for itself - reusable templates the in-house team can run on every subsequent grant without going back to counsel. The eight deliverables that make up that binder are itemised below.</p>
                ...
                <ul>
                    <li>MGT-14 filing within 30 days of Special Resolution under Section 117(2). Coordinated with <a href="/esop-corporate-filings/pune">ESOP Corporate Filings</a> workflow.</li>
...
<section class="content-section" id="challenges-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>The scheme defects that turn up in Pune engagements are rarely complicated - they are the predictable shortcuts a Hinjewadi or Magarpatta team takes at seed stage to ship a scheme over a weekend, which then surface as restatement risk when Series A counsel reopens the documents or when a senior product hire negotiates the fine print of an acceleration clause. An under-sized pool, woolly leaver language and a missing acceleration provision lead the list. Each row below pairs the mistake with the bill it eventually lands and the drafting decision Patron takes upfront to avoid it.</p>
                <div class="table-responsive-wrapper">
                <table>
                    ...
                    <tbody>
                        ...
                        <tr><td><strong>MGT-14 default under Section 117(2)</strong></td><td>Rs 100 per day after the 30-day filing window under Section 117(2) of Companies Act 2013. Compounding can exceed Rs 25,000 for a 6-month delay plus regulatory friction during subsequent funding diligence.</td><td>Patron filing calendar tracks every Special Resolution against the 30-day MGT-14 deadline. PAS-3 30-day window also tracked under Section 39(5) - Rs 1,000 per day default for private companies up to Rs 25 lakh. End-to-end through <a href="/esop-corporate-filings/pune">ESOP Corporate Filings</a> retainer.</td></tr>
            ...
            <div class="content-text">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr><td>Founder ESOP under DPIIT exemption</td><td>DPIIT recognition coordination plus Rule 12 10-year founder exemption activation plus Section 80-IAC tax deferral pathway</td><td class="table-amount">Quoted on scoping call</td></tr>
                        <tr><td>Seed stage scheme</td><td>Pool sizing, basic scheme drafting, Board and EGM kit, MGT-14 within 30 days, SH-6 register setup</td><td class="table-amount">From INR 19,999</td></tr>
                        ...
                        <tr><td>Cross-border mirror grant coordination</td><td>Foreign parent plus Indian subsidiary structure under FEMA OI Rules 2022; OPI classification; LRS design; quoted separately for complex structures</td><td class="table-amount">Quoted separately</td></tr>
                        <tr><td>Listed entity SEBI SBEB premium</td><td>SEBI SBEB Regulations 2021 alignment - grantee class disclosure, Stock Exchange notification, Regulation 18 variation procedure; quoted separately</td><td class="table-amount">Quoted separately</td></tr>
                        <tr><td><strong>Patron Accounting Professional Fees</strong></td><td>Starting price for ESOP Scheme Design for Pune startups; stage-based scope (Seed / Pre-Series A / Series A to B) and listed-company SEBI SBEB or cross-border structures are quoted on a free scoping call; ESOP filings retainer (MGT-14, PAS-3, MGT-7) available as separate annual engagement under ESOP Corporate Filings</td><td class="table-amount"><strong>Starting from INR 19,999 (Exl GST and Govt. Charges)</strong></td></tr>
...
<section class="why-choose-section" id="benefits-section">
    ...
    <article class="feature-card"><h3>One Pune Team: CA + CS + Valuation + Tax</h3><p>A Hinjewadi or Chakan founder deals with a single team - CA, CS, valuation and tax specialists with named-partner accountability under one engagement, not four firms passing files between them. End-to-end delivery from AoA review through the first Grant Letter in 4 to 8 weeks.</p></article>
    <article class="feature-card"><h3>Built to Clear Investor Diligence</h3><p>The scheme is drafted to stand up to Series A, B and C due diligence and diligence-level Q&amp;A. On Patron schemes, investor counsel typically returns just one or two minor comments - a clean diligence pass is the standard outcome, not the exception.</p></article>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p><strong>Who we work with:</strong> ESOP scheme design engagements completed across SaaS, fintech, edtech, healthtech, consumer-tech and B2B startups from Seed through Series B, for companies based in Pune and across India.</p>
...
<section class="content-section" id="comparison-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>A free online template will get a Baner founder to a signed scheme over a weekend - and then cost two to five lakh in restatement when the Series A investor's counsel reopens it. The economics only look favourable until the first priced round. The dimension-by-dimension comparison below shows where a generic template and a Patron custom-designed scheme diverge, from pool sizing through Ind AS 102 modelling to the three-year total cost of ownership.</p>
                <div class="table-responsive-wrapper">
                <table>
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <tr><td><strong>Total Cost (3 Years)</strong></td><td>Free upfront + Rs 2 to 5 lakh restatement cost at Series A + founder dilution from pool top-up</td><td>From INR 19,999 one-time + Rs 36,000+ annual compliance retainer through ESOP Corporate Filings</td></tr>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <ul>
                    <li><strong><a href="/esop-services/pune">ESOP Services Master Hub</a></strong> - end-to-end ESOP lifecycle services covering all verticals and engagement types; ongoing operational compliance after scheme design including vesting tracking and annual ESOP disclosures.</li>
                    ...
                    <li><strong><a href="/esop-restructuring-underwater-options/pune">ESOP Restructuring and Underwater Options</a></strong> - down-round remediation through Repricing, Exchange Program, Top-Up Grants, Vesting Acceleration or Cashout/Buyback for schemes that have gone underwater post-down-round.</li>
                    <li><strong><a href="/esop-valuation-services/pune">ESOP Valuation Services</a></strong> - Rule 11UA FMV reports including DCF, NAV and CCA methodologies for grant date, exercise events and modification events; IBBI Registered Valuer engagement.</li>
                    ...
                    <li><strong><a href="/esop-corporate-filings/pune">ESOP Corporate Filings</a></strong> - ongoing MCA filings retainer covering MGT-14, PAS-3 and MGT-7 for active grant cycles plus annual Directors Report ESOP disclosure under Rule 12(9).</li>
...
<section class="content-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>Every Pune ESOP scheme Patron drafts sits on the same statutory spine - the Companies Act 2013 and its Rule 12, the Income Tax Act provisions on perquisite tax and deferral, Rule 11UA valuation, the SEBI SBEB Regulations for listed entities, and Ind AS 102 for accounting. Pune-registered companies file the resulting forms with RoC Pune on MCA21. The full list of statutes, Sections, Rules and forms referenced across this engagement is set out below.</p>
                <ul>
    ...
    <div class="content-container">
        <div class="text-content">
            <div class="faq-expanded">
                ...
                <div class="faq-expanded__list">
                    <div class="faq-expanded__item" id="faq-1">
                        <h3 class="faq-expanded__q">How much does ESOP scheme design cost in Pune?</h3>
                        <div class="faq-expanded__a"><p>ESOP scheme design for Pune startups starts from INR 19,999 (Exl GST and Govt. Charges). Stage-based scope - Seed, Pre-Series A and Series A to B with cap table modelling, leaver matrix, performance vesting and SHA coordination - is quoted on a free scoping call. IBBI valuation is a third-party pass-through of Rs 25,000 to Rs 75,000. Fees are exclusive of GST.</p></div>
                    </div>
                    ...
                    <div class="faq-expanded__item" id="faq-8">
                        <h3 class="faq-expanded__q">What is the process for designing an ESOP scheme?</h3>
                        <div class="faq-expanded__a"><p>Designing an ESOP scheme follows this process. First, the AoA is reviewed to confirm whether it authorises ESOPs; if it does not, an amendment is required. Next come cap table modelling and pool sizing - typically 10 to 15 percent of post-money equity for Indian startups. The scheme is then drafted under Section 62(1)(b) of the Companies Act 2013, covering the pool, 4-year vesting with the Rule 12(6)(a) 1-year statutory cliff, exercise price (at or below FMV but not below face value), the leaver matrix (good leaver vs bad leaver), single or double-trigger acceleration and clawback. The Board Resolution is then passed and a 21-day EGM notice is issued under Section 101. At the EGM, a Special Resolution is passed at a 75 percent majority. MGT-14 is filed within 30 days under Section 117(2) (default Rs 100 per day). IBBI valuation is obtained under Rule 11UA (valid for 180 days). The Form SH-6 register is maintained at the registered office under Rule 12(10) and authenticated by the Company Secretary. Where the company holds DPIIT recognition under Notification GSR 127(E) 2019, founders and 10 percent-plus directors may also receive ESOPs through the Rule 12 10-year exemption. The Section 17(2)(vi) perquisite tax applies at exercise; a 48-month deferral under Section 80-IAC plus Section 192(2C) is available to DPIIT plus IMB certified startups (60 months under the Income Tax Act 2025 from 1 April 2026). Under Ind AS 102, the share-based payment expense is recognised over the vesting period using Black-Scholes. Patron completes the entire process in 4 to 8 weeks, including the sample term sheet, scheme document, Board kit, EGM kit, MGT-14, IBBI valuation, SH-6 setup and the first Grant Letter. Call <a href="tel:+919459456700" style="color:inherit;">+91 945 945 6700</a>.</p></div>
                    </div>
                </div>
            </div>
            ...
            <div class="highlight-box" style="margin-top:32px;">
                ...
                <ul>
                    <li><strong>What is a typical ESOP pool size for a startup?</strong> Most Indian startups reserve 10 to 15 percent of post-money equity, with 5 to 10 percent at seed stage rising to as much as 18 percent by Series B.</li>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text" style="text-align:left;">
                ...
                <p style="color:rgba(255,255,255,0.92);">Ready to design your first ESOP scheme? <strong><a href="tel:+919459456700" style="color:#fff;">Call us at +91 945 945 6700</a></strong> or <strong><a href="https://wa.me/919459456700?text=Hello%2C%20I%20just%20visited%20your%20ESOP%20Scheme%20Design%20in%20Pune%20page.%20I%20would%20like%20to%20know%20more%20about%20it." target="_blank" rel="noopener" style="color:#fff;">WhatsApp us</a></strong> for a free scheme design scoping call. Response within 2 hours. 4 to 8 week end-to-end timeline from discovery to first Grant Letter.</p>

            </div>
            <div style="display:flex;gap:14px;flex-wrap:wrap;margin-top:24px;">
                <a href="tel:+919459456700" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:var(--orange);color:#fff;border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#128222; Call +91 945 945 6700</a>
                <a href="https://wa.me/919459456700?text=Hello%2C%20I%20just%20visited%20your%20ESOP%20Scheme%20Design%20in%20Pune%20page.%20I%20would%20like%20to%20know%20more%20about%20it." target="_blank" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:#25D366;color:#fff;border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;" rel="noopener">&#128172; WhatsApp Us</a>
...
<section class="content-section" style="padding:48px 32px;background:var(--gray-50);">
    <div class="content-container"><div class="text-content">
        ...
        <div class="pa-city-grid"><span class="pa-city-card" aria-current="page" style="border-color:var(--orange);background:#FFF7F2;cursor:default;position:relative;"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Pune</div><div class="pa-card-sub">Maharashtra</div></div><span style="position:absolute;top:10px;right:12px;font-size:10px;font-weight:700;color:var(--orange);letter-spacing:.04em;">YOU'RE HERE</span></span><a href="/esop-scheme-design/mumbai" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Mumbai</div><div class="pa-card-sub">Maharashtra</div></div></a><a href="/esop-scheme-design/delhi" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Delhi</div><div class="pa-card-sub">Delhi NCR</div></div></a><a href="/esop-scheme-design/gurugram" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Gurugram</div><div class="pa-card-sub">Haryana</div></div></a></div>
    </div></div>
</section>
