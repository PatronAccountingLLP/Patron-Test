...
@section('meta')
    <title>Delhi ESOP Buyback & Liquidity Structuring for Startups</title>
    <meta name="description" content="Delhi founders structure compliant ESOP buybacks and secondary sales under Companies Act Section 68, with capital gains and FC-TRS support from INR 24,999.">
    <meta name="keywords" content="ESOP Secondary Sale Advisory Delhi, ESOP Secondary Sale Advisory in Delhi, ESOP Secondary Sale Advisory services in Delhi, ESOP services Delhi, ESOP Secondary Sale Advisory cost Delhi, ESOP Secondary Sale Advisory consultants Delhi, CA firm for ESOP Secondary Sale Advisory Delhi, ESOP advisory Delhi">
    <link rel="canonical" href="/esop-secondary-sale-advisory/delhi">
    <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1">
    <meta property="og:title" content="Delhi ESOP Buyback & Liquidity Structuring for Startups | Patron Accounting">
    <meta property="og:description" content="Delhi founders structure compliant ESOP buybacks and secondary sales under Companies Act Section 68, with capital gains and FC-TRS support from INR 24,999.">
...
@section('schema')    <script type="application/ld+json">{
  ...
  "@graph": [
    {
      "@type": "Service",
      "@id": "https://www.patronaccounting.com/esop-secondary-sale-advisory/delhi#service",
      "name": "ESOP Secondary Sale and Buyback Advisory",
      "url": "https://www.patronaccounting.com/esop-secondary-sale-advisory/delhi",
        ...
        "itemListElement": [
          {
            ...
            "priceCurrency": "INR",
            "price": "24999",
            "description": "End-to-end secondary program engagement - vehicle diagnostic, Rule 11UA FMV coordination, tender offer or buyback execution, per-employee tax planning; stage-based scope quoted on a free scoping call"
          }
        ]
      }
    },
    {
      "@type": "BreadcrumbList",
      "@id": "https://www.patronaccounting.com/esop-secondary-sale-advisory/delhi#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
        ...
        },
        {
          ...
          "position": 4,
          "name": "ESOP Secondary Sale and Buyback Advisory",
          "item": "https://www.patronaccounting.com/esop-secondary-sale-advisory/delhi"
        }
      ]
    },
    {
      ...
      "@id": "https://www.patronaccounting.com/esop-secondary-sale-advisory/delhi#localbusiness",
      "name": "Patron Accounting LLP - ESOP Secondary Sale Advisory, Delhi",
      "url": "https://www.patronaccounting.com/esop-secondary-sale-advisory/delhi",
    ...
    {
      "@type": "FAQPage",
      "@id": "https://www.patronaccounting.com/esop-secondary-sale-advisory/delhi#faq",
      ...
      "mainEntity": [
        ...
        {
          "@type": "Question",
          "name": "What is the tax on ESOP secondary sale in Delhi?",
          "acceptedAnswer": {
            "@type": "Answer",
        ...
        <div class="row align-items-center">
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-4 private-registration-heading">
                        ESOP Secondary Sale and Buyback Advisory in Delhi
                    </h1>

                    <p class="mb-4" style="font-size:17px;line-height:1.6;color:var(--text-secondary);">For RoC Delhi-registered companies in the Nehru Place, Connaught Place and Saket-Aerocity belt - and their resident and NRI investors - we structure tender offers and Section 68 buybacks right next to the MCA head office.</p>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Fees:</span> From INR 24,999/project (Exl GST and Govt. Charges)</p>
                        </div>
                    </div>

                    <p class="mb-4 fw-bold" style="color: var(--blue); font-size: 15px;">Tender Offers + Buybacks for Nehru Place, Saket and Aerocity Startups | RoC Delhi | Near MCA HQ | 10,000+ Businesses Served | 4.9 Google Rating | 15+ Years</p>
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'Liquidity Vehicle Diagnostic',
                    'options'  => [
                        'Liquidity Vehicle Diagnostic' => 'Liquidity Vehicle Diagnostic',
                        'Tender Offer - Small to Mid Size' => 'Tender Offer - Small to Mid Size',
                        'Tender Offer - Large or Multi-Tranche' => 'Tender Offer - Large or Multi-Tranche',
                        'Company Buyback under Section 68' => 'Company Buyback under Section 68',
                        'ESOP Trust Secondary Acquisition' => 'ESOP Trust Secondary Acquisition',
                        'Cross-Border Buyer + FC-TRS' => 'Cross-Border Buyer + FC-TRS',
                        'Rule 11UA Valuation Pass-Through' => 'Rule 11UA Valuation Pass-Through',
                        'Annual Recurring Secondary Program' => 'Annual Recurring Secondary Program',
                        'Pre-IPO Tender Offer Coordination' => 'Pre-IPO Tender Offer Coordination',
                        'Direct Secondary Sale Advisory' => 'Direct Secondary Sale Advisory',
                        'Other' => 'Other',
                    ],
                ])
            </div>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>Delhi sits at the regulatory centre of gravity for any secondary program. The Ministry of Corporate Affairs head office is in the capital, the Nehru Place IT cluster and the Saket-Aerocity corporate belt host consumer-internet and edtech companies whose long-tenured teams are now ESOP-rich, and the Connaught Place finance district supplies investor counterparties. The structural problem holds across all of them - vesting runs 4 to 6 years, exercise needs cash, and the unlisted Delhi-headquartered company has no public market for its shares - and Delhi NCR has been one of the most active buyback geographies, with companies such as HealthKart and Adda247 running employee liquidity events. Each vehicle - tender offer, Section 68 buyback, ESOP Trust secondary, direct sale - carries distinct mechanics, tax treatment and employee-communication needs.</p>
                <p><strong>Delhi local market context.</strong> Delhi-registered companies file with the Registrar of Companies (RoC) Delhi, and the MCA headquarters being in Delhi means Section 68 buyback filings - Form SH-9, the SH-10 register and Form SH-11 return under Rule 17 - are a familiar, well-trodden path here. Delhi NCR's consumer-internet and edtech issuers often have a mix of resident and NRI investors, so tender pricing under Rule 11UA and, for cross-border buyers, FEMA NDI Rule 21 with FC-TRS through the authorised dealer bank are common. Patron Accounting LLP runs the program end-to-end - vehicle diagnostic, <a href="/esop-valuation-services/delhi">Rule 11UA pricing</a> (SEBI Cat I Merchant Banker DCF or CA NAV), capital gains modelling under Section 49(2AA) cost basis and Section 112 LTCG rate, <a href="/esop-fema-and-rbi-firms-reporting/delhi">FEMA NDI Rule 21 plus FC-TRS</a> for foreign buyers, the post-Finance Act 2024 buyback workflow under Section 2(22)(f), Section 195 TDS for non-resident buyers, ROFR and pre-emption waivers, and remaining-employee communication. One firm coordinating CA, CS, valuation, FEMA and HR streams, with offices in Pune, Mumbai, Delhi and Gurugram.</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="two-column">
            <div class="column-content">
                ...
                <div class="content-text what-is-definition">
                    ...
                    <p>For a Delhi startup - say a Nehru Place trading-and-product venture or a Saket consumer-tech company - an ESOP secondary sale is simply the moment an early employee finally converts paper equity into cash. The employee sells shares acquired on ESOP exercise (or, occasionally, vested-but-unexercised options surrendered through a cashless mechanism) to a third party: a fund, an incoming investor, or the company itself via buyback. It bridges the long gap between grant and the eventual IPO or M&amp;A exit. In the absence of any structured program, a Connaught Place team that has been building since the seed round can sit on illiquid options for 7 to 10 years; a well-run secondary compresses that wait into a single coordinated event.</p>
                    <p>Delhi NCR founders generally weigh four routes against each other. A <strong>Direct Secondary Sale</strong> is the most bilateral - the employee transfers to a named investor or co-shareholder. A <strong>Tender Offer</strong> scales that up: the company itself orchestrates a coordinated, uniformly priced sale of employee shares to a third-party investor (an existing VC, growth fund or secondary fund). A <strong>Company Buyback</strong> under Section 68 of Companies Act 2013 deploys the firm's own free reserves and securities premium, with Board approval up to 10 percent or a Special Resolution up to 25 percent. And where a Trust route already exists, an <strong>ESOP Trust Secondary Acquisition</strong> under SEBI (Share Based Employee Benefits and Sweat Equity) Regulations 2021 Regulation 6 lets the Trust mop up shares within a 2 percent of paid-up capital per year cap.</p>
                    <p>The tax outcome turns on the <a href="/esop-capital-gains-tax-on-sale/delhi">capital gains machinery</a>. Section 45 is the charging section and Section 48 the computation; crucially, Section 49(2AA) fixes the cost basis at the FMV already <a href="/esop-perquisite-tax-section-17-2-vi/delhi">taxed as perquisite on exercise under Section 17(2)(vi)</a>, so there is no double tax. For unlisted shares the LTCG line sits at 24 months from the exercise date under Section 2(42A), and Section 112 then applies 12.5 percent without indexation, effective 23 July 2024 post Finance (No. 2) Act 2024. Pricing below FMV bites both sides - Section 50CA on the seller, Section 56(2)(x) on the buyer. Delhi's deep base of NRI investors and foreign growth funds makes the cross-border layer routine here: FEMA Non-Debt Instruments Rules 2019 Rule 21 mandates pricing not below FMV, an FC-TRS filing follows within 60 days, sectoral FDI caps must clear, and Section 195 TDS applies on payment to a non-resident.</p>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <ul>
                    <li><strong>CFOs and CHROs of Nehru Place, Saket and Aerocity consumer-internet and edtech firms planning structured employee secondary programs</strong> - typically Series C onwards with employees holding 4-7 years of vested grants; following the HealthKart and Adda247 buyback pattern, a Delhi liquidity event restores ESOP retention value before the next round.</li>
...
<section class="content-section" id="services-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>Delhi engagements span the full range - from a single Saket consumer-tech founder running a first tender for a tight team, to a Nehru Place trading platform managing a recurring cross-border secondary for NRI and foreign-fund buyers. Most Delhi clients begin with the diagnostic and then pick exactly one of the tiers below; the cross-border add-on is bolted on whenever a non-resident sits on the buy side.</p>
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Service</th><th>What We Do</th></tr></thead>
                    <tbody>

                        <tr><td><strong>Liquidity Vehicle Diagnostic (Standalone)</strong></td><td>A focused 2-week study that maps the founder's liquidity goal, benchmarks all four routes side by side (Tender, Buyback, Trust Secondary, Direct), runs the post-FA 2024 comparative tax numbers, and hands back a recommendation memo with the trade-offs quantified. Almost every Delhi engagement opens here before any vehicle is locked.</td><td>Quoted on scoping call</td></tr>
                        <tr><td><strong>Tender Offer (Small to Mid Size)</strong></td><td>The workhorse for a Saket or Aerocity venture's first liquidity event - full tender documentation, investor pricing negotiation, the Rule 11UA FMV report, a per-employee LTCG-vs-STCG tax memo, the communication pack (offer letter, FAQ, election form), execution, settlement, SH-4 transfer filings and post-tender transparency to the team that stays. Up to ~100 participants.</td><td>Quoted on scoping call</td></tr>
                        <tr><td><strong>Cross-Border Buyer Add-On</strong></td><td>Built for Delhi's NRI and foreign-fund buyer base - FEMA NDI Rule 21 pricing, the FC-TRS filing inside 60 days through the authorised dealer bank, sectoral FDI cap analysis, the Section 195 TDS workflow and DTAA Article 13 capital gains reading. Layers onto any tender or direct-sale engagement.</td><td>Quoted on scoping call</td></tr>
                        <tr><td><strong>Company Buyback (Section 68)</strong></td><td>Because Delhi-registered companies file with RoC Delhi, the SH-series path is well worn - Form SH-9 Notice of Meeting, SH-10 Register of Buyback and SH-11 Return of Buyback, with Section 70 12-month cooling-period management, the post-Finance Act 2024 deemed dividend mechanics under Section 2(22)(f) and a matching employee communication pack.</td><td>Quoted on scoping call</td></tr>
                        <tr><td><strong>Rule 11UA Valuation (Pass-Through)</strong></td><td>FMV report by a SEBI Cat I Merchant Banker (DCF) or CA (NAV). This is the defensibility floor that keeps Section 50CA off the seller and Section 56(2)(x) off the buyer, and it doubles as the Rule 21 anchor when the buyer is a foreign fund.</td><td>Quoted on scoping call</td></tr>
                        <tr><td><strong>ESOP Trust Secondary Acquisition</strong></td><td>Where a Trust route is already running, the Trust acquires employee shares under SEBI SBEB 2021 Regulation 6 within the 2 percent paid-up capital per year cap, with the 5 percent overall ceiling tracked across primary plus secondary and Trust compliance under Regulations 28-29.</td><td>Quoted on scoping call</td></tr>
                        <tr><td><strong>Annual Recurring Secondary Program (3-Year Retainer)</strong></td><td>For Connaught Place finance-adjacent firms that want predictable yearly liquidity - an annual tender or buyback cycle, ongoing employee education and execution, investor-relationship management for a repeat buyer base, and SHA ROFR waivers handled cycle by cycle.</td><td>Quoted on scoping call</td></tr>
                        <tr><td><strong>Tender Offer (Large or Multi-Tranche)</strong></td><td>Multi-investor coordination, tiered pricing across grantee cohorts, cross-border buyer FC-TRS, 100-plus participants, pre-IPO multi-tranche sequencing, NCLT coordination where required, and SEBI Cat I Merchant Banker DCF coordination.</td><td>Quoted on scoping call</td></tr>
        ...
        <div class="steps-container">
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <p class="step-description">We anchor the FMV at the sale date - SEBI Cat I Merchant Banker DCF where cash flows are projectable, CA NAV for an asset-heavy or early-stage Saket venture, CCA as a comparable-company cross-check. Pricing is then negotiated with the investor at last-round or a 10-30 percent discount (a pre-IPO tender 6-12 months before the DRHP often clears at expected IPO price minus 20-30 percent). The Section 50CA and Section 56(2)(x) defensibility floor is confirmed before anything is offered to employees.</p>
                    <div class="step-highlights">
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <p class="step-description">When the buyer is an NRI or foreign fund - a common Delhi scenario - the FC-TRS (Foreign Currency Transfer of Shares) is filed within 60 days of transfer through the authorised dealer bank. We assemble the share transfer deed, sale consideration receipt, Rule 11UA FMV report and KYC of both parties, confirm the sectoral FDI cap, and reconcile Section 195 TDS with the non-resident buyer's tax position.</p>
                    <div class="step-highlights">
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>A Delhi secondary engagement leaves the founder with a complete, audit-ready file - diagnostic memos, governance papers, the valuation report, employee communication, the RoC Delhi statutory filings and post-program support. For a Nehru Place trading firm with NRI buyers the FC-TRS set sits alongside the SH-series; for a self-funded Saket consumer-tech buyback the SH-9/SH-10/SH-11 pack does the heavy lifting. The eight deliverable groups below travel with every engagement.</p>
                ...
                <ul>
                    ...
                    <li>Coordinated through <a href="/esop-valuation-services/delhi">ESOP Valuation Services</a>.</li>
                </ul>
                ...
                <ul>
                    ...
                    <li>Coordinated through <a href="/esop-corporate-filings/delhi">ESOP Corporate Filings</a>.</li>
                </ul>
...
<section class="content-section" id="challenges-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>The errors that derail Delhi NCR secondaries cluster in two places - the cross-border buy side, given the city's NRI and foreign-fund investor base, and the post-FA 2024 buyback tax that surprises employees who expected the old tax-free treatment. The table below pairs each common mistake with its consequence and how Patron heads it off.</p>
                <div class="table-responsive-wrapper">
                <table>
                    ...
                    <tbody>
                        ...
                        <tr><td><strong>Foreign buyer secondary without FC-TRS filing</strong></td><td>Cross-border share transfer requires FC-TRS filing within 60 days through authorised dealer bank. Late or missed FC-TRS attracts RBI compounding (typically Rs 50,000 to Rs 5,00,000 per instance) and Section 13 FEMA penalty. Transfer may also be flagged for unwinding.</td><td>Because so many Delhi deals carry an NRI or foreign-fund buyer, Patron files FC-TRS in parallel with settlement as standard, with sectoral cap pre-confirmation and AD bank coordination locked before any money moves - so there is never a post-facto compounding scramble.</td></tr>
            ...
            <div class="content-text">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr><td>Liquidity vehicle diagnostic (standalone)</td><td>2-week diagnostic, vehicle comparison, recommendation memo with post-FA 2024 tax analysis</td><td class="table-amount">Quoted on scoping call</td></tr>
                        <tr><td>Rule 11UA valuation (pass-through)</td><td>FMV report by SEBI Cat I Merchant Banker (DCF) or CA (NAV) methodology</td><td class="table-amount">Quoted on scoping call</td></tr>
                        <tr><td>ESOP Trust secondary acquisition</td><td>Trust-led secondary under SBEB 2021 Regulation 6 with 2 percent annual cap; overall 5 percent ceiling tracking</td><td class="table-amount">Quoted on scoping call</td></tr>
                        <tr><td>Company buyback (Section 68)</td><td>Buyback workflow including SH-9, SH-10, SH-11; post-FA 2024 tax mechanics; employee communication</td><td class="table-amount">Quoted on scoping call</td></tr>
                        <tr><td>Annual recurring secondary program (3-year retainer)</td><td>Annual tender or buyback program; ongoing employee education; investor relationship management</td><td class="table-amount">Quoted on scoping call</td></tr>
                        <tr><td>Tender offer (small to mid size, up to 100 participants)</td><td>Full tender documentation, pricing, per-employee tax memo, communication, execution, post-tender</td><td class="table-amount">Quoted on scoping call</td></tr>
                        <tr><td>Cross-border buyer add-on</td><td>FEMA NDI Rule 21 compliance, FC-TRS filing, sectoral cap analysis, Section 195 TDS workflow</td><td class="table-amount">Quoted on scoping call</td></tr>
                        <tr><td>Tender offer (large or multi-tranche, 100-plus participants)</td><td>Multi-investor coordination, complex pricing, cross-border buyer, pre-IPO multi-tranche workflows</td><td class="table-amount">Quoted on scoping call</td></tr>
                        <tr><td><strong>Patron Accounting Professional Fees</strong></td><td>Standard starting price for small-to-mid tender offer; multi-tranche pre-IPO programs and cross-border tender offers quoted separately; annual recurring 3-year retainer model available</td><td class="table-amount"><strong>From INR 24,999/project (Exl GST and Govt. Charges)</strong></td></tr>
...
<section class="why-choose-section" id="benefits-section">
    ...
    <article class="feature-card"><h3>Four-Vehicle Framework Mapped to Liquidity Goal</h3><p>Whether you are a Nehru Place trading platform or a Saket consumer-tech venture, we pick the route - Tender Offer, Section 68 Buyback, Trust Secondary or Direct Sale - via a quantified memo weighing post-FA 2024 tax economics, employee perception, execution complexity and timeline. No vehicle dogma.</p></article>
    ...
    <article class="feature-card"><h3>FEMA NDI Rule 21 + FC-TRS Coordination</h3><p>Delhi's NRI and foreign-fund buyer base makes this routine for us - pricing not below FMV, FC-TRS within 60 days, sectoral FDI cap analysis, Section 195 TDS workflow and DTAA Article 13 capital gains reading, all under one engagement and end-to-end through the FDI Compliance team.</p></article>
    <article class="feature-card"><h3>Section 68 Companies Act Buyback Workflow</h3><p>With the MCA head office and RoC Delhi both in the city, the SH-series filing path is well-trodden for us - Form SH-9 Notice of Meeting, SH-10 Register of Buyback and SH-11 Return of Buyback under Rule 17, plus Section 70 12-month cooling period and debt-equity ratio management, end-to-end through the ESOP Corporate Filings retainer.</p></article>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p><strong>Who we work with:</strong> Secondary program engagements completed for tender offers, buybacks and Trust secondaries across SaaS, fintech, consumer-tech and pharma verticals. </p>
...
<section class="content-section" id="comparison-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>Which route a Delhi founder lands on rarely comes down to one factor. A Nehru Place trading platform with a foreign growth fund on the buy side leans toward a tender offer (capital gains, FC-TRS, FEMA Rule 21); a cash-rich, self-funded Saket consumer-tech firm may prefer a Section 68 buyback - though post-FA 2024 the deemed-dividend hit at slab often pushes it back to tender; a Connaught Place finance-adjacent issuer running yearly liquidity uses the Trust secondary; and a one-off sale to a single named NRI investor stays a direct secondary. The table sets the mechanic, the trigger, the employee-side tax and the binding compliance for each side by side.</p>
                <div class="table-responsive-wrapper">
                <table>
                    <thead>
                        <tr>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <ul>
                    <li><strong><a href="/esop-services/delhi">ESOP Services Master Hub</a></strong> - end-to-end ESOP lifecycle services including downstream pre-IPO scheme conversion engagements after pre-IPO tender offers.</li>
                    <li><strong><a href="/esop-valuation-services/delhi">ESOP Valuation Services</a></strong> - Rule 11UA FMV reports critical for secondary sale pricing; DCF (via SEBI Cat I Merchant Banker), NAV (via CA) and CCA methodologies.</li>
                    <li><strong><a href="/esop-scheme-design/delhi">ESOP Scheme Design</a></strong> - first-time scheme drafting with sample term sheet; foundational engagement that precedes any secondary program.</li>
                    <li><strong><a href="/esop-for-tech-startups/delhi">ESOP for Tech Startups</a></strong> - tech-vertical scheme design with refresh grants and acceleration triggers; secondary programs are downstream liquidity vehicle.</li>
                    <li><strong><a href="/esop-for-saas-companies/delhi">ESOP for SaaS Companies</a></strong> - B2B SaaS-specific design with ARR-linked vesting; secondary programs serve SaaS pre-IPO timelines.</li>
                    <li><strong><a href="/esop-restructuring-underwater-options/delhi">ESOP Restructuring and Underwater Options</a></strong> - down-round remediation via Repricing, Exchange Program, Top-Up Grants, Vesting Acceleration or Cashout/Buyback; distinct from secondary sale (modification vs liquidity).</li>
                    <li><strong><a href="/esop-accounting-ind-as-102/delhi">ESOP Accounting under Ind AS 102</a></strong> - settlement accounting under Ind AS 102 paragraph 28 and Schedule III disclosure for buyback corporate actions.</li>
                    <li><strong><a href="/esop-corporate-filings/delhi">ESOP Corporate Filings</a></strong> - ongoing MCA filings retainer covering MGT-14, PAS-3, MGT-7 plus SH-4, SH-9, SH-10, SH-11 for buyback workflows and SH-4 for tender offer transfer filings.</li>
    ...
    <div class="content-container">
        <div class="text-content">
            <div class="faq-expanded">
                ...
                <div class="faq-expanded__list">
                    ...
                    <div class="faq-expanded__item" id="faq-3">
                        <h3 class="faq-expanded__q">What is the tax on ESOP secondary sale in Delhi?</h3>
                    ...
                    <div class="faq-expanded__item" id="faq-6">
                        <h3 class="faq-expanded__q">How is a Delhi NCR startup ESOP buyback taxed for employees?</h3>
                        <div class="faq-expanded__a"><p>It depends on what is surrendered. When a Delhi NCR startup buys back vested-but-unexercised options for cash (the HealthKart and Adda247 pattern), the gain is salary income taxed at slab with TDS under Section 192. When employees first exercise and the company then buys back the shares under Section 68, post Finance Act 2024 the proceeds are a deemed dividend under Section 2(22)(f) taxed at slab in the shareholder's hands. A tender offer or direct secondary sale instead attracts capital gains - LTCG at 12.5 percent under Section 112 after 24 months. The structure chosen drives the tax outcome, so Patron models all three before the company commits.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-7">
                        <h3 class="faq-expanded__q">What does a Delhi company file with RoC Delhi for a buyback?</h3>
                        <div class="faq-expanded__a"><p>A Section 68 buyback by a Delhi-registered company is filed with RoC Delhi - Form SH-9 (declaration of solvency where applicable), the SH-10 register of buyback, and Form SH-11 return of buyback, all under Rule 17 of the Companies (Share Capital and Debentures) Rules 2014, with Board approval up to 10 percent or a special resolution up to 25 percent and a 12-month Section 70 cooling period. A pure tender offer or direct secondary sale, by contrast, is a share transfer between parties and needs no separate RoC filing beyond updating the register of members. With the MCA head office in Delhi, this is a routine, well-trodden filing path. Patron prepares and files the full SH-series set.</p></div>
                    </div>
                    ...
                    <div class="faq-expanded__item" id="faq-9">
                        <h3 class="faq-expanded__q">How much tax is payable on an ESOP secondary sale?</h3>
                        <div class="faq-expanded__a"><p>An ESOP secondary sale attracts capital gains tax. The cost basis is the FMV at the time of exercise under Section 49(2AA), because the perquisite tax already paid on exercise under Section 17(2)(vi) fixes that same FMV as the cost basis, so there is no double taxation. If the shares are held for more than 24 months, LTCG applies at 12.5 percent without indexation under Section 112 (post Finance Act 2024, effective 23 July 2024). If held for less than 24 months, STCG applies at slab rate (typically 30 percent plus surcharge plus cess). The holding period begins from the date of EXERCISE, not the date of grant. For example, if 10,000 shares are sold at Rs 500, the FMV at exercise was Rs 200 (the cost basis), and the shares were held for 3 years, the capital gain is (500-200) x 10,000 = Rs 30 lakh. LTCG at 12.5 percent works out to Rs 3.75 lakh, plus surcharge and cess, approximately Rs 4.29 lakh, leaving the employee with a net of Rs 45.71 lakh. Section 50CA and Section 56(2)(x) impose a penalty if the shares are sold below FMV. A buyback (post FA 2024) is now taxed in the shareholder's hands as a deemed dividend at slab rate under Section 2(22)(f), so a shareholder in the 30 percent slab can face tax of up to 39 percent. A tender offer is usually more tax-efficient. Where the buyer is cross-border, the FEMA NDI Rule 21 pricing rule (not below FMV) applies and FC-TRS must be filed within 60 days. Patron ESOP secondary sale advisory starts from INR 24,999/project. Stage-based scope is quoted on a free scoping call. Call <a href="tel:+919459456700" style="color:inherit;">+91 945 945 6700</a>.</p></div>
                    </div>
                </div>
            </div>
            ...
            <div class="highlight-box" style="margin-top:32px;">
                ...
                <ul>
                    <li><strong>Can employees sell unvested options in a secondary sale?</strong> No - only exercised shares (or, in some cases, vested-but-unexercised options routed through a cashless mechanism) can be sold in a secondary transaction.</li>
                    <li><strong>Is there a minimum price at which ESOP shares can be sold?</strong> Yes - for a cross-border buyer, FEMA NDI Rule 21 bars pricing below FMV, while for resident-to-resident deals Sections 50CA and 56(2)(x) penalise any sale below FMV in both the seller's and the buyer's hands.</li>
                    <li><strong>What is the annual cap on secondary acquisition through an ESOP Trust?</strong> Under SEBI SBEB Regulations 2021 Regulation 6, an ESOP Trust may acquire up to 2 percent of paid-up capital per year via secondary route, subject to an overall 5 percent ceiling combining primary and secondary holdings.</li>
                    <li><strong>How are share buyback proceeds taxed after Finance Act 2024?</strong> Buyback proceeds are taxed in the shareholder's hands at the applicable slab rate as a deemed dividend under Section 2(22)(f), effective 1 October 2024.</li>
                    <li><strong>What is the long-term capital gains rate after Finance Act 2024?</strong> Long-term capital gains are taxed at 12.5 percent without indexation under Section 112, effective 23 July 2024.</li>
                    <li><strong>What is the deadline for filing Form FC-TRS?</strong> Form FC-TRS must be filed within 60 days of a resident-to-non-resident share transfer, through the authorised dealer bank.</li>
                </ul>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text" style="text-align:left;">
                ...
                <p style="color:rgba(255,255,255,0.92);">Ready to design your employee liquidity program? <strong><a href="tel:+919459456700" style="color:inherit;text-decoration:underline;">Call us at +91 945 945 6700</a></strong> or <strong><a href="https://wa.me/919459456700?text=Hi%2C%20I%20would%20like%20a%20free%20consultation%20about%20ESOP%20services." target="_blank" rel="noopener" style="color:inherit;text-decoration:underline;">WhatsApp us</a></strong> for a free ESOP secondary scoping call. Response within 4 hours. 8 to 14 week end-to-end timeline from diagnostic to post-tender communication.</p>
...
<section class="content-section">
    <div class="content-container"><div class="text-content">
        ...
        <div class="content-text"><p>Start with the national ESOP Secondary Sale Advisory service, then explore complementary ESOP services across India.</p>
        <ul>
                    <li><strong><a href="/esop-secondary-sale-advisory">ESOP Secondary Sale Advisory in India</a></strong> - the national parent service</li>
...
<section class="content-section" style="padding:48px 32px;background:var(--gray-50);">
    <div class="content-container"><div class="text-content">
        <h2 class="section-title">ESOP Secondary Sale Advisory by City</h2>
        <div class="content-text"><p>Available across our four office cities. You are viewing the Delhi page.</p></div>
        <div class="pa-city-grid"><a href="/esop-secondary-sale-advisory/pune" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Pune</div><div class="pa-card-sub">Maharashtra</div></div></a><a href="/esop-secondary-sale-advisory/mumbai" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Mumbai</div><div class="pa-card-sub">Maharashtra</div></div></a><span class="pa-city-card" aria-current="page" style="border-color:var(--orange);background:#FFF7F2;cursor:default;position:relative;"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Delhi</div><div class="pa-card-sub">Delhi NCR</div></div><span style="position:absolute;top:10px;right:12px;font-size:10px;font-weight:700;color:var(--orange);letter-spacing:.04em;">YOU'RE HERE</span></span><a href="/esop-secondary-sale-advisory/gurugram" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Gurugram</div><div class="pa-card-sub">Haryana</div></div></a></div>
    </div></div>
</section>
