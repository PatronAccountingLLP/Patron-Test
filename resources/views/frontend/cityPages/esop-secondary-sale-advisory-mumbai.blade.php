...
@section('meta')
    <title>Mumbai ESOP Secondary Sale: Tax, FEMA & SEBI Compliance</title>
    <meta name="description" content="Mumbai pre-IPO teams unlock ESOP liquidity through tender offers and buybacks, with Rule 11UA FMV, LTCG planning and SEBI-aligned structuring from INR 24,999.">
    <meta name="keywords" content="ESOP Secondary Sale Advisory Mumbai, ESOP Secondary Sale Advisory in Mumbai, ESOP Secondary Sale Advisory services in Mumbai, ESOP services Mumbai, ESOP Secondary Sale Advisory cost Mumbai, ESOP Secondary Sale Advisory consultants Mumbai, CA firm for ESOP Secondary Sale Advisory Mumbai, ESOP advisory Mumbai">
    <link rel="canonical" href="/esop-secondary-sale-advisory/mumbai">
    <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1">
    <meta property="og:title" content="Mumbai ESOP Secondary Sale: Tax, FEMA & SEBI Compliance | Patron Accounting">
    <meta property="og:description" content="Mumbai pre-IPO teams unlock ESOP liquidity through tender offers and buybacks, with Rule 11UA FMV, LTCG planning and SEBI-aligned structuring from INR 24,999.">
    <meta property="og:url" content="/esop-secondary-sale-advisory/mumbai">
    ...
    <meta name="twitter:title" content="Mumbai ESOP Secondary Sale: Tax, FEMA & SEBI Compliance | Patron Accounting">
    <meta name="twitter:description" content="Mumbai pre-IPO teams unlock ESOP liquidity through tender offers and buybacks, with Rule 11UA FMV, LTCG planning and SEBI-aligned structuring from INR 24,999.">
...
@section('schema')    <script type="application/ld+json">{
  ...
  "@graph": [
    {
      "@type": "Service",
      "@id": "https://www.patronaccounting.com/esop-secondary-sale-advisory/mumbai#service",
      "name": "ESOP Secondary Sale and Buyback Advisory",
      "url": "https://www.patronaccounting.com/esop-secondary-sale-advisory/mumbai",
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://www.patronaccounting.com/esop-secondary-sale-advisory/mumbai#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
        ...
        },
        {
          ...
          "position": 4,
          "name": "ESOP Secondary Sale and Buyback Advisory",
          "item": "https://www.patronaccounting.com/esop-secondary-sale-advisory/mumbai"
        }
      ]
    },
    {
      ...
      "@id": "https://www.patronaccounting.com/esop-secondary-sale-advisory/mumbai#localbusiness",
      "name": "Patron Accounting LLP - ESOP Secondary Sale Advisory, Mumbai",
      "url": "https://www.patronaccounting.com/esop-secondary-sale-advisory/mumbai",
    ...
    {
      "@type": "FAQPage",
      "@id": "https://www.patronaccounting.com/esop-secondary-sale-advisory/mumbai#faq",
      ...
      "mainEntity": [
        ...
        {
          "@type": "Question",
          "name": "What is the tax on ESOP secondary sale in Mumbai?",
          "acceptedAnswer": {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          "name": "Who typically buys employee shares in a Mumbai tender offer?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "In Mumbai the buyer is usually a growth fund, family office or existing VC based in the BKC and Lower Parel finance hubs, or a new investor coming in at the same round. The company orchestrates the tender; the investor funds it directly rather than the company using its own cash. SEBI is headquartered in BKC, but an unlisted-share tender needs no SEBI approval - only a Rule 11UA FMV floor and, for any cross-border buyer, FEMA NDI Rule 21 pricing and FC-TRS within 60 days. Pricing is benchmarked to the last round, often at a 10-30 percent discount."
          }
        },
        {
          "@type": "Question",
          "name": "Does a Mumbai fintech secondary need extra FEMA compliance?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Often yes. Mumbai secondary candidates skew fintech and financial-services SaaS, which frequently have foreign investors on the cap table, so when a non-resident buys employee shares the transaction must price not below FMV under FEMA NDI Rule 21, file FC-TRS through the authorised dealer bank within 60 days, and respect any sectoral FDI cap - fintech and NBFC-linked sectors carry specific conditions. Section 195 TDS may apply on payment from the non-resident buyer. For resident-to-resident Mumbai deals none of this applies, only the Rule 11UA FMV floor and Section 50CA and 56(2)(x). Patron handles the FEMA and FC-TRS workstream end-to-end."
          }
        },
        {
          "@type": "Question",
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "An ESOP secondary sale attracts capital gains tax. The cost basis is the FMV at the time of exercise under Section 49(2AA), because the perquisite tax already paid at exercise under Section 17(2)(vi) becomes the cost basis, so the same gain is not taxed twice. If the shares are held for more than 24 months, the gain is taxed as LTCG at 12.5 percent without indexation under Section 112 (post Finance Act 2024, effective 23 July 2024). If held for less than 24 months, the gain is taxed as STCG at the applicable slab rate (typically 30 percent plus surcharge plus cess). The holding period begins from the date of EXERCISE, not the date of grant. For example, if 10,000 shares are sold at Rs 500 each, with an FMV of Rs 200 at exercise (the cost basis), and held for 3 years, the capital gain is (500-200) x 10000 = Rs 30 lakh. The LTCG tax at 12.5 percent is Rs 3.75 lakh, plus surcharge and cess, totalling approximately Rs 4.29 lakh, leaving the employee with a net of Rs 45.71 lakh. Section 50CA and Section 56(2)(x) impose a penalty if the shares are sold below FMV. In a buyback (post Finance Act 2024), the proceeds are now taxed in the shareholder's hands as deemed dividend at the slab rate under Section 2(22)(f), so a shareholder in the 30 percent slab may bear tax of up to 39 percent. A tender offer is usually more tax-efficient. Where the buyer is cross-border, the FEMA NDI Rule 21 pricing rule (not below FMV) applies and FC-TRS must be filed within 60 days. Patron ESOP secondary sale advisory starts from INR 24,999/project. The stage-based scope is quoted on a free scoping call. Call +91 945 945 6700."
          }
        }
      ]
    }
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-4 private-registration-heading">
                        ESOP Secondary Sale and Buyback Advisory in Mumbai
                    </h1>
                    ...
                    <p class="mb-4" style="font-size:16px;color:var(--text-secondary);line-height:1.6;">For a BKC or Lower Parel finance house, a Powai or Andheri SaaS team, or any RoC Mumbai company with SEBI a few minutes away in BKC, we structure tender offers and Section 68 buybacks with Rule 11UA FMV, LTCG planning and FEMA FC-TRS handled under one roof.</p>
                    ...
                    <p class="mb-4 fw-bold" style="color: var(--blue); font-size: 15px;">Tender Offers + Buybacks for BKC, Lower Parel and Powai Startups | RoC Mumbai | 10,000+ Businesses Served | 4.9 Google Rating | 15+ Years</p>
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="https://wa.me/919459456700?text=Hello%2C%20I%20just%20visited%20your%20ESOP%20Secondary%20Sale%20Advisory%20in%20Mumbai%20page.%20I%20would%20like%20to%20know%20more%20about%20it." target="_blank" class="btn-sample text-decoration-none" rel="noopener">
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>Mumbai is where India's secondary market actually clears. The BKC and Lower Parel finance hubs put growth funds, family offices and the buy-side that fund tender offers within a few kilometres of the companies running them, while the Andheri-Powai SaaS belt and the Goregaon-Vikhroli startup corridor supply the issuers whose employees want liquidity. The structural problem is unchanged - vesting runs 4 to 6 years, exercise needs cash, and the unlisted Mumbai-headquartered company has no public market for the shares - but the proximity of capital makes a tender offer easier to assemble here than almost anywhere else. Each vehicle - tender offer, Section 68 buyback, ESOP Trust secondary, direct sale - carries distinct mechanics, tax treatment and employee-communication needs.</p>
                <p><strong>Mumbai local market context.</strong> Mumbai-registered companies file with the Registrar of Companies (RoC) Mumbai, and the city is also home to SEBI's headquarters in BKC - relevant background for Rule 11UA valuations done by SEBI Cat I Merchant Bankers, many of whom are themselves Mumbai-based, though an unlisted-share tender needs no SEBI approval. Mumbai secondary candidates skew fintech and financial-services SaaS where FEMA exposure is common, so cross-border buyer pricing under FEMA NDI Rule 21 and FC-TRS through an authorised dealer bank are frequent workstreams. Patron Accounting LLP runs the program end-to-end - vehicle diagnostic, Rule 11UA pricing (SEBI Cat I Merchant Banker DCF or CA NAV), capital gains modelling under Section 49(2AA) cost basis and Section 112 LTCG rate, FEMA NDI Rule 21 plus FC-TRS for foreign buyers, the post-Finance Act 2024 buyback workflow under Section 2(22)(f), Section 195 TDS for non-resident buyers, ROFR and pre-emption waivers, and remaining-employee communication. One firm coordinating CA, CS, valuation, FEMA and HR streams, with offices in Pune, Mumbai, Delhi and Gurugram.</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="two-column">
            <div class="column-content">
                ...
                <div class="content-text what-is-definition">
                    ...
                    <p>Picture a BKC-headquartered fintech that has run four funding rounds out of the same building that houses half of Mumbai's growth-fund and family-office capital, or a Powai deep-tech startup whose senior engineers have carried vested grants for the better part of a decade. For both, an ESOP secondary sale is the route that converts paper equity into money in the bank long before a listing. Mechanically, the employee transfers shares acquired on <a href="/esop-exercise-and-cap-table-management/mumbai">ESOP exercise</a> - or, through a cashless route, vested-but-unexercised options - to an incoming investor, a secondary fund, or back to the company through buyback. Without it, a holder typically sits through 7 to 10 years of vesting and pre-IPO drift; a structured secondary collapses that wait.</p>
                    <p>Four vehicles deliver this, and because the SEBI head office sits a few minutes away at the Bandra Kurla Complex, Mumbai promoters tend to scrutinise the securities-law footing of each before signing off. The <strong>Direct Secondary Sale</strong> is the simplest - a bilateral transfer from employee to a named investor or co-shareholder. A <strong>Tender Offer</strong> scales that up into a company-coordinated, uniform-price purchase of employee shares by a third-party investor such as an existing VC, growth fund or dedicated secondary fund. A <strong>Company Buyback</strong> under Section 68 of Companies Act 2013 instead uses the company's own free reserves and securities premium, with Board approval up to 10 percent and a Special Resolution up to 25 percent. The <strong>ESOP Trust Secondary Acquisition</strong> runs through an existing trust under SEBI (Share Based Employee Benefits and Sweat Equity) Regulations 2021 Regulation 6, capped at 2 percent of paid-up capital each year.</p>
                    <p>Whichever vehicle a Lower Parel finance team or an Andheri SaaS board lands on, the tax spine is the same. The gain is <a href="/esop-capital-gains-tax-on-sale/mumbai">charged under Section 45</a> and computed under Section 48; Section 49(2AA) anchors the cost basis to the FMV that was already taxed as <a href="/esop-perquisite-tax-section-17-2-vi/mumbai">perquisite at exercise under Section 17(2)(vi)</a>; Section 2(42A) fixes the 24-month LTCG threshold for unlisted shares running from the exercise date; and Section 112 levies 12.5 percent without indexation effective 23 July 2024 under Finance (No. 2) Act 2024. Price below FMV and Section 50CA hits the seller while Section 56(2)(x) hits the buyer. The wrinkle that makes Mumbai deals distinctive is how often a foreign fund or FPI sits on the cap table, so the cross-border layer recurs constantly - FEMA Non-Debt Instruments Rules 2019 Rule 21 pricing not below FMV, FC-TRS within 60 days, sectoral FDI cap checks, and Section 195 TDS on the non-resident payment.</p>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <ul>
                    <li><strong>CFOs and CHROs of BKC, Lower Parel, Andheri and Powai fintech and SaaS firms planning structured employee secondary programs</strong> - typically Series C onwards with employees holding 4-7 years of vested grants; with growth funds and family offices next door in BKC, a Mumbai tender restores ESOP retention value before the next round.</li>
...
<section class="content-section" id="services-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>Mumbai engagements typically open with the diagnostic and the <a href="/esop-valuation-services/mumbai">Rule 11UA valuation</a>, then move into a tender or buyback once the board has weighed the BKC investor appetite against the company's own reserves. Because so many city cap tables carry a foreign fund, the cross-border add-on is requested far more often here than the national average. The tiers below can be taken standalone or stacked.</p>
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Service</th><th>What We Do</th></tr></thead>
                    <tbody>

                        <tr><td><strong>Liquidity Vehicle Diagnostic (Standalone)</strong></td><td>2-week diagnostic covering liquidity goal mapping, vehicle comparison across all four routes (Direct, Tender, Buyback, Trust Secondary), comparative tax analysis post-FA 2024, recommendation memo with quantified trade-offs. The usual starting point for a Mumbai board before committing to any single route.</td><td>Quoted on scoping call</td></tr>
                        <tr><td><strong>Rule 11UA Valuation (Pass-Through)</strong></td><td>FMV report by SEBI Cat I Merchant Banker (DCF method) or CA (NAV method). Defensibility floor for Section 50CA seller protection and Section 56(2)(x) buyer protection. Indispensable where a BKC growth fund or overseas investor is the buyer, since FEMA NDI Rule 21 pricing keys off it.</td><td>Quoted on scoping call</td></tr>
                        <tr><td><strong>Tender Offer (Small to Mid Size)</strong></td><td>Full tender offer documentation, pricing negotiation with investor, Rule 11UA FMV report, per-employee tax planning memo (LTCG vs STCG bracketing), employee communication pack (offer letter, FAQ, election form), execution and settlement, SH-4 share transfer filings, post-tender remaining-employee transparency. Up to ~100 participants - the typical size for an Andheri or Powai SaaS team.</td><td>Quoted on scoping call</td></tr>
                        <tr><td><strong>Cross-Border Buyer Add-On</strong></td><td>FEMA NDI Rule 21 compliance plus FC-TRS filing within 60 days through authorised dealer bank plus sectoral FDI cap analysis plus Section 195 TDS workflow for non-resident buyer plus DTAA Article 13 capital gains analysis. The most-stacked add-on for Mumbai fintech and financial-services deals; layered on top of any tender or direct sale engagement.</td><td>Quoted on scoping call</td></tr>
                        <tr><td><strong>Company Buyback (Section 68)</strong></td><td>Buyback workflow under Section 68 of Companies Act 2013 - Form SH-9 Notice of Meeting, SH-10 Register of Buyback, SH-11 Return of Buyback; Section 70 12-month cooling period management; post-Finance Act 2024 deemed dividend tax mechanics under Section 2(22)(f); employee communication pack.</td><td>Quoted on scoping call</td></tr>
                        ...
                        <tr><td><strong>Annual Recurring Secondary Program (3-Year Retainer)</strong></td><td>Annual tender offer or buyback program; ongoing employee education and execution; investor relationship management for a repeat BKC or Lower Parel buyer base; SHA ROFR waivers cycle-by-cycle.</td><td>Quoted on scoping call</td></tr>
                        <tr><td><strong>Tender Offer (Large or Multi-Tranche)</strong></td><td>Multi-investor coordination, complex pricing across grantee tiers, cross-border buyer FC-TRS, 100-plus participants, pre-IPO multi-tranche workflows, NCLT coordination if required, SEBI Cat I Merchant Banker DCF coordination.</td><td>Quoted on scoping call</td></tr>
...
<section class="steps-section" id="procedure-section">
    <div class="section-container">
        <div class="section-header" style="text-align:center;margin-bottom:48px;">
            ...
            <p class="section-subtitle" style="text-align:left;max-width:100%;">For a Mumbai company the workflow runs 8 to 14 weeks, and the cross-border step is rarely optional - a BKC fintech with an overseas fund as buyer will lean on the FC-TRS week the way an all-resident Powai deal will not. The eight stages move from liquidity vehicle diagnostic, through Rule 11UA FMV valuation, documentation drafting, the Board and (if required) EGM cycle, an employee election window backed by per-employee tax memos, execution and settlement with SH-4 filings, FC-TRS within 60 days for any non-resident buyer, and finally post-secondary communication to the employees who stayed in.</p>
        </div>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>A Mumbai secondary closes only when the paper trail is complete - and for a fintech or financial-services issuer with a foreign buyer, the FC-TRS and FEMA file (item 7 below) carries as much weight as the tender documents themselves. Each Patron engagement hands over the full kit: diagnostic memos, governance documents, the Rule 11UA valuation, employee communication, the statutory filings and post-program ITR support.</p>
                ...
                <ul>
                    ...
                    <li>Coordinated through <a href="/esop-corporate-filings/mumbai">ESOP Corporate Filings</a>.</li>
                </ul>
...
<section class="content-section" id="challenges-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>The errors that sink a Mumbai secondary cluster around the cross-border file, because the typical city deal - a BKC fintech selling to an overseas fund, or a Powai deep-tech team with an FPI on the register - lives or dies on FEMA timing. The table leads with those, then runs through the pricing, holding-period and governance traps that catch every issuer.</p>
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Challenge</th><th>Impact</th><th>How Patron Accounting Solves It</th></tr></thead>
                    <tbody>

                        <tr><td><strong>Foreign buyer secondary without FC-TRS filing</strong></td><td>Cross-border share transfer requires FC-TRS filing within 60 days through authorised dealer bank. Late or missed FC-TRS attracts RBI compounding (typically Rs 50,000 to Rs 5,00,000 per instance) and Section 13 FEMA penalty. Transfer may also be flagged for unwinding - a live risk where a Mumbai fintech sells to a foreign fund.</td><td>Patron files FC-TRS in parallel with execution settlement. All cross-border tender offers include sectoral cap pre-confirmation and AD bank coordination before settlement to avoid post-facto compounding.</td></tr>
...
<section class="why-choose-section" id="benefits-section">
    <div class="section-container">
        <div style="text-align:center;margin-bottom:48px;">
            ...
            <p class="section-subtitle" style="text-align:center;max-width:760px;margin:0 auto;">A Mumbai secondary lives at the intersection of the city's buy-side and its FEMA exposure - the funds and family offices that fund tenders sit in BKC and Lower Parel, while the fintech and financial-services issuers that run them almost always carry a foreign investor. The strengths below are built for exactly that combination, not a generic resident-only deal.</p>
        </div>
        <div class="features-grid">
    <article class="feature-card"><h3>Built for Mumbai's Cross-Border Cap Tables</h3><p>The city's fintech and financial-services issuers almost always carry a foreign fund or FPI as buyer, so we run FEMA NDI Rule 21 pricing not below FMV, FC-TRS within 60 days, sectoral FDI cap analysis, Section 195 TDS workflow and DTAA Article 13 capital gains analysis under one engagement, end-to-end through the FDI Compliance team.</p></article>
    <article class="feature-card"><h3>Rule 11UA FMV Defensibility</h3><p>SEBI Cat I Merchant Banker DCF coordination for projectable cash flows; CA NAV for asset-heavy/early-stage; CCA cross-check. Section 50CA seller protection and Section 56(2)(x) buyer protection - and the same report that satisfies a BKC growth fund under FEMA NDI Rule 21.</p></article>
    <article class="feature-card"><h3>Four-Vehicle Framework Mapped to Liquidity Goal</h3><p>Direct Sale, Tender Offer, Section 68 Buyback, Trust Secondary - selected via a quantified recommendation memo weighing post-FA 2024 tax economics, employee perception, execution complexity and timeline. No vehicle dogma, whether the board sits in Lower Parel or Powai.</p></article>
...
<section class="content-section" id="comparison-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>Which vehicle wins in Mumbai usually turns on two local facts - is there a BKC or Lower Parel fund willing to fund a tender, and is the buyer a foreign investor that drags in FEMA NDI Rule 21 and FC-TRS. A Powai SaaS company with a willing growth fund and a clean resident cap table will tilt toward a tender offer; a mature Goregaon or Vikhroli issuer sitting on free reserves but without an obvious buyer may still find a Section 68 buyback simpler, even after the post-Finance Act 2024 deemed-dividend hit. The table below sets the four routes side by side so the board can read mechanic, fit, employee-side tax and compliance load in one view.</p>
                <div class="table-responsive-wrapper">
                <table>
                    <thead>
                        <tr>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <ul>
                    <li><strong><a href="/esop-services/mumbai">ESOP Services Master Hub</a></strong> - end-to-end ESOP lifecycle services including downstream pre-IPO scheme conversion engagements after pre-IPO tender offers.</li>
                    <li><strong><a href="/esop-valuation-services/mumbai">ESOP Valuation Services</a></strong> - Rule 11UA FMV reports critical for secondary sale pricing; DCF (via SEBI Cat I Merchant Banker), NAV (via CA) and CCA methodologies.</li>
                    <li><strong><a href="/esop-scheme-design/mumbai">ESOP Scheme Design</a></strong> - first-time scheme drafting with sample term sheet; foundational engagement that precedes any secondary program.</li>
                    <li><strong><a href="/esop-for-tech-startups/mumbai">ESOP for Tech Startups</a></strong> - tech-vertical scheme design with refresh grants and acceleration triggers; secondary programs are downstream liquidity vehicle.</li>
                    <li><strong><a href="/esop-for-saas-companies/mumbai">ESOP for SaaS Companies</a></strong> - B2B SaaS-specific design with ARR-linked vesting; secondary programs serve SaaS pre-IPO timelines.</li>
                    <li><strong><a href="/esop-restructuring-underwater-options/mumbai">ESOP Restructuring and Underwater Options</a></strong> - down-round remediation via Repricing, Exchange Program, Top-Up Grants, Vesting Acceleration or Cashout/Buyback; distinct from secondary sale (modification vs liquidity).</li>
                    ...
                    <li><strong><a href="/esop-corporate-filings/mumbai">ESOP Corporate Filings</a></strong> - ongoing MCA filings retainer covering MGT-14, PAS-3, MGT-7 plus SH-4, SH-9, SH-10, SH-11 for buyback workflows and SH-4 for tender offer transfer filings.</li>
...
<section class="content-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>A Mumbai secondary draws on four authorities at once - the Income Tax Act and Rules for the capital-gains spine, the Companies Act 2013 for any Section 68 buyback, SEBI's SBEB Regulations 2021 for the Trust route, and the FEMA NDI Rules that bite the moment a non-resident buys into a city cap table. The FEMA layer is what makes the Mumbai file heavier than most - SEBI is headquartered minutes away in BKC, but it is the RBI-administered FC-TRS clock and Rule 21 pricing floor, not SEBI approval, that govern an unlisted-share tender. The provisions below are the ones we work to on every engagement.</p>
                <ul>
            ...
            <div class="faq-expanded">
                ...
                <div class="faq-expanded__list">
                    ...
                    <div class="faq-expanded__item" id="faq-3">
                        <h3 class="faq-expanded__q">What is the tax on ESOP secondary sale in Mumbai?</h3>
                    ...
                    <div class="faq-expanded__item" id="faq-6">
                        <h3 class="faq-expanded__q">Who typically buys employee shares in a Mumbai tender offer?</h3>
                        <div class="faq-expanded__a"><p>In Mumbai the buyer is usually a growth fund, family office or existing VC based in the BKC and Lower Parel finance hubs, or a new investor coming in at the same round. The company orchestrates the tender; the investor funds it directly rather than the company using its own cash. SEBI is headquartered in BKC, but an unlisted-share tender needs no SEBI approval - only a Rule 11UA FMV floor and, for any cross-border buyer, FEMA NDI Rule 21 pricing and FC-TRS within 60 days. Pricing is benchmarked to the last round, often at a 10-30 percent discount.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-7">
                        <h3 class="faq-expanded__q">Does a Mumbai fintech secondary need extra FEMA compliance?</h3>
                        <div class="faq-expanded__a"><p>Often yes. Mumbai secondary candidates skew fintech and financial-services SaaS, which frequently have foreign investors on the cap table, so when a non-resident buys employee shares the transaction must price not below FMV under FEMA NDI Rule 21, file FC-TRS through the authorised dealer bank within 60 days, and respect any sectoral FDI cap - fintech and NBFC-linked sectors carry specific conditions. Section 195 TDS may apply on payment from the non-resident buyer. For resident-to-resident Mumbai deals none of this applies, only the Rule 11UA FMV floor and Section 50CA and 56(2)(x). Patron handles the FEMA and FC-TRS workstream end-to-end.</p></div>
                    </div>
                    ...
                    <div class="faq-expanded__item" id="faq-9">
                        ...
                        <div class="faq-expanded__a"><p>An ESOP secondary sale attracts capital gains tax. The cost basis is the FMV at the time of exercise under Section 49(2AA), because the perquisite tax already paid at exercise under Section 17(2)(vi) becomes the cost basis, so the same gain is not taxed twice. If the shares are held for more than 24 months, the gain is taxed as LTCG at 12.5 percent without indexation under Section 112 (post Finance Act 2024, effective 23 July 2024). If held for less than 24 months, the gain is taxed as STCG at the applicable slab rate (typically 30 percent plus surcharge plus cess). The holding period begins from the date of EXERCISE, not the date of grant. For example, if 10,000 shares are sold at Rs 500 each, with an FMV of Rs 200 at exercise (the cost basis), and held for 3 years, the capital gain is (500-200) x 10000 = Rs 30 lakh. The LTCG tax at 12.5 percent is Rs 3.75 lakh, plus surcharge and cess, totalling approximately Rs 4.29 lakh, leaving the employee with a net of Rs 45.71 lakh. Section 50CA and Section 56(2)(x) impose a penalty if the shares are sold below FMV. In a buyback (post Finance Act 2024), the proceeds are now taxed in the shareholder's hands as deemed dividend at the slab rate under Section 2(22)(f), so a shareholder in the 30 percent slab may bear tax of up to 39 percent. A tender offer is usually more tax-efficient. Where the buyer is cross-border, the FEMA NDI Rule 21 pricing rule (not below FMV) applies and FC-TRS must be filed within 60 days. Patron ESOP secondary sale advisory starts from INR 24,999/project. The stage-based scope is quoted on a free scoping call. Call <a href="tel:+919459456700" style="color:inherit;">+91 945 945 6700</a>.</p></div>
                    </div>
                </div>
            </div>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text" style="text-align:left;">
                ...
                <p style="color:rgba(255,255,255,0.92);">Ready to design your employee liquidity program? <strong><a href="tel:+919459456700" style="color:inherit;text-decoration:underline;">Call us at +91 945 945 6700</a></strong> or <strong><a href="https://wa.me/919459456700?text=Hello%2C%20I%20just%20visited%20your%20ESOP%20Secondary%20Sale%20Advisory%20in%20Mumbai%20page.%20I%20would%20like%20to%20know%20more%20about%20it." target="_blank" rel="noopener" style="color:inherit;text-decoration:underline;">WhatsApp us</a></strong> for a free ESOP secondary scoping call. Response within 4 hours. 8 to 14 week end-to-end timeline from diagnostic to post-tender communication.</p>

            </div>
            <div style="display:flex;gap:14px;flex-wrap:wrap;margin-top:24px;">
                <a href="tel:+919459456700" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:var(--orange);color:#fff;border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#128222; Call +91 945 945 6700</a>
                <a href="https://wa.me/919459456700?text=Hello%2C%20I%20just%20visited%20your%20ESOP%20Secondary%20Sale%20Advisory%20in%20Mumbai%20page.%20I%20would%20like%20to%20know%20more%20about%20it." target="_blank" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:#25D366;color:#fff;border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;" rel="noopener">&#128172; WhatsApp Us</a>
...
<section class="content-section" style="padding:48px 32px;background:var(--gray-50);">
    <div class="content-container"><div class="text-content">
        ...
        <div class="pa-city-grid"><a href="/esop-secondary-sale-advisory/pune" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Pune</div><div class="pa-card-sub">Maharashtra</div></div></a><span class="pa-city-card" aria-current="page" style="border-color:var(--orange);background:#FFF7F2;cursor:default;position:relative;"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Mumbai</div><div class="pa-card-sub">Maharashtra</div></div><span style="position:absolute;top:10px;right:12px;font-size:10px;font-weight:700;color:var(--orange);letter-spacing:.04em;">YOU'RE HERE</span></span><a href="/esop-secondary-sale-advisory/delhi" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Delhi</div><div class="pa-card-sub">Delhi NCR</div></div></a><a href="/esop-secondary-sale-advisory/gurugram" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Gurugram</div><div class="pa-card-sub">Haryana</div></div></a></div>
    </div></div>
</section>
