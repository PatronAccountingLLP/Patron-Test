...
@section('meta')
    <title>Mumbai ESOP TDS under Section 192 with Form 24Q Returns</title>
    <meta name="description" content="Get accurate Section 192 TDS on ESOP perquisites and timely Form 24Q returns for Mumbai's BKC and Powai employers, with sell-to-cover support, from INR 4,999.">
    <meta name="keywords" content="ESOP TDS Section 192 and Form 24Q Mumbai, ESOP TDS Section 192 and Form 24Q in Mumbai, ESOP TDS Section 192 and Form 24Q services in Mumbai, ESOP services Mumbai, ESOP TDS Section 192 and Form 24Q cost Mumbai, ESOP TDS Section 192 and Form 24Q consultants Mumbai, CA firm for ESOP TDS Section 192 and Form 24Q Mumbai, ESOP advisory Mumbai">
    <link rel="canonical" href="/esop-tds-section-192-and-form-24q/mumbai">
    <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1">
    <meta property="og:title" content="Mumbai ESOP TDS under Section 192 with Form 24Q Returns | Patron Accounting">
    <meta property="og:description" content="Get accurate Section 192 TDS on ESOP perquisites and timely Form 24Q returns for Mumbai's BKC and Powai employers, with sell-to-cover support, from INR 4,999.">
...
@section('schema')    <script type="application/ld+json">{
  ...
  "@graph": [
    {
      "@type": "Service",
      "@id": "https://www.patronaccounting.com/esop-tds-section-192-and-form-24q/mumbai#service",
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://www.patronaccounting.com/esop-tds-section-192-and-form-24q/mumbai#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
        ...
        },
        {
          ...
          "item": "https://www.patronaccounting.com/esop-tds-section-192-and-form-24q/mumbai"
        }
      ]
    },
    {
      ...
      "@id": "https://www.patronaccounting.com/esop-tds-section-192-and-form-24q/mumbai#localbusiness",
      "name": "Patron Accounting LLP - ESOP Tds Section 192 And Form 24Q, Mumbai",
      "url": "https://www.patronaccounting.com/esop-tds-section-192-and-form-24q/mumbai",
    ...
    {
      "@type": "FAQPage",
      "@id": "https://www.patronaccounting.com/esop-tds-section-192-and-form-24q/mumbai#faq",
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-4 private-registration-heading">
                        ESOP TDS under Section 192 and Form 24Q in Mumbai
                    </h1>

                    <p class="mb-4" style="font-size:16px;color:var(--text-secondary);">For BKC, Lower Parel and Powai employers under SEBI's watch, we value the exercise perquisite, withhold Section 192 TDS, and file Form 24Q against your Mumbai TAN.</p>
...
<section class="content-section" id="local-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">ESOP TDS for Mumbai Employers</h2>
            <div class="content-text">
                <p>Mumbai carries the densest mix of listed-company and large-cap ESOP plans in India. Financial institutions and listed groups in BKC and Lower Parel, technology and media firms in Andheri and Powai, and venture-backed teams in the Goregaon-Vikhroli corridor file under the Registrar of Companies (RoC) Mumbai. The TDS on each exercise, however, is a central income-tax obligation deposited against your TAN and reported in Form 24Q, regardless of where in the city you sit.</p>
                <p>For listed Mumbai companies, the FMV is the SEBI-prescribed market price on the exercise date, and broad-based exercise windows can push hundreds of employees into a single quarter's Form 24Q. For unlisted firms, a <a href="/esop-valuation-services/mumbai">merchant-banker valuation</a> sets the FMV. Either way, the Section 192 perquisite is added to salary, withheld at the average slab rate with surcharge and cess, and reconciled into Annexure II for Form 16.</p>
                <div class="highlight-box" style="margin-top:16px;">
                    <p><strong>Local example:</strong> a Lower Parel listed company runs an exercise window in December. Every perquisite is added to that month's salary, the TDS is deposited by 7 January, and the lot is reported in the Q3 Form 24Q due 31 January. We reconcile each Form 16 to Form 12BA and Form 26AS before issue to avoid employee notices.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>If even one option holder exercises in a quarter, the employer is in scope, and Mumbai's finance and SaaS ecosystems produce a steady stream of these events. The following employers across the city carry the obligation:</p>
                <ul>
                    <li>BKC and Lower Parel finance, fintech and listed groups whose staff exercise SEBI-priced listed ESOPs.</li>
                    <li>Andheri and Powai SaaS and media companies with unlisted, merchant-banker-valued option pools.</li>
                    <li>Indian arms of foreign parents withholding on overseas-parent ESOP and RSU benefits for Mumbai teams.</li>
                    <li>Venture-backed startups in the Goregaon-Vikhroli corridor weighing the <a href="/esop-startup-tds-deferral-section-192-1c/mumbai">Section 192(1C) deferral</a> for eligible employees.</li>
                    <li>HR and payroll desks that must issue and reconcile Form 16 after each exercise.</li>
                </ul>
                <p><strong>Statutory anchor:</strong> any employer that deducts salary TDS must file Form 24Q for that quarter under Rule 31A. Skip it and a Rs 200 per day fee bites under Section 234E, and your Mumbai employees are left unable to obtain their Form 16.</p>
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <table>
                    ...
                    <tbody>
                        <tr><td>Section 192 TDS Computation</td><td>We value the perquisite off the SEBI-formula price for listed BKC or Lower Parel issuers, compute slab-rate TDS, and fold it into the employee's monthly Mumbai payroll run.</td></tr>
                        <tr><td>Sell-to-Cover Coordination</td><td>For a non-cash BKC fintech or Powai SaaS perquisite, we size the share sale that funds the TDS so no payroll shortfall ever forms.</td></tr>
                        <tr><td>Form 24Q Quarterly Filing</td><td>Every quarter we build Annexure I, add Annexure II in Q4, validate employee PANs, and upload the FVU against your Mumbai TAN.</td></tr>
                        <tr><td>Form 16 Issuance</td><td>We pull Form 16 Part A and Part B from TRACES and hand them to your employees by 15 June.</td></tr>
                        <tr><td>Section 192(1C) Deferral</td><td>For Goregaon-Vikhroli corridor startups that hold DPIIT and IMB recognition, we apply the deferral and watch for the trigger event.</td></tr>
                        <tr><td>Notice and Default Resolution</td><td>We clear short-deduction and late-filing defaults raised by CPC-TDS.</td></tr>
...
<section class="steps-section" id="procedure-section">
    <div class="section-container">
        <header class="section-header" style="text-align:center;margin-bottom:48px;">
            ...
            <p class="section-subtitle" style="text-align:left;max-width:100%;">Whether you are a listed BKC group running a broad exercise window or a Powai startup with a handful of exercises, this is the quarter-by-quarter cycle we drive for Mumbai employers, from the first perquisite working through to a reconciled Form 16.</p>
        </header>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <ul>
                    <li>Per-employee perquisite working, with exercise date and the FMV source (SEBI-formula price for a listed BKC issuer, or the merchant-banker certificate for an unlisted Andheri or Powai firm).</li>
                    <li>Your Mumbai entity's TAN and TRACES login.</li>
                    <li>Employee PANs and monthly salary data for the quarter.</li>
                    <li>ITNS 281 challan details for the TDS already deposited.</li>
                    <li>DPIIT recognition and IMB certificate, where a corridor startup is claiming the Section 192(1C) deferral.</li>
                    <li>Acknowledgements of the earlier 24Q quarters in the same financial year.</li>
                </ul>
                <div class="highlight-box" style="margin-top:16px;">
                    <p><strong>Why the ESOP perquisite catches Mumbai payroll teams out</strong></p>
                    <p>The gain is non-cash, so there is no fresh salary outflow to deduct from. A BKC fintech therefore has to either recover the tax from the employee or run a sell-to-cover, and then still report the perquisite in the correct quarter's Form 24Q against its Mumbai TAN.</p>
                </div>
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <table>
                    ...
                    <tbody>
                        <tr><td>A BKC issuer's wide exercise window dumps hundreds of perquisites into one quarter</td><td>Volume and deadline crunch</td><td>We process the batch, validate every PAN, and file the Form 24Q before the due date.</td></tr>
                        <tr><td>Non-cash perquisite with no salary to deduct from</td><td>Funding shortfall</td><td>We structure a sell-to-cover or employee recovery so the TDS is funded and deposited on time.</td></tr>
                        <tr><td>Under-deduction at a Powai SaaS startup triggers Section 201 interest</td><td>1% or 1.5% per month</td><td>We compute the correct slab TDS with surcharge and cess ahead of the deposit date.</td></tr>
                        <tr><td>Form 16 mismatches the employee's Form 26AS</td><td>Employee notices</td><td>We reconcile Annexure II, Form 12BA and Form 26AS before any Form 16 is issued.</td></tr>
                        <tr><td>Plan documents still quote the old section and form numbers</td><td>Outdated references</td><td>We refresh references for the Income-tax Act 2025 (192 to 392, 24Q to 138, 16 to 130).</td></tr>
...
<article class="feature-card">
            ...
            <p class="feature-text">Accurate slab-rate TDS on the non-cash perquisite, valued off the SEBI price for listed BKC issuers, so Section 201 interest never bites.</p>
        </article>
<article class="feature-card">
            ...
            <p class="feature-text">Form 24Q filed ahead of the due date each quarter, even through a heavy exercise window, so the Rs 200 per day Section 234E fee stays off your books.</p>
        </article>
<article class="feature-card">
            ...
            <p class="feature-text">Form 16 tied out against Form 12BA and Form 26AS before it reaches your Mumbai employees, heading off mismatch notices.</p>
        </article>
<article class="feature-card">
            ...
            <p class="feature-text">Your plan documents and payroll templates refreshed for the Income-tax Act 2025 renumbering to Section 392, Form 138 and Form 130.</p>
        </article>
        </div>
    </div>
</section>
            ...
            <div class="faq-expanded">
                ...
                <div class="faq-expanded__list">
                    ...
                    <div class="faq-expanded__item" id="faq-3">
                        <h3 class="faq-expanded__q">How is the ESOP perquisite valued for a listed Mumbai company?</h3>
                        <div class="faq-expanded__a"><p>For a listed BKC or Lower Parel company, the FMV on the exercise date is the SEBI-formula market price (the average of the opening and closing price on the recognised stock exchange). The perquisite is that FMV minus the exercise price, times shares. For unlisted Mumbai firms, a SEBI-registered merchant banker certifies the FMV. The result is added to salary and withheld under Section 192.</p></div>
                    </div>
                    ...
                    <div class="faq-expanded__item" id="faq-5">
                        <h3 class="faq-expanded__q">How is ESOP TDS handled for a BKC fintech using sell-to-cover?</h3>
                        <div class="faq-expanded__a"><p>For a fintech in BKC or Lower Parel, the ESOP perquisite is non-cash, so most employers run a sell-to-cover: part of the exercised shares is sold to fund the Section 192 TDS and the net shares go to the employee. The employer still deposits the full TDS by the 7th of the next month and reports it in Form 24Q against the Mumbai entity TAN. We document the sell-to-cover working so the perquisite, the shares sold, and the deposited TDS reconcile in Annexure II and the eventual Form 16.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-6">
                        <h3 class="faq-expanded__q">Can a Goregaon or Vikhroli corridor startup defer ESOP TDS?</h3>
                        <div class="faq-expanded__a"><p>Only if it holds both DPIIT recognition and an IMB certificate under Section 80-IAC. Many venture-backed Mumbai startups have DPIIT recognition but not the IMB certificate, so they cannot use the Section 192(1C) deferral. Where it does qualify, TDS defers to the earliest of 48 months from the end of the relevant assessment year, the date of sale, or cessation of employment.</p></div>
                    </div>
                    ...
                    <div class="faq-expanded__item" id="faq-8">
                        <h3 class="faq-expanded__q">Which RoC and jurisdiction applies to ESOP filings for Mumbai companies?</h3>
                        <div class="faq-expanded__a"><p>Mumbai companies are registered with the Registrar of Companies (RoC) Mumbai under the MCA for corporate filings, while ESOP TDS is a central income-tax obligation filed in Form 24Q against your TAN through TRACES, not the RoC. We run Section 192 computation and quarterly filing for employers across BKC, Lower Parel, Andheri, Powai and the Goregaon-Vikhroli corridor, in person and remotely.</p></div>
                    </div>
                </div>
            </div>
