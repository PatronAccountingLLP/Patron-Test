...
@section('meta')
    <title>Delhi ESOP Valuation: MCA-Ready Rule 11UA FMV Reports</title>
    <meta name="description" content="ESOP valuation for Delhi startups near Nehru Place and Connaught Place - MCA-ready, Rule 11UA-compliant FMV and merchant banker reports from INR 24,999.">
    <meta name="keywords" content="ESOP Valuation Services Delhi, ESOP Valuation Services in Delhi, ESOP Valuation Services services in Delhi, ESOP services Delhi, ESOP Valuation Services cost Delhi, ESOP Valuation Services consultants Delhi, CA firm for ESOP Valuation Services Delhi, ESOP advisory Delhi">
    <link rel="canonical" href="/esop-valuation-services/delhi">
    <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1">
    <meta property="og:title" content="Delhi ESOP Valuation: MCA-Ready Rule 11UA FMV Reports | Patron Accounting">
    <meta property="og:description" content="ESOP valuation for Delhi startups near Nehru Place and Connaught Place - MCA-ready, Rule 11UA-compliant FMV and merchant banker reports from INR 24,999.">
...
@section('schema')    <script type="application/ld+json">{
  ...
  "@graph": [
    {
      "@type": "Service",
      "@id": "https://www.patronaccounting.com/esop-valuation-services/delhi#service",
      "name": "ESOP Valuation Services in Delhi",
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://www.patronaccounting.com/esop-valuation-services/delhi#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
    ...
    },
    {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "Who can do ESOP valuation in Delhi?",
          "acceptedAnswer": {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          "name": "Does RoC Delhi jurisdiction cover Haryana and Gurugram companies too?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes. The Registrar of Companies, Delhi has jurisdiction over the NCT of Delhi and the State of Haryana, so a Gurugram or Faridabad company files its PAS-3 allotments, MGT-14 resolutions and FC-GPR cross-border forms with RoC Delhi, not a separate Haryana registry. For ESOP valuation this means the Section 247 registered-valuer report and the downstream Companies Act filings follow the same RoC route for Delhi and Gurugram entities. Patron handles both from one engagement and keeps the FMV evidence consistent across the group."
          }
        },
        {
          "@type": "Question",
          "name": "How much does an ESOP valuation report cost in Delhi?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "ESOP valuation services for Delhi companies start from INR 24,999 (exclusive of GST and government charges). The exact fee depends on the methodology, the company's stage and the number of valuation events, so stage-based scope is quoted on a free scoping call."
          }
        },
        {
          "@type": "Question",
          "name": "What valuation does a Delhi startup need when raising from NRI angel investors?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "When a Saket or Aerocity startup issues shares to NRI or overseas angels, the price must be at least the Fair Market Value certified under Rule 21 of the FEMA Non-Debt Instruments Rules 2019, filed with FC-GPR within 30 days of issuance. A SEBI Merchant Banker or a CA may sign using internationally accepted methods, usually DCF. If the same founders also grant ESOPs around the raise, Patron issues the grant-date FMV under Section 247 alongside the FEMA report so both rest on one evidence base."
          }
        },
        {
          "@type": "Question",
        ...
        {
          "@type": "Question",
          "name": "What Companies Act filings follow an ESOP grant valuation?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "After a grant-date FMV under Section 247, a Delhi company filing with RoC Delhi typically passes a board and shareholder resolution for the ESOP scheme and files MGT-14 for the special resolution, then files PAS-3 on any fresh allotment when options are exercised. The valuation report supports the exercise price set under Section 62(1)(b). Patron sequences the registered-valuer report and these MGT-14 and PAS-3 filings so the FMV, the resolution and the allotment stay aligned."
          }
        },
        {
          "@type": "Question",
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-4 private-registration-heading">
                        ESOP Valuation Services in Delhi
                    </h1>

                    <p class="mb-4" style="color: var(--text-secondary); font-size: 16px; max-width: 640px;">For Delhi NCR cap tables built around NRI and overseas angels - and filing with RoC Delhi, in the same city as the MCA head office - Patron issues grant, exercise and FEMA cross-border FMV reports that clear scrutiny on the first read.</p>
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="https://wa.me/919459456700?text=Hello%2C%20I%20just%20visited%20your%20ESOP%20Valuation%20Services%20in%20Delhi%20page.%20I%20would%20like%20to%20know%20more%20about%20it." target="_blank" class="btn-sample text-decoration-none" rel="noopener">
...
@include('partials.testimonials', [
    ...
    'ctaText'    => 'Trusted by founders, CFOs and CS teams for Rule 11UA-compliant ESOP and share valuation reports.',
])
        ...
        <div class="two-column">
            <div class="column-content">
                ...
                <div class="content-text what-is-definition">
                    ...
                    <p>Take a Nehru Place IT-product company that has just hired a senior engineering bench from a US-headquartered rival and wants to lock them in with options. Before a single grant is priced, it needs a signed Fair Market Value (FMV) certificate - the per-share number that sets the exercise price today, drives the <a href="/esop-perquisite-tax-section-17-2-vi/delhi">perquisite charged later under Section 17(2)(vi)</a> of the Income Tax Act 1961, and, if an overseas fund joins the cap table, certifies the share price under the FEMA NDI Rules 2019. That certificate is what "ESOP valuation services" delivers.</p>
                    <p>Which valuer signs is decided by why the report exists, not by who you call first. Companies Act grant work goes to an IBBI-Registered Valuer under Section 247; Income Tax exercise FMV and cross-border pricing go to a SEBI Category I Merchant Banker. In Delhi the two almost never arrive apart - the same Aerocity venture grants to engineers and closes an NRI-led round in overlapping weeks, while a Connaught Place finance house refreshes an exercise FMV the same quarter it issues fresh stock.</p>
                    <p>The legal recipe is fixed regardless of postcode: Rule 11UA of the Income Tax Rules 1962, Section 247 of the Companies Act 2013 read with the Companies (Registered Valuers and Valuation) Rules 2017, and Rule 21 of the FEMA Non-Debt Instruments Rules 2019. What changes in the capital is the scrutiny bar - with the Ministry of Corporate Affairs headquartered here and every filing routing through RoC Delhi, a thinly-supported report does not survive. Patron Accounting LLP keeps both valuer tracks inside one engagement so PAS-3, FC-GPR, FC-TRS, MGT-14 and the Section 17(2)(vi) perquisite TDS all trace back to a single FMV evidence base.
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>In the capital the order in which these triggers appear is its own story - the cross-border raise tends to come before the option pool is fully drafted, because Delhi cap tables lean on NRI and overseas money. From the Nehru Place IT cluster to the Saket and Aerocity startup belt, these are the moments that put a Delhi company in front of a valuer:</p>
                <ul>
                    <li><strong>Raising from NRI or overseas angels:</strong> a Saket consumer-tech venture issuing shares to non-resident investors needs FMV for the FEMA FC-GPR filing under Rule 21 of the NDI Rules - typically the first valuer engagement a Delhi NCR founder ever commissions, ahead of any grant</li>
                    <li><strong>Designing the ESOP scheme:</strong> grant-date FMV to set the exercise-price formula (IBBI Registered Valuer under Section 62(1)(b)) - typical when a Nehru Place trading firm formalises an option pool for senior staff</li>
...
<section class="content-section" id="services-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">ESOP Valuation in the Delhi Market</h2>
            <div class="content-text" style="margin-bottom:40px;">
                <p>Delhi's ESOP market blends old economy and new. The Nehru Place IT hub and Connaught Place commercial core hold long-established IT-product, trading and professional-services companies that grant ESOPs to retain senior talent, while the Saket and Aerocity corporate belt has become a magnet for D2C, edtech and SaaS founders who set up option pools at incorporation. With the Ministry of Corporate Affairs headquartered in the capital, Companies Act compliance - Section 247 registered-valuer reports, MGT-14 board approvals and PAS-3 allotments - is held to a high standard here, and many Delhi founders also raise from NRI and overseas angels, pulling FEMA NDI valuation into the picture.</p>
                <p>Delhi-registered companies file with <strong>RoC Delhi</strong>, which also has jurisdiction over Haryana, so PAS-3, MGT-14 and FC-GPR filings for both Delhi and Gurugram entities route through the same registry. Patron benchmarks each engagement to the company's profile: a Nehru Place IT firm granting to senior staff usually needs a clean grant-date FMV under Section 247, while a Saket consumer-tech startup raising from NRI angels needs a coordinated grant-date FMV and a FEMA NDI report under Rule 21. We run the IBBI Registered Valuer and SEBI Merchant Banker tracks together so one FMV evidence base feeds grant, exercise perquisite and cross-border issuance.</p>
            </div>
...
<section class="steps-section" id="procedure-section">
    <div class="section-container">
        <div class="section-header" style="text-align:center;margin-bottom:48px;">
            ...
            <p class="section-subtitle" style="text-align:left;max-width:100%;">Whether you are a Connaught Place finance house or a Saket consumer-tech startup, the path runs the same 8 steps - scoping to signed report - covering both IBBI Registered Valuer and SEBI Category I Merchant Banker deliverables under one Patron engagement, with RoC Delhi filings sequenced off the same FMV.</p>
        </div>
    ...
    <div class="step-content">
        ...
        <p class="step-description">30 to 45 minutes to pin down purpose (grant, exercise, FEMA, Ind AS 102), the regulatory hook (Rule 11UA(1) vs 11UA(2), Section 247, NDI Rule 21), the valuer required (IBBI vs Merchant Banker), and timing. For a Delhi founder raising from NRI angels we map the FEMA NDI report and grant-date FMV together here.</p>
...
<div class="step-card">
    <div class="step-content">
        ...
        <p class="step-description">DCF for revenue-generating growth-stage, NAV for asset-heavy or pre-revenue, hybrid where appropriate; document methodology rationale in working papers.</p>
        <div class="step-highlights">
...
<div class="step-card">
    <div class="step-content">
        ...
        <p class="step-description">The signed report drives PAS-3, FC-GPR, FC-TRS, MGT-14 or Section 17(2)(vi) perquisite TDS as applicable - for Delhi and Gurugram entities these route through RoC Delhi, all on the same FMV evidence.</p>
        <div class="step-highlights">
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>What a Delhi company - whether a Nehru Place trading firm or a Saket consumer-tech venture - puts in front of the valuer to build a defensible FMV:</p>
                <ul>
                    ...
                    <li>Latest funding round documents - Term Sheet, SHA, SSPA, PAS-3 and FC-GPR (key where the round includes NRI or overseas investors)</li>
                    ...
                    <li>Intellectual property register, key contracts and management bench profile</li>
...
<section class="content-section" id="challenges-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p style="margin-bottom:20px;">Delhi cap tables lean heavily on NRI and overseas angels, and the MCA head office sets a high documentation bar - so the friction points here cluster around cross-border FMV and scrutiny defence. The issues Patron sees most often with capital-city companies:</p>
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Challenge</th><th>Impact</th><th>How Patron Accounting Solves It</th></tr></thead>
                    <tbody>
                        <tr><td>Mismatch between FEMA FMV and Income Tax FMV</td><td>Section 56(2)(x) on recipient + FEMA non-compliance on issuer - dual regulator risk, common when a Saket startup raises from NRI angels</td><td>Patron aligns both valuations on the same date and methodology so a single report defends both regulators.</td></tr>
<tr><td>Income Tax AO rejecting DCF methodology</td><td>Legacy Section 56(2)(viib) demand additions; methodology disputes at scrutiny</td><td>Patron drafts methodology rationale citing stage, revenue trajectory and peer benchmarks; maintains parallel NAV computation as defence position. Section 56(2)(viib) is abolished from FY 2025-26 by Finance Act 2024 but prior-year assessments remain open.</td></tr>
<tr><td>Valuation older than 180 days at exercise</td><td>Perquisite TDS exposed to reassessment under Rule 3(8); employee TDS may be challenged</td><td>Annual retainer model refreshes the Merchant Banker FMV every 180 days or before any exercise batch. Validity tracked automatically.</td></tr>
<tr><td>Black-Scholes confusion with Rule 11UA FMV</td><td>Founders using Black-Scholes output as grant-date FMV - rejected at scrutiny</td><td>Black-Scholes is Ind AS 102 compensation expense fair value, not per-share FMV under Rule 11UA. Patron keeps these separate and runs both as needed.</td></tr>
...
<tr><td>Annual Retainer (4 events)</td><td>Quoted on scoping call<br><small>Bundled grant + exercise + funding + cross-border</small></td></tr>
                ...
                <p style="margin-top:16px;"><strong>Get a free ESOP Valuation consultation - <a href="tel:+919459456700">Call +91 945 945 6700</a> or <a href="https://wa.me/919459456700?text=Hello%2C%20I%20just%20visited%20your%20ESOP%20Valuation%20Services%20in%20Delhi%20page.%20I%20would%20like%20to%20know%20more%20about%20it." target="_blank" rel="noopener">WhatsApp us</a>. No-obligation assessment.</strong></p>
            </div>
        </div>
    </div>
</section>
...
<section class="why-choose-section" id="benefits-section">
    <div class="section-container">
        <div style="text-align:center;margin-bottom:48px;">
            ...
            <p class="section-subtitle" style="margin:0 auto;">For Delhi companies - Nehru Place IT firms, Connaught Place finance houses and Saket-Aerocity ventures alike - the value is one team handling both valuer regimes and the RoC Delhi filings that follow, with cross-border FMV kept watertight for NRI-funded cap tables.</p>
        </div>
...
<article class="feature-card">
    ...
    <p class="feature-description">IBBI Registered Valuer and SEBI Cat I Merchant Banker under one engagement - no juggling two firms.</p>
</article>
<article class="feature-card">
    ...
    <p class="feature-description">DCF, NAV, CCA, CTA, PWERM, OPM and Black-Scholes selected by company stage and report purpose.</p>
</article>
<article class="feature-card">
    ...
    <p class="feature-description">One firm coordinating valuation, MGT-14, PAS-3, FC-GPR, FC-TRS and Section 17(2)(vi) perquisite filings - all routed through RoC Delhi for Delhi and Gurugram entities.</p>
</article>
<article class="feature-card">
...
<article class="feature-card">
    ...
    <p class="feature-description">Methodology rationale, sensitivity analysis and director certification - built for scrutiny defence.</p>
</article>
<article class="feature-card">
    ...
    <p class="feature-description">Response to legacy Section 56(2)(viib) and Section 56(2)(x) Income Tax notices and FEMA compounding queries - the cross-border issues Delhi's NRI-funded ventures hit most.</p>
</article>
</div>
    </div>
</section>
...
<section class="content-section" id="comparison-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p style="margin-bottom:20px;">For Delhi NCR companies the method is rarely a free choice - it is dictated by the trigger. A Saket startup pricing an NRI-led FC-GPR is pushed toward DCF under Rule 11UA(2)(b) and signed by a Merchant Banker; a Nehru Place asset-heavy trading firm granting to staff usually rests on NAV, which an Income Tax AO seldom disturbs. Where the cap table carries multiple share classes from successive overseas rounds - common in the Aerocity belt - OPM or PWERM allocates value across the waterfall. The table below maps each method to when it fits, who may sign it, and where it tends to fail.</p>
                <div class="table-responsive-wrapper">
                <table>
...
<tr><td>CTA (Comparable Transaction Analysis)</td><td>Recent M&amp;A or funding round benchmarking</td><td>Merchant Banker</td><td>Transaction-evidence based</td><td>Data scarcity for early-stage Delhi startups</td></tr>
            ...
            <div class="faq-expanded">
                ...
                <div class="faq-expanded__list">
                    <div class="faq-expanded__item" id="faq-1">
                        <h3 class="faq-expanded__q">Who can do ESOP valuation in Delhi?</h3>
                    ...
                    <div class="faq-expanded__item" id="faq-2">
                        <h3 class="faq-expanded__q">Does RoC Delhi jurisdiction cover Haryana and Gurugram companies too?</h3>
                        <div class="faq-expanded__a"><p>Yes. The Registrar of Companies, Delhi has jurisdiction over the NCT of Delhi and the State of Haryana, so a Gurugram or Faridabad company files its PAS-3 allotments, MGT-14 resolutions and FC-GPR cross-border forms with RoC Delhi, not a separate Haryana registry. For ESOP valuation this means the Section 247 registered-valuer report and the downstream Companies Act filings follow the same RoC route for Delhi and Gurugram entities. Patron handles both from one engagement and keeps the FMV evidence consistent across the group.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-3">
                        <h3 class="faq-expanded__q">How much does an ESOP valuation report cost in Delhi?</h3>
                        <div class="faq-expanded__a"><p>ESOP valuation services for Delhi companies start from INR 24,999 (exclusive of GST and government charges). The exact fee depends on the methodology, the company's stage and the number of valuation events, so stage-based scope is quoted on a free scoping call.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-4">
                        <h3 class="faq-expanded__q">What valuation does a Delhi startup need when raising from NRI angel investors?</h3>
                        <div class="faq-expanded__a"><p>When a Saket or Aerocity startup issues shares to NRI or overseas angels, the price must be at least the Fair Market Value certified under Rule 21 of the FEMA Non-Debt Instruments Rules 2019, filed with FC-GPR within 30 days of issuance. A SEBI Merchant Banker or a CA may sign using internationally accepted methods, usually DCF. If the same founders also grant ESOPs around the raise, Patron issues the grant-date FMV under Section 247 alongside the FEMA report so both rest on one evidence base.</p></div>
                    </div>
                    ...
                    <div class="faq-expanded__item" id="faq-7">
                        <h3 class="faq-expanded__q">What Companies Act filings follow an ESOP grant valuation?</h3>
                        <div class="faq-expanded__a"><p>After a grant-date FMV under Section 247, a Delhi company filing with RoC Delhi typically passes a board and shareholder resolution for the ESOP scheme and files MGT-14 for the special resolution, then files PAS-3 on any fresh allotment when options are exercised. The valuation report supports the exercise price set under Section 62(1)(b). Patron sequences the registered-valuer report and these MGT-14 and PAS-3 filings so the FMV, the resolution and the allotment stay aligned.</p></div>
                    </div>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p style="margin-top:16px;"><strong>Need urgent valuation support? <a href="tel:+919459456700">Call +91 945 945 6700</a> or <a href="https://wa.me/919459456700?text=Hello%2C%20I%20just%20visited%20your%20ESOP%20Valuation%20Services%20in%20Delhi%20page.%20I%20would%20like%20to%20know%20more%20about%20it.">WhatsApp us</a>. Response within 2 hours.</strong></p>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div style="display:flex;gap:14px;flex-wrap:wrap;margin-top:24px;">
                ...
                <a href="https://wa.me/919459456700?text=Hello%2C%20I%20just%20visited%20your%20ESOP%20Valuation%20Services%20in%20Delhi%20page.%20I%20would%20like%20to%20know%20more%20about%20it." target="_blank" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:#25D366;color:#fff;border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;" rel="noopener">&#128172; WhatsApp Us</a>
...
<section class="content-section" style="padding:48px 32px;background:var(--gray-50);">
    <div class="content-container"><div class="text-content">
        ...
        <div class="pa-city-grid"><a href="/esop-valuation-services/pune" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Pune</div><div class="pa-card-sub">Maharashtra</div></div></a><a href="/esop-valuation-services/mumbai" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Mumbai</div><div class="pa-card-sub">Maharashtra</div></div></a><span class="pa-city-card" aria-current="page" style="border-color:var(--orange);background:#FFF7F2;cursor:default;position:relative;"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Delhi</div><div class="pa-card-sub">Delhi NCR</div></div><span style="position:absolute;top:10px;right:12px;font-size:10px;font-weight:700;color:var(--orange);letter-spacing:.04em;">YOU'RE HERE</span></span><a href="/esop-valuation-services/gurugram" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Gurugram</div><div class="pa-card-sub">Haryana</div></div></a></div>
    </div></div>
</section>
