...
@section('meta')
    <title>Delhi ESOP Vesting Tracking & SH-6 Forfeiture Logs</title>
    <meta name="description" content="Delhi startups get reconciled ESOP records: vesting milestones tracked, forfeitures filed in Form SH-6 and vesting alerts sent, from INR 9,999/yr.">
    <meta name="keywords" content="ESOP Vesting and Forfeiture Tracking Delhi, ESOP Vesting and Forfeiture Tracking in Delhi, ESOP Vesting and Forfeiture Tracking services in Delhi, ESOP services Delhi, ESOP Vesting and Forfeiture Tracking cost Delhi, ESOP Vesting and Forfeiture Tracking consultants Delhi, CA firm for ESOP Vesting and Forfeiture Tracking Delhi, ESOP advisory Delhi">
    <link rel="canonical" href="/esop-vesting-and-forfeiture-tracking/delhi">
    <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1">
    <meta property="og:title" content="Delhi ESOP Vesting Tracking & SH-6 Forfeiture Logs | Patron Accounting">
    <meta property="og:description" content="Delhi startups get reconciled ESOP records: vesting milestones tracked, forfeitures filed in Form SH-6 and vesting alerts sent, from INR 9,999/yr.">
...
@section('schema')    <script type="application/ld+json">{
  ...
  "@graph": [
    {
      "@type": "Service",
      "@id": "https://www.patronaccounting.com/esop-vesting-and-forfeiture-tracking/delhi#service",
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://www.patronaccounting.com/esop-vesting-and-forfeiture-tracking/delhi#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
        ...
        },
        {
          ...
          "item": "https://www.patronaccounting.com/esop-vesting-and-forfeiture-tracking/delhi"
        }
      ]
    },
    {
      ...
      "@id": "https://www.patronaccounting.com/esop-vesting-and-forfeiture-tracking/delhi#localbusiness",
      "name": "Patron Accounting LLP - ESOP Vesting And Forfeiture Tracking, Delhi",
      "url": "https://www.patronaccounting.com/esop-vesting-and-forfeiture-tracking/delhi",
    ...
    {
      "@type": "FAQPage",
      "@id": "https://www.patronaccounting.com/esop-vesting-and-forfeiture-tracking/delhi#faq",
      ...
      "mainEntity": [
        ...
        {
          "@type": "Question",
          "name": "Why is it essential to track ESOP vesting?",
          "acceptedAnswer": {
            "@type": "Answer",
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-4 private-registration-heading">
                        ESOP Vesting and Forfeiture Tracking in Delhi
                    </h1>

                    <p class="mb-4" style="font-size:16px;color:var(--text-secondary);line-height:1.7;">For Delhi companies under RoC Delhi and within reach of the MCA head office in the capital, we keep your SH-6 register live for Nehru Place, Connaught Place and Saket-Aerocity option pools, with vesting tracked and NRI holders kept informed.</p>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>Delhi's option-issuing employers spread across the Nehru Place IT district, the Connaught Place finance core and the Saket-Aerocity corporate belt, and being in the NCR with the MCA headquartered in the capital means board approvals, RoC filings and ESOP records get scrutinised carefully here. Options vest every month, employees come and go, and each event has to be recorded, notified and reflected in your SH-6 register, or your cap table quietly drifts out of truth. Patron Accounting tracks it for you on a subscription basis: monthly vesting milestones, forfeiture events recorded in SH-6, employee notifications, and automated alerts for upcoming vesting.</p>
                <p>In a market where consumer-tech and product ventures around Saket grant equity aggressively and trading houses near Nehru Place run leaner pools, the one constant is movement: a tranche vests, a desk loses a hire, an overseas holder asks what they now own. Left to a founder's spreadsheet, those moving parts fall behind within a quarter, and the bill comes due the day an out-of-state lead investor asks for a clean cap table. We replace that reconstruction risk with a register that is always current.</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>Whether you are a Nehru Place trading firm with a lean option pool or a Saket consumer-tech venture handing equity to a fast-growing product team, the same discipline applies: every event we handle flows straight into your SH-6 register, so the statutory book and the live schedule stay in lockstep. Here is what we keep current month after month:</p>
                <ul>
                    <li><strong>SH-6 entries posted in real time:</strong> grants, vesting, exercise, lapse and forfeiture, each with its date and cause, kept inspection-ready for an RoC Delhi audit.</li>
                    <li><strong>Vesting milestones tranche by tranche:</strong> we follow each employee's schedule as options vest, so the vested and unvested split is always exact.</li>
                    <li><strong>Forfeiture on every exit:</strong> when someone leaves a Connaught Place finance team or a Nehru Place desk, the unvested options are forfeited and returned to the pool.</li>
                    <li><strong>Pool reconciliation:</strong> granted, vested, exercised and forfeited numbers tie back to the authorised pool at all times.</li>
                    <li><strong>Vesting notifications to employees,</strong> including NRI option-holders who need clear written confirmation of what has vested.</li>
                    <li><strong>Upcoming-vesting and exercise-window alerts</strong> sent ahead of every key date so nothing slips.</li>
                </ul>
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <table>
                    ...
                    <tbody>
                        <tr><td>SH-6 Register Upkeep</td><td>We post grants, vesting, exercise, lapse and forfeiture to the Form SH-6 register with dates and causes, so a Delhi statutory audit or RoC Delhi inspection finds it complete.</td></tr>
                        <tr><td>Vesting Milestone Tracking</td><td>We run each employee's schedule and update every tranche as it vests, keeping a live vested-versus-unvested position for the whole option base.</td></tr>
                        <tr><td>Forfeiture Event Management</td><td>For each leaver, common in product and trading teams across Nehru Place and Saket, we apply the scheme's leaver terms, record the forfeiture in SH-6 and return the options to the pool.</td></tr>
                        <tr><td>Alerts and Employee Notices</td><td>We flag upcoming vesting and exercise deadlines to the company and issue vesting notices to staff, including NRI holders and post-termination exercise windows.</td></tr>
                        <tr><td>Periodic Reporting and Pool Reconciliation</td><td>You receive a regular vesting and forfeiture report tied back to the authorised pool, ready for an NCR diligence room on short notice.</td></tr>
...
<section class="steps-section" id="procedure-section">
    <div class="section-container">
        <header class="section-header" style="text-align:center;margin-bottom:48px;">
            ...
            <p class="section-subtitle" style="text-align:left;max-width:100%;">From a Nehru Place trading firm to a Saket consumer-tech venture, the same monthly cadence keeps your vesting and forfeiture record live, reconciled and ready for any RoC Delhi audit or NCR investor diligence, all year.</p>
        </header>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>Unlike vesting, which follows the calendar, forfeiture is triggered by an employee walking out the door, which is exactly why it is the entry most often missed. In high-churn Delhi product and trading teams, around Nehru Place or the Saket-Aerocity belt, a single quarter can bring several exits, and each one changes the pool.</p>
                ...
                <p><strong>Each forfeiture must be recorded in SH-6 with the date and cause,</strong> and the forfeited options returned to the pool so it reconciles. We capture the leaver event, apply the scheme's <a href="/esop-employee-exit-and-good-leaver-bad-leaver/delhi">good-leaver or bad-leaver terms</a>, and post the entry, so nothing is missed and the pool stays correct, the kind of detail an NCR investor's counsel checks line by line before they sign.</p>
                <div class="highlight-box" style="margin-top:16px;">
                    <p><strong>Alerts and employee notifications</strong></p>
                    <p>We send upcoming-vesting alerts to the company ahead of each vesting date and exercise deadline, vesting notices to employees, including NRI option-holders working out of the country, when their options vest, and leaver-window flags when a departing employee's exercise window is running, so no one in a Connaught Place finance team or a Nehru Place desk is caught out.</p>
                </div>
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <table>
                    ...
                    <tbody>
                        <tr><td>Frequent exits in Nehru Place and Saket teams go unrecorded</td><td>Pool overstated, SH-6 incomplete</td><td>Capture each leaver and post the dated forfeiture entry to SH-6.</td></tr>
                        <tr><td>Vesting run off a stale founder spreadsheet</td><td>Vested-versus-unvested numbers drift from truth</td><td>Maintain a live, reconciled vesting position month by month.</td></tr>
                        <tr><td>Pool fails to reconcile when NCR investors open the data room</td><td>Diligence red flag, deal delay</td><td>Tie granted, vested, exercised and forfeited back to the authorised pool on demand.</td></tr>
                        <tr><td>NRI and remote option-holders unsure what has vested</td><td>Disputes and lapsed exercise windows</td><td>Issue clear vesting notices and exercise-window flags to every holder.</td></tr>
...
<article class="feature-card">
            ...
            <h3 class="feature-title">NCR diligence-ready</h3>
            <p class="feature-text">When a Connaught Place or Gurugram investor opens the data room, your pool reconciles on demand, with no last-minute reconstruction.</p>
        </article>
<article class="feature-card">
            ...
            <h3 class="feature-title">RoC Delhi audit-ready SH-6</h3>
            <p class="feature-text">Every forfeiture from your Nehru Place or Saket team recorded in SH-6 with its date and cause, ready for inspection.</p>
        </article>
<article class="feature-card">
            ...
            <h3 class="feature-title">Every holder informed</h3>
            <p class="feature-text">Staff and NRI option-holders kept clear on what has vested, so equity stays motivating and disputes are rare.</p>
        </article>
<article class="feature-card">
            ...
            <h3 class="feature-title">Live, never behind</h3>
            <p class="feature-text">A reconciled vesting position maintained month by month, never a stale spreadsheet rebuilt before year-end.</p>
        </article>
        </div>
    </div>
</section>
...
<section class="content-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">ESOP Vesting Tracking for Delhi's Corporate and IT Districts</h2>
            <div class="content-text">

                <p>10,000+ Businesses  |  4.9 Google Rating  |  50,000+ Documents Processed  |  15+ Years</p>
                <p>Delhi-incorporated companies file with the Registrar of Companies (RoC) Delhi, which sits in the same NCR as the Ministry of Corporate Affairs headquarters, so option-pool and ESOP record-keeping is held to a visible standard here. A large share of the city's option-issuing employers cluster in three areas we work with closely: the Nehru Place IT district, the Connaught Place finance core, and the Saket-Aerocity corporate belt. These mix product startups with established corporates, which means varied vesting designs and frequent leaver events to record.</p>
                <p>The standard Indian grant most Delhi companies run, a four-year schedule with a one-year cliff, means roughly a quarter of each grant vests at month twelve and the rest monthly or quarterly thereafter, so the vested and unvested split moves every single month. We track that for each tranche, post leaver forfeitures to SH-6 against the scheme's good-leaver and bad-leaver terms, and keep the option pool reconciled. Patron Accounting LLP is a CA and CS firm with 15+ years of this work, with a Delhi presence plus offices in Pune, Mumbai and Gurugram, serving clients in person and remotely.</p>
...
<section class="content-section" id="comparison-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>This comes up constantly in Delhi engagements, particularly with NRI and overseas option-holders who worry that a vesting milestone has created an Indian tax bill. It has not. Vesting is purely a record-keeping step; the <a href="/esop-perquisite-tax-section-17-2-vi/delhi">perquisite charge arises only at exercise</a> and <a href="/esop-capital-gains-tax-on-sale/delhi">capital gains only on sale</a>. Our tracking service keeps the SH-6 position and the vested-versus-unvested split straight, while the actual tax at exercise is handled separately by payroll and tax teams, an especially useful split for a Connaught Place finance team coordinating with employees across time zones.</p>
                <div class="table-responsive-wrapper">
                <table>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>The rules below are national, set under the Companies Act, but they land with extra weight for a Delhi company: you file under RoC Delhi, the Ministry of Corporate Affairs is headquartered in the capital, and an inspection or diligence on your registered office is never far away. Keeping the SH-6 register inspection-ready is therefore less a formality and more a standing expectation here.</p>
            ...
            <div class="faq-expanded">
                ...
                <div class="faq-expanded__list">
                    ...
                    <div class="faq-expanded__item" id="faq-3">
                        <h3 class="faq-expanded__q">Why is it essential to track ESOP vesting?</h3>
                        <div class="faq-expanded__a"><p>Because options vest every month and, when an employee leaves, their unvested options are forfeited. If these events are not tracked on time and recorded in the SH-6 register, the vested and unvested figures stop reconciling and the pool no longer ties back. Such gaps are typically caught later, during an audit or a funding round. We track vesting monthly, record forfeitures, and notify employees.</p></div>
                    </div>
                    ...
                    <div class="faq-expanded__item" id="faq-5">
                        <h3 class="faq-expanded__q">Which RoC do Delhi companies file ESOP records with?</h3>
                        <div class="faq-expanded__a"><p>Companies incorporated in Delhi fall under the Registrar of Companies (RoC) Delhi, which also covers Haryana including Gurugram, and the Ministry of Corporate Affairs is headquartered in the capital. The Form SH-6 register itself is not filed with the RoC or MCA; it is kept at your registered office and produced on inspection during a statutory audit or diligence. We keep that register continuously accurate so that when your secretarial filings, board approvals or a Delhi-based audit reference the option pool, the vested, unvested and forfeited numbers all tie back cleanly.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-6">
                        <h3 class="faq-expanded__q">How does this help when NCR investors run diligence on us?</h3>
                        <div class="faq-expanded__a"><p>Delhi and wider NCR rounds often involve investors and counsel who cross-check the cap table against the SH-6 register before they sign. In that review the option pool, the vested and unvested splits, acceleration terms and every forfeiture entry are examined, and gaps slow the deal down. Because we reconcile the register month by month, your numbers tie out on demand instead of being reconstructed under pressure when a Connaught Place or Gurugram diligence team opens the data room.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-7">
                        <h3 class="faq-expanded__q">Do you track ESOPs for Nehru Place and Saket corporate teams?</h3>
                        <div class="faq-expanded__a"><p>Yes. Much of our Delhi work is exactly these employers, product and IT companies around the Nehru Place district, finance teams near Connaught Place, and corporates across the Saket-Aerocity belt, which mix startup-style and established-company vesting designs with frequent leaver events. We handle time-based, graded, milestone and performance-based vesting with cliffs and mixed tranches, capture each leaver's forfeiture in SH-6, and keep the pool reconciled, in person across Delhi or fully remotely.</p></div>
                    </div>
