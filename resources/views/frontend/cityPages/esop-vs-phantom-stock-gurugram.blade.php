...
@section('meta')
    <title>Gurugram ESOP vs Phantom Stock: Equity or Cash Plan?</title>
    <meta name="description" content="Cyber City enterprise-SaaS firms in Gurugram: choose between dilutive ESOPs and cash-paid phantom stock without Section 62 filing. Free comparison guide.">
    <meta name="keywords" content="ESOP vs Phantom Stock Gurugram, ESOP vs Phantom Stock in Gurugram, ESOP vs Phantom Stock services in Gurugram, ESOP services Gurugram, ESOP vs Phantom Stock cost Gurugram, ESOP vs Phantom Stock consultants Gurugram, CA firm for ESOP vs Phantom Stock Gurugram, ESOP advisory Gurugram">
    <link rel="canonical" href="/esop-vs-phantom-stock/gurugram">
    <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1">
    <meta property="og:title" content="Gurugram ESOP vs Phantom Stock: Equity or Cash Plan? | Patron Accounting">
    <meta property="og:description" content="Cyber City enterprise-SaaS firms in Gurugram: choose between dilutive ESOPs and cash-paid phantom stock without Section 62 filing. Free comparison guide.">
...
@section('schema')    <script type="application/ld+json">{
  ...
  "@graph": [
    {
      "@type": "Service",
      "@id": "https://www.patronaccounting.com/esop-vs-phantom-stock/gurugram#service",
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://www.patronaccounting.com/esop-vs-phantom-stock/gurugram#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
        ...
        },
        {
          ...
          "position": 4,
          "name": "ESOP vs Phantom Stock",
          "item": "https://www.patronaccounting.com/esop-vs-phantom-stock/gurugram"
        }
      ]
    },
    {
      ...
      "@id": "https://www.patronaccounting.com/esop-vs-phantom-stock/gurugram#localbusiness",
      "name": "Patron Accounting LLP - ESOP vs Phantom Stock, Gurugram",
      "url": "https://www.patronaccounting.com/esop-vs-phantom-stock/gurugram",
    ...
    {
      "@type": "FAQPage",
      "@id": "https://www.patronaccounting.com/esop-vs-phantom-stock/gurugram#faq",
      ...
      "mainEntity": [
        ...
        {
          "@type": "Question",
          "name": "Why do Gurugram SaaS firms and global-capability centres use phantom stock?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "In the Cyber City and Udyog Vihar talent market, ESOP pools often run dry between rounds, so Gurugram SaaS firms use phantom stock to keep topping up incentives in cash without further dilution. Global-capability centres, the India arms of foreign parents, also use it because issuing parent shares to local staff is awkward, while a cash-settled phantom award tied to value is simple and needs no RoC Delhi filing. Early Golf Course Road startups still favour ESOPs for genuine ownership."
          }
        },
        {
          "@type": "Question",
          "name": "When is tax charged on phantom stock?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Tax on phantom stock arises only at payout, as salary income, at the employee's slab rate, and the employer deducts TDS at that point. There is no tax at grant or at vesting, and there is no capital-gains event, because no actual shares are ever issued."
          }
        },
        {
          "@type": "Question",
        ...
        <div class="row align-items-center">
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <p class="mb-4" style="color: var(--text-secondary); font-size: 16px; line-height: 1.6;">For the enterprise-SaaS unicorns and global-capability centres around DLF Cyber City and Udyog Vihar - the world that produced Zomato, Delhivery and Policybazaar - the equity-versus-cash call shapes every senior hire.</p>
        ...
        <div class="two-column">
            <div class="column-content">
                ...
                <div class="content-text what-is-definition">
                    ...
                    <p>Think of the way a Gurugram-born company such as Zomato or Policybazaar created real wealth for early staff when it listed - that upside is exactly what an ESOP is built to deliver. An ESOP gives an employee the right to buy company shares at a pre-set exercise price once vesting completes, under Section 62(1)(b) of the Companies Act. The day the option is exercised, the engineer or product lead stops being a grantee and becomes an actual shareholder on the cap table.</p>
                    <p>The trade-off is that the ownership is real, and so is the paperwork. Issuing genuine shares dilutes the founders and existing investors, and the route is a full compliance exercise - special resolution, <a href="/esop-valuation-services/gurugram">valuation</a>, allotment, PAS-3 and the <a href="/esop-sh-6-register-administration/gurugram">SH-6 register</a>, all filed through the RoC Delhi that covers Haryana. Tax also bites twice: as a perquisite at exercise, then again as capital gains on sale. For an early Golf Course Road startup raising its first institutional cheque, this is usually the point - investors want to see staff holding a slice of the company, not just a cash IOU.</p>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>Phantom stock flips that logic. Rather than handing over equity, the company makes a contractual promise to pay cash equal to the value of a notional block of shares - or just their appreciation - when a future trigger arrives. Nothing is issued. That is precisely why a Udyog Vihar SaaS firm that has burned through its option pool waiting for the next round, or a Sohna Road scale-up unwilling to widen its cap table, keeps reaching for it.</p>
                <p>The person on the receiving end never appears on the cap table, gets no vote and no dividend, and the founders' stake stays untouched to the last decimal. It comes in two shapes:</p>
                <ul>
                    <li><strong>Full-value phantom stock:</strong> pays the entire share value at settlement.</li>
                    <li><strong>Appreciation-only phantom stock:</strong> pays only the increase over the grant value.</li>
                </ul>
                <p>Because no shares move, the Companies Act says little about it, so the entire arrangement lives inside a board-approved policy or agreement. That contractual nature is what lets a Cyber City global-capability centre - say, the India engineering arm of a US software parent - run a plan tied to the local entity's value and settle it in rupees, without ever asking the overseas parent to release stock.</p>
...
<section class="content-section" id="services-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>Set side by side, the two instruments diverge on seven things a Gurugram founder actually cares about - dilution, control, what the employee walks away with, the filing burden at the RoC Delhi, and the tax and cash hit. Read this table as the cheat sheet a Cyber City CFO would keep before a board meeting.</p>
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Dimension</th><th>ESOP vs Phantom for a Gurugram team</th></tr></thead>
                    <tbody>
                        <tr><td>Dilution of the cap table</td><td>Diluted on exercise (ESOP) vs untouched (Phantom) - the deciding factor for many Golf Course Road founders</td></tr>
                        <tr><td>Ownership rights</td><td>Voting and dividends as a real shareholder (ESOP) vs none (Phantom)</td></tr>
                        <tr><td>What the employee receives</td><td>Real shares (ESOP) vs cash linked to share value (Phantom)</td></tr>
                        <tr><td>Companies Act position</td><td>Section 62(1)(b) process (ESOP) vs contractual, Act largely silent (Phantom)</td></tr>
                        <tr><td>RoC Delhi filings</td><td>MGT-14, PAS-3, SH-6 (ESOP) vs none, just a policy or agreement (Phantom)</td></tr>
                        <tr><td>Taxation</td><td>Perquisite at exercise plus capital gains at sale (ESOP) vs salary at payout only (Phantom)</td></tr>
                        <tr><td>Company cash impact</td><td>None until an optional buyback (ESOP) vs a real cash outflow at payout (Phantom)</td></tr>
...
<section class="steps-section" id="procedure-section">
    <div class="section-container">
        <header class="section-header" style="text-align:center;margin-bottom:48px;">
            ...
            <h2 class="section-title">How Phantom Stock Works in Gurugram</h2>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>Ask any Cyber City product manager who has held both, and the tax timing is what separates the two instruments in real life. An ESOP can tax you on a paper gain before a single rupee has moved; phantom stock waits until the cash is in hand. Concretely, the ESOP triggers tax at two separate moments, while phantom stock is taxed just once, and only later:</p>
                <ul>
                    <li><strong>ESOP, at exercise:</strong> the gap between FMV and the exercise price is taxed in the salary as a perquisite, even though no cash has arrived yet.</li>
                    <li><strong>ESOP, at sale:</strong> any gain over the exercise FMV is taxed separately as capital gains.</li>
                    <li><strong>Phantom, at payout only:</strong> the whole cash settlement is taxed as salary income at the slab rate, the employer deducts TDS, and there is no capital-gains step at all.</li>
                </ul>
                <div class="highlight-box" style="margin-top:16px;">
                    <p><strong>Why phantom stock is cleaner to tax</strong></p>
                    <p>No tax at grant, none at vesting, and no capital-gains layer. A Cyber City employee is taxed a single time, as salary, only when the money is actually received - so nobody is paying tax on a paper gain before any cash lands in the bank.</p>
                </div>
                <p style="margin-top:16px;"><strong>Note on SAR:</strong> appreciation-only phantom stock sits very close to a stock appreciation right; the two overlap and are covered separately in our <a href="/esop-vs-sar/gurugram">SAR comparison</a>.</p>
                <p><strong>When phantom stock makes sense in Gurugram:</strong> a Sohna Road firm wanting to reward staff without diluting, a Cyber City SaaS company bridging an exhausted ESOP pool between rounds, founders protecting control, or any team that prefers a contract over the full Section 62 process. <strong>When an ESOP is still the better call:</strong> at seed and Series A, where Gurugram investors expect an option pool and where real ownership motivates harder than a cash promise.</p>
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <table>
                    ...
                    <tbody>
                        <tr><td>Unfunded liability when a Cyber City exit triggers payouts</td><td>Cash crunch at the worst moment</td><td>Model the phantom liability and cash flow up front, since settlement is a genuine cash outflow.</td></tr>
                        <tr><td>No written phantom policy or fixed valuation method</td><td>Disputes and audit gaps in diligence</td><td>Adopt a board-approved policy that pins down units, vesting, the valuation method and the triggers.</td></tr>
                        <tr><td>Booking a phantom payout as capital gains</td><td>Wrong tax treatment, TDS exposure</td><td>Treat it correctly as salary income, with employer TDS at payout.</td></tr>
                        <tr><td>Reaching for phantom too early on Golf Course Road</td><td>Signals a weak option pool to investors</td><td>Stick with ESOPs at seed and Series A; layer phantom in later for specific cases such as a GCC or a dry pool.</td></tr>
...
<article class="feature-card">
            ...
            <p class="feature-text">A clear ESOP-or-phantom call matched to your dilution tolerance and cash position, whether you are an early Golf Course Road startup or a Cyber City scale-up.</p>
        </article>
<article class="feature-card">
            ...
            <p class="feature-text">A board-approved phantom policy and valuation method that stand up to audit and investor diligence in a funding round.</p>
        </article>
<article class="feature-card">
            ...
            <p class="feature-text">Correct tax treatment, with the payout taxed as salary and TDS deducted at settlement - no misfiled capital-gains claim.</p>
        </article>
<article class="feature-card">
            ...
            <p class="feature-text">A tidy balance-sheet treatment of the phantom liability, including mark-to-market movement as the valuation rises - useful for a GCC reporting to a foreign parent.</p>
        </article>
        </div>
    </div>
</section>
...
<section class="content-section" id="comparison-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>There is no single right answer for Gurugram - the call shifts with your funding stage, your remaining pool and whether you are a founder-led Golf Course Road startup or a global-capability centre answering to an overseas parent. Map your situation to the row that fits.</p>
                <div class="table-responsive-wrapper">
                <table>
...
<section class="content-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>The law is national, but for a Haryana company the practical touchpoint is the RoC Delhi - that is where an ESOP share issue from a Cyber City or Sohna Road office is filed, while a phantom plan stays off the registry entirely. Here is the framework that governs both:</p>
                <p><strong>ESOP:</strong> issued under Section 62(1)(b) of the Companies Act as an option to buy shares, with the <a href="/esop-perquisite-tax-section-17-2-vi/gurugram">perquisite at exercise taxed under Section 17(2)(vi)</a> and capital gains on sale.</p>
            ...
            <div class="faq-expanded">
                ...
                <div class="faq-expanded__list">
                    ...
                    <div class="faq-expanded__item" id="faq-2">
                        <h3 class="faq-expanded__q">Why do Gurugram SaaS firms and global-capability centres use phantom stock?</h3>
                        <div class="faq-expanded__a"><p>In the Cyber City and Udyog Vihar talent market, ESOP pools often run dry between rounds, so Gurugram SaaS firms use phantom stock to keep topping up incentives in cash without further dilution. Global-capability centres, the India arms of foreign parents, also use it because issuing parent shares to local staff is awkward, while a cash-settled phantom award tied to value is simple and needs no RoC Delhi filing. Early Golf Course Road startups still favour ESOPs for genuine ownership.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-3">
                        <h3 class="faq-expanded__q">When is tax charged on phantom stock?</h3>
                        <div class="faq-expanded__a"><p>Tax on phantom stock arises only at payout, as salary income, at the employee's slab rate, and the employer deducts TDS at that point. There is no tax at grant or at vesting, and there is no capital-gains event, because no actual shares are ever issued.</p></div>
                    </div>
                    ...
                    <div class="faq-expanded__item" id="faq-5">
                        <h3 class="faq-expanded__q">Is phantom stock legal in Gurugram, and which RoC covers Haryana companies?</h3>
                        <div class="faq-expanded__a"><p>Yes, phantom stock is legal for Gurugram companies. Haryana companies fall under the RoC Delhi, but a cash-settled phantom plan issues no shares, so it needs no filing there at all. It is not specifically defined under the Companies Act, so for an unlisted Cyber City or Sohna Road firm it runs as a board-approved contract, while an ESOP share issue would route through the RoC Delhi. Listed companies offering share-based benefits separately follow the SEBI Share Based Employee Benefits and Sweat Equity Regulations 2021.</p></div>
                    </div>
                    ...
                    <div class="faq-expanded__item" id="faq-7">
                        <h3 class="faq-expanded__q">Can a Gurugram global-capability centre settle phantom stock for staff of a foreign parent?</h3>
                        <div class="faq-expanded__a"><p>Yes, and this is a common pattern in Cyber City and Udyog Vihar. A Gurugram global-capability centre can run a local phantom plan tied to the Indian entity's value, or to an agreed metric, and settle it in rupees, which avoids the complexity of issuing or transferring foreign parent shares to Indian staff. Because no shares move, there is no RoC Delhi filing and no FEMA share-transfer step. We structure the valuation link and payout mechanics so the award is clean for both the parent and the India arm.</p></div>
                    </div>
