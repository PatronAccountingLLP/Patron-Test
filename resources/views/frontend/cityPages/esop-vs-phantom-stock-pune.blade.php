...
@section('meta')
    <title>Pune ESOP vs Phantom Stock: Equity or Cash Payout?</title>
    <meta name="description" content="For Pune SaaS teams in Hinjewadi and Kharadi, see how ESOPs dilute equity while phantom stock pays cash with no Section 62 filing. Free comparison guide.">
    <meta name="keywords" content="ESOP vs Phantom Stock Pune, ESOP vs Phantom Stock in Pune, ESOP vs Phantom Stock services in Pune, ESOP services Pune, ESOP vs Phantom Stock cost Pune, ESOP vs Phantom Stock consultants Pune, CA firm for ESOP vs Phantom Stock Pune, ESOP advisory Pune">
    <link rel="canonical" href="/esop-vs-phantom-stock/pune">
    <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1">
    <meta property="og:title" content="Pune ESOP vs Phantom Stock: Equity or Cash Payout? | Patron Accounting">
    <meta property="og:description" content="For Pune SaaS teams in Hinjewadi and Kharadi, see how ESOPs dilute equity while phantom stock pays cash with no Section 62 filing. Free comparison guide.">
    <meta property="og:url" content="/esop-vs-phantom-stock/pune">
    <meta property="og:type" content="website">
    <meta property="og:site_name" content="Patron Accounting">
    <meta property="og:image" content="/images/esop-vs-phantom-stock-og.webp">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Pune ESOP vs Phantom Stock: Equity or Cash Payout? | Patron Accounting">
    <meta name="twitter:description" content="For Pune SaaS teams in Hinjewadi and Kharadi, see how ESOPs dilute equity while phantom stock pays cash with no Section 62 filing. Free comparison guide.">
...
@section('schema')    <script type="application/ld+json">{
  ...
  "@graph": [
    {
      "@type": "Service",
      "@id": "https://www.patronaccounting.com/esop-vs-phantom-stock/pune#service",
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://www.patronaccounting.com/esop-vs-phantom-stock/pune#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
        ...
        },
        {
          ...
          "position": 4,
          "name": "ESOP vs Phantom Stock",
          "item": "https://www.patronaccounting.com/esop-vs-phantom-stock/pune"
        }
      ]
    },
    {
      ...
      "@id": "https://www.patronaccounting.com/esop-vs-phantom-stock/pune#localbusiness",
      "name": "Patron Accounting LLP - ESOP vs Phantom Stock, Pune",
      "url": "https://www.patronaccounting.com/esop-vs-phantom-stock/pune",
    ...
    {
      "@type": "FAQPage",
      "@id": "https://www.patronaccounting.com/esop-vs-phantom-stock/pune#faq",
      ...
      "mainEntity": [
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Phantom stock is taxed only at the time of payout, as salary income, at the employee's slab rate, and the employer deducts TDS. There is no tax at grant or vesting, and there is no capital-gains event either, because no actual shares are issued."
          }
        },
        {
          "@type": "Question",
        ...
        {
          "@type": "Question",
          "name": "When should you choose phantom stock?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Phantom stock works well when you do not want dilution, when the ESOP pool has been exhausted, or when founders wish to retain control. However, at the seed or Series A stage an ESOP is preferable, because investors expect it and real ownership motivates employees more strongly."
          }
        },
        {
          "@type": "Question",
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-4 private-registration-heading">
                        ESOP vs Phantom Stock in Pune
                    </h1>

                    <p class="mb-4" style="color: var(--text-secondary); font-size: 16px;">For SaaS and product teams from Hinjewadi's Rajiv Gandhi Infotech Park to EON IT Park in Kharadi, the choice comes down to one thing: issue real shares through RoC Pune, or pay cash and keep the cap table whole.</p>
        ...
        <div class="two-column">
            <div class="column-content">
                ...
                <div class="content-text what-is-definition">
                    ...
                    <p>Think of an ESOP as a reserved-price ticket to ownership. Under Section 62(1)(b) of the Companies Act, the company grants an employee the right to buy its own shares at a price fixed today; after the vesting clock runs out, the employee pays that price, exercises, and walks onto the cap table as a real shareholder. A funded SaaS product company in Hinjewadi handing its founding engineers a slice of a future exit is the textbook case.</p>
                    <p>The catch is that the ticket is real equity, so it carries real machinery. Every exercise dilutes the promoters, and issuing those shares means clearing the full Pune compliance run: a special resolution, a registered-valuer report, board allotment, then the MGT-14 and PAS-3 filings with RoC Pune and an entry in the SH-6 register. Tax lands in two places too - first as a salary perquisite on the day of exercise, and again as capital gains when the Pune employee eventually sells. Voting rights, dividends and genuine upside come with it; so does the paperwork.</p>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>Phantom stock keeps the reward but drops the ownership. Picture a Chakan MIDC auto-component manufacturer with a tightly held promoter family: it wants its production head to gain when the business grows, but it will not let a non-family name onto the register. The answer is a written promise to pay cash later - an amount pegged to what a set block of notional "phantom" units, or just their appreciation, would be worth at a future trigger date. No share is ever allotted.</p>
                <p>Because nothing is issued, the recipient never appears on the cap table, holds no votes and draws no dividends, and the promoter shareholding reads exactly as it did before. Pune companies typically pick one of two designs:</p>
                <ul>
                    <li><strong>Full-value phantom stock:</strong> settles the entire value of the notional units in cash.</li>
                    <li><strong>Appreciation-only phantom stock:</strong> settles only the growth from grant value to payout value.</li>
                </ul>
                <p>With no allotment and no RoC Pune filing in sight, the Companies Act says almost nothing here - which means a tight, board-approved policy is the only thing holding the plan together, and it has to be drafted to do that job.</p>
...
<section class="content-section" id="services-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>Set side by side, the two instruments split on six things a Pune founder actually cares about - who ends up on the register, whether RoC Pune gets a filing, and when the tax and the cash hit. Read the table as "ESOP route vs Phantom route" for the same Hinjewadi or Kharadi hire.</p>
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Service</th><th>What We Do</th></tr></thead>
                    <tbody>
                        <tr><td>Effect on the cap table</td><td>Dilutes promoters on exercise (ESOP) vs untouched, zero dilution (Phantom)</td></tr>
                        <tr><td>Ownership and rights</td><td>Real shares with voting and dividends (ESOP) vs cash linked to share value, no rights (Phantom)</td></tr>
                        <tr><td>RoC Pune route</td><td>Section 62(1)(b) share-issue process (ESOP) vs contractual, Companies Act largely silent (Phantom)</td></tr>
                        <tr><td>Filings to complete</td><td>MGT-14, PAS-3 and SH-6 (ESOP) vs none, just a board-approved policy or agreement (Phantom)</td></tr>
                        <tr><td>How it is taxed</td><td>Perquisite at exercise plus capital gains on sale (ESOP) vs salary at payout only (Phantom)</td></tr>
                        <tr><td>Cash impact on the company</td><td>None until an optional buyback (ESOP) vs real cash outflow at the trigger (Phantom)</td></tr>
...
<section class="steps-section" id="procedure-section">
    <div class="section-container">
        <header class="section-header" style="text-align:center;margin-bottom:48px;">
            ...
            <h2 class="section-title">How Phantom Stock Works in Pune</h2>
            <p class="section-subtitle" style="text-align:left;max-width:100%;">Unlike an ESOP, none of this touches MCA21 or the RoC Pune registry - a phantom plan is a private contract the board writes for itself. The three stages below are how it plays out for a Magarpatta SaaS team or a Chakan manufacturer from the day units are granted to the day cash is paid.</p>
        </header>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>Tax is where the two diverge most, and it is best read as a timeline rather than a rule. Follow a Kharadi product engineer through each instrument and count how many times the taxman shows up:</p>
                <ul>
                    <li><strong>ESOP - moment of exercise:</strong> the gap between fair market value and the exercise price is a <a href="/esop-perquisite-tax-section-17-2-vi/pune">salary perquisite under Section 17(2)(vi)</a>, taxed there and then even though no cash has changed hands.</li>
                    <li><strong>ESOP - moment of sale:</strong> whatever the shares gain beyond that exercise FMV is taxed all over again, this time as <a href="/esop-capital-gains-tax-on-sale/pune">capital gains</a>, whenever the Pune employee actually sells.</li>
                    <li><strong>Phantom - one moment only:</strong> nothing at grant, nothing at vesting; the whole cash settlement is salary at the slab rate on payout day, employer deducts TDS, and there is no capital-gains chapter at all.</li>
                </ul>
                <div class="highlight-box" style="margin-top:16px;">
                    <p><strong>Why a Chakan manufacturer often finds phantom stock cleaner to tax</strong></p>
                    <p>Nothing is taxed at grant, nothing at vesting, and there is no capital-gains step to track. The plant head is taxed a single time, as salary, only on the day the cash actually lands, so no one is paying tax on a paper gain before the money exists.</p>
                </div>
                <p style="margin-top:16px;"><strong>Note on SAR:</strong> appreciation-only phantom stock sits very close to a stock appreciation right; the two overlap heavily and we treat them together in our <a href="/esop-vs-sar/pune">SAR comparison</a>.</p>
                <p><strong>When phantom stock earns its place:</strong> when a Hinjewadi founder wants to avoid dilution, bridge an ESOP pool that has run dry between funding rounds, keep promoter control intact, or simply skip the Section 62 compliance load. <strong>When an ESOP still wins:</strong> at seed and <a href="/esop-at-funding-round-series-a-b-c/pune">Series A</a>, where investors expect to see an option pool and real ownership does more to retain talent.</p>
...
<section class="content-section" id="challenges-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>The mistakes we see most in Pune cluster around two moments: drafting the plan and funding the payout. A Chakan manufacturer that forgets phantom is a real cash outflow, or a Hinjewadi startup that books the settlement as capital gains, learns it the expensive way. Here is what trips Pune companies up, and how we close each gap.</p>
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Challenge</th><th>Impact</th><th>How Patron Accounting Solves It</th></tr></thead>
                    <tbody>
                        <tr><td>Unfunded payout liability when a Chakan plant exit triggers settlement</td><td>Cash crunch on the due date</td><td>Model the liability and phase the cash flow early, because a phantom payout is a genuine outflow, not a paper entry.</td></tr>
                        <tr><td>No written policy or fixed valuation method for the notional units</td><td>Disputes and audit gaps</td><td>Put a board-approved policy in place that pins down units, vesting, the valuation basis and the trigger events.</td></tr>
                        <tr><td>Booking a phantom payout as capital gains</td><td>Wrong tax treatment, TDS exposure</td><td>Treat it correctly as salary income and deduct TDS at the point of payout.</td></tr>
                        <tr><td>A Hinjewadi startup reaching for phantom before raising</td><td>Signals a weak cap table to investors</td><td>Keep ESOPs front and centre at seed and Series A; deploy phantom later for the specific cases it suits.</td></tr>
...
<section class="why-choose-section" id="benefits-section">
    <div class="section-container">
        <div style="text-align:center;margin-bottom:48px;">
            ...
            <p class="section-subtitle" style="margin:0 auto;text-align:center;">From Hinjewadi SaaS teams to Chakan plants, the four things a Pune company gains by getting the structure right the first time.</p>
        </div>
...
<article class="feature-card">
            ...
            <h3 class="feature-title">Right instrument for your stage</h3>
            <p class="feature-text">A clear call between equity and cash, matched to your dilution headroom and cash runway, whether you are a funded Hinjewadi SaaS team or a Chakan manufacturer.</p>
        </article>
<article class="feature-card">
            ...
            <h3 class="feature-title">Stands up to diligence</h3>
            <p class="feature-text">A phantom policy and valuation method documented well enough to survive a statutory audit and investor diligence.</p>
        </article>
<article class="feature-card">
            ...
            <h3 class="feature-title">Correct tax and TDS</h3>
            <p class="feature-text">Payouts taxed the right way, as salary income with employer TDS, with no capital-gains mix-up.</p>
        </article>
<article class="feature-card">
            ...
            <p class="feature-text">The phantom liability carried and marked to market cleanly, so your books read straight at every review.</p>
        </article>
        </div>
    </div>
</section>
...
<section class="content-section" id="comparison-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>There is no universal winner - the right call shifts with your funding stage and cash position. Map your own company to the closest row: a fundraising Kharadi SaaS firm rarely lands in the same place as a control-conscious Chakan promoter or a Baner team whose option pool has already run dry.</p>
                <div class="table-responsive-wrapper">
                <table>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>The law is the same statute book across India, but for a Pune company the practical touch-point is the RoC Pune jurisdiction on MCA21, where an ESOP's share-issue filings land and a phantom plan's never do. The provisions that govern each instrument:</p>
                <p><strong>ESOP:</strong> issued under Section 62(1)(b) of the Companies Act as an option to buy shares - the route that carries the MGT-14 and PAS-3 filings with RoC Pune - with the perquisite at exercise taxed under Section 17(2)(vi) and capital gains on sale.</p>
                <p><strong>Phantom stock:</strong> not a share issue and not governed by Section 62, so nothing reaches the registry; for an unlisted Hinjewadi or Magarpatta company it is purely contractual under a board-approved policy, with the Companies Act broadly silent on it.</p>
            ...
            <div class="faq-expanded">
                ...
                <div class="faq-expanded__list">
                    ...
                    <div class="faq-expanded__item" id="faq-2">
                        <h3 class="faq-expanded__q">Should a bootstrapped Pune SaaS startup pick ESOP or phantom stock?</h3>
                        <div class="faq-expanded__a"><p>Many bootstrapped Pune SaaS teams in Baner-Balewadi and Kharadi prefer phantom stock because it rewards early engineers in cash without diluting a thin cap table or running the RoC Pune share-issue process. If you plan to raise a seed or Series A round soon, an ESOP is usually expected by investors and motivates better through real ownership. The honest answer depends on your dilution headroom and cash runway.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-3">
                        <h3 class="faq-expanded__q">When is phantom stock taxed?</h3>
                        <div class="faq-expanded__a"><p>Phantom stock is taxed only at the time of payout, as salary income, at the employee's slab rate, and the employer deducts TDS. There is no tax at grant or vesting, and there is no capital-gains event either, because no actual shares are issued.</p></div>
                    </div>
                    ...
                    <div class="faq-expanded__item" id="faq-5">
                        <h3 class="faq-expanded__q">Is phantom stock legal for a Pune company, and does it need an RoC Pune filing?</h3>
                        <div class="faq-expanded__a"><p>Yes, phantom stock is legal for Pune companies and needs no RoC Pune filing, since no shares are issued. It is not specifically defined under the Companies Act, so for an unlisted Hinjewadi or Magarpatta firm it runs purely as a board-approved contract. By contrast, an ESOP here would route through the RoC Pune share-issue process. Listed companies offering share-based benefits separately follow the SEBI Share Based Employee Benefits and Sweat Equity Regulations 2021.</p></div>
                    </div>
                    ...
                    <div class="faq-expanded__item" id="faq-7">
                        <h3 class="faq-expanded__q">When should you choose phantom stock?</h3>
                        <div class="faq-expanded__a"><p>Phantom stock works well when you do not want dilution, when the ESOP pool has been exhausted, or when founders wish to retain control. However, at the seed or Series A stage an ESOP is preferable, because investors expect it and real ownership motivates employees more strongly.</p></div>
                    </div>
...
<section class="content-section" style="padding:48px 32px;background:var(--gray-50);">
    <div class="content-container"><div class="text-content">
        ...
        <div class="pa-city-grid"><span class="pa-city-card" aria-current="page" style="border-color:var(--orange);background:#FFF7F2;cursor:default;position:relative;"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Pune</div><div class="pa-card-sub">Maharashtra</div></div><span style="position:absolute;top:10px;right:12px;font-size:10px;font-weight:700;color:var(--orange);letter-spacing:.04em;">YOU'RE HERE</span></span><a href="/esop-vs-phantom-stock/mumbai" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Mumbai</div><div class="pa-card-sub">Maharashtra</div></div></a><a href="/esop-vs-phantom-stock/delhi" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Delhi</div><div class="pa-card-sub">Delhi NCR</div></div></a><a href="/esop-vs-phantom-stock/gurugram" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Gurugram</div><div class="pa-card-sub">Haryana</div></div></a></div>
    </div></div>
</section>
