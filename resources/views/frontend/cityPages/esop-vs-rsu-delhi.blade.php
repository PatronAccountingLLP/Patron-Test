...
@section('meta')
    <title>ESOP vs RSU for Delhi Startups: Picking Equity Right</title>
    <meta name="description" content="Delhi founders near Nehru Place and Connaught Place: weigh ESOP against RSU and pick the right equity instrument for your stage. Free comparison guide.">
    <meta name="keywords" content="ESOP vs RSU Delhi, ESOP vs RSU in Delhi, ESOP vs RSU services in Delhi, ESOP services Delhi, ESOP vs RSU cost Delhi, ESOP vs RSU consultants Delhi, CA firm for ESOP vs RSU Delhi, ESOP advisory Delhi">
    <link rel="canonical" href="/esop-vs-rsu/delhi">
    <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1">
    <meta property="og:title" content="ESOP vs RSU for Delhi Startups: Picking Equity Right | Patron Accounting">
    <meta property="og:description" content="Delhi founders near Nehru Place and Connaught Place: weigh ESOP against RSU and pick the right equity instrument for your stage. Free comparison guide.">
    <meta property="og:url" content="/esop-vs-rsu/delhi">
    <meta property="og:type" content="website">
    <meta property="og:site_name" content="Patron Accounting">
    <meta property="og:image" content="/images/esop-vs-rsu-og.webp">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="ESOP vs RSU for Delhi Startups: Picking Equity Right | Patron Accounting">
    <meta name="twitter:description" content="Delhi founders near Nehru Place and Connaught Place: weigh ESOP against RSU and pick the right equity instrument for your stage. Free comparison guide.">
...
@section('schema')    <script type="application/ld+json">{
  ...
  "@graph": [
    {
      "@type": "Service",
      "@id": "https://www.patronaccounting.com/esop-vs-rsu/delhi#service",
      "name": "ESOP vs RSU",
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://www.patronaccounting.com/esop-vs-rsu/delhi#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
        ...
        },
        {
          ...
          "position": 4,
          "name": "ESOP vs RSU",
          "item": "https://www.patronaccounting.com/esop-vs-rsu/delhi"
        }
      ]
    },
    {
      ...
      "@id": "https://www.patronaccounting.com/esop-vs-rsu/delhi#localbusiness",
      "name": "Patron Accounting LLP - ESOP vs RSU, Delhi",
      "url": "https://www.patronaccounting.com/esop-vs-rsu/delhi",
    ...
    {
      "@type": "FAQPage",
      "@id": "https://www.patronaccounting.com/esop-vs-rsu/delhi#faq",
      ...
      "mainEntity": [
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "An ESOP is an option under which you pay an exercise price to acquire the shares, whereas an RSU delivers the shares free of cost on vesting. In India, an RSU is not a separate instrument, so it is structured as an ESOP or as a cash-settled SAR. An ESOP is taxed at exercise, while an RSU is taxed at vesting."
          }
        },
        {
          "@type": "Question",
          "name": "How are RSUs taxed in Delhi?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "RSUs are taxed as a salary perquisite at vesting, on the full fair market value of the shares, since they are granted free. The employer deducts TDS on that value. When the shares are later sold, the gain over the vesting-date FMV is taxed as capital gains. Foreign-parent RSUs are also taxable in Delhi at vesting, with DTAA relief for any tax withheld abroad."
          }
        },
        {
          "@type": "Question",
          "name": "I run a DPIIT-recognised startup in Delhi. Should I grant ESOPs or RSUs?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "For a DPIIT-recognised startup in Delhi-NCR, ESOPs are usually the better fit. They cost no cash on grant, reward the upside your early team is building, and DPIIT-recognised startups get a deferral of the perquisite tax at exercise. RSUs make more sense once you are late-stage, near an IPO, or aligning with a foreign parent. Since you file with RoC Delhi, whichever route you pick is delivered as an ESOP or a cash-settled right under the Companies Act."
          }
        },
        {
          "@type": "Question",
          "name": "I work at a Nehru Place or Aerocity arm of a foreign software firm and hold parent RSUs. How are they taxed in Delhi?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "At the Delhi arm of a US or other foreign software group, the listed parent grants RSUs that vest into its own shares. The vesting-date value is taxed in Delhi as a salary perquisite and your employer deducts TDS. The foreign country may also withhold tax, for which you claim DTAA relief, and you must report the foreign shares in Schedule FA of your Indian return each year you hold them."
          }
        },
        {
          "@type": "Question",
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Phantom tax arises when you pay perquisite tax on the vesting-date value of an RSU but the share price later falls. You have paid tax on a higher value while the asset is now worth less, which is a real economic loss. A capital loss only partially recovers it."
          }
        },
        {
          "@type": "Question",
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-4 private-registration-heading">
                        ESOP vs RSU in Delhi
                    </h1>

                    <p class="mb-4" style="font-size:16px;color:var(--text-secondary);">From Nehru Place SaaS desks to the Connaught Place finance district and the Saket-Aerocity belt, Delhi founders and NRI-linked employees weigh an option-to-buy ESOP against free-on-vesting RSUs, filed with RoC Delhi at the MCA's home address.</p>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>RSU:</span> free shares on vesting, common at Nehru Place and Aerocity foreign-parent arms.</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
...
<div class="toc-section">
    <div class="toc-container">
        ...
        <div class="toc-wrapper" id="tocWrapper">
            ...
            <button class="toc-btn" onclick="document.getElementById('procedure-section').scrollIntoView({behavior:'smooth'})">RSU in Delhi</button>
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                <div class="highlight-box" style="margin-bottom:20px;">
                    ...
                    <p>For Delhi teams: an ESOP is a paid option to buy shares after vesting, an RSU drops shares in free at vesting. Because Indian law recognises no standalone RSU, a Delhi company delivers it as an ESOP or a cash-settled right and files it with RoC Delhi.</p>
                </div>
                <p>ESOP or RSU? The short answer: an ESOP is an option to buy shares, an RSU is a grant of free shares, and in Delhi an RSU is not a separate instrument. This free guide explains the difference in structure, cost, vesting, taxation and risk, and how RSUs are actually structured under Indian law, framed for companies and employees across the capital.</p>
                <p>Delhi is one of India's biggest equity-compensation markets. Delhi-NCR is the country's second-largest startup hub, with more than 15,000 DPIIT-recognised startups and around 2.2 billion dollars raised in 2025, so ESOP pools are everywhere, from the Connaught Place premium-finance district to the Saket and Aerocity corporate belt. Nehru Place, Asia's largest IT and tech market, mixes resellers, SaaS firms and the Indian arms of foreign software groups that pass RSUs down from a listed parent. Delhi companies file with the Registrar of Companies (RoC) Delhi, co-located with the MCA head office on the MCA21 portal, so the same office that defines national ESOP policy sits in the city.</p>
                <p>The difference is simple at the core: an ESOP is an option you choose to exercise by paying a price, while an RSU is a promise of free shares once you vest. The Indian twist is that RSU is not a defined instrument under the Companies Act, so a Delhi company delivers it through an ESOP or a cash-settled structure.</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="two-column">
            <div class="column-content">
                ...
                <div class="content-text what-is-definition">
                    ...
                    <p>Most Delhi-NCR cap tables start with an ESOP. Under Section 62(1)(b) of the Companies Act, an Employee Stock Option Plan hands an employee a right, never an obligation, to buy a fixed number of shares at an exercise price locked in today, redeemable only after the vesting clock runs out. The shares are not free, the employee pays that exercise price to convert the option into stock.</p>
                    <p>That paid-conversion design is the whole point. Take a Nehru Place SaaS firm that grants options at the current fair value, if the company climbs over the next funding rounds, the early hire buys in cheap and pockets the spread, but if the valuation stalls the option sits underwater and is simply allowed to lapse, costing nobody anything. For a cash-light Saket consumer-tech venture or a Connaught Place fintech, that zero-cash-on-grant, all-upside profile is exactly why the ESOP, not the RSU, is the instrument of first resort.</p>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>Plenty of Delhi-NCR professionals first meet the term RSU on a US payslip, not in an Indian board resolution. A Restricted Stock Unit is simply a promise by the company to hand over shares at no cost once the vesting clock or a performance milestone is reached, with no exercise price ever changing hands.</p>
                <p>That free grant is exactly why RSUs feel different on the ground here. Walk through the foreign-software arms clustered around Aerocity or the back-offices off the airport corridor and you will find listed multinational parents granting RSUs to their Delhi staff, where the shares already carry value the day they vest, making them steadier than an option. The catch is statutory: Indian company law does not define an RSU at all, so a Connaught Place finance group or a Saket consumer-tech venture that wants to mirror an RSU has to deliver it as an ESOP carrying a token exercise price, or as a cash-settled right such as a <a href="/esop-vs-sar/delhi">stock appreciation right</a>.</p>
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <table>
                    ...
                    <tbody>
                        <tr><td>What you get</td><td>ESOP is a right to buy shares; an RSU simply hands you the shares free</td></tr>
                        <tr><td>What it costs you</td><td>ESOP needs the exercise price paid; an RSU costs the employee nothing</td></tr>
                        <tr><td>Status under Indian law</td><td>ESOP is recognised under Section 62(1)(b); an RSU is not a separate instrument, so it runs through an ESOP or a cash-settled route</td></tr>
                        <tr><td>When salary perquisite hits</td><td>ESOP is taxed at exercise; an RSU is taxed at vesting</td></tr>
                        <tr><td>Cost base for capital gains</td><td>ESOP uses FMV at exercise; an RSU uses FMV at vesting, with gain taxed on later sale</td></tr>
                        <tr><td>Where it can hurt</td><td>An ESOP can fall underwater; an RSU exposes you to phantom-tax if the price drops after vesting</td></tr>
                        <tr><td>Who it suits in Delhi-NCR</td><td>ESOP fits Nehru Place startups and high-growth firms; RSU fits listed and foreign-parent subsidiaries</td></tr>
...
<section class="steps-section" id="procedure-section">
    <div class="section-container">
        <header class="section-header" style="text-align:center;margin-bottom:48px;">
            ...
            <h2 class="section-title">How RSUs Are Structured in Delhi</h2>
    ...
    <div class="step-content">
        ...
        <p class="step-description">The Delhi company dresses the RSU up as an ESOP carrying a near-zero or token exercise price, or routes it through a Section 62(1)(c) preferential allotment with the Section 42 private-placement paperwork filed at RoC Delhi. Either way the employee walks away holding real, registered shares, with the perquisite landing at vesting.</p>
...
<div class="step-card">
    <div class="step-content">
        ...
        <p class="step-description">A board that wants to reward staff without widening the cap table grants a stock appreciation right or <a href="/esop-vs-phantom-stock/delhi">phantom stock</a>, a cash payout tracking the share value or its rise, with not a single share issued. No dilution, no share-issue filing, and the payout is taxed in the employee's hands as salary. A common pick for closely held Connaught Place finance groups.</p>
        <div class="step-highlights">
...
<div class="step-card">
    <div class="step-content">
        ...
        <p class="step-description">The Aerocity and airport-corridor back-offices of US and other foreign groups pass down the listed parent's own RSUs. Those shares are foreign, taxed in Delhi at vesting, often withheld on abroad too, so the cross-border layering, DTAA credit and Schedule FA reporting, is where <a href="/esop-for-nri-and-non-resident-employees/delhi">Delhi and NRI holders</a> need the most care.</p>
        <div class="step-highlights">
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>For a Delhi taxpayer, the tax map is the same shape for both instruments: salary perquisite at one stage, capital gains at another. What an employee in Nehru Place or an NRI-linked holder near Connaught Place needs to pin down is when that first salary hit lands, because the two instruments differ on exactly this.</p>
                <ul>
                    <li><strong>RSU, perquisite at vesting:</strong> because the shares arrive free, the entire FMV on the vesting date is treated as salary in your hands.</li>
                    <li><strong>ESOP, perquisite at exercise:</strong> only the spread between FMV on exercise and the exercise price you paid is taxed as salary.</li>
                    <li><strong>Both, capital gains at sale:</strong> when you eventually sell, the gain over the FMV already taxed is a capital gain, long or short term by holding period.</li>
                </ul>
                <div class="highlight-box" style="margin-top:16px;">
                    <p><strong>Where the phantom-tax trap bites an RSU holder</strong></p>
                    <p>RSU perquisite tax is locked to the vesting-date value. Picture a Saket consumer-tech employee whose foreign-parent stock vests at a high and then slides on a weak quarter, they have already paid tax on a value they may never see, a real cash loss that a later capital loss only partly claws back.</p>
                </div>
                <p style="margin-top:16px;"><strong>So which way should a Delhi company lean:</strong> a seed-stage Nehru Place startup leans to ESOPs (no cash outlay, pure upside); a listed or pre-IPO firm leans to ESOP-structured RSUs (steady value, simple to explain to staff); a foreign parent mirrors its global RSU plan, rebuilt for Indian compliance and tax; and a board wary of dilution picks a cash-settled SAR or phantom stock that tracks the share value without issuing a single new share.</p>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Where Delhi Teams Slip Up</th><th>What It Costs</th><th>How Patron Accounting Fixes It</th></tr></thead>
                    <tbody>
                        <tr><td>Foreign-parent RSU income left out, missing Schedule FA and DTAA credit</td><td>Double tax and disclosure default</td><td>Claim DTAA relief and Form 67 for tax withheld abroad, and report the foreign shares correctly.</td></tr>
                        <tr><td>A Nehru Place firm pasting in a US RSU plan as if RSU were an Indian instrument</td><td>Compliance gap with RoC Delhi</td><td>Rebuild it as an ESOP or a cash-settled right with the right Companies Act compliance.</td></tr>
                        <tr><td>No plan for the vesting-date tax outflow on RSUs</td><td>Tax paid on value not yet realised</td><td>Set up liquidity or a sell-to-cover so the perquisite tax is funded.</td></tr>
                        <tr><td>FMV at grant out of step with the FMV taxed</td><td>Wrong perquisite computed</td><td>Tie the perquisite to a properly supported valuation.</td></tr>
...
<article class="feature-card">
            ...
            <h3 class="feature-title">Cross-border, sorted</h3>
            <p class="feature-text">Foreign-parent RSUs held by Delhi and NRI employees aligned with Indian compliance, DTAA relief and Schedule FA reporting.</p>
        </article>
<article class="feature-card">
            ...
            <h3 class="feature-title">RoC Delhi-ready</h3>
            <p class="feature-text">RSUs rebuilt under the Companies Act as an ESOP or cash-settled right, not pasted in as a foreign concept.</p>
        </article>
<article class="feature-card">
            ...
            <h3 class="feature-title">Phantom-tax managed</h3>
            <p class="feature-text">Vesting-date perquisite timed and funded, so a Saket consumer-tech holder is not caught by phantom tax.</p>
        </article>
<article class="feature-card">
            ...
            <h3 class="feature-title">Fit for your stage</h3>
            <p class="feature-text">The right pick for a Connaught Place finance group or a Nehru Place startup, by cash position and dilution tolerance.</p>
        </article>
        </div>
    </div>
</section>
...
<section class="content-section" id="comparison-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>Across Delhi-NCR the right instrument tracks the company's stage almost mechanically. A bootstrapped Nehru Place startup and a listed parent feeding RSUs into its Aerocity arm sit at opposite ends of this ladder, and most Delhi boards land where the table below puts them.</p>
                <div class="table-responsive-wrapper">
                <table>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>Delhi companies sit under the same statute book as the rest of India, but they file it at the source: RoC Delhi, co-located with the MCA head office in the capital. Here is how the law maps onto each instrument.</p>
                <p><strong>ESOP:</strong> issued as an option to buy shares under Section 62(1)(b) of the Companies Act, with the exercise-date perquisite charged to salary under Section 17(2)(vi) of the Income-tax Act.</p>
                <p><strong>RSU in Delhi:</strong> no standalone statutory form exists, so a Delhi board lands it as an equity-settled ESOP, a Section 62(1)(c) preferential allotment carrying Section 42 compliance, or a cash-settled SAR or phantom stock that is taxed simply as salary.</p>
                <p><strong>Taxation:</strong> the RSU perquisite bites at vesting on the full FMV, the ESOP perquisite at exercise on FMV less the exercise price, and on a later sale both are taxed as capital gains, the cost base being whatever FMV was already taxed.</p>
                <p><strong>Listed and foreign:</strong> a listed Delhi issuer follows the SEBI (Share Based Employee Benefits and Sweat Equity) Regulations 2021, while RSUs from a foreign parent can draw overseas withholding that a Delhi or NRI holder offsets through DTAA relief.</p>
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    ...
                    <p class="faq-expanded__lead">Common questions on how ESOPs and RSUs differ, RSU legality and taxation in Delhi, which suits which stage, and foreign-parent RSUs.</p>
                ...
                <div class="faq-expanded__list">
                    ...
                    <div class="faq-expanded__item" id="faq-2">
                        <h3 class="faq-expanded__q">Is RSU legal in Delhi?</h3>
                        <div class="faq-expanded__a"><p>RSUs are used in Delhi, but RSU is not a separately recognised instrument under the Companies Act. Companies deliver RSUs either as an ESOP with a token exercise price, as a Section 62(1)(c) preferential allotment, or as a cash-settled stock appreciation right or phantom stock. So an RSU is legal, but it is structured through one of these recognised routes rather than as a standalone RSU.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-3">
                        <h3 class="faq-expanded__q">What is the difference between an ESOP and an RSU?</h3>
                        <div class="faq-expanded__a"><p>An ESOP is an option under which you pay an exercise price to acquire the shares, whereas an RSU delivers the shares free of cost on vesting. In India, an RSU is not a separate instrument, so it is structured as an ESOP or as a cash-settled SAR. An ESOP is taxed at exercise, while an RSU is taxed at vesting.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-4">
                        <h3 class="faq-expanded__q">How are RSUs taxed in Delhi?</h3>
                        <div class="faq-expanded__a"><p>RSUs are taxed as a salary perquisite at vesting, on the full fair market value of the shares, since they are granted free. The employer deducts TDS on that value. When the shares are later sold, the gain over the vesting-date FMV is taxed as capital gains. Foreign-parent RSUs are also taxable in Delhi at vesting, with DTAA relief for any tax withheld abroad.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-5">
                        <h3 class="faq-expanded__q">I run a DPIIT-recognised startup in Delhi. Should I grant ESOPs or RSUs?</h3>
                        <div class="faq-expanded__a"><p>For a DPIIT-recognised startup in Delhi-NCR, ESOPs are usually the better fit. They cost no cash on grant, reward the upside your early team is building, and DPIIT-recognised startups get a deferral of the perquisite tax at exercise. RSUs make more sense once you are late-stage, near an IPO, or aligning with a foreign parent. Since you file with RoC Delhi, whichever route you pick is delivered as an ESOP or a cash-settled right under the Companies Act.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-6">
                        <h3 class="faq-expanded__q">I work at a Nehru Place or Aerocity arm of a foreign software firm and hold parent RSUs. How are they taxed in Delhi?</h3>
                        <div class="faq-expanded__a"><p>At the Delhi arm of a US or other foreign software group, the listed parent grants RSUs that vest into its own shares. The vesting-date value is taxed in Delhi as a salary perquisite and your employer deducts TDS. The foreign country may also withhold tax, for which you claim DTAA relief, and you must report the foreign shares in Schedule FA of your Indian return each year you hold them.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-7">
                        <h3 class="faq-expanded__q">What is phantom tax on an RSU?</h3>
                        <div class="faq-expanded__a"><p>Phantom tax arises when you pay perquisite tax on the vesting-date value of an RSU but the share price later falls. You have paid tax on a higher value while the asset is now worth less, which is a real economic loss. A capital loss only partially recovers it.</p></div>
                    </div>
            ...
            <div class="highlight-box" style="margin-top:32px;">
                ...
                <ul>
                    ...
                    <li><strong>How can global RSUs be granted in Delhi?</strong> RSUs are typically structured as an ESOP plan or settled in cash, since Indian company law has no separate RSU framework.</li>
...
<section class="content-section" style="padding:48px 32px;background:var(--gray-50);">
    <div class="content-container"><div class="text-content">
        ...
        <div class="pa-city-grid"><a href="/esop-vs-rsu/pune" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Pune</div><div class="pa-card-sub">Maharashtra</div></div></a><a href="/esop-vs-rsu/mumbai" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Mumbai</div><div class="pa-card-sub">Maharashtra</div></div></a><span class="pa-city-card" aria-current="page" style="border-color:var(--orange);background:#FFF7F2;cursor:default;position:relative;"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Delhi</div><div class="pa-card-sub">Delhi NCR</div></div><span style="position:absolute;top:10px;right:12px;font-size:10px;font-weight:700;color:var(--orange);letter-spacing:.04em;">YOU'RE HERE</span></span><a href="/esop-vs-rsu/gurugram" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Gurugram</div><div class="pa-card-sub">Haryana</div></div></a></div>
    </div></div>
</section>
