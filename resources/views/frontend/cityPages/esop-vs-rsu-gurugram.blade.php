...
@section('meta')
    <title>ESOP vs RSU for Gurugram Cyber City SaaS Teams Explained</title>
    <meta name="description" content="For Gurugram's Cyber City SaaS teams, understand how ESOPs and RSUs work, differ in tax and vesting, and which to grant. Download our free guide now.">
    <meta name="keywords" content="ESOP vs RSU Gurugram, ESOP vs RSU in Gurugram, ESOP vs RSU services in Gurugram, ESOP services Gurugram, ESOP vs RSU cost Gurugram, ESOP vs RSU consultants Gurugram, CA firm for ESOP vs RSU Gurugram, ESOP advisory Gurugram">
    <link rel="canonical" href="/esop-vs-rsu/gurugram">
    <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1">
    <meta property="og:title" content="ESOP vs RSU for Gurugram Cyber City SaaS Teams Explained | Patron Accounting">
    <meta property="og:description" content="For Gurugram's Cyber City SaaS teams, understand how ESOPs and RSUs work, differ in tax and vesting, and which to grant. Download our free guide now.">
...
@section('schema')    <script type="application/ld+json">{
  ...
  "@graph": [
    {
      "@type": "Service",
      "@id": "https://www.patronaccounting.com/esop-vs-rsu/gurugram#service",
      "name": "ESOP vs RSU",
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://www.patronaccounting.com/esop-vs-rsu/gurugram#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
        ...
        },
        {
          ...
          "position": 4,
          "name": "ESOP vs RSU",
          "item": "https://www.patronaccounting.com/esop-vs-rsu/gurugram"
        }
      ]
    },
    {
      ...
      "@id": "https://www.patronaccounting.com/esop-vs-rsu/gurugram#localbusiness",
      "name": "Patron Accounting LLP - ESOP vs RSU, Gurugram",
      "url": "https://www.patronaccounting.com/esop-vs-rsu/gurugram",
    ...
    {
      "@type": "FAQPage",
      "@id": "https://www.patronaccounting.com/esop-vs-rsu/gurugram#faq",
      ...
      "mainEntity": [
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "An ESOP is an option under which you pay an exercise price to acquire shares, whereas an RSU delivers shares free of cost on vesting. In India, an RSU is not a separate instrument, so it is structured as an ESOP or as a cash-settled SAR. An ESOP is taxed at exercise, while an RSU is taxed at vesting."
          }
        },
        {
          "@type": "Question",
          "name": "How are RSUs taxed in Gurugram?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "RSUs are taxed as a salary perquisite at vesting, on the full fair market value of the shares, since they are granted free. The employer deducts TDS on that value. When the shares are later sold, the gain over the vesting-date FMV is taxed as capital gains. Foreign-parent RSUs are also taxable in Gurugram at vesting, with DTAA relief for any tax withheld abroad."
          }
        },
        {
          "@type": "Question",
          "name": "I am at a late-stage Cyber City unicorn in Gurugram. Will my ESOPs convert to RSUs near IPO?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "At a late-stage Gurugram unicorn around DLF Cyber City or Golf Course Road, companies often add RSUs alongside existing ESOPs as an IPO nears, because RSUs almost always retain value and suit a soon-to-be-listed share. Your vested ESOPs do not automatically turn into RSUs; the company runs both, with ESOPs for earlier grants and RSUs for newer ones. Each is taxed on its own basis, ESOPs at exercise and RSUs at vesting."
          }
        },
        {
          "@type": "Question",
          "name": "My employer in Udyog Vihar is the Indian arm of a US enterprise-software firm. How are my parent-company RSUs taxed?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "At a Cyber City or Udyog Vihar arm of a US enterprise-software group, the listed parent grants RSUs that vest into its own shares. The vesting-date value is taxed in Gurugram as a salary perquisite and your employer deducts TDS. The US may also withhold tax, for which you claim DTAA relief, and you must report the foreign shares in Schedule FA of your Indian return each year you hold them."
          }
        },
        {
          "@type": "Question",
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Phantom tax arises when you pay perquisite tax on the vesting-date value of an RSU, but the share price subsequently falls. You have paid tax on a higher value while the asset is now worth less, which is a real economic loss. A capital loss claim recovers only part of it."
          }
        },
        {
          "@type": "Question",
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>RSU:</span> free shares on vesting, common at Cyber City unicorns and foreign-parent arms.</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
...
<div class="toc-section">
    <div class="toc-container">
        ...
        <div class="toc-wrapper" id="tocWrapper">
            ...
            <button class="toc-btn" onclick="document.getElementById('procedure-section').scrollIntoView({behavior:'smooth'})">RSU in Gurugram</button>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>ESOP or RSU? The short answer: an ESOP is an option to buy shares, an RSU is a grant of free shares, and in Gurugram an RSU is not a separate instrument. This free guide explains the difference in structure, cost, vesting, taxation and risk, and how RSUs are actually structured under Indian law, framed for Gurugram's enterprise-SaaS and unicorn ecosystem.</p>
                <p>Gurugram is one of India's densest equity-compensation clusters. DLF Cyber City and Udyog Vihar are packed with SaaS and ITES companies, the Golf Course Road and Sohna Road corridors host a startup belt, and the city is home to around 20 unicorns including Zomato, Delhivery and Policybazaar. These late-stage, IPO-bound and listed companies lean towards RSUs and pre-IPO ESOP pools, while the Indian arms of US enterprise-software groups in Cyber City pass RSUs down from a listed parent. Gurugram sits in Haryana, so companies here file with the Registrar of Companies (RoC) Delhi, which covers Haryana, on the MCA21 portal.</p>
                <p>The difference is simple at the core: an ESOP is an option you choose to exercise by paying a price, while an RSU is a promise of free shares once you vest. The Indian twist is that RSU is not a defined instrument under the Companies Act, so a Gurugram company delivers it through an ESOP or a cash-settled structure.</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="two-column">
            <div class="column-content">
                ...
                <div class="content-text what-is-definition">
                    ...
                    <p>For a typical Sohna Road or Golf Course Extension Road startup, an ESOP (Employee Stock Option Plan) is the first equity tool reached for. Under Section 62(1)(b) of the Companies Act, it gives an employee the right, but never the obligation, to buy company shares at a fixed exercise price once they have vested. Acquiring the shares means paying that price.</p>
                    <p>That payment is the whole point: the option is worth something only when the share price climbs above the exercise price. If a Gurugram startup's valuation stalls and the price stays below, the grant goes underwater and the holder lets it lapse rather than buy in at a loss. Founders across the Cyber City belt favour ESOPs precisely because they put no cash on the company's books at grant and pay out only on genuine future upside.</p>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>Walk into almost any enterprise-SaaS office around DLF Cyber City or Udyog Vihar and the equity letter on the table will say RSU, not ESOP. A Restricted Stock Unit is simply a promise: the company hands over shares free of cost the moment vesting conditions, whether a time period or a performance milestone, are satisfied. The employee never writes a cheque to acquire them, because there is no exercise price.</p>
                <p>That free grant is exactly why RSUs feel safer to Gurugram's listed-multinational and unicorn workforce. A share that costs nothing at vesting almost always carries real value, so the instrument rarely sits worthless the way an underwater option can. The catch is structural: Indian law does not name the RSU as an instrument, so a Cyber City employer typically delivers it either as an ESOP carrying a token exercise price, or as a cash-settled right such as a <a href="/esop-vs-sar/gurugram">stock appreciation right</a>, while a US-headquartered parent on Golf Course Road grants its own listed stock directly.</p>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <table>
                    <thead><tr><th>Point of difference</th><th>ESOP vs RSU</th></tr></thead>
                    <tbody>
                        <tr><td>Who typically grants it in Gurugram</td><td>Sohna Road and early Cyber City startups (ESOP) vs listed multinationals and foreign-parent arms in Udyog Vihar (RSU)</td></tr>
                        <tr><td>Cost to the employee</td><td>Exercise price payable to acquire shares (ESOP) vs nothing payable, shares are free (RSU)</td></tr>
                        <tr><td>What it is in essence</td><td>An option to buy shares (ESOP) vs an outright free grant of shares (RSU)</td></tr>
                        <tr><td>Status under Indian law</td><td>Recognised under Section 62(1)(b) (ESOP) vs not a separate instrument; delivered via an ESOP or a cash-settled right (RSU)</td></tr>
                        <tr><td>When perquisite tax bites</td><td>At exercise (ESOP) vs at vesting (RSU)</td></tr>
                        <tr><td>Capital gains on sale</td><td>Cost taken as FMV at exercise (ESOP) vs cost taken as FMV at vesting (RSU)</td></tr>
                        <tr><td>Main downside risk</td><td>Can go underwater if price falls (ESOP) vs phantom tax on value never realised (RSU)</td></tr>
...
<section class="steps-section" id="procedure-section">
    <div class="section-container">
        <header class="section-header" style="text-align:center;margin-bottom:48px;">
            ...
            <h2 class="section-title">How RSUs Are Structured in Gurugram</h2>
...
<div class="step-card">
    <div class="step-content">
        ...
        <p class="step-description">Where a US or other foreign parent grants RSUs to Indian-subsidiary employees, the shares are foreign, taxed in Gurugram at vesting, and may also face withholding abroad, so cross-border structuring matters.</p>
        <div class="step-highlights">
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>For a Gurugram employee, both instruments <a href="/blog/esop-taxation-rules-2026-when-how-stock-options-taxed-rules">trigger tax at two separate moments</a>, first as a salary perquisite and again as capital gains when the shares are sold. What separates them is when that first perquisite charge lands, and getting that timing right matters as much for a Cyber City RSU holder as for a Sohna Road startup's option pool.</p>
                <ul>
                    ...
                    <li><strong><a href="/esop-perquisite-tax-section-17-2-vi/gurugram">ESOP perquisite at exercise</a>:</strong> only the spread between the FMV on the exercise date and the exercise price you paid is taxed as salary.</li>
                    <li><strong>Capital gains on eventual sale:</strong> for either instrument, the sale price less the FMV already taxed as perquisite is the gain, short or long term by holding period.</li>
                </ul>
                <div class="highlight-box" style="margin-top:16px;">
                    <p><strong>The phantom-tax trap that bites Cyber City RSU holders</strong></p>
                    <p>RSU perquisite tax is locked in at the vesting-date value. Picture a Udyog Vihar engineer whose foreign-parent RSUs vest in a strong quarter, only for the listed share to slide afterwards. The tax was paid on a high value that was never cashed in, a real economic loss that a subsequent capital loss claim recovers only in part.</p>
                </div>
                <p style="margin-top:16px;"><strong>So which route fits which company:</strong> a foreign-headquartered enterprise-SaaS group on Golf Course Road simply mirrors its global RSU plan, structured for Indian compliance and tax; a listed or pre-IPO Cyber City firm leans on ESOP-structured RSUs for steadier, easy-to-explain value; a dilution-averse employer picks a cash-settled SAR or phantom stock that tracks the equity without issuing a single share; and an early-stage Sohna Road startup still favours plain ESOPs for their zero cash cost and future upside.</p>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Pitfall we see in Gurugram</th><th>What it costs you</th><th>How Patron Accounting Solves It</th></tr></thead>
                    <tbody>
                        <tr><td>Foreign-parent RSU taxed twice without relief</td><td>Same income taxed in India and abroad</td><td>Claim DTAA relief and file Form 67 for the tax withheld by the US or other parent.</td></tr>
                        <tr><td>Phantom-tax risk on Cyber City RSUs overlooked</td><td>Tax paid on value never realised</td><td>Plan liquidity or a sell-to-cover at vesting so the perquisite outflow is funded.</td></tr>
                        <tr><td>RSU issued as if it were a defined Indian instrument</td><td>Compliance gap in the cap table</td><td>Deliver it as an ESOP or a cash-settled right with the correct filings behind it.</td></tr>
                        <tr><td>Grant-date and tax-date valuations out of sync</td><td>Wrong perquisite computed</td><td>Anchor the FMV used for the perquisite to a proper, defensible <a href="/esop-valuation-services/gurugram">valuation</a>.</td></tr>
...
<section class="why-choose-section" id="benefits-section">
    <div class="section-container">
        <div style="text-align:center;margin-bottom:48px;">
            ...
            <h2 class="section-title">Why Gurugram Companies and Employees Ask Us First</h2>
        </div>
...
<article class="feature-card">
            ...
            <h3 class="feature-title">Cross-border RSUs handled</h3>
            <p class="feature-text">Foreign-parent plans common in Udyog Vihar and Cyber City, aligned to Indian compliance with DTAA relief and Schedule FA reporting.</p>
        </article>
<article class="feature-card">
            ...
            <p class="feature-text">ESOP, RSU or cash-settled, chosen for your cash position and dilution tolerance, whether you are a Sohna Road startup or a pre-IPO unicorn.</p>
        </article>
<article class="feature-card">
            ...
            <h3 class="feature-title">Phantom-tax timing managed</h3>
            <p class="feature-text">The vesting-date perquisite and the phantom-tax exposure on listed RSUs planned ahead, not discovered at filing time.</p>
        </article>
<article class="feature-card">
            ...
            <h3 class="feature-title">RSUs made Companies-Act-ready</h3>
            <p class="feature-text">Structured as an ESOP or a cash-settled right under Indian law, never left dangling as an unrecognised foreign concept.</p>
        </article>
        </div>
    </div>
</section>
...
<section class="content-section" id="comparison-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>Gurugram's equity map maps neatly onto company stage: the early teams on Sohna Road and Golf Course Extension Road still run on ESOPs, the pre-IPO unicorns around DLF Cyber City blend both, listed and US-parent groups in Udyog Vihar lean on RSUs, and the choice usually decides itself once you place a company on this ladder.</p>
                <div class="table-responsive-wrapper">
                <table>
...
<section class="content-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>A Gurugram company is a Haryana-registered entity, so its scheme, board and shareholder approvals and share-issue filings go to the Registrar of Companies (RoC) Delhi, which has jurisdiction over Haryana, on the MCA21 portal. The instruments and the tax treatment behind an ESOP or an RSU, however, are set by central statute and apply the same way here as anywhere in India.</p>
                ...
                <p><strong>RSU in Gurugram:</strong> not a separate statutory instrument; delivered as an equity-settled ESOP, a Section 62(1)(c) preferential allotment with Section 42 compliance, or a cash-settled SAR or phantom stock taxed as salary.</p>
                ...
                <p><strong>Listed and foreign:</strong> listed-company plans follow the SEBI (Share Based Employee Benefits and Sweat Equity) Regulations 2021; foreign-parent RSUs may attract overseas withholding with DTAA relief in Gurugram.</p>
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    ...
                    <p class="faq-expanded__lead">Common questions on how ESOPs and RSUs differ, RSU legality and taxation in Gurugram, which suits which stage, and foreign-parent RSUs.</p>
                ...
                <div class="faq-expanded__list">
                    ...
                    <div class="faq-expanded__item" id="faq-2">
                        <h3 class="faq-expanded__q">Is RSU legal in Gurugram?</h3>
                        <div class="faq-expanded__a"><p>RSUs are used in Gurugram, but RSU is not a separately recognised instrument under the Companies Act. Companies deliver RSUs either as an ESOP with a token exercise price, as a Section 62(1)(c) preferential allotment, or as a cash-settled stock appreciation right or phantom stock. So an RSU is legal, but it is structured through one of these recognised routes rather than as a standalone RSU.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-3">
                        <h3 class="faq-expanded__q">What is the difference between an ESOP and an RSU?</h3>
                        <div class="faq-expanded__a"><p>An ESOP is an option under which you pay an exercise price to acquire shares, whereas an RSU delivers shares free of cost on vesting. In India, an RSU is not a separate instrument, so it is structured as an ESOP or as a cash-settled SAR. An ESOP is taxed at exercise, while an RSU is taxed at vesting.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-4">
                        <h3 class="faq-expanded__q">How are RSUs taxed in Gurugram?</h3>
                        <div class="faq-expanded__a"><p>RSUs are taxed as a salary perquisite at vesting, on the full fair market value of the shares, since they are granted free. The employer deducts TDS on that value. When the shares are later sold, the gain over the vesting-date FMV is taxed as capital gains. Foreign-parent RSUs are also taxable in Gurugram at vesting, with DTAA relief for any tax withheld abroad.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-5">
                        <h3 class="faq-expanded__q">I am at a late-stage Cyber City unicorn in Gurugram. Will my ESOPs convert to RSUs near IPO?</h3>
                        <div class="faq-expanded__a"><p>At a late-stage Gurugram unicorn around DLF Cyber City or Golf Course Road, companies often add RSUs alongside existing ESOPs as an IPO nears, because RSUs almost always retain value and suit a soon-to-be-listed share. Your vested ESOPs do not automatically turn into RSUs; the company runs both, with ESOPs for earlier grants and RSUs for newer ones. Each is taxed on its own basis, ESOPs at exercise and RSUs at vesting.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-6">
                        <h3 class="faq-expanded__q">My employer in Udyog Vihar is the Indian arm of a US enterprise-software firm. How are my parent-company RSUs taxed?</h3>
                        <div class="faq-expanded__a"><p>At a Cyber City or Udyog Vihar arm of a US enterprise-software group, the listed parent grants RSUs that vest into its own shares. The vesting-date value is taxed in Gurugram as a salary perquisite and your employer deducts TDS. The US may also withhold tax, for which you claim DTAA relief, and you must report the foreign shares in Schedule FA of your Indian return each year you hold them.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-7">
                        <h3 class="faq-expanded__q">What is phantom tax on an RSU?</h3>
                        <div class="faq-expanded__a"><p>Phantom tax arises when you pay perquisite tax on the vesting-date value of an RSU, but the share price subsequently falls. You have paid tax on a higher value while the asset is now worth less, which is a real economic loss. A capital loss claim recovers only part of it.</p></div>
                    </div>
            ...
            <div class="highlight-box" style="margin-top:32px;">
                ...
                <ul>
                    ...
                    <li><strong>How can global RSUs be granted in Gurugram?</strong> RSUs are typically structured as an ESOP plan or settled in cash, since Indian company law has no separate RSU framework.</li>
