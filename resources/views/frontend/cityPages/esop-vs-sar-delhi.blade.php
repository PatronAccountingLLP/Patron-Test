...
@section('meta')
    <title>Delhi ESOP vs SAR: Choosing the Right Employee Reward Plan</title>
    <meta name="description" content="Choosing between ESOP equity and cash-settled SARs for your Delhi startup? This free guide explains tax timing, dilution and Ind AS 102 in plain terms.">
    <meta name="keywords" content="ESOP vs SAR Delhi, ESOP vs SAR in Delhi, ESOP vs SAR services in Delhi, ESOP services Delhi, ESOP vs SAR cost Delhi, ESOP vs SAR consultants Delhi, CA firm for ESOP vs SAR Delhi, ESOP advisory Delhi">
    <link rel="canonical" href="/esop-vs-sar/delhi">
    <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1">
    <meta property="og:title" content="Delhi ESOP vs SAR: Choosing the Right Employee Reward Plan | Patron Accounting">
    <meta property="og:description" content="Choosing between ESOP equity and cash-settled SARs for your Delhi startup? This free guide explains tax timing, dilution and Ind AS 102 in plain terms.">
...
@section('schema')    <script type="application/ld+json">{
  ...
  "@graph": [
    {
      "@type": "Service",
      "@id": "https://www.patronaccounting.com/esop-vs-sar/delhi#service",
      "name": "ESOP vs SAR",
      ...
      "about": [
        {
          ...
          "sameAs": "https://en.wikipedia.org/wiki/Stock_appreciation_right"
        }
      ]
    },
    {
      "@type": "BreadcrumbList",
      "@id": "https://www.patronaccounting.com/esop-vs-sar/delhi#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
        ...
        },
        {
          ...
          "position": 4,
          "name": "ESOP vs SAR",
          "item": "https://www.patronaccounting.com/esop-vs-sar/delhi"
        }
      ]
    },
    {
      ...
      "@id": "https://www.patronaccounting.com/esop-vs-sar/delhi#localbusiness",
      "name": "Patron Accounting LLP - ESOP vs SAR, Delhi",
      "url": "https://www.patronaccounting.com/esop-vs-sar/delhi",
    ...
    {
      "@type": "FAQPage",
      "@id": "https://www.patronaccounting.com/esop-vs-sar/delhi#faq",
      ...
      "mainEntity": [
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "No. Unlike an ESOP, a SAR has no exercise price; the employee pays nothing to receive the appreciation. The benefit is the increase in share value from the grant price to the value at exercise, paid in cash or settled in shares. This is one of the main attractions of a SAR, since employees are never asked to fund a purchase to realise their reward."
          }
        },
        {
          "@type": "Question",
          "name": "What is the difference between a SAR and an ESOP?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Under an ESOP, you pay an exercise price to purchase shares. Under a SAR, you pay nothing and simply receive the appreciation, settled in cash or shares. A cash-settled SAR causes no dilution, and a SAR can never go underwater the way an ESOP can."
          }
        },
        {
          "@type": "Question",
          "name": "Can a Delhi founder be rewarded with a SAR when Rule 12(1) blocks an ESOP?",
          "acceptedAnswer": {
            "@type": "Answer",
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Under Ind AS 102, a cash-settled SAR is a cash-settled share-based payment, re-valued at fair value at each reporting date until settlement, with the expense charged over the vesting period and a corresponding liability that moves with the company's value. An equity-settled SAR, like an ESOP, is measured at grant-date fair value and is not re-valued, which makes earnings more predictable."
          }
        },
        {
          "@type": "Question",
          "name": "What is the difference between a SAR and phantom stock?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Phantom stock is ordinarily settled only in cash. A SAR can be settled in either cash or equity, and that is the most significant difference. A cash-settled SAR is a close cousin of phantom stock, but an equity-settled SAR has no phantom-stock equivalent."
          }
        },
        {
          "@type": "Question",
          "name": "Why do Nehru Place and Connaught Place companies compare ESOP against SAR?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "The demand in Delhi spans the Nehru Place IT market, the Connaught Place finance district and the Saket and Aerocity corporate belt, mixing early-stage SaaS firms with established corporates. SaaS founders favour cash-settled SARs to retain talent without diluting investors or filing share-capital resolutions with RoC Delhi, while corporates often run full ESOPs for senior hires who want real ownership. The choice usually turns on whether the company wants to issue shares at all."
          }
        }
      ]
    }
        ...
        <div class="row align-items-center">
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <p class="mb-4" style="color: var(--text-secondary); font-size: 16px;">For capital-region companies filing with RoC Delhi, a stone's throw from the MCA head office, this guide weighs the share-issuing ESOP against the dilution-free cash-settled SAR that Nehru Place and Saket founders favour with NRI investors on the cap table.</p>
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="mailto:sales@patronaccounting.com?subject=Enquiry%20for%20ESOP vs SAR%20Services&body=Hello%2C%20I%20just%20visited%20your%20ESOP%20vs%20SAR%20Services%20page.%20I%20would%20like%20to%20know%20more%20about%20it.%0A%0AThank%20you." class="btn-sample text-decoration-none">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:18px;height:18px;"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,12 2,6"/></svg>
                            Email Us
                        </a>
                        <a href="https://wa.me/919459456700?text=Hello%2C%20I%20just%20visited%20your%20ESOP%20vs%20SAR%20Services%20page.%20I%20would%20like%20to%20know%20more%20about%20it." target="_blank" class="btn-sample text-decoration-none" rel="noopener">
...
<section class="steps-section" id="procedure-section">
    <div class="section-container">
        <header class="section-header" style="text-align:center;margin-bottom:48px;">
            ...
            <p class="section-subtitle" style="text-align:left;max-width:100%;">Once a capital-region founder settles on a SAR, the next fork is how it pays out, the single lever plain phantom stock never offers. A Nehru Place trading firm sitting on tight working capital leans one way; a Saket consumer-tech venture shielding an NRI-held register leans the other. The two settlement forms behave so differently that the choice deserves its own decision, so here is how each one works.</p>
        </header>
...
<div class="step-card">
    <div class="step-content">
        ...
        <p class="step-description">Phantom stock pays out only in cash, so a cash-settled SAR is its near twin, while an equity-settled SAR has no phantom counterpart at all. For a Delhi firm choosing an instrument, that ability to settle in either cash or equity is precisely what marks a SAR off from plain phantom stock.</p>
        <div class="step-highlights">
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>Two questions decide the tax and accounting on a Delhi SAR, and both turn on settlement: when is it taxed, and how does it sit in the books? A SAR is a salary perquisite, but its timing moves with whether you pay cash or hand over shares, and Ind AS 102 records each mode on a different basis. So a Nehru Place trading firm paying cash and a Saket venture issuing equity end up with very different lines in their accounts, even on identical economics.</p>
                <ul>
                    <li><strong>Equity-settled SAR tax:</strong> the appreciation is taxed as a perquisite on the exercise date, and the later sale of those shares is taxed as capital gains.</li>
                    <li><strong>Cash-settled SAR tax:</strong> the cash appreciation is taxed as salary on the date of payment, with Section 192 TDS, and there is no capital-gains event.</li>
                    <li><strong>Ind AS 102 accounting:</strong> cash-settled SARs are re-valued at fair value at each reporting date until settlement, while equity-settled SARs and ESOPs stay at grant-date fair value.</li>
                </ul>
                <div class="highlight-box" style="margin-top:16px;">
                    <p><strong>Why the Ind AS 102 difference matters</strong></p>
                    <p>A cash-settled SAR lives on the balance sheet as a liability marked to market at every reporting date. As a fast-growing Nehru Place trading firm gains value, the expense and the liability climb alongside it, throwing up earnings volatility that an ESOP, locked at grant-date value, simply never produces.</p>
                </div>
                <p style="margin-top:16px;"><strong>When a SAR makes sense:</strong> there is no exercise-price friction, so employees realise value without funding any purchase; settlement can be tuned to a firm's cash flow and dilution appetite; a cash-settled SAR causes no dilution; and vesting is flexible, since unlisted SARs carry no mandated minimum vesting that ESOPs are bound by. When ESOP is still better: when a Delhi founder wants employees to hold genuine equity and ownership, and to reach the startup deferral and capital-gains treatment that only real shares unlock.</p>
...
<section class="content-section" id="challenges-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p style="margin-bottom:16px;">The slip-ups we see across Nehru Place, Connaught Place and the Saket-Aerocity belt tend to surface during a statutory audit or an NRI-investor diligence round, exactly when they are hardest to fix. Here is what trips Delhi firms up and how we head it off.</p>
                <div class="table-responsive-wrapper">
                <table>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p style="margin-top:16px;"><strong>Get a free ESOP vs SAR consultation - <a href="tel:+919459456700">Call +91 945 945 6700</a> or <a href="https://wa.me/919459456700?text=Hello%2C%20I%20just%20visited%20your%20ESOP%20vs%20SAR%20Services%20page.%20I%20would%20like%20to%20know%20more%20about%20it." target="_blank" rel="noopener">WhatsApp us</a>. No-obligation assessment.</strong></p>
            </div>
        </div>
    </div>
</section>
...
<article class="feature-card">
            ...
            <p class="feature-text">A documented SAR scheme and valuation that stand up to an NRI-investor diligence round and a Delhi statutory audit.</p>
        </article>
<article class="feature-card">
            ...
            <p class="feature-text">The settlement mode matched to your dilution tolerance and cash position, whether you sit in Nehru Place or Saket.</p>
        </article>
<article class="feature-card">
            ...
            <p class="feature-text">Tax timing pinned down for both cash-settled and equity-settled SARs, with Section 192 TDS handled.</p>
        </article>
<article class="feature-card">
            ...
            <p class="feature-text">Ind AS 102 accounting taken care of, including the period re-valuation of cash-settled SARs.</p>
        </article>
        </div>
    </div>
</section>
...
<section class="content-section" id="comparison-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p style="margin-bottom:16px;">Capital-region founders usually shortlist three instruments side by side. A Connaught Place corporate after real ownership tends toward the ESOP; a Nehru Place SaaS team protecting an NRI-held cap table leans to a cash-settled SAR; and phantom stock comes up wherever cash is the only acceptable currency. The grid below sets them against each other on the levers Delhi boards care about most.</p>
                <div class="table-responsive-wrapper">
                <table>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p style="margin-bottom:16px;">For companies filing under RoC Delhi, four bodies of law govern how an ESOP and a SAR are issued, taxed and reported. Because the MCA head office sits in the capital, the Companies Act limbs in particular are applied to the letter here. The framework in brief:</p>
                <p><strong>ESOP:</strong> granted under Section 62(1)(b) of the Companies Act as an option to buy shares, taxed as a <a href="/esop-perquisite-tax-section-17-2-vi/delhi">perquisite at exercise under Section 17(2)(vi)</a> and as <a href="/esop-capital-gains-tax-on-sale/delhi">capital gains on sale</a>.</p>
                ...
                <p><strong>Taxation:</strong> SARs are taxed as a salary perquisite with <a href="/esop-tds-section-192-and-form-24q/delhi">Section 192 TDS</a>; cash-settled on the date of payment, equity-settled on the exercise date with capital gains on later sale.</p>
...
<section class="content-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">ESOP vs SAR for Delhi Companies</h2>
            <div class="content-text">
                <p>Delhi companies are registered with the <strong>Registrar of Companies, Delhi</strong>, and the city is also home to the <strong>Ministry of Corporate Affairs</strong>, so Companies Act compliance is unusually visible here. An ESOP requires a special resolution, an MGT-14 filing with RoC Delhi and adherence to Rule 12 of the Share Capital and Debentures Rules, including Rule 12(1) which prohibits granting options to promoters or shareholders holding more than 10 percent, unless the company is a DPIIT-recognised startup within the 10-year relaxation window.</p>
                <p>That compliance load is exactly why a SAR appeals to many unlisted Delhi companies. A SAR is contractual, has no Section 62 share-issue requirement, and a cash-settled SAR even lets a company reward a promoter-founder for appreciation without running into the Rule 12(1) option restriction. The demand clusters are spread across the <strong>Nehru Place IT market</strong>, the <strong>Connaught Place finance district</strong> and the <strong>Saket and Aerocity corporate belt</strong>, where both early-stage SaaS firms and established corporates use these instruments.</p>
                <p>A typical Delhi pattern: a startup that has crossed its DPIIT window uses cash-settled SARs to reward a 10 percent-plus founder where an ESOP is restricted, and a full ESOP for the broader team. We help Delhi companies pick the compliant route through RoC Delhi and account for cash-settled SARs under Ind AS 102.</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="content-container">
        <div class="text-content">
            <div class="faq-expanded">
                ...
                <div class="faq-expanded__list">
                    ...
                    <div class="faq-expanded__item" id="faq-3">
                        <h3 class="faq-expanded__q">What is the difference between a SAR and an ESOP?</h3>
                        <div class="faq-expanded__a"><p>Under an ESOP, you pay an exercise price to purchase shares. Under a SAR, you pay nothing and simply receive the appreciation, settled in cash or shares. A cash-settled SAR causes no dilution, and a SAR can never go underwater the way an ESOP can.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-4">
                        <h3 class="faq-expanded__q">Can a Delhi founder be rewarded with a SAR when Rule 12(1) blocks an ESOP?</h3>
                        <div class="faq-expanded__a"><p>Often yes. With the Ministry of Corporate Affairs headquartered in Delhi, RoC Delhi companies follow Rule 12(1) closely, and it bars granting ESOP options to a promoter or a 10 percent-plus shareholder unless the company is a DPIIT-recognised startup inside its 10-year window. A cash-settled SAR has no Section 62 share issue, so it can reward a promoter-founder for appreciation without running into that option restriction. This is a common reason Delhi founders compare the two instruments before granting.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-5">
                        <h3 class="faq-expanded__q">How are SARs taxed in Delhi?</h3>
                    ...
                    <div class="faq-expanded__item" id="faq-7">
                        <h3 class="faq-expanded__q">What is the difference between a SAR and phantom stock?</h3>
                        <div class="faq-expanded__a"><p>Phantom stock is ordinarily settled only in cash. A SAR can be settled in either cash or equity, and that is the most significant difference. A cash-settled SAR is a close cousin of phantom stock, but an equity-settled SAR has no phantom-stock equivalent.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-8">
                        <h3 class="faq-expanded__q">Why do Nehru Place and Connaught Place companies compare ESOP against SAR?</h3>
                        <div class="faq-expanded__a"><p>The demand in Delhi spans the Nehru Place IT market, the Connaught Place finance district and the Saket and Aerocity corporate belt, mixing early-stage SaaS firms with established corporates. SaaS founders favour cash-settled SARs to retain talent without diluting investors or filing share-capital resolutions with RoC Delhi, while corporates often run full ESOPs for senior hires who want real ownership. The choice usually turns on whether the company wants to issue shares at all.</p></div>
                    </div>
                </div>
            </div>
            ...
            <div class="highlight-box" style="margin-top:32px;">
                ...
                <ul>
                    <li><strong>What is an ESOP?</strong> An ESOP is an option that lets an employee buy shares at a pre-agreed exercise price.</li>
                    <li><strong>What is a SAR?</strong> A SAR gives an employee the right to the appreciation in share value, with nothing to pay upfront.</li>
                    <li><strong>How is a SAR settled?</strong> A SAR can be settled in cash or in equity.</li>
                    <li><strong>How is a SAR taxed?</strong> A SAR is taxed as salary, at the point of payment or exercise.</li>
                    <li><strong>How does Ind AS 102 treat a SAR?</strong> Under Ind AS 102, a cash-settled SAR is re-valued each reporting period.</li>
                </ul>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div style="display:flex;gap:14px;flex-wrap:wrap;margin-top:24px;">
                ...
                <a href="https://wa.me/919459456700?text=Hello%2C%20I%20just%20visited%20your%20ESOP%20vs%20SAR%20Services%20page.%20I%20would%20like%20to%20know%20more%20about%20it." target="_blank" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:#25D366;color:#fff;border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;" rel="noopener">&#128172; WhatsApp Us</a>
                <a href="mailto:sales@patronaccounting.com?subject=Enquiry%20for%20ESOP vs SAR%20Services&body=Hello%2C%20I%20just%20visited%20your%20ESOP%20vs%20SAR%20Services%20page.%20I%20would%20like%20to%20know%20more%20about%20it.%0A%0AThank%20you." style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:transparent;color:#fff;border:2px solid rgba(255,255,255,0.3);border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#9993;&#65039; Email Us</a>
            </div>
...
<section class="content-section">
    <div class="content-container"><div class="text-content">
        ...
        <div class="content-text"><p>Start with the national ESOP vs SAR service, then explore complementary ESOP services across India.</p>
        <ul>
                    <li><strong><a href="/esop-vs-sar">ESOP vs SAR in India</a></strong> - the national parent service</li>
...
<section class="content-section" style="padding:48px 32px;background:var(--gray-50);">
    <div class="content-container"><div class="text-content">
        <h2 class="section-title">ESOP vs SAR by City</h2>
        <div class="content-text"><p>Available across our four office cities. You are viewing the Delhi page.</p></div>
        <div class="pa-city-grid"><a href="/esop-vs-sar/pune" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Pune</div><div class="pa-card-sub">Maharashtra</div></div></a><a href="/esop-vs-sar/mumbai" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Mumbai</div><div class="pa-card-sub">Maharashtra</div></div></a><span class="pa-city-card" aria-current="page" style="border-color:var(--orange);background:#FFF7F2;cursor:default;position:relative;"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Delhi</div><div class="pa-card-sub">Delhi NCR</div></div><span style="position:absolute;top:10px;right:12px;font-size:10px;font-weight:700;color:var(--orange);letter-spacing:.04em;">YOU'RE HERE</span></span><a href="/esop-vs-sar/gurugram" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Gurugram</div><div class="pa-card-sub">Haryana</div></div></a></div>
    </div></div>
</section>
