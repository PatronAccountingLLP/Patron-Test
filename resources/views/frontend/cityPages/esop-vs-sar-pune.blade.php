...
@section('meta')
    <title>Pune ESOP vs SAR: Equity or Cash-Settled Employee Rewards</title>
    <meta name="description" content="Weighing ESOP equity against cash-settled SARs for your Pune SaaS team in Hinjewadi or Kharadi? Get a free guide on dilution, tax and Ind AS 102.">
    <meta name="keywords" content="ESOP vs SAR Pune, ESOP vs SAR in Pune, ESOP vs SAR services in Pune, ESOP services Pune, ESOP vs SAR cost Pune, ESOP vs SAR consultants Pune, CA firm for ESOP vs SAR Pune, ESOP advisory Pune">
    <link rel="canonical" href="/esop-vs-sar/pune">
    <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1">
    <meta property="og:title" content="Pune ESOP vs SAR: Equity or Cash-Settled Employee Rewards | Patron Accounting">
    <meta property="og:description" content="Weighing ESOP equity against cash-settled SARs for your Pune SaaS team in Hinjewadi or Kharadi? Get a free guide on dilution, tax and Ind AS 102.">
...
@section('schema')    <script type="application/ld+json">{
  ...
  "@graph": [
    {
      "@type": "Service",
      "@id": "https://www.patronaccounting.com/esop-vs-sar/pune#service",
      "name": "ESOP vs SAR",
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://www.patronaccounting.com/esop-vs-sar/pune#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
        ...
        },
        {
          ...
          "position": 4,
          "name": "ESOP vs SAR",
          "item": "https://www.patronaccounting.com/esop-vs-sar/pune"
        }
      ]
    },
    {
      ...
      "@id": "https://www.patronaccounting.com/esop-vs-sar/pune#localbusiness",
      "name": "Patron Accounting LLP - ESOP vs SAR, Pune",
      "url": "https://www.patronaccounting.com/esop-vs-sar/pune",
    ...
    {
      "@type": "FAQPage",
      "@id": "https://www.patronaccounting.com/esop-vs-sar/pune#faq",
      ...
      "mainEntity": [
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Under an ESOP, you pay the exercise price to purchase the shares. Under a SAR, you pay nothing and receive only the appreciation, either in cash or in shares. A cash-settled SAR causes no dilution, and a SAR can never go underwater the way an ESOP can."
          }
        },
        {
          "@type": "Question",
          "name": "Why do Hinjewadi and Baner startups often prefer SARs over ESOPs?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Engineering teams in the Hinjewadi and Magarpatta IT parks can earn far more at neighbouring MNCs, so founders want a strong retention reward without cap-table churn. A cash-settled SAR pays the appreciation in money with no exercise price and no dilution, which suits cash-watching Kharadi, Viman Nagar and Baner startups. ESOPs are still used for senior CXO hires who want genuine ownership."
          }
        },
        {
          "@type": "Question",
          "name": "How are SARs taxed in Pune?",
          "acceptedAnswer": {
            "@type": "Answer",
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Phantom stock is generally settled in cash only. A SAR can be settled in either cash or equity, and this is the most significant difference between the two. A cash-settled SAR is a close cousin of phantom stock, whereas an equity-settled SAR is not possible with phantom stock."
          }
        },
        {
          "@type": "Question",
          "name": "Does a Pune company file the ESOP or the SAR with RoC Pune?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Pune companies are registered with the Registrar of Companies, Pune, which administers the Companies Act for the region. An ESOP needs a board and shareholder resolution and an MGT-14 filing with RoC Pune under Section 62(1)(b). A SAR for an unlisted Pune company is largely contractual and does not need the same share-capital filing, which is one reason founders pick it for speed."
          }
        }
      ]
    }
        ...
        <div class="row align-items-center">
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <p style="font-size:1.05rem;color:var(--text-secondary);margin-top:-0.75rem;margin-bottom:1.5rem;">For a Hinjewadi or Kharadi product team, the equity-versus-cash call decides whether you dilute the cap table before your next round or pay the upside out as salary, files routed through RoC Pune on MCA21.</p>
...
<section class="content-section" id="services-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>Set side by side for a Pune company, the two instruments part ways on seven things that matter to a Hinjewadi or Baner board, who pays, what is actually granted, how it settles, what it does to the cap table, when tax bites, how it hits the Ind AS 102 charge, and whether it can ever go underwater. Read the table below as the decision grid we walk Pune founders through before recommending one over the other.</p>
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Dimension</th><th>ESOP vs SAR for a Pune company</th></tr></thead>
                    <tbody>
                        <tr><td>Cost to the employee</td><td>ESOP needs the exercise price paid; a SAR costs the employee nothing</td></tr>
                        <tr><td>What is granted</td><td>ESOP is an option to buy shares; a SAR is a right to the appreciation alone</td></tr>
                        <tr><td>How it settles</td><td>ESOP settles in equity only; a SAR can settle in cash or in equity</td></tr>
                        <tr><td>Effect on the cap table</td><td>ESOP always dilutes; a cash-settled SAR does not, an equity-settled SAR does</td></tr>
                        <tr><td>Tax treatment</td><td>ESOP is a perquisite at exercise plus capital gains on sale; a SAR is salary, taxed at payment or at exercise</td></tr>
                        <tr><td>Ind AS 102 charge</td><td>ESOP uses grant-date fair value with no re-valuation; a cash-settled SAR is re-valued each period</td></tr>
                        <tr><td>Downside risk</td><td>An ESOP can fall underwater; a SAR draws its value straight from the company</td></tr>
...
<section class="steps-section" id="procedure-section">
    <div class="section-container">
        <header class="section-header" style="text-align:center;margin-bottom:48px;">
            ...
            <p class="section-subtitle" style="text-align:left;max-width:100%;">Once a Pune company has chosen a SAR over an ESOP, the next fork is settlement, the single dial that phantom stock never offers. A cash-settled and an equity-settled SAR look alike on the grant letter but diverge sharply on the Kharadi startup's runway, on dilution before the next round, and on how the entry lands under Ind AS 102.</p>
        </header>
...
<div class="step-card">
    <div class="step-content">
        ...
        <p class="step-description">Here the company hands over shares worth the appreciation. That issues fresh equity and dilutes the cap table, much like an ESOP, which may suit a Chakan manufacturer that genuinely wants a key hire on the shareholding. It is taxed as a perquisite on the exercise date, with capital gains when the shares are later sold, and under Ind AS 102 it is fixed at grant-date fair value with no re-valuation.</p>
        <div class="step-highlights">
...
<div class="step-card">
    <div class="step-content">
        ...
        <p class="step-description">Phantom stock pays out in cash and nothing else. A cash-settled SAR is its near-twin, while an equity-settled SAR has no phantom counterpart at all. For a Pune founder weighing the options, this dual-settlement choice is precisely what makes a SAR more flexible than plain phantom stock.</p>
        <div class="step-highlights">
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>This is the section where Pune finance teams most often come unstuck. A SAR is always taxed as a salary perquisite, but the date the tax crystallises moves with how the award settles, and Ind AS 102 then books the two settlement modes on entirely different bases. For a fast-scaling Magarpatta SaaS firm running its first audited accounts, or a Chakan manufacturer adding a SAR onto an existing payroll, getting the timing and the entry right at the design stage is far cheaper than untangling it during the year-end close.</p>
                <ul>
                    <li><strong>Equity-settled SAR tax:</strong> the appreciation is a perquisite taxed on the exercise date, and the eventual sale of the shares is taxed separately as capital gains.</li>
                    <li><strong>Cash-settled SAR tax:</strong> the cash appreciation is salary, taxed on the date it is paid, with Section 192 TDS deducted and no capital-gains event at all.</li>
                    <li><strong>Ind AS 102 accounting:</strong> a cash-settled SAR is re-valued at fair value at each reporting date right up to settlement, while equity-settled SARs and ESOPs stay at grant-date fair value.</li>
                </ul>
                <div class="highlight-box" style="margin-top:16px;">
                    <p><strong>Why the Ind AS 102 difference matters for a growing Pune company</strong></p>
                    <p>A cash-settled SAR lives on the balance sheet as a liability marked to market every reporting date. For a fast-appreciating Hinjewadi SaaS business, that means the expense and the liability climb with each valuation uptick, producing earnings swings that an ESOP, frozen at grant-date value, simply does not.</p>
                </div>
                <p style="margin-top:16px;"><strong>When a SAR is the better fit:</strong> there is no exercise price for the employee to fund, settlement can be tuned to your cash flow and dilution targets, a cash-settled award causes no dilution, and vesting is flexible because unlisted SARs carry no mandated minimum vesting the way ESOPs do. <strong>When an ESOP still wins:</strong> when you genuinely want the person holding real equity and ownership, and to unlock the startup tax deferral and capital-gains treatment that only come with actual shares.</p>
...
<section class="content-section" id="challenges-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>Across the SAR and ESOP schemes we have cleaned up for Pune companies, from Hinjewadi product startups to MIDC-belt manufacturers, the same four mistakes recur. None of them are exotic; each is the kind of slip a busy founder makes when a scheme is drafted in a hurry and only examined later, usually mid-diligence. Here is what they cost and how we close them off.</p>
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Mistake we see in Pune schemes</th><th>What it costs you</th><th>How Patron Accounting fixes it</th></tr></thead>
                    <tbody>
                        <tr><td>Treating a SAR as if it were the same as phantom stock</td><td>Wrong instrument chosen</td><td>Use a SAR where cash-or-equity flexibility is needed; reserve phantom for cash-only rewards.</td></tr>
                        <tr><td>Skipping the Ind AS 102 re-valuation on cash-settled SARs</td><td>Earnings volatility at year-end</td><td>Carry the SAR liability at fair value at every reporting date so the books stay clean.</td></tr>
                        <tr><td>Getting the tax timing wrong across cash and equity settlement</td><td>TDS default and notices</td><td>Tax cash-settled awards at payment and equity-settled at exercise, with Section 192 TDS handled.</td></tr>
                        <tr><td>Running a SAR with no written scheme or valuation method</td><td>Audit and diligence gaps</td><td>Put a board-approved scheme in place with grant price, vesting and a defensible valuation.</td></tr>
...
<section class="why-choose-section" id="benefits-section">
    <div class="section-container">
        <div style="text-align:center;margin-bottom:48px;">
            ...
            <h2 class="section-title">What a Pune Founder Gets From Getting This Right</h2>
            <p class="section-subtitle" style="margin:0 auto;">The choice between an ESOP and a SAR, and between cash and equity settlement, is reversible only at real cost once grants are out. These are the four things we lock down for Hinjewadi, Kharadi and MIDC-belt teams before the first grant letter.</p>
        </div>
...
<article class="feature-card">
            ...
            <h3 class="feature-title">Settlement matched to your cash flow</h3>
            <p class="feature-text">We pick the cash or equity settlement that fits a Pune company's dilution tolerance and cash position.</p>
        </article>
<article class="feature-card">
            ...
            <h3 class="feature-title">Tax timing done right</h3>
            <p class="feature-text">Correct perquisite and salary timing across cash-settled and equity-settled SARs, with Section 192 TDS.</p>
        </article>
<article class="feature-card">
            ...
            <h3 class="feature-title">Ind AS 102 fully handled</h3>
            <p class="feature-text">Complete Ind AS 102 accounting, including the period-by-period re-valuation of cash-settled SARs.</p>
        </article>
<article class="feature-card">
            ...
            <p class="feature-text">A documented SAR scheme and valuation that stand up in audit and investor diligence.</p>
        </article>
        </div>
    </div>
</section>
...
<section class="content-section" id="comparison-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>Pune founders rarely weigh just two instruments, <a href="/esop-vs-phantom-stock/pune">phantom stock</a> keeps coming up as the third option, especially among manufacturing and services firms in the MIDC belt that want a cash-only reward. The grid below lines up all three on the points a Hinjewadi or Baner board actually decides on, so you can see why a cash-settled SAR is often the middle path: the no-dilution comfort of phantom with the option to flip to equity later that phantom can never give.</p>
                <div class="table-responsive-wrapper">
                <table>
...
<section class="content-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>The same statutes apply to a Pune company as anywhere in India, but for a local board the practical touchpoint is that any share issue under an ESOP, or an equity-settled SAR, runs the Companies Act filings, the special resolution under Section 62(1)(b) and the MGT-14, and later the PAS-3 return of allotment, through the Registrar of Companies, Pune on the MCA21 portal. Here is the framework that governs each piece.</p>
                <p><strong>ESOP:</strong> granted under Section 62(1)(b) of the Companies Act as an option to buy shares, taxed as a <a href="/esop-perquisite-tax-section-17-2-vi/pune">perquisite at exercise under Section 17(2)(vi)</a> and as <a href="/esop-capital-gains-tax-on-sale/pune">capital gains on sale</a>.</p>
                ...
                <p><strong>Ind AS 102:</strong> cash-settled SARs are <a href="/esop-accounting-ind-as-102/pune">cash-settled share-based payments</a>, re-valued at fair value at each reporting date until settlement; equity-settled SARs and ESOPs are measured at grant-date fair value and not re-valued.</p>
...
<section class="content-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">ESOP vs SAR for Pune Startups</h2>
            <div class="content-text">
                <p>Pune's company filings sit with the <strong>Registrar of Companies, Pune</strong>, which administers the Companies Act for Maharashtra alongside RoC Mumbai. An ESOP grant therefore runs through RoC Pune for the SPICe-related and MGT-14 filings, while a SAR for an unlisted Pune company is largely contractual and does not need the same share-capital paperwork, which is one practical reason a fast-moving startup picks a SAR.</p>
                <p>The clusters that drive demand here are distinct. The <strong>Hinjewadi Rajiv Gandhi Infotech Park and Magarpatta City IT parks</strong> are full of engineering-heavy teams where founders want to reward value creation without the cap-table churn of issuing shares. The <strong>Kharadi and Viman Nagar startup hubs</strong> and the <strong>Baner and Balewadi tech corridor</strong> are home to younger, cash-watching companies that often choose cash-settled SARs so they neither dilute early investors nor ask employees to fund an exercise price.</p>
                <p>A typical Pune pattern: a SaaS company in Baner uses a cash-settled SAR for its core engineers (no dilution, paid out as salary at exercise), and a full ESOP for a handful of senior CXO hires who want genuine ownership. We help Pune founders draw that line and account for both correctly under Ind AS 102, including the re-valuation that the cash-settled SAR carries every reporting date.</p>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="faq-expanded">
                ...
                <div class="faq-expanded__list">
                    ...
                    <div class="faq-expanded__item" id="faq-3">
                        ...
                        <div class="faq-expanded__a"><p>Under an ESOP, you pay the exercise price to purchase the shares. Under a SAR, you pay nothing and receive only the appreciation, either in cash or in shares. A cash-settled SAR causes no dilution, and a SAR can never go underwater the way an ESOP can.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-4">
                        <h3 class="faq-expanded__q">Why do Hinjewadi and Baner startups often prefer SARs over ESOPs?</h3>
                        <div class="faq-expanded__a"><p>Engineering teams in the Hinjewadi and Magarpatta IT parks can earn far more at neighbouring MNCs, so founders want a strong retention reward without cap-table churn. A cash-settled SAR pays the appreciation in money with no exercise price and no dilution, which suits cash-watching Kharadi, Viman Nagar and Baner startups. ESOPs are still used for senior CXO hires who want genuine ownership.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-5">
                        <h3 class="faq-expanded__q">How are SARs taxed in Pune?</h3>
                    ...
                    <div class="faq-expanded__item" id="faq-7">
                        ...
                        <div class="faq-expanded__a"><p>Phantom stock is generally settled in cash only. A SAR can be settled in either cash or equity, and this is the most significant difference between the two. A cash-settled SAR is a close cousin of phantom stock, whereas an equity-settled SAR is not possible with phantom stock.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-8">
                        <h3 class="faq-expanded__q">Does a Pune company file the ESOP or the SAR with RoC Pune?</h3>
                        <div class="faq-expanded__a"><p>Pune companies are registered with the Registrar of Companies, Pune, which administers the Companies Act for the region. An ESOP needs a board and shareholder resolution and an MGT-14 filing with RoC Pune under Section 62(1)(b). A SAR for an unlisted Pune company is largely contractual and does not need the same share-capital filing, which is one reason founders pick it for speed.</p></div>
                    </div>
                </div>
            </div>
...
<section class="content-section" style="padding:48px 32px;background:var(--gray-50);">
    <div class="content-container"><div class="text-content">
        ...
        <div class="pa-city-grid"><span class="pa-city-card" aria-current="page" style="border-color:var(--orange);background:#FFF7F2;cursor:default;position:relative;"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Pune</div><div class="pa-card-sub">Maharashtra</div></div><span style="position:absolute;top:10px;right:12px;font-size:10px;font-weight:700;color:var(--orange);letter-spacing:.04em;">YOU'RE HERE</span></span><a href="/esop-vs-sar/mumbai" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Mumbai</div><div class="pa-card-sub">Maharashtra</div></div></a><a href="/esop-vs-sar/delhi" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Delhi</div><div class="pa-card-sub">Delhi NCR</div></div></a><a href="/esop-vs-sar/gurugram" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Gurugram</div><div class="pa-card-sub">Haryana</div></div></a></div>
    </div></div>
</section>
