...
@section('meta')
    <title>FCRA Annual Return (Form FC-4) in Pune</title>
    <meta name="description" content="File FCRA Form FC-4 by 31 December every year. Learn the nil return rule, CA certificate, attachments and late-filing penalty. Expert CA help. Serving Pune.">
    <link rel="canonical" href="/fcra-fc-4-annual-return/pune">
    ...
    <meta property="og:url" content="/fcra-fc-4-annual-return/pune">
...
@section('schema')
    @include('partials.city-localbusiness', ['citySlug' => 'pune', 'pageUrl' => '/fcra-fc-4-annual-return/pune'])
  ...
  "@graph": [
    {
      ...
      "itemListElement": [
        ...
        },
        {
          "@type": "ListItem",
          "position": 3,
          "name": "FCRA Annual Return (Form FC-4) in Pune",
          "item": "https://www.patronaccounting.com/fcra-fc-4-annual-return/pune"
        }
      ]
    },
    {
    ...
    },
    {
      ...
      "url": "https://www.patronaccounting.com/fcra-fc-4-annual-return/pune",
      "offers": {
        "@type": "Offer",
        "priceCurrency": "INR",
        "price": "7500",
    ...
    {
      "@type": "LocalBusiness",
      "name": "Patron Accounting LLP - FCRA Annual Return (Form FC-4) Pune",
      "url": "https://www.patronaccounting.com/fcra-fc-4-annual-return/pune",
      "areaServed": {
        "@type": "City",
        "name": "Pune"
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-4 private-registration-heading">
                        FCRA Annual Return (Form FC-4) in Pune</h1>
                    ...
                    <div class="form-header">
                        ...
                        <p class="form-subtitle">Talk to a CA/CS expert today</p>
                                        ...
                                        @include('partials.bigin-form', [
                                            'variant' => 'bare',
                                            'service'  => 'FCRA Annual Return Form FC-4 in Pune',
                                            'city'     => 'Pune',
                                        ])
