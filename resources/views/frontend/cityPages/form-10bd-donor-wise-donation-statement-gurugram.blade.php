...
@section('meta')
    <title>Form 10BD in Gurugram</title>
    <meta name="description" content="Form 10BD is the annual donor-wise statement filed by 80G and Section 35 institutions by 31 May. Learn who files, due dates, penalties, and Fo Serving Gurugram.">
    <link rel="canonical" href="/form-10bd-donor-wise-donation-statement/gurugram">
    ...
    <meta property="og:url" content="/form-10bd-donor-wise-donation-statement/gurugram">
  ...
  "@graph": [
    {
      ...
      "itemListElement": [
        ...
        },
        {
          "@type": "ListItem",
          "position": 3,
          "name": "Form 10BD in Gurugram",
          "item": "https://www.patronaccounting.com/form-10bd-donor-wise-donation-statement/gurugram"
        }
      ]
    },
    {
    ...
    },
    {
      ...
      "url": "https://www.patronaccounting.com/form-10bd-donor-wise-donation-statement/gurugram",
      "offers": {
        "@type": "Offer",
        "priceCurrency": "INR",
        "price": "3999",
    ...
    {
      "@type": "LocalBusiness",
      "name": "Patron Accounting LLP - Form 10BD Gurugram",
      "url": "https://www.patronaccounting.com/form-10bd-donor-wise-donation-statement/gurugram",
      "areaServed": {
        "@type": "City",
        "name": "Gurugram"
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-4 private-registration-heading">
                        Form 10BD Donor-Wise Statement of Donations in Gurugram</h1>
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - Form 10BD Statement of Donations in Gurugram'/>
...
<section class="content-section" style="padding:48px 32px;background:var(--gray-50,#F9FAFB);">
  <div class="content-container"><div class="text-content">
    ...
    <div class="content-text"><p>Patron delivers form 10bd for trusts, societies, Section 8 companies and NGOs in Gurugram and across India. Choose your city:</p></div>
