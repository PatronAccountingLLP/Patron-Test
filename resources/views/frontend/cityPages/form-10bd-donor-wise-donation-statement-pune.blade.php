...
@section('meta')
    <title>Form 10BD in Pune</title>
    <meta name="description" content="Form 10BD is the annual donor-wise statement filed by 80G and Section 35 institutions by 31 May. Learn who files, due dates, penalties, and Form 1 Serving Pune.">
    <link rel="canonical" href="/form-10bd-donor-wise-donation-statement/pune">
    ...
    <meta property="og:url" content="/form-10bd-donor-wise-donation-statement/pune">
  ...
  "@graph": [
    {
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "position": 2,
          "name": "Form 10BD",
          "item": "https://www.patronaccounting.com/form-10bd-donor-wise-donation-statement"
        },
        {
          "@type": "ListItem",
          "position": 3,
          "name": "Form 10BD in Pune",
          "item": "https://www.patronaccounting.com/form-10bd-donor-wise-donation-statement/pune"
        }
      ]
    },
    {
    ...
    },
    {
      ...
      "url": "https://www.patronaccounting.com/form-10bd-donor-wise-donation-statement/pune",
      "offers": {
        "@type": "Offer",
        "priceCurrency": "INR",
        "price": "3999",
    ...
    {
      "@type": "LocalBusiness",
      "name": "Patron Accounting LLP - Form 10BD Pune",
      "url": "https://www.patronaccounting.com/form-10bd-donor-wise-donation-statement/pune",
      "areaServed": {
        "@type": "City",
        "name": "Pune"
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-4 private-registration-heading">
                        Form 10BD Donor-Wise Statement of Donations in Pune</h1>
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - Form 10BD Statement of Donations in Pune'/>
...
<section class="content-section" style="padding:48px 32px;background:var(--gray-50,#F9FAFB);">
  <div class="content-container"><div class="text-content">
    <h2 class="section-title">Form 10BD in Other Cities</h2>
    <div class="content-text"><p>Patron delivers form 10bd for trusts, societies, Section 8 companies and NGOs in Pune and across India. Choose your city:</p></div>
    <div class="pa-city-grid"><span class="pa-city-card" aria-current="page" style="border-color:var(--orange,#E8712C);background:#FFF7F2;position:relative;"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange,#E8712C)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Pune</div><div class="pa-card-sub">Maharashtra</div></div><span style="position:absolute;top:10px;right:12px;font-size:10px;font-weight:700;color:var(--orange,#E8712C);">YOU'RE HERE</span></span><a href="/form-10bd-donor-wise-donation-statement/mumbai" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange,#E8712C)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Mumbai</div><div class="pa-card-sub">Maharashtra</div></div></a><a href="/form-10bd-donor-wise-donation-statement/delhi" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange,#E8712C)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Delhi</div><div class="pa-card-sub">Delhi</div></div></a><a href="/form-10bd-donor-wise-donation-statement/gurugram" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange,#E8712C)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Gurugram</div><div class="pa-card-sub">Haryana</div></div></a></div>
  </div></div>
</section>
