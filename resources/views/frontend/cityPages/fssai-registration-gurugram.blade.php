...
@section('meta')
    ...
    <meta name="description" content="CA-assisted FSSAI registration in Gurugram. Basic, state, central food licence via FOSCOS. Serving Cyber Hub, Sohna Road, Manesar food businesses.">
...
@section('schema')
    @include('partials.city-localbusiness', ['citySlug' => 'gurugram', 'pageUrl' => '/fssai-registration/gurugram'])
