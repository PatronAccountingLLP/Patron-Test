...
@section('meta')
    ...
    <meta name="description" content="CA-assisted FSSAI registration in Pune. Basic, State, Central food licence via FoSCoS. Serving FC Road, Koregaon Park, Hinjewadi food businesses.">
...
@section('schema')
    @include('partials.city-localbusiness', ['citySlug' => 'pune', 'pageUrl' => '/fssai-registration/pune'])
