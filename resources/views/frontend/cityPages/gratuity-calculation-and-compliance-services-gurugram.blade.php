...
@section('meta')
    ...
    <link rel="canonical" href="/gratuity-calculation-and-compliance-services/gurugram">
    ...
    <meta property="og:url" content="/gratuity-calculation-and-compliance-services/gurugram">
...
@section('schema')
    @include('partials.city-localbusiness', ['citySlug' => 'gurugram', 'pageUrl' => '/gratuity-calculation-and-compliance-services/gurugram'])
  ...
  "@graph": [
    {
      ...
      "url": "https://www.patronaccounting.com/gratuity-calculation-and-compliance-services/gurugram",
    ...
    },
    {
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "position": 3,
          "name": "Gratuity Calculation Gurugram - Formula & 5-Year Rule",
          "item": "https://www.patronaccounting.com/gratuity-calculation-and-compliance-services/gurugram"
        }
      ]
    },
    {
