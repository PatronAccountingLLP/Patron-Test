...
@section('meta')
    ...
    <meta property="og:image" content="/images/gratuity-calculation-compliance/pune-og.webp">
    ...
    <meta name="twitter:image" content="/images/gratuity-calculation-compliance/pune-og.webp">
@endsection
  ...
  "@graph": [
    {
      ...
      "url": "/gratuity-calculation-compliance/pune",
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - Gratuity Compliance in Pune'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="gratuity-calculation-compliance/pune" selected>Gratuity Compliance in Pune</option><option value="payroll-services/pune">Payroll Services in Pune</option><option value="esic-calculation-compliance/pune">ESIC Compliance in Pune</option><option value="gst-returns/pune">GST Returns in Pune</option><option value="private-limited-company-registration-in-india/pune">Pvt Ltd Registration in Pune</option><option value="trademark-registration/pune">Trademark Registration in Pune</option><option value="income-tax-return">Income Tax Return Filing</option><option value="other">Other</option>
