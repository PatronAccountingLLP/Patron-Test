  ...
  "@graph": [
    {
      ...
      "url": "/gratuity-calculations-and-compliance/gurugram",
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-4 private-registration-heading">
                        Gratuity Calculations & Compliance in Gurugram: Formula, 50% Rule, and Labour Code Updates
                    </h1>
                    ...
                    <div class="mb-4">
                        <div class="d-flex align-items-start mb-3">
                            ...
                            <p class="mb-0 text-dark benefit-paragraph"><span>Documents:</span> Employee records, salary registers, CTC structures, nomination forms, actuarial reports</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Fees:</span> Monthly provisioning: from Rs 5,000. CTC restructuring: Rs 15,000-25,000. Actuarial: Rs 10,000-20,000</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Eligibility:</span> Establishments with 10+ employees. Employees with 5 years (permanent) or 1 year (fixed-term)</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Timeline:</span> Payment within 30 days of becoming due. 50% wage rule effective Nov 2025. Annual actuarial</p>
                        </div>
                    </div>
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="mailto:sales@patronaccounting.com?subject=Enquiry%20for%20Gratuity%20Compliance%20in%20Gurugram&body=Hello%20Patron%20Accounting%20Team%2C%0A%0AI%20am%20interested%20in%20your%20Gratuity%20Compliance%20services%20in%20Gurugram%20and%20would%20like%20to%20know%20more.%0A%0APlease%20get%20in%20touch%20with%20me%20at%20your%20earliest%20convenience.%0A%0AThank%20you." class="btn-sample text-decoration-none">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:18px;height:18px;"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,12 2,6"/></svg>
                            Email Us
                        </a>
                        <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20help%20with%20Gratuity%20Compliance%20in%20Gurugram.%20Please%20share%20details." target="_blank" class="btn-sample text-decoration-none">
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - Gratuity Compliance Gurugram'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="gratuity-calculations-and-compliance/gurugram" selected>Gratuity Compliance in Gurugram</option>
...
<section class="testimonials-section">
    <div class="section-container">
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            ...
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">50% wage rule restructuring for 500+ employees. Patron analyzed our CTC, restructured basic to comply, and computed revised gratuity liability. Increase was Rs 2.4 crore. Without Patron, we would have been blindsided at year-end.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div>
                    ...
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">CHRO, IT Company, DLF Cyber City</div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Fixed-term workforce: 800 contract workers. Patron computed pro-rata gratuity for each after the 1-year rule. Rs 1.8 crore new liability provisioned. Actuarial valuation coordinated for March 2026 accounts.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div>
                    ...
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">HR Director, Manufacturing, IMT Manesar</div>
                    <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                </div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">3 delayed gratuity payments. Haryana Labour notice received. Patron settled all within 15 days, filed documentation, and set up automated 30-day payment trigger in our payroll system. No further notices.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div>
                    ...
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Director, Services Company, Golf Course Road</div>
                    <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                </div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Startup with 45 employees. Patron set up gratuity provisioning from day one. CTC structured correctly for 50% rule. When our first employee completed 5 years, gratuity was pre-funded. Zero cash flow surprise.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div>
                    ...
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Co-founder, Startup, Sohna Road</div>
                    <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                </div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Patron coordinated our actuarial valuation for Ind AS 19. Dual salary data prepared. Past Service Cost of Rs 85 lakh recognized in March 2026 P&L. Auditors accepted without query. Clean financials.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div>
                    ...
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">CFO, MNC, Golf Course Road</div>
                    <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                </div>
        ...
        <div class="reviews-cta" style="margin-top: 16px; display: flex !important;">
            <div class="reviews-cta-content">
                ...
                <div class="reviews-cta-text">
                    ...
                    <p>Trusted gratuity compliance partner for employers across Gurugram.</p>
                </div>
            </div>
...
<div class="stats-bar">
    <div class="stats-container">
        <div class="stat-item">
            ...
            <div class="stat-content"><span class="stat-value">10,000+</span><span class="stat-label">Businesses Served</span><span class="stat-desc">Gratuity calculations and labour compliance across India.</span></div>
        </div>
        <div class="stat-item">
            <div class="stat-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8M12 17v4"/></svg></div>
            <div class="stat-content"><span class="stat-value">15+</span><span class="stat-label">Years Experience</span><span class="stat-desc">Deep expertise in gratuity computation, 50% wage rule, and labour codes.</span></div>
        </div>
        <div class="stat-item">
            <div class="stat-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><path d="M14 2v6h6M16 13H8M16 17H8"/></svg></div>
            <div class="stat-content"><span class="stat-value">50,000+</span><span class="stat-label">Documents Filed</span><span class="stat-desc">Gratuity computations, CTC restructurings, and compliance documents handled.</span></div>
        </div>
        <div class="stat-item">
            <div class="stat-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="8" r="7"/><path d="M8.21 13.89L7 23l5-3 5 3-1.21-9.12"/></svg></div>
            <div class="stat-content"><span class="stat-value">4.9&#9733;</span><span class="stat-label">Client Rating</span><span class="stat-desc">Trusted by IT companies, manufacturers, BPOs, and corporates.</span></div>
        </div>
...
<section class="content-section" id="overview-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Why Gratuity Compliance Matters in Gurugram</h2>
            <div class="content-text">
                <div class="highlight-box" style="margin-bottom:20px;">
                    <p><strong>&#128204; TL;DR - Gratuity Compliance Services at a Glance</strong></p>
                    <p>Gratuity is a statutory terminal benefit payable after 5 years continuous service (1 year for fixed-term from November 2025). Formula: (Last Drawn Wages x 15 x Years) / 26. Maximum Rs 20 lakh. The Code on Social Security 2020 and Code on Wages 2019 broadened wages - excluded allowances cannot exceed 50% of total remuneration, increasing payouts. Payment within 30 days. Non-payment: imprisonment up to 1 year, fines up to Rs 20,000.</p>
                </div>
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Parameter</th><th>Detail</th></tr></thead>
                    <tbody>
                        <tr><td>Governing Law</td><td>Code on Social Security 2020 | Code on Wages 2019 | Payment of Gratuity Act 1972</td></tr>
                        <tr><td>Registry</td><td>Copyright Office, DPIIT (<a href="https://hrylabour.gov.in" target="_blank" rel="noopener">Haryana Labour (hrylabour.gov.in)</a>). Registrar of Copyrights</td></tr>
                        <tr><td>Form</td><td>Form A (opening) | Form F (nomination) | Form I (claim) | Form IV (application to authority)</td></tr>
                ...
                <p>Gurugram employs over 2 million workers across IT/BPO in DLF Cyber City, manufacturing in IMT Manesar, and corporates on Golf Course Road. Every establishment with 10+ employees must comply with gratuity provisions. For comprehensive information about <a href="#">gratuity compliance across India</a>, visit our national service page.</p>
                <p>The new labour codes (Nov 2025) expanded gratuity eligibility and broadened wages. Gurugram employers must restructure CTC, provision for higher liabilities, and recognize Past Service Cost in March 2026 financials. You will also need <a href="/pf-registration">PF registration</a> and <a href="/esic-registration">ESIC registration</a> for complete labour compliance.</p>
    ...
    <div class="content-container">
        <div class="two-column">
            <div class="column-content">
                <h2 class="section-title">What Is Gratuity and How Is It Calculated</h2>
                <div class="content-text what-is-definition">
                    <p>Gratuity is a statutory lump-sum terminal benefit paid by an employer to an employee as recognition of long-term service, governed by the Code on Social Security 2020. Payable on resignation, retirement, death, disablement, or termination after completing the requisite service period.</p>
                    <p>Formula: (Last Drawn Wages x 15 x Completed Years) / 26. Under the 50% wage rule, excluded allowances exceeding 50% of total remuneration are added back to the wage base, significantly increasing gratuity for most Gurugram employees.</p>
                    <p>Maximum Rs 20 lakh (private). Service exceeding 6 months rounds up. Fixed-term employees eligible after 1 year from Nov 2025. For complete labour compliance, pair with <a href="/pf-registration">PF registration</a> and <a href="/esic-registration">ESIC registration</a>.</p>
                </div>
                <div class="highlight-box" style="margin-top:20px;">
                    <p><strong>Key Terms for Copyright Registration:</strong></p>
                    <ul>
                        <li><strong>Gratuity Formula</strong> - (Wages x 15 x Years) / 26, max Rs 20 lakh</li>
                        <li><strong>50% Wage Rule</strong> - Excluded allowances capped at 50% of total remuneration</li>
                        <li><strong>Fixed-Term Gratuity</strong> - 1 year eligibility from November 2025</li>
                        <li><strong>Ind AS 19</strong> - Actuarial valuation standard for gratuity reporting</li>
                        <li><strong>Controlling Authority</strong> - Haryana Labour Dept for gratuity disputes</li>
                    </ul>
                </div>
            </div>
...
<section class="content-section" id="who-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Who Needs Gratuity Compliance in Gurugram</h2>
            <div class="content-text">
                <ul>
                    <li><strong>IT and BPO companies in DLF Cyber City and Golf Course Road</strong>. 10+ employees = covered. CTC restructuring needed for 50% wage rule. High attrition = frequent gratuity payouts.</li>
                    <li><strong>Manufacturing units in IMT Manesar</strong>. Large permanent and fixed-term workforce. Fixed-term employees now eligible after 1 year. Significant liability increase.</li>
                    ...
                    <li><strong>Corporate offices and MNCs</strong> with Ind AS 19 reporting requirements. Annual actuarial valuation. Past Service Cost recognition for FY 2025-26.</li>
...
<section class="content-section" id="services-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">8 Gratuity Compliance Services Included</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Service</th><th>What We Do</th></tr></thead>
                    <tbody>
                        <tr><td>Gratuity Computation and Provisioning</td><td>Accurate calculation for all eligible employees using Code on Social Security formula. 50% wage rule applied. Monthly provisioning.</td></tr>
                        <tr><td>CTC Restructuring Advisory</td><td>Analysis and restructuring for 50% wage rule compliance. Minimizing unexpected liability while maintaining take-home pay.</td></tr>
                        <tr><td>Actuarial Valuation Support</td><td>Ind AS 19 / AS 15 coordination with actuaries. Dual salary structures. Past Service Cost recognition for March 2026.</td></tr>
                        <tr><td>Fixed-Term Employee Management</td><td>Identification, tracking, and computation for fixed-term employees eligible after 1 year. BPO and manufacturing critical.</td></tr>
                        <tr><td>Trust/Insurance Advisory</td><td>Group Gratuity schemes with LIC. Premium computation. Tax implications S36(1)(v). Fund management.</td></tr>
                        <tr><td>Compliance Documentation and Disputes</td><td>Form A, F, I, IV. Haryana Labour filings. Dispute resolution before Controlling Authority. Payroll integration.</td></tr>
...
<section class="steps-section" id="procedure-section">
    <div class="section-container">
        <header class="section-header" style="text-align:center;margin-bottom:48px;">
            ...
            <h2 class="section-title">How Gratuity Compliance Works: 5-Step Process</h2>
            <p class="section-subtitle" style="text-align:left;max-width:100%;">Our CA-led team handles gratuity computation, CTC restructuring, actuarial valuation coordination, fixed-term compliance, and dispute resolution for Gurugram employers.</p>
        </header>
        <div class="steps-container">
            <div class="step-card">
                <div class="step-content">
                    <span class="step-badge">Step 1</span>
                    <h3 class="step-title">Identify Eligible Employees</h3>
                    <p class="step-description">List all with 5+ years (permanent) or 1+ year (fixed-term). Include death/disablement. Segregate by employment type.</p>
                    <div class="step-highlights">
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Listed</span>
                ...
                <div class="step-visual">
                    <div class="step-illustration">
                        ...
                        <span class="illustration-label">Employees</span>
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">Apply 50% Wage Rule</h3>
                    <p class="step-description">Restructure wage definition. Check if excluded allowances exceed 50%. Calculate revised Last Drawn Wages.</p>
                    <div class="step-highlights">
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>50% Applied</span>
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Restructured</span>
                    </div>
                </div>
                <div class="step-visual">
                    <div class="step-illustration">
                        ...
                        <span class="illustration-label">Wages Set</span>
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">Calculate Gratuity</h3>
                    <p class="step-description">Apply formula: (Wages x 15 x Years) / 26. Cap at Rs 20 lakh. Pro-rata for fixed-term. Round up >6 months.</p>
                    <div class="step-highlights">
                        ...
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Capped</span>
                    </div>
                </div>
                <div class="step-visual">
                    <div class="step-illustration">
                        ...
                        <span class="illustration-label">Formula</span>
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">Provision and Report</h3>
                    <p class="step-description">Monthly provisioning. Annual actuarial (Ind AS 19). Past Service Cost recognition. Financial statement impact.</p>
                    <div class="step-highlights">
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Provisioned</span>
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Ind AS 19</span>
                    </div>
                </div>
                <div class="step-visual">
                    <div class="step-illustration">
                        ...
                        <span class="illustration-label">Booked</span>
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">Pay Within 30 Days</h3>
                    <p class="step-description">Payment on exit/event within 30 days. Interest on delay. Documentation. Form I claim processing.</p>
                    <div class="step-highlights">
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">Maintain Compliance</h3>
                    <p class="step-description">Form F nominations. Trust/insurance review. Annual actuarial update. Payroll configuration. Ongoing monitoring.</p>
                    <div class="step-highlights">
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Maintained</span>
        ...
        <div class="highlight-box" style="margin-top:32px;max-width:1000px;margin-left:auto;margin-right:auto;">
            <p><strong>City Processing Note:</strong> Patron's Gurugram office handles gratuity computation, CTC restructuring, and actuarial coordination for employers across Gurugram.</p>
        </div>
    </div>
</section>
...
<section class="content-section" id="documents-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <ul>
                    <li><strong>Employee Records:</strong> Date of joining, last drawn wages, years of service, designation, employment type.</li>
                    <li><strong>Salary Registers:</strong> Basic pay, DA, allowances breakdown. CTC structure for 50% wage rule analysis.</li>
                    <li><strong>Nomination Forms:</strong> Form F nominations from all employees. Updated beneficiary details.</li>
                    <li><strong>Additional:</strong> Previous actuarial reports | Trust fund details | Insurance policies | Exit records.</li>
                </ul>
            </div>
        </div>
    </div>
...
<section class="content-section" id="challenges-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">5 Common Gratuity Challenges in Gurugram</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Challenge</th><th>Impact</th><th>How Patron Accounting Solves It</th></tr></thead>
                    <tbody>
                        <tr><td>50% Wage Rule CTC Restructuring</td><td>IT companies with basic at 30-40% must restructure. Gratuity base increases 25-50%. Failure = higher-than-expected claims</td><td>Restructure CTC to comply. Maintain take-home. Provision for revised gratuity. Start before first claim under new rules.</td></tr>
                        <tr><td>Fixed-Term Gratuity Liability Surge</td><td>Manesar manufacturers and BPOs with contract staff now face gratuity after 1 year. Significant one-time charge</td><td>Identify all fixed-term employees. Compute pro-rata gratuity. Provision in FY 2025-26 financials. Budget for ongoing liability.</td></tr>
                        <tr><td>Actuarial Impact on March 2026 Accounts</td><td>Nov 2025 changes = plan amendment under Ind AS 19. Past Service Cost in P&L. Impact on reported profits.</td><td>Coordinate dual salary actuarial data (old and new). Recognize Past Service Cost. Prepare for auditor queries.</td></tr>
                        <tr><td>Delayed Gratuity Payments</td><td>Haryana Labour Dept issues notices to Gurugram establishments for delayed payments. Imprisonment up to 1 year</td><td>Pay within 30 days. Document all exits. Maintain Form I records. Interest on delay. Avoid Controlling Authority proceedings.</td></tr>
                        <tr><td>Gratuity Forfeiture Misapplication</td><td>Employer forfeits gratuity for misconduct not covered under Act. Employee appeals to Controlling Authority. Employer loses</td><td>Forfeiture only for damage, loss, or offence involving moral turpitude during service. Document thoroughly. Legal review before forfeiture.</td></tr>
                    </tbody>
                </table>
                </div>
            </div>
...
<section class="content-section" id="fees-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Gratuity Compliance Fees in Gurugram 2026</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table class="table-amount">
                    <thead><tr><th>Fee Component</th><th>Amount</th></tr></thead>
                    <tbody>
                        <tr><td>Monthly Gratuity Provisioning</td><td>From Rs 5,000/month</td></tr>
                        <tr><td>CTC Restructuring (50% Rule)</td><td>Rs 15,000-25,000 one-time</td></tr>
                        <tr><td>Actuarial Valuation Coordination</td><td>Rs 10,000-20,000/year</td></tr>
                        <tr><td>Fixed-Term Employee Tracking</td><td>Rs 3,000-8,000/year</td></tr>
                        <tr><td>Trust/Insurance Advisory</td><td>Rs 10,000-20,000 one-time</td></tr>
                        <tr><td>Dispute Resolution</td><td>Rs 10,000-25,000 per case</td></tr>
                ...
                <p style="margin-top:16px;">No government fee for gratuity compliance. Professional fees cover computation, CTC advisory, actuarial coordination, and documentation. Separate pricing for dispute resolution.</p>
                <p style="margin-top:16px;"><strong>Get a free Copyright Registration consultation - <a href="tel:+919459456700">Call +91 945 945 6700</a> or <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20help%20with%20Gratuity%20Compliance%20in%20Gurugram.%20Please%20share%20fee%20details." target="_blank">WhatsApp us</a>. No-obligation assessment.</strong></p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <table>
                    ...
                    <tbody>
                        <tr><td>Gratuity Payment</td><td>Within 30 days of becoming due (exit/event)</td></tr>
                        <tr><td>Monthly Provisioning</td><td>Monthly computation and booking</td></tr>
                        <tr><td>CTC Restructuring</td><td>2-3 weeks (one-time)</td></tr>
                        <tr><td>Actuarial Valuation</td><td>Before year-end closing (annually)</td></tr>
                        <tr><td>Form F Nominations</td><td>At joining and upon change in family</td></tr>
                        <tr><td>Fixed-Term Tracking</td><td>Continuous from November 2025</td></tr>
                        <tr><td>Non-Payment Penalty</td><td>Interest + imprisonment up to 1 year + fine Rs 20,000</td></tr>
                    </tbody>
                </table>
                </div>
                <div class="highlight-box" style="margin-top:16px;">
                    <p><strong>Note:</strong> Payment within 30 days of exit/event. Monthly provisioning recommended. Actuarial valuation before year-end closing. CTC restructuring: 2-3 weeks.</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="why-choose-section" id="benefits-section">
    <div class="section-container">
        <div style="text-align:center;margin-bottom:48px;">
            ...
            <h2 class="section-title">Why Choose Patron for Gratuity in Gurugram</h2>
        </div>
        <div class="features-grid">
            <article class="feature-card">
                ...
                <h3 class="feature-title">Accurate Computation</h3>
                <p class="feature-text">Formula applied correctly. 50% wage rule. Pro-rata for fixed-term. Max Rs 20 lakh cap. Round-up rules.</p>
            </article>
            <article class="feature-card">
                ...
                <h3 class="feature-title">CTC Restructuring</h3>
                <p class="feature-text">50% wage rule compliance. Minimize liability increase. Maintain take-home. HR and payroll aligned.</p>
            </article>
            <article class="feature-card">
                ...
                <h3 class="feature-title">Actuarial Support</h3>
                <p class="feature-text">Ind AS 19 coordination. Dual salary data. Past Service Cost. Annual valuation. Audit-ready.</p>
            </article>
            <article class="feature-card">
                <div class="feature-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg></div>
                <h3 class="feature-title">Fixed-Term Mgmt</h3>
                <p class="feature-text">1-year eligibility tracking. Pro-rata computation. BPO and manufacturing workforce coverage.</p>
            </article>
            <article class="feature-card">
                ...
                <p class="feature-text">Controlling Authority representation. Delayed payment. Forfeiture cases. Haryana Labour proceedings.</p>
            </article>
            <article class="feature-card">
                ...
                <p class="feature-text">Tally, Zoho, GreytHR, Keka configured. Auto-compute monthly provision. Updated wage definition. Automated.</p>
            </article>
        </div>
    </div>
</section>
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <table class="table-comparison">
                    <thead><tr><th>Employee Type</th><th>Eligibility / Formula / Gurugram Context</th></tr></thead>
                    <tbody>
                        <tr><td>Permanent (covered)</td><td>5 years. (Wages x 15 x Years) / 26. IT employees, manufacturing, corporate</td></tr>
                        <tr><td>Fixed-Term (NEW Nov 2025)</td><td>1 year. Pro-rata formula. BPO contract staff, Manesar project workers</td></tr>
                        <tr><td>Death/Disablement</td><td>No minimum service. Formula on date of event. All Gurugram employers</td></tr>
                        <tr><td>Seasonal Workers</td><td>Each completed season. 7 days wages per season. Limited in Gurugram</td></tr>
                    </tbody>
                </table>
                </div>
                <p style="margin-top:12px;">External Authority: <a href="https://hrylabour.gov.in" target="_blank" rel="noopener">Haryana Labour Department (hrylabour.gov.in)</a></p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                <ul>
                    ...
                    <li><a href="/pf-registration">PF Registration</a> - Provident fund registration and compliance for employers</li>
...
<section class="content-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>Gratuity is governed by the <strong>Code on Social Security 2020</strong> (consolidating Payment of Gratuity Act 1972) and the <strong>Code on Wages 2019</strong> (50% wage definition). The Haryana Labour Department enforces gratuity compliance in Gurugram district.</p>
                <p>Formula: (Last Drawn Wages x 15 x Years) / 26. Maximum Rs 20 lakh (private). <strong>Non-payment</strong>: imprisonment up to 1 year, fine up to Rs 20,000. <strong>Fixed-term</strong>: 1 year eligibility from November 2025. <strong>Ind AS 19</strong>: actuarial valuation mandatory.</p>
                <p>India's membership in the Berne Convention (1886, India joined 1928), the Universal Copyright Convention, and TRIPS (WTO) ensures international recognition. The WIPO Copyright Treaty (WCT) and WIPO Performances and Phonograms Treaty (WPPT) provide additional protections for digital rights. Copyright registration with the Copyright Office at <a href="https://hrylabour.gov.in" target="_blank" rel="noopener">Haryana Labour (hrylabour.gov.in)</a> is administered by the Department for Promotion of Industry and Internal Trade (DPIIT). IP enforcement in Gurugram falls under the jurisdiction of the Delhi High Court.</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    <h2 class="faq-expanded__title">FAQs - Gratuity Compliance in Gurugram</h2>
                    <p class="faq-expanded__lead">Answers to common questions about gratuity calculation, eligibility, 50% wage rule, fixed-term employees, and compliance for Gurugram employers.</p>
                    @include('partials.faq-enquiry-form', ['enquiryLocation' => 'Gurugram', 'enquiryService' => 'Gratuity Compliance in Gurugram'])
                </aside>
                <div class="faq-expanded__list">
                    <div class="faq-expanded__item" id="faq-1">
                        <h3 class="faq-expanded__q">What is the gratuity calculation formula?</h3>
                        <div class="faq-expanded__a"><p>Gratuity equals (Last Drawn Wages multiplied by 15 multiplied by Completed Years of Service) divided by 26. Maximum Rs 20 lakh for private sector employees. Last Drawn Wages under the new labour codes includes basic pay plus DA plus retaining allowance. The 50% wage rule means excluded allowances cannot exceed 50% of total remuneration.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-2">
                        <h3 class="faq-expanded__q">How much does gratuity compliance cost?</h3>
                        <div class="faq-expanded__a"><p>Monthly provisioning from Rs 5,000 per month. CTC restructuring Rs 15,000-25,000 one-time. Actuarial valuation coordination Rs 10,000-20,000 per year. Fixed-term tracking Rs 3,000-8,000 per year. Trust/insurance advisory Rs 10,000-20,000. Dispute resolution Rs 10,000-25,000 per case. Call +91 945 945 6700.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-3">
                        <h3 class="faq-expanded__q">When is gratuity payable to employees?</h3>
                        <div class="faq-expanded__a"><p>Total timeline: 2-6 months. Filing and Diary Number: immediate. Mandatory 30-day objection waiting period: 1 month. Pay Within 30 Days: 1-3 months. Certificate issuance: after examination approval. If a third-party objection is filed, the timeline extends by 2-4 months for hearing and resolution.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-4">
                        <h3 class="faq-expanded__q">What is the 50% wage rule for gratuity?</h3>
                        <div class="faq-expanded__a"><p>Under the Code on Wages 2019, excluded allowances (HRA, special allowance, flexible benefits) cannot exceed 50% of total remuneration. If they do, the excess is added back to the basic wages for all statutory computations including gratuity. For Gurugram IT companies with basic at 30-40% of CTC, this can increase the gratuity base by 25-50%.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-5">
                        <h3 class="faq-expanded__q">Does gratuity apply to IT companies?</h3>
                        <div class="faq-expanded__a"><p>Yes. Every establishment employing 10 or more persons on any day in the preceding 12 months is covered under the gratuity provisions. IT companies in DLF Cyber City, BPOs on Golf Course Road, startups on Sohna Road, and manufacturing units in IMT Manesar all must comply. Once covered, the establishment remains covered even if headcount falls below 10.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-6">
                        <h3 class="faq-expanded__q">Do fixed-term employees get gratuity?</h3>
                        <div class="faq-expanded__a"><p>Yes, from November 2025 under the new labour codes. Fixed-term employees are eligible for pro-rata gratuity after completing 1 year of continuous service. This is a major change from the earlier 5-year requirement. Manesar manufacturing firms and Gurugram BPO centres with large contract workforces face significant new gratuity liabilities that must be provisioned.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-7">
                        <h3 class="faq-expanded__q">What happens if gratuity is not paid on time?</h3>
                        <div class="faq-expanded__a"><p>Non-payment of gratuity within 30 days of it becoming due attracts simple interest from the employer. The Controlling Authority (Haryana Labour Department) can direct payment with interest. Continued non-payment can result in imprisonment for up to 1 year and a fine of up to Rs 20,000 under the Act. The Haryana Labour Department regularly issues notices to Gurugram establishments for delayed payments.</p></div>
                    </div>
                </div>
            </div>
            ...
            <div class="highlight-box" style="margin-top:32px;">
                ...
                <p><strong>Gratuity kab milti hai?</strong> 5 saal ki continuous service ke baad. Fixed-term ko Nov 2025 se 1 saal baad. Death/disablement mein koi minimum nahi.</p>
                <p><strong>Formula kya hai?</strong> (Last Drawn Salary x 15 x Completed Years) / 26. Maximum Rs 20 lakh. 50% wage rule se base badhta hai.</p>
                <p><strong>IT company mein bhi milti hai?</strong> Haan. 10+ employees hai toh Act lagta hai. DLF Cyber City, Golf Course Road - sabko comply karna padta hai.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section" style="background: var(--orange-lighter) !important; border-left: 4px solid var(--orange);">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Why Gratuity Compliance Matters in Gurugram</h2>
            <div class="content-text">
                <p>New labour codes effective November 2025 expanded gratuity eligibility (1 year fixed-term) and broadened wages (50% rule). Gurugram employers must restructure CTC, provision for higher liabilities, and recognize Past Service Cost in March 2026 financials. Non-payment within 30 days attracts interest and imprisonment up to 2 years. Haryana Labour Department actively issuing notices. Act now.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section" style="background: var(--blue) !important;">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title" style="color:#FFFFFF !important;">Start Gratuity Compliance in Gurugram Today</h2>
            <div class="content-text" style="text-align:left;">
                <p style="color:rgba(255,255,255,0.85);">Gratuity compliance in Gurugram requires accurate formula application, 50% wage rule CTC restructuring, fixed-term employee tracking, actuarial valuation for Ind AS 19, and timely payment within 30 days - protecting employers from penalties, disputes, and accounting surprises.</p>
                <p style="color:rgba(255,255,255,0.85);">Patron Accounting's Gurugram office on Golf Course Extension Road provides CA-assisted gratuity compliance including computation, CTC restructuring, actuarial coordination, fixed-term management, trust/insurance advisory, and dispute resolution for IT companies, manufacturers, and corporates across Gurugram.</p>
            ...
            <div style="display:flex;gap:14px;flex-wrap:wrap;margin-top:24px;">
                ...
                <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20help%20with%20Gratuity%20Compliance%20in%20Gurugram.%20Please%20share%20details." target="_blank" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:#25D366;color:#fff;border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#128172; WhatsApp Us</a>
                <a href="mailto:sales@patronaccounting.com?subject=Enquiry%20for%20Gratuity%20Compliance%20in%20Gurugram&body=Hello%20Patron%20Accounting%20Team%2C%0A%0AI%20am%20interested%20in%20your%20Gratuity%20Compliance%20services%20in%20Gurugram%20and%20would%20like%20to%20know%20more.%0A%0APlease%20get%20in%20touch%20with%20me%20at%20your%20earliest%20convenience.%0A%0AThank%20you." style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:transparent;color:#fff;border:2px solid rgba(255,255,255,0.3);border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#9993;&#65039; Email Us</a>
            </div>
...
<section class="content-section" style="padding:48px 32px;background:var(--gray-50);">
    <div class="content-container">
        <div class="text-content">
            ...
            <p style="text-align:center;color:var(--text-muted);font-size:15px;margin-bottom:40px;">Gratuity compliance services available across India with local office support.</p>
            ...
            <div class="pa-city-block" style="margin-bottom:40px;">
                <div class="pa-city-grid">
                    ...
                    <a href="/gratuity-calculations-compliance/mumbai" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Mumbai</div><div class="pa-card-sub">Maharashtra</div></div></a>
            ...
            <div class="pa-city-block">
                ...
                <div class="pa-block-sub">End-to-end support for Gratuity Compliance in Gurugram</div>
...
<section class="content-section" style="padding:32px;">
    <div class="content-container">
        <div class="text-content" style="font-size:13px;color:var(--text-muted);">
            ...
            <p>This page is reviewed quarterly for accuracy. Code on Social Security 2020, Code on Wages 2019, gratuity formula, 50% wage rule, fixed-term provisions, and actuarial requirements are verified against current notifications. Gurugram employment landscape is validated with each review.</p>
        </div>
    </div>
</section>
