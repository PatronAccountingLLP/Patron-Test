...
@section('meta')
    ...
    <meta property="og:image" content="/images/gst-annual-returns/pune-og.webp">
    ...
    <meta name="twitter:image" content="/images/gst-annual-returns/pune-og.webp">
@endsection
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'gst-annual-returns/pune',
                    'options'  => [
                        'gst-annual-returns/pune' => 'GST Annual Returns in Pune',
