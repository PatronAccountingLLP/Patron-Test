            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - GST Audit Service in Gurugram'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="gst-audit/gurugram" selected>GST Audit in Gurugram</option><option value="gst-return/gurugram">GST Return Filing in Gurugram</option><option value="gst-registration/gurugram">GST Registration in Gurugram</option><option value="accounting-services/gurugram">Accounting Services in Gurugram</option><option value="annual-compliance/gurugram">Annual Compliance in Gurugram</option><option value="income-tax-return/gurugram">Income Tax Return in Gurugram</option><option value="legal-drafting/gurugram">Legal Drafting in Gurugram</option><option value="other">Other</option>
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    ...
                    @include('partials.faq-enquiry-form', ['enquiryLocation' => 'Gurugram', 'enquiryService' => 'GST Audit in Gurugram'])
                </aside>
