            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-4 private-registration-heading">
                        GST Notice in Gurugram: Professional Response to Scrutiny, Show Cause, and Demand
                    </h1>
                    ...
                    <div class="mb-4">
                        <div class="d-flex align-items-start mb-3">
                            ...
                            <p class="mb-0 text-dark benefit-paragraph"><span>Documents:</span> GST notice copy, GSTR-1/3B/2B data, invoices, payment proofs, reconciliation sheets</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Fees:</span> ASMT-10 reply: Rs 3,999-9,999. DRC-01 reply: Rs 9,999-24,999. Prevention: Rs 4,999/month</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Eligibility:</span> Any GST-registered business that has received or wants to prevent a GST notice</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Timeline:</span> ASMT-10 reply: 30 days. DRC-01 reply: 30 days. Appeal: 3 months from order</p>
                        </div>
                    </div>
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="mailto:sales@patronaccounting.com?subject=Enquiry%20for%20GST%20Notice%20in%20Gurugram&body=Hello%20Patron%20Accounting%20Team%2C%0A%0AI%20am%20interested%20in%20your%20GST%20Notice%20services%20in%20Gurugram%20and%20would%20like%20to%20know%20more.%0A%0APlease%20get%20in%20touch%20with%20me%20at%20your%20earliest%20convenience.%0A%0AThank%20you." class="btn-sample text-decoration-none">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:18px;height:18px;"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,12 2,6"/></svg>
                            Email Us
                        </a>
                        <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20help%20with%20GST%20Notice%20in%20Gurugram.%20Please%20share%20details." target="_blank" class="btn-sample text-decoration-none">
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - GST Notice Gurugram'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="gst-notice/gurugram" selected>GST Notice in Gurugram</option>
...
<section class="testimonials-section">
    <div class="section-container">
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            ...
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">ASMT-10 for Rs 12 lakh ITC mismatch. Patron reconciled: Rs 8 lakh timing (vendor late filing), Rs 3 lakh genuine, Rs 1 lakh error. Paid Rs 4 lakh via DRC-03. Rest documented. No escalation. Saved Rs 8 lakh.</div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">DRC-01 for Rs 5 lakh output tax difference. Patron proved: Rs 4 lakh was credit notes in different month GSTR-3B. Rs 1 lakh paid with interest via DRC-03. Zero penalty under S73(8). Rs 12,000 fee saved Rs 5 lakh.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">We ignored an ASMT-10. Got DRC-01. Then DRC-07 demand. Patron filed APL-01 appeal, got pre-deposit sorted, and the demand was reduced by 70% on appeal. But it cost 10x what responding to ASMT-10 would have.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div>
                    ...
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Founder, E-commerce Brand, Sohna Road</div>
                    <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                </div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Patron runs monthly GSTR-1/3B/2B reconciliation for us. Zero notices in 3 years. Vendors followed up for timely GSTR-1. ITC reviewed. Prevention costs Rs 5,000/month. One notice response costs Rs 10,000+.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div>
                    ...
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Operations Head, Corporate, Golf Course Road</div>
                    <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                </div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">REG-17 cancellation notice. 7 days deadline. Patron filed REG-18 same day with all pending returns. Registration saved. If we had missed the 7-day window, GSTIN cancelled, would need fresh registration.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div>
                    ...
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Founder, Restaurant, Cyber Hub</div>
                    <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                </div>
        ...
        <div class="reviews-cta" style="margin-top: 16px; display: flex !important;">
            <div class="reviews-cta-content">
                ...
                <div class="reviews-cta-text">
                    ...
                    <p>Trusted GST notice response partner for businesses across Gurugram.</p>
                </div>
            </div>
...
<div class="stats-bar">
    <div class="stats-container">
        <div class="stat-item">
            ...
            <div class="stat-content"><span class="stat-value">10,000+</span><span class="stat-label">Businesses Served</span><span class="stat-desc">GST notice response and prevention across India.</span></div>
        </div>
        <div class="stat-item">
            <div class="stat-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8M12 17v4"/></svg></div>
            <div class="stat-content"><span class="stat-value">15+</span><span class="stat-label">Years Experience</span><span class="stat-desc">Deep expertise in GST notice reply, reconciliation, and dispute resolution.</span></div>
        </div>
        <div class="stat-item">
            <div class="stat-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><path d="M14 2v6h6M16 13H8M16 17H8"/></svg></div>
            <div class="stat-content"><span class="stat-value">50,000+</span><span class="stat-label">Documents Filed</span><span class="stat-desc">GST notice replies, reconciliation statements, and compliance documents handled.</span></div>
        </div>
        <div class="stat-item">
            <div class="stat-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="8" r="7"/><path d="M8.21 13.89L7 23l5-3 5 3-1.21-9.12"/></svg></div>
            <div class="stat-content"><span class="stat-value">4.9&#9733;</span><span class="stat-label">Client Rating</span><span class="stat-desc">Trusted by IT companies, manufacturers, e-commerce sellers, and corporates.</span></div>
        </div>
...
<section class="content-section" id="overview-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Why GST Notice Response Matters for Gurugram Businesses</h2>
            <div class="content-text">
                <div class="highlight-box" style="margin-bottom:20px;">
                    <p><strong>&#128204; TL;DR - GST Notice Response Services at a Glance</strong></p>
                    <p>GST notices are formal communications identifying discrepancies or initiating demand proceedings. ASMT-10 (scrutiny, reply ASMT-11, 30 days), DRC-01 (show cause S73/74, reply DRC-06, 30 days), DRC-01A (pre-SCN intimation), REG-17 (cancellation). Silence = acceptance. Non-response = ex parte DRC-07 order. Under S73(8): pay within 30 days with interest = NO penalty. S74: 100% penalty. S74A unified from FY 2024-25. Appeal APL-01 within 3 months. Prevention through monthly reconciliation is cheapest.</p>
                </div>
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Parameter</th><th>Detail</th></tr></thead>
                    <tbody>
                        <tr><td>Governing Law</td><td>CGST Act 2017 - S61 (scrutiny), S73 (non-fraud), S74 (fraud), S74A (unified FY 2024-25+)</td></tr>
                        ...
                        <tr><td>Form</td><td>ASMT-10/11 (scrutiny) | DRC-01/06 (show cause) | DRC-03 (payment) | APL-01 (appeal)</td></tr>
                ...
                <p>Gurugram businesses face increasing GST notices. IT companies get ASMT-10 for ITC mismatches. Manufacturers get DRC-01 for output tax discrepancies. D2C brands get TCS reconciliation notices. Corporates get ITC ineligibility notices. The response quality determines the outcome. For comprehensive information about <a href="/gst-notice">GST notice services across India</a>, visit our national service page.</p>
                <p>The most expensive response is no response. Non-reply to ASMT-10 escalates to DRC-01. Non-reply to DRC-01 results in ex parte DRC-07 demand order. A timely reply at ASMT-10 resolves matters in 30 days at minimal cost. You will also need <a href="#">monthly GST return filing</a> and <a href="/gst-annual-returns">GST annual returns</a> for complete compliance.</p>
        ...
        <div class="two-column">
            <div class="column-content">
                ...
                <div class="content-text what-is-definition">
                    <p>A GST notice is a formal communication from CGST or SGST authority identifying discrepancies, demanding explanations, or initiating demand and recovery proceedings under specific sections of the CGST Act 2017.</p>
                    <p>Common types: ASMT-10 (scrutiny), DRC-01A (pre-SCN), DRC-01 (show cause), DRC-07 (demand order), GSTR-3A (non-filing), REG-17 (cancellation). Each has specific reply forms and deadlines.</p>
                    <p>Under S73(8), paying demand plus interest within 30 days of SCN = zero penalty. This is the most cost-effective resolution. For complete GST compliance, pair with <a href="#">monthly return filing</a> and <a href="/gst-annual-returns">annual returns</a>.</p>
                </div>
                <div class="highlight-box" style="margin-top:20px;">
                    <p><strong>Key Terms for Copyright Registration:</strong></p>
                    <ul>
                        <li><strong>ASMT-10</strong> - Scrutiny notice for return discrepancies (30-day reply)</li>
                        <li><strong>DRC-01</strong> - Show cause notice for tax demand under S73/74</li>
                        <li><strong>DRC-03</strong> - Voluntary payment to reduce/eliminate penalty</li>
                        <li><strong>DRC-07</strong> - Demand order creating formal tax liability</li>
                        <li><strong>APL-01</strong> - Appeal to Appellate Authority within 3 months</li>
                    </ul>
                </div>
            </div>
...
<section class="content-section" id="who-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Who Receives GST Notices in Gurugram</h2>
            <div class="content-text">
                <ul>
                    <li><strong>IT and SaaS companies in DLF Cyber City</strong> receiving ASMT-10 for ITC mismatches. Vendor late GSTR-1 filing creates GSTR-2B mismatch triggering automated scrutiny.</li>
                    <li><strong>Manufacturing companies in Udyog Vihar</strong> receiving DRC-01 for output tax discrepancies. Credit notes and amendments not properly reconciled between GSTR-1 and GSTR-3B.</li>
                    ...
                    <li><strong>Restaurants and hospitality</strong> in Cyber Hub receiving ITC notices for ineligible items (food, beverages, personal consumption under S17(5)).</li>
...
<section class="content-section" id="services-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">7 GST Notice Response Services Included</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Service</th><th>What We Do</th></tr></thead>
                    <tbody>
                        <tr><td>Notice Identification and Analysis</td><td>Identifying type (ASMT-10, DRC-01, DRC-01A, REG-17). Analyzing discrepancy. Determining section. Assessing deadline and penalty.</td></tr>
                        <tr><td>ASMT-11 Reply (Scrutiny)</td><td>Reconciling GSTR-1 vs 3B output tax and GSTR-2B vs 3B ITC. Explaining each discrepancy with evidence. Filing within 30 days.</td></tr>
                        <tr><td>DRC-06 Reply (Show Cause)</td><td>Addressing every allegation. Legal citations and case law. Factual rebuttal with reconciliation. Filing on portal.</td></tr>
                        <tr><td>DRC-03 Voluntary Payment</td><td>Computing tax and interest. Strategic payment under S73(8) for zero penalty. Partial payment while contesting rest.</td></tr>
                        <tr><td>Personal Hearing Representation</td><td>Appearing before GST officer. Oral arguments. Responding to queries. Seeking adjournment if needed.</td></tr>
                        <tr><td>Appeal (APL-01) and Prevention</td><td>Filing appeal within 3 months of DRC-07. Pre-deposit. Monthly reconciliation to prevent future notices.</td></tr>
...
<section class="steps-section" id="procedure-section">
    <div class="section-container">
        <header class="section-header" style="text-align:center;margin-bottom:48px;">
            ...
            <h2 class="section-title">How GST Notice Response Works: 6-Step Process</h2>
            <p class="section-subtitle" style="text-align:left;max-width:100%;">Our CA-led team handles GST notice identification, reply drafting, DRC-03 payment, hearing representation, and monthly reconciliation prevention for Gurugram businesses.</p>
        </header>
        <div class="steps-container">
            <div class="step-card">
                <div class="step-content">
                    <span class="step-badge">Step 1</span>
                    <h3 class="step-title">Identify Notice Type</h3>
                    <p class="step-description">Determine form (ASMT-10, DRC-01, DRC-01A, REG-17). Check section. Note deadline. Assess penalty exposure.</p>
                    <div class="step-highlights">
                        ...
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Section</span>
                    </div>
                </div>
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">Reconcile Returns</h3>
                    <p class="step-description">Match GSTR-1 vs 3B output tax. Match GSTR-2B vs 3B ITC. Identify source of each discrepancy.</p>
                    <div class="step-highlights">
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">Draft and File Reply</h3>
                    <p class="step-description">Address every allegation. Attach reconciliation and evidence. File ASMT-11 or DRC-06 on portal. Pay DRC-03 if applicable.</p>
                    <div class="step-highlights">
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Reply Filed</span>
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">Attend Personal Hearing</h3>
                    <p class="step-description">Present before GST officer. Oral arguments. Evidence. Respond to queries. Seek adjournment if needed.</p>
                    <div class="step-highlights">
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Presented</span>
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">Receive Order</h3>
                    <p class="step-description">ASMT-12 closure (resolved) or DRC-07 demand order. If demand: evaluate merits for appeal.</p>
                    <div class="step-highlights">
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">Appeal or Comply</h3>
                    <p class="step-description">If order unfavourable: APL-01 within 3 months. Pre-deposit 10%. If favourable: matter closed. Set up prevention.</p>
                    <div class="step-highlights">
        ...
        <div class="highlight-box" style="margin-top:32px;max-width:1000px;margin-left:auto;margin-right:auto;">
            <p><strong>City Processing Note:</strong> Patron's Gurugram office handles GST notice responses, reconciliation, and monthly prevention for businesses across Gurugram.</p>
        </div>
    </div>
</section>
...
<section class="content-section" id="documents-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Documents Required for GST Notice Response in Gurugram</h2>
            <div class="content-text">
                <ul>
                    <li><strong>GST Notice Copy:</strong> Complete notice with all pages. Note form number, section, and deadline.</li>
                    <li><strong>GST Return Data:</strong> GSTR-1, GSTR-3B, GSTR-2B for relevant periods. Invoice-level details.</li>
                    <li><strong>Supporting Evidence:</strong> Invoices, payment proofs, delivery challans, e-way bills, reconciliation sheets.</li>
                    <li><strong>Additional:</strong> Books of accounts | Previous correspondence with GST dept | DRC-03 receipts | Legal opinions if any.</li>
                </ul>
            </div>
        </div>
    </div>
...
<section class="content-section" id="challenges-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">5 Common GST Notice Scenarios in Gurugram</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Challenge</th><th>Impact</th><th>How Patron Accounting Solves It</th></tr></thead>
                    <tbody>
                        <tr><td>ITC Mismatch - Vendor Late Filing</td><td>IT company claims Rs 5 lakh ITC but GSTR-2B shows Rs 4 lakh (vendor filed late). ASMT-10 issued</td><td>Show updated GSTR-2B, invoice copies, payment proof. ITC is genuine - timing difference, not fraud. Resolved at ASMT-12.</td></tr>
                        <tr><td>GSTR-1 vs GSTR-3B Output Mismatch</td><td>GSTR-1 Rs 10 lakh output tax but GSTR-3B Rs 8 lakh. Credit notes in different month. Rs 50K genuine error</td><td>Reconciliation showing credit note timing. Pay Rs 50K + interest via DRC-03. Explain rest. Matter resolved.</td></tr>
                        <tr><td>Non-Response Leading to Ex Parte Order</td><td>D2C brand ignores ASMT-10. Escalates to DRC-01. No response. DRC-07: Rs 3.84 lakh demand. Now needs appeal.</td><td>Never ignore notices. Rs 5,000-10,000 reply at ASMT-10 stage prevents Rs 3-4 lakh demand orders. Respond within deadline.</td></tr>
                        <tr><td>S73 vs S74 Classification</td><td>Notice cites S74 (fraud) for what is actually an inadvertent error. S74 means 100% penalty vs S73 zero penalty</td><td>Challenge classification. Demonstrate genuine error not fraud. S73 = zero penalty if paid in 30 days. Documentation is key.</td></tr>
                        <tr><td>ITC on Ineligible Items</td><td>Restaurant claims ITC on food and beverages for employees. S17(5) makes this ineligible. Notice for reversal</td><td>Review ITC eligibility before claiming. Reverse ineligible ITC voluntarily. S17(5) list: food, club, personal items, motor vehicles.</td></tr>
                    </tbody>
                </table>
                </div>
            </div>
...
<section class="content-section" id="fees-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">GST Notice Response Fees in Gurugram 2026</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table class="table-amount">
                    <thead><tr><th>Fee Component</th><th>Amount</th></tr></thead>
                    <tbody>
                        <tr><td>ASMT-10 Scrutiny Reply</td><td>Rs 3,999-9,999</td></tr>
                        <tr><td>DRC-01 Show Cause Reply</td><td>Rs 9,999-24,999</td></tr>
                        <tr><td>DRC-03 Voluntary Payment</td><td>Rs 2,999-5,999</td></tr>
                        <tr><td>Personal Hearing</td><td>Rs 4,999-14,999</td></tr>
                        <tr><td>APL-01 Appeal</td><td>Rs 9,999-24,999</td></tr>
                        <tr><td>Monthly Prevention Bundle</td><td>Rs 4,999-9,999/month</td></tr>
                ...
                <p style="margin-top:16px;">Professional fees cover notice analysis, reconciliation, reply drafting, and hearing. DRC-03 voluntary payment (tax + interest) is separate. Prevention bundle: monthly reconciliation.</p>
                <p style="margin-top:16px;"><strong>Get a free Copyright Registration consultation - <a href="tel:+919459456700">Call +91 945 945 6700</a> or <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20help%20with%20GST%20Notice%20in%20Gurugram.%20Please%20share%20fee%20details." target="_blank">WhatsApp us</a>. No-obligation assessment.</strong></p>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section" id="timeline-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">GST Notice Response Timeline in Gurugram</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Stage</th><th>Estimated Timeline</th></tr></thead>
                    <tbody>
                        <tr><td>Notice Receipt and Analysis</td><td>1-2 days</td></tr>
                        <tr><td>Reconciliation</td><td>3-7 days</td></tr>
                        <tr><td>Reply Drafting</td><td>3-5 days</td></tr>
                        <tr><td>ASMT-11 Deadline</td><td>30 days (+15 extension)</td></tr>
                        <tr><td>DRC-06 Deadline</td><td>30 days from DRC-01</td></tr>
                        <tr><td>REG-18 Deadline</td><td>7 working days from REG-17</td></tr>
                        <tr><td>APL-01 Appeal</td><td>3 months from DRC-07 order</td></tr>
                    </tbody>
                </table>
                </div>
                <div class="highlight-box" style="margin-top:16px;">
                    <p><strong>Note:</strong> ASMT-10 reply: 30 days (+15 extension). DRC-01 reply: 30 days. REG-17: 7 working days. APL-01: 3 months. Respond within deadline - non-response = adverse order.</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="why-choose-section" id="benefits-section">
    <div class="section-container">
        <div style="text-align:center;margin-bottom:48px;">
            ...
            <h2 class="section-title">Why Choose Patron for GST Notice in Gurugram</h2>
        </div>
        <div class="features-grid">
            <article class="feature-card">
                ...
                <h3 class="feature-title">Notice Analysis</h3>
                <p class="feature-text">Identify notice type, section, deadline. Assess penalty exposure. Determine optimal response strategy.</p>
            </article>
            <article class="feature-card">
                ...
                <h3 class="feature-title">Reconciliation Defence</h3>
                <p class="feature-text">4-way reconciliation proving each discrepancy. Invoice-level matching. Evidence-based replies that resolve at first response.</p>
            </article>
            <article class="feature-card">
                ...
                <h3 class="feature-title">DRC-03 Strategy</h3>
                <p class="feature-text">Strategic voluntary payment under S73(8) for zero penalty. Partial payment while contesting rest. Minimizing total exposure.</p>
            </article>
            <article class="feature-card">
                <div class="feature-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg></div>
                <h3 class="feature-title">Hearing Representation</h3>
                <p class="feature-text">Personal hearing before GST officer. Oral arguments supplementing written reply. Experienced GST dispute representation.</p>
            </article>
            <article class="feature-card">
                ...
                <h3 class="feature-title">Appeal Expertise</h3>
                <p class="feature-text">APL-01 filing within 3 months. Pre-deposit computation. Legal grounds with CBIC circulars and case law.</p>
            </article>
            <article class="feature-card">
                ...
                <h3 class="feature-title">Monthly Prevention</h3>
                <p class="feature-text">Proactive GSTR-1/3B/2B reconciliation. Vendor GSTR-1 follow-up. ITC eligibility review. Prevention is cheapest.</p>
            </article>
        </div>
    </div>
</section>
...
<section class="content-section" id="comparison-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">GST Notice Types Quick Reference</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table class="table-comparison">
                    <thead><tr><th>Notice</th><th>Details</th></tr></thead>
                    <tbody>
                        <tr><td>ASMT-10 (Scrutiny S61)</td><td>Reply ASMT-11. 30 days. If accepted: ASMT-12 closure. If not: escalation</td></tr>
                        <tr><td>DRC-01A (Pre-SCN)</td><td>Intimation before formal SCN. Opportunity to pay. Reduces penalty</td></tr>
                        <tr><td>DRC-01 (SCN S73/74)</td><td>Reply DRC-06. 30 days. S73: no penalty if paid in 30 days with interest</td></tr>
                        <tr><td>DRC-07 (Demand)</td><td>Final order. Electronic Liability Ledger. Appeal: APL-01, 3 months</td></tr>
                        <tr><td>GSTR-3A (Non-Filing)</td><td>File immediately. Non-response: S62 best judgment + cancellation risk</td></tr>
                        <tr><td>REG-17 (Cancellation)</td><td>Reply REG-18. 7 working days. Non-response: registration cancelled</td></tr>
                    </tbody>
                </table>
                </div>
...
<section class="content-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>GST notices are issued under the <strong>CGST Act 2017</strong>. <strong>S61</strong> (scrutiny, ASMT-10), <strong>S73</strong> (non-fraud demand), <strong>S74</strong> (fraud/suppression demand), <strong>S74A</strong> (unified from FY 2024-25). CGST Commissionerate Gurugram and Haryana SGST have concurrent jurisdiction.</p>
                <p><strong>S73(8)</strong>: pay demand + interest within 30 days of SCN = NO penalty. <strong>S74</strong>: fraud/suppression = 100% penalty. <strong>S62</strong>: best judgment assessment for non-filers. Appeal under <strong>S107</strong> to Appellate Authority (APL-01) within 3 months, pre-deposit 10%.</p>
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    <h2 class="faq-expanded__title">FAQs - GST Notice in Gurugram</h2>
                    <p class="faq-expanded__lead">Answers to common questions about GST notices including notice types, response strategy, penalty avoidance, and prevention for Gurugram businesses.</p>
                    @include('partials.faq-enquiry-form', ['enquiryLocation' => 'Gurugram', 'enquiryService' => 'GST Notice in Gurugram'])
                </aside>
                <div class="faq-expanded__list">
                    <div class="faq-expanded__item" id="faq-1">
                        <h3 class="faq-expanded__q">What should I do when I receive a GST notice?</h3>
                        <div class="faq-expanded__a"><p>First identify the notice type (ASMT-10, DRC-01, DRC-01A, REG-17). Check the response deadline. Reconcile your returns (GSTR-1 vs 3B, GSTR-2B vs 3B ITC). Address every point in the notice (silence is construed as acceptance). File the reply on the GST portal within the deadline. Never ignore a GST notice.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-2">
                        <h3 class="faq-expanded__q">How much does GST notice reply cost?</h3>
                        <div class="faq-expanded__a"><p>ASMT-10 scrutiny reply: Rs 3,999-9,999. DRC-01 show cause reply: Rs 9,999-24,999. DRC-03 voluntary payment: Rs 2,999-5,999. Personal hearing: Rs 4,999-14,999. APL-01 appeal: Rs 9,999-24,999. Monthly prevention: Rs 4,999-9,999/month. Call +91 945 945 6700 for a detailed quote.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-3">
                        <h3 class="faq-expanded__q">Can penalty be avoided on GST notices?</h3>
                        <div class="faq-expanded__a"><p>Total timeline: 2-6 months. Filing and Diary Number: immediate. Mandatory 30-day objection waiting period: 1 month. Receive Order: 1-3 months. Certificate issuance: after examination approval. If a third-party objection is filed, the timeline extends by 2-4 months for hearing and resolution.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-4">
                        <h3 class="faq-expanded__q">What happens if I do not respond to a GST notice?</h3>
                        <div class="faq-expanded__a"><p>The officer passes an ex parte demand order (DRC-07) without hearing your side. Tax, interest, and penalty become a formal demand in your Electronic Liability Ledger, immediately recoverable. Reversing this requires filing an appeal (APL-01), paying pre-deposit (10% of disputed tax), and months of proceedings. A timely reply at the notice stage is always better.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-5">
                        <h3 class="faq-expanded__q">What is the difference between S73 and S74?</h3>
                        <div class="faq-expanded__a"><p>S73 applies to non-fraud cases (inadvertent errors, miscalculations). If demand is paid with interest within 30 days of SCN, penalty is NIL. S74 applies to fraud, willful misstatement, or suppression of facts. Penalty is 100% of tax. From FY 2024-25, S74A provides a unified framework replacing the S73/S74 distinction.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-6">
                        <h3 class="faq-expanded__q">How can GST notices be prevented?</h3>
                        <div class="faq-expanded__a"><p>Monthly reconciliation of GSTR-1 vs GSTR-3B (output tax), GSTR-2B vs GSTR-3B (ITC), and books vs returns. Follow up with vendors for timely GSTR-1 filing (their delay causes your ITC mismatch). Review ITC eligibility under S17(5). Correct discrepancies in the next month's return. Prevention is always cheaper than litigation.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-7">
                        <h3 class="faq-expanded__q">What is the APL-01 appeal process?</h3>
                        <div class="faq-expanded__a"><p>If the final order (DRC-07) is unfavourable, appeal to the Appellate Authority by filing APL-01 within 3 months. Pre-deposit required: 10% of disputed tax amount (maximum Rs 25 crore). The appeal is heard by the First Appellate Authority. Further appeal lies to the GST Appellate Tribunal and then the High Court.</p></div>
                    </div>
                </div>
            </div>
            ...
            <div class="highlight-box" style="margin-top:32px;">
                ...
                <p><strong>Notice aaya - kya karun?</strong> Type identify karo (ASMT-10, DRC-01, REG-17). Deadline dekho. Returns reconcile karo. Har point ka jawab do. Portal pe reply file karo. Ignore mat karo.</p>
                <p><strong>Penalty bach sakti hai?</strong> S73 mein: SCN ke 30 din mein tax + interest pay karo DRC-03 se = ZERO penalty. S74 mein: 100% penalty. Voluntary payment sabse sasta resolution hai.</p>
                <p><strong>Prevention kaise?</strong> Har mahine GSTR-1 vs 3B reconcile karo. GSTR-2B se ITC match karo. Monthly reconciliation se notice hi nahi aayega.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section" style="background: var(--orange-lighter) !important; border-left: 4px solid var(--orange);">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Why GST Notice Response Matters for Gurugram Businesses</h2>
            <div class="content-text">
                <p>A Gurugram e-commerce brand receives ASMT-10 for Rs 8 lakh ITC mismatch. Patron's response: Rs 5 lakh timing difference (vendor filed late, show updated GSTR-2B), Rs 2 lakh ineligible ITC paid via DRC-03, Rs 1 lakh error corrected. Result: Rs 2 lakh actual tax (not Rs 8 lakh). No escalation. No penalty. Rs 5,999 reply saved Rs 6 lakh in disputed demand.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section" style="background: var(--blue) !important;">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title" style="color:#FFFFFF !important;">Respond to Your GST Notice in Gurugram Today</h2>
            <div class="content-text" style="text-align:left;">
                <p style="color:rgba(255,255,255,0.85);">GST Notice Reply in Gurugram covers the complete response lifecycle from scrutiny (ASMT-10) through show cause (DRC-01) to demand (DRC-07) and appeal (APL-01), with reconciliation-based defence and strategic voluntary payment to minimize exposure.</p>
                <p style="color:rgba(255,255,255,0.85);">Patron Accounting's Gurugram office on Golf Course Extension Road handles GST notice identification, reply drafting, DRC-03 payment, hearing representation, APL-01 appeals, and monthly reconciliation prevention for businesses across Gurugram.</p>
            ...
            <div style="display:flex;gap:14px;flex-wrap:wrap;margin-top:24px;">
                ...
                <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20help%20with%20GST%20Notice%20in%20Gurugram.%20Please%20share%20details." target="_blank" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:#25D366;color:#fff;border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#128172; WhatsApp Us</a>
                <a href="mailto:sales@patronaccounting.com?subject=Enquiry%20for%20GST%20Notice%20in%20Gurugram&body=Hello%20Patron%20Accounting%20Team%2C%0A%0AI%20am%20interested%20in%20your%20GST%20Notice%20services%20in%20Gurugram%20and%20would%20like%20to%20know%20more.%0A%0APlease%20get%20in%20touch%20with%20me%20at%20your%20earliest%20convenience.%0A%0AThank%20you." style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:transparent;color:#fff;border:2px solid rgba(255,255,255,0.3);border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#9993;&#65039; Email Us</a>
            </div>
...
<section class="content-section" style="padding:48px 32px;background:var(--gray-50);">
    <div class="content-container">
        <div class="text-content">
            ...
            <p style="text-align:center;color:var(--text-muted);font-size:15px;margin-bottom:40px;">GST notice response services available across India with local office support.</p>
            ...
            <div class="pa-city-block">
                ...
                <div class="pa-block-sub">End-to-end support for GST Notice in Gurugram</div>
...
<section class="content-section" style="padding:32px;">
    <div class="content-container">
        <div class="text-content" style="font-size:13px;color:var(--text-muted);">
            ...
            <p>This page is reviewed quarterly for accuracy. CGST Act notice provisions, response forms, deadlines, penalty structures, and appeal procedures are verified against current CBIC notifications and circulars. Gurugram GST compliance landscape is validated with each review.</p>
        </div>
    </div>
</section>
