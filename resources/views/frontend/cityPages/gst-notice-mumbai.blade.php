...
@section('meta')
    ...
    <meta property="og:image" content="/images/gst-notice-mumbai-og.webp">
    ...
    <meta name="twitter:image" content="/images/gst-notice-mumbai-og.webp">
@endsection
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - GST Notice'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="gst-notice/mumbai" selected>GST Notice in Mumbai</option>
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    ...
                    @include('partials.faq-enquiry-form', ['enquiryLocation' => 'Mumbai', 'enquiryService' => 'GST Notice Reply in Mumbai'])
                </aside>
