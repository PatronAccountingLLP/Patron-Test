            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - GST Refund in Delhi'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="gst-refund/delhi" selected>GST Refund in Delhi</option><option value="gst-registration/delhi">GST Registration in Delhi</option><option value="gst-returns/delhi">GST Returns in Delhi</option><option value="gst-annual-returns/delhi">GST Annual Returns in Delhi</option><option value="private-limited-company-registration/delhi">Private Limited Company Registration in Delhi</option><option value="income-tax-return/delhi">Income Tax Return Filing in Delhi</option><option value="trademark-registration/delhi">Trademark Registration in Delhi</option><option value="other">Other</option>
