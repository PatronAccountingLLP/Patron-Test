...
@section('meta')
    ...
    <meta name="description" content="CA-assisted GST registration in Pune. GSTIN in 3-7 days. PTRC/PTEC, Shop Act, accounting included. Serving Hinjewadi, Kharadi, MIDC businesses.">
...
@section('schema')
    @include('partials.city-localbusiness', ['citySlug' => 'pune', 'pageUrl' => '/gst-registration/pune'])
