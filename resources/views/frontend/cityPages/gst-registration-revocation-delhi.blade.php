...
@section('meta')
    <title>GST Registration Revocation in Delhi | Patron Accounting</title>
    <meta name="description" content="GST Registration Revocation in Delhi: Revoke an officer cancelled GSTIN through Form REG-21 within 90 days (extendable to 270). Returns, dues and late fees...">
    <link rel="canonical" href="/gst-registration-revocation/delhi">
    <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1">
    <meta property="og:title" content="GST Registration Revocation in Delhi | Patron Accounting">
    <meta property="og:description" content="GST Registration Revocation in Delhi: Revoke an officer cancelled GSTIN through Form REG-21 within 90 days (extendable to 270). Returns, dues and late fees...">
    <meta property="og:url" content="/gst-registration-revocation/delhi">
    <meta property="og:type" content="website">
    <meta property="og:site_name" content="Patron Accounting">
    <meta property="og:image" content="https://www.patronaccounting.com/images/gst-registration-revocation-delhi-og.webp">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="GST Registration Revocation in Delhi | Patron Accounting">
    <meta name="twitter:description" content="GST Registration Revocation in Delhi: Revoke an officer cancelled GSTIN through Form REG-21 within 90 days (extendable to 270). Returns, dues and late fees...">
    <meta name="twitter:image" content="https://www.patronaccounting.com/images/gst-registration-revocation-delhi-og.webp">
@endsection
...
@section('schema')
    <script type="application/ld+json">
    {
        ...
        "@type": "Service",
        "@id": "https://www.patronaccounting.com/gst-registration-revocation/delhi/#service",
        "name": "GST Registration Revocation in Delhi",
        ...
        "mainEntityOfPage": { "@type": "WebPage", "@id": "https://www.patronaccounting.com/gst-registration-revocation/delhi" },
    ...
    <script type="application/ld+json">
    {
        "@context": "https://schema.org",
        "@type": "BreadcrumbList",
        "@id": "https://www.patronaccounting.com/gst-registration-revocation/delhi/#breadcrumb",
        "itemListElement": [
            { "@type": "ListItem", "position": 1, "name": "Home", "item": "https://www.patronaccounting.com/" },
            { "@type": "ListItem", "position": 2, "name": "GST Services", "item": "https://www.patronaccounting.com/gst-services" },
            { "@type": "ListItem", "position": 3, "name": "GST Registration Revocation in Delhi", "item": "https://www.patronaccounting.com/gst-registration-revocation/delhi" }
        ]
    }
    </script>
    <script type="application/ld+json">
    {
        "@context": "https://schema.org",
        "@type": "FAQPage",
        "@id": "https://www.patronaccounting.com/gst-registration-revocation/delhi/#faq",
        ...
        <div class="row align-items-center">
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-4 private-registration-heading">GST Registration Revocation in Delhi</h1>
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    <h2 class="faq-expanded__title">FAQs: GST Registration Revocation in Delhi</h2>
                    <p class="faq-expanded__lead">Common questions about GST Registration Revocation for Delhi businesses, answered by our CA and CS team.</p>
                    @include('partials.faq-enquiry-form', ['enquiryLocation' => 'Delhi', 'enquiryService' => 'GST Registration Revocation in Delhi'])
                </aside>
