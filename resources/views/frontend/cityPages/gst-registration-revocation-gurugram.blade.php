...
@section('meta')
    <title>GST Registration Revocation in Gurugram | Patron Accounting</title>
    <meta name="description" content="GST Registration Revocation in Gurugram: Revoke an officer cancelled GSTIN through Form REG-21 within 90 days (extendable to 270). Returns, dues and late...">
    <link rel="canonical" href="/gst-registration-revocation/gurugram">
    <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1">
    <meta property="og:title" content="GST Registration Revocation in Gurugram | Patron Accounting">
    <meta property="og:description" content="GST Registration Revocation in Gurugram: Revoke an officer cancelled GSTIN through Form REG-21 within 90 days (extendable to 270). Returns, dues and late...">
    <meta property="og:url" content="/gst-registration-revocation/gurugram">
    <meta property="og:type" content="website">
    <meta property="og:site_name" content="Patron Accounting">
    <meta property="og:image" content="https://www.patronaccounting.com/images/gst-registration-revocation-gurugram-og.webp">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="GST Registration Revocation in Gurugram | Patron Accounting">
    <meta name="twitter:description" content="GST Registration Revocation in Gurugram: Revoke an officer cancelled GSTIN through Form REG-21 within 90 days (extendable to 270). Returns, dues and late...">
    <meta name="twitter:image" content="https://www.patronaccounting.com/images/gst-registration-revocation-gurugram-og.webp">
@endsection
...
@section('schema')
    <script type="application/ld+json">
    {
        ...
        "@type": "Service",
        "@id": "https://www.patronaccounting.com/gst-registration-revocation/gurugram/#service",
        "name": "GST Registration Revocation in Gurugram",
        ...
        "mainEntityOfPage": { "@type": "WebPage", "@id": "https://www.patronaccounting.com/gst-registration-revocation/gurugram" },
    ...
    <script type="application/ld+json">
    {
        "@context": "https://schema.org",
        "@type": "BreadcrumbList",
        "@id": "https://www.patronaccounting.com/gst-registration-revocation/gurugram/#breadcrumb",
        "itemListElement": [
            { "@type": "ListItem", "position": 1, "name": "Home", "item": "https://www.patronaccounting.com/" },
            { "@type": "ListItem", "position": 2, "name": "GST Services", "item": "https://www.patronaccounting.com/gst-services" },
            { "@type": "ListItem", "position": 3, "name": "GST Registration Revocation in Gurugram", "item": "https://www.patronaccounting.com/gst-registration-revocation/gurugram" }
        ]
    }
    </script>
    <script type="application/ld+json">
    {
        "@context": "https://schema.org",
        "@type": "FAQPage",
        "@id": "https://www.patronaccounting.com/gst-registration-revocation/gurugram/#faq",
        ...
        <div class="row align-items-center">
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-4 private-registration-heading">GST Registration Revocation in Gurugram</h1>
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    <h2 class="faq-expanded__title">FAQs: GST Registration Revocation in Gurugram</h2>
                    <p class="faq-expanded__lead">Common questions about GST Registration Revocation for Gurugram businesses, answered by our CA and CS team.</p>
                    @include('partials.faq-enquiry-form', ['enquiryLocation' => 'Gurugram', 'enquiryService' => 'GST Registration Revocation in Gurugram'])
                </aside>
