...
@section('meta')
    <title>GST Registration Rule 14A in Gurugram | Patron Accounting</title>
    <meta name="description" content="GST Registration Rule 14A in Gurugram: Rule 14A grants Aadhaar based GST registration in 3 working days for B2B taxpayers with monthly output tax below Rs...">
    <link rel="canonical" href="/gst-registration-rule-14a/gurugram">
    <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1">
    <meta property="og:title" content="GST Registration Rule 14A in Gurugram | Patron Accounting">
    <meta property="og:description" content="GST Registration Rule 14A in Gurugram: Rule 14A grants Aadhaar based GST registration in 3 working days for B2B taxpayers with monthly output tax below Rs...">
    <meta property="og:url" content="/gst-registration-rule-14a/gurugram">
    <meta property="og:type" content="website">
    <meta property="og:site_name" content="Patron Accounting">
    <meta property="og:image" content="https://www.patronaccounting.com/images/gst-registration-rule-14a-gurugram-og.webp">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="GST Registration Rule 14A in Gurugram | Patron Accounting">
    <meta name="twitter:description" content="GST Registration Rule 14A in Gurugram: Rule 14A grants Aadhaar based GST registration in 3 working days for B2B taxpayers with monthly output tax below Rs...">
    <meta name="twitter:image" content="https://www.patronaccounting.com/images/gst-registration-rule-14a-gurugram-og.webp">
@endsection
...
@section('schema')
    <script type="application/ld+json">
    {
        ...
        "@type": "Service",
        "@id": "https://www.patronaccounting.com/gst-registration-rule-14a/gurugram/#service",
        "name": "GST Registration Under Rule 14A in Gurugram",
        ...
        "mainEntityOfPage": { "@type": "WebPage", "@id": "https://www.patronaccounting.com/gst-registration-rule-14a/gurugram" },
    ...
    <script type="application/ld+json">
    {
        "@context": "https://schema.org",
        "@type": "BreadcrumbList",
        "@id": "https://www.patronaccounting.com/gst-registration-rule-14a/gurugram/#breadcrumb",
        "itemListElement": [
            { "@type": "ListItem", "position": 1, "name": "Home", "item": "https://www.patronaccounting.com/" },
            { "@type": "ListItem", "position": 2, "name": "GST Services", "item": "https://www.patronaccounting.com/gst-services" },
            { "@type": "ListItem", "position": 3, "name": "Rule 14A GST Registration in Gurugram", "item": "https://www.patronaccounting.com/gst-registration-rule-14a/gurugram" }
        ]
    }
    </script>
    <script type="application/ld+json">
    {
        "@context": "https://schema.org",
        "@type": "FAQPage",
        "@id": "https://www.patronaccounting.com/gst-registration-rule-14a/gurugram/#faq",
...
<nav aria-label="Breadcrumb" style="background:var(--gray-50);border-bottom:1px solid var(--gray-200);padding:10px 16px;">
    <div style="max-width:1320px;margin:0 auto;">
        <ol style="display:flex;align-items:center;gap:8px;list-style:none;padding:0;margin:0;font-size:13px;font-family:'Barlow',sans-serif;">
            ...
            <li><span style="color:var(--orange);font-weight:600;">Rule 14A GST Registration Services</span></li>
        </ol>
    </div>
</nav>
        ...
        <div class="row align-items-center">
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-4 private-registration-heading">GST Registration Under Rule 14A in Gurugram</h1>
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - Rule 14A GST Registration'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value='Rule 14A GST Registration' selected>Rule 14A GST Registration</option>
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    <h2 class="faq-expanded__title">FAQs: GST Registration Rule 14A in Gurugram</h2>
                    <p class="faq-expanded__lead">Common questions about GST Registration Rule 14A for Gurugram businesses, answered by our CA and CS team.</p>
                    @include('partials.faq-enquiry-form', ['enquiryLocation' => 'Gurugram', 'enquiryService' => 'GST Registration Rule 14A in Gurugram'])
                </aside>
...
<section class="content-section" style="padding:48px 32px;background:var(--gray-50);">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title" style="text-align:center;margin-bottom:12px;">Rule 14A Registration Support Across India</h2>
            <p style="text-align:center;color:var(--text-muted);font-size:15px;margin-bottom:40px;">With offices in Pune, Mumbai, Delhi, and Gurugram, Patron Accounting serves small B2B taxpayers across India - both in-person and remotely.</p>

            <div class="pa-city-block" style="margin-bottom:40px;">
                <div class="pa-block-title">Rule 14A Registration Support by City</div>
                <div class="pa-block-sub">Fast track 3 working day GST registration, on-the-ground and remote</div>
                <div class="pa-city-grid">
                    <a href="/gst-registration-rule-14a/delhi" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Delhi</div><div class="pa-card-sub">NCR</div></div></a>
                    <a href="/gst-registration-rule-14a/mumbai" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Mumbai</div><div class="pa-card-sub">Maharashtra</div></div></a>
                    <a href="/gst-registration-rule-14a/pune" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Pune</div><div class="pa-card-sub">Maharashtra</div></div></a>
                    <a href="/gst-registration-rule-14a/gurugram" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Gurugram</div><div class="pa-card-sub">Haryana</div></div></a>
                </div>
            </div>
