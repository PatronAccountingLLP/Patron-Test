...
@section('meta')
    <title>GST Registration Rule 14A in Pune 2026 | Patron Accounting</title>
    <meta name="description" content="GST Registration Rule 14A in Pune: Rule 14A grants Aadhaar based GST registration in 3 working days for B2B taxpayers with monthly output tax below Rs 2.5...">
    <link rel="canonical" href="/gst-registration-rule-14a/pune">
    <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1">
    <meta property="og:title" content="GST Registration Rule 14A in Pune 2026 | Patron Accounting">
    <meta property="og:description" content="GST Registration Rule 14A in Pune: Rule 14A grants Aadhaar based GST registration in 3 working days for B2B taxpayers with monthly output tax below Rs 2.5...">
    <meta property="og:url" content="/gst-registration-rule-14a/pune">
    <meta property="og:type" content="website">
    <meta property="og:site_name" content="Patron Accounting">
    <meta property="og:image" content="https://www.patronaccounting.com/images/gst-registration-rule-14a-pune-og.webp">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="GST Registration Rule 14A in Pune 2026 | Patron Accounting">
    <meta name="twitter:description" content="GST Registration Rule 14A in Pune: Rule 14A grants Aadhaar based GST registration in 3 working days for B2B taxpayers with monthly output tax below Rs 2.5...">
    <meta name="twitter:image" content="https://www.patronaccounting.com/images/gst-registration-rule-14a-pune-og.webp">
@endsection
...
@section('schema')
    <script type="application/ld+json">
    {
        ...
        "@type": "Service",
        "@id": "https://www.patronaccounting.com/gst-registration-rule-14a/pune/#service",
        "name": "GST Registration Under Rule 14A in Pune",
        ...
        "mainEntityOfPage": { "@type": "WebPage", "@id": "https://www.patronaccounting.com/gst-registration-rule-14a/pune" },
    ...
    <script type="application/ld+json">
    {
        "@context": "https://schema.org",
        "@type": "BreadcrumbList",
        "@id": "https://www.patronaccounting.com/gst-registration-rule-14a/pune/#breadcrumb",
        "itemListElement": [
            { "@type": "ListItem", "position": 1, "name": "Home", "item": "https://www.patronaccounting.com/" },
            { "@type": "ListItem", "position": 2, "name": "GST Services", "item": "https://www.patronaccounting.com/gst-services" },
            { "@type": "ListItem", "position": 3, "name": "Rule 14A GST Registration in Pune", "item": "https://www.patronaccounting.com/gst-registration-rule-14a/pune" }
        ]
    }
    </script>
    <script type="application/ld+json">
    {
        "@context": "https://schema.org",
        "@type": "FAQPage",
        "@id": "https://www.patronaccounting.com/gst-registration-rule-14a/pune/#faq",
        ...
        <div class="row align-items-center">
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-4 private-registration-heading">GST Registration Under Rule 14A in Pune</h1>
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    <h2 class="faq-expanded__title">FAQs: GST Registration Rule 14A in Pune</h2>
                    <p class="faq-expanded__lead">Common questions about GST Registration Rule 14A for Pune businesses, answered by our CA and CS team.</p>
                    @include('partials.faq-enquiry-form', ['enquiryLocation' => 'Pune', 'enquiryService' => 'GST Registration Rule 14A in Pune'])
                </aside>
