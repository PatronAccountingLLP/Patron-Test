  ...
  "@graph": [
    {
      ...
      "url": "/gst-returns-for-e-commerce-operator/gurugram",
                ...
                <div class="pe-lg-5">
                    ...
                    <div class="mb-4">
                        <div class="d-flex align-items-start mb-3">
                            ...
                            <p class="mb-0 text-dark benefit-paragraph"><span>Documents:</span> Platform settlement reports, TCS certificates, GSTR-2A/2B, sales data, operator GSTINs</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Fees:</span> Operator GSTR-8: Rs 4,999-14,999. Seller: Rs 2,999-9,999. Reconciliation: Rs 1,999-4,999</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Eligibility:</span> E-commerce operators (platforms) and sellers on marketplaces. Mandatory registration S24</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Timeline:</span> GSTR-8: by 10th. GSTR-1: by 11th. GSTR-3B: by 20th. Monthly filing cycle</p>
                        </div>
                    </div>
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="mailto:sales@patronaccounting.com?subject=Enquiry%20for%20GST%20E-commerce%20Returns%20in%20Gurugram&body=Hello%20Patron%20Accounting%20Team%2C%0A%0AI%20am%20interested%20in%20your%20GST%20E-commerce%20Returns%20services%20in%20Gurugram%20and%20would%20like%20to%20know%20more.%0A%0APlease%20get%20in%20touch%20with%20me%20at%20your%20earliest%20convenience.%0A%0AThank%20you." class="btn-sample text-decoration-none">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:18px;height:18px;"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,12 2,6"/></svg>
                            Email Us
                        </a>
                        <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20help%20with%20GST%20E-commerce%20Returns%20in%20Gurugram.%20Please%20share%20details." target="_blank" class="btn-sample text-decoration-none">
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - GST E-commerce Returns Gurugram'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="gst-returns-for-e-commerce-operator/gurugram" selected>GST Returns for E-commerce in Gurugram</option>
...
<section class="testimonials-section">
    <div class="section-container">
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            ...
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Selling on 3 platforms. Rs 2.76 lakh TCS unclaimed over 12 months. Patron restructured our GSTR-1 with Table 4A/8, claimed all accumulated TCS, resolved ASMT-10. Monthly cost Rs 5,000. Annual TCS recovered Rs 2.76 lakh.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div>
                    ...
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Founder, D2C Fashion Brand, Sohna Road</div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Patron files our GSTR-8 and handles S9(5) restaurant GST compliance. TCS calculation, deposit, filing - all by the 10th. Zero penalties. Our sellers get TCS credit on time because we file on time.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div>
                    ...
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">COO, Food Delivery Platform, DLF Cyber City</div>
                    <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                </div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Amazon + Flipkart + Meesho. Three different settlement report formats. Patron downloads, extracts, reconciles TCS across all three. One clean GSTR-3B. Multi-platform reconciliation is the service we needed most.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div>
                    ...
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Multi-Platform Seller, Gurugram</div>
                    <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                </div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Our B2B marketplace sales needed proper HSN codes and e-invoicing. Patron handles GSTR-1 with correct place of supply (most sales inter-state = IGST). TCS reconciliation with IndiaMART data integrated.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                <div style="width:36px;height:36px;border-radius:50%;background:#6366F1;display:flex;align-items:center;justify-content:center;font-weight:700;font-size:13px;color:#fff;flex-shrink:0;">SK</div>
                <div>
                    <div style="font-weight:700;font-size:13px;color:var(--blue);">Suresh Kumar</div>
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Director, Manufacturing Seller, Udyog Vihar</div>
                    <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                </div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Started selling on Amazon. Did not know GST registration is mandatory (S24). Patron registered, set up GSTR-1/3B with Table 4A/8, explained TCS credit claiming. Complete handholding for first-time e-commerce seller.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div>
                    ...
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Individual Seller, Gurugram</div>
                    <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                </div>
        ...
        <div class="reviews-cta" style="margin-top: 16px; display: flex !important;">
            <div class="reviews-cta-content">
                ...
                <div class="reviews-cta-text">
                    ...
                    <p>Trusted e-commerce GST compliance partner for operators and sellers across Gurugram.</p>
                </div>
            </div>
...
<div class="stats-bar">
    <div class="stats-container">
        <div class="stat-item">
            ...
            <div class="stat-content"><span class="stat-value">10,000+</span><span class="stat-label">Businesses Served</span><span class="stat-desc">E-commerce GST compliance across India.</span></div>
        </div>
        <div class="stat-item">
            <div class="stat-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8M12 17v4"/></svg></div>
            <div class="stat-content"><span class="stat-value">15+</span><span class="stat-label">Years Experience</span><span class="stat-desc">Deep expertise in GSTR-8, TCS reconciliation, and e-commerce GST compliance.</span></div>
        </div>
        <div class="stat-item">
            <div class="stat-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><path d="M14 2v6h6M16 13H8M16 17H8"/></svg></div>
            <div class="stat-content"><span class="stat-value">50,000+</span><span class="stat-label">Documents Filed</span><span class="stat-desc">E-commerce GST returns, TCS filings, and compliance documents handled.</span></div>
        </div>
        <div class="stat-item">
            <div class="stat-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="8" r="7"/><path d="M8.21 13.89L7 23l5-3 5 3-1.21-9.12"/></svg></div>
            <div class="stat-content"><span class="stat-value">4.9&#9733;</span><span class="stat-label">Client Rating</span><span class="stat-desc">Trusted by marketplace operators, D2C brands, and e-commerce sellers.</span></div>
        </div>
...
<section class="content-section" id="overview-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Why E-commerce GST Returns Matter for Gurugram Businesses</h2>
            <div class="content-text">
                <div class="highlight-box" style="margin-bottom:20px;">
                    <p><strong>&#128204; TL;DR - E-commerce GST Return Services at a Glance</strong></p>
                    <p>E-commerce operators must collect TCS at 1% under S52 and file GSTR-8 by 10th. Sellers file GSTR-1 (Table 4A/8 with operator GSTIN) and GSTR-3B (TCS credit from cash ledger). Registration mandatory regardless of turnover (S24). S9(5): operators pay GST on restaurant (5%), cab, accommodation. TCS goes to electronic cash ledger (not ITC). Multi-platform reconciliation essential. Late GSTR-8: Rs 200/day.</p>
                </div>
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Parameter</th><th>Detail</th></tr></thead>
                    <tbody>
                        <tr><td>Governing Law</td><td>CGST Act 2017 - S52 (TCS), S9(5) (operator liability), S24 (mandatory registration)</td></tr>
                        ...
                        <tr><td>Form</td><td>GSTR-8 (operator TCS) | GSTR-1 Table 4A/8 (seller) | GSTR-3B (seller + TCS credit)</td></tr>
                ...
                <p>Gurugram's e-commerce ecosystem is among India's densest. Marketplace startups in DLF Cyber City, D2C brands on Sohna Road selling on Amazon/Flipkart/Meesho, manufacturers in Udyog Vihar on B2B platforms, and food/cab aggregators all have e-commerce GST obligations. For comprehensive information about <a href="/gst-returns-for-e-commerce-operator">e-commerce GST returns across India</a>, visit our national service page.</p>
                <p>The most common mistake: not claiming TCS credit in GSTR-3B. Rs 20,000/month unclaimed = Rs 2.4 lakh/year overpaid. Also need <a href="/gst-registration">GST registration</a> (mandatory S24) and <a href="#">monthly GST return filing</a> for complete compliance.</p>
    ...
    <div class="content-container">
        <div class="two-column">
            <div class="column-content">
                <h2 class="section-title">What Are GST Returns for E-commerce Operator</h2>
                <div class="content-text what-is-definition">
                    <p>E-commerce GST returns cover two streams: (1) operator compliance - GSTR-8 (TCS), GSTR-1, GSTR-3B, GSTR-9; and (2) seller compliance - GSTR-1 with Table 4A/8, GSTR-3B with TCS credit, and annual reconciliation.</p>
                    <p>GSTR-8 reports all supplies through the platform, TCS collected, and TCS deposited. Both streams must synchronize - operator GSTR-8 must match seller GSTR-1/3B data.</p>
                    <p>Under S9(5), operators are liable for GST on restaurant services (Swiggy/Zomato), cab services, and accommodation by unregistered suppliers. For complete compliance, integrate with <a href="#">monthly return filing</a> and <a href="/gst-registration">GST registration</a>.</p>
                </div>
                <div class="highlight-box" style="margin-top:20px;">
                    <p><strong>Key Terms for Copyright Registration:</strong></p>
                    <ul>
                        <li><strong>GSTR-8</strong> - Monthly TCS return by operators (10th)</li>
                        <li><strong>TCS</strong> - Tax Collected at Source 1% by operators</li>
                        <li><strong>S9(5)</strong> - Operator GST liability on restaurant/cab/accommodation</li>
                        <li><strong>Table 4A/8</strong> - GSTR-1 e-commerce disclosure tables</li>
                        <li><strong>Electronic Cash Ledger</strong> - Where TCS credit is deposited for sellers</li>
                    </ul>
                </div>
            </div>
...
<section class="content-section" id="who-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Who Needs E-commerce GST Returns in Gurugram</h2>
            <div class="content-text">
                <ul>
                    <li><strong>Marketplace startups in DLF Cyber City</strong> building platforms. Any platform collecting payment on behalf of sellers = e-commerce operator requiring GSTR-8 and TCS.</li>
                    <li><strong>Food delivery platforms (Swiggy, Zomato)</strong> in Gurugram. S9(5): collect and deposit 5% GST on restaurant orders. File GSTR-8 for TCS. Complex S9(5) compliance.</li>
                    ...
                    <li><strong>Manufacturers in Udyog Vihar</strong> selling on Amazon Business, IndiaMART, B2B marketplaces. B2B e-commerce needs proper HSN, place of supply, and e-invoicing.</li>
...
<section class="content-section" id="services-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">6 E-commerce GST Return Services Included</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Service</th><th>What We Do</th></tr></thead>
                    <tbody>
                        <tr><td>GSTR-8 Filing (Operators)</td><td>TCS calculation on net value. GSTR-8 by 10th. Deposit TCS. Reconcile with seller data.</td></tr>
                        <tr><td>GSTR-1 for E-commerce Sellers</td><td>Table 4A/8 with operator GSTIN. B2B/B2C classification. Place of supply for inter-state. By 11th.</td></tr>
                        <tr><td>GSTR-3B with TCS Credit</td><td>TCS credit from cash ledger claimed. Reduces cash payment. Without claiming: monthly overpayment.</td></tr>
                        <tr><td>Multi-Platform TCS Reconciliation</td><td>Settlement reports from each platform. Extract TCS. Match GSTR-2A/2B. Resolve discrepancies.</td></tr>
                        <tr><td>S9(5) Compliance</td><td>Restaurant 5% GST. Cab/accommodation by unregistered. Separate compliance track in GSTR-1/3B.</td></tr>
                        <tr><td>Notice Prevention</td><td>Monthly pre-filing reconciliation. GSTR-1/3B vs GSTR-8 matching. Rule 88C prevention. Reply if received.</td></tr>
...
<section class="steps-section" id="procedure-section">
    <div class="section-container">
        <header class="section-header" style="text-align:center;margin-bottom:48px;">
            ...
            <h2 class="section-title">How E-commerce GST Returns Work: 5-Step Process</h2>
            <p class="section-subtitle" style="text-align:left;max-width:100%;">Our CA-led team handles GSTR-8 for operators, GSTR-1/3B for sellers, TCS reconciliation, and S9(5) compliance for Gurugram e-commerce businesses.</p>
        </header>
        <div class="steps-container">
            <div class="step-card">
                <div class="step-content">
                    <span class="step-badge">Step 1</span>
                    <h3 class="step-title">Download Platform Reports</h3>
                    <p class="step-description">Download settlement reports from each platform. Extract sales, returns, TCS data. Consolidate.</p>
                    <div class="step-highlights">
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Downloaded</span>
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Reports OK</span>
                    </div>
                </div>
                <div class="step-visual">
                    <div class="step-illustration">
                        ...
                        <span class="illustration-label">Extracted</span>
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">Reconcile TCS</h3>
                    <p class="step-description">Match platform TCS with GSTR-2A/2B. Accept TCS entries on GST portal. Identify missing entries.</p>
                    <div class="step-highlights">
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>TCS Matched</span>
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Accepted</span>
                    </div>
                </div>
                <div class="step-visual">
                    <div class="step-illustration">
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">File GSTR-1 with E-commerce Tables</h3>
                    <p class="step-description">Table 4A/8 with operator GSTIN for each platform. B2B/B2C. Returns adjusted. By 11th.</p>
                    <div class="step-highlights">
                        ...
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Table 4A OK</span>
                    </div>
                </div>
                <div class="step-visual">
                    <div class="step-illustration">
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">File GSTR-3B with TCS Credit</h3>
                    <p class="step-description">Claim TCS credit from electronic cash ledger. Offset against output tax. Pay balance. By 20th.</p>
                    <div class="step-highlights">
                        ...
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>TCS Claimed</span>
                    </div>
                </div>
                <div class="step-visual">
                    <div class="step-illustration">
                        ...
                        <span class="illustration-label">Credited</span>
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">Operator: File GSTR-8</h3>
                    <p class="step-description">Calculate TCS on net supplies. Deposit. File GSTR-8 by 10th. Reconcile with seller data.</p>
                    <div class="step-highlights">
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>GSTR-8 Filed</span>
                ...
                <div class="step-visual">
                    <div class="step-illustration">
                        ...
                        <span class="illustration-label">Operator OK</span>
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">Verify and Prevent Notices</h3>
                    <p class="step-description">Cross-check GSTR-8 vs seller GSTR-1/3B. Resolve mismatches before department notices. Monthly cycle.</p>
                    <div class="step-highlights">
        ...
        <div class="highlight-box" style="margin-top:32px;max-width:1000px;margin-left:auto;margin-right:auto;">
            <p><strong>City Processing Note:</strong> Patron's Gurugram office handles GSTR-8, seller GSTR-1/3B, TCS reconciliation, and S9(5) compliance for e-commerce businesses across Gurugram.</p>
        </div>
    </div>
</section>
...
<section class="content-section" id="documents-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Documents Required for E-commerce GST Returns in Gurugram</h2>
            <div class="content-text">
                <ul>
                    <li><strong>Platform Reports:</strong> Settlement reports from Amazon, Flipkart, Meesho with sales, returns, TCS data.</li>
                    <li><strong>GSTR-2A/2B:</strong> Auto-populated TCS entries from operator GSTR-8 filings. Accept on portal.</li>
                    <li><strong>Sales Records:</strong> Channel-wise sales data. B2B/B2C. Operator GSTINs. Returns/cancellations.</li>
                    <li><strong>Additional:</strong> TCS certificates from operators | E-invoicing data (B2B) | Place of supply workings.</li>
                </ul>
            </div>
        </div>
    </div>
...
<section class="content-section" id="challenges-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">5 Common E-commerce GST Challenges in Gurugram</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Challenge</th><th>Impact</th><th>How Patron Accounting Solves It</th></tr></thead>
                    <tbody>
                        <tr><td>TCS Credit Not Claimed</td><td>D2C brand sells Rs 20 lakh/month. Amazon deducts Rs 20,000 TCS. Not claimed in GSTR-3B. Rs 2.4 lakh/year overpaid</td><td>Accept TCS from GSTR-2A/2B. Claim credit in GSTR-3B. Offset against output tax. Check every month.</td></tr>
                        <tr><td>Multi-Platform TCS Mismatch</td><td>Seller on 3 platforms. Combined TCS in GSTR-2A/2B shows less than expected (one platform filed GSTR-8 late)</td><td>Reconcile all platforms. Check GSTR-8 filing dates. Wait for late filer or claim in next month. Document discrepancy.</td></tr>
                        <tr><td>GSTR-1 Table 4A Not Used</td><td>Seller reports all in regular B2C tables. Misses Table 4A/8 operator GSTIN. System cannot match with GSTR-8</td><td>Always tick Is E-commerce Operator. Enter operator GSTIN. Report channel-wise. Prevents reconciliation notices.</td></tr>
                        <tr><td>Returns/Cancellations Not Adjusted</td><td>Seller reports gross sales in GSTR-1. Operator reports net (after returns) in GSTR-8. 15-30% return rate in fashion</td><td>Report net sales consistently. Credit notes for returns. Match operator net value. Reconcile before filing.</td></tr>
                        <tr><td>S9(5) Compliance Missed</td><td>Food platform not depositing 5% GST on unregistered restaurant orders. S9(5) audit triggers demand</td><td>Track S9(5) liability separately. Deposit GST on restaurant/cab/accommodation. Separate line in GSTR-3B.</td></tr>
                    </tbody>
                </table>
                </div>
            </div>
...
<section class="content-section" id="fees-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">E-commerce GST Return Fees in Gurugram 2026</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table class="table-amount">
                    <thead><tr><th>Fee Component</th><th>Amount</th></tr></thead>
                    <tbody>
                        <tr><td>Operator GSTR-8</td><td>Rs 4,999-14,999/month</td></tr>
                        <tr><td>Seller GSTR-1 + GSTR-3B</td><td>Rs 2,999-9,999/month</td></tr>
                        <tr><td>Multi-Platform TCS Reconciliation</td><td>Rs 1,999-4,999/month</td></tr>
                        <tr><td>GSTR-9 Annual (E-commerce)</td><td>Rs 4,999-14,999</td></tr>
                        <tr><td>S9(5) Compliance</td><td>Rs 2,999-7,999/month</td></tr>
                        <tr><td>E-commerce GST Bundle</td><td>Rs 7,999-19,999/month</td></tr>
                ...
                <p style="margin-top:16px;">No government fee for filing. Late fee Rs 200/day for GSTR-8. Professional fees cover TCS calculation, multi-platform reconciliation, filing, and credit claiming.</p>
                <p style="margin-top:16px;"><strong>Get a free Copyright Registration consultation - <a href="tel:+919459456700">Call +91 945 945 6700</a> or <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20help%20with%20GST%20E-commerce%20Returns%20in%20Gurugram.%20Please%20share%20fee%20details." target="_blank">WhatsApp us</a>. No-obligation assessment.</strong></p>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section" id="timeline-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">E-commerce GST Return Timeline in Gurugram</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Stage</th><th>Estimated Timeline</th></tr></thead>
                    <tbody>
                        <tr><td>GSTR-8 (Operator)</td><td>By 10th of following month</td></tr>
                        <tr><td>GSTR-1 (Seller)</td><td>By 11th of following month</td></tr>
                        <tr><td>GSTR-3B (Seller)</td><td>By 20th of following month</td></tr>
                        <tr><td>TCS Credit Acceptance</td><td>Before GSTR-3B filing each month</td></tr>
                        <tr><td>GSTR-9 Annual</td><td>By December 31</td></tr>
                        <tr><td>Platform Report Download</td><td>Monthly (1st-5th for reconciliation)</td></tr>
                        <tr><td>Reconciliation</td><td>Before each GSTR-1/3B filing</td></tr>
                    </tbody>
                </table>
                </div>
                <div class="highlight-box" style="margin-top:16px;">
                    <p><strong>Note:</strong> GSTR-8 by 10th. GSTR-1 by 11th. GSTR-3B by 20th. Monthly filing cycle. TCS credit must be claimed each month. Reconciliation before filing.</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="why-choose-section" id="benefits-section">
    <div class="section-container">
        <div style="text-align:center;margin-bottom:48px;">
            ...
            <h2 class="section-title">Why Choose Patron for E-commerce GST in Gurugram</h2>
        </div>
        <div class="features-grid">
            <article class="feature-card">
                ...
                <h3 class="feature-title">GSTR-8 for Operators</h3>
                <p class="feature-text">TCS calculation on net supplies. GSTR-8 by 10th. Deposit. Supplier reconciliation. S9(5) compliance.</p>
            </article>
            <article class="feature-card">
                ...
                <h3 class="feature-title">TCS Credit Claiming</h3>
                <p class="feature-text">Accept TCS from GSTR-2A/2B. Claim in GSTR-3B. Offset output tax. Prevents monthly overpayment.</p>
            </article>
            <article class="feature-card">
                ...
                <h3 class="feature-title">Multi-Platform Reconciliation</h3>
                <p class="feature-text">Amazon + Flipkart + Meesho + own website. Settlement reports. TCS matching. One GSTR-3B for all channels.</p>
            </article>
            <article class="feature-card">
                <div class="feature-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg></div>
                <h3 class="feature-title">Table 4A/8 Compliance</h3>
                <p class="feature-text">GSTR-1 e-commerce disclosures. Operator GSTIN for each platform. B2B/B2C. Returns adjusted. Prevents notices.</p>
            </article>
            <article class="feature-card">
                ...
                <h3 class="feature-title">S9(5) Management</h3>
                <p class="feature-text">Restaurant, cab, accommodation GST by operators. Separate compliance track. 5% GST deposit and reporting.</p>
            </article>
            <article class="feature-card">
                ...
                <p class="feature-text">Pre-filing reconciliation every month. GSTR-8 vs GSTR-1/3B matching. Rule 88C prevention. Proactive resolution.</p>
            </article>
        </div>
    </div>
</section>
...
<section class="content-section" id="comparison-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Operator vs Seller Compliance</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table class="table-comparison">
                    <thead><tr><th>Aspect</th><th>Operator vs Seller</th></tr></thead>
                    <tbody>
                        <tr><td>Registration</td><td>Both mandatory S24. No threshold. Zero exemption</td></tr>
                        <tr><td>Primary Return</td><td>Operator: GSTR-8 (TCS). Seller: GSTR-1 + GSTR-3B</td></tr>
                        <tr><td>TCS</td><td>Operator collects 1%. Deposits by 10th. Reports in GSTR-8</td></tr>
                        <tr><td>TCS Credit</td><td>Seller claims in GSTR-3B from electronic cash ledger</td></tr>
                        <tr><td>S9(5)</td><td>Operator pays GST on restaurant (5%), cab, accommodation. Not seller</td></tr>
                        <tr><td>Reconciliation</td><td>Operator GSTR-8 must match seller GSTR-1/3B. Mismatch = notice</td></tr>
                    </tbody>
                </table>
                </div>
...
<section class="content-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>E-commerce GST is governed by <strong>Section 52 CGST Act 2017</strong> (TCS by operators), <strong>Section 9(5)</strong> (operator liability for restaurant/cab/accommodation), and <strong>Section 24</strong> (mandatory registration). GSTR-8 under Rule 67A.</p>
                <p>TCS at <strong>1% of net taxable supplies</strong> (0.5% CGST + 0.5% SGST or 1% IGST). Net value = aggregate taxable minus returns/cancellations. TCS credit to seller's <strong>electronic cash ledger</strong> (not ITC). Late GSTR-8: <strong>Rs 200/day</strong> (max Rs 5,000).</p>
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    <h2 class="faq-expanded__title">FAQs - E-commerce GST Returns in Gurugram</h2>
                    <p class="faq-expanded__lead">Answers to common questions about e-commerce GST returns including GSTR-8, TCS, seller compliance, and multi-platform reconciliation for Gurugram businesses.</p>
                    @include('partials.faq-enquiry-form', ['enquiryLocation' => 'Gurugram', 'enquiryService' => 'E-commerce GST Returns in Gurugram'])
                </aside>
                <div class="faq-expanded__list">
                    <div class="faq-expanded__item" id="faq-1">
                        <h3 class="faq-expanded__q">What returns must e-commerce sellers file?</h3>
                        <div class="faq-expanded__a"><p>GSTR-1 monthly by the 11th with Table 4A/8 identifying operator GSTIN for each platform. GSTR-3B by the 20th with TCS credit claimed from electronic cash ledger. GSTR-9 annual. TCS entries from operator GSTR-8 must be accepted from GSTR-2A/2B on the GST portal before filing GSTR-3B.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-2">
                        <h3 class="faq-expanded__q">How much does e-commerce GST filing cost?</h3>
                        <div class="faq-expanded__a"><p>Operator GSTR-8: Rs 4,999-14,999/month. Seller GSTR-1 plus 3B: Rs 2,999-9,999/month. Multi-platform reconciliation: Rs 1,999-4,999/month. Annual: Rs 4,999-14,999. E-commerce bundle: Rs 7,999-19,999/month. Call +91 945 945 6700 for a detailed quote.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-3">
                        <h3 class="faq-expanded__q">What is GSTR-8 and who files it?</h3>
                        <div class="faq-expanded__a"><p>Total timeline: 2-6 months. Filing and Diary Number: immediate. Mandatory 30-day objection waiting period: 1 month. Operator: File GSTR-8: 1-3 months. Certificate issuance: after examination approval. If a third-party objection is filed, the timeline extends by 2-4 months for hearing and resolution.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-4">
                        <h3 class="faq-expanded__q">Is GST registration mandatory for e-commerce sellers?</h3>
                        <div class="faq-expanded__a"><p>Yes. Under Section 24 of the CGST Act, both e-commerce operators and sellers making supplies through e-commerce operators must obtain GST registration regardless of turnover. There is no threshold exemption. Even if your annual turnover is below Rs 20 lakh (or Rs 40 lakh for goods), you must register if you sell through any marketplace platform.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-5">
                        <h3 class="faq-expanded__q">What is TCS credit and how do sellers claim it?</h3>
                        <div class="faq-expanded__a"><p>TCS collected by e-commerce operators goes to the seller's electronic cash ledger (not ITC ledger). Sellers must accept TCS entries from GSTR-2A/2B on the GST portal and then claim the credit in GSTR-3B to offset their output tax liability. Without claiming, sellers effectively overpay GST by the TCS amount every month.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-6">
                        <h3 class="faq-expanded__q">What is Section 9(5) liability for operators?</h3>
                        <div class="faq-expanded__a"><p>Under Section 9(5), e-commerce operators are deemed suppliers and must collect and deposit GST on certain services: restaurant services through food delivery platforms like Swiggy and Zomato at 5%, passenger transport services through cab aggregators, and accommodation services when supplied by unregistered suppliers. This is the operator's liability, not the restaurant or driver's.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-7">
                        <h3 class="faq-expanded__q">How to handle multi-platform TCS reconciliation?</h3>
                        <div class="faq-expanded__a"><p>Download settlement reports from each platform (Amazon, Flipkart, Meesho). Extract TCS data from each. Reconcile with GSTR-2A/2B auto-populated TCS entries. Identify discrepancies (platforms filing GSTR-8 late, amount mismatches). Combine all platform data into one consolidated GSTR-3B. File after reconciliation is complete. Mismatches trigger scrutiny notices.</p></div>
                    </div>
                </div>
            </div>
            ...
            <div class="highlight-box" style="margin-top:32px;">
                ...
                <p><strong>Seller ke liye kya file karna hai?</strong> GSTR-1 monthly (Table 4A/8 mein operator GSTIN). GSTR-3B monthly (TCS credit claim karo). TCS accept karo GSTR-2A/2B se.</p>
                <p><strong>Operator ke liye?</strong> GSTR-8 har mahine 10 tarikh. TCS 1% collect karo net sales pe. Deposit karo. GSTR-1 aur GSTR-3B bhi. S9(5) restaurant/cab GST bhi.</p>
                <p><strong>Multiple platforms?</strong> Har ek se settlement report download. TCS reconcile GSTR-2A/2B se. Ek GSTR-3B mein sab combine. Mismatch se notice aayega.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section" style="background: var(--orange-lighter) !important; border-left: 4px solid var(--orange);">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Why E-commerce GST Returns Matter for Gurugram Businesses</h2>
            <div class="content-text">
                <p>A Gurugram D2C brand sells Rs 28 lakh/month across Amazon (Rs 15 lakh), Flipkart (Rs 8 lakh), own website (Rs 5 lakh). Monthly TCS: Rs 23,000. Accountant pays full GST without claiming TCS. 12 months: Rs 2.76 lakh overpaid. GSTR-1 missing Table 4A/8 triggers ASMT-10. Patron restructures filing, claims Rs 2.76 lakh accumulated TCS, resolves notice. Monthly cost: Rs 5,000. Annual TCS savings: Rs 2.76 lakh.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section" style="background: var(--blue) !important;">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title" style="color:#FFFFFF !important;">Start Your E-commerce GST Filing in Gurugram Today</h2>
            <div class="content-text" style="text-align:left;">
                <p style="color:rgba(255,255,255,0.85);">GST Returns for E-commerce Operator in Gurugram covers GSTR-8 (TCS by operators), GSTR-1/3B (seller returns with e-commerce disclosures and TCS credit), multi-platform reconciliation, and S9(5) liability management for Gurugram's dense marketplace ecosystem.</p>
                <p style="color:rgba(255,255,255,0.85);">Patron Accounting's Gurugram office on Golf Course Extension Road handles GSTR-8 for operators, GSTR-1/3B for multi-platform sellers, TCS reconciliation, TCS credit claiming, S9(5) compliance, and e-commerce notice prevention for marketplace startups, D2C brands, and sellers across Gurugram.</p>
            ...
            <div style="display:flex;gap:14px;flex-wrap:wrap;margin-top:24px;">
                ...
                <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20help%20with%20GST%20E-commerce%20Returns%20in%20Gurugram.%20Please%20share%20details." target="_blank" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:#25D366;color:#fff;border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#128172; WhatsApp Us</a>
                <a href="mailto:sales@patronaccounting.com?subject=Enquiry%20for%20GST%20E-commerce%20Returns%20in%20Gurugram&body=Hello%20Patron%20Accounting%20Team%2C%0A%0AI%20am%20interested%20in%20your%20GST%20E-commerce%20Returns%20services%20in%20Gurugram%20and%20would%20like%20to%20know%20more.%0A%0APlease%20get%20in%20touch%20with%20me%20at%20your%20earliest%20convenience.%0A%0AThank%20you." style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:transparent;color:#fff;border:2px solid rgba(255,255,255,0.3);border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#9993;&#65039; Email Us</a>
            </div>
...
<section class="content-section" style="padding:48px 32px;background:var(--gray-50);">
    <div class="content-container">
        <div class="text-content">
            ...
            <p style="text-align:center;color:var(--text-muted);font-size:15px;margin-bottom:40px;">E-commerce GST return services available across India with local office support.</p>
            ...
            <div class="pa-city-block">
                ...
                <div class="pa-block-sub">End-to-end support for E-commerce GST Returns in Gurugram</div>
...
<section class="content-section" style="padding:32px;">
    <div class="content-container">
        <div class="text-content" style="font-size:13px;color:var(--text-muted);">
            ...
            <p>This page is reviewed quarterly for accuracy. CGST Act e-commerce provisions, TCS rates, GSTR-8 requirements, S9(5) liability, and seller compliance rules are verified against current CBIC notifications. Gurugram e-commerce landscape is validated with each review.</p>
        </div>
    </div>
</section>
