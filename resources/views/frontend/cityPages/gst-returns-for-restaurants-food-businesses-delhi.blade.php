        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'gst-returns-for-restaurants-food-businesses/delhi',
                    'options'  => [
                        'gst-returns-for-restaurants-food-businesses/delhi' => 'Restaurant GST Returns in Delhi',
                        'gst-registration/delhi' => 'GST Registration in Delhi',
                        'gst-returns/delhi' => 'GST Returns in Delhi',
                        'fssai-returns/delhi' => 'FSSAI Returns in Delhi',
