...
@section('meta')
    ...
    <meta property="og:image" content="/images/gst-returns-for-restaurants-gurugram-og.webp">
    ...
    <meta name="twitter:image" content="/images/gst-returns-for-restaurants-gurugram-og.webp">
@endsection
  ...
  "@graph": [
    {
      ...
      "url": "/gst-returns-for-restaurants-food-businesses/gurugram",
        ...
        <div class="row align-items-center">
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-4 private-registration-heading">
                        GST Returns for Restaurants in Gurugram: Rate Classification, Platform Reconciliation, and Compliance
                    </h1>
                    ...
                    <div class="mb-4">
                        <div class="d-flex align-items-start mb-3">
                            ...
                            <p class="mb-0 text-dark benefit-paragraph"><span>Documents:</span> POS sales data, Swiggy/Zomato reports, purchase invoices, composition declaration</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Fees:</span> Monthly: from Rs 2,499. Composition: from Rs 1,999/quarter. Annual bundle: from Rs 29,999</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Eligibility:</span> Restaurants, cloud kitchens, QSR chains, cafes, catering services, hotel restaurants</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Timeline:</span> GSTR-1: by 11th. GSTR-3B: by 20th. CMP-08: quarterly. GSTR-4: annually</p>
                        </div>
                    </div>
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="mailto:sales@patronaccounting.com?subject=Enquiry%20for%20GST%20Restaurant%20Returns%20in%20Gurugram&body=Hello%20Patron%20Accounting%20Team%2C%0A%0AI%20am%20interested%20in%20your%20GST%20Restaurant%20Returns%20services%20in%20Gurugram%20and%20would%20like%20to%20know%20more.%0A%0APlease%20get%20in%20touch%20with%20me%20at%20your%20earliest%20convenience.%0A%0AThank%20you." class="btn-sample text-decoration-none">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:18px;height:18px;"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,12 2,6"/></svg>
                            Email Us
                        </a>
                        <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20help%20with%20GST%20Restaurant%20Returns%20in%20Gurugram.%20Please%20share%20details." target="_blank" class="btn-sample text-decoration-none">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'gst-returns-for-restaurants/gurugram',
                    'options'  => [
                        'gst-returns-for-restaurants/gurugram' => 'GST Returns for Restaurants in Gurugram',
...
<section class="testimonials-section">
    <div class="section-container">
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            ...
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Patron handles all 3 of our outlet GSTINs. Rate classification, platform reconciliation, monthly filing. Zero notices. S9(5) Swiggy/Zomato data reconciled every month before filing.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div>
                    ...
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Owner, Restaurant Chain, Cyber Hub</div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Cloud kitchen on Sohna Road. 100% delivery. Patron reconciles Swiggy and Zomato reports monthly. Handles returns/cancellations correctly. No double-reporting. Clean GSTR-1 every month.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">We were claiming ITC at 5% for 2 years. Nobody told us it was wrong. Patron caught it, reversed proactively, avoided demand notice. Now filing correctly at 5% with zero ITC.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div>
                    ...
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Owner, Restaurant, Sector 29</div>
                    <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                </div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Hotel restaurant at 18% GST. Patron manages full ITC on ingredients, equipment, and rent. GSTR-2B reconciliation ensures maximum ITC claim. Rs 12 lakh ITC claimed properly last year.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div>
                    ...
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">F&B Manager, Hotel, NH-48</div>
                    <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                </div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Small dhaba. Patron moved us to composition scheme. 1% flat tax. Quarterly CMP-08. So much simpler than monthly filing. Saves time and money. Perfect for small restaurants.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div>
                    ...
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Owner, Eatery, Udyog Vihar</div>
                    <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                </div>
        ...
        <div class="reviews-cta" style="margin-top: 16px; display: flex !important;">
            <div class="reviews-cta-content">
                ...
                <div class="reviews-cta-text">
                    ...
                    <p>Trusted restaurant GST filing partner serving 300+ restaurant clients across Gurugram.</p>
                </div>
            </div>
...
<div class="stats-bar">
    <div class="stats-container">
        <div class="stat-item">
            ...
            <div class="stat-content"><span class="stat-value">10,000+</span><span class="stat-label">Businesses Served</span><span class="stat-desc">Restaurant GST compliance across India.</span></div>
        </div>
        <div class="stat-item">
            <div class="stat-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8M12 17v4"/></svg></div>
            <div class="stat-content"><span class="stat-value">15+</span><span class="stat-label">Years Experience</span><span class="stat-desc">Deep expertise in restaurant GST rates, S9(5), and composition scheme.</span></div>
        </div>
        <div class="stat-item">
            <div class="stat-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><path d="M14 2v6h6M16 13H8M16 17H8"/></svg></div>
            <div class="stat-content"><span class="stat-value">50,000+</span><span class="stat-label">Documents Filed</span><span class="stat-desc">Restaurant GST returns, platform reconciliations, and compliance documents handled.</span></div>
        </div>
        <div class="stat-item">
            <div class="stat-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="8" r="7"/><path d="M8.21 13.89L7 23l5-3 5 3-1.21-9.12"/></svg></div>
            <div class="stat-content"><span class="stat-value">4.9&#9733;</span><span class="stat-label">Client Rating</span><span class="stat-desc">Trusted by restaurants, cloud kitchens, QSR chains, and hotel F&B operations.</span></div>
        </div>
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                <div class="highlight-box" style="margin-bottom:20px;">
                    <p><strong>&#128204; TL;DR - Restaurant GST Return Services at a Glance</strong></p>
                    <p>Restaurants in Gurugram pay GST at 5% (without ITC) or 18% (hotel restaurants with room tariff Rs 7,500+). Monthly GSTR-1 and GSTR-3B for regular scheme. Composition (up to Rs 1.5 crore): quarterly CMP-08 and annual GSTR-4. Since January 2022, Swiggy and Zomato collect 5% GST under Section 9(5). Late fee Rs 50/day. Incorrect ITC claim at 5% = full reversal with interest.</p>
                </div>
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Parameter</th><th>Detail</th></tr></thead>
                    <tbody>
                        <tr><td>Governing Law</td><td>CGST Act 2017 | HGST Act | Notification 11/2017-CT(R) | S9(5) | S10 Composition</td></tr>
                        ...
                        <tr><td>Form</td><td>GSTR-1/3B (regular) | CMP-08 (composition quarterly) | GSTR-4 (composition annual) | GSTR-9</td></tr>
                ...
                <p>Gurugram is one of NCR's most vibrant food corridors. Cyber Hub and Golf Course Road house premium dining. Sector 29 has 100+ restaurants. Sohna Road and Udyog Vihar have growing cloud kitchens. NH-48 hotel corridor has 18% GST restaurants. For comprehensive information about <a href="#">restaurant GST returns across India</a>, visit our national service page.</p>
                <p>Every missed deadline = Rs 50/day late fee plus 18% interest. Restaurants incorrectly claiming ITC at 5% face full reversal demands. GST Commissionerate Gurugram is scrutinising Swiggy/Zomato reconciliation. You will also need <a href="/gst-registration">GST registration</a> and <a href="/fssai-registration">FSSAI registration</a> for complete restaurant compliance.</p>
        ...
        <div class="two-column">
            <div class="column-content">
                ...
                <div class="content-text what-is-definition">
                    <p>A GST return for restaurants is a periodic declaration filed on gst.gov.in reporting all food and beverage sales, ITC claimed (if eligible at 18%), and net tax payable. Restaurant services are classified under HSN/SAC 9963 at either 5% or 18%.</p>
                    <p>Standalone restaurants pay 5% GST without ITC. Hotel restaurants (room tariff Rs 7,500+) pay 18% with full ITC. Swiggy/Zomato collect 5% under S9(5). Composition scheme: 1% on turnover, quarterly CMP-08.</p>
                    <p>Return filing involves dine-in, takeaway, platform-mediated (S9(5)), and catering sales. For complete restaurant compliance, pair with <a href="/fssai-registration">FSSAI registration</a> and <a href="/shop-act-registration">shop act registration</a>.</p>
                </div>
                <div class="highlight-box" style="margin-top:20px;">
                    <p><strong>Key Terms for Copyright Registration:</strong></p>
                    <ul>
                        <li><strong>GSTR-1</strong> - Monthly outward supply return for restaurants (by 11th)</li>
                        <li><strong>S9(5)</strong> - Swiggy/Zomato collect 5% GST on food delivery</li>
                        <li><strong>CMP-08</strong> - Quarterly composition scheme return (up to Rs 1.5 Cr)</li>
                        <li><strong>HSN 9963</strong> - Restaurant and food services classification code</li>
                        <li><strong>ITC</strong> - Available only at 18% rate, not at 5% standalone rate</li>
                    </ul>
                </div>
            </div>
...
<section class="content-section" id="who-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Who Needs Restaurant GST Returns in Gurugram</h2>
            <div class="content-text">
                <ul>
                    <li><strong>Premium restaurants in DLF Cyber Hub and Golf Course Road</strong>. Multi-outlet chains. 5% GST. High-volume POS data. Swiggy/Zomato reconciliation for delivery orders.</li>
                    <li><strong>Sector 29 restaurants and bars</strong>. 100+ F&B outlets. 5% GST on food. Liquor under state excise (not GST). Mixed billing requires careful segregation.</li>
                    ...
                    <li><strong>Hotel restaurants along NH-48</strong> (Leela, Oberoi, Westin). 18% GST with ITC. Room tariff Rs 7,500+. Full ITC on ingredients, rent, equipment.</li>
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <table>
                    ...
                    <tbody>
                        <tr><td>Monthly GSTR-1 Filing</td><td>Dine-in, takeaway, catering, platform supplies. Rate classification (5%/18%). Operator GSTIN for Swiggy/Zomato.</td></tr>
                        <tr><td>Monthly GSTR-3B Filing</td><td>Output tax. ITC reconciliation (18% only). Zero ITC for 5%. Net tax payment. By 20th.</td></tr>
                        <tr><td>CMP-08 (Composition)</td><td>Quarterly return for small restaurants. Turnover and flat 1% tax. Up to Rs 1.5 crore. Simplified.</td></tr>
                        <tr><td>S9(5) Platform Reconciliation</td><td>Swiggy/Zomato settlement reports matched with GSTR-1. No double-reporting. Discrepancy resolution.</td></tr>
                        <tr><td>ITC Management (18%)</td><td>Full ITC for hotel restaurants. Ingredients, equipment, rent, utilities. GSTR-2B reconciliation.</td></tr>
                        <tr><td>Multi-Outlet and Rate Advisory</td><td>Separate GSTIN per outlet. 5% vs 18% classification. Composition vs regular scheme decision.</td></tr>
...
<section class="steps-section" id="procedure-section">
    <div class="section-container">
        <header class="section-header" style="text-align:center;margin-bottom:48px;">
            ...
            <h2 class="section-title">How Restaurant GST Filing Works: 5-Step Process</h2>
            <p class="section-subtitle" style="text-align:left;max-width:100%;">Our CA-led team handles 5%/18% rate classification, GSTR-1/3B, S9(5) Swiggy/Zomato reconciliation, composition CMP-08, and ITC management for Gurugram restaurants.</p>
        </header>
        <div class="steps-container">
            <div class="step-card">
                <div class="step-content">
                    <span class="step-badge">Step 1</span>
                    <h3 class="step-title">Classify Rate and Scheme</h3>
                    <p class="step-description">5% standalone vs 18% hotel. Regular vs composition. Rate determines ITC eligibility and filing frequency.</p>
                    <div class="step-highlights">
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Rate Set</span>
                ...
                <div class="step-visual">
                    <div class="step-illustration">
                        ...
                        <span class="illustration-label">5% or 18%</span>
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">Compile Sales Data</h3>
                    <p class="step-description">POS data. Swiggy/Zomato reports. Catering invoices. Segregate food from liquor. Classify by rate.</p>
                    <div class="step-highlights">
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>POS Data</span>
                ...
                <div class="step-visual">
                    <div class="step-illustration">
                        ...
                        <span class="illustration-label">Sales Ready</span>
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">File GSTR-1 or CMP-08</h3>
                    <p class="step-description">Report outward supplies. Platform sales with operator GSTIN. Direct sales. By 11th (regular) or quarterly.</p>
                    <div class="step-highlights">
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>GSTR-1 Filed</span>
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>11th Done</span>
                    </div>
                </div>
                <div class="step-visual">
                    <div class="step-illustration">
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">File GSTR-3B and Pay Tax</h3>
                    <p class="step-description">Output tax. ITC claim (18% only). Zero ITC for 5%. Net tax. By 20th. NIL if no transactions.</p>
                    <div class="step-highlights">
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>3B Filed</span>
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Tax Paid</span>
                    </div>
                </div>
                <div class="step-visual">
                    <div class="step-illustration">
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">Reconcile Platform Data</h3>
                    <p class="step-description">Match Swiggy/Zomato settlement with GSTR-1. No double-reporting. Resolve discrepancies monthly.</p>
                    <div class="step-highlights">
                ...
                <div class="step-visual">
                    <div class="step-illustration">
                        ...
                        <span class="illustration-label">Platform OK</span>
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">Annual Return</h3>
                    <p class="step-description">GSTR-9 (regular) or GSTR-4 (composition). Reconcile with books. Annual compliance clean.</p>
                    <div class="step-highlights">
        ...
        <div class="highlight-box" style="margin-top:32px;max-width:1000px;margin-left:auto;margin-right:auto;">
            <p><strong>City Processing Note:</strong> Patron's Gurugram office serves 300+ restaurant clients with GST filing, rate classification, and platform reconciliation across Gurugram.</p>
        </div>
    </div>
</section>
...
<section class="content-section" id="documents-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <ul>
                    <li><strong>POS Sales Data:</strong> Dine-in, takeaway, catering invoices. Platform vs direct sales segregation.</li>
                    <li><strong>Platform Reports:</strong> Swiggy/Zomato settlement reports with S9(5) GST details.</li>
                    <li><strong>Purchase Invoices:</strong> Ingredients, equipment, rent (for 18% ITC restaurants only).</li>
                    <li><strong>Additional:</strong> Composition declaration (if applicable) | Hotel room tariff proof | Liquor vs food segregation.</li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <table>
                    ...
                    <tbody>
                        <tr><td>ITC Claimed at 5% Rate</td><td>Restaurant at 5% GST claims ITC on purchases. Error: 5% = no ITC. Full reversal demand with interest</td><td>5% restaurants cannot claim ITC on anything. Zero ITC. If you need ITC, check if 18% applies (hotel, catering).</td></tr>
                        <tr><td>S9(5) Reconciliation Failure</td><td>Cloud kitchen reports Swiggy sales in GSTR-1 but Swiggy already deposited GST under S9(5). Double-reporting</td><td>Match platform settlement reports with GSTR-1. S9(5) supplies reported separately. No double GST payment.</td></tr>
                        <tr><td>Composition Scheme Violations</td><td>Restaurant under composition supplies inter-state (not allowed) or exceeds Rs 1.5 crore without switching</td><td>Monitor turnover. Switch to regular before crossing Rs 1.5 crore. No inter-state supply under composition.</td></tr>
                        <tr><td>Rate Misclassification</td><td>Hotel restaurant charges 5% when room tariff is Rs 7,500+. Should be 18%. Or vice versa. Incorrect rate = notice</td><td>Check room tariff quarterly. Rs 7,500+ = 18% with ITC. Below = 5% no ITC. Document classification basis.</td></tr>
                        <tr><td>Liquor Revenue Mixed with Food GST</td><td>Sector 29 bar includes liquor in GST invoices. Liquor is state excise not GST. Over-reporting GST turnover</td><td>Segregate food (GST) from liquor (state excise). Bill separately. Only food attracts GST. POS configuration.</td></tr>
                    </tbody>
                </table>
                </div>
            </div>
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <table class="table-amount">
                    ...
                    <tbody>
                        <tr><td>Monthly GSTR-1 + GSTR-3B (Regular)</td><td>From Rs 2,499/month</td></tr>
                        <tr><td>Quarterly CMP-08 (Composition)</td><td>From Rs 1,999/quarter</td></tr>
                        <tr><td>Annual GSTR-9 / GSTR-4</td><td>Rs 3,000-8,000</td></tr>
                        <tr><td>S9(5) Platform Reconciliation</td><td>Rs 1,000-2,500/month (included in bundle)</td></tr>
                        <tr><td>Multi-Outlet (per additional GSTIN)</td><td>Rs 1,999-4,999/month</td></tr>
                        <tr><td>Rate Classification Advisory</td><td>Rs 2,000-5,000 (one-time)</td></tr>
                ...
                <p style="margin-top:16px;">No government fee for filing. Late fee Rs 50/day. Professional fees cover POS data compilation, platform reconciliation, filing, and rate advisory.</p>
                <p style="margin-top:16px;"><strong>Get a free Copyright Registration consultation - <a href="tel:+919459456700">Call +91 945 945 6700</a> or <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20help%20with%20GST%20Restaurant%20Returns%20in%20Gurugram.%20Please%20share%20fee%20details." target="_blank">WhatsApp us</a>. No-obligation assessment.</strong></p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <table>
                    ...
                    <tbody>
                        <tr><td>GSTR-1 (Regular)</td><td>By 11th of following month</td></tr>
                        <tr><td>GSTR-3B (Regular)</td><td>By 20th of following month</td></tr>
                        <tr><td>CMP-08 (Composition)</td><td>18th of month after quarter end</td></tr>
                        <tr><td>GSTR-4 (Composition Annual)</td><td>By 30th April</td></tr>
                        <tr><td>GSTR-9 (Regular Annual)</td><td>By December 31</td></tr>
                        <tr><td>Platform Reconciliation</td><td>Before each GSTR-1 filing</td></tr>
                        <tr><td>Late Fee</td><td>Rs 50/day. 18% interest. 2 months = suspension</td></tr>
                    </tbody>
                </table>
                </div>
                <div class="highlight-box" style="margin-top:16px;">
                    <p><strong>Note:</strong> GSTR-1 by 11th. GSTR-3B by 20th. CMP-08 quarterly. GSTR-4/9 annually Dec 31. Platform reconciliation before each filing.</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="why-choose-section" id="benefits-section">
    <div class="section-container">
        <div style="text-align:center;margin-bottom:48px;">
            ...
            <h2 class="section-title">Why Choose Patron for Restaurant GST in Gurugram</h2>
        </div>
        <div class="features-grid">
            <article class="feature-card">
                ...
                <h3 class="feature-title">Rate Classification</h3>
                <p class="feature-text">5% vs 18% advisory. Hotel room tariff check. Composition eligibility. Correct rate prevents ITC reversal demands.</p>
            </article>
            <article class="feature-card">
                ...
                <h3 class="feature-title">S9(5) Reconciliation</h3>
                <p class="feature-text">Swiggy/Zomato settlement matched with GSTR-1. No double-reporting. Platform GST properly accounted.</p>
            </article>
            <article class="feature-card">
                ...
                <h3 class="feature-title">ITC Management</h3>
                <p class="feature-text">Full ITC for 18% hotel restaurants. Ingredients, equipment, rent. GSTR-2B reconciliation. Zero ITC at 5%.</p>
            </article>
            <article class="feature-card">
                <div class="feature-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg></div>
                <h3 class="feature-title">Composition Scheme</h3>
                <p class="feature-text">1% flat tax for small restaurants. CMP-08 quarterly. GSTR-4 annual. Simplified compliance under Rs 1.5 crore.</p>
            </article>
            <article class="feature-card">
                ...
                <h3 class="feature-title">Multi-Outlet Filing</h3>
                <p class="feature-text">Separate returns per GSTIN. Chain restaurants across Cyber Hub, Sector 29, Golf Course Road. Consolidated management.</p>
            </article>
            <article class="feature-card">
                ...
                <h3 class="feature-title">Liquor Segregation</h3>
                <p class="feature-text">Food GST vs liquor excise separated. POS configured correctly. Only food in GST returns. Clean billing.</p>
            </article>
        </div>
    </div>
</section>
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <table class="table-comparison">
                    <thead><tr><th>Restaurant Type</th><th>GST Rate / ITC / Gurugram Context</th></tr></thead>
                    <tbody>
                        <tr><td>Standalone (AC/non-AC)</td><td>5% (2.5%+2.5%). No ITC. Cyber Hub, Sector 29, Golf Course Road</td></tr>
                        <tr><td>Cloud Kitchen</td><td>5%. No ITC. Sohna Road, Udyog Vihar delivery kitchens</td></tr>
                        <tr><td>Hotel Restaurant (Rs 7,500+)</td><td>18% (9%+9%). Full ITC. NH-48 hotel corridor</td></tr>
                        <tr><td>Outdoor Catering</td><td>18%. ITC. Corporate catering for Cyber City</td></tr>
                        <tr><td>Composition Scheme</td><td>1% flat. No ITC. Small eateries under Rs 1.5 crore</td></tr>
                        <tr><td>Takeaway / Delivery</td><td>Same 5% as dine-in for all outlets</td></tr>
                    </tbody>
                </table>
                </div>
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                <ul>
                    ...
                    <li><a href="/fssai-registration">FSSAI Registration</a> - Food license for restaurants, cloud kitchens, and catering</li>
...
<section class="content-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>Restaurant GST is governed by the <strong>CGST Act 2017</strong> and <strong>HGST Act 2017</strong>. <strong>Notification 11/2017-CT(R)</strong> prescribes rates. <strong>Section 9(5)</strong> makes Swiggy/Zomato liable for food delivery GST. <strong>Section 10</strong> governs composition scheme for restaurants up to Rs 1.5 crore.</p>
                <p>5% GST under <strong>Notification 11/2017 Entry 6(b)</strong>: no ITC condition. 18% for hotel restaurants per <strong>Entry 7(ix)</strong>: room tariff Rs 7,500+, full ITC. Composition at 1% under <strong>S10</strong>. Late fee <strong>S47</strong>: Rs 50/day. Interest <strong>S50</strong>: 18%.</p>
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    <h2 class="faq-expanded__title">FAQs - Restaurant GST Returns in Gurugram</h2>
                    <p class="faq-expanded__lead">Answers to common questions about restaurant GST returns including 5% vs 18% rates, Swiggy/Zomato S9(5), composition scheme, and ITC for Gurugram restaurants.</p>
                    @include('partials.faq-enquiry-form', ['enquiryLocation' => 'Gurugram', 'enquiryService' => 'Restaurant GST Returns in Gurugram'])
                </aside>
                <div class="faq-expanded__list">
                    <div class="faq-expanded__item" id="faq-1">
                        <h3 class="faq-expanded__q">What is the GST rate for restaurants in Gurugram?</h3>
                        <div class="faq-expanded__a"><p>Standalone restaurants (AC or non-AC, dine-in or takeaway) pay 5% GST (2.5% CGST plus 2.5% SGST) without ITC. Hotel restaurants where room tariff is Rs 7,500 or above pay 18% GST with full ITC. Cloud kitchens pay the same 5% as regular restaurants. Composition scheme restaurants pay 1% flat on turnover.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-2">
                        <h3 class="faq-expanded__q">How much does restaurant GST filing cost?</h3>
                        <div class="faq-expanded__a"><p>Monthly GSTR-1 plus 3B from Rs 2,499 per month. Composition CMP-08 from Rs 1,999 per quarter. Annual GSTR-9 or GSTR-4: Rs 3,000-8,000. Multi-outlet per additional GSTIN: Rs 1,999-4,999 per month. Annual bundle from Rs 29,999. Call +91 945 945 6700 for a detailed quote.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-3">
                        <h3 class="faq-expanded__q">How does Swiggy and Zomato GST work under Section 9(5)?</h3>
                        <div class="faq-expanded__a"><p>Total timeline: 2-6 months. Filing and Diary Number: immediate. Mandatory 30-day objection waiting period: 1 month. Reconcile Platform Data: 1-3 months. Certificate issuance: after examination approval. If a third-party objection is filed, the timeline extends by 2-4 months for hearing and resolution.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-4">
                        <h3 class="faq-expanded__q">Can restaurants claim ITC at 5% GST?</h3>
                        <div class="faq-expanded__a"><p>No. Restaurants paying 5% GST cannot claim Input Tax Credit on any purchases whatsoever, including ingredients, rent, equipment, or utilities. The 5% rate is specifically conditioned on non-availment of ITC. ITC is only available at the 18% rate applicable to hotel restaurants (room tariff Rs 7,500+) and outdoor catering services.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-5">
                        <h3 class="faq-expanded__q">What is the composition scheme for restaurants?</h3>
                        <div class="faq-expanded__a"><p>Available for restaurants with aggregate turnover up to Rs 1.5 crore under Section 10 of the CGST Act. Flat 1% tax on turnover (0.5% CGST plus 0.5% SGST). Quarterly CMP-08 filing and annual GSTR-4. No ITC available. Cannot make inter-state supplies. Simplified compliance for small eateries and dhabas in Gurugram.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-6">
                        <h3 class="faq-expanded__q">Do cloud kitchens in Gurugram pay different GST?</h3>
                        <div class="faq-expanded__a"><p>No. Cloud kitchens pay the same 5% GST as regular standalone restaurants under HSN 9963. They are classified as restaurant service providers regardless of being delivery-only. They must file GSTR-1 and GSTR-3B monthly. Platform reconciliation with Swiggy and Zomato is critical because cloud kitchens typically have 100% platform-mediated sales.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-7">
                        <h3 class="faq-expanded__q">What are the penalties for late restaurant GST filing?</h3>
                        <div class="faq-expanded__a"><p>Rs 50 per day late fee (Rs 25 CGST plus Rs 25 SGST), capped at Rs 5,000 per return under Section 47. Plus 18% interest per annum on any outstanding tax under Section 50. Missing GSTR-3B for 2 consecutive months triggers GSTIN suspension, halting all restaurant operations including billing and e-way bills.</p></div>
                    </div>
                </div>
            </div>
            ...
            <div class="highlight-box" style="margin-top:32px;">
                ...
                <p><strong>Restaurant ka GST kitna hai?</strong> Standalone: 5% bina ITC. Hotel (room Rs 7,500+): 18% with ITC. Cloud kitchen: 5%. Composition: 1% on turnover.</p>
                <p><strong>Swiggy/Zomato pe GST kaun bharta hai?</strong> S9(5) ke tahat platform collect aur deposit karta hai 5% GST. Restaurant ko GSTR-1 mein report karna hota hai.</p>
                <p><strong>Cloud kitchen ka GST alag hai?</strong> Nahi, 5% GST - regular restaurant jaisa. GSTR-1/3B monthly. Platform reconciliation zaroori hai.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section" style="background: var(--orange-lighter) !important; border-left: 4px solid var(--orange);">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Why Restaurant GST Returns Matter in Gurugram</h2>
            <div class="content-text">
                <p>Every missed return deadline costs Rs 50/day in late fees under S47 plus 18% interest under S50. Restaurants incorrectly claiming ITC at 5% face full reversal demands. From July 2025, returns older than three years cannot be filed. GST Commissionerate Gurugram is scrutinising Swiggy/Zomato reconciliation data. File on time, classify correctly, and reconcile platform reports.</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text" style="text-align:left;">
                <p style="color:rgba(255,255,255,0.85);">GST return filing for restaurants in Gurugram covers rate classification (5%/18%), monthly GSTR-1 and GSTR-3B, Section 9(5) Swiggy/Zomato reconciliation, composition CMP-08, ITC management, and multi-outlet compliance for Gurugram's restaurant ecosystem.</p>
                <p style="color:rgba(255,255,255,0.85);">Patron Accounting's Gurugram office on Golf Course Extension Road serves 300+ restaurant clients with 5%/18% rate classification, S9(5) reconciliation, composition scheme, and multi-outlet GST management for restaurants across Gurugram.</p>
            ...
            <div style="display:flex;gap:14px;flex-wrap:wrap;margin-top:24px;">
                ...
                <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20help%20with%20GST%20Restaurant%20Returns%20in%20Gurugram.%20Please%20share%20details." target="_blank" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:#25D366;color:#fff;border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#128172; WhatsApp Us</a>
                <a href="mailto:sales@patronaccounting.com?subject=Enquiry%20for%20GST%20Restaurant%20Returns%20in%20Gurugram&body=Hello%20Patron%20Accounting%20Team%2C%0A%0AI%20am%20interested%20in%20your%20GST%20Restaurant%20Returns%20services%20in%20Gurugram%20and%20would%20like%20to%20know%20more.%0A%0APlease%20get%20in%20touch%20with%20me%20at%20your%20earliest%20convenience.%0A%0AThank%20you." style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:transparent;color:#fff;border:2px solid rgba(255,255,255,0.3);border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#9993;&#65039; Email Us</a>
            </div>
...
<section class="content-section" style="padding:48px 32px;background:var(--gray-50);">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title" style="text-align:center;margin-bottom:12px;">Restaurant GST Returns Across India</h2>
            <p style="text-align:center;color:var(--text-muted);font-size:15px;margin-bottom:40px;">Restaurant GST return services available across India with local office support.</p>
            ...
            <div class="pa-city-block">
                ...
                <div class="pa-block-sub">End-to-end support for Restaurant GST Returns in Gurugram</div>
...
<section class="content-section" style="padding:32px;">
    <div class="content-container">
        <div class="text-content" style="font-size:13px;color:var(--text-muted);">
            ...
            <p>This page is reviewed quarterly for accuracy. CGST Act restaurant provisions, GST rates, S9(5) rules, composition scheme, and ITC eligibility are verified against current notifications. Gurugram restaurant landscape is validated with each review.</p>
        </div>
    </div>
</section>
