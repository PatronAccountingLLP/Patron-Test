...
@section('meta')
    ...
    <meta property="og:image" content="/images/gst-returns-restaurants-mumbai-og.webp">
    ...
    <meta name="twitter:image" content="/images/gst-returns-restaurants-mumbai-og.webp">
@endsection
  ...
  "@graph": [
    {
      ...
      "url": "/gst-returns-for-restaurants-food-businesses/mumbai",
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - Restaurant GST Returns'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="gst-returns-for-restaurants/mumbai" selected>Restaurant GST Returns Mumbai</option>
