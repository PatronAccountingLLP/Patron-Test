...
@section('meta')
    ...
    <meta property="og:image" content="/images/gst-returns-for-sez-gurugram-og.webp">
    ...
    <meta name="twitter:image" content="/images/gst-returns-for-sez-gurugram-og.webp">
@endsection
  ...
  "@graph": [
    {
      ...
      "url": "/gst-returns-for-sez/gurugram",
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-4 private-registration-heading">
                        GST Returns for SEZ in Gurugram: Zero-Rated Supply, LUT, and Refund Compliance
                    </h1>
                    ...
                    <div class="mb-4">
                        <div class="d-flex align-items-start mb-3">
                            ...
                            <p class="mb-0 text-dark benefit-paragraph"><span>Documents:</span> SEZ endorsement, LUT copy, IGST invoices, authorized operation documents, dual GSTIN records</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Fees:</span> SEZ unit: from Rs 3,000/month. DTA supplier: from Rs 3,000/month. IGST refund: from Rs 4,999</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Eligibility:</span> SEZ units, SEZ developers, and DTA suppliers making supplies to Gurugram SEZs</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Timeline:</span> GSTR-1: by 11th. GSTR-3B: by 20th. LUT: before FY start. IGST refund: within 2 years</p>
                        </div>
                    </div>
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="mailto:sales@patronaccounting.com?subject=Enquiry%20for%20GST%20SEZ%20Returns%20in%20Gurugram&body=Hello%20Patron%20Accounting%20Team%2C%0A%0AI%20am%20interested%20in%20your%20GST%20SEZ%20Returns%20services%20in%20Gurugram%20and%20would%20like%20to%20know%20more.%0A%0APlease%20get%20in%20touch%20with%20me%20at%20your%20earliest%20convenience.%0A%0AThank%20you." class="btn-sample text-decoration-none">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:18px;height:18px;"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,12 2,6"/></svg>
                            Email Us
                        </a>
                        <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20help%20with%20GST%20SEZ%20Returns%20in%20Gurugram.%20Please%20share%20details." target="_blank" class="btn-sample text-decoration-none">
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - GST SEZ Returns Gurugram'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="gst-returns-for-sez/gurugram" selected>GST Returns for SEZ in Gurugram</option>
...
<section class="testimonials-section">
    <div class="section-container">
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            ...
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">We operate in DLF Cyber City SEZ and have a DTA office on Golf Course Road. Patron manages both GSTINs, files separate returns, and ensures no transaction mixing. Zero notices in 4 years of dual registration.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div>
                    ...
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">CFO, IT Company, DLF Cyber City SEZ</div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">DTA supplier to 3 Gurugram SEZs. Patron files our zero-rated GSTR-1 with Table 6A every month. LUT renewal handled automatically. Endorsed supply certificates compiled for every transaction. IGST refund when we choose that route.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div>
                    ...
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Director, IT Vendor, Golf Course Road</div>
                    <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                </div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">We missed LUT renewal once. IGST payable on everything until filed. Cash flow nightmare. Patron now handles LUT renewal 30 days before deadline. Never missed again. Small thing, huge impact.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div>
                    ...
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Head of Compliance, SEZ Unit, ASF Insignia</div>
                    <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                </div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Our endorsed supply documentation was incomplete for 2 quarters. Audit flagged it. Patron helped reconstruct endorsements, filed corrected returns, and now maintains endorsement checklist per supply. Systematic.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div>
                    ...
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Manager, DTA Supplier, Udyog Vihar</div>
                    <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                </div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">SEZ export unit. Patron handles GSTR-1/3B, LUT, and ITC refund quarterly. Rs 1.5 crore in ITC recovered over 2 years. Export compliance integrated with SEZ GST. Complete solution.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div>
                    ...
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">CEO, IT/ITES, Candor TechSpace SEZ</div>
                    <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                </div>
        ...
        <div class="reviews-cta" style="margin-top: 16px; display: flex !important;">
            <div class="reviews-cta-content">
                ...
                <div class="reviews-cta-text">
                    ...
                    <p>Trusted SEZ GST compliance partner for 28 notified SEZs across Gurugram.</p>
                </div>
            </div>
...
<div class="stats-bar">
    <div class="stats-container">
        <div class="stat-item">
            ...
            <div class="stat-content"><span class="stat-value">10,000+</span><span class="stat-label">Businesses Served</span><span class="stat-desc">SEZ GST compliance and zero-rated supply across India.</span></div>
        </div>
        <div class="stat-item">
            <div class="stat-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8M12 17v4"/></svg></div>
            <div class="stat-content"><span class="stat-value">15+</span><span class="stat-label">Years Experience</span><span class="stat-desc">Deep expertise in SEZ GST, zero-rated supply, LUT, and IGST refund.</span></div>
        </div>
        <div class="stat-item">
            <div class="stat-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><path d="M14 2v6h6M16 13H8M16 17H8"/></svg></div>
            <div class="stat-content"><span class="stat-value">50,000+</span><span class="stat-label">Documents Filed</span><span class="stat-desc">SEZ GST returns, LUT filings, and refund applications handled.</span></div>
        </div>
        <div class="stat-item">
            <div class="stat-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="8" r="7"/><path d="M8.21 13.89L7 23l5-3 5 3-1.21-9.12"/></svg></div>
            <div class="stat-content"><span class="stat-value">4.9&#9733;</span><span class="stat-label">Client Rating</span><span class="stat-desc">Trusted by SEZ units, DTA suppliers, and SEZ developers.</span></div>
        </div>
...
<section class="content-section" id="overview-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Why SEZ GST Returns Matter in Gurugram</h2>
            <div class="content-text">
                <div class="highlight-box" style="margin-bottom:20px;">
                    <p><strong>&#128204; TL;DR - SEZ GST Return Services at a Glance</strong></p>
                    <p>Supplies to SEZ units and developers are zero-rated under Section 16 of the IGST Act 2017. DTA suppliers can supply under LUT without IGST or pay IGST and claim refund. SEZ units need separate GSTIN and file GSTR-1, GSTR-3B monthly, GSTR-9 annually. Services imported by SEZ for authorized operations are exempt under Notification 18/2017-IT(R). LUT filed annually in Form RFD-11. Gurugram hosts 28 notified SEZs.</p>
                </div>
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Parameter</th><th>Detail</th></tr></thead>
                    <tbody>
                        <tr><td>Governing Law</td><td>IGST Act S16 (zero-rated) | SEZ Act 2005 | CGST Act S25 (dual GSTIN) | Notif 18/2017-IT(R)</td></tr>
                        ...
                        <tr><td>Form</td><td>GSTR-1 Table 6A/6B | GSTR-3B | RFD-11 (LUT) | RFD-01 (IGST refund) | GSTR-9</td></tr>
                ...
                <p>Gurugram hosts 28 notified SEZs - the highest concentration in Haryana. DLF Cyber City SEZ hosts major tech companies. ASF Insignia SEZ attracts export-oriented IT. Candor TechSpace serves IT/ITES. DTA suppliers across Golf Course Road, Udyog Vihar, and Sohna Road service these SEZs. For comprehensive information about <a href="/gst-returns-for-sez">SEZ GST returns across India</a>, visit our national service page.</p>
                <p>LUT for FY 2026-27 must be filed by March 31, 2026. Missing = upfront IGST on all SEZ supplies. IGST refund claims expire in 2 years. Endorsed supply documentation under increasing scrutiny. You will also need <a href="/gst-registration">GST registration</a> (separate for SEZ) and <a href="#">monthly GST return filing</a> for complete compliance.</p>
        ...
        <div class="two-column">
            <div class="column-content">
                ...
                <div class="content-text what-is-definition">
                    <p>GST returns for SEZ are periodic declarations filed by SEZ units, developers, and DTA suppliers reporting zero-rated supplies, inter-state supplies, ITC, and refund claims under Section 16 of the IGST Act 2017. SEZs are outside customs territory for supply purposes.</p>
                    <p>DTA suppliers have two options: supply under LUT without IGST and claim ITC refund, or pay IGST and claim full IGST refund. Both require accurate GSTR-1 Table 6A/6B reporting and GSTR-3B classification.</p>
                    <p>SEZ to DTA clearances attract IGST as inter-state supply. Separate GSTIN mandatory for SEZ. For complete SEZ compliance, pair with <a href="/gst-refund">GST refund</a> services and <a href="/gst-registration">GST registration</a>.</p>
                </div>
                <div class="highlight-box" style="margin-top:20px;">
                    <p><strong>Key Terms for Copyright Registration:</strong></p>
                    <ul>
                        <li><strong>Table 6A/6B</strong> - GSTR-1 tables for zero-rated SEZ supply reporting</li>
                        <li><strong>Zero-Rated</strong> - 0% GST on supplies to SEZ under S16 IGST</li>
                        <li><strong>LUT (RFD-11)</strong> - Annual LUT for supply without IGST payment</li>
                        <li><strong>DTA</strong> - Domestic Tariff Area outside SEZ boundaries</li>
                        <li><strong>Endorsed Supply</strong> - SEZ authority confirmation for authorized operations</li>
                    </ul>
                </div>
            </div>
            <div class="column-image">
                <div class="illustration-placeholder">
                    ...
                    <div class="illustration-badge">
                        <span>GST Portal / SEZ Online</span>
                        <strong>SEZ Compliance</strong>
                    </div>
                </div>
            </div>
        </div>
...
<section class="content-section" id="who-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Who Needs SEZ GST Returns in Gurugram</h2>
            <div class="content-text">
                <ul>
                    <li><strong>SEZ units in DLF Cyber City SEZ</strong>. Separate GSTIN. Monthly GSTR-1/3B. Zero-rated inward from DTA. IGST on DTA clearances. IT/ITES export services.</li>
                    <li><strong>DTA suppliers to Gurugram SEZs</strong>. IT vendors, infrastructure providers, service companies supplying to SEZ units. LUT or IGST route. Table 6A/6B reporting.</li>
                    ...
                    <li><strong>IT companies with dual presence</strong> (SEZ + DTA) on Golf Course Road and Cyber City. Separate GSTINs and returns for each registration. Common in Gurugram.</li>
...
<section class="content-section" id="services-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">8 SEZ GST Return Services Included</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Service</th><th>What We Do</th></tr></thead>
                    <tbody>
                        <tr><td>Monthly GSTR-1 + GSTR-3B (SEZ)</td><td>SEZ unit returns with zero-rated inward, DTA clearances (IGST), export supplies. Proper classification.</td></tr>
                        <tr><td>DTA Supplier Zero-Rated Filing</td><td>GSTR-1 Table 6A (LUT) or 6B (IGST). GSTR-3B with zero-rated adjustments. Endorsed supply matching.</td></tr>
                        <tr><td>LUT Filing (Form RFD-11)</td><td>Annual LUT before FY start. Renewal. Zero-rated without IGST. Missing deadline = cash flow disruption.</td></tr>
                        <tr><td>IGST Refund (Form RFD-01)</td><td>Refund for IGST paid on SEZ supplies. Endorsed certificates. 2-year limitation. 90% provisional.</td></tr>
                        <tr><td>Dual GSTIN Management</td><td>Separate filing for SEZ and DTA registrations. No mixing of transactions. Separate books and returns.</td></tr>
                        <tr><td>Annual Return + E-Way Bill</td><td>GSTR-9 annual. E-way bill for goods movement DTA-SEZ (above Rs 50,000). Endorsed supply documentation.</td></tr>
...
<section class="steps-section" id="procedure-section">
    <div class="section-container">
        <header class="section-header" style="text-align:center;margin-bottom:48px;">
            ...
            <h2 class="section-title">How SEZ GST Filing Works: 5-Step Process</h2>
            <p class="section-subtitle" style="text-align:left;max-width:100%;">Our CA-led team handles SEZ unit returns, DTA supplier zero-rated filing, LUT management, IGST refund, and dual GSTIN coordination for Gurugram SEZ businesses.</p>
        </header>
        <div class="steps-container">
            <div class="step-card">
                <div class="step-content">
                    <span class="step-badge">Step 1</span>
                    <h3 class="step-title">Classify SEZ Transaction</h3>
                    <p class="step-description">DTA to SEZ (zero-rated), SEZ to DTA (IGST), intra-SEZ, inter-SEZ, or export. Classification determines filing.</p>
                    <div class="step-highlights">
                        ...
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>SEZ/DTA</span>
                    </div>
                </div>
                <div class="step-visual">
                    <div class="step-illustration">
                        ...
                        <span class="illustration-label">Transaction</span>
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">File LUT Annually</h3>
                    <p class="step-description">Form RFD-11 before FY start. Enables zero-rated without IGST. Annual renewal. March 31 deadline.</p>
                    <div class="step-highlights">
                        ...
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>RFD-11 OK</span>
                    </div>
                </div>
                <div class="step-visual">
                    <div class="step-illustration">
                        ...
                        <span class="illustration-label">LUT Ready</span>
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">File GSTR-1 with SEZ Tables</h3>
                    <p class="step-description">Table 6A (LUT route) or 6B (IGST route). DTA clearances in Table 4. Endorsed supply details. By 11th.</p>
                    <div class="step-highlights">
                        ...
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Table 6A/6B</span>
                    </div>
                </div>
                <div class="step-visual">
                    <div class="step-illustration">
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <p class="step-description">Output tax. ITC. Zero-rated adjustments. IGST on DTA clearances. Separate SEZ and DTA returns. By 20th.</p>
                    <div class="step-highlights">
                        ...
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Separated</span>
                    </div>
                </div>
                <div class="step-visual">
                    <div class="step-illustration">
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">Apply for Refund if Applicable</h3>
                    <p class="step-description">RFD-01 for IGST refund or ITC refund. Endorsed supply certificates. Bank proof. Within 2-year window.</p>
                    <div class="step-highlights">
                        ...
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Refund</span>
                    </div>
                </div>
                <div class="step-visual">
                    <div class="step-illustration">
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">Annual Return and Compliance</h3>
                    <p class="step-description">GSTR-9 annual. Dual GSTIN reconciliation. Endorsement documentation archive. LUT renewal. Ongoing compliance.</p>
                    <div class="step-highlights">
        ...
        <div class="highlight-box" style="margin-top:32px;max-width:1000px;margin-left:auto;margin-right:auto;">
            <p><strong>City Processing Note:</strong> Patron's Gurugram office handles SEZ GST returns, LUT filing, IGST refund, and dual GSTIN management for SEZ units and DTA suppliers across Gurugram.</p>
        </div>
    </div>
</section>
...
<section class="content-section" id="documents-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Documents Required for SEZ GST Returns</h2>
            <div class="content-text">
                <ul>
                    <li><strong>SEZ Endorsement:</strong> Authorized operation endorsement from SEZ authority for each supply.</li>
                    <li><strong>LUT Copy:</strong> Current year Form RFD-11. Valid LUT for zero-rated supply without IGST.</li>
                    <li><strong>IGST Invoices:</strong> Tax invoices for IGST-paid SEZ supplies (if IGST route chosen).</li>
                    <li><strong>Additional:</strong> Dual GSTIN records | E-way bills | DC approval | Bank realization proof (for refund).</li>
                </ul>
            </div>
        </div>
    </div>
...
<section class="content-section" id="challenges-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">5 Common SEZ GST Challenges in Gurugram</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Challenge</th><th>Impact</th><th>How Patron Accounting Solves It</th></tr></thead>
                    <tbody>
                        <tr><td>Dual GSTIN SEZ/DTA Mix-up</td><td>IT company operates in SEZ and DTA. Mixing transactions in one GSTIN triggers notices from Commissionerate</td><td>Maintain separate GSTINs, books, and returns for SEZ and DTA. No cross-contamination of transactions.</td></tr>
                        <tr><td>Endorsed Supply Documentation Gap</td><td>DTA supplier fails to obtain SEZ endorsement. Zero-rated treatment denied. Full IGST liability plus interest</td><td>Obtain and retain endorsement from SEZ authority for every supply. Without endorsement, zero-rated denied.</td></tr>
                        <tr><td>IGST Refund Documentation Incomplete</td><td>DTA supplier files RFD-01 but missing endorsed certificates. Processing delayed. 2-year limitation approaching</td><td>Compile all invoices, endorsed certificates, and bank proof before filing. 2-year clock is non-negotiable.</td></tr>
                        <tr><td>LUT Renewal Missed</td><td>SEZ unit misses March 31 LUT deadline. Must pay IGST on all supplies until new LUT filed. Cash flow hit</td><td>File LUT by March 31 every year. Set reminder 30 days before. Missing = IGST payable on all zero-rated supplies.</td></tr>
                        <tr><td>SEZ to DTA Clearance Misclassification</td><td>SEZ unit sells to DTA but reports as zero-rated. Error: SEZ to DTA = inter-state IGST. Demand notice issued</td><td>SEZ to DTA = IGST. Only DTA to SEZ and exports are zero-rated. Classify correctly in GSTR-1.</td></tr>
                    </tbody>
                </table>
                </div>
            </div>
...
<section class="content-section" id="fees-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">SEZ GST Return Fees in Gurugram 2026</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table class="table-amount">
                    <thead><tr><th>Fee Component</th><th>Amount</th></tr></thead>
                    <tbody>
                        <tr><td>SEZ Unit Monthly GSTR-1 + GSTR-3B</td><td>From Rs 3,000/month per GSTIN</td></tr>
                        <tr><td>DTA Supplier Zero-Rated Filing</td><td>From Rs 3,000/month</td></tr>
                        <tr><td>Dual GSTIN Management (SEZ + DTA)</td><td>From Rs 5,000/month</td></tr>
                        <tr><td>LUT Filing (Annual)</td><td>Rs 1,000-2,000</td></tr>
                        <tr><td>IGST Refund Application (RFD-01)</td><td>From Rs 4,999</td></tr>
                        <tr><td>Annual GSTR-9 (SEZ)</td><td>Rs 5,000-12,000</td></tr>
                ...
                <p style="margin-top:16px;">No government fee for filing. Professional fees cover SEZ classification, return filing, LUT management, and refund application. Dual GSTIN pricing per registration.</p>
                <p style="margin-top:16px;"><strong>Get a free Copyright Registration consultation - <a href="tel:+919459456700">Call +91 945 945 6700</a> or <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20help%20with%20GST%20SEZ%20Returns%20in%20Gurugram.%20Please%20share%20fee%20details." target="_blank">WhatsApp us</a>. No-obligation assessment.</strong></p>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section" id="timeline-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">SEZ GST Return Timeline</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Stage</th><th>Estimated Timeline</th></tr></thead>
                    <tbody>
                        <tr><td>GSTR-1 (SEZ/DTA)</td><td>By 11th of following month</td></tr>
                        <tr><td>GSTR-3B (SEZ/DTA)</td><td>By 20th of following month</td></tr>
                        <tr><td>LUT (Form RFD-11)</td><td>Before start of each financial year (March 31)</td></tr>
                        <tr><td>IGST Refund (RFD-01)</td><td>Within 2 years from relevant date</td></tr>
                        <tr><td>GSTR-9 Annual</td><td>By December 31</td></tr>
                        <tr><td>E-Way Bill</td><td>Before goods movement DTA-SEZ (above Rs 50,000)</td></tr>
                        <tr><td>Endorsed Supply</td><td>Per transaction from SEZ authority</td></tr>
                    </tbody>
                </table>
                </div>
                <div class="highlight-box" style="margin-top:16px;">
                    <p><strong>Note:</strong> GSTR-1 by 11th. GSTR-3B by 20th. LUT by March 31 annually. IGST refund within 2 years. Endorsed supply maintained per transaction.</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="why-choose-section" id="benefits-section">
    <div class="section-container">
        <div style="text-align:center;margin-bottom:48px;">
            ...
            <h2 class="section-title">Why Choose Patron for SEZ GST in Gurugram</h2>
        </div>
        <div class="features-grid">
            <article class="feature-card">
                ...
                <h3 class="feature-title">Zero-Rated Filing</h3>
                <p class="feature-text">DTA to SEZ at 0%. Table 6A/6B. Endorsed supply documentation. Correct classification every transaction.</p>
            </article>
            <article class="feature-card">
                ...
                <p class="feature-text">Annual RFD-11 before March 31. Renewal tracking. Missing = IGST on all supplies. Automated reminders.</p>
            </article>
            <article class="feature-card">
                ...
                <h3 class="feature-title">IGST Refund</h3>
                <p class="feature-text">RFD-01 filing for IGST paid on SEZ supplies. Endorsed certificates. 2-year tracking. 90% provisional.</p>
            </article>
            <article class="feature-card">
                <div class="feature-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg></div>
                <h3 class="feature-title">Dual GSTIN</h3>
                <p class="feature-text">Separate returns for SEZ and DTA registrations. No transaction mixing. Independent compliance tracks.</p>
            </article>
            <article class="feature-card">
                ...
                <h3 class="feature-title">Endorsed Supply</h3>
                <p class="feature-text">SEZ authority endorsement per supply. Documentation maintained. Audit-ready. Without = zero-rated denied.</p>
            </article>
            <article class="feature-card">
                ...
                <h3 class="feature-title">28 SEZ Coverage</h3>
                <p class="feature-text">DLF Cyber City, ASF Insignia, Candor TechSpace, Sohna Road SEZs. All Gurugram SEZ clusters covered.</p>
            </article>
        </div>
    </div>
</section>
...
<section class="content-section" id="comparison-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">SEZ Transaction Classification</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table class="table-comparison">
                    <thead><tr><th>Transaction</th><th>GST Treatment / Return Reporting / Gurugram Context</th></tr></thead>
                    <tbody>
                        <tr><td>DTA to SEZ (authorized ops)</td><td>Zero-rated (0%). GSTR-1 Table 6A/6B. IT vendors to DLF Cyber City SEZ</td></tr>
                        <tr><td>SEZ to DTA clearance</td><td>IGST (inter-state). GSTR-1 Table 4. SEZ unit selling to Gurugram DTA</td></tr>
                        <tr><td>Intra-SEZ supply</td><td>Zero-rated. GSTR-1 separate line. Between units in same SEZ</td></tr>
                        <tr><td>Inter-SEZ supply</td><td>Zero-rated. GSTR-1. DLF Cyber City SEZ to ASF Insignia SEZ</td></tr>
                        <tr><td>Import into SEZ</td><td>Exempt (authorized ops). No GST. Foreign goods/services into SEZ</td></tr>
                        <tr><td>SEZ services export</td><td>Zero-rated. GSTR-1 + LUT. IT/ITES export from Gurugram SEZ units</td></tr>
                    </tbody>
                </table>
                </div>
                <p style="margin-top:12px;">External Authority: <a href="https://gst.gov.in" target="_blank" rel="noopener">GST Portal (gst.gov.in) | SEZ Online System</a></p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                <ul>
                    ...
                    <li><a href="/gst-refund">GST Refund</a> - IGST refund and ITC refund for SEZ and export supplies</li>
...
<section class="content-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>SEZ GST is governed by <strong>Section 16 of the IGST Act 2017</strong> (zero-rated supply), the <strong>SEZ Act 2005</strong>, and the <strong>CGST Act 2017</strong>. <strong>Notification 18/2017-IT(R)</strong> exempts services imported by SEZ for authorized operations. <strong>Rule 89</strong> governs refund computation.</p>
                <p><strong>Section 25 CGST Act</strong>: separate GSTIN mandatory for SEZ and DTA. <strong>LUT (Form RFD-11)</strong>: annual filing before FY start. <strong>Section 54</strong>: 2-year limitation for IGST refund. <strong>E-way bill</strong>: mandatory for goods movement DTA-SEZ above Rs 50,000.</p>
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    <h2 class="faq-expanded__title">FAQs - SEZ GST Returns in Gurugram</h2>
                    <p class="faq-expanded__lead">Answers to common questions about SEZ GST returns including zero-rated supply, LUT, IGST refund, and dual GSTIN for Gurugram SEZ businesses.</p>
                    @include('partials.faq-enquiry-form', ['enquiryLocation' => 'Gurugram', 'enquiryService' => 'SEZ GST Returns in Gurugram'])
                </aside>
                <div class="faq-expanded__list">
                    <div class="faq-expanded__item" id="faq-1">
                        <h3 class="faq-expanded__q">Are supplies to SEZ zero-rated?</h3>
                        <div class="faq-expanded__a"><p>Yes. All supplies to SEZ units and developers are zero-rated under Section 16 of the IGST Act 2017. DTA suppliers can supply under LUT without paying IGST (and claim ITC refund) or pay IGST at the time of supply and claim full IGST refund. The supplies must be for authorized operations with endorsed documentation from the SEZ authority.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-2">
                        <h3 class="faq-expanded__q">How much does SEZ GST filing cost?</h3>
                        <div class="faq-expanded__a"><p>SEZ unit returns from Rs 3,000 per month per GSTIN. DTA supplier zero-rated filing from Rs 3,000 per month. Dual GSTIN management from Rs 5,000 per month. LUT filing Rs 1,000-2,000. IGST refund from Rs 4,999. Annual GSTR-9 Rs 5,000-12,000. Call +91 945 945 6700 for a detailed quote.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-3">
                        <h3 class="faq-expanded__q">Does an SEZ unit need a separate GSTIN?</h3>
                        <div class="faq-expanded__a"><p>Total timeline: 2-6 months. Filing and Diary Number: immediate. Mandatory 30-day objection waiting period: 1 month. Apply for Refund if Applicable: 1-3 months. Certificate issuance: after examination approval. If a third-party objection is filed, the timeline extends by 2-4 months for hearing and resolution.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-4">
                        <h3 class="faq-expanded__q">What is LUT and when must it be filed?</h3>
                        <div class="faq-expanded__a"><p>Letter of Undertaking filed in Form GST RFD-11 before the start of each financial year. It enables SEZ units and DTA suppliers to make zero-rated supplies without paying IGST upfront. Must be renewed annually by March 31. Missing the deadline means IGST must be paid on all zero-rated supplies until the new LUT is filed, creating significant cash flow disruption.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-5">
                        <h3 class="faq-expanded__q">How does IGST refund for SEZ supplies work?</h3>
                        <div class="faq-expanded__a"><p>DTA suppliers who pay IGST on SEZ supplies file Form RFD-01 for refund. Must include endorsed supply certificates from the SEZ authority. Two-year limitation from the relevant date under Section 54. Incomplete documentation causes processing delays. Ensure all invoices, endorsements, and bank realization proof are compiled before filing.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-6">
                        <h3 class="faq-expanded__q">What happens when SEZ sells to DTA?</h3>
                        <div class="faq-expanded__a"><p>SEZ to DTA clearance is treated as an inter-state supply attracting IGST. This must be reported separately in GSTR-1 Table 4. Only supplies from DTA to SEZ are zero-rated. Many SEZ units in Gurugram sell IT services both to foreign clients (export, zero-rated) and to DTA clients in Gurugram (IGST), requiring careful classification in returns.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-7">
                        <h3 class="faq-expanded__q">How many SEZs are in Gurugram?</h3>
                        <div class="faq-expanded__a"><p>Gurugram hosts 28 notified Special Economic Zones, the highest concentration in Haryana. Major SEZs include DLF Cyber City SEZ (IT/ITES), ASF Insignia SEZ, Candor TechSpace, and clusters along the Sohna Road corridor. Most are IT/ITES-focused, reflecting Gurugram's position as India's second-largest technology hub.</p></div>
                    </div>
                </div>
            </div>
            ...
            <div class="highlight-box" style="margin-top:32px;">
                ...
                <p><strong>SEZ mein supply pe GST lagta hai?</strong> Nahi - SEZ ko supply zero-rated hai S16 IGST Act. LUT file karke bina IGST supply kar sakte hain.</p>
                <p><strong>SEZ unit ko alag GSTIN chahiye?</strong> Haan. SEZ aur DTA ke liye alag-alag GSTIN mandatory hai S25 CGST Act.</p>
                <p><strong>SEZ se DTA mein bhejne par?</strong> IGST lagega - inter-state supply maani jaati hai. Zero-rated sirf DTA se SEZ ko hai.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section" style="background: var(--orange-lighter) !important; border-left: 4px solid var(--orange);">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Why SEZ GST Returns Matter in Gurugram</h2>
            <div class="content-text">
                <p>LUT for FY 2026-27 must be filed by March 31, 2026. Missing this means IGST payable on all zero-rated supplies until filed. IGST refund claims within 2 years or permanently lost. GST Commissionerate Gurugram and DC NSEZ are increasing scrutiny on endorsed supply documentation. File on time, maintain endorsements, renew LUT annually.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section" style="background: var(--blue) !important;">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title" style="color:#FFFFFF !important;">Start Your SEZ GST Filing in Gurugram Today</h2>
            <div class="content-text" style="text-align:left;">
                <p style="color:rgba(255,255,255,0.85);">GST return filing for SEZ in Gurugram covers zero-rated supply compliance, dual GSTIN management, LUT filing, endorsed supply documentation, and IGST refund claims for 28 notified SEZs across DLF Cyber City, ASF Insignia, Candor TechSpace, and the Sohna Road corridor.</p>
                <p style="color:rgba(255,255,255,0.85);">Patron Accounting's Gurugram office on Golf Course Extension Road provides end-to-end SEZ GST compliance including monthly returns, LUT management, refund applications, and dual GSTIN coordination for SEZ units and DTA suppliers across Gurugram.</p>
            ...
            <div style="display:flex;gap:14px;flex-wrap:wrap;margin-top:24px;">
                ...
                <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20help%20with%20GST%20SEZ%20Returns%20in%20Gurugram.%20Please%20share%20details." target="_blank" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:#25D366;color:#fff;border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#128172; WhatsApp Us</a>
                <a href="mailto:sales@patronaccounting.com?subject=Enquiry%20for%20GST%20SEZ%20Returns%20in%20Gurugram&body=Hello%20Patron%20Accounting%20Team%2C%0A%0AI%20am%20interested%20in%20your%20GST%20SEZ%20Returns%20services%20in%20Gurugram%20and%20would%20like%20to%20know%20more.%0A%0APlease%20get%20in%20touch%20with%20me%20at%20your%20earliest%20convenience.%0A%0AThank%20you." style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:transparent;color:#fff;border:2px solid rgba(255,255,255,0.3);border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#9993;&#65039; Email Us</a>
            </div>
...
<section class="content-section" style="padding:48px 32px;background:var(--gray-50);">
    <div class="content-container">
        <div class="text-content">
            ...
            <p style="text-align:center;color:var(--text-muted);font-size:15px;margin-bottom:40px;">SEZ GST return services available across India with local office support.</p>
            ...
            <div class="pa-city-block" style="margin-bottom:40px;">
                <div class="pa-city-grid">
                    ...
                    <a href="/gst-returns-for-sez/mumbai" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Mumbai</div><div class="pa-card-sub">Maharashtra</div></div></a>
            ...
            <div class="pa-city-block">
                ...
                <div class="pa-block-sub">End-to-end support for SEZ GST Returns in Gurugram</div>
...
<section class="content-section" style="padding:32px;">
    <div class="content-container">
        <div class="text-content" style="font-size:13px;color:var(--text-muted);">
            ...
            <p>This page is reviewed quarterly for accuracy. IGST Act SEZ provisions, zero-rated supply rules, LUT requirements, refund procedures, and endorsed supply documentation standards are verified against current notifications. Gurugram SEZ landscape (28 notified SEZs) is validated with each review.</p>
        </div>
    </div>
</section>
