            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-4 private-registration-heading">
                        IEC Renewal in Gurugram: Prevent Deactivation, Protect Your Trade
                    </h1>
                    ...
                    <div class="mb-4">
                        <div class="d-flex align-items-start mb-3">
                            ...
                            <p class="mb-0 text-dark benefit-paragraph"><span>Documents:</span> DGFT portal credentials, Aadhaar (for OTP) or DSC, address proof (if changed), bank details (if changed)</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Fees:</span> Confirmation (no changes): FREE. Modification (changes): Rs 200 + GST. Professional: Rs 999-2,999</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Eligibility:</span> All IEC holders - individuals, proprietorships, companies, LLPs, partnerships</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Timeline:</span> 5-10 minutes online. Annual window: April 1 to June 30. Deadline: June 30</p>
                        </div>
                    </div>
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="mailto:sales@patronaccounting.com?subject=Enquiry%20for%20IEC%20Renewal%20in%20Gurugram&body=Hello%20Patron%20Accounting%20Team%2C%0A%0AI%20am%20interested%20in%20your%20IEC%20Renewal%20services%20in%20Gurugram%20and%20would%20like%20to%20know%20more.%0A%0APlease%20get%20in%20touch%20with%20me%20at%20your%20earliest%20convenience.%0A%0AThank%20you." class="btn-sample text-decoration-none">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:18px;height:18px;"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,12 2,6"/></svg>
                            Email Us
                        </a>
                        <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20help%20with%20IEC%20Renewal%20in%20Gurugram.%20Please%20share%20details." target="_blank" class="btn-sample text-decoration-none">
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - IEC Renewal Gurugram'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="iec-renewal/gurugram" selected>IEC Renewal in Gurugram</option>
...
<section class="testimonials-section">
    <div class="section-container">
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            ...
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Patron updates our IEC on April 1 every year - literally the first day of the window. We never worry about deactivation. They also bundle it with AD Code verification and GST LUT. Complete export compliance in one go. Essential for any Gurugram exporter.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div>
                    <div style="font-weight:700;font-size:13px;color:var(--blue);">Manoj Gupta</div>
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Export Manager, Auto Components, Manesar</div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Our IEC was deactivated because we missed the June 30 deadline by 2 days. ICEGATE rejected our Shipping Bill for a Rs 40 lakh order. Patron reactivated it in 10 minutes. Now they manage our annual update proactively. Never again.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                <div style="width:36px;height:36px;border-radius:50%;background:var(--blue);display:flex;align-items:center;justify-content:center;font-weight:700;font-size:13px;color:#fff;flex-shrink:0;">RC</div>
                <div>
                    <div style="font-weight:700;font-size:13px;color:var(--blue);">Rohit Chawla</div>
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Owner, Trading Company, Gurugram</div>
                    <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                </div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">We couldn't access our DGFT portal - the password was set by someone who left 4 years ago. Patron recovered our credentials, updated the portal details, and completed the IEC renewal. Saved us from deactivation with 10 days to spare.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div>
                    <div style="font-weight:700;font-size:13px;color:var(--blue);">Priyanka Das</div>
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Director, Import Business, Udyog Vihar</div>
                    <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                </div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Patron handles IEC renewal for our 3 group companies. Different IECs, different DGFT logins, different details. They manage all three every April. Zero deactivations in 4 years. Multi-entity management at its best.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div>
                    <div style="font-weight:700;font-size:13px;color:var(--blue);">Anil Sharma</div>
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">CFO, Manufacturing Group, Manesar</div>
                    <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                </div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Our e-commerce export account on Amazon was at risk because of deactivated IEC. Patron reactivated it the same day and re-filed the pending Shipping Bills. They explained that the 5-minute update prevents days of disruption. Lesson learned.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div>
                    <div style="font-weight:700;font-size:13px;color:var(--blue);">Neha Jain</div>
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">E-commerce Exporter, DLF Cyber City</div>
                    <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                </div>
        ...
        <div class="reviews-cta" style="margin-top: 16px; display: flex !important;">
            <div class="reviews-cta-content">
                ...
                <div class="reviews-cta-text">
                    ...
                    <p>Trusted IEC renewal and export compliance partner for traders and exporters in Gurugram.</p>
                </div>
            </div>
...
<div class="stats-bar">
    <div class="stats-container">
        <div class="stat-item">
            ...
            <div class="stat-content"><span class="stat-value">10,000+</span><span class="stat-label">Businesses Served</span><span class="stat-desc">IEC renewal and export compliance across India.</span></div>
        </div>
        <div class="stat-item">
            <div class="stat-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8M12 17v4"/></svg></div>
            <div class="stat-content"><span class="stat-value">15+</span><span class="stat-label">Years Experience</span><span class="stat-desc">Deep expertise in IEC renewal, DGFT compliance, and export management.</span></div>
        </div>
        <div class="stat-item">
            <div class="stat-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><path d="M14 2v6h6M16 13H8M16 17H8"/></svg></div>
            <div class="stat-content"><span class="stat-value">50,000+</span><span class="stat-label">Documents Filed</span><span class="stat-desc">IEC renewals, DGFT updates, and export compliance documents handled.</span></div>
        </div>
        <div class="stat-item">
            <div class="stat-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="8" r="7"/><path d="M8.21 13.89L7 23l5-3 5 3-1.21-9.12"/></svg></div>
            <div class="stat-content"><span class="stat-value">4.9&#9733;</span><span class="stat-label">Client Rating</span><span class="stat-desc">Trusted by manufacturers, IT exporters, and trading companies.</span></div>
        </div>
...
<section class="content-section" id="overview-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Why IEC Renewal Matters for Gurugram's Trade Economy</h2>
            <div class="content-text">
                <div class="highlight-box" style="margin-bottom:20px;">
                    <p><strong>&#128204; TL;DR - IEC Renewal Services at a Glance</strong></p>
                    <p>Your Import Export Code (IEC) has lifetime validity - it never expires. However, DGFT mandates that every IEC holder must update or confirm their IEC details annually between April 1 and June 30 on the DGFT portal (dgft.gov.in), even if absolutely nothing has changed. If you miss the June 30 deadline, your IEC is automatically deactivated on July 1. A deactivated IEC means: no Shipping Bills on ICEGATE (exports blocked), no Bills of Entry (imports blocked), no customs clearance, no export incentives (RoDTEP, duty drawback, IGST refund), and banks may refuse trade-related forex transactions. The annual update is free (no government fee for confirmation). If you make changes, Rs 200 fee applies. The process takes 5 minutes. Reactivation after deactivation is immediate on completing the update.</p>
                </div>
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Parameter</th><th>Detail</th></tr></thead>
                    <tbody>
                        <tr><td>What</td><td>Mandatory annual confirmation/update of IEC details on DGFT portal</td></tr>
                        <tr><td>When</td><td>April 1 to June 30 every year. Deadline: June 30</td></tr>
                        <tr><td>Who</td><td>ALL IEC holders - active or dormant. No exceptions</td></tr>
                        <tr><td>Fee</td><td>Confirmation (no changes): FREE. Modification: Rs 200 + GST</td></tr>
                        <tr><td>Process</td><td>Login <a href="https://dgft.gov.in" target="_blank" rel="noopener">dgft.gov.in</a> > Services > IEC > Update IEC > Review/Confirm > Authenticate > Submit</td></tr>
                        <tr><td>Non-Compliance</td><td>Automatic deactivation on July 1. No import/export/customs/incentives until reactivated</td></tr>
                        <tr><td>Reactivation</td><td>Complete the pending update. Reactivation usually immediate. No late penalty</td></tr>
                        <tr><td>Authority</td><td>Directorate General of Foreign Trade (DGFT), Ministry of Commerce</td></tr>
                    </tbody>
                </table>
                </div>
                <p>Gurugram's export economy is substantial: IT services exports from DLF Cyber City, manufactured goods from Udyog Vihar and Manesar, auto components, pharmaceutical products, e-commerce exports, and trading operations. Every one of these businesses holds an IEC. Every July 1, hundreds of Gurugram IECs are deactivated because the 5-minute annual update was not completed. For comprehensive information about <a href="/iec-renewal">IEC renewal across India</a>, visit our national service page.</p>
                <p>The most frustrating aspect: there is no monetary penalty for late update. The real penalty is business disruption. A Gurugram exporter with goods packed and buyer waiting cannot ship because the IEC is deactivated. Patron includes IEC annual update in every client's April compliance calendar. You also need <a href="/ad-code-registration">AD Code registration</a> and <a href="/gst-registration">GST registration with LUT</a> for complete export compliance.</p>
        ...
        <div class="two-column">
            <div class="column-content">
                ...
                <div class="content-text what-is-definition">
                    <p>IEC Renewal (annual update) is the mandatory process of confirming or updating your Import Export Code details on the DGFT portal every year between April 1 and June 30. This applies to ALL IEC holders, even if no details have changed.</p>
                    <p>The process takes 5 minutes: login to dgft.gov.in, review each section (general info, directors, bank, contact), confirm or update, authenticate with Aadhaar OTP or DSC, and submit. Free for confirmation, Rs 200 for modifications.</p>
                    <p>Missing the June 30 deadline causes automatic IEC deactivation on July 1, blocking all trade operations. Reactivation is immediate on completing the update. For complete export compliance, bundle IEC renewal with <a href="/ad-code-registration">AD Code verification</a> and <a href="/gst-registration">GST LUT renewal</a>.</p>
                </div>
                <div class="highlight-box" style="margin-top:20px;">
                    <p><strong>Key Terms for Copyright Registration:</strong></p>
                    <ul>
                        <li><strong>IEC Annual Update</strong> - Mandatory confirmation/modification on DGFT portal April 1-June 30</li>
                        <li><strong>DGFT Portal</strong> - dgft.gov.in for IEC management and annual update</li>
                        <li><strong>Deactivation</strong> - Automatic on July 1 if update not completed by June 30</li>
                        <li><strong>Reactivation</strong> - Completing pending update restores IEC immediately</li>
                        <li><strong>GST LUT</strong> - Letter of Undertaking for zero-rated exports, renewed annually</li>
                    </ul>
                </div>
            </div>
            <div class="column-image">
                <div class="illustration-placeholder">
                    ...
                    <div class="illustration-badge">
                        <span>DGFT Portal</span>
                        <strong>5-Min Annual Update</strong>
                    </div>
                </div>
            </div>
        </div>
...
<section class="content-section" id="who-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Who Needs IEC Renewal in Gurugram</h2>
            <div class="content-text">
                <ul>
                    <li><strong>Manufacturing exporters</strong> in Udyog Vihar and Manesar shipping auto components, engineering goods, electrical equipment, textiles, and consumer products. These companies file Shipping Bills regularly and depend on active IEC status for every shipment.</li>
                    <li><strong>IT and technology companies</strong> in DLF Cyber City exporting software services and technology solutions. IEC is needed for claiming export benefits, RBI compliance, and bank FIRC processing. Deactivated IEC can delay service export payments.</li>
                    ...
                    <li><strong>Import businesses</strong> in Gurugram importing raw materials, components, machinery, IT hardware, and consumer goods. Bills of Entry (import customs clearance) require active IEC. Deactivated IEC means goods stuck at customs incurring demurrage.</li>
...
<section class="content-section" id="services-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">6 IEC Renewal Services Included</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Service</th><th>What We Do</th></tr></thead>
                    <tbody>
                        <tr><td>Proactive Annual Update (April-June)</td><td>Completing the IEC annual update on DGFT portal during April 1-30 window (well before June 30 deadline). Reviewing all sections, confirming or updating, authenticating, and submitting. Certificate download.</td></tr>
                        <tr><td>Detail Modification</td><td>Updating changed business details: address, directors/partners, bank account, contact info. Uploading supporting documents. Rs 200 government fee for modifications.</td></tr>
                        <tr><td>Deactivated IEC Reactivation</td><td>For businesses whose IEC has been deactivated: immediately completing pending update to trigger reactivation. Verifying on ICEGATE. Coordinating with customs broker to resume shipments.</td></tr>
                        <tr><td>DGFT Portal Credential Recovery</td><td>Recovering lost or forgotten DGFT portal login credentials. Password reset, email update, mobile verification to restore portal access before the update deadline.</td></tr>
                        <tr><td>Annual Export Compliance Calendar</td><td>Integrating IEC renewal into complete annual compliance: IEC update (April-June), GST LUT renewal (annual), AD Code verification, RCMC renewal, export benefit claims.</td></tr>
                        <tr><td>IEC + AD Code + GST LUT Bundle</td><td>Annual renewal of all three core export registrations together. These three are needed for uninterrupted export operations. Bundle ensures all are current.</td></tr>
                        <tr><td>Export Incentive Eligibility Check</td><td>Verifying that IEC status, AD Code linkage, and GST LUT are correctly configured for RoDTEP, duty drawback, and IGST refund claims. Deactivated IEC blocks all incentives.</td></tr>
                    </tbody>
                </table>
                </div>
            </div>
...
<section class="steps-section" id="procedure-section">
    <div class="section-container">
        <header class="section-header" style="text-align:center;margin-bottom:48px;">
            ...
            <h2 class="section-title">How IEC Renewal Works in Gurugram: 5-Step Process</h2>
            <p class="section-subtitle" style="text-align:left;max-width:100%;">Our CA-led team manages IEC annual updates, deactivated IEC reactivation, detail modifications, and annual export compliance bundles for Gurugram exporters.</p>
        </header>
        <div class="steps-container">
            <div class="step-card">
                <div class="step-content">
                    <span class="step-badge">Step 1</span>
                    <h3 class="step-title">Login to DGFT Portal</h3>
                    <p class="step-description">Access dgft.gov.in with your IEC credentials. Navigate to Services > IEC > Update IEC. If credentials are lost, recover through password reset with registered email and mobile.</p>
                    <div class="step-highlights">
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>All Reviewed</span>
                ...
                <div class="step-visual">
                    <div class="step-illustration">
                        ...
                        <span class="illustration-label">Credentials OK</span>
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">Review and Confirm All Sections</h3>
                    <p class="step-description">Check general info, partner/director details, bank details, and contact info. Confirm each section. If any details have changed, update with supporting documents (Rs 200 modification fee).</p>
                    <div class="step-highlights">
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>All Reviewed</span>
                ...
                <div class="step-visual">
                    <div class="step-illustration">
                        ...
                        <span class="illustration-label">Sections OK</span>
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <p class="step-description">Verify with Aadhaar OTP or Digital Signature Certificate. Submit the update. Download the updated IEC certificate. Annual confirmation complete.</p>
                    <div class="step-highlights">
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">Verify on ICEGATE</h3>
                    <p class="step-description">Confirm IEC shows active status on ICEGATE portal. Shipping Bills and Bills of Entry can be filed without interruption. Trade operations continue seamlessly.</p>
                    <div class="step-highlights">
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>ICEGATE Active</span>
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Ports OK</span>
                    </div>
                </div>
                <div class="step-visual">
                    <div class="step-illustration">
                        ...
                        <span class="illustration-label">Active</span>
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">Update AD Code and GST LUT</h3>
                    <p class="step-description">Complete the annual export compliance: verify AD Code is current, renew GST LUT for zero-rated exports. All three (IEC + AD Code + GST LUT) needed for uninterrupted export operations.</p>
                    <div class="step-highlights">
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>AD Code OK</span>
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>LUT Renewed</span>
                    </div>
                </div>
                <div class="step-visual">
                    <div class="step-illustration">
                        ...
                        <span class="illustration-label">Bundle Done</span>
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">Annual Compliance Secured</h3>
                    <p class="step-description">IEC active for the full year. Export incentives (RoDTEP, drawback, IGST refund) accessible. All ports operational. Set reminder for next April 1 update window. No further action needed until next year.</p>
                    <div class="step-highlights">
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Year Secured</span>
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>April Reminder</span>
                    </div>
                </div>
                <div class="step-visual">
                    <div class="step-illustration">
        ...
        <div class="highlight-box" style="margin-top:32px;max-width:1000px;margin-left:auto;margin-right:auto;">
            <p><strong>City Processing Note:</strong> Patron's Gurugram office on Golf Course Extension Road manages IEC annual updates, deactivated IEC reactivation, and annual export compliance for manufacturers, IT exporters, and trading companies across Gurugram.</p>
        </div>
    </div>
</section>
...
<section class="content-section" id="documents-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Documents Required for IEC Renewal in Gurugram</h2>
            <div class="content-text">
                <ul>
                    <li><strong>DGFT Portal Access:</strong> Login credentials (user ID and password) for dgft.gov.in. If lost, credential recovery needed first.</li>
                    <li><strong>Authentication:</strong> Aadhaar (for OTP verification) or Digital Signature Certificate (DSC) for submission authentication.</li>
                    <li><strong>If Modifications:</strong> Address proof (if address changed) | New bank cancelled cheque (if bank changed) | Director/partner appointment letter (if directors changed).</li>
                    <li><strong>No Changes:</strong> If confirming with no changes - NO documents needed. Just DGFT portal login and Aadhaar OTP or DSC.</li>
                </ul>
            </div>
        </div>
    </div>
...
<section class="content-section" id="challenges-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">5 Common IEC Renewal Challenges in Gurugram</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Challenge</th><th>Impact</th><th>How Patron Accounting Solves It</th></tr></thead>
                    <tbody>
                        <tr><td>Forgotten DGFT Portal Credentials</td><td>IEC registered years ago, employee who set it up left, email inactive, password forgotten</td><td>Maintain DGFT credentials in a secure location. Update registered email and mobile when staff changes. Patron recovers credentials through DGFT's password reset process.</td></tr>
                        <tr><td>Assuming 'Lifetime Validity' Means No Update</td><td>Business believes lifetime validity means zero maintenance. Was true before 2021</td><td>Since DGFT Notification 58/2015-2020, annual update is mandatory even with no changes. IEC remains valid for life but can be deactivated for non-update. Deactivated is not expired.</td></tr>
                        <tr><td>Discovery at Shipment Time</td><td>Manufacturer files Shipping Bill in August but ICEGATE rejects - IEC deactivated since July 1</td><td>Complete update in April (day 1 of window). 5 minutes prevents months of disruption. Patron auto-schedules updates for all clients.</td></tr>
                        <tr><td>Bank Account Mismatch</td><td>During annual update, DGFT system flags bank account details that no longer match</td><td>Update bank details during annual update with supporting documents (new cancelled cheque). Rs 200 modification fee. Prevents export incentive payment issues.</td></tr>
                        <tr><td>June Last-Minute Portal Congestion</td><td>DGFT portal becomes slow/unavailable in the last week of June due to high traffic</td><td>Complete the update in April (first week). Don't wait until June. Portal congestion near deadline causes failures and missed deadlines.</td></tr>
                    </tbody>
                </table>
                </div>
            </div>
...
<section class="content-section" id="fees-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">IEC Renewal Fees in Gurugram 2026</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table class="table-amount">
                    <thead><tr><th>Fee Component</th><th>Amount</th></tr></thead>
                    <tbody>
                        <tr><td>IEC Annual Confirmation (no changes)</td><td>FREE govt + Rs 999-1,499 professional</td></tr>
                        <tr><td>IEC Modification (with changes)</td><td>Rs 200 govt + Rs 1,999-2,999 professional</td></tr>
                        <tr><td>Deactivated IEC Reactivation</td><td>FREE govt + Rs 1,499-2,499 professional</td></tr>
                        <tr><td>DGFT Portal Credential Recovery</td><td>Rs 999-1,999</td></tr>
                        <tr><td>Annual Export Bundle (IEC + AD Code + GST LUT)</td><td>Rs 2,999-4,999</td></tr>
                        <tr><td>Multi-Entity IEC Management (per entity)</td><td>Rs 999-1,499/year</td></tr>
                ...
                <p style="margin-top:16px;">Government fee: FREE for confirmation, Rs 200 for modification. Professional fees cover portal management, credential recovery, modification assistance, and compliance tracking.</p>
                <p style="margin-top:16px;"><strong>Get a free Copyright Registration consultation - <a href="tel:+919459456700">Call +91 945 945 6700</a> or <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20help%20with%20IEC%20Renewal%20in%20Gurugram.%20Please%20share%20fee%20details." target="_blank">WhatsApp us</a>. No-obligation assessment.</strong></p>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section" id="timeline-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">IEC Annual Update Timeline</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Stage</th><th>Estimated Timeline</th></tr></thead>
                    <tbody>
                        <tr><td>Login to DGFT Portal</td><td>1 minute (if credentials available)</td></tr>
                        <tr><td>Review All Sections</td><td>2-3 minutes</td></tr>
                        <tr><td>Confirm or Modify Details</td><td>1-2 minutes (longer if modifications)</td></tr>
                        <tr><td>Aadhaar OTP / DSC Authentication</td><td>1 minute</td></tr>
                        <tr><td>Submit and Download Certificate</td><td>Immediate</td></tr>
                        <tr><td>Total (confirmation, no changes)</td><td>5-10 minutes</td></tr>
                        <tr><td>Credential Recovery (if needed)</td><td>1-3 business days additional</td></tr>
                    </tbody>
                </table>
                </div>
                <div class="highlight-box" style="margin-top:16px;">
                    <p><strong>Note:</strong> The IEC annual update is a 5-minute online process. The only timeline variable is credential recovery if portal access is lost. Complete the update in April (first week) to avoid June congestion and July 1 deactivation risk.</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="why-choose-section" id="benefits-section">
    <div class="section-container">
        <div style="text-align:center;margin-bottom:48px;">
            ...
            <h2 class="section-title">Why Choose Patron for IEC Renewal in Gurugram</h2>
        </div>
        <div class="features-grid">
            <article class="feature-card">
                ...
                <h3 class="feature-title">April Auto-Update</h3>
                <p class="feature-text">IEC update completed in the first week of April every year. Well before the June 30 deadline. Zero deactivation risk. Part of annual compliance calendar.</p>
            </article>
            <article class="feature-card">
                ...
                <h3 class="feature-title">Credential Recovery</h3>
                <p class="feature-text">DGFT portal login recovery: password reset, email update, mobile verification. Many businesses cannot access the portal - we solve this first.</p>
            </article>
            <article class="feature-card">
                ...
                <h3 class="feature-title">Reactivation Service</h3>
                <p class="feature-text">Immediate reactivation of deactivated IECs. DGFT update completion, ICEGATE verification, and customs broker coordination to resume pending shipments.</p>
            </article>
            <article class="feature-card">
                <div class="feature-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg></div>
                <h3 class="feature-title">Export Compliance Bundle</h3>
                <p class="feature-text">IEC + AD Code + GST LUT annual renewal together. All three needed for uninterrupted export operations. Single engagement, zero missed deadlines.</p>
            </article>
            <article class="feature-card">
                ...
                <h3 class="feature-title">Detail Modification</h3>
                <p class="feature-text">Address, director, bank, and contact changes during annual update. Supporting document upload. Rs 200 fee processing. Updated certificate download.</p>
            </article>
            <article class="feature-card">
                ...
                <h3 class="feature-title">Incentive Protection</h3>
                <p class="feature-text">Verifying IEC, AD Code, and GST LUT are correctly linked for RoDTEP, duty drawback, and IGST refund claims. Deactivated IEC blocks all incentives.</p>
            </article>
        </div>
    </div>
</section>
...
<section class="content-section" id="comparison-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">IEC Annual Update Calendar</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table class="table-comparison">
                    <thead><tr><th>Timeline</th><th>Action</th><th>Status</th></tr></thead>
                    <tbody>
                        <tr><td>April 1</td><td>Update window opens on DGFT portal</td><td>Complete now (recommended)</td></tr>
                        <tr><td>April 1-30</td><td>Best time to complete. Portal stable</td><td>5 minutes. Free. Done</td></tr>
                        <tr><td>May 1-31</td><td>Still within window. Complete ASAP</td><td>Active but deadline approaching</td></tr>
                        <tr><td>June 1-30</td><td>LAST CHANCE. Portal may be congested</td><td>Risk of portal congestion</td></tr>
                        <tr><td>July 1 onwards</td><td>IEC DEACTIVATED. No trade possible</td><td>Blocked. Must update to reactivate</td></tr>
                        <tr><td>After July 1 (on update)</td><td>Complete pending update. Immediate reactivation</td><td>Reactivated. Trade resumes</td></tr>
                    </tbody>
                </table>
                </div>
                <p style="margin-top:12px;">External Authority: <a href="https://dgft.gov.in" target="_blank" rel="noopener">DGFT (dgft.gov.in)</a></p>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>IEC annual update is mandated by <strong>DGFT Notification No. 58/2015-2020</strong> and subsequent trade notices. The <strong>Directorate General of Foreign Trade (DGFT)</strong> under the Ministry of Commerce and Industry administers the IEC system and the annual update requirement through the dgft.gov.in portal.</p>
                <p>IEC has lifetime validity under the Foreign Trade Policy, but the annual update requirement ensures data accuracy in the DGFT system. Deactivation is automatic and system-driven - no human review or notice. Reactivation is also automatic on completing the pending update. No monetary penalty exists for late update, but trade disruption is the effective consequence.</p>
                <p>The <a href="https://dgft.gov.in" target="_blank" rel="noopener">DGFT portal (dgft.gov.in)</a> is the central platform for IEC management, annual updates, and trade facilitation services. IEC status is linked to <a href="https://icegate.gov.in" target="_blank" rel="noopener">ICEGATE</a> for customs clearance - deactivated IEC automatically blocks all Shipping Bills and Bills of Entry on ICEGATE.</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    <h2 class="faq-expanded__title">FAQs - IEC Renewal in Gurugram</h2>
                    <p class="faq-expanded__lead">Answers to common questions about IEC annual update including the April-June window, deactivation prevention, reactivation process, and export incentive eligibility for Gurugram traders.</p>
                    @include('partials.faq-enquiry-form', ['enquiryLocation' => 'Gurugram', 'enquiryService' => 'IEC Renewal in Gurugram'])
                </aside>
                <div class="faq-expanded__list">
                    <div class="faq-expanded__item" id="faq-1">
                        <h3 class="faq-expanded__q">When must IEC be updated annually?</h3>
                        <div class="faq-expanded__a"><p>Every year between April 1 and June 30 on the DGFT portal (dgft.gov.in). This is mandatory for ALL IEC holders - active or dormant - even if absolutely no details have changed. If the June 30 deadline is missed, the IEC is automatically deactivated on July 1, blocking all import and export operations until the pending update is completed.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-2">
                        <h3 class="faq-expanded__q">How much does IEC renewal cost?</h3>
                        <div class="faq-expanded__a"><p>Government fee: FREE for confirmation (no changes). Rs 200 + GST if details are modified. Professional fee: Rs 999 to Rs 2,999. Annual export compliance bundle (IEC + AD Code + GST LUT): Rs 2,999 to Rs 4,999. Call +91 945 945 6700 for a detailed quote.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-3">
                        <h3 class="faq-expanded__q">What happens if I miss the June 30 deadline?</h3>
                        <div class="faq-expanded__a"><p>Total timeline: 2-6 months. Filing and Diary Number: immediate. Mandatory 30-day objection waiting period: 1 month. Update AD Code and GST LUT: 1-3 months. Certificate issuance: after examination approval. If a third-party objection is filed, the timeline extends by 2-4 months for hearing and resolution.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-4">
                        <h3 class="faq-expanded__q">Do I need to update even if nothing has changed?</h3>
                        <div class="faq-expanded__a"><p>Yes. The annual confirmation is mandatory even with zero changes. Login to dgft.gov.in, review each section (general info, directors, bank details, contact), confirm, authenticate with Aadhaar OTP or DSC, and submit. The process takes 5 minutes. It is free (no government fee). No documents are needed for a simple confirmation.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-5">
                        <h3 class="faq-expanded__q">How do I reactivate a deactivated IEC?</h3>
                        <div class="faq-expanded__a"><p>Login to dgft.gov.in, navigate to the IEC update section, complete the pending annual update (review and confirm all sections), authenticate with Aadhaar OTP or DSC, and submit. Reactivation is typically immediate. Verify on ICEGATE that your IEC shows active status. Then resume filing Shipping Bills and Bills of Entry.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-6">
                        <h3 class="faq-expanded__q">What export incentives are blocked by deactivated IEC?</h3>
                        <div class="faq-expanded__a"><p>RoDTEP (Remission of Duties and Taxes on Exported Products), duty drawback, IGST refund on exports, and all DGFT scheme benefits. Banks may also refuse trade-related forex transactions until IEC is reactivated. For Gurugram manufacturers, these incentives can be Rs 8-15 lakh annually - all blocked by a missed 5-minute update.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-7">
                        <h3 class="faq-expanded__q">Is IEC renewal the same as IEC registration?</h3>
                        <div class="faq-expanded__a"><p>No. IEC registration is a one-time process for obtaining a new Import Export Code from DGFT. IEC renewal (annual update) is the mandatory yearly confirmation of existing IEC details on the DGFT portal. IEC has lifetime validity and never expires, but it must be confirmed annually between April 1 and June 30 to remain active. They are separate compliance requirements.</p></div>
                    </div>
                </div>
            </div>
            ...
            <div class="highlight-box" style="margin-top:32px;">
                ...
                <p><strong>Kab update karna hai?</strong> Har saal April 1 se June 30 ke beech DGFT portal pe. Deadline miss kari toh July 1 ko IEC deactivate ho jayega. April ke pehle hafte mein kar lo - 5 minute lagta hai.</p>
                <p><strong>Kuch badla nahi toh bhi karna hai?</strong> Haan. Mandatory hai. Sirf login karo, har section confirm karo, submit karo. Free hai. Koi document nahi chahiye. Bas Aadhaar OTP ya DSC se sign karo.</p>
                <p><strong>Deactivate ho gaya toh?</strong> DGFT portal pe jao, pending update complete karo, submit karo. Turant reactivate ho jayega. Lekin jab tak deactivated hai, koi import-export nahi ho sakta.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section" style="background: var(--orange-lighter) !important; border-left: 4px solid var(--orange);">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Why IEC Renewal Matters for Gurugram's Trade Economy</h2>
            <div class="content-text">
                <p>A Gurugram e-commerce exporter processes 200 international orders daily through Amazon Global Selling. On July 3, ICEGATE rejects all pending Shipping Bills because the IEC was deactivated (annual update missed by 3 days). 200 orders are stuck. Amazon's seller metrics drop. The exporter completes the DGFT update in 5 minutes, IEC is reactivated, but the 2-day delay affects 400 orders. Amazon flags the account for late shipment. The Rs 0 IEC update (free confirmation) that was not done in April causes Rs 3-5 lakh in lost revenue and seller rating damage.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section" style="background: var(--blue) !important;">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title" style="color:#FFFFFF !important;">Start Your IEC Renewal in Gurugram Today</h2>
            <div class="content-text" style="text-align:left;">
                <p style="color:rgba(255,255,255,0.85);">IEC Renewal in Gurugram is a 5-minute mandatory annual confirmation on the DGFT portal that prevents automatic deactivation of your Import Export Code - protecting your ability to import, export, clear customs, and claim export incentives throughout the year.</p>
                <p style="color:rgba(255,255,255,0.85);">Patron Accounting's Gurugram office on Golf Course Extension Road manages IEC annual updates, deactivated IEC reactivation, detail modifications, and annual export compliance bundles for manufacturers, IT exporters, e-commerce sellers, and trading companies across Gurugram.</p>
            ...
            <div style="display:flex;gap:14px;flex-wrap:wrap;margin-top:24px;">
                ...
                <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20help%20with%20IEC%20Renewal%20in%20Gurugram.%20Please%20share%20details." target="_blank" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:#25D366;color:#fff;border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#128172; WhatsApp Us</a>
                <a href="mailto:sales@patronaccounting.com?subject=Enquiry%20for%20IEC%20Renewal%20in%20Gurugram&body=Hello%20Patron%20Accounting%20Team%2C%0A%0AI%20am%20interested%20in%20your%20IEC%20Renewal%20services%20in%20Gurugram%20and%20would%20like%20to%20know%20more.%0A%0APlease%20get%20in%20touch%20with%20me%20at%20your%20earliest%20convenience.%0A%0AThank%20you." style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:transparent;color:#fff;border:2px solid rgba(255,255,255,0.3);border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#9993;&#65039; Email Us</a>
            </div>
...
<section class="content-section" style="padding:48px 32px;background:var(--gray-50);">
    <div class="content-container">
        <div class="text-content">
            ...
            <p style="text-align:center;color:var(--text-muted);font-size:15px;margin-bottom:40px;">IEC renewal services available in major cities across India with local office support.</p>
            ...
            <div class="pa-city-block">
                ...
                <div class="pa-block-sub">End-to-end support for IEC Renewal in Gurugram</div>
...
<section class="content-section" style="padding:32px;">
    <div class="content-container">
        <div class="text-content" style="font-size:13px;color:var(--text-muted);">
            ...
            <p>This page is reviewed quarterly for accuracy. DGFT notifications, IEC annual update requirements, deactivation/reactivation procedures, and portal processes are verified against official trade notices. Gurugram export industry information is validated with each review.</p>
        </div>
    </div>
</section>
