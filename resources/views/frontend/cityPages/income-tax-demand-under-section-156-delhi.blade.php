...
@section('meta')
    ...
    <meta property="og:image" content="/images/income-tax-demand-under-section-156/delhi-og.webp">
    ...
    <meta name="twitter:image" content="/images/income-tax-demand-under-section-156/delhi-og.webp">
@endsection
  ...
  "@graph": [
    {
      ...
      "url": "/income-tax-demand-under-section-156/delhi",
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - IT Demand Notice S.156 in Delhi'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="income-tax-demand-under-section-156/delhi" selected>IT Demand Notice S.156 in Delhi</option>
                                ...
                                <option value="itr-filing-for-salary/delhi">ITR for Salary in Delhi</option>
