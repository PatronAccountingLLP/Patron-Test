        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'income-tax-demand-under-section-156/delhi',
                    'options'  => [
                        'income-tax-demand-under-section-156/delhi' => 'IT Demand Notice S.156 in Delhi',
                        ...
                        'itr-filing-for-salary/delhi' => 'ITR for Salary in Delhi',
                        'other' => 'Other',
                    ],
                ])
            </div>
