...
@section('meta')
    ...
    <meta property="og:image" content="/images/income-tax-return-filing/gurugram-og.webp">
    ...
    <meta name="twitter:image" content="/images/income-tax-return-filing/gurugram-og.webp">
@endsection
  ...
  "@graph": [
    {
      ...
      "url": "/income-tax-return-filing/gurugram",
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - ITR Filing in Gurugram'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="income-tax-return-filing/gurugram" selected>ITR Filing in Gurugram</option><option value="gst-registration/gurugram">GST Registration in Gurugram</option><option value="accounting-services/gurugram">Accounting Services in Gurugram</option><option value="payroll-services/gurugram">Payroll Services in Gurugram</option><option value="tan-registration/gurugram">TAN Registration in Gurugram</option><option value="pan-registration/gurugram">PAN Registration in Gurugram</option><option value="private-limited-company-registration/gurugram">Pvt Ltd Registration in Gurugram</option><option value="other">Other</option>
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    ...
                    @include('partials.faq-enquiry-form', ['enquiryLocation' => 'Gurugram', 'enquiryService' => 'ITR Filing in Gurugram'])
                </aside>
