...
@section('meta')
    ...
    <meta property="og:image" content="/images/income-tax-return/kolkata-og.webp">
    ...
    <meta name="twitter:image" content="/images/income-tax-return/kolkata-og.webp">
@endsection
        ...
        },
        {
          ...
          "itemListElement": [
            ...
            },
            {
              ...
              "item": "/income-tax-return/kolkata"
            }
          ]
        },
        {
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - ITR Filing in Kolkata'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="income-tax-return/kolkata" selected>ITR Filing in Kolkata</option>
                            ...
                            <option value="tan-registration/kolkata">TAN Registration in Kolkata</option>
