        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'iso-registration/mumbai',
                    'options'  => [
                        'iso-registration/mumbai' => 'ISO Registration in Mumbai',
                        ...
                        'fssai-central-license/mumbai' => 'FSSAI Central License in Mumbai',
                        'iec-registration/mumbai' => 'IEC Registration in Mumbai',
                        'epf-registration/mumbai' => 'EPF Registration in Mumbai',
                        'other' => 'Other',
                    ],
                ])
            </div>
