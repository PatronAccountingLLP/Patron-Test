            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20to%20issue%20shares%20for%20my%20Gurugram%20company.%20Please%20share%20details." target="_blank" class="btn-sample text-decoration-none">
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - Issue of Shares in Gurugram'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="issue-of-shares/gurugram" selected>Issue of Shares in Gurugram</option><option value="change-in-authorised-capital/gurugram">Change Authorised Capital in Gurugram</option><option value="fdi-compliance/gurugram">FDI Compliance in Gurugram</option><option value="transfer-of-shares/gurugram">Transfer of Shares in Gurugram</option><option value="esop/gurugram">ESOP Scheme in Gurugram</option><option value="private-limited-registration/gurugram">Company Registration in Gurugram</option><option value="annual-compliance/gurugram">Annual Compliance in Gurugram</option><option value="other">Other</option>
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    ...
                    @include('partials.faq-enquiry-form', ['enquiryLocation' => 'Gurugram', 'enquiryService' => 'Issue of Shares in Gurugram'])
                </aside>
