...
@section('meta')
    ...
    <meta property="og:image" content="/images/accounting-services-for-it-software/gurugram-og.webp">
    ...
    <meta name="twitter:image" content="/images/accounting-services-for-it-software/gurugram-og.webp">
@endsection
  ...
  "@graph": [
    {
      ...
      "url": "/it-sector-accounting-services/gurugram",
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - IT &amp; Software Accounting'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="accounting-services-for-it-software/gurugram" selected>IT Software Accounting in Gurugram</option>
        ...
        <div class="reviews-cta" style="margin-top: 16px; display: flex !important;">
            <div class="reviews-cta-content">
                ...
                <div class="reviews-cta-text">
                    ...
                    <p>Get export LUT compliance, transfer pricing documentation, and SaaS-ready financials for your Gurugram IT company.</p>
                </div>
            </div>
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    ...
                    @include('partials.faq-enquiry-form', ['enquiryLocation' => 'Gurugram', 'enquiryService' => 'IT/Software Accounting in Gurugram'])
                </aside>
