...
@section('meta')
    ...
    <meta property="og:image" content="/images/itr-filing-for-freelancers-professionals/gurugram-og.webp">
    ...
    <meta name="twitter:image" content="/images/itr-filing-for-freelancers-professionals/gurugram-og.webp">
@endsection
  ...
  "@graph": [
    {
      ...
      "url": "/itr-filing-for-freelancers-professionals/gurugram",
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - ITR for Professionals and Freelancers in Gurugram'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="itr-filing-for-freelancers-professionals/gurugram" selected>ITR for Freelancers in Gurugram</option>
                                ...
                                <option value="tds-return-filing/gurugram">TDS Return Filing in Gurugram</option>
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    ...
                    @include('partials.faq-enquiry-form', ['enquiryLocation' => 'Gurugram', 'enquiryService' => 'ITR for Freelancers in Gurugram'])
                </aside>
