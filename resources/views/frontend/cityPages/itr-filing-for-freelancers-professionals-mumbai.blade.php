...
@section('meta')
    ...
    <meta property="og:image" content="/images/itr-for-professionals-freelancers/mumbai-og.webp">
    ...
    <meta name="twitter:image" content="/images/itr-for-professionals-freelancers/mumbai-og.webp">
@endsection
  ...
  "@graph": [
    {
      ...
      "url": "/itr-filing-for-freelancers-professionals/mumbai",
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - ITR for Professionals &amp; Freelancers'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="itr-for-professionals-freelancers/mumbai" selected>ITR for Professionals &amp; Freelancers in Mumbai</option>
        ...
        <div class="reviews-cta" style="margin-top: 16px; display: flex !important;">
            <div class="reviews-cta-content">
                ...
                <div class="reviews-cta-text">
                    ...
                    <p>Get your professional ITR filed by a CA team that handles 44ADA vs 44AD optimisation, foreign income, and profession-specific expenses.</p>
                </div>
            </div>
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    ...
                    @include('partials.faq-enquiry-form', ['enquiryLocation' => 'Mumbai', 'enquiryService' => 'ITR for Professionals & Freelancers in Mumbai'])
                </aside>
