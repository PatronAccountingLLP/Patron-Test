...
@section('meta')
    ...
    <meta property="og:image" content="/images/itr-for-business-gurugram-og.webp">
    ...
    <meta name="twitter:image" content="/images/itr-for-business-gurugram-og.webp">
@endsection
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-4 private-registration-heading">
                        ITR for Business in Gurugram: Proprietor, Firm, LLP, and Company Tax Filing
                    </h1>
                    ...
                    <div class="mb-4">
                        <div class="d-flex align-items-start mb-3">
                            ...
                            <p class="mb-0 text-dark benefit-paragraph"><span>Documents:</span> Financial statements, P&L, balance sheet, Form 26AS/AIS, bank statements, audit report</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Fees:</span> ITR-4: Rs 3,000. ITR-3: Rs 5,000-8,000. ITR-5: Rs 8,000-15,000. ITR-6: Rs 10,000-25,000</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Eligibility:</span> Sole proprietors, partnership firms, LLPs, Pvt Ltd companies, startups, MNC subsidiaries</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Timeline:</span> Non-audit: 31 Jul/31 Aug. Company: 30 Sep. Audit firm: 31 Oct. TP: 30 Nov</p>
                        </div>
                    </div>
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="mailto:sales@patronaccounting.com?subject=Enquiry%20for%20Business%20ITR%20in%20Gurugram&body=Hello%20Patron%20Accounting%20Team%2C%0A%0AI%20am%20interested%20in%20your%20Business%20ITR%20services%20in%20Gurugram%20and%20would%20like%20to%20know%20more.%0A%0APlease%20get%20in%20touch%20with%20me%20at%20your%20earliest%20convenience.%0A%0AThank%20you." class="btn-sample text-decoration-none">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:18px;height:18px;"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,12 2,6"/></svg>
                            Email Us
                        </a>
                        <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20help%20with%20Business%20ITR%20in%20Gurugram.%20Please%20share%20details." target="_blank" class="btn-sample text-decoration-none">
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - Business ITR Gurugram'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="itr-for-business/gurugram" selected>ITR for Business in Gurugram</option>
...
<section class="testimonials-section">
    <div class="section-container">
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            ...
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">ITR-6 for our DLF Cyber City company. Patron modeled S115BAA vs regular rate, recommended 115BAA - saved Rs 45 lakh annually. Tax audit coordinated. Filed by 25 Sep. Clean assessment.</div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Small restaurant on MG Road. Turnover Rs 80 lakh. Patron set up 44AD presumptive - 8% deemed income, no books, no audit. ITR-4 filed. Simple and compliant. Rs 3,000 fee vs Rs 15,000 for regular.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div>
                    ...
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Owner, Restaurant, MG Road</div>
                    <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                </div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">LLP with 4 partners. Patron files ITR-5, allocates partner income, handles tax audit, and files individual ITR-3 for each partner. Integrated compliance for the entire firm.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div>
                    ...
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Partner, Consulting LLP, Golf Course Road</div>
                    <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                </div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">DPIIT startup. Patron filed ITR-6 with S80-IAC benefit claim. Rs 1.2 crore tax saving over 3 years. Also handles angel tax exemption documentation. Startup-specific expertise.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div>
                    ...
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Founder, Tech Startup, Sohna Road</div>
                    <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                </div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Manufacturing unit. TP documentation for parent company transactions. Patron prepared benchmarking study, filed ITR-6 by 30 Nov, and handled TP assessment. Zero adjustment.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
        ...
        <div class="reviews-cta" style="margin-top: 16px; display: flex !important;">
            <div class="reviews-cta-content">
                ...
                <div class="reviews-cta-text">
                    ...
                    <p>Trusted business ITR filing partner for all entity types across Gurugram.</p>
                </div>
            </div>
...
<div class="stats-bar">
    <div class="stats-container">
        <div class="stat-item">
            ...
            <div class="stat-content"><span class="stat-value">10,000+</span><span class="stat-label">Businesses Served</span><span class="stat-desc">Business ITR filing and tax compliance across India.</span></div>
        </div>
        <div class="stat-item">
            <div class="stat-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8M12 17v4"/></svg></div>
            <div class="stat-content"><span class="stat-value">15+</span><span class="stat-label">Years Experience</span><span class="stat-desc">Deep expertise in ITR-3/4/5/6, tax audit, 44AD, and 115BAA.</span></div>
        </div>
        <div class="stat-item">
            <div class="stat-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><path d="M14 2v6h6M16 13H8M16 17H8"/></svg></div>
            <div class="stat-content"><span class="stat-value">50,000+</span><span class="stat-label">Documents Filed</span><span class="stat-desc">Business ITR filings, tax audits, and compliance documents handled.</span></div>
        </div>
        <div class="stat-item">
            <div class="stat-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="8" r="7"/><path d="M8.21 13.89L7 23l5-3 5 3-1.21-9.12"/></svg></div>
            <div class="stat-content"><span class="stat-value">4.9&#9733;</span><span class="stat-label">Client Rating</span><span class="stat-desc">Trusted by proprietors, firms, LLPs, and companies.</span></div>
        </div>
...
<section class="content-section" id="overview-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Why Business ITR Filing Matters in Gurugram</h2>
            <div class="content-text">
                <div class="highlight-box" style="margin-bottom:20px;">
                    <p><strong>&#128204; TL;DR - Business ITR Services at a Glance</strong></p>
                    <p>Every business in Gurugram must file ITR annually. ITR-3 for proprietors, ITR-4 (Sugam) for presumptive (44AD/44ADA), ITR-5 for firms/LLPs (30%), ITR-6 for companies (22% under S115BAA). Due: 31 Jul (non-audit) / 31 Aug (ITR-4) / 30 Sep (company) / 31 Oct (audit) / 30 Nov (TP). Late = Rs 5,000 S234F + loss carry-forward forfeiture. AY 2026-27 forms notified 30 Mar 2026.</p>
                </div>
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Parameter</th><th>Detail</th></tr></thead>
                    <tbody>
                        <tr><td>Governing Law</td><td>Income Tax Act 1961 | S44AD/44ADA | S44AB | S115BAA | S234F | S92 (TP)</td></tr>
                        <tr><td>Registry</td><td>Copyright Office, DPIIT (<a href="https://incometax.gov.in" target="_blank" rel="noopener">Income Tax Portal (incometax.gov.in)</a>). Registrar of Copyrights</td></tr>
                        <tr><td>Form</td><td>ITR-3 (proprietor) | ITR-4 Sugam (presumptive) | ITR-5 (firm/LLP) | ITR-6 (company)</td></tr>
                ...
                <p>Gurugram's business landscape spans every entity type. DLF Cyber City IT companies (ITR-6), Golf Course Road MNCs (ITR-6 with TP), IMT Manesar manufacturers (ITR-5/6), Sohna Road proprietors (ITR-3/4). For comprehensive information about <a href="/itr-for-business">business ITR across India</a>, visit our national service page.</p>
                <p>CBDT notified AY 2026-27 forms on 30 March 2026. Filing window is open. Late = Rs 5,000 + interest + loss forfeiture. Tax audit by 30 Sep. Advance tax Q1 by 15 June approaching. You will also need <a href="/tds-return-filing-24q">TDS return filing</a> and <a href="#">GST return filing</a> for complete compliance.</p>
    ...
    <div class="content-container">
        <div class="two-column">
            <div class="column-content">
                <h2 class="section-title">Which ITR Form for Your Gurugram Business</h2>
                <div class="content-text what-is-definition">
                    <p>ITR-3 for proprietors with business income. ITR-4 (Sugam) for presumptive taxation under 44AD (8% of turnover up to Rs 2 crore) and 44ADA (50% of receipts up to Rs 50 lakh). No books or audit needed under presumptive.</p>
                    <p>ITR-5 for partnership firms and LLPs at 30% flat. ITR-6 for companies - 22% under S115BAA (effective 25.17%) or 25%/30%. Filed electronically with DSC. Tax audit under S44AB when turnover exceeds thresholds.</p>
                    <p>Haryana has no Professional Tax. ITR + GST + TDS + PF + ESI = core compliance. For complete business compliance, pair with <a href="/tds-return-filing-24q">TDS return filing</a> and <a href="#">GST return filing</a>.</p>
                </div>
                <div class="highlight-box" style="margin-top:20px;">
                    <p><strong>Key Terms for Copyright Registration:</strong></p>
                    <ul>
                        <li><strong>ITR-3/ITR-4</strong> - Proprietor regular or presumptive (44AD/44ADA)</li>
                        <li><strong>ITR-5/ITR-6</strong> - Firm/LLP (30%) or Company (22-30%)</li>
                        <li><strong>Section 44AD</strong> - Presumptive 8% income on turnover up to Rs 2 Cr</li>
                        <li><strong>Section 115BAA</strong> - Concessional 22% company tax rate</li>
                        <li><strong>Tax Audit S44AB</strong> - Mandatory above Rs 1 Cr / Rs 10 Cr threshold</li>
                    </ul>
                </div>
            </div>
...
<section class="content-section" id="who-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Who Must File Business ITR in Gurugram</h2>
            <div class="content-text">
                <ul>
                    <li><strong>IT companies in DLF Cyber City</strong> (ITR-6). S115BAA at 22%. Complex P&L with employee costs, SaaS revenue, inter-company transactions. DSC filing. 30 Sep deadline.</li>
                    <li><strong>Sole proprietors on Sohna Road and MG Road</strong> (ITR-3/4). Shops, clinics, restaurants, freelancers. Presumptive 44AD for small businesses. 31 Jul / 31 Aug deadline.</li>
                    ...
                    <li><strong>Manufacturing companies in IMT Manesar</strong> (ITR-6). Factory P&L. Depreciation schedules. MAT or S115BAA. Tax audit. 30 Sep deadline.</li>
...
<section class="content-section" id="services-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">8 Business ITR Services Included</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Service</th><th>What We Do</th></tr></thead>
                    <tbody>
                        <tr><td>ITR-4 Sugam (Presumptive)</td><td>44AD/44ADA. 8% or 50% deemed income. No books. No audit. Small businesses and professionals. 31 Aug.</td></tr>
                        <tr><td>ITR-3 (Proprietor Regular)</td><td>Business income, P&L, balance sheet. Slab rates. Deductions S80C-80U. 31 Jul non-audit.</td></tr>
                        <tr><td>ITR-5 (Firm / LLP)</td><td>30% flat. Partner allocation. Firm computation. Audit if applicable. Mandatory even for NIL income.</td></tr>
                        <tr><td>ITR-6 (Company)</td><td>22% S115BAA or 25/30%. DSC. MAT S115JB. Form 10-IC. 30 Sep. Tax audit coordination.</td></tr>
                        <tr><td>Tax Audit (S44AB)</td><td>Mandatory above Rs 1 Cr. Report by 30 Sep. ITR by 31 Oct. Audit observations. Qualified reports.</td></tr>
                        <tr><td>TP Documentation and Advance Tax</td><td>S92 transfer pricing for MNCs. Advance tax 4 quarterly installments (15 Jun/Sep/Dec/Mar). Interest computation.</td></tr>
...
<section class="steps-section" id="procedure-section">
    <div class="section-container">
        <header class="section-header" style="text-align:center;margin-bottom:48px;">
            ...
            <h2 class="section-title">How Business ITR Filing Works: 5-Step Process</h2>
            <p class="section-subtitle" style="text-align:left;max-width:100%;">Our CA-led team handles ITR-3/4/5/6, tax audit, presumptive taxation, 115BAA, transfer pricing, advance tax, and startup benefits for all Gurugram business entities.</p>
        </header>
        <div class="steps-container">
            <div class="step-card">
                <div class="step-content">
                    <span class="step-badge">Step 1</span>
                    <h3 class="step-title">Select Correct ITR Form</h3>
                    <p class="step-description">Entity type determines form: ITR-3/4 (proprietor), ITR-5 (firm/LLP), ITR-6 (company). Check presumptive eligibility. Verify income sources.</p>
                    <div class="step-highlights">
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Selected</span>
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Determined</span>
                    </div>
                </div>
                <div class="step-visual">
                    <div class="step-illustration">
                        ...
                        <span class="illustration-label">Form Set</span>
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">Prepare Financials and Audit</h3>
                    <p class="step-description">P&L, balance sheet, schedules. Tax audit if required (S44AB). Advance tax computation. Books of accounts finalized.</p>
                    <div class="step-highlights">
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>P&L Ready</span>
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Audited</span>
                    </div>
                </div>
                <div class="step-visual">
                    <div class="step-illustration">
                        ...
                        <span class="illustration-label">Books OK</span>
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">Compute Tax and File Return</h3>
                    <p class="step-description">Apply correct rate. Claim deductions. Upload on incometax.gov.in. DSC for companies. Form 10-IC for S115BAA.</p>
                    <div class="step-highlights">
                ...
                <div class="step-visual">
                    <div class="step-illustration">
                        ...
                        <span class="illustration-label">Return OK</span>
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">Verify 26AS/AIS</h3>
                    <p class="step-description">Cross-check TDS, TCS, advance tax credits with Form 26AS/AIS. Resolve mismatches before filing.</p>
                    <div class="step-highlights">
                ...
                <div class="step-visual">
                    <div class="step-illustration">
                        ...
                        <span class="illustration-label">Credits OK</span>
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">Pay Balance Tax</h3>
                    <p class="step-description">Self-assessment tax via Challan 280 before filing. Interest S234A/B/C computation. Tax payment receipt.</p>
                    <div class="step-highlights">
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">Post-Filing Compliance</h3>
                    <p class="step-description">ITR-V verification (if not DSC). Refund tracking. Assessment response if selected. Next year advance tax planning.</p>
                    <div class="step-highlights">
                ...
                <div class="step-visual">
                    <div class="step-illustration">
                        ...
                        <span class="illustration-label">Done</span>
        ...
        <div class="highlight-box" style="margin-top:32px;max-width:1000px;margin-left:auto;margin-right:auto;">
            <p><strong>City Processing Note:</strong> Patron's Gurugram office handles ITR-3/4/5/6, tax audit, presumptive advisory, and advance tax for all business types across Gurugram.</p>
        </div>
    </div>
</section>
...
<section class="content-section" id="documents-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Documents Required for Business ITR</h2>
            <div class="content-text">
                <ul>
                    <li><strong>Financial Statements:</strong> P&L, balance sheet, schedules. Audited if applicable. Tax computation.</li>
                    <li><strong>Form 26AS/AIS:</strong> TDS credits, TCS, advance tax, self-assessment tax verification.</li>
                    <li><strong>Bank Statements:</strong> All business accounts. Cash flow verification. Interest income reconciliation.</li>
                    <li><strong>Additional:</strong> Tax audit report (S44AB) | DSC (companies) | Form 10-IC (S115BAA) | TP documentation (S92).</li>
                </ul>
            </div>
        </div>
    </div>
...
<section class="content-section" id="challenges-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">5 Common Business ITR Challenges in Gurugram</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Challenge</th><th>Impact</th><th>How Patron Accounting Solves It</th></tr></thead>
                    <tbody>
                        <tr><td>Wrong ITR Form Selection</td><td>Proprietor files ITR-4 but has capital gains or foreign income. Reject. Must use ITR-3. Form mismatch = re-filing</td><td>Check all income sources before selecting form. ITR-4 has restrictions. When in doubt, use ITR-3.</td></tr>
                        <tr><td>44AD Opt-Out Lock-In</td><td>Once opted into 44AD, must continue for 5 years. Opt-out = maintain books and get audit for 5 years</td><td>Evaluate 44AD lock-in before opting in. Consider growth trajectory. Rs 2 Cr threshold. Plan for 5 years.</td></tr>
                        <tr><td>115BAA Election Irreversibility</td><td>Once elected, S115BAA cannot be withdrawn. Company permanently forfeits specified deductions and exemptions</td><td>Model both scenarios (115BAA vs regular) before electing. Consider future deduction eligibility. Permanent choice.</td></tr>
                        <tr><td>Transfer Pricing Documentation Gaps</td><td>MNC subsidiary without S92 documentation. Assessment results in TP adjustment with 100% penalty</td><td>Prepare TP study, benchmarking, and documentation well before 30 Nov deadline. Contemporaneous records mandatory.</td></tr>
                        <tr><td>Loss Carry-Forward Forfeiture</td><td>Filed ITR after due date. Business loss and capital loss carry-forward permanently lost. Cannot be recovered</td><td>File before due date every year. Even estimated return preserves carry-forward. Late filing = permanent loss.</td></tr>
                    </tbody>
                </table>
                </div>
            </div>
...
<section class="content-section" id="fees-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Business ITR Fees in Gurugram 2026</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table class="table-amount">
                    <thead><tr><th>Fee Component</th><th>Amount</th></tr></thead>
                    <tbody>
                        <tr><td>ITR-4 (Sugam - Presumptive)</td><td>From Rs 3,000</td></tr>
                        <tr><td>ITR-3 (Proprietor - Regular)</td><td>Rs 5,000-8,000</td></tr>
                        <tr><td>ITR-5 (Partnership / LLP)</td><td>Rs 8,000-15,000</td></tr>
                        <tr><td>ITR-6 (Company)</td><td>Rs 10,000-25,000</td></tr>
                        <tr><td>Tax Audit (S44AB)</td><td>Rs 15,000-30,000</td></tr>
                        <tr><td>Transfer Pricing Documentation</td><td>Rs 25,000-75,000</td></tr>
                ...
                <p style="margin-top:16px;">No government fee for filing. Late fee Rs 5,000 S234F. Professional fees cover computation, filing, audit coordination, and post-filing support.</p>
                <p style="margin-top:16px;"><strong>Get a free Copyright Registration consultation - <a href="tel:+919459456700">Call +91 945 945 6700</a> or <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20help%20with%20Business%20ITR%20in%20Gurugram.%20Please%20share%20fee%20details." target="_blank">WhatsApp us</a>. No-obligation assessment.</strong></p>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section" id="timeline-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Business ITR Due Dates</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Stage</th><th>Estimated Timeline</th></tr></thead>
                    <tbody>
                        <tr><td>ITR-3 / ITR-4 (Non-Audit)</td><td>31 July 2026 / 31 August 2026</td></tr>
                        <tr><td>ITR-6 (Company)</td><td>30 September 2026</td></tr>
                        <tr><td>Tax Audit Report</td><td>30 September 2026</td></tr>
                        <tr><td>ITR-5 (Audit Firm/LLP)</td><td>31 October 2026</td></tr>
                        <tr><td>Transfer Pricing Cases</td><td>30 November 2026</td></tr>
                        <tr><td>Advance Tax (Q1-Q4)</td><td>15 Jun / 15 Sep / 15 Dec / 15 Mar</td></tr>
                        <tr><td>Late Penalty</td><td>Rs 5,000 S234F + interest S234A/B/C + loss forfeiture</td></tr>
                    </tbody>
                </table>
                </div>
                <div class="highlight-box" style="margin-top:16px;">
                    <p><strong>Note:</strong> Non-audit: 31 Jul/31 Aug. Company: 30 Sep. Audit firm: 31 Oct. TP: 30 Nov. Tax audit: 30 Sep. Advance tax quarterly.</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="why-choose-section" id="benefits-section">
    <div class="section-container">
        <div style="text-align:center;margin-bottom:48px;">
            ...
            <h2 class="section-title">Why Choose Patron for Business ITR in Gurugram</h2>
        </div>
        <div class="features-grid">
            <article class="feature-card">
                ...
                <h3 class="feature-title">All Entity Types</h3>
                <p class="feature-text">ITR-3, ITR-4, ITR-5, ITR-6. Every business structure covered. Correct form selection guaranteed.</p>
            </article>
            <article class="feature-card">
                ...
                <h3 class="feature-title">Presumptive Advisory</h3>
                <p class="feature-text">44AD/44ADA eligibility. Lock-in implications. Growth planning. Threshold monitoring. Optimal scheme selection.</p>
            </article>
            <article class="feature-card">
                ...
                <h3 class="feature-title">Tax Audit</h3>
                <p class="feature-text">S44AB compliance. Audit report by 30 Sep. Observations addressed. Qualified reports handled. ITR by 31 Oct.</p>
            </article>
            <article class="feature-card">
                <div class="feature-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg></div>
                <h3 class="feature-title">115BAA Advisory</h3>
                <p class="feature-text">Concessional rate modeling. Deduction forfeiture analysis. MAT comparison. Permanent election guidance.</p>
            </article>
            <article class="feature-card">
                ...
                <h3 class="feature-title">Transfer Pricing</h3>
                <p class="feature-text">S92 documentation. Benchmarking study. International transactions. DTAA. 30 Nov deadline. MNC compliance.</p>
            </article>
            <article class="feature-card">
                ...
                <h3 class="feature-title">Advance Tax</h3>
                <p class="feature-text">Quarterly installments. 15 Jun/Sep/Dec/Mar. Interest minimization. Cash flow planning. S234B/C avoidance.</p>
            </article>
        </div>
    </div>
</section>
...
<section class="content-section" id="comparison-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Business Tax Rates Comparison</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table class="table-comparison">
                    <thead><tr><th>Entity Type</th><th>Rate / Surcharge / Cess / Effective Rate</th></tr></thead>
                    <tbody>
                        <tr><td>Proprietor</td><td>Slab rates / 10-25% surcharge / 4% cess / Varies by income</td></tr>
                        <tr><td>Partnership Firm</td><td>30% / 12% above Rs 1 Cr / 4% / ~34.32-34.94%</td></tr>
                        <tr><td>LLP</td><td>30% / 12% above Rs 1 Cr / 4% / ~34.32-34.94%</td></tr>
                        <tr><td>Company (S115BAA)</td><td>22% / 10% / 4% / ~25.17%</td></tr>
                        <tr><td>Company (regular)</td><td>25-30% / 7-12% / 4% / ~26-34.94%</td></tr>
                        <tr><td>New Manufacturing (S115BAB)</td><td>15% / 10% / 4% / ~17.16%</td></tr>
                    </tbody>
                </table>
                </div>
                <p style="margin-top:12px;">External Authority: <a href="https://incometax.gov.in" target="_blank" rel="noopener">Income Tax Portal (incometax.gov.in)</a></p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                <ul>
                    ...
                    <li><a href="/tds-return-filing-24q">TDS Return Filing</a> - Quarterly TDS return and Form 16 compliance</li>
...
<section class="content-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Legal Framework for Business ITR</h2>
            <div class="content-text">
                <p>Business ITR is governed by the <strong>Income Tax Act 1961</strong>. <strong>S44AD/44ADA</strong>: presumptive taxation. <strong>S44AB</strong>: tax audit. <strong>S115BAA</strong>: concessional 22% company rate. <strong>S234F</strong>: late filing penalty Rs 5,000. <strong>S92</strong>: transfer pricing.</p>
                <p>Proprietor: <strong>slab rates</strong>. Firm/LLP: <strong>30% flat</strong>. Company: <strong>22% S115BAA</strong> / 25% / 30%. Tax audit above <strong>Rs 1 Cr</strong> (Rs 10 Cr with <5% cash). Advance tax: <strong>15 Jun/Sep/Dec/Mar</strong>. AY 2026-27 forms notified.</p>
                <p>India's membership in the Berne Convention (1886, India joined 1928), the Universal Copyright Convention, and TRIPS (WTO) ensures international recognition. The WIPO Copyright Treaty (WCT) and WIPO Performances and Phonograms Treaty (WPPT) provide additional protections for digital rights. Copyright registration with the Copyright Office at <a href="https://incometax.gov.in" target="_blank" rel="noopener">Income Tax Portal (incometax.gov.in)</a> is administered by the Department for Promotion of Industry and Internal Trade (DPIIT). IP enforcement in Gurugram falls under the jurisdiction of the Delhi High Court.</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    <h2 class="faq-expanded__title">FAQs - Business ITR in Gurugram</h2>
                    <p class="faq-expanded__lead">Answers to common questions about business ITR including form selection, presumptive taxation, tax audit, 115BAA, and due dates for Gurugram businesses.</p>
                    @include('partials.faq-enquiry-form', ['enquiryLocation' => 'Gurugram', 'enquiryService' => 'Business ITR in Gurugram'])
                </aside>
                <div class="faq-expanded__list">
                    <div class="faq-expanded__item" id="faq-1">
                        <h3 class="faq-expanded__q">Which ITR form should my business file?</h3>
                        <div class="faq-expanded__a"><p>ITR-3 for sole proprietors and individuals with business or professional income (regular computation). ITR-4 (Sugam) for presumptive taxation under Section 44AD (turnover up to Rs 2 crore) or 44ADA (professionals up to Rs 50 lakh). ITR-5 for partnership firms and LLPs. ITR-6 for all companies. Form selection depends on entity type, income structure, and whether presumptive taxation is opted.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-2">
                        <h3 class="faq-expanded__q">How much does business ITR filing cost?</h3>
                        <div class="faq-expanded__a"><p>ITR-4 (Sugam) from Rs 3,000. ITR-3 (proprietor regular) Rs 5,000-8,000. ITR-5 (firm/LLP) Rs 8,000-15,000. ITR-6 (company) Rs 10,000-25,000. Tax audit Rs 15,000-30,000. Transfer pricing documentation Rs 25,000-75,000. Call +91 945 945 6700.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-3">
                        <h3 class="faq-expanded__q">What is the due date for business ITR?</h3>
                        <div class="faq-expanded__a"><p>Total timeline: 2-6 months. Filing and Diary Number: immediate. Mandatory 30-day objection waiting period: 1 month. Pay Balance Tax: 1-3 months. Certificate issuance: after examination approval. If a third-party objection is filed, the timeline extends by 2-4 months for hearing and resolution.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-4">
                        <h3 class="faq-expanded__q">What is Section 44AD presumptive taxation?</h3>
                        <div class="faq-expanded__a"><p>Eligible businesses with turnover up to Rs 2 crore (Rs 3 crore if cash receipts are under 5%) can declare 8% of turnover as taxable income (6% for digital and banking receipts). No detailed books of accounts required. No tax audit mandated. File ITR-4 by 31 August 2026. Once opted in, must continue for 5 years. Opt-out triggers book maintenance and audit obligations for 5 years.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-5">
                        <h3 class="faq-expanded__q">What is Section 115BAA for companies?</h3>
                        <div class="faq-expanded__a"><p>Concessional 22% corporate tax rate (effective approximately 25.17% with surcharge and cess) for domestic companies that forgo specified deductions and exemptions including Section 80-IA, 80-IB, additional depreciation, and others. No Minimum Alternate Tax applies. Election is irreversible. File Form 10-IC along with ITR-6.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-6">
                        <h3 class="faq-expanded__q">When is tax audit required?</h3>
                        <div class="faq-expanded__a"><p>Under Section 44AB: business turnover exceeding Rs 1 crore (Rs 10 crore if cash transactions do not exceed 5% of total turnover and cash payments do not exceed 5% of total payments). Professional gross receipts above Rs 50 lakh. Opt-out from presumptive taxation. Audit report must be filed by 30 September 2026. ITR due date extends to 31 October 2026.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-7">
                        <h3 class="faq-expanded__q">Do dormant companies need to file ITR?</h3>
                        <div class="faq-expanded__a"><p>Yes. Every company registered under the Companies Act must file ITR-6 regardless of whether it has income, activity, or operations. NIL return filing is mandatory. Non-filing triggers Section 234F late penalty of Rs 5,000, potential ROC notices for non-compliance, and risk of director disqualification under Section 164(2) if defaults persist for three consecutive years.</p></div>
                    </div>
                </div>
            </div>
            ...
            <div class="highlight-box" style="margin-top:32px;">
                ...
                <p><strong>Business ka ITR kab file karna hai?</strong> Non-audit: 31 Jul. ITR-4: 31 Aug. Company: 30 Sep. Audit firm/LLP: 31 Oct. TP: 30 Nov.</p>
                <p><strong>Meri company ka form kaun sa hai?</strong> Pvt Ltd: ITR-6. LLP: ITR-5. Proprietorship: ITR-3 ya ITR-4. Partnership: ITR-5.</p>
                <p><strong>44AD scheme kya hai?</strong> Rs 2 Cr tak turnover pe 8% income declare karo (6% digital). Books nahi, audit nahi. ITR-4 mein file karo.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section" style="background: var(--orange-lighter) !important; border-left: 4px solid var(--orange);">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Why Business ITR Filing Matters in Gurugram</h2>
            <div class="content-text">
                <p>CBDT notified AY 2026-27 ITR forms on 30 March 2026. Filing window is open. Companies must file by 30 Sep, firms by 31 Oct (audit), proprietors by 31 Jul/31 Aug. Late = Rs 5,000 + interest + loss forfeiture. Wrong form, 44AD lock-in, 115BAA irreversibility, and TP gaps are common Gurugram pitfalls. Start now.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section" style="background: var(--blue) !important;">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title" style="color:#FFFFFF !important;">Start Your Business ITR in Gurugram Today</h2>
            <div class="content-text" style="text-align:left;">
                <p style="color:rgba(255,255,255,0.85);">ITR for business in Gurugram covers every entity type - ITR-3/4 for proprietors, ITR-5 for firms/LLPs, ITR-6 for companies - with tax audit, presumptive taxation, 115BAA advisory, transfer pricing, and advance tax computation for all Gurugram businesses.</p>
                <p style="color:rgba(255,255,255,0.85);">Patron Accounting's Gurugram office on Golf Course Extension Road provides CA-assisted business ITR filing for all entity types including tax audit, transfer pricing, startup benefits, advance tax, and integrated compliance for IT companies, manufacturers, and corporates across Gurugram.</p>
            ...
            <div style="display:flex;gap:14px;flex-wrap:wrap;margin-top:24px;">
                ...
                <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20help%20with%20Business%20ITR%20in%20Gurugram.%20Please%20share%20details." target="_blank" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:#25D366;color:#fff;border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#128172; WhatsApp Us</a>
                <a href="mailto:sales@patronaccounting.com?subject=Enquiry%20for%20Business%20ITR%20in%20Gurugram&body=Hello%20Patron%20Accounting%20Team%2C%0A%0AI%20am%20interested%20in%20your%20Business%20ITR%20services%20in%20Gurugram%20and%20would%20like%20to%20know%20more.%0A%0APlease%20get%20in%20touch%20with%20me%20at%20your%20earliest%20convenience.%0A%0AThank%20you." style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:transparent;color:#fff;border:2px solid rgba(255,255,255,0.3);border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#9993;&#65039; Email Us</a>
            </div>
...
<section class="content-section" style="padding:48px 32px;background:var(--gray-50);">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title" style="text-align:center;margin-bottom:12px;">Business ITR Across India</h2>
            <p style="text-align:center;color:var(--text-muted);font-size:15px;margin-bottom:40px;">Business ITR filing services available across India with local office support.</p>
            ...
            <div class="pa-city-block">
                ...
                <div class="pa-block-sub">End-to-end support for Business ITR in Gurugram</div>
...
<section class="content-section" style="padding:32px;">
    <div class="content-container">
        <div class="text-content" style="font-size:13px;color:var(--text-muted);">
            ...
            <p>This page is reviewed quarterly for accuracy. Income Tax Act provisions, ITR form rules, tax rates, audit thresholds, and due dates verified against CBDT notifications. AY 2026-27 forms notified 30 March 2026. Gurugram business landscape validated with each review.</p>
        </div>
    </div>
</section>
