...
@section('meta')
    ...
    <meta property="og:image" content="/images/itr-for-companies/gurugram-og.webp">
    ...
    <meta name="twitter:image" content="/images/itr-for-companies/gurugram-og.webp">
@endsection
  ...
  "@graph": [
    {
      ...
      "url": "/itr-for-companies/gurugram",
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - ITR for Companies in Gurugram'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="itr-for-companies/gurugram" selected>ITR for Companies in Gurugram</option>
