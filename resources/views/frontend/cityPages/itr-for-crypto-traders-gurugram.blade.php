...
@section('meta')
    ...
    <meta property="og:image" content="/images/itr-for-crypto-traders/gurugram-og.webp">
    ...
    <meta name="twitter:image" content="/images/itr-for-crypto-traders/gurugram-og.webp">
@endsection
  ...
  "@graph": [
    {
      ...
      "url": "/itr-for-crypto-traders/gurugram",
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'itr-for-crypto-traders/gurugram',
                    'options'  => [
                        'itr-for-crypto-traders/gurugram' => 'ITR for Crypto Traders in Gurugram',
