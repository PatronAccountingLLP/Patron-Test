...
@section('meta')
    ...
    <meta property="og:image" content="/images/legal-drafting-service/mumbai-og.webp">
    ...
    <meta name="twitter:image" content="/images/legal-drafting-service/mumbai-og.webp">
@endsection
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'legal-drafting-service/mumbai',
                    'options'  => [
                        'legal-drafting-service/mumbai' => 'Legal Drafting in Mumbai',
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    ...
                    @include('partials.faq-enquiry-form', ['enquiryLocation' => 'Mumbai', 'enquiryService' => 'Legal Drafting in Mumbai'])
                </aside>
