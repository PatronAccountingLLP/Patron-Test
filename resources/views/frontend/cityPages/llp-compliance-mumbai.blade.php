...
@section('meta')
    ...
    <meta property="og:image" content="/images/llp-compliance/mumbai-og.webp">
    ...
    <meta name="twitter:image" content="/images/llp-compliance/mumbai-og.webp">
@endsection
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'llp-compliance/mumbai',
                    'options'  => [
                        'llp-compliance/mumbai' => 'LLP Compliance in Mumbai',
