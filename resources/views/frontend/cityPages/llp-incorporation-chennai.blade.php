...
@section('meta')
    ...
    <meta property="og:image" content="/images/llp-incorporation/chennai-og.webp">
    ...
    <meta name="twitter:image" content="/images/llp-incorporation/chennai-og.webp">
@endsection
        ...
        },
        {
          ...
          "itemListElement": [
            ...
            },
            {
              ...
              "item": "/llp-incorporation/chennai"
            }
          ]
        },
        {
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="mailto:sales@patronaccounting.com?subject=Enquiry%20for%20LLP%20Registration%20in%20Chennai&body=Hello%20Patron%20Accounting%20Team%2C%0A%0AI%20need%20LLP%20registration%20in%20Chennai.%0A%0AThank%20you." class="btn-sample text-decoration-none">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:18px;height:18px;"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,12 2,6"/></svg>
                            Email Us
                        </a>
                        <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20LLP%20registration%20in%20Chennai.%20Please%20share%20details." target="_blank" class="btn-sample text-decoration-none">
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - LLP Registration in Chennai'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="llp-incorporation/chennai" selected>LLP Registration in Chennai</option><option value="private-limited-company-registration/chennai">Private Limited Company Registration in Chennai</option><option value="gst-registration/chennai">GST Registration in Chennai</option><option value="trademark-registration/chennai">Trademark Registration in Chennai</option><option value="startup-registration/chennai">Startup Registration in Chennai</option><option value="accounting-services/chennai">Accounting Services in Chennai</option><option value="income-tax-return/chennai">Income Tax Return Filing in Chennai</option><option value="payroll-services/chennai">Payroll Services in Chennai</option><option value="other">Other</option>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p style="margin-top:16px;"><strong>Get a free LLP Registration in Chennai consultation - <a href="tel:+919459456700">Call +91 945 945 6700</a> or <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20LLP%20registration%20in%20Chennai.%20Please%20share%20a%20free%20consultation." target="_blank">WhatsApp us</a>. No-obligation assessment.</strong></p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    ...
                    @include('partials.faq-enquiry-form', ['enquiryLocation' => 'Chennai', 'enquiryService' => 'LLP Registration in Chennai'])
                </aside>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>LLP Agreement (Form 3) must be filed within 30 days of incorporation. Late filing attracts Rs 100 per day penalty under LLP Act 2008 - that is Rs 3,000 per month of delay. Annual return (Form 11) is due by 30 May and Form 8 by 30 October - late filing of either attracts Rs 100 per day. If your Chennai business is operating without a registered entity, you are also missing limited liability protection on every contract you sign.</p><p><strong><a href="tel:+919459456700">Call +91 945 945 6700</a> or <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20LLP%20registration%20in%20Chennai." target="_blank">WhatsApp us</a> to start your LLP registration in Chennai today.</strong></p>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div style="display:flex;gap:14px;flex-wrap:wrap;margin-top:24px;">
                ...
                <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20LLP%20registration%20in%20Chennai.%20Please%20share%20a%20free%20consultation." target="_blank" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:#25D366;color:#fff;border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#128172; WhatsApp Us</a>
                <a href="mailto:sales@patronaccounting.com?subject=Enquiry%20for%20LLP%20Registration%20in%20Chennai&body=Hello%20Patron%20Accounting%20Team%2C%0A%0AI%20need%20LLP%20registration%20in%20Chennai.%0A%0AThank%20you." style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:transparent;color:#fff;border:2px solid rgba(255,255,255,0.3);border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#9993;&#65039; Email Us</a>
            </div>
