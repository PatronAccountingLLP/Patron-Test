        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'llp-incorporation/kolkata',
                    'options'  => [
                        'llp-incorporation/kolkata' => 'LLP Registration in Kolkata',
                        'gst-registration/kolkata' => 'GST Registration in Kolkata',
                        'private-limited-company-registration-in-india/kolkata' => 'Pvt Ltd Registration in Kolkata',
