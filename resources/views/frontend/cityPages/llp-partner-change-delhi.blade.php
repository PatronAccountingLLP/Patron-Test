...
@section('meta')
    ...
    <meta property="og:image" content="/images/llp-partner-change/delhi-og.webp">
    ...
    <meta name="twitter:image" content="/images/llp-partner-change/delhi-og.webp">
@endsection
        ...
        <div class="row align-items-center">
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20help%20with%20LLP%20Partner%20Change%20in%20Delhi.%20Please%20call%20me." target="_blank" class="btn-sample text-decoration-none">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'llp-partner-change/delhi',
                    'options'  => [
                        'llp-partner-change/delhi' => 'LLP Partner Change in Delhi',
                        'llp-agreement-change/delhi' => 'LLP Agreement Change in Delhi',
                        'llp-contribution-change/delhi' => 'LLP Contribution Change in Delhi',
                        'llp-name-change/delhi' => 'LLP Name Change in Delhi',
                        'llp-incorporation/delhi' => 'LLP Registration in Delhi',
                        'pvt-llp-compliance/delhi' => 'LLP Compliance in Delhi',
...
<section class="testimonials-section">
    <div class="section-container">
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
    <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
    <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Senior partner retiring, 2 new partners joining. Patron applied for both DPINs, drafted comprehensive supplementary deed, filed Form 4 + Form 3 linked in 10 days. Updated bank signatories and GST. Seamless transition.</div>
    <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
        ...
        <div>
            <div style="font-weight:700;font-size:13px;color:var(--blue);">Anil Kapoor</div>
            <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Managing Partner, Delhi LLP</div>
            <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
        </div>
        <div style="margin-left:auto;font-size:11px;color:var(--text-muted);">2 months ago</div>
    </div>
...
<div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
    <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
    <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Needed to add a foreign investor-partner to our Delhi startup LLP. Patron handled the passport-based DPIN application, drafted the supplementary deed with clear contribution and profit terms, and filed everything within 12 days. Very professional.</div>
    <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
        ...
        <div>
            ...
            <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Founder, Tech Startup LLP</div>
            <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
        </div>
...
<div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
    <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
    <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Partner removal was complicated - our agreement didn't have a removal clause. Patron reviewed everything, explained the First Schedule defaults, and helped us restructure through voluntary resignation instead. Saved us from a legal mess.</div>
    <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
        <div style="width:36px;height:36px;border-radius:50%;background:#0D9488;display:flex;align-items:center;justify-content:center;font-weight:700;font-size:13px;color:#fff;flex-shrink:0;">PG</div>
        <div>
            <div style="font-weight:700;font-size:13px;color:var(--blue);">Priya Gupta</div>
            <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Partner, Consulting LLP Delhi</div>
            <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
        </div>
...
<div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
    <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
    <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Our CA firm LLP needed to simultaneously admit 3 junior CAs as partners. Patron handled all 3 DPINs, single comprehensive supplementary deed, one set of linked Form 4 + Form 3 filing. Clean execution, no delays.</div>
    <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
        <div style="width:36px;height:36px;border-radius:50%;background:#7C3AED;display:flex;align-items:center;justify-content:center;font-weight:700;font-size:13px;color:#fff;flex-shrink:0;">VM</div>
        <div>
            <div style="font-weight:700;font-size:13px;color:var(--blue);">Vikas Mittal</div>
            <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Senior Partner, CA Firm LLP</div>
            <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
        </div>
        ...
        <div class="reviews-cta" style="margin-top: 16px; display: flex !important;">
            <div class="reviews-cta-content">
                ...
                <div class="reviews-cta-text">
                    ...
                    <p>From LLP partner changes to full compliance - hear how Patron helps Delhi businesses stay compliant.</p>
                </div>
            </div>
...
<p><strong>Contact Patron's Delhi office for immediate partner change compliance: <a href="tel:+919459456700">Call +91 945 945 6700</a> or <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20help%20with%20LLP%20Partner%20Change%20in%20Delhi." target="_blank">WhatsApp us</a>.</strong></p>
            ...
            <div class="pa-city-block" style="margin-bottom:40px;">
                ...
                <div class="pa-city-block">
                    ...
                    <div class="pa-cross-grid">
                        ...
                        <a href="/llp-compliance/delhi" class="pa-cross-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg></div><div><div class="pa-card-title">LLP Compliance</div><div class="pa-card-sub">Delhi</div></div></a>
