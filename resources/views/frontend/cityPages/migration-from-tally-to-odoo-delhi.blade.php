...
@section('schema')
  ...
  "@graph": [
    {
      "@type": "BreadcrumbList",
      "@id": "/migration-from-tally-to-odoo/delhi#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
        ...
        },
        {
          ...
          "item": "/migration-from-tally-to-odoo/delhi"
        }
      ]
    },
    {
      "@type": "FAQPage",
      "@id": "/migration-from-tally-to-odoo/delhi#faq",
    ...
    {
      "@type": "Service",
      "@id": "/migration-from-tally-to-odoo/delhi#service",
      "name": "Tally to Odoo Migration in Delhi",
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="migration-from-tally-to-odoo/delhi" selected>Tally to Odoo Migration in Delhi</option>
                                <option value="odoo-accounting/delhi">Odoo Accounting in Delhi</option>
