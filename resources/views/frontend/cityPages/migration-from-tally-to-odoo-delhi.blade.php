        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'migration-from-tally-to-odoo/delhi',
                    'options'  => [
                        'migration-from-tally-to-odoo/delhi' => 'Tally to Odoo Migration in Delhi',
                        'odoo-accounting/delhi' => 'Odoo Accounting in Delhi',
