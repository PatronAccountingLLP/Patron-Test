        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'migration-from-tally-to-odoo/mumbai',
                    'options'  => [
                        'migration-from-tally-to-odoo/mumbai' => 'Tally to Odoo Migration in Mumbai',
                        'odoo-accounting/mumbai' => 'Odoo Accounting in Mumbai',
