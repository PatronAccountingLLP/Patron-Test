        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'migration-from-tally-to-odoo/pune',
                    'options'  => [
                        'migration-from-tally-to-odoo/pune' => 'Tally to Odoo Migration in Pune',
                        'odoo-accounting/pune' => 'Odoo Accounting in Pune',
                        ...
                        'backlog-bookkeeping-catch-up-services/pune' => 'Backlog Bookkeeping in Pune',
                        'other' => 'Other',
                    ],
                ])
            </div>
