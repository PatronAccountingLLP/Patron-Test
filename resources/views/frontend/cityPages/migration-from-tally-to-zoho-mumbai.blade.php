...
@section('schema')
  ...
  "@graph": [
    {
      "@type": "BreadcrumbList",
      "@id": "/migration-from-tally-to-zoho/mumbai#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
    ...
    {
      "@type": "FAQPage",
      "@id": "/migration-from-tally-to-zoho/mumbai#faq",
    ...
    {
      "@type": "Service",
      "@id": "/migration-from-tally-to-zoho/mumbai#service",
      "name": "Tally to Zoho Migration in Mumbai",
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-4 private-registration-heading">
                        Tally to Zoho Migration in Mumbai
                    </h1>
                    ...
                    <div class="mb-4">
                        <div class="d-flex align-items-start mb-3">
                            ...
                            <p class="mb-0 text-dark benefit-paragraph"><span>What Moves:</span> Ledgers, masters, opening balances, and selected years of Tally history rebuilt inside Zoho Books</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                        ...
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Best For:</span> BKC and Lower Parel finance firms, Andheri and Powai media and SaaS teams, Bhiwandi distributors</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Go-Live:</span> 3 to 7 working days on opening balances; 3 to 6 weeks where full history is rebuilt</p>
                        </div>
                    </div>
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="https://wa.me/919459456700?text=Hi%2C%20I%20want%20to%20migrate%20from%20Tally%20to%20Zoho%20Books%20in%20Mumbai.%20Please%20share%20details." target="_blank" class="btn-sample text-decoration-none">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="migration-from-tally-to-zoho/mumbai" selected>Tally to Zoho Migration in Mumbai</option>
...
<section class="content-section" id="overview-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Tally to Zoho Migration in Mumbai - Overview</h2>
            <div class="content-text">
                <div class="highlight-box" style="margin-bottom:20px;">
                    <p><strong>&#128204; TL;DR - Tally to Zoho Books Migration in Mumbai at a Glance</strong></p>
                    <p>A Tally to Zoho Books move takes your ledgers, masters, opening balances, and chosen history out of a locked desktop file and rebuilds them in cloud accounting your auditor can open from anywhere. Patron Accounting maps each Tally group to a Zoho account, imports in the right sequence, wires up GST and bank feeds, and proves the trial balance agrees. Fees begin at INR 9,999. We support BKC, Lower Parel, Andheri, Powai, and the Bhiwandi belt.</p>
                </div>
                ...
                <table>
                    ...
                    <tbody>
                        <tr><td>What It Is</td><td>A planned shift of Tally data into Zoho Books, or the wider Zoho One suite, on the cloud</td></tr>
                        <tr><td>Best Suited To</td><td>BKC and Lower Parel finance and professional-services firms, Andheri and Powai media and SaaS houses, Bhiwandi and Dombivli distributors</td></tr>
                        <tr><td>Starting Price</td><td>Starting from INR 9,999 (Exl GST and Govt. Charges)</td></tr>
                        <tr><td>Go-Live Timeline</td><td>3 to 7 working days on opening balances; up to 3 to 6 weeks where full history is rebuilt</td></tr>
                        <tr><td>Import Order</td><td>Accounts first, then contacts, items, opening balances, and finally historical transactions</td></tr>
                        <tr><td>Validation Check</td><td>Opening Balance Adjustment account driven to zero, then a two-point trial balance tie-out</td></tr>
                        <tr><td>GST Setup</td><td>GSTIN, HSN and SAC codes, GSP connection, e-invoicing, and GSTR-2B reconciliation in Zoho Books</td></tr>
                    </tbody>
                </table>
                </div>

                <p>In Mumbai the push to leave Tally is rarely cosmetic. A finance or advisory firm in BKC or Lower Parel wants auditor-friendly cloud books that partners and reviewers can open without passing one licensed laptop around. A media house or SaaS team in Andheri or Powai needs its founders and remote finance staff working off the same ledger from any browser. A distributor in Bhiwandi or Dombivli wants purchases, stock, and GST in one online system rather than a single desktop install. Migration is how that shift happens without dropping a rupee of history. See our national <a href="/migration-from-tally-to-zoho">Migration from Tally to Zoho</a> service.</p>
                <p>Patron Accounting's Mumbai team, working out of our Marine Lines office, runs migration as an accounting engagement rather than a copy-paste exercise. We reconstruct the chart of accounts inside Zoho Books, bring opening balances across from your Tally trial balance, and prove both systems agree before you issue a single Zoho invoice. To keep the books running afterwards, see <a href="/zoho-books-accounting/mumbai">Zoho Books Accounting in Mumbai</a>. This page is reviewed quarterly for accuracy.</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="two-column">
            <div class="column-content">
                ...
                <div class="highlight-box" style="margin-top:20px;">
                    ...
                    <p><strong>Chart of Accounts Mapping:</strong> Aligning every Tally ledger and group to its Zoho Books counterpart so reports remain comparable across the two systems.</p>
                    ...
                    <p><strong>Opening Balance Adjustment:</strong> The control account in Zoho Books that has to settle at zero once debits and credits are posted correctly.</p>
                    <p><strong>Import Sequence:</strong> Bringing in accounts, then contacts, items, opening balances, and historical transactions in the order Zoho Books demands.</p>
                    <p><strong>Bank Feeds:</strong> The automatic flow of bank transactions into Zoho Books that drives ongoing reconciliation after go-live.</p>
                </div>
            </div>
...
<section class="content-section" id="who-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>If your Mumbai business has outgrown a single-seat Tally licence, needs the books reachable by a distributed team, or is consolidating onto the Zoho ecosystem, moving to Zoho Books is the logical next step.</p>
                <ul>
                    <li><strong>Finance and Professional-Services Firms (BKC/Lower Parel)</strong> - Want auditor-friendly cloud books that partners, reviewers, and clients can access without sharing one machine.</li>
                    <li><strong>Media Houses and SaaS Teams (Andheri/Powai)</strong> - Need browser-based accounting that plugs cleanly into Zoho CRM and Zoho People for multi-user, multi-location work.</li>
                    <li><strong>Warehousing and Distribution Units (Bhiwandi/Dombivli)</strong> - Require item masters, stock, and GST in one cloud system the warehouse and head office can both reach.</li>
                    <li><strong>Groups Standardising on Zoho One</strong> - Already on Zoho CRM, Expense, or People and want Books on the same login and shared ledger.</li>
                    <li><strong>Distributed and Hybrid Finance Teams</strong> - Accountants who can no longer pass a single desktop Tally file between offices and home.</li>
                    <li><strong>Firms Wanting Sharper GST and E-Invoicing</strong> - After built-in GSTR-2B reconciliation and e-invoicing inside the accounting tool itself.</li>
                </ul>
            </div>
        </div>
    </div>
...
<section class="content-section" id="services-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Our Tally to Zoho Migration Services in Mumbai</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Service</th><th>What We Do</th></tr></thead>
                    <tbody>
                        <tr><td>Chart of Accounts Mapping</td><td>Align each Tally ledger and group with a Zoho Books account so your balance sheet and profit and loss stay comparable across both systems.</td></tr>
                        <tr><td>Masters and Contacts Import</td><td>Load customers, vendors, items, tax rates, and HSN/SAC codes into Zoho Books, de-duplicated and cleaned along the way.</td></tr>
                        ...
                        <tr><td>Historical Transactions</td><td>Rebuild your chosen years of invoices, bills, payments, receipts, and journals following Zoho's required import sequence.</td></tr>
                        <tr><td>GST, E-Invoicing, and Bank Feeds</td><td>Set up GSTIN, GSP connection, e-invoicing, GSTR-2B reconciliation, and connect automated bank feeds for each account.</td></tr>
                        <tr><td>Team Training and Handover</td><td>Coach your Mumbai team on everyday Zoho Books use, then hand over a reconciled, audit-ready organisation.</td></tr>
                    </tbody>
                </table>
                </div>
...
<section class="content-section" id="documents-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">What We Need to Migrate Tally to Zoho in Mumbai</h2>
            <div class="content-text">
                <ul>
                    <li><strong>Tally Company File or Backup</strong> - The source data covering your full migration period</li>
                    <li><strong>Tally Trial Balance</strong> - As on 31 March or your chosen cut-off, to seed the opening balances</li>
                    <li><strong>Chart of Accounts and Ledger List</strong> - With groupings, ready for mapping into Zoho Books</li>
                    <li><strong>Customer and Vendor Masters</strong> - Complete with GSTINs and contact details</li>
                    <li><strong>Item and Stock Masters</strong> - Quantities, values, and HSN/SAC codes, if you carry inventory</li>
                    <li><strong>GST Registration Certificate</strong> - One GSTIN per registration across your branches</li>
                    <li><strong>PAN of the Business Entity</strong></li>
                    <li><strong>Bank Statements</strong> - For opening bank reconciliation and feed connection</li>
                    <li><strong>Zoho Books or Zoho One Plan Choice</strong> - So we provision the correct edition</li>
                    <li><strong>PTRC and PTEC Details</strong> - Maharashtra Professional Tax registrations, where they apply</li>
                </ul>
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <table>
                    ...
                    <tbody>
                        <tr><td>Several GSTINs and branches across BKC, Andheri, and Bhiwandi</td><td>Set up each registration as its own Zoho Books organisation, keep place-of-supply correct, and reconcile every GSTIN separately for clean Maharashtra GST reporting.</td></tr>
                        <tr><td>Tally groups with no clean Zoho equivalent</td><td>Prepare a documented mapping sheet, merge or split ledgers as needed, and agree report comparability with you before loading.</td></tr>
                        <tr><td>Opening balances that will not agree</td><td>Push the Opening Balance Adjustment account to zero and run a two-point trial balance check before a single transaction is imported.</td></tr>
                        <tr><td>Stock values drifting after the move</td><td>Carry opening stock at the Tally closing quantities and values, then reconcile the Zoho Inventory position item by item for Bhiwandi warehouses.</td></tr>
                        <tr><td>GST and e-invoicing left unconfigured at go-live</td><td>Finish the entire Zoho Books GST setup, GSP and e-invoicing included, before any live invoice is raised.</td></tr>
                    </tbody>
                </table>
                </div>
            </div>
...
<section class="content-section" id="fees-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Tally to Zoho Migration Fees in Mumbai</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table class="table-amount">
                    ...
                    <tbody>
                        ...
                        <tr><td>Additional Years of History</td><td>Quoted per financial year, scaled to transaction volume</td></tr>
                        <tr><td>Inventory and Stock Migration</td><td>Quoted on item-master volume for Bhiwandi and Dombivli distributors</td></tr>
                        <tr><td>Multiple GSTINs and Branches</td><td>Quoted per additional registration set up in Zoho Books</td></tr>
                        <tr><td>Zoho Books / Zoho One Subscription</td><td>Billed separately by Zoho for the edition you choose</td></tr>
                ...
                <div class="reviews-cta">
                    <div class="reviews-cta-content">
                        ...
                        <div class="reviews-cta-text">
                            ...
                            <p>Share your ledger count, GSTINs, and years of history; we reply within 2 hours.</p>
                        </div>
                    </div>
...
<section class="content-section" id="timeline-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">How Long Tally to Zoho Migration Takes in Mumbai</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Migration Scope</th><th>Typical Turnaround</th></tr></thead>
                    <tbody>
                        <tr><td>Opening balances only, single GSTIN</td><td>3 to 7 working days for a lean BKC or Andheri firm</td></tr>
                        <tr><td>Current year plus masters</td><td>1 to 2 weeks for the typical Mumbai SME</td></tr>
                        <tr><td>2 to 3 years of full history</td><td>3 to 5 weeks, depending on volume and number of GSTINs</td></tr>
                        <tr><td>Multi-year with inventory</td><td>4 to 6 weeks for Bhiwandi and Dombivli distributors with stock to reconstruct</td></tr>
                    </tbody>
                </table>
                </div>
                <p>How long it takes hinges on the volume of history you carry forward and how fast masters are confirmed. Service and media firms with tidy ledgers reach go-live soonest; distribution units rebuilding stock take the longest.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="why-choose-section" id="benefits-section">
    <div class="section-container">
        <div class="why-choose-header">
            <h2 class="section-title" style="text-align:center;">Why Choose Patron for Tally to Zoho Migration in Mumbai</h2>
        </div>
        <div class="features-grid">
            <div class="feature-card">
                ...
                <p class="feature-text">A Chartered Accountant signs off only once a two-point trial balance check shows Zoho Books matching your Tally closing position to the rupee.</p>
            </div>
            <div class="feature-card">
                ...
                <p class="feature-text">GSTIN, HSN/SAC codes, GSP connection, e-invoicing, and GSTR-2B reconciliation are all live before your first Zoho invoice goes out.</p>
            </div>
            <div class="feature-card">
                ...
                <p class="feature-text">Accounts, contacts, items, opening balances, then history are loaded in the precise order Zoho Books needs, so nothing breaks part way through.</p>
            </div>
            <div class="feature-card">
                ...
                <p class="feature-text">A clear quote from INR 9,999 agreed before work starts, covering your ledgers, GSTINs, years of history, and inventory.</p>
            </div>
            <div class="feature-card">
                ...
                <p class="feature-text">Familiar with the GST Commissionerate and Maharashtra GST practice, and the sectors driving BKC, Lower Parel, Andheri, Powai, and Bhiwandi.</p>
            </div>
            <div class="feature-card">
                ...
                <p class="feature-text">Your team is trained on Zoho Books at handover, and we can carry on with monthly bookkeeping so the new system stays accurate.</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <table class="table-comparison">
                    ...
                    <tbody>
                        <tr><td>Multi-GSTIN and branch setup</td><td>Each registration mapped and reconciled separately</td><td>Place-of-supply errors slip through</td></tr>
                        ...
                        <tr><td>Import sequence</td><td>Loaded in Zoho's required order</td><td>Out-of-order loads throw errors</td></tr>
                        <tr><td>GST and e-invoicing setup</td><td>Tested before the first invoice</td><td>Found broken after go-live</td></tr>
                    </tbody>
                </table>
                </div>
...
<section class="content-section" id="legal-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p><strong>CGST Act 2017, GST configuration:</strong> Zoho Books must carry the correct <strong>GSTIN, HSN and SAC codes, and GSP connection</strong> before invoicing, so returns and e-invoices are valid from go-live.</p>
                <p><strong>E-Invoicing Rules:</strong> Firms past the notified turnover threshold have to raise <strong>e-invoices via the IRP</strong>; this is switched on inside Zoho Books during migration.</p>
                <p><strong>GSTR-2B Reconciliation:</strong> Input tax credit must be matched against the auto-drafted <strong>GSTR-2B</strong> under the CGST Act 2017; Zoho Books handles this natively once set up.</p>
                ...
                <p><strong>Companies Act 2013, Section 128:</strong> Companies have to maintain proper books of account; for Mumbai companies, filings route through <strong>RoC Mumbai</strong> under the MCA.</p>
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    <h2 class="faq-expanded__title">Frequently Asked Questions: Tally to Zoho Migration in Mumbai</h2>
                    <p class="faq-expanded__lead">Real questions from Mumbai founders and finance teams about moving from Tally to Zoho Books.</p>
                    @include('partials.faq-enquiry-form', ['enquiryLocation' => 'Mumbai', 'enquiryService' => 'Tally to Zoho Migration in Mumbai'])
                </aside>
                <div class="faq-expanded__list">
                    <div class="faq-expanded__item" id="faq-1">
                        <h3 class="faq-expanded__q">How much does a Tally to Zoho Books migration cost in Mumbai?</h3>
                        <div class="faq-expanded__a"><p>Patron Accounting starts Starting from INR 9,999 (Exl GST and Govt. Charges). Your final quote scales with the years of history carried over, the count of ledgers and GSTINs, stock volume, and whether you take Zoho Books on its own or the full Zoho One suite. BKC and Lower Parel firms receive a fixed quote upfront.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-2">
                        <h3 class="faq-expanded__q">Will my opening balances and trial balance tie out once we are on Zoho Books?</h3>
                        <div class="faq-expanded__a"><p>Yes. Opening balances are keyed in from your Tally trial balance as on 31 March or your chosen cut-off, after which we confirm the Opening Balance Adjustment account in Zoho Books reads zero. A two-point trial balance tie-out between Tally and Zoho Books then proves the debits and credits agree before we sign off.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-3">
                        <h3 class="faq-expanded__q">Can you configure GST and e-invoicing inside Zoho Books while migrating?</h3>
                        <div class="faq-expanded__a"><p>Yes. We finish the Zoho Books GST setup end to end: GSTIN entry, HSN and SAC codes, GSP connection, e-invoicing, reverse charge where relevant, and GSTR-2B reconciliation under the CGST Act 2017. Everything is live and tested before the first Zoho invoice leaves your office, so nothing breaks at go-live.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-4">
                        <h3 class="faq-expanded__q">We are a BKC firm with several GSTINs and branches. Can Zoho Books handle that?</h3>
                        <div class="faq-expanded__a"><p>Yes. For multi-GSTIN groups across BKC, Lower Parel, and Andheri, we map each registration to its own Zoho Books organisation or branch, keep place-of-supply rules correct, and reconcile every GSTIN separately. Inter-branch entries and consolidated reporting are set up so your auditor sees a clean, registration-wise view across Maharashtra GST.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-5">
                        <h3 class="faq-expanded__q">Do auditors and lenders in Mumbai accept books kept in Zoho Books?</h3>
                        <div class="faq-expanded__a"><p>Yes. Zoho Books produces a standard trial balance, profit and loss, balance sheet, and audit trail that Mumbai auditors and bankers accept. Because we tie the migrated ledgers back to your Tally closing figures, the prior-year comparatives match. We also retain the original Tally file so statutory audit and assessments have a verifiable source.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-6">
                        <h3 class="faq-expanded__q">Can you carry warehouse stock from Tally into Zoho for a Bhiwandi unit?</h3>
                        <div class="faq-expanded__a"><p>Yes. For Bhiwandi and Dombivli warehousing and distribution operations, we move item masters, opening stock quantities and values, and tax mappings into Zoho Books or Zoho Inventory. The migrated stock summary is matched line by line to your Tally closing position so valuation carries on seamlessly past the cut-off date.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-7">
                        <h3 class="faq-expanded__q">Is it possible to migrate to Zoho Books in the middle of the financial year?</h3>
                        <div class="faq-expanded__a"><p>Yes. A mid-year switch is common for Mumbai firms. We freeze a cut-off date, lift opening balances as on that date from Tally, and reconstruct the transactions from 1 April to the cut-off so the full-year figures stay intact. GST returns continue without a gap, and the year still closes cleanly inside Zoho Books.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-8">
                        <h3 class="faq-expanded__q">Should an Andheri media or SaaS team pick Zoho Books or the full Zoho One suite?</h3>
                        <div class="faq-expanded__a"><p>Zoho Books alone fits teams that only need accounting, GST, and bank feeds. An Andheri or Powai media house or SaaS team already on Zoho CRM or Zoho People usually gains from Zoho One, where Books, Inventory, Expense, and Payroll share a single ledger and login. Patron recommends the right edition during scoping.</p></div>
                    </div>
                </div>
            </div>
...
<section class="content-section" id="quick-answers-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p><strong>Cheapest way to migrate?</strong> Carry only opening balances and the current year now, and add older history later if a report actually calls for it.</p>
                <p><strong>Will my reports still reconcile?</strong> Yes, because the Tally chart of accounts is mapped to Zoho Books deliberately and the trial balance is proven to tie out before go-live.</p>
                <p><strong>Can it run remotely?</strong> Yes. Most Mumbai migrations are handled online; an on-site review is offered for Bhiwandi and Dombivli warehouses with physical stock records.</p>
                <p><strong>What do I end up with?</strong> A live, GST-ready Zoho Books organisation, connected bank feeds, a verified trial balance, and a trained team.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section" id="conclusion-section" style="background: var(--blue) !important;">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title" style="color:#FFFFFF !important;">Move Your Mumbai Books to Zoho the Right Way</h2>
            <div class="content-text" style="text-align:left;">
                <p style="color:rgba(255,255,255,0.85);font-size:15px;line-height:1.8;">Skipping the mapping or the opening-balance checks always costs more to unwind than to do properly the first time. Whether you run a finance firm in BKC or Lower Parel, a media or SaaS team in Andheri or Powai, or a distribution operation in Bhiwandi, Patron Accounting's CA-supervised service lifts your Tally data into Zoho Books, configures GST and bank feeds, and proves the trial balance ties out from INR 9,999.</p>
                <p style="color:rgba(255,255,255,0.85);font-size:15px;line-height:1.8;">Start with the national <a href="/migration-from-tally-to-zoho" style="color:#fff;text-decoration:underline;">Migration from Tally to Zoho</a> page, then move on to <a href="/zoho-books-accounting" style="color:#fff;text-decoration:underline;">Zoho Books Accounting</a> once you are live. Patron Accounting LLP serves 10,000+ businesses with a 4.9 Google rating.</p>
            </div>
            <div style="display:flex;gap:14px;flex-wrap:wrap;margin-top:24px;">
                <a href="tel:+919459456700" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:var(--orange);color:#fff;border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#128222; Call +91 945 945 6700</a>
                <a href="https://wa.me/919459456700?text=Hi%2C%20I%20want%20to%20migrate%20from%20Tally%20to%20Zoho%20Books%20in%20Mumbai.%20Please%20call%20me." target="_blank" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:#25D366;color:#fff;border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#128172; WhatsApp Us</a>
                <a href="mailto:sales@patronaccounting.com?subject=Enquiry%20for%20Tally%20to%20Zoho%20Migration%20in%20Mumbai&body=Hello%20Patron%20Team%2C%0A%0AI%20want%20to%20migrate%20from%20Tally%20to%20Zoho%20Books%20in%20Mumbai.%0A%0APlease%20contact%20me.%0A%0AThank%20you." style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:transparent;color:#fff;border:2px solid rgba(255,255,255,0.3);border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#9993;&#65039; Email Us</a>
            </div>
