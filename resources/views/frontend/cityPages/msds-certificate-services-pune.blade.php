  ...
  "@graph": [
    {
      ...
      "url": "/msds-certificate-services/pune",
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20MSDS%20certificate%20services%20in%20Pune.%20Please%20call%20me." target="_blank" class="btn-sample text-decoration-none">
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - MSDS Certificate in Pune'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="msds-certificate-services/pune" selected>MSDS Certificate in Pune</option><option value="gst-registration/pune">GST Registration in Pune</option><option value="trademark-registration/pune">Trademark Registration in Pune</option><option value="private-limited-company-registration-in-india/pune">Pvt Ltd Registration in Pune</option><option value="fdi-compliance/pune">FDI Compliance in Pune</option><option value="gst-returns/pune">GST Returns in Pune</option><option value="income-tax-returns/pune">ITR Filing in Pune</option><option value="other">Other</option>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p style="margin-top:16px;"><strong>Get a free MSDS Certificate in Pune consultation - <a href="tel:+919459456700">Call +91 945 945 6700</a> or <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20MSDS%20certificate%20in%20Pune.%20Please%20call%20me." target="_blank">WhatsApp us</a>. No-obligation assessment.</strong></p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    ...
                    @include('partials.faq-enquiry-form', ['enquiryLocation' => 'Pune', 'enquiryService' => 'MSDS Certificate Services in Pune'])
                </aside>
