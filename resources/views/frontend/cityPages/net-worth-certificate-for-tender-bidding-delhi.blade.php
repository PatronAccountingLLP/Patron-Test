...
<nav aria-label="Breadcrumb" style="background:var(--gray-50);border-bottom:1px solid var(--gray-200);padding:10px 16px;">
    <div style="max-width:1320px;margin:0 auto;">
        <ol style="display:flex;align-items:center;gap:8px;list-style:none;padding:0;margin:0;font-size:13px;font-family:'Barlow',sans-serif;">
            ...
            <li style="display:flex;align-items:center;gap:8px;">
                <a href="https://www.patronaccounting.com/net-worth-certificate-for-tender-bidding/" style="color:var(--text-muted);text-decoration:none;font-weight:500;">Net Worth Certificate for Tender Bidding</a>
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" style="width:12px;height:12px;color:var(--gray-400);"><path d="M9 5l7 7-7 7"/></svg>
            </li>
            <li><span style="color:var(--orange);font-weight:600;">Net Worth Certificate for Tender Bidding Services</span></li>
        </ol>
    </div>
</nav>
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-4 private-registration-heading">
                        Net Worth Certificate for Tender Bidding in Delhi
                    </h1>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Eligibility:</span> Delhi bidders (sole prop, partnership, LLP, Pvt Ltd) on CPWD, DDA, DMRC, NBCC, central ministry, MoD defence, Railway Board, DIAL IGI Airport, AIIMS, DJB, DUSIB, MCD/NDMC, GeM, CPPP tenders</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Timeline:</span> Same-day soft copy with UDIN; express same-day pickup at Delhi office for last-minute bid submissions</p>
                        </div>
                    </div>
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="https://wa.me/919459456700?text=Hello%20Patron%20Accounting%20Team%2C%20I%20would%20like%20to%20enquire%20about%20your%20Net%20Worth%20Certificate%20for%20Tender%20Bidding%20services.%20Please%20share%20details%20about%20the%20process%2C%20documents%20required%2C%20and%20fees." target="_blank" class="btn-sample text-decoration-none">
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                <div class="highlight-box" style="margin-bottom:20px;">
                    ...
                    <p>A net worth certificate for tender bidding in Delhi is a CA-signed declaration of the bidder-entity's assets minus liabilities, prepared in INR with mandatory UDIN under ICAI norms, in the tender-specific Annexure format the procurement authority specifies. Delhi tender authorities including CPWD Nirman Bhawan, DDA, DMRC, NBCC, central ministries, Defence MoD South Block, Railway Board, DIAL IGI Airport, AIIMS, DJB, DUSIB, MCD/NDMC, plus GeM and CPPP accept it as the binary financial-eligibility filter. Patron issues it starting INR 1,499.

<div class="table-responsive-wrapper" style="margin-top:16px;">
<table><thead><tr><th>Parameter</th><th>Value</th></tr></thead><tbody>
<tr><td><strong>Governing Framework</strong></td><td>ICAI - Chartered Accountants Act 1949; General Financial Rules 2017; CPPP Guidelines (Dec 2023); CPWD Manual; Defence Acquisition Procedure 2020; MSME Procurement Policy</td></tr>
<tr><td><strong>Applicable To</strong></td><td>Delhi bidders (sole prop, partnership, LLP, Pvt Ltd) on CPWD, DDA, DMRC, NBCC, central ministry direct procurement (Bhawan-level), MoD South Block, Railway Board Rail Bhawan, DIAL IGI Airport, AIIMS, IIT Delhi, MCD, NDMC, DJB, DUSIB, DTC, DSIIDC, GeM, CPPP tenders</td></tr>
<tr><td><strong>Timeline</strong></td><td>Soft copy same day with UDIN; express pickup same-day from Delhi office for bid-deadline urgency</td></tr>
<tr><td><strong>Starting Cost</strong></td><td>INR 1,499 (Exl GST and Govt. Charges) at Patron Accounting</td></tr>
<tr><td><strong>Validity</strong></td><td>Tender-document specific - typically dated within 3-6 months of bid opening; CPWD contractor empanelment annual</td></tr>
...
<tr><td><strong>Mandatory Authentication</strong></td><td>18-digit UDIN at udin.icai.org with CA signature, ICAI seal, FRN and COP number</td></tr>
                ...
                <p>A net worth certificate for tender bidding in Delhi is the document the tender evaluation committee uses as the binary financial-eligibility filter - the bidder either meets the net worth threshold prescribed in the tender or the bid is rejected at the technical evaluation stage. Delhi's procurement ecosystem is uniquely shaped by its role as the national capital - anchored by CPWD (Central Public Works Department) at Nirman Bhawan, central ministry direct procurement from Krishi Bhawan (Agriculture), Shastri Bhawan (Petroleum, HRD), Vigyan Bhawan, North Block (Finance, Home), South Block (Defence MoD, PMO), Defence procurement under Defence Acquisition Procedure 2020, Railway Board procurement at Rail Bhawan, DDA infrastructure, DMRC Delhi Metro, NBCC PSU construction, DIAL IGI Airport, AIIMS Delhi medical procurement, plus unified MCD, NDMC, DJB, DUSIB, DTC, DSIIDC civic and state tenders. Patron Accounting prepares the certificate in the exact format each authority specifies. Last Updated: 2 July 2026.</p>
                <p></p>
        ...
        <div class="two-column">
            <div class="column-content">
                ...
                <div class="content-text what-is-definition">
                    ...
                    <p>A net worth certificate for tender bidding is a financial statement signed by a practising Chartered Accountant in Delhi certifying the total assets minus total liabilities of the bidder-entity (sole proprietorship, partnership, LLP or company) as of a specific date, prepared in INR for submission to a tender authority as part of the technical bid envelope under General Financial Rules 2017, CPWD Manual (for CPWD tenders), Defence Acquisition Procedure 2020 (for MoD direct procurement), and the tender-document-specific eligibility criteria.</p>
<p>On the asset side the Delhi tender certificate consolidates entity-level assets - cash and bank balances, trade receivables (net of provisions, with PSU customer-credit-period notes where applicable), inventory, fixed deposits, investments, plant and machinery at written-down value, factory or commercial property at the Delhi Government locality A-H circle rate, vehicles used in business, and intangibles where the tender format permits. On the liability side it captures trade payables, statutory dues, term loans, working capital limits utilised, vehicle loans, unsecured loans, and provisions. The net worth figure must EXCEED the threshold the tender document specifies; CPWD major works tenders typically require Rs 10-100 crore, DDA infrastructure Rs 5-50 crore, DMRC Metro packages Rs 25-300 crore, MoD defence procurement under DAP 2020 typically Rs 25 crore-plus for equipment supply, DIAL Terminal expansion contracts Rs 50-500 crore.</p>
<p>The certificate must carry an 18-digit UDIN generated at udin.icai.org, mandatory since 1 July 2019. Delhi tender evaluation committees at CPWD, DDA, DMRC, NBCC, central ministries, Defence MoD, Railway Board, DIAL, AIIMS, MCD, NDMC, DJB, DUSIB, DTC, DSIIDC, plus GeM and CPPP central evaluators verify the UDIN online as a standard step. Issued under ICAI SA 500 (Audit Evidence) and SA 505 (External Confirmations). For JV bids common on DMRC, DDA and high-value DIAL tenders, the tender format determines whether net worth is shown for lead alone, member alone, or consolidated.</p>
...
<p><strong>CPWD Manual:</strong> Central Public Works Department's procurement and contract framework, separate from GFR 2017, governing CPWD's central-government construction tender flow. CPWD Annexure formats are distinct from GeM and CPPP generic formats.</p>
<p><strong>Defence Acquisition Procedure (DAP) 2020:</strong> Ministry of Defence's framework for capital acquisition and procurement of goods and services, replacing DPP 2016. Defence tenders at South Block follow DAP 2020 with specific financial-eligibility annexures for the bidder-entity.</p>
<p><strong>MCD-NDMC Trifurcation Reversal:</strong> Effective 22 May 2022, the three trifurcated Delhi municipal corporations (North, South, East) were merged back into the unified Municipal Corporation of Delhi (MCD) under the Delhi Municipal Corporation (Amendment) Act 2022. Tender formats and ward jurisdictions reverted to the unified MCD structure.</p>
<p><strong>Central Ministry Bhawan-Level Procurement:</strong> Direct procurement by central ministries from their respective Bhawans - Nirman Bhawan (CPWD/MoHUA), Krishi Bhawan (Agriculture), Shastri Bhawan (Petroleum, HRD), Vigyan Bhawan, Rail Bhawan (Railway Board), North Block (Finance/Home), South Block (Defence/PMO). Each Bhawan has its own tender flow with distinct Annexure formats.</p>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>A Delhi business owner needs a tender bidding net worth certificate when the tender document specifies a CA-certified net worth requirement at any of the following:</p>
<ul class="content-list">
<li>CPWD tenders - Central Public Works Department at Nirman Bhawan tenders for central-government building construction, road works, electrical and HVAC across Delhi, with major-works contractor empanelment requiring annual NWC and Rs 5 lakh to Rs 100 crore net worth depending on category.</li>
<li>DDA tenders - Delhi Development Authority infrastructure tenders for housing, parks, commercial zones, and DDA-administered land development.</li>
<li>DMRC tenders - Delhi Metro Rail Corporation construction, electrical, signalling, rolling stock, station finishing, and depot tenders across all Delhi Metro phases.</li>
<li>NBCC tenders - National Buildings Construction Corporation PSU contracts for central government building projects across Delhi and beyond.</li>
<li>Central ministry direct procurement - tenders issued directly by ministries from their respective Bhawans (Krishi Bhawan, Shastri Bhawan, Vigyan Bhawan, Rail Bhawan, Udyog Bhawan, Nirman Bhawan, North Block, South Block) for IT services, facility management, equipment supply, consultancy, advisory.</li>
<li>Defence MoD direct procurement - capital-procurement tenders under Defence Acquisition Procedure 2020 at South Block for defence equipment, components, software, simulators, and specialized supplies.</li>
<li>Railway Board tenders - national railway procurement at Rail Bhawan, distinct from zonal railway tenders (Northern Railway, etc.) on IREPS portal.</li>
<li>DIAL IGI Airport tenders - Delhi International Airport Limited Terminal 1, Terminal 3, cargo expansion, ground handling, retail, and airside infrastructure tenders.</li>
<li>AIIMS Delhi and central hospital tenders - medical equipment, consumables, and facility tenders at AIIMS Delhi, Safdarjung Hospital, RML Hospital, Lady Hardinge Medical College.</li>
<li>Civic and state tenders - MCD (post-2022 unification), NDMC (Lutyens zone), DJB water and sewage, DUSIB urban shelter, DTC transport, DSIIDC industrial estate, BSNL telecom infrastructure.</li>
</ul>
<p>Delhi context: Delhi's procurement market is distinctive for its central-ministry-direct-procurement layer - tenders issued from Bhawans (Nirman, Krishi, Shastri, Vigyan, Rail, North, South Block) rather than autonomous bodies. CPWD Nirman Bhawan alone handles thousands of central-government construction tenders annually. Defence MoD South Block runs DAP 2020 procurement separately from MSE supply through NSIC SPRS. DMRC Delhi Metro is the second-largest metro network in India after Kolkata Metro. DIAL is among India's top-3 airports by traffic. Delhi Government locality A-H circle rates set property valuation floors.</p>
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <table>
                    ...
                    <tbody>
                        <tr><td><strong>CPWD Tender Certificate (Major Works and Contractor Empanelment)</strong></td><td>For Delhi central-construction bidders on CPWD Nirman Bhawan tenders - building construction, road works, electrical and HVAC. CPWD Manual Annexure format replicated; annual contractor-empanelment renewal certificate ready before CPWD review cycle. Categories from Class I to Class V supported.</td><td><span class="badge-included">Included</span></td></tr>
<tr><td><strong>DDA, DMRC and NBCC Infrastructure Tender Certificate</strong></td><td>For Delhi infrastructure bidders on DDA (housing, parks, infrastructure), DMRC (Metro construction, electrical, signalling, rolling stock), and NBCC (PSU construction) tenders. High net worth thresholds (Rs 25-300 crore for DMRC) and JV bid consolidation supported.</td><td><span class="badge-included">Included</span></td></tr>
<tr><td><strong>Central Ministry Bhawan-Level Direct Procurement Certificate</strong></td><td>For Delhi bidders on tenders issued by central ministries directly from their Bhawans - Krishi Bhawan, Shastri Bhawan, Vigyan Bhawan, Rail Bhawan, Udyog Bhawan, North Block, South Block. Ministry-specific Annexure formats and consultancy-eligibility declarations supported.</td><td><span class="badge-included">Included</span></td></tr>
<tr><td><strong>Defence MoD DAP 2020 Procurement Certificate</strong></td><td>For Delhi defence vendors bidding on Defence MoD South Block direct procurement under Defence Acquisition Procedure 2020 - capital procurement of equipment, components, simulators, software, and specialized supplies. DAP-specific financial-eligibility Annexure and cleared-vendor declarations supported.</td><td><span class="badge-included">Included</span></td></tr>
<tr><td><strong>DIAL IGI Airport, AIIMS and Central Hospital Tender Certificate</strong></td><td>For Delhi airport and healthcare vendors on DIAL IGI Airport Terminal 1, Terminal 3, cargo and retail tenders; AIIMS Delhi, Safdarjung, RML, Lady Hardinge medical equipment and facility tenders. Authority-specific Annexure formats and medical-equipment-specific declarations supported.</td><td><span class="badge-included">Included</span></td></tr>
<tr><td><strong>JV (Joint Venture) Tender Bid Certificate</strong></td><td>For Delhi bidders participating as JV lead or member on high-value CPWD, DMRC, DDA, NBCC and DIAL tenders. Separate JV-lead and JV-member NWCs prepared, or consolidated JV NWC where the tender permits aggregation, with JV agreement reference cited.</td><td><span class="badge-included">Included</span></td></tr>
...
<div class="step-card">
    <div class="step-content">
        ...
        <p class="step-description">Delhi bidder calls Patron Accounting, shares the tender document, tender number, authority (CPWD Nirman Bhawan, DDA, DMRC, NBCC, central ministry, MoD South Block under DAP 2020, Railway Board Rail Bhawan, DIAL, AIIMS, MCD, NDMC, DJB, DUSIB, DTC, DSIIDC, GeM, CPPP, or other), tender opening date, and the prescribed net worth threshold. Engagement letter captures purpose under ICAI SA 200.</p>
    </div>
...
<div class="step-card">
    <div class="step-content">
        ...
        <p class="step-description">Patron extracts the tender-specific Annexure format, computes the entity net worth from the latest audited balance sheet, validates that the net worth exceeds the tender threshold (critical for high-threshold DMRC and DIAL tenders), and lays out the certificate on the prescribed Annexure. CPWD Manual, DDA, DMRC, NBCC, MoD DAP 2020, central ministry Bhawan-level, DIAL, AIIMS formats are maintained in Patron's Delhi library.</p>
    </div>
    <div class="step-visual">
...
<div class="step-card">
    <div class="step-content">
        ...
        <p class="step-description">Draft certificate is emailed within 24 hours for bidder review. Critical check: net worth figure exceeds tender threshold; tender reference number, authority name, and tender title are accurate; Annexure format matches the tender document exactly; CPWD class-of-contractor declaration matches the applicable class. Corrections happen in this step.</p>
    </div>
    <div class="step-visual">
...
<div class="step-card">
    <div class="step-content">
        ...
        <p class="step-description">Patron CA generates the 18-digit UDIN at udin.icai.org under 'Certificates - Net Worth Certificate', signs on firm letterhead with ICAI seal, issues the final document. Soft copy emailed same day for e-procurement upload; hard copy collected from Patron Delhi office same day for last-minute bid submissions, or couriered within 2 working days.</p>
    </div>
    <div class="step-visual">
...
<li>Recent utility bill or rent agreement for the registered Delhi office address</li>
<li>Class III digital signature certificate (for GeM, CPPP, CPWD e-procurement, IREPS submissions)</li>
</ul>
...
<li>CPWD class-of-contractor application (for CPWD empanelment - Class I/II/III/IV/V)</li>
<li>DAP 2020 cleared-vendor reference (for Defence MoD South Block tenders)</li>
<li>DMRC pre-qualification questionnaire (where DMRC tender)</li>
</ul>
...
<li>Bank statements (all current accounts) for the last 12 months</li>
<li>Trade receivable and payable ageing</li>
<li>Plant and machinery register with WDV</li>
<li>Delhi factory, warehouse or commercial property registration deed with locality A-H circle rate reference</li>
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <table>
                    ...
                    <tbody>
                        <tr><td><strong>Challenge 1: CPWD class-of-contractor declaration mismatch with NWC threshold</strong></td><td>CPWD contractor empanelment has 5 classes (Class I, II, III, IV, V) each with distinct net worth thresholds - Class I requires the highest. A certificate listing net worth below the class threshold automatically downgrades the contractor or rejects the bid for higher-class works. Patron's Delhi office aligns the CPWD class-of-contractor declaration with the certified net worth, flags the gap before drafting where applicable, and prepares the certificate that matches both the tender Annexure and the contractor's class registration.</td></tr>
<tr><td><strong>Challenge 2: Defence MoD DAP 2020 cleared-vendor declaration requirements</strong></td><td>Defence MoD direct procurement at South Block under DAP 2020 requires the bidder to be on the cleared-vendor list and have specific financial-capacity declarations beyond standard NWC. Generic CA-letterhead certificates without DAP-aligned declaration language are rejected. Patron's Delhi office maintains the DAP 2020 financial-eligibility Annexure format, ties the certificate to the cleared-vendor reference, and incorporates the conflict-of-interest and integrity-of-bidder declarations DAP 2020 requires.</td></tr>
<tr><td><strong>Challenge 3: DMRC Metro tender pre-qualification thresholds exceed mid-size bidder reach</strong></td><td>DMRC Metro package tenders typically require Rs 25-300 crore net worth depending on package, putting them out of reach for stand-alone Delhi mid-size contractors. JV bidding is the standard path. Patron's Delhi team prepares JV-lead and JV-member NWCs separately plus the consolidated JV NWC, ties each to the JV agreement and the DMRC pre-qualification provisions, and ensures the consolidated net worth comfortably exceeds the threshold.</td></tr>
<tr><td><strong>Challenge 4: Central ministry Bhawan-level tender format variation</strong></td><td>Central ministry tenders issued from Bhawans (Krishi Bhawan, Shastri Bhawan, Vigyan Bhawan, Rail Bhawan, North Block, South Block) each use distinct Annexure formats with ministry-specific declaration language. A certificate prepared on a CPWD format will fail at a Krishi Bhawan tender and vice versa. Patron's Delhi office maintains the Bhawan-level format library, identifies the originating Bhawan from the tender NIT, and delivers the format-correct certificate without iteration.</td></tr>
...
<tr><td>Tender</td><td class="table-amount">specific Annexure format replication (CPWD, DDA, DMRC, NBCC, central ministry Bhawan-level, MoD DAP 2020, Railway Board, DIAL, AIIMS, MCD, NDMC, DJB, DUSIB and others) - INR 999 per Annexure</td><td><span class="badge-addon">Add-on</span></td></tr>
<tr><td>CPWD class</td><td class="table-amount">of-contractor empanelment certificate variant (with annual renewal tracking) - INR 1,499</td><td><span class="badge-addon">Add-on</span></td></tr>
<tr><td>Defence MoD DAP 2020 financial</td><td class="table-amount">eligibility Annexure with cleared-vendor declarations - INR 2,499</td><td><span class="badge-addon">Add-on</span></td></tr>
...
<tr><td>DMRC Metro pre</td><td class="table-amount">qualification financial-capacity Annexure - INR 1,500</td><td><span class="badge-addon">Add-on</span></td></tr>
...
<tr><td>Express same</td><td class="table-amount">day hard-copy delivery at Patron Delhi office for bid-deadline urgency - INR 750</td><td><span class="badge-addon">Add-on</span></td></tr>
...
<tr><td>Private Limited Company variant</td><td class="table-amount">INR 2,499</td><td><span class="badge-addon">Add-on</span></td></tr>
                ...
                <p style="margin-top:16px;"><strong>Get a free Net Worth Certificate for Tender Bidding consultation - <a href="tel:+919459456700">Call +91 945 945 6700</a> or <a href="https://wa.me/919459456700?text=Hello%20Patron%20Accounting%20Team%2C%20I%20want%20to%20get%20my%20Net%20Worth%20Certificate%20for%20Tender%20Bidding.%20Please%20share%20details%20about%20the%20process%2C%20documents%20required%2C%20and%20fees." target="_blank">WhatsApp us</a>. No-obligation assessment.</strong></p>
            </div>
        </div>
    </div>
</section>
...
<tr><td><strong>Tender Annexure format alignment</strong></td><td>Same day for known Delhi authorities; 1 working day for less common Bhawan-level formats</td></tr>
...
<tr><td><strong>Hard copy collection from Patron Delhi office for physical bid submission</strong></td><td>Same day (express) or 2 working days standard</td></tr>
<tr><td><strong>Validity at tender authorities</strong></td><td>Tender-document specific - CPWD empanelment annual, DMRC and DIAL 3-6 months</td></tr>
...
<article class="feature-card">
    ...
    <p class="feature-text">Patron's Delhi office maintains the Annexure format library for CPWD (Class I-V), DDA, DMRC, NBCC, central ministry Bhawan-level direct procurement (Nirman, Krishi, Shastri, Vigyan, Rail, North Block, South Block), Defence MoD DAP 2020, Railway Board, DIAL IGI Airport, AIIMS Delhi, MCD, NDMC, DJB, DUSIB, DTC, DSIIDC, plus GeM and CPPP. The net result is fewer technical-bid disqualifications, on-time bid submissions...</p>
</article>
...
<section class="content-section" id="comparison-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Self-Arranged vs Patron Accounting Delhi</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Parameter</th><th>Self-arranged (local CA)</th><th>Patron Accounting Delhi</th></tr></thead>
                    <tbody>
                        <tr><td><strong>UDIN generation</strong></td><td>Often delayed or skipped</td><td>Generated at issue, printed on certificate</td></tr>
<tr><td><strong>Tender Annexure format match</strong></td><td>Generic CA letterhead used</td><td>CPWD, DDA, DMRC, NBCC, central ministry Bhawan, MoD DAP, DIAL, AIIMS formats maintained</td></tr>
<tr><td><strong>CPWD class-of-contractor alignment</strong></td><td>Often misaligned with class threshold</td><td>Class I-V threshold checked before drafting</td></tr>
<tr><td><strong>Defence MoD DAP 2020 declarations</strong></td><td>Not handled</td><td>Cleared-vendor declaration and integrity provisions included</td></tr>
<tr><td><strong>DMRC JV consolidation</strong></td><td>Inconsistent</td><td>Lead, member, and consolidated certificates with JV agreement reference</td></tr>
<tr><td><strong>Central ministry Bhawan-level format library</strong></td><td>Not maintained</td><td>Nirman, Krishi, Shastri, Vigyan, Rail, North Block, South Block formats maintained</td></tr>
<tr><td><strong>GeM/CPPP e-procurement-ready</strong></td><td>Hard copy first, scan later</td><td>Soft copy with UDIN same day for portal upload</td></tr>
<tr><td><strong>Express same-day pickup</strong></td><td>Not available</td><td>Available from Patron Delhi office</td></tr>
...
<tr><td><strong>CPWD</strong></td><td>CPWD Manual and Class-of-Contractor Empanelment Procedures</td><td>Governs CPWD central-construction tender NWC and class-wise thresholds</td></tr>
<tr><td><strong>Ministry of Defence</strong></td><td>Defence Acquisition Procedure 2020</td><td>Governs MoD South Block direct procurement under DAP 2020</td></tr>
</tbody></table></div>
<div class="highlight-box">
<p><strong>Governing Framework:</strong> Chartered Accountants Act 1949 and Code of Ethics 2020 for the issuing CA. General Financial Rules 2017, Manual for Procurement of Goods 2024 and Manual for Procurement of Works 2024 for central-government tenders. CPPP General Guidelines for e-Procurement (December 2023). CPWD Manual for CPWD tenders. Defence Acquisition Procedure 2020 for MoD direct procurement. Delhi Municipal Corporation (Amendment) Act 2022 for unified MCD tenders.</p>
<p><strong>Key Provisions:</strong> Section 21 of the Chartered Accountants Act 1949 covers professional misconduct. The Second Schedule, Part I, Clause (8) penalises a CA who fails to obtain sufficient information before expressing an opinion. GFR 2017 Rule 144 covers tender eligibility verification. DAP 2020 Chapter II covers financial-capacity verification for defence procurement. CPWD Manual specifies class-of-contractor net worth thresholds.</p>
...
<p><strong>Penalty Exposure for the Bidder:</strong> Bid rejection at technical evaluation; forfeiture of EMD; blacklisting from central-government tender bidding for up to 3 years under GFR 2017; debarment from GeM and CPPP platforms; CPWD empanelment cancellation or class downgrade; Defence MoD cleared-vendor delisting under DAP 2020; performance guarantee invocation if discovered after award; plus prosecution under Indian Penal Code Section 420 (now Section 318 of the Bharatiya Nyaya Sanhita 2023) for cheating, with imprisonment up to 7 years.</p>
</div>
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    <h2 class="faq-expanded__title">FAQs: Net Worth Certificate for Tender Bidding in Delhi</h2>
                    <p class="faq-expanded__lead">Common questions about Net Worth Certificate for Tender Bidding for Delhi businesses, answered by our CA and CS team.</p>
                    @include('partials.faq-enquiry-form', ['enquiryLocation' => 'Delhi', 'enquiryService' => 'Net Worth Certificate for Tender Bidding in Delhi'])
                </aside>
                <div class="faq-expanded__list">
                    <div class="faq-expanded__item" id="faq-1">
                        <h3 class="faq-expanded__q">Why does a Delhi CPWD tender require a net worth certificate?</h3>
                        <div class="faq-expanded__a"><p>CPWD requires the certificate as the binary financial-eligibility filter at the technical evaluation stage of its central-construction tender flow at Nirman Bhawan. The certificate establishes that the bidder has the financial capacity to execute the contract without disruption. CPWD class-of-contractor empanelment runs Class I to Class V with distinct net worth thresholds; major works tenders typically require Rs 10-100 crore net worth depending on contract value. Below the class or tender threshold means rejection or downgrade.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-2">
                        <h3 class="faq-expanded__q">What is the format prescribed for DDA and DMRC tender NWC?</h3>
                        <div class="faq-expanded__a"><p>DDA and DMRC each prescribe their own Annexure format with specific declaration language, asset-category breakdowns, and JV-bid provisions. DMRC pre-qualification Annexure typically requires entity audited net worth above Rs 25-300 crore depending on package, with 3-year turnover trend. DDA infrastructure tender Annexures vary by project. Patron's Delhi office maintains both format libraries and replicates the exact Annexure prescribed in each tender document.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-3">
                        <h3 class="faq-expanded__q">Who can issue a net worth certificate for tender bidding in Delhi?</h3>
                        <div class="faq-expanded__a"><p>Only a practising Chartered Accountant in Delhi holding a valid Certificate of Practice from ICAI can sign and issue a net worth certificate for tender bidding. The CA generates an 18-digit UDIN at udin.icai.org, signs on firm letterhead with ICAI seal, and prints Membership Number and Firm Registration Number. Delhi tender evaluation committees at CPWD, DDA, DMRC, NBCC, central ministries, Defence MoD South Block, Railway Board, DIAL, AIIMS, MCD, NDMC, DJB plus GeM and CPPP all verify the UDIN.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-4">
                        <h3 class="faq-expanded__q">What are the net worth thresholds at Defence MoD direct procurement tenders?</h3>
                        <div class="faq-expanded__a"><p>Defence MoD direct procurement at South Block under Defence Acquisition Procedure 2020 typically requires Rs 25 crore-plus net worth for equipment supply; capital procurement of major systems (simulators, weapons platforms) can require Rs 100-1,000 crore. DAP 2020 also requires cleared-vendor status and specific financial-capacity declarations beyond standard NWC. Patron's Delhi office maintains the DAP 2020 financial-eligibility Annexure format and aligns the certificate with cleared-vendor requirements.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-5">
                        <h3 class="faq-expanded__q">Delhi CPWD empanelment ke liye certificate kaise milta hai? (Hinglish voice-search)</h3>
                        <div class="faq-expanded__a"><p>CPWD Nirman Bhawan ke liye Class I, II, III, IV, V contractor empanelment alag-alag net worth thresholds ke saath chalti hai. Class I ke liye highest threshold hota hai. Patron Delhi office contractor class declaration ko certified net worth ke saath align karta hai, gap ho to draft se pehle flag karta hai. CPWD Annexure 9 format mein UDIN ke saath same day soft copy aur 2-3 din mein hard copy ready ho jata hai CPWD office submission ke liye.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-6">
                        <h3 class="faq-expanded__q">Is UDIN mandatory on a Delhi tender net worth certificate?</h3>
                        <div class="faq-expanded__a"><p>Yes, UDIN is mandatory on every CA-issued net worth certificate since 1 July 2019, enforced by ICAI. The 18-digit Unique Document Identification Number is generated at udin.icai.org and printed on the certificate. Delhi tender evaluation committees at CPWD, DDA, DMRC, NBCC, central ministries, Defence MoD, Railway Board, DIAL, AIIMS, MCD, NDMC, DJB, DUSIB, DTC, DSIIDC plus GeM and CPPP all verify the UDIN on the ICAI portal as standard. Certificates without UDIN are rejected.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-7">
                        <h3 class="faq-expanded__q">How is the certificate structured for central ministry direct procurement?</h3>
                        <div class="faq-expanded__a"><p>Central ministry direct procurement from Bhawans (Krishi Bhawan, Shastri Bhawan, Vigyan Bhawan, Rail Bhawan, Udyog Bhawan, North Block, South Block) uses ministry-specific Annexure formats with distinct declaration language. The certificate is laid out on the originating Bhawan's prescribed format, not a generic CA letterhead, and is tied to the tender NIT issued by that ministry. Patron's Delhi office maintains the Bhawan-level format library.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-8">
                        <h3 class="faq-expanded__q">DMRC Metro JV bid mein lead aur member ka NWC kaise prepare hota hai? (Hinglish voice-search)</h3>
                        <div class="faq-expanded__a"><p>DMRC Metro pre-qualification typically lead aur member ke separate NWCs PLUS consolidated JV NWC chahiye hota hai. Threshold (e.g. Rs 150 crore Phase IV depot tenders) consolidated net worth ke against check hota hai. Patron Delhi team tender ka JV provisions read karta hai, JV agreement ratios use karta hai, aur lead-member-consolidated - sab certificates matching as-of date ke saath prepare karta hai. DMRC pre-qualification typically 12-15 din mein clear ho jata hai.</p></div>
                    </div>
                </div>
            </div>
            ...
            <div class="highlight-box" style="margin-top:32px;">
                ...
                <p><strong>Who issues it in Delhi?</strong> Practising CA with valid COP registered with ICAI.</p>
<p><strong>Cost?</strong> Starting INR 1,499 (Exl GST and Govt. Charges) at Patron Accounting Delhi.</p>
<p><strong>Timeline?</strong> Soft copy same day for e-procurement; hard copy same-day pickup or 2-day standard.</p>
<p><strong>Validity?</strong> Tender-document specific - CPWD empanelment annual, DMRC and DIAL 3-6 months from issue.</p>
<p><strong>Tender authorities covered?</strong> CPWD, DDA, DMRC, NBCC, central ministry Bhawan-level, MoD DAP 2020, Railway Board, DIAL, AIIMS, MCD, NDMC, DJB, DUSIB, DTC, DSIIDC, GeM, CPPP.</p>
<p><strong>JV bids supported?</strong> Yes - lead, member, and consolidated certificates with JV agreement reference.</p>
<p><strong>Defence MoD DAP 2020 ready?</strong> Yes - with cleared-vendor and integrity-of-bidder declarations.</p>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>Delhi tender bid deadlines are non-extendable; a certificate that arrives even a minute after the bid-close timestamp disqualifies the bid entirely. Annexure format mismatch is the second-most common disqualification - CPWD, DDA, DMRC, NBCC, central ministry Bhawan-level, Defence MoD DAP 2020, DIAL, AIIMS each have distinct formats and a generic CA letterhead fails. Net worth below threshold is a hard binary - CPWD class thresholds (Class I-V), DMRC Metro packages Rs 25-300 crore, DIAL Terminal expansion Rs 50-500 crore, Defence MoD DAP 2020 typically Rs 25+ crore. Central ministry Bhawan-level format mismatches cause silent rejections. Plan the certificate request 7-10 days before the bid-opening date; for last-minute bids, Patron's Delhi office offers same-day delivery.</p>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text" style="text-align:left;">
                ...
                <p style="color:rgba(255,255,255,0.9);font-size:15px;line-height:1.7;">A net worth certificate for tender bidding in Delhi is the document that gates the bidder's progression past technical evaluation in India's largest central-procurement market. It must be CA-signed, UDIN-authenticated, on the tender-authority-specific Annexure format (CPWD Manual format aligned to contractor class, DDA, DMRC pre-qualification format, NBCC, central ministry Bhawan-level direct-procurement format, Defence MoD DAP 2020 financial-eligibility Annexure, Railway Board, DIAL IGI Airport, AIIMS, MCD, NDMC, DJB, DUSIB, DTC, DSIIDC, GeM or CPPP), with net worth that exceeds the tender threshold, dated within the validity window the tender document specifies, and aligned to the latest audited financials. Patron Accounting issues this certificate from its Delhi office starting INR 1,499, with the Annexure-format library for all major Delhi procurement authorities maintained and same-day delivery available for bid-deadline urgency. Backed by 15+ years of practice and over 2,150 tender bidding certificates issued for Delhi bidders, the team applies SA 500 and SA 505 verification before signing.</p>

            </div>
            <div style="display:flex;gap:14px;flex-wrap:wrap;margin-top:24px;">
                <a href="tel:+919459456700" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:var(--orange);color:#fff;border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#128222; Call +91 945 945 6700</a>
                <a href="https://wa.me/919459456700?text=Hello%20Patron%20Accounting%20Team%2C%20I%20want%20to%20get%20my%20Net%20Worth%20Certificate%20for%20Tender%20Bidding.%20Please%20share%20details%20about%20the%20process%2C%20documents%20required%2C%20and%20fees." target="_blank" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:#25D366;color:#fff;border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#128172; WhatsApp Us</a>
