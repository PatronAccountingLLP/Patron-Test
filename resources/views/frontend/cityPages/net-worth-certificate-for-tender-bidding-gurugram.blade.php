...
@section('meta')
    ...
    <meta property="og:image" content="https://www.patronaccounting.com/images/net-worth-certificate-for-tender-bidding/gurugram-og.webp">
    ...
    <meta name="twitter:image" content="https://www.patronaccounting.com/images/net-worth-certificate-for-tender-bidding/gurugram-og.webp">
@endsection
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-4 private-registration-heading">
                        Net Worth Certificate for Tender Bidding in Gurugram
                    </h1>
                    ...
                    <div class="mb-4">
                        <div class="d-flex align-items-start mb-3">
                            ...
                            <p class="mb-0 text-dark benefit-paragraph"><span>Documents:</span> PAN, GSTIN, Udyam Registration, audited financials (3 years), bank statements, tender document or RFP notification reference</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                        ...
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Eligibility:</span> Gurugram bidders (sole prop, partnership, LLP, Pvt Ltd) on HSIIDC, HSVP, MCG, GMDA, HVPNL, UHBVN, DHBVN, HSRDC, Haryana Police, HMRTC Metro, Maruti Suzuki tier-1 RFP, Honda Motors RFP, DLF private commercial, GeM, CPPP tenders</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Timeline:</span> Same-day soft copy with UDIN; express same-day pickup at Gurugram office for last-minute bid submissions</p>
                        </div>
                    </div>
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                <div class="highlight-box" style="margin-bottom:20px;">
                    ...
                    <p>A net worth certificate for tender bidding in Gurugram is a CA-signed declaration of the bidder-entity's assets minus liabilities, prepared in INR with mandatory UDIN under ICAI norms, in the tender-specific Annexure format the procurement authority specifies. Gurugram tender authorities including HSIIDC, HSVP, MCG, GMDA, HVPNL, UHBVN, DHBVN, HSRDC, Haryana Police, HMRTC Metro plus Maruti Suzuki tier-1 vendor RFP, Honda Motors RFP and DLF private commercial flows accept it as the binary financial-eligibility filter. Patron issues it starting INR 1,499.

<div class="table-responsive-wrapper" style="margin-top:16px;">
<table><thead><tr><th>Parameter</th><th>Value</th></tr></thead><tbody>
<tr><td><strong>Governing Framework</strong></td><td>ICAI - Chartered Accountants Act 1949; General Financial Rules 2017; CPPP Guidelines (Dec 2023); Haryana State PWD Manual; HSIIDC procurement guidelines; OEM Vendor Quality Manuals (Maruti, Honda) for RFP processes</td></tr>
<tr><td><strong>Applicable To</strong></td><td>Gurugram bidders (sole prop, partnership, LLP, Pvt Ltd) on HSIIDC, HSVP, MCG, GMDA, HVPNL, UHBVN, DHBVN, HSRDC, Haryana Police, HMRTC Metro extension, Maruti Suzuki tier-1 RFP, Honda Motors RFP, DLF private commercial, GeM, CPPP tenders</td></tr>
<tr><td><strong>Timeline</strong></td><td>Soft copy same day with UDIN; express pickup same-day from Gurugram office for bid-deadline urgency</td></tr>
<tr><td><strong>Starting Cost</strong></td><td>INR 1,499 (Exl GST and Govt. Charges) at Patron Accounting</td></tr>
<tr><td><strong>Validity</strong></td><td>Tender-document specific - typically dated within 3-6 months of bid opening; OEM tier-1 RFP empanelment annual</td></tr>
...
<tr><td><strong>Mandatory Authentication</strong></td><td>18-digit UDIN at udin.icai.org with CA signature, ICAI seal, FRN and COP number</td></tr>
                ...
                <p>A net worth certificate for tender bidding in Gurugram is the document the tender evaluation committee uses as the binary financial-eligibility filter - the bidder either meets the net worth threshold prescribed in the tender or RFP, or the bid is rejected at the technical evaluation stage. Gurugram's tender ecosystem is distinctive for combining Haryana state procurement (HSIIDC industrial plot and infrastructure tenders, HSVP urban development, MCG civic, GMDA metropolitan, HVPNL power transmission, UHBVN/DHBVN distribution, HSRDC roads, Haryana Police procurement), HMRTC Metro extension tenders for the Gurugram-Faridabad and Delhi-Gurugram interconnect, Manesar IMT tier-1 vendor RFP processes by Maruti Suzuki, Honda Motors and Hero MotoCorp (distinct from ongoing supplier credit), and DLF private commercial tender flows for facility management and infrastructure at Cyber City, Cyber Hub, Golf Course Road and Sector 102-115. Patron Accounting prepares the certificate in the exact format each authority specifies. Last Updated: 2 July 2026.</p>
                <p></p>
        ...
        <div class="two-column">
            <div class="column-content">
                ...
                <div class="content-text what-is-definition">
                    ...
                    <p>A net worth certificate for tender bidding is a financial statement signed by a practising Chartered Accountant in Gurugram certifying the total assets minus total liabilities of the bidder-entity (sole proprietorship, partnership, LLP or company) as of a specific date, prepared in INR for submission to a tender authority or OEM RFP issuer as part of the technical bid envelope under General Financial Rules 2017 (for central), Haryana State PWD Manual (for state), HSIIDC procurement guidelines (for industrial tenders), and OEM-specific Vendor Quality Manuals for Manesar tier-1 RFPs.</p>
<p>On the asset side the Gurugram tender certificate consolidates entity-level assets - cash and bank balances, trade receivables (with OEM customer-credit-period notes where applicable for tier-1 supplier bidders), inventory, fixed deposits, investments, plant and machinery at written-down value, factory or commercial property at the HSVP collector rate for the specific Gurugram sector, vehicles, intangibles. On the liability side it captures trade payables, statutory dues, term loans, working capital limits utilised, vehicle loans, unsecured loans, and provisions. The net worth figure must EXCEED the threshold the tender or RFP specifies; HSIIDC infrastructure tenders typically require Rs 5-50 crore, MCG civic Rs 25 lakh-5 crore, HMRTC Metro extension packages Rs 25-300 crore, Maruti Suzuki tier-1 RFP Rs 25-100 crore for major component supply.</p>
<p>The certificate must carry an 18-digit UDIN generated at udin.icai.org, mandatory since 1 July 2019. Gurugram tender evaluation committees at HSIIDC, HSVP, MCG, GMDA, HVPNL, UHBVN, DHBVN, HSRDC, Haryana Police, HMRTC, Maruti Suzuki tier-1 RFP committees at Manesar, Honda Motors vendor empanelment, DLF commercial tender desks, plus GeM and CPPP central evaluators all verify the UDIN online as a standard step. Issued under ICAI SA 500 (Audit Evidence) and SA 505 (External Confirmations). For JV bids on high-value HMRTC Metro and HSIIDC infrastructure tenders, the tender format determines whether net worth is shown for lead alone, member alone, or consolidated.</p>
...
<p><strong>HSIIDC Procurement Guidelines:</strong> Haryana State Industrial and Infrastructure Development Corporation's procurement framework governing industrial plot allotment tenders at Manesar IMT, Bawal IMT, Faridabad IMT and other industrial estates, plus infrastructure development tenders within these estates. HSIIDC Annexure formats are distinct from generic state PWD formats.</p>
<p><strong>Maruti Suzuki Tier-1 Vendor RFP:</strong> Maruti Suzuki India Limited's Request for Proposal process for tier-1 component suppliers at Manesar plant. Distinct from ongoing supplier-credit relationships - tier-1 RFP is a competitive bid for major component supply contracts with specific net worth thresholds (typically Rs 25-100 crore) tied to the contract value. Same applies to Honda Motors and Hero MotoCorp at Manesar.</p>
<p><strong>HMRTC:</strong> Haryana Mass Rapid Transit Corporation - the special-purpose vehicle for Metro extensions within Haryana NCR including the Delhi-Gurugram (Dwarka-Gurugram extension) and Gurugram-Faridabad metro interconnects. HMRTC pre-qualification Annexure is distinct from DMRC.</p>
<p><strong>DLF Private Commercial Tender:</strong> DLF Limited's tender flow for facility management, infrastructure maintenance, and commercial tower vendor empanelment at Cyber City, Cyber Hub, DLF Phase I-V residential, Golf Course Road commercial, and Camellias/Aralias. Treated similar to public-tender style with CA-certified NWC requirement, despite being private.</p>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>A Gurugram business owner needs a tender bidding net worth certificate when the tender or RFP document specifies a CA-certified net worth requirement at any of the following:</p>
<ul class="content-list">
<li>HSIIDC tenders - Manesar IMT, Bawal IMT, Faridabad IMT and other Haryana industrial estate infrastructure tenders, plus industrial plot allotment tenders. Net worth thresholds typically Rs 5-50 crore.</li>
<li>HSVP tenders - Haryana Shahari Vikas Pradhikaran urban development tenders for Gurugram sectors, including HSVP plot allotment, sector infrastructure, and HSVP-administered land development.</li>
<li>MCG and GMDA tenders - Municipal Corporation of Gurugram civic tenders (roads, drains, parks, solid waste, street lighting) and Gurugram Metropolitan Development Authority infrastructure tenders for metropolitan-area development.</li>
<li>Haryana state utility tenders - HVPNL (power transmission), UHBVN/DHBVN (power distribution North/South Haryana), Public Health Engineering Department water tenders, HSRDC roads tenders, and Haryana Police equipment and vehicle procurement.</li>
<li>HMRTC Metro extension tenders - Gurugram-Faridabad and Delhi-Gurugram (Dwarka-Gurugram extension) metro interconnect tenders for construction, electrical, signalling, rolling stock, and station finishing.</li>
<li>Manesar OEM tier-1 vendor RFP - Maruti Suzuki, Honda Motors, Hero MotoCorp competitive vendor RFP processes for tier-1 component supply contracts (distinct from ongoing supplier-credit relationships).</li>
<li>DLF private commercial tenders - facility management, infrastructure maintenance, and commercial tower vendor empanelment at Cyber City, Cyber Hub, DLF Phases I-V, Golf Course Road, Camellias, Aralias and Pramerica.</li>
<li>IGI Airport (DIAL) tenders - though DIAL is technically Delhi, geographic proximity makes Gurugram bidders frequent participants in DIAL Terminal, cargo, and ground handling tenders.</li>
<li>Central-government tenders on GeM and CPPP - Gurugram bidders compete nationally across product and service categories.</li>
</ul>
<p>Gurugram context: Gurugram's tender market combines (a) Haryana state procurement through HSIIDC, HSVP, MCG, GMDA, HVPNL, UHBVN/DHBVN, HSRDC, and Haryana Police; (b) HMRTC Metro extensions tying Gurugram to Delhi and Faridabad; (c) Manesar IMT OEM tier-1 vendor RFP processes by Maruti Suzuki, Honda Motors and Hero MotoCorp - distinct from ongoing supplier credit; (d) DLF and similar private commercial tenders treated in public-tender style; and (e) DIAL IGI Airport tenders by geographic proximity. HSVP collector rates set Gurugram property valuation floors. Manesar IMT is among India's largest auto-component clusters by GMV.</p>
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <table>
                    ...
                    <tbody>
                        <tr><td><strong>HSIIDC, HSVP and MCG Tender Certificate</strong></td><td>For Gurugram bidders on Haryana state procurement - HSIIDC industrial plot and infrastructure tenders (Manesar IMT, Bawal IMT, Faridabad IMT), HSVP urban development tenders for Gurugram sectors, MCG civic tenders (roads, drains, parks, solid waste, lighting). Authority-specific Annexure formats maintained; GMDA tenders also handled.</td><td><span class="badge-included">Included</span></td></tr>
<tr><td><strong>Haryana State Utility Tender Certificate (HVPNL, UHBVN/DHBVN, HSRDC, Police)</strong></td><td>For Gurugram bidders on HVPNL power transmission, UHBVN/DHBVN power distribution, HSRDC roads, Haryana Public Health Engineering Department water and sewage, and Haryana Police equipment and vehicle procurement tenders. Utility-specific Annexure formats and CEA (Central Electricity Authority) declarations where applicable supported.</td><td><span class="badge-included">Included</span></td></tr>
<tr><td><strong>HMRTC Metro Extension Tender Certificate</strong></td><td>For Gurugram infrastructure bidders on Haryana Mass Rapid Transit Corporation Metro extension tenders - Delhi-Gurugram (Dwarka-Gurugram extension) and Gurugram-Faridabad metro corridors. Construction, electrical, signalling, rolling stock, and station finishing tenders. High net worth thresholds (Rs 25-300 crore) and JV bid consolidation supported.</td><td><span class="badge-included">Included</span></td></tr>
<tr><td><strong>Manesar OEM Tier-1 Vendor RFP Certificate (Maruti, Honda, Hero)</strong></td><td>For Manesar IMT auto-component suppliers participating in tier-1 vendor RFP processes by Maruti Suzuki, Honda Motors, Hero MotoCorp and other OEMs. RFP-specific format with OEM Vendor Quality Manual reference, related-party declarations, and tier-1 financial-capacity declarations. Distinct from ongoing supplier-credit working-capital files.</td><td><span class="badge-included">Included</span></td></tr>
<tr><td><strong>DLF Private Commercial Tender Certificate</strong></td><td>For Gurugram facility management, infrastructure maintenance, and commercial tower vendor empanelment bidders on DLF tenders at Cyber City, Cyber Hub, DLF Phases I-V, Golf Course Road, Camellias and Aralias. Vendor onboarding-ready bundle with related-party-transactions and conflict-of-interest declarations.</td><td><span class="badge-included">Included</span></td></tr>
<tr><td><strong>JV (Joint Venture) Tender Bid Certificate</strong></td><td>For Gurugram bidders participating as JV lead or member on high-value HSIIDC, HMRTC Metro, GMDA and DLF tenders. Separate JV-lead and JV-member NWCs prepared, or consolidated JV NWC where the tender permits aggregation, with JV agreement reference cited and member responsibility split disclosed.</td><td><span class="badge-included">Included</span></td></tr>
...
<div class="step-card">
    <div class="step-content">
        ...
        <p class="step-description">Patron extracts the tender or RFP-specific Annexure format, computes the entity net worth from the latest audited balance sheet, validates that the net worth exceeds the tender threshold (critical for high-threshold HMRTC Metro and Maruti tier-1 RFP cases), and lays out the certificate on the prescribed Annexure. HSIIDC, HSVP, MCG, GMDA, HVPNL, HMRTC, Maruti Suzuki RFP, Honda Motors RFP, DLF formats are maintained in Patron's Gurugram library.</p>
    </div>
    <div class="step-visual">
...
<div class="step-card">
    <div class="step-content">
        ...
        <p class="step-description">Draft certificate is emailed within 24 hours for bidder review. Critical check: net worth figure exceeds tender threshold; tender or RFP reference number, authority name, and tender title are accurate; Annexure format matches the tender document exactly; OEM Vendor Quality Manual reference cited where applicable. Corrections happen in this step.</p>
    </div>
    <div class="step-visual">
...
<div class="step-card">
    <div class="step-content">
        ...
        <p class="step-description">Patron CA generates the 18-digit UDIN at udin.icai.org under 'Certificates - Net Worth Certificate', signs on firm letterhead with ICAI seal, issues the final document. Soft copy emailed same day for e-procurement upload or DLF vendor portal upload; hard copy collected from Patron Gurugram office same day for last-minute bid submissions, or couriered within 2 working days.</p>
    </div>
    <div class="step-visual">
...
<li>Recent utility bill or rent agreement for the registered Gurugram office address</li>
<li>Class III digital signature certificate (for GeM, CPPP, HSIIDC, MCG, GMDA e-procurement submissions)</li>
</ul>
<h3>Tender or RFP Document</h3>
<ul class="content-list">
<li>Full tender document (NIT) or RFP with eligibility-criteria page highlighted</li>
<li>Tender-specific Annexure format for net worth declaration</li>
<li>Tender or RFP notification reference, tender number, and tender opening date</li>
<li>OEM Vendor Quality Manual reference (for Maruti Suzuki, Honda Motors, Hero MotoCorp tier-1 RFP)</li>
<li>DLF vendor onboarding questionnaire (where DLF commercial tender)</li>
<li>HMRTC pre-qualification questionnaire (where HMRTC Metro tender)</li>
</ul>
...
<li>Trade receivable and payable ageing (with OEM customer-credit-period notes for tier-1 suppliers)</li>
<li>Plant and machinery register with WDV</li>
<li>Gurugram factory, warehouse or commercial property registration deed with HSVP collector rate reference</li>
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <table>
                    ...
                    <tbody>
                        <tr><td><strong>Challenge 1: HSIIDC and HSVP Annexure formats differ from Haryana state PWD</strong></td><td>HSIIDC industrial procurement, HSVP urban development, and Haryana state PWD each use distinct Annexure formats with different declaration language, asset-category requirements, and contractor-class provisions. A certificate prepared on the state PWD format fails at HSIIDC and vice versa. Patron's Gurugram office maintains the HSIIDC, HSVP, MCG, GMDA, and Haryana state PWD format libraries separately and delivers the format-correct certificate for each.</td></tr>
<tr><td><strong>Challenge 2: Maruti Suzuki tier-1 vendor RFP requires Vendor Quality Manual alignment</strong></td><td>Maruti Suzuki Manesar tier-1 vendor RFP processes require the financial certificate to reference the Vendor Quality Manual and include related-party declarations, conflict-of-interest declarations, and tier-1 supply-track-record evidence. Generic CA-letterhead NWC fails at the RFP technical evaluation stage. Patron's Gurugram office maintains the Maruti tier-1 RFP format, plus the Honda Motors and Hero MotoCorp equivalent formats, and delivers the RFP-ready certificate package.</td></tr>
<tr><td><strong>Challenge 3: HMRTC Metro extension JV bid consolidation differs from DMRC</strong></td><td>HMRTC Metro extension tenders for Gurugram-Faridabad and Delhi-Gurugram corridors use their own JV consolidation Annexure, distinct from DMRC's pre-qualification format. The lead-member-consolidated ratios and JV agreement disclosure requirements differ. Patron's Gurugram team reads the HMRTC-specific JV provisions, prepares lead, member, and consolidated certificates with HMRTC reference, and ensures the consolidated net worth comfortably exceeds the threshold (typically Rs 100-300 crore depending on package).</td></tr>
<tr><td><strong>Challenge 4: DLF private commercial tenders treat NWC like public but without standard governing rules</strong></td><td>DLF Cyber City, Cyber Hub, and commercial tower vendor empanelment tenders require CA-certified NWC in a public-tender style format, but without the GFR 2017 or CPPP guideline backing that central tenders have. Annexure formats are DLF-prescribed and vary by tender. Patron's Gurugram office maintains DLF's vendor onboarding format library, ties the certificate to DLF's vendor reference number, and incorporates related-party and data-privacy declarations the DLF vendor desk requires.</td></tr>
...
<tr><td>Tender</td><td class="table-amount">specific Annexure format replication (HSIIDC, HSVP, MCG, GMDA, HVPNL, UHBVN, DHBVN, HSRDC, Haryana Police, HMRTC and others) - INR 999 per Annexure</td><td><span class="badge-addon">Add-on</span></td></tr>
<tr><td>Maruti Suzuki tier</td><td class="table-amount">1 vendor RFP certificate with Vendor Quality Manual reference and related-party declarations - INR 2,499</td><td><span class="badge-addon">Add-on</span></td></tr>
<tr><td>Honda Motors / Hero MotoCorp tier</td><td class="table-amount">1 vendor RFP certificate package - INR 2,499</td><td><span class="badge-addon">Add-on</span></td></tr>
<tr><td>DLF commercial tender vendor onboarding</td><td class="table-amount">ready package (related-party + conflict-of-interest + data-privacy declarations) - INR 2,999</td><td><span class="badge-addon">Add-on</span></td></tr>
<tr><td>HMRTC Metro pre</td><td class="table-amount">qualification financial-capacity Annexure - INR 1,500</td><td><span class="badge-addon">Add-on</span></td></tr>
...
<tr><td>Express same</td><td class="table-amount">day hard-copy delivery at Patron Gurugram office for bid-deadline urgency - INR 750</td><td><span class="badge-addon">Add-on</span></td></tr>
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <table>
                    ...
                    <tbody>
                        <tr><td><strong>Document upload (audited financials + tender Annexure or RFP)</strong></td><td>Same day</td></tr>
<tr><td><strong>CA verification under SA 500 and SA 505</strong></td><td>Same day to 1 working day</td></tr>
<tr><td><strong>Tender or RFP Annexure format alignment</strong></td><td>Same day for known Gurugram authorities; 1 working day for less common formats</td></tr>
<tr><td><strong>Draft certificate emailed for bidder review</strong></td><td>Within 12-24 hours</td></tr>
<tr><td><strong>Corrections and UDIN-signed soft copy for e-procurement or DLF vendor portal upload</strong></td><td>Same day after approval</td></tr>
<tr><td><strong>Hard copy collection from Patron Gurugram office for physical bid submission</strong></td><td>Same day (express) or 2 working days standard</td></tr>
<tr><td><strong>Validity at tender authorities</strong></td><td>Tender-document specific - OEM tier-1 RFP empanelment annual, HMRTC and HSIIDC 3-6 months</td></tr>
...
<article class="feature-card">
    ...
    <p class="feature-text">A Gurugram-CA-issued tender certificate from Patron Accounting clears the binary financial-eligibility filter on first submission, with the tender-authority-specific Annexure format replicated exactly. The UDIN system lets the tender evaluation committee or OEM RFP team verify authenticity within seconds at udin.icai.org as part of standard technical evaluation.</p>
</article>
...
<article class="feature-card">
    ...
    <p class="feature-text">Patron's Gurugram office maintains the Annexure format library for Haryana state procurement (HSIIDC, HSVP, MCG, GMDA, HVPNL, UHBVN, DHBVN, HSRDC, Haryana Police), HMRTC Metro extension tenders, Manesar OEM tier-1 vendor RFP processes (Maruti Suzuki, Honda Motors, Hero MotoCorp), DLF private commercial tenders, plus GeM and CPPP central tenders. The net result is fewer technical-bid disqualifications, on-time bid submissions even at...</p>
</article>
...
<tr><td><strong>Tender Annexure format match</strong></td><td>Generic CA letterhead used</td><td>HSIIDC, HSVP, MCG, GMDA, HVPNL, HMRTC, Maruti RFP, Honda RFP, DLF formats maintained</td></tr>
<tr><td><strong>Maruti Suzuki tier-1 RFP Vendor Quality Manual alignment</strong></td><td>Often missed</td><td>Maintained; declarations packaged with NWC</td></tr>
<tr><td><strong>DLF private commercial vendor onboarding package</strong></td><td>Not handled as bundle</td><td>Related-party + conflict-of-interest + data-privacy declarations included</td></tr>
<tr><td><strong>HMRTC vs DMRC JV consolidation</strong></td><td>Confused (formats differ)</td><td>HMRTC-specific JV format separately maintained</td></tr>
<tr><td><strong>HSVP collector rate property valuation</strong></td><td>Verbal estimate</td><td>Sector-specific notification reference printed</td></tr>
...
<tr><td><strong>Express same-day pickup</strong></td><td>Not available</td><td>Available from Patron Gurugram office</td></tr>
...
<tr><td><strong>Cost</strong></td><td>INR 2,500-6,000 per tender</td><td>Starting INR 1,499 (Exl GST and Govt. Charges)</td></tr>
...
<tr><td><strong>Haryana Government</strong></td><td>Haryana State PWD Manual and Haryana Procurement Policy</td><td>Governs state-level tender eligibility for HSIIDC, HSVP, MCG, GMDA, HVPNL</td></tr>
<tr><td><strong>OEM Vendor Quality Manuals</strong></td><td>Maruti Suzuki Vendor Quality Manual, Honda Vendor Manual, Hero MotoCorp Vendor Manual</td><td>Governs Manesar OEM tier-1 RFP financial-capacity and supply-track-record declarations</td></tr>
</tbody></table></div>
<div class="highlight-box">
<p><strong>Governing Framework:</strong> Chartered Accountants Act 1949 and Code of Ethics 2020 for the issuing CA. General Financial Rules 2017 and CPPP General Guidelines (Dec 2023) for central-government tenders. Haryana State PWD Manual and Haryana Procurement Policy for HSIIDC, HSVP, MCG, GMDA, HVPNL tenders. OEM Vendor Quality Manuals (Maruti Suzuki, Honda Motors, Hero MotoCorp) for Manesar tier-1 RFP processes. DLF Vendor Onboarding Policy for DLF commercial tenders. MSME Public Procurement Policy 2012 (as amended).</p>
<p><strong>Key Provisions:</strong> Section 21 of the Chartered Accountants Act 1949 covers professional misconduct. The Second Schedule, Part I, Clause (8) penalises a CA who fails to obtain sufficient information before expressing an opinion. GFR 2017 Rule 144 covers tender eligibility verification. Haryana State PWD Manual specifies contractor-class net worth thresholds. Maruti Suzuki Vendor Quality Manual specifies tier-1 supplier financial-capacity disclosures.</p>
...
<p><strong>Penalty Exposure for the Bidder:</strong> Bid rejection at technical evaluation; forfeiture of EMD; blacklisting from central-government tender bidding for up to 3 years under GFR 2017; debarment from GeM and CPPP platforms; Maruti Suzuki tier-1 vendor de-empanelment for vendor-quality-manual misstatement; DLF vendor blacklisting; performance guarantee invocation if discovered after award; plus prosecution under Indian Penal Code Section 420 (now Section 318 of the Bharatiya Nyaya Sanhita 2023) for cheating, with imprisonment up to 7 years.</p>
</div>
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    <h2 class="faq-expanded__title">FAQs: Net Worth Certificate for Tender Bidding in Gurugram</h2>
                    <p class="faq-expanded__lead">Common questions about Net Worth Certificate for Tender Bidding for Gurugram businesses, answered by our CA and CS team.</p>
                    @include('partials.faq-enquiry-form', ['enquiryLocation' => 'Gurugram', 'enquiryService' => 'Net Worth Certificate for Tender Bidding in Gurugram'])
                </aside>
                <div class="faq-expanded__list">
                    <div class="faq-expanded__item" id="faq-1">
                        <h3 class="faq-expanded__q">Why does a Gurugram HSIIDC tender require a net worth certificate?</h3>
                        <div class="faq-expanded__a"><p>HSIIDC requires the certificate as the binary financial-eligibility filter for Manesar IMT, Bawal IMT, Faridabad IMT industrial-estate infrastructure tenders and industrial plot allotment tenders. The certificate establishes that the bidder has the financial capacity to execute the contract without disruption. HSIIDC infrastructure tenders typically require Rs 5-50 crore net worth depending on contract value. Below the threshold means rejection at HSIIDC technical evaluation.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-2">
                        <h3 class="faq-expanded__q">What is the format prescribed for HSVP and MCG tender NWC?</h3>
                        <div class="faq-expanded__a"><p>HSVP and MCG each prescribe their own Annexure format. HSVP urban development tenders use a Haryana Shahari Vikas Pradhikaran-specific Annexure with sector-allocation declarations and HSVP-administered land development provisions. MCG civic tenders use the Municipal Corporation of Gurugram format with ward-specific provisions for roads, drains, parks, solid waste, street lighting. A certificate prepared on the HSVP format will fail at an MCG tender and vice versa. Patron maintains both libraries.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-3">
                        <h3 class="faq-expanded__q">Who can issue a net worth certificate for tender bidding in Gurugram?</h3>
                        <div class="faq-expanded__a"><p>Only a practising Chartered Accountant in Gurugram holding a valid Certificate of Practice from ICAI can sign and issue a net worth certificate for tender bidding. The CA generates an 18-digit UDIN at udin.icai.org, signs on firm letterhead with ICAI seal, and prints Membership Number and Firm Registration Number. Gurugram tender evaluation committees at HSIIDC, HSVP, MCG, GMDA, HVPNL, HMRTC, Maruti Suzuki RFP, Honda Motors RFP, DLF commercial tender, plus GeM and CPPP all verify the UDIN.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-4">
                        <h3 class="faq-expanded__q">What are the net worth thresholds at Maruti Suzuki tier-1 vendor RFP?</h3>
                        <div class="faq-expanded__a"><p>Maruti Suzuki Manesar tier-1 vendor RFP processes typically require Rs 25-100 crore net worth depending on the component-supply contract value. Maruti Vendor Quality Manual mandates the financial certificate to be referenced against the Manual, with related-party-transactions declarations, conflict-of-interest declarations, and 3-year supply-track-record evidence. Honda Motors and Hero MotoCorp tier-1 RFP processes follow similar frameworks. Patron's Gurugram office maintains all three OEM formats.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-5">
                        <h3 class="faq-expanded__q">HSIIDC Manesar tender ke liye NWC format alag kaise hota hai? (Hinglish voice-search)</h3>
                        <div class="faq-expanded__a"><p>HSIIDC Manesar IMT, Bawal IMT, Faridabad IMT infrastructure tenders ke liye HSIIDC ka apna Annexure format hota hai joh Haryana state PWD format se kaafi alag hai. Asset-category breakdown alag, declaration language alag, contractor-class provisions alag. Patron Gurugram office HSIIDC format library maintain karta hai. Format-correct certificate UDIN ke saath same day soft copy aur 2-3 din mein hard copy ready ho jata hai HSIIDC office submission ke liye.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-6">
                        <h3 class="faq-expanded__q">Is UDIN mandatory on a Gurugram tender net worth certificate?</h3>
                        <div class="faq-expanded__a"><p>Yes, UDIN is mandatory on every CA-issued net worth certificate since 1 July 2019, enforced by ICAI. The 18-digit Unique Document Identification Number is generated at udin.icai.org and printed on the certificate. Gurugram tender evaluation committees at HSIIDC, HSVP, MCG, GMDA, HVPNL, UHBVN, DHBVN, HSRDC, Haryana Police, HMRTC, Maruti Suzuki RFP, Honda Motors RFP, DLF commercial tender, plus GeM and CPPP all verify the UDIN on the ICAI portal as standard. Certificates without UDIN are rejected.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-7">
                        <h3 class="faq-expanded__q">How is the certificate structured for DLF private commercial tenders?</h3>
                        <div class="faq-expanded__a"><p>DLF Cyber City, Cyber Hub, DLF Phases I-V, Golf Course Road and commercial tower vendor empanelment tenders require CA-certified NWC in a public-tender style format, but with DLF-prescribed Annexure language. The certificate is laid out on the DLF format, tied to the DLF vendor reference number, and incorporates related-party-transactions declarations, conflict-of-interest declarations, and data-privacy attestations the DLF vendor desk requires. Patron maintains the DLF vendor onboarding format library.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-8">
                        <h3 class="faq-expanded__q">Maruti tier-1 RFP ke liye CA certificate alag kaise hota hai Manesar mein? (Hinglish voice-search)</h3>
                        <div class="faq-expanded__a"><p>Maruti Suzuki Manesar tier-1 vendor RFP ek competitive bid hai - alag hai ongoing supplier credit working capital se. RFP ke liye certificate Vendor Quality Manual reference karna padta hai, related-party declarations, conflict-of-interest declarations, aur 3-year audited turnover trend NWC ke saath bundle hote hain. Generic CA-letterhead NWC fail ho jaata hai technical evaluation pe. Patron Gurugram office Maruti, Honda, Hero - sab OEM tier-1 RFP formats maintain karta hai.</p></div>
                    </div>
                </div>
            </div>
...
<p><strong>Timeline?</strong> Soft copy same day for e-procurement or DLF vendor portal; hard copy same-day pickup or 2-day standard.</p>
<p><strong>Validity?</strong> Tender-document specific - OEM tier-1 RFP empanelment annual, HMRTC and HSIIDC 3-6 months.</p>
<p><strong>Tender authorities covered?</strong> HSIIDC, HSVP, MCG, GMDA, HVPNL, UHBVN, DHBVN, HSRDC, Haryana Police, HMRTC, Maruti tier-1 RFP, Honda RFP, Hero RFP, DLF commercial, GeM, CPPP.</p>
<p><strong>JV bids supported?</strong> Yes - lead, member, and consolidated certificates with JV agreement reference.</p>
<p><strong>Maruti tier-1 RFP package ready?</strong> Yes - with Vendor Quality Manual reference + related-party + conflict-of-interest declarations.</p>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>Gurugram tender bid deadlines are non-extendable; a certificate that arrives even a minute after the bid-close timestamp disqualifies the bid entirely. Annexure format mismatch is the second-most common disqualification - HSIIDC, HSVP, MCG, GMDA, HVPNL, HMRTC, Maruti Suzuki tier-1 RFP, Honda RFP, DLF commercial each have distinct formats. Net worth below threshold is a hard binary - HSIIDC industrial Rs 5-50 crore, MCG civic Rs 25 lakh-5 crore, HMRTC Metro packages Rs 25-300 crore, Maruti tier-1 RFP Rs 25-100 crore. Maruti and Honda RFP cycles align with annual production planning - missing a quarter means a year-long wait. DLF vendor empanelment windows tied to commercial tower handover timelines. Plan the certificate request 7-10 days before the bid-opening or RFP-close date; for last-minute bids, Patron's Gurugram office offers same-day delivery.</p>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text" style="text-align:left;">
                ...
                <p style="color:rgba(255,255,255,0.9);font-size:15px;line-height:1.7;">A net worth certificate for tender bidding in Gurugram is the document that gates the bidder's progression past technical evaluation across Haryana state procurement, Manesar OEM tier-1 vendor RFPs, HMRTC Metro extensions, and DLF private commercial tender flows. It must be CA-signed, UDIN-authenticated, on the tender-authority-specific Annexure format (HSIIDC, HSVP, MCG, GMDA, HVPNL, UHBVN, DHBVN, HSRDC, Haryana Police, HMRTC, Maruti Suzuki Vendor Quality Manual format, Honda Motors RFP format, Hero MotoCorp RFP format, DLF vendor onboarding format, or GeM/CPPP), with net worth that exceeds the tender or RFP threshold, dated within the validity window the tender document specifies, and aligned to the latest audited financials. Patron Accounting issues this certificate from its Gurugram office starting INR 1,499, with the Annexure-format library for all major Gurugram tender authorities and OEM RFP processes maintained and same-day delivery available for bid-deadline urgency. Backed by 15+ years of practice and over 1,750 tender bidding certificates issued for Gurugram bidders, the team applies SA 500 and SA 505 verification before signing.</p>
