...
@section('meta')
    ...
    <meta property="og:image" content="https://www.patronaccounting.com/images/net-worth-certificate-for-tender-bidding/mumbai-og.webp">
    ...
    <meta name="twitter:image" content="https://www.patronaccounting.com/images/net-worth-certificate-for-tender-bidding/mumbai-og.webp">
@endsection
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    ...
                    @include('partials.faq-enquiry-form', ['enquiryLocation' => 'Mumbai', 'enquiryService' => 'Net Worth Certificate for Tender Bidding in Mumbai'])
                </aside>
