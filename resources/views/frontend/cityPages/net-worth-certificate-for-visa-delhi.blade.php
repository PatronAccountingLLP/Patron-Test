{{-- /net-worth-certificate-for-visa/delhi
     Generated from Generated Pages/net-worth-certificate-for-visa-delhi/net-worth-certificate-for-visa-delhi.html by Scripts/build_blade.py.
     ...
     Before this goes live:
       - deploy public/images/networth-cluster/net-worth-certificate-for-visa-delhi/** and public/certificates/**
...
@section('meta')
    <title>Net Worth Certificate for Visa Applications in Delhi</title>
    <meta name="description" content="For embassy submissions across Chanakyapuri, with MEA apostille arranged and your funds presented the way each mission there expects to see them set out.">
    <link rel="canonical" href="https://www.patronaccounting.com/net-worth-certificate-for-visa/delhi">
    <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1">
    <meta property="og:title" content="Visa Certificates for Chanakyapuri Missions">
    <meta property="og:description" content="Embassy submissions and MEA apostille, prepared in Rohini.">
    <meta property="og:url" content="https://www.patronaccounting.com/net-worth-certificate-for-visa/delhi">
    <meta property="og:type" content="website">
    <meta property="og:site_name" content="Patron Accounting">
    <meta property="og:image" content="https://www.patronaccounting.com/images/networth-cluster/og/net-worth-certificate-for-visa-delhi.jpg">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Visa Certificates for Chanakyapuri Missions">
    <meta name="twitter:description" content="Embassy submissions and MEA apostille, prepared in Rohini.">
    <meta name="twitter:image" content="https://www.patronaccounting.com/images/networth-cluster/og/net-worth-certificate-for-visa-delhi.jpg">
@endsection
    ...
    <script type="application/ld+json">
{
 ...
 "@graph": [
  {
   "@type": "Service",
   "@id": "https://www.patronaccounting.com/net-worth-certificate-for-visa/delhi#service",
   "name": "Net Worth Certificate for Visa Applications in Delhi",
   "description": "For embassy submissions across Chanakyapuri, with MEA apostille arranged and your funds presented the way each mission there expects to see them set out.",
   "provider": {
    "@id": "https://www.patronaccounting.com/#organization"
   },
   "areaServed": "Delhi",
   "url": "https://www.patronaccounting.com/net-worth-certificate-for-visa/delhi"
  },
  {
   "@type": "LocalBusiness",
  ...
  {
   "@type": "BreadcrumbList",
   "@id": "https://www.patronaccounting.com/net-worth-certificate-for-visa/delhi#breadcrumb",
   "itemListElement": [
    {
     "@type": "ListItem",
     "position": 1,
    ...
    },
    {
     "@type": "ListItem",
     "position": 4,
     "name": "Net Worth Certificate for Visa in Delhi",
     "item": "https://www.patronaccounting.com/net-worth-certificate-for-visa/delhi"
    }
   ]
  },
  {
   "@type": "FAQPage",
   "@id": "https://www.patronaccounting.com/net-worth-certificate-for-visa/delhi#faq",
   "datePublished": "2026-07-30T10:00:00+05:30",
   "dateModified": "2026-08-04T10:00:00+05:30",
   "mainEntity": [
    {
     "@type": "Question",
     "name": "Why must the certificate be apostilled before some Chanakyapuri embassies accept it?",
     "acceptedAnswer": {
      "@type": "Answer",
      "text": "Because a foreign authority cannot verify an Indian signature on its own. Apostille certifies the origin of the document under the 1961 Hague Convention, so the receiving country treats it as authentic without further checks. Missions in Chanakyapuri that require legalisation will not process a funds pack without it."
     }
    },
    {
     "@type": "Question",
     "name": "Does apostille attach to the original or to a copy?",
     "acceptedAnswer": {
      "@type": "Answer",
      "text": "To the document actually presented, which is why the signed original goes forward. A photocopy legalised after the fact is not the same document. Missions reject packs where the apostille sticker sits on a copy of a certificate whose original was never presented. The certificate is therefore signed in the form intended for legalisation."
     }
    },
    {
     "@type": "Question",
     "name": "How long does the apostille step add to a Delhi visa timeline?",
     "acceptedAnswer": {
      "@type": "Answer",
      "text": "Enough that it has to be planned, not squeezed in. The document is routed through an authorised collection channel to the Ministry of External Affairs and returns legalised. The round trip runs into days rather than hours. Applications that fail on timing usually did the certificate last instead of first."
     }
    },
    {
     "@type": "Question",
     "name": "Which other documents go for legalisation alongside the certificate?",
     "acceptedAnswer": {
      "@type": "Answer",
      "text": "Whatever the destination lists. Educational certificates, birth and marriage certificates and affidavits commonly travel with the funds pack. Several require state-level authentication before the Ministry of External Affairs will apostille them. Sending the net worth certificate alone, only to send a second batch later, is the avoidable delay."
     }
    },
    {
     "@type": "Question",
     "name": "Does a notarised copy work where the embassy asks for legalisation?",
     "acceptedAnswer": {
      "@type": "Answer",
      "text": "No. Notarisation attests a copy or a signature within India; legalisation makes the document acceptable to a foreign authority. Where an embassy in Delhi specifies apostille or consular attestation, a notarised copy is not a substitute and the pack is returned. The two steps are sometimes both required, in sequence."
     }
    },
    {
     "@type": "Question",
     "name": "Is the education loan sanction letter legalised too?",
     "acceptedAnswer": {
      "@type": "Answer",
      "text": "Only if the destination asks. Most missions accept a bank's sanction letter in original with the funds pack, since the bank is identifiable and contactable. Where the country requires every supporting document legalised, the letter goes through the same route as the certificate. The bank is told in advance so the original is released."
     }
    },
    {
     "@type": "Question",
     "name": "Can a certificate be re-signed if the apostille application is returned?",
     "acceptedAnswer": {
      "@type": "Answer",
      "text": "Yes, and a fresh certificate carries a new date and a new UDIN. Returns usually turn on a formatting or authentication step rather than on the content, so the underlying work does not repeat. What cannot happen is a new signature on the old date, because the document states a position as at the date it was signed."
     }
    },
    {
     "@type": "Question",
     "name": "Do all missions in Delhi require legalisation?",
     "acceptedAnswer": {
      "@type": "Answer",
      "text": "No, and assuming they do adds cost. Several accept the signed original with UDIN verification, particularly for short-stay categories. Legalisation is more often demanded for immigration, study and long-stay routes. The mission's own document checklist is the operative source, since requirements differ between categories at the same embassy."
     }
    },
    {
     "@type": "Question",
     "name": "Does the applicant have to appear in person with the original?",
     "acceptedAnswer": {
      "@type": "Answer",
      "text": "It depends on the mission and the category. Some Delhi embassies require personal submission of originals at interview, others accept a courier or a visa centre lodgement. Where originals are handed over, a certified copy is retained by the applicant, because the certificate is the document the sponsor or bank may need again."
     }
    },
    {
     "@type": "Question",
     "name": "What if the name on the passport differs from the name on the certificate?",
     "acceptedAnswer": {
      "@type": "Answer",
      "text": "It is corrected before submission. Missions match names character by character. An expanded initial, a middle name or a maiden name appearing on one document but not the other is a standard ground for a query. The certificate is issued in the passport spelling, with any other name recorded as an alias."
     }
    }
   ]
  },
  {
   "@type": "WebPage",
   "@id": "https://www.patronaccounting.com/net-worth-certificate-for-visa/delhi#webpage",
   "url": "https://www.patronaccounting.com/net-worth-certificate-for-visa/delhi",
   "name": "Net Worth Certificate for Visa Applications in Delhi",
   "description": "For embassy submissions across Chanakyapuri, with MEA apostille arranged and your funds presented the way each mission there expects to see them set out.",
   "isPartOf": {
...
<nav aria-label="Breadcrumb" style="background:var(--gray-50);border-bottom:1px solid var(--gray-200);padding:10px 16px;">
    <div style="max-width:1320px;margin:0 auto;">
        <ol style="display:flex;align-items:center;gap:8px;list-style:none;padding:0;margin:0;font-size:13px;font-family:'Barlow',sans-serif;flex-wrap:wrap;">
            ...
            <li><span style="color:var(--orange);font-weight:600;">Net Worth Certificate for Visa in Delhi</span></li>
        </ol>
    </div>
</nav>
        ...
        <div class="row align-items-center">
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-4 private-registration-heading">Net Worth Certificate for Visa in Delhi</h1>
                    ...
                    <div class="mb-4 hero-benefits">
                        <div class="hero-benefit"><span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span><p class="mb-0 text-dark benefit-paragraph"><span>Originals issued in Delhi</span></p></div>
                        <div class="hero-benefit"><span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span><p class="mb-0 text-dark benefit-paragraph"><span>Sequenced for legalisation</span></p></div>
                        <div class="hero-benefit"><span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span><p class="mb-0 text-dark benefit-paragraph"><span>Liquidity shown separately</span></p></div>
                        <div class="hero-benefit"><span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span><p class="mb-0 text-dark benefit-paragraph"><span>Authenticated and still checkable</span></p></div>
                    </div>
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="mailto:sales@patronaccounting.com?subject=Enquiry%20for%20a%20Net%20Worth%20Certificate%20for%20Visa%20in%20Delhi&body=Hello%20Patron%20Accounting%20Team%2C%0A%0AI%20need%20a%20net%20worth%20certificate%20for%20visa%20in%20delhi%20and%20would%20like%20to%20know%20more.%0A%0AThank%20you." class="btn-sample text-decoration-none">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:18px;height:18px;"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,12 2,6"/></svg>
                            Email Us
                        </a>
                        <a href="https://wa.me/919459456700?text=Hi%20Patron%2C%20I%20need%20a%20net%20worth%20certificate%20for%20visa%20in%20delhi" target="_blank" rel="noopener" class="btn-sample text-decoration-none">
...
<section class="testimonials-section">
  <div class="section-container">
    <div class="section-header">
      <h2>Delhi Applicants We Have Certified For</h2>
...
<section class="content-section" id="overview-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Visa Files From Delhi: What the Consulate Expects</h2>
            <div class="content-text">
                <div class="highlight-box" style="margin-bottom:20px;">
                    <p><strong>&#128204; TL;DR &mdash; Net Worth Certificate for Visa in Delhi at a Glance</strong></p>
                    <p>Delhi adds a step other cities do not. Documents going to several destinations must pass MEA apostille before an embassy in Chanakyapuri will take them. Apostille attaches to the signed original, not to a copy made afterwards. So the net worth certificate is prepared and signed in the form that will be legalised, before the funds pack goes forward.</p>
                </div>
<p>Delhi applicants usually arrive holding more than they need and less than they think. There are statements, deeds and often an old certificate. There is frequently a destination that requires the document to be legalised before it is lodged. Which of those has to happen first is the question worth settling. The order cannot be corrected afterwards, and an old certificate is rarely worth reusing. Our note on <a href="/net-worth-certificate-for-visa">preparing funds evidence</a> sets out the general shape.</p>
<p>Legalisation is what fixes that order. The figure has to be final and the paper signed before it leaves for authentication. A reprint issued afterwards carries nothing at all. So the position is settled before the paper is signed, and the signing is the last step rather than an early one. <a href="/glossary/networth/attestation">Attestation</a> and apostille procedure is published by <a href="https://www.mea.gov.in/" target="_blank" rel="noopener">the Ministry of External Affairs</a>.</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="content-container">
        <div class="two-column">
            <div class="column-content">
                <h2 class="section-title">What Legalisation Does to This Certificate</h2>
                <div class="content-text what-is-definition">
<p>Files leaving the capital for many destinations must be authenticated before they are lodged. Authentication attaches to the signed original and confirms the signature and seal on it, not the truth of what it says. A <a href="/net-worth-certificate">net worth certificate</a> for visa in Delhi is an accountant's dated statement of what an applicant or sponsor holds. It becomes a legalised document only once that original has been through the chain.</p>
<p>The consequence is an order of work rather than a different document. The figure is settled and the paper signed before it leaves, because a reprint issued afterwards carries none of the authentication. An authenticated certificate with a thin <a href="/glossary/networth/statement-of-affairs">statement of affairs</a> behind it is still just as thin as it was. Notarisation, where the appointed agency requires it, happens before the document leaves. A net worth certificate for visa in Delhi shows liquid holdings apart from property, so what could actually be moved is visible.</p>
                </div>
...
<p>The sample shows masked values in both currencies. What matters in Delhi is that this is the document that goes for authentication, so it is the signed original rather than a reprint. The sample separates liquid holdings from property, which is the distinction a mission uses when it asks whether fees can actually be met.</p>
...
<section class="content-section" id="who-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Chanakyapuri Embassy Submissions</h2>
            <div class="why-patron-grid is-4">
                <div><strong>The File Goes to Chanakyapuri</strong><p>The mission sits in the diplomatic enclave and takes submissions directly. Its checklist governs the file, and it is not the same as the checklist of the embassy next door.</p></div>
                <div><strong>The Destination Requires MEA Apostille</strong><p>Authentication comes before lodging, and it fastens to whichever paper was signed. So a Delhi file settles its figure early, and any correction made later means buying the legalisation twice.</p></div>
                <div><strong>An Attestation Route Applies Instead</strong><p>Some destinations outside the Hague Convention require embassy attestation rather than apostille. The sequence differs, and starting down the wrong one costs a reissue and a second wait.</p></div>
                <div><strong>A Study File Needs a Loan Sanction</strong><p>An education loan sanction and the funds evidence are being submitted together. Each has to be consistent with the other on amounts, on names and on dates.</p></div>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section" id="local-bodies-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <h2 class="section-title">Filing With Embassies in Chanakyapuri and Other Delhi Bodies</h2>
            <div class="content-text">
                <ul class="al-list">
                    <li><span class="al-t">Embassies in Chanakyapuri</span><span class="al-d">The diplomatic enclave holds embassies rather than consulates, which is the practical difference between a Delhi file and one lodged in another city. An embassy's jurisdiction is usually the widest of any mission a country keeps in India, and for several countries it takes in Haryana and much of the north.</span></li>
                    <li><span class="al-t">MEA apostille counter</span><span class="al-d">There is no public counter at the Ministry of External Affairs. The Ministry stopped accepting documents from applicants directly. Everything for apostille or attestation is lodged with and collected from one of four appointed agencies: BLS International, Superb Enterprises, IVS Global and Alhind Tours and Travels. The Ministry's own fee is Rs 50 a document. The agency charge is Rs 22 for a personal document, Rs 18 for an educational one and Rs 16 for a commercial one.</span></li>
                    <li><span class="al-t">Where documents can be lodged directly</span><span class="al-d">The Ministry's branch secretariats, which do take documents directly, are at Hyderabad, Chennai, Kolkata and Guwahati, and there is none in the north. So a Delhi file goes through an agency whether or not the applicant is standing in the same city as the Ministry.</span></li>
                    <li><span class="al-t">VFS Delhi</span><span class="al-d">The application centres in the city then take the pack for missions that outsource, and a document needing legalisation must be legalised before it is lodged. That order cannot be reversed afterwards.</span></li>
                </ul>
            </div>
        </div>
    </div>
...
<section class="content-section" id="usecase-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <h2 class="section-title">Chanakyapuri Embassy and MEA Apostille Files</h2>
            <div class="content-text">
                <ul class="al-list">
                    <li><span class="al-t">Apostille through the MEA</span><span class="al-d">Legalisation decides the order of work on a Delhi file, and getting the order wrong costs more than any other mistake. A certificate that will be apostilled has to be signed, and notarised where the agency requires it, before it is lodged, and the apostille attaches to that signed original. A reprint issued afterwards is a different document and carries nothing. The figure therefore has to be final before the paper leaves the office, so the position is settled first and the legalisation runs last.</span></li>
                    <li><span class="al-t">What an apostille does not do</span><span class="al-d">An apostille authenticates the signature and seal rather than the contents. It tells the receiving country that the person who signed holds the office claimed, and says nothing about whether the assets exist. Missions know that, which is why an apostilled certificate with a thin statement of affairs behind it does no better than an unapostilled one. The legalisation settles provenance and the evidence still has to be there.</span></li>
                    <li><span class="al-t">Student files</span><span class="al-d">Study files from the city are usually sponsored, and the sponsor is often self-employed. A business owner's worth is spread between a proprietary concern, property and deposits, and the mission is reading for whether the money can actually be moved when fees fall due. Liquid holdings are worth separating from the rest on the face of the statement, because a reader left to work out what is realisable will assume the worst. A sponsor drawing income from a firm also has to show the firm's position separately, because the two are not interchangeable. Where the fee will be met by selling something, saying what is to be sold is stronger than showing the asset and leaving the reader to guess.</span></li>
                    <li><span class="al-t">Chanakyapuri embassy submissions</span><span class="al-d">Visitor applications made from the city are frequently for a parent travelling to a child abroad. The applicant has retired, the income has stopped, and the worth sits in a house and in deposits. That is a strong position and a weak income statement at the same time, and the certificate is the document that shows the first. Naming what is held, where it is held and what is charged against it does more for that file than any amount of covering explanation.</span></li>
                </ul>
            </div>
        </div>
    </div>
...
<section class="content-section" id="services-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">What a Delhi Visa Engagement Includes</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Service</th><th>What&#x27;s included</th><th>Frequency</th></tr></thead>
                    <tbody>
                        <tr><td>Certificate sequenced for legalisation</td><td>The figure settled and the document signed before it leaves for authentication, because a reprint carries nothing.</td><td><span class="badge-included">Per application</span></td></tr>
                        <tr><td>Notarisation arranged where required</td><td>Where the agency handling the apostille requires a notarised original, that step is completed before lodging.</td><td><span class="badge-included">Where applicable</span></td></tr>
                        <tr><td>Liquid holdings shown separately</td><td>Deposits and readily realisable assets set apart from property, so what can be moved is visible.</td><td><span class="badge-included">Per application</span></td></tr>
                        <tr><td>Self-employed sponsor position certified</td><td>A proprietary concern's position and the sponsor's own separated, with the share held stated.</td><td><span class="badge-included">Where applicable</span></td></tr>
                        <tr><td>Retired applicant position stated</td><td>Where income has stopped, holdings and the charges against them are set out in place of an income statement.</td><td><span class="badge-included">Where applicable</span></td></tr>
                        <tr><td>Signed originals for collection</td><td>Collected from the office in the number the agency requires for authentication.</td><td><span class="badge-included">Per application</span></td></tr>
                        <tr><td>Destination format matched</td><td>Drawn to the destination's published requirement, and to whether it takes an apostille or asks for embassy attestation instead.</td><td><span class="badge-included">Per application</span></td></tr>
                        <tr><td>Student and education-loan files</td><td>Study applications where a self-employed sponsor is funding, with liquid holdings separated from property on the face of the statement.</td><td><span class="badge-included">Where a study application applies</span></td></tr>
                        <tr><td>Dual currency format</td><td>Both currencies on the signed original that goes for authentication, since a reprint issued afterwards carries none of it.</td><td><span class="badge-included">Per application</span></td></tr>
                    </tbody>
                </table>
                </div>
            </div>
...
<section class="steps-section" id="procedure-section">
    <div class="section-container">
        <header class="section-header" style="text-align:center;margin-bottom:48px;">
            ...
            <h2 class="section-title">From Papers to Signed Certificate, Timed to Your Delhi Appointment</h2>
  ...
  <div class="step-content">
    ...
    <h3 class="step-title">Delhi submission route established</h3>
    <p class="step-description">We establish where the file is going, which from Delhi means an embassy in the Chanakyapuri enclave, and what that route expects of a funds document. The destination decides the form of the certificate long before any balance is looked at.</p>
  </div>
  <div class="step-visual"><div class="step-illustration" style="padding:0;background:none;"><img src="/images/networth-cluster/net-worth-certificate-for-visa/delhi/step-1-delhi-submission-route-established-delhi.webp" alt="We establish where the file is going, which from Delhi means an embassy in the Chanakyapuri enclave" loading="lazy" width="1200" height="896" style="width:100%;height:auto;border-radius:var(--radius-xl);"></div></div>
</div>
            <div class="step-card">
  <div class="step-content">
  ...
  <div class="step-visual"><div class="step-illustration" style="padding:0;background:none;"><img src="/images/networth-cluster/net-worth-certificate-for-visa/delhi/step-4-dual-currency-figures-fixed-delhi.webp" alt="The total is shown in rupees and in the currency the mission works in, at a reference rate carrying its own date" loading="lazy" width="1200" height="896" style="width:100%;height:auto;border-radius:var(--radius-xl);"></div></div>
</div>
            <div class="step-card">
  <div class="step-content">
  ...
  <div class="step-visual"><div class="step-illustration" style="padding:0;background:none;"><img src="/images/networth-cluster/net-worth-certificate-for-visa/delhi/step-5-signed-in-final-form-delhi.webp" alt="A practising chartered accountant signs and generates the UDIN while the document is in its final state" loading="lazy" width="1200" height="896" style="width:100%;height:auto;border-radius:var(--radius-xl);"></div></div>
</div>
            <div class="step-card">
  <div class="step-content">
    <span class="step-badge">Step 6</span>
    <h3 class="step-title">Legalisation arranged from Delhi</h3>
    <p class="step-description">For a Hague Convention destination the signed original goes for MEA apostille; otherwise the longer chain ending in embassy attestation applies. From Delhi the sequence is worked backwards from the appointment already held.</p>
  </div>
  <div class="step-visual"><div class="step-illustration" style="padding:0;background:none;"><img src="/images/networth-cluster/net-worth-certificate-for-visa/delhi/step-6-legalisation-arranged-from-delhi-delhi.webp" alt="From Delhi the sequence is worked backwards from the appointment already held" loading="lazy" width="1200" height="896" style="width:100%;height:auto;border-radius:var(--radius-xl);"></div></div>
</div>
        </div>
    </div>
</section>
...
<section class="content-section" id="documents-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
<ul>
<li>The passport, and the destination's published requirement for legalisation</li>
<li>Confirmation of which appointed agency will lodge the document for apostille</li>
<li>A schedule separating liquid holdings from property, for the sponsor being certified</li>
<li>The sponsor's returns and, where self-employed, the concern's accounts alongside</li>
<li>The original in the number of copies the agency asks for, since a reprint carries nothing</li>
<li>Where notarisation is required first, the notary's requirements confirmed in advance</li>
</ul>
...
<section class="content-section" id="challenges-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Where Delhi Visa Files Get Held Up</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Challenge</th><th>Why it happens</th><th>How it is handled</th></tr></thead>
                    <tbody>
                        <tr><td>The document is signed in the wrong order</td><td>Authentication attaches to the original, and a figure corrected afterwards produces an unauthenticated reprint.</td><td>The position is settled first, the paper signed second, and legalisation last.</td></tr>
                        <tr><td>The agency wants a notarised original</td><td>Requirements differ between the appointed agencies and are discovered when the document is presented.</td><td>The requirement is confirmed before signing, and notarisation is completed as part of the same sitting.</td></tr>
                        <tr><td>The apostille is expected to do more</td><td>Authentication confirms a signature, and a thin statement behind it stays thin.</td><td>The statement of affairs is built to stand on its own, and the legalisation is treated as provenance rather than proof.</td></tr>
                        <tr><td>A retired applicant has no income to show</td><td>Income has stopped while worth sits in a house and in deposits.</td><td>Holdings and the charges against them are set out, with liquid items separated so what can be moved is visible.</td></tr>
                    </tbody>
                </table>
                </div>
            </div>
...
<section class="content-section" id="fees-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">What a Visa Certificate Costs Delhi Applicants</h2>
            <div class="content-text">
                ...
                <p style="margin-top:16px;"><strong>Get a free consultation &mdash; <a href="tel:+919459456700">Call +91 94594 56700</a> or <a href="https://wa.me/919459456700?text=Hi%20Patron%2C%20I%20need%20a%20net%20worth%20certificate%20for%20visa%20in%20delhi" target="_blank" rel="noopener">WhatsApp us</a>.</strong></p>
            </div>
        </div>
    </div>
</section>
...
<section class="why-choose-section" id="benefits-section">
    <div class="section-container">
        <div style="text-align:center;margin-bottom:48px;">
            ...
            <h2 class="section-title">Why a Delhi File Fails After the Apostille</h2>
        </div>
...
<article class="feature-card">
  ...
  <h3 class="feature-title">A Figure Changed After Signing</h3>
  <p class="feature-text">The apostille attaches to the signed original. A correction made afterwards produces a document carrying no authentication at all, and the legalisation then has to be bought and waited for a second time.</p>
</article>
<article class="feature-card">
  ...
  <h3 class="feature-title">Legalisation Attempted After Lodging</h3>
  <p class="feature-text">Authentication has to precede submission and the order cannot be reversed once the pack is in. A file lodged in the wrong sequence is returned rather than corrected, and the appointment goes with it.</p>
</article>
<article class="feature-card">
  ...
  <h3 class="feature-title">An Apostille Mistaken for Proof</h3>
  <p class="feature-text">Authentication confirms a signature and a seal, not that the assets exist. A thin statement of affairs sitting behind an apostilled certificate is exactly as thin as it was before the stamp was applied.</p>
</article>
<article class="feature-card">
  ...
  <h3 class="feature-title">Liquidity Left for the Reader to Find</h3>
  <p class="feature-text">A sponsor's worth spread across a business, property and deposits does not show what can be moved when fees fall due. A reader made to work that out will assume the least favourable reading of it.</p>
</article>
        </div>
    </div>
</section>
...
<section class="content-section" id="why-patron-section" style="background: var(--cream) !important;">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="why-patron-grid is-4">
                <div><strong>Originals issued in Delhi</strong><p>Signed originals are collected at the Rohini office, which matters when the document is going on to an appointed agency for apostille and a copy will not serve.</p></div>
                <div><strong>Sequenced for legalisation</strong><p>The figure is settled and the paper signed before it leaves, because authentication attaches to that original and a reprint made afterwards carries none of it.</p></div>
                <div><strong><a href="/glossary/networth/liquidity">Liquidity</a> shown separately</strong><p>A sponsor's deposits are set apart from property, so a mission can see what could actually be moved when fees fall due instead of inferring it.</p></div>
                <div><strong>Authenticated and still checkable</strong><p>The apostille confirms the signature; the UDIN confirms the signatory. Both are on the document, and neither is a substitute for the evidence behind it.</p></div>
            </div>
...
<section class="content-section" id="comparison-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <h2 class="section-title">When to Legalise, and Whether To</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
<table class="nwc-comparison"><thead><tr><th>Legalisation route</th><th>What it gives you</th><th>What it costs</th></tr></thead><tbody>
<tr><td>No legalisation</td><td>Fastest and cheapest, and correct for destinations that do not ask</td><td>Useless if the destination does require it, and discovered late</td></tr>
<tr><td>Apostille through an appointed agency</td><td>What convention countries accept, and the usual route from Delhi</td><td>Adds days, and attaches only to the signed original</td></tr>
<tr><td>Embassy attestation instead</td><td>Required for destinations outside the convention</td><td>Slower again, and the mission's own requirements govern</td></tr>
</tbody></table>
                </div>
<p class="nwc-verdict">Check the destination's published requirement before anything is signed. Legalising a document nobody asked to be legalised is money and days spent for no gain, and the reverse mistake costs the appointment.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section" id="tool-section" style="background-color:var(--blue-lighter);">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Settle the Figure Before Anything Is Signed</h2>
            <div class="content-text">
<p>Enter holdings and the destination currency and check the result carefully, because in Delhi the signed original is what goes for authentication. A figure corrected after signing means legalising again. The converter gives an estimate, not the certified number.</p>
...
<section class="content-section" id="legal-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Apostille Law Behind a Delhi Visa Certificate</h2>
            <div class="content-text">
                <p>Delhi is where the legalisation chain governs the order of work. A certificate destined for a country that is party to the apostille convention must be signed, sometimes notarised, and then authenticated, in that sequence and no other.</p>
                <p>The underlying evidence is governed by ordinary Indian law, and the certificate by the professional standard. Neither is displaced by the authentication that follows them.</p>
                <ul class="al-list">
                    <li><span class="al-t"><strong>Hague Convention Abolishing the Requirement of Legalisation for Foreign Public Documents 1961</strong></span><span class="al-d">provides the apostille that member states accept, which authenticates the signature and seal rather than the contents.</span></li>
                    <li><span class="al-t"><strong>Notaries Act 1952</strong></span><span class="al-d">governs the notarisation that several appointed agencies require before a document is accepted for authentication.</span></li>
                    <li><span class="al-t"><strong>Income-tax Act 1961, section 139</strong></span><span class="al-d">requires the return a self-employed sponsor's position is read against, alongside the concern's own accounts.</span></li>
                    <li><span class="al-t"><strong>Registration Act 1908, section 17</strong></span><span class="al-d">compels registration of the transfer, so property put forward behind a sponsorship is evidenced by what stands on the register.</span></li>
                    <li><span class="al-t"><strong>ICAI Guidance Note on Reports or Certificates for Special Purposes, Revised 2016</strong></span><span class="al-d">requires the certificate to state its basis, which matters more once the document has been authenticated and cannot be reissued.</span></li>
                </ul>
...
<section id="faq-section" class="content-section" style="background-color:#ffffff;">
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    <h2 class="faq-expanded__title">Delhi Visa Questions We Are Actually Asked</h2>
  ...
  <h3 class="faq-expanded__q">Why must the certificate be apostilled before some Chanakyapuri embassies accept it?</h3>
  <div class="faq-expanded__a"><p>Because a foreign authority cannot verify an Indian signature on its own. Apostille certifies the origin of the document under the 1961 Hague Convention, so the receiving country treats it as authentic without further checks. Missions in Chanakyapuri that require legalisation will not process a funds pack without it.</p></div>
</div>
                    <div class="faq-expanded__item">
  <h3 class="faq-expanded__q">Does apostille attach to the original or to a copy?</h3>
  <div class="faq-expanded__a"><p>To the document actually presented, which is why the signed original goes forward. A photocopy legalised after the fact is not the same document. Missions reject packs where the apostille sticker sits on a copy of a certificate whose original was never presented. The certificate is therefore signed in the form intended for legalisation.</p></div>
</div>
                    <div class="faq-expanded__item">
  <h3 class="faq-expanded__q">How long does the apostille step add to a Delhi visa timeline?</h3>
  <div class="faq-expanded__a"><p>Enough that it has to be planned, not squeezed in. The document is routed through an authorised collection channel to the Ministry of External Affairs and returns legalised. The round trip runs into days rather than hours. Applications that fail on timing usually did the certificate last instead of first.</p></div>
</div>
                    <div class="faq-expanded__item">
  <h3 class="faq-expanded__q">Which other documents go for legalisation alongside the certificate?</h3>
  <div class="faq-expanded__a"><p>Whatever the destination lists. Educational certificates, birth and marriage certificates and affidavits commonly travel with the funds pack. Several require state-level authentication before the Ministry of External Affairs will apostille them. Sending the net worth certificate alone, only to send a second batch later, is the avoidable delay.</p></div>
</div>
                    <div class="faq-expanded__item">
  <h3 class="faq-expanded__q">Does a notarised copy work where the embassy asks for legalisation?</h3>
  <div class="faq-expanded__a"><p>No. Notarisation attests a copy or a signature within India; legalisation makes the document acceptable to a foreign authority. Where an embassy in Delhi specifies apostille or consular attestation, a notarised copy is not a substitute and the pack is returned. The two steps are sometimes both required, in sequence.</p></div>
</div>
                    <div class="faq-expanded__item">
  <h3 class="faq-expanded__q">Is the education loan sanction letter legalised too?</h3>
  <div class="faq-expanded__a"><p>Only if the destination asks. Most missions accept a bank's <a href="/net-worth-certificate-for-bank-loan">sanction letter</a> in original with the funds pack, since the bank is identifiable and contactable. Where the country requires every supporting document legalised, the letter goes through the same route as the certificate. The bank is told in advance so the original is released.</p></div>
</div>
                    <div class="faq-expanded__item">
  <h3 class="faq-expanded__q">Can a certificate be re-signed if the apostille application is returned?</h3>
  <div class="faq-expanded__a"><p>Yes, and a fresh certificate carries a new date and a new UDIN. Returns usually turn on a formatting or authentication step rather than on the content, so the underlying work does not repeat. What cannot happen is a new signature on the old date, because the document states a position as at the date it was signed.</p></div>
</div>
                    <div class="faq-expanded__item">
  <h3 class="faq-expanded__q">Do all missions in Delhi require legalisation?</h3>
  <div class="faq-expanded__a"><p>No, and assuming they do adds cost. Several accept the signed original with UDIN verification, particularly for short-stay categories. Legalisation is more often demanded for immigration, study and long-stay routes. The mission's own document checklist is the operative source, since requirements differ between categories at the same embassy.</p></div>
</div>
                    <div class="faq-expanded__item">
  <h3 class="faq-expanded__q">Does the applicant have to appear in person with the original?</h3>
  <div class="faq-expanded__a"><p>It depends on the mission and the category. Some Delhi embassies require personal submission of originals at interview, others accept a courier or a visa centre lodgement. Where originals are handed over, a certified copy is retained by the applicant, because the certificate is the document the sponsor or bank may need again.</p></div>
</div>
                    <div class="faq-expanded__item">
  <h3 class="faq-expanded__q">What if the name on the passport differs from the name on the certificate?</h3>
  <div class="faq-expanded__a"><p>It is corrected before submission. Missions match names character by character. An expanded initial, a middle name or a maiden name appearing on one document but not the other is a standard ground for a query. The certificate is issued in the passport spelling, with any other name recorded as an alias.</p></div>
</div>
                </div>
            </div>
        </div>
...
<section class="content-section" style="background: var(--orange-lighter) !important; border-left: 4px solid var(--orange);">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Same-Day Certification for Delhi Appointments</h2>
            <div class="content-text">
<p>Delhi missions in the Chanakyapuri enclave publish their own funds expectations, and those differ from one another. Reading the wrong checklist costs an appointment rather than merely a redraft. Confirm which applies before anything is drafted. Call or WhatsApp <a href="tel:+919459456700">+91 94594 56700</a> with the mission and the date you are working to.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section" style="background: var(--blue) !important;">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title" style="color:#FFFFFF !important;">Start Your Delhi Visa Certificate</h2>
            <div class="content-text" style="text-align:left;">
<p style="color:rgba(255,255,255,0.88);">From Delhi most files go to a mission in the Chanakyapuri enclave, and each publishes its own expectations of a funds document. A file assembled to a general template is the one that comes back. Read your destination&#x27;s checklist before anything is drafted, because that is what decides the form. Tell us the mission and the appointment you hold, and we will build the sequence around it.</p>
            </div>
            <div style="display:flex;gap:14px;flex-wrap:wrap;margin-top:24px;">
                ...
                <a href="https://wa.me/919459456700?text=Hi%20Patron%2C%20I%20need%20a%20net%20worth%20certificate%20for%20visa%20in%20delhi" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:#25D366;color:#fff;border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;">&#128172; WhatsApp Us</a>
                <a href="mailto:sales@patronaccounting.com?subject=Enquiry%20for%20a%20Net%20Worth%20Certificate%20for%20Visa%20in%20Delhi&body=Hello%20Patron%20Accounting%20Team%2C%0A%0AI%20need%20a%20net%20worth%20certificate%20for%20visa%20in%20delhi%20and%20would%20like%20to%20know%20more.%0A%0AThank%20you." style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:transparent;color:#fff;border:2px solid rgba(255,255,255,0.3);border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;">&#9993;&#65039; Email Us</a>
            </div>
...
<p>Patron Accounting LLP works from Sector 5 at Rohini. Signed originals are collected from this address, which matters when a document is going on to an agency for apostille and a copy will not serve. Passports, bank statements and sponsor papers can be brought here in person.</p>
