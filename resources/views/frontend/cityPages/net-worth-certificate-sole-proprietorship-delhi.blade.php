        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'net-worth-certificate-sole-proprietorship/delhi',
                    'options'  => [
                        'net-worth-certificate-sole-proprietorship/delhi' => 'Net Worth Certificate for Sole Proprietorship in Delhi',
