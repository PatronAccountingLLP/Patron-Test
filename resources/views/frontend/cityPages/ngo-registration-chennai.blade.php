...
@section('meta')
    ...
    <meta property="og:image" content="/images/ngo-registration/chennai-og.webp">
    ...
    <meta name="twitter:image" content="/images/ngo-registration/chennai-og.webp">
@endsection
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20NGO%20registration%20in%20Chennai.%20Please%20share%20details." target="_blank" class="btn-sample text-decoration-none">
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - NGO Registration in Chennai'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="ngo-registration/chennai" selected>NGO Registration in Chennai</option><option value="gst-registration/chennai">GST Registration in Chennai</option><option value="income-tax-return/chennai">Income Tax Return Filing in Chennai</option><option value="startup-registration/chennai">Startup Registration in Chennai</option><option value="private-limited-company-registration/chennai">Private Limited Company Registration in Chennai</option><option value="trademark-registration/chennai">Trademark Registration in Chennai</option><option value="accounting-services/chennai">Accounting Services in Chennai</option><option value="other">Other</option>
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    ...
                    @include('partials.faq-enquiry-form', ['enquiryLocation' => 'Chennai', 'enquiryService' => 'NGO Registration in Chennai'])
                </aside>
