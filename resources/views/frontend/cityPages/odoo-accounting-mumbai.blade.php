...
@section('meta')
    ...
    <meta property="og:image" content="/images/odoo-accounting/mumbai-og.webp">
    ...
    <meta name="twitter:image" content="/images/odoo-accounting/mumbai-og.webp">
@endsection
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - Odoo Accounting in Mumbai'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="odoo-accounting/mumbai" selected>Odoo Accounting in Mumbai</option><option value="zoho-books-accounting">Zoho Books Accounting</option><option value="tally-accounting">Tally Accounting</option><option value="accounting-services/mumbai">Accounting Services in Mumbai</option><option value="gst-registration/mumbai">GST Registration in Mumbai</option><option value="tds-return-filing">TDS Returns</option><option value="other">Other</option>
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    ...
                    @include('partials.faq-enquiry-form', ['enquiryLocation' => 'Mumbai', 'enquiryService' => 'Odoo Accounting in Mumbai'])
                </aside>
