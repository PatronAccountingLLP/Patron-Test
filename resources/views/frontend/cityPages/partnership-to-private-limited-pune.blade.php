...
@section('schema')
    ...
    {"@context":"https://schema.org","@type":"Service","@id":"/partnership-to-private-limited/pune/#service","name":"Partnership to Private Limited Conversion in Pune","description":"Professional partnership firm to Pvt Ltd conversion services for Pune businesses. Covers partner consent, capital-to-shareholding structuring, name reservation, newspaper advertisement in Pune English and Marathi dailies, Form URC-1 and SPICe+ filing, MOA and AOA drafting, tax-neutral conversion planning under S.47(xiii), Registrar of Firms dissolution, and post-conversion compliance setup.","provider":{"@id":"/#organization"},"areaServed":{"@type":"City","name":"Pune","sameAs":"https://en.wikipedia.org/wiki/Pune"},"serviceType":"Partnership to Private Limited Conversion","url":"/partnership-to-private-limited/pune"},

    {"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"/"},{"@type":"ListItem","position":2,"name":"Partnership to Private Limited","item":"/partnership-to-private-limited"},{"@type":"ListItem","position":3,"name":"Partnership to Pvt Ltd in Pune","item":"/partnership-to-private-limited/pune"}]},
    ...
    {"@context":"https://schema.org","@type":"WebPage","@id":"/partnership-to-private-limited/pune","name":"Partnership to Private Limited in Pune 2026 | CA & CS | Patron Accounting","description":"CA and CS assisted partnership to Pvt Ltd conversion in Pune. URC-1, SPICe+, newspaper ad, ROC approval, fresh COI, auto-transfer. Family businesses, Camp traders, MIDC manufacturers. Call +91 945 945 6700.","url":"/partnership-to-private-limited/pune","inLanguage":"en-IN","isPartOf":{"@id":"/#website"},"author":{"@id":"/#team"},
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20help%20with%20Partnership%20to%20Private%20Limited%20Conversion%20in%20Pune.%20Please%20share%20details." target="_blank" class="btn-sample text-decoration-none">
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - Partnership to Private Limited in Pune'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="partnership-to-private-limited/pune" selected>Partnership to Pvt Ltd in Pune</option>
                                <option value="pvt-ltd-company-compliance/pune">Pvt Ltd Compliance in Pune</option>
...
<section class="testimonials-section">
    <div class="section-container">
        ...
        -->
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;"><div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div><div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Our 30-year-old textile trading partnership at Camp converted to Pvt Ltd through Patron. The capital-to-shareholding mapping for 3 brothers was handled sensitively. The newspaper ad, URC-1, SPICe+ - everything was coordinated. We now have limited liability and our bank immediately improved our credit terms.</div><div style="display:flex;align-items:center;gap:10px;margin-top:16px;"><div style="width:36px;height:36px;border-radius:50%;background:var(--orange);display:flex;align-items:center;justify-content:center;font-weight:700;font-size:13px;color:#fff;flex-shrink:0;">RD</div><div><div style="font-weight:700;font-size:13px;color:var(--blue);">Rajesh Deshpande</div><div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Director, Trading Company - Camp</div><div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div></div><div style="margin-left:auto;font-size:11px;color:var(--text-muted);">1 month ago</div></div></div>
<div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;"><div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div><div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Our MIDC Bhosari manufacturing partnership needed to convert for an OEM vendor registration. Patron structured the conversion as tax-neutral under Section 47(xiii), saving us significant capital gains on our factory and machinery. The entire process took 55 days and all contracts transferred seamlessly.</div><div style="display:flex;align-items:center;gap:10px;margin-top:16px;"><div style="width:36px;height:36px;border-radius:50%;background:var(--blue);display:flex;align-items:center;justify-content:center;font-weight:700;font-size:13px;color:#fff;flex-shrink:0;">AK</div><div><div style="font-weight:700;font-size:13px;color:var(--blue);">Anil Kulkarni</div><div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Director, Manufacturing - MIDC Bhosari</div><div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div></div><div style="margin-left:auto;font-size:11px;color:var(--text-muted);">2 months ago</div></div></div>
<div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;"><div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div><div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">An angel investor wanted to put Rs 50 lakh into our consumer brand but we were a partnership. Patron converted us to Pvt Ltd, structured the share allotment, and the investment closed within 2 months of starting the conversion. They also set up our first-year compliance calendar so we never missed a deadline.</div><div style="display:flex;align-items:center;gap:10px;margin-top:16px;"><div style="width:36px;height:36px;border-radius:50%;background:#0D9488;display:flex;align-items:center;justify-content:center;font-weight:700;font-size:13px;color:#fff;flex-shrink:0;">SP</div><div><div style="font-weight:700;font-size:13px;color:var(--blue);">Sneha Patil</div><div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Director, Consumer Brand - Deccan</div><div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div></div><div style="margin-left:auto;font-size:11px;color:var(--text-muted);">3 months ago</div></div></div>
<div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;"><div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div><div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Our Viman Nagar jewellery partnership was unregistered for 20 years. Patron prepared the deed, gathered all evidence, and converted us directly to Pvt Ltd in one step. My son is now a director and shareholder. The succession plan is in place. Worth every rupee of the professional fee.</div><div style="display:flex;align-items:center;gap:10px;margin-top:16px;"><div style="width:36px;height:36px;border-radius:50%;background:#7C3AED;display:flex;align-items:center;justify-content:center;font-weight:700;font-size:13px;color:#fff;flex-shrink:0;">MJ</div><div><div style="font-weight:700;font-size:13px;color:var(--blue);">Mohan Joshi</div><div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Director, Jewellery - Viman Nagar</div><div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div></div><div style="margin-left:auto;font-size:11px;color:var(--text-muted);">4 months ago</div></div></div>
    </div>
        <div class="reviews-cta" style="margin-top: 16px; display: flex !important;">
            <div class="reviews-cta-content">
                ...
                <div class="reviews-cta-text">
                    ...
                    <p>From Camp trading families to MIDC manufacturers, Pune partnerships trust Patron for seamless Pvt Ltd conversion.</p>
                </div>
            </div>
...
<tr><td>Government Fees</td><td>URC-1/SPICe+ filing fee (based on authorised capital Rs 2,000-50,000) + Maharashtra stamp duty on MOA/AOA + DIN Rs 500/director</td></tr>
                ...
                <p style="margin-top:16px;"><strong>Get a free Partnership to Private Limited in Pune consultation - <a href="tel:+919459456700">Call +91 945 945 6700</a> or <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20help%20with%20Partnership%20to%20Private%20Limited%20Conversion%20in%20Pune.%20Please%20share%20details." target="_blank">WhatsApp us</a>. No-obligation assessment.</strong></p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    ...
                    @include('partials.faq-enquiry-form', ['enquiryLocation' => 'Pune', 'enquiryService' => 'Partnership to Private Limited in Pune'])
                </aside>
...
<p style="color:rgba(255,255,255,0.9);font-size:16px;line-height:1.8;">With 15+ years of experience, 10,000+ businesses served, and a 4.9 Google rating, Patron Accounting LLP is a trusted CA and CS firm for corporate compliance across Pune, Mumbai, Delhi, and Gurugram.</p>
            ...
            <div style="display:flex;gap:14px;flex-wrap:wrap;margin-top:24px;">
                ...
                <a href="mailto:sales@patronaccounting.com?subject=Enquiry%20for%20Partnership%20to%20Pvt%20Ltd%20in%20Pune&body=Hello%20Patron%20Accounting%20Team%2C%0A%0AI%20need%20help%20with%20partnership%20to%20private%20limited%20conversion%20in%20Pune.%0A%0AThank%20you." style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:transparent;color:#fff;border:2px solid rgba(255,255,255,0.3);border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#9993;&#65039; Email Us</a>
            </div>
...
<section class="content-section" style="padding:48px 32px;background:var(--gray-50);">
    <div class="content-container">
       ...
       <div class="pa-city-block" style="margin-bottom:40px;"><div class="pa-city-grid">
        ...
        <a href="/partnership-to-private-limited/mumbai" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Mumbai</div><div class="pa-card-sub">Maharashtra</div></div></a>
        <a href="/partnership-to-private-limited/delhi" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Delhi</div><div class="pa-card-sub">Delhi NCR</div></div></a>
         <a href="/partnership-to-private-limited/gurugram" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Gurugram</div><div class="pa-card-sub">Haryana</div></div></a>
    </div></div>
