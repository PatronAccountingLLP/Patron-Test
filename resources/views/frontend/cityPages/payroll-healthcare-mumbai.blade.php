        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'payroll-healthcare/mumbai',
                    'options'  => [
                        'payroll-healthcare/mumbai' => 'Healthcare Payroll in Mumbai',
                        'payroll-services' => 'Payroll Services',
                        'healthcare-accounting-services/mumbai' => 'Healthcare Accounting in Mumbai',
