...
@section('meta')
    ...
    <link rel="canonical" href="/payroll-hospitality/mumbai">
    ...
    <meta property="og:url" content="/payroll-hospitality/mumbai">
    <meta property="og:type" content="website">
    <meta property="og:site_name" content="Patron Accounting">
    <meta property="og:image" content="/images/payroll-hospitality/mumbai-og.webp">
    ...
    <meta name="twitter:image" content="/images/payroll-hospitality/mumbai-og.webp">
@endsection
  ...
  "@graph": [
    {
      ...
      "url": "/payroll-hospitality/mumbai",
    ...
    },
    {
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "item": "https://www.patronaccounting.com/payroll-hospitality"
        },
        {
          "@type": "ListItem",
          "position": 3,
          "name": "Hotel & Restaurant Accounting in Mumbai - POS, OTA & GST",
          "item": "https://www.patronaccounting.com/payroll-hospitality/mumbai"
        }
      ]
    },
    {
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20hospitality%20payroll%20services%20in%20Mumbai.%20Please%20call%20me." target="_blank" class="btn-sample text-decoration-none">
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - Hospitality Payroll in Mumbai'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="payroll-hospitality/mumbai" selected>Hospitality Payroll in Mumbai</option><option value="payroll-services">Payroll Services</option><option value="accounting-services/mumbai">Accounting Services in Mumbai</option><option value="gst-registration/mumbai">GST Registration in Mumbai</option><option value="tds-return-filing">TDS Returns</option><option value="fssai-registration/mumbai">FSSAI Registration in Mumbai</option><option value="other">Other</option>
...
<section class="testimonials-section">
    <div class="section-container">
        ...
        -->
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;"><div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div><div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Our 5-star hotel has 800 staff across 12 departments with 3 shifts. Patron processes department-wise shift payroll, computes night allowance and overtime automatically from duty rosters, and manages our tip pool and 10% service charge distribution with full TDS trail. The perquisite valuation for staff meals and accommodation is correctly computed for each category. Our outlet-wise labour cost MIS is ready by the 10th.</div><div style="display:flex;align-items:center;gap:10px;margin-top:16px;"><div style="width:36px;height:36px;border-radius:50%;background:var(--orange);display:flex;align-items:center;justify-content:center;font-weight:700;font-size:13px;color:#fff;flex-shrink:0;">GM</div><div><div style="font-weight:700;font-size:13px;color:var(--blue);">General Manager</div><div style="font-size:12px;color:var(--text-muted);margin-top:2px;">5-Star Hotel, South Mumbai</div><div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div></div><div style="margin-left:auto;font-size:11px;color:var(--text-muted);">1 month ago</div></div></div><div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;"><div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div><div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Our restaurant chain operates 15 outlets across Mumbai. The previous payroll provider treated all outlets as one entity - we had no visibility into per-outlet labour cost. Patron processes outlet-wise: each has its own shift roster, tip pool, and PF/ESI. Staff transfers between outlets don't disrupt PF. Our labour cost as % of revenue per outlet is now a monthly management metric. Service charge TDS is properly documented for every outlet.</div><div style="display:flex;align-items:center;gap:10px;margin-top:16px;"><div style="width:36px;height:36px;border-radius:50%;background:var(--blue);display:flex;align-items:center;justify-content:center;font-weight:700;font-size:13px;color:#fff;flex-shrink:0;">FD</div><div><div style="font-weight:700;font-size:13px;color:var(--blue);">Finance Director</div><div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Restaurant Chain, Mumbai</div><div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div></div><div style="margin-left:auto;font-size:11px;color:var(--text-muted);">2 months ago</div></div></div><div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;"><div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div><div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Our bar-restaurant in Lower Parel has 45 staff with Maharashtra Excise FL-III licence. Patron maintains the bar staff records for excise inspection, processes split-shift payroll for servers (lunch + dinner), computes overtime correctly when we're short-staffed on weekends, and handles our 8% service charge distribution with TDS. The Maharashtra S&amp;E registers are always inspector-ready. When a labour complaint came last year, every record was in order.</div><div style="display:flex;align-items:center;gap:10px;margin-top:16px;"><div style="width:36px;height:36px;border-radius:50%;background:#0D9488;display:flex;align-items:center;justify-content:center;font-weight:700;font-size:13px;color:#fff;flex-shrink:0;">OW</div><div><div style="font-weight:700;font-size:13px;color:var(--blue);">Owner</div><div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Bar-Restaurant, Lower Parel</div><div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div></div><div style="margin-left:auto;font-size:11px;color:var(--text-muted);">3 months ago</div></div></div><div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;"><div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div><div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Wedding season is chaos for our banquet operation: 80 extra staff in November-February, then back to 30 regular. Patron handles rapid onboarding of daily-wage event staff with PF assessment, processes pro-rata wages for each event engagement, and settles F&amp;F within 10 days of engagement end. The regular staff shift payroll runs smoothly alongside. Our FSSAI food handler training compliance is tracked as part of the payroll workflow.</div><div style="display:flex;align-items:center;gap:10px;margin-top:16px;"><div style="width:36px;height:36px;border-radius:50%;background:#7C3AED;display:flex;align-items:center;justify-content:center;font-weight:700;font-size:13px;color:#fff;flex-shrink:0;">MD</div><div><div style="font-weight:700;font-size:13px;color:var(--blue);">Managing Director</div><div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Banquet &amp; Catering, Andheri</div><div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div></div><div style="margin-left:auto;font-size:11px;color:var(--text-muted);">2 months ago</div></div></div>
    </div>
        <div class="reviews-cta" style="margin-top: 16px; display: flex !important;">
            <div class="reviews-cta-content">
                ...
                <div class="reviews-cta-text">
                    ...
                    <p>CA-led hospitality payroll with shifts, tips, service charge, perquisites, PF/ESI, and excise compliance for Mumbai hotels and restaurants.</p>
                </div>
            </div>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p style="margin-top:16px;"><strong>Get a free Hospitality Payroll in Mumbai consultation - <a href="tel:+919459456700">Call +91 945 945 6700</a> or <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20hospitality%20payroll%20in%20Mumbai.%20Please%20call%20me." target="_blank">WhatsApp us</a>. No-obligation assessment.</strong></p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    ...
                    @include('partials.faq-enquiry-form', ['enquiryLocation' => 'Mumbai', 'enquiryService' => 'Hospitality Payroll in Mumbai'])
                </aside>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div style="display:flex;gap:14px;flex-wrap:wrap;margin-top:24px;">
                ...
                <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20hospitality%20payroll%20in%20Mumbai.%20Please%20call%20me." target="_blank" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:#25D366;color:#fff;border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#128172; WhatsApp Us</a>
                <a href="mailto:sales@patronaccounting.com?subject=Enquiry%20for%20Hospitality%20Payroll%20Mumbai&body=Hello%20Patron%20Accounting%20Team%2C%0A%0AI%20need%20hospitality%20payroll%20services%20in%20Mumbai.%0A%0APlease%20get%20in%20touch.%0A%0AThank%20you." style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:transparent;color:#fff;border:2px solid rgba(255,255,255,0.3);border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#9993;&#65039; Email Us</a>
            </div>
