  ...
  "@graph": [
    {
      ...
      "url": "/payroll-processing-services-for-education-industry/pune",
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20education%20payroll%20services%20in%20Pune.%20Please%20share%20details." target="_blank" class="btn-sample text-decoration-none">
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - Payroll for Schools &amp; Colleges in Pune'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="payroll-processing-services-for-education-industry/pune" selected>Education Payroll in Pune</option><option value="payroll-services/pune">Payroll Services in Pune</option><option value="accounting-services/pune">Accounting Services in Pune</option><option value="gst-registration/pune">GST Registration in Pune</option><option value="gst-return-filing/pune">GST Return Filing in Pune</option><option value="private-limited-company-registration/pune">Pvt Ltd Registration in Pune</option><option value="trademark-registration/pune">Trademark Registration in Pune</option><option value="startup-registration/pune">Startup Registration in Pune</option><option value="other">Other</option>
        ...
        <div class="reviews-cta" style="margin-top: 16px; display: flex !important;">
            <div class="reviews-cta-content">
                ...
                <div class="reviews-cta-text">
                    ...
                    <p>Get CA-managed education payroll, EPF/ESIC compliance, and statutory audit support for your Pune institution.</p>
                </div>
            </div>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p style="margin-top:16px;"><strong>Get a free Payroll for Schools &amp; Colleges in Pune consultation - <a href="tel:+919459456700">Call +91 945 945 6700</a> or <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20school%20payroll%20in%20Pune.%20Please%20share%20a%20quote." target="_blank">WhatsApp us</a>. No-obligation assessment.</strong></p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    ...
                    @include('partials.faq-enquiry-form', ['enquiryLocation' => 'Pune', 'enquiryService' => 'Education Payroll in Pune'])
                </aside>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>Late EPF deposits attract 12% p.a. interest plus damages up to 100% of arrears under the EPF Act. Late ESIC: 12% p.a. interest. TDS non-deduction costs 1.5% per month under Section 201(1A). Maharashtra PT late payment: 1.25% per month. If your Pune school or college is processing payroll manually or through a non-specialist provider, get a payroll compliance audit done before the next quarterly TDS filing deadline.</p><p><strong>Call +91 945 945 6700 today or <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20school%20payroll%20in%20Pune" target="_blank">WhatsApp us</a> to protect your institution from compliance risk.</strong></p>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div style="display:flex;gap:14px;flex-wrap:wrap;margin-top:24px;">
                ...
                <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20school%20payroll%20in%20Pune.%20Please%20share%20a%20quote." target="_blank" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:#25D366;color:#fff;border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#128172; WhatsApp Us</a>
                <a href="mailto:sales@patronaccounting.com?subject=Enquiry%20for%20Education%20Payroll%20in%20Pune&body=Hello%20Patron%2C%0AI%20need%20education%20payroll%20services%20in%20Pune.%0AThank%20you." style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:transparent;color:#fff;border:2px solid rgba(255,255,255,0.3);border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#9993;&#65039; Email Us</a>
            </div>
