...
@section('meta')
    ...
    <meta property="og:image" content="/images/payroll-services/delhi-og.webp">
    ...
    <meta name="twitter:image" content="/images/payroll-services/delhi-og.webp">
@endsection
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20help%20with%20Payroll%20Services%20in%20Delhi.%20Please%20call%20me." target="_blank" class="btn-sample text-decoration-none">
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <iframe name='hidden208810000001209168Frame' id='hidden208810000001209168Frame' style='display:none;' src='about:blank'></iframe>
                        ...
                        'deal' => 'Website Enquiry - Payroll Services in Delhi',
                        'options' => [
                            ['value' => '', 'label' => 'Select a service', 'selected' => true, 'disabled' => true],
                            ['value' => 'payroll-services/delhi', 'label' => 'Payroll Services in Delhi', 'selected' => true, 'disabled' => false],
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    ...
                    @include('partials.faq-enquiry-form', ['enquiryLocation' => 'Delhi', 'enquiryService' => 'Payroll Services in Delhi'])
                </aside>
