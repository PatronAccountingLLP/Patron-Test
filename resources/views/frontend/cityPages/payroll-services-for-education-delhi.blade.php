...
@section('meta')
    ...
    <meta name="description" content="CA-led school and college payroll in Delhi. 7th CPC salary, PF/ESI, TDS, visiting faculty. DSEA Section 10 compliant. Serving Dwarka, Rohini, Civil Lines.">
...
@section('schema')
    @include('partials.city-localbusiness', ['citySlug' => 'delhi', 'pageUrl' => '/payroll-services-for-education/delhi'])
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <p class="mb-4 text-muted city-parent-link">
                        ...
                        <a href="/payroll-services-for-education">Payroll Services for Education Sector</a> page.
                    </p>
