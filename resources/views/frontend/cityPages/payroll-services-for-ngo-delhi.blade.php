...
@section('meta')
    ...
    <link rel="canonical" href="/payroll-services-for-ngo/delhi">
    ...
    <meta property="og:url" content="/payroll-services-for-ngo/delhi">
    <meta property="og:type" content="website">
    <meta property="og:site_name" content="Patron Accounting">
    <meta property="og:image" content="/images/payroll-services-for-ngo/delhi-og.webp">
    ...
    <meta name="twitter:image" content="/images/payroll-services-for-ngo/delhi-og.webp">
@endsection
  ...
  "@graph": [
    {
      ...
      "url": "/payroll-services-for-ngo/delhi",
    ...
    },
    {
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "item": "https://www.patronaccounting.com/payroll-services-for-ngo"
        },
        {
          "@type": "ListItem",
          "position": 3,
          "name": "NGO & Non-Profit Accounting in Delhi - Bookkeeping & Audit",
          "item": "https://www.patronaccounting.com/payroll-services-for-ngo/delhi"
        }
      ]
    },
    {
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - NGO Payroll in Delhi'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="payroll-services-for-ngo/delhi" selected>NGO Payroll in Delhi</option><option value="payroll-processing-and-management-services/delhi">Payroll Processing in Delhi</option><option value="ngo-and-non-profit-accounting-services/delhi">NGO Accounting in Delhi</option><option value="statutory-audit/delhi">Statutory Audit in Delhi</option><option value="accounting-services/delhi">Accounting Services in Delhi</option><option value="income-tax-return/delhi">Income Tax Return in Delhi</option><option value="gst-registration/delhi">GST Registration in Delhi</option><option value="other">Other</option>
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    ...
                    @include('partials.faq-enquiry-form', ['enquiryLocation' => 'Delhi', 'enquiryService' => 'NGO Payroll in Delhi'])
                </aside>
