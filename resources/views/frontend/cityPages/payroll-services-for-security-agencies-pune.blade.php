...
@section('meta')
    ...
    <meta property="og:image" content="/images/payroll-services-for-security-agencies-pune-og.webp">
    ...
    <meta name="twitter:image" content="/images/payroll-services-for-security-agencies-pune-og.webp">
@endsection
  ...
  "@graph": [
    {
      ...
      "url": "/payroll-services-for-security-agencies/pune",
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20security%20agency%20payroll%20services%20in%20Pune.%20Please%20share%20details." target="_blank" class="btn-sample text-decoration-none">
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - Security Agency Payroll in Pune'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="payroll-services-for-security-agencies/pune" selected>Security Agency Payroll in Pune</option><option value="payroll-services/pune">Payroll Services in Pune</option><option value="accounting-services/pune">Accounting Services in Pune</option><option value="gst-registration/pune">GST Registration in Pune</option><option value="gst-return-filing/pune">GST Return Filing in Pune</option><option value="startup-registration/pune">Startup Registration in Pune</option><option value="private-limited-company-registration/pune">Pvt Ltd Registration in Pune</option><option value="other">Other</option>
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    ...
                    @include('partials.faq-enquiry-form', ['enquiryLocation' => 'Pune', 'enquiryService' => 'Security Agency Payroll in Pune'])
                </aside>
