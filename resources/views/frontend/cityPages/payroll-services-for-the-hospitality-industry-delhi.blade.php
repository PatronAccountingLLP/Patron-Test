...
@section('meta')
    ...
    <meta property="og:image" content="/images/payroll-services-for-the-hospitality-industry/delhi-og.webp">
    ...
    <meta name="twitter:image" content="/images/payroll-services-for-the-hospitality-industry/delhi-og.webp">
@endsection
  ...
  "@graph": [
    {
      ...
      "url": "/payroll-services-for-the-hospitality-industry/delhi",
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20hospitality%20payroll%20in%20Delhi." target="_blank" class="btn-sample text-decoration-none">
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - Hospitality Payroll in Delhi'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="payroll-services-for-the-hospitality-industry/delhi" selected>Hospitality Payroll in Delhi</option><option value="payroll-processing-and-management-services/delhi">Payroll Processing in Delhi</option><option value="hospitality-sector-accounting-services/delhi">Hospitality Accounting in Delhi</option><option value="statutory-audit/delhi">Statutory Audit in Delhi</option><option value="accounting-services/delhi">Accounting Services in Delhi</option><option value="gst-registration/delhi">GST Registration in Delhi</option><option value="income-tax-return/delhi">Income Tax Return in Delhi</option><option value="other">Other</option>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p style="margin-top:16px;"><strong>Get a free Hospitality Payroll in Delhi consultation - <a href="tel:+919459456700">Call +91 945 945 6700</a> or <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20hospitality%20payroll%20in%20Delhi." target="_blank">WhatsApp us</a>. No-obligation assessment.</strong></p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    ...
                    @include('partials.faq-enquiry-form', ['enquiryLocation' => 'Delhi', 'enquiryService' => 'Hospitality Payroll in Delhi'])
                </aside>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>PF/ESI by 15th. TDS by 7th. Service charge CCPA ruling. 50% basic in effect. EPFO inspects hotels during wedding season. Perquisite not valued = IT demand. High turnover PF chaos. From Rs 5,000/month.</p><p><strong><a href="tel:+919459456700">Call +91 945 945 6700</a> or <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20hospitality%20payroll%20in%20Delhi." target="_blank">WhatsApp us</a>.</strong></p>
