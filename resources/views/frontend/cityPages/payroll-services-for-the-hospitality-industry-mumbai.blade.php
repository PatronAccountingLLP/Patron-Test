...
@section('schema')
    @include('partials.city-localbusiness', ['citySlug' => 'mumbai', 'pageUrl' => '/payroll-services-for-the-hospitality-industry/mumbai'])
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <p class="mb-4 text-muted city-parent-link">
                        ...
                        <a href="/payroll-services-for-the-hospitality-industry">Hospitality Payroll Services</a> page.
                    </p>
