...
@section('meta')
    ...
    <meta property="og:image" content="/images/payroll-services-for-travel-and-logistics-industry-pune-og.webp">
    ...
    <meta name="twitter:image" content="/images/payroll-services-for-travel-and-logistics-industry-pune-og.webp">
@endsection
  ...
  "@graph": [
    {
      ...
      "url": "/payroll-services-for-travel-and-logistics-industry/pune",
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - Logistics Payroll in Pune'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="payroll-services-for-travel-and-logistics-industry/pune" selected>Logistics Payroll in Pune</option><option value="payroll-services/pune">Payroll Services in Pune</option><option value="accounting-services/pune">Accounting Services in Pune</option><option value="gst-registration/pune">GST Registration in Pune</option><option value="gst-return-filing/pune">GST Return Filing in Pune</option><option value="startup-registration/pune">Startup Registration in Pune</option><option value="private-limited-company-registration/pune">Pvt Ltd Registration in Pune</option><option value="other">Other</option>
