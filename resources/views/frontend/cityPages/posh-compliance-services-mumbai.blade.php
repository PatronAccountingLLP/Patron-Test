...
@section('meta')
    ...
    <meta property="og:image" content="/images/posh-compliance-mumbai-og.webp">
    ...
    <meta name="twitter:image" content="/images/posh-compliance-mumbai-og.webp">
@endsection
  ...
  "@graph": [
    {
      ...
      "url": "/posh-compliance-services/mumbai",
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="posh-compliance/mumbai" selected>POSH Compliance in Mumbai</option>
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    ...
                    @include('partials.faq-enquiry-form', ['enquiryLocation' => 'Mumbai', 'enquiryService' => 'POSH Compliance in Mumbai'])
                </aside>
