...
@section('meta')
    ...
    <meta name="description" content="CA-assisted Pvt Ltd company registration in Pune via SPICe+. PAN, TAN, GST, PTEC included. Serving Hinjewadi, Kharadi, Chakan MIDC startups.">
...
@section('schema')
    @include('partials.city-localbusiness', ['citySlug' => 'pune', 'pageUrl' => '/private-limited-company-registration/pune'])
