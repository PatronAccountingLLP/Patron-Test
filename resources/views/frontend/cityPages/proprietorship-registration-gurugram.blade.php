...
@section('meta')
    ...
    <meta property="og:image" content="/images/proprietorship-registration/gurugram-og.webp">
    ...
    <meta name="twitter:image" content="/images/proprietorship-registration/gurugram-og.webp">
@endsection
  ...
  "@graph": [
    {
      ...
      "url": "/proprietorship-registration/gurugram",
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - Proprietorship Setup'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="proprietorship-registration/gurugram" selected>Proprietorship Gurugram</option><option value="private-limited-company-registration/gurugram">Pvt Ltd Registration in Gurugram</option><option value="income-tax-return/gurugram">Income Tax Return in Gurugram</option><option value="gst-registration/gurugram">GST Registration in Gurugram</option><option value="startup-registration/gurugram">Startup Registration in Gurugram</option><option value="trademark-registration/gurugram">Trademark Registration in Gurugram</option><option value="payroll-services/gurugram">Payroll Services in Gurugram</option><option value="other">Other</option>
        ...
        <div class="reviews-cta" style="margin-top: 16px; display: flex !important;">
            <div class="reviews-cta-content">
                ...
                <div class="reviews-cta-text">
                    ...
                    <p>Get GST, Udyam, Shops Act, and S44AD tax optimization for your Gurugram sole proprietorship.</p>
                </div>
            </div>
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    ...
                    @include('partials.faq-enquiry-form', ['enquiryLocation' => 'Gurugram', 'enquiryService' => 'Proprietorship in Gurugram'])
                </aside>
