...
@section('meta')
    ...
    <meta property="og:image" content="/images/proprietorship-registration-pune-og.webp">
    ...
    <meta name="twitter:image" content="/images/proprietorship-registration-pune-og.webp">
@endsection
  ...
  "@graph": [
    {
      ...
      "url": "/proprietorship-registration/pune",
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20proprietorship%20registration%20in%20Pune.%20Please%20share%20details." target="_blank" class="btn-sample text-decoration-none">
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - Proprietorship Registration in Pune'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="proprietorship-registration/pune" selected>Proprietorship Registration in Pune</option><option value="company-registration/pune">Company Registration in Pune</option><option value="llp-registration/pune">LLP Registration in Pune</option><option value="gst-registration/pune">GST Registration in Pune</option><option value="accounting-services/pune">Accounting Services in Pune</option><option value="income-tax-filing/pune">Income Tax Filing in Pune</option><option value="startup-registration/pune">Startup Registration in Pune</option><option value="other">Other</option>
        ...
        <div class="reviews-cta" style="margin-top: 16px; display: flex !important;">
            <div class="reviews-cta-content">
                ...
                <div class="reviews-cta-text">
                    ...
                    <p>Get CA-assisted proprietorship registration with Gumasta, MSME Udyam, GST, and bank account setup from Patron's Pune office.</p>
                </div>
            </div>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p style="margin-top:16px;"><strong>Get a free Proprietorship Registration in Pune consultation - <a href="tel:+919459456700">Call +91 945 945 6700</a> or <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20to%20register%20a%20proprietorship%20in%20Pune.%20Please%20share%20a%20quote." target="_blank">WhatsApp us</a>. No-obligation assessment.</strong></p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>Operating without Gumasta risks Rs 50,000 PMC penalty. Crossing GST threshold without registration triggers retrospective tax with 18% interest. Without MSME Udyam, you miss priority lending and government schemes. Without a current bank account, personal and business finances are mixed creating tax complications. Patron's bundled registration takes 7-10 days and establishes your complete legal identity.</p><p><strong>Call +91 945 945 6700 today or <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20proprietorship%20registration%20in%20Pune" target="_blank">WhatsApp us</a> to get started.</strong></p>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div style="display:flex;gap:14px;flex-wrap:wrap;margin-top:24px;">
                ...
                <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20to%20register%20a%20proprietorship%20in%20Pune.%20Please%20share%20a%20quote." target="_blank" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:#25D366;color:#fff;border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#128172; WhatsApp Us</a>
                <a href="mailto:sales@patronaccounting.com?subject=Enquiry%20for%20Proprietorship%20Registration%20in%20Pune&body=Hello%20Patron%2C%0AI%20need%20proprietorship%20registration%20in%20Pune.%0AThank%20you." style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:transparent;color:#fff;border:2px solid rgba(255,255,255,0.3);border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#9993;&#65039; Email Us</a>
            </div>
