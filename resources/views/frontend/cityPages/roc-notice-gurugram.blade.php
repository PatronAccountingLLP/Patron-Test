...
@section('meta')
    ...
    <meta property="og:image" content="/images/roc-notice-gurugram-og.webp">
    ...
    <meta name="twitter:image" content="/images/roc-notice-gurugram-og.webp">
@endsection
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-4 private-registration-heading">
                        ROC Notice in Gurugram: Professional Response to MCA Penalties, Strike-Off, and Defaults
                    </h1>
                    ...
                    <div class="mb-4">
                        <div class="d-flex align-items-start mb-3">
                            ...
                            <p class="mb-0 text-dark benefit-paragraph"><span>Documents:</span> ROC notice copy, company CIN, director DINs, pending financial statements, board resolutions</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Fees:</span> S454 response: Rs 10,000-25,000. Strike-off: Rs 15,000-30,000. Default filing: Rs 5,000-10,000/form</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Eligibility:</span> All companies and LLPs in Gurugram/Haryana that have received or want to prevent ROC notices</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Timeline:</span> Response: 15-30 days. Default filing: immediate. DIN reactivation: 7-10 days</p>
                        </div>
                    </div>
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="mailto:sales@patronaccounting.com?subject=Enquiry%20for%20ROC%20Notice%20in%20Gurugram&body=Hello%20Patron%20Accounting%20Team%2C%0A%0AI%20am%20interested%20in%20your%20ROC%20Notice%20services%20in%20Gurugram%20and%20would%20like%20to%20know%20more.%0A%0APlease%20get%20in%20touch%20with%20me%20at%20your%20earliest%20convenience.%0A%0AThank%20you." class="btn-sample text-decoration-none">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:18px;height:18px;"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,12 2,6"/></svg>
                            Email Us
                        </a>
                        <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20help%20with%20ROC%20Notice%20in%20Gurugram.%20Please%20share%20details." target="_blank" class="btn-sample text-decoration-none">
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <iframe name='hidden208810000001209168Frame' id='hidden208810000001209168Frame' style='display:none;' src='about:blank'></iframe>
                        ...
                        'deal' => 'Website Enquiry - ROC Notice Gurugram',
                        'city' => 'Gurugram',
                        'options' => [
                            ['value' => '', 'label' => 'Select a service', 'selected' => false, 'disabled' => true],
                            ['value' => 'roc-notice/gurugram', 'label' => 'ROC Notice in Gurugram', 'selected' => true, 'disabled' => false],
                            ['value' => 'annual-compliance', 'label' => 'Annual Compliance', 'selected' => false, 'disabled' => false],
...
<section class="testimonials-section">
    <div class="section-container">
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            ...
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">STK-5 notice for our dormant startup. Patron filed 3 years of pending AOC-4 and MGT-7, responded to ROC Haryana within 15 days. Company saved from strike-off. DINs active. Now they handle annual compliance.</div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">S454 penalty notice for Rs 2 lakh. Patron analysed, filed defence, attended hearing at ROC Haryana. Penalty reduced to Rs 40,000. Professional representation made the difference.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div>
                    ...
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Director, IT Company, DLF Cyber City</div>
                    <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                </div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">DIR-3 KYC not filed for 2 years. DIN deactivated. Could not sign any company filings. Patron filed KYC, paid Rs 10,000 fees, DIN reactivated in 8 days. Critical unblock.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div>
                    ...
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Director, Multiple Companies, Gurugram</div>
                    <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                </div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Company struck off 2 years ago. Founder wanted to restart. Patron filed NCLT restoration application, cleared all defaults, paid penalties. Company restored in 4 months. Back in business.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div>
                    ...
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Former Director, Restored Company, Sohna Road</div>
                    <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                </div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Manufacturing company with DPT-3 issues. Patron classified all transactions, filed DPT-3, and resolved before ROC could issue formal notice. Preventive compliance saved us from potential Rs 10 crore exposure.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div>
                    ...
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">CFO, Manufacturing, Manesar</div>
                    <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                </div>
        ...
        <div class="reviews-cta" style="margin-top: 16px; display: flex !important;">
            <div class="reviews-cta-content">
                ...
                <div class="reviews-cta-text">
                    ...
                    <p>Trusted ROC notice response partner for companies across Gurugram.</p>
                </div>
            </div>
...
<div class="stats-bar">
    <div class="stats-container">
        <div class="stat-item">
            ...
            <div class="stat-content"><span class="stat-value">10,000+</span><span class="stat-label">Businesses Served</span><span class="stat-desc">ROC notice response and MCA compliance across India.</span></div>
        </div>
        <div class="stat-item">
            <div class="stat-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8M12 17v4"/></svg></div>
            <div class="stat-content"><span class="stat-value">15+</span><span class="stat-label">Years Experience</span><span class="stat-desc">Deep expertise in ROC notices, S454 penalties, strike-off, and MCA compliance.</span></div>
        </div>
        <div class="stat-item">
            <div class="stat-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><path d="M14 2v6h6M16 13H8M16 17H8"/></svg></div>
            <div class="stat-content"><span class="stat-value">50,000+</span><span class="stat-label">Documents Filed</span><span class="stat-desc">ROC notice responses, default filings, and MCA compliance documents handled.</span></div>
        </div>
        <div class="stat-item">
            <div class="stat-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="8" r="7"/><path d="M8.21 13.89L7 23l5-3 5 3-1.21-9.12"/></svg></div>
            <div class="stat-content"><span class="stat-value">4.9&#9733;</span><span class="stat-label">Client Rating</span><span class="stat-desc">Trusted by companies, directors, startups, and LLPs across Gurugram.</span></div>
        </div>
...
<section class="content-section" id="overview-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Why ROC Notice Response Matters in Gurugram</h2>
            <div class="content-text">
                <div class="highlight-box" style="margin-bottom:20px;">
                    <p><strong>&#128204; TL;DR - ROC Notice Response Services at a Glance</strong></p>
                    <p>Gurugram companies now fall under ROC Haryana, Chandigarh (from 16 February 2026). ROC notices issued for non-compliance: AOC-4/MGT-7 defaults (Rs 100/day no cap), DIR-3 KYC (Rs 5,000 + DIN deactivation), DPT-3, strike-off (STK-5/STK-7), and S454 adjudication penalties (expanded Feb 2026). Response window 15-30 days. Failure to respond = penalties, DIN deactivation, director disqualification, and company strike-off.</p>
                </div>
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Parameter</th><th>Detail</th></tr></thead>
                    <tbody>
                        <tr><td>Governing Law</td><td>Companies Act 2013 | LLP Act 2008 | S454, S248, S164(2), S73/74</td></tr>
                        <tr><td>Registry</td><td>Copyright Office, DPIIT (<a href="https://mca.gov.in" target="_blank" rel="noopener">MCA Portal (mca.gov.in)</a>). Registrar of Copyrights</td></tr>
                        <tr><td>Form</td><td>AOC-4 (financials) | MGT-7 (annual return) | DIR-3 KYC | DPT-3 | STK-5/STK-7 (strike-off)</td></tr>
                ...
                <p>Gurugram has thousands of registered companies. Startups on Golf Course Road that never filed returns face strike-off. IT directors in DLF Cyber City who changed jobs without DIR-3 KYC face DIN deactivation. Manesar manufacturers with deposit issues face DPT-3 notices. For comprehensive information about <a href="/roc-notice">ROC notice services across India</a>, visit our national service page.</p>
                <p>ROC Haryana exercising expanded S454 powers since Feb 2026. Strike-off under STK-5 leads to company dissolution + 5-year director disqualification. AOC-4/MGT-7 penalties accumulate at Rs 100/day with no cap. Respond immediately. You will also need <a href="#">annual compliance</a> and <a href="#">company registration</a> services for complete MCA compliance.</p>
        ...
        <div class="two-column">
            <div class="column-content">
                ...
                <div class="content-text what-is-definition">
                    <p>An ROC notice is a formal communication from the Registrar of Companies under the Companies Act 2013 for non-compliance with statutory filing, corporate governance, or regulatory obligations. For Gurugram companies, notices now originate from ROC Haryana at Chandigarh (since 16 February 2026).</p>
                    <p>Notice types: compliance default (AOC-4/MGT-7), Section 454 penalty (direct adjudication), strike-off (STK-5/STK-7), show cause, DIR-3 KYC, and DPT-3. Each has specific response process, deadline, and escalation path.</p>
                    <p>Most common triggers: startups that never filed returns, directors who forgot DIR-3 KYC, and companies with deposit issues. For complete MCA compliance, pair with <a href="#">annual compliance</a> and <a href="#">company registration</a>.</p>
                </div>
                <div class="highlight-box" style="margin-top:20px;">
                    <p><strong>Key Terms for Copyright Registration:</strong></p>
                    <ul>
                        <li><strong>Section 454</strong> - ROC adjudication penalty (expanded Feb 2026)</li>
                        <li><strong>STK-5</strong> - Strike-off notice under Section 248</li>
                        <li><strong>AOC-4/MGT-7</strong> - Annual filing forms (financial statements / annual return)</li>
                        <li><strong>DIR-3 KYC</strong> - Annual director KYC by 30 September</li>
                        <li><strong>ROC Haryana</strong> - New ROC at Chandigarh for Gurugram companies</li>
                    </ul>
                </div>
            </div>
            <div class="column-image">
                <div class="illustration-placeholder">
                    ...
                    <div class="illustration-badge">
                        <span>ROC Haryana / MCA</span>
                        <strong>Notice Defence</strong>
                    </div>
                </div>
            </div>
        </div>
...
<section class="content-section" id="who-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Who Receives ROC Notices in Gurugram</h2>
            <div class="content-text">
                <ul>
                    <li><strong>IT companies in DLF Cyber City</strong> receiving AOC-4/MGT-7 default notices or S454 penalty orders. Directors changing jobs without DIR-3 KYC face DIN deactivation.</li>
                    <li><strong>Dormant startups on Golf Course Road and Sohna Road</strong> incorporated during 2018-2023 boom. No returns filed. STK-5 strike-off notices. Founder DINs disqualified.</li>
                    ...
                    <li><strong>Companies with multi-year defaults</strong>. 3-5 years of unfiled AOC-4/MGT-7. Accumulated penalties Rs 100/day per form. Rs 2+ lakh in additional fees. Director disqualification risk.</li>
...
<section class="content-section" id="services-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">8 ROC Notice Response Services Included</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Service</th><th>What We Do</th></tr></thead>
                    <tbody>
                        <tr><td>Section 454 Penalty Response</td><td>Defence against ROC adjudication. Written reply. Hearing representation. Penalty mitigation. 15-30 days.</td></tr>
                        <tr><td>Strike-Off Response (STK-5/STK-6)</td><td>Response to company removal notice. Pending return filing. Compliance restoration. 30-day deadline.</td></tr>
                        <tr><td>AOC-4/MGT-7 Default Filing</td><td>Filing pending financial statements and annual returns with additional fees. Clearing years of defaults.</td></tr>
                        <tr><td>DIR-3 KYC and DIN Reactivation</td><td>Filing DIR-3 KYC. Rs 5,000 fee. DIN reactivation. Unblocking director from all company filings.</td></tr>
                        <tr><td>DPT-3 Compliance</td><td>Return of deposits filing. Section 73/74 compliance. Penalty up to Rs 10 crore prevention.</td></tr>
                        <tr><td>Company Restoration and Prevention</td><td>NCLT application for struck-off companies. Ongoing compliance calendar. Annual filing management.</td></tr>
...
<section class="steps-section" id="procedure-section">
    <div class="section-container">
        <header class="section-header" style="text-align:center;margin-bottom:48px;">
            ...
            <h2 class="section-title">How ROC Notice Response Works: 5-Step Process</h2>
            <p class="section-subtitle" style="text-align:left;max-width:100%;">Our CA/CS team handles ROC notice identification, S454 defence, strike-off response, default filing, DIN reactivation, and ROC Haryana representation for Gurugram companies.</p>
        </header>
        <div class="steps-container">
            <div class="step-card">
                <div class="step-content">
                    <span class="step-badge">Step 1</span>
                    <h3 class="step-title">Identify Notice Type and Deadline</h3>
                    <p class="step-description">S454 penalty, STK-5 strike-off, AOC-4/MGT-7 default, DIR-3 KYC, or DPT-3. Note response deadline. Assess penalty exposure.</p>
                    <div class="step-highlights">
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Identified</span>
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Deadline</span>
                    </div>
                </div>
                <div class="step-visual">
                    <div class="step-illustration">
                        ...
                        <span class="illustration-label">Noticed</span>
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">File All Pending Returns</h3>
                    <p class="step-description">File overdue AOC-4, MGT-7, DIR-3 KYC, DPT-3 with additional fees on MCA portal. Clear defaults before responding.</p>
                    <div class="step-highlights">
                ...
                <div class="step-visual">
                    <div class="step-illustration">
                        ...
                        <span class="illustration-label">Defaults OK</span>
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">Draft and File Response</h3>
                    <p class="step-description">Address every allegation. Attach compliance evidence and filed return receipts. File on MCA portal within deadline.</p>
                    <div class="step-highlights">
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Responded</span>
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <p class="step-description">Personal hearing before ROC Haryana. Present defence with documents. Seek penalty reduction. Adjournment if needed.</p>
                    <div class="step-highlights">
                ...
                <div class="step-visual">
                    <div class="step-illustration">
                        ...
                        <span class="illustration-label">Presented</span>
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">Receive Order and Evaluate</h3>
                    <p class="step-description">If adverse: appeal to Regional Director NR-II or NCLT. If favourable: implement. Pay any penalty ordered.</p>
                    <div class="step-highlights">
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Order</span>
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Evaluated</span>
                    </div>
                </div>
                <div class="step-visual">
                    <div class="step-illustration">
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">Restore and Prevent</h3>
                    <p class="step-description">All returns filed. Penalties paid. DINs active. Annual compliance calendar set. Prevention strategy implemented.</p>
                    <div class="step-highlights">
                ...
                <div class="step-visual">
                    <div class="step-illustration">
                        ...
                        <span class="illustration-label">Restored</span>
        ...
        <div class="highlight-box" style="margin-top:32px;max-width:1000px;margin-left:auto;margin-right:auto;">
            <p><strong>City Processing Note:</strong> Patron's Gurugram office handles ROC notice response, default filing, and compliance restoration for companies across Gurugram.</p>
        </div>
    </div>
</section>
...
<section class="content-section" id="documents-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Documents Required for ROC Notice Response</h2>
            <div class="content-text">
                <ul>
                    <li><strong>ROC Notice Copy:</strong> Complete notice with all pages. Note form number, section, and deadline.</li>
                    <li><strong>Company Documents:</strong> CIN, MOA/AOA, director DINs, registered office proof, board resolutions.</li>
                    <li><strong>Pending Returns:</strong> Financial statements (AOC-4), annual returns (MGT-7), DIR-3 KYC data, DPT-3 details.</li>
                    <li><strong>Additional:</strong> Previous ROC correspondence | DSC of directors | Audited accounts | Board minutes.</li>
                </ul>
            </div>
        </div>
    </div>
...
<section class="content-section" id="challenges-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">5 Common ROC Notice Challenges in Gurugram</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Challenge</th><th>Impact</th><th>How Patron Accounting Solves It</th></tr></thead>
                    <tbody>
                        <tr><td>ROC Delhi to Haryana Transition</td><td>Migration creates confusion. Notices from ROC Delhi pre-Feb 2026 now handled by ROC Haryana. Verify filing authority</td><td>Contact roc.haryana@mca.gov.in. Pending matters being transferred. Verify before filing response.</td></tr>
                        <tr><td>Dormant Startup Strike-Off</td><td>Thousands of startups incorporated but never filed returns. STK-5 after 2 years of non-filing. DIN disqualified</td><td>File pending returns immediately. Respond to STK-5 within 30 days. Prevent dissolution and director disqualification.</td></tr>
                        <tr><td>DIN Deactivation Cascade</td><td>Director changed jobs without DIR-3 KYC. DIN deactivated. Blocks filings at old AND new companies</td><td>File DIR-3 KYC with Rs 5,000. Wait for reactivation. File for all companies where director holds position.</td></tr>
                        <tr><td>Multi-Year Accumulated Penalties</td><td>3-5 years of unfiled AOC-4 and MGT-7. Rs 100/day per form. No cap. Penalties exceed Rs 2 lakh easily</td><td>File all pending returns with additional fees. Set up annual compliance calendar. Prevention costs fraction of penalties.</td></tr>
                        <tr><td>DPT-3 Non-Filing Risk</td><td>Deposits received without filing DPT-3. Penalties up to Rs 10 crore or 2x deposit. NCLT jurisdiction</td><td>File DPT-3 immediately. Classify all transactions. Some may be exempt. Professional analysis reduces exposure.</td></tr>
                    </tbody>
                </table>
                </div>
            </div>
...
<section class="content-section" id="fees-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">ROC Notice Response Fees in Gurugram 2026</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table class="table-amount">
                    <thead><tr><th>Fee Component</th><th>Amount</th></tr></thead>
                    <tbody>
                        <tr><td>Section 454 Penalty Response</td><td>Rs 10,000-25,000</td></tr>
                        <tr><td>Strike-Off Response (STK-5/STK-6)</td><td>Rs 15,000-30,000</td></tr>
                        <tr><td>AOC-4/MGT-7 Default Filing (per form)</td><td>Rs 5,000-10,000 + govt additional fees</td></tr>
                        <tr><td>DIR-3 KYC + DIN Reactivation</td><td>Rs 3,000-5,000 + Rs 5,000 govt fee</td></tr>
                        <tr><td>DPT-3 Compliance</td><td>Rs 10,000-20,000</td></tr>
                        <tr><td>Company Restoration (NCLT)</td><td>Rs 25,000-50,000 + NCLT fees</td></tr>
                        <tr><td>Patron Accounting Professional Fees</td><td>INR 5,000 (Exl GST and Govt. Charges)</td></tr>
                    </tbody>
                </table>
                </div>
                <p style="margin-top:16px;font-size:13px;color:var(--text-muted);font-style:italic;">All fees and charges listed are indicative only and do not constitute a binding offer. Final amounts may vary depending on the volume of work and the complexity involved.</p>
                <p style="margin-top:16px;">Government additional fees (Rs 100/day per form) are separate. Professional fees cover notice analysis, reply drafting, hearing representation, and compliance restoration.</p>
                <p style="margin-top:16px;"><strong>Get a free Copyright Registration consultation - <a href="tel:+919459456700">Call +91 945 945 6700</a> or <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20help%20with%20ROC%20Notice%20in%20Gurugram.%20Please%20share%20fee%20details." target="_blank">WhatsApp us</a>. No-obligation assessment.</strong></p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <table>
                    ...
                    <tbody>
                        <tr><td>Notice Analysis</td><td>1-2 days</td></tr>
                        <tr><td>Default Filing</td><td>3-10 days (depends on years of default)</td></tr>
                        <tr><td>S454 Response</td><td>Within 15-30 days of notice</td></tr>
                        <tr><td>STK-5 Response</td><td>Within 30 days of publication</td></tr>
                        <tr><td>DIR-3 KYC Reactivation</td><td>7-10 working days</td></tr>
                        <tr><td>Company Restoration (NCLT)</td><td>3-6 months</td></tr>
                        <tr><td>Ongoing Compliance</td><td>Annual calendar setup + monitoring</td></tr>
                    </tbody>
                </table>
                </div>
                <div class="highlight-box" style="margin-top:16px;">
                    <p><strong>Note:</strong> Response deadline 15-30 days. Default filing: immediate. DIN reactivation: 7-10 days. Company restoration: 3-6 months via NCLT.</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="why-choose-section" id="benefits-section">
    <div class="section-container">
        <div style="text-align:center;margin-bottom:48px;">
            ...
            <h2 class="section-title">Why Choose Patron for ROC Notices in Gurugram</h2>
        </div>
        <div class="features-grid">
            <article class="feature-card">
                ...
                <h3 class="feature-title">S454 Defence</h3>
                <p class="feature-text">Penalty response. Written defence. Hearing representation. Mitigation arguments. ROC Haryana proceedings.</p>
            </article>
            <article class="feature-card">
                ...
                <h3 class="feature-title">Strike-Off Response</h3>
                <p class="feature-text">STK-5/STK-7 response within 30 days. Pending returns filed. Compliance restored. Company saved from dissolution.</p>
            </article>
            <article class="feature-card">
                ...
                <h3 class="feature-title">Default Filing</h3>
                <p class="feature-text">AOC-4, MGT-7, DIR-3 KYC, DPT-3 with additional fees. Multi-year defaults cleared. Penalty calculation and payment.</p>
            </article>
            <article class="feature-card">
                <div class="feature-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg></div>
                <h3 class="feature-title">DIN Reactivation</h3>
                <p class="feature-text">DIR-3 KYC filed. Rs 5,000 paid. DIN reactivated. All company filings unblocked. 7-10 working days.</p>
            </article>
            <article class="feature-card">
                ...
                <h3 class="feature-title">Company Restoration</h3>
                <p class="feature-text">NCLT application under S252 for struck-off companies. All returns filed. Penalties paid. Full restoration.</p>
            </article>
            <article class="feature-card">
                ...
                <h3 class="feature-title">Annual Prevention</h3>
                <p class="feature-text">Compliance calendar. Automated reminders. AOC-4/MGT-7/DIR-3 KYC filed on time. Zero ROC notices.</p>
            </article>
        </div>
    </div>
</section>
...
<section class="content-section" id="comparison-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">ROC Penalty Structure for Gurugram Companies</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table class="table-comparison">
                    <thead><tr><th>Default</th><th>Penalty / Authority / Legal Provision</th></tr></thead>
                    <tbody>
                        <tr><td>AOC-4/MGT-7 late</td><td>Rs 100/day per form, no cap. ROC Haryana. Companies Act S137/S92</td></tr>
                        <tr><td>DIR-3 KYC late</td><td>Rs 5,000 per director + DIN deactivation. MCA Portal. S153</td></tr>
                        <tr><td>DPT-3 non-filing</td><td>Up to Rs 10 crore or 2x deposit. ROC/NCLT. S73/74</td></tr>
                        <tr><td>S454 penalty</td><td>As per adjudication order. ROC Haryana direct. S454</td></tr>
                        <tr><td>Strike-off (STK-5)</td><td>Company dissolved + directors disqualified 5 years. ROC. S248</td></tr>
                        <tr><td>Director disqualification</td><td>5-year bar from all directorships. Automatic. S164(2)</td></tr>
                    </tbody>
                </table>
                </div>
                <p style="margin-top:12px;">External Authority: <a href="https://mca.gov.in" target="_blank" rel="noopener">ROC Haryana, Chandigarh (mca.gov.in)</a></p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                <ul>
                    ...
                    <li><a href="#">Annual Compliance</a> - AOC-4, MGT-7, DIR-3 KYC annual filing to prevent ROC notices</li>
...
<section class="content-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>ROC notices are governed by the <strong>Companies Act 2013</strong> and <strong>LLP Act 2008</strong>. <strong>Section 454</strong>: adjudication penalties. <strong>Section 248</strong>: strike-off. <strong>Section 164(2)</strong>: director disqualification. <strong>Section 73/74</strong>: deposit provisions (DPT-3).</p>
                <p>Filing defaults: <strong>Rs 100/day per form, no cap</strong>. DIR-3 KYC: <strong>Rs 5,000 + DIN deactivation</strong>. DPT-3: <strong>up to Rs 10 crore</strong>. Strike-off: <strong>company dissolved + 5-year disqualification</strong>. Restoration via <strong>NCLT Section 252</strong>.</p>
                <p>India's membership in the Berne Convention (1886, India joined 1928), the Universal Copyright Convention, and TRIPS (WTO) ensures international recognition. The WIPO Copyright Treaty (WCT) and WIPO Performances and Phonograms Treaty (WPPT) provide additional protections for digital rights. Copyright registration with the Copyright Office at <a href="https://mca.gov.in" target="_blank" rel="noopener">MCA Portal (mca.gov.in)</a> is administered by the Department for Promotion of Industry and Internal Trade (DPIIT). IP enforcement in Gurugram falls under the jurisdiction of the Delhi High Court.</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    <h2 class="faq-expanded__title">FAQs - ROC Notice in Gurugram</h2>
                    <p class="faq-expanded__lead">Answers to common questions about ROC notices including S454 penalties, strike-off, default filing, DIR-3 KYC, and company restoration for Gurugram companies.</p>
                    @include('partials.faq-enquiry-form', ['enquiryLocation' => 'Gurugram', 'enquiryService' => 'ROC Notice in Gurugram'])
                </aside>
                <div class="faq-expanded__list">
                    <div class="faq-expanded__item" id="faq-1">
                        <h3 class="faq-expanded__q">What should I do when I receive an ROC notice?</h3>
                        <div class="faq-expanded__a"><p>Identify the notice type (S454 penalty, STK-5 strike-off, AOC-4/MGT-7 default, DIR-3 KYC). Note the response deadline (typically 15-30 days). File all pending returns immediately on the MCA portal. Engage a CA/CS for professional response. Never ignore an ROC notice - non-response leads to penalties, DIN deactivation, or company strike-off.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-2">
                        <h3 class="faq-expanded__q">How much does ROC notice response cost?</h3>
                        <div class="faq-expanded__a"><p>S454 penalty response Rs 10,000-25,000. Strike-off response Rs 15,000-30,000. Default filing Rs 5,000-10,000 per form plus government additional fees (Rs 100/day). DIR-3 KYC Rs 3,000-5,000 plus Rs 5,000 govt fee. Company restoration Rs 25,000-50,000. Call +91 945 945 6700.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-3">
                        <h3 class="faq-expanded__q">Which ROC handles Gurugram companies now?</h3>
                        <div class="faq-expanded__a"><p>Total timeline: 2-6 months. Filing and Diary Number: immediate. Mandatory 30-day objection waiting period: 1 month. Receive Order and Evaluate: 1-3 months. Certificate issuance: after examination approval. If a third-party objection is filed, the timeline extends by 2-4 months for hearing and resolution.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-4">
                        <h3 class="faq-expanded__q">What happens if a strike-off notice is ignored?</h3>
                        <div class="faq-expanded__a"><p>The company name is removed from the Register of Companies and the company is dissolved. All directors are automatically disqualified under Section 164(2) for 5 years, meaning they cannot serve as directors in any company in India. Company assets vest in the government. Restoration requires an NCLT application under Section 252.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-5">
                        <h3 class="faq-expanded__q">What is Section 454 penalty?</h3>
                        <div class="faq-expanded__a"><p>Section 454 gives the ROC power to directly adjudicate and impose penalties for minor company law violations without going through NCLT. This power was significantly expanded in February 2026. ROC Haryana can now issue penalty orders through a streamlined process with a 15-30 day response window. Professional defence can significantly reduce the penalty amount.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-6">
                        <h3 class="faq-expanded__q">What are penalties for not filing AOC-4 and MGT-7?</h3>
                        <div class="faq-expanded__a"><p>Additional fee of Rs 100 per day per form with no cap, accruing from the due date until filing. Three years of default on both AOC-4 and MGT-7 can exceed Rs 2 lakh in additional fees alone. Directors may face disqualification under Section 164(2) if defaults continue for 3 consecutive years. The company also risks strike-off proceedings under Section 248.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-7">
                        <h3 class="faq-expanded__q">Can a struck-off company be restored?</h3>
                        <div class="faq-expanded__a"><p>Yes. A struck-off company can be restored through an NCLT application under Section 252 of the Companies Act 2013. The application must be filed within 20 years of the strike-off. All pending annual returns must be filed, all penalties paid, and proper grounds for restoration demonstrated. The process typically takes 3-6 months and costs Rs 25,000-50,000 in professional fees plus NCLT filing fees.</p></div>
                    </div>
                </div>
            </div>
            ...
            <div class="highlight-box" style="margin-top:32px;">
                ...
                <p><strong>ROC notice aaya - kya karun?</strong> Type identify karo. Deadline note karo (15-30 din). Pending returns file karo. CA/CS se turant contact karo. Ignore mat karo.</p>
                <p><strong>Gurugram ka ROC kahan hai?</strong> 16 Feb 2026 se ROC Haryana, Chandigarh. Pehle ROC Delhi tha. Email: roc.haryana@mca.gov.in.</p>
                <p><strong>Strike-off ignore karne se?</strong> Company ka naam hat jaata hai. Directors 5 saal ke liye disqualify. Kisi bhi company mein director nahi ban sakte.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section" style="background: var(--orange-lighter) !important; border-left: 4px solid var(--orange);">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Why ROC Notice Response Matters in Gurugram</h2>
            <div class="content-text">
                <p>ROC notices have strict 15-30 day deadlines. ROC Haryana exercising expanded S454 powers since Feb 2026. Strike-off = company dissolved + directors disqualified 5 years. AOC-4/MGT-7 penalties Rs 100/day no cap. DPT-3 defaults up to Rs 10 crore. ROC Delhi transition creates fresh enforcement focus on Haryana companies. Respond immediately, file all pending returns, secure professional representation.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section" style="background: var(--blue) !important;">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title" style="color:#FFFFFF !important;">Respond to Your ROC Notice in Gurugram Today</h2>
            <div class="content-text" style="text-align:left;">
                <p style="color:rgba(255,255,255,0.85);">ROC notice response in Gurugram requires prompt, accurate action within strict deadlines. With ROC Haryana at Chandigarh (Feb 2026), expanded S454 powers, and MCA's tightened enforcement, every Gurugram company must treat ROC notices as urgent compliance matters.</p>
                <p style="color:rgba(255,255,255,0.85);">Patron Accounting's Gurugram office on Golf Course Extension Road handles S454 penalty defence, strike-off response, default filing, DIN reactivation, DPT-3 compliance, and ROC Haryana representation for companies across Gurugram.</p>
            ...
            <div style="display:flex;gap:14px;flex-wrap:wrap;margin-top:24px;">
                ...
                <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20help%20with%20ROC%20Notice%20in%20Gurugram.%20Please%20share%20details." target="_blank" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:#25D366;color:#fff;border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#128172; WhatsApp Us</a>
                <a href="mailto:sales@patronaccounting.com?subject=Enquiry%20for%20ROC%20Notice%20in%20Gurugram&body=Hello%20Patron%20Accounting%20Team%2C%0A%0AI%20am%20interested%20in%20your%20ROC%20Notice%20services%20in%20Gurugram%20and%20would%20like%20to%20know%20more.%0A%0APlease%20get%20in%20touch%20with%20me%20at%20your%20earliest%20convenience.%0A%0AThank%20you." style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:transparent;color:#fff;border:2px solid rgba(255,255,255,0.3);border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#9993;&#65039; Email Us</a>
            </div>
...
<section class="content-section" style="padding:48px 32px;background:var(--gray-50);">
    <div class="content-container">
        <div class="text-content">
            ...
            <p style="text-align:center;color:var(--text-muted);font-size:15px;margin-bottom:40px;">ROC notice response services available across India with local office support.</p>
            ...
            <div class="pa-city-block" style="margin-bottom:40px;">
                <div class="pa-city-grid">
                    ...
                    <a href="/roc-notice/mumbai" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Mumbai</div><div class="pa-card-sub">Maharashtra</div></div></a>
            ...
            <div class="pa-city-block">
                ...
                <div class="pa-block-sub">End-to-end support for ROC Notice in Gurugram</div>
...
<section class="content-section" style="padding:32px;">
    <div class="content-container">
        <div class="text-content" style="font-size:13px;color:var(--text-muted);">
            ...
            <p>This page is reviewed quarterly for accuracy. Companies Act provisions, S454 adjudication powers, strike-off rules, filing deadlines, and penalty structures are verified against current MCA notifications. ROC Haryana establishment details and Gurugram company landscape validated with each review.</p>
        </div>
    </div>
</section>
