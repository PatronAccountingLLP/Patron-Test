        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'secretarial-audit/gurugram',
                    'options'  => [
                        'secretarial-audit/gurugram' => 'Secretarial Audit in Gurugram',
                        'annual-compliance/gurugram' => 'Annual Compliance in Gurugram',
                        'appointment-of-auditor/gurugram' => 'Auditor Appointment in Gurugram',
