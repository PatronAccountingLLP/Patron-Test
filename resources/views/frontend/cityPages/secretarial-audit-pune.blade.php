...
@section('meta')
    ...
    <meta property="og:image" content="/images/secretarial-audit-service/pune-og.webp">
    ...
    <meta name="twitter:image" content="/images/secretarial-audit-service/pune-og.webp">
@endsection
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - Secretarial Audit in Pune'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="secretarial-audit-service/pune" selected>Secretarial Audit in Pune</option><option value="statutory-audit">Statutory Audit</option><option value="fdi-compliance/pune">FDI Compliance in Pune</option><option value="annual-roc-filing/pune">Annual ROC Filing in Pune</option><option value="gst-registration/pune">GST Registration in Pune</option><option value="legal-drafting-service/pune">Legal Drafting in Pune</option><option value="accounting-services">Accounting Services</option><option value="other">Other</option>
        ...
        <div class="reviews-cta" style="margin-top: 16px; display: flex !important;">
            <div class="reviews-cta-content">
                ...
                <div class="reviews-cta-text">
                    ...
                    <p>Get expert secretarial audit for your Pune company today.</p>
                </div>
            </div>
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    ...
                    @include('partials.faq-enquiry-form', ['enquiryLocation' => 'Pune', 'enquiryService' => 'Secretarial Audit Service in Pune'])
                </aside>
