        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'section8-company-registration/mumbai',
                    'options'  => [
                        'section8-company-registration/mumbai' => 'Section 8 Company Registration in Mumbai',
                        ...
                        'society-registration/mumbai' => 'Society Registration in Mumbai',
                        'one-person-company-registration/mumbai' => 'OPC Registration in Mumbai',
                        'other' => 'Other',
                    ],
                ])
            </div>
