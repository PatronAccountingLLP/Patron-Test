...
@section('meta')
    ...
    <meta property="og:image" content="/images/shop-act-registration-gurugram-og.webp">
    ...
    <meta name="twitter:image" content="/images/shop-act-registration-gurugram-og.webp">
@endsection
  ...
  "@graph": [
    {
      ...
      "url": "/shop-act-registration/gurugram",
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-4 private-registration-heading">
                        Shop Act Registration in Gurugram: Legal License for Every Commercial Establishment
                    </h1>
                    ...
                    <div class="mb-4">
                        <div class="d-flex align-items-start mb-3">
                            ...
                            <p class="mb-0 text-dark benefit-paragraph"><span>Documents:</span> Owner Aadhaar/PAN, address proof of premises, NOC from landlord (if rented), employee details, GST certificate</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Fees:</span> Government: Rs 500-5,000 (based on employee count and business type). Professional: Rs 1,999-4,999</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Eligibility:</span> Every shop, office, restaurant, cafe, salon, warehouse, studio, or commercial establishment in Gurugram</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Timeline:</span> 7-15 working days online. Must register within 30 days of commencing operations</p>
                        </div>
                    </div>
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="mailto:sales@patronaccounting.com?subject=Enquiry%20for%20Shop%20Act%20Registration%20in%20Gurugram&body=Hello%20Patron%20Accounting%20Team%2C%0A%0AI%20am%20interested%20in%20your%20Shop%20Act%20Registration%20services%20in%20Gurugram%20and%20would%20like%20to%20know%20more.%0A%0APlease%20get%20in%20touch%20with%20me%20at%20your%20earliest%20convenience.%0A%0AThank%20you." class="btn-sample text-decoration-none">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:18px;height:18px;"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,12 2,6"/></svg>
                            Email Us
                        </a>
                        <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20help%20with%20Shop%20Act%20Registration%20in%20Gurugram.%20Please%20share%20details." target="_blank" class="btn-sample text-decoration-none">
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - Shop Act Registration Gurugram'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="shop-act-registration/gurugram" selected>Shop Act Registration in Gurugram</option>
...
<section class="testimonials-section">
    <div class="section-container">
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            ...
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Patron handled Shop Act registration for our 3 restaurant locations in Cyber Hub and Golf Course Road. Each location got its own certificate. They also set up employee registers and advised on working hour compliance. Complete restaurant setup.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div>
                    <div style="font-weight:700;font-size:13px;color:var(--blue);">Vikram Oberoi</div>
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Owner, Restaurant Chain, Gurugram</div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">We didn't know our IT office in Cyber City needed Shop Act registration. Patron explained the Act covers all commercial premises. Registration was done in 10 days. They also bundled it with our GST and PF setup.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div>
                    ...
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Founder, IT Company, DLF Cyber City</div>
                    <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                </div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Our retail shop's 3-year certificate was expiring and we had no idea. Patron tracked the renewal date, filed the renewal on the Haryana portal, and our certificate was renewed before the grace period ended. Now they track all our compliance dates.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div>
                    ...
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Retailer, Sector 29 Market</div>
                    <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                </div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Patron set up the complete business for our new salon: Shop Act, GST registration, and bank account assistance. The Shop Act certificate was the foundation document that unlocked everything else. Excellent bundled service.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                <div style="width:36px;height:36px;border-radius:50%;background:#6366F1;display:flex;align-items:center;justify-content:center;font-weight:700;font-size:13px;color:#fff;flex-shrink:0;">PM</div>
                <div>
                    <div style="font-weight:700;font-size:13px;color:var(--blue);">Pooja Malhotra</div>
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Owner, Salon, Sohna Road</div>
                    <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                </div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Labour Inspector visited our warehouse and asked for Form A and Form C registers. Patron had already set these up during our Shop Act registration. No penalties, no issues. They think ahead about compliance requirements.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div>
                    ...
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Manager, Warehouse Operations, Udyog Vihar</div>
                    <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                </div>
        ...
        <div class="reviews-cta" style="margin-top: 16px; display: flex !important;">
            <div class="reviews-cta-content">
                ...
                <div class="reviews-cta-text">
                    ...
                    <p>Trusted Shop Act registration partner for commercial establishments in Gurugram.</p>
                </div>
            </div>
...
<div class="stats-bar">
    <div class="stats-container">
        <div class="stat-item">
            ...
            <div class="stat-content"><span class="stat-value">10,000+</span><span class="stat-label">Businesses Served</span><span class="stat-desc">Shop Act registration and commercial compliance across India.</span></div>
        </div>
        <div class="stat-item">
            <div class="stat-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8M12 17v4"/></svg></div>
            <div class="stat-content"><span class="stat-value">15+</span><span class="stat-label">Years Experience</span><span class="stat-desc">Deep expertise in Shop Act, labour compliance, and business setup.</span></div>
        </div>
        <div class="stat-item">
            <div class="stat-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><path d="M14 2v6h6M16 13H8M16 17H8"/></svg></div>
            <div class="stat-content"><span class="stat-value">50,000+</span><span class="stat-label">Documents Filed</span><span class="stat-desc">Shop Act registrations, renewals, and compliance documents handled.</span></div>
        </div>
        <div class="stat-item">
            <div class="stat-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="8" r="7"/><path d="M8.21 13.89L7 23l5-3 5 3-1.21-9.12"/></svg></div>
            <div class="stat-content"><span class="stat-value">4.9&#9733;</span><span class="stat-label">Client Rating</span><span class="stat-desc">Trusted by retail shops, IT offices, restaurants, and commercial establishments.</span></div>
        </div>
...
<section class="content-section" id="overview-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Why Shop Act Registration Matters for Gurugram Businesses</h2>
            <div class="content-text">
                <div class="highlight-box" style="margin-bottom:20px;">
                    <p><strong>&#128204; TL;DR - Shop Act Registration Services at a Glance</strong></p>
                    <p>Shop Act Registration (formally: registration under the Haryana Shops & Commercial Establishments Act) is mandatory for every shop and commercial establishment in Gurugram. This includes retail shops, offices, restaurants, cafes, salons, warehouses, studios, co-working spaces, and any premises where business or trade is conducted. Register within 30 days of commencing operations. Issued by the Haryana Labour Department through the online portal (hrylabour.gov.in). Validity: 3 years, renewable by 31st March. Government fee: Rs 500-5,000. The Act regulates: working hours (max 9 hours/day, 48 hours/week), overtime, weekly holidays, earned leave, and conditions of employment. Non-registration penalty: Rs 100/day minimum. Shop Act certificate is a prerequisite for GST registration, bank account opening, FSSAI, and other business licences.</p>
                </div>
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Parameter</th><th>Detail</th></tr></thead>
                    <tbody>
                        <tr><td>Governing Law</td><td>Haryana Shops & Commercial Establishments Act (based on Punjab Act 1958)</td></tr>
                        <tr><td>Authority</td><td>Haryana Labour Department. Portal: <a href="https://hrylabour.gov.in" target="_blank" rel="noopener">hrylabour.gov.in</a>. Gurugram District Labour Office</td></tr>
                        <tr><td>Applicability</td><td>ALL shops and commercial establishments in notified areas of Haryana (entire Gurugram)</td></tr>
                        <tr><td>Registration Deadline</td><td>Within 30 days of commencing business operations</td></tr>
                        <tr><td>Validity</td><td>3 years. Renewable by 31st March after every 3 years. 30-day grace period</td></tr>
                        <tr><td>Fee</td><td>Rs 500 to Rs 5,000 (based on employee count and business type)</td></tr>
                        <tr><td>Working Hours</td><td>Max 9 hours/day, 48 hours/week. Overtime: max 2 hours/day. Rest: 1 hour after 5 hours</td></tr>
                        <tr><td>Non-Registration Penalty</td><td>Rs 100/day minimum. Additional penalties for working hour violations</td></tr>
                    </tbody>
                </table>
                </div>
                <p>Gurugram's commercial landscape is vast and diverse. DLF Cyber City houses hundreds of IT offices needing Shop Act registration. Golf Course Road has corporate offices and restaurants. Cyber Hub has restaurants and entertainment venues. Sector markets have thousands of retail shops. Sohna Road has co-working spaces, salons, and clinics. Every one needs Shop Act registration. For comprehensive information about <a href="/shop-act-registration">Shop Act registration across India</a>, visit our national service page.</p>
                <p>Shop Act registration is often the first business licence obtained because it serves as a foundational document. Banks require it for current account opening. GST registration may need it as business proof. FSSAI for restaurants needs it as premises proof. Without the Shop Act certificate, the entire compliance chain is blocked. You will also need <a href="/gst-registration">GST registration</a> and <a href="#">company registration</a> for complete business setup.</p>
        ...
        <div class="two-column">
            <div class="column-content">
                ...
                <div class="content-text what-is-definition">
                    <p>Shop Act Registration is the mandatory licensing of every shop and commercial establishment under the Haryana Shops & Commercial Establishments Act. It provides legal recognition to your business premises and regulates working conditions for employees.</p>
                    <p>Registration is done online via the Haryana Labour Department portal (hrylabour.gov.in). A Basic Information Performa (BIP) is completed with establishment details, employee information, and working hours. Certificate is issued after verification.</p>
                    <p>3-year validity with mandatory renewal. The certificate serves as foundational proof for GST, bank accounts, FSSAI, and other registrations. For complete business setup, pair Shop Act with <a href="/gst-registration">GST registration</a> and <a href="#">company registration</a>.</p>
                </div>
                <div class="highlight-box" style="margin-top:20px;">
                    <p><strong>Key Terms for Copyright Registration:</strong></p>
                    <ul>
                        <li><strong>Haryana Shop Act</strong> - State law governing registration of shops and commercial establishments</li>
                        <li><strong>BIP</strong> - Basic Information Performa filed on the Haryana Labour portal</li>
                        <li><strong>Form A</strong> - Appointment register recording employment and working hours</li>
                        <li><strong>Form C</strong> - Register of employees for Labour Inspector inspection</li>
                        <li><strong>3-Year Renewal</strong> - Certificate must be renewed by 31st March every 3 years</li>
                    </ul>
                </div>
            </div>
...
<section class="content-section" id="who-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Who Needs Shop Act Registration in Gurugram</h2>
            <div class="content-text">
                <ul>
                    <li><strong>IT companies and offices</strong> in DLF Cyber City, Sector 44, and Golf Course Road. Every office premises where business is conducted needs Shop Act registration. Large IT companies with multiple floors may need registration for each distinct establishment.</li>
                    <li><strong>Retail shops</strong> across Gurugram: sector markets, DLF malls, standalone shops, boutiques, electronics stores, grocery stores, pharmacies, and any premises where goods are sold to customers.</li>
                    ...
                    <li><strong>Professional service establishments</strong>: salons, spas, clinics, dental offices, legal offices, CA/CS offices, architecture studios, design studios, and any premises where professional services are rendered.</li>
...
<section class="content-section" id="services-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">6 Shop Act Registration Services Included</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Service</th><th>What We Do</th></tr></thead>
                    <tbody>
                        <tr><td>Online Registration on Haryana Portal</td><td>Creating login on hrylabour.gov.in. Completing BIP with establishment details, owner details, business category, address, and employee information. Uploading documents. Paying fee. Tracking approval.</td></tr>
                        <tr><td>Document Preparation</td><td>Organizing all required documents: owner ID (Aadhaar, PAN), premises address proof (lease deed, utility bill), NOC from landlord, employee details, GST certificate, incorporation certificate.</td></tr>
                        <tr><td>Employee Compliance Advisory</td><td>Advising on working hours (max 9 hrs/day, 48 hrs/week), overtime limits (2 hrs/day), rest intervals (1 hr after 5 hrs), weekly holiday, earned leave (1 day per 20 days), termination notice (1 month).</td></tr>
                        <tr><td>Register Maintenance</td><td>Setting up mandatory Form A (appointment register) and Form C (employee register). These must be maintained and produced on demand by the Labour Inspector.</td></tr>
                        <tr><td>3-Year Renewal Management</td><td>Tracking the 3-year renewal cycle. Filing renewal before 31st March. 30-day grace period management. Updating changed information. Ensuring continuous validity.</td></tr>
                        <tr><td>Integration with Other Registrations</td><td>Coordinating Shop Act with GST registration, bank account opening, FSSAI (restaurants), ESI, PF. Single-point compliance management for new business setup.</td></tr>
                        <tr><td>Labour Inspector Readiness</td><td>Maintaining complete records for Labour Inspector visits: employee registers, working hours records, leave records, overtime documentation. Preventing penalties during inspections.</td></tr>
                    </tbody>
                </table>
                </div>
            </div>
...
<section class="steps-section" id="procedure-section">
    <div class="section-container">
        <header class="section-header" style="text-align:center;margin-bottom:48px;">
            ...
            <h2 class="section-title">How Shop Act Registration Works in Gurugram: 5-Step Process</h2>
            <p class="section-subtitle" style="text-align:left;max-width:100%;">Our CA-led team handles Shop Act registration on the Haryana Labour portal, 3-year renewal tracking, employee compliance, and business setup integration for Gurugram establishments.</p>
        </header>
        <div class="steps-container">
            <div class="step-card">
                <div class="step-content">
                    ...
                    <p class="step-description">Gather owner Aadhaar/PAN, premises address proof (lease deed/utility bill), landlord NOC (if rented), employee details with wages, GST certificate, company registration.</p>
                ...
                <div class="step-visual">
                    <div class="step-illustration">
                        ...
                        <span class="illustration-label">Documents OK</span>
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">Apply on Haryana Labour Portal</h3>
                    <p class="step-description">Create login on hrylabour.gov.in. Complete BIP form with establishment details, owner info, business category, address, employee count, and working hours schedule.</p>
                    <div class="step-highlights">
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>BIP Filed</span>
                ...
                <div class="step-visual">
                    <div class="step-illustration">
                        ...
                        <span class="illustration-label">Application OK</span>
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">Upload Documents and Pay Fee</h3>
                    <p class="step-description">Upload all documents in prescribed format. Pay government fee (Rs 500-5,000) online. Submit application. Track approval status on portal.</p>
                    <div class="step-highlights">
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">Verification and Inspection</h3>
                    <p class="step-description">Labour Department verifies application. Inspector may visit premises to check compliance with working hours, employee conditions, and premises suitability. Address any observations.</p>
                    <div class="step-highlights">
                ...
                <div class="step-visual">
                    <div class="step-illustration">
                        ...
                        <span class="illustration-label">Inspected</span>
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">Registers Set</h3>
                    <p class="step-description">Shop Act registration certificate issued. Valid for 3 years. Display at premises. Use as foundation document for GST, bank, FSSAI, and other registrations.</p>
                    <div class="step-highlights">
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <p class="step-description">Maintain Form A and Form C employee registers. Follow working hours rules (9 hrs/day, 48 hrs/week). Track 3-year renewal date. Integrate with GST, ESIC, PF, and other business compliances.</p>
                    <div class="step-highlights">
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Registers Set</span>
        ...
        <div class="highlight-box" style="margin-top:32px;max-width:1000px;margin-left:auto;margin-right:auto;">
            <p><strong>City Processing Note:</strong> Patron's Gurugram office on Golf Course Extension Road handles Shop Act registration, renewal, and employee compliance for retail shops, IT offices, restaurants, and commercial establishments across Gurugram.</p>
        </div>
    </div>
</section>
...
<section class="content-section" id="documents-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Documents Required for Shop Act Registration in Gurugram</h2>
            <div class="content-text">
                <ul>
                    <li><strong>Owner Identity:</strong> Aadhaar card and PAN card of the establishment owner/proprietor/director.</li>
                    <li><strong>Premises Proof:</strong> Lease deed / rent agreement / ownership document | Utility bill (electricity/water) | NOC from landlord (if rented).</li>
                    <li><strong>Business Documents:</strong> GST registration certificate | Company/LLP incorporation certificate | Employee details with wages.</li>
                    <li><strong>Additional:</strong> Photographs of premises (if required) | Nature of business description | Working hours schedule.</li>
                </ul>
            </div>
        </div>
    </div>
...
<section class="content-section" id="challenges-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">5 Common Shop Act Registration Challenges in Gurugram</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Challenge</th><th>Impact</th><th>How Patron Accounting Solves It</th></tr></thead>
                    <tbody>
                        <tr><td>Not Registering Within 30 Days</td><td>Retailer opens shop and focuses on sales without registering. Labour Inspector visits after 90 days</td><td>Register before or within 30 days. Penalty: Rs 100/day. 90 days = Rs 9,000+ penalty vs Rs 500-5,000 registration fee. Not worth the delay.</td></tr>
                        <tr><td>IT Offices Assuming Exemption</td><td>IT companies believe 'technology company' is exempt from Shop Act. Act covers all commercial premises</td><td>Act's definition of 'shop' includes any premises where business or services are rendered. Software companies, consulting firms, BPOs all need registration.</td></tr>
                        <tr><td>Renewal Missed After 3 Years</td><td>Business forgets the 3-year renewal date. Certificate becomes invalid</td><td>Track renewal date from day one. Renew by 31st March. 30-day grace period. Set calendar reminders 3 months before. Patron tracks all renewal dates.</td></tr>
                        <tr><td>Working Hours Violations</td><td>Restaurants and retail require 12-14 hour shifts without overtime pay</td><td>Max 9 hours/day, 48 hours/week. Overtime at double rate. Labour Inspector can penalize for violations. Structure shifts to comply with the Act.</td></tr>
                        <tr><td>Employee Registers Not Maintained</td><td>Form A and Form C registers missing during Labour Inspector visit</td><td>Set up Form A (appointment) and Form C (employee register) at registration time. Maintain current records. Produce on demand during inspection.</td></tr>
                    </tbody>
                </table>
                </div>
            </div>
...
<section class="content-section" id="fees-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Shop Act Registration Fees in Gurugram 2026</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table class="table-amount">
                    <thead><tr><th>Fee Component</th><th>Amount</th></tr></thead>
                    <tbody>
                        <tr><td>Shop Act Registration</td><td>Rs 500-5,000 govt + Rs 1,999-3,999 professional</td></tr>
                        <tr><td>3-Year Renewal</td><td>Rs 500-5,000 govt + Rs 999-1,999 professional</td></tr>
                        <tr><td>Employee Compliance Setup</td><td>Rs 1,500-2,500 (registers + advisory)</td></tr>
                        <tr><td>New Business Setup Bundle</td><td>Rs 7,999-14,999 (Shop Act + GST + Company + Bank)</td></tr>
                        <tr><td>Multi-Location Registration</td><td>Rs 1,499-2,999 per additional location</td></tr>
                        <tr><td>Labour Inspector Readiness Audit</td><td>Rs 2,000-3,000</td></tr>
                ...
                <p style="margin-top:16px;">Government fee is Rs 500-5,000 based on employee count and business type. Professional fees cover portal filing, document preparation, and compliance setup. New business bundles include Shop Act with GST and company registration.</p>
                <p style="margin-top:16px;"><strong>Get a free Copyright Registration consultation - <a href="tel:+919459456700">Call +91 945 945 6700</a> or <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20help%20with%20Shop%20Act%20Registration%20in%20Gurugram.%20Please%20share%20fee%20details." target="_blank">WhatsApp us</a>. No-obligation assessment.</strong></p>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section" id="timeline-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Shop Act Registration Timeline in Gurugram</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Stage</th><th>Estimated Timeline</th></tr></thead>
                    <tbody>
                        <tr><td>Document Preparation</td><td>1-3 business days</td></tr>
                        <tr><td>Online Application on Haryana Portal</td><td>Same day</td></tr>
                        <tr><td>Verification/Inspection (if required)</td><td>5-10 working days</td></tr>
                        <tr><td>Certificate Issuance</td><td>7-15 working days total</td></tr>
                        <tr><td>Registration Deadline</td><td>Within 30 days of commencing operations</td></tr>
                        <tr><td>3-Year Renewal</td><td>By 31st March + 30-day grace period</td></tr>
                        <tr><td>Penalty for Delay</td><td>Rs 100/day from date of commencement</td></tr>
                    </tbody>
                </table>
                </div>
                <div class="highlight-box" style="margin-top:16px;">
                    <p><strong>Note:</strong> Shop Act registration is processed within 7-15 working days on the Haryana Labour portal. Register within 30 days of commencing operations to avoid Rs 100/day penalty. Patron handles the entire process from document preparation to certificate download.</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="why-choose-section" id="benefits-section">
    <div class="section-container">
        <div style="text-align:center;margin-bottom:48px;">
            ...
            <h2 class="section-title">Why Choose Patron for Shop Act Registration in Gurugram</h2>
        </div>
        <div class="features-grid">
            <article class="feature-card">
                ...
                <h3 class="feature-title">Online Portal Filing</h3>
                <p class="feature-text">Complete application on the Haryana Labour portal. BIP form completion, document upload, fee payment. Certificate procurement and download.</p>
            </article>
            <article class="feature-card">
                ...
                <h3 class="feature-title">Working Hours Advisory</h3>
                <p class="feature-text">Expert guidance on 9-hour/day and 48-hour/week limits, overtime rules, rest intervals, weekly holidays, and earned leave. Preventing Labour Inspector penalties.</p>
            </article>
            <article class="feature-card">
                ...
                <h3 class="feature-title">3-Year Renewal Tracking</h3>
                <p class="feature-text">Proactive tracking of the 3-year renewal cycle. Filing renewal before 31st March. Ensuring continuous validity and preventing certificate lapse.</p>
            </article>
            <article class="feature-card">
                <div class="feature-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg></div>
                <h3 class="feature-title">Business Setup Bundle</h3>
                <p class="feature-text">Shop Act + GST + Company Registration + Bank Account - complete new business setup from a single engagement. Foundation document for all other registrations.</p>
            </article>
            <article class="feature-card">
                ...
                <h3 class="feature-title">Register Maintenance</h3>
                <p class="feature-text">Setting up and maintaining mandatory Form A and Form C employee registers. Ready for Labour Inspector inspection at any time.</p>
            </article>
            <article class="feature-card">
                ...
                <h3 class="feature-title">Multi-Location Filing</h3>
                <p class="feature-text">Coordinating Shop Act registration for businesses with multiple locations: restaurant chains, retail groups, multi-office IT companies. Each location needs own registration.</p>
            </article>
        </div>
    </div>
</section>
...
<section class="content-section" id="comparison-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Key Provisions of the Haryana Shop Act</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table class="table-comparison">
                    <thead><tr><th>Provision</th><th>Requirement</th></tr></thead>
                    <tbody>
                        <tr><td>Working Hours</td><td>Max 9 hours/day. Max 48 hours/week. Overtime: max 2 hours/day, 50 hours/quarter</td></tr>
                        <tr><td>Rest Interval</td><td>1 hour rest after 5 continuous hours. No employee works 5+ hours without break</td></tr>
                        <tr><td>Weekly Holiday</td><td>Shops: closed on Sunday (or substitute). Employees: 1 mandatory day off per week</td></tr>
                        <tr><td>National Holidays</td><td>Paid leave on Republic Day, Independence Day, Gandhi Jayanti</td></tr>
                        <tr><td>Earned Leave</td><td>1 day earned leave for every 20 days worked. Young persons: 1 day per 15 days</td></tr>
                        <tr><td>Termination Notice</td><td>1 month notice for employees with 3+ months of service</td></tr>
                    </tbody>
                </table>
                </div>
                <p style="margin-top:12px;">External Authority: <a href="https://hrylabour.gov.in" target="_blank" rel="noopener">Haryana Labour Dept (hrylabour.gov.in)</a></p>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>Shop Act Registration is governed by the <strong>Haryana Shops & Commercial Establishments Act</strong> (based on the Punjab Shops and Commercial Establishments Act, 1958). The Act applies to every shop and commercial establishment in notified areas across Haryana, including the entire Gurugram district.</p>
                <p>The Act regulates <strong>working conditions</strong>: maximum 9 hours/day and 48 hours/week, overtime at double rate (max 2 hours/day), 1-hour rest after 5 continuous hours, mandatory weekly holiday, earned leave of 1 day per 20 days worked, and termination notice of 1 month for employees with 3+ months of service.</p>
                <p>Registration is processed through the <a href="https://hrylabour.gov.in" target="_blank" rel="noopener">Haryana Labour Department portal (hrylabour.gov.in)</a>. The Gurugram District Labour Office handles local enforcement and inspections. The <a href="https://investharyana.in" target="_blank" rel="noopener">Invest Haryana portal</a> provides additional business facilitation services.</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    <h2 class="faq-expanded__title">FAQs - Shop Act Registration in Gurugram</h2>
                    <p class="faq-expanded__lead">Answers to common questions about Shop Act registration including applicability, fees, validity, working hour rules, and renewal for Gurugram commercial establishments.</p>
                    @include('partials.faq-enquiry-form', ['enquiryLocation' => 'Gurugram', 'enquiryService' => 'Shop Act Registration in Gurugram'])
                </aside>
                <div class="faq-expanded__list">
                    <div class="faq-expanded__item" id="faq-1">
                        <h3 class="faq-expanded__q">Who needs Shop Act registration in Gurugram?</h3>
                        <div class="faq-expanded__a"><p>Every shop and commercial establishment in Gurugram: retail shops, offices, restaurants, cafes, salons, warehouses, studios, co-working spaces, clinics, and any premises where business or trade is conducted. IT offices are included - the Act covers all commercial premises where services are rendered. Registration must be obtained within 30 days of commencing operations.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-2">
                        <h3 class="faq-expanded__q">How much does Shop Act registration cost?</h3>
                        <div class="faq-expanded__a"><p>Government fee: Rs 500 to Rs 5,000 (based on employee count and business type). Professional fee: Rs 1,999 to Rs 3,999. New business setup bundle (Shop Act + GST + Company/LLP registration): Rs 7,999 to Rs 14,999. 3-year renewal: Rs 500-5,000 govt + Rs 999-1,999 professional. Call +91 945 945 6700 for a detailed quote.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-3">
                        <h3 class="faq-expanded__q">How long is Shop Act certificate valid?</h3>
                        <div class="faq-expanded__a"><p>Total timeline: 2-6 months. Filing and Diary Number: immediate. Mandatory 30-day objection waiting period: 1 month. Certificate Issued: 1-3 months. Certificate issuance: after examination approval. If a third-party objection is filed, the timeline extends by 2-4 months for hearing and resolution.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-4">
                        <h3 class="faq-expanded__q">Do IT offices in Cyber City need Shop Act registration?</h3>
                        <div class="faq-expanded__a"><p>Yes. The Act defines 'shop' as any premises where business or trade is carried on or services are rendered to customers. IT offices rendering software services, consulting firms, BPOs, and technology companies are all commercial establishments covered under the Act. Being a technology company does not create an exemption from Shop Act registration.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-5">
                        <h3 class="faq-expanded__q">What working hour rules does the Shop Act impose?</h3>
                        <div class="faq-expanded__a"><p>Maximum 9 hours per day and 48 hours per week. Overtime: maximum 2 hours per day and 50 hours per quarter (paid at double the normal rate). Rest interval: 1 hour after 5 continuous hours of work. Weekly holiday: one closed day per week (Sunday or substitute). National holidays: paid leave on Republic Day, Independence Day, and Gandhi Jayanti.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-6">
                        <h3 class="faq-expanded__q">What happens if I do not register under the Shop Act?</h3>
                        <div class="faq-expanded__a"><p>Penalty of Rs 100 per day minimum for non-registration, accumulating from the date operations commenced. Additional fines for violations of working hour rules, missing employee registers, and failure to provide mandatory weekly holidays. Labour Inspector can visit at any time and impose penalties. The penalties quickly exceed the registration cost.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-7">
                        <h3 class="faq-expanded__q">Is Shop Act certificate needed for other registrations?</h3>
                        <div class="faq-expanded__a"><p>Yes. The Shop Act certificate serves as a foundational business document. Banks require it for opening current accounts. GST registration may require it as business premises proof. FSSAI licensing for restaurants references it. ESI and PF registration may need it. Without the Shop Act certificate, the entire chain of business compliance can be delayed.</p></div>
                    </div>
                </div>
            </div>
            ...
            <div class="highlight-box" style="margin-top:32px;">
                ...
                <p><strong>Kaun register karega?</strong> Har shop, office, restaurant, salon, warehouse, studio - koi bhi commercial jagah jahan business hota hai. IT office bhi. 30 din ke andar register karna padta hai.</p>
                <p><strong>Kitne saal ki validity?</strong> 3 saal. Har 3 saal 31 March se pehle renew karna padta hai. 30 din grace period. Renew nahi kiya toh certificate invalid ho jayega.</p>
                <p><strong>Kya kya rules follow karne hain?</strong> Working hours max 9 ghante/din, 48 ghante/hafta. Overtime max 2 ghante (extra pay). 5 ghante ke baad 1 ghanta rest. Weekly holiday mandatory. Register Form A aur Form C maintain karo.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section" style="background: var(--orange-lighter) !important; border-left: 4px solid var(--orange);">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Why Shop Act Registration Matters for Gurugram Businesses</h2>
            <div class="content-text">
                <p>A Gurugram restaurant in Cyber Hub operates 6 months without Shop Act registration. The owner applies for a bank loan but the bank asks for the Shop Act certificate. The owner does not have one. Separately, a Labour Inspector visits and finds no registration, no employee registers, and 12-hour shifts without overtime pay. Penalties: Rs 100/day x 180 days = Rs 18,000 plus additional fines for working hour violations. Total penalty exceeds Rs 30,000 - when the registration would have cost Rs 1,999-5,000.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section" style="background: var(--blue) !important;">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title" style="color:#FFFFFF !important;">Start Your Shop Act Registration in Gurugram Today</h2>
            <div class="content-text" style="text-align:left;">
                <p style="color:rgba(255,255,255,0.85);">Shop Act Registration in Gurugram is the foundational commercial licence for every shop, office, restaurant, and commercial establishment, mandated by the Haryana Shops and Commercial Establishments Act, regulating working hours, employee welfare, and establishing legal recognition for business operations.</p>
                <p style="color:rgba(255,255,255,0.85);">Patron Accounting's Gurugram office on Golf Course Extension Road handles Shop Act registration on the Haryana Labour Department portal, 3-year renewal tracking, employee compliance advisory, and business setup integration for retail shops, IT offices, restaurants, and commercial establishments across Gurugram.</p>
            ...
            <div style="display:flex;gap:14px;flex-wrap:wrap;margin-top:24px;">
                ...
                <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20help%20with%20Shop%20Act%20Registration%20in%20Gurugram.%20Please%20share%20details." target="_blank" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:#25D366;color:#fff;border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#128172; WhatsApp Us</a>
                <a href="mailto:sales@patronaccounting.com?subject=Enquiry%20for%20Shop%20Act%20Registration%20in%20Gurugram&body=Hello%20Patron%20Accounting%20Team%2C%0A%0AI%20am%20interested%20in%20your%20Shop%20Act%20Registration%20services%20in%20Gurugram%20and%20would%20like%20to%20know%20more.%0A%0APlease%20get%20in%20touch%20with%20me%20at%20your%20earliest%20convenience.%0A%0AThank%20you." style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:transparent;color:#fff;border:2px solid rgba(255,255,255,0.3);border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#9993;&#65039; Email Us</a>
            </div>
...
<section class="content-section" style="padding:48px 32px;background:var(--gray-50);">
    <div class="content-container">
        <div class="text-content">
            ...
            <p style="text-align:center;color:var(--text-muted);font-size:15px;margin-bottom:40px;">Shop Act registration services available in major cities across India with local office support.</p>
            ...
            <div class="pa-city-block">
                ...
                <div class="pa-block-sub">End-to-end support for Shop Act Registration in Gurugram</div>
...
<section class="content-section" style="padding:32px;">
    <div class="content-container">
        <div class="text-content" style="font-size:13px;color:var(--text-muted);">
            ...
            <p>This page is reviewed quarterly for accuracy. Haryana Shop Act provisions, Labour Department portal processes, fee schedules, and working hour regulations are verified against official government notifications. Gurugram commercial landscape information is validated with each review.</p>
        </div>
    </div>
</section>
