...
@section('meta')
    ...
    <meta property="og:image" content="/images/startup-india-registration/bangalore-og.webp">
    ...
    <meta name="twitter:image" content="/images/startup-india-registration/bangalore-og.webp">
@endsection
      ...
      "@graph": [
        {
          ...
          "url": "/startup-registration/bangalore",
        ...
        },
        {
          ...
          "itemListElement": [
            ...
            },
            {
              ...
              "item": "/startup-registration/bangalore"
            }
          ]
        },
        {
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - Startup India Registration in Bangalore'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="startup-india-registration/bangalore" selected>Startup India Registration in Bangalore</option>
