...
@section('meta')
    ...
    <meta property="og:image" content="/images/startup-registration/chennai-og.webp">
    ...
    <meta name="twitter:image" content="/images/startup-registration/chennai-og.webp">
@endsection
      ...
      "@graph": [
        {
          ...
          "url": "/startup-registration/chennai",
        ...
        },
        {
          ...
          "itemListElement": [
            ...
            },
            {
              ...
              "item": "/startup-registration/chennai"
            }
          ]
        },
        {
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'startup-registration/chennai',
                    'options'  => [
