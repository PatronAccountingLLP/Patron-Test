...
@section('meta')
    ...
    <meta property="og:image" content="/images/startup-registration/kolkata-og.webp">
    ...
    <meta name="twitter:image" content="/images/startup-registration/kolkata-og.webp">
@endsection
      ...
      "@graph": [
        {
          ...
          "url": "/startup-registration/kolkata",
        ...
        },
        {
          ...
          "itemListElement": [
            ...
            },
            {
              ...
              "item": "/startup-registration/kolkata"
            }
          ]
        },
        {
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - Startup Registration in Kolkata'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="startup-registration/kolkata" selected>Startup Registration in Kolkata</option>
