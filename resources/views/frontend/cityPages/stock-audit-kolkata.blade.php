        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'stock-audit/kolkata',
                    'options'  => [
                        'stock-audit/kolkata' => 'Stock Audit in Kolkata',
                        ...
                        'udyam-registration/kolkata' => 'Udyam Registration in Kolkata',
                        'startup-registration/kolkata' => 'Startup Registration in Kolkata',
