...
@section('schema')
    @include('partials.city-localbusiness', ['citySlug' => 'kolkata', 'pageUrl' => '/stock-audit/kolkata'])
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="mailto:sales@patronaccounting.com?subject=Enquiry%20for%20Stock Audit in Kolkata%20Services&body=Hello%2C%20I%20just%20visited%20your%20Stock%20Audit%20in%20Kolkata%20Services%20page.%20I%20would%20like%20to%20know%20more%20about%20it.%0A%0AThank%20you." class="btn-sample text-decoration-none">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:18px;height:18px;"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,12 2,6"/></svg>
                            Email Us
                        </a>
                        <a href="https://wa.me/919459456700?text=Hello%2C%20I%20just%20visited%20your%20Stock%20Audit%20in%20Kolkata%20Services%20page.%20I%20would%20like%20to%20know%20more%20about%20it." target="_blank" class="btn-sample text-decoration-none" rel="noopener">
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    @include('partials.bigin-form', [
                        'variant' => 'bare',
                        'service'  => 'Stock Audit in Kolkata',
                        'city'     => 'Kolkata',
                    ])
                    @verbatim
...
<tr><td><strong>Access to Upper Floor Storage</strong></td><td>Market buildings with stock stacked on upper floors and no lift take substantially longer per line than ground-level godown space.</td></tr>
                ...
                <p style="margin-top:16px;"><strong>Get a free Stock Audit in Kolkata consultation - <a href="tel:+919459456700">Call +91 945 945 6700</a> or <a href="https://wa.me/919459456700?text=Hello%2C%20I%20just%20visited%20your%20Stock%20Audit%20in%20Kolkata%20Services%20page.%20I%20would%20like%20to%20know%20more%20about%20it." target="_blank" rel="noopener">WhatsApp us</a>. No-obligation assessment.</strong></p>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section" style="background: var(--orange-lighter) !important; border-left: 4px solid var(--orange);">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text"><div class="pa-deadline-grid"><article class="pa-deadline"><div class="pa-deadline-m"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round"><rect x="3" y="4" width="18" height="18" rx="2"/><path d="M16 2v4M8 2v4M3 10h18"/></svg>MAR</div><div class="pa-deadline-b"><h3>March Year End Across Howrah and Burrabazar</h3><p>A stock auditor in Kolkata works inside market hours and around river crossings, and in March both constraints bite while every trader wants the same dates.</p></div></article>
<article class="pa-deadline"><div class="pa-deadline-m"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round"><rect x="3" y="4" width="18" height="18" rx="2"/><path d="M16 2v4M8 2v4M3 10h18"/></svg>NOW</div><div class="pa-deadline-b"><h3>Puja Season Closes the Counting Window Early</h3><p>The festival period effectively closes the trading calendar for counting, so autumn work is booked well ahead of it rather than squeezed against it.</p></div></article></div></div>
        </div>
    </div>
</section>
...
<p>Far-bank godowns are given their own day, and market premises are booked to trading hours with the coverage agreed in advance.</p>
            ...
            <div style="display:flex;gap:14px;flex-wrap:wrap;margin-top:24px;">
                ...
                <a href="https://wa.me/919459456700?text=Hello%2C%20I%20just%20visited%20your%20Stock%20Audit%20in%20Kolkata%20Services%20page.%20I%20would%20like%20to%20know%20more%20about%20it." target="_blank" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:#25D366;color:#fff;border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;" rel="noopener">&#128172; WhatsApp Us</a>
                <a href="mailto:sales@patronaccounting.com?subject=Enquiry%20for%20Stock Audit in Kolkata%20Services&body=Hello%2C%20I%20just%20visited%20your%20Stock%20Audit%20in%20Kolkata%20Services%20page.%20I%20would%20like%20to%20know%20more%20about%20it.%0A%0AThank%20you." style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:transparent;color:#fff;border:2px solid rgba(255,255,255,0.3);border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#9993;&#65039; Email Us</a>
            </div>
...
<div class="wa-sticky-bar" id="waBar">
    <div class="wa-sticky-bar-content">
        ...
        <a href="https://wa.me/919459456700?text=Hello%2C%20I%20just%20visited%20your%20Stock%20Audit%20in%20Kolkata%20Services%20page.%20I%20would%20like%20to%20know%20more%20about%20it." target="_blank" rel="noopener" class="wa-sticky-bar-btn">
