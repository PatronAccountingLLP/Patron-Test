    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <h3>March Year End Across the Pune Component Belt</h3>
<p>A stock auditor in Pune is booked across the whole belt in March, because every borrower on a working capital limit wants the same fortnight and plants schedule shutdowns into it.</p>
<h3>September Half Year for Lender Reporting</h3>
<p>Half-year reporting brings a second peak. Lenders reviewing limits in the September quarter ask for counts inside the same weeks, so dates fill from the top of the month.</p>
