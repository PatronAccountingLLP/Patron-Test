  ...
  "@graph": [
    {
      ...
      "url": "/tds-return-filing/gurugram",
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-4 private-registration-heading">
                        TDS Return Filing in Gurugram: Quarterly 24Q, Monthly Deposit, and Form 16 Compliance
                    </h1>
                    ...
                    <div class="mb-4">
                        <div class="d-flex align-items-start mb-3">
                            ...
                            <p class="mb-0 text-dark benefit-paragraph"><span>Documents:</span> Payroll data, employee PAN, TDS challans, salary breakup, investment declarations</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Fees:</span> Quarterly: from Rs 1,500. Monthly computation: Rs 1,000. Form 16: Rs 50/employee. Annual: Rs 7,500</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Eligibility:</span> All employers deducting TDS from salaries under Section 192. TAN required</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Timeline:</span> TDS: by 7th monthly. 24Q: quarterly deadlines. Form 16: by 15 June</p>
                        </div>
                    </div>
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="mailto:sales@patronaccounting.com?subject=Enquiry%20for%20TDS%20Return%20Filing%20in%20Gurugram&body=Hello%20Patron%20Accounting%20Team%2C%0A%0AI%20am%20interested%20in%20your%20TDS%20Return%20Filing%20services%20in%20Gurugram%20and%20would%20like%20to%20know%20more.%0A%0APlease%20get%20in%20touch%20with%20me%20at%20your%20earliest%20convenience.%0A%0AThank%20you." class="btn-sample text-decoration-none">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:18px;height:18px;"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,12 2,6"/></svg>
                            Email Us
                        </a>
                        <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20help%20with%20TDS%20Return%20Filing%20in%20Gurugram.%20Please%20share%20details." target="_blank" class="btn-sample text-decoration-none">
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - TDS Return Filing Gurugram'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="tds-return-filing/gurugram" selected>TDS Return Filing in Gurugram</option>
...
<section class="testimonials-section">
    <div class="section-container">
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            ...
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">500+ employees. Patron computes monthly TDS, files quarterly 24Q, generates Form 16 for all employees by June 10. Q4 Annexure II verified line by line. Zero correction returns needed in 3 years.</div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">We have 3 TANs across 3 locations. Patron files separate 24Q for each. Employee-TAN mapping maintained. Consolidated Form 16. Multi-location compliance without the headache.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div>
                    ...
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">HR Director, Corporate, Golf Course Road</div>
                    <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                </div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">PAN-Aadhaar linking issue affected 30 employees. Patron identified before payroll, communicated to employees, prevented 20% TDS. Saved significant employee dissatisfaction.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div>
                    ...
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Payroll Manager, MNC, Cyber City</div>
                    <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                </div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">First year of TDS compliance for our startup. 15 employees. Patron set up TAN registration, monthly TDS, quarterly filing, and Form 16. Complete handholding from scratch.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Q4 Annexure II had an HRA error affecting all employees. Patron caught it during verification, corrected before filing. If filed with error, 200+ employees would have received wrong Form 16.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div>
                    ...
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">HR Head, Manufacturing, IMT Manesar</div>
                    <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                </div>
        ...
        <div class="reviews-cta" style="margin-top: 16px; display: flex !important;">
            <div class="reviews-cta-content">
                ...
                <div class="reviews-cta-text">
                    ...
                    <p>Trusted TDS return filing partner for employers across Gurugram.</p>
                </div>
            </div>
...
<div class="stats-bar">
    <div class="stats-container">
        <div class="stat-item">
            ...
            <div class="stat-content"><span class="stat-value">10,000+</span><span class="stat-label">Businesses Served</span><span class="stat-desc">TDS return filing and salary compliance across India.</span></div>
        </div>
        <div class="stat-item">
            <div class="stat-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8M12 17v4"/></svg></div>
            <div class="stat-content"><span class="stat-value">15+</span><span class="stat-label">Years Experience</span><span class="stat-desc">Deep expertise in Form 24Q, Form 16, TRACES, and salary TDS compliance.</span></div>
        </div>
        <div class="stat-item">
            <div class="stat-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><path d="M14 2v6h6M16 13H8M16 17H8"/></svg></div>
            <div class="stat-content"><span class="stat-value">50,000+</span><span class="stat-label">Documents Filed</span><span class="stat-desc">TDS returns, Form 16 certificates, and payroll compliance documents handled.</span></div>
        </div>
        <div class="stat-item">
            <div class="stat-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="8" r="7"/><path d="M8.21 13.89L7 23l5-3 5 3-1.21-9.12"/></svg></div>
            <div class="stat-content"><span class="stat-value">4.9&#9733;</span><span class="stat-label">Client Rating</span><span class="stat-desc">Trusted by IT companies, manufacturers, startups, and corporates.</span></div>
        </div>
            ...
            <div class="content-text">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr><td>Form</td><td>Form 24Q (quarterly) | Form 16 (annual) | Form 143/130 (from Apr 2026)</td></tr>
                ...
                <p>Gurugram has 2 million+ salaried employees across DLF Cyber City IT/BPO, Golf Course Road corporates, IMT Manesar manufacturing, and Sohna Road startups. Every employer deducting salary TDS must file Form 24Q and issue Form 16. For comprehensive information about <a href="/tds-return-filing-24q">TDS return filing across India</a>, visit our national service page.</p>
                <p>Late TDS = Rs 200/day penalty. Q4 Annexure II errors cascade to every Form 16. PAN-Aadhaar unlinking triggers 20% TDS rate. From April 2026, all forms change. You will also need <a href="/income-tax-return">income tax return filing</a> and <a href="/pf-return">PF return filing</a> for complete payroll compliance.</p>
        ...
        <div class="two-column">
            <div class="column-content">
                ...
                <div class="content-text what-is-definition">
                    <p>TDS return filing is the quarterly reporting of all tax deducted from employee salaries under Section 192 through Form 24Q submitted to the Income Tax Department. Form 16 is the annual TDS certificate employees need for ITR filing.</p>
                    <p>Form 24Q has Annexure I (all quarters: employee details, TDS, challans) and Annexure II (Q4 only: complete annual salary breakup). TDS deposited by 7th monthly. Return filed quarterly.</p>
                    <p>Haryana has no Professional Tax - salary TDS is the primary payroll tax. From April 2026, Form 24Q becomes Form 143 and Form 16 becomes Form 130. For complete compliance, pair with <a href="/pf-return">PF return</a> and <a href="/income-tax-return">ITR filing</a>.</p>
                </div>
                <div class="highlight-box" style="margin-top:20px;">
                    <p><strong>Key Terms for Copyright Registration:</strong></p>
                    <ul>
                        <li><strong>Form 24Q</strong> - Quarterly salary TDS return (Form 143 from Apr 2026)</li>
                        <li><strong>Form 16</strong> - Annual TDS certificate (Form 130 from Apr 2026)</li>
                        <li><strong>Section 234E</strong> - Late filing fee Rs 200/day capped at total TDS</li>
                        <li><strong>TRACES</strong> - Portal for Form 16 download and 26AS reconciliation</li>
                        <li><strong>Annexure II</strong> - Q4 annual salary breakup (most critical component)</li>
                    </ul>
                </div>
            </div>
...
<section class="content-section" id="who-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <ul>
                    <li><strong>IT and BPO companies in DLF Cyber City</strong>. Hundreds to thousands of employees. Complex salary structures with HRA, allowances, perquisites. New vs old regime management.</li>
                    <li><strong>Corporate headquarters on Golf Course Road</strong>. Multi-location employers. Multiple TANs. Senior management with complex compensation including ESOPs and variable pay.</li>
                    ...
                    <li><strong>Startups on Sohna Road and Golf Course Road</strong>. Growing teams. First-time TAN registration. ESOPs and variable compensation. Founder salary TDS.</li>
...
<section class="content-section" id="services-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">8 TDS Return Filing Services Included</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Service</th><th>What We Do</th></tr></thead>
                    <tbody>
                        <tr><td>Monthly TDS Computation</td><td>S192 salary TDS calculation. Old vs new regime. Investment declarations. Challan preparation. Deposit by 7th.</td></tr>
                        <tr><td>Quarterly Form 24Q Filing</td><td>Annexure I preparation. Employee PAN, salary, TDS, challan mapping. FVU validation. Quarterly submission.</td></tr>
                        <tr><td>Q4 Annexure II</td><td>Complete annual salary breakup. Regime classification. Deduction verification. Section 80C/80D/HRA computation.</td></tr>
                        <tr><td>Form 16 Generation</td><td>TRACES download. Part A (employer TDS) and Part B (salary details). Verification. Issue by 15 June.</td></tr>
                        <tr><td>26AS Reconciliation</td><td>Match TDS deposited with 26AS/AIS. Verify employee-wise credits. Identify mismatches.</td></tr>
                        <tr><td>Correction Returns and Transition</td><td>Correction returns for errors. PAN-Aadhaar linking verification. Form 143/130 transition from April 2026.</td></tr>
...
<section class="steps-section" id="procedure-section">
    <div class="section-container">
        <header class="section-header" style="text-align:center;margin-bottom:48px;">
            ...
            <p class="section-subtitle" style="text-align:left;max-width:100%;">Our CA-led team handles monthly TDS computation, quarterly Form 24Q, TRACES Form 16, 26AS reconciliation, correction returns, and Form 143/130 transition for Gurugram employers.</p>
        </header>
        <div class="steps-container">
            <div class="step-card">
                <div class="step-content">
                    <span class="step-badge">Step 1</span>
                    <h3 class="step-title">Compute Monthly TDS</h3>
                    <p class="step-description">Calculate TDS per employee. Old vs new regime. Investment declarations. Prepare challan. Deposit by 7th.</p>
                ...
                <div class="step-visual">
                    <div class="step-illustration">
                        ...
                        <span class="illustration-label">TDS Done</span>
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">Prepare Quarterly Form 24Q</h3>
                    <p class="step-description">Compile Annexure I: PAN, salary, TDS, challan details for all employees in the quarter.</p>
                    <div class="step-highlights">
                ...
                <div class="step-visual">
                    <div class="step-illustration">
                        ...
                        <span class="illustration-label">Quarter OK</span>
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">File and Validate</h3>
                    <p class="step-description">Upload Form 24Q. FVU validation. Submit with TAN. ARN generated. Q4 includes Annexure II.</p>
                    <div class="step-highlights">
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>24Q Filed</span>
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <p class="step-description">Download from TRACES after Q4. Verify Part A and Part B. Issue to all employees by 15 June.</p>
                    <div class="step-highlights">
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">Reconcile 26AS</h3>
                    <p class="step-description">Match TDS deposited with 26AS/AIS. Verify employee credits. File correction returns if discrepancies.</p>
                    <div class="step-highlights">
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">Prepare for Next Year</h3>
                    <p class="step-description">Update payroll system for Form 143/130 transition. Collect new year declarations. Set quarterly calendar.</p>
                    <div class="step-highlights">
        ...
        <div class="highlight-box" style="margin-top:32px;max-width:1000px;margin-left:auto;margin-right:auto;">
            <p><strong>City Processing Note:</strong> Patron's Gurugram office handles monthly TDS, quarterly 24Q, annual Form 16, and 26AS reconciliation for employers across Gurugram.</p>
        </div>
    </div>
</section>
...
<section class="content-section" id="documents-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <ul>
                    <li><strong>Payroll Data:</strong> Employee-wise salary, allowances, perquisites, deductions. Monthly breakup.</li>
                    <li><strong>Employee PAN:</strong> PAN for each employee. PAN-Aadhaar linking status verified.</li>
                    <li><strong>TDS Challans:</strong> Monthly TDS deposit challans with BSR code, date, and serial number.</li>
                    <li><strong>Additional:</strong> Investment declarations (Form 12BB) | Form 10-IEA (old regime opt-out) | Previous quarter returns.</li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <table>
                    ...
                    <tbody>
                        <tr><td>PAN-Aadhaar Linking Failures</td><td>Unlinked PAN = inoperative = 20% TDS rate instead of slab rate. Diverse Gurugram workforce = varied linking status</td><td>Verify PAN-Aadhaar linking on IT portal before payroll processing. 20% rate hurts employees. Employer liability.</td></tr>
                        <tr><td>Q4 Annexure II Errors</td><td>Errors in salary breakup or regime in Q4 produce wrong Form 16 for every employee. Mass ITR problems</td><td>Triple-check Q4 Annexure II. Verify regime, HRA, S80C for each employee. One systemic error affects hundreds.</td></tr>
                        <tr><td>New vs Old Regime Confusion</td><td>New regime (S115BAC) is default from FY 2023-24. Employees must opt out via Form 10-IEA for old regime</td><td>Collect Form 10-IEA from opt-out employees. Default to new regime. Document regime choice per employee.</td></tr>
                        <tr><td>Multi-TAN Management</td><td>Multi-location: Cyber City + Manesar + Sohna Road. Separate TANs. Each needs separate 24Q. Consolidation complex</td><td>File separate 24Q per TAN. Maintain employee-TAN mapping. Avoid cross-TAN errors. Consolidate for Form 16.</td></tr>
                        <tr><td>Form 143/130 Transition</td><td>All form numbers and sections change from April 2026. Payroll systems must be updated. First Q1 under new Act</td><td>Update payroll and filing software before April 2026. Test with new form numbers. Train HR teams on changes.</td></tr>
                    </tbody>
                </table>
                </div>
            </div>
...
<section class="content-section" id="fees-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">TDS Return Filing Fees in Gurugram 2026</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table class="table-amount">
                    <thead><tr><th>Fee Component</th><th>Amount</th></tr></thead>
                    <tbody>
                        <tr><td>Quarterly Form 24Q Filing</td><td>From Rs 1,500/quarter</td></tr>
                        <tr><td>Monthly TDS Computation + Challan</td><td>Rs 1,000/month</td></tr>
                        <tr><td>Form 16 Generation (TRACES)</td><td>Rs 50/employee</td></tr>
                        <tr><td>Annual Package (4Q + monthly + Form 16)</td><td>From Rs 7,500/year</td></tr>
                        <tr><td>Correction Return</td><td>Rs 1,500-3,000</td></tr>
                        <tr><td>26AS Reconciliation</td><td>Rs 2,000-5,000</td></tr>
                ...
                <p style="margin-top:16px;">No government fee for filing. Late fee Rs 200/day under S234E. Professional fees cover computation, filing, Form 16, and reconciliation. Volume discounts for large employers.</p>
                <p style="margin-top:16px;"><strong>Get a free Copyright Registration consultation - <a href="tel:+919459456700">Call +91 945 945 6700</a> or <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20help%20with%20TDS%20Return%20Filing%20in%20Gurugram.%20Please%20share%20fee%20details." target="_blank">WhatsApp us</a>. No-obligation assessment.</strong></p>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="content-text">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr><td>Q1 Return (Apr-Jun)</td><td>By 31 July</td></tr>
                        <tr><td>Q2 Return (Jul-Sep)</td><td>By 31 October</td></tr>
                        <tr><td>Q3 Return (Oct-Dec)</td><td>By 31 January</td></tr>
                        <tr><td>Q4 Return + Annexure II (Jan-Mar)</td><td>By 31 May (most critical)</td></tr>
                        <tr><td>Form 16 Issuance</td><td>By 15 June</td></tr>
                        <tr><td>Late Fee</td><td>Rs 200/day from due date. S271H: Rs 10K-1L additional</td></tr>
                    </tbody>
                </table>
                </div>
                <div class="highlight-box" style="margin-top:16px;">
                    <p><strong>Note:</strong> TDS by 7th monthly. Q1: 31 Jul. Q2: 31 Oct. Q3: 31 Jan. Q4: 31 May. Form 16: 15 Jun. Rs 200/day late fee.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="section-container">
        ...
        <div class="features-grid">
            <article class="feature-card">
                ...
                <h3 class="feature-title">Monthly TDS</h3>
                <p class="feature-text">S192 computation. Old vs new regime. Investment proofs. Challan generation. Deposit by 7th. Zero delays.</p>
            </article>
            <article class="feature-card">
                ...
                <h3 class="feature-title">Quarterly 24Q</h3>
                <p class="feature-text">All four quarters filed on time. Annexure I accurate. Q4 Annexure II triple-checked. Zero late fees.</p>
            </article>
            <article class="feature-card">
                ...
                <h3 class="feature-title">Form 16 / TRACES</h3>
                <p class="feature-text">TRACES download. Part A and Part B verified. Issued by 15 June. Correct for employee ITR filing.</p>
            </article>
            <article class="feature-card">
                <div class="feature-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg></div>
                <h3 class="feature-title">26AS Reconciliation</h3>
                <p class="feature-text">TDS deposited matches 26AS/AIS. Employee credits verified. Mismatches identified and corrected.</p>
            </article>
            <article class="feature-card">
                ...
                <h3 class="feature-title">PAN-Aadhaar Check</h3>
                <p class="feature-text">Linking status verified before payroll. 20% rate prevention. Employee communication and follow-up.</p>
            </article>
            <article class="feature-card">
                ...
                <p class="feature-text">Form 24Q to 143. Form 16 to 130. S192 to S392. System update. Training. Seamless transition.</p>
            </article>
        </div>
    </div>
</section>
...
<section class="content-section" id="comparison-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">TDS Deposit and Filing Calendar</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table class="table-comparison">
                    <thead><tr><th>Month / Quarter</th><th>TDS Deposit By / Return Due Date</th></tr></thead>
                    <tbody>
                        <tr><td>Q1 (Apr-Jun)</td><td>Deposit: 7th of each month. Return: 31 July</td></tr>
                        <tr><td>Q2 (Jul-Sep)</td><td>Deposit: 7th of each month. Return: 31 October</td></tr>
                        <tr><td>Q3 (Oct-Dec)</td><td>Deposit: 7th of each month. Return: 31 January</td></tr>
                        <tr><td>Q4 (Jan-Mar)</td><td>Deposit: 7th (Jan/Feb), 30 Apr (Mar). Return: 31 May. ANNEXURE II</td></tr>
                        <tr><td>Form 16</td><td>Issue to all employees by 15 June</td></tr>
                        <tr><td>Late Fee</td><td>Rs 200/day under S234E. S271H: Rs 10,000-1,00,000</td></tr>
                    </tbody>
                </table>
                </div>
...
<section class="content-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>TDS on salaries is governed by <strong>Section 192 of the Income Tax Act 1961</strong> (Section 392 from April 2026). <strong>Section 234E</strong>: late filing fee Rs 200/day. <strong>Section 271H</strong>: penalty Rs 10,000-1,00,000. <strong>Form 24Q</strong> under Rule 31A. <strong>Form 16</strong> under Rule 31.</p>
                <p>TDS deposit by <strong>7th monthly</strong>. Late deposit interest: <strong>1.5% per month</strong>. Non-deduction interest: <strong>1% per month</strong>. From April 2026: <strong>Income Tax Act 2025</strong> replaces 1961 Act. Form 24Q becomes <strong>Form 143</strong>. Form 16 becomes <strong>Form 130</strong>.</p>
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    <h2 class="faq-expanded__title">FAQs - TDS Return Filing in Gurugram</h2>
                    <p class="faq-expanded__lead">Answers to common questions about TDS return filing including Form 24Q, Form 16, penalties, PAN-Aadhaar, and April 2026 transition for Gurugram employers.</p>
                    @include('partials.faq-enquiry-form', ['enquiryLocation' => 'Gurugram', 'enquiryService' => 'TDS Return Filing in Gurugram'])
                </aside>
                <div class="faq-expanded__list">
                    <div class="faq-expanded__item" id="faq-1">
                        <h3 class="faq-expanded__q">When must TDS returns be filed?</h3>
                        <div class="faq-expanded__a"><p>Quarterly: Q1 (April-June) by 31 July, Q2 (July-September) by 31 October, Q3 (October-December) by 31 January, Q4 (January-March) by 31 May. TDS must be deposited by the 7th of the following month (March TDS by 30 April). Form 16 must be issued to all employees by 15 June.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-2">
                        <h3 class="faq-expanded__q">How much does TDS return filing cost?</h3>
                        <div class="faq-expanded__a"><p>Quarterly Form 24Q from Rs 1,500 per quarter. Monthly TDS computation Rs 1,000 per month. Form 16 generation Rs 50 per employee. Annual package from Rs 7,500. Correction returns Rs 1,500-3,000. 26AS reconciliation Rs 2,000-5,000. Call +91 945 945 6700 for a detailed quote.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-3">
                        <h3 class="faq-expanded__q">What is the penalty for late TDS filing?</h3>
                        <div class="faq-expanded__a"><p>Total timeline: 2-6 months. Filing and Diary Number: immediate. Mandatory 30-day objection waiting period: 1 month. Reconcile 26AS: 1-3 months. Certificate issuance: after examination approval. If a third-party objection is filed, the timeline extends by 2-4 months for hearing and resolution.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-4">
                        <h3 class="faq-expanded__q">What changes from April 2026?</h3>
                        <div class="faq-expanded__a"><p>Under the new Income Tax Act 2025 effective from April 2026: Form 24Q is replaced by Form 143, Form 16 is replaced by Form 130, Section 192 becomes Section 392, and employee declarations change to Form 122. All payroll systems, HR documentation, and filing processes must be updated before the transition.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-5">
                        <h3 class="faq-expanded__q">What is Form 16 and when is it due?</h3>
                        <div class="faq-expanded__a"><p>Form 16 is the annual TDS certificate issued by the employer to each employee, summarising total salary paid and tax deducted during the financial year. It becomes Form 130 from April 2026. Must be issued by 15 June after the financial year ends. Downloaded from TRACES portal after Q4 return processing. Essential for employees to file their ITR.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-6">
                        <h3 class="faq-expanded__q">What happens if PAN is not linked to Aadhaar?</h3>
                        <div class="faq-expanded__a"><p>If an employee's PAN is not linked to Aadhaar, the PAN becomes inoperative and TDS must be deducted at 20% instead of the applicable income tax slab rate. Gurugram employers must verify PAN-Aadhaar linking status on the income tax portal before processing payroll each month to avoid deducting at the higher rate.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-7">
                        <h3 class="faq-expanded__q">What is the most critical TDS quarter?</h3>
                        <div class="faq-expanded__a"><p>Q4 (January-March) is the most critical. Annexure II, filed only with Q4, contains the complete annual salary breakup for every employee including all deductions, exemptions, and regime classification. Errors in Q4 Annexure II cascade to every Form 16 issued. For IT companies with hundreds of employees, one systemic error creates mass ITR filing problems.</p></div>
                    </div>
                </div>
            </div>
            ...
            <div class="highlight-box" style="margin-top:32px;">
                ...
                <p><strong>TDS return kab file karna hai?</strong> Quarterly: Q1 31 July, Q2 31 Oct, Q3 31 Jan, Q4 31 May. TDS har mahine 7 tarikh tak deposit karo.</p>
                <p><strong>Form 16 kab milta hai?</strong> Employer ko 15 June tak dena zaroori hai. TRACES se download hota hai. April 2026 se Form 130 hoga.</p>
                <p><strong>April 2026 se kya badlega?</strong> 24Q = Form 143. Form 16 = Form 130. Section 192 = Section 392. Naye Income Tax Act 2025 ke under.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section" style="background: var(--orange-lighter) !important; border-left: 4px solid var(--orange);">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Why TDS Return Filing Matters in Gurugram</h2>
            <div class="content-text">
                <p>Late TDS filing costs Rs 200/day under S234E. Q4 Annexure II errors produce wrong Form 16 for every employee. PAN-Aadhaar unlinking triggers 20% TDS. From April 2026, all form numbers change under new Income Tax Act 2025. Gurugram employers must update systems before first Q1 FY 2026-27 filing. Quarterly filing from Rs 1,500 prevents cascading penalties.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section" style="background: var(--blue) !important;">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title" style="color:#FFFFFF !important;">Start Your TDS Return Filing in Gurugram Today</h2>
            <div class="content-text" style="text-align:left;">
                <p style="color:rgba(255,255,255,0.85);">TDS return filing in Gurugram covers quarterly Form 24Q, monthly TDS computation and deposit, TRACES-based Form 16 generation, 26AS reconciliation, correction returns, and Form 143/Form 130 transition from April 2026 for employers across Gurugram.</p>
            ...
            <div style="display:flex;gap:14px;flex-wrap:wrap;margin-top:24px;">
                ...
                <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20help%20with%20TDS%20Return%20Filing%20in%20Gurugram.%20Please%20share%20details." target="_blank" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:#25D366;color:#fff;border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#128172; WhatsApp Us</a>
                <a href="mailto:sales@patronaccounting.com?subject=Enquiry%20for%20TDS%20Return%20Filing%20in%20Gurugram&body=Hello%20Patron%20Accounting%20Team%2C%0A%0AI%20am%20interested%20in%20your%20TDS%20Return%20Filing%20services%20in%20Gurugram%20and%20would%20like%20to%20know%20more.%0A%0APlease%20get%20in%20touch%20with%20me%20at%20your%20earliest%20convenience.%0A%0AThank%20you." style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:transparent;color:#fff;border:2px solid rgba(255,255,255,0.3);border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#9993;&#65039; Email Us</a>
            </div>
        ...
        <div class="text-content">
            ...
            <div class="pa-city-block" style="margin-bottom:40px;">
                <div class="pa-city-grid">
                    ...
                    <a href="/tds-return-filing/mumbai" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Mumbai</div><div class="pa-card-sub">Maharashtra</div></div></a>
            ...
            <div class="pa-city-block">
                ...
                <div class="pa-block-sub">End-to-end support for TDS Return Filing in Gurugram</div>
...
<section class="content-section" style="padding:32px;">
    <div class="content-container">
        <div class="text-content" style="font-size:13px;color:var(--text-muted);">
            ...
            <p>This page is reviewed quarterly for accuracy. Income Tax Act provisions, TDS rates, Form 24Q requirements, S234E penalties, and April 2026 transition details are verified against current CBDT notifications. Gurugram employer landscape validated with each review.</p>
        </div>
    </div>
</section>
