  ...
  "@graph": [
    {
      ...
      "url": "/trademark-opposition/mumbai",
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="trademark-opposition/mumbai" selected>Trademark Opposition in Mumbai</option>
                                ...
                                <option value="trademark-notice-reply/mumbai">Trademark Notice Reply in Mumbai</option>
