  ...
  "@graph": [
    {
      ...
      "url": "/trademark-rectification/gurugram",
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-4 private-registration-heading">
                        Trademark Rectification in Gurugram: Cancel Blocking Marks, Defend Your Registration
                    </h1>
                    ...
                    <div class="mb-4">
                        <div class="d-flex align-items-start mb-3">
                            ...
                            <p class="mb-0 text-dark benefit-paragraph"><span>Documents:</span> Target mark details, evidence of non-use/fraud, your TM application/registration, market research, POA</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Fees:</span> Government: Rs 3,000 (e-filing). Delhi HC: court fees. Professional: Rs 15,000-40,000</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Eligibility:</span> Any aggrieved person - competitor, potential user, anyone whose business interests are affected by the registration</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Timeline:</span> 1-3 years total. Filing to decision. Evidence stages + hearing + Registrar/HC decision</p>
                        </div>
                    </div>
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="mailto:sales@patronaccounting.com?subject=Enquiry%20for%20TM%20Rectification%20in%20Gurugram&body=Hello%20Patron%20Accounting%20Team%2C%0A%0AI%20am%20interested%20in%20your%20TM%20Rectification%20services%20in%20Gurugram%20and%20would%20like%20to%20know%20more.%0A%0APlease%20get%20in%20touch%20with%20me%20at%20your%20earliest%20convenience.%0A%0AThank%20you." class="btn-sample text-decoration-none">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:18px;height:18px;"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,12 2,6"/></svg>
                            Email Us
                        </a>
                        <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20help%20with%20TM%20Rectification%20in%20Gurugram.%20Please%20share%20details." target="_blank" class="btn-sample text-decoration-none">
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - TM Rectification Gurugram'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="trademark-rectification/gurugram" selected>Trademark Rectification in Gurugram</option>
...
<section class="testimonials-section">
    <div class="section-container">
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            ...
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Our application was blocked by S11 citing a mark registered 7 years ago with zero marketplace presence. Patron filed S47 cancellation. Owner couldn't prove use. Mark cancelled. Our application proceeded to registration. Rs 25,000 rectification unlocked our brand.</div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">A competitor filed S47 non-use against our mark in Class 25. Patron compiled 4 years of invoices, advertising records, and product photos. Counter-statement filed with strong evidence. Rectification dismissed. Our registration saved.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div>
                    ...
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Brand Manager, D2C Company, Sohna Road</div>
                    <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                </div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">We missed the 4-month opposition window for a competitor's confusingly similar mark. Patron filed S57 rectification and eventually got the mark varied to exclude our product category. It was costlier than opposition would have been, but it was the only option.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                <div style="width:36px;height:36px;border-radius:50%;background:#10B981;display:flex;align-items:center;justify-content:center;font-weight:700;font-size:13px;color:#fff;flex-shrink:0;">AV</div>
                <div>
                    <div style="font-weight:700;font-size:13px;color:var(--blue);">Arun Verma</div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Patron discovered that a former distributor had registered our product trademark in their own name without authorization. S57 fraud ground. Evidence of our prior use and the distribution agreement. Mark cancelled and restored to us.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                <div style="width:36px;height:36px;border-radius:50%;background:#6366F1;display:flex;align-items:center;justify-content:center;font-weight:700;font-size:13px;color:#fff;flex-shrink:0;">SY</div>
                <div>
                    <div style="font-weight:700;font-size:13px;color:var(--blue);">Suresh Yadav</div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Patron cleared 3 blocking marks for our portfolio filing. All three were 6-8 years unused. S47 cancellation for each. Our 5 applications that were stuck at S11 objection all proceeded after the blocking marks were removed. Portfolio strategy.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
        ...
        <div class="reviews-cta" style="margin-top: 16px; display: flex !important;">
            <div class="reviews-cta-content">
                ...
                <div class="reviews-cta-text">
                    ...
                    <p>Trusted trademark rectification partner for brand owners across Gurugram.</p>
                </div>
            </div>
...
<div class="stats-bar">
    <div class="stats-container">
        <div class="stat-item">
            ...
            <div class="stat-content"><span class="stat-value">10,000+</span><span class="stat-label">Businesses Served</span><span class="stat-desc">Trademark rectification and register clearance across India.</span></div>
        </div>
        <div class="stat-item">
            <div class="stat-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8M12 17v4"/></svg></div>
            <div class="stat-content"><span class="stat-value">15+</span><span class="stat-label">Years Experience</span><span class="stat-desc">Deep expertise in S47/S57 rectification, blocking mark clearance, and TM defence.</span></div>
        </div>
        <div class="stat-item">
            <div class="stat-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><path d="M14 2v6h6M16 13H8M16 17H8"/></svg></div>
            <div class="stat-content"><span class="stat-value">50,000+</span><span class="stat-label">Documents Filed</span><span class="stat-desc">Trademark rectifications, cancellation petitions, and evidence affidavits handled.</span></div>
        </div>
        <div class="stat-item">
...
<section class="content-section" id="overview-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Why Trademark Rectification Matters for Gurugram's Brand Economy</h2>
            <div class="content-text">
                <div class="highlight-box" style="margin-bottom:20px;">
                    <p><strong>&#128204; TL;DR - Trademark Rectification Services at a Glance</strong></p>
                    <p>Trademark rectification is the legal process of correcting, cancelling, or varying a registered trademark. Section 47: removal for non-use (5+ continuous years or no bona fide intention). Section 57: rectification for contravention, error, fraud, or wrongful retention. Filed by any aggrieved person before the Trademark Registry or Delhi High Court. Procedure: application, counter-statement, evidence affidavits, hearing, decision. Burden of proof for non-use falls on the trademark OWNER. Rectification is the ONLY remedy when a blocking mark has already been registered. Form TM-O, Rs 3,000 e-filing.</p>
                </div>
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Parameter</th><th>Detail</th></tr></thead>
                    <tbody>
                        <tr><td>Governing Law</td><td>Trade Marks Act 1999 - S47 (non-use removal), S57 (rectification), S124 (during infringement suit)</td></tr>
                        <tr><td>Who Can File</td><td>Any aggrieved person - competitor, potential user. <a href="https://ipindia.gov.in" target="_blank" rel="noopener">IP India portal</a></td></tr>
                        <tr><td>Section 47 Grounds</td><td>No bona fide intention to use + no use | 5+ years continuous non-use from registration date</td></tr>
                        <tr><td>Section 57 Grounds</td><td>Contravention | Entry without sufficient cause | Wrongly remaining | Error/defect | Fraud</td></tr>
                        <tr><td>Where to File</td><td>Trademark Registry (same office as original filing) OR Delhi High Court (for Haryana/Gurugram)</td></tr>
                        <tr><td>Procedure</td><td>Application > Counter-statement > Evidence (affidavits) > Hearing > Decision > Appeal to Delhi HC</td></tr>
                        <tr><td>Burden of Proof (S47)</td><td>On the trademark OWNER to prove use (not on applicant to prove non-use)</td></tr>
                        <tr><td>Form and Fee</td><td>Form TM-O. Rs 3,000 (e-filing). Professional fees separate. HC filing: court fees additional</td></tr>
                    </tbody>
                </table>
                </div>
                <p>Gurugram businesses encounter rectification needs from two directions. Offensively: startups' applications objected under S11 citing dormant marks need S47 cancellation. Defensively: brands receiving rectification petitions need counter-statements with evidence. For comprehensive information about <a href="/trademark-rectification">trademark rectification across India</a>, visit our national service page.</p>
                <p>India's Register contains thousands of dormant, unused marks that block new applications. For Gurugram companies trying to register brands, these blocking marks are obstacles removable only through S47 rectification. The 5-year non-use threshold means any mark unused since registration can potentially be cancelled. You may also need <a href="/trademark-registration">trademark registration</a> after clearing the block, and <a href="/trademark-opposition">trademark opposition</a> for marks still in the application stage.</p>
        ...
        <div class="two-column">
            <div class="column-content">
                ...
                <div class="content-text what-is-definition">
                    <p>Trademark rectification is the legal process of correcting, cancelling, or varying a registered trademark on the Trademark Register. Section 47 covers removal for non-use. Section 57 covers rectification for contravention, error, fraud, or wrongful retention.</p>
                    <p>Filed by any aggrieved person before the Trademark Registry or Delhi High Court. The registered proprietor files a counter-statement. Evidence is exchanged via affidavits. Hearing is conducted. For S47 non-use, the burden of proof falls on the trademark OWNER to prove use.</p>
                    <p>Rectification is the ONLY remedy when a blocking mark has already been registered (the 4-month opposition window having passed). After cancellation, combine with <a href="/trademark-registration">fresh trademark registration</a> and <a href="#">objection reply</a> for the pending application.</p>
                </div>
                <div class="highlight-box" style="margin-top:20px;">
                    <p><strong>Key Terms for Copyright Registration:</strong></p>
                    <ul>
                        <li><strong>Section 47</strong> - Non-use cancellation for 5+ years of no commercial use</li>
                        <li><strong>Section 57</strong> - Rectification for fraud, error, contravention, wrongful retention</li>
                        <li><strong>Blocking Mark</strong> - Dormant mark on Register preventing new applications</li>
                        <li><strong>Counter-Statement</strong> - Owner's response defending against rectification petition</li>
                        <li><strong>Section 124</strong> - Rectification as defence during infringement proceedings</li>
                    </ul>
                </div>
            </div>
            <div class="column-image">
                <div class="illustration-placeholder">
                    ...
                    <div class="illustration-badge">
                        <span>TM Registry / Delhi HC</span>
                        <strong>S47/S57 Clearance</strong>
                    </div>
                </div>
            </div>
        </div>
...
<section class="content-section" id="who-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Who Needs Trademark Rectification in Gurugram</h2>
            <div class="content-text">
                <ul>
                    <li><strong>Startups and businesses</strong> whose TM applications face S11 objections citing dormant registered marks. The only path to registration is S47 non-use cancellation of the blocking mark, then re-presenting the application.</li>
                    <li><strong>IT companies in DLF Cyber City</strong> seeking to cancel speculatively registered marks similar to their brand names. Tech brand squatting is common in India. S47 non-use or S57 bad faith filing grounds apply.</li>
                    ...
                    <li><strong>Brand owners</strong> whose registered trademarks are challenged through rectification by competitors alleging non-use or invalid registration. Defence requires strong counter-statement with evidence of use.</li>
...
<section class="content-section" id="services-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">6 Trademark Rectification Services Included</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Service</th><th>What We Do</th></tr></thead>
                    <tbody>
                        <tr><td>Non-Use Cancellation (Section 47)</td><td>Filing to remove marks unused for 5+ years. Statement of case with marketplace absence evidence. For blocking marks: coordinating with pending TM application.</td></tr>
                        <tr><td>Rectification Petition (Section 57)</td><td>Filing for fraud, error, contravention, or wrongful retention. Detailed facts and legal arguments. Statement of case with supporting evidence.</td></tr>
                        <tr><td>Defence Against Rectification</td><td>When your mark is challenged: analyzing petition, identifying weaknesses, counter-statement, evidence of genuine use (invoices, ads, products). Burden on YOU for S47.</td></tr>
                        <tr><td>Evidence Preparation</td><td>For filing: market surveys, IP India research, website archives, product availability. For defending: invoices, ads, packaging, media coverage proving use.</td></tr>
                        <tr><td>Hearing Representation</td><td>Appearing before Registrar or Delhi HC. Oral arguments. Evidence presentation. Case law. Arguments tailored to specific ground (non-use, fraud, error).</td></tr>
                        <tr><td>Own Registration Correction (S58)</td><td>Correcting errors in your own registration: proprietor details, address, goods/services description, disclaimers. Administrative process through Registrar.</td></tr>
...
<section class="steps-section" id="procedure-section">
    <div class="section-container">
        <header class="section-header" style="text-align:center;margin-bottom:48px;">
            ...
            <h2 class="section-title">How Trademark Rectification Works: 6-Step Process</h2>
            <p class="section-subtitle" style="text-align:left;max-width:100%;">Our CA-led team handles S47/S57 rectification filing, defence, evidence preparation, hearing representation, and Delhi HC appeal coordination for Gurugram brands.</p>
        </header>
        <div class="steps-container">
            <div class="step-card">
                <div class="step-content">
                    <span class="step-badge">Step 1</span>
                    <h3 class="step-title">Identify Ground and Research</h3>
                    <p class="step-description">Determine S47 (non-use 5+ years) or S57 (fraud/error). Research target mark: marketplace presence, website, products, advertising history.</p>
                    <div class="step-highlights">
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>S47/S57</span>
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Ground Set</span>
                    </div>
                </div>
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">Prepare Statement of Case</h3>
                    <p class="step-description">Draft detailed statement with facts, legal grounds, evidence of non-use or fraud. For S47: prove absence of commercial use. For S57: prove specific ground.</p>
                    <div class="step-highlights">
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Case Drafted</span>
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Facts Ready</span>
                    </div>
                </div>
                <div class="step-visual">
                    <div class="step-illustration">
                        ...
                        <span class="illustration-label">Statement OK</span>
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <p class="step-description">File Form TM-O with Trademark Registry (Rs 3,000 e-filing) or Delhi HC. Registry serves notice on the registered proprietor.</p>
                    <div class="step-highlights">
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>TM-O Filed</span>
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Rs 3,000 Paid</span>
                    </div>
                </div>
                <div class="step-visual">
                    <div class="step-illustration">
                        ...
                        <span class="illustration-label">Served</span>
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">Counter-Statement and Evidence</h3>
                    <p class="step-description">Owner files counter-statement. Evidence exchange via affidavits. For S47: owner must prove use. For S57: applicant proves the ground.</p>
                    <div class="step-highlights">
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Counter Filed</span>
                ...
                <div class="step-visual">
                    <div class="step-illustration">
                        ...
                        <span class="illustration-label">Evidenced</span>
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <p class="step-description">Both parties present before Registrar or HC. Oral arguments. Evidence reviewed. Decision issued: mark cancelled, varied, or petition dismissed.</p>
                    <div class="step-highlights">
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">Post-Decision Action</h3>
                    <p class="step-description">If cancelled: blocking mark removed, your application proceeds. If dismissed: appeal to Delhi HC within 3 months. If defending and mark saved: registration confirmed.</p>
                    <div class="step-highlights">
        ...
        <div class="highlight-box" style="margin-top:32px;max-width:1000px;margin-left:auto;margin-right:auto;">
            <p><strong>City Processing Note:</strong> Patron's Gurugram office on Golf Course Extension Road handles trademark rectification filing, defence, evidence preparation, and hearing representation for brand owners across Gurugram.</p>
        </div>
    </div>
</section>
...
<section class="content-section" id="documents-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Documents Required for Trademark Rectification in Gurugram</h2>
            <div class="content-text">
                <ul>
                    <li><strong>Target Mark Details:</strong> Registration number, class, goods/services, proprietor details. Download from IP India portal.</li>
                    <li><strong>Non-Use Evidence (S47):</strong> Market surveys, website archive checks (Wayback Machine), product search results, advertising absence proof.</li>
                    <li><strong>Use Evidence (Defence):</strong> Sales invoices (dated), advertising materials, product photographs, website traffic data, media coverage, customer testimonials.</li>
                    <li><strong>Additional:</strong> Your TM application/registration details | Statement of case | POA | Board resolution | Legal arguments for specific S57 grounds.</li>
                </ul>
            </div>
        </div>
    </div>
...
<section class="content-section" id="challenges-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">5 Common Trademark Rectification Scenarios in Gurugram</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Challenge</th><th>Impact</th><th>How Patron Accounting Solves It</th></tr></thead>
                    <tbody>
                        <tr><td>Blocking Mark in Section 11 Objection</td><td>D2C brand's application objected citing mark registered 7 years ago with no commercial presence</td><td>S47 cancellation: evidence of 7 years non-use. Burden on owner. No invoices = mark cancelled. D2C brand objection lifted. Registration proceeds.</td></tr>
                        <tr><td>Fraudulent Registration</td><td>Former distributor registered manufacturer's trademark in their own name without authorization</td><td>S57 rectification: fraud/misrepresentation. Evidence of manufacturer's prior use plus distribution agreement. Mark cancelled or transferred.</td></tr>
                        <tr><td>Defending Against Non-Use Cancellation</td><td>Corporate brand faces S47 petition for class with minimal use. Evidence is thin</td><td>Compile every invoice, ad, product listing in that class. Even minimal use may constitute bona fide use. Argue special circumstances (S47(3)). Start using mark now.</td></tr>
                        <tr><td>Post-Opposition Remedy - Missed Window</td><td>Business discovers competitor's registered mark but 4-month opposition window closed</td><td>S57 rectification is the only remaining option. Costlier and longer than opposition. File with strong grounds. TM Journal monitoring would have prevented this.</td></tr>
                        <tr><td>Multiple Blocking Marks in Same Class</td><td>Startup's application faces S11 objection citing 3 different dormant marks</td><td>Separate S47 petition for each blocking mark. Bulk filing strategy. Coordinate all cancellations to clear the way simultaneously. Portfolio clearance approach.</td></tr>
                    </tbody>
                </table>
                </div>
            </div>
...
<section class="content-section" id="fees-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Trademark Rectification Fees in Gurugram 2026</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table class="table-amount">
                    <thead><tr><th>Fee Component</th><th>Amount</th></tr></thead>
                    <tbody>
                        <tr><td>S47 Non-Use Cancellation Filing</td><td>Rs 3,000 govt + Rs 15,000-30,000 professional</td></tr>
                        <tr><td>S57 Rectification Filing</td><td>Rs 3,000 govt + Rs 15,000-35,000 professional</td></tr>
                        <tr><td>Defence Against Rectification</td><td>Rs 15,000-40,000 professional</td></tr>
                        <tr><td>Evidence Preparation (Affidavits)</td><td>Rs 5,000-10,000</td></tr>
                        <tr><td>Hearing Representation</td><td>Rs 8,000-15,000</td></tr>
                        <tr><td>Delhi HC Filing and Appearance</td><td>Rs 20,000-50,000 + court fees</td></tr>
                ...
                <p style="margin-top:16px;">Government fee: Rs 3,000 for Form TM-O (e-filing). Professional fees cover statement of case, evidence, and hearing. Delhi HC filing involves additional court fees.</p>
                <p style="margin-top:16px;"><strong>Get a free Copyright Registration consultation - <a href="tel:+919459456700">Call +91 945 945 6700</a> or <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20help%20with%20TM%20Rectification%20in%20Gurugram.%20Please%20share%20fee%20details." target="_blank">WhatsApp us</a>. No-obligation assessment.</strong></p>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section" id="timeline-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Trademark Rectification Timeline in Gurugram</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Stage</th><th>Estimated Timeline</th></tr></thead>
                    <tbody>
                        <tr><td>Rectification Application Filing</td><td>1-2 weeks</td></tr>
                        <tr><td>Counter-Statement by Owner</td><td>2-3 months from notice</td></tr>
                        <tr><td>Evidence Stages (Affidavits)</td><td>4-8 months total</td></tr>
                        <tr><td>Hearing Scheduling</td><td>3-6 months after evidence</td></tr>
                        <tr><td>Registrar Decision</td><td>1-3 months after hearing</td></tr>
                        <tr><td>Total Duration</td><td>1-3 years from filing to decision</td></tr>
                        <tr><td>Appeal to Delhi HC</td><td>Within 3 months of Registrar order</td></tr>
                    </tbody>
                </table>
                </div>
                <div class="highlight-box" style="margin-top:16px;">
                    <p><strong>Note:</strong> Rectification takes 1-3 years from filing to decision. Evidence stages are the longest phase. Patron pushes for earliest hearing dates and manages all deadlines proactively.</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="why-choose-section" id="benefits-section">
    <div class="section-container">
        <div style="text-align:center;margin-bottom:48px;">
            ...
            <h2 class="section-title">Why Choose Patron for Trademark Rectification in Gurugram</h2>
        </div>
        <div class="features-grid">
            <article class="feature-card">
                ...
                <h3 class="feature-title">S47 Non-Use Cancellation</h3>
                <p class="feature-text">Removing marks unused for 5+ years from the Register. Burden on owner to prove use. Clearing blocking marks for your pending applications.</p>
            </article>
            <article class="feature-card">
                ...
                <h3 class="feature-title">S57 Rectification</h3>
                <p class="feature-text">Challenging marks registered through fraud, error, or contravention. Detailed statement of case with evidence. Registry or Delhi HC filing.</p>
            </article>
            <article class="feature-card">
                ...
                <h3 class="feature-title">Defence Strategy</h3>
                <p class="feature-text">When YOUR mark is challenged: comprehensive counter-statement with evidence of genuine use. Invoices, ads, products. Burden on you under S47 - we build the proof.</p>
            </article>
            <article class="feature-card">
                <div class="feature-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg></div>
                <h3 class="feature-title">Blocking Mark Clearance</h3>
                <p class="feature-text">Identifying and cancelling marks cited in S11 objections. Coordinating cancellation with pending TM application. One engagement clears the path.</p>
            </article>
            <article class="feature-card">
                ...
                <p class="feature-text">Market research, website archives, product surveys, advertising records. Building the case that a mark is unused (filing) or proving use (defending).</p>
            </article>
            <article class="feature-card">
                ...
                <p class="feature-text">Filing and arguing rectification before the Delhi High Court. Appeals from Registrar decisions. Full court proceeding representation.</p>
            </article>
        </div>
    </div>
</section>
...
<section class="content-section" id="comparison-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Section 47 vs Section 57 Comparison</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table class="table-comparison">
                    <thead><tr><th>Aspect</th><th>Section 47 vs Section 57</th></tr></thead>
                    <tbody>
                        <tr><td>Primary Ground</td><td>S47: Non-use 5+ years or no bona fide intention. S57: Contravention, error, fraud, wrongful retention</td></tr>
                        <tr><td>Burden of Proof</td><td>S47: On the OWNER to prove use. S57: On the APPLICANT to prove the ground</td></tr>
                        <tr><td>Who Files</td><td>Both: Any aggrieved person. Broadly interpreted. Competitor, potential user, public interest</td></tr>
                        <tr><td>Forum</td><td>Both: Trademark Registry or Delhi High Court</td></tr>
                        <tr><td>Evidence Focus</td><td>S47: Absence of use. S57: Fraud evidence, error documentation, legal analysis</td></tr>
                        <tr><td>Common Use</td><td>S47: Clearing blocking marks. S57: Challenging fraudulent or erroneous registrations</td></tr>
                    </tbody>
                </table>
                </div>
                <p style="margin-top:12px;">External Authority: <a href="https://ipindia.gov.in" target="_blank" rel="noopener">TM Registry / Delhi HC (ipindia.gov.in)</a></p>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>Trademark rectification is governed by <strong>Sections 47 and 57 of the Trade Marks Act 1999</strong>. Section 47 provides for removal on grounds of non-use. Section 57 provides for rectification of the Register. Section 124 allows rectification as a defence during infringement proceedings.</p>
                <p>For S47 non-use claims, the <strong>burden of proof</strong> falls on the registered trademark owner to demonstrate genuine commercial use. The applicant only needs to show the mark has been on the Register for 5+ years. This reversed burden makes S47 a powerful tool against dormant marks.</p>
                <p>Since IPAB was abolished in 2021, rectification applications and appeals go to the <strong>Delhi High Court</strong> for Haryana/Gurugram matters. The <a href="https://ipindia.gov.in" target="_blank" rel="noopener">IP India portal (ipindia.gov.in)</a> hosts the Trademark Register and e-filing facility. Rectification is the only post-registration remedy when the 4-month opposition window has passed.</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    <h2 class="faq-expanded__title">FAQs - Trademark Rectification in Gurugram</h2>
                    <p class="faq-expanded__lead">Answers to common questions about trademark rectification including S47 non-use, S57 grounds, blocking mark clearance, and defence strategy for Gurugram brands.</p>
                    @include('partials.faq-enquiry-form', ['enquiryLocation' => 'Gurugram', 'enquiryService' => 'Trademark Rectification in Gurugram'])
                </aside>
                <div class="faq-expanded__list">
                    <div class="faq-expanded__item" id="faq-1">
                        <h3 class="faq-expanded__q">Can a registered trademark be cancelled or removed?</h3>
                        <div class="faq-expanded__a"><p>Yes. Section 47 allows removal for non-use: if a mark has not been used for 5 continuous years from the date of registration, or was registered without bona fide intention to use. Section 57 allows rectification for contravention of conditions, entry without sufficient cause, mark wrongly remaining on the Register, error or defect, or fraud/misrepresentation. Any aggrieved person can file.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-2">
                        <h3 class="faq-expanded__q">How much does trademark rectification cost?</h3>
                        <div class="faq-expanded__a"><p>Government fee: Rs 3,000 (e-filing Form TM-O). Professional: Rs 15,000-35,000 for filing. Defence against rectification: Rs 15,000-40,000. Evidence preparation: Rs 5,000-10,000. Hearing representation: Rs 8,000-15,000. Delhi HC filing: Rs 20,000-50,000 plus court fees. Call +91 945 945 6700 for a detailed quote.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-3">
                        <h3 class="faq-expanded__q">Who bears the burden of proof in non-use cancellation?</h3>
                        <div class="faq-expanded__a"><p>Total timeline: 2-6 months. Filing and Diary Number: immediate. Mandatory 30-day objection waiting period: 1 month. Hearing: 1-3 months. Certificate issuance: after examination approval. If a third-party objection is filed, the timeline extends by 2-4 months for hearing and resolution.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-4">
                        <h3 class="faq-expanded__q">Can I clear a blocking mark for my trademark application?</h3>
                        <div class="faq-expanded__a"><p>Yes. If your application faces a Section 11 objection citing a prior registered mark that is dormant or unused, you can file a Section 47 non-use cancellation petition. Once the blocking mark is cancelled, the S11 objection is lifted and your application proceeds to registration. This is one of the most common strategic uses of trademark rectification.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-5">
                        <h3 class="faq-expanded__q">How is rectification different from opposition?</h3>
                        <div class="faq-expanded__a"><p>Opposition is filed BEFORE a mark is registered (within the 4-month window after Trademark Journal publication). Rectification is filed AFTER a mark has already been registered. Rectification is costlier and takes longer than opposition (1-3 years vs several months). This is why Trademark Journal monitoring is important - filing opposition within the 4-month window prevents the need for costlier rectification.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-6">
                        <h3 class="faq-expanded__q">Where do I file rectification for Gurugram?</h3>
                        <div class="faq-expanded__a"><p>Before the Trademark Registry (the same office where the original mark was filed) or the Delhi High Court. For Haryana/Gurugram matters, the Delhi High Court has jurisdiction. Since IPAB was abolished in 2021, all appeals from Registrar decisions also go directly to the Delhi High Court.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-7">
                        <h3 class="faq-expanded__q">How long does trademark rectification take?</h3>
                        <div class="faq-expanded__a"><p>1 to 3 years from filing to decision. Filing and counter-statement phase: 3-6 months. Evidence stages via affidavits: 4-8 months. Hearing scheduling: 3-6 months. Registrar decision: 1-3 months after hearing. Appeal to Delhi High Court (if filed): additional 6-12 months. The evidence stage is typically the longest phase.</p></div>
                    </div>
                </div>
            </div>
            ...
            <div class="highlight-box" style="margin-top:32px;">
                ...
                <p><strong>Blocking mark hata sakte hain?</strong> Haan. Agar registered mark 5+ saal se use nahi hua (S47), ya fraud se registered hai (S57), toh cancellation petition file karke hata sakte ho. Registrar ya Delhi HC mein file karo.</p>
                <p><strong>Mere mark pe rectification aaya toh?</strong> Counter-statement file karo with evidence of use - invoices, advertisements, products. Burden aap pe hai (owner) use prove karne ka. Strong evidence = mark safe.</p>
                <p><strong>Opposition se alag kaise?</strong> Opposition registration se PEHLE (4 months window). Rectification registration ke BAAD. Rectification longer aur costlier hai. Isliye TM Journal monitoring rakho aur opposition time pe karo.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section" style="background: var(--orange-lighter) !important; border-left: 4px solid var(--orange);">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Why Trademark Rectification Matters for Gurugram's Brand Economy</h2>
            <div class="content-text">
                <p>A Gurugram SaaS company's application is objected under S11 citing a mark registered 8 years ago. Research reveals: no website, no app, no product, no advertising - complete marketplace absence. Patron files S47 cancellation. The owner cannot produce a single invoice proving use. Burden on owner under S47. Mark cancelled. S11 objection lifted. Application proceeds. Cost: Rs 30,000-50,000. Value unlocked: unimpeded registration for a platform generating Rs 3 crore annual revenue.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section" style="background: var(--blue) !important;">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title" style="color:#FFFFFF !important;">Start Your Trademark Rectification in Gurugram Today</h2>
            <div class="content-text" style="text-align:left;">
                <p style="color:rgba(255,255,255,0.85);">Trademark Rectification in Gurugram enables the cancellation, correction, or variation of registered trademarks through Section 47 (non-use removal for 5+ years) and Section 57 (rectification for fraud, error, contravention) - clearing blocking marks from the Register and protecting legitimate registrations through evidence-based proceedings.</p>
                <p style="color:rgba(255,255,255,0.85);">Patron Accounting's Gurugram office on Golf Course Extension Road handles trademark rectification filing, defence against rectification, evidence preparation, hearing representation, and Delhi HC appeal coordination for startups, corporates, D2C brands, and manufacturers across Gurugram.</p>
            ...
            <div style="display:flex;gap:14px;flex-wrap:wrap;margin-top:24px;">
                ...
                <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20help%20with%20TM%20Rectification%20in%20Gurugram.%20Please%20share%20details." target="_blank" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:#25D366;color:#fff;border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#128172; WhatsApp Us</a>
                <a href="mailto:sales@patronaccounting.com?subject=Enquiry%20for%20TM%20Rectification%20in%20Gurugram&body=Hello%20Patron%20Accounting%20Team%2C%0A%0AI%20am%20interested%20in%20your%20TM%20Rectification%20services%20in%20Gurugram%20and%20would%20like%20to%20know%20more.%0A%0APlease%20get%20in%20touch%20with%20me%20at%20your%20earliest%20convenience.%0A%0AThank%20you." style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:transparent;color:#fff;border:2px solid rgba(255,255,255,0.3);border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#9993;&#65039; Email Us</a>
            </div>
...
<section class="content-section" style="padding:48px 32px;background:var(--gray-50);">
    <div class="content-container">
        <div class="text-content">
            ...
            <p style="text-align:center;color:var(--text-muted);font-size:15px;margin-bottom:40px;">Trademark rectification services available across India with local office support.</p>
            ...
            <div class="pa-city-block">
                ...
                <div class="pa-block-sub">End-to-end support for Trademark Rectification in Gurugram</div>
...
<section class="content-section" style="padding:32px;">
    <div class="content-container">
        <div class="text-content" style="font-size:13px;color:var(--text-muted);">
            ...
            <p>This page is reviewed quarterly for accuracy. Trade Marks Act 1999 S47/S57 provisions, Registrar procedures, Delhi HC filing requirements, and evidence standards are verified against current practices. Gurugram brand ecosystem information is validated with each review.</p>
        </div>
    </div>
</section>
