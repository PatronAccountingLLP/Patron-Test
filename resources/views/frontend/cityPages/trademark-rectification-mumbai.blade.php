        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'trademark-rectification/mumbai',
                    'options'  => [
                        'trademark-rectification/mumbai' => 'Trademark Rectification in Mumbai',
                        'trademark-registration/mumbai' => 'Trademark Registration in Mumbai',
                        'trademark-opposition/mumbai' => 'Trademark Opposition in Mumbai',
