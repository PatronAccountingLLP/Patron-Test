...
@section('meta')
    ...
    <meta name="description" content="CA-assisted trademark registration in Chennai via IP India. Rs 4,500/class for startups. TM Registry Chennai filing. Serving OMR, T. Nagar brands.">
...
@section('schema')
    @include('partials.city-localbusiness', ['citySlug' => 'chennai', 'pageUrl' => '/trademark-registration/chennai'])
