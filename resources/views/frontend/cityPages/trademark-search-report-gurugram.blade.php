  ...
  "@graph": [
    {
      ...
      "url": "/trademark-search-report/gurugram",
        ...
        <div class="row align-items-center">
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-4 private-registration-heading">
                        Trademark Search Report in Gurugram: Know Before You File
                    </h1>
                    ...
                    <div class="mb-4">
                        <div class="d-flex align-items-start mb-3">
                            ...
                            <p class="mb-0 text-dark benefit-paragraph"><span>Documents:</span> Proposed brand name, logo (if applicable), business description, target goods/services</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Fees:</span> Basic: Rs 999-2,499. Comprehensive: Rs 3,999-7,999. Search + filing bundle: Rs 7,999-14,999</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Eligibility:</span> Any business or individual planning to file a trademark application or evaluating a brand name</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Timeline:</span> Basic: 2-4 hours. Comprehensive: 4-24 hours. Multi-class: 1-3 business days</p>
                        </div>
                    </div>
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="mailto:sales@patronaccounting.com?subject=Enquiry%20for%20TM%20Search%20Report%20in%20Gurugram&body=Hello%20Patron%20Accounting%20Team%2C%0A%0AI%20am%20interested%20in%20your%20TM%20Search%20Report%20services%20in%20Gurugram%20and%20would%20like%20to%20know%20more.%0A%0APlease%20get%20in%20touch%20with%20me%20at%20your%20earliest%20convenience.%0A%0AThank%20you." class="btn-sample text-decoration-none">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:18px;height:18px;"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,12 2,6"/></svg>
                            Email Us
                        </a>
                        <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20help%20with%20TM%20Search%20Report%20in%20Gurugram.%20Please%20share%20details." target="_blank" class="btn-sample text-decoration-none">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'trademark-search-report/gurugram',
                    'options'  => [
                        'trademark-search-report/gurugram' => 'Trademark Search Report in Gurugram',
...
<section class="testimonials-section">
    <div class="section-container">
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            ...
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Patron's search report found 3 phonetically similar marks in Class 42 for our proposed SaaS brand name. We modified the name before filing. Zero objections. Registered in 8 months. The Rs 5,000 search saved us from a certain S11 objection and months of hearing.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div>
                    <div style="font-weight:700;font-size:13px;color:var(--blue);">Rohit Verma</div>
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Founder, SaaS Startup, DLF Cyber City</div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">We almost filed our D2C brand without a search. Patron found an identical mark in our class - registered 2 years ago. We chose an alternative name that tested completely clear. Saved us from certain objection and potential Rs 15 lakh rebranding.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                <div style="width:36px;height:36px;border-radius:50%;background:var(--blue);display:flex;align-items:center;justify-content:center;font-weight:700;font-size:13px;color:#fff;flex-shrink:0;">NS</div>
                <div>
                    <div style="font-weight:700;font-size:13px;color:var(--blue);">Neha Sharma</div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Patron's multi-database search found a Madrid Protocol mark designating India that our IP India self-search completely missed. That international mark would have caused certain opposition. The ROMARIN database coverage justified the professional search cost.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                <div style="width:36px;height:36px;border-radius:50%;background:#10B981;display:flex;align-items:center;justify-content:center;font-weight:700;font-size:13px;color:#fff;flex-shrink:0;">AK</div>
                <div>
                    <div style="font-weight:700;font-size:13px;color:var(--blue);">Arun Kapoor</div>
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Legal Head, Corporate, Golf Course Road</div>
                    <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                </div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">We used the search + filing bundle: comprehensive search on Monday, application filed on Wednesday. Clear report, immediate filing. No gap for competitors to file similar names. Seamless from search to application. Best value for startups.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                <div style="width:36px;height:36px;border-radius:50%;background:#6366F1;display:flex;align-items:center;justify-content:center;font-weight:700;font-size:13px;color:#fff;flex-shrink:0;">AJ</div>
                <div>
                    <div style="font-weight:700;font-size:13px;color:var(--blue);">Amit Jain</div>
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Co-founder, Tech Startup, Gurugram</div>
                    <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                </div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Patron searched our logo using Vienna Code and found 2 similar device marks. They recommended specific design modifications to our logo before filing. Modified logo registered without objection. The Vienna Code search for logos is something most providers don't offer.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div>
                    ...
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Design Head, Brand Agency, Gurugram</div>
                    <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                </div>
        ...
        <div class="reviews-cta" style="margin-top: 16px; display: flex !important;">
            <div class="reviews-cta-content">
                ...
                <div class="reviews-cta-text">
                    ...
                    <p>Trusted trademark clearance partner for brand owners across Gurugram.</p>
                </div>
            </div>
...
<div class="stats-bar">
    <div class="stats-container">
        <div class="stat-item">
            ...
            <div class="stat-content"><span class="stat-value">10,000+</span><span class="stat-label">Businesses Served</span><span class="stat-desc">Trademark search and brand clearance across India.</span></div>
        </div>
        <div class="stat-item">
            <div class="stat-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8M12 17v4"/></svg></div>
            <div class="stat-content"><span class="stat-value">15+</span><span class="stat-label">Years Experience</span><span class="stat-desc">Deep expertise in trademark search, clearance analysis, and registrability opinions.</span></div>
        </div>
        <div class="stat-item">
            <div class="stat-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><path d="M14 2v6h6M16 13H8M16 17H8"/></svg></div>
            <div class="stat-content"><span class="stat-value">50,000+</span><span class="stat-label">Documents Filed</span><span class="stat-desc">Trademark searches, clearance reports, and filing strategy documents handled.</span></div>
        </div>
        <div class="stat-item">
            <div class="stat-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="8" r="7"/><path d="M8.21 13.89L7 23l5-3 5 3-1.21-9.12"/></svg></div>
            <div class="stat-content"><span class="stat-value">4.9&#9733;</span><span class="stat-label">Client Rating</span><span class="stat-desc">Trusted by startups, D2C brands, corporates, and manufacturers.</span></div>
        </div>
...
<section class="content-section" id="overview-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Why Trademark Search Report Matters for Gurugram Brands</h2>
            <div class="content-text">
                <div class="highlight-box" style="margin-bottom:20px;">
                    <p><strong>&#128204; TL;DR - Trademark Search Report Services at a Glance</strong></p>
                    <p>A Trademark Search Report is a comprehensive pre-filing analysis identifying existing marks identical or similar to your proposed brand across IP India, Madrid Protocol (ROMARIN), MCA company names, and common law sources. Covers: wordmark (text match), phonetic (sound similarity - most common S11 objection reason), and Vienna Code (logo similarity). Results are risk-rated (high/medium/low), analyzed for registrability under S9 and S11, with filing strategy (proceed, modify, or abandon). Cost: Rs 3,999-7,999. Cost of filing without search and facing objection/opposition/rebranding: Rs 50,000-5,00,000+.</p>
                </div>
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Parameter</th><th>Detail</th></tr></thead>
                    <tbody>
                        <tr><td>What</td><td>Pre-filing analysis identifying existing marks conflicting with your proposed brand</td></tr>
                        <tr><td>Databases</td><td><a href="https://tmrsearch.ipindia.gov.in" target="_blank" rel="noopener">IP India</a> + WIPO ROMARIN (Madrid) + MCA company names + common law/market</td></tr>
                        <tr><td>Search Types</td><td>Wordmark (text) + Phonetic (sound) + Vienna Code (logo) across relevant NICE classes</td></tr>
                        <tr><td>NICE Classes</td><td>45 classes (1-34 goods, 35-45 services). Search covers all relevant classes for your business</td></tr>
                        <tr><td>Risk Assessment</td><td>Identical (high), phonetically similar (high), visually similar (medium-high), conceptually similar (medium)</td></tr>
                        <tr><td>Report Contents</td><td>Conflicting marks list + risk rating + registrability opinion + filing strategy + class recommendation</td></tr>
                        <tr><td>Why Essential</td><td>Prevents S11 objections, oppositions, infringement claims, and rebranding. Saves months and lakhs</td></tr>
                        <tr><td>Timeline</td><td>Basic: 2-4 hours. Comprehensive: 4-24 hours. Multi-class: 1-3 business days</td></tr>
                    </tbody>
                </table>
                </div>
                <p>Gurugram's business ecosystem generates thousands of new brand names every year. IT startups in DLF Cyber City launch platforms with coined names. D2C brands on Sohna Road create consumer product names. Corporates on Golf Course Road extend portfolios. Manufacturers in Udyog Vihar develop product marks. Every name exists in a crowded landscape where conflict probability is high. For comprehensive information about <a href="/trademark-search-report">trademark search reports across India</a>, visit our national service page.</p>
                <p>The most common expensive mistake: a startup files an application, launches the brand, invests Rs 10-50 lakh in marketing, then receives a S11 objection citing a phonetically similar prior mark. The startup must fight (costly, uncertain) or rebrand (lose entire investment). A comprehensive search (Rs 5,000-8,000) identifies conflicts before the first rupee is spent on branding. You should follow the search with <a href="/trademark-registration">trademark registration</a> for clear brands and <a href="#">trademark objection reply</a> if objections do arise.</p>
        ...
        <div class="two-column">
            <div class="column-content">
                ...
                <div class="content-text what-is-definition">
                    <p>A Trademark Search Report is a pre-filing analysis identifying existing trademarks identical or similar to your proposed brand name or logo across multiple databases. The search determines whether your proposed mark can be registered without conflict.</p>
                    <p>Three search dimensions: wordmark (text), phonetic (sound similarity), and Vienna Code (figurative/logo elements). Results are risk-rated and accompanied by a registrability opinion under Section 9 (absolute) and Section 11 (relative) of the Trade Marks Act 1999.</p>
                    <p>The report includes a filing strategy: proceed (clear), proceed with caution, modify (specific changes), or abandon (high-risk). For complete brand protection, follow with <a href="/trademark-registration">trademark registration</a> and <a href="/copyright-registration">copyright registration</a> for creative works.</p>
                </div>
                <div class="highlight-box" style="margin-top:20px;">
                    <p><strong>Key Terms for Copyright Registration:</strong></p>
                    <ul>
                        <li><strong>Wordmark Search</strong> - Text-based search for identical and similar brand names</li>
                        <li><strong>Phonetic Search</strong> - Sound-similarity search for deceptively similar marks</li>
                        <li><strong>Vienna Code</strong> - Logo similarity search using figurative element classification</li>
                        <li><strong>NICE Classification</strong> - 45 classes for goods and services in trademark</li>
                        <li><strong>Registrability Opinion</strong> - Professional S9/S11 assessment of registration likelihood</li>
                    </ul>
                </div>
            </div>
            <div class="column-image">
                <div class="illustration-placeholder">
                    ...
                    <div class="illustration-badge">
                        <span>IP India Search Portal</span>
                        <strong>Pre-Filing Clearance</strong>
                    </div>
                </div>
            </div>
        </div>
...
<section class="content-section" id="who-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Who Needs a Trademark Search Report in Gurugram</h2>
            <div class="content-text">
                <ul>
                    <li><strong>Startups</strong> in DLF Cyber City and across Gurugram finalizing brand names before filing. The search report is the first step - it determines whether the chosen name is worth filing or needs modification.</li>
                    <li><strong>IT and SaaS companies</strong> selecting product, platform, or service brand names. Tech trademark space is densely populated. Classes 9, 35, and 42 have the highest conflict rates.</li>
                    ...
                    <li><strong>Corporates on Golf Course Road</strong> extending brand portfolios into new product lines. Before launching a sub-brand, a search ensures no conflicts in the target class.</li>
...
<section class="content-section" id="services-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">6 Trademark Search Report Services Included</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Service</th><th>What We Do</th></tr></thead>
                    <tbody>
                        <tr><td>Wordmark Search</td><td>IP India database for identical and similar text marks using start-with, contains, and match options across all relevant NICE classes. Identifying exact matches and close variants.</td></tr>
                        <tr><td>Phonetic Search</td><td>Identifying marks that sound similar regardless of spelling. Most common reason for S11 objections. Critical search that self-conducted searches often miss.</td></tr>
                        <tr><td>Vienna Code Search (Logo)</td><td>For device and composite marks: searching figurative elements using Vienna Classification. Identifying logos with similar visual elements.</td></tr>
                        <tr><td>Multi-Database Coverage</td><td>Beyond IP India: WIPO ROMARIN (Madrid designations), MCA company names, domain registrations, and common law/market presence (Google, social media, e-commerce).</td></tr>
                        <tr><td>Risk Assessment and Opinion</td><td>Rating conflicts as high/medium/low risk. Registrability analysis under S9 and S11. Final opinion on likelihood of successful registration.</td></tr>
                        <tr><td>Filing Strategy Recommendation</td><td>Based on results: proceed (clear), proceed with caution, modify (specific changes), or abandon. Class recommendation. Search + filing bundle available.</td></tr>
...
<section class="steps-section" id="procedure-section">
    <div class="section-container">
        <header class="section-header" style="text-align:center;margin-bottom:48px;">
            ...
            <h2 class="section-title">How Trademark Search Report Works: 5-Step Process</h2>
            <p class="section-subtitle" style="text-align:left;max-width:100%;">Our CA-led team conducts multi-database trademark searches with risk-rated reports, registrability opinions, and filing strategy recommendations for Gurugram brands.</p>
        </header>
        <div class="steps-container">
            <div class="step-card">
                <div class="step-content">
                    <span class="step-badge">Step 1</span>
                    <h3 class="step-title">Define Brand and Classes</h3>
                    <p class="step-description">Confirm proposed brand name (wordmark) and logo (device mark if applicable). Identify relevant NICE classes for your goods/services. IT: Classes 9, 35, 42.</p>
                    <div class="step-highlights">
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Name Set</span>
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Classes ID</span>
                    </div>
                </div>
                <div class="step-visual">
                    <div class="step-illustration">
                        ...
                        <span class="illustration-label">Brand Ready</span>
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">Conduct Multi-Database Search</h3>
                    <p class="step-description">Wordmark + phonetic + Vienna Code across IP India, WIPO ROMARIN, MCA company names, and market/common law sources. All relevant classes searched.</p>
                    <div class="step-highlights">
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>All DBs Searched</span>
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Reports In</span>
                    </div>
                </div>
                <div class="step-visual">
                    <div class="step-illustration">
                        ...
                        <span class="illustration-label">Searched</span>
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">Analyze and Risk-Rate Conflicts</h3>
                    <p class="step-description">Rate each conflicting mark as high, medium, or low risk based on visual, phonetic, and conceptual similarity, class overlap, and mark status (registered/pending/expired).</p>
                    <div class="step-highlights">
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Rated</span>
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Assessed</span>
                    </div>
                </div>
                <div class="step-visual">
                    <div class="step-illustration">
                        ...
                        <span class="illustration-label">Analyzed</span>
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">Registrability Opinion</h3>
                    <p class="step-description">Professional assessment under S9 (absolute) and S11 (relative) grounds. Likelihood of successful registration. Specific risks identified and addressed.</p>
                    <div class="step-highlights">
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>S9/S11 Clear</span>
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Opinion Done</span>
                    </div>
                </div>
                <div class="step-visual">
                    <div class="step-illustration">
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">Filing Strategy Recommendation</h3>
                    <p class="step-description">Proceed (clear path), proceed with caution (minor conflicts), modify (changes recommended), or abandon (high-risk). Class recommendation. Immediate action plan.</p>
                    <div class="step-highlights">
                        ...
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Go/No-Go</span>
                    </div>
                </div>
                <div class="step-visual">
                    <div class="step-illustration">
            ...
            <div class="step-card">
                <div class="step-content">
                    ...
                    <h3 class="step-title">File Application</h3>
                    <p class="step-description">If clear: file trademark application immediately through search + filing bundle. Do not delay - databases update daily. From search to filing within the same week.</p>
                    <div class="step-highlights">
                        ...
                        <span class="highlight-tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>On Track</span>
                    </div>
                </div>
                <div class="step-visual">
                    <div class="step-illustration">
                        ...
                        <span class="illustration-label">Applied</span>
        ...
        <div class="highlight-box" style="margin-top:32px;max-width:1000px;margin-left:auto;margin-right:auto;">
            <p><strong>City Processing Note:</strong> Patron's Gurugram office on Golf Course Extension Road conducts trademark search reports with multi-database coverage and filing strategy recommendations for brand owners across Gurugram.</p>
        </div>
    </div>
</section>
...
<section class="content-section" id="documents-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Information Required for Trademark Search Report in Gurugram</h2>
            <div class="content-text">
                <ul>
                    <li><strong>Proposed Brand Name:</strong> Exact wordmark text as you intend to file. Include any alternative spellings or variations being considered.</li>
                    <li><strong>Logo (if applicable):</strong> High-resolution image of proposed logo/device mark for Vienna Code search.</li>
                    <li><strong>Business Description:</strong> Description of goods/services to determine correct NICE classes. Nature of business, target market, product categories.</li>
                    <li><strong>Additional:</strong> Preferred NICE classes (if known) | Competitor brand names for comparison | Any existing trademark applications or registrations.</li>
                </ul>
            </div>
        </div>
    </div>
...
<section class="content-section" id="challenges-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">5 Common Trademark Search Challenges in Gurugram</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Challenge</th><th>Impact</th><th>How Patron Accounting Solves It</th></tr></thead>
                    <tbody>
                        <tr><td>Self-Search Missing Phonetic Conflicts</td><td>Startup searches wordmark on IP India, finds no match, files. S11 objection cites phonetically similar mark only visible in phonetic search</td><td>Professional phonetic search catches sound-similar marks that wordmark search misses. Phonetic similarity is the #1 reason for S11 objections.</td></tr>
                        <tr><td>Wrong Class Searched</td><td>SaaS company searches Class 9 only but Examiner also considers Class 42 and Class 35 for related services</td><td>Comprehensive search covers all relevant and related classes. IT brands need Classes 9, 35, and 42 minimum. Professional class advisory prevents gaps.</td></tr>
                        <tr><td>Ignoring Madrid Protocol Designations</td><td>IP India public search misses international marks designating India via Madrid Protocol</td><td>WIPO ROMARIN database search catches Madrid designations. International brands with India coverage create valid opposition grounds.</td></tr>
                        <tr><td>Filing After Delay - Database Updated</td><td>Search conducted in January, filing delayed to June. Competitor files identical mark in March</td><td>File immediately after receiving a clear search report. Databases update daily. Every day of delay is a day competitors could file. Search + filing bundle eliminates this risk.</td></tr>
                        <tr><td>Relying on Free Portal Only</td><td>Free IP India search misses phonetic matches, Madrid marks, MCA conflicts, and common law brands</td><td>Professional multi-database search catches what the free portal misses. Rs 4,000-8,000 comprehensive search vs Rs 50,000+ rebranding cost.</td></tr>
                    </tbody>
                </table>
                </div>
            </div>
...
<section class="content-section" id="fees-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Trademark Search Report Fees in Gurugram 2026</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table class="table-amount">
                    <thead><tr><th>Fee Component</th><th>Amount</th></tr></thead>
                    <tbody>
                        <tr><td>Basic Availability Search (single class)</td><td>Rs 999-2,499</td></tr>
                        <tr><td>Comprehensive Search Report</td><td>Rs 3,999-7,999</td></tr>
                        <tr><td>Multi-Class Search (per additional class)</td><td>Rs 1,500-2,500</td></tr>
                        <tr><td>Vienna Code Logo Search</td><td>Rs 1,999-3,499</td></tr>
                        <tr><td>Search + Filing Bundle</td><td>Rs 7,999-14,999</td></tr>
                        <tr><td>M&A Due Diligence Search</td><td>Rs 10,000-25,000</td></tr>
                ...
                <p style="margin-top:16px;">No government fee for conducting searches. Professional fees cover multi-database searches, analysis, risk rating, and registrability opinion. Search + filing bundle offers the best value for startups planning immediate filing.</p>
                <p style="margin-top:16px;"><strong>Get a free Copyright Registration consultation - <a href="tel:+919459456700">Call +91 945 945 6700</a> or <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20help%20with%20TM%20Search%20Report%20in%20Gurugram.%20Please%20share%20fee%20details." target="_blank">WhatsApp us</a>. No-obligation assessment.</strong></p>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section" id="timeline-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Trademark Search Report Timeline in Gurugram</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Stage</th><th>Estimated Timeline</th></tr></thead>
                    <tbody>
                        <tr><td>Basic Search (single class, wordmark + phonetic)</td><td>2-4 hours</td></tr>
                        <tr><td>Comprehensive Search (multi-database)</td><td>4-24 hours</td></tr>
                        <tr><td>Multi-Class Search</td><td>1-3 business days</td></tr>
                        <tr><td>Vienna Code Logo Search</td><td>4-8 hours</td></tr>
                        <tr><td>Risk Assessment and Report Writing</td><td>Included in delivery timeline</td></tr>
                        <tr><td>Filing After Clear Report</td><td>Same day or next day (search + filing bundle)</td></tr>
                        <tr><td>Urgency Surcharge Available</td><td>2-4 hour delivery for critical searches</td></tr>
                    </tbody>
                </table>
                </div>
                <div class="highlight-box" style="margin-top:16px;">
                    <p><strong>Note:</strong> Search reports are delivered within hours to days depending on scope. File the application promptly after a clear report - databases update daily and delay risks new conflicts. Search + filing bundle ensures same-week completion.</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="why-choose-section" id="benefits-section">
    <div class="section-container">
        <div style="text-align:center;margin-bottom:48px;">
            ...
            <h2 class="section-title">Why Choose Patron for Trademark Search Report in Gurugram</h2>
        </div>
        <div class="features-grid">
            <article class="feature-card">
                ...
                <h3 class="feature-title">Multi-Database Search</h3>
                <p class="feature-text">IP India + WIPO ROMARIN + MCA + market sources. No conflict missed. Comprehensive coverage beyond the free portal.</p>
            </article>
            <article class="feature-card">
                ...
                <h3 class="feature-title">Phonetic Analysis</h3>
                <p class="feature-text">Algorithmic phonetic search identifying sound-similar marks. The #1 reason for S11 objections. Critical search that self-conducted searches miss.</p>
            </article>
            <article class="feature-card">
                ...
                <h3 class="feature-title">Risk-Rated Report</h3>
                <p class="feature-text">Every conflict rated high/medium/low. Visual, phonetic, and conceptual analysis. Clear picture of the registration landscape for your proposed mark.</p>
            </article>
            <article class="feature-card">
                <div class="feature-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg></div>
                <h3 class="feature-title">Registrability Opinion</h3>
                <p class="feature-text">Professional S9/S11 assessment. Likelihood of successful registration. Specific risks and recommendations. Not just data - expert analysis.</p>
            </article>
            <article class="feature-card">
                ...
                <h3 class="feature-title">Filing Strategy</h3>
                <p class="feature-text">Proceed, modify, or abandon recommendation based on search results. Class advisory included. Search + filing bundle for seamless brand launch.</p>
            </article>
            <article class="feature-card">
                ...
                <h3 class="feature-title">Vienna Code Search</h3>
                <p class="feature-text">Logo and figurative element search using Vienna Classification. Essential for device marks and composite marks. Visual similarity analysis.</p>
            </article>
        </div>
    </div>
</section>
...
<section class="content-section" id="comparison-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Search Types Comparison</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table class="table-comparison">
                    <thead><tr><th>Search Type</th><th>What It Finds</th></tr></thead>
                    <tbody>
                        <tr><td>Wordmark (Start With)</td><td>Marks starting with your keyword. E.g., 'LOVE' finds 'LOVEKART,' 'LOVEBIRD'</td></tr>
                        <tr><td>Wordmark (Contains)</td><td>Marks containing your keyword anywhere. E.g., 'LOVE' finds 'TRUELOVE,' 'ILOVEINDIA'</td></tr>
                        <tr><td>Wordmark (Match With)</td><td>Exact matches only. E.g., 'LOVEKART' finds only 'LOVEKART'</td></tr>
                        <tr><td>Phonetic</td><td>Sound-similar marks regardless of spelling. E.g., 'FLEXIPAY' finds 'FLEXYPEY'</td></tr>
                        <tr><td>Vienna Code</td><td>Visually similar logos and figurative elements by classification code</td></tr>
                        <tr><td>Multi-Database</td><td>Madrid (ROMARIN), MCA company names, domains, common law market presence</td></tr>
                    </tbody>
                </table>
                </div>
                <p style="margin-top:12px;">External Authority: <a href="https://tmrsearch.ipindia.gov.in" target="_blank" rel="noopener">IP India Search (tmrsearch.ipindia.gov.in)</a></p>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Search Framework and Databases</h2>
            <div class="content-text">
                <p>Trademark searches are conducted against the <strong>Trade Marks Act 1999</strong> framework. <strong>Section 9</strong> (absolute grounds: descriptive, generic, non-distinctive) and <strong>Section 11</strong> (relative grounds: similarity to prior marks, likelihood of confusion) define what can and cannot be registered.</p>
                <p>The <strong>IP India Public Search Portal</strong> (<a href="https://tmrsearch.ipindia.gov.in" target="_blank" rel="noopener">tmrsearch.ipindia.gov.in</a>) provides free wordmark, phonetic, and Vienna Code searches. The <strong>WIPO ROMARIN</strong> database covers Madrid Protocol designations. The <strong>NICE Classification</strong> system (45 classes) determines class-specific search scope.</p>
                <p>Professional search reports go beyond the free portal: multi-database coverage, algorithmic phonetic analysis, risk rating, registrability opinion, and filing strategy. The <a href="https://ipindia.gov.in" target="_blank" rel="noopener">IP India portal (ipindia.gov.in)</a> hosts both the public search and the e-filing facility for immediate application after a clear search.</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    <h2 class="faq-expanded__title">FAQs - Trademark Search Report in Gurugram</h2>
                    <p class="faq-expanded__lead">Answers to common questions about trademark search reports including databases, search types, phonetic analysis, risk assessment, and filing strategy for Gurugram brands.</p>
                    @include('partials.faq-enquiry-form', ['enquiryLocation' => 'Gurugram', 'enquiryService' => 'Trademark Search Report in Gurugram'])
                </aside>
                <div class="faq-expanded__list">
                    <div class="faq-expanded__item" id="faq-1">
                        <h3 class="faq-expanded__q">Is a trademark search mandatory before filing?</h3>
                        <div class="faq-expanded__a"><p>A trademark search is not legally mandatory, but it is practically essential. Filing without a search is like investing lakhs in a brand without knowing if someone else already owns a similar name. The search costs Rs 3,999-7,999. Filing without a search and facing objection, opposition, or rebranding costs Rs 50,000-5,00,000+. The ROI of a search is unquestionable.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-2">
                        <h3 class="faq-expanded__q">How much does a trademark search report cost?</h3>
                        <div class="faq-expanded__a"><p>Basic availability search (single class, same-day): Rs 999-2,499. Comprehensive multi-database report: Rs 3,999-7,999. Multi-class (per additional class): Rs 1,500-2,500. Vienna Code logo search: Rs 1,999-3,499. Search + filing bundle: Rs 7,999-14,999. Call +91 945 945 6700 for a detailed quote.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-3">
                        <h3 class="faq-expanded__q">How long does a search report take?</h3>
                        <div class="faq-expanded__a"><p>Total timeline: 2-6 months. Filing and Diary Number: immediate. Mandatory 30-day objection waiting period: 1 month. Filing Strategy Recommendation: 1-3 months. Certificate issuance: after examination approval. If a third-party objection is filed, the timeline extends by 2-4 months for hearing and resolution.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-4">
                        <h3 class="faq-expanded__q">What databases are covered in a comprehensive search?</h3>
                        <div class="faq-expanded__a"><p>IP India Trademark Registry (tmrsearch.ipindia.gov.in) for all Indian registered and pending marks. WIPO ROMARIN for international marks designating India under the Madrid Protocol. MCA (Ministry of Corporate Affairs) for company name conflicts. Common law sources: Google search, social media, e-commerce platforms (Amazon, Flipkart), and domain name registrations.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-5">
                        <h3 class="faq-expanded__q">What is phonetic search and why is it critical?</h3>
                        <div class="faq-expanded__a"><p>Phonetic search identifies marks that sound similar when spoken, regardless of spelling differences. For example, 'FlexiPay' and 'FlexyPey' are spelled differently but sound identical. Phonetic similarity is the most common reason for Section 11 examination objections in India. Self-conducted wordmark searches on the IP India portal completely miss these conflicts. Professional phonetic search is the most important component of a comprehensive search report.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-6">
                        <h3 class="faq-expanded__q">What happens if the search finds conflicts?</h3>
                        <div class="faq-expanded__a"><p>Each conflict is risk-rated: high (identical or phonetically identical in same class - registration very unlikely), medium-high (visually or conceptually similar), medium (similar but in different class or expired), low (distant similarity). The report provides a filing strategy: proceed (clear), proceed with caution, modify the name (specific changes recommended), or abandon and choose an alternative. The strategy prevents wasted filing fees and brand investment.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-7">
                        <h3 class="faq-expanded__q">Can I search for logo trademarks too?</h3>
            ...
            <div class="highlight-box" style="margin-top:32px;">
                ...
                <p><strong>Search zaruri hai kya filing se pehle?</strong> Haan. Legally mandatory nahi hai lekin practically essential hai. Bina search ke filing karna = andhere mein teer maarna. Rs 4,000-8,000 search Rs 50,000-5 lakh ki rebranding/litigation se bachata hai.</p>
                <p><strong>Free search kaafi hai?</strong> IP India portal pe basic wordmark search ho sakta hai. Lekin phonetic search, Madrid marks, MCA names, aur common law marks miss ho jaate hain. Comprehensive report chahiye.</p>
                <p><strong>Search ke baad filing?</strong> Clear report = file with confidence. Conflicts milein = modify name/class. High risk = choose alternative name. Search + filing bundle sab ek saath karo.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section" style="background: var(--orange-lighter) !important; border-left: 4px solid var(--orange);">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Why Trademark Search Report Matters for Gurugram Brands</h2>
            <div class="content-text">
                <p>A Gurugram fintech startup selects 'PaySwift' for its payment platform. Without a search, it files (Rs 4,500), designs logo (Rs 50,000), builds website (Rs 2 lakh), prints materials (Rs 1 lakh), launches Rs 10 lakh campaign. Three months later: S11 objection citing 'PaySwyft' - phonetically identical in same class. Must fight objection or rebrand (Rs 13.5 lakh lost). A Rs 5,000-8,000 search would have identified 'PaySwyft' before the first rupee was spent on branding.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section" style="background: var(--blue) !important;">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title" style="color:#FFFFFF !important;">Get Your Trademark Search Report in Gurugram Today</h2>
            <div class="content-text" style="text-align:left;">
                <p style="color:rgba(255,255,255,0.85);">Trademark Search Report in Gurugram is the essential pre-filing analysis that identifies conflicts across IP India, Madrid, MCA, and market databases through wordmark, phonetic, and Vienna Code searches - providing risk-rated registrability opinions that prevent costly objections, oppositions, and rebranding.</p>
                <p style="color:rgba(255,255,255,0.85);">Patron Accounting's Gurugram office on Golf Course Extension Road conducts comprehensive trademark search reports with multi-database coverage, risk assessment, registrability opinions, and filing strategy recommendations for startups, corporates, D2C brands, and manufacturers across Gurugram.</p>
            ...
            <div style="display:flex;gap:14px;flex-wrap:wrap;margin-top:24px;">
                ...
                <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20help%20with%20TM%20Search%20Report%20in%20Gurugram.%20Please%20share%20details." target="_blank" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:#25D366;color:#fff;border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#128172; WhatsApp Us</a>
                <a href="mailto:sales@patronaccounting.com?subject=Enquiry%20for%20TM%20Search%20Report%20in%20Gurugram&body=Hello%20Patron%20Accounting%20Team%2C%0A%0AI%20am%20interested%20in%20your%20TM%20Search%20Report%20services%20in%20Gurugram%20and%20would%20like%20to%20know%20more.%0A%0APlease%20get%20in%20touch%20with%20me%20at%20your%20earliest%20convenience.%0A%0AThank%20you." style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:transparent;color:#fff;border:2px solid rgba(255,255,255,0.3);border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#9993;&#65039; Email Us</a>
            </div>
...
<section class="content-section" style="padding:48px 32px;background:var(--gray-50);">
    <div class="content-container">
        <div class="text-content">
            ...
            <p style="text-align:center;color:var(--text-muted);font-size:15px;margin-bottom:40px;">Trademark search report services available across India with local office support.</p>
            ...
            <div class="pa-city-block" style="margin-bottom:40px;">
                <div class="pa-city-grid">
                    ...
                    <a href="/trademark-search-report/mumbai" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Mumbai</div><div class="pa-card-sub">Maharashtra</div></div></a>
            ...
            <div class="pa-city-block">
                ...
                <div class="pa-block-sub">End-to-end support for Trademark Search Report in Gurugram</div>
...
<section class="content-section" style="padding:32px;">
    <div class="content-container">
        <div class="text-content" style="font-size:13px;color:var(--text-muted);">
            ...
            <p>This page is reviewed quarterly for accuracy. IP India search portal capabilities, NICE Classification updates, Madrid Protocol database coverage, and Trade Marks Act registrability standards are verified against current practices. Gurugram brand naming landscape is validated with each review.</p>
        </div>
    </div>
</section>
