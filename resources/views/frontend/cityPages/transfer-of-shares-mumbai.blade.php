...
@section('meta')
    ...
    <meta property="og:image" content="/images/transfer-of-shares/mumbai-og.webp">
    ...
    <meta name="twitter:image" content="/images/transfer-of-shares/mumbai-og.webp">
@endsection
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'transfer-of-shares/mumbai',
                    'options'  => [
                        'transfer-of-shares/mumbai' => 'Transfer of Shares in Mumbai',
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    ...
                    @include('partials.faq-enquiry-form', ['enquiryLocation' => 'Mumbai', 'enquiryService' => 'Transfer of Shares in Mumbai'])
                </aside>
