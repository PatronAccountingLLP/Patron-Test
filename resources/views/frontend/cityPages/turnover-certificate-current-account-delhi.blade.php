        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'turnover-certificate-for-current-account/delhi',
                    'options'  => [
                        'turnover-certificate-for-current-account/delhi' => 'Turnover Certificate for Current Account in Delhi',
