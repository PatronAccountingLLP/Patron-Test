...
@section('meta')
    ...
    <meta property="og:image" content="/images/udyam-registration/bangalore-og.webp">
    ...
    <meta name="twitter:image" content="/images/udyam-registration/bangalore-og.webp">
@endsection
      ...
      "@graph": [
        {
          ...
          "url": "/udyam-registration/bangalore",
        ...
        },
        {
          ...
          "itemListElement": [
            ...
            },
            {
              ...
              "item": "/udyam-registration/bangalore"
            }
          ]
        },
        {
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - Udyam Registration in Bangalore'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="udyam-registration/bangalore" selected>Udyam Registration in Bangalore</option>
