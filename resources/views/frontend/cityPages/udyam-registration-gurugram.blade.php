            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    <div class="form-header">
                        ...
                        'deal' => 'Website Enquiry - Udyam Registration in Gurugram',
                        'options' => [
                            ['value' => '', 'label' => 'Select a service', 'selected' => true, 'disabled' => true],
                            ['value' => 'udyam-registration/gurugram', 'label' => 'Udyam Registration in Gurugram', 'selected' => true, 'disabled' => false],
