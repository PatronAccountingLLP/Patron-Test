...
@section('meta')
    ...
    <meta property="og:image" content="/images/zoho-books-accounting/chennai-og.webp">
    ...
    <meta name="twitter:image" content="/images/zoho-books-accounting/chennai-og.webp">
@endsection
      ...
      "@graph": [
        {
          ...
          "url": "/zoho-books-accounting/chennai",
        ...
        },
        {
          ...
          "itemListElement": [
            ...
            },
            {
              ...
              "item": "/zoho-books-accounting/chennai"
            }
          ]
        },
        {
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - Zoho Books Accounting in Chennai'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="zoho-books-accounting/chennai" selected>Zoho Books Accounting in Chennai</option>
                            <option value="accounting-services/chennai">Accounting Services in Chennai</option>
                            <option value="payroll-services/chennai">Payroll Services in Chennai</option>
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    ...
                    @include('partials.faq-enquiry-form', ['enquiryLocation' => 'Chennai', 'enquiryService' => 'Zoho Books Accounting in Chennai'])
                </aside>
