        ...
        <div class="why-choose-features">
            <div class="features-grid">
                ...
                <div class="feature-item">
                    ...
                    <div class="feature-content">
                        <h4>Serving Businesses Across India — Offices in Pune, Mumbai, Delhi, Gurgaon & Ahmedabad</h4>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-9">
                <div class="faq-list">
                    ...
                    <div class="faq-item" style="background: white; border-radius: 12px; margin-bottom: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.06); overflow: hidden;">
                        ...
                        <div class="faq-answer" style="display: none; padding: 0 20px 18px; font-family: 'DM Sans', sans-serif; font-size: 14px; color: #6B7280; line-height: 1.8;">
                            Patron Accounting files all ITR types — ITR-1 through ITR-7. This includes returns for <a href="/itr-for-salary" style="color: #D4541C; text-decoration: underline;">salaried professionals with multiple Form 16s and HRA claims</a>, <a href="/itr-for-business" style="color: #D4541C; text-decoration: underline;">business owners with presumptive or regular income</a>, <a href="/itr-for-professionals" style="color: #D4541C; text-decoration: underline;">freelancers and consultants with Section 44ADA benefits</a>, NRIs with Indian rental or capital gains income, and startup founders with ESOP taxation. Our CAs run old-vs-new regime comparisons and build advance tax schedules so you never face interest under Section 234B/C.
                        </div>
                    </div>
