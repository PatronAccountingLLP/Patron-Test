...
<section class="py-5 bg-white">
    <div class="container">
        <div class="text-center mb-5">
            <h2 class="fw-bold mb-4" style="color: #14365F; font-size: 2.25rem; font-family: 'Barlow', sans-serif;">
                Chartered Expertise. Client-Centric Solutions
            </h2>
            <p class="text-muted mx-auto mb-3" style="max-width: 900px; font-size: 1rem; line-height: 1.8;">
                At Patron Accounting, we deliver more than compliance—we deliver confidence. As a trusted partner to businesses across industries, we simplify complex processes, ensure regulatory alignment, and help you focus on what matters most: growth, clarity, and peace of mind.
            </p>
            <p class="mx-auto mb-4" style="max-width: 900px; font-size: 1rem; line-height: 1.8; color: #6B7280;">
                Explore <a href="#" id="openHeaderMenu" style="color: #F26522; font-weight: 600; text-decoration: none;">our header menu section</a> to navigate key service areas right from Accounting and Registrations to Compliance, IP Protection and Advisory. Everything you need, clearly organized and easy to access.
            </p>
        </div>
    ...
    <div class="container">
        <div class="comparison-header">
            ...
            <p class="comparison-subtitle">
                Discover the key differences that make Patron Accounting the smarter, faster, and more reliable choice
...
<section class="who-we-are-section">
    <div class="container">
        <h2 class="who-we-are-title text-center mb-5">Who we are</h2>
            ...
            <div class="col-lg-8">
                <div class="video-wrapper position-relative" style="border-radius: 24px; overflow: hidden; box-shadow: 0 10px 40px rgba(0, 0, 0, 0.15);">
                    <video 
                        ...
                        <source src="{{ asset('images/About Patron Accounting.ogg') }}" type="video/ogg">
                        Your browser does not support the video tag.
                    </video>
                    <!-- Custom Play Button Overlay -->
                    <div id="playButtonOverlay" class="play-button-overlay position-absolute top-50 start-50 translate-middle" 
                         onclick="document.getElementById('whoWeAreVideo').click();"
                         style="width: 80px; height: 80px; border-radius: 50%; display: flex; align-items: center; justify-content: center; cursor: pointer; z-index: 10; transition: all 0.3s ease;">
                        <img src="{{ asset('images/play_circle.png') }}" alt="Play Button" style="width: 67px; height: 67px;">
                    </div>
                </div>
            </div>
        </div>
...
<section class="why-choose-section">
    <div class="container">
        ...
        <p class="why-choose-description">
            Patron Accounting is a tech-enabled legal and compliance partner built to simplify every stage of your
            ...
            <div class="features-grid">
                ...
                <div class="feature-item">
                    ...
                    <div class="feature-content">
                        <h4>One Stop Solution for all your business needs</h4>
                    </div>
                </div>
                ...
                <div class="feature-item">
                    ...
                    <div class="feature-content">
                        <h4>100% Transparent & Paperless Process</h4>
                    </div>
                </div>
                ...
                <div class="feature-item">
                    ...
                    <div class="feature-content">
                        <h4>Well-structured and streamlined procedures</h4>
                    </div>
                </div>
                ...
                <div class="feature-item">
                    ...
                    <div class="feature-content">
                        <h4>Long-term partnership approach with ongoing support</h4>
                    </div>
                </div>
                ...
                <div class="feature-item">
                    ...
                    <div class="feature-content">
                        <h4>Secure handling of sensitive documents and data. </h4>
                    </div>
                </div>
        ...
        <div class="more-than-legal-content">
            <div class="more-than-legal-text">
                ...
                <p class="more-than-legal-description">
                    At Patron Accounting, we're not here to just complete tasks; we're here to build trust. That's why
                    every service we provide comes with a layer of insight, foresight, and partnership you won't find
                    elsewhere. We don't just guide you through the setup; we help future-proof your business. Our team
                    monitors upcoming compliance needs, offers quarterly business health reviews, and ensures your legal
                    foundation stays strong as you grow. You'll also get lifetime access to a digital document vault,
                    early reminders for renewals, and practical advice when business laws change, all without extra
                    charges. Whether you're launching your startup or managing a multi-state expansion, we bring
...
<section class="real-stories-section d-none">
    <div class="container">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (heroSearchInput) {
            ...
            fetch(`/api/search-pages?q=${encodeURIComponent(query)}`, {
                ...
                .catch(error => {
                    ...
                    heroSearchSuggestions.innerHTML =
                        '<div class="hero-no-results">Error loading results</div>';
                    heroSearchSuggestions.classList.add('show');
                });
        }

        function displayHeroResults(pages) {
            if (pages.length === 0) {
            ...
            pages.forEach(page => {
                ...
                html += `
                    <a href="${pageUrl}" class="hero-suggestion-item">
                        <div class="hero-suggestion-title">${escapeHtml(page.title)}</div>
                        <div class="hero-suggestion-excerpt">${escapeHtml(excerpt)}${excerpt.length > 0 ? '...' : ''}</div>
                    </a>
                `;
            });
        ...
        heroSearchInput.addEventListener('focus', function() {
            if (this.value.trim().length > 0 && heroSearchSuggestions.innerHTML !== '') {
                heroSearchSuggestions.classList.add('show');
            }
        });
        ...
        heroSearchInput.addEventListener('keydown', function(e) {
            if (e.key === 'Enter') {
                e.preventDefault();
                const firstResult = heroSearchSuggestions.querySelector('.hero-suggestion-item');
                if (firstResult) {
...
<!-- Client Testimonial Section - Dynamic -->
@if($testimonials && $testimonials->count() > 0)
<section class="client-testimonial-section">
    <div class="container">
        <div class="testimonial-section-header">
            <h2 class="testimonial-section-title">Client Testimonial</h2>
            <div class="testimonial-rating">
                <p class="testimonial-rating-text">We have been rated <strong>4.8 <span class="star-icon">⭐</span></strong> on <strong>Google</strong></p>
            </div>
        </div>
            ...
            <div class="client-testimonial-card">
                <div class="testimonial-card-content">
                    @if($testimonial->video)
                        <!-- Video Testimonial -->
                        <div class="testimonial-video-wrapper" onclick="playVideo(this)">
                            <video class="testimonial-video" poster="" playsinline>
                    ...
                    <div class="testimonial-text-content">
                        <p class="client-testimonial-text">{{ $testimonial->content }}</p>
                    </div>
                    @endif
                    
                    <div class="testimonial-footer-info">
                        <div class="testimonial-author-section">
                            <div class="testimonial-avatar-small">
                                @if($testimonial->image || $testimonial->video)
...
.testimonial-rating-stars .star {
    font-size: 16px;
}

.testimonial-rating-stars .star.filled {
    color: #FFA500;
}

.testimonial-rating-stars .star.empty {
    color: #D1D5DB;
}
...
// Listen for video pause/end events to show play button again
document.addEventListener('DOMContentLoaded', function() {
    const videos = document.querySelectorAll('.testimonial-video');
    videos.forEach(video => {
        video.addEventListener('pause', function() {
            const wrapper = this.closest('.testimonial-video-wrapper');
            if (wrapper) {
                wrapper.classList.remove('playing');
            }
        });
