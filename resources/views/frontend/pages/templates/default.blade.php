...
<section class="py-5" style="background: linear-gradient(180deg, var(--cream) 0%, var(--white) 100%);">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                <div class="card shadow-lg border-0"  style="border-radius: 15px;border-top: 5px #F26522 solid !important;" id="consultationFormCard">
    ...
    <iframe name='hidden208810000001209168Frame' id='hidden208810000001209168Frame' style='display:none;' src='about:blank'></iframe>
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <div class="form-group" style="display: none">
                            {{-- <label class="form-label">Service Needed</label> --}}
                             @php
                                ...
                                $service_name = ucwords(str_replace('-', ' ', implode('-', request()->segments())));
                                @endphp
                        ...
                        <button type='submit' class='btn-submit' id='formSubmitBtn'>Get started now &rarr;</button>
                    </form>
...
@include('partials.faq-section', [
    'faqs' => $faqData,
    'heading' => $page->faq_title ?? 'Frequently Asked Questions',
    'lead' => $page->faq_subtitle ?? 'Have a look at the answers to the most asked questions.',
    'includeSchema' => true,
    'enquiryService' => $page->title ?? '',
])
@endif
