...
@php
    ...
    /* This view serves /blog, /blog/<category> and every /page-N of both. It is an
       index of other pages, so partials/footer must not try to name it - it was
       sending "I just visited your Index page", this file's own name, from the
       floating button on all 179 of them. */
    config(['pa.page_has_no_name' => true]);

    /* The sidebar's own WhatsApp CTA, which carried that same "Index". Someone
       writing from a category page is reading about that subject, so say so; from
       /blog itself, keep it broad. */
    $pbWaMsg = $catName !== ''
        ? 'Hello, I was reading your ' . $catName . ' articles. I would like to speak to a CA about my own situation.'
        : 'Hello, I was reading your blog. I would like to speak to a CA about my own situation.';
@endphp
      ...
      <aside class="pb-layout-sidebar">
        ...
        <div class="pb-contact-card">
          ...
          <div class="pb-contact-buttons">
            ...
            <a href="https://wa.me/919459456700?text={{ rawurlencode($pbWaMsg) }}" class="pb-btn pb-btn-whatsapp pb-btn-block" target="_blank" rel="noopener">
