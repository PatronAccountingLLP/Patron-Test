...
@section('meta')
    <title>Startup Accounting Services in India for Indian SMEs</title>
...
<p>In practice, it runs the general ledger, the payroll and the monthly close. On top of that sits the reporting a funded business is judged by: burn, runway and cohort performance in a format investors recognise. It handles the recognition timing on employee share awards, where a charge booked in the wrong month creates a problem for both company and employee. For subscription businesses, it also spreads deferred revenue across the term it belongs to. This function also tracks the conditions attached to recognised-startup benefits, so a claim is not lost to a missed window. Accounting for startups, then, is ordinary bookkeeping carried out to a standard a priced round will test. Preparing valuation reports or fielding diligence responses falls outside this engagement.</p>
                ...
                <div class="highlight-box" style="margin-top:20px;">
                    ...
                    <div class="key-terms"><ul class="al-list"><li><span class="al-t"><a href="/glossary/accounting/monthly-burn-rate">Monthly Burn Rate</a></span><span class="al-d">How much cash the business spends over and above what it brings in monthly.</span></li><li><span class="al-t"><a href="/glossary/accounting/cash-runway-calculation">Cash Runway Calculation</a></span><span class="al-d">How many months the cash on hand will last at the current burn.</span></li><li><span class="al-t"><a href="/glossary/accounting/cap-table-dilution">Cap Table Dilution</a></span><span class="al-d">How much each shareholder&#x27;s percentage falls when new shares are issued.</span></li><li><span class="al-t"><a href="/glossary/accounting/operating-cash-runway">Operating Cash Runway</a></span><span class="al-d">Runway measured from operating cash flow alone, ignoring one-off funding inflows.</span></li><li><span class="al-t"><a href="/glossary/accounting/ind-as-102-share-based-payment">Ind AS 102 Share-based Payment</a></span><span class="al-d">The accounting standard for recording the cost of shares given to employees.</span></li><li><span class="al-t"><a href="/glossary/accounting/vesting-period-graded-amortization">Vesting Period Graded Amortization</a></span><span class="al-d">Spreading an ESOP cost across the years employees earn their options.</span></li><li><span class="al-t"><a href="/glossary/accounting/deferred-revenue-unearned-revenue">Deferred Revenue (Unearned Revenue)</a></span><span class="al-d">Money collected upfront for goods or services not yet delivered.</span></li><li><span class="al-t"><a href="/glossary/accounting/monthly-recurring-revenue-mrr">Monthly Recurring Revenue (MRR)</a></span><span class="al-d">The predictable subscription income a business expects to earn each month.</span></li></ul></div>
...
<section class="content-section portal-grid-sec" id="client-portal-section" style="background: var(--cream) !important;">
  <div class="section-container">
    ...
    <div class="portal-grid">
      ...
      <article class="portal-card">
        <div class="browser-frame"><div class="bbar"><span></span><span></span><span></span></div>
          <img src="/images/accounting-cluster/portal/portal-4-startups.webp" alt="MSME and Udyam registration document checklist in the client portal, with an upload button beside each item" loading="lazy" width="1280" height="1027"></div>
        <div class="portal-card__body"><span class="portal-card__num">3</span>
          <h3>Share what the service asks for</h3><p>For every service, the portal shows the exact documents it needs, each with its own upload button. The list shown here is the MSME (Udyam) registration checklist. When a service needs nothing from you, it simply asks for nothing.</p></div>
      </article>
      <article class="portal-card">
        <div class="browser-frame"><div class="bbar"><span></span><span></span><span></span></div>
...
<p>Those reliefs turn on records kept prospectively, not reconstructed later. A <a href="/glossary/accounting/cap-table-dilution">Cap Table Dilution</a> history, the grant terms behind each ESOP and the <a href="/glossary/accounting/monthly-burn-rate">Monthly Burn Rate</a> that lenders and boards read all have to be evidenced as they happen. Startup accounting services keep the statutory books and this second layer in step, against the provisions below.</p>
...
<section class="content-section" id="tool-section" style="background-color:var(--blue-lighter);">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>Estimate your monthly burn and how many months of runway you have left, instantly.</p>
...
{{-- Enquiry form markup + JS now live in partials/enquiry-form.blade.php (included in the hero above). --}}
