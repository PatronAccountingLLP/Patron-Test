        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'annual-compliance-cost-comparison-cheap-vs-quality',
                    'options'  => [
                        'annual-compliance-cost-comparison-cheap-vs-quality' => 'Annual Compliance Cost Comparison (this page)',
