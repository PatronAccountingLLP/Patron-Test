        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'audit-report-types-india',
                    'options'  => [
                        'audit-report-types-india' => 'Audit Report Types Reference (this page)',
                        'statutory-audit' => 'Statutory Audit Engagement',
                        'caro-2020-reporting' => 'CARO 2020 Reporting',
                        'internal-financial-controls-audit' => 'Internal Financial Controls Audit',
                        'schedule-iii-compliance-companies-act' => 'Schedule III Compliance',
