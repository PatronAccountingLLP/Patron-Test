            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - Brand Copyright Registration'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="brand-copyright-registration" selected>Brand Copyright Registration</option>
                                <option value="trademark-registration">Trademark Registration</option>
                                <option value="logo-copyright-registration">Logo Copyright Registration</option>
                                <option value="copyright-registration">Copyright Registration (General)</option>
