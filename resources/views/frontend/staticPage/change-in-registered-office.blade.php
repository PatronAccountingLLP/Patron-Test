...
@section('meta')
    ...
    <meta property="og:image" content="/images/change-in-registered-office-og.webp">
    ...
    <meta name="twitter:image" content="/images/change-in-registered-office-og.webp">
@endsection
      ...
      "@graph": [
        {
          ...
          "url": "/change-in-registered-office",
        ...
        },
        {
          ...
          "itemListElement": [
            ...
            },
            {
              ...
              "position": 2,
              "name": "Change Registered Office India: INC-22 Guide",
              "item": "/change-in-registered-office"
            }
          ]
        },
        {
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - Registered Office Change'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="change-in-registered-office" selected>Change in Registered Office</option><option value="change-in-name-of-company">Change in Company Name</option><option value="private-limited-company-compliance">Pvt Ltd Compliance</option><option value="gst-registration">GST Registration</option><option value="change-in-authorised-capital">Change in Capital</option><option value="other">Other</option>
