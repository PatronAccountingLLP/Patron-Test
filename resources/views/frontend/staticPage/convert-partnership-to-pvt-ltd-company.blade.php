        ...
        },
        {
          ...
          "itemListElement": [
            ...
            },
            {
              ...
              "position": 2,
              "name": "Convert Partnership Firm to PVT LTD in India Guide",
              "item": "/convert-partnership-to-pvt-ltd-company"
            }
          ]
        },
        {
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'convert-partnership-to-pvt-ltd-company',
                    'options'  => [
                        'convert-partnership-to-pvt-ltd-company' => 'Partnership to Pvt Ltd',
                        'private-limited-company-registration-in-india' => 'Pvt Ltd Registration',
                        'convert-partnership-to-llp' => 'Partnership to LLP',
...
<a href="/partnership-to-private-limited/pune" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Pune</div><div class="pa-card-sub">Maharashtra</div></div></a>
