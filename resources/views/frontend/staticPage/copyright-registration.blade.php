...
@section('meta')
    ...
    <meta property="og:image" content="/images/copyright-registration-og.webp">
    ...
    <meta name="twitter:image" content="/images/copyright-registration-og.webp">
@endsection
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'copyright-registration',
                    'options'  => [
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    ...
                    @include('partials.faq-enquiry-form', ['enquiryService' => 'Copyright Registration'])
                </aside>
