...
@section('meta')
    ...
    <meta property="og:image" content="https://www.patronaccounting.com/images/corporate-compliance-for-opc-og.webp">
    ...
    <meta name="twitter:image" content="https://www.patronaccounting.com/images/corporate-compliance-for-opc-og.webp">
@endsection
...
<nav aria-label="Breadcrumb" style="background:var(--gray-50);border-bottom:1px solid var(--gray-200);padding:10px 16px;">
    <div style="max-width:1320px;margin:0 auto;">
        <ol style="display:flex;align-items:center;gap:8px;list-style:none;padding:0;margin:0;font-size:13px;font-family:'Barlow',sans-serif;">
            ...
            <li><span style="color:var(--orange);font-weight:600;">OPC Compliance Services</span></li>
        </ol>
    </div>
</nav>
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - OPC Compliance'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="corporate-compliance-for-opc" selected>OPC Compliance</option>
...
<section class="content-section" style="padding:48px 32px;background:var(--gray-50);">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title" style="text-align:center;margin-bottom:12px;">OPC Compliance Support Across India</h2>
            <p style="text-align:center;color:var(--text-muted);font-size:15px;margin-bottom:40px;">In-person and remote One Person Company compliance support from our offices in Pune, Mumbai, Delhi and Gurugram.</p>
