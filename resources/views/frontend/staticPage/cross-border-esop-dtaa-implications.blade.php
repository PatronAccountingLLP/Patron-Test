        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'Cross-Border ESOP DTAA Implications',
                    'options'  => [
                        'Cross-Border ESOP DTAA Implications' => 'Cross-Border ESOP DTAA Implications',
                        'ESOP Management and Compliance' => 'ESOP Management and Compliance',
                        'ESOP Services' => 'ESOP Services',
                        'ESOP for Foreign Parent, Indian Subsidiary' => 'ESOP for Foreign Parent, Indian Subsidiary',
