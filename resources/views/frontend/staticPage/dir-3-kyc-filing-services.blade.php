        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'dir-3-kyc-filing-services',
                    'options'  => [
                        'dir-3-kyc-filing-services' => 'DIR-3 KYC Filing (this page)',
                        'director-kyc' => 'Director KYC Hub',
                        ...
                        'condonation-of-delay-roc-filings' => 'Backlog Cleanup',
                        'other' => 'Other',
                    ],
                ])
            </div>
