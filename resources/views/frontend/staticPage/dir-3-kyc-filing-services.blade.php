...
@section('schema')
    <script type="application/ld+json">
    {
        ...
        "@graph": [
            {
                "@type": "BreadcrumbList",
                "@id": "/dir-3-kyc-filing-services#breadcrumb",
                "itemListElement": [
                    {
                        "@type": "ListItem",
                        "position": 1,
                    ...
                    },
                    {
                        ...
                        "item": "/dir-3-kyc-filing-services"
                    }
                ]
            },
            {
                "@type": "FAQPage",
                "@id": "/dir-3-kyc-filing-services#faq",
                "mainEntity": [
            {
                "@type": "Question",
            ...
            {
                "@type": "Service",
                "@id": "/dir-3-kyc-filing-services#service",
                "name": "DIR-3 KYC Filing Services in India",
                "url": "/dir-3-kyc-filing-services",
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20DIR-3%20KYC%20filing%20under%20the%20new%20triennial%20regime%20for%20my%20DIN%20or%20DPIN." target="_blank" class="btn-sample text-decoration-none">
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - DIR-3 KYC Filing Services'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="dir-3-kyc-filing-services" selected>DIR-3 KYC Filing (this page)</option>
                                <option value="director-kyc">Director KYC Hub</option>
                                <option value="appointment-of-director">Appointment of Director</option>
                                <option value="resignation-of-director">Resignation of Director</option>
                                ...
                                <option value="condonation-of-delay-roc-filings">Backlog Cleanup</option>
...
<section class="testimonials-section">
    <div class="section-container">
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">DIN was deactivated when our AOC-4 filing failed. Patron filed DIR-3 KYC Web with Rs 5,000 fee, got reactivation in 4 days, and immediately released the AOC-4 + MGT-7 backlog. Total cleanup in one week.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div>
                    <div style="font-weight:700;font-size:13px;color:var(--blue);">Ravi Desai</div>
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Founder, SaaS Co</div>
                    <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                </div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Foreign-national co-founder needed DIR-3 KYC. Patron handled apostille chain via Indian Embassy Singapore - notarised passport, address proof, full documentation. Filed in 8 working days end-to-end.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                <div style="width:36px;height:36px;border-radius:50%;background:var(--blue);display:flex;align-items:center;justify-content:center;font-weight:700;font-size:13px;color:#fff;flex-shrink:0;">PJ</div>
                <div>
                    <div style="font-weight:700;font-size:13px;color:var(--blue);">Pradeep Jain</div>
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">CFO, Fintech</div>
                    <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                </div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">7 directors in our founding team. Patron batched the DIR-3 KYC cycle - single intake form, sequenced OTPs over 3 days, consolidated billing. Saved us 12 hours of coordination per director.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                <div style="width:36px;height:36px;border-radius:50%;background:#10B981;display:flex;align-items:center;justify-content:center;font-weight:700;font-size:13px;color:#fff;flex-shrink:0;">SI</div>
                <div>
                    <div style="font-weight:700;font-size:13px;color:var(--blue);">Suresh Iyer</div>
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">COO, Mfg Co</div>
                    <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                </div>
                <div style="margin-left:auto;font-size:11px;color:var(--text-muted);">2 months ago</div>
            </div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">As LLP designated partner I never knew DPIN needed DIR-3 KYC. Patron flagged this with our Form 8 / 11 engagement and filed alongside. Saved DPIN deactivation that would have blocked our LLP annual filings.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                <div style="width:36px;height:36px;border-radius:50%;background:#F59E0B;display:flex;align-items:center;justify-content:center;font-weight:700;font-size:13px;color:#fff;flex-shrink:0;">VK</div>
                <div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Changed my mobile number last March. Forgot the 30-day rule. Patron caught it in their annual compliance retainer review and filed DIR-3 KYC Web update with applicable fee. Avoided DIN deactivation.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                <div style="width:36px;height:36px;border-radius:50%;background:#7C3AED;display:flex;align-items:center;justify-content:center;font-weight:700;font-size:13px;color:#fff;flex-shrink:0;">AM</div>
                <div>
                    <div style="font-weight:700;font-size:13px;color:var(--blue);">Anita Mehta</div>
        ...
        <div class="reviews-cta" style="margin-top: 16px; display: flex !important;">
            <div class="reviews-cta-content">
                ...
                <div class="reviews-cta-text">
                    ...
                    <p>Free 15-minute consultation. Triennial cycle tracking for retainer clients. DIN reactivation with downstream backlog release in 3-5 working days.</p>
                </div>
            </div>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p style="margin-top:16px;"><strong>Get a free DIR-3 KYC Filing Services consultation - <a href="tel:+919459456700">Call +91 945 945 6700</a> or <a href="https://wa.me/919459456700?text=Hi%2C%20please%20share%20a%20quote%20for%20DIR-3%20KYC%20filing%20or%20DIN%20reactivation." target="_blank">WhatsApp us</a>. No-obligation assessment.</strong></p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p style="margin-top:16px;"><strong>Get DIR-3 KYC Filed in 1 Working Day -</strong> <a href="tel:+919459456700">Call +91 945 945 6700</a> or <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20DIR-3%20KYC%20filing%20or%20DIN%20reactivation." target="_blank">WhatsApp us</a>. Free 15-minute consultation. We respond within 2 hours during business hours.</p>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div style="display:flex;gap:14px;flex-wrap:wrap;margin-top:24px;">
                ...
                <a href="https://wa.me/919459456700?text=Hi%2C%20please%20share%20a%20quote%20for%20DIR-3%20KYC%20filing%20or%20DIN%20reactivation." target="_blank" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:#25D366;color:#fff;border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#128172; WhatsApp Us</a>
