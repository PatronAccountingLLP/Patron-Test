...
<nav aria-label="Breadcrumb" style="background:var(--gray-50);border-bottom:1px solid var(--gray-200);padding:10px 16px;">
    <div style="max-width:1320px;margin:0 auto;">
        <ol style="display:flex;align-items:center;gap:8px;list-style:none;padding:0;margin:0;font-size:13px;font-family:'Barlow',sans-serif;">
            ...
            <li><span style="color:var(--orange);font-weight:600;">E-Invoicing Implementation Services</span></li>
        </ol>
    </div>
</nav>
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - E-Invoicing Implementation'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value='E-Invoicing Implementation' selected>E-Invoicing Implementation</option>
...
<section class="content-section" style="padding:48px 32px;background:var(--gray-50);">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title" style="text-align:center;margin-bottom:12px;">GST and E-Invoicing Support Across India</h2>
            ...
            <div class="pa-city-block" style="margin-bottom:40px;">
                <div class="pa-block-title">GST and E-Invoicing Support by City</div>
                <div class="pa-block-sub">On-the-ground GST and e-invoicing support plus remote implementation delivery</div>
