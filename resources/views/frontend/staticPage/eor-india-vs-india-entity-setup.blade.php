...
@section('schema')
    <script type="application/ld+json">
    {
      ...
      "@graph": [
        {
          "@type": "BreadcrumbList",
          "@id": "/eor-india-vs-india-entity-setup#breadcrumb",
          "itemListElement": [
            { "@type": "ListItem", "position": 1, "name": "Home", "item": "/" },
            { "@type": "ListItem", "position": 2, "name": "Services", "item": "/services" },
            { "@type": "ListItem", "position": 3, "name": "EOR vs Pvt Ltd India - Decision Framework", "item": "/eor-india-vs-india-entity-setup" }
          ]
        },
        {
          "@type": "FAQPage",
          "@id": "/eor-india-vs-india-entity-setup#faq",
          "mainEntity": [
            {
              "@type": "Question",
        ...
        {
          "@type": "Service",
          "@id": "/eor-india-vs-india-entity-setup#service",
          ...
          "mainEntityOfPage": {
            "@type": "WebPage",
            "@id": "/eor-india-vs-india-entity-setup",
        ...
        <div class="row align-items-center">
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="https://wa.me/919459456700?text=Hi%2C%20please%20help%20me%20choose%20between%20EOR%20and%20setting%20up%20an%20Indian%20Pvt%20Ltd%20subsidiary." target="_blank" class="btn-sample text-decoration-none">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'eor-india-vs-india-entity-setup',
                    'options'  => [
                        'eor-india-vs-india-entity-setup' => 'EOR vs Pvt Ltd Decision Framework',
                        'best-eor-providers-india-2026' => 'EOR Vendor Selection (9-Provider Roundup)',
                        'eor-vs-contractor-india' => 'EOR vs Contractor (Conversion)',
                        'eor-india-engineering-team' => 'EOR India Engineering Team',
                        'eor-india-for-saas-companies' => 'EOR India for SaaS Companies',
                        'eor-india-for-fintechs' => 'EOR India for Fintech',
                        'eor-india-for-ai-companies' => 'EOR India for AI Companies',
...
<section class="testimonials-section">
    <div class="section-container">
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            ...
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div>
                    ...
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">US Dev Tools Startup (anonymised)</div>
                    <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                </div>
                <div style="margin-left:auto;font-size:11px;color:var(--text-muted);">2 months ago</div>
            </div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Patron's three-factor decision tree saved us from incorporating too early. At 6 employees with uncertain growth, we stayed on Path A. By month 14 we hit 16 employees and the same Patron team migrated us. Saved approximately USD 22,000 in unnecessary Year 1 fixed compliance costs.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Cost crossover analysis was decisive. Patron's model showed that at our 25-employee projection, entity saved USD 90,000+ per year. Path B incorporation took 4 weeks; full migration in 75 days. The same Patron CA who advised us executed the migration with no vendor switch.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div>
                    ...
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">US Series B Tech Startup</div>
                    <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                </div>
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">PE risk for our India sales engineers was flagged in Patron's discovery call. They recommended Path B over Path A specifically because of the PE exposure. Saved us 25-30 percent corporate tax on attributable profits. The PE diagnosis would have been missed by an EOR-only vendor.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">We needed to invoice Indian customers in INR and raise Indian VC. EOR couldn't deliver either. Patron set up the Pvt Ltd in 5 weeks, GST registration in parallel, and we had INR invoicing live by week 8. The strategic case for entity over EOR was decisive once Patron mapped it for us.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
        ...
        <div class="reviews-cta" style="margin-top: 16px; display: flex !important;">
            <div class="reviews-cta-content">
                ...
                <div class="reviews-cta-text">
                    ...
                    <p>Trusted by founders, CFOs, and HR heads across the US, UK, EU, Singapore, and Australia for vendor-neutral CA-led decisions on EOR vs Indian Pvt Ltd subsidiary setup, with execution under either Path A or Path B.</p>
                </div>
            </div>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p style="margin-top:16px;"><strong>Get a free EOR vs Pvt Ltd India consultation - <a href="tel:+919459456700">Call +91 945 945 6700</a> or <a href="https://wa.me/919459456700?text=Hi%2C%20please%20share%20a%20cost-comparison%20model%20for%20EOR%20vs%20Pvt%20Ltd%20at%20our%20projected%20India%20headcount." target="_blank">WhatsApp us</a>. No-obligation assessment.</strong></p>
            </div>
        </div>
    </div>
</section>
...
<p style="margin-top:16px;"><strong>Talk to Patron's CA-led Decision Team:</strong> <a href="tel:+919459456700">Call +91 945 945 6700</a> | <a href="https://wa.me/919459456700?text=Hi%2C%20please%20share%20a%20cost-comparison%20model%20for%20EOR%20vs%20Pvt%20Ltd%20at%20our%20projected%20India%20headcount." target="_blank">WhatsApp +91 945 945 6700</a> | <a href="mailto:contact@patronaccounting.com?subject=Enquiry%20for%20EOR%20vs%20Pvt%20Ltd%20India%20Decision&body=Hello%20Patron%20Accounting%20Team%2C%0A%0AI%20am%20choosing%20between%20EOR%20and%20Indian%20Pvt%20Ltd%20setup%20and%20would%20like%20a%20discovery%20call%20with%20cost-comparison%20modelling%20across%20both%20paths.%0A%0AThank%20you.">Email contact@patronaccounting.com</a>. Free 30-minute discovery call. We model EOR vs Entity for your specific scenario.</p>
...
<p>10,000+ Businesses Served | 4.9 Google Rating | 4 Cities (Pune, Mumbai, Delhi, Gurugram) | Both Paths (EOR + Entity setup)</p>
            ...
            <div style="display:flex;gap:14px;flex-wrap:wrap;margin-top:24px;">
                ...
                <a href="https://wa.me/919459456700?text=Hi%2C%20please%20share%20a%20cost-comparison%20model%20for%20EOR%20vs%20Pvt%20Ltd%20at%20our%20projected%20India%20headcount." target="_blank" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:#25D366;color:#fff;border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#128172; WhatsApp Us</a>
            ...
            <!-- CITY_PAGES_GRID PATTERN:
                ...
                <div class="pa-city-block" style="margin-bottom:40px;">
                    <div class="pa-city-grid">
                        ...
                        <a href="/eor-india-vs-india-entity-setup-mumbai" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Mumbai</div><div class="pa-card-sub">Maharashtra</div></div></a>
                        <a href="/eor-india-vs-india-entity-setup-delhi" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Delhi</div><div class="pa-card-sub">NCR</div></div></a>
                        <a href="/eor-india-vs-india-entity-setup-gurugram" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Gurugram</div><div class="pa-card-sub">Haryana</div></div></a>
                        <a href="/eor-india-vs-india-entity-setup-bangalore" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Bangalore</div><div class="pa-card-sub">Karnataka</div></div></a>
                        <a href="/eor-india-vs-india-entity-setup-hyderabad" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Hyderabad</div><div class="pa-card-sub">Telangana</div></div></a>
                        <a href="/eor-india-vs-india-entity-setup-chennai" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Chennai</div><div class="pa-card-sub">Tamil Nadu</div></div></a>
                        <a href="/eor-india-vs-india-entity-setup-kolkata" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Kolkata</div><div class="pa-card-sub">West Bengal</div></div></a>
                    </div>
                </div>
