...
@section('schema')
    <script type="application/ld+json">
    {
      ...
      "@graph": [
        {
          "@type": "BreadcrumbList",
          "@id": "/eor-india-vs-rippling#breadcrumb",
          "itemListElement": [
            { "@type": "ListItem", "position": 1, "name": "Home", "item": "/" },
            { "@type": "ListItem", "position": 2, "name": "Services", "item": "/services" },
            { "@type": "ListItem", "position": 3, "name": "Rippling Alternative India", "item": "/eor-india-vs-rippling" }
          ]
        },
        {
          "@type": "FAQPage",
          "@id": "/eor-india-vs-rippling#faq",
          "mainEntity": [
            {
              "@type": "Question",
        ...
        {
          "@type": "Service",
          "@id": "/eor-india-vs-rippling#service",
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - Rippling Alternative India'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="eor-india-vs-rippling" selected>Rippling Alternative India</option>
