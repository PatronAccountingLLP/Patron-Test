        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'esic-calculation-and-compliance-services',
                    'options'  => [
                        'esic-calculation-and-compliance-services' => 'ESIC Calculation & Compliance',
                        'esic-registration' => 'ESIC Registration',
                        'esic-return' => 'ESIC Returns',
                        'pf-registration' => 'PF Registration',
                        'pf-return' => 'PF Returns',
                        'payroll-processing-and-management-services' => 'Payroll Services',
                        'payroll-services' => 'Payroll Overview',
                        'other' => 'Other',
                    ],
                ])
            </div>
