...
@section('meta')
    <title>ESOP Corporate Filings in India: MGT-14 and PAS-3 Guide</title>
    <meta name="description" content="ESOP corporate filings for Indian companies: MGT-14, PAS-3, MGT-7 and SH-6 register under Companies Act 2013. CS-led annual retainer from Rs 50,000.">
    <link rel="canonical" href="/esop-corporate-filings">
    <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1">
    <meta property="og:title" content="ESOP Corporate Filings in India: MGT-14 and PAS-3 Guide | Patron Accounting">
    <meta property="og:description" content="ESOP corporate filings for Indian companies: MGT-14, PAS-3, MGT-7 and SH-6 register under Companies Act 2013. CS-led annual retainer from Rs 50,000.">
...
@section('schema')
    <script type="application/ld+json">
    {
        ...
        "@type": "Service",
        "@id": "https://www.patronaccounting.com/esop-corporate-filings/#service",
        "name": "ESOP Corporate Filings in India",
        "url": "https://www.patronaccounting.com/esop-corporate-filings/",
        ...
        "hasOfferCatalog": {
            ...
            "itemListElement": [
                {
                    "@type": "Offer",
                    "name": "Seed Stage Annual Retainer",
                    "priceCurrency": "INR",
                    "price": "50000",
                    "description": "1 scheme, up to 10 grantees; Board minutes, SH-6, MGT-14, PAS-3 up to 4 per year, MGT-7 disclosure"
                },
                {
                    "@type": "Offer",
                    "name": "Growth Stage Annual Retainer",
                    "priceCurrency": "INR",
                    "price": "75000",
                    "description": "1 scheme, 11 to 50 grantees; quarterly Board cycles, multiple PAS-3 allotments, scheme variations, full Directors' Report disclosure"
                },
                {
                    "@type": "Offer",
                    "name": "Scale Stage Annual Retainer",
                    "priceCurrency": "INR",
                    "price": "100000",
                    "description": "2 to 3 schemes, 50 plus grantees; multi-scheme reconciliation, group consolidation, accelerated vesting events, modification filings"
                },
                {
                    "@type": "Offer",
                    "name": "ESOP Trust Route Add-On",
                    "priceCurrency": "INR",
                    "price": "35000",
                    "description": "Trust deed registration, trustees minutes, ITR-7, trust audit coordination"
                }
            ]
        }
    }
    ...
    <script type="application/ld+json">
    {
        "@context": "https://schema.org",
        "@type": "BreadcrumbList",
        "@id": "https://www.patronaccounting.com/esop-corporate-filings/#breadcrumb",
        "itemListElement": [
            {
                "@type": "ListItem",
                "position": 1,
            ...
            },
            {
                ...
                "item": "https://www.patronaccounting.com/esop-corporate-filings/"
            }
        ]
    }
    </script>
    <script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "FAQPage",
  "@id": "https://www.patronaccounting.com/esop-corporate-filings/#faq",
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "Is MGT-14 required for every ESOP grant?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "No. MGT-14 is required only when a special resolution is passed - this happens at scheme adoption, pool top-up, scheme variation and AoA amendment. Routine grants from within an already approved pool require only a Board Resolution, recorded in minutes within 15 days, with SH-6 register updates - no MGT-14."
      }
    },
    {
      "@type": "Question",
    ...
    {
      "@type": "Question",
      "name": "What filings are required for ESOP Trust?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "ESOP Trust route adds these filings - Trust Deed registration with the Sub-Registrar under Section 25 of the Indian Trusts Act 1882, Trust PAN application, trustees first board minutes documenting trust formation, annual trustees meeting minutes, ITR-7 annual income tax return under Section 139(4A), trust accounts audit if turnover thresholds met, and SEBI SBEB Regulation 19 compliance for listed companies running ESOP through Trust."
      }
    },
    {
      "@type": "Question",
    ...
    {
      "@type": "Question",
      "name": "ESOP filing kaise karte hain? (How are ESOP filings done?)",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "ESOP filings step-by-step - first scheme ke liye EGM aur Special Resolution, fir MGT-14 30 din mein. Har grant ke liye Board Resolution aur SH-6 entry. Har exercise pe Allotment Resolution aur PAS-3 30 din mein. Saal ke end mein MGT-7 mein ESOP details aur Directors' Report mein Rule 12(9) disclosure. Trust hai to ITR-7 separately. Patron annual retainer mein sab handle karta hai. Call +91 945 945 6700."
      }
    }
  ]
}
...
@section('content')
@push('styles')
<link rel="stylesheet" href="{{ asset('css/pages-12.css') }}?v=1">
@endpush
<main>
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Fees:</span> Rs 50,000 to Rs 1,50,000 per year retainer plus per-grant and per-allotment statutory fees</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="https://wa.me/919459456700?text=Hello%2C%20I%20just%20visited%20your%20ESOP%20Corporate%20Filings%20page.%20I%20would%20like%20to%20know%20more%20about%20it." target="_blank" class="btn-sample text-decoration-none" rel="noopener">
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>ESOP corporate filings are the ongoing compliance layer that keeps your scheme legally valid after Day 1. Every grant tranche generates Board minutes. Every exercise generates an allotment Board Resolution plus a PAS-3 within 30 days. Every scheme modification needs a fresh special resolution and MGT-14. Every annual return requires the ESOP movement table in MGT-7 and the Rule 12(9) disclosure in the Directors' Report.</p>
                <p>Companies miss these silently and discover the gap at Series A diligence or at an MCA penalty notice. Patron Accounting LLP delivers all ESOP-specific MCA filings on a single annual retainer, run by qualified Company Secretaries. The firm has handled corporate secretarial work for startups, growth-stage companies and listed entities since 2009 across offices in Pune, Mumbai, Delhi and Gurugram.</p>
        ...
        <div class="two-column">
            <div class="column-content">
                ...
                <div class="content-text what-is-definition">
                    ...
                    <p>ESOP corporate filings are the suite of MCA forms, board minutes, statutory registers and annual return disclosures a company must maintain on an ongoing basis to keep its Employee Stock Option Plan compliant under Section 62(1)(b) of the Companies Act 2013 and Rule 12 of the Companies (Share Capital and Debentures) Rules 2014.</p>
                    <p>The core filings are MGT-14 for special resolutions, PAS-3 for share allotment on exercise, MGT-7 for the annual return ESOP movement disclosure and the Form SH-6 Register of Employee Stock Options.</p>
                    <p>ESOP Trust route adds trust deed registration, trustees minutes and ITR-7 filings. Cross-border employee exercise adds FC-GPR within 30 days under FEMA. Listed companies running ESOP through Trust must also comply with SEBI (Share Based Employee Benefits and Sweat Equity) Regulations 2021 Regulation 19.</p>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>ESOP filings are not periodic in a fixed sense - they are triggered by specific corporate events. Understanding which event triggers which filing avoids both over-filing and missed deadlines.</p>
...
<section class="steps-section" id="procedure-section">
    <div class="section-container">
        <div class="section-header" style="text-align:center;margin-bottom:48px;">
            ...
            <p class="section-subtitle" style="text-align:left;max-width:100%;">From employee exercise notice to MCA21 filing and SH-6 register update, Patron's CS team runs the seven-step PAS-3 procedure within Section 39(4)'s 30-day window. Most allotments are filed within 10 working days of exercise.</p>
        </div>
            ...
            <div class="content-text">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr><td>Seed Stage (1 scheme, up to 10 grantees)</td><td>Board minutes, SH-6 maintenance, MGT-14 (1 per year if needed), PAS-3 (up to 4 per year), MGT-7 disclosure</td><td class="table-amount">Rs 50,000 to Rs 75,000 per year</td></tr>
                        <tr><td>Growth Stage (1 scheme, 11 to 50 grantees)</td><td>Quarterly Board cycles, multiple PAS-3 allotments, scheme variations, full Directors' Report disclosure</td><td class="table-amount">Rs 75,000 to Rs 1,00,000 per year</td></tr>
                        <tr><td>Scale Stage (2 to 3 schemes, 50 plus grantees)</td><td>Multi-scheme reconciliation, group consolidation, accelerated vesting events, modification filings</td><td class="table-amount">Rs 1,00,000 to Rs 1,50,000 per year</td></tr>
                        <tr><td>ESOP Trust Route Add-On</td><td>Trust deed registration, trustees minutes, ITR-7, trust audit coordination</td><td class="table-amount">Rs 35,000 to Rs 75,000 per year</td></tr>
                        <tr><td>Cross-Border Add-On</td><td>FC-GPR, FC-TRS for foreign employees under FEMA</td><td class="table-amount">Rs 15,000 to Rs 25,000 per filing</td></tr>
                        <tr><td>Per-Allotment PAS-3 (One-Off)</td><td>Single PAS-3 with allotment Board Resolution and share certificate issuance</td><td class="table-amount">Rs 7,500 to Rs 12,500 per filing</td></tr>
                        <tr><td>MGT-14 (One-Off)</td><td>Special resolution drafting plus filing within 30 days</td><td class="table-amount">Rs 7,500 to Rs 15,000 per filing</td></tr>
                        <tr><td><strong>Patron Accounting Professional Fees</strong></td><td>Standard starting price for Seed Stage annual ESOP filings retainer (1 scheme, up to 10 grantees)</td><td class="table-amount"><strong>Starting from INR 50,000 per year (Excl. GST and Govt. Charges)</strong></td></tr>
...
<section class="why-choose-section" id="benefits-section">
    ...
    <article class="feature-card">
        <h3>Single Retainer, All ESOP Filings</h3>
        <p>One annual fee covers MGT-14, PAS-3, MGT-7, SH-6 register and Directors' Report disclosure. No per-form invoicing surprises across the year.</p>
    </article>
    <article class="feature-card">
        <h3>CS as Point Person</h3>
        <p>Qualified Company Secretary as the named point of accountability. Partner-level oversight on all special resolutions and EGM workflows.</p>
    </article>
    <article class="feature-card">
        <h3>Customised Filing Calendar</h3>
        <p>Year-ahead Filing Calendar mapped to your scheme cycle - grant batches, vesting waves, AGM and MGT-7 deadlines. Quarterly reviews.</p>
    </article>
    <article class="feature-card">
        <h3>Cross-Functional Coordination</h3>
        <p>Integrated with valuation (IBBI / Merchant Banker), accounting (Ind AS 102 / Schedule III) and tax (Section 17(2)(vi) perquisite) teams for end-to-end ESOP workflow.</p>
    </article>
    <article class="feature-card">
        <h3>Trust-Route Capability</h3>
        <p>Full ESOP Trust set up and ongoing trustees minutes, ITR-7, trust audit coordination. SEBI SBEB Regulation 19 for listed companies.</p>
    </article>
    <article class="feature-card">
        <h3>Cross-Border Filings In-House</h3>
        <p>FC-GPR and FC-TRS for foreign employees handled under the same retainer. No outsourcing to a separate law firm at additional cost.</p>
    </article>
</div>
    </div>
</section>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p>Our previous CS treated PAS-3 as private placement (15-day window) and we were filing late despite being well within the Section 39 30-day window for ESOPs. Patron corrected the workflow, recovered 2 years of overpaid late fees and runs our quarterly cycle on time. - CFO, B2B SaaS startup (Pune).</p>
                <p>We set up an ESOP Trust as part of moving to SEBI SBEB-style implementation. Patron handled trust deed registration, ITR-7, trustees minutes and the SEBI SBEB Regulation 19 compliance work alongside our existing ESOP filings. - CEO, listed mid-cap (Mumbai).</p>
            ...
            <div class="content-text">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr><td><strong>Total cost (Series A scale)</strong></td><td>Rs 6 to 8 lakh fully loaded annual salary plus tools</td><td>Rs 75,000 to Rs 1,00,000 per year</td></tr>
            ...
            <div class="faq-expanded">
                ...
                <div class="faq-expanded__list">
                    ...
                    <div class="faq-expanded__item" id="faq-3">
                        <h3 class="faq-expanded__q">Is MGT-14 required for every ESOP grant?</h3>
                        <div class="faq-expanded__a"><p>No. MGT-14 is required only when a special resolution is passed - this happens at scheme adoption, pool top-up, scheme variation and AoA amendment. Routine grants from within an already approved pool require only a Board Resolution, recorded in minutes within 15 days, with SH-6 register updates - no MGT-14.</p></div>
                    </div>
                    ...
                    <div class="faq-expanded__item" id="faq-6">
                        <h3 class="faq-expanded__q">What filings are required for ESOP Trust?</h3>
                        <div class="faq-expanded__a"><p>ESOP Trust route adds these filings - Trust Deed registration with the Sub-Registrar under Section 25 of the Indian Trusts Act 1882, Trust PAN application, trustees first board minutes documenting trust formation, annual trustees meeting minutes, ITR-7 annual income tax return under Section 139(4A), trust accounts audit if turnover thresholds met, and SEBI SBEB Regulation 19 compliance for listed companies running ESOP through Trust.</p></div>
                    </div>
                    ...
                    <div class="faq-expanded__item" id="faq-8">
                        <h3 class="faq-expanded__q">ESOP filing kaise karte hain? (How are ESOP filings done?)</h3>
                        <div class="faq-expanded__a"><p>ESOP filings step-by-step - first scheme ke liye EGM aur Special Resolution, fir MGT-14 30 din mein. Har grant ke liye Board Resolution aur SH-6 entry. Har exercise pe Allotment Resolution aur PAS-3 30 din mein. Saal ke end mein MGT-7 mein ESOP details aur Directors' Report mein Rule 12(9) disclosure. Trust hai to ITR-7 separately. Patron annual retainer mein sab handle karta hai. Call +91 945 945 6700.</p></div>
                    </div>
                </div>
            </div>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div style="display:flex;gap:14px;flex-wrap:wrap;margin-top:24px;">
                ...
                <a href="https://wa.me/919459456700?text=Hello%2C%20I%20just%20visited%20your%20ESOP%20Corporate%20Filings%20page.%20I%20would%20like%20to%20know%20more%20about%20it." target="_blank" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:#25D366;color:#fff;border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;" rel="noopener">&#128172; WhatsApp Us</a>
...
<section class="content-section" style="padding:48px 32px;background:var(--gray-50);">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title" style="text-align:center;margin-bottom:12px;">Pan-India Coverage for ESOP Corporate Filings</h2>
            <p style="text-align:center;color:var(--text-muted);font-size:15px;margin-bottom:40px;">ESOP corporate filings are delivered remotely from our Pune, Mumbai, Delhi and Gurugram offices to companies across India. The MCA21 portal is national - registered office location does not constrain the filing workflow.</p>
