...
@section('meta')
    ...
    <meta name="twitter:image" content="/images/financial-ratios-og.webp">
@endsection
...
@section('schema')
    <script type="application/ld+json">
    {
      ...
      "@graph": [
        {
          "@type": "BreadcrumbList",
          "@id": "/financial-ratios#breadcrumb",
          "itemListElement": [
            { "@type": "ListItem", "position": 1, "name": "Home", "item": "/" },
            { "@type": "ListItem", "position": 2, "name": "Accounting Services", "item": "/accounting-services" },
            { "@type": "ListItem", "position": 3, "name": "Financial Ratios Analysis and Schedule III Disclosure", "item": "/financial-ratios" }
          ]
        },
        {
          "@type": "FAQPage",
          "@id": "/financial-ratios#faq",
          "mainEntity": [
        ...
        <div class="row align-items-center">
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="https://wa.me/919459456700?text=Hi%20Patron%2C%20I%20need%20financial%20ratios%20analysis%20-%20Schedule%20III%20disclosure%2Fdashboard%2Flender%20report." target="_blank" class="btn-sample text-decoration-none">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'Financial Ratios - Schedule III',
                    'options'  => [
                        'Financial Ratios - Schedule III' => 'Financial Ratios - Schedule III Disclosure',
                        'Monthly CFO Dashboard' => 'Monthly CFO Ratio Dashboard',
                        'Lender Ratio Report' => 'Lender Ratio Report',
                        'Industry Benchmarking' => 'Industry Ratio Benchmarking',
                        'CFO Analytics Retainer' => 'CFO Analytics Retainer',
...
<section class="testimonials-section">
    <div class="section-container">
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            ...
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Series-B fundraise needed a 12-quarter ratio walk-through. Patron built the model in 3 weeks - Schedule III + sector benchmarks + projected covenants. Lead investor called it the cleanest pack they had seen this year.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div><div style="font-weight:700;font-size:13px;color:var(--blue);">CFO</div><div style="font-size:12px;color:var(--text-muted);margin-top:2px;">SaaS Startup, Series B</div><div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div></div>
                <div style="margin-left:auto;font-size:11px;color:var(--text-muted);">1 month ago</div>
            </div>
        </div>
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">The 25 percent variance explanations were entity-specific and audit-ready. Our statutory auditor signed off the Note 9 disclosure without a single query.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                ...
                <div><div style="font-weight:700;font-size:13px;color:var(--blue);">Finance Controller</div><div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Mfg Pvt Ltd</div><div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div></div>
                <div style="margin-left:auto;font-size:11px;color:var(--text-muted);">2 months ago</div>
            </div>
        </div>
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Consortium lender meeting needed covenant tables across four banks with uniform projections. Patron delivered DSCR, debt-equity and current ratio with documented workings.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                <div style="width:36px;height:36px;border-radius:50%;background:var(--orange);display:flex;align-items:center;justify-content:center;font-weight:700;font-size:13px;color:#fff;flex-shrink:0;">CB</div>
                <div><div style="font-weight:700;font-size:13px;color:var(--blue);">Group CFO</div><div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Mid-Corporate</div><div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div></div>
                <div style="margin-left:auto;font-size:11px;color:var(--text-muted);">3 months ago</div>
            </div>
        </div>
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
            <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
            <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Monthly CFO dashboard within 5 business days of book close, every month. Trend charts and variance commentary make our Board pack effortless.</div>
            <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                <div style="width:36px;height:36px;border-radius:50%;background:var(--blue);display:flex;align-items:center;justify-content:center;font-weight:700;font-size:13px;color:#fff;flex-shrink:0;">VC</div>
                <div><div style="font-weight:700;font-size:13px;color:var(--blue);">VP Finance</div><div style="font-size:12px;color:var(--text-muted);margin-top:2px;">VC-Backed Scaleup</div><div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div></div>
        ...
        <div class="reviews-cta" style="margin-top: 16px; display: flex !important;">
            <div class="reviews-cta-content">
                ...
                <div class="reviews-cta-text">
                    ...
                    <p>CFOs, founders, and Audit Committees trust Patron's Schedule III Note 9 specialty, lender consortium ratio reporting, and audit-defensible working papers - partner CA on every engagement.</p>
                </div>
            </div>
...
<tr><td>Patron Accounting Professional Fees</td><td>Starting from Rs 25,000 (Exl GST and Govt. Charges)</td></tr>
                ...
                <p style="margin-top:16px;"><strong>Get a free Financial Ratios consultation - <a href="tel:+919459456700">Call +91 945 945 6700</a> or <a href="https://wa.me/919459456700?text=Hi%20Patron%2C%20I%20need%20a%20fixed-fee%20quote%20for%20financial%20ratios%20analysis." target="_blank">WhatsApp us</a>. No-obligation assessment.</strong></p>
            </div>
        </div>
    </div>
</section>
