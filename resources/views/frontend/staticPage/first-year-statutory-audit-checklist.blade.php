        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'First Year Statutory Audit',
                    'options'  => [
                        'First Year Statutory Audit' => 'First Year Statutory Audit',
                        'Statutory Audit' => 'Statutory Audit (India)',
                        'Appointment of Auditor' => 'Appointment of Auditor (ADT-1)',
                        'CARO 2020 Reporting' => 'CARO 2020 Reporting',
                        'IFC Audit' => 'Internal Financial Controls Audit',
                        'Schedule III Compliance' => 'Schedule III Compliance',
                        'Pvt Ltd Compliance' => 'Private Limited Company Compliance',
                        'Change of Auditor' => 'Change of Auditor',
                        'Tax Audit' => 'Tax Audit (Section 44AB)',
                        'Other' => 'Other',
                    ],
                ])
            </div>
