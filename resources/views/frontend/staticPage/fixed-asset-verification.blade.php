...
<title>Fixed Asset Verification: Physical Count and FAR Match | Patron Accounting</title>
    ...
    <meta property="og:image" content="https://www.patronaccounting.com/images/fixed-asset-verification-og.webp">
    ...
    <meta name="twitter:image" content="https://www.patronaccounting.com/images/fixed-asset-verification-og.webp">
...
<li><span style="color:var(--orange);font-weight:600;">Fixed Asset Verification</span></li>
</ol>
    </div>
</nav>
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - Fixed Asset Verification'/>
...
<option value='Fixed Asset Verification' selected>Fixed Asset Verification</option>
