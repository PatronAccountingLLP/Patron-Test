        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'form-10bd-donor-wise-donation-statement',
                    'options'  => [
                        'form-10bd-donor-wise-donation-statement' => 'Form 10BD Statement of Donations',
                        'form-10be-donor-certificate-management' => 'Form 10BE Donor Certificate Management',
                        '80g-registration' => '80G Registration',
                        '12a-80g-renewal-5-year-cycle' => '12A and 80G Renewal (5-Year Cycle)',
