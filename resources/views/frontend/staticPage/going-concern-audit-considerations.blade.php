        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'going-concern-audit-considerations',
                    'options'  => [
                        'going-concern-audit-considerations' => 'Going Concern Audit Considerations (this page)',
                        'statutory-audit' => 'Statutory Audit (general)',
                        'qualified-vs-unqualified-audit-opinion' => 'Qualified vs Unqualified Opinion',
                        'audit-report-types-india' => 'Audit Report Types',
                        'caro-2020-reporting' => 'CARO 2020 Reporting',
                        'internal-financial-controls-audit' => 'IFC Audit',
                        'other' => 'Other',
                    ],
                ])
            </div>
