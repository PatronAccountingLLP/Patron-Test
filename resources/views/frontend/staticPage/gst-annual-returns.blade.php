            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - GST Annual Returns'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="gst-annual-returns" selected>GST Annual Returns (GSTR-9 / GSTR-9C)</option>
                                <option value="gst-returns">GST Returns (Monthly/Quarterly)</option>
                                <option value="gst-registration">GST Registration</option>
                                <option value="gst-audit">GST Audit</option>
                                <option value="gst-notice">GST Notice Assistance</option>
