            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - GST Audit'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="gst-audit" selected>GST Audit / GSTR-9C</option><option value="gst-returns">GST Returns Filing</option><option value="gst-registration">GST Registration</option><option value="gst-notice">GST Notice Response</option><option value="tax-audit">Tax Audit</option><option value="statutory-audit">Statutory Audit</option><option value="other">Other</option>
