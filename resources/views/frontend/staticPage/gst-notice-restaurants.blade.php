        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'gst-notice-restaurants',
                    'options'  => [
                        'gst-notice-restaurants' => 'GST Notice for Restaurants (this page)',
                        'gst-notice' => 'GST Notice (National Parent)',
                        'gst-returns-for-restaurants-food-businesses' => 'GST Returns for Restaurants',
                        'gst-returns-for-e-commerce-operator' => 'GST Returns for ECO',
                        'gst-audit' => 'GST Audit',
