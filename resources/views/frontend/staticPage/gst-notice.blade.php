                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="gst-notice" selected>GST Notice Reply</option><option value="gst-registration">GST Registration</option><option value="gst-return-filing">GST Return Filing</option><option value="gst-annual-return">GST Annual Return</option><option value="gst-cancellation">GST Cancellation</option><option value="income-tax-notice">Income Tax Notice</option><option value="gst-returns">GST Returns</option><option value="other">Other</option>
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    ...
                    @include('partials.faq-enquiry-form', ['enquiryService' => 'GST Notice'])
                </aside>
