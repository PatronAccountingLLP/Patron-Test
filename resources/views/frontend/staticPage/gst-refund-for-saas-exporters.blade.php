...
@section('meta')
    ...
    <meta property="og:image" content="/images/gst-refund-for-saas-exporters-og.webp">
    ...
    <meta name="twitter:image" content="/images/gst-refund-for-saas-exporters-og.webp">
@endsection
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <iframe name='hidden208810000001209168Frame' id='hidden208810000001209168Frame' style='display:none;' src='about:blank'></iframe>
                        ...
                        'deal' => 'Website Enquiry - GST Refund for SaaS Exporters',
                        'options' => [
                            ['value' => '', 'label' => 'Select a service', 'selected' => true, 'disabled' => true],
                            ['value' => 'gst-refund-for-saas-exporters', 'label' => 'GST Refund for SaaS Exporters', 'selected' => true, 'disabled' => false],
                            ...
                            ['value' => 'gstat-appeal-it-software', 'label' => 'GSTAT Appeal for IT and Software', 'selected' => false, 'disabled' => false],
        ...
        <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
                ...
                <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                    ...
                    <div>
                        ...
                        <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Founder, B2B SaaS Startup</div>
            ...
            <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
                ...
                <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                    ...
                    <div>
                        ...
                        <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">CFO, Vertical SaaS Platform</div>
                        <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                    </div>
            ...
            <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
                <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
                <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Stripe FIRA reconciliation was our biggest headache. Patron mapped every Standard Chartered payment advice to invoices and filed Statement 2 cleanly. We now file refunds monthly without rejection notices or deficiency memos.</div>
                <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                    ...
                    <div>
                        ...
                        <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">CEO, API Platform Company</div>
                        <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                    </div>
            ...
            <div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
                <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
                <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Our place-of-supply was challenged as intermediary services under Section 13(8)(b). The Patron team prepared a complete opinion citing CBIC Circular 159 and won the case. We have now recovered 18 months of stuck refunds.</div>
                <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
                    ...
                    <div>
                        ...
                        <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Finance Director, HR-Tech SaaS</div>
                        <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                    </div>
        ...
        <div class="reviews-cta" style="margin-top: 16px; display: flex !important;">
            <div class="reviews-cta-content">
                ...
                <div class="reviews-cta-text">
                    ...
                    <p>From bootstrapped SaaS startups to scaling platforms, we handle monthly RFD-01 cycles, FIRC reconciliation, and place-of-supply opinions for service exporters across India.</p>
                </div>
            </div>
