...
@section('meta')
    ...
    <meta property="og:image" content="/images/gst-refund-rfd-01-filing-og.webp">
    ...
    <meta name="twitter:image" content="/images/gst-refund-rfd-01-filing-og.webp">
@endsection
    ...
    <script type="application/ld+json">
{
  ...
  "@graph": [
    {
      "@type": "BreadcrumbList",
      "@id": "/gst-refund-rfd-01-filing/#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
        ...
        },
        {
          ...
          "position": 3,
          "name": "RFD-01 Filing",
          "item": "/gst-refund-rfd-01-filing/"
        }
      ]
    },
    {
      "@type": "FAQPage",
      "@id": "/gst-refund-rfd-01-filing/#faq",
    ...
    {
      "@type": "Service",
      "@id": "/gst-refund-rfd-01-filing/#service",
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - RFD-01 Filing'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                <option value='' disabled selected>Select a service</option>
                                                                <option value="gst-refund-rfd-01-filing" selected>GST RFD-01 Filing</option>
