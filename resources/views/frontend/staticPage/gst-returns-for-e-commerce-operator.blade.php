      ...
      "@graph": [
        {
          ...
          "url": "/gst-returns-for-e-commerce-operator",
        ...
        },
        {
          ...
          "itemListElement": [
            ...
            },
            {
              ...
              "position": 2,
              "name": "E-commerce GST Returns: GSTR-8 TCS",
              "item": "/gst-returns-for-e-commerce-operator"
            }
          ]
        },
        {
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - E-commerce GST Returns'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="gst-returns-for-e-commerce-operator" selected>E-commerce GST Returns</option>
                                <option value="gst-registration">GST Registration</option>
                                <option value="gst-returns">GST Returns (General)</option>
