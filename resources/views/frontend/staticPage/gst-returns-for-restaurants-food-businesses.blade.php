...
@section('meta')
    ...
    <meta property="og:image" content="/images/gst-returns-for-restaurants-food-businesses-og.webp">
    ...
    <meta name="twitter:image" content="/images/gst-returns-for-restaurants-food-businesses-og.webp">
@endsection
      ...
      "@graph": [
        {
          ...
          "url": "/gst-returns-for-restaurants-food-businesses",
        ...
        },
        {
          ...
          "itemListElement": [
            ...
            },
            {
              ...
              "position": 2,
              "name": "Restaurant GST Returns: Filing Guide",
              "item": "/gst-returns-for-restaurants-food-businesses"
            }
          ]
        },
        {
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - GST Returns for Restaurants'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="gst-returns-for-restaurants-food-businesses" selected>GST Returns (Restaurants)</option><option value="gst-registration">GST Registration</option><option value="gst-returns">GST Returns (All)</option><option value="fssai-registration">FSSAI Registration</option><option value="fssai-returns">FSSAI Returns</option><option value="gst-notice">GST Notice Reply</option><option value="hospitality-sector-accounting-services">Hospitality Accounting</option><option value="other">Other</option>
