        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'gst-returns-for-restaurants-food-businesses',
                    'options'  => [
                        'gst-returns-for-restaurants-food-businesses' => 'GST Returns (Restaurants)',
                        'gst-registration' => 'GST Registration',
                        'gst-returns' => 'GST Returns (All)',
                        'fssai-registration' => 'FSSAI Registration',
                        'fssai-returns' => 'FSSAI Returns',
                        'gst-notice' => 'GST Notice Reply',
                        'hospitality-sector-accounting-services' => 'Hospitality Accounting',
                        'other' => 'Other',
                    ],
                ])
            </div>
