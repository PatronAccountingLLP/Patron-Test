            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - GST Returns for SEZ'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="gst-returns-for-sez" selected>GST Returns (SEZ)</option><option value="gst-registration">GST Registration</option><option value="gst-returns">GST Returns (All)</option><option value="gst-audit">GST Audit</option><option value="iec-registration">IEC Registration</option><option value="fdi-compliance">FDI Compliance</option><option value="gst-notice">GST Notice Reply</option><option value="other">Other</option>
