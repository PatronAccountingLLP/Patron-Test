...
@section('meta')
    ...
    <meta property="og:description" content="GSTAT appeal for educational institutions facing GST exemption boundary disputes, coaching classification, and affiliation fee taxation. 10% pre-deposit. 3-month deadline. CA and CS Team, Patron Accounting LLP.">
    <meta property="og:url" content="/gstat-appeal-education">
    <meta property="og:type" content="website">
    <meta property="og:site_name" content="Patron Accounting">
    <meta property="og:image" content="/images/gstat-appeal-education-og.webp">
    <meta property="og:locale" content="en_IN">
    <meta property="og:locale" content="en_IN">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Education GSTAT Appeal - GST Exemption | Patron">
    <meta name="twitter:description" content="GSTAT appeal for educational institutions facing GST exemption boundary disputes, coaching classification, and affiliation fee taxation. 10% pre-deposit. 3-month deadline. CA and CS Team, Patron Accounting LLP.">
    <meta name="twitter:image" content="/images/gstat-appeal-education-og.webp">
@endsection
...
@section('schema')
    <script type="application/ld+json">
    {
      ...
      "@graph": [
        {
          "@type": "Service",
          "name": "Education GSTAT Appeal: GST Exemption Disputes",
          "description": "GSTAT appeal for educational institutions facing GST exemption boundary disputes, coaching classification, and affiliation fee taxation. 10% pre-deposit. 3-month deadline. CA and CS Team, Patron Accounting LLP.",
          "url": "https://www.patronaccounting.com/gstat-appeal-education",
          "serviceType": "Education GSTAT Appeal: GST Exemption Disputes",
          "areaServed": {
            "@type": "Country",
            "name": "India"
          },
        ...
        },
        {
          ...
          "itemListElement": [
            ...
            },
            {
              ...
              "position": 2,
              "name": "Education GSTAT Appeal: GST Exemption Disputes",
              "item": "https://www.patronaccounting.com/gstat-appeal-education"
            }
          ]
        },
        {
          ...
          "mainEntity": [
            {
              "@type": "Question",
              "name": "What is the pre-deposit for a GSTAT appeal on an education exemption rejection?",
              "acceptedAnswer": {
                "@type": "Answer",
            ...
            {
              "@type": "Question",
              "name": "What is the time limit to file a GSTAT appeal for education exemption rejection?",
              "acceptedAnswer": {
                "@type": "Answer",
            ...
            },
            {
              ...
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "Yes - Section 112(9) CGST Act provides automatic stay of recovery of the remaining disputed amount once the appeal is admitted with confirmed pre-deposit. This protects institutional cash flow during proceedings."
              }
            },
            {
              "@type": "Question",
              "name": "What education GST exemption disputes can be appealed at GSTAT?",
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "Common disputes include exemption boundary under Notification 12/2017-CT(Rate) Entry 66 , coaching institute classification at 18%, university affiliation fee taxation, online education and EdTech platform taxability, and vocational training exemption disputes."
              }
            },
            {
              "@type": "Question",
              "name": "Can the GSTAT appeal deadline be extended for educational institutions?",
              "acceptedAnswer": {
                "@type": "Answer",
            ...
            {
              "@type": "Question",
              "name": "Is coaching institute GST classification 18% or exempt?",
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "Coaching institutes are generally taxable at 18% GST . The exemption under Notification 12/2017 Entry 66 applies only to educational institutions providing education as part of a curriculum for obtaining a qualification recognised by law. Commercial coaching falls outside this exemption boundary."
              }
            },
            {
              "@type": "Question",
              "name": "What is Notification 12/2017 Entry 66 education exemption?",
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "Entry 66 of Notification 12/2017-CT(Rate) exempts services by educational institutions to students, faculty, and staff. The exemption covers education as part of a curriculum leading to a qualification recognised by any law. The boundary between exempt education and taxable coaching is the most litigated issue."
              }
            }
          ]
        }
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-4 private-registration-heading">
                        GSTAT Appeal for Education - GST Exemption and Classification Disputes
                    </h1>
                    ...
                    <div class="mb-4">
                        <div class="d-flex align-items-start mb-3">
                            ...
                            <p class="mb-0 text-dark benefit-paragraph"><span>Dispute Types:</span> GST exemption boundary disputes under Notification 12/2017-CT(Rate) and coaching institute classification at 18%</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="mailto:sales@patronaccounting.com?subject=GSTAT%20Appeal%20-%20Education%20GST%20Exemption%20Dispute&body=Hello%2C%0A%0AI%20need%20help%20with%20a%20GSTAT%20appeal%20for%20an%20education%20GST%20exemption%20dispute.%20Please%20contact%20me.%0A%0ARegards" class="btn-sample text-decoration-none">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:18px;height:18px;"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,12 2,6"/></svg>
                            Email Us
                        </a>
                        <a href="https://wa.me/919459456700?text=Hello%2C%20I%20need%20help%20with%20a%20GSTAT%20appeal%20for%20an%20education%20GST%20exemption%20dispute.%20Please%20contact%20me." target="_blank" class="btn-sample text-decoration-none">
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <iframe name='hidden208810000001209168Frame' id='hidden208810000001209168Frame' style='display:none;' src='about:blank'></iframe>
                        ...
                        'deal' => 'Website Enquiry - GSTAT Appeal for Education',
                        'options' => [
                            ['value' => '', 'label' => 'Select a service', 'selected' => true, 'disabled' => true],
                            ['value' => 'GSTAT Appeal - Education', 'label' => 'GSTAT Appeal - Education GST Exemption', 'selected' => true, 'disabled' => false],
...
<section class="testimonials-section">
    ...
    <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Our university received a Rs 4.8 crore GST demand on affiliation fees. Patron Accounting's GSTAT team structured the Entry 66 argument brilliantly and secured the stay of recovery within weeks. The depth of exemption knowledge was outstanding.</div>
    <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
        ...
        <div>
            ...
            <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">University, Pune</div>
...
<div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
    <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
    <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">The coaching classification dispute seemed hopeless after the Commissioner Appeals upheld the 18% demand. Patron Accounting identified specific Entry 66 arguments we had missed and filed a strong GSTAT appeal.</div>
    <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
        ...
        <div>
            ...
            <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Coaching Institute Chain, Delhi</div>
            <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
        </div>
...
<div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
    <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
    <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Surbhi Premi's understanding of the education exemption boundary is exceptional. Her analysis of UGC recognition requirements and the Entry 66 scope helped us build a defence our internal team could not have prepared.</div>
    <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
        ...
        <div>
            ...
            <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Educational Trust, Mumbai</div>
            <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
        </div>
...
<div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
    <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
    <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Our EdTech platform faced a classification dispute on online courses. Patron Accounting navigated the OIDAR vs education exemption distinction and filed the GSTAT appeal with supporting CBIC circulars. Highly recommended.</div>
    <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
        ...
        <div>
            ...
            <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">CFO, EdTech Platform</div>
            <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
        </div>
...
<div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
    <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
    <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">The pre-deposit calculation for our education exemption dispute was complex given the multi-year demand. Patron Accounting computed the exact Section 112(8) obligation and secured the stay on the full balance. Invaluable for our budget planning.</div>
    <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
        ...
        <div>
            ...
            <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Vocational Training Institute, Bangalore</div>
            <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
        </div>
...
<section class="content-section" id="overview-section">
    ...
    <p style="color:var(--text-secondary);font-size:15px;line-height:1.7;"><strong>1.</strong> File GSTAT appeal within 3 months under Section 112(1) CGST Act. <strong>2.</strong> Pay 10% pre-deposit on disputed amount under Section 112(8) - capped at Rs 20 crore. <strong>3.</strong> Contact Patron Accounting for education GST exemption and classification dispute representation.</p>
</div>
<div class="table-responsive-wrapper"><table><thead><tr><th>Parameter</th><th>Detail</th></tr></thead><tbody>
    <tr><td>Dispute Types</td><td>Exemption boundary (Notification 12/2017 Entry 66), coaching 18% classification, affiliation fees, EdTech taxability</td></tr>
    <tr><td>Governing Law</td><td>Section 112, CGST Act 2017 read with Notification 12/2017-CT(Rate)</td></tr>
...
<p>Educational institutions facing GST exemption denial, coaching institute classification at 18%, or university affiliation fee taxation now have a dedicated appellate remedy through the Goods and Services Tax Appellate Tribunal (GSTAT). <strong>GSTAT appeal for education GST exemption disputes</strong> under Section 112 CGST Act 2017 requires specialist representation combining knowledge of Notification 12/2017-CT(Rate) Entry 66 boundaries with tribunal litigation strategy.</p>
<p>Patron Accounting's GSTAT practice addresses the full spectrum of education exemption disputes - from exemption boundary classification to affiliation fee and EdTech taxability disputes. Under <strong>Section 112 CGST Act 2017</strong>, GSTAT is the second appellate forum with binding authority on matters of fact.</p>
            </div>
    </div>
</section>
    ...
    <div class="content-container">
        <div class="two-column">
            <div class="column-content">
                <h2 class="section-title">What Is a GSTAT Appeal for Education GST Exemption Disputes</h2>
<div class="highlight-box" style="background:var(--blue-lighter);border-left:4px solid var(--blue);padding:20px 24px;border-radius:0 var(--radius-md) var(--radius-md) 0;margin-bottom:24px;"><p style="font-size:15px;color:var(--text-primary);line-height:1.7;margin:0;"><strong>Definition:</strong> An education GST exemption dispute arises when the GST authority denies the exemption under <strong>Entry 66 of Notification 12/2017-CT(Rate)</strong> to an educational institution, reclassifies coaching services at 18%, or levies GST on university affiliation fees or EdTech platform services.</p></div>
<div class="content-text">
    <p>When the first appellate authority under Section 107 CGST Act upholds such a classification or exemption denial order, the educational institution may file a second appeal before GSTAT under <strong><a href="https://taxinformation.cbic.gov.in/content/html/tax_repository/gst/acts/2017_CGST_act/active/chapter18/section112_v1.00.html" target="_blank" rel="noopener">Section 112 CGST Act 2017</a></strong> within 3 months.</p>
    <p>GSTAT, unlike the Commissioner (Appeals) under Section 107 CGST Act, is a judicial body - not a departmental authority - and its orders carry the force of a court decree, making GSTAT the first genuinely independent forum in the GST appellate hierarchy for resolving education exemption disputes.</p>
    <p>GSTAT (Goods and Services Tax Appellate Tribunal), constituted under Section 109 CGST Act 2017, also referred to as the GST Tribunal or GST Appellate Tribunal - all names refer to the same statutory body hearing second appeals in GST matters across India.</p>
</div>
            </div>
    ...
    <svg viewBox="0 0 200 160" fill="none" xmlns="http://www.w3.org/2000/svg" style="width:180px;margin-bottom:16px;">
        ...
        <rect x="55" y="30" width="90" height="10" rx="3" fill="#E8712C" opacity="0.3"/>
        <rect x="55" y="48" width="70" height="6" rx="2" fill="#14365F" opacity="0.15"/>
        <rect x="55" y="60" width="80" height="6" rx="2" fill="#14365F" opacity="0.15"/>
        <circle cx="50" cy="130" r="22" fill="#E8712C" opacity="0.1" stroke="#E8712C" stroke-width="1"/>
        <text x="50" y="134" font-size="8" fill="#E8712C" font-weight="600" text-anchor="middle">Entry 66</text>
        <circle cx="150" cy="130" r="22" fill="#14365F" opacity="0.1" stroke="#14365F" stroke-width="1"/>
        <text x="150" y="134" font-size="8" fill="#14365F" font-weight="600" text-anchor="middle">18% GST</text>
        <line x1="72" y1="130" x2="128" y2="130" stroke="#14365F" stroke-width="1" stroke-dasharray="4 2"/>
    </svg>
    <span class="illustration-badge" style="display:inline-block;background:var(--blue);color:#fff;padding:6px 16px;border-radius:50px;font-size:12px;font-weight:700;">Education GST Exemption vs Classification</span>
</div>
            </div>
        </div>
    </div>
...
<section class="content-section" id="who-section">
    <div class="content-container">
        <div class="text-content">
                <h2 class="section-title">Who Should File a GSTAT Appeal for Education GST Disputes</h2>
<div class="content-text">
    <p>Educational institutions that have received an adverse order from the Commissioner (Appeals) under Section 107 CGST Act should consider filing a GSTAT appeal. Common dispute types include:</p>
    <ul>
        <li><strong>Universities and colleges</strong> - Exemption denial under Entry 66 of Notification 12/2017, affiliation fee GST demands, hostel and mess facility taxation</li>
        <li><strong>Coaching institutes</strong> - Classification at 18% GST where the institute argues educational institution status under the notification</li>
        <li><strong>EdTech platforms</strong> - Online education taxability disputes, OIDAR classification, and recorded content vs live instruction distinction</li>
        <li><strong>Vocational training providers</strong> - NSDC-affiliated training exempt status disputes and skill development programme classification</li>
        <li><strong>Educational trusts and societies</strong> - Charitable and educational trust GST registration and exemption boundary disputes</li>
    </ul>
...
<div class="table-responsive-wrapper"><table><thead><tr><th>Service</th><th>What We Do</th></tr></thead><tbody>
    <tr><td>Exemption Assessment and Pre-Deposit Strategy</td><td>Analyse the exemption denial order, identify grounds of appeal under Notification 12/2017 Entry 66, and calculate pre-deposit under Section 112(8)</td></tr>
    <tr><td>Grounds of Appeal Drafting</td><td>Structure legal arguments on exemption boundary interpretation, institutional status, UGC/NSDC recognition, and supporting HC judgments</td></tr>
    ...
    <tr><td>Stay of Recovery under Section 112(9)</td><td>Secure automatic stay against recovery of GST demand on educational services during GSTAT proceedings</td></tr>
    <tr><td>Hearing Representation</td><td>Advocate representation at GSTAT hearings across all 31 State Benches and the Principal Bench at New Delhi</td></tr>
    <tr><td>High Court Writ under Article 226</td><td>Alternative remedy where GSTAT appeal window has expired or jurisdictional issues arise for education disputes</td></tr>
</tbody></table></div>
            </div>
    </div>
</section>
...
<div class="content-text"><ul>
    <li>Certified copy of impugned order from Commissioner (Appeals) denying exemption</li>
    ...
    <li>Grounds of appeal with specific education exemption dispute details</li>
    <li>Power of attorney or vakalatnama for authorised representative</li>
    <li>UGC/AICTE/NSDC recognition certificates and affiliation documents</li>
    <li>Notification 12/2017-CT(Rate) Entry 66 analysis with curriculum details</li>
    <li>Student enrollment records and course curriculum for exemption claim</li>
    <li>Affiliation agreements and fee receipts (for affiliation fee disputes)</li>
    <li>Supporting CBIC circulars and HC/SC judgments on education exemption</li>
</ul>
<p>Download our checklist - email <a href="mailto:sales@patronaccounting.com?subject=Education%20GSTAT%20Appeal%20Checklist">sales@patronaccounting.com</a> or call <a href="tel:+919459456700">+91 945 945 6700</a>.</p></div>
            </div>
    </div>
</section>
...
<div class="content-text">
    <h3>Exemption Boundary Under Notification 12/2017 Entry 66</h3>
    <p>The most contested issue is whether an institution qualifies as an "educational institution" providing education "as part of a curriculum for obtaining a qualification recognised by any law." In our experience, authorities frequently deny exemption to institutions offering professional development, certificate courses, or skill-based programmes not leading to a UGC-recognised degree.</p>
    <h3>Coaching Institute Classification at 18%</h3>
    <p>Coaching institutes argue they provide education equivalent to recognised institutions. Surbhi Premi notes that the distinction hinges on whether the coaching leads to a qualification recognised by law - competitive exam preparation alone typically does not qualify for the Entry 66 exemption.</p>
    <h3>University Affiliation Fee GST Disputes</h3>
    <p>Universities charging affiliation fees to colleges face demands treating these fees as taxable services rather than part of the educational service chain. Across the matters we have handled, the argument that affiliation is integral to providing education has had mixed success at the first appellate level.</p>
    <h3>Online Education and EdTech Taxability</h3>
    <p>EdTech platforms face classification disputes on whether pre-recorded courses, live online classes, and hybrid learning models qualify for the education exemption or are taxable at 18% as "other services."</p>
...
<div class="content-text">
    ...
    <div class="table-responsive-wrapper"><table class="table-amount"><thead><tr><th>Component</th><th>Amount (Illustrative)</th><th>Basis</th></tr></thead><tbody>
        <tr><td>Total demand order</td><td>Rs 4,80,00,000</td><td>GST demand on affiliation fees - exemption denied</td></tr>
        <tr><td>Disputed tax (IGST)</td><td>Rs 4,00,00,000</td><td>Tax component (18% on affiliation fees)</td></tr>
        <tr><td>Interest + penalty</td><td>Rs 80,00,000</td><td>Interest and penalty components</td></tr>
        <tr><td>S.107(6) - already paid</td><td>Rs 40,00,000</td><td>10% of disputed tax at first appellate stage</td></tr>
        <tr><td>S.112(8) - payable now</td><td>Rs 40,00,000</td><td>10% additional - cap Rs 20 crore</td></tr>
        <tr><td>Total deposited both stages</td><td>Rs 80,00,000</td><td>S.107(6) + S.112(8)</td></tr>
        <tr><td>Balance - stayed S.112(9)</td><td>Rs 4,00,00,000</td><td>Automatic stay on GSTAT admission</td></tr>
    ...
    <p>The 10% deposited under <strong>Section 107(6)</strong> and the 10% under <strong>Section 112(8)</strong> are not independent - paying S.112(8) activates the <strong><a href="/gstat-pre-deposit-calculation">Section 112(9) stay of recovery</a></strong>, protecting the educational institution from coercive recovery during GSTAT proceedings.</p>
</div>
<div style="display:flex;gap:14px;flex-wrap:wrap;margin-top:24px;">
    ...
    <a href="https://wa.me/919459456700?text=Hello%2C%20I%20need%20help%20with%20a%20GSTAT%20appeal%20for%20an%20education%20GST%20exemption%20dispute.%20Please%20contact%20me." target="_blank" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:#25D366;color:#fff;border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;">&#128172; WhatsApp Us</a>
</div>
            </div>
    </div>
</section>
...
<div class="features-grid">
    ...
    <div class="feature-card"><div class="feature-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><h3>Pan-India Coverage</h3><p>Education GSTAT appeals across Pune (trusts), Mumbai (coaching chains), Delhi (university affiliations), and Bangalore (EdTech hub).</p></div>
...
<div class="content-text">
    <blockquote style="border-left:4px solid var(--orange);padding:16px 24px;margin:24px 0;background:var(--gray-50);border-radius:0 var(--radius-md) var(--radius-md) 0;">
        <p style="font-style:italic;color:var(--text-primary);margin:0;">&#8220;Patron Accounting's GSTAT team understood our exemption exposure immediately. Surbhi Premi's approach to structuring the grounds of appeal on Entry 66 was methodical and thorough.&#8221;</p>
        <p style="font-size:13px;color:var(--text-muted);margin-top:8px;">- Finance Director, Educational Trust [Illustrative]</p>
    </blockquote>
    <p>With offices in Pune, Mumbai, Delhi, and Gurugram, Patron Accounting provides GSTAT representation across the Principal Bench at New Delhi and State Benches pan-India - including Pune (educational trusts), Mumbai (coaching chains), Delhi (university affiliations), and Bangalore (EdTech hub).</p>
</div>
            </div>
    </div>
</section>
...
<p style="margin-top:16px;">A GSTAT appeal under Section 112 is the appropriate remedy where the first appellate authority has passed an order on merits rejecting an education exemption claim - unlike a High Court writ under Article 226 which lies only where there is a jurisdictional error, violation of natural justice, or where the GSTAT remedy is time-barred beyond the 4-month outer limit under Section 112(2).</p>
            </div>
    </div>
</section>
...
<div class="table-responsive-wrapper"><table><thead><tr><th>Provision</th><th>Reference</th><th>Key Requirement</th></tr></thead><tbody>
    ...
    <tr><td>Condonation</td><td>Section 112(2) CGST Act</td><td>Max 1 additional month on sufficient cause</td></tr>
    ...
    <tr><td>Education Exemption</td><td>Notification 12/2017-CT(Rate) Entry 66</td><td>Services by educational institutions to students/faculty/staff</td></tr>
    <tr><td>Educational Institution</td><td>Notification 12/2017 Clause 2(y)</td><td>Institution providing education as part of curriculum for qualification recognised by law</td></tr>
    <tr><td>Coaching Classification</td><td><a href="https://cbic-gst.gov.in/" target="_blank" rel="noopener">CBIC</a> Rate Schedule</td><td>Commercial coaching at 18% GST - outside Entry 66 exemption</td></tr>
...
<section class="content-section" id="faq-section">
            ...
            <div class="faq-expanded">
                ...
                <div class="faq-expanded__list">
                    <div class="faq-expanded__item" id="faq-1">
                        <h3 class="faq-expanded__q">What is the pre-deposit for a GSTAT appeal on an education exemption rejection?</h3>
                    ...
                    <div class="faq-expanded__item" id="faq-2">
                        <h3 class="faq-expanded__q">What is the time limit to file a GSTAT appeal for education exemption rejection?</h3>
                    ...
                    <div class="faq-expanded__item" id="faq-4">
                        ...
                        <div class="faq-expanded__a"><p>Yes - <strong>Section 112(9) CGST Act</strong> provides automatic stay of recovery of the remaining disputed amount once the appeal is admitted with confirmed pre-deposit. This protects institutional cash flow during proceedings.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-5">
                        <h3 class="faq-expanded__q">What education GST exemption disputes can be appealed at GSTAT?</h3>
                        <div class="faq-expanded__a"><p>Common disputes include exemption boundary under <strong>Notification 12/2017-CT(Rate) Entry 66</strong>, coaching institute classification at 18%, university affiliation fee taxation, online education and EdTech platform taxability, and vocational training exemption disputes.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-6">
                        <h3 class="faq-expanded__q">Can the GSTAT appeal deadline be extended for educational institutions?</h3>
                    ...
                    <div class="faq-expanded__item" id="faq-7">
                        <h3 class="faq-expanded__q">Is coaching institute GST classification 18% or exempt?</h3>
                        <div class="faq-expanded__a"><p>Coaching institutes are generally taxable at <strong>18% GST</strong>. The exemption under Notification 12/2017 Entry 66 applies only to educational institutions providing education as part of a curriculum for obtaining a qualification recognised by law. Commercial coaching falls outside this exemption boundary.</p></div>
                    </div>
                    <div class="faq-expanded__item" id="faq-8">
                        <h3 class="faq-expanded__q">What is Notification 12/2017 Entry 66 education exemption?</h3>
                        <div class="faq-expanded__a"><p><strong>Entry 66</strong> of Notification 12/2017-CT(Rate) exempts services by educational institutions to students, faculty, and staff. The exemption covers education as part of a curriculum leading to a qualification recognised by any law. The boundary between exempt education and taxable coaching is the most litigated issue.</p></div>
                    </div>
                </div>
            </div>
    ...
    <div class="qa-grid" style="display:grid;grid-template-columns:repeat(2,1fr);gap:16px;">
        ...
        <div><strong>What is the appeal deadline?</strong><br><span style="color:var(--text-secondary);font-size:14px;">3 months from order under Section 112(1). Staggered: 30 June 2026.</span></div>
        <div><strong>Is coaching exempt from GST?</strong><br><span style="color:var(--text-secondary);font-size:14px;">Generally no - 18% GST. Entry 66 exemption requires qualification recognised by law.</span></div>
        <div><strong>Is stay of recovery automatic?</strong><br><span style="color:var(--text-secondary);font-size:14px;">Yes - Section 112(9) provides automatic stay on confirmed pre-deposit.</span></div>
        <div><strong>What form for GSTAT appeal?</strong><br><span style="color:var(--text-secondary);font-size:14px;">Form GST APL-05, filed electronically on efiling.gstat.gov.in.</span></div>
        <div><strong>What is Entry 66 exemption?</strong><br><span style="color:var(--text-secondary);font-size:14px;">Notification 12/2017 exempts educational institution services as part of recognised curriculum.</span></div>
    </div>
</div>
...
<p>Every day from the order communication date reduces your available window. Contact Patron Accounting immediately on receiving an adverse order from the first appellate authority relating to education GST exemption rejection.</p>
<p><strong>Contact us now:</strong> <a href="tel:+919459456700">+91 945 945 6700</a> | <a href="https://wa.me/919459456700?text=Hello%2C%20I%20need%20help%20with%20a%20GSTAT%20appeal%20for%20an%20education%20GST%20exemption%20dispute.%20Please%20contact%20me." target="_blank">WhatsApp Us</a></p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text" style="text-align:left;">
                <p><strong>GSTAT appeal for education GST exemption disputes</strong> under Section 112 CGST Act 2017 provides the dedicated judicial forum that educational institutions have needed - a specialist tribunal with the authority to review and reverse adverse orders on exemption denials, coaching classification, affiliation fee taxation, and EdTech taxability disputes.</p>
<p>Patron Accounting's GSTAT practice, led by of-counsel Advocate Surbhi Premi - former Partner at Lakshmikumaran and Sridharan and a specialist in GST, Customs, and Foreign Trade Policy - brings over 15 years of indirect tax litigation depth to every GSTAT engagement.</p>
            <div class="conclusion-cta-row" style="display:flex;gap:14px;flex-wrap:wrap;margin-top:24px;">
                ...
                <a href="https://wa.me/919459456700?text=Hello%2C%20I%20need%20help%20with%20a%20GSTAT%20appeal%20for%20an%20education%20GST%20exemption%20dispute.%20Please%20contact%20me." target="_blank" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:#25D366;color:#fff;border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#128172; WhatsApp Us</a>
                <a href="mailto:sales@patronaccounting.com?subject=GSTAT%20Appeal%20-%20Education%20GST%20Exemption%20Dispute&body=Hello%2C%0A%0AI%20need%20help%20with%20a%20GSTAT%20appeal%20for%20an%20education%20GST%20exemption%20dispute.%20Please%20contact%20me.%0A%0ARegards" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:transparent;color:#fff;border:2px solid rgba(255,255,255,0.3);border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#9993;&#65039; Email Us</a>
            </div>
...
<section class="content-section" style="padding:32px;">
    <div class="content-container">
        <div class="text-content" style="font-size:13px;color:var(--text-muted);">
            ...
            <p>This page is reviewed every 3 months or upon Finance Act amendments to Section 112 or Section 54, CBIC circulars on education exemption, changes to Notification 12/2017, HC/SC judgments on affiliation fees, coaching classification circulars, EdTech OIDAR rules, or UGC/NSDC notifications.</p>
        </div>
    </div>
</section>
