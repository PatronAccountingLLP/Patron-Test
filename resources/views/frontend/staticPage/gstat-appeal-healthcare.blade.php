...
@section('meta')
    ...
    <meta name="description" content="GSTAT appeal for healthcare ITC reversal disputes under Section 17(5) CGST Act. 10% pre-deposit, 3-month deadline. Led by former LKS Partner. Patron Accounting.">
    ...
    <meta property="og:description" content="GSTAT appeal for healthcare ITC reversal disputes under Section 17(5) CGST Act. 10% pre-deposit, 3-month deadline. Led by former LKS Partner. Patron Accounting.">
    <meta property="og:url" content="/gstat-appeal-healthcare">
    <meta property="og:type" content="website">
    <meta property="og:site_name" content="Patron Accounting">
    <meta property="og:image" content="/images/gstat-appeal-healthcare-og.webp">
    <meta property="og:locale" content="en_IN">
    <meta property="og:locale" content="en_IN">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Healthcare GSTAT Appeal - GST Exemption | Patron">
    <meta name="twitter:description" content="GSTAT appeal for healthcare ITC reversal disputes under Section 17(5) CGST Act. 10% pre-deposit, 3-month deadline. Led by former LKS Partner. Patron Accounting.">
    <meta name="twitter:image" content="/images/gstat-appeal-healthcare-og.webp">
@endsection
      ...
      "@graph": [
        {
          ...
          "description": "GSTAT appeal for healthcare ITC reversal disputes under Section 17(5) CGST Act. 10% pre-deposit, 3-month deadline. Led by former LKS Partner. Patron Accounting.",
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="https://wa.me/919459456700?text=Hello%2C%20I%20need%20help%20with%20a%20GSTAT%20appeal%20for%20a%20healthcare%20GST%20exemption%20dispute.%20Please%20contact%20me." target="_blank" class="btn-sample text-decoration-none">
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <iframe name='hidden208810000001209168Frame' id='hidden208810000001209168Frame' style='display:none;' src='about:blank'></iframe>
                        ...
                        'deal' => 'Website Enquiry - GSTAT Appeal for Healthcare',
                        'options' => [
                            ['value' => '', 'label' => 'Select a service', 'selected' => true, 'disabled' => true],
                            ['value' => 'GSTAT Appeal - Healthcare', 'label' => 'GSTAT Appeal - Healthcare GST Exemption', 'selected' => true, 'disabled' => false],
...
<section class="testimonials-section">
    ...
    <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Our hospital received a Rs 2.8 crore demand on in-patient medicine supplies. Patron Accounting's GSTAT team structured the composite supply argument under Entry 74 and secured the stay of recovery within weeks. Outstanding healthcare sector knowledge.</div>
    <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
        ...
        <div>
            ...
            <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Hospital Chain, Mumbai</div>
...
<div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
    <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
    <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">The drug vs. cosmetic classification dispute seemed complex, but Surbhi Premi applied the dominant-purpose test with CDSCO registration evidence that our internal team had missed. Clear, actionable GSTAT strategy.</div>
    <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
        ...
        <div>
            ...
            <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Pharmaceutical Company, Hyderabad</div>
            <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
        </div>
...
<div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
    <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
    <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">The pre-deposit calculation saved us from depositing excess working capital. We were not aware of the Rs 20 crore cap under Finance Act 2024. Surbhi Premi's LKS background gave us complete confidence at the GSTAT stage.</div>
    <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
        ...
        <div>
            ...
            <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Diagnostic Centre, Bangalore</div>
            <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
        </div>
...
<div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
    <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
    <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Our pharma company faced inverted duty refund denial on APIs at 18% vs medicines at 5%. Patron Accounting structured the Section 54(3) refund argument with HC precedents and filed the GSTAT appeal within weeks.</div>
    <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
        ...
        <div>
            ...
            <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Tax Director, Pharma Company</div>
            <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
        </div>
...
<div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
    <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
    <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Patron Accounting understood our composite supply classification issue for in-patient pharmacy and handled the GSTAT filing with precision. The Section 112(9) stay secured immediately was critical for our operations.</div>
    <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
        ...
        <div>
            ...
            <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Multi-Speciality Hospital, Chennai</div>
            <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
        </div>
...
<div class="table-responsive-wrapper"><table><thead><tr><th>Service</th><th>What We Do</th></tr></thead><tbody>
    ...
    <tr><td>Hearing Representation</td><td>Advocacy before Principal Bench and all 31 State Benches by the Patron team led by of-counsel Advocate Surbhi Premi</td></tr>
...
<div style="display:flex;gap:14px;flex-wrap:wrap;margin-top:24px;">
    ...
    <a href="https://wa.me/919459456700?text=Hello%2C%20I%20need%20help%20with%20a%20GSTAT%20appeal%20for%20a%20healthcare%20GST%20exemption%20dispute.%20Please%20contact%20me." target="_blank" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:#25D366;color:#fff;border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;">&#128172; WhatsApp Us</a>
</div>
            </div>
    </div>
</section>
...
<p><strong>Contact us now:</strong> <a href="tel:+919459456700">+91 945 945 6700</a> | <a href="https://wa.me/919459456700?text=Hello%2C%20I%20need%20help%20with%20a%20GSTAT%20appeal%20for%20a%20healthcare%20GST%20exemption%20dispute.%20Please%20contact%20me." target="_blank">WhatsApp Us</a></p>
            </div>
        </div>
    </div>
</section>
