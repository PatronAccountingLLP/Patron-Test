            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="mailto:sales@patronaccounting.com?subject=GSTAT%20Importer%20IGST%20Valuation%20Appeal%20-%20Enquiry&body=Hello%20Patron%20Accounting%2C%0A%0AI%20need%20assistance%20with%20a%20GSTAT%20appeal%20for%20an%20import%20IGST%20valuation%20dispute.%20Please%20contact%20me.%0A%0AThank%20you." class="btn-sample text-decoration-none">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:18px;height:18px;"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,12 2,6"/></svg>
                            Email Us
                        </a>
                        <a href="https://wa.me/919459456700?text=Hello%2C%20I%20need%20help%20with%20a%20GSTAT%20appeal%20for%20an%20importer%20IGST%20valuation%20dispute.%20Please%20contact%20me." target="_blank" class="btn-sample text-decoration-none">
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <iframe name='hidden208810000001209168Frame' id='hidden208810000001209168Frame' style='display:none;' src='about:blank'></iframe>
                        ...
                        'deal' => 'Website Enquiry - GSTAT Appeal: Importers',
                        'options' => [
                            ['value' => '', 'label' => 'Select a service', 'selected' => true, 'disabled' => true],
                            ['value' => 'GSTAT Appeal: Importers', 'label' => 'GSTAT Appeal: Importers', 'selected' => true, 'disabled' => false],
...
<section class="testimonials-section">
    ...
    <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Our customs valuation reassessment led to an IGST demand of Rs 1.5 crore. Patron Accounting challenged the valuation methodology at GSTAT and secured automatic stay, protecting our working capital while the appeal proceeds.</div>
    <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
        ...
        <div>
            ...
            <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Import Trading Company, Mumbai</div>
...
<div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
    ...
    <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
        ...
        <div>
            ...
            <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Manufacturing Importer, Chennai</div>
            <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
        </div>
...
<div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
    <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
    <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">Patron Accounting handled our Bill of Entry amendment dispute and the resulting IGST demand at GSTAT. Their knowledge of customs valuation rules was exactly what we needed. Professional and thorough.</div>
    <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
        ...
        <div>
            ...
            <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Pharmaceutical Importer, Hyderabad</div>
            <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
        </div>
...
<div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
    <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
    <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">As a multinational with significant intra-group imports, our transfer pricing-related IGST dispute was complex. Patron Accounting's combined customs and GST expertise made the GSTAT appeal strategy clear and actionable.</div>
    <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
        ...
        <div>
            ...
            <div style="font-size:12px;color:var(--text-muted);margin-top:2px;">Multinational Importer, Delhi</div>
            <div style="color:var(--orange);font-size:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
        </div>
        ...
        <div class="text-content">
                ...
                <div style="background:var(--orange-lighter);border-radius:var(--radius-md);padding:20px 24px;margin-top:24px;text-align:center;">
                    ...
                    <div style="display:flex;gap:12px;justify-content:center;flex-wrap:wrap;">
                        ...
                        <a href="https://wa.me/919459456700?text=Hello%2C%20I%20need%20help%20with%20a%20GSTAT%20appeal%20for%20an%20importer%20IGST%20valuation%20dispute.%20Please%20contact%20me." target="_blank" style="display:inline-flex;align-items:center;gap:8px;padding:12px 24px;background:#25D366;color:#fff;border-radius:50px;font-weight:700;font-size:14px;text-decoration:none;">&#128172; WhatsApp Us</a>
                    </div></div>
            </div>
    </div>
</section>
    ...
    <div class="content-container">
        <div class="text-content">
            <div class="content-text">
                ...
                <p><strong>Contact us:</strong> <a href="tel:+919459456700">+91 945 945 6700</a> | <a href="https://wa.me/919459456700?text=Hello%2C%20I%20need%20help%20with%20a%20GSTAT%20appeal%20for%20an%20importer%20IGST%20valuation%20dispute.%20Please%20contact%20me." target="_blank" rel="noopener">WhatsApp Us</a></p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="conclusion-cta-row" style="display:flex;gap:14px;flex-wrap:wrap;margin-top:24px;">
                ...
                <a href="mailto:sales@patronaccounting.com?subject=GSTAT%20Importer%20IGST%20Valuation%20Appeal%20-%20Enquiry&body=Hello%20Patron%20Accounting%2C%0A%0AI%20need%20assistance%20with%20a%20GSTAT%20appeal%20for%20an%20import%20IGST%20valuation%20dispute.%20Please%20contact%20me.%0A%0AThank%20you." style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:transparent;color:#fff;border:2px solid rgba(255,255,255,0.3);border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#9993;&#65039; Email Us</a>
            </div>
