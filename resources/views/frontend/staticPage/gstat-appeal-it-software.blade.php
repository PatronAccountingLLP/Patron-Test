            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - GSTAT Appeal for IT/Software'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="GSTAT Appeal - IT/Software" selected>GSTAT Appeal - IT/Software Place of Supply</option>
...
<div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
    <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
    <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">The OIDAR classification dispute on our SaaS platform seemed complex, but Surbhi Premi's Section 13(12) analysis and distinction from customised development was clear and actionable. The GSTAT appeal was filed promptly.</div>
    <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
...
<div class="testimonial-card" style="padding:20px;background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);margin:0 8px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
    <div style="color:var(--orange);font-size:28px;line-height:1;margin-bottom:8px;">&ldquo;</div>
    <div style="font-size:13px;color:var(--text-dark);line-height:1.6;flex:1;">The pre-deposit calculation and stay of recovery under Section 112(9) protected our export cash flow immediately. Surbhi Premi's LKS background in handling IT sector intermediary disputes gave us complete confidence.</div>
    <div style="display:flex;align-items:center;gap:10px;margin-top:16px;">
...
<div class="content-text">
    <blockquote style="border-left:4px solid var(--orange);padding:16px 24px;margin:24px 0;background:var(--gray-50);border-radius:0 var(--radius-md) var(--radius-md) 0;">
        <p style="font-style:italic;color:var(--text-primary);margin:0;">&#8220;Patron Accounting's GSTAT team understood our intermediary reclassification exposure immediately. Surbhi Premi's approach to structuring the Section 2(13) defence was methodical and thorough.&#8221;</p>
