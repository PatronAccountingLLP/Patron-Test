            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="https://wa.me/919459456700?text=Hello%2C%20I%20need%20GSTAT%20State%20Bench%20representation.%20Please%20contact%20me." target="_blank" class="btn-sample text-decoration-none" rel="noopener">
                    ...
                    <div class="form-header">
                        ...
                        <p class="form-subtitle">Talk to a CA/CS expert today</p>
                                        ...
                                        @include('partials.bigin-form', [
                                            'variant' => 'bare',
                                            'service'  => 'GSTAT State Bench Representation',
                                        ])
        ...
        <div class="text-content">
                ...
                <div style="background:var(--orange-lighter);border-radius:var(--radius-md);padding:20px 24px;margin-top:24px;text-align:center;">
                    ...
                    <div style="display:flex;gap:12px;justify-content:center;flex-wrap:wrap;">
                        ...
                        <a href="https://wa.me/919459456700?text=Hello%2C%20I%20need%20GSTAT%20State%20Bench%20representation.%20Please%20contact%20me." target="_blank" style="display:inline-flex;align-items:center;gap:8px;padding:12px 24px;background:#25D366;color:#fff;border-radius:50px;font-weight:700;font-size:14px;text-decoration:none;" rel="noopener">&#128172; WhatsApp Us</a>
                    </div></div>
            </div>
    </div>
</section>
