        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'how-to-evaluate-statutory-audit-firm',
                    'options'  => [
                        'how-to-evaluate-statutory-audit-firm' => 'Audit Firm Evaluation (Buyer\'s Guide)',
                        'statutory-audit' => 'Statutory Audit',
                        'first-statutory-auditor-appointment-checklist' => 'First Statutory Auditor Appointment',
                        'change-of-auditor' => 'Change of Auditor (Section 140)',
                        'audit-rotation-transition-india' => 'Audit Rotation Transition (Section 139(2))',
                        'caro-2020-reporting' => 'CARO 2020 Reporting',
                        'internal-financial-controls-audit' => 'Internal Financial Controls Audit',
