                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="iec-registration" selected>IEC Registration</option><option value="iec-renewal">IEC Renewal</option><option value="ad-code-registration">AD Code Registration</option><option value="gst-registration">GST Registration</option><option value="private-limited-company-registration">Pvt Ltd Registration</option><option value="llp-registration">LLP Registration</option><option value="company-registration-in-uae">Company in UAE</option><option value="other">Other</option>
