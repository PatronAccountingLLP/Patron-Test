                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="iec-renewal" selected>IEC Renewal</option><option value="iec-registration">IEC Registration (New)</option><option value="ad-code-registration">AD Code Registration</option><option value="gst-registration">GST Registration</option><option value="duns-number-service">DUNS Number</option><option value="private-limited-company-registration">Pvt Ltd Registration</option><option value="llp-registration">LLP Registration</option><option value="other">Other</option>
