...
<script type="application/ld+json">
{
  ...
  "@graph": [
    {
      "@type": "BreadcrumbList",
      "@id": "https://www.patronaccounting.com/imf-application-rejection-recovery/#breadcrumb",
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "IMF Application Rejection Recovery", "item": "https://www.patronaccounting.com/imf-application-rejection-recovery" }
      ]
    },
    {
      "@type": "FAQPage",
      "@id": "https://www.patronaccounting.com/imf-application-rejection-recovery/#faq",
      "mainEntity": [
        {
          "@type": "Question",
    ...
    {
      "@type": "Service",
      "@id": "https://www.patronaccounting.com/imf-application-rejection-recovery/#service",
      ...
      "hasOfferCatalog": {
        ...
        "itemListElement": [
          { "@type": "Offer", "name": "Tier 1 - Diagnostic and Reapplication (specific deficiency cases)", "price": "40000", "priceCurrency": "INR", "availability": "https://schema.org/InStock", "url": "https://www.patronaccounting.com/imf-application-rejection-recovery" },
          { "@type": "Offer", "name": "Tier 2 - Comprehensive Recovery and Reapplication (multiple-deficiency cases)", "price": "55000", "priceCurrency": "INR", "availability": "https://schema.org/InStock", "url": "https://www.patronaccounting.com/imf-application-rejection-recovery" }
        ]
      }
    }
  ]
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="https://wa.me/919459456700?text=Hello%2C%20I%20just%20visited%20your%20IMF%20Application%20Rejection%20Recovery%20page.%20I%20would%20like%20to%20know%20more%20about%20it.'s%20recovery%20help." target="_blank" class="btn-sample text-decoration-none" rel="noopener">
                ...
                <div class="form-card" id="consultationFormCard">
                    ...
                    <iframe name='hidden208810000001209168Frame' id='hidden208810000001209168Frame' style='display:none;' src='about:blank'></iframe>
                                        ...
                                        @include('partials.bigin-form', [
                                            'variant' => 'bare',
                                            'service'  => 'IMF Rejection Recovery',
                                        ])
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p style="margin-top:16px;"><strong>Get a free IMF Rejection Recovery consultation - <a href="tel:+919459456700">Call +91 945 945 6700</a> or <a href="https://wa.me/919459456700?text=Hello%2C%20I%20just%20visited%20your%20IMF%20Application%20Rejection%20Recovery%20page.%20I%20would%20like%20to%20know%20more%20about%20it.'s%20recovery%20engagement." target="_blank" rel="noopener">WhatsApp us</a>. No-obligation assessment.</strong></p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="text-content">
            ...
            <div class="pa-city-block">
                ...
                <div class="pa-city-grid">
                    <a href="/imf-application-rejection-recovery/pune" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Pune</div><div class="pa-card-sub">Maharashtra</div></div></a>
                    <a href="/imf-application-rejection-recovery/mumbai" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Mumbai</div><div class="pa-card-sub">Maharashtra</div></div></a>
                    <a href="/imf-application-rejection-recovery/delhi" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Delhi</div><div class="pa-card-sub">NCR</div></div></a>
                    <a href="/imf-application-rejection-recovery/gurugram" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Gurugram</div><div class="pa-card-sub">Haryana</div></div></a>
                </div>
            </div>
        </div>
    </div>
