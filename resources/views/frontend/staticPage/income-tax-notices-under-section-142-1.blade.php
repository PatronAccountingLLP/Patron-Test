...
@section('meta')
    ...
    <meta property="og:image" content="/images/income-tax-notices-under-section-142-1-og.webp">
    ...
    <meta name="twitter:image" content="/images/income-tax-notices-under-section-142-1-og.webp">
@endsection
      ...
      "@graph": [
        {
          ...
          "url": "/income-tax-notices-under-section-142-1",
        ...
        },
        {
          ...
          "itemListElement": [
            ...
            },
            {
              ...
              "position": 2,
              "name": "IT Notice u/s 142(1): CA Reply",
              "item": "/income-tax-notices-under-section-142-1"
            }
          ]
        },
        {
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'income-tax-notices-under-section-142-1',
                    'options'  => [
                        'income-tax-notices-under-section-142-1' => 'Section 142(1) Notice Reply',
                        'income-tax-notice' => 'Income Tax Notice Assistance',
                        'income-tax-notices-under-section-143-3' => 'Section 143(3) Scrutiny',
                        'income-tax-notices-under-section-147' => 'Section 147 Reassessment',
