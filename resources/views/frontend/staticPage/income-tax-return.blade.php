        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'Income Tax Return Filing (Hub)',
                    'options'  => [
                        'Income Tax Return Filing (Hub)' => 'Income Tax Return Filing (Hub)',
                        'ITR for Salaries (ITR-1/ITR-2)' => 'ITR for Salaries (ITR-1/ITR-2)',
                        'ITR for Business (ITR-3/ITR-4)' => 'ITR for Business (ITR-3/ITR-4)',
                        'ITR for Capital Gains' => 'ITR for Capital Gains',
                        'ITR for Property Sale (Section 54)' => 'ITR for Property Sale (Section 54)',
                        'ITR for F and O Traders' => 'ITR for F and O Traders',
                        'ITR for Crypto Traders (Section 115BBH)' => 'ITR for Crypto Traders (Section 115BBH)',
                        'ITR for Influencers and Content Creators' => 'ITR for Influencers and Content Creators',
                        'ITR for Professionals (Section 44ADA)' => 'ITR for Professionals (Section 44ADA)',
                        'ITR for Freelancers' => 'ITR for Freelancers',
                        'ITR for Companies (ITR-6)' => 'ITR for Companies (ITR-6)',
                        'NRI Return with Schedule FA' => 'NRI Return with Schedule FA',
                        'Tax Audit (Section 44AB)' => 'Tax Audit (Section 44AB)',
                        'Income Tax Notice Response' => 'Income Tax Notice Response',
