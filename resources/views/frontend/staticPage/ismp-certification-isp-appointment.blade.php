...
<script type="application/ld+json">
{
  ...
  "@graph": [
    {
      "@type": "BreadcrumbList",
      "@id": "https://www.patronaccounting.com/ismp-certification-isp-appointment/#breadcrumb",
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "ISMP Certification and ISP Appointment", "item": "https://www.patronaccounting.com/ismp-certification-isp-appointment" }
      ]
    },
    {
      "@type": "FAQPage",
      "@id": "https://www.patronaccounting.com/ismp-certification-isp-appointment/#faq",
      "mainEntity": [
        {
          "@type": "Question",
    ...
    {
      "@type": "Service",
      "@id": "https://www.patronaccounting.com/ismp-certification-isp-appointment/#service",
      ...
      "hasOfferCatalog": {
        ...
        "itemListElement": [
          { "@type": "Offer", "name": "Tier 1 - PO Coordination and Appointment (Standalone) - institute selection, training enrolment coordination, examination scheduling, Fit and Proper documentation under Schedule II, Board Resolution under Section 173 Companies Act 2013, IRDAI portal notification, Code of Conduct Undertaking", "price": "15000", "priceCurrency": "INR", "availability": "https://schema.org/InStock", "url": "https://www.patronaccounting.com/ismp-certification-isp-appointment" },
          { "@type": "Offer", "name": "Tier 2 - ISP Coordination per ISP Onboarding - per-ISP institute selection and enrolment per sectoral specialisation, examination scheduling, Fit and Proper certification by PO, Code of Conduct Undertaking, IMF register onboarding, insurer-specific code generation", "price": "5000", "priceCurrency": "INR", "availability": "https://schema.org/InStock", "url": "https://www.patronaccounting.com/ismp-certification-isp-appointment" },
          { "@type": "Offer", "name": "Tier 3 - Combined PO and Up-to-5 ISPs Onboarding - all Tier 1 deliverables for PO plus Tier 2 deliverables for up to 5 ISPs with varied sectoral specialisations plus comprehensive Fit and Proper documentation for all roles", "price": "35000", "priceCurrency": "INR", "availability": "https://schema.org/InStock", "url": "https://www.patronaccounting.com/ismp-certification-isp-appointment" },
          { "@type": "Offer", "name": "Tier 4 - Combined PO and Up-to-10 ISPs Plus CPD Setup - all Tier 3 deliverables expanded to 10 ISPs plus annual CPD tracking calendar setup plus initial compliance manual plus customer disclosure templates plus first-year quarterly returns template for ISP onboarding tracking", "price": "45000", "priceCurrency": "INR", "availability": "https://schema.org/InStock", "url": "https://www.patronaccounting.com/ismp-certification-isp-appointment" }
        ]
      }
    }
  ]
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="https://wa.me/919459456700?text=Hello%2C%20I%20just%20visited%20your%20Ismp%20Certification%20Isp%20Appointment%20page.%20I%20would%20like%20to%20know%20more%20about%20it." target="_blank" class="btn-sample text-decoration-none" rel="noopener">
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <p style="margin-top:16px;"><strong>Get a free ISMP Certification and ISP Appointment consultation - <a href="tel:+919459456700">Call +91 945 945 6700</a> or <a href="https://wa.me/919459456700?text=Hello%2C%20I%20just%20visited%20your%20Ismp%20Certification%20Isp%20Appointment%20page.%20I%20would%20like%20to%20know%20more%20about%20it." target="_blank" rel="noopener">WhatsApp us</a>. No-obligation assessment.</strong></p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <ul>
                    ...
                    <li><a href="/llp-incorporation">LLP Registration</a> - LLP route as alternative IMF entity.</li>
        ...
        <div class="text-content">
            ...
            <p style="text-align:center;color:var(--text-muted);font-size:15px;margin-bottom:40px;">Parent IMF registration hub plus sister services - incorporation, IRDAI registration, compliance retainer, entity formation, statutory audit and ITR / accounting for Insurance Marketing Firms.</p>
              <div class="pa-city-block" style="margin-bottom:40px;">
                ...
                <div class="pa-cross-grid">
                    ...
                    <a href="/llp-incorporation" class="pa-cross-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><circle cx="12" cy="7" r="4"/><path d="M5 22v-2a7 7 0 0114 0v2"/></svg></div><div><div class="pa-card-title">LLP Registration</div><div class="pa-card-sub">Alternative IMF route</div></div></a>
            ...
            <div class="pa-city-block">
                ...
                <div class="pa-city-grid">
                    <a href="/ismp-certification-isp-appointment/pune" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Pune</div><div class="pa-card-sub">NIA hub city</div></div></a>
                    <a href="/ismp-certification-isp-appointment/mumbai" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Mumbai</div><div class="pa-card-sub">III + IRDAI HQ city</div></div></a>
                    <a href="/ismp-certification-isp-appointment/delhi" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Delhi</div><div class="pa-card-sub">NCR</div></div></a>
                    <a href="/ismp-certification-isp-appointment/gurugram" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Gurugram</div><div class="pa-card-sub">Haryana</div></div></a>
                </div>
            </div>
        </div>
    </div>
