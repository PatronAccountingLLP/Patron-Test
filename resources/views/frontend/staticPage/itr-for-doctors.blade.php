        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'itr-for-doctors',
                    'options'  => [
                        'itr-for-doctors' => 'ITR for Doctors',
                        'itr-filing-for-freelancers-professionals' => 'ITR for Professionals / Freelancers',
                        'tax-audit' => 'Tax Audit (Section 44AB)',
                        'tds-return-filing' => 'TDS Return Filing',
                        'payroll-processing-for-the-healthcare-industry' => 'Healthcare Payroll Services',
                        'itr-for-property-sale' => 'ITR for Property Sale (Form 26QB)',
                        'tax-planning-services' => 'Tax Planning Services',
                        'income-tax-notice-for-defective-return' => 'Defective Return Notice (Sec 139(9))',
                        'other' => 'Other',
                    ],
                ])
            </div>
