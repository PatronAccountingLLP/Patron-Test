        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'Section 44ADA Presumptive ITR-4',
                    'options'  => [
                        'Section 44ADA Presumptive ITR-4' => 'Section 44ADA Presumptive ITR-4',
                        'ITR-3 with Regular Books' => 'ITR-3 with Regular Books',
                        'ITR-3 with Section 44AB Tax Audit' => 'ITR-3 with Section 44AB Tax Audit',
                        'Doctor ITR Filing' => 'Doctor ITR Filing',
                        'Lawyer or Advocate ITR' => 'Lawyer or Advocate ITR',
                        'Chartered Accountant Practice ITR' => 'Chartered Accountant Practice ITR',
                        'Architect or Interior Designer ITR' => 'Architect or Interior Designer ITR',
                        'Technical Consultant or Engineer ITR' => 'Technical Consultant or Engineer ITR',
                        'Foreign Income with FIRC and Form 67' => 'Foreign Income with FIRC and Form 67',
                        'GST LUT Filing (Form RFD-11)' => 'GST LUT Filing (Form RFD-11)',
                        'IGST Refund Claim' => 'IGST Refund Claim',
                        'Other' => 'Other',
                    ],
                ])
            </div>
