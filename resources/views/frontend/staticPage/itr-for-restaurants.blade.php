        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'itr-for-restaurants',
                    'options'  => [
                        'itr-for-restaurants' => 'ITR for Restaurants (current)',
                        'income-tax-return' => 'Income Tax Return (overview)',
                        'itr-for-business' => 'ITR for Business',
                        'itr-for-companies' => 'ITR for Companies',
                        'tax-audit' => 'Tax Audit',
                        'gst-returns-for-restaurants-food-businesses' => 'GST for Restaurants',
