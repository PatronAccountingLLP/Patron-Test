        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'Simple Salaried ITR-1 (single Form 16)',
                    'options'  => [
                        'Simple Salaried ITR-1 (single Form 16)' => 'Simple Salaried ITR-1 (single Form 16)',
                        'ITR-1 with HRA, 80C, Home Loan Interest' => 'ITR-1 with HRA, 80C, Home Loan Interest',
                        'Multi-Form-16 Consolidation (job changers)' => 'Multi-Form-16 Consolidation (job changers)',
                        'ITR-2 with Capital Gains' => 'ITR-2 with Capital Gains',
                        'ITR-2 with ESOP Perquisite plus Sale' => 'ITR-2 with ESOP Perquisite plus Sale',
                        'ITR-2 with RSU Vesting' => 'ITR-2 with RSU Vesting',
                        'ITR-2 with Foreign Assets (Schedule FA)' => 'ITR-2 with Foreign Assets (Schedule FA)',
                        'NRI Salaried Returnee with DTAA' => 'NRI Salaried Returnee with DTAA',
                        'Salary plus F and O Trading' => 'Salary plus F and O Trading',
                        'Salary plus Crypto' => 'Salary plus Crypto',
                        'Salary plus Property Sale' => 'Salary plus Property Sale',
                        'Other' => 'Other',
                    ],
                ])
            </div>
