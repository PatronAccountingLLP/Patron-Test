        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'itr-for-textile-manufacturers',
                    'options'  => [
                        'itr-for-textile-manufacturers' => 'ITR for Textile Manufacturers (current)',
                        'itr-for-business' => 'ITR for Business (HUB)',
                        'itr-for-llp-partnership' => 'ITR for LLP and Partnership',
