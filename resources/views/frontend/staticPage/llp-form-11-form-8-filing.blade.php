        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'llp-form-11-form-8-filing',
                    'options'  => [
                        'llp-form-11-form-8-filing' => 'LLP Form 11 + Form 8 Filing (this page)',
                        'llp-annual-compliance' => 'LLP Annual Compliance Bundle (Rs 25k)',
                        'llp-compliance' => 'LLP Compliance Hub',
                        'llp-form-11-filing' => 'LLP Form 11 Filing (Standalone)',
                        'llp-form-8-filing' => 'LLP Form 8 Filing (Standalone)',
                        'director-kyc' => 'DIR-3 KYC for DPIN',
