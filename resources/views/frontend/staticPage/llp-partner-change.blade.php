        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'llp-partner-change',
                    'options'  => [
                        'llp-partner-change' => 'LLP Partner Change',
                        'llp-agreement-change' => 'LLP Agreement Change',
                        'llp-contribution-change' => 'LLP Contribution Change',
                        'pvt-llp-compliance' => 'LLP Compliance',
