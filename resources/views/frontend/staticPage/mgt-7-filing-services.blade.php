        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'mgt-7-filing-services',
                    'options'  => [
                        'mgt-7-filing-services' => 'MGT-7 / MGT-7A Filing (this page)',
                        'aoc-4-filing-services' => 'AOC-4 Filing (Filed First)',
                        'private-limited-company-annual-compliance' => 'Pvt Ltd Annual Compliance Bundle',
                        'small-company-annual-compliance' => 'Small Company Annual Compliance',
                        'private-limited-company-compliance' => 'Pvt Ltd Compliance Hub',
                        'adt-1-filing-services' => 'ADT-1 Filing',
