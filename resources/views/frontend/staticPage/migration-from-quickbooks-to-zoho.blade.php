        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'migration-from-quickbooks-to-zoho',
                    'options'  => [
                        'migration-from-quickbooks-to-zoho' => 'QuickBooks to Zoho Migration',
                        'zoho-books-accounting' => 'Zoho Books Accounting',
                        'quickbooks-accounting' => 'QuickBooks Accounting',
                        'accounting-services' => 'Accounting Services',
                        'gst-returns' => 'GST Returns',
                        'migration-from-tally-to-zoho' => 'Migration from Tally to Zoho',
