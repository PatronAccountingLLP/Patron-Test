{{-- /net-owned-fund-certificate-for-nbfc
     Generated from Generated Pages/net-owned-fund-certificate-for-nbfc/net-owned-fund-certificate-for-nbfc.html by Scripts/build_blade.py.
     ...
     Before this goes live:
       - deploy public/images/networth-cluster/net-owned-fund-certificate-for-nbfc/** and public/certificates/**
...
@section('meta')
    <title>Minimum Net Owned Fund Certificate for NBFC Registration</title>
    <meta name="description" content="Owned funds less group exposure, computed the way the RBI defines it and certified for registration, annual returns and scale based regulation reporting.">
    <link rel="canonical" href="https://www.patronaccounting.com/net-owned-fund-certificate-for-nbfc">
    <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1">
    <meta property="og:title" content="Net Owned Fund, Certified to the RBI Formula">
    <meta property="og:description" content="NOF computed with the right deductions and certified for your RBI registration or annual filing.">
    ...
    <script type="application/ld+json">
{
 ...
 "@graph": [
  {
   "@type": "Service",
   "@id": "https://www.patronaccounting.com/net-owned-fund-certificate-for-nbfc#service",
   "name": "Minimum Net Owned Fund Certificate for NBFC Registration",
   "description": "Owned funds less group exposure, computed the way the RBI defines it and certified for registration, annual returns and scale based regulation reporting.",
   "provider": {
    "@id": "https://www.patronaccounting.com/#organization"
   },
   "areaServed": "India",
   "url": "https://www.patronaccounting.com/net-owned-fund-certificate-for-nbfc"
  },
  {
   "@type": "BreadcrumbList",
   "@id": "https://www.patronaccounting.com/net-owned-fund-certificate-for-nbfc#breadcrumb",
   "itemListElement": [
    {
     "@type": "ListItem",
     "position": 1,
    ...
    },
    {
     "@type": "ListItem",
     "position": 3,
     "name": "Minimum Net Owned Fund for NBFC",
     "item": "https://www.patronaccounting.com/net-owned-fund-certificate-for-nbfc"
    }
   ]
  },
  {
   "@type": "FAQPage",
   "@id": "https://www.patronaccounting.com/net-owned-fund-certificate-for-nbfc#faq",
   "datePublished": "2026-07-30T10:00:00+05:30",
   "dateModified": "2026-08-04T10:00:00+05:30",
   "mainEntity": [
    {
     "@type": "Question",
     "name": "When must an NBFC file its net owned fund certificate with the Reserve Bank?",
     "acceptedAnswer": {
      "@type": "Answer",
      "text": "At application, and thereafter whenever the Reserve Bank calls for it. A company seeking registration under section 45-IA of the Reserve Bank of India Act 1934 files a statutory auditor's certificate of net owned fund with the application. Registered NBFCs submit an annual certificate as part of their regulatory returns."
     }
    },
    {
     "@type": "Question",
     "name": "Which chartered accountant may sign the certificate?",
     "acceptedAnswer": {
      "@type": "Answer",
  ...
  {
   "@type": "WebPage",
   "@id": "https://www.patronaccounting.com/net-owned-fund-certificate-for-nbfc#webpage",
   "url": "https://www.patronaccounting.com/net-owned-fund-certificate-for-nbfc",
   "name": "Minimum Net Owned Fund Certificate for NBFC Registration",
   "description": "Owned funds less group exposure, computed the way the RBI defines it and certified for registration, annual returns and scale based regulation reporting.",
   "isPartOf": {
...
<nav aria-label="Breadcrumb" style="background:var(--gray-50);border-bottom:1px solid var(--gray-200);padding:10px 16px;">
    <div style="max-width:1320px;margin:0 auto;">
        <ol style="display:flex;align-items:center;gap:8px;list-style:none;padding:0;margin:0;font-size:13px;font-family:'Barlow',sans-serif;flex-wrap:wrap;">
            ...
            <li><span style="color:var(--orange);font-weight:600;">Minimum Net Owned Fund for NBFC</span></li>
        </ol>
    </div>
</nav>
...
<section class="py-5" style="background: linear-gradient(180deg, var(--cream) 0%, var(--white) 100%);">
        ...
        <div class="row align-items-center">
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-4 private-registration-heading">Minimum Net Owned Fund (NOF) for NBFC</h1>
                    ...
                    <div class="mb-4 hero-benefits">
                        <div class="hero-benefit"><span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span><p class="mb-0 text-dark benefit-paragraph"><span>Structure mapped before the arithmetic</span></p></div>
                        <div class="hero-benefit"><span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span><p class="mb-0 text-dark benefit-paragraph"><span>Computed on the RBI Master Direction</span></p></div>
                        <div class="hero-benefit"><span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span><p class="mb-0 text-dark benefit-paragraph"><span>Each deduction traceable, UDIN attached</span></p></div>
                        <div class="hero-benefit"><span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span><p class="mb-0 text-dark benefit-paragraph"><span>Group structure chart supplied</span></p></div>
                    </div>
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="mailto:sales@patronaccounting.com?subject=Enquiry%20for%20a%20Minimum%20Net%20Owned%20Fund%20for%20NBFC&body=Hello%20Patron%20Accounting%20Team%2C%0A%0AI%20need%20a%20minimum%20net%20owned%20fund%20for%20nbfc%20and%20would%20like%20to%20know%20more.%0A%0AThank%20you." class="btn-sample text-decoration-none">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:18px;height:18px;"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,12 2,6"/></svg>
                            Email Us
                        </a>
                        <a href="https://wa.me/919459456700?text=Hi%20Patron%2C%20I%20need%20a%20minimum%20net%20owned%20fund%20for%20nbfc" target="_blank" rel="noopener" class="btn-sample text-decoration-none">
    ...
    'selected' => 'net-owned-fund-certificate-for-nbfc',
])
            </div>
        </div>
    </div>
...
<section class="testimonials-section">
  <div class="section-container">
    <div class="section-header">
      <h2>What Our NOF Certificate Clients Say</h2>
...
<section class="content-section" id="overview-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">NOF Certificate: Scope, Deliverables and Who It Suits</h2>
            <div class="content-text">
                <div class="highlight-box" style="margin-bottom:20px;">
                    <p><strong>&#128204; TL;DR &mdash; Minimum Net Owned Fund for NBFC at a Glance</strong></p>
                    <p>Minimum net owned fund is the capital floor the Reserve Bank sets for an NBFC, and it is not the same as net worth. Owned funds are reduced by investments in and loans to group companies beyond a prescribed limit, so the certified figure usually comes out lower. A chartered accountant computes it from audited accounts for registration and annual filings.</p>
                </div>
<p>An NBFC meets this requirement twice: once when applying for registration, and again each year when the position has to be reported. Between those two points the figure moves, because group exposure changes and losses reduce owned funds without anyone re-running the calculation. The number that was comfortable at application is not automatically the number on the annual return. The gap is rarely noticed until somebody asks for the certificate.</p><p>The deduction is what separates this from net worth. Owned funds are worked out, then investment in and credit to group companies is deducted to the extent it exceeds ten per cent of those owned funds. Tracing that exposure through a group structure takes the time. A position that falls below the floor mid-year has its own answer. The applicable directions are <a href="https://www.rbi.org.in" target="_blank" rel="noopener">published by the Reserve Bank</a>, and <a href="/tools/nof-calculator">our calculator</a> applies the same formula.</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="content-container">
        <div class="two-column">
            <div class="column-content">
                <h2 class="section-title">What Is Minimum Net Owned Fund for an NBFC?</h2>
                <div class="content-text what-is-definition">
<p>Net owned fund is a regulatory measure of an NBFC's capital, defined by the Reserve Bank for the purposes of registration and continuing supervision. It begins with owned funds and reduces them by exposure to group and subsidiary companies above the prescribed proportion.</p><p>Three things it is not. It is not net worth: the group-exposure deduction has no equivalent in the Companies Act definition. It is not capital adequacy, which measures capital against risk-weighted assets and is reported separately. And it is not <a href="/net-worth-certificate-for-company">paid-up capital</a>, though paid-up capital is one of its inputs. An NBFC can satisfy one of these measures and fall short on another.</p>
                </div>
                <div class="highlight-box" style="margin-top:20px;">
                    <p><strong>Key terms on this page:</strong></p>
                    <div class="key-terms"><ul class="al-list">
                    <li><span class="al-t"><a href="/glossary/networth/tier-i-capital">Tier I Capital</a></span><span class="al-d">Tier I capital is the core capital a regulator treats as genuinely loss-absorbing.</span></li>
                    <li><span class="al-t"><a href="/glossary/networth/capital-to-risk-weighted-assets-ratio-crar">Capital to Risk-weighted Assets Ratio (CRAR)</a></span><span class="al-d">The capital to risk-weighted assets ratio measures regulatory capital against exposures adjusted for how risky they are.</span></li>
                    </ul></div>
                </div>
            </div>
            <div class="column-image"><img src="/images/networth-cluster/net-owned-fund-certificate-for-nbfc/what-is.webp" alt="Owned funds reduced by group and subsidiary exposure to arrive at the net owned fund the RBI supervises" loading="lazy" width="1200" height="896" style="width:100%;height:auto;border-radius:var(--radius-xl);box-shadow:var(--shadow-md);"></div>
        </div>
    </div>
</section>
...
<section class="content-section specimen-section" id="specimen-section">
    ...
    <div class="text-content">
      <div class="specimen-item">
        <div class="specimen-caption"><div class="specimen-sticky">
          <h2 class="section-title">What a Net Owned Fund Certificate Looks Like: A Masked Specimen</h2>
          ...
          <div class="specimen-pane is-active" data-spec-pane="0">
            ...
            <p>The sample shows the computation the Reserve Bank looks for: owned funds built up from paid-up capital, <a href="/glossary/networth/free-reserves">free reserves</a> and <a href="/glossary/networth/securities-premium">securities premium</a>, less accumulated losses and intangibles, then reduced by exposure to group companies above the prescribed proportion. The resulting figure is presented against the minimum applicable to the company's category, so compliance or shortfall reads off the page.</p>
            <a class="specimen-download" href="/certificates/08-net-owned-fund-certificate-nbfc.pdf" download>Download this sample (PDF)</a>
          </div>
        ...
        <div class="specimen-stack" id="specimenStack">
          ...
          <div class="specimen-tabs" role="tablist" aria-label="Choose a sample">
            <button type="button" role="tab" class="specimen-tab is-active" data-spec-tab="0" aria-selected="true">Net owned fund certificate</button>
          </div>
          <div class="specimen-frame" id="specimenFrame" role="button" tabindex="0" aria-label="Enlarge this sample">
            <div class="specimen-doc is-active" data-spec-doc="0"><article class="nwc-spec" aria-label="Net Owned Fund Certificate — NBFC (RBI) - specimen, all values masked, not a valid certificate">
  <svg class="nwc-spec__mark" aria-hidden="true" focusable="false">
    <defs><pattern id="nwcwm-08" width="400" height="230"
      patternUnits="userSpaceOnUse">
      <text x="16" y="150" transform="rotate(-24 16 150)">Patron Accounting</text>
    </pattern></defs>
    <rect width="100%" height="100%" fill="url(#nwcwm-08)"/>
  </svg>
  ...
  <h3>Certificate of Net Owned Fund</h3>
  <div class="nwc-spec__to"><b>To,</b><br>The Regional Director<br><span class="b">XXXXXXX XXXX XX XXXXX</span><br><span class="b">XXXXXXXXXX XX XXX-XXXXXXX XXXXXXXXX</span></div>
  <p>This is to certify that we have examined the audited financial statements and books
  of account of <span class="b">XXXXXXXX XXXXXXX XXXXXXX XXXXXXX</span>, a company incorporated under the Companies Act, having its registered
  office at <span class="b">XXXX XXX, XXXXXXXX XX XXXX, XXXXXXX XXXXX, XXXX XXXXXX</span>, holding Corporate Identity Number <span class="b">XXXXXXXXXXXXXXXXXXXXX</span>, as at <span class="b">XX XXXXX XXXX</span>, for the purpose of its
  application for a Certificate of Registration as a Non-Banking Financial Company.</p>
  <p>Net Owned Fund has been computed in accordance with the definition in Section 45-IA of the
  Reserve Bank of India Act, 1934, read with the applicable RBI Master Direction. Reserves
  created by revaluation of assets have been excluded.</p>
  ...
  <table><caption class="nwc-spec__sr">Specimen figures - all values masked</caption><thead><tr><th style="width:50px">Sr.</th><th>Particulars</th>
    ...
    <tr class="sub"><td>A</td><td><b>Owned Fund</b></td><td></td></tr>
    <tr><td>1</td><td>Paid-up equity share capital</td><td class="num"><span class="b b--n">X,XX,XX,XXX</span></td></tr>
    <tr><td>2</td><td>Preference shares compulsorily convertible into equity</td>
      <td class="num"><span class="b b--n">XX,XX,XXX</span></td></tr>
    <tr><td>3</td><td>Free reserves</td><td class="num"><span class="b b--n">X,XX,XX,XXX</span></td></tr>
    <tr><td>4</td><td>Balance in share premium account</td><td class="num"><span class="b b--n">XX,XX,XXX</span></td></tr>
    <tr><td>5</td><td>Capital reserves representing surplus on sale of assets</td>
      <td class="num"><span class="b b--n">XX,XX,XXX</span></td></tr>
    <tr><td>6</td><td>Less: Accumulated balance of loss</td><td class="num"><span class="b b--n">(XX,XX,XXX)</span></td></tr>
    <tr><td>7</td><td>Less: Deferred revenue expenditure</td><td class="num"><span class="b b--n">(XX,XX,XXX)</span></td></tr>
    <tr><td>8</td><td>Less: Other intangible assets</td><td class="num"><span class="b b--n">(XX,XX,XXX)</span></td></tr>
    <tr class="sub"><td></td><td><b>Owned Fund (A)</b></td><td class="num"><b><span class="b b--n">X,XX,XX,XXX</span></b></td></tr>
    <tr class="sub"><td>B</td><td><b>Deductions &mdash; group and NBFC exposure</b></td>
      <td></td></tr>
    <tr><td>9</td><td>Investments in shares of subsidiaries and group companies</td>
      <td class="num"><span class="b b--n">XX,XX,XXX</span></td></tr>
    <tr><td>10</td><td>Investments in shares of other NBFCs</td><td class="num"><span class="b b--n">XX,XX,XXX</span></td></tr>
    <tr><td>11</td><td>Debentures, bonds, loans and advances to and deposits with
      subsidiaries and group companies</td><td class="num"><span class="b b--n">XX,XX,XXX</span></td></tr>
    <tr class="sub"><td></td><td><b>Total group exposure</b></td>
      <td class="num"><b><span class="b b--n">X,XX,XX,XXX</span></b></td></tr>
    <tr><td>12</td><td>Less: 10% of Owned Fund (threshold)</td><td class="num"><span class="b b--n">(XX,XX,XXX)</span></td></tr>
    <tr class="sub"><td></td><td><b>Excess over threshold, deductible (B)</b></td>
      <td class="num"><b><span class="b b--n">XX,XX,XXX</span></b></td></tr>
    <tr class="tot"><td></td><td><b>NET OWNED FUND (A &minus; B)</b></td>
      <td class="num"><b><span class="b b--n">X,XX,XX,XXX</span></b></td></tr>
  </tbody></table>
  <p>On the basis of our examination, we certify that the Net Owned Fund of <span class="b">XXXXXXXX XXXXXXX XXXXXXX XXXXXXX</span> as at <span class="b">XX XXXXX XXXX</span>
  is <b>INR <span class="b">X,XX,XX,XXX</span></b> (Rupees <span class="b">XXXXX XXXXX XXXXX</span> only), which meets the minimum Net Owned Fund prescribed by the
  Reserve Bank of India for the category of registration applied for.</p>
  <p>This certificate is issued at the request of the Company solely for submission to the
  Reserve Bank of India and is not to be used for any other purpose.</p>
...
<section class="content-section" id="who-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Which NBFCs Must Evidence Their Net Owned Fund</h2>
            <div class="why-patron-grid is-4">
                <div><strong>A Registration Application Is Being Made</strong><p>The application to the Reserve Bank requires the net owned fund position computed on its definition, from audited accounts, and certified. It is a condition of the application rather than a supporting document.</p></div>
                <div><strong>The Annual Position Must Be Reported</strong><p>The requirement recurs each year, and the figure moves between filings as group exposure and accumulated losses change. Last year's number is not this year's answer.</p></div>
                <div><strong>Group Exposure Has Grown</strong><p>Investment in or lending to group and subsidiary companies has increased. Above the prescribed proportion it is deducted, so the reportable figure can fall while the balance sheet itself grows.</p></div>
                <div><strong>The Position May Have Slipped</strong><p>Losses or a change in exposure have brought the computed figure close to, or under, the prescribed minimum. Establishing where it actually stands is the first step in deciding what follows.</p></div>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section" id="services-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Our NOF Certificate Service: What You Receive</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Service</th><th>What&#x27;s included</th><th>Frequency</th></tr></thead>
                    <tbody>
                        <tr><td>Net owned fund certificate for the filing</td><td>The certificate in the form the annual return requires, signed with a <a href="/blog/how-to-verify-a-net-worth-certificate">UDIN</a>; <a href="/blog/icai-guidelines-for-ca-certificates">the ICAI guidelines behind CA certificates</a> sets out the standards behind it.</td><td><span class="badge-included">Annually</span></td></tr>
                        <tr><td>Owned funds computation</td><td>Paid-up capital, free reserves and securities premium totalled, less the losses carried forward, deferred revenue expenditure and any intangible asset on the books.</td><td><span class="badge-included">Once the audited accounts are signed</span></td></tr>
                        <tr><td>Free reserve classification</td><td>Each reserve identified and tested, since a reserve created for a specific purpose or by revaluation is not free and does not count.</td><td><span class="badge-included">Annually, with the audited accounts</span></td></tr>
                        <tr><td>Group exposure trace</td><td>Every holding in and advance to a company inside the group, traced across the whole structure, which is where the work in this engagement sits.</td><td><span class="badge-included">Per engagement</span></td></tr>
                        <tr><td>Ten per cent deduction working</td><td>The deduction applied where group exposure passes ten per cent of owned funds, shown line by line; it is the reason the certified figure sits below the balance sheet.</td><td><span class="badge-included">Per engagement</span></td></tr>
                        <tr><td>Position against the category minimum</td><td>The computed figure presented against the minimum for the company's layer and deposit-taking status, so compliance or shortfall reads plainly.</td><td><span class="badge-included">Annually</span></td></tr>
                        <tr><td>Group structure chart</td><td>A chart of every related entity and how it connects, because the link that makes an entity part of the group is not visible in a ledger name.</td><td><span class="badge-included">Per engagement</span></td></tr>
                    </tbody>
                </table>
                </div>
            </div>
...
<section class="steps-section" id="procedure-section">
    <div class="section-container">
        <header class="section-header" style="text-align:center;margin-bottom:48px;">
            ...
            <h2 class="section-title">How We Issue a Net Owned Fund Certificate, Step by Step</h2>
  ...
  <div class="step-content">
    ...
    <h3 class="step-title">Owned funds computed</h3>
    <p class="step-description">Owned funds are built from paid-up capital, free reserves and the securities premium account, less accumulated losses, deferred revenue expenditure and other intangible assets. That figure is the base every later adjustment works from, so it is tied to the balance sheet line by line.</p>
  </div>
  <div class="step-visual"><div class="step-illustration" style="padding:0;background:none;"><img src="/images/networth-cluster/net-owned-fund-certificate-for-nbfc/step-1-owned-funds-computed.webp" alt="Owned funds are built from paid-up capital, free reserves and the securities premium account, less accumulated losses" loading="lazy" width="1200" height="896" style="width:100%;height:auto;border-radius:var(--radius-xl);"></div></div>
</div>
            <div class="step-card">
  <div class="step-content">
    <span class="step-badge">Step 2</span>
    <h3 class="step-title">Group exposure traced</h3>
    <p class="step-description">Investment in and lending to group and subsidiary companies is identified across the whole structure. Tracing it properly is where the time goes, and it is the point at which in-house computations most often stop short of the full picture.</p>
  </div>
  <div class="step-visual"><div class="step-illustration" style="padding:0;background:none;"><img src="/images/networth-cluster/net-owned-fund-certificate-for-nbfc/step-2-group-exposure-traced.webp" alt="Investment in and lending to group and subsidiary companies is identified across the whole structure" loading="lazy" width="1200" height="896" style="width:100%;height:auto;border-radius:var(--radius-xl);"></div></div>
</div>
            <div class="step-card">
  <div class="step-content">
    <span class="step-badge">Step 3</span>
    <h3 class="step-title">Ten per cent deduction applied</h3>
    <p class="step-description">Exposure above ten per cent of owned funds is deducted, which is what separates net owned fund from net worth. The certified figure ordinarily lands below the balance sheet total, and the working shows precisely why it does.</p>
  </div>
  <div class="step-visual"><div class="step-illustration" style="padding:0;background:none;"><img src="/images/networth-cluster/net-owned-fund-certificate-for-nbfc/step-3-ten-per-cent-deduction-applied.webp" alt="Exposure above ten per cent of owned funds is deducted, which is what separates net owned fund from net worth" loading="lazy" width="1200" height="896" style="width:100%;height:auto;border-radius:var(--radius-xl);"></div></div>
</div>
            <div class="step-card">
  <div class="step-content">
    <span class="step-badge">Step 4</span>
    <h3 class="step-title">Position stated against the floor</h3>
    <p class="step-description">The computed figure is presented against the minimum applicable to the company's category, so the filing shows compliance or shortfall plainly. Leaving the reader to work that comparison out themselves is how a deficiency is missed.</p>
  </div>
  <div class="step-visual"><div class="step-illustration" style="padding:0;background:none;"><img src="/images/networth-cluster/net-owned-fund-certificate-for-nbfc/step-4-position-stated-against-the-floor.webp" alt="The computed figure is presented against the minimum applicable to the company's category" loading="lazy" width="1200" height="896" style="width:100%;height:auto;border-radius:var(--radius-xl);"></div></div>
</div>
            <div class="step-card">
  <div class="step-content">
    <span class="step-badge">Step 5</span>
    <h3 class="step-title">Management representation obtained</h3>
    <p class="step-description">The company confirms that all group exposures and related-party positions have been disclosed, and signs a management representation. Undisclosed group lending is the item that most often moves the figure after a first draft.</p>
  </div>
  <div class="step-visual"><div class="step-illustration" style="padding:0;background:none;"><img src="/images/networth-cluster/net-owned-fund-certificate-for-nbfc/step-5-management-representation-obtained.webp" alt="The company confirms that all group exposures and related-party positions have been disclosed" loading="lazy" width="1200" height="896" style="width:100%;height:auto;border-radius:var(--radius-xl);"></div></div>
</div>
            <div class="step-card">
  <div class="step-content">
    <span class="step-badge">Step 6</span>
    <h3 class="step-title">Signed for the filing</h3>
    <p class="step-description">The certificate is signed by a <a href="/net-worth-certificate-by-ca">practising chartered accountant</a> with a UDIN, in the form the registration application or the annual return requires. The full computation is annexed, so the regulator can follow every deduction back to the balance sheet line it came from.</p>
  </div>
  <div class="step-visual"><div class="step-illustration" style="padding:0;background:none;"><img src="/images/networth-cluster/net-owned-fund-certificate-for-nbfc/step-6-signed-for-the-filing.webp" alt="The certificate is signed by a practising chartered accountant with a UDIN" loading="lazy" width="1200" height="896" style="width:100%;height:auto;border-radius:var(--radius-xl);"></div></div>
</div>
        </div>
    </div>
</section>
...
<section class="content-section" id="documents-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Documents Required for a Net Owned Fund Certificate</h2>
            <div class="content-text">
                ...
                <ul>
                    <li><a href="/statutory-audit">Audited financial statements</a> for the latest year, with every schedule and note</li>
                    <li>Certificate of Registration issued by the Reserve Bank, or the application in progress</li>
                    <li>Shareholding pattern and confirmation of paid-up <a href="/net-worth-certificate-for-company">share capital</a></li>
                    <li>Schedule of free reserves, identifying each reserve and how it arose</li>
                    <li>Securities premium account balance, with its movement for the year</li>
                    <li>Details of accumulated losses, deferred revenue expenditure and intangible assets</li>
                    <li>Complete schedule of investments in and loans to group and subsidiary companies</li>
                    <li>Group structure chart showing every related entity and how it is connected</li>
                    <li>Board resolution recording the company's layer and whether it accepts deposits</li>
                </ul>
                <p><strong>Where they apply:</strong></p>
                <ul>
                    <li>The previous year's net owned fund certificate, where one was issued</li>
                </ul>
            </div>
        </div>
    </div>
...
<section class="content-section" id="challenges-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Common NOF Certificate Problems and How We Solve Them</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Challenge</th><th>Why it happens</th><th>How it is handled</th></tr></thead>
                    <tbody>
                        <tr><td>Balance sheet net worth offered as net owned fund</td><td>The two look alike and start from the same capital and reserves, and only the regulatory deductions separate them.</td><td>The regulatory computation is run in full, so the certified figure reflects the deductions rather than the accounting total; <a href="/blog/icai-guidelines-for-ca-certificates">the standards a CA certificate is issued under</a>.</td></tr>
                        <tr><td>Group exposure traced only part of the way</td><td>Ledger account names rarely reveal which counterparties sit inside the group, so tracing tends to stop at the obvious ones.</td><td>A group structure chart is built first and every holding and advance is traced against it, which is the bulk of what this certificate actually costs in time.</td></tr>
                        <tr><td>A <a href="/glossary/networth/revaluation-reserve">revaluation reserve</a> counted as free</td><td>It sits among the reserves and increases them, and nothing in the balance sheet marks it as unavailable.</td><td>Each reserve is tested for whether it is genuinely free, and anything earmarked or arising on revaluation is taken out.</td></tr>
                        <tr><td>The applicable minimum not identified</td><td>It depends on where the company sits in the scale-based framework and on its deposit status, neither of which shows on the computation.</td><td>The category is established from the registration and the board's own record, and the figure is presented against the minimum that applies to it.</td></tr>
                        <tr><td>Movement since last year left unexplained</td><td>A year passes, exposures change, and the earlier certificate is filed away without anybody reconciling the two.</td><td>The prior certificate is read alongside the current computation so the movement is explained while the working papers behind both are still available.</td></tr>
                    </tbody>
                </table>
                </div>
            </div>
...
<section class="content-section" id="fees-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">NOF Certificate Fees</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Plan</th><th>Fee</th></tr></thead>
                    <tbody>
                        <tr><td><strong>Standard</strong> &mdash; One company with audited accounts signed, a documented group structure and exposures readily traceable.</td><td>Starting from INR 14999<br><span style="font-size:12px;color:var(--text-muted);">(Exl GST and Govt. Charges)</span></td></tr>
                        <tr><td><strong>Extended</strong> &mdash; A layered group to map, exposures across several entities to trace, or reserves to reclassify before the computation runs.</td><td>On quote</td></tr>
                        <tr><td><strong>Multiple certificates</strong> &mdash; Certificates for more than one group NBFC, prepared from a single mapping exercise.</td><td>On quote</td></tr>
                    </tbody>
                </table>
                </div>
  ...
  <li>An On quote row means the scope decides the fee. It is not a higher tier waiting to be sold; some engagements simply cannot be priced before the records are seen.</li>
                ...
                <p style="margin-top:16px;"><strong>Get a free consultation &mdash; <a href="tel:+919459456700">Call +91 94594 56700</a> or <a href="https://wa.me/919459456700?text=Hi%20Patron%2C%20I%20need%20a%20minimum%20net%20owned%20fund%20for%20nbfc" target="_blank" rel="noopener">WhatsApp us</a>.</strong></p>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section" id="timeline-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <h2 class="section-title">RBI Net Owned Fund Thresholds and Reporting Dates</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
<table class="nwc-timeline"><thead><tr><th>Obligation</th><th>Applies to</th><th>Due date</th></tr></thead><tbody>
  <tr><td>Minimum net owned fund maintained on a continuing basis</td><td>Every NBFC holding a certificate of registration</td><td>Tested at each balance sheet date, not only at registration</td></tr>
  <tr><td>Transfer of not less than twenty per cent of net profit to the reserve fund</td><td>Every NBFC to which section 45-IC applies</td><td>Each year, before any dividend is declared</td></tr>
  <tr><td>Audited financial statements adopted at the annual general meeting</td><td>Every NBFC incorporated as a company</td><td>Within six months of the financial year end</td></tr>
  <tr><td>Statutory Auditors' Certificate confirming continued eligibility and compliance</td><td>Every registered NBFC</td><td>Annually, following the statutory audit</td></tr>
  <tr><td>DNBS-02 return of key financial parameters</td><td>Non-deposit-taking NBFCs</td><td>Quarterly</td></tr>
  <tr><td>Net owned fund certificate from a practising <a href="/net-worth-certificate-by-ca">chartered accountant</a></td><td>Applicants for registration, and registered NBFCs where the filing requires it</td><td>With the registration application, and with the annual submission</td></tr>
</tbody></table>
                </div>
<ul class="nwc-timeline-notes">
  <li>The minimum net owned fund itself is not tabulated above. It depends on the company's category and its layer under scale-based regulation, and it is subject to a phased increase. Confirm the amount applicable to you against the current RBI Master Direction before planning to it.</li>
  <li>Portal due dates for returns are set administratively and change. The cadence in the table is stable; the exact filing date is not.</li>
</ul>
            </div>
        </div>
    </div>
...
<section class="why-choose-section" id="benefits-section">
    <div class="section-container">
        <div style="text-align:center;margin-bottom:48px;">
            ...
            <h2 class="section-title">Why a Net Owned Fund Certificate Matters</h2>
        </div>
...
<article class="feature-card">
  ...
  <h3 class="feature-title">Falling Below the Floor Invites Action</h3>
  <p class="feature-text">Net owned fund is a continuing requirement, not a one-time test at registration. A position that drifts below the prescribed floor exposes the company to supervisory action, and the drift is usually noticed by the regulator rather than internally.</p>
</article>
<article class="feature-card">
  ...
  <h3 class="feature-title">Group Exposure Left Undeducted Overstates</h3>
  <p class="feature-text">Exposure to group and subsidiary companies must be netted off above the prescribed proportion. A computation that skips it reports a figure the Reserve Bank will not accept, and the correction always reduces the number.</p>
</article>
<article class="feature-card">
  ...
  <h3 class="feature-title">Reporting Net Worth Instead Fails the Filing</h3>
  <p class="feature-text">The two measures are defined differently and produce different numbers. Submitting a net worth figure where net owned fund was required answers a question nobody asked, and the filing is deficient until corrected.</p>
</article>
        </div>
    </div>
</section>
...
<section class="content-section" id="why-patron-section" style="background: var(--cream) !important;">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Why Clients Choose Patron for NOF Certificates</h2>
            ...
            <div class="why-patron-grid">
                <div><strong>Structure mapped before the arithmetic</strong><p>What makes a counterparty part of the group is seldom visible in an account name. The map is drawn first, and each holding is then tested against it.</p></div>
                <div><strong>Computed on the RBI Master Direction</strong><p>Owned funds, free reserves and the group-exposure deduction follow the Reserve Bank's Master Direction, and the result is shown against the minimum that applies to the company.</p></div>
                <div><strong>Each deduction traceable, UDIN attached</strong><p>The computation is annexed in full so every deduction can be followed back to its source, and the UDIN on the <a href="/blog/how-to-verify-a-net-worth-certificate">ICAI portal</a> confirms who signed it.</p></div>
                <div><strong>Group structure chart supplied</strong><p>A chart of every related entity goes out with the certificate, which is what makes the exposure deduction checkable instead of a number taken on trust.</p></div>
                <div><strong>Regulated entities on the books</strong><p>A CA and CS team carrying 25,000+ filings completed, with Reserve Bank registration and return work among them, so a layer minimum is known rather than researched.</p></div>
            </div>
...
<section class="content-section" id="tool-section" style="background-color:var(--blue-lighter);">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Compute Net Owned Fund the Way the RBI Defines It</h2>
            <div class="content-text">
                <p>Enter owned funds and your exposure to group and subsidiary companies. The calculator applies the ten per cent deduction and shows the net owned fund against the minimum for your category, so a shortfall is visible before the filing rather than after it.</p>
                ...
                <div class="nwt-wrap">
                    <div class="nwt-card">
                        <h3 class="nwt-title">Free tool: Net Owned Fund Calculator (RBI formula)</h3>
                        ...
                        <div class="nwt-cols nwt-cols--3">
                            <div class="nwt-col">
                                <h4>Owned funds: what is added</h4>
                                <div class="nwt-row"><label for="nwt-g0-0">Paid-up equity capital</label><input class="nwt-input" type="text" id="nwt-g0-0" data-nwt="g0" data-name="Paid-up equity capital" inputmode="decimal" autocomplete="off" placeholder="0"></div>
                                <div class="nwt-row"><label for="nwt-g0-1">Preference shares compulsorily convertible into equity</label><input class="nwt-input" type="text" id="nwt-g0-1" data-nwt="g0" data-name="Preference shares compulsorily convertible into equity" inputmode="decimal" autocomplete="off" placeholder="0"></div>
                                <div class="nwt-row"><label for="nwt-g0-2">Free reserves</label><input class="nwt-input" type="text" id="nwt-g0-2" data-nwt="g0" data-name="Free reserves" inputmode="decimal" autocomplete="off" placeholder="0"></div>
                                <div class="nwt-row"><label for="nwt-g0-3">Securities premium account</label><input class="nwt-input" type="text" id="nwt-g0-3" data-nwt="g0" data-name="Securities premium account" inputmode="decimal" autocomplete="off" placeholder="0"></div>
                            </div>
                            <div class="nwt-col">
                                <h4>Owned funds: what is removed</h4>
                                <div class="nwt-row"><label for="nwt-g1-0">Accumulated losses</label><input class="nwt-input" type="text" id="nwt-g1-0" data-nwt="g1" data-name="Accumulated losses" inputmode="decimal" autocomplete="off" placeholder="0"></div>
                                <div class="nwt-row"><label for="nwt-g1-1">Deferred revenue expenditure</label><input class="nwt-input" type="text" id="nwt-g1-1" data-nwt="g1" data-name="Deferred revenue expenditure" inputmode="decimal" autocomplete="off" placeholder="0"></div>
                                <div class="nwt-row"><label for="nwt-g1-2">Other intangible assets</label><input class="nwt-input" type="text" id="nwt-g1-2" data-nwt="g1" data-name="Other intangible assets" inputmode="decimal" autocomplete="off" placeholder="0"></div>
                            </div>
                            <div class="nwt-col">
                                <h4>Exposure to group and subsidiary companies</h4>
                                <div class="nwt-row"><label for="nwt-g2-0">Investment in shares of subsidiaries</label><input class="nwt-input" type="text" id="nwt-g2-0" data-nwt="g2" data-name="Investment in shares of subsidiaries" inputmode="decimal" autocomplete="off" placeholder="0"></div>
                                <div class="nwt-row"><label for="nwt-g2-1">Investment in shares of group companies</label><input class="nwt-input" type="text" id="nwt-g2-1" data-nwt="g2" data-name="Investment in shares of group companies" inputmode="decimal" autocomplete="off" placeholder="0"></div>
                                <div class="nwt-row"><label for="nwt-g2-2">Loans and advances to subsidiaries</label><input class="nwt-input" type="text" id="nwt-g2-2" data-nwt="g2" data-name="Loans and advances to subsidiaries" inputmode="decimal" autocomplete="off" placeholder="0"></div>
                                <div class="nwt-row"><label for="nwt-g2-3">Loans and advances to group companies</label><input class="nwt-input" type="text" id="nwt-g2-3" data-nwt="g2" data-name="Loans and advances to group companies" inputmode="decimal" autocomplete="off" placeholder="0"></div>
                            </div>
                        </div>
                        ...
                        <div class="nwt-result" id="nwtResult">
                            <div class="nwt-rgrid">
                                <div class="nwt-rcard"><div class="nwt-rlabel">Added</div><div class="nwt-rval" id="nwtA">&mdash;</div></div>
                                <div class="nwt-rcard"><div class="nwt-rlabel">Removed</div><div class="nwt-rval" id="nwtB">&mdash;</div></div>
                                <div class="nwt-rcard"><div class="nwt-rlabel">Owned funds</div><div class="nwt-rval" id="nwtSub">&mdash;</div></div>
                                <div class="nwt-rcard full"><div class="nwt-rlabel">Net owned fund</div><div class="nwt-rval" id="nwtNet">&mdash;</div></div>
                                
                            </div>
                            <div class="nwt-break" id="nwtBreak"></div>
                            <div class="nwt-actions">
                                <a href="https://wa.me/919459456700?text=Hi%20Patron%2C%20I%20need%20a%20minimum%20net%20owned%20fund%20for%20nbfc" target="_blank" rel="noopener" class="nwt-abtn"><svg viewBox="0 0 24 24" fill="#25D366" aria-hidden="true"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347z"/></svg> Ask a CA</a>
                        ...
                        <p class="nwt-note">The ten per cent is measured against owned funds after the first set of deductions, not against the balance sheet total; computing it the other way overstates the result. No minimum is printed here: the applicable amount depends on your category and layer, and a figure left unrevised would be worse than none. An estimate carrying no UDIN.</p>
                    </div>
                </div>
                ...
                (function(){
                    ...
                    var SIGNS = [1,-1,0], DED10 = [0,0,1], NOF10 = true;
                    function calculate(){
                        ...
                        $('nwtBreak').innerHTML = rows
                            ? rows + row('<strong>Net owned fund</strong>', '<strong>' + money(net) + '</strong>')
                            : '';
                        show();
                    }
                ...
                <p style="margin-top:16px;font-size:14px;"><a href="/tools/nof-calculator" target="_blank" rel="noopener" style="color:var(--blue);font-weight:600;">Open the full calculator &#8599;</a></p>
...
<section class="content-section" id="legal-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">The Legal and Professional Framework Behind NOF Certificates</h2>
            <div class="content-text">
                <p>This is the most tightly defined certificate in the group. Net owned fund is a regulatory measure created by the Reserve Bank rather than an accounting one. It exists because a company can show a healthy balance sheet while much of what supports it sits inside its own group.</p>
                <p>The computation therefore starts from the accounts and then departs from them deliberately. What follows is a figure that is almost always lower than balance sheet net worth, measured against a minimum that depends on what the company is licensed to do.</p>
                <ul class="al-list">
                    <li><span class="al-t"><strong>Section 45-IA, Reserve Bank of India Act 1934</strong></span><span class="al-d">requires registration with the Reserve Bank and sets a minimum net owned fund as a condition of it, which is why the certified figure is presented against a floor rather than on its own.</span></li>
                    <li><span class="al-t"><strong>RBI Master Direction DNBR.PD.008/2016 (as amended), Chapter I</strong></span><span class="al-d">builds owned funds from share capital that has been paid up, reserves that are free, and the premium account, then strips out carried-forward losses, deferred revenue expenditure and intangibles. Group exposure beyond a tenth of the result is deducted again.</span></li>
                    <li><span class="al-t"><strong>Section 129, Companies Act 2013</strong></span><span class="al-d">governs the audited financial statements the computation runs off, with the deductions found in the schedules rather than on the face of the balance sheet.</span></li>
                    <li><span class="al-t"><strong>Section 2(57), Companies Act 2013</strong></span><span class="al-d">defines net worth for company law purposes, and the difference between it and net owned fund is precisely the regulatory deduction, which is why the two figures should not be presented interchangeably.</span></li>
                    <li><span class="al-t"><strong>Sections 137 and 92, Companies Act 2013</strong></span><span class="al-d">put the audited accounts and annual return on the public record, where the regulator corroborates the base the computation started from.</span></li>
                    <li><span class="al-t"><strong>ICAI Guidance Note on Reports or Certificates for Special Purposes (Revised 2016)</strong></span><span class="al-d">governs the certificate, including the representation covering group exposures and related-party positions that a ledger alone would not reveal.</span></li>
                </ul>
...
<section id="faq-section" class="content-section" style="background-color:#ffffff;">
  ...
  <h3 class="faq-expanded__q">When must an NBFC file its net owned fund certificate with the Reserve Bank?</h3>
  <div class="faq-expanded__a"><p>At application, and thereafter whenever the Reserve Bank calls for it. A company seeking registration under section 45-IA of the Reserve Bank of India Act 1934 files a statutory auditor's certificate of net owned fund with the application. Registered NBFCs submit an annual certificate as part of their regulatory returns.</p></div>
</div>
                    <div class="faq-expanded__item">
  <h3 class="faq-expanded__q">Which chartered accountant may sign the certificate?</h3>
  <div class="faq-expanded__a"><p>The statutory auditor, in the ordinary course. The Reserve Bank's registration requirements refer specifically to a certificate from the applicant company's statutory auditors rather than any practising member. The signatory is expected to have examined the audited accounts the figure comes from. A newly incorporated applicant appoints its first auditor before applying.</p></div>
</div>
                    <div class="faq-expanded__item">
  <h3 class="faq-expanded__q">What is the minimum net owned fund requirement for an NBFC?</h3>
  <div class="faq-expanded__a"><p>Category matters. The Reserve Bank sets the floor by NBFC type under its scale-based regulation framework. Separate minimums apply to microfinance companies, factors, account aggregators, peer-to-peer platforms and infrastructure finance companies. Because these were revised with glide paths to later dates, the applicable figure is read from the current master direction rather than from memory.</p></div>
</div>
                    <div class="faq-expanded__item">
  <h3 class="faq-expanded__q">What happens if net owned fund falls below the prescribed floor?</h3>
  <div class="faq-expanded__a"><p>The company is in breach of a registration condition. Section 45-IA empowers the Reserve Bank to cancel a certificate of registration where an NBFC ceases to meet the requirements on which it was granted. Shortfalls are ordinarily met by fresh capital infusion within the time the regulator allows. The auditor also reports the position.</p></div>
</div>
                    <div class="faq-expanded__item">
  <h3 class="faq-expanded__q">Is the certificate required for a change of control application?</h3>
  <div class="faq-expanded__a"><p>Yes. Prior written approval of the Reserve Bank is needed for any takeover or change in control of an NBFC. For a change in shareholding beyond the prescribed proportion, and the application carries current financials including the net owned fund position. The incoming management's fit-and-proper credentials are examined alongside.</p></div>
</div>
                    <div class="faq-expanded__item">
  <h3 class="faq-expanded__q">Does a Type I NBFC that takes no public funds face the same requirement?</h3>
  <div class="faq-expanded__a"><p>The net owned fund floor applies regardless. Type I classification, for NBFCs neither accepting public funds nor having customer interface, relaxes several prudential and reporting obligations but not the entry-point capital condition. That condition sits in section 45-IA itself rather than in the prudential directions.</p></div>
</div>
                    <div class="faq-expanded__item">
  <h3 class="faq-expanded__q">Is a fresh certificate needed when an NBFC raises capital mid-year?</h3>
  <div class="faq-expanded__a"><p>Where the capital raise is what brings the company to the required floor, yes. The Reserve Bank looks for the position on a stated date supported by the allotment record and the bank credit, not for a year-old audited figure. An interim certificate is issued from the books as at that date.</p></div>
</div>
                    <div class="faq-expanded__item">
  <h3 class="faq-expanded__q">Can share premium received from a foreign investor be counted?</h3>
  <div class="faq-expanded__a"><p>Securities premium forms part of owned fund, and foreign-sourced premium is treated no differently once the inflow is regularised. The evidence trail is longer. The <a href="/glossary/networth/foreign-inward-remittance-certificate-firc">foreign inward remittance certificate</a>, the Form FC-GPR filed with the Reserve Bank and the pricing guidelines all sit behind the reported figure.</p></div>
</div>
                    <div class="faq-expanded__item">
  <h3 class="faq-expanded__q">Must the figure be certified as at a specific date?</h3>
  <div class="faq-expanded__a"><p>Always. Net owned fund is a point-in-time measure. So the certificate names the date and the accounts behind it, whether the latest <a href="/statutory-audit">audited balance sheet</a> or an interim position. A certificate without a date proves nothing, because the deductions for group investments change with every movement in the portfolio.</p></div>
</div>
                    <div class="faq-expanded__item">
  <h3 class="faq-expanded__q">Does an NBFC surrendering its registration still need a certificate?</h3>
  <div class="faq-expanded__a"><p>It usually does. A company applying to surrender its certificate of registration has to show that it has stopped carrying on non-banking financial activity. The Reserve Bank examines its financial position, including net owned fund, before cancellation. Companies that simply stop filing rather than applying formally remain on the register.</p></div>
</div>
                </div>
            </div>
        </div>
...
<section class="content-section" style="background: var(--blue) !important;">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title" style="color:#FFFFFF !important;">Start Your NOF Certificate with Patron Accounting</h2>
            <div class="content-text" style="text-align:left;">
<p style="color:rgba(255,255,255,0.88);">Net owned fund is a regulatory measure rather than an accounting one, and the certified figure almost always lands below the balance sheet total. The work sits in tracing group exposure properly, which a ledger will not show you on its own because the connection is rarely visible in an account name. Send the audited accounts with a note of every connected entity, and we will map the structure before the computation runs.</p>
            </div>
            <div style="display:flex;gap:14px;flex-wrap:wrap;margin-top:24px;">
                ...
                <a href="https://wa.me/919459456700?text=Hi%20Patron%2C%20I%20need%20a%20minimum%20net%20owned%20fund%20for%20nbfc" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:#25D366;color:#fff;border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;">&#128172; WhatsApp Us</a>
                <a href="mailto:sales@patronaccounting.com?subject=Enquiry%20for%20a%20Minimum%20Net%20Owned%20Fund%20for%20NBFC&body=Hello%20Patron%20Accounting%20Team%2C%0A%0AI%20need%20a%20minimum%20net%20owned%20fund%20for%20nbfc%20and%20would%20like%20to%20know%20more.%0A%0AThank%20you." style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:transparent;color:#fff;border:2px solid rgba(255,255,255,0.3);border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;">&#9993;&#65039; Email Us</a>
            </div>
...
<a href="https://www.patronaccounting.com/llp-incorporation" class="pa-cross-card"><div class="pa-card-title">LLP Incorporation</div></a></div>
            ...
            <div class="pa-city-block" style="margin-top:36px;">
                ...
                <ul class="pa-read-list">
                    ...
                    <li><a href="/blog/how-to-calculate-net-owned-fund">How to Calculate Net Owned Fund (NOF)</a></li>
                    <li><a href="/blog/is-net-owned-fund-the-same-as-net-worth">Is Net Owned Fund the Same as Net Worth?</a></li>
                    <li><a href="/blog/nbfc-layers-and-types-under-rbi-classification">NBFC Layers and Types Under RBI Classification</a></li>
                    <li><a href="/blog/net-owned-fund-vs-paid-up-capital">Net Owned Fund vs Paid-Up Capital: The Difference</a></li>
                    <li><a href="/blog/the-50-50-rule-for-nbfcs">The 50-50 Rule for NBFCs, Explained</a></li>
