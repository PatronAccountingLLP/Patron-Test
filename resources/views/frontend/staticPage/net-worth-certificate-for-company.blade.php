{{-- /net-worth-certificate-for-company
     Generated from Generated Pages/net-worth-certificate-for-company/net-worth-certificate-for-company.html by Scripts/build_blade.py.
     ...
     Before this goes live:
       - deploy public/images/networth-cluster/net-worth-certificate-for-company/** and public/certificates/**
...
@section('meta')
    <title>Net Worth Certificate for Company Under Section 2(57)</title>
    <meta name="description" content="Certify your company net worth under Section 2(57), computed from audited accounts with revaluation reserves excluded, for lenders, tenders and filings.">
    <link rel="canonical" href="https://www.patronaccounting.com/net-worth-certificate-for-company">
    <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1">
    <meta property="og:title" content="Company Net Worth, Certified Under Section 2(57)">
    <meta property="og:description" content="We compute and certify a company's net worth from its audited balance sheet, exclusions applied correctly.">
    <meta property="og:url" content="https://www.patronaccounting.com/net-worth-certificate-for-company">
    ...
    <meta name="twitter:title" content="Company Net Worth, Certified Under Section 2(57)">
    <meta name="twitter:description" content="We compute and certify a company's net worth from its audited balance sheet, exclusions applied correctly.">
    ...
    <script type="application/ld+json">
{
 ...
 "@graph": [
  {
   "@type": "Service",
   "@id": "https://www.patronaccounting.com/net-worth-certificate-for-company#service",
   "name": "Net Worth Certificate for Company Under Section 2(57)",
   "description": "Certify your company net worth under Section 2(57), computed from audited accounts with revaluation reserves excluded, for lenders, tenders and filings.",
   "provider": {
    "@id": "https://www.patronaccounting.com/#organization"
   },
   "areaServed": "India",
   "url": "https://www.patronaccounting.com/net-worth-certificate-for-company"
  },
  {
   "@type": "BreadcrumbList",
   "@id": "https://www.patronaccounting.com/net-worth-certificate-for-company#breadcrumb",
   "itemListElement": [
    {
     "@type": "ListItem",
     "position": 1,
    ...
    },
    {
     "@type": "ListItem",
     "position": 3,
     "name": "Net Worth Certificate for Company",
     "item": "https://www.patronaccounting.com/net-worth-certificate-for-company"
    }
   ]
  },
  {
   "@type": "FAQPage",
   "@id": "https://www.patronaccounting.com/net-worth-certificate-for-company#faq",
   "datePublished": "2026-07-30T10:00:00+05:30",
   "dateModified": "2026-08-05T10:00:00+05:30",
   "mainEntity": [
    {
     "@type": "Question",
     "name": "Must a company's certificate be based on audited financial statements?",
     "acceptedAnswer": {
      "@type": "Answer",
      "text": "Audited figures are the expected base, because every company incorporated under the Companies Act 2013 has its accounts audited annually. Where the certificate covers a date after the last audited balance sheet, the CA works from management accounts and says so on the face of the certificate. That most recipients accept if the gap is short."
     }
    },
    {
     "@type": "Question",
     "name": "Can a company get a certificate mid-year before the annual accounts are finalised?",
     "acceptedAnswer": {
      "@type": "Answer",
      "text": "Yes, and interim certificates are routine for tenders and loan sanctions falling due before the audit is signed. The CA works from the ledgers at the chosen date, verifies movements since the last audited balance sheet, and labels the figures unaudited. The certificate then states the date on which the position is drawn."
     }
    },
    {
     "@type": "Question",
     "name": "Does share application money pending allotment count towards net worth?",
     "acceptedAnswer": {
      "@type": "Answer",
      "text": "Not as paid-up capital. Section 2(57) of the Companies Act 2013 builds net worth from paid-up share capital, reserves created out of profits and securities premium. So money received but not yet allotted sits outside that definition until the shares are issued. It is disclosed separately so the reader can see it."
     }
    },
    {
     "@type": "Question",
     "name": "Who signs the company's statement of affairs alongside the chartered accountant?",
     "acceptedAnswer": {
      "@type": "Answer",
      "text": "A director signs the statement from which the CA certifies, and in most engagements the board authorises it by resolution. The CA's signature attests to the verification performed; the director's signature owns the completeness of the disclosure. Recipients generally want both, since a certificate with no company signatory has nothing behind it."
     }
    },
    {
     "@type": "Question",
     "name": "Are amounts lent by directors to the company treated as liabilities?",
     "acceptedAnswer": {
      "@type": "Answer",
      "text": "Yes. A director's loan is money owed by the company and is deducted like any other borrowing, whether or not it carries interest. Recipients often ask separately whether such loans are subordinated. A lender assessing the balance sheet treats a subordinated director loan differently from an amount repayable on demand."
     }
    },
    {
     "@type": "Question",
     "name": "Do subsidiary figures get consolidated into the parent company's certificate?",
     "acceptedAnswer": {
      "@type": "Answer",
      "text": "Only if the certificate says so. The default is standalone, where the parent's investment in the subsidiary appears at its carrying value rather than the subsidiary's underlying assets. Where a recipient wants group strength, a consolidated certificate is issued from consolidated financial statements and the basis is stated in the opening paragraph."
     }
    },
    {
     "@type": "Question",
     "name": "Can a newly incorporated company obtain a certificate in its first year?",
     "acceptedAnswer": {
      "@type": "Answer",
      "text": "Yes. A company that has not completed a financial year still has a verifiable position: subscribed capital actually received, bank balances, preliminary expenses and any assets acquired. The certificate is drawn as at a stated date from the books and bank evidence, and it notes that no audited accounts exist yet."
     }
    },
    {
     "@type": "Question",
     "name": "Does foreign shareholding change how a company's net worth is certified?",
     "acceptedAnswer": {
      "@type": "Answer",
      "text": "The arithmetic does not change, but the evidence widens. Share capital received from a non-resident is supported by the foreign inward remittance certificate and the Form FC-GPR filed with the Reserve Bank. The CA checks that allotment happened within the prescribed period. Recipients abroad often ask for that trail explicitly."
     }
    },
    {
     "@type": "Question",
     "name": "How is a section 8 company's net worth certified when it has no share capital?",
     "acceptedAnswer": {
      "@type": "Answer",
      "text": "Through its reserves and corpus. A section 8 company limited by guarantee has no paid-up share capital, so the certificate reports accumulated surplus, corpus and earmarked funds, less liabilities. Grant-making bodies reading it usually want restricted and unrestricted funds separated, because only the unrestricted portion is genuinely free."
     }
    },
    {
     "@type": "Question",
     "name": "Can a company under insolvency proceedings still obtain a certificate?",
     "acceptedAnswer": {
      "@type": "Answer",
      "text": "It can, though the certificate has to disclose the proceedings. Once the corporate insolvency resolution process is admitted under the Insolvency and Bankruptcy Code 2016, the board stands suspended and the resolution professional runs the company. So the statement of affairs comes from the professional and claims admitted in the process are reflected as liabilities."
     }
    }
   ]
  },
  {
   "@type": "WebPage",
   "@id": "https://www.patronaccounting.com/net-worth-certificate-for-company#webpage",
   "url": "https://www.patronaccounting.com/net-worth-certificate-for-company",
   "name": "Net Worth Certificate for Company Under Section 2(57)",
   "description": "Certify your company net worth under Section 2(57), computed from audited accounts with revaluation reserves excluded, for lenders, tenders and filings.",
   "isPartOf": {
        ...
        <div class="row align-items-center">
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-4 private-registration-heading">Net Worth Certificate for Company</h1>
                    ...
                    <div class="mb-4 hero-benefits">
                        <div class="hero-benefit"><span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span><p class="mb-0 text-dark benefit-paragraph"><span>Each reserve traced to its origin</span></p></div>
                        <div class="hero-benefit"><span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span><p class="mb-0 text-dark benefit-paragraph"><span>Computed on section 2(57)</span></p></div>
                        <div class="hero-benefit"><span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span><p class="mb-0 text-dark benefit-paragraph"><span>Working annexed for the reader</span></p></div>
                        <div class="hero-benefit"><span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span><p class="mb-0 text-dark benefit-paragraph"><span>Both bases issued where unclear</span></p></div>
                    </div>
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="mailto:sales@patronaccounting.com?subject=Enquiry%20for%20a%20Net%20Worth%20Certificate%20for%20Company&body=Hello%2C%20I%20just%20visited%20your%20a%20Net%20Worth%20Certificate%20for%20Company%20page.%20I%20would%20like%20to%20know%20more%20about%20it.%0A%0AThank%20you." class="btn-sample text-decoration-none">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:18px;height:18px;"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,12 2,6"/></svg>
                            Email Us
                        </a>
                        <a href="https://wa.me/919459456700?text=Hello%2C%20I%20just%20visited%20your%20a%20Net%20Worth%20Certificate%20for%20Company%20page.%20I%20would%20like%20to%20know%20more%20about%20it." target="_blank" rel="noopener" class="btn-sample text-decoration-none">
            ...
            <div class="col-lg-4">
                @include('partials.bigin-form', [
                    'service'  => 'Company Net Worth Certificate',
                ])
            </div>
        </div>
    </div>
...
<section class="testimonials-section">
  <div class="section-container">
    <div class="section-header">
      <h2>What Our Company Net Worth Certificate Clients Say</h2>
...
<section class="content-section" id="overview-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Company Net Worth Certificate: Scope, Deliverables and Who It Suits</h2>
            <div class="content-text">
                <div class="highlight-box" style="margin-bottom:20px;">
                    <p><strong>&#128204; TL;DR &mdash; Net Worth Certificate for Company at a Glance</strong></p>
                    <p>A net worth certificate for a company follows Section 2(57) of the Companies Act. It adds paid-up share capital, reserves created out of profits and the securities premium account. It then deducts accumulated losses, deferred expenditure and miscellaneous expenditure not written off. Reserves from revaluation, write-back of depreciation and amalgamation are excluded. Every figure traces to the audited balance sheet, so the certificate is only as current as that date.</p>
                </div>
<p>The requirement tends to surface late, when a <a href="/net-worth-certificate-for-bank-loan">lender</a>, a <a href="/solvency-certificate">tender committee</a> or a regulator asks for a certified figure. The audited accounts hold the inputs but not the answer, because a balance sheet does not present the number in that form. Someone then has to decide which reserves count and which are excluded, and that decision is where most in-house computations go wrong.</p><p>Two situations change the answer rather than the arithmetic. Where the audit report carries a qualification, the certificate has to disclose it. Where the company holds investments in group entities, the question becomes which accounts the recipient asked for, standalone or consolidated. Directors certifying their own position for a fit-and-proper declaration are covered here too. <a href="/blog/documents-required-for-net-worth-certificate">The papers a chartered accountant will ask for</a> are listed separately, alongside the <a href="https://www.mca.gov.in" target="_blank" rel="noopener">Companies Act</a>.</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="content-container">
        <div class="two-column">
            <div class="column-content">
                <h2 class="section-title">What Is a Company Net Worth Certificate Under Section 2(57)?</h2>
                <div class="content-text what-is-definition">
<p>A company <a href="/net-worth-certificate">net worth certificate</a> reports the net worth of the company as a legal person, distinct from the personal position of its promoters or directors. Section 2(57) of the Companies Act supplies the definition, and the <a href="/statutory-audit">audited financial statements</a> supply the figures.</p><p>Its scope is bounded in three ways. The figure is standalone unless a consolidated position is expressly requested. It is stated as at the date of the audited balance sheet, not as at the date of signing. And it carries no opinion on <a href="/solvency-certificate">solvency</a>, on going concern, or on whether the company can meet a particular obligation.</p>
                </div>
                <div class="highlight-box" style="margin-top:20px;">
                    <p><strong>Key terms on this page:</strong></p>
                    <div class="key-terms"><ul class="al-list">
                    <li><span class="al-t"><a href="/glossary/networth/free-reserves">Free Reserves</a></span><span class="al-d">Free reserves are the part of a company's reserves available for distribution as dividend, and section 2(43) of the Companies Act 2013 defines them by exclusion.</span></li>
                    <li><span class="al-t"><a href="/glossary/networth/securities-premium">Securities Premium</a></span><span class="al-d">Securities premium is the amount a company receives on issuing shares above their face value.</span></li>
                    <li><span class="al-t"><a href="/glossary/networth/revaluation-reserve">Revaluation Reserve</a></span><span class="al-d">A revaluation reserve arises when a company writes an asset up to a higher value without selling it.</span></li>
                    <li><span class="al-t"><a href="/glossary/networth/slump-sale">Slump Sale</a></span><span class="al-d">A slump sale is the transfer of an undertaking as a going concern for a lump sum consideration, without values being assigned to individual assets and liabilities.</span></li>
                    <li><span class="al-t"><a href="/glossary/networth/net-worth-erosion">Net Worth Erosion</a></span><span class="al-d">Net worth erodes when accumulated losses consume the reserves and then the capital itself.</span></li>
                    </ul></div>
                </div>
            </div>
            <div class="column-image"><img src="/images/networth-cluster/net-worth-certificate-for-company/what-is.webp" alt="The net worth of the company as a legal person, taken from the audited balance sheet under Section 2(57)" loading="lazy" width="1200" height="896" style="width:100%;height:auto;border-radius:var(--radius-xl);box-shadow:var(--shadow-md);"></div>
        </div>
    </div>
</section>
...
<section class="content-section specimen-section" id="specimen-section">
    ...
    <div class="text-content">
      <div class="specimen-item">
        <div class="specimen-caption"><div class="specimen-sticky">
          <h2 class="section-title">What a Company Net Worth Certificate Looks Like: A Masked Specimen</h2>
          ...
          <div class="specimen-pane is-active" data-spec-pane="0">
            ...
            <p>The sample certifies the company as a legal person, distinct from its promoters. It runs the Section 2(57) computation on the face of the document, adding paid-up capital and reserves that came out of profits and taking off accumulated losses and expenditure not yet written off. The balance sheet date it speaks to is stated plainly, so nobody reads the figure as current to the day it was signed.</p>
            <a class="specimen-download" href="/certificates/03-net-worth-certificate-company.pdf" download>Download this sample (PDF)</a>
          </div>
        ...
        <div class="specimen-stack" id="specimenStack">
          ...
          <div class="specimen-tabs" role="tablist" aria-label="Choose a sample">
            <button type="button" role="tab" class="specimen-tab is-active" data-spec-tab="0" aria-selected="true">Company net worth certificate</button>
          </div>
          <div class="specimen-frame" id="specimenFrame" role="button" tabindex="0" aria-label="Enlarge this sample">
            <div class="specimen-doc is-active" data-spec-doc="0"><article class="nwc-spec" aria-label="Net Worth Certificate — Company (Pvt Ltd) - specimen, all values masked, not a valid certificate">
  <svg class="nwc-spec__mark" aria-hidden="true" focusable="false">
    <defs><pattern id="nwcwm-03" width="400" height="230"
      patternUnits="userSpaceOnUse">
      <text x="16" y="150" transform="rotate(-24 16 150)">Patron Accounting</text>
    </pattern></defs>
    <rect width="100%" height="100%" fill="url(#nwcwm-03)"/>
  </svg>
  ...
  <h3>Certificate of Net Worth of the Company</h3>
  ...
  office at <span class="b">XXXX XXX, XXXXXXXX XX XXXX, XXXXXXX XXXXX, XXXX XXXXXX</span>, holding Corporate Identity Number <span class="b">XXXXXXXXXXXXXXXXXXXXX</span> and Permanent Account Number <span class="b">XXXXXXXXXX</span>,
  as at <span class="b">XX XXXXX XXXX</span>.</p>
<h4>Extract from the Audited Balance Sheet</h4><table><caption class="nwc-spec__sr">Extract from the Audited Balance Sheet - all figures masked</caption><thead><tr><th style="width:50px">Sr.</th><th>Particulars</th><th class="num">Amount (INR)</th></tr></thead><tbody><tr class="sub"><td>A</td><td><b>Assets</b></td><td class="num"></td></tr><tr><td>1</td><td>Property, plant and equipment (net of depreciation)</td><td class="num"><span class="b b--n">X,XX,XX,XXX</span></td></tr><tr><td>2</td><td>Capital work-in-progress</td><td class="num"><span class="b b--n">X,XX,XX,XXX</span></td></tr><tr><td>3</td><td>Non-current investments</td><td class="num"><span class="b b--n">X,XX,XX,XXX</span></td></tr><tr><td>4</td><td>Inventories</td><td class="num"><span class="b b--n">X,XX,XX,XXX</span></td></tr><tr><td>5</td><td>Trade receivables</td><td class="num"><span class="b b--n">X,XX,XX,XXX</span></td></tr><tr><td>6</td><td>Cash and cash equivalents</td><td class="num"><span class="b b--n">X,XX,XX,XXX</span></td></tr><tr><td>7</td><td>Other current assets</td><td class="num"><span class="b b--n">X,XX,XX,XXX</span></td></tr><tr class="sub"><td></td><td><b>Total Assets (A)</b></td><td class="num"><span class="b b--n">X,XX,XX,XXX</span></td></tr><tr class="sub"><td>B</td><td><b>Liabilities</b></td><td class="num"></td></tr><tr><td>1</td><td>Long-term borrowings</td><td class="num"><span class="b b--n">X,XX,XX,XXX</span></td></tr><tr><td>2</td><td>Short-term borrowings</td><td class="num"><span class="b b--n">X,XX,XX,XXX</span></td></tr><tr><td>3</td><td>Trade payables</td><td class="num"><span class="b b--n">X,XX,XX,XXX</span></td></tr><tr><td>4</td><td>Other current liabilities and provisions</td><td class="num"><span class="b b--n">X,XX,XX,XXX</span></td></tr><tr class="sub"><td></td><td><b>Total Liabilities (B)</b></td><td class="num"><span class="b b--n">X,XX,XX,XXX</span></td></tr><tr class="tot"><td></td><td><b>NET WORTH (A &minus; B)</b></td><td class="num"><span class="b b--n">X,XX,XX,XXX</span></td></tr></tbody></table>  <h4>Computation under Section 2(57), Companies Act 2013</h4>
  <table><caption class="nwc-spec__sr">Specimen figures - all values masked</caption><tbody>
    <tr><td>Paid-up share capital</td><td class="num"><span class="b b--n">X,XX,XX,XXX</span></td></tr>
    <tr><td>Add: Reserves created out of profits</td><td class="num"><span class="b b--n">X,XX,XX,XXX</span></td></tr>
    <tr><td>Add: Securities premium account</td><td class="num"><span class="b b--n">XX,XX,XXX</span></td></tr>
    <tr><td>Add: Credit balance in profit and loss account</td><td class="num"><span class="b b--n">XX,XX,XXX</span></td></tr>
    <tr><td>Less: Deferred expenditure not written off</td><td class="num"><span class="b b--n">(XX,XX,XXX)</span></td></tr>
    <tr class="tot"><td><b>NET WORTH</b></td><td class="num"><b><span class="b b--n">X,XX,XX,XXX</span></b></td></tr>
  </tbody></table>
  <p>Reserves created out of revaluation of assets, write-back of depreciation and
  amalgamation have been excluded, as required by the said Section.</p>
  ...
  <p>This certificate is issued at the request of the applicant for the purpose of submission to a regulatory authority and is
...
<section class="content-section" id="who-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Who Needs a Company Net Worth Certificate in India</h2>
            <div class="why-patron-grid">
                <div><strong>The Audited Accounts Do Not Answer It</strong><p>The balance sheet is signed and filed, but nobody has restated it as a single net worth figure under the statutory definition. The person asking wants that number, not the accounts it comes from.</p></div>
                <div><strong>A Tender Has Named a Figure</strong><p>An eligibility clause sets a minimum net worth the company has to show. Whether the company clears it depends on which reserves count, and that is decided before any certificate is drafted.</p></div>
                <div><strong>The Audit Report Carries a Qualification</strong><p>There is a modification in the auditor's opinion, and nobody has yet decided how it is disclosed on a certificate drawn from those same accounts. Leaving it unmentioned is not one of the options.</p></div>
                <div><strong>The Group Structure Complicates the Answer</strong><p>The company holds investments in or lends to related entities. Which set of accounts the recipient meant, standalone or consolidated, changes the figure materially and is worth settling before the work starts.</p></div>
                <div><strong>A Directorship Requires Personal Disclosure</strong><p>A fit-and-proper declaration or a regulatory appointment requires the individual's net worth alongside the company's. The two are separate certificates, separate computations and often separate dates.</p></div>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section" id="services-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Our Company Net Worth Certificate Service: What You Receive</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Service</th><th>What&#x27;s included</th><th>Frequency</th></tr></thead>
                    <tbody>
                        <tr><td>Statutory computation under section 2(57)</td><td>Paid-up capital, <a href="/glossary/networth/securities-premium">securities premium</a> and reserves out of profits totalled, the statutory deductions applied, every line tied back to the audited balance sheet; <a href="/blog/how-to-calculate-net-worth-for-a-net-worth-certificate">how a company&#x27;s net worth is computed</a>.</td><td><span class="badge-included">Once the audited accounts are signed</span></td></tr>
                        <tr><td>Reserve classification schedule</td><td>Each reserve identified by how it arose, so revaluation, depreciation write-back and amalgamation reserves sit visibly outside the total instead of silently inside it.</td><td><span class="badge-included">Annually, with the audited accounts</span></td></tr>
                        <tr><td>Certificate naming the company and its CIN</td><td>The certificate carrying the company name exactly as the register holds it, the CIN, and the balance sheet date the figure speaks to, signed with a <a href="/blog/how-to-verify-a-net-worth-certificate">UDIN</a>.</td><td><span class="badge-included">Per engagement</span></td></tr>
                        <tr><td>Standalone or consolidated position</td><td>Whichever the recipient asked for, or both where they have not said, so the file is not returned for answering the wrong question.</td><td><span class="badge-included">Per engagement</span></td></tr>
                        <tr><td>Audit qualification disclosure</td><td>Where the auditor's report is modified, the wording agreed with you and carried on the face of the certificate rather than passed over.</td><td><span class="badge-included">Where applicable</span></td></tr>
                        <tr><td><a href="/net-owned-fund-certificate-for-nbfc">Group exposure</a> schedule</td><td>Money placed with or lent to companies in the same group, set out separately, which a tender committee reads before it accepts the headline total.</td><td><span class="badge-included">Per engagement</span></td></tr>
                        <tr><td>Annual reissue after the audit</td><td>A fresh certificate each year once the accounts are signed; an interim one on provisional figures is possible where the certificate says so on its face.</td><td><span class="badge-included">Annually</span></td></tr>
                    </tbody>
                </table>
                </div>
            </div>
...
<section class="steps-section" id="procedure-section">
    <div class="section-container">
        <header class="section-header" style="text-align:center;margin-bottom:48px;">
            ...
            <h2 class="section-title">How We Issue a Company Net Worth Certificate, Step by Step</h2>
  ...
  <div class="step-content">
    ...
    <h3 class="step-title">Audited accounts taken up</h3>
    <p class="step-description">We begin from the signed audited financial statements rather than a trial balance or management figures. The date those accounts carry becomes the date the certificate speaks to, and it is stated on the face of the certificate so nobody assumes it is current to signing.</p>
  </div>
  <div class="step-visual"><div class="step-illustration" style="padding:0;background:none;"><img src="/images/networth-cluster/net-worth-certificate-for-company/step-1-audited-accounts-taken-up.webp" alt="We begin from the signed audited financial statements rather than a trial balance or management figures" loading="lazy" width="1200" height="896" style="width:100%;height:auto;border-radius:var(--radius-xl);"></div></div>
</div>
            <div class="step-card">
  <div class="step-content">
    <span class="step-badge">Step 2</span>
    <h3 class="step-title">Statutory computation run</h3>
    <p class="step-description">The computation adds paid-up share capital to the securities premium account and to reserves that came out of profits. Accumulated losses come off, as do deferred expenditure and miscellaneous expenditure not yet written off, each line tying back to the audited balance sheet it came from.</p>
  </div>
  <div class="step-visual"><div class="step-illustration" style="padding:0;background:none;"><img src="/images/networth-cluster/net-worth-certificate-for-company/step-2-statutory-computation-run.webp" alt="The computation adds paid-up share capital to the securities premium account and to reserves that came out of profits" loading="lazy" width="1200" height="896" style="width:100%;height:auto;border-radius:var(--radius-xl);"></div></div>
</div>
            <div class="step-card">
  <div class="step-content">
    <span class="step-badge">Step 3</span>
    <h3 class="step-title">Excluded reserves stripped out</h3>
    <p class="step-description">Reserves arising from revaluation of assets, from write-back of depreciation and from amalgamation are removed from the total. Each exclusion is identified in the working, so a reader can see exactly what was taken out and on what authority it was taken.</p>
  </div>
  <div class="step-visual"><div class="step-illustration" style="padding:0;background:none;"><img src="/images/networth-cluster/net-worth-certificate-for-company/step-3-excluded-reserves-stripped-out.webp" alt="Reserves arising from revaluation of assets, from write-back of depreciation and from amalgamation are removed from the total" loading="lazy" width="1200" height="896" style="width:100%;height:auto;border-radius:var(--radius-xl);"></div></div>
</div>
            <div class="step-card">
  <div class="step-content">
    <span class="step-badge">Step 4</span>
    <h3 class="step-title">Audit qualification addressed</h3>
    <p class="step-description">Where the auditor's report carries a modification, how it is disclosed on the certificate is settled with you before drafting. A qualification that touches the figures cannot be passed over in silence when the certificate rests on those very accounts.</p>
  </div>
  <div class="step-visual"><div class="step-illustration" style="padding:0;background:none;"><img src="/images/networth-cluster/net-worth-certificate-for-company/step-4-audit-qualification-addressed.webp" alt="Where the auditor's report carries a modification, how it is disclosed on the certificate is settled with you before drafting" loading="lazy" width="1200" height="896" style="width:100%;height:auto;border-radius:var(--radius-xl);"></div></div>
</div>
            <div class="step-card">
  <div class="step-content">
    <span class="step-badge">Step 5</span>
    <h3 class="step-title">Group position confirmed</h3>
    <p class="step-description">Where the company has funded or lent to entities inside its own group, we confirm whether the recipient asked for the standalone or the consolidated position. The two produce materially different figures, and answering the wrong one sends the file back.</p>
  </div>
  <div class="step-visual"><div class="step-illustration" style="padding:0;background:none;"><img src="/images/networth-cluster/net-worth-certificate-for-company/step-5-group-position-confirmed.webp" alt="Where the company has funded or lent to entities inside its own group" loading="lazy" width="1200" height="896" style="width:100%;height:auto;border-radius:var(--radius-xl);"></div></div>
</div>
            <div class="step-card">
  <div class="step-content">
    <span class="step-badge">Step 6</span>
    <h3 class="step-title">Signed and UDIN generated</h3>
    <p class="step-description">The certificate is signed by a <a href="/net-worth-certificate-by-ca">practising chartered accountant</a> with the full computation annexed, and a UDIN is generated against it. The annexure is what lets a tender committee or a lender check the arithmetic rather than take the total on trust.</p>
  </div>
  <div class="step-visual"><div class="step-illustration" style="padding:0;background:none;"><img src="/images/networth-cluster/net-worth-certificate-for-company/step-6-signed-and-udin-generated.webp" alt="The certificate is signed by a practising chartered accountant with the full computation annexed" loading="lazy" width="1200" height="896" style="width:100%;height:auto;border-radius:var(--radius-xl);"></div></div>
</div>
        </div>
    </div>
</section>
...
<section class="content-section" id="documents-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Documents Required for a Company Net Worth Certificate</h2>
            <div class="content-text">
                ...
                <ul>
                    <li>Signed audited financial statements for the latest financial year, with the auditor's report</li>
                    <li>Trial balance and general ledger as at the balance sheet date</li>
                    <li>Schedule of reserves showing how each reserve arose</li>
                    <li>Securities premium account balance with its movement for the year</li>
                    <li>Details of accumulated losses, deferred expenditure and miscellaneous expenditure not written off</li>
                    <li>Fixed asset register, with any revaluation identified separately</li>
                    <li>Register of members and confirmation of paid-up share capital</li>
                    <li>Schedule of investments in and loans to group and subsidiary companies</li>
                    <li>CIN and PAN of the company, and the MCA master data as it currently stands</li>
                </ul>
                <p><strong>Where they apply:</strong></p>
                <ul>
                    <li>Memorandum and Articles of Association, where borrowing powers or transfer restrictions bear on the figures</li>
                </ul>
            </div>
        </div>
    </div>
...
<section class="content-section" id="challenges-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Common Company Net Worth Certificate Problems and How We Solve Them</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Challenge</th><th>Why it happens</th><th>How it is handled</th></tr></thead>
                    <tbody>
                        <tr><td><a href="/glossary/networth/revaluation-reserve">Revaluation reserve</a> left inside the total</td><td>An uplift taken on property sits in the reserves like any other, and a computation run off the balance sheet total carries it through without noticing.</td><td>The reserve schedule identifies how each reserve arose, and anything from revaluation, depreciation write-back or amalgamation is removed with the working shown.</td></tr>
                        <tr><td>Management figures used where the statute reads audited ones</td><td>Month-end numbers are closer to hand and feel more current, so they get supplied when a tender deadline is near.</td><td>The computation starts from the signed audited statements and states the balance sheet date on the certificate; <a href="/blog/how-to-calculate-net-worth-for-a-net-worth-certificate">how the statutory figure is arrived at</a>.</td></tr>
                        <tr><td>Standalone and consolidated positions confused</td><td>A group produces two sets of accounts and two very different figures, and the request rarely says which one the recipient wants.</td><td>We ask the recipient which basis they are assessing before drafting, and issue both where they have not said, each labelled on its face.</td></tr>
                        <tr><td>An audit qualification passed over in silence</td><td>The qualification sits in the auditor's report rather than in the figures, so a computation drawn from those same figures never encounters it.</td><td>Where the report is modified, how it is disclosed is settled with you first and then carried on the certificate itself.</td></tr>
                        <tr><td>Subscribed capital presented as paid-up</td><td>The two sit close together in the accounts and differ only by what shareholders have actually paid, which is easy to read past.</td><td>Paid-up capital is confirmed against the register of members and the allotment return before it opens the computation.</td></tr>
                    </tbody>
                </table>
                </div>
            </div>
...
<section class="content-section" id="fees-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Company Net Worth Certificate Fees</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Plan</th><th>Fee</th></tr></thead>
                    <tbody>
                        <tr><td><strong>Standard</strong> &mdash; One company with <a href="/statutory-audit">signed audited accounts</a>, a clean reserve schedule and no group holdings to trace.</td><td>Starting from INR 1999<br><span style="font-size:12px;color:var(--text-muted);">(Exl GST and Govt. Charges)</span></td></tr>
                        <tr><td><strong>Extended</strong> &mdash; Group companies to trace, a reserve schedule to rebuild, or a modified audit report to be disclosed on the certificate.</td><td>On quote</td></tr>
                        <tr><td><strong>Multiple certificates</strong> &mdash; The company and its <a href="/net-worth-certificate-for-rera-registration">promoter</a> certified together, which lenders assessing an unsecured facility frequently ask for.</td><td>On quote</td></tr>
                    </tbody>
                </table>
                </div>
...
<section class="why-choose-section" id="benefits-section">
    <div class="section-container">
        <div style="text-align:center;margin-bottom:48px;">
            ...
            <h2 class="section-title">Why a Company Net Worth Certificate Matters</h2>
        </div>
...
<article class="feature-card">
  ...
  <h3 class="feature-title">Including Revaluation Overstates the Figure</h3>
  <p class="feature-text">Revaluation reserves are excluded from the statutory definition. A computation that leaves them in produces a number the recipient can disprove from the same balance sheet. That is a worse position than reporting a lower figure honestly.</p>
</article>
<article class="feature-card">
  ...
  <h3 class="feature-title">An Undisclosed Qualification Surfaces Later</h3>
  <p class="feature-text">A recipient who reads the audit report will find a qualification the certificate did not mention. Discovering it second undermines both documents, and the question shifts from the figure to why it was left out.</p>
</article>
<article class="feature-card">
  ...
  <h3 class="feature-title">The Wrong Accounts Fail the Test</h3>
  <p class="feature-text">A standalone figure submitted where a consolidated one was wanted is not a small error. It answers a different question from the one asked, and the file goes back for the version that should have been sent.</p>
</article>
<article class="feature-card">
  ...
  <h3 class="feature-title">A Stale Balance Sheet Date Disqualifies</h3>
  <p class="feature-text">Many recipients set a maximum age for the accounts behind a certificate. A figure traced to a balance sheet older than that limit will not be considered, however carefully the computation itself was done.</p>
</article>
        </div>
    </div>
</section>
...
<section class="content-section" id="why-patron-section" style="background: var(--cream) !important;">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Why Clients Choose Patron for Company Net Worth Certificates</h2>
            ...
            <div class="why-patron-grid">
                <div><strong>Each reserve traced to its origin</strong><p>A reserve schedule is built before the computation runs, so an uplift taken on property years ago is visible and removed rather than travelling into the total unnoticed.</p></div>
                <div><strong>Computed on section 2(57)</strong><p>The figure follows the statutory definition in section 2(57) of the Companies Act 2013, read off the audited balance sheet, with every addition and deduction tied to the line it came from.</p></div>
                <div><strong>Working annexed for the reader</strong><p>A tender committee can follow the computation from paid-up capital through to the certified figure, and confirm the UDIN on the <a href="/blog/how-to-verify-a-net-worth-certificate">ICAI portal</a>, without asking us for anything.</p></div>
                <div><strong>Both bases issued where unclear</strong><p>Where the recipient has not said which basis they are assessing, standalone and consolidated are prepared and labelled, so nothing comes back for having answered a question nobody asked.</p></div>
                <div><strong>Statutory audit behind the certificate</strong><p>The same CA and CS team runs statutory audit and MCA compliance across 3,000+ businesses, which is why an audit qualification is familiar ground rather than a query back to you.</p></div>
            </div>
...
<section class="content-section" id="comparison-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <h2 class="section-title">Company Net Worth vs the Promoter's Personal Net Worth</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
<table class="nwc-comparison"><thead><tr><th>Criterion</th><th>The company's own certificate</th><th>The promoter's personal certificate</th></tr></thead><tbody>
  <tr><td>Whose position is stated</td><td>The company as a separate legal person, with its own assets and borrowings.</td><td>The individual behind it, including holdings that have nothing to do with the business.</td></tr>
  <tr><td>Which records it is drawn from</td><td>The signed audited financial statements, on the statutory definition.</td><td>Personal records: returns, bank statements, title deeds and depository statements.</td></tr>
  <tr><td>How the statutory exclusions apply</td><td>Revaluation, depreciation write-back and amalgamation reserves come out.</td><td>No statutory formula applies; the basis for each asset is disclosed instead.</td></tr>
  <tr><td>When a recipient asks for it</td><td>Tenders, <a href="/net-worth-certificate-for-rera-registration">RERA</a> registration, credit assessment of the business itself.</td><td>Personal guarantees, visa files, and where a lender wants the promoter behind the borrowing.</td></tr>
  <tr><td>What it cannot do</td><td>It says nothing about whether the promoter could support the company.</td><td>It cannot satisfy a tender or a regulator assessing the entity.</td></tr>
  <tr class="verdict"><td>Verdict</td><td colspan="2">These answer different questions and neither substitutes for the other. A lender assessing an unsecured facility frequently wants both, because the company net worth certificate shows the business and the personal one shows what stands behind it. <a href="/blog/how-to-calculate-net-worth-of-a-pvt-ltd-company">how a private company's figure is built</a>.</td></tr>
</tbody></table>
                </div>
...
<section class="content-section" id="director-fit-and-proper-section">
    <div class="content-container">
        <div class="text-content">
            <span class="section-eyebrow"></span>
            <h2 class="section-title">Director Fit-and-Proper Declarations</h2>
            <div class="content-text">
                <ul class="al-list">
                    <li><span class="al-t">Where regulators ask for a director's net worth</span><span class="al-d">Fit-and-proper criteria run across several Indian regulators, and net worth appears in most of them as one test among several. The Reserve Bank applies fit-and-proper criteria to directors of non-banking financial companies and to those of banks. The insurance regulator applies its own to insurers. Exchanges and the market regulator apply theirs to brokers and to the boards of listed companies. In each case the declaration is made by the individual and the supporting certificate is issued in their personal name.</span></li>
                    <li><span class="al-t">A personal certificate against the company's own</span><span class="al-d">This is the distinction that sends files back. A fit-and-proper declaration is about the person, so the certificate covers their personal assets and liabilities including everything unconnected to the company. A company net worth certificate under section 2(57) covers the entity and says nothing about any individual. A director who submits the company's certificate against a personal fit-and-proper requirement has answered a different question, and the regulator will ask again.</span></li>
                    <li><span class="al-t">NBFC, insurance and listed-company boards</span><span class="al-d">The practical differences are in what accompanies the figure. An NBFC director's declaration is usually read alongside the company's own <a href="/net-owned-fund-certificate-for-nbfc">net owned fund</a> position. The two are therefore prepared together and stated on a consistent basis. An insurance or exchange filing tends to ask for a longer disclosure of other directorships and interests. A listed company board declaration is made annually and must be capable of repetition on the same basis. That is why the working papers are retained rather than discarded once the certificate is issued.</span></li>
                    <li><span class="al-t">Timing and repetition</span><span class="al-d">Fit-and-proper declarations recur. Most regulators require them annually, and several require a fresh declaration on appointment and on any material change in the director's position. That makes consistency between years as important as accuracy in any one of them. We keep the working papers and the basis used. A declaration made this year can then be prepared on the same footing next year, and any movement explained rather than discovered. A director whose certified position moves sharply between two filings, with no explanation on file, invites the question the declaration exists to close.</span></li>
                </ul>
            </div>
        </div>
    </div>
...
<section class="content-section" id="tool-section" style="background-color:var(--blue-lighter);">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Compute Your Company's Net Worth From the Balance Sheet</h2>
            <div class="content-text">
                <p>Enter paid-up capital, the securities premium account and reserves by how each arose. The calculator applies the section 2(57) additions and deductions and shows what is excluded as well as what counts, which is usually the part a company's own working gets wrong.</p>
                ...
                <div class="nwt-wrap">
                    <div class="nwt-card">
                        <h3 class="nwt-title">Free tool: Company Net Worth Calculator (Section 2(57))</h3>
                        ...
                        <div class="nwt-cols nwt-cols--3">
                            <div class="nwt-col">
                                <h4>What the definition adds</h4>
                                <div class="nwt-row"><label for="nwt-g0-0">Paid-up share capital</label><input class="nwt-input" type="text" id="nwt-g0-0" data-nwt="g0" data-name="Paid-up share capital" inputmode="decimal" autocomplete="off" placeholder="0"></div>
                                <div class="nwt-row"><label for="nwt-g0-1">Securities premium account</label><input class="nwt-input" type="text" id="nwt-g0-1" data-nwt="g0" data-name="Securities premium account" inputmode="decimal" autocomplete="off" placeholder="0"></div>
                                <div class="nwt-row"><label for="nwt-g0-2">General reserve (built from profits)</label><input class="nwt-input" type="text" id="nwt-g0-2" data-nwt="g0" data-name="General reserve (built from profits)" inputmode="decimal" autocomplete="off" placeholder="0"></div>
                                <div class="nwt-row"><label for="nwt-g0-3">Retained earnings / surplus in P&amp;L</label><input class="nwt-input" type="text" id="nwt-g0-3" data-nwt="g0" data-name="Retained earnings / surplus in P&amp;L" inputmode="decimal" autocomplete="off" placeholder="0"></div>
                            </div>
                            <div class="nwt-col">
                                <h4>What the definition deducts</h4>
                                ...
                                <div class="nwt-row"><label for="nwt-g1-1">Deferred expenditure</label><input class="nwt-input" type="text" id="nwt-g1-1" data-nwt="g1" data-name="Deferred expenditure" inputmode="decimal" autocomplete="off" placeholder="0"></div>
                                <div class="nwt-row"><label for="nwt-g1-2">Miscellaneous expenditure not written off</label><input class="nwt-input" type="text" id="nwt-g1-2" data-nwt="g1" data-name="Miscellaneous expenditure not written off" inputmode="decimal" autocomplete="off" placeholder="0"></div>
                            </div>
                            <div class="nwt-col">
                                <h4>Excluded by the statute (entered, never counted)</h4>
                                <div class="nwt-row"><label for="nwt-g2-0">Revaluation reserve</label><input class="nwt-input" type="text" id="nwt-g2-0" data-nwt="g2" data-name="Revaluation reserve" inputmode="decimal" autocomplete="off" placeholder="0"></div>
                                <div class="nwt-row"><label for="nwt-g2-1">Reserve created by writing back depreciation</label><input class="nwt-input" type="text" id="nwt-g2-1" data-nwt="g2" data-name="Reserve created by writing back depreciation" inputmode="decimal" autocomplete="off" placeholder="0"></div>
                                <div class="nwt-row"><label for="nwt-g2-2">Reserve arising on amalgamation</label><input class="nwt-input" type="text" id="nwt-g2-2" data-nwt="g2" data-name="Reserve arising on amalgamation" inputmode="decimal" autocomplete="off" placeholder="0"></div>
                            </div>
                        </div>
                        ...
                        <div class="nwt-result" id="nwtResult">
                            <div class="nwt-rgrid">
                                <div class="nwt-rcard"><div class="nwt-rlabel">Additions</div><div class="nwt-rval" id="nwtA">&mdash;</div></div>
                                <div class="nwt-rcard"><div class="nwt-rlabel">Deductions</div><div class="nwt-rval" id="nwtB">&mdash;</div></div>
                                <div class="nwt-rcard"><div class="nwt-rlabel">Excluded reserves (not in the figure above)</div><div class="nwt-rval" id="nwtMemo">&mdash;</div></div>
                                <div class="nwt-rcard full"><div class="nwt-rlabel">Net worth under section 2(57)</div><div class="nwt-rval" id="nwtNet">&mdash;</div></div>
                                
                            </div>
                            <div class="nwt-break" id="nwtBreak"></div>
                            <div class="nwt-actions">
                                <a href="https://wa.me/919459456700?text=Hello%2C%20I%20just%20visited%20your%20a%20Net%20Worth%20Certificate%20for%20Company%20page.%20I%20would%20like%20to%20know%20more%20about%20it." target="_blank" rel="noopener" class="nwt-abtn"><svg viewBox="0 0 24 24" fill="#25D366" aria-hidden="true"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347z"/></svg> Ask a CA</a>
                        ...
                        <p class="nwt-note">Classify each reserve by how it arose, not by its name. An estimate from the figures you enter: it is not a certified computation and carries no UDIN.</p>
                    </div>
                </div>
                ...
                (function(){
                    ...
                    function calculate(){
                        ...
                        $('nwtBreak').innerHTML = rows
                            ? rows + row('<strong>Net worth under section 2(57)</strong>', '<strong>' + money(net) + '</strong>')
                            : '';
                        show();
                    }
...
<section class="content-section" id="legal-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">The Legal and Professional Framework Behind Company Net Worth Certificates</h2>
            <div class="content-text">
                <p>Unlike an individual's position, a company's net worth is defined by statute. Section 2(57) sets out exactly what is added and what is deducted, and it reads the figure from the audited balance sheet rather than from any management account. That is why the engagement begins with signed accounts and not with a trial balance.</p>
                <p>The definition does most of the work, but it does not sit alone. The provisions below govern how the components are evidenced, what the company was permitted to do, and where a recipient can corroborate the accounts the figure was drawn from.</p>
                <ul class="al-list">
                    <li><span class="al-t"><strong>Section 2(57), Companies Act 2013</strong></span><span class="al-d">sets the formula exactly: share capital paid up, reserves arising from profits and the premium account are added, while losses carried forward and expenditure still unwritten off come away. Anything created by revaluing an asset, writing back depreciation or amalgamating is outside it.</span></li>
                    <li><span class="al-t"><strong>Section 129, Companies Act 2013</strong></span><span class="al-d">requires the financial statements to give a true and fair view and to follow the prescribed form, which is what makes the audited balance sheet a document a certificate can properly be built on.</span></li>
                    <li><span class="al-t"><strong>Section 39(4), Companies Act 2013 read with Rule 12, Companies (Prospectus and Allotment of Securities) Rules 2014, Form PAS-3</strong></span><span class="al-d">requires a return of allotment to be filed whenever securities are allotted, and that return is where paid-up capital is confirmed. Subscribed capital not yet paid up is a different figure and is often supplied in its place.</span></li>
                    <li><span class="al-t"><strong>Sections 137 and 92, Companies Act 2013</strong></span><span class="al-d">require the audited accounts and the annual return to be filed with the Registrar, so a tender committee can check the figures against the public record without asking the company for anything.</span></li>
                    <li><span class="al-t"><strong>Section 180, Companies Act 2013</strong></span><span class="al-d">restricts the board's borrowing beyond a stated threshold, which is relevant where a liability reduces the certified position and the recipient wants to know it was properly incurred.</span></li>
                    <li><span class="al-t"><strong>ICAI Guidance Note on Reports or Certificates for Special Purposes (Revised 2016)</strong></span><span class="al-d">governs the certificate itself, including how a modified auditor's report is disclosed where the accounts the figure came from carry one.</span></li>
                </ul>
...
<section id="faq-section" class="content-section" style="background-color:#ffffff;">
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    <h2 class="faq-expanded__title">Company Net Worth Certificate FAQs</h2>
  ...
  <h3 class="faq-expanded__q">Must a company's certificate be based on audited financial statements?</h3>
  <div class="faq-expanded__a"><p>Audited figures are the expected base, because every company incorporated under the Companies Act 2013 has its accounts audited annually. Where the certificate covers a date after the last audited balance sheet, the CA works from management accounts and says so on the face of the certificate. That most recipients accept if the gap is short.</p></div>
</div>
                    <div class="faq-expanded__item">
  <h3 class="faq-expanded__q">Can a company get a certificate mid-year before the annual accounts are finalised?</h3>
  <div class="faq-expanded__a"><p>Yes, and interim certificates are routine for tenders and loan sanctions falling due before the audit is signed. The CA works from the ledgers at the chosen date, verifies movements since the last audited balance sheet, and labels the figures unaudited. The certificate then states the date on which the position is drawn.</p></div>
</div>
                    <div class="faq-expanded__item">
  <h3 class="faq-expanded__q">Does share application money pending allotment count towards net worth?</h3>
  <div class="faq-expanded__a"><p>Not as paid-up capital. Section 2(57) of the Companies Act 2013 builds net worth from paid-up share capital, reserves created out of profits and securities premium. So money received but not yet allotted sits outside that definition until the shares are issued. It is disclosed separately so the reader can see it.</p></div>
</div>
                    <div class="faq-expanded__item">
  <h3 class="faq-expanded__q">Who signs the company's statement of affairs alongside the chartered accountant?</h3>
  <div class="faq-expanded__a"><p>A director signs the statement from which the CA certifies, and in most engagements the board authorises it by resolution. The CA's signature attests to the verification performed; the director's signature owns the completeness of the disclosure. Recipients generally want both, since a certificate with no company signatory has nothing behind it.</p></div>
</div>
                    <div class="faq-expanded__item">
  <h3 class="faq-expanded__q">Are amounts lent by directors to the company treated as liabilities?</h3>
  <div class="faq-expanded__a"><p>Yes. A director's loan is money owed by the company and is deducted like any other borrowing, whether or not it carries interest. Recipients often ask separately whether such loans are subordinated. A lender assessing the balance sheet treats a subordinated director loan differently from an amount repayable on demand.</p></div>
</div>
                    <div class="faq-expanded__item">
  <h3 class="faq-expanded__q">Do subsidiary figures get consolidated into the parent company's certificate?</h3>
  <div class="faq-expanded__a"><p>Only if the certificate says so. The default is standalone, where the parent's investment in the subsidiary appears at its carrying value rather than the subsidiary's underlying assets. Where a recipient wants group strength, a consolidated certificate is issued from consolidated financial statements and the basis is stated in the opening paragraph.</p></div>
</div>
                    <div class="faq-expanded__item">
  <h3 class="faq-expanded__q">Can a newly incorporated company obtain a certificate in its first year?</h3>
  <div class="faq-expanded__a"><p>Yes. A company that has not completed a financial year still has a verifiable position: subscribed capital actually received, bank balances, preliminary expenses and any assets acquired. The certificate is drawn as at a stated date from the books and bank evidence, and it notes that no audited accounts exist yet.</p></div>
</div>
                    <div class="faq-expanded__item">
  <h3 class="faq-expanded__q">Does foreign shareholding change how a company's net worth is certified?</h3>
  <div class="faq-expanded__a"><p>The arithmetic does not change, but the evidence widens. Share capital received from a non-resident is supported by the <a href="/glossary/networth/foreign-inward-remittance-certificate-firc">foreign inward remittance certificate</a> and the Form FC-GPR filed with the Reserve Bank. The CA checks that allotment happened within the prescribed period. Recipients abroad often ask for that trail explicitly.</p></div>
</div>
                    <div class="faq-expanded__item">
  <h3 class="faq-expanded__q">How is a section 8 company's net worth certified when it has no share capital?</h3>
  <div class="faq-expanded__a"><p>Through its reserves and corpus. A section 8 company limited by guarantee has no paid-up share capital, so the certificate reports accumulated surplus, corpus and earmarked funds, less liabilities. Grant-making bodies reading it usually want restricted and unrestricted funds separated, because only the unrestricted portion is genuinely free.</p></div>
</div>
                    <div class="faq-expanded__item">
  <h3 class="faq-expanded__q">Can a company under insolvency proceedings still obtain a certificate?</h3>
  <div class="faq-expanded__a"><p>It can, though the certificate has to disclose the proceedings. Once the corporate insolvency resolution process is admitted under the Insolvency and Bankruptcy Code 2016, the board stands suspended and the resolution professional runs the company. So the <a href="/glossary/networth/statement-of-affairs">statement of affairs</a> comes from the professional and claims admitted in the process are reflected as liabilities.</p></div>
</div>
                </div>
            </div>
        </div>
...
<p style="color:rgba(255,255,255,0.88);">A company&#x27;s figure is fixed by its audited accounts, so the decision in front of you is narrower than it looks. It is which set of accounts, and whether the recipient wants the standalone or the consolidated position. Those two answers shape everything that follows. If the accounts are signed and you know who is asking, send both across and we will confirm what the computation will show before you commit to anything.</p>
            ...
            <div style="display:flex;gap:14px;flex-wrap:wrap;margin-top:24px;">
                ...
                <a href="https://wa.me/919459456700?text=Hello%2C%20I%20just%20visited%20your%20a%20Net%20Worth%20Certificate%20for%20Company%20page.%20I%20would%20like%20to%20know%20more%20about%20it." target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:#25D366;color:#fff;border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;">&#128172; WhatsApp Us</a>
                <a href="mailto:sales@patronaccounting.com?subject=Enquiry%20for%20a%20Net%20Worth%20Certificate%20for%20Company&body=Hello%2C%20I%20just%20visited%20your%20a%20Net%20Worth%20Certificate%20for%20Company%20page.%20I%20would%20like%20to%20know%20more%20about%20it.%0A%0AThank%20you." style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:transparent;color:#fff;border:2px solid rgba(255,255,255,0.3);border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;">&#9993;&#65039; Email Us</a>
            </div>
...
<a href="https://www.patronaccounting.com/llp-incorporation" class="pa-cross-card"><div class="pa-card-title">LLP Incorporation</div></a></div>
            ...
            <div class="pa-city-block" style="margin-top:36px;">
                ...
                <ul class="pa-read-list">
                    <li><a href="/blog/director-fit-and-proper-net-worth-explained">Director Fit-and-Proper: Net Worth Requirements Explained</a></li>
                    <li><a href="/blog/negative-net-worth-what-it-means-for-a-company">Negative Net Worth: What It Means for a Company</a></li>
