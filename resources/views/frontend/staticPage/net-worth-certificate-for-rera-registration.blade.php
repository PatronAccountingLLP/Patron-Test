{{-- /net-worth-certificate-for-rera-registration
     Generated from Generated Pages/net-worth-certificate-for-rera-registration/net-worth-certificate-for-rera-registration.html by Scripts/build_blade.py.
     ...
     Before this goes live:
       - deploy public/images/networth-cluster/net-worth-certificate-for-rera-registration/** and public/certificates/**
...
@section('meta')
    <title>CA Certificate for RERA Promoter Net Worth in India</title>
    <meta name="description" content="State authorities test promoter net worth against estimated project cost. Get the computation and the CA certificate your RERA registration application needs.">
    <link rel="canonical" href="https://www.patronaccounting.com/net-worth-certificate-for-rera-registration">
    <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1">
    <meta property="og:title" content="Promoter Net Worth, Certified for RERA Filing">
    <meta property="og:description" content="MahaRERA, HRERA, GujRERA and Delhi RERA promoter certificates, computed and signed with a UDIN.">
    <meta property="og:url" content="https://www.patronaccounting.com/net-worth-certificate-for-rera-registration">
    <meta property="og:type" content="website">
    <meta property="og:site_name" content="Patron Accounting">
    <meta property="og:image" content="https://www.patronaccounting.com/images/networth-cluster/og/net-worth-certificate-for-rera-registration.jpg">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Promoter Net Worth, Certified for RERA Filing">
    <meta name="twitter:description" content="MahaRERA, HRERA, GujRERA and Delhi RERA promoter certificates, computed and signed with a UDIN.">
    <meta name="twitter:image" content="https://www.patronaccounting.com/images/networth-cluster/og/net-worth-certificate-for-rera-registration.jpg">
@endsection
    ...
    <script type="application/ld+json">
{
 ...
 "@graph": [
  {
   "@type": "Service",
   "@id": "https://www.patronaccounting.com/net-worth-certificate-for-rera-registration#service",
   "name": "CA Certificate for RERA Promoter Net Worth in India",
   "description": "State authorities test promoter net worth against estimated project cost. Get the computation and the CA certificate your RERA registration application needs.",
   "provider": {
  ...
  {
   "@type": "BreadcrumbList",
   "@id": "https://www.patronaccounting.com/net-worth-certificate-for-rera-registration#breadcrumb",
   "itemListElement": [
    {
     "@type": "ListItem",
     "position": 1,
    ...
    },
    {
     "@type": "ListItem",
     "position": 3,
     "name": "CA Certificate for RERA",
     "item": "https://www.patronaccounting.com/net-worth-certificate-for-rera-registration"
    }
   ]
  },
  {
   "@type": "FAQPage",
   "@id": "https://www.patronaccounting.com/net-worth-certificate-for-rera-registration#faq",
   "datePublished": "2026-07-30T10:00:00+05:30",
   "dateModified": "2026-08-05T10:00:00+05:30",
   "mainEntity": [
    {
     "@type": "Question",
     "name": "Which RERA form carries the chartered accountant's certificate?",
     "acceptedAnswer": {
      "@type": "Answer",
      "text": "It varies by state, because each authority notifies its own rules under the Real Estate (Regulation and Development) Act 2016. Maharashtra uses Form 3 for the chartered accountant's certificate on withdrawals from the designated account, while other states prescribe their own annexures at registration. The promoter checks the state authority's current format before filing."
     }
    },
    {
     "@type": "Question",
     "name": "Is the promoter's personal net worth certified or the company's?",
     "acceptedAnswer": {
      "@type": "Answer",
      "text": "The entity that is registering as promoter. Where a private limited company or an LLP is the promoter, its own position is certified. Where an individual or a proprietary concern promotes the project, the individual's is. Some authorities additionally ask for the directors' or partners' personal statements alongside the entity certificate."
     }
    },
    {
     "@type": "Question",
     "name": "Does the same chartered accountant have to certify the escrow withdrawals?",
     "acceptedAnswer": {
      "@type": "Answer",
      "text": "No, the engagements are separate and can be handled by different members. The registration-stage certificate reports financial standing; the withdrawal certificate confirms that money drawn from the designated account is proportionate to construction and land cost incurred. Continuity is convenient, because the second engagement builds on project records the first CA already examined."
     }
    },
    {
     "@type": "Question",
     "name": "How often is the withdrawal certificate issued during construction?",
     "acceptedAnswer": {
      "@type": "Answer",
      "text": "Each time the promoter draws from the designated account. Section 4(2)(l)(D) of the 2016 Act requires seventy per cent of realisations from allottees to be kept in a separate account. Withdrawals are permitted only in proportion to completion, certified by an engineer, an architect and a practising chartered accountant. There is no fixed calendar."
     }
    },
    {
     "@type": "Question",
     "name": "Does a joint development partner also need a certificate?",
     "acceptedAnswer": {
      "@type": "Answer",
      "text": "Where the landowner is treated as a co-promoter, yes. A joint development or area-sharing arrangement can make the landowner a promoter within the Act's definition, and authorities then expect their financial standing on record too. The development agreement is the document that settles which party carries promoter obligations."
     }
    },
    {
     "@type": "Question",
     "name": "Is a certificate needed for a project below the registration threshold?",
     "acceptedAnswer": {
      "@type": "Answer",
      "text": "Not for registration, because section 3(2) exempts projects where the land does not exceed five hundred square metres or the number of apartments does not exceed eight. Lenders funding such a project may still ask for one. The section reads \"or\", though some authorities apply both limbs together. State rules may also notify lower limits."
     }
    },
    {
     "@type": "Question",
     "name": "Does a real estate agent registration require a net worth certificate?",
     "acceptedAnswer": {
      "@type": "Answer",
      "text": "Agents register separately under section 9 and the requirement depends on the state's rules. That mostly ask for identity, address, PAN and past registration details rather than certified net worth. Some authorities do seek a financial statement. This is why the agent registration checklist is read on the state portal, not assumed from the central Act."
     }
    },
    {
     "@type": "Question",
     "name": "Must the certificate be uploaded to the state RERA portal?",
     "acceptedAnswer": {
      "@type": "Answer",
      "text": "Yes. Registration is an online filing, so the signed certificate is scanned and uploaded with the application. Withdrawal certificates are uploaded against quarterly project updates where the state requires them. The original is retained by the promoter, because the authority can call for it during scrutiny."
     }
    },
    {
     "@type": "Question",
     "name": "Is a fresh certificate needed when a project registration is extended?",
     "acceptedAnswer": {
      "@type": "Answer",
      "text": "Usually yes. Section 6 allows extension of registration on force majeure grounds, ordinarily for up to one year. The authority reassesses the promoter's capacity to complete before granting it. A current certificate is part of that reassessment, since the original was based on a position several years old by then."
     }
    },
    {
     "@type": "Question",
     "name": "What happens to the certificate if the project is transferred to another promoter?",
     "acceptedAnswer": {
      "@type": "Answer",
      "text": "The incoming promoter files its own. Section 15 permits transfer of a majority of rights and liabilities in a project only on two conditions. Two-thirds of allottees must consent in writing, and the authority must approve in advance. The new promoter's financial standing is examined at that point. The outgoing promoter's certificate does not carry over."
     }
    }
   ]
  },
  {
   "@type": "WebPage",
   "@id": "https://www.patronaccounting.com/net-worth-certificate-for-rera-registration#webpage",
   "url": "https://www.patronaccounting.com/net-worth-certificate-for-rera-registration",
   "name": "CA Certificate for RERA Promoter Net Worth in India",
   "description": "State authorities test promoter net worth against estimated project cost. Get the computation and the CA certificate your RERA registration application needs.",
   "isPartOf": {
        ...
        <div class="row align-items-center">
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-4 private-registration-heading">CA Certificate for RERA</h1>
                    ...
                    <div class="mb-4 hero-benefits">
                        <div class="hero-benefit"><span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span><p class="mb-0 text-dark benefit-paragraph"><span>Applying entity, not the group</span></p></div>
                        <div class="hero-benefit"><span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span><p class="mb-0 text-dark benefit-paragraph"><span>Drawn under the RERA Act 2016</span></p></div>
                        <div class="hero-benefit"><span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span><p class="mb-0 text-dark benefit-paragraph"><span>Papers kept, UDIN attached</span></p></div>
                        <div class="hero-benefit"><span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span><p class="mb-0 text-dark benefit-paragraph"><span>Position shown against project cost</span></p></div>
                    </div>
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="mailto:sales@patronaccounting.com?subject=Enquiry%20for%20a%20CA%20Certificate%20for%20RERA&body=Hello%20Patron%20Accounting%20Team%2C%0A%0AI%20need%20a%20ca%20certificate%20for%20rera%20and%20would%20like%20to%20know%20more.%0A%0AThank%20you." class="btn-sample text-decoration-none">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:18px;height:18px;"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,12 2,6"/></svg>
                            Email Us
                        </a>
                        <a href="https://wa.me/919459456700?text=Hi%20Patron%2C%20I%20need%20a%20ca%20certificate%20for%20rera" target="_blank" rel="noopener" class="btn-sample text-decoration-none">
...
<section class="testimonials-section">
  <div class="section-container">
    <div class="section-header">
      <h2>What Our RERA CA Certificate Clients Say</h2>
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                <div class="highlight-box" style="margin-bottom:20px;">
                    <p><strong>&#128204; TL;DR &mdash; CA Certificate for RERA at a Glance</strong></p>
                    <p>A CA certificate for RERA reports a promoter's net worth to the state authority, which weighs it against what the project is estimated to cost. The figure is traced to audited accounts and certified for the promoter entity named in the application. Formats differ between state authorities, so the certificate is drawn to the one your state publishes.</p>
                </div>
<p>A promoter reaches this requirement with the project already costed and the registration window open. The authority is not asking whether the promoter is wealthy. It is asking whether what stands behind the project is proportionate to what the project will cost to finish. That is a comparison, not a threshold, and it is why two promoters of the same size can get different answers.</p><p>The comparison decides the work. Estimated project cost is fixed first, and the certified position is read against it, so the useful question is which entity the authority will actually look at. A holding company's strength does not transfer automatically to the project SPV named in the application. State authorities publish their own formats and their own view of what counts. <a href="/blog/documents-required-for-net-worth-certificate">The supporting papers</a> are listed separately, alongside the Act on <a href="https://www.indiacode.nic.in" target="_blank" rel="noopener">India Code</a>.</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="content-container">
        <div class="two-column">
            <div class="column-content">
                <h2 class="section-title">What Is a CA Certificate for RERA Registration?</h2>
                <div class="content-text what-is-definition">
<p>A CA certificate for RERA registration attests the net worth of the promoter entity applying to register a project. It is issued in the form the relevant state authority prescribes.</p><p>It is one of several certificates RERA requires, and it is easily confused with the others. It is not the periodic certificate issued on withdrawals from the designated project account. It is not an estimate of project cost, which the promoter supplies separately. It attests the promoter's position as at the audited date, and asserts nothing about whether the project will be completed.</p>
                </div>
            </div>
            <div class="column-image"><img src="/images/networth-cluster/net-worth-certificate-for-rera-registration/what-is.webp" alt="The promoter entity net worth attested in the form the state authority prescribes for project registration" loading="lazy" width="1200" height="896" style="width:100%;height:auto;border-radius:var(--radius-xl);box-shadow:var(--shadow-md);"></div>
        </div>
    </div>
</section>
...
<section class="content-section specimen-section" id="specimen-section">
    ...
    <div class="text-content">
      <div class="specimen-item">
        <div class="specimen-caption"><div class="specimen-sticky">
          <h2 class="section-title">What a CA Certificate for RERA Looks Like: A Masked Specimen</h2>
          ...
          <div class="specimen-pane is-active" data-spec-pane="0">
            <h3>CA certificate for a RERA application</h3>
            <p>The sample attests the promoter entity named in the application, which is the entity the authority assesses even where a larger group stands behind it. It is drawn in the wording the state authority prescribes and traced to audited figures, with the balance sheet date on its face. It attests a position and asserts nothing about whether the project will be completed.</p>
            <a class="specimen-download" href="/certificates/10-ca-certificate-for-rera.pdf" download>Download this sample (PDF)</a>
          </div>
        ...
        <div class="specimen-stack" id="specimenStack">
          ...
          <div class="specimen-tabs" role="tablist" aria-label="Choose a sample">
            <button type="button" role="tab" class="specimen-tab is-active" data-spec-tab="0" aria-selected="true">CA certificate for a RERA application</button>
          </div>
          <div class="specimen-frame" id="specimenFrame" role="button" tabindex="0" aria-label="Enlarge this sample">
            <div class="specimen-doc is-active" data-spec-doc="0"><article class="nwc-spec" aria-label="CA Certificate for RERA - promoter net worth specimen, all values masked, not a valid certificate">
  <svg class="nwc-spec__mark" aria-hidden="true" focusable="false">
    <defs><pattern id="nwcwm-10" width="400" height="230"
      patternUnits="userSpaceOnUse">
      <text x="16" y="150" transform="rotate(-24 16 150)">Patron Accounting</text>
    </pattern></defs>
    <rect width="100%" height="100%" fill="url(#nwcwm-10)"/>
  </svg>
  ...
  <h3>Certificate of Net Worth of the Promoter</h3>
  <div class="nwc-spec__to"><b>To,</b><br>The Real Estate Regulatory Authority<br><span class="b">XXXXX XX XXXXXXXXXXX</span></div>
  <p>This is to certify that we have examined the audited financial statements, books of
  account and records produced before us of <span class="b">XXXXXXXX XXXXXXX XXXXXXX XXXXXXX</span>, the promoter, having its
  principal place of business at <span class="b">XXXX XXX, XXXXXXXX XX XXXX, XXXXXXX XXXXX, XXXX XXXXXX</span>, holding Permanent Account
  Number <span class="b">XXXXXXXXXX</span>, in connection with the proposed registration of the real estate project
  <span class="b">XXXXXXX XXXXXXX XXXXXX XXXXX</span> situated at <span class="b">XXXXXXX XXXXXX, XXXX XXXXXX</span>, as at <span class="b">XX XXXXX XXXX</span>.</p>
  <h4>Computation of Promoter Net Worth</h4>
  <table><caption class="nwc-spec__sr">Promoter net worth computation - all values masked</caption><thead><tr><th style="width:50px">Sr.</th><th>Particulars</th><th class="num">Amount (INR)</th></tr></thead><tbody>
    <tr class="sub"><td>A</td><td><b>Assets</b></td><td class="num"></td></tr>
    <tr><td>1</td><td>Paid-up share capital / partners' capital</td><td class="num"><span class="b b--n">X,XX,XX,XXX</span></td></tr>
    <tr><td>2</td><td>Free reserves and surplus</td><td class="num"><span class="b b--n">X,XX,XX,XXX</span></td></tr>
    <tr><td>3</td><td>Land and development rights held</td><td class="num"><span class="b b--n">X,XX,XX,XXX</span></td></tr>
    <tr><td>4</td><td>Work-in-progress on ongoing projects</td><td class="num"><span class="b b--n">X,XX,XX,XXX</span></td></tr>
    <tr><td>5</td><td>Bank balances and readily realisable investments</td><td class="num"><span class="b b--n">XX,XX,XXX</span></td></tr>
    <tr class="sub"><td></td><td><b>Total Assets (A)</b></td><td class="num"><b><span class="b b--n">X,XX,XX,XXX</span></b></td></tr>
    <tr class="sub"><td>B</td><td><b>Deductions</b></td><td class="num"></td></tr>
    <tr><td>6</td><td>Secured and unsecured borrowings</td><td class="num"><span class="b b--n">X,XX,XX,XXX</span></td></tr>
    <tr><td>7</td><td>Current liabilities and provisions</td><td class="num"><span class="b b--n">XX,XX,XXX</span></td></tr>
    <tr><td>8</td><td>Revaluation reserve, excluded</td><td class="num"><span class="b b--n">(XX,XX,XXX)</span></td></tr>
    <tr><td>9</td><td>Miscellaneous expenditure not written off</td><td class="num"><span class="b b--n">(XX,XX,XXX)</span></td></tr>
    <tr class="sub"><td></td><td><b>Total Deductions (B)</b></td><td class="num"><b><span class="b b--n">X,XX,XX,XXX</span></b></td></tr>
    <tr class="tot"><td></td><td><b>NET WORTH OF THE PROMOTER (A &minus; B)</b></td><td class="num"><b><span class="b b--n">X,XX,XX,XXX</span></b></td></tr>
  </tbody></table>
  <p>Reserves created out of revaluation of assets have been excluded from the computation
  above. The net worth stated is that of the promoter entity and does not include the personal
  assets of its directors, partners or designated partners.</p>
  <p>On the basis of our examination and the information and explanations given to us, we
  certify that the net worth of the promoter as at <span class="b">XX XXXXX XXXX</span> is <b>INR <span class="b">X,XX,XX,XXX</span></b>
  (Rupees <span class="b">XXX XXXXX XXXXX XXXX XXXX</span> only).</p>
  <p>This certificate is issued at the request of the promoter for the purpose of submission
  to the Real Estate Regulatory Authority in connection with the registration of the said
  project, and is not to be used, referred to or distributed for any other purpose or to any
  other party without our prior written consent.</p>
  <p>The preparation of the Statement is the responsibility of the promoter, including the completeness of the assets and liabilities disclosed. Our responsibility is to certify the Statement on the basis of the records produced before us.</p>
...
<section class="content-section" id="who-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Who Needs a CA Certificate for RERA in India</h2>
            <div class="why-patron-grid is-4">
                <div><strong>A Project Registration Is Being Assembled</strong><p>The application is being prepared and the authority's checklist names a promoter <a href="/net-worth-certificate">net worth certificate</a> in its own prescribed form. It is one of several certificates the filing requires.</p></div>
                <div><strong>The Project Cost Is Already Estimated</strong><p>The estimated cost is fixed, and the authority reads the promoter's position against it. That comparison, rather than any absolute threshold, decides whether the position is adequate.</p></div>
                <div><strong>The Promoter Is an SPV</strong><p>The applicant is a project entity and not the parent. The authority assesses the entity named in the application, so the parent's strength does not carry across on its own.</p></div>
                <div><strong>You Are Registering in a Second State</strong><p>A certificate drawn for one authority may not meet another's form or its view of what counts. Each state publishes its own requirement and expects that one to be followed to the letter.</p></div>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <table>
                    ...
                    <tbody>
                        <tr><td>Certificate in the authority's prescribed form</td><td>The certificate issued in the state RERA authority's own format, since one drawn to another state's form comes back unread; <a href="/net-worth-certificate-by-ca">the wider certificate directory</a> sets out the alternatives.</td><td><span class="badge-included">Per engagement</span></td></tr>
                        <tr><td>Promoter entity computation</td><td>The figure drawn from the applying entity's own <a href="/statutory-audit">audited accounts</a>, not its parent's, however strong the group standing behind it may be.</td><td><span class="badge-included">Annually, with the audited accounts</span></td></tr>
                        <tr><td>Project cost comparison statement</td><td>The certified position presented beside the estimated project cost, which is the comparison the authority is actually making.</td><td><span class="badge-included">Per engagement</span></td></tr>
                        <tr><td>Other-project commitment schedule</td><td>Every other project under way, with what has already been promised to each, since a sufficient position may be spoken for.</td><td><span class="badge-included">Per engagement</span></td></tr>
                        <tr><td>Related party exposure schedule</td><td>Investments in and loans to related entities set out, so the authority can see where money has moved before accepting the total.</td><td><span class="badge-included">Per engagement</span></td></tr>
                        <tr><td>Query response pack</td><td>The working papers behind every figure assembled together, so a question from the authority is answered from the file rather than re-derived.</td><td><span class="badge-included">Per engagement</span></td></tr>
                        <tr><td>Annual renewal certificate</td><td>A fresh certificate for each year's compliance, drawn from that year's audited accounts as the authority requires.</td><td><span class="badge-included">Annually</span></td></tr>
                    </tbody>
                </table>
                </div>
            </div>
...
<section class="steps-section" id="procedure-section">
    <div class="section-container">
        <header class="section-header" style="text-align:center;margin-bottom:48px;">
            ...
            <h2 class="section-title">How We Issue a CA Certificate for RERA, Step by Step</h2>
  ...
  <div class="step-content">
    ...
    <h3 class="step-title">Authority and form identified</h3>
    <p class="step-description">We establish which state authority the application goes to and which form it prescribes, because both the format and the view of what counts differ between them. A certificate drawn to another state's form is returned regardless of how sound the figures are.</p>
  </div>
  <div class="step-visual"><div class="step-illustration" style="padding:0;background:none;"><img src="/images/networth-cluster/net-worth-certificate-for-rera-registration/step-1-authority-and-form-identified.webp" alt="We establish which state authority the application goes to and which form it prescribes" loading="lazy" width="1200" height="896" style="width:100%;height:auto;border-radius:var(--radius-xl);"></div></div>
</div>
            <div class="step-card">
  <div class="step-content">
    <span class="step-badge">Step 2</span>
    <h3 class="step-title">Promoter entity fixed</h3>
    <p class="step-description">We confirm which entity the application names, since the authority assesses that entity and not its parent. Where a project SPV is the applicant, the certificate is drawn on the SPV's own accounts however strong the group behind it may be.</p>
  </div>
  <div class="step-visual"><div class="step-illustration" style="padding:0;background:none;"><img src="/images/networth-cluster/net-worth-certificate-for-rera-registration/step-2-promoter-entity-fixed.webp" alt="We confirm which entity the application names, since the authority assesses that entity and not its parent" loading="lazy" width="1200" height="896" style="width:100%;height:auto;border-radius:var(--radius-xl);"></div></div>
</div>
            <div class="step-card">
  <div class="step-content">
    <span class="step-badge">Step 3</span>
    <h3 class="step-title">Audited figures traced</h3>
    <p class="step-description">Every element of the computation is traced back to audited accounts and the balance sheet date is stated. Nothing is drawn from management figures, however recent those may be and however much closer they sit to the filing date.</p>
  </div>
  <div class="step-visual"><div class="step-illustration" style="padding:0;background:none;"><img src="/images/networth-cluster/net-worth-certificate-for-rera-registration/step-3-audited-figures-traced.webp" alt="Every element of the computation is traced back to audited accounts and the balance sheet date is stated" loading="lazy" width="1200" height="896" style="width:100%;height:auto;border-radius:var(--radius-xl);"></div></div>
</div>
            <div class="step-card">
  <div class="step-content">
    <span class="step-badge">Step 4</span>
    <h3 class="step-title">Position read against project cost</h3>
    <p class="step-description">The estimated project cost is taken as given and the certified position presented beside it, so the authority can weigh one against the other. That comparison, not any absolute threshold, is what the certificate exists to support.</p>
  </div>
  <div class="step-visual"><div class="step-illustration" style="padding:0;background:none;"><img src="/images/networth-cluster/net-worth-certificate-for-rera-registration/step-4-position-read-against-project-cost.webp" alt="The estimated project cost is taken as given and the certified position presented beside it" loading="lazy" width="1200" height="896" style="width:100%;height:auto;border-radius:var(--radius-xl);"></div></div>
</div>
            <div class="step-card">
  <div class="step-content">
    <span class="step-badge">Step 5</span>
    <h3 class="step-title">Management representation obtained</h3>
    <p class="step-description">The promoter confirms the completeness of what has been presented and signs a management representation. Where the promoter holds interests in other projects, those are disclosed rather than left for the authority to discover.</p>
  </div>
  <div class="step-visual"><div class="step-illustration" style="padding:0;background:none;"><img src="/images/networth-cluster/net-worth-certificate-for-rera-registration/step-5-management-representation-obtained.webp" alt="The promoter confirms the completeness of what has been presented and signs a management representation" loading="lazy" width="1200" height="896" style="width:100%;height:auto;border-radius:var(--radius-xl);"></div></div>
</div>
            <div class="step-card">
  <div class="step-content">
    <span class="step-badge">Step 6</span>
    <h3 class="step-title">Issued in the prescribed form</h3>
    <p class="step-description">The certificate is issued in the authority's own format, signed by a practising chartered accountant and carrying a <a href="/blog/how-to-verify-a-net-worth-certificate">UDIN</a>. It attaches to the registration application exactly as the state rules require, with nothing left for the authority to come back and ask for.</p>
  </div>
  <div class="step-visual"><div class="step-illustration" style="padding:0;background:none;"><img src="/images/networth-cluster/net-worth-certificate-for-rera-registration/step-6-issued-in-the-prescribed-form.webp" alt="The certificate is issued in the authority's own format, signed by a practising chartered accountant and carrying a UDIN" loading="lazy" width="1200" height="896" style="width:100%;height:auto;border-radius:var(--radius-xl);"></div></div>
</div>
        </div>
    </div>
</section>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <ul>
                    <li>The state authority's own prescribed certificate format</li>
                    <li><a href="/statutory-audit">Audited financial statements</a> of the promoter entity for the last three years</li>
                    <li>Constitution documents of the promoter entity, as the authority's form requires them</li>
                    <li>PAN of the promoter entity, and the CIN or LLPIN where one applies</li>
                    <li>Estimated cost of the project, with the break-up behind it</li>
                    <li>Title documents for the project land, with the <a href="/glossary/networth/encumbrance-certificate">encumbrance certificate</a></li>
                    <li>Details of other ongoing projects and the commitments already made to them</li>
                    <li>Schedule of the promoter's investments in and loans to related entities</li>
                </ul>
                <p><strong>Where they apply:</strong></p>
                <ul>
                    <li>Statements for the project bank account, where one has already been opened</li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <table>
                    ...
                    <tbody>
                        <tr><td>A form drawn for another state's authority</td><td>The Act is central but each state authority prescribes its own format, and a template found online belongs to whichever state published it.</td><td>The certificate is issued in the format the state authority actually prescribes; <a href="/net-worth-certificate-by-ca">the wider certificate directory</a> sets out the other certificate types.</td></tr>
                        <tr><td>The parent company's accounts used</td><td>Group strength is the real commercial position, and the applying entity often looks thin beside it.</td><td>Only the accounts of the entity actually applying are used, since that is who the authority holds answerable to home buyers.</td></tr>
                        <tr><td>The position given without the project cost beside it</td><td>The certificate answers what the promoter is worth, while the authority is weighing that against what the project will cost to build.</td><td>The cost estimate is accepted as supplied and shown beside the certified position, putting the comparison the authority makes on the page itself.</td></tr>
                        <tr><td>Commitments to other projects not shown</td><td>Each project is registered separately, so a promoter naturally thinks about them one at a time.</td><td>Ongoing projects and what has already been promised to each are scheduled, since a position sufficient in isolation may be spoken for.</td></tr>
                        <tr><td>Provisional accounts offered near a deadline</td><td>Registration is time-critical and the audit for the year may not be signed yet.</td><td>Audited accounts are used and their date stated; where only provisional figures exist, the certificate says so rather than implying otherwise.</td></tr>
                    </tbody>
                </table>
                </div>
            </div>
...
<section class="content-section" id="fees-section">
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <table>
                    ...
                    <tbody>
                        <tr><td><strong>Standard</strong> &mdash; One promoter entity with audited accounts signed, the state authority's format known and a single project.</td><td>Starting from INR 7999<br><span style="font-size:12px;color:var(--text-muted);">(Exl GST and Govt. Charges)</span></td></tr>
                        <tr><td><strong>Extended</strong> &mdash; Related-party exposure to schedule, several ongoing projects to reflect, or an authority query to answer from the working file.</td><td>On quote</td></tr>
                        <tr><td><strong>Multiple certificates</strong> &mdash; Certificates for more than one promoter entity, where a project is registered by a joint venture.</td><td>On quote</td></tr>
                    </tbody>
                </table>
                </div>
  ...
  <li>An On quote row means the scope decides the fee. It is not a higher tier waiting to be sold; some engagements simply cannot be priced before the records are seen.</li>
                ...
                <p style="margin-top:16px;"><strong>Get a free consultation &mdash; <a href="tel:+919459456700">Call +91 94594 56700</a> or <a href="https://wa.me/919459456700?text=Hi%20Patron%2C%20I%20need%20a%20ca%20certificate%20for%20rera" target="_blank" rel="noopener">WhatsApp us</a>.</strong></p>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section" id="timeline-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <h2 class="section-title">RERA Filing Dates Promoters Work To</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
<table class="nwc-timeline"><thead><tr><th>Obligation</th><th>Applies to</th><th>Due date</th></tr></thead><tbody>
  <tr><td>Net worth certificate supporting the registration application</td><td>A promoter applying to register a project</td><td>At application, and again where the state authority requires it annually</td></tr>
  <tr><td>Quarterly update of project details on the authority's web portal</td><td>Every promoter of a registered project</td><td>Quarterly, within the period the state's own rules prescribe after each quarter ends</td></tr>
  <tr><td>Audit of the project accounts by a practising chartered accountant</td><td>Every promoter of a registered project</td><td>Within six months of the end of each financial year, so by 30 September</td></tr>
  <tr><td>Certificate that amounts collected were applied to that project, and that withdrawals matched the stage of completion</td><td>Every promoter of a registered project</td><td>With the annual project audit</td></tr>
  <tr><td>Form 5, the annual chartered accountant's certificate, uploaded to the portal</td><td>Promoters registered with MahaRERA</td><td>30 September each year, for the financial year just ended</td></tr>
  <tr><td>Application to extend the registration of the project</td><td>A promoter unable to complete within the registered period</td><td>Before the registration expires; up to one year in aggregate</td></tr>
</tbody></table>
                </div>
<ul class="nwc-timeline-notes">
  <li>Rows marked as state requirements apply only in that state. The quarterly update is required everywhere, but the window for filing it after quarter end is set by each state's own rules.</li>
  <li>The 30 September date follows from the six-month period in the Act, so it moves only if the financial year does.</li>
</ul>
            </div>
        </div>
    </div>
...
<section class="why-choose-section" id="benefits-section">
    <div class="section-container">
        <div style="text-align:center;margin-bottom:48px;">
            ...
            <h2 class="section-title">Why a CA Certificate for RERA Matters</h2>
        </div>
...
<article class="feature-card">
  ...
  <h3 class="feature-title">An Incomplete Application Delays the Launch</h3>
  <p class="feature-text">A registration application without the certificate the authority prescribes is not assessed on its merits. A deficiency notice follows, the cure period runs, and a launch planned around the registration date moves with it.</p>
</article>
<article class="feature-card">
  ...
  <h3 class="feature-title">The Wrong Entity Certified Is Not Cured</h3>
  <p class="feature-text">Certifying a parent company where the authority asked for the project entity does not answer the question. The application is deficient until the entity named in it is the entity certified.</p>
</article>
<article class="feature-card">
  ...
  <h3 class="feature-title">A Format From Another State Is Rejected</h3>
  <p class="feature-text">State authorities prescribe their own forms and their own view of what counts. A certificate drawn for one regulator, submitted to another, is returned regardless of how sound the underlying figures are.</p>
</article>
        </div>
    </div>
</section>
...
<section class="content-section" id="why-patron-section" style="background: var(--cream) !important;">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Why Clients Choose Patron for RERA CA Certificates</h2>
            ...
            <div class="why-patron-grid">
                <div><strong>Applying entity, not the group</strong><p>The figure comes from the accounts of the entity the authority will hold answerable to home buyers, however much stronger the group standing behind it may look on paper.</p></div>
                <div><strong>Drawn under the RERA Act 2016</strong><p>Each state authority prescribes its own format under the Real Estate (Regulation and Development) Act 2016, and the certificate is issued in the one that actually applies.</p></div>
                <div><strong>Papers kept, UDIN attached</strong><p>Working papers behind every figure are kept together and the UDIN is checkable on the <a href="/blog/how-to-verify-a-net-worth-certificate">ICAI portal</a>, so an authority query is met from evidence rather than from memory.</p></div>
                <div><strong>Position shown against project cost</strong><p>The certified position sits next to what the project is expected to cost, since that pairing is what the authority weighs.</p></div>
                <div><strong>Promoter compliance, not only certificates</strong><p>A CA and CS team with 25,000+ filings completed, including promoter registration and annual returns, so project-account rules are routine rather than researched.</p></div>
            </div>
...
<section class="content-section" id="tool-section" style="background-color:var(--blue-lighter);">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Check Promoter Net Worth Against Your Project Cost</h2>
            <div class="content-text">
                <p>Enter the promoter entity's audited position and the estimated project cost. The calculator sets the two side by side, which is how a state authority reads a promoter net worth certificate when it decides whether the project is adequately backed.</p>
                ...
                <div class="nwt-wrap">
                    <div class="nwt-card">
                        <h3 class="nwt-title">Free tool: Promoter Net Worth Against Project Cost</h3>
                        ...
                        <div class="nwt-field nwt-compare">
                            <span class="nwt-label">Estimated project cost</span>
                        ...
                        <div class="nwt-cols nwt-cols--2">
                            <div class="nwt-col">
                                <h4>Promoter entity assets (from the audited accounts)</h4>
                                <div class="nwt-row"><label for="nwt-g0-0">Land and buildings</label><input class="nwt-input" type="text" id="nwt-g0-0" data-nwt="g0" data-name="Land and buildings" inputmode="decimal" autocomplete="off" placeholder="0"></div>
                                <div class="nwt-row"><label for="nwt-g0-1">Work in progress</label><input class="nwt-input" type="text" id="nwt-g0-1" data-nwt="g0" data-name="Work in progress" inputmode="decimal" autocomplete="off" placeholder="0"></div>
                                <div class="nwt-row"><label for="nwt-g0-2">Bank balances and deposits</label><input class="nwt-input" type="text" id="nwt-g0-2" data-nwt="g0" data-name="Bank balances and deposits" inputmode="decimal" autocomplete="off" placeholder="0"></div>
                                <div class="nwt-row"><label for="nwt-g0-3">Trade receivables</label><input class="nwt-input" type="text" id="nwt-g0-3" data-nwt="g0" data-name="Trade receivables" inputmode="decimal" autocomplete="off" placeholder="0"></div>
                                <div class="nwt-row"><label for="nwt-g0-4">Investments</label><input class="nwt-input" type="text" id="nwt-g0-4" data-nwt="g0" data-name="Investments" inputmode="decimal" autocomplete="off" placeholder="0"></div>
                                <div class="nwt-row"><label for="nwt-g0-5">Other assets</label><input class="nwt-input" type="text" id="nwt-g0-5" data-nwt="g0" data-name="Other assets" inputmode="decimal" autocomplete="off" placeholder="0"></div>
                            </div>
                            <div class="nwt-col">
                                <h4>Promoter entity liabilities</h4>
                                <div class="nwt-row"><label for="nwt-g1-0">Secured borrowings</label><input class="nwt-input" type="text" id="nwt-g1-0" data-nwt="g1" data-name="Secured borrowings" inputmode="decimal" autocomplete="off" placeholder="0"></div>
                                <div class="nwt-row"><label for="nwt-g1-1">Unsecured borrowings</label><input class="nwt-input" type="text" id="nwt-g1-1" data-nwt="g1" data-name="Unsecured borrowings" inputmode="decimal" autocomplete="off" placeholder="0"></div>
                                <div class="nwt-row"><label for="nwt-g1-2">Trade payables</label><input class="nwt-input" type="text" id="nwt-g1-2" data-nwt="g1" data-name="Trade payables" inputmode="decimal" autocomplete="off" placeholder="0"></div>
                        ...
                        <div class="nwt-result" id="nwtResult">
                            <div class="nwt-rgrid">
                                ...
                                <div class="nwt-rcard full"><div class="nwt-rlabel">Promoter net worth</div><div class="nwt-rval" id="nwtNet">&mdash;</div></div>
                            ...
                            <div class="nwt-actions">
                                <a href="https://wa.me/919459456700?text=Hi%20Patron%2C%20I%20need%20a%20ca%20certificate%20for%20rera" target="_blank" rel="noopener" class="nwt-abtn"><svg viewBox="0 0 24 24" fill="#25D366" aria-hidden="true"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347z"/></svg> Ask a CA</a>
                        ...
                        <p class="nwt-note">The two figures are set side by side and nothing more is inferred from them. Whether a project is adequately backed is decided by the state authority under its own rules, not by this arithmetic. An estimate carrying no UDIN.</p>
                    </div>
                </div>
                    ...
                    function calculate(){
                        ...
                        if($('nwtCmp')){
                            ...
                            if(isFinite(target) && target !== 0){
                                var diff = net - target;
                                $('nwtCmpLabel').textContent = diff >= 0 ? 'Promoter net worth stands above the estimated project cost by' : 'Promoter net worth stands below the estimated project cost by';
                                $('nwtCmp').textContent = money(Math.abs(diff));
                                rows += row('Estimated project cost', money(target));
                            } else {
                        ...
                        $('nwtBreak').innerHTML = rows
                            ? rows + row('<strong>Promoter net worth</strong>', '<strong>' + money(net) + '</strong>')
                            : '';
                        show();
                    }
...
<section class="content-section" id="legal-section">
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                <p>Here the requirement is statutory and specific. A promoter applying to register a real estate project must satisfy the authority about its own financial position, and the certificate exists to answer that. The Act is central but the format is not: each state authority prescribes its own.</p>
                <p>What follows from that is the constraint most applications fail on. The entity assessed is the one that applies, its position is read against the project cost, and the money collected from buyers is governed separately.</p>
                <ul class="al-list">
                    <li><span class="al-t"><strong>Section 4, Real Estate (Regulation and Development) Act 2016</strong></span><span class="al-d">requires the promoter to make an application containing prescribed particulars, which is where the net worth requirement sits and why the applying entity's own audited accounts are the only permissible source.</span></li>
                    <li><span class="al-t"><strong>Section 4(2)(l)(D), Real Estate (Regulation and Development) Act 2016</strong></span><span class="al-d">requires seventy per cent of the amounts realised from allottees to be kept in a separate account for the project, so the balance in it forms part of what is being certified.</span></li>
                    <li><span class="al-t"><strong>Section 129, Companies Act 2013</strong></span><span class="al-d">governs the audited financial statements the promoter's position is drawn from, and the date those accounts carry is stated on the certificate.</span></li>
                    <li><span class="al-t"><strong>Sections 137 and 92, Companies Act 2013</strong></span><span class="al-d">put the promoter's accounts and annual return on the public record, which is where the authority corroborates what the certificate asserts.</span></li>
                    <li><span class="al-t"><strong>Section 17, Registration Act 1908</strong></span><span class="al-d">makes the registered instrument the evidence of title for the project land, usually the promoter's largest asset and the one the authority scrutinises most closely.</span></li>
                    <li><span class="al-t"><strong>ICAI Guidance Note on Reports or Certificates for Special Purposes (Revised 2016)</strong></span><span class="al-d">governs the certificate itself, and requires any limitation to be stated where the authority's own format does not accommodate one.</span></li>
                </ul>
...
<section id="faq-section" class="content-section" style="background-color:#ffffff;">
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    <h2 class="faq-expanded__title">RERA CA Certificate FAQs</h2>
  ...
  <h3 class="faq-expanded__q">Which RERA form carries the chartered accountant's certificate?</h3>
  <div class="faq-expanded__a"><p>It varies by state, because each authority notifies its own rules under the Real Estate (Regulation and Development) Act 2016. Maharashtra uses Form 3 for the chartered accountant's certificate on withdrawals from the designated account, while other states prescribe their own annexures at registration. The promoter checks the state authority's current format before filing.</p></div>
</div>
                    <div class="faq-expanded__item">
  <h3 class="faq-expanded__q">Is the promoter's personal net worth certified or the company's?</h3>
  <div class="faq-expanded__a"><p>The entity that is registering as promoter. Where a <a href="/private-limited-company-registration">private limited company</a> or an LLP is the promoter, its own position is certified. Where an individual or a proprietary concern promotes the project, the individual's is. Some authorities additionally ask for the directors' or partners' personal statements alongside the entity certificate.</p></div>
</div>
                    <div class="faq-expanded__item">
  <h3 class="faq-expanded__q">Does the same chartered accountant have to certify the escrow withdrawals?</h3>
  <div class="faq-expanded__a"><p>No, the engagements are separate and can be handled by different members. The registration-stage certificate reports financial standing; the withdrawal certificate confirms that money drawn from the designated account is proportionate to construction and land cost incurred. Continuity is convenient, because the second engagement builds on project records the first CA already examined.</p></div>
</div>
                    <div class="faq-expanded__item">
  <h3 class="faq-expanded__q">How often is the withdrawal certificate issued during construction?</h3>
  <div class="faq-expanded__a"><p>Each time the promoter draws from the designated account. Section 4(2)(l)(D) of the 2016 Act requires seventy per cent of realisations from allottees to be kept in a separate account. Withdrawals are permitted only in proportion to completion, certified by an engineer, an architect and a practising chartered accountant. There is no fixed calendar.</p></div>
</div>
                    <div class="faq-expanded__item">
  <h3 class="faq-expanded__q">Does a joint development partner also need a certificate?</h3>
  <div class="faq-expanded__a"><p>Where the landowner is treated as a co-promoter, yes. A joint development or area-sharing arrangement can make the landowner a promoter within the Act's definition, and authorities then expect their financial standing on record too. The development agreement is the document that settles which party carries promoter obligations.</p></div>
</div>
                    <div class="faq-expanded__item">
  <h3 class="faq-expanded__q">Is a certificate needed for a project below the registration threshold?</h3>
  <div class="faq-expanded__a"><p>Not for registration, because section 3(2) exempts projects where the land does not exceed five hundred square metres or the number of apartments does not exceed eight. Lenders funding such a project may still ask for one. The section reads "or", though some authorities apply both limbs together. State rules may also notify lower limits.</p></div>
</div>
                    <div class="faq-expanded__item">
  <h3 class="faq-expanded__q">Does a real estate agent registration require a net worth certificate?</h3>
  <div class="faq-expanded__a"><p>Agents register separately under section 9 and the requirement depends on the state's rules. That mostly ask for identity, address, PAN and past registration details rather than <a href="/net-worth-certificate">certified net worth</a>. Some authorities do seek a financial statement. This is why the agent registration checklist is read on the state portal, not assumed from the central Act.</p></div>
</div>
                    <div class="faq-expanded__item">
  <h3 class="faq-expanded__q">Must the certificate be uploaded to the state RERA portal?</h3>
  <div class="faq-expanded__a"><p>Yes. Registration is an online filing, so the signed certificate is scanned and uploaded with the application. Withdrawal certificates are uploaded against quarterly project updates where the state requires them. The original is retained by the promoter, because the authority can call for it during scrutiny.</p></div>
</div>
                    <div class="faq-expanded__item">
  <h3 class="faq-expanded__q">Is a fresh certificate needed when a project registration is extended?</h3>
  <div class="faq-expanded__a"><p>Usually yes. Section 6 allows extension of registration on force majeure grounds, ordinarily for up to one year. The authority reassesses the promoter's capacity to complete before granting it. A current certificate is part of that reassessment, since the original was based on a position several years old by then.</p></div>
</div>
                    <div class="faq-expanded__item">
  <h3 class="faq-expanded__q">What happens to the certificate if the project is transferred to another promoter?</h3>
  <div class="faq-expanded__a"><p>The incoming promoter files its own. Section 15 permits transfer of a majority of rights and liabilities in a project only on two conditions. Two-thirds of allottees must consent in writing, and the authority must approve in advance. The new promoter's financial standing is examined at that point. The outgoing promoter's certificate does not carry over.</p></div>
</div>
                </div>
            </div>
        </div>
...
<section class="content-section" style="background: var(--orange-lighter) !important; border-left: 4px solid var(--orange);">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">RERA CA Certificate Deadlines That Cannot Slip</h2>
            <div class="content-text">
<p>Two dates here are genuinely statutory rather than commercial. Project accounts must be audited within six months of the financial year end, and an extension of registration has to be applied for before the current one expires. Neither moves for a promoter&#x27;s convenience. Call or WhatsApp <a href="tel:+919459456700">+91 94594 56700</a> well ahead of either.</p>
            </div>
        </div>
    </div>
</section>
...
<p style="color:rgba(255,255,255,0.88);">Registration turns on the applying entity&#x27;s own audited position, read beside the estimated cost of the project itself. Neither the strength of the group behind it nor a template written for another state will carry the application. Confirm which authority you are filing with and which format it prescribes, then send the promoter&#x27;s audited accounts and the cost estimate. We will draw the certificate to that authority&#x27;s own form.</p>
            </div>
            <div style="display:flex;gap:14px;flex-wrap:wrap;margin-top:24px;">
                ...
                <a href="https://wa.me/919459456700?text=Hi%20Patron%2C%20I%20need%20a%20ca%20certificate%20for%20rera" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:#25D366;color:#fff;border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;">&#128172; WhatsApp Us</a>
                <a href="mailto:sales@patronaccounting.com?subject=Enquiry%20for%20a%20CA%20Certificate%20for%20RERA&body=Hello%20Patron%20Accounting%20Team%2C%0A%0AI%20need%20a%20ca%20certificate%20for%20rera%20and%20would%20like%20to%20know%20more.%0A%0AThank%20you." style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:transparent;color:#fff;border:2px solid rgba(255,255,255,0.3);border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;">&#9993;&#65039; Email Us</a>
            </div>
...
<a href="https://www.patronaccounting.com/llp-incorporation" class="pa-cross-card"><div class="pa-card-title">LLP Incorporation</div></a></div>
            ...
            <div class="pa-city-block" style="margin-top:36px;">
                ...
                <ul class="pa-read-list">
                    ...
                    <li><a href="/blog/rera-promoter-net-worth-explained">RERA Promoter Net Worth, Explained</a></li>
                    <li><a href="/blog/when-promoter-net-worth-falls-short">When Promoter Net Worth Falls Short: Options Before Filing</a></li>
                </ul>
            </div>
        </div>
    </div>
