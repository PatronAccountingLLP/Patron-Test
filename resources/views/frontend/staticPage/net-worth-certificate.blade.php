...
@section('meta')
    ...
    <meta property="og:image" content="https://www.patronaccounting.com/images/networth-cluster/og/net-worth-certificate.jpg">
    ...
    <meta name="twitter:image" content="https://www.patronaccounting.com/images/networth-cluster/og/net-worth-certificate.jpg">
@endsection
...
<nav aria-label="Breadcrumb" style="background:var(--gray-50);border-bottom:1px solid var(--gray-200);padding:10px 16px;">
    <div style="max-width:1320px;margin:0 auto;">
        <ol style="display:flex;align-items:center;gap:8px;list-style:none;padding:0;margin:0;font-size:13px;font-family:'Barlow',sans-serif;flex-wrap:wrap;">
            ...
            <li><span style="color:var(--orange);font-weight:600;">Net Worth Certificate</span></li>
        </ol>
    </div>
</nav>
