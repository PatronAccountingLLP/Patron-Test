        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'payroll-processing-for-the-healthcare-industry',
                    'options'  => [
                        'payroll-processing-for-the-healthcare-industry' => 'Healthcare Payroll',
                        'payroll-services' => 'Payroll Services (Overview)',
                        'healthcare-sector-accounting-services' => 'Healthcare Accounting',
                        ...
                        'gratuity-calculation-and-compliance-services' => 'Gratuity Compliance',
                        'other' => 'Other',
                    ],
                ])
            </div>
