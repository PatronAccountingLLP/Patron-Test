            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="https://wa.me/919459456700?text=Hello%2C%20I%20just%20visited%20your%20Payroll%20Services%20for%20Construction%20page.%20I%20would%20like%20to%20know%20more%20about%20it." target="_blank" class="btn-sample text-decoration-none" rel="noopener">
...
@include('partials.testimonials', [
    ...
    'ctaText'    => 'Talk to a Patron CA team specialising in construction payroll - BoCW cess, ISMW Act, CLRA reconciliation and project-wise EPC allocation.',
])
...
<ul>
    ...
    <li><strong><a href="/gst-audit">GST Audit Service</a>:</strong> Section 35(5) CGST audit for construction contractors; works-contract ITC reconciliation under Section 17(5) and Rule 42 / 43.</li>
...
<p style="color:#fff;margin-top:12px;">The engagement includes project-wise wage allocation, BoCW Form I cess filing per phase, ISMW Act per-site applicability with allowance and register handling, CLRA quarterly contractor reconciliation, Code on Wages Section 17 site SLAs, and Section 194C sub-contractor batch. Multi-state GST returns, statutory audit and ROC compliance cross-sell deliver a single point of accountability across the full construction company compliance perimeter.</p>
            ...
            <div style="display:flex;gap:14px;flex-wrap:wrap;margin-top:24px;">
                ...
                <a href="https://wa.me/919459456700?text=Hello%2C%20I%20just%20visited%20your%20Payroll%20Services%20for%20Construction%20page.%20I%20would%20like%20to%20know%20more%20about%20it." target="_blank" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:#25D366;color:#fff;border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;" rel="noopener">&#128172; WhatsApp Us</a>
...
<div class="pa-city-block">
    ...
    <div class="pa-cross-grid">
        ...
        <a href="/gst-audit" class="pa-cross-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><circle cx="11" cy="11" r="8"/><path d="M21 21l-4.35-4.35"/></svg></div><div><div class="pa-card-title">GST Audit Service</div><div class="pa-card-sub">India</div></div></a>
