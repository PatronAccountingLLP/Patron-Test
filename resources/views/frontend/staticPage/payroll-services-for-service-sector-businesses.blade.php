      ...
      "@graph": [
        {
          ...
          "url": "/payroll-services-for-service-sector-businesses",
        ...
        },
        {
          ...
          "itemListElement": [
            ...
            },
            {
              ...
              "position": 2,
              "name": "Payroll for Service Sector Companies",
              "item": "/payroll-services-for-service-sector-businesses"
            }
          ]
        },
        {
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'payroll-services-for-service-sector-businesses',
                    'options'  => [
                        'payroll-services-for-service-sector-businesses' => 'Service Sector Payroll',
                        'payroll-services' => 'Payroll Services (Overview)',
                        'payroll-services-for-the-hospitality-industry' => 'Hospitality Payroll',
                        'payroll-processing-and-management-services' => 'Payroll Processing and Management',
...
<section class="content-section" style="padding:48px 32px;background:var(--gray-50);">
    ...
    <div class="pa-city-grid">
        ...
        <a href="/payroll-service-sector/mumbai" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Mumbai</div><div class="pa-card-sub">Maharashtra</div></div></a>
        <a href="/payroll-services-for-service-sector/delhi" class="pa-city-card"><div class="pa-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2" style="width:16px;height:16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div><div class="pa-card-title">Delhi</div><div class="pa-card-sub">NCR</div></div></a>
