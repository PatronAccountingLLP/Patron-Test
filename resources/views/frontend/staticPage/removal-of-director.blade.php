...
@section('meta')
    ...
    <meta property="og:image" content="/images/removal-of-director-og.webp">
    ...
    <meta name="twitter:image" content="/images/removal-of-director-og.webp">
@endsection
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - Removal of Director'/>
                        ...
                        <div class="form-group">
                            ...
                            <select name='Contacts.Description' id='consultService' class='form-select' onchange='clearFieldError(this)'>
                                ...
                                <option value="removal-of-director" selected>Removal of Director</option><option value="resignation-of-director">Resignation of Director</option><option value="appointment-of-director">Appointment of Director</option><option value="director-kyc">Director KYC</option><option value="private-limited-company-compliance">Pvt Ltd Compliance</option><option value="other">Other</option>
