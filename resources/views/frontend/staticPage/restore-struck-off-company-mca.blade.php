        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'restore-struck-off-company-mca',
                    'options'  => [
                        'restore-struck-off-company-mca' => 'NCLT Restoration Section 252 (this page)',
                        'company-closure' => 'Voluntary Closure (STK-2)',
                        'llp-strike-off-form-24' => 'LLP Strike-Off Form 24',
                        'private-limited-company-annual-compliance' => 'Pvt Ltd Annual Compliance',
                        'backlog-filings-3-year-cleanup' => 'Backlog Cleanup CCFS-2026',
                        'director-kyc' => 'DIR-3 KYC + DIR-10',
