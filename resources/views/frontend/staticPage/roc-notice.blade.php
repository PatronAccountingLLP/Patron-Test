...
@section('meta')
    ...
    <meta property="og:image" content="/images/roc-notice-og.webp">
    ...
    <meta name="twitter:image" content="/images/roc-notice-og.webp">
@endsection
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="https://wa.me/919459456700?text=Hi%2C%20I%20received%20a%20ROC%20Notice.%20Please%20help%20me%20reply." target="_blank" class="btn-sample text-decoration-none">
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <iframe name='hidden208810000001209168Frame' id='hidden208810000001209168Frame' style='display:none;' src='about:blank'></iframe>
                        ...
                        'deal' => 'Website Enquiry - ROC Notice',
                        'options' => [
                            ['value' => '', 'label' => 'Select a service', 'selected' => true, 'disabled' => true],
                            ['value' => 'roc-notice', 'label' => 'ROC Notice', 'selected' => true, 'disabled' => false],
                            ['value' => 'roc-annual-filing', 'label' => 'ROC Annual Filing', 'selected' => false, 'disabled' => false],
...
<tr><td>NCLT Restoration (Section 252)</td><td class="table-amount">Rs 24,999</td></tr>
                ...
                <p style="margin-top:16px;"><strong>Get a free ROC Notice consultation - <a href="tel:+919459456700">Call +91 945 945 6700</a> or <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20help%20with%20a%20ROC%20Notice.%20Please%20call%20me." target="_blank">WhatsApp us</a>. No-obligation assessment.</strong></p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="text-content">
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    ...
                    @include('partials.faq-enquiry-form', ['enquiryService' => 'ROC Notice'])
                </aside>
