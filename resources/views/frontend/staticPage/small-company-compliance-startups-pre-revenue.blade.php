        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'small-company-compliance-startups-pre-revenue',
                    'options'  => [
                        'small-company-compliance-startups-pre-revenue' => 'Pre-Revenue Startup Compliance (this page)',
                        'startup-registration' => 'Startup Registration (Predecessor)',
                        'private-limited-company-annual-compliance' => 'Pvt Ltd Annual Compliance (Graduation)',
                        'small-company-compliance-dormant' => 'Dormant Company Section 455',
                        'strike-off-private-limited-company' => 'Strike Off Pvt Ltd (STK-2)',
                        'condonation-of-delay-roc-filings' => 'Condonation of Delay (Recovery)',
                        'small-company-annual-compliance' => 'Small Company Compliance',
                        'other' => 'Other',
                    ],
                ])
            </div>
