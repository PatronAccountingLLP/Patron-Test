        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'standards-on-auditing',
                    'options'  => [
                        'standards-on-auditing' => 'Standards on Auditing (SAs)',
                        'statutory-audit' => 'Statutory Audit',
                        'statutory-audit-for-listed-companies' => 'Statutory Audit (Listed Companies)',
                        'statutory-audit-private-limited-company' => 'Statutory Audit (Pvt Ltd)',
                        'statutory-audit-llp' => 'Statutory Audit (LLP)',
