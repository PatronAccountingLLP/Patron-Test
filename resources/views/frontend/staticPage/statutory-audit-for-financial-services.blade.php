        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'statutory-audit-for-financial-services',
                    'options'  => [
                        'statutory-audit-for-financial-services' => 'Statutory Audit (Financial Services)',
                        'statutory-audit' => 'Statutory Audit (Hub)',
                        'tax-audit' => 'Tax Audit (Section 44AB)',
                        'internal-audit' => 'Internal Audit (RBI RBIA)',
                        'nbfc-registration' => 'NBFC Registration',
                        'aif-registration' => 'AIF Registration',
                        'gst-audit' => 'GST Audit',
