        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'Statutory Audit - Healthcare',
                    'options'  => [
                        'Statutory Audit - Healthcare' => 'Statutory Audit - Healthcare',
                        'Pharma SA 501 Inventory' => 'Pharma SA 501 Inventory Audit',
                        'Hospital TPA Receivables' => 'Hospital TPA Receivables Audit',
                        'Clinical Trial Revenue' => 'Clinical Trial Revenue / Grants',
                        'Section 35(2AB) Form 3CLA' => 'Section 35(2AB) Form 3CLA',
                        'DPCO / Drug Licence' => 'DPCO / Drug Licence Compliance',
                        'Tax Audit' => 'Tax Audit (Section 44AB)',
                        'Cost Records (Sec 148)' => 'Cost Records (Sec 148)',
                        'Other' => 'Other',
                    ],
                ])
            </div>
