        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'statutory-audit-for-retail-companies',
                    'options'  => [
                        'statutory-audit-for-retail-companies' => 'Statutory Audit for Retail Companies',
                        'statutory-audit' => 'Statutory Audit (India)',
                        'tax-audit' => 'Tax Audit (Section 44AB)',
                        'internal-audit' => 'Internal Audit',
                        'stock-audit' => 'Stock Audit',
                        'gst-audit' => 'GST Audit',
                        'accounting-services-for-trading-industry' => 'Trading Accounting Services',
                        'accounting-services-for-e-commerce-industry' => 'E-Commerce Accounting Services',
                        'other' => 'Other',
                    ],
                ])
            </div>
