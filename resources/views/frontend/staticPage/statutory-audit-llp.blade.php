        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'statutory-audit-llp',
                    'options'  => [
                        'statutory-audit-llp' => 'LLP Statutory Audit (Section 34(4))',
                        'statutory-audit-services' => 'Statutory Audit Services (National Hub)',
                        'statutory-audit-private-limited-company' => 'Pvt Ltd Statutory Audit (Section 139)',
                        'llp-incorporation' => 'LLP Incorporation',
                        'pvt-llp-compliance' => 'Pvt and LLP Compliance Retainer',
                        'llp-strike-off-form-24' => 'LLP Strike-Off (Form 24)',
                        'convert-partnership-to-llp' => 'Convert Partnership to LLP',
                        'tax-audit' => 'Section 44AB Tax Audit',
                        'other' => 'Other',
                    ],
                ])
            </div>
