            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    @include('partials.lead-form', [
                        'deal'    => 'Website Enquiry - Stock Audit for Auto Components',
                        'options' => [
                            ...
                            ['value' => 'Stock Audit for Auto Components', 'label' => 'Stock Audit for Auto Components', 'selected' => true, 'disabled' => false],
