...
<title>Stock Audit for Dark Stores: Micro-Fulfilment Counts | Patron Accounting</title>
    ...
    <meta property="og:title" content="Stock Audit for Dark Stores: Micro-Fulfilment Counts | Patron Accounting">
    <meta property="og:description" content="Dark stores and micro-fulfilment centres are audited without pausing fulfilment. Cycle counts measure pick accuracy, damages, returns and genuine shrinkage.">
    <meta property="og:url" content="https://www.patronaccounting.com/stock-audit-for-dark-stores">
    <meta property="og:type" content="website">
    <meta property="og:site_name" content="Patron Accounting">
    <meta property="og:image" content="https://www.patronaccounting.com/images/stock-audit-for-dark-stores-og.webp">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Stock Audit for Dark Stores: Micro-Fulfilment Counts | Patron Accounting">
    <meta name="twitter:description" content="Dark stores and micro-fulfilment centres are audited without pausing fulfilment. Cycle counts measure pick accuracy, damages, returns and genuine shrinkage.">
    <meta name="twitter:image" content="https://www.patronaccounting.com/images/stock-audit-for-dark-stores-og.webp">
...
<script type="application/ld+json">
    {
        ...
        "@type": "Service",
        "@id": "https://www.patronaccounting.com/stock-audit-for-dark-stores/#service",
        "name": "Stock Audit for Dark Stores in India",
        "description": "Dark stores and micro-fulfilment centres are audited without pausing fulfilment. Cycle counts measure pick accuracy, damages, returns and genuine shrinkage.",
        "provider": { "@id": "https://www.patronaccounting.com/#organization" },
        "mainEntityOfPage": { "@type": "WebPage", "@id": "https://www.patronaccounting.com/stock-audit-for-dark-stores" },
        "areaServed": { "@type": "Country", "name": "India", "sameAs": "https://en.wikipedia.org/wiki/India" },
        "about": [{ "@type": "Thing", "name": "Stock Audit for Dark Stores", "sameAs": "" }],
        "hasOfferCatalog": {
            "@type": "OfferCatalog",
            "name": "Stock Audit for Dark Stores Service Plans",
            "itemListElement": [
                {"@type": "Offer", "itemOffered": {"@type": "Service", "name": "Site-Level Accuracy Score", "description": "One comparable measure for each quick commerce site, computed identically everywhere, so a single location can be read against the network rather than in isolation."}},
{"@type": "Offer", "itemOffered": {"@type": "Service", "name": "Pick Face Accuracy Against the Order Line Extract", "description": "Each picked unit is set against the order it was drawn for, so a substitution at the shelf is separated from a genuine shortage in the holding."}},
{"@type": "Offer", "itemOffered": {"@type": "Service", "name": "Network Comparison Across Every Site", "description": "The distribution across the whole quick commerce india network with outliers identified, and whether the same sites keep appearing as outliers cycle after cycle."}}
            ]
        }
    }
    </script><script type="application/ld+json">
{
    "@context": "https://schema.org",
    "@type": "BreadcrumbList",
    "@id": "https://www.patronaccounting.com/stock-audit-for-dark-stores/#breadcrumb",
    "itemListElement": [
        {
            "@type": "ListItem",
            "position": 1,
        ...
        },
        {
            ...
            "position": 4,
            "name": "Dark Stores",
            "item": "https://www.patronaccounting.com/stock-audit-for-dark-stores"
        }
    ]
}
</script><script type="application/ld+json">
    {
        "@context": "https://schema.org",
        "@type": "FAQPage",
        "@id": "https://www.patronaccounting.com/stock-audit-for-dark-stores/#faq",
        "datePublished": "2026-08-20T08:00:00+05:30",
        "dateModified": "2026-08-20T08:00:00+05:30",
        "mainEntity": [
            {"@type": "Question", "name": "How is a dark store stock audit different from a retail count?", "acceptedAnswer": {"@type": "Answer", "text": "A dark store has no customers, runs on very fast pick cycles, and holds a narrow high-rotation range. The count must happen without pausing fulfilment, so cycle counting by zone replaces the full shutdown count used in conventional retail."}},
{"@type": "Question", "name": "Why does dark store stock drift so quickly?", "acceptedAnswer": {"@type": "Answer", "text": "Drift comes from picking errors, customer returns re-entering stock, damages during rapid handling, and substitutions made at the pick face. Because order volume is high and cycle times are short, a small per-order error rate compounds into a visible variance within days."}},
{"@type": "Question", "name": "Can you count a dark store without stopping deliveries?", "acceptedAnswer": {"@type": "Answer", "text": "Yes, by counting zone by zone during low-demand windows and freezing only the zone being counted rather than the whole site. The system must be able to segregate movements during that freeze, because picks made mid-count against an unfrozen zone will corrupt the result."}},
{"@type": "Question", "name": "What is pick accuracy and why is it audited?", "acceptedAnswer": {"@type": "Answer", "text": "Pick accuracy measures how often the correct item and quantity were picked. It is the leading indicator of stock variance: falling pick accuracy predicts a widening gap between system and physical stock before the count itself reveals it."}},
{"@type": "Question", "name": "How is shrinkage measured across many micro-fulfilment sites?", "acceptedAnswer": {"@type": "Answer", "text": "Shrinkage is measured per site and normalised against throughput, not just absolute value, so a high-volume store is not unfairly compared with a small one. Reporting by site and by category exposes whether loss is concentrated in specific products or specific locations."}},
{"@type": "Question", "name": "What is a micro-fulfilment centre?", "acceptedAnswer": {"@type": "Answer", "text": "A micro-fulfilment centre is a small urban facility holding a limited high-rotation range for rapid local delivery. It is the unit an audit is scoped around in quick commerce, because each site behaves like a separate stock location with its own variance profile."}},
{"@type": "Question", "name": "How are customer returns handled in a dark store count?", "acceptedAnswer": {"@type": "Answer", "text": "Returns must be segregated until they are inspected and either restocked or written off. Counting them with saleable stock overstates availability. The audit checks whether the return-to-stock decision is being made and recorded, or whether returns are simply flowing back onto the pick face."}},
{"@type": "Question", "name": "What is order fill rate and how does it relate to stock accuracy?", "acceptedAnswer": {"@type": "Answer", "text": "Fill rate measures the proportion of orders fulfilled complete. Persistent short-fills on items the system shows as available is the clearest operational signal of phantom stock, and often surfaces before a scheduled count would find it."}},
{"@type": "Question", "name": "How often should a dark store be counted?", "acceptedAnswer": {"@type": "Answer", "text": "Because stock turns quickly, most operators cycle count continuously rather than counting everything periodically, covering the full range over a short cycle and counting the fastest-moving lines most often. A quarterly full count alone is too slow for this format."}},
{"@type": "Question", "name": "Are dark store audits useful for quick commerce franchise operators?", "acceptedAnswer": {"@type": "Answer", "text": "Yes, but the purpose differs. A franchisee wants assurance that stock losses are within agreed limits and that reconciliations with the brand are accurate. The scope is the same count; the reporting is oriented to the contract between franchisee and brand."}}
        ]
    }
    </script><script type="application/ld+json">
    {
        "@context": "https://schema.org",
        "@type": "WebPage",
        "@id": "https://www.patronaccounting.com/stock-audit-for-dark-stores",
        "name": "Stock Audit for Dark Stores in India",
        "description": "Dark stores and micro-fulfilment centres are audited without pausing fulfilment. Cycle counts measure pick accuracy, damages, returns and genuine shrinkage.",
        "url": "https://www.patronaccounting.com/stock-audit-for-dark-stores",
        "inLanguage": "en-IN",
        "isPartOf": { "@id": "https://www.patronaccounting.com" },
        "about": { "@id": "https://www.patronaccounting.com/stock-audit-for-dark-stores/#service" },
        "datePublished": "2026-08-20T08:00:00+05:30",
        "dateModified": "2026-08-20T08:00:00+05:30",
        "author": { "@id": "https://www.patronaccounting.com/#team" },
        "breadcrumb": { "@id": "https://www.patronaccounting.com/stock-audit-for-dark-stores/#breadcrumb" }
    }
    </script><script type="application/ld+json">
    {
        "@context": "https://schema.org",
...
<li><span style="color:var(--orange);font-weight:600;">Dark Stores</span></li>
</ol>
    </div>
</nav>
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-4 private-registration-heading">
                        Stock Audit for Dark Stores in India
                    </h1>
                    ...
                    <div class="mb-4">
                        <div class="d-flex align-items-start mb-3">
                            ...
                            <p class="mb-0 text-dark benefit-paragraph"><span>Which Sites Lose Stock and Which Lose Discipline:</span> The count separates sites with a genuine shrinkage problem from sites whose records simply lag the floor, and those two are fixed in entirely different ways.</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Fill Rate Explained by Something Other Than Demand:</span> Where a site reports high fill while quietly substituting, the count against the order line extract shows it, which no demand report ever will.</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Perishable Losses Separated From Picking Losses:</span> Expiry, damage and mis-pick quantified apart from one another, so a quick commerce india network knows whether it has a rotation problem or a picking problem.</p>
                        </div>
                        </div>

                    <p class="mb-4 fw-bold" style="color: var(--blue); font-size: 15px;">Micro-fulfilment sites counted fast, between waves.</p>
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="mailto:sales@patronaccounting.com?subject=Enquiry%20for%20Stock Audit for Dark Stores%20Services&body=Hello%20Patron%20Accounting%20Team%2C%0A%0AI%20am%20interested%20in%20your%20Stock Audit for Dark Stores%20services%20and%20would%20like%20to%20know%20more.%0A%0APlease%20get%20in%20touch%20with%20me%20at%20your%20earliest%20convenience.%0A%0AThank%20you." class="btn-sample text-decoration-none">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:18px;height:18px;"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,12 2,6"/></svg>
                            Email Us
                        </a>
                        <a href="https://wa.me/919459456700?text=Hi%2C%20I%20need%20a%20quote%20for%20Stock%20Audit%20for%20Dark%20Stores." target="_blank" class="btn-sample text-decoration-none">
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - Stock Audit for Dark Stores'/>
...
<option value='Stock Audit for Dark Stores' selected>Stock Audit for Dark Stores</option>
...
<section class="content-section" id="overview-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">What Makes Dark Stores Stock Different</h2>
            <div class="content-text">
                <div class="highlight-box" style="margin-bottom:20px;">
                    <p><strong>&#128204; TL;DR - Stock Audit for Dark Stores Services at a Glance</strong></p>
                    <p>A stock audit for dark stores runs zone by zone inside live operating windows, because the site never closes long enough to count. Coverage includes pick accuracy against the order line extract, returns shelved ahead of the system, and damages cleared without a note. Quick commerce operators also collect tax at source under section 52 of the CGST Act on supplies made through the platform. Designed for networks judged on consistency across sites.</p>
                </div>
                <p>The exercise has to work at the speed the format runs at. A micro-fulfilment site holding a few thousand lines can turn most of them inside a week, serves orders in minutes, and never closes long enough for a conventional wall-to-wall count. The stock position is accurate for hours rather than days, so the count has to be designed around the operation instead of interrupting it.</p>
                
<div class="pa-ov-grid pa-cols-3"><article class="pa-ov-card"><h3>Stock That Drifts Inside a Single Week</h3><p>A <a href="/glossary/stock-audit/micro-fulfilment-centre">micro-fulfilment centre (mfc)</a> receives, picks and dispatches continuously, so an error introduced on Monday is buried under four days of movement by Friday. Drift comes from short picks confirmed as complete, damages cleared without a note, and customer returns put back to the shelf ahead of the system. None of it is visible in a daily sales report; all of it shows up the moment somebody counts a zone.</p></article>
<article class="pa-ov-card"><h3>Ten Minute Promises, Ten Second Picks</h3><p>The delivery promise sets the picking pace, and the picking pace sets the error rate. When a picker has seconds per line, the wrong variant of a similar pack goes into the bag and the system decrements the wrong SKU. <a href="/glossary/stock-audit/pick-accuracy">pick accuracy</a> and <a href="/glossary/stock-audit/order-fill-rate">order fill rate</a> are read together for this reason: a site can report a high fill rate while quietly substituting, and only a physical check against the order line extract separates the two.</p></article>
<article class="pa-ov-card"><h3>Counting a Site That Never Closes</h3><p>Quick commerce sites cannot be shut for a count, so the count is cut into zones and run inside the quieter windows, with movement into and out of a zone frozen only while that zone is counted. Chilled and frozen sections are counted inside their own temperature windows rather than held open. Across a network, the value of the exercise is comparability: the same procedure at every site, so variance means something when two sites are put side by side, in the same way a network-wide <a href="/stock-audit">stock audit</a> is run to one instruction set.</p></article></div>
    ...
    <div class="content-container">
        <div class="two-column">
            <div class="column-content">
                <h2 class="section-title">What a Dark Stores Stock Audit Covers</h2>
                <div class="content-text what-is-definition">
                    
                    <p>A stock audit for dark stores covers the whole site, taken in zones, including every holding position a unit can occupy between arriving and leaving. What makes the scope unusual is that the site is running throughout, so the exercise covers a moving position rather than a still one. The boundary follows from that: results describe the site at the moment each zone closed, and they say nothing about the hours either side.</p><div class="pa-wi-list"><article class="pa-wi-item"><span class="pa-wi-n">01</span><div class="pa-wi-b"><h3>A Micro-Fulfilment Count, Not a Store Count</h3><p>The format looks like a small shop and counts like a small warehouse. There is no shelf a customer browses, so there is no facing to assess and no display to check. Every position exists to be picked from quickly, which means the population is dense, the line count is high relative to floor area, and value per line is low. Applying a retail counting method here produces a slow exercise that answers questions the format does not have.</p></div></article>
<article class="pa-wi-item"><span class="pa-wi-n">02</span><div class="pa-wi-b"><h3>Pick Faces, Reserve Stock and Return Bins</h3><p>Three holding states, each behaving differently. The pick face is the fast-moving front position and carries most of the transaction error. Reserve stock sits above or behind it, moves rarely and reconciles more cleanly. Return bins hold units that came back from a failed delivery, and they are the population most often absent from the system entirely. Counting the pick face alone is the common shortcut, and it misses the two places where the discrepancy usually lives.</p></div></article>
<article class="pa-wi-item"><span class="pa-wi-n">03</span><div class="pa-wi-b"><h3>What the Count Says Nothing About</h3><p>It establishes what was present, not whether the site can hold what it holds. Cold chain integrity, food safety condition and licensing are separate regimes with their own inspections. Delivery performance and rider operations sit outside it entirely. And because the count is zonal and the site never stops, it does not produce a single instant position for the whole store, which is a limitation to state in the report rather than to work around quietly.</p></div></article></div>

                </div>
                <div class="highlight-box" style="margin-top:20px;">
                    <p><strong>Key terms on this page:</strong></p>
                    <div class="key-terms"><ul class="al-list"><li><span class="al-t">Pick face</span><span class="al-d">The forward position a picker draws from, replenished from reserve.</span></li>
<li><span class="al-t"><a href="https://www.patronaccounting.com/glossary/stock-audit/pick-accuracy" class="pa-offsite">Pick accuracy</a></span><span class="al-d">Whether the unit picked matches the unit the order line called for.</span></li>
<li><span class="al-t"><a href="https://www.patronaccounting.com/glossary/stock-audit/order-fill-rate" class="pa-offsite">Order fill rate</a></span><span class="al-d">The share of ordered lines despatched complete, read alongside accuracy.</span></li></ul></div>

                </div>
            </div>
            <div class="column-image">
                <figure class="pa-art"><figcaption class="pa-art-t">Stock Audit for Dark Stores in India</figcaption><img src="/images/stock-audit/stock-audit-for-dark-stores/what-is.webp" alt="Counting fast-moving packs in a compact dark store where stock turns over within days" loading="lazy" width="1200" height="896"></figure>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section" id="who-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Who Commissions a Dark Store Stock Audit</h2>
            <div class="content-text">
                
                <p>A stock audit for dark stores is bought by readers separated by who holds the stock and who answers for it. The operator running its own network, the partner holding somebody else's brand, and the brand wanting an independent read on sites it funds.</p><div class="pa-ov-grid pa-cols-3"><article class="pa-ov-card"><h3>Quick Commerce Operators Running Owned Sites</h3><p>An operator with dozens or hundreds of its own sites needs a comparable measurement across all of them, not a deep count of one. This reader is usually supply chain or finance leadership looking for the outliers and the repeat offenders. What they buy is coverage and consistency; a single site's variance tells them almost nothing.</p></article>
<article class="pa-ov-card"><h3>Franchise Partners Holding Brand Stock</h3><p>A partner operating a site under a brand's name may hold stock the brand still owns, or may have bought it outright, and the two arrangements produce very different reports. The reader here needs the ownership position settled before the count, because it decides whose balance sheet the result lands on and who can be asked for the shortfall.</p></article>
<article class="pa-ov-card"><h3>Grocery Brands Auditing Their Own Dark Stores</h3><p>A grocery or FMCG brand running fulfilment sites of its own wants assurance that its stock position is real before it is used for planning or reported upward. This reader often also runs a <a href="/mystery-audit">how a mystery audit works</a> programme on the customer-facing side, and reads the two together to separate a stock problem from a service one.</p></article></div>
...
<section class="content-section" id="services-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Scope and Deliverables for Dark Stores</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Deliverable</th><th>What It Includes</th></tr></thead>
                    <tbody>
                        <tr><td><strong>Site-Level Accuracy Score</strong></td><td>One comparable measure for each quick commerce site, computed identically everywhere, so a single location can be read against the network rather than in isolation.</td></tr>
<tr><td><strong>Pick Face Accuracy Against the Order Line Extract</strong></td><td>Each picked unit is set against the order it was drawn for, so a substitution at the shelf is separated from a genuine shortage in the holding.</td></tr>
<tr><td><strong>Network Comparison Across Every Site</strong></td><td>The distribution across the whole quick commerce india network with outliers identified, and whether the same sites keep appearing as outliers cycle after cycle.</td></tr>
...
<section class="steps-section" id="procedure-section">
    <div class="section-container">
        <header class="section-header" style="text-align:center;margin-bottom:48px;">
            ...
            <h2 class="section-title">How the Count Runs in Dark Stores</h2>
        ...
        <div class="steps-container">
            <div class="step-card"><div class="step-content"><span class="step-badge">Step 1</span><h3 class="step-title">Counting Between Delivery Waves</h3><p class="step-description">Work is fitted into quieter windows between demand peaks, zone by zone, with picking routed around whichever zone is closed. The site keeps trading throughout, which is the only condition on which a quick commerce india operator will agree to a count.</p></div><div class="step-visual"><div class="step-illustration" style="padding:0;background:none;"><img src="/images/stock-audit/_library/steps/freeze.webp" alt="Counting Between Delivery Waves" loading="lazy" width="1200" height="896" style="width:100%;height:auto;border-radius:var(--radius-xl);"></div></div></div>
<div class="step-card"><div class="step-content"><span class="step-badge">Step 2</span><h3 class="step-title">Chilled and Frozen Zones Counted Inside Their Window</h3><p class="step-description">Temperature-controlled sections are counted within the time the door can be open, in short passes rather than one long sweep. Propping a chamber open to finish a count creates an excursion, which turns a counting exercise into a valuation problem.</p></div><div class="step-visual"><div class="step-illustration" style="padding:0;background:none;"><img src="/images/stock-audit/_library/steps/controlled-entry.webp" alt="Chilled and Frozen Zones Counted Inside Their Window" loading="lazy" width="1200" height="896" style="width:100%;height:auto;border-radius:var(--radius-xl);"></div></div></div>
<div class="step-card"><div class="step-content"><span class="step-badge">Step 3</span><h3 class="step-title">Pick Face First, Reserve Stock Second</h3><p class="step-description">The forward picking positions are counted first because that is where transaction error concentrates and where stock moves fastest through the day. Reserve locations sitting behind or above them are counted after, since they turn slowly and reconcile far more cleanly.</p></div><div class="step-visual"><div class="step-illustration" style="padding:0;background:none;"><img src="/images/stock-audit/_library/steps/zone-sequence.webp" alt="Pick Face First, Reserve Stock Second" loading="lazy" width="1200" height="896" style="width:100%;height:auto;border-radius:var(--radius-xl);"></div></div></div>
<div class="step-card"><div class="step-content"><span class="step-badge">Step 4</span><h3 class="step-title">Return and Damage Bins Reconciled Last</h3><p class="step-description">Returned and damaged units are counted at the end and matched against what the system believes came back. This population is the one most often absent from records entirely, and leaving it to the end keeps it from being swept into the main count.</p></div><div class="step-visual"><div class="step-illustration" style="padding:0;background:none;"><img src="/images/stock-audit/_library/steps/zone-sequence.webp" alt="Return and Damage Bins Reconciled Last" loading="lazy" width="1200" height="896" style="width:100%;height:auto;border-radius:var(--radius-xl);"></div></div></div>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <ul class="pa-doc-list"><li><strong>Order Line Extract for the Count Window</strong> — Every order line picked during the window, so picked units can be checked against what was ordered. This is what separates a substitution problem from a stock problem.</li>
<li><strong>Inter-Site Transfer Records</strong> — Movements between sites across the quick commerce india network for the period, since stock rebalanced overnight between micro-fulfilment centres is a frequent source of apparent shortage at a single site.</li>
<li><strong>Rider Return and Cancellation Logs</strong> — Failed deliveries, cancellations and returns with their timestamps. Units that came back and were shelved ahead of the system are invisible without this record.</li></ul>
...
<section class="content-section" id="challenges-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Why Dark Store Stock Drifts Within Days</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Issue</th><th>What It Does to the Count</th></tr></thead>
                    <tbody>
                        <tr><td><strong>Cancelled Orders Restocked but Never Booked</strong></td><td>A refused delivery comes back and is shelved ahead of any system entry. Across a quick commerce india network the volume is significant and entirely undocumented.</td></tr>
<tr><td><strong>Expiry on Perishables Nobody Pulled</strong></td><td>Short-dated lines left on the pick face past their date, counted as saleable and provisioned for nowhere, because no one owns the daily pull.</td></tr>
<tr><td><strong>Transfers Between Sites Recorded Once</strong></td><td>Overnight rebalancing entered at the sending site and not at the receiving one, so the same units appear short at one address and unexplained at another.</td></tr>
<tr><td><strong>Accuracy That Decays Within Days of a Count</strong></td><td>A verified position that is already stale by midweek. Anyone treating an annual figure as current for this format is reading a number about a different fortnight.</td></tr>
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <table>
                    ...
                    <tbody>
                        <tr><td><strong>Number of Sites in the Network</strong></td><td>Pricing follows network size rather than any single site, because the value of the exercise lies in comparability across all of them.</td></tr>
<tr><td><strong>SKU Range per Site</strong></td><td>Quick commerce india sites carrying a full grocery range take substantially longer than convenience formats holding a few hundred lines, on identical floor space.</td></tr>
<tr><td><strong>Whether Counting Runs Between Delivery Waves</strong></td><td>Zonal counting inside live operating windows takes more elapsed time than a closed-site count, and it is usually the only option the operation will accept.</td></tr>
                ...
                <p style="margin-top:16px;"><strong>Get a free Stock Audit for Dark Stores consultation - <a href="tel:+919459456700">Call +91 945 945 6700</a> or <a href="https://wa.me/919459456700?text=Hi%2C%20I%20would%20like%20to%20book%20Stock%20Audit%20for%20Dark%20Stores." target="_blank">WhatsApp us</a>. No-obligation assessment.</strong></p>
            </div>
        </div>
    </div>
</section>
...
<section class="why-choose-section" id="benefits-section">
    <div class="section-container">
        ...
        <div class="features-grid pa-cols-3"><article class="feature-card"><div class="feature-icon feature-icon--navy"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#19355E" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M10 12h4" /> <path d="M10 8h4" /> <path d="M14 21v-3a2 2 0 0 0-4 0v3" /> <path d="M6 10H4a2 2 0 0 0-2 2v7a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-2" /> <path d="M6 21V5a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v16" /> </svg></div><h3 class="feature-title">Which Sites Lose Stock and Which Lose Discipline</h3><p class="feature-text">The count separates sites with a genuine shrinkage problem from sites whose records simply lag the floor, and those two are fixed in entirely different ways.</p></article>
<article class="feature-card"><div class="feature-icon feature-icon--orange"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#F76722" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M10 12h4" /> <path d="M10 8h4" /> <path d="M14 21v-3a2 2 0 0 0-4 0v3" /> <path d="M6 10H4a2 2 0 0 0-2 2v7a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-2" /> <path d="M6 21V5a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v16" /> </svg></div><h3 class="feature-title">Fill Rate Explained by Something Other Than Demand</h3><p class="feature-text">Where a site reports high fill while quietly substituting, the count against the order line extract shows it, which no demand report ever will.</p></article>
<article class="feature-card"><div class="feature-icon feature-icon--navy"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#19355E" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M13.744 17.736a6 6 0 1 1-7.48-7.48" /> <path d="M15 6h1v4" /> <path d="m6.134 14.768.866-.5 2 3.464" /> <circle cx="16" cy="8" r="6" /> </svg></div><h3 class="feature-title">Perishable Losses Separated From Picking Losses</h3><p class="feature-text">Expiry, damage and mis-pick quantified apart from one another, so a quick commerce india network knows whether it has a rotation problem or a picking problem.</p></article></div>
    </div>
</section>
...
<section class="content-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Counts Run in Dark Stores</h2>
            <div class="content-text">
                
                <p style="font-size:16px"><strong>500+ stock audits completed.</strong></p><ul style="list-style:none;padding:0;margin:0 0 14px"><li style="margin-bottom:10px"><strong>Dark Store Sites Counted</strong></li>
<li style="margin-bottom:10px"><strong>Cities in the Network Covered</strong></li>
<li style="margin-bottom:10px"><strong>Count Window Achieved per Site</strong></li></ul><p style="font-size:14.5px">Across engagements run by the Patron team. The figure is counted from completed engagements only, and it is restated when it changes rather than rounded up and left. Scope for any one count is still agreed against your own site list.</p>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="why-patron-grid pa-cols-3">
                <article class="feature-card"><div class="feature-icon feature-icon--navy"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#19355E" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M10 12h4" /> <path d="M10 8h4" /> <path d="M14 21v-3a2 2 0 0 0-4 0v3" /> <path d="M6 10H4a2 2 0 0 0-2 2v7a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-2" /> <path d="M6 21V5a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v16" /> </svg></div><h3 class="feature-title">Crews Who Count Around a Live Delivery Clock</h3><p class="feature-text">A stock audit for dark stores is run zone by zone inside operating windows, so the site keeps trading and the operation does not treat the count as an outage.</p></article>
<article class="feature-card"><div class="feature-icon feature-icon--orange"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#F76722" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M10 12h4" /> <path d="M10 8h4" /> <path d="M14 21v-3a2 2 0 0 0-4 0v3" /> <path d="M6 10H4a2 2 0 0 0-2 2v7a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-2" /> <path d="M6 21V5a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v16" /> </svg></div><h3 class="feature-title">Network Reporting, Not Site Reports in a Folder</h3><p class="feature-text">Results are produced as a network view with the outliers named, because a set of individual site reports leaves the comparison work to whoever opens the folder.</p></article>
<article class="feature-card"><div class="feature-icon feature-icon--navy"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#19355E" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M10 12h4" /> <path d="M10 8h4" /> <path d="M14 21v-3a2 2 0 0 0-4 0v3" /> <path d="M6 10H4a2 2 0 0 0-2 2v7a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-2" /> <path d="M6 21V5a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v16" /> </svg></div><h3 class="feature-title">Coverage Across Every Metro in the Rollout</h3><p class="feature-text">Sites in different cities are covered under one engagement and one method, which is what makes a network number mean anything at all.</p></article>
            </div>
...
<section class="content-section" id="case-study-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">A Dark Stores Count We Have Run</h2>
            
            <article class="pa-case pa-rm"><div class="pa-case-h"><h3>A Network Where Two Sites Explained the Whole Variance</h3><p class="pa-case-scale">metro network · all sites counted in one window</p><p class="pa-case-client">A quick-commerce operator running micro-fulfilment sites across one metro</p></div><ol class="pa-rm-track"><li class="pa-rm-stage"><span class="pa-rm-node">01</span><span class="pa-rm-lab">The challenge</span><p>Aggregate network variance looked like a systemic control failure, and a network-wide retraining programme had been costed.</p></li><li class="pa-rm-stage"><span class="pa-rm-node">02</span><span class="pa-rm-lab">What we did</span><p>Every site was counted inside a single window, with each site counted and reported separately rather than rolled into a network figure.</p></li><li class="pa-rm-stage is-out"><span class="pa-rm-node">03</span><span class="pa-rm-lab">What the count found</span><p>Two sites accounted for almost all of the variance. The rest of the network sat within tolerance. What looked systemic was two locations with a specific problem.</p></li><li class="pa-rm-stage"><span class="pa-rm-node">04</span><span class="pa-rm-lab">What changed</span><p>The network-wide programme was cancelled and replaced with intervention at two sites, at a fraction of the cost and without disrupting the sites that were working.</p></li></ol></article>
<article class="pa-case pa-rm"><div class="pa-case-h"><h3>Return Bins That Were Never Restocked</h3><p class="pa-case-scale">metro network · return bins counted as separate locations</p><p class="pa-case-client">A quick-commerce operator running micro-fulfilment sites</p></div><ol class="pa-rm-track"><li class="pa-rm-stage"><span class="pa-rm-node">01</span><span class="pa-rm-lab">The challenge</span><p>The operating rule was that customer returns are assessed the same day and either restocked or written off. Availability was suffering and nobody could say why.</p></li><li class="pa-rm-stage"><span class="pa-rm-node">02</span><span class="pa-rm-lab">What we did</span><p>We counted every return bin as its own location rather than folding it into site stock, and aged what was in it.</p></li><li class="pa-rm-stage is-out"><span class="pa-rm-node">03</span><span class="pa-rm-lab">What the count found</span><p>A consistent quantity was sitting unassessed across the network, still valued as saleable, and part of it was past date. The same-day rule existed on paper and had quietly stopped being followed at most sites.</p></li><li class="pa-rm-stage"><span class="pa-rm-node">04</span><span class="pa-rm-lab">What changed</span><p>Saleable stock was restocked and the rest written down. The return bin became a reported position rather than an invisible one.</p></li></ol></article></div>
    </div>
</section>
        ...
        <div class="text-content">
            ...
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    <h2 class="faq-expanded__title">Dark Stores Stock Audit: Common Questions</h2>
                ...
                <div class="faq-expanded__list">
                    <div class="faq-expanded__item"><h3 class="faq-expanded__q">How is a dark store stock audit different from a retail count?</h3><div class="faq-expanded__a"><p>A dark store has no customers, runs on very fast pick cycles, and holds a narrow high-rotation range. The count must happen without pausing fulfilment, so cycle counting by zone replaces the full shutdown count used in conventional retail.</p></div></div>
<div class="faq-expanded__item"><h3 class="faq-expanded__q">Why does dark store stock drift so quickly?</h3><div class="faq-expanded__a"><p>Drift comes from picking errors, customer returns re-entering stock, damages during rapid handling, and substitutions made at the pick face. Because order volume is high and cycle times are short, a small per-order error rate compounds into a visible variance within days.</p></div></div>
<div class="faq-expanded__item"><h3 class="faq-expanded__q">Can you count a dark store without stopping deliveries?</h3><div class="faq-expanded__a"><p>Yes, by counting zone by zone during low-demand windows and freezing only the zone being counted rather than the whole site. The system must be able to segregate movements during that freeze, because picks made mid-count against an unfrozen zone will corrupt the result.</p></div></div>
<div class="faq-expanded__item"><h3 class="faq-expanded__q">What is pick accuracy and why is it audited?</h3><div class="faq-expanded__a"><p>Pick accuracy measures how often the correct item and quantity were picked. It is the leading indicator of stock variance: falling pick accuracy predicts a widening gap between system and physical stock before the count itself reveals it.</p></div></div>
<div class="faq-expanded__item"><h3 class="faq-expanded__q">How is shrinkage measured across many micro-fulfilment sites?</h3><div class="faq-expanded__a"><p>Shrinkage is measured per site and normalised against throughput, not just absolute value, so a high-volume store is not unfairly compared with a small one. Reporting by site and by category exposes whether loss is concentrated in specific products or specific locations.</p></div></div>
<div class="faq-expanded__item"><h3 class="faq-expanded__q">What is a micro-fulfilment centre?</h3><div class="faq-expanded__a"><p>A micro-fulfilment centre is a small urban facility holding a limited high-rotation range for rapid local delivery. It is the unit an audit is scoped around in quick commerce, because each site behaves like a separate stock location with its own variance profile.</p></div></div>
<div class="faq-expanded__item"><h3 class="faq-expanded__q">How are customer returns handled in a dark store count?</h3><div class="faq-expanded__a"><p>Returns must be segregated until they are inspected and either restocked or written off. Counting them with saleable stock overstates availability. The audit checks whether the return-to-stock decision is being made and recorded, or whether returns are simply flowing back onto the pick face.</p></div></div>
<div class="faq-expanded__item"><h3 class="faq-expanded__q">What is order fill rate and how does it relate to stock accuracy?</h3><div class="faq-expanded__a"><p>Fill rate measures the proportion of orders fulfilled complete. Persistent short-fills on items the system shows as available is the clearest operational signal of phantom stock, and often surfaces before a scheduled count would find it.</p></div></div>
<div class="faq-expanded__item"><h3 class="faq-expanded__q">How often should a dark store be counted?</h3><div class="faq-expanded__a"><p>Because stock turns quickly, most operators cycle count continuously rather than counting everything periodically, covering the full range over a short cycle and counting the fastest-moving lines most often. A quarterly full count alone is too slow for this format.</p></div></div>
<div class="faq-expanded__item"><h3 class="faq-expanded__q">Are dark store audits useful for quick commerce franchise operators?</h3><div class="faq-expanded__a"><p>Yes, but the purpose differs. A franchisee wants assurance that stock losses are within agreed limits and that reconciliations with the brand are accurate. The scope is the same count; the reporting is oriented to the contract between franchisee and brand.</p></div></div>
                </div>
            </div>
...
<section class="content-section" style="background:var(--gray-50);"><div class="content-container"><div class="pa-city-block" style="margin-bottom:0;"><div class="pa-block-title">Related Reading</div><div class="pa-read-grid"><a href="https://www.patronaccounting.com/blog/cycle-counting-in-a-dark-store" class="pa-read-card">Cycle Counting in a Dark Store: Counting Without Stopping Fulfilment<span class="pa-read-go">&rarr;</span></a>
<a href="https://www.patronaccounting.com/blog/quick-commerce-shrinkage" class="pa-read-card">Quick Commerce Shrinkage: Measuring Loss Across Hundreds of Micro-Fulfilment Sites<span class="pa-read-go">&rarr;</span></a>
<a href="https://www.patronaccounting.com/blog/why-dark-store-stock-drifts-in-48-hours" class="pa-read-card">Why Dark Store Stock Drifts in 48 Hours: Picking Errors, Returns and Damages<span class="pa-read-go">&rarr;</span></a></div></div></div></section>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text" style="text-align:left;">
                ...
                <h3>What a Site Handover Looks Like</h3>
<p>Zone layout, the order line extract for the window, and agreement on which zones can be closed when. A stock audit for dark stores is planned around the operating clock.</p>
<h3>Sizing a First Wave Across the Network</h3>
<p>A first wave covers enough sites to establish the network distribution, so later cycles are measuring movement against a baseline rather than starting again.</p>

            </div>
            <div style="display:flex;gap:14px;flex-wrap:wrap;margin-top:24px;">
                <a href="tel:+919459456700" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:var(--orange);color:#fff;border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#128222; Call +91 945 945 6700</a>
                <a href="https://wa.me/919459456700?text=Hi%2C%20I%20would%20like%20to%20book%20Stock%20Audit%20for%20Dark%20Stores." target="_blank" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:#25D366;color:#fff;border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#128172; WhatsApp Us</a>
                <a href="mailto:sales@patronaccounting.com?subject=Enquiry%20for%20Stock Audit for Dark Stores%20Services&body=Hello%20Patron%20Accounting%20Team%2C%0A%0AI%20am%20interested%20in%20your%20Stock Audit for Dark Stores%20services%20and%20would%20like%20to%20know%20more.%0A%0APlease%20get%20in%20touch%20with%20me%20at%20your%20earliest%20convenience.%0A%0AThank%20you." style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:transparent;color:#fff;border:2px solid rgba(255,255,255,0.3);border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#9993;&#65039; Email Us</a>
            </div>
