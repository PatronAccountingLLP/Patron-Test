...
<title>Retail Audit and Store Audit: Shrinkage Store by Store | Patron Accounting</title>
    ...
    <meta property="og:title" content="Retail Audit and Store Audit: Shrinkage Store by Store | Patron Accounting">
    <meta property="og:description" content="A retail audit for multi-store chains counts at SKU level. Shrinkage is measured store by store, with mark-down, planogram and sell-through checks.">
...
<script type="application/ld+json">
    {
        ...
        "@type": "Service",
        "@id": "https://www.patronaccounting.com/stock-audit-for-retail/#service",
        "name": "Retail Audit/Store Audit in India: Checklist, Process and Fees",
        "description": "A retail audit for multi-store chains counts at SKU level. Shrinkage is measured store by store, with mark-down, planogram and sell-through checks.",
        "provider": { "@id": "https://www.patronaccounting.com/#organization" },
        "mainEntityOfPage": { "@type": "WebPage", "@id": "https://www.patronaccounting.com/stock-audit-for-retail" },
        "areaServed": { "@type": "Country", "name": "India", "sameAs": "https://en.wikipedia.org/wiki/India" },
        "about": [{ "@type": "Thing", "name": "Stock Audit for Retail", "sameAs": "" }],
        "hasOfferCatalog": {
            "@type": "OfferCatalog",
            "name": "Stock Audit for Retail Service Plans",
            "itemListElement": [
                {"@type": "Offer", "itemOffered": {"@type": "Service", "name": "Store-Level Variance Report", "description": "Variance by store on a like-for-like basis, so outlets can be compared against each other rather than against a chain average that hides both ends of the distribution."}},
{"@type": "Offer", "itemOffered": {"@type": "Service", "name": "Retail Audit Checklist Applied Store by Store", "description": "The same checklist run identically at every location, which is what makes the results comparable and what separates a chain programme from a set of separate visits."}},
{"@type": "Offer", "itemOffered": {"@type": "Service", "name": "Chain Roll-Up for Head Office", "description": "A consolidated position with the outliers named, so head office reads which stores need attention rather than a single total that answers nothing."}}
            ]
        }
    }
    </script><script type="application/ld+json">
{
    "@context": "https://schema.org",
    "@type": "BreadcrumbList",
    "@id": "https://www.patronaccounting.com/stock-audit-for-retail/#breadcrumb",
    "itemListElement": [
        {
            "@type": "ListItem",
            "position": 1,
        ...
        },
        {
            ...
            "position": 4,
            "name": "Retail",
            "item": "https://www.patronaccounting.com/stock-audit-for-retail"
        }
    ]
}
</script><script type="application/ld+json">
    {
        "@context": "https://schema.org",
        "@type": "FAQPage",
        "@id": "https://www.patronaccounting.com/stock-audit-for-retail/#faq",
        "datePublished": "2026-08-20T08:00:00+05:30",
        "dateModified": "2026-08-20T08:00:00+05:30",
        "mainEntity": [
            {"@type": "Question", "name": "Can a stock audit be done without closing the store?", "acceptedAnswer": {"@type": "Answer", "text": "Yes. Cycle counting sections of the store, or counting outside trading hours, avoids closing. A full wall-to-wall count is faster and cleaner but needs the store shut or trading frozen. Most chains use cycle counts through the year and a full count at year end."}},
{"@type": "Question", "name": "What is the difference between a retail audit and a mystery audit?", "acceptedAnswer": {"@type": "Answer", "text": "A retail audit is announced and examines stock, pricing and compliance with staff present. A mystery audit is covert and measures the customer experience. Chains commonly run both because each finds problems the other cannot see."}},
{"@type": "Question", "name": "What is a retail audit?", "acceptedAnswer": {"@type": "Answer", "text": "A retail audit is an independent check of what is actually happening in a store: stock on hand against system records, planogram and display compliance, pricing and MRP accuracy, expiry, and shrinkage. It gives head office evidence from the shop floor rather than a report filed by the store itself."}},
{"@type": "Question", "name": "How do audits work in a retail chain?", "acceptedAnswer": {"@type": "Answer", "text": "Auditors visit stores on a rotating schedule, count stock in defined categories, compare against the POS or ERP balance, and record variances by SKU and by store. Results are reported store by store so head office can rank outlets and target the ones with persistent gaps."}},
{"@type": "Question", "name": "What should a retail store audit checklist cover?", "acceptedAnswer": {"@type": "Answer", "text": "A workable checklist covers physical stock count by category, high-value item verification, expiry and near-expiry stock, damaged and unsaleable goods, price and MRP tags against the master, planogram compliance, cash and till reconciliation, and back-store stock not on the shop floor."}},
{"@type": "Question", "name": "What counts as normal shrinkage in Indian retail?", "acceptedAnswer": {"@type": "Answer", "text": "Shrinkage varies sharply by format and category, so a single benchmark is misleading. The useful comparison is your own trend by store and category over time. An outlet that suddenly moves away from its own historic range matters more than one that sits above a published industry average."}},
{"@type": "Question", "name": "Why do two stores report different stock accuracy?", "acceptedAnswer": {"@type": "Answer", "text": "Differences usually trace to process rather than dishonesty: inconsistent goods-inward recording, unrecorded inter-store transfers, damaged stock written off at different points, or POS overrides. An audit that reports variance by cause rather than a single percentage tells you which store needs training."}},
{"@type": "Question", "name": "How often should a retail chain count stock?", "acceptedAnswer": {"@type": "Answer", "text": "Most chains combine a full count once or twice a year with cycle counts of high-value or fast-moving lines every month. Frequency should follow risk: outlets with high shrinkage, high staff turnover or weak prior scores warrant more frequent counts than stable stores."}},
{"@type": "Question", "name": "What is planogram compliance and why is it audited?", "acceptedAnswer": {"@type": "Answer", "text": "Planogram compliance measures whether the shelf layout in the store matches the layout head office specified. It is audited alongside stock because the two interact: missing facings often reveal stock that the system says is on hand but is not on the floor."}},
{"@type": "Question", "name": "How is expiry and near-expiry stock treated in a retail audit?", "acceptedAnswer": {"@type": "Answer", "text": "Auditors segregate expired stock, quantify near-expiry stock by remaining shelf life, and check whether it has been provided for in the books. Stock past its date that still sits in the system at full value is one of the most common valuation findings in retail."}}
        ]
    }
    </script><script type="application/ld+json">
    {
        "@context": "https://schema.org",
        "@type": "WebPage",
        "@id": "https://www.patronaccounting.com/stock-audit-for-retail",
        "name": "Retail Audit/Store Audit in India: Checklist, Process and Fees",
        "description": "A retail audit for multi-store chains counts at SKU level. Shrinkage is measured store by store, with mark-down, planogram and sell-through checks.",
        "url": "https://www.patronaccounting.com/stock-audit-for-retail",
        "inLanguage": "en-IN",
        "isPartOf": { "@id": "https://www.patronaccounting.com" },
        "about": { "@id": "https://www.patronaccounting.com/stock-audit-for-retail/#service" },
        "datePublished": "2026-08-20T08:00:00+05:30",
        "dateModified": "2026-08-20T08:00:00+05:30",
        "author": { "@id": "https://www.patronaccounting.com/#team" },
        "breadcrumb": { "@id": "https://www.patronaccounting.com/stock-audit-for-retail/#breadcrumb" }
    }
    </script><script type="application/ld+json">
    {
        "@context": "https://schema.org",
            ...
            <div class="col-lg-8">
                <div class="pe-lg-5">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-4 private-registration-heading">
                        Retail Audit/Store Audit in India: Checklist, Process and Fees
                    </h1>
                    ...
                    <div class="mb-4">
                        <div class="d-flex align-items-start mb-3">
                            ...
                            <p class="mb-0 text-dark benefit-paragraph"><span>Which Stores Actually Lose Stock:</span> A retail audit reports variance store by store on a like-for-like basis, so the outliers are identifiable rather than hidden inside a chain average.</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>Provisioning Backed by a Counted Number:</span> Damaged, expired and unsaleable lines quantified at the shelf, so a provisioning estimate becomes a figure with a physical count behind it.</p>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            <span class="check-icon me-2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span>
                            <p class="mb-0 text-dark benefit-paragraph"><span>A Baseline the Next Cycle Is Measured Against:</span> One documented method applied identically at every store, so the following count measures change rather than measuring a different procedure.</p>
                        </div>
                        </div>

                    <p class="mb-4 fw-bold" style="color: var(--blue); font-size: 15px;">Shelf, backroom and transit stock, counted apart and reported apart.</p>
                    ...
                    <div class="hero-cta">
                        ...
                        <a href="mailto:sales@patronaccounting.com?subject=Enquiry%20for%20Stock Audit for Retail%20Services&body=Hello%2C%20I%20just%20visited%20your%20Stock%20Audit%20for%20Retail%20Services%20page.%20I%20would%20like%20to%20know%20more%20about%20it.%0A%0AThank%20you." class="btn-sample text-decoration-none">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:18px;height:18px;"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,12 2,6"/></svg>
                            Email Us
                        </a>
                        <a href="https://wa.me/919459456700?text=Hello%2C%20I%20just%20visited%20your%20Stock%20Audit%20for%20Retail%20Services%20page.%20I%20would%20like%20to%20know%20more%20about%20it." target="_blank" class="btn-sample text-decoration-none" rel="noopener">
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    @include('partials.bigin-form', [
                        'variant' => 'bare',
                        'service'  => 'Stock Audit for Retail',
                    ])
                    @verbatim
...
<section class="content-section" id="overview-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">What Makes Retail Stock Different</h2>
            <div class="content-text">
                <div class="highlight-box" style="margin-bottom:20px;">
                    <p><strong>&#128204; TL;DR - Stock Audit for Retail Services at a Glance</strong></p>
                    <p>A retail audit counts merchandise that keeps moving while it is being counted, across tills, back rooms and deliveries arriving mid-count. Scope covers one agreed cut-off across every till, value-weighted sampling, shrinkage measurement and variance reported store by store. Packaged goods on the shelf carry declarations under the Legal Metrology (Packaged Commodities) Rules 2011, recorded alongside quantity. Built for chains where 2 stores on identical systems report different accuracy.</p>
                </div>
                <p>A retail audit has to count stock that keeps moving while it is being counted. Thousands of low-value lines, tills open, deliveries arriving at the back door, and a system balance that was accurate at four this morning. The problem in retail is never finding the stock. It is agreeing which moment the count belongs to, and explaining the difference between that moment and the books.</p>
                
<div class="pa-ov-grid pa-cols-3"><article class="pa-ov-card"><h3>Fast Moving SKUs, Slow Moving Cash</h3><p>A store's line count runs into thousands while the value concentrates in a fraction of them. A store audit that treats every SKU as equal spends its day on confectionery and never reaches the categories that decide the margin. <a href="/glossary/stock-audit/sell-through-rate">sell-through rate</a> is what separates the two: lines turning quickly need accuracy on quantity, while lines that have not moved for a season need attention on whether they are still worth what the books say.</p></article>
<article class="pa-ov-card"><h3>Shrinkage That Nobody Books</h3><p>Inventory shrinkage does not arrive as a journal entry. It accumulates from mis-scans at the till, damage cleared into a back room, returns put away without paperwork, and theft that leaves no record at all. Until a physical count happens, the system carries stock that is not on the shelf. This is the single largest reason a system figure and a shelf disagree, and the reason a retail audit is the only instrument that finds it.</p></article>
<article class="pa-ov-card"><h3>Why Two Stores Never Count the Same Way</h3><p>Store-level discipline is not uniform, and the count exposes it. One store receives against the invoice, another against the delivery note; one clears damages weekly, another at month end; one applies a <a href="/glossary/stock-audit/mark-down">mark-down</a> at the shelf and in the system, another only at the shelf. Comparable results across a chain come from a fixed procedure applied identically, which is why a chain-wide <a href="/stock-audit">stock audit</a> is run to one instruction set rather than store by store.</p></article></div>
    ...
    <div class="content-container">
        <div class="two-column">
            <div class="column-content">
                <h2 class="section-title">What a Retail Stock Audit Covers</h2>
                <div class="content-text what-is-definition">
                    
                    <p>Scope in retail is defined by where the goods stand rather than by what they are. A retail audit covers every location inside the store that holds saleable stock, together with the records that describe it, at one agreed moment. The boundary matters as much as the coverage. This is a count of merchandise, not an assessment of how the store is run, and the two are routinely confused in briefs.</p><div class="pa-wi-list"><article class="pa-wi-item"><span class="pa-wi-n">01</span><div class="pa-wi-b"><h3>A Store Audit and a Stock Count in One Visit</h3><p>A store audit and a stock count are separable exercises that usually share a visit because the visit is the expensive part. The count establishes quantity and value. The store audit records observable conditions around it: <a href="/glossary/stock-audit/planogram-compliance">planogram compliance</a>, price display, damaged stock left on shelf. Combining them is efficient and creates one risk worth naming, that a weak observation gets read with the same authority as a counted figure. The report separates the two for that reason.</p></div></article>
<article class="pa-wi-item"><span class="pa-wi-n">02</span><div class="pa-wi-b"><h3>Shelf Stock, Backroom Stock and Transit Stock</h3><p>Three populations, counted separately and reported separately. Shelf stock is what a customer could buy today. Backroom stock is held, often unfaced and sometimes unrecorded at line level. Transit stock has left the distribution centre and not yet been received, so it belongs to whichever side the terms of sale place it on. A store total that merges the three hides exactly the imbalance a chain most needs to see, which is stock present in the building and not on the shelf.</p></div></article>
<article class="pa-wi-item"><span class="pa-wi-n">03</span><div class="pa-wi-b"><h3>What a Retail Count Deliberately Leaves Out</h3><p>Cash, fixed assets and fittings are outside it. So is anything requiring a judgement about staff. Customer service quality is not assessed here; where a brand wants that measured it belongs in <a href="/mystery-audit">how a mystery audit works</a>, which is a different instrument with a different method. The count also reaches no conclusion on why a difference arose. It records that stock is missing; attributing it between theft, damage and recording error is a management investigation.</p></div></article></div>

                </div>
                <div class="highlight-box" style="margin-top:20px;">
                    <p><strong>Key terms on this page:</strong></p>
                    <div class="key-terms"><ul class="al-list"><li><span class="al-t">Shrinkage</span><span class="al-d">Stock recorded but not present, with no document explaining its absence.</span></li>
<li><span class="al-t"><a href="https://www.patronaccounting.com/glossary/stock-audit/sell-through-rate" class="pa-offsite">Sell-through rate</a></span><span class="al-d">The share of received stock sold in a period, used to weight sampling.</span></li>
<li><span class="al-t"><a href="https://www.patronaccounting.com/glossary/stock-audit/planogram-compliance" class="pa-offsite">Planogram compliance</a></span><span class="al-d">Whether shelf layout matches the plan, observed rather than counted.</span></li></ul></div>

                </div>
            </div>
            <div class="column-image">
                <figure class="pa-art"><figcaption class="pa-art-t">Stock Audit for Retail in India</figcaption><img src="/images/stock-audit/stock-audit-for-retail/what-is.webp" alt="Counting stock on the shop floor and in the stockroom behind, as two separate locations" loading="lazy" width="1200" height="896"></figure>
            </div>
        </div>
    </div>
</section>
...
<article class="pa-ov-card"><h3>Franchise Networks Counting Company-Owned Stock</h3><p>In a mixed network the brand owns stock in some outlets and the franchisee owns it in others, sometimes on the same shelf. The reader here needs the ownership line drawn before anything is added up, and a report that keeps the two populations apart. Access at franchised sites rests on the franchise agreement rather than on any right of the brand.</p></article>
<article class="pa-ov-card"><h3>Single-Store Retailers Sitting on a Bank Limit</h3><p>One shop, one godown, one cash credit limit secured on stock. This reader is not running a control programme; a lender has asked and the count has to be done properly and quickly. Records are often a purchase register and a till system that were never designed to reconcile, so the preparation matters more than the counting.</p></article></div>
...
<section class="content-section" id="services-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Scope and Deliverables for Retail</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Deliverable</th><th>What It Includes</th></tr></thead>
                    <tbody>
                        <tr><td><strong>Store-Level Variance Report</strong></td><td>Variance by store on a like-for-like basis, so outlets can be compared against each other rather than against a chain average that hides both ends of the distribution.</td></tr>
<tr><td><strong>Retail Audit Checklist Applied Store by Store</strong></td><td>The same checklist run identically at every location, which is what makes the results comparable and what separates a chain programme from a set of separate visits.</td></tr>
<tr><td><strong>Chain Roll-Up for Head Office</strong></td><td>A consolidated position with the outliers named, so head office reads which stores need attention rather than a single total that answers nothing.</td></tr>
...
<section class="steps-section" id="procedure-section">
    <div class="section-container">
        <header class="section-header" style="text-align:center;margin-bottom:48px;">
            ...
            <h2 class="section-title">How the Count Runs in Retail</h2>
        ...
        <div class="steps-container">
            <div class="step-card"><div class="step-content"><span class="step-badge">Step 1</span><h3 class="step-title">Counting Before the Doors Open</h3><p class="step-description">The count runs before trading starts wherever the format allows, because a till transaction during counting moves stock that has already been recorded. Where a store cannot close, tills are logged and the movements reconciled against the count afterwards.</p></div><div class="step-visual"><div class="step-illustration" style="padding:0;background:none;"><img src="/images/stock-audit/_library/steps/freeze.webp" alt="Counting Before the Doors Open" loading="lazy" width="1200" height="896" style="width:100%;height:auto;border-radius:var(--radius-xl);"></div></div></div>
<div class="step-card"><div class="step-content"><span class="step-badge">Step 2</span><h3 class="step-title">Shelf, Backroom and Transit Zones in Sequence</h3><p class="step-description">A retail audit closes each zone before the next begins, so nothing is carried between them mid-count. Shelf first while it is undisturbed, backroom second, and goods received but not yet put away treated as their own population.</p></div><div class="step-visual"><div class="step-illustration" style="padding:0;background:none;"><img src="/images/stock-audit/_library/steps/zone-sequence.webp" alt="Shelf, Backroom and Transit Zones in Sequence" loading="lazy" width="1200" height="896" style="width:100%;height:auto;border-radius:var(--radius-xl);"></div></div></div>
<div class="step-card"><div class="step-content"><span class="step-badge">Step 3</span><h3 class="step-title">Recount Rules for High-Value SKUs</h3><p class="step-description">Lines above an agreed value threshold are counted twice by different people, and any difference is resolved on the spot rather than logged. The threshold is set before fieldwork so it cannot be adjusted afterwards to reduce the exception list.</p></div><div class="step-visual"><div class="step-illustration" style="padding:0;background:none;"><img src="/images/stock-audit/_library/steps/sample-test.webp" alt="Recount Rules for High-Value SKUs" loading="lazy" width="1200" height="896" style="width:100%;height:auto;border-radius:var(--radius-xl);"></div></div></div>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <ul class="pa-doc-list"><li><strong>POS Stock Report per Store</strong> - The system stock position for each store as at the cut-off, taken store by store rather than as a chain total, since a retail audit reports variance at store level.</li>
<li><strong>Goods Receipt and Stock Transfer Notes</strong> - Receipts into each store and transfers between stores for the period around the cut-off. Inter-store movement is where the same carton is most often counted twice.</li>
<li><strong>Damage, Expiry and Write-Off Registers</strong> - What has been cleared as damaged, expired or written off, and when. Stock removed physically but never written off is a difference that looks like shrinkage.</li></ul>
...
<section class="content-section" id="challenges-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Shrinkage, Returns and Store-Level Variance</h2>
            <div class="content-text">
                <div class="table-responsive-wrapper">
                <table>
                    <thead><tr><th>Issue</th><th>What It Does to the Count</th></tr></thead>
                    <tbody>
                        <tr><td><strong>Shrinkage Nobody Has Split Between Theft, Damage and Error</strong></td><td>One unexplained figure absorbing three different problems with three different fixes. A retail audit can quantify it; separating the causes needs the store's own records behind it.</td></tr>
<tr><td><strong>Customer Returns Sitting Outside the System</strong></td><td>Goods accepted back at the counter and put on the shelf before anything is entered. The stock is present, saleable and invisible until a count finds it.</td></tr>
<tr><td><strong>Stores That Count Themselves</strong></td><td>Self-counted stock reported as verified. Where the person counting is also answerable for the variance, the figure has not been independently established at all.</td></tr>
        ...
        <div class="text-content">
            ...
            <div class="content-text">
                ...
                <table>
                    ...
                    <tbody>
                        <tr><td><strong>Store Count and Geographic Spread</strong></td><td>A retail audit prices on the number of stores and how far apart they sit. Ten stores in one city and ten across four states are very different pieces of work.</td></tr>
<tr><td><strong>SKU Density Inside Each Store</strong></td><td>A convenience format and a department store occupy similar floor area and hold entirely different line counts, which is what the counting hours actually follow.</td></tr>
<tr><td><strong>Whether Counts Run Overnight</strong></td><td>Counting before trading opens avoids reconciling till movement, and it moves the work into hours that carry a different cost to staff.</td></tr>
                ...
                <p style="margin-top:16px;"><strong>Get a free Stock Audit for Retail consultation - <a href="tel:+919459456700">Call +91 945 945 6700</a> or <a href="https://wa.me/919459456700?text=Hello%2C%20I%20just%20visited%20your%20Stock%20Audit%20for%20Retail%20Services%20page.%20I%20would%20like%20to%20know%20more%20about%20it." target="_blank" rel="noopener">WhatsApp us</a>. No-obligation assessment.</strong></p>
            </div>
        </div>
    </div>
</section>
...
<section class="why-choose-section" id="benefits-section">
    <div class="section-container">
        ...
        <div class="features-grid pa-cols-3"><article class="feature-card"><div class="feature-icon feature-icon--navy"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#19355E" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M3 3v16a2 2 0 0 0 2 2h16" /> <path d="M18 17V9" /> <path d="M13 17V5" /> <path d="M8 17v-3" /> </svg></div><h3 class="feature-title">Which Stores Actually Lose Stock</h3><p class="feature-text">A retail audit reports variance store by store on a like-for-like basis, so the outliers are identifiable rather than hidden inside a chain average.</p></article>
<article class="feature-card"><div class="feature-icon feature-icon--orange"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#F76722" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M13.744 17.736a6 6 0 1 1-7.48-7.48" /> <path d="M15 6h1v4" /> <path d="m6.134 14.768.866-.5 2 3.464" /> <circle cx="16" cy="8" r="6" /> </svg></div><h3 class="feature-title">Provisioning Backed by a Counted Number</h3><p class="feature-text">Damaged, expired and unsaleable lines quantified at the shelf, so a provisioning estimate becomes a figure with a physical count behind it.</p></article>
<article class="feature-card"><div class="feature-icon feature-icon--navy"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#19355E" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <rect width="8" height="4" x="8" y="2" rx="1" ry="1" /> <path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2" /> <path d="m9 14 2 2 4-4" /> </svg></div><h3 class="feature-title">A Baseline the Next Cycle Is Measured Against</h3><p class="feature-text">One documented method applied identically at every store, so the following count measures change rather than measuring a different procedure.</p></article></div>
    </div>
</section>
...
<section class="content-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">Counts Run in Retail</h2>
            <div class="content-text">
                
                <p style="font-size:16px"><strong>500+ stock audits completed.</strong></p><ul style="list-style:none;padding:0;margin:0 0 14px"><li style="margin-bottom:10px"><strong>Stores Counted and SKUs Verified</strong></li>
<li style="margin-bottom:10px"><strong>Retail Formats and Cities Covered</strong></li>
<li style="margin-bottom:10px"><strong>Overnight Turnaround Achieved</strong></li></ul><p style="font-size:14.5px">Across engagements run by the Patron team. The figure is counted from completed engagements only, and it is restated when it changes rather than rounded up and left. Scope for any one count is still agreed against your own site list.</p>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="why-patron-grid pa-cols-3">
                <article class="feature-card"><div class="feature-icon feature-icon--navy"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#19355E" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2" /> <path d="M16 3.128a4 4 0 0 1 0 7.744" /> <path d="M22 21v-2a4 4 0 0 0-3-3.87" /> <circle cx="9" cy="7" r="4" /> </svg></div><h3 class="feature-title">Crews Who Have Counted a Shop Floor Before</h3><p class="feature-text">A retail audit runs against tills, deliveries and customers, and crews used to that environment work around it rather than asking the store to stop while they finish.</p></article>
<article class="feature-card"><div class="feature-icon feature-icon--orange"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#F76722" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M13.744 17.736a6 6 0 1 1-7.48-7.48" /> <path d="M15 6h1v4" /> <path d="m6.134 14.768.866-.5 2 3.464" /> <circle cx="16" cy="8" r="6" /> </svg></div><h3 class="feature-title">Counts That Do Not Bring the Shutter Down</h3><p class="feature-text">Work is scheduled before trading or around it, so the count does not cost a day of sales to produce a figure the business needed anyway.</p></article>
<article class="feature-card"><div class="feature-icon feature-icon--navy"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#19355E" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2" /> <path d="M16 3.128a4 4 0 0 1 0 7.744" /> <path d="M22 21v-2a4 4 0 0 0-3-3.87" /> <circle cx="9" cy="7" r="4" /> </svg></div><h3 class="feature-title">One Team Across a Multi-City Chain</h3><p class="feature-text">The same team and the same checklist at every store, which is the only condition under which store-by-store variance can be compared honestly.</p></article>
            </div>
...
<section class="content-section" id="case-study-section">
    <div class="content-container">
        <div class="text-content">
            <h2 class="section-title">A Retail Count We Have Run</h2>
            
            <article class="pa-case pa-rm"><div class="pa-case-h"><h3>Where the Shrinkage Was Actually Sitting</h3><p class="pa-case-scale">showroom estate · shelf, backroom and transit counted separately</p><p class="pa-case-client">A jewellery and watch retail chain</p></div><ol class="pa-rm-track"><li class="pa-rm-stage"><span class="pa-rm-node">01</span><span class="pa-rm-lab">The challenge</span><p>Chain-level shrinkage was running a little over 1% and had been treated as a network-wide control problem. A chain-wide corrective programme was under consideration.</p></li><li class="pa-rm-stage"><span class="pa-rm-node">02</span><span class="pa-rm-lab">What we did</span><p>We counted with shelf stock, backroom stock and transit stock kept as three separate populations rather than one store total. High-value lines were verified in full rather than sampled, which in jewellery and watches is the only defensible basis.</p></li><li class="pa-rm-stage is-out"><span class="pa-rm-node">03</span><span class="pa-rm-lab">What the count found</span><p>Split by store, the shrinkage was not spread at all. A small number of locations carried most of it and the remainder sat within tolerance. Much of what looked like shrinkage in the clean stores was in fact stock present in the backroom and not on the shelf - available to sell, but invisible to the shop floor.</p></li><li class="pa-rm-stage"><span class="pa-rm-node">04</span><span class="pa-rm-lab">What changed</span><p>The corrective programme was redirected to the stores that needed it, and backroom replenishment was addressed separately as a availability problem rather than a loss one.</p></li></ol></article>
<article class="pa-case pa-rm"><div class="pa-case-h"><h3>A Chain Counted Across Cities in One Night</h3><p class="pa-case-scale">showrooms across several cities · counted simultaneously after close</p><p class="pa-case-client">A jewellery and watch retail chain</p></div><ol class="pa-rm-track"><li class="pa-rm-stage"><span class="pa-rm-node">01</span><span class="pa-rm-lab">The challenge</span><p>Showrooms transfer stock between themselves on inter-branch notes that clear on their own timetable. Counting cities on separate nights meant the same pieces could appear in two counts, and the consolidated figure had never been trusted.</p></li><li class="pa-rm-stage"><span class="pa-rm-node">02</span><span class="pa-rm-lab">What we did</span><p>Every showroom was counted simultaneously after close, with inter-branch transfers frozen from the same hour. Teams were briefed centrally and high-value lines verified in full.</p></li><li class="pa-rm-stage is-out"><span class="pa-rm-node">03</span><span class="pa-rm-lab">What the count found</span><p>Stock in transit between showrooms at the cut-off was identified and allocated once. The chain total reconciled to the system position rather than approximating it.</p></li><li class="pa-rm-stage"><span class="pa-rm-node">04</span><span class="pa-rm-lab">What changed</span><p>The count was complete before opening the next morning, with no trading day lost, and the reconciliation was issued within the week.</p></li></ol></article></div>
    </div>
</section>
        ...
        <div class="text-content">
            ...
            <div class="faq-expanded">
                <aside class="faq-expanded__aside">
                    <h2 class="faq-expanded__title">Retail Stock Audit: Common Questions</h2>
                ...
                <div class="faq-expanded__list">
                    <div class="faq-expanded__item"><h3 class="faq-expanded__q">Can a stock audit be done without closing the store?</h3><div class="faq-expanded__a"><p>Yes. Cycle counting sections of the store, or counting outside trading hours, avoids closing. A full wall-to-wall count is faster and cleaner but needs the store shut or trading frozen. Most chains use cycle counts through the year and a full count at year end.</p></div></div>
<div class="faq-expanded__item"><h3 class="faq-expanded__q">What is the difference between a retail audit and a mystery audit?</h3><div class="faq-expanded__a"><p>A retail audit is announced and examines stock, pricing and compliance with staff present. A mystery audit is covert and measures the customer experience. Chains commonly run both because each finds problems the other cannot see.</p></div></div>
<div class="faq-expanded__item"><h3 class="faq-expanded__q">What is a retail audit?</h3><div class="faq-expanded__a"><p>A retail audit is an independent check of what is actually happening in a store: stock on hand against system records, planogram and display compliance, pricing and MRP accuracy, expiry, and shrinkage. It gives head office evidence from the shop floor rather than a report filed by the store itself.</p></div></div>
<div class="faq-expanded__item"><h3 class="faq-expanded__q">How do audits work in a retail chain?</h3><div class="faq-expanded__a"><p>Auditors visit stores on a rotating schedule, count stock in defined categories, compare against the POS or ERP balance, and record variances by SKU and by store. Results are reported store by store so head office can rank outlets and target the ones with persistent gaps.</p></div></div>
<div class="faq-expanded__item"><h3 class="faq-expanded__q">What should a retail store audit checklist cover?</h3><div class="faq-expanded__a"><p>A workable checklist covers physical stock count by category, high-value item verification, expiry and near-expiry stock, damaged and unsaleable goods, price and MRP tags against the master, planogram compliance, cash and till reconciliation, and back-store stock not on the shop floor.</p></div></div>
<div class="faq-expanded__item"><h3 class="faq-expanded__q">What counts as normal shrinkage in Indian retail?</h3><div class="faq-expanded__a"><p>Shrinkage varies sharply by format and category, so a single benchmark is misleading. The useful comparison is your own trend by store and category over time. An outlet that suddenly moves away from its own historic range matters more than one that sits above a published industry average.</p></div></div>
<div class="faq-expanded__item"><h3 class="faq-expanded__q">Why do two stores report different stock accuracy?</h3><div class="faq-expanded__a"><p>Differences usually trace to process rather than dishonesty: inconsistent goods-inward recording, unrecorded inter-store transfers, damaged stock written off at different points, or POS overrides. An audit that reports variance by cause rather than a single percentage tells you which store needs training.</p></div></div>
<div class="faq-expanded__item"><h3 class="faq-expanded__q">How often should a retail chain count stock?</h3><div class="faq-expanded__a"><p>Most chains combine a full count once or twice a year with cycle counts of high-value or fast-moving lines every month. Frequency should follow risk: outlets with high shrinkage, high staff turnover or weak prior scores warrant more frequent counts than stable stores.</p></div></div>
<div class="faq-expanded__item"><h3 class="faq-expanded__q">What is planogram compliance and why is it audited?</h3><div class="faq-expanded__a"><p>Planogram compliance measures whether the shelf layout in the store matches the layout head office specified. It is audited alongside stock because the two interact: missing facings often reveal stock that the system says is on hand but is not on the floor.</p></div></div>
<div class="faq-expanded__item"><h3 class="faq-expanded__q">How is expiry and near-expiry stock treated in a retail audit?</h3><div class="faq-expanded__a"><p>Auditors segregate expired stock, quantify near-expiry stock by remaining shelf life, and check whether it has been provided for in the books. Stock past its date that still sits in the system at full value is one of the most common valuation findings in retail.</p></div></div>
                </div>
            </div>
...
<a href="https://www.patronaccounting.com/blog/stock-audit-retail-fmcg-perishables-expiry-shrinkage" class="pa-read-card">Retail Shrinkage Benchmarks in India: What Counts as Normal at Audit<span class="pa-read-go">&rarr;</span></a></div></div></div></section>
    ...
    <div class="content-container">
        <div class="text-content">
            ...
            <div class="content-text" style="text-align:left;">
                ...
                <h3>What We Need From Each Store Manager</h3>
<p>A system stock report as at the cut-off, the receipt and transfer notes around it, and confirmation of who opens the store. A retail audit runs on those three per site.</p>
<h3>Lead Time for a Chain-Wide Cycle</h3>
<p>Chain cycles are planned around trading calendars, so lead time reflects how many stores run in parallel and whether counting happens before doors open.</p>

            </div>
            <div style="display:flex;gap:14px;flex-wrap:wrap;margin-top:24px;">
                <a href="tel:+919459456700" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:var(--orange);color:#fff;border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#128222; Call +91 945 945 6700</a>
                <a href="https://wa.me/919459456700?text=Hello%2C%20I%20just%20visited%20your%20Stock%20Audit%20for%20Retail%20Services%20page.%20I%20would%20like%20to%20know%20more%20about%20it." target="_blank" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:#25D366;color:#fff;border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;" rel="noopener">&#128172; WhatsApp Us</a>
                <a href="mailto:sales@patronaccounting.com?subject=Enquiry%20for%20Stock Audit for Retail%20Services&body=Hello%2C%20I%20just%20visited%20your%20Stock%20Audit%20for%20Retail%20Services%20page.%20I%20would%20like%20to%20know%20more%20about%20it.%0A%0AThank%20you." style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:transparent;color:#fff;border:2px solid rgba(255,255,255,0.3);border-radius:50px;font-weight:700;font-size:15px;text-decoration:none;transition:all 0.25s;">&#9993;&#65039; Email Us</a>
            </div>
...
<div class="wa-sticky-bar" id="waBar">
    <div class="wa-sticky-bar-content">
        ...
        <a href="https://wa.me/919459456700?text=Hello%2C%20I%20just%20visited%20your%20Stock%20Audit%20for%20Retail%20Services%20page.%20I%20would%20like%20to%20know%20more%20about%20it." target="_blank" rel="noopener" class="wa-sticky-bar-btn">
