...
<li><span style="color:var(--orange);font-weight:600;">Retail</span></li>
</ol>
    </div>
</nav>
            ...
            <div class="col-lg-4">
                <div class="form-card" id="consultationFormCard">
                    ...
                    <form id='BiginWebToRecordForm208810000001209168'
                        ...
                        <input type='hidden' name='Potential Name' id='dealNameField' value='Website Enquiry - Stock Audit for Retail'/>
...
<option value='Stock Audit for Retail' selected>Stock Audit for Retail</option>
