        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                @include('partials.enquiry-form', [
                    'selected' => 'trademark-registration',
                    'options'  => [
                        'trademark-registration' => 'Trademark Registration',
                        'trademark-search-report' => 'Trademark Search Report',
                        'trademark-formality-check-fail' => 'Trademark Formality Check Fail',
                        'trademark-notice' => 'Trademark Notice / Objection Reply',
