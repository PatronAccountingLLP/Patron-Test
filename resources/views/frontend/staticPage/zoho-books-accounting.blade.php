...
<section class="pa-logos-section"><div class="pa-logos-wrap"><p class="pa-logos-title">The software and platforms we work with</p><div class="pa-logos-cards" data-count="3"><div class="pa-logo-card"><img src="/images/accounting-cluster/_platform-logos/zoho-books.webp" alt="Zoho Books" loading="lazy"></div><div class="pa-logo-card"><img src="/images/accounting-cluster/_platform-logos/tally.webp" alt="Tally" loading="lazy"></div><div class="pa-logo-card"><img src="/images/accounting-cluster/_platform-logos/xero.webp" alt="Xero" loading="lazy"></div></div></div></section><section class="content-section" id="services-section">
    <div class="content-container">
        <div class="text-content">
