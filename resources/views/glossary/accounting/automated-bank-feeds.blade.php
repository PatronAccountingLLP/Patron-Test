...
@section('meta')
    <title>Automated Bank Feeds: Meaning and Example in Accounting</title>
    ...
    <meta property="og:title" content="Automated Bank Feeds: Meaning and Example in Accounting | Patron Accounting">
...
<script type="application/ld+json">
{
  ...
  "@graph": [
    ...
    },
    {
      ...
      "headline": "What Are Automated Bank Feeds? Meaning and How It Works",
    ...
    },
    {
      "@type": "WebPage",
      "@id": "https://www.patronaccounting.com/glossary/accounting/automated-bank-feeds",
      "name": "Automated Bank Feeds: Meaning and Example in Accounting",
      "description": "A direct connection that imports bank lines without manual entry. Explained simply, with the ledger entry that goes with it. Reviewed by our CA team.",
      "url": "https://www.patronaccounting.com/glossary/accounting/automated-bank-feeds",
      "inLanguage": "en-IN",
      "isPartOf": {
