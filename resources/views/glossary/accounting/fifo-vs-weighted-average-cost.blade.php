...
@include('partials.bigin-form', [
    'variant'  => 'compact',
    'service'  => 'Glossary - FIFO vs Weighted Average Cost',
    'title'    => 'Talk to a CA about your books',
    'subtitle' => 'Share your accounting software and we\'ll scope the work.',
    'note'     => 'This enquiry came from the glossary page "FIFO vs Weighted Average Cost", which explains a term rather than selling a service - please ask the client which service they are looking for.',
])
