...
@section('meta')
    <title>Ledger Mapping Schema: Meaning, Definition and Example</title>
    ...
    <meta property="og:title" content="Ledger Mapping Schema: Meaning, Definition and Example | Patron Accounting">
...
<script type="application/ld+json">
{
  ...
  "@graph": [
    ...
    },
    {
      ...
      "headline": "What Is a Ledger Mapping Schema? Definition and How It Works",
    ...
    },
    {
      "@type": "WebPage",
      "@id": "https://www.patronaccounting.com/glossary/accounting/ledger-mapping-schema",
      "name": "Ledger Mapping Schema: Meaning, Definition and Example",
      "description": "The old-ledger to new-ledger map a migration is reconciled against. Defined in plain English, with an example of where it shows up. In plain English.",
      "url": "https://www.patronaccounting.com/glossary/accounting/ledger-mapping-schema",
      "inLanguage": "en-IN",
      "isPartOf": {
