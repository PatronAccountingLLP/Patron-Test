...
@include('partials.bigin-form', [
    'variant'  => 'compact',
    'service'  => 'Glossary - Trial Balance',
    'title'    => 'Talk to a CA about your books',
    'subtitle' => 'Share your accounting software and we\'ll scope the work.',
    'note'     => 'This enquiry came from the glossary page "Trial Balance", which explains a term rather than selling a service - please ask the client which service they are looking for.',
])
