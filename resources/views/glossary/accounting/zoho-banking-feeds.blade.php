...
@section('meta')
    <title>Zoho Banking Feeds: Meaning and Example in Accounting</title>
    ...
    <meta property="og:title" content="Zoho Banking Feeds: Meaning and Example in Accounting | Patron Accounting">
...
<script type="application/ld+json">
{
  ...
  "@graph": [
    ...
    },
    {
      ...
      "headline": "What Are Zoho Banking Feeds? Definition and How It Works",
    ...
    },
    {
      "@type": "WebPage",
      "@id": "https://www.patronaccounting.com/glossary/accounting/zoho-banking-feeds",
      "name": "Zoho Banking Feeds: Meaning and Example in Accounting",
      "description": "Bank transactions pulled into Zoho Books automatically for matching. What it means, why it matters and where you will meet it. Part of our glossary.",
      "url": "https://www.patronaccounting.com/glossary/accounting/zoho-banking-feeds",
      "inLanguage": "en-IN",
      "isPartOf": {
