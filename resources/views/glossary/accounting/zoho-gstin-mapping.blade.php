...
@section('meta')
    <title>Zoho GSTIN Mapping: Meaning and Example in Accounting</title>
    ...
    <meta property="og:title" content="Zoho GSTIN Mapping: Meaning and Example in Accounting | Patron Accounting">
...
<script type="application/ld+json">
{
  ...
  "@graph": [
    ...
    },
    {
      ...
      "headline": "What Is Zoho GSTIN Mapping? Definition and How It Works",
    ...
    },
    {
      "@type": "WebPage",
      "@id": "https://www.patronaccounting.com/glossary/accounting/zoho-gstin-mapping",
      "name": "Zoho GSTIN Mapping: Meaning and Example in Accounting",
      "description": "Mapping each GSTIN to its branch so Zoho files against the right state. The definition, the entry it drives and the mistake. Browse the glossary.",
      "url": "https://www.patronaccounting.com/glossary/accounting/zoho-gstin-mapping",
      "inLanguage": "en-IN",
      "isPartOf": {
