...
@verbatim
<div class="gl-page">
  <section class="gl-hero"><div class="gl-wrap gl-herogrid"><div class="gl-heromain"><div class="gl-cat">Accounting Glossary &middot; Core / Software</div><h1 class="gl-h1">Zoho GSTIN Mapping</h1><div class="gl-byline"><span class="ok"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg></span><span class="who">Reviewed by CA &amp; CS Team, Patron Accounting LLP</span><span class="sep">&middot;</span><span>Last updated 22 Jul 2026</span><span class="sep">&middot;</span><span>5 min read</span><span class="sep">&middot;</span><span class="lvl">Intermediate</span></div></div><aside class="gl-rotcta" data-rotate><div class="gl-cta-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z"/></svg></div><div class="gl-rotcta__slides"><div class="gl-rotcta__slide is-active"><h3>Prefer a CA to handle your books?</h3><p>Talk to a Chartered Accountant about your accounting and compliance.</p><a class="gl-rotcta__btn" href="/contact-us">Talk to an Expert &rarr;</a></div><div class="gl-rotcta__slide"><h3>Need help with Zoho GSTIN Mapping?</h3><p>Zoho Books Accounting - our CA-led team handles it end to end.</p><a class="gl-rotcta__btn" href="/zoho-books-accounting">Explore the service &rarr;</a></div><div class="gl-rotcta__slide"><h3>Migration: Tally to Zoho Books</h3><p>A closely related service to keep your books and filings in order.</p><a class="gl-rotcta__btn" href="/migration-from-tally-to-zoho">Learn more &rarr;</a></div><div class="gl-rotcta__slide"><h3>Accounting &amp; Bookkeeping Services in India</h3><p>A closely related service to keep your books and filings in order.</p><a class="gl-rotcta__btn" href="/accounting-services">Learn more &rarr;</a></div><div class="gl-rotcta__slide"><h3>Have a question about Zoho GSTIN Mapping?</h3><p>Speak to a Chartered Accountant - no obligation.</p><a class="gl-rotcta__btn" href="/contact-us">Book a call &rarr;</a></div></div><div class="gl-rotcta__dots"><span class="gl-rotcta__dot is-active" data-i="0"></span><span class="gl-rotcta__dot" data-i="1"></span><span class="gl-rotcta__dot" data-i="2"></span><span class="gl-rotcta__dot" data-i="3"></span><span class="gl-rotcta__dot" data-i="4"></span></div></aside></div></section>
...
@include('partials.bigin-form', [
    'variant'  => 'compact',
    'service'  => 'Glossary - Zoho GSTIN Mapping',
    'title'    => 'Talk to a CA about your books',
    'subtitle' => 'Share your accounting software and we\'ll scope the work.',
    'note'     => 'This enquiry came from the glossary page "Zoho GSTIN Mapping", which explains a term rather than selling a service - please ask the client which service they are looking for.',
])
