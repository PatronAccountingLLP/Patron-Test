...
@section('meta')
<title>Book Debt: What It Means in Working Capital Lending</title>
<meta name="description" content="Book debt is the money your customers owe you. Alongside stock it forms the drawing power base a lender lends against, which is why auditors verify it.">
<link rel="canonical" href="https://www.patronaccounting.com/glossary/stock-audit/book-debt">
...
<script type="application/ld+json">
{
    ...
    "itemListElement": [
        ...
        },
        {
            ...
            "position": 4,
            "name": "Book Debt",
            "item": "https://www.patronaccounting.com/glossary/stock-audit/book-debt"
        }
    ],
    "@id": "https://www.patronaccounting.com/glossary/stock-audit/book-debt/#breadcrumb"
}
</script><script type="application/ld+json">
{
    "@context": "https://schema.org",
    "@type": "FAQPage",
    "@id": "https://www.patronaccounting.com/glossary/stock-audit/book-debt/#faq",
    "mainEntity": [
        {
            "@type": "Question",
            "name": "How are book debts verified alongside stock?",
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "By ageing the receivables ledger, testing a sample against invoices and acknowledgements, and identifying debts beyond the period the lender treats as eligible. Old debts commonly remain in the base long after they should have been excluded."
            }
        },
        {
            "@type": "Question",
            "name": "Why are old book debts excluded from the drawing power base?",
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "Because their realisability falls with age. Lenders normally set an eligibility period and exclude anything older, so a borrower carrying long-overdue receivables in the statement is overstating the base rather than the balance sheet."
            }
        },
        {
            "@type": "Question",
            "name": "Are related-party receivables treated differently?",
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "Usually yes. Lenders often exclude or discount receivables from group companies because they are not arm-length and may not convert to cash on normal terms. Identifying them separately avoids a dispute during the audit."
            }
        }
    ]
}
...
<div class="gl-page"><section class="gl-hero"><div class="gl-wrap gl-herogrid"><div class="gl-heromain"><nav class="gl-crumb" aria-label="Breadcrumb"><a href="https://www.patronaccounting.com/">Home</a><span class="sep">&rsaquo;</span><a href="/glossary/stock-audit">Glossary</a><span class="sep">&rsaquo;</span><a href="/stock-audit">Stock Audit</a><span class="sep">&rsaquo;</span><span class="cur">Book Debt</span></nav><div class="gl-cat">Stock Audit Glossary &middot; The Lending Trigger</div><h1 class="gl-h1">Book Debt</h1><div class="gl-byline"><span class="ok"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg></span><span class="who">Reviewed by CA &amp; CS Team, Patron Accounting LLP</span><span class="sep">&middot;</span><span>5 min read</span></div></div><aside class="gl-herocta"><div class="gl-cta-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z"/></svg></div><h3>Prefer a CA to run the count?</h3><p>This term describes something an auditor has to establish on site. That is the work we do.</p><a class="gl-herocta__btn" href="/stock-audit">Talk to an Expert &rarr;</a><div class="gl-herocta__trust"><span class="star">&#9733;</span> 4.9 on Google &middot; UDIN on every report</div></aside></div></section><div class="gl-tocbar"><div class="gl-wrap gl-toc"><a href="#definition" class="gl-pill is-active">Definition</a><a href="#what-is" class="gl-pill">What it is</a><a href="#covenant" class="gl-pill">In the sanction letter</a><a href="#compliance" class="gl-pill">Under Indian law</a><a href="#how-works" class="gl-pill">How it works</a><a href="#example" class="gl-pill">Example</a><a href="#mistakes" class="gl-pill">Mistakes</a><a href="#related" class="gl-pill">Related terms</a><a href="#faq-section" class="gl-pill">FAQs</a></div></div><div class="gl-body"><div class="gl-wrap"><div class="gl-grid"><div class="gl-main"><section id="definition" class="gl-sec"><div class="gl-eyebrow">Book Debt: Definition</div><div class="definition-box"><p>A book debt is an amount a customer owes the business for goods supplied or services rendered, recorded in the sales ledger and not yet collected. Together with inventory it forms the current asset base a working capital facility is secured against. Lenders treat book debts by age, and receivables outstanding beyond a stated period are usually excluded from the figure the facility is computed on.</p></div></section><section id="what-is" class="gl-sec"><h2>What Is a Book Debt?</h2><p>A receivable is an asset that exists only as a promise, which is what makes it awkward as security. There is nothing to count and nothing to inspect; its value depends entirely on whether the customer pays, and that becomes less likely the longer the amount stays outstanding. Lenders manage this through ageing, treating receivables within a defined period as eligible and excluding older ones altogether, so a business with slow collections finds that a substantial part of its debtor book supports no borrowing at all.</p><p>Verification therefore looks different from a stock count. The exercise tests whether the invoices are supported by orders and despatch documents, whether the balances agree to the ledger, whether credit notes and returns have been properly recorded, and whether any customer disputes the amount. Balances owed by related parties are usually excluded, as are amounts already assigned or factored elsewhere. What emerges is an eligible figure that is frequently well below the debtor total the accounts show.</p></section><section id="covenant" class="gl-sec"><h2>Where Book Debt Appears in a Sanction Letter</h2><p>Receivables are dealt with separately from stock, usually in the same clauses but on their own terms.</p><ul class="gloss-bullets"><li>The security description, which extends the charge to present and future receivables rather than only those existing at sanction.</li><li>The eligibility clause, stating the age beyond which a receivable is excluded from the computation entirely, commonly expressed in days.</li><li>The margin clause, which frequently applies a different percentage to receivables than to stock, reflecting that one can be counted and the other cannot.</li><li>The exclusions, naming balances owed by associate concerns, amounts already factored or discounted elsewhere, and anything under dispute.</li><li>The submission covenant, requiring an aged analysis rather than a single total, which is why a statement giving only a debtors figure is returned rather than processed.</li></ul></section><section id="compliance" class="gl-sec"><h2>Book Debt Under Indian Law</h2><p>Position: no regulation prescribes how drawing power is computed or which receivables are eligible. The Reserve Bank does not lay down a formula, an ageing cut-off or a margin percentage for book debts. Each of those is set by the individual bank's board-approved credit policy and appears in the borrower's sanction letter.</p><ul class="gloss-bullets"><li>Common practice applies an ageing exclusion, frequently at ninety or one hundred and twenty days, and a margin distinct from the one applied to stock. Both vary by bank, by industry and by borrower rating.</li><li>Source: the bank's own loan policy and the sanction letter, not any RBI circular.</li><li>Note: a borrower told that a ninety day cut-off is a regulatory requirement is being told something incorrect. It is a negotiable term of the facility.</li></ul></section><section id="how-works" class="gl-sec"><h2>How Book Debt Works in Practice</h2><ol><li>Goods are supplied on credit and an invoice is raised. The amount enters the sales ledger as a receivable and stays there until the customer pays.</li></ol><ol><li>The balance is aged, grouping each amount by how long it has been outstanding, because the likelihood of collection falls as time passes.</li></ol><ol><li>Receivables beyond the period the sanction permits are excluded, as are amounts owed by related parties, balances already factored or assigned, and anything the customer is disputing.</li></ol><ol><li>What survives those exclusions is the eligible figure, and the lender applies its own margin to it before the amount contributes to what may be drawn.</li></ol><ol><li>At verification the surviving balances are tested against orders, despatch records and the ledger, and confirmations may be sought from customers directly, which is the only evidence that does not originate inside the business.</li></ol></section><section id="example" class="gl-sec"><h2>Book Debt: A Worked Example</h2><div class="gloss-table-wrap"><table class="gloss-table"><thead><tr><th>Ageing bucket</th><th>Gross receivable</th><th>Eligible?</th><th>Reason</th></tr></thead><tbody><tr><td>0-90 days</td><td>Rs 2,40,00,000</td><td>Yes</td><td>Within the sanctioned ageing limit</td></tr><tr><td>91-180 days</td><td>Rs 62,00,000</td><td>No</td><td>Beyond the eligibility window</td></tr><tr><td>Over 180 days</td><td>Rs 18,00,000</td><td>No</td><td>Beyond the window; provision expected</td></tr><tr><td>Due from a group company</td><td>Rs 35,00,000</td><td>No</td><td>Related party, excluded by sanction</td></tr><tr><td>Eligible book debt</td><td>Rs 2,40,00,000</td><td>-</td><td>-</td></tr></tbody></table></div><figure class="pa-chart"><figcaption>Gross receivable</figcaption><div class="pa-chart-scroll"><svg viewBox="0 0 466 210" width="466" height="210" role="img" aria-label="Gross receivable"><rect x="26" y="30" width="62" height="150" rx="5" fill="#14365F"/><text x="57" y="22" text-anchor="middle" font-size="12" font-weight="700" fill="#14365F">24,000,000</text><text x="57" y="198" text-anchor="middle" font-size="11" fill="#6B7280">0-90 days</text><rect x="114" y="141" width="62" height="39" rx="5" fill="#14365F"/><text x="145" y="133" text-anchor="middle" font-size="12" font-weight="700" fill="#14365F">6,200,000</text><text x="145" y="198" text-anchor="middle" font-size="11" fill="#6B7280">91-180 days</text><rect x="202" y="169" width="62" height="11" rx="5" fill="#14365F"/><text x="233" y="161" text-anchor="middle" font-size="12" font-weight="700" fill="#14365F">1,800,000</text><text x="233" y="198" text-anchor="middle" font-size="11" fill="#6B7280">Over 180 days</text><rect x="290" y="158" width="62" height="22" rx="5" fill="#14365F"/><text x="321" y="150" text-anchor="middle" font-size="12" font-weight="700" fill="#14365F">3,500,000</text><text x="321" y="198" text-anchor="middle" font-size="11" fill="#6B7280">Due from a group</text><rect x="378" y="30" width="62" height="150" rx="5" fill="#E8712C"/><text x="409" y="22" text-anchor="middle" font-size="12" font-weight="700" fill="#14365F">24,000,000</text><text x="409" y="198" text-anchor="middle" font-size="11" fill="#6B7280">Eligible book de</text><line x1="0" y1="181" x2="466" y2="181" stroke="#E5E7EB" stroke-width="1"/></svg></div></figure><p>A Pune auto-components supplier reports Rs 3.55 crore of receivables in its monthly statement. Only Rs 2.40 crore of that reaches the drawing power calculation.</p><p>Three separate exclusions do the work, and they are cumulative rather than alternative. Ageing removes Rs 80 lakh. The related-party filter removes a further Rs 35 lakh that was inside the ninety-day window and would otherwise have qualified. Borrowers frequently report the gross figure in good faith and are surprised when the eligible number lands a third lower. Reading the sanction letter for which exclusions apply, before the statement is filed rather than after, avoids a correction that looks like misreporting when it was only an oversight.</p></section><section id="mistakes" class="gl-sec"><h2>Common Mistakes With Book Debt</h2><p>Receivables are where borrowers most often overstate what is genuinely available to them.</p><ul class="gloss-bullets"><li>Reporting a single debtors total with no ageing, which cannot be used without further work and is usually returned. Supply the ageing with the statement.</li><li>Including balances owed by group or related parties, which are almost always excluded from the eligible figure. Identify and remove them before reporting.</li><li>Carrying invoices that have already been factored or assigned elsewhere, so the same receivable supports two arrangements. Exclude anything already pledged.</li><li>Leaving credit notes and returns unprocessed at the period end, which inflates the balance by amounts the customer will never pay. Post them before the cut-off.</li><li>Assuming a disputed invoice still counts because it has not been formally written off. A customer contesting the amount is not an eligible receivable.</li></ul></section><section id="related" class="gl-sec"><h2>Related Stock Audit Terms</h2><p>Where several banks share the same security, the reporting runs through one of them, so <a href="/glossary/stock-audit/consortium-banking">consortium banking</a> is the entry to read next. Every other term in this cluster is listed in the <a href="/glossary/stock-audit">A-Z of stock audit terms</a>, grouped by the part of the work it belongs to.</p></section><section class="gl-cta"><div class="gl-cta__t"><h3>Need Help With Book Debt?</h3><p>This page explains the idea. The practical question begins when stock and receivables both have to be verified for a drawing power computation, and settling it means fieldwork of the kind <a href="/stock-audit">how we run a stock audit</a> sets out. Scope is built from the sites involved and the state of the underlying records.</p></div><div class="gl-cta__btns"><a class="gl-cta__primary" href="/stock-audit">How we run a stock audit &rarr;</a><a class="gl-cta__phone" href="tel:+919459456700">Book a consultation: +91 94594 56700</a></div></section></div><aside class="gl-aside"><div class="gl-card gl-card--service"><div class="gl-card__eyebrow">Related service</div><div class="gl-card__name">Stock Audit</div><p>CA-led stock and inventory counts for lenders and borrowers across India.</p><a class="gl-card__cta" href="/stock-audit">Explore the service &rarr;</a></div><div class="gl-card"><div class="gl-card__eyebrow">Where it is applied</div><ul><li><a href="/stock-audit">how we run a stock audit<span class="arw">&rarr;</span></a></li></ul></div><div class="gl-card"><div class="gl-card__eyebrow">Related terms</div><ul><li><a href="/glossary/stock-audit/consortium-banking">consortium banking<span class="arw">&rarr;</span></a></li><li><a href="/glossary/stock-audit">Stock Audit Glossary<span class="arw">&rarr;</span></a></li></ul></div></aside></div></div></div><section id="faq-section" class="gl-faq-section"><div class="faq-expanded"><aside class="faq-expanded__aside"><h2 class="faq-expanded__title">Book Debt FAQs</h2><p class="faq-expanded__lead">Common questions about Book Debt in a stock audit.</p><a class="faq-expanded__cta" href="https://www.patronaccounting.com/contact-us">Still have a question? Talk to a CA &rarr;</a><form class="faq-enquiry" action="https://www.patronaccounting.com/enquiry" method="post" novalidate><h3 class="faq-enquiry__title">Talk to the stock audit team</h3><p class="faq-enquiry__sub">Tell us where the stock sits and we will scope the count.</p><p class="faq-enquiry__context">Enquiring about: <strong>Book Debt</strong></p><input class="faq-enquiry__input" type="text" name="name" placeholder="Your name" required><input class="faq-enquiry__input" type="email" name="email" placeholder="Email" required><div class="faq-enquiry__phone"><span class="faq-enquiry__cc">+91</span><input class="faq-enquiry__input faq-enquiry__input--phone" type="tel" name="phone" placeholder="Mobile" required></div><button class="faq-enquiry__btn" type="submit">Get a Callback</button><p class="faq-enquiry__msg" role="status" aria-live="polite"></p><div class="faq-enquiry__badges"><span class="faq-enquiry__badge"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>CA-led team</span></div></form></aside><div class="faq-expanded__list"><div class="faq-expanded__item"><h3 class="faq-expanded__q" aria-expanded="true" aria-controls="faq-a1">How are book debts verified alongside stock?</h3><div class="faq-expanded__a" id="faq-a1"><p>By ageing the receivables ledger, testing a sample against invoices and acknowledgements, and identifying debts beyond the period the lender treats as eligible. Old debts commonly remain in the base long after they should have been excluded.</p></div></div><div class="faq-expanded__item"><h3 class="faq-expanded__q" aria-expanded="true" aria-controls="faq-a2">Why are old book debts excluded from the drawing power base?</h3><div class="faq-expanded__a" id="faq-a2"><p>Because their realisability falls with age. Lenders normally set an eligibility period and exclude anything older, so a borrower carrying long-overdue receivables in the statement is overstating the base rather than the balance sheet.</p></div></div><div class="faq-expanded__item"><h3 class="faq-expanded__q" aria-expanded="true" aria-controls="faq-a3">Are related-party receivables treated differently?</h3><div class="faq-expanded__a" id="faq-a3"><p>Usually yes. Lenders often exclude or discount receivables from group companies because they are not arm-length and may not convert to cash on normal terms. Identifying them separately avoids a dispute during the audit.</p></div></div></div></div></section><section class="gl-eeat-sec"><div class="eeat-review-wrap"><div class="eeat-review"><div class="eeat-review__badge"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>Reviewed by the CA &amp; CS Team, Patron Accounting LLP</div><div class="eeat-review__sources"><span>Official sources:</span> <a href="https://icai.org" target="_blank" rel="noopener">ICAI</a><a href="https://rbi.org.in" target="_blank" rel="noopener">RBI</a></div><div class="eeat-review__meta">ICAI &amp; ICSI registered &nbsp;&middot;&nbsp; Reviewed by CA Sundram Gupta (FCA) &nbsp;&middot;&nbsp; Last reviewed 20 August 2026 &nbsp;&middot;&nbsp; Next review 20 November 2026</div></div><p class="eeat-note">Last reviewed on 20 August 2026 by CA Sundram Gupta (FCA). Definitions are reviewed against the standard or lender practice they describe, and restated when that moves.</p></div></section><footer class="gl-foot"><div class="gl-foot__in"><a href="/glossary/stock-audit">&larr; Back to the stock audit glossary</a></div></footer></div>
@endverbatim
@endsection
