...
@section('meta')
<title>Mark-Down: Cutting Price and Cutting Carrying Value</title>
<meta name="description" content="A mark-down is a deliberate reduction in selling price, usually to clear ageing stock. It affects net realisable value and therefore the carrying figure.">
<link rel="canonical" href="https://www.patronaccounting.com/glossary/stock-audit/mark-down">
...
<script type="application/ld+json">
{
    ...
    "itemListElement": [
        ...
        },
        {
            ...
            "position": 4,
            "name": "Mark-Down",
            "item": "https://www.patronaccounting.com/glossary/stock-audit/mark-down"
        }
    ],
    "@id": "https://www.patronaccounting.com/glossary/stock-audit/mark-down/#breadcrumb"
}
</script><script type="application/ld+json">
{
    "@context": "https://schema.org",
    "@type": "FAQPage",
    "@id": "https://www.patronaccounting.com/glossary/stock-audit/mark-down/#faq",
    "mainEntity": [
        {
            "@type": "Question",
            "name": "How does a mark-down affect stock valuation?",
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "It reduces the expected selling price, so where the marked-down price is below cost the stock must be written down to net realisable value rather than continuing to be carried at cost."
            }
        },
        {
            "@type": "Question",
            "name": "When should a mark-down be recognised in the accounts?",
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "When the decision is taken that makes the stock unlikely to sell at full price, not when the discounted sale eventually occurs. Waiting for the sale itself defers the loss into a later period than the one in which the value was actually lost."
            }
        },
        {
            "@type": "Question",
            "name": "Do mark-downs distort shrinkage measurement?",
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "They can, if the value basis changes between count and comparison. Shrinkage should be measured at a consistent cost basis, otherwise a price reduction shows up as a loss that never physically occurred."
            }
        }
    ]
}
...
<div class="gl-page"><section class="gl-hero"><div class="gl-wrap gl-herogrid"><div class="gl-heromain"><nav class="gl-crumb" aria-label="Breadcrumb"><a href="https://www.patronaccounting.com/">Home</a><span class="sep">&rsaquo;</span><a href="/glossary/stock-audit">Glossary</a><span class="sep">&rsaquo;</span><a href="/stock-audit">Stock Audit</a><span class="sep">&rsaquo;</span><span class="cur">Mark-Down</span></nav><div class="gl-cat">Stock Audit Glossary &middot; Sector Vocabulary</div><h1 class="gl-h1">Mark-Down</h1><div class="gl-byline"><span class="ok"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg></span><span class="who">Reviewed by CA &amp; CS Team, Patron Accounting LLP</span><span class="sep">&middot;</span><span>4 min read</span></div></div><aside class="gl-herocta"><div class="gl-cta-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z"/></svg></div><h3>Prefer a CA to run the count?</h3><p>This term describes something an auditor has to establish on site. That is the work we do.</p><a class="gl-herocta__btn" href="/stock-audit">Talk to an Expert &rarr;</a><div class="gl-herocta__trust"><span class="star">&#9733;</span> 4.9 on Google &middot; UDIN on every report</div></aside></div></section><div class="gl-tocbar"><div class="gl-wrap gl-toc"><a href="#definition" class="gl-pill is-active">Definition</a><a href="#what-is" class="gl-pill">What it is</a><a href="#sector" class="gl-pill">By sector</a><a href="#how-works" class="gl-pill">How it works</a><a href="#example" class="gl-pill">Example</a><a href="#mistakes" class="gl-pill">Mistakes</a><a href="#related" class="gl-pill">Related terms</a><a href="#faq-section" class="gl-pill">FAQs</a></div></div><div class="gl-body"><div class="gl-wrap"><div class="gl-grid"><div class="gl-main"><section id="definition" class="gl-sec"><div class="gl-eyebrow">Mark-Down: Definition</div><div class="definition-box"><p>A mark-down is a permanent reduction in the selling price of merchandise, taken because the goods are not expected to sell at the original price. It differs from a temporary promotional discount in that the lower price becomes the new price. Because it reduces the amount the stock will realise, a mark-down bears directly on the value at which the remaining inventory should be carried.</p></div></section><section id="what-is" class="gl-sec"><h2>What Is a Mark-Down?</h2><p>Reducing a price permanently is an admission about value rather than a sales tactic, which is what distinguishes it from a promotion. A promotional discount is temporary and the price returns; a mark-down establishes a new price because the goods will not sell at the old one. That difference determines the accounting, since only the second bears on what the remaining inventory is worth.</p><p>The consequence reaches valuation directly. Where stock is carried at cost and the reduced price less the costs of selling falls below it, a write-down is due whether or not the goods have actually sold. Where a retailer values inventory by working back from selling prices, the effect is larger still, because the margin assumption the whole method rests on no longer describes what the goods realise, and closing stock is overstated by the accumulated difference. Mark-down records are therefore examined closely at any retail verification, and unrecorded reductions applied at the shelf but never entered are a recurring finding.</p></section><section id="sector" class="gl-sec"><h2>Which Sectors Use Mark-Down and Why</h2><p>Any business that sets a shelf price uses the term, but it carries accounting weight in a narrower set.</p><ul class="gloss-bullets"><li>Fashion retail, where reductions are planned into the season from the outset and the timing of them decides the margin.</li><li>Grocery and fresh food, where price cuts run daily against remaining shelf life and the volume of them is substantial.</li><li>Electronics and white goods, where a superseded model is cleared at a reduction rather than held.</li><li>Department stores and multi-category formats that derive stock cost from ticket prices, where reductions corrupt the entire valuation approach rather than a single line.</li><li>It has little application in manufacturing or bulk commodities, where price is set at the point of contract and there is no ticket to reduce.</li></ul></section><section id="how-works" class="gl-sec"><h2>How Mark-Down Works in Practice</h2><ol><li>A line is identified as unlikely to clear at its current price, from sell-through tracking, an ageing report or a decision to exit the range.</li></ol><ol><li>A new price is approved at the level authorised for the amount involved, and the reduction is recorded centrally rather than applied only at the shelf.</li></ol><ol><li>The system is updated first and the ticket changed second, so the till charges what the records expect and no window opens in which the two disagree.</li></ol><ol><li>The accounting consequence is assessed immediately. Where the new price, less what it will cost to sell the goods, falls below what they cost, the shortfall is charged in that period whether or not anything has yet sold.</li></ol><ol><li>Where the valuation method derives cost from ticket prices, the margin ratio is recalculated to absorb the reduction, since an unchanged ratio pushes the entire gap into the closing figure.</li></ol></section><section id="example" class="gl-sec"><h2>Mark-Down: A Worked Example</h2><div class="gloss-table-wrap"><table class="gloss-table"><thead><tr><th>Stage</th><th>Units</th><th>Price</th><th>Value realised</th></tr></thead><tbody><tr><td>Full price, weeks 1-8</td><td>405</td><td>Rs 2,499</td><td>Rs 10,12,095</td></tr><tr><td>First mark-down, 30%</td><td>480</td><td>Rs 1,749</td><td>Rs 8,39,520</td></tr><tr><td>Second mark-down, 50%</td><td>390</td><td>Rs 1,249</td><td>Rs 4,87,110</td></tr><tr><td>Clearance, 70%</td><td>225</td><td>Rs 749</td><td>Rs 1,68,525</td></tr><tr><td>Total on 1,500 units</td><td>1,500</td><td>-</td><td>Rs 25,07,250</td></tr></tbody></table></div><figure class="pa-chart"><figcaption>Value realised</figcaption><div class="pa-chart-scroll"><svg viewBox="0 0 466 210" width="466" height="210" role="img" aria-label="Value realised"><rect x="26" y="119" width="62" height="61" rx="5" fill="#14365F"/><text x="57" y="111" text-anchor="middle" font-size="12" font-weight="700" fill="#14365F">1,012,095</text><text x="57" y="198" text-anchor="middle" font-size="11" fill="#6B7280">Full price, week</text><rect x="114" y="130" width="62" height="50" rx="5" fill="#14365F"/><text x="145" y="122" text-anchor="middle" font-size="12" font-weight="700" fill="#14365F">839,520</text><text x="145" y="198" text-anchor="middle" font-size="11" fill="#6B7280">First mark-down,</text><rect x="202" y="151" width="62" height="29" rx="5" fill="#14365F"/><text x="233" y="143" text-anchor="middle" font-size="12" font-weight="700" fill="#14365F">487,110</text><text x="233" y="198" text-anchor="middle" font-size="11" fill="#6B7280">Second mark-down</text><rect x="290" y="170" width="62" height="10" rx="5" fill="#14365F"/><text x="321" y="162" text-anchor="middle" font-size="12" font-weight="700" fill="#14365F">168,525</text><text x="321" y="198" text-anchor="middle" font-size="11" fill="#6B7280">Clearance, 70%</text><rect x="378" y="30" width="62" height="150" rx="5" fill="#E8712C"/><text x="409" y="22" text-anchor="middle" font-size="12" font-weight="700" fill="#14365F">2,507,250</text><text x="409" y="198" text-anchor="middle" font-size="11" fill="#6B7280">Total on 1,500 u</text><line x1="0" y1="181" x2="466" y2="181" stroke="#E5E7EB" stroke-width="1"/></svg></div></figure><p>Style C from the same retailer, followed to the end of the season.</p><p>Against a full-price value of Rs 37.49 lakh the line realised Rs 25.07 lakh, so Rs 12.42 lakh of margin went in discount. The instructive part is the shape: each successive reduction moved fewer units than the one before, and the final 225 units at 70% off contributed under 7% of the total. Deeper cuts late in a season buy progressively less. A retailer reading only the closing stock figure sees the units clear and the problem look solved, while the buying error that created it sits entirely in the price column and is only visible if realised value is tracked against original ticket.</p></section><section id="mistakes" class="gl-sec"><h2>Common Mistakes With Mark-Down</h2><p>The accounting consequence is missed more often than the commercial one.</p><ul class="gloss-bullets"><li>Changing the shelf ticket without entering the reduction, so the system continues valuing the goods at a price nobody will pay.</li><li>Filing it as a temporary offer that will lapse, when a price cut meant to stick changes what the unsold balance is actually worth.</li><li>Waiting for the goods to sell before recognising the effect, since the charge arises as soon as the new price, net of what it takes to sell, drops under what was paid.</li><li>Failing to recompute the margin assumption where the valuation is derived from ticket prices, which carries the entire accumulated gap into closing stock.</li><li>Applying reductions store by store without recording them centrally, so nobody can reconcile the valuation across the estate.</li></ul></section><section id="related" class="gl-sec"><h2>Related Stock Audit Terms</h2><p>Whether the shelf matches the plan is the other retail measure taken on the same visit, so <a href="/glossary/stock-audit/planogram-compliance">planogram compliance</a> is the entry to read next. Every other term in this cluster is listed in the <a href="/glossary/stock-audit">stock audit terms</a>, grouped by the part of the work it belongs to.</p></section><section class="gl-cta"><div class="gl-cta__t"><h3>Need Help With Mark-Down?</h3><p>Knowing the term is not the same as knowing the position. Where reductions have moved the value of what remains, the answer comes from a site rather than from a page, and that is what <a href="/stock-audit-for-retail">stock audit for retail chains</a> covers. Send the location list and whatever records exist, and scope follows from those.</p></div><div class="gl-cta__btns"><a class="gl-cta__primary" href="/stock-audit">How we run a stock audit &rarr;</a><a class="gl-cta__phone" href="tel:+919459456700">Book a consultation: +91 94594 56700</a></div></section></div><aside class="gl-aside"><div class="gl-card gl-card--service"><div class="gl-card__eyebrow">Related service</div><div class="gl-card__name">Stock Audit</div><p>CA-led stock and inventory counts for lenders and borrowers across India.</p><a class="gl-card__cta" href="/stock-audit">Explore the service &rarr;</a></div><div class="gl-card"><div class="gl-card__eyebrow">Where it is applied</div><ul><li><a href="/stock-audit-for-retail">stock audit for retail chains<span class="arw">&rarr;</span></a></li></ul></div><div class="gl-card"><div class="gl-card__eyebrow">Related terms</div><ul><li><a href="/glossary/stock-audit/planogram-compliance">planogram compliance<span class="arw">&rarr;</span></a></li><li><a href="/glossary/stock-audit">Stock Audit Glossary<span class="arw">&rarr;</span></a></li></ul></div></aside></div></div></div><section id="faq-section" class="gl-faq-section"><div class="faq-expanded"><aside class="faq-expanded__aside"><h2 class="faq-expanded__title">Mark-Down FAQs</h2><p class="faq-expanded__lead">Common questions about Mark-Down in a stock audit.</p><a class="faq-expanded__cta" href="https://www.patronaccounting.com/contact-us">Still have a question? Talk to a CA &rarr;</a><form class="faq-enquiry" action="https://www.patronaccounting.com/enquiry" method="post" novalidate><h3 class="faq-enquiry__title">Talk to the stock audit team</h3><p class="faq-enquiry__sub">Tell us where the stock sits and we will scope the count.</p><p class="faq-enquiry__context">Enquiring about: <strong>Mark-Down</strong></p><input class="faq-enquiry__input" type="text" name="name" placeholder="Your name" required><input class="faq-enquiry__input" type="email" name="email" placeholder="Email" required><div class="faq-enquiry__phone"><span class="faq-enquiry__cc">+91</span><input class="faq-enquiry__input faq-enquiry__input--phone" type="tel" name="phone" placeholder="Mobile" required></div><button class="faq-enquiry__btn" type="submit">Get a Callback</button><p class="faq-enquiry__msg" role="status" aria-live="polite"></p><div class="faq-enquiry__badges"><span class="faq-enquiry__badge"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>CA-led team</span></div></form></aside><div class="faq-expanded__list"><div class="faq-expanded__item"><h3 class="faq-expanded__q" aria-expanded="true" aria-controls="faq-a1">How does a mark-down affect stock valuation?</h3><div class="faq-expanded__a" id="faq-a1"><p>It reduces the expected selling price, so where the marked-down price is below cost the stock must be written down to net realisable value rather than continuing to be carried at cost.</p></div></div><div class="faq-expanded__item"><h3 class="faq-expanded__q" aria-expanded="true" aria-controls="faq-a2">When should a mark-down be recognised in the accounts?</h3><div class="faq-expanded__a" id="faq-a2"><p>When the decision is taken that makes the stock unlikely to sell at full price, not when the discounted sale eventually occurs. Waiting for the sale itself defers the loss into a later period than the one in which the value was actually lost.</p></div></div><div class="faq-expanded__item"><h3 class="faq-expanded__q" aria-expanded="true" aria-controls="faq-a3">Do mark-downs distort shrinkage measurement?</h3><div class="faq-expanded__a" id="faq-a3"><p>They can, if the value basis changes between count and comparison. Shrinkage should be measured at a consistent cost basis, otherwise a price reduction shows up as a loss that never physically occurred.</p></div></div></div></div></section><section class="gl-eeat-sec"><div class="eeat-review-wrap"><div class="eeat-review"><div class="eeat-review__badge"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>Reviewed by the CA &amp; CS Team, Patron Accounting LLP</div><div class="eeat-review__sources"><span>Official sources:</span> <a href="https://icai.org" target="_blank" rel="noopener">ICAI</a><a href="https://rbi.org.in" target="_blank" rel="noopener">RBI</a></div><div class="eeat-review__meta">ICAI &amp; ICSI registered &nbsp;&middot;&nbsp; Reviewed by CA Sundram Gupta (FCA) &nbsp;&middot;&nbsp; Last reviewed 20 August 2026 &nbsp;&middot;&nbsp; Next review 20 November 2026</div></div><p class="eeat-note">Last reviewed on 20 August 2026 by CA Sundram Gupta (FCA). Definitions are reviewed against the standard or lender practice they describe, and restated when that moves.</p></div></section><footer class="gl-foot"><div class="gl-foot__in"><a href="/glossary/stock-audit">&larr; Back to the stock audit glossary</a></div></footer></div>
@endverbatim
@endsection
