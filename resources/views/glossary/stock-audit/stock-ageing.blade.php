...
@section('meta')
<title>Stock Ageing: Bucketing Inventory by How Long It Sat</title>
<meta name="description" content="Stock ageing groups inventory by how long it has been held. The older buckets drive provisioning talks and tell a lender how liquid the security really is.">
<link rel="canonical" href="https://www.patronaccounting.com/glossary/stock-audit/stock-ageing">
...
<script type="application/ld+json">
{
    ...
    "itemListElement": [
        ...
        },
        {
            ...
            "position": 4,
            "name": "Stock Ageing",
            "item": "https://www.patronaccounting.com/glossary/stock-audit/stock-ageing"
        }
    ],
    "@id": "https://www.patronaccounting.com/glossary/stock-audit/stock-ageing/#breadcrumb"
}
</script><script type="application/ld+json">
{
    "@context": "https://schema.org",
    "@type": "FAQPage",
    "@id": "https://www.patronaccounting.com/glossary/stock-audit/stock-ageing/#faq",
    "mainEntity": [
        {
            "@type": "Question",
            "name": "How is stock ageing calculated?",
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "By the time elapsed since receipt or last movement, bucketed into bands. Ageing by last movement is more useful than ageing by receipt, because it identifies stock that has been sitting untouched regardless of when it arrived."
            }
        },
        {
            "@type": "Question",
            "name": "What does an ageing report tell a lender?",
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "How much of the security is actually moving. A high proportion of old stock suggests the value shown may not be realisable at that figure, which affects how much the lender is willing to lend against it."
            }
        },
        {
            "@type": "Question",
            "name": "Does old stock always need a provision?",
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "Not automatically. Slow-moving spares supporting live equipment may be entirely appropriate to hold. The test is whether the stock will be used or sold at its carrying value, not simply how long it has been there."
            }
        }
    ]
}
...
<div class="gl-page"><section class="gl-hero"><div class="gl-wrap gl-herogrid"><div class="gl-heromain"><nav class="gl-crumb" aria-label="Breadcrumb"><a href="https://www.patronaccounting.com/">Home</a><span class="sep">&rsaquo;</span><a href="/glossary/stock-audit">Glossary</a><span class="sep">&rsaquo;</span><a href="/stock-audit">Stock Audit</a><span class="sep">&rsaquo;</span><span class="cur">Stock Ageing</span></nav><div class="gl-cat">Stock Audit Glossary &middot; The Count</div><h1 class="gl-h1">Stock Ageing</h1><div class="gl-byline"><span class="ok"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg></span><span class="who">Reviewed by CA &amp; CS Team, Patron Accounting LLP</span><span class="sep">&middot;</span><span>4 min read</span></div></div><aside class="gl-herocta"><div class="gl-cta-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z"/></svg></div><h3>Prefer a CA to run the count?</h3><p>This term describes something an auditor has to establish on site. That is the work we do.</p><a class="gl-herocta__btn" href="/stock-audit">Talk to an Expert &rarr;</a><div class="gl-herocta__trust"><span class="star">&#9733;</span> 4.9 on Google &middot; UDIN on every report</div></aside></div></section><div class="gl-tocbar"><div class="gl-wrap gl-toc"><a href="#definition" class="gl-pill is-active">Definition</a><a href="#what-is" class="gl-pill">What it is</a><a href="#at-the-count" class="gl-pill">At the count</a><a href="#how-works" class="gl-pill">How it works</a><a href="#example" class="gl-pill">Example</a><a href="#mistakes" class="gl-pill">Mistakes</a><a href="#related" class="gl-pill">Related terms</a><a href="#faq-section" class="gl-pill">FAQs</a></div></div><div class="gl-body"><div class="gl-wrap"><div class="gl-grid"><div class="gl-main"><section id="definition" class="gl-sec"><div class="gl-eyebrow">Stock Ageing: Definition</div><div class="definition-box"><p>Stock ageing analyses inventory by how long each item has been held, grouping it into bands measured from the date of receipt or of last movement. It is a diagnostic that shows where value is sitting still. Ageing identifies items that warrant examination; it does not by itself establish what any of them is worth, which is settled by testing realisable value item by item.</p></div></section><section id="what-is" class="gl-sec"><h2>What Is Stock Ageing?</h2><p>Ageing turns an inventory balance into a distribution, which is a far more useful thing to look at than a total. Grouping items by how long they have been held shows where value is accumulating without moving, and it is the standard starting point for any assessment of obsolescence, because nothing else identifies which lines are worth examining out of a catalogue that may run to thousands.</p><p>What it cannot do is establish value, and treating it as though it could is the recurring error. A high-value spare deliberately held against a long-lead-time failure may not move for years and remain worth every rupee; a fast-moving line may be about to be superseded and worth very little. Ageing also depends entirely on a date field, and those fields are unreliable in one direction: a re-receipt, an inter-location transfer, a count adjustment or a system migration can each reset the clock on stock that has not actually moved, so recently dated items are frequently the ones worth sampling.</p></section><section id="at-the-count" class="gl-sec"><h2>What Stock Ageing Means at a Physical Count</h2><p>The ageing report is one of the documents requested before the visit, and it shapes what the team looks at.</p><ul class="gloss-bullets"><li>Reconciling the report's total to the ledger first, since a schedule failing to agree is measuring some other set of goods entirely.</li><li>Using it to prioritise the walk, so aged high-value items are examined physically rather than left to a sample.</li><li>Inspecting those items for condition, since ageing identifies candidates and only the floor establishes whether goods are damaged, superseded or perfectly saleable.</li><li>Sampling deliberately from the newest bands as well, since a movement between sites, a re-booking or a post-count correction will each refresh the date on stock nobody has touched.</li><li>Recording what was found against each aged item, which is the evidence supporting whatever provision follows.</li></ul></section><section id="how-works" class="gl-sec"><h2>How Stock Ageing Works in Practice</h2><ol><li>A reference date is chosen and, for each item, the date taken as the start of the holding period is identified, usually whichever is later, when it came in or when it was last drawn on.</li></ol><ol><li>The elapsed period is computed and each item falls into a band, commonly running from under three months through to over a year.</li></ol><ol><li>Quantities and values are totalled by band, and the report's grand total is reconciled to the stock figure in the ledger. A report that does not tie is describing a different population.</li></ol><ol><li>Items in the older bands are examined, but so are a sample from the newest, because a transfer, re-receipt, count adjustment or migration can reset a date on stock that never moved.</li></ol><ol><li>What the analysis produces is a shortlist. Realisable value is then established for those items individually, and the provision follows from that rather than from the band.</li></ol></section><section id="example" class="gl-sec"><h2>Stock Ageing: A Worked Example</h2><div class="gloss-table-wrap"><table class="gloss-table"><thead><tr><th>Ageing band</th><th>Value</th><th>Share</th><th>Provision indicated</th></tr></thead><tbody><tr><td>0-90 days</td><td>Rs 4,20,00,000</td><td>60%</td><td>Nil</td></tr><tr><td>91-180 days</td><td>Rs 1,40,00,000</td><td>20%</td><td>Nil</td></tr><tr><td>181-365 days</td><td>Rs 84,00,000</td><td>12%</td><td>Review individually</td></tr><tr><td>Over 365 days</td><td>Rs 56,00,000</td><td>8%</td><td>Rs 42,00,000 indicated</td></tr><tr><td>Total</td><td>Rs 7,00,00,000</td><td>100%</td><td>-</td></tr></tbody></table></div><figure class="pa-chart"><figcaption>Share</figcaption><div class="pa-chart-scroll"><svg viewBox="0 0 466 210" width="466" height="210" role="img" aria-label="Share"><rect x="26" y="90" width="62" height="90" rx="5" fill="#14365F"/><text x="57" y="82" text-anchor="middle" font-size="12" font-weight="700" fill="#14365F">60</text><text x="57" y="198" text-anchor="middle" font-size="11" fill="#6B7280">0-90 days</text><rect x="114" y="150" width="62" height="30" rx="5" fill="#14365F"/><text x="145" y="142" text-anchor="middle" font-size="12" font-weight="700" fill="#14365F">20</text><text x="145" y="198" text-anchor="middle" font-size="11" fill="#6B7280">91-180 days</text><rect x="202" y="162" width="62" height="18" rx="5" fill="#14365F"/><text x="233" y="154" text-anchor="middle" font-size="12" font-weight="700" fill="#14365F">12</text><text x="233" y="198" text-anchor="middle" font-size="11" fill="#6B7280">181-365 days</text><rect x="290" y="168" width="62" height="12" rx="5" fill="#14365F"/><text x="321" y="160" text-anchor="middle" font-size="12" font-weight="700" fill="#14365F">8</text><text x="321" y="198" text-anchor="middle" font-size="11" fill="#6B7280">Over 365 days</text><rect x="378" y="30" width="62" height="150" rx="5" fill="#E8712C"/><text x="409" y="22" text-anchor="middle" font-size="12" font-weight="700" fill="#14365F">100</text><text x="409" y="198" text-anchor="middle" font-size="11" fill="#6B7280">Total</text><line x1="0" y1="181" x2="466" y2="181" stroke="#E5E7EB" stroke-width="1"/></svg></div></figure><p>A Gurugram consumer durables distributor ages its stock by receipt date rather than by SKU.</p><p>The oldest band is the one that changes the figures. Rs 56 lakh has sat for more than a year in a category where the model year turns over, so it is unlikely to move at full price. The provision indicated is a judgement based on what comparable stock has actually realised, not a percentage applied mechanically to the band. The 181-365 band is left for individual review because it contains both slow lines and genuinely long-cycle items that are perfectly saleable. Ageing by receipt date rather than by SKU matters here: a code that is constantly replenished can look young in aggregate while specific batches inside it are old.</p></section><section id="mistakes" class="gl-sec"><h2>Common Mistakes With Stock Ageing</h2><p>The analysis is reliable only if its inputs are, and they frequently are not.</p><ul class="gloss-bullets"><li>Treating the report as a statement of value, when it identifies what to examine and settles nothing about what anything is worth.</li><li>Trusting the date field without testing it, since re-receipts, transfers between sites, adjustments after counting and system migrations all restart the clock on goods that never moved.</li><li>Sampling the oldest bands only, when goods showing a fresh date are often exactly the ones whose clock was restarted, making them the population to sample.</li><li>Running the analysis without reconciling its total to the ledger, so any provision computed from it is wrong in the same proportion as the report.</li><li>Applying a single provision percentage across a band containing both a critical spare and a superseded line, which describes neither.</li></ul></section><section id="related" class="gl-sec"><h2>Related Stock Audit Terms</h2><p>What aged stock is actually worth is settled by realisable value, not by its age, so <a href="/glossary/stock-audit/net-realisable-value">net realisable value (nrv)</a> is the entry to read next. Every other term in this cluster is listed in the <a href="/glossary/stock-audit">stock audit terms</a>, grouped by the part of the work it belongs to.</p></section><section class="gl-cta"><div class="gl-cta__t"><h3>Need Help With Stock Ageing?</h3><p>Terminology takes you only as far as the question. Where an aged balance needs establishing before anybody provides against it, what follows is attendance, testing and a reconciliation, described under <a href="/stock-audit">inventory audit</a>. Share the site list and the records, and the effort can be sized from them.</p></div><div class="gl-cta__btns"><a class="gl-cta__primary" href="/stock-audit">How we run a stock audit &rarr;</a><a class="gl-cta__phone" href="tel:+919459456700">Book a consultation: +91 94594 56700</a></div></section></div><aside class="gl-aside"><div class="gl-card gl-card--service"><div class="gl-card__eyebrow">Related service</div><div class="gl-card__name">Stock Audit</div><p>CA-led stock and inventory counts for lenders and borrowers across India.</p><a class="gl-card__cta" href="/stock-audit">Explore the service &rarr;</a></div><div class="gl-card"><div class="gl-card__eyebrow">Where it is applied</div><ul><li><a href="/stock-audit">inventory audit<span class="arw">&rarr;</span></a></li></ul></div><div class="gl-card"><div class="gl-card__eyebrow">Related terms</div><ul><li><a href="/glossary/stock-audit/net-realisable-value">net realisable value (nrv)<span class="arw">&rarr;</span></a></li><li><a href="/glossary/stock-audit">Stock Audit Glossary<span class="arw">&rarr;</span></a></li></ul></div></aside></div></div></div><section id="faq-section" class="gl-faq-section"><div class="faq-expanded"><aside class="faq-expanded__aside"><h2 class="faq-expanded__title">Stock Ageing FAQs</h2><p class="faq-expanded__lead">Common questions about Stock Ageing in a stock audit.</p><a class="faq-expanded__cta" href="https://www.patronaccounting.com/contact-us">Still have a question? Talk to a CA &rarr;</a><form class="faq-enquiry" action="https://www.patronaccounting.com/enquiry" method="post" novalidate><h3 class="faq-enquiry__title">Talk to the stock audit team</h3><p class="faq-enquiry__sub">Tell us where the stock sits and we will scope the count.</p><p class="faq-enquiry__context">Enquiring about: <strong>Stock Ageing</strong></p><input class="faq-enquiry__input" type="text" name="name" placeholder="Your name" required><input class="faq-enquiry__input" type="email" name="email" placeholder="Email" required><div class="faq-enquiry__phone"><span class="faq-enquiry__cc">+91</span><input class="faq-enquiry__input faq-enquiry__input--phone" type="tel" name="phone" placeholder="Mobile" required></div><button class="faq-enquiry__btn" type="submit">Get a Callback</button><p class="faq-enquiry__msg" role="status" aria-live="polite"></p><div class="faq-enquiry__badges"><span class="faq-enquiry__badge"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>CA-led team</span></div></form></aside><div class="faq-expanded__list"><div class="faq-expanded__item"><h3 class="faq-expanded__q" aria-expanded="true" aria-controls="faq-a1">How is stock ageing calculated?</h3><div class="faq-expanded__a" id="faq-a1"><p>By the time elapsed since receipt or last movement, bucketed into bands. Ageing by last movement is more useful than ageing by receipt, because it identifies stock that has been sitting untouched regardless of when it arrived.</p></div></div><div class="faq-expanded__item"><h3 class="faq-expanded__q" aria-expanded="true" aria-controls="faq-a2">What does an ageing report tell a lender?</h3><div class="faq-expanded__a" id="faq-a2"><p>How much of the security is actually moving. A high proportion of old stock suggests the value shown may not be realisable at that figure, which affects how much the lender is willing to lend against it.</p></div></div><div class="faq-expanded__item"><h3 class="faq-expanded__q" aria-expanded="true" aria-controls="faq-a3">Does old stock always need a provision?</h3><div class="faq-expanded__a" id="faq-a3"><p>Not automatically. Slow-moving spares supporting live equipment may be entirely appropriate to hold. The test is whether the stock will be used or sold at its carrying value, not simply how long it has been there.</p></div></div></div></div></section><section class="gl-eeat-sec"><div class="eeat-review-wrap"><div class="eeat-review"><div class="eeat-review__badge"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>Reviewed by the CA &amp; CS Team, Patron Accounting LLP</div><div class="eeat-review__sources"><span>Official sources:</span> <a href="https://icai.org" target="_blank" rel="noopener">ICAI</a><a href="https://rbi.org.in" target="_blank" rel="noopener">RBI</a></div><div class="eeat-review__meta">ICAI &amp; ICSI registered &nbsp;&middot;&nbsp; Reviewed by CA Sundram Gupta (FCA) &nbsp;&middot;&nbsp; Last reviewed 20 August 2026 &nbsp;&middot;&nbsp; Next review 20 November 2026</div></div><p class="eeat-note">Last reviewed on 20 August 2026 by CA Sundram Gupta (FCA). Definitions are reviewed against the standard or lender practice they describe, and restated when that moves.</p></div></section><footer class="gl-foot"><div class="gl-foot__in"><a href="/glossary/stock-audit">&larr; Back to the stock audit glossary</a></div></footer></div>
@endverbatim
@endsection
