...
<a href="{{ $paWaFloatHref }}" target="_blank" rel="noopener noreferrer" class="pa-wa-float" aria-label="Chat on WhatsApp" data-track="contact.whatsapp">
