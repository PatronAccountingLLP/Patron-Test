{{-- Self-contained glossary assets (inlined so pages render even if the
     separate /css/glossary.css + /js/glossary.js are not on the web root).
     A closing script tag inside the JS is escaped so the inline tag can't close early. --}}
@verbatim
<style>
/* ============================================================
