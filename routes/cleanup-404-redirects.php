...
$cleanup404Redirects = [
    ...
    ['/tools/compliance-penalty-estimator', '/tools/notice-penalty-calculator'],
    ...
    ['/blog/category/gst', '/blog'],
    ['/blog/category/licences-registrations', '/blog'],
    ...
    ['/blog/dividend-payout-ratio', '/blog'],
    ['/blog/draft-income-tax-rules-2026-complete-summary-key-changes', '/blog/draft-income-tax-rules-2026-summary-key-changes'],
    ['/blog/economic-value-added-eva', '/blog'],
    ['/blog/epfo-compliance', '/blog'],
    ['/blog/epfo-inspection-readiness', '/blog'],
    ...
    ['/blog/tax-implications-of-investing-abroad', '/blog'],
    ...
    ['/blog/wos-vs-llp-india', '/blog'],
    ['/blog/zero-rated-supplies-under-gst', '/blog'],
    ...
    ['/tools/agm-due-date-calculator', '/tools/date-difference-calculator'],
    ['/tools/authorised-capital-stamp-duty-calculator', '/tools/stamp-duty-calculator'],
    ...
    ['/tools/director-kyc-deadline-checker', '/tools'],
    ...
    ['/tools/gst-place-of-supply-checker', '/tools'],
    ['/tools/gst-rcm-liability-checker', '/tools'],
    ...
    ['/tools/internship-letter-generator', '/tools'],
    ...
    ['/tools/roc-due-date-calculator', '/tools/roc-filing-due-date-calendar'],
    ['/tools/roc-late-fee-calculator', '/tools/gst-late-fee-calculator'],
    ['/tools/share-transfer-stamp-duty-calculator', '/tools/stamp-duty-calculator'],
    ['/tools/small-company-status-checker', '/tools'],
...
$cleanup404Gone = [
    ...
    '/,Olln',
    '/,Ruct,R,Alakkain',
    '/-Glprhrcdenermnibzrmnmbmplliprernklmpin',
    '/-Kiki1Tgmbgmeg',
    '/0,Adg,Amagaam,Amagaam,Ozhodepin',
    '/0,Akea,Aa,Aaw',
    '/0-.Ropxoopn',
    '/09Bzsmmllgml',
    '/0Baclxaaaaaaziin',
    '/0Ciaakollampin',
    '/1-,Icd,Vllyil,Vllyil,Kozhikodpin',
    '/100)',
    '/1Sagspchos',
    '/2B,K.Pcomplex,Koolaparambu,Kodiyura,Vanimel-,Kodiyura,Kozhikodepin',
    '/2Lmoneynnupin',
    '/2Truzgurrrtub',
    '/3,Apza,Oampin',
    '/3,Hrprblbldng,Westkodikuam,Idukkipn',
    '/38Rhabuldgputheaujuctopoothottaeraulampin',
    '/3D,Karaperavoor,Kannurpin',
    '/3Rykurpin',
    '/42Ksooeegzpuygokozkoepuykozkoepin',
    '/43Cdpumgpumplkkdpin',
    '/5,Municipalbuilding,Railwaystationsquare,Alwaye,Ernakulampin',
    '/5Bopxptiitttkozikodpin',
    '/5F,Orkkatteri,Kozhikode,Orkkatteri,Kozhikodepin',
    '/5Krvclkrpin',
    '/5Kurkurpin',
    '/5Prvrpn',
    '/6,Ir,Urpin',
    '/6,Savithatouristhomebuilding,Neendaparachurchjunction,Neriamangalam,Ernakulampin',
    '/6-,Hrvr,Pn-674,Hrvr,Kozhkodepin',
    '/6To/0,Anapparabuilding,Nearkelothl.Pschool,Thamarassery-Koyilandyroad,Unnikulam,Unnikulam,Kozhikodepin',
    '/7,Kumarbuildings,Chullickal,Thoppumpady,Ernakulampin',
    '/759,Unalur,Kollamin',
    '/7Mnoitiruvngknnurpin',
    '/7Pptowerchoondijunctionvdmpdiernkulmpin',
    '/8,Ward,Fathimacomplex,Kuzhalmannam,Palakkadpin',
    '/8-F1,F2,Westtower,Po.Westhill,Kozhikode,Pin-600,Kozhikodecorporation,Westhill,Kozhikodepin',
    '/89An8Ckcomlexmokerimokerikozhikoein',
    '/8Aapn',
    '/8Pkrtwrthmrssrythmrssrykzhikdpin',
    '/8Utuyidurpin',
    '/9,Agrculturalbankbuldng,Bye-Passjuncton,Alwaye,Ernakulampin',
    '/9,Kscbankbuilding,Koothattukulam,Ernakulampin',
    '/9,Manjapraksheerolpadakaco-Opsocetybuldng,Manjaprajuncton,Manjapra,Ernakulampin',
    '/9/,Tnr,Kollin',
    '/9Ciuaakoapin',
    '/9E,Kannavam,Kannurpin',
    '/9Nhudukpin',
    '/A,Apzharoad,Engaoorp.O,Idkkipin',
    '/A-guide-to-import-export-code-registration-online',
    '/Blueyweveco-Op.Ocietybuildingblueyblueykozhikodepin',
    '/Digital-Signature-registration',
    '/Free-stamp-duty-calculator-for-LLP-Company-registration-in-India',
    '/How-to-choose-name-for-new-company-registration',
    '/Important-Links',
    '/MSME-registration',
    '/Pnhmpnhtd',
    '/Rent_agreement',
    ...
    '/audit-services',
    '/authorhub',
    '/authorhub/boby-gautam',
    '/bookkeeping-services/mumbai',
    '/business-set-up-services',
    '/ca-certified-services',
    '/cfo-services',
    '/company-registration-in-Mumbai',
    '/company-registration/delhi',
    '/compounding-of-offences',
    '/copyright-for-dramatic-work/delhi',
    '/copyright-for-dramatic-work/gurugram',
    '/copyright-for-dramatic-work/mumbai',
    '/copyright-for-dramatic-work/pune',
    '/copyright-for-literary-work/delhi',
    '/copyright-for-literary-work/gurugram',
    '/copyright-for-literary-work/mumbai',
    '/copyright-for-sound-recording/delhi',
    '/copyright-for-sound-recording/gurugram',
    '/copyright-for-sound-recording/mumbai',
    '/copyright-for-sound-recording/pune',
    '/delhi',
    '/dir-3-kyc-filing-services/delhi',
    '/dir-3-kyc-filing-services/gurugram',
    '/dir-3-kyc-filing-services/mumbai',
    '/dir-3-kyc-filing-services/pune',
    '/direct-tax-services',
    '/double-currency-networth',
    '/double-currency-networth-certificate',
    '/download-formats.xml',
    '/drug-license.xml',
    '/duns-number-service',
    '/ecommerce-accounting-services',
    '/epf-registration/mumbai',
    '/esi-pf-compliance',
    '/esi-registration',
    '/esi-registration/pune',
    '/fema-compliance',
    '/gst-audit-service/pune',
    '/gst-litigation',
    '/gst-return-filing/mumbai',
    '/gst-return/gurugram',
    '/gstat-litigation-services',
    '/guidance-on-company-registration-in-India',
    '/gurugram',
    '/how-to-register-llp-in-india-and-its-benefits',
    '/hr-advisory',
    '/hsn-code',
    '/ifsc-code',
    '/ifsc_01_state_bank_of_india_sitemap.xml',
    '/ifsc_06_bank_of_baroda_sitemap.xml',
    '/ifsc_08_axis_bank_sitemap.xml',
    '/ifsc_09_indian_bank_sitemap.xml',
    '/ifsc_10_icici_bank_limited_sitemap.xml',
    '/ifsc_11_central_bank_of_india_sitemap.xml',
    '/ifsc_12_idbi_bank_sitemap.xml',
    '/ifsc_13_yes_bank_sitemap.xml',
    '/ifsc_15_uco_bank_sitemap.xml',
    '/in',
    '/in/blog/writing-object-clause-for-new-company-registration',
    '/in/blog/writing-object-clause-for-private-company-registrations-in-india',
    '/in/services/audits/stock',
    '/in/services/closures/director-resignation',
    '/in/tools/board-resolution-for-gst-generator',
    '/in/tools/free-stamp-duty-calculator-for-llp-and-company-registration',
    '/in/tools/internship-letter-generator',
    ...
    '/legal-drafting-service/delhi',
    '/legal-drafting-service/gurugram',
    '/legal-drafting-service/mumbai',
    '/llp-annual-compliance/delhi',
    '/llp-annual-compliance/gurugram',
    '/llp-annual-compliance/mumbai',
    '/llp-annual-compliance/pune',
    '/llp-registration-in-ahmedabad',
    '/llp-registration-in-amritsar',
    '/llp-registration-in-aurangabad',
    '/llp-registration-in-bengaluru',
    '/llp-registration-in-bhopal',
    '/llp-registration-in-bhubaneswar',
    '/llp-registration-in-bilaspur',
    '/llp-registration-in-chandigarh',
    '/llp-registration-in-chennai',
    '/llp-registration-in-cuttack',
    '/llp-registration-in-dehradun',
    '/llp-registration-in-delhi',
    '/llp-registration-in-faridabad',
    '/llp-registration-in-ghaziabad',
    '/llp-registration-in-haridwar',
    '/llp-registration-in-hyderabad',
    '/llp-registration-in-jaipur',
    '/llp-registration-in-jalandhar',
    '/llp-registration-in-jodhpur',
    '/llp-registration-in-kolkata',
    '/llp-registration-in-kota',
    '/llp-registration-in-ludhiana',
    '/llp-registration-in-meerut',
    '/llp-registration-in-mumbai',
    '/llp-registration-in-nashik',
    '/llp-registration-in-noida',
    '/llp-registration-in-patna',
    '/llp-registration-in-pune',
    '/llp-registration-in-raipur',
    '/llp-registration-in-rajkot',
    '/llp-registration-in-ranchi',
    '/llp-registration-in-sonipat',
    '/llp-registration-in-surat',
    '/llp-registration-in-udaipur',
    '/llp-registration-in-vadodara',
    '/llp-registration-in-varanasi',
    '/lut-filing',
    '/month',
    '/mumbai',
    '/nic-code',
    '/noc-certificate-download',
    '/our-approach',
    '/our-clients',
    '/payroll-hr-compliance-services',
    '/payroll-services-for-actuarial-valuation/pune',
    '/port-code',
    '/private-limited-company-annual-compliance/delhi',
    '/private-limited-company-annual-compliance/gurugram',
    '/private-limited-company-annual-compliance/mumbai',
    '/private-limited-company-annual-compliance/pune',
    '/private-limited-company-registration-in-india/mumbai',
    '/professional-tax-pt-inr-calculator-compliance-services',
    '/provident-fund-registration',
    '/pune',
    '/pvt-ltd-company-compliance/delhi',
    '/pvt-ltd-company-compliance/pune',
    '/roc-annual-filing',
    '/scrutiny-assessment',
    '/section-8-compliance',
    '/shops-establishments',
    '/sitemap-accounting.xml',
    '/sitemap-fssai.xml',
    '/sitemap-itr.xml',
    '/sitemap-main-p.xml',
    '/sitemap-networth.xml',
    '/sitemap-tds.xml',
    '/sitemap-trademark.xml',
    '/statutory-audit-service/pune',
    '/tax-audit-service/pune',
    '/terms',
    '/upload/23660342083.m3u8',
    '/upload/23660342103.m3u8',
    '/upload/23660342290.m3u8',
    '/upload/23660342381.m3u8',
    '/upload/9581462037.m3u8',
    '/upload/9581462063.m3u8',
    '/upload/9581462184.m3u8',
    '/upload/9581462235.m3u8',
    '/upload/9581462340.m3u8',
    '/upload/9581462375.m3u8',
    '/upload/9581462568.m3u8',
    '/virtual-cfo/delhi',
    '/virtual-cfo/gurugram',
    '/virtual-cfo/mumbai',
    '/virtual-cfo/pune',
    '/who-we-are',
    '/0O8,Hekkekrbuilding,Mruhonkrrod,Kuidi,Kuidi,Kozhikodepin',
];
